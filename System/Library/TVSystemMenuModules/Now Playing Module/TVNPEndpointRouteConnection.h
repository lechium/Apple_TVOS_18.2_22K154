...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x00100000000025b0
- (void).cxx_destruct;	// IMP=0x0000000000007770
...
- (id)_preloadArtwork;	// IMP=0x00000000000072b0
- (id)_placeholderArtwork;	// IMP=0x00000000000071b0
- (void)_updateState;	// IMP=0x0000000000006f50
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000006e60
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x00000000000065e0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000006430
- (void)_updateMetadata;	// IMP=0x00000000000039e0
- (void)_createRequestController;	// IMP=0x0000000000003350
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000003080
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000002d90
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000002830
- (void)playPause;	// IMP=0x0000000000002800
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000002770
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000002690
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000002510
- (id)playerPath;	// IMP=0x0000000000002420
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000002230
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000001f00
