...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000012cf0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000001d590
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001d0b0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000001ba60
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00000000000179e0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000017560
- (void)_updateAvailableRoutes;	// IMP=0x0000000000016a10
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000016850
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x00000000000167d0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000016780
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000016580
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000015e30
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000015960
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000014450
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000000014370
- (void)dealloc;	// IMP=0x0000000000013dc0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000012ea0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000012e00
- (id)init;	// IMP=0x0000000000012da0
