...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000002cfc0
- (void)connectAndPair;	// IMP=0x000000000002cfb0
- (void)togglePlayPause;	// IMP=0x000000000002cfa0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000002cf00
