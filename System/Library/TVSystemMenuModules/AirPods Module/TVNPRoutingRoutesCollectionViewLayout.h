...
+ (Class)layoutAttributesClass;	// IMP=0x006000000002dde0
- (void).cxx_destruct;	// IMP=0x000000000002e4c0
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000002e280
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000002df70
- (void)prepareLayout;	// IMP=0x000000000002de10
