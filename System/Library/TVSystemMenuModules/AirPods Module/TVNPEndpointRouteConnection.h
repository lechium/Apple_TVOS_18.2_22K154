...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x00100000000303e0
- (void).cxx_destruct;	// IMP=0x0000000000035390
...
- (id)_preloadArtwork;	// IMP=0x0000000000034ed0
- (id)_placeholderArtwork;	// IMP=0x0000000000034dd0
- (void)_updateState;	// IMP=0x0000000000034b70
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000034a80
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x00000000000342f0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000034140
- (void)_updateMetadata;	// IMP=0x0000000000031760
- (void)_createRequestController;	// IMP=0x00000000000310d0
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000030e00
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000000030b50
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000030660
- (void)playPause;	// IMP=0x0000000000030630
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00000000000305a0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000304c0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000030340
- (id)playerPath;	// IMP=0x0000000000030250
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000030060
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x000000000002fd30
