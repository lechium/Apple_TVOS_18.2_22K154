...
- (id)_unfocusedProgressColor;	// IMP=0x000000000003de40
- (id)_focusedProgressColor;	// IMP=0x000000000003dd60
- (void)_rightPressed:(id)arg1;	// IMP=0x000000000003dc70
- (void)_leftPressed:(id)arg1;	// IMP=0x000000000003db90
- (void)_panUpdated:(id)arg1;	// IMP=0x000000000003d5f0
- (void)_menuPressed;	// IMP=0x000000000003d5e0
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003d570
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003d500
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000003d490
- (_Bool)shouldTrack;	// IMP=0x000000000003d470
- (double)maxBarWidth;	// IMP=0x000000000003d450
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x000000000003d3e0
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000000003d0f0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000003d010
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000003cfd0
- (void)layoutSubviews;	// IMP=0x000000000003c990
- (_Bool)canBecomeFocused;	// IMP=0x000000000003c970
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000003bfa0
