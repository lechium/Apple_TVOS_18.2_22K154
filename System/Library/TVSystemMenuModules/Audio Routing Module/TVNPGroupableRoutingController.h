...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000001e40
- (void).cxx_destruct;	// IMP=0x000000000000cea0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000000c7e0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000c300
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000acb0
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000006c30
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x00000000000067b0
- (void)_updateAvailableRoutes;	// IMP=0x0000000000005c60
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000005a50
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x00000000000059d0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000005980
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000005780
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000005030
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000004b60
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x00000000000035e0
- (void)_updateAllowsDestinationSelection;	// IMP=0x0000000000003500
- (void)dealloc;	// IMP=0x0000000000002f50
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001ff0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000001f50
- (id)init;	// IMP=0x0000000000001ef0
