...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x00400000000214c0
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000001f020
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x004000000001a730
+ (_Bool)allowsSelection;	// IMP=0x004000000001a710
- (void).cxx_destruct;	// IMP=0x00000000000219a0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x00000000000212b0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000020410
- (unsigned long long)_controlStateForCell;	// IMP=0x0000000000020340
- (void)_addInitialConstraints;	// IMP=0x000000000001f1d0
- (void)accessoryViewSelected;	// IMP=0x000000000001f010
- (void)routeViewSelected;	// IMP=0x000000000001f000
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000001efc0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000001e5a0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000001e470
- (void)updateConstraints;	// IMP=0x000000000001c630
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000001c500
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000001c4e0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001c3a0
- (void)prepareForReuse;	// IMP=0x000000000001c300
- (id)preferredFocusEnvironments;	// IMP=0x000000000001c180
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000001a750
