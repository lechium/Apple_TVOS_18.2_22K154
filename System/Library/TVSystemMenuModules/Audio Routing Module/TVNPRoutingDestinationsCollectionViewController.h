...
- (void).cxx_destruct;	// IMP=0x000000000001a630
...
- (id)_indexPathForCurrentDestination;	// IMP=0x000000000001a160
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x0000000000019fc0
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x0000000000019e50
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x0000000000019de0
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000000019510
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000018ee0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000187e0
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x0000000000018570
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x00000000000182c0
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x00000000000179e0
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000172a0
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000017210
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000000170e0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000016a90
- (void)viewDidLoad;	// IMP=0x0000000000016500
- (void)dealloc;	// IMP=0x0000000000016440
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x00000000000161c0
