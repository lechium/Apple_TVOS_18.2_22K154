...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x001000000002a460
- (void).cxx_destruct;	// IMP=0x000000000002f470
...
- (id)_preloadArtwork;	// IMP=0x000000000002efb0
- (id)_placeholderArtwork;	// IMP=0x000000000002eeb0
- (void)_updateState;	// IMP=0x000000000002ec50
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000002eb60
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000002e370
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000002e1c0
- (void)_updateMetadata;	// IMP=0x000000000002b7e0
- (void)_createRequestController;	// IMP=0x000000000002b150
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x000000000002ae80
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x000000000002abd0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x000000000002a6e0
- (void)playPause;	// IMP=0x000000000002a6b0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x000000000002a620
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000002a540
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x000000000002a3c0
- (id)playerPath;	// IMP=0x000000000002a2d0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x000000000002a0e0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000029db0
