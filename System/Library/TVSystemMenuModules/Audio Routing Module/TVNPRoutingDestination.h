...
- (void).cxx_destruct;	// IMP=0x0000000000031af0
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x00000000000315f0
- (void)connectAndPair;	// IMP=0x00000000000315e0
- (void)togglePlayPause;	// IMP=0x00000000000315d0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0000000000031530
- (id)init;	// IMP=0x0000000000031500
