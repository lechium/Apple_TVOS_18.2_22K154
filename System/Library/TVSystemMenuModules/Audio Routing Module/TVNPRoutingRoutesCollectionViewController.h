...
- (void).cxx_destruct;	// IMP=0x00000000000386c0
...
- (void)_pickRoute:(id)arg1;	// IMP=0x0000000000037fb0
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0000000000037f00
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0000000000037d90
- (void)_calculateVisibleVolumeCells;	// IMP=0x0000000000037840
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x00000000000376f0
- (id)_gradientMask;	// IMP=0x0000000000037090
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0000000000036f80
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0000000000036690
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0000000000036620
- (void)shareAudioSelected;	// IMP=0x0000000000036580
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0000000000036270
- (void)longPressSelect:(id)arg1;	// IMP=0x0000000000036170
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0000000000036010
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0000000000035e40
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0000000000035c70
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x0000000000035bd0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000035840
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000000035600
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000354d0
- (void)handleVolumeDown;	// IMP=0x0000000000034ea0
- (void)handleVolumeUp;	// IMP=0x0000000000034810
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x0000000000033570
- (void)viewDidLayoutSubviews;	// IMP=0x00000000000331e0
- (void)viewDidLoad;	// IMP=0x00000000000322b0
- (void)dealloc;	// IMP=0x0000000000032260
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x0000000000032110
