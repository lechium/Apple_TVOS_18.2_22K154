...
+ (Class)layoutAttributesClass;	// IMP=0x0060000000026100
- (void).cxx_destruct;	// IMP=0x00000000000267e0
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x00000000000265a0
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000026290
- (void)prepareLayout;	// IMP=0x0000000000026130
