...
- (void)_removeAnimations;	// IMP=0x000000000003ad80
- (void)_addAnimationsWithRepeatCount:(float)arg1;	// IMP=0x000000000003a8a0
- (void)_setBarHeights:(double)arg1;	// IMP=0x000000000003a600
- (void)_setSubviewsHidden:(_Bool)arg1;	// IMP=0x000000000003a410
- (void)_updateInternalState;	// IMP=0x000000000003a3a0
- (void)tintColorDidChange;	// IMP=0x0000000000039f60
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000039ed0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000039b50
