...
+ (id)_defaultShortNameFormatter;	// IMP=0x0010000000006920
+ (id)availableStyles;	// IMP=0x0010000000006260
- (void).cxx_destruct;	// IMP=0x0000000000006b70
...
- (id)stringForNameComponents:(id)arg1;	// IMP=0x0000000000006870
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x00000000000066f0
...
- (void)_updateProfilePhoto;	// IMP=0x0000000000006550
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000006450
...
- (void)dealloc;	// IMP=0x0000000000006200
- (id)initWithSuggestedUser:(id)arg1;	// IMP=0x0000000000006090
