...
+ (id)availableStyles;	// IMP=0x00100000000038c0
...
- (void)contentModuleViewControllerDidTriggerAction:(id)arg1;	// IMP=0x0000000000003c30
...
- (id)init;	// IMP=0x00000000000038e0
