...
- (id)_collectionViewWrapperViewGradientMask;	// IMP=0x0000000000006fc0
- (void)_handleMenuPress:(id)arg1;	// IMP=0x0000000000006f40
- (void)layoutSubviews;	// IMP=0x0000000000006d20
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005aa0
