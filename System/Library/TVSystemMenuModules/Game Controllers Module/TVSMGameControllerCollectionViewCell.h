...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0060000000003f70
...
- (void)_updateColors;	// IMP=0x0000000000004480
- (void)_updateVisibleAccessoryView;	// IMP=0x0000000000004390
- (unsigned long long)_floatingContentViewControlState;	// IMP=0x00000000000042c0
- (void)_updateFloatingContentViewControlState;	// IMP=0x0000000000004220
- (_Bool)_canHandlePresses:(id)arg1;	// IMP=0x0000000000004120
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000003ea0
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000003dd0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000003d00
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000003b40
- (void)prepareForReuse;	// IMP=0x0000000000003ac0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000039d0
- (void)setSelected:(_Bool)arg1;	// IMP=0x00000000000039b0
- (void)updateConstraints;	// IMP=0x0000000000003740
@property(copy, nonatomic) NSString *subtitle;
@property(copy, nonatomic) NSString *title;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000001400
