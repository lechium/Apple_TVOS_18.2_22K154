...
- (void)setPlatterColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007c40
- (void)setSecondaryContentColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007ac0
- (void)setPrimaryContentColor:(id)arg1 forControlState:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000000007940
- (void)setAccessoryText:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007870
- (void)setSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007740
- (void)setSystemImageName:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000007610
- (void)setTitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000074e0
- (void)updateStateAnimated:(_Bool)arg1;	// IMP=0x0000000000006cf0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000006b70
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006a50
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006960
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000006810
- (_Bool)canBecomeFocused;	// IMP=0x00000000000067f0
...
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 systemImageName:(id)arg3;	// IMP=0x0000000000005200
