...
- (unsigned long long)constantOffsetAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000010dd
- (unsigned long long)alignment;	// IMP=0x00000000000010cc
- (unsigned long long)encodedLength;	// IMP=0x00000000000010bb
- (_Bool)bufferLayoutMatchesFrontEndLayout;	// IMP=0x00000000000010ab
- (void)dealloc;	// IMP=0x0000000000000f73
- (id)initWithDevice:(id)arg1 reference:(unsigned int)arg2 data:(CDStruct_146dae35 *)arg3;	// IMP=0x0000000000000ed4
