...
- (int)setOwnerWithIdentity:(unsigned int)arg1;	// IMP=0x0000000000013614
@property(readonly) unsigned long long heapOffset;
- (void)setHeapOffset:(unsigned long long)arg1;	// IMP=0x00000000000135d6
- (void)waitUntilComplete;	// IMP=0x00000000000135d0
- (_Bool)isPurgeable;	// IMP=0x00000000000135c8
- (_Bool)isComplete;	// IMP=0x00000000000135c0
- (_Bool)doesAliasResource:(id)arg1;	// IMP=0x0000000000013590
- (_Bool)doesAliasAnyResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000001357b
- (_Bool)doesAliasAllResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000013563
- (_Bool)doesAliasResources:(const id *)arg1 count:(unsigned long long)arg2 all:(_Bool)arg3;	// IMP=0x0000000000013412
...
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x0000000000013379
- (void)makeAliasable;	// IMP=0x00000000000132db
- (_Bool)isAliasable;	// IMP=0x00000000000132d2
@property(readonly) id <MTLHeap> heap; // @dynamic heap;
@property(copy) NSString *label; // @dynamic label;
- (id)retainedLabel;	// IMP=0x000000000001327b
@property(readonly) id <MTLDevice> device; // @dynamic device;
- (void)dealloc;	// IMP=0x00000000000131b0
- (id)initWithResourceRef:(unsigned int)arg1 options:(unsigned long long)arg2 device:(id)arg3 heap:(id)arg4;	// IMP=0x0000000000013114
