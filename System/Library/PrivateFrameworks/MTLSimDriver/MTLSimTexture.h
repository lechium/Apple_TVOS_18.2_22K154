...
+ (void)decompress:(const char *)arg1 expandedTex:(char *)arg2 srcFormat:(unsigned long long)arg3 destFormat:(unsigned long long)arg4 width:(unsigned long long)arg5 height:(unsigned long long)arg6 destRowBytes:(unsigned long long)arg7 srcRowBytes:(unsigned long long)arg8;	// IMP=0x0010000000013e9c
+ (unsigned long long)getDecompressedFormat:(unsigned long long)arg1;	// IMP=0x0010000000013b45
...
- (void)_swapDecompressedPropertiesWith:(id)arg1;	// IMP=0x0000000000016b1a
...
- (id)newTextureViewWithPixelFormat:(unsigned long long)arg1 textureType:(unsigned long long)arg2 levels:(struct _NSRange)arg3 slices:(struct _NSRange)arg4 swizzle:(CDStruct_a06f635e)arg5;	// IMP=0x000000000001668e
- (void)didModifyData;	// IMP=0x0000000000016688
- (void)replaceRegion:(CDStruct_caaed6bc)arg1 mipmapLevel:(unsigned long long)arg2 withBytes:(const void *)arg3 bytesPerRow:(unsigned long long)arg4;	// IMP=0x0000000000016642
- (void)replaceRegion:(CDStruct_caaed6bc)arg1 mipmapLevel:(unsigned long long)arg2 slice:(unsigned long long)arg3 withBytes:(const void *)arg4 bytesPerRow:(unsigned long long)arg5 bytesPerImage:(unsigned long long)arg6;	// IMP=0x00000000000162d9
- (id)newTextureViewWithPixelFormat:(unsigned long long)arg1 textureType:(unsigned long long)arg2 levels:(struct _NSRange)arg3 slices:(struct _NSRange)arg4;	// IMP=0x0000000000015f7e
- (id)newTextureViewWithPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000015eca
- (id)newTextureViewWithPixelFormatInternal:(unsigned long long)arg1 isInternalTextureView:(_Bool)arg2;	// IMP=0x0000000000015c1a
- (id)newRemoteTextureViewForDevice:(id)arg1;	// IMP=0x0000000000015c12
- (void)getBytes:(void *)arg1 bytesPerRow:(unsigned long long)arg2 fromRegion:(CDStruct_caaed6bc)arg3 mipmapLevel:(unsigned long long)arg4;	// IMP=0x0000000000015bce
@property(readonly) unsigned long long hazardTrackingMode;
- (void)getBytes:(void *)arg1 bytesPerRow:(unsigned long long)arg2 bytesPerImage:(unsigned long long)arg3 fromRegion:(CDStruct_caaed6bc)arg4 mipmapLevel:(unsigned long long)arg5 slice:(unsigned long long)arg6;	// IMP=0x000000000001581f
- (unsigned long long)setPurgeableState:(unsigned long long)arg1;	// IMP=0x0000000000015814
...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000150fc
@property(readonly) unsigned int textureRef;
- (void)dealloc;	// IMP=0x0000000000014fa5
- (id)initWithTexture:(id)arg1 device:(id)arg2;	// IMP=0x0000000000014f9c
- (id)initWithDescriptor:(id)arg1 decompressedPixelFormat:(unsigned long long)arg2 iosurface:(struct __IOSurface *)arg3 plane:(unsigned long long)arg4 textureRef:(unsigned int)arg5 heap:(id)arg6 device:(id)arg7 shareable:(_Bool)arg8;	// IMP=0x0000000000014efd
- (id)initWithDescriptor:(id)arg1 decompressedPixelFormat:(unsigned long long)arg2 iosurface:(struct __IOSurface *)arg3 plane:(unsigned long long)arg4 textureRef:(unsigned int)arg5 heap:(id)arg6 device:(id)arg7;	// IMP=0x0000000000014ba2
- (id)initWithBuffer:(id)arg1 offset:(unsigned long long)arg2 bytesPerRow:(unsigned long long)arg3 descriptor:(id)arg4 textureRef:(unsigned int)arg5;	// IMP=0x00000000000149c6
- (id)initWithTexture:(id)arg1 pixelFormat:(unsigned long long)arg2 decompressedPixelFormat:(unsigned long long)arg3 textureRef:(unsigned int)arg4 isInternalTextureView:(_Bool)arg5;	// IMP=0x00000000000148fd
- (id)initWithTexture:(id)arg1 pixelFormat:(unsigned long long)arg2 decompressedPixelFormat:(unsigned long long)arg3 textureType:(unsigned long long)arg4 levels:(struct _NSRange)arg5 slices:(struct _NSRange)arg6 swizzle:(CDStruct_a06f635e)arg7 textureRef:(unsigned int)arg8 isInternalTextureView:(_Bool)arg9;	// IMP=0x00000000000148ac
- (id)initWithTextureInternal:(id)arg1 pixelFormat:(unsigned long long)arg2 decompressedPixelFormat:(unsigned long long)arg3 textureType:(unsigned long long)arg4 levels:(struct _NSRange)arg5 slices:(struct _NSRange)arg6 swizzle:(CDStruct_a06f635e)arg7 compressedView:(_Bool)arg8 textureRef:(unsigned int)arg9 isInternalTextureView:(_Bool)arg10;	// IMP=0x000000000001452a
- (unsigned long long)calculateOffsetToRegion:(CDStruct_caaed6bc)arg1 level:(unsigned long long)arg2 slice:(unsigned long long)arg3;	// IMP=0x00000000000142b3
- (void)decompressPlaceholder:(const char *)arg1 expandedTex:(char *)arg2 srcFormat:(unsigned long long)arg3 destFormat:(unsigned long long)arg4 width:(unsigned long long)arg5 height:(unsigned long long)arg6 destRowBytes:(unsigned long long)arg7 srcRowBytes:(unsigned long long)arg8;	// IMP=0x000000000001429a
