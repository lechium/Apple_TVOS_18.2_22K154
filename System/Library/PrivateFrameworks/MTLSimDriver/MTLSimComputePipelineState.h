...
- (id)pipelineBinaries;	// IMP=0x000000000000e64b
- (unsigned int)pipelineRef;	// IMP=0x000000000000e63b
- (void)dealloc;	// IMP=0x000000000000e561
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000e369
