...
- (id)pipelineBinaries;	// IMP=0x0000000000013107
- (unsigned long long)imageblockMemoryLengthForDimensions:(CDStruct_da2e99ad)arg1;	// IMP=0x00000000000130ff
@property(readonly) unsigned long long imageblockSampleLength;
- (unsigned int)getVertexShaderTelemetryID;	// IMP=0x00000000000130ef
- (unsigned int)getFragmentShaderTelemetryID;	// IMP=0x00000000000130e7
- (id)newVertexShaderDebugInfo;	// IMP=0x00000000000130df
- (id)newFragmentShaderDebugInfo;	// IMP=0x00000000000130d7
- (unsigned int)pipelineRef;	// IMP=0x00000000000130c7
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (void)dealloc;	// IMP=0x0000000000012e60
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x0000000000012df5
