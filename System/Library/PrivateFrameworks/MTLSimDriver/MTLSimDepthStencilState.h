...
- (unsigned int)depthStencilRef;	// IMP=0x0000000000012de5
- (void)dealloc;	// IMP=0x0000000000012d1b
- (id)initWithDescriptor:(id)arg1 reference:(unsigned int)arg2 device:(id)arg3;	// IMP=0x0000000000012cd3
