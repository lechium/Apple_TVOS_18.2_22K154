...
{
    struct MTLSimConnection _mainConnection;	// 496 = 0x1f0
    struct MTLSimConnection _resourceConnection;	// 512 = 0x200
    struct MTLSimConnection _compilerConnection;	// 528 = 0x210
    MTLSerializer *_serializer;	// 544 = 0x220
    unsigned long long _processRef;	// 552 = 0x228
    unsigned int _deserializerVersion;	// 560 = 0x230
    unsigned long long _registryID;	// 568 = 0x238
    NSObject<OS_dispatch_queue> *_commandBufferQueue;	// 576 = 0x240
    struct unordered_map<unsigned int, MTLSimCommandBuffer *, std::hash<unsigned int>, std::equal_to<unsigned int>, std::allocator<std::pair<const unsigned int, MTLSimCommandBuffer *>>> _commandBuffers;	// 584 = 0x248
    MTLResourceListPool *_resourceListPool;	// 624 = 0x270
    id <MTLDeviceSPI> _deviceWrapper;	// 632 = 0x278
    struct _opaque_pthread_mutex_t {
        long long __sig;
        char __opaque[56];
    } _notificationMutex;	// 640 = 0x280
    void *_notifications;	// 704 = 0x2c0
    CDStruct_da2e99ad _maxThreadsPerThreadgroup;	// 712 = 0x2c8
    unsigned long long _maxThreadgroupMemoryLength;	// 736 = 0x2e0
    unsigned long long _hostFeatureProfile;	// 744 = 0x2e8
    _Bool headless;	// 752 = 0x2f0
    _Bool lowPower;	// 753 = 0x2f1
    _Bool hasUnifiedMemory;	// 754 = 0x2f2
    _Bool removable;	// 755 = 0x2f3
    _Bool programmableSamplePositionsSupported;	// 756 = 0x2f4
    _Bool depth24Stencil8PixelFormatSupported;	// 757 = 0x2f5
    unsigned long long currentAllocatedSize;	// 760 = 0x2f8
    MTLArchitecture *architecture;	// 768 = 0x300
}

- (id).cxx_construct;	// IMP=0x000000000000799e
- (void).cxx_destruct;	// IMP=0x000000000000798d
...
@property(readonly) unsigned int deserializerVersion;
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x00000000000078a3
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x000000000000789b
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x0000000000007884
...
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x00000000000075bd
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x00000000000072a9
- (id)newSharedEventWithOptions:(long long)arg1;	// IMP=0x000000000000708e
- (id)newEventWithOptions:(long long)arg1;	// IMP=0x000000000000707c
- (id)newSharedEvent;	// IMP=0x0000000000006e6d
- (id)newEvent;	// IMP=0x0000000000006e5b
...
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x0000000000006e37
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x0000000000006e2f
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006e0e
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006ded
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000006dc9
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000006da5
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000006d81
- (void)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006d60
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000006bf8
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000006a34
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x0000000000006a0f
- (_Bool)setResourcesPurgeableState:(id *)arg1 newState:(unsigned long long)arg2 oldState:(unsigned long long *)arg3 count:(int)arg4;	// IMP=0x0000000000006a07
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000006881
- (id)vendorName;	// IMP=0x0000000000006874
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x000000000000685e
- (int)llvmVersion;	// IMP=0x0000000000006853
- (id)productName;	// IMP=0x0000000000006846
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 offset:(unsigned long long)arg4 bytesPerRow:(unsigned long long)arg5;	// IMP=0x0000000000006822
- (id)newTiledTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 deallocator:(CDUnknownBlockType)arg3 descriptor:(id)arg4 offset:(unsigned long long)arg5 bytesPerRow:(unsigned long long)arg6;	// IMP=0x00000000000067fe
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x00000000000067da
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x00000000000067b6
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000006792
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x0000000000006517
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x00000000000062c7
- (id)familyName;	// IMP=0x00000000000062ba
- (id)newComputePipelineWithDescriptor:(id)arg1 variant:(id)arg2 errorMessage:(id *)arg3;	// IMP=0x0000000000005fdf
- (id)newComputeVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000005fc8
- (id)wrapComputeState:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000005fa4
- (id)pipelinePerformanceStatisticsWithComputeVariant:(id)arg1 compileTimeOutput:(id)arg2;	// IMP=0x0000000000005f35
- (id)pipelinePerformanceStatisticsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 vertexCompileTimeOutput:(id)arg3 fragmentCompileTimeOutput:(id)arg4;	// IMP=0x0000000000005e1c
- (CDStruct_9028b892)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2;	// IMP=0x0000000000005e14
- (id)newRenderPipelineWithDescriptor:(id)arg1 vertexVariant:(id)arg2 fragmentVariant:(id)arg3 errorMessage:(id *)arg4;	// IMP=0x0000000000005b94
- (id)newVertexVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000005b7d
- (id)newFragmentVariantWithCompilerOutput:(id)arg1 pipelineStatisticsOutput:(id)arg2;	// IMP=0x0000000000005b66
- (id)newFunctionVariantWithCompilerOutput:(id)arg1 functionType:(unsigned long long)arg2;	// IMP=0x0000000000005892
- (id)reportLeaks;	// IMP=0x00000000000057b2
- (void)freeVertexFunctionKey:(void *)arg1 vertexKeySize:(unsigned long long)arg2;	// IMP=0x00000000000057ac
- (void)freeFragmentFunctionKey:(void *)arg1 fragmentKeySize:(unsigned long long)arg2;	// IMP=0x00000000000057a6
- (void *)vertexFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 nextStageVariant:(id)arg3 vertexKeySize:(unsigned long long *)arg4;	// IMP=0x0000000000005797
- (void *)fragmentFunctionKeyWithRenderPipelineDescriptor:(id)arg1 options:(unsigned long long)arg2 previousStateVariant:(id)arg3 fragmentKeySize:(unsigned long long *)arg4;	// IMP=0x0000000000005788
- (id)wrapRenderState:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000005764
- (void)registerViewTexture:(id)arg1 baseTextureView:(id)arg2;	// IMP=0x000000000000575e
@property(readonly) _Bool deserializerSupportsSharedTextures;
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x0000000000005314
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x0000000000004fe4
- (id)_fixUpSwizzleForTexture:(id)arg1 key:(unsigned int)arg2;	// IMP=0x0000000000004ea6
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x0000000000004d58
- (void)dispatchNotificationWithReference:(unsigned int)arg1;	// IMP=0x0000000000004c37
- (void)registerEventNotification:(unsigned int)arg1 listener:(id)arg2 event:(id)arg3 value:(unsigned long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000000004b5a
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x0000000000004b36
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x0000000000004825
- (id)newFence;	// IMP=0x0000000000004593
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x0000000000004445
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000000441c
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x00000000000043ee
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000043b9
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 pointer:(void *)arg3 copyBytes:(_Bool)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x00000000000040fb
- (void)releaseCommandBufferRef:(unsigned int)arg1;	// IMP=0x0000000000004047
- (unsigned int)registerCommandBuffer:(id)arg1;	// IMP=0x0000000000003eb4
- (id)commandBufferForReference:(unsigned int)arg1;	// IMP=0x0000000000003d47
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x0000000000003acf
- (CDStruct_da2e99ad)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x0000000000003a92
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x00000000000038fd
- (unsigned int)getNewResourceID;	// IMP=0x00000000000038ea
- (id)compiler;	// IMP=0x00000000000037c1
- (id)_deviceWrapper;	// IMP=0x0000000000003797
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x0000000000003786
- (void)dealloc;	// IMP=0x000000000000368d
- (id)init;	// IMP=0x0000000000002d02
...
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x0000000000002982
