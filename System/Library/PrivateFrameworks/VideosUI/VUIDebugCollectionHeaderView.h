...
- (void).cxx_destruct;	// IMP=0x000000000002d83f
...
- (void)layoutSubviews;	// IMP=0x000000000002d5d5
- (void)configureHeaderViewWithTitle:(id)arg1;	// IMP=0x000000000002d59a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002d3a6
