...
- (void)layoutSubviews;	// IMP=0x000000000004b6b5
- (void)configureSubtitleTextLayout:(id)arg1;	// IMP=0x000000000004b618
- (void)configureTitleTextLayout:(id)arg1;	// IMP=0x000000000004b569
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004b369
