...
- (void).cxx_destruct;	// IMP=0x0000000000061c6e
...
- (id)description;	// IMP=0x0000000000061503
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000061216
- (unsigned long long)hash;	// IMP=0x00000000000610b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000061035
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x0000000000060fce
