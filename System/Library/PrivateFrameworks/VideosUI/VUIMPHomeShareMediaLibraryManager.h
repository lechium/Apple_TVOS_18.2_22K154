...
+ (id)_sharedMPMediaLibraries;	// IMP=0x0010000000166489
- (void).cxx_destruct;	// IMP=0x0000000000166b44
...
- (void)_notifyDelegateHomeShareMediaLibrariesDidUpdate:(id)arg1 withChangeSet:(id)arg2;	// IMP=0x0000000000166a32
- (void)_updateMediaLibrariesWithSharedMPMediaLibraries:(id)arg1;	// IMP=0x0000000000166789
- (id)_homeShareMediaLibraries;	// IMP=0x000000000016657a
- (void)_handleAvailableMediaLibrariesDidChange:(id)arg1;	// IMP=0x0000000000166345
- (void)endDiscoveringMediaLibraries;	// IMP=0x000000000016632c
- (void)beginDiscoveringMediaLibraries;	// IMP=0x0000000000166313
@property(readonly, copy, nonatomic) NSArray *homeShareMediaLibraries;
- (void)dealloc;	// IMP=0x0000000000166119
- (id)initWithManager:(id)arg1;	// IMP=0x0000000000166002
