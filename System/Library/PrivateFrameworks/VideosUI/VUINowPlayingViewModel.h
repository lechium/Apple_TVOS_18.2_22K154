...
- (void).cxx_destruct;	// IMP=0x00000000000cb23a
...
- (void)_updateMetadataForCurrentMediaItem;	// IMP=0x00000000000cafbe
- (void)_handleMetadataDidChangeNotification:(id)arg1;	// IMP=0x00000000000cafac
- (void)_handleMediaItemDidChangeNotification:(id)arg1;	// IMP=0x00000000000caf9a
- (void)_unregisterPlaybackNotifications;	// IMP=0x00000000000cae5c
- (void)_registerPlaybackNotifications;	// IMP=0x00000000000cad80
- (void)_unregisterPlayerObserver;	// IMP=0x00000000000cad2d
- (void)_registerPlayerObserver;	// IMP=0x00000000000caccd
@property(readonly, nonatomic, getter=canAutoPlay) _Bool autoPlay;
@property(readonly, nonatomic) NSString *currentMediaTitle;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000ca8fc
- (void)dealloc;	// IMP=0x00000000000ca8a9
- (id)initWithMediaController:(id)arg1;	// IMP=0x00000000000ca7e7
- (id)init;	// IMP=0x00000000000ca7a6
