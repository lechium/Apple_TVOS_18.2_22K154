...
- (void).cxx_destruct;	// IMP=0x00000000001acf67
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x00000000001acd95
- (id)init;	// IMP=0x00000000001acd26
