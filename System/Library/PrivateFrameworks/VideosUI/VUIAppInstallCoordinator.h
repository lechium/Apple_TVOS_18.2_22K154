...
- (void).cxx_destruct;	// IMP=0x00000000000f528f
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000f49ac
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f48cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f4808
- (unsigned long long)hash;	// IMP=0x00000000000f479a
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x00000000000f46dd
