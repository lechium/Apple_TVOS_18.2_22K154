...
+ (id)keyPathsForValuesAffectingExpirationDate;	// IMP=0x00800000000c4f44
+ (id)keyPathsForValuesAffectingLocalPlaybackURL;	// IMP=0x00800000000c4f24
...
@property(retain, nonatomic) NSString *downloadedPlaybackMode; // @dynamic downloadedPlaybackMode;
...
@property(nonatomic) _Bool isSportingEvent; // @dynamic isSportingEvent;
...
@property(copy, nonatomic) NSString *playablePassThrough; // @dynamic playablePassThrough;
