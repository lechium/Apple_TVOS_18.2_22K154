...
- (id)description;	// IMP=0x00000000002001e0
- (id)initWithMediaItemEntityTypesChangeSet:(id)arg1 localMediaItemsAvailableDidChange:(_Bool)arg2;	// IMP=0x000000000020016a
- (id)init;	// IMP=0x00000000002000fb
