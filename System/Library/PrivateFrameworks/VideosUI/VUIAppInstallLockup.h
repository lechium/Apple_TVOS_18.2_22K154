...
- (void).cxx_destruct;	// IMP=0x000000000017b1fa
...
- (id)_textColorForDarkMode;	// IMP=0x000000000017b0c8
- (void)_configureLabels;	// IMP=0x000000000017ad33
- (void)_configureAgeRatingBadge;	// IMP=0x000000000017ab3f
- (_Bool)canBecomeFocused;	// IMP=0x000000000017ab1a
@property(readonly, nonatomic) VUIAppInstallView *installView;
- (void)_layoutForIos;	// IMP=0x000000000017a2ed
- (void)_layoutForTvos;	// IMP=0x0000000000179d8a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000179a23
