...
- (void).cxx_destruct;	// IMP=0x0000000000240b37
...
- (id)notificationBody;	// IMP=0x0000000000240a2e
- (id)notificationTitle;	// IMP=0x0000000000240a11
@property(readonly, nonatomic) NSString *title;
@property(readonly, nonatomic) NSString *buyParams;
@property(readonly, nonatomic) _Bool playWhenDone;
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000240553
