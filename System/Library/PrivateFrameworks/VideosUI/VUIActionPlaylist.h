...
- (void).cxx_destruct;	// IMP=0x00000000000374ba
...
- (_Bool)isAccountRequired;	// IMP=0x000000000003737f
- (void)_presentViewController:(CDUnknownBlockType)arg1;	// IMP=0x00000000000369d5
- (id)_maxContentRating;	// IMP=0x0000000000036833
- (id)_ratingValue;	// IMP=0x0000000000036792
- (id)_ratingDomain;	// IMP=0x000000000003667e
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000360a2
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000035e33
