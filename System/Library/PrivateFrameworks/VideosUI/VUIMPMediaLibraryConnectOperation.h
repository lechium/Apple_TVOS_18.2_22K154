...
- (void).cxx_destruct;	// IMP=0x00000000001e3b5c
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x00000000001e3959
- (void)_stopProgressTimer;	// IMP=0x00000000001e3906
- (void)_startProgressTimer;	// IMP=0x00000000001e37b6
- (void)executionDidBegin;	// IMP=0x00000000001e347a
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000001e33d9
- (id)init;	// IMP=0x00000000001e336a
