...
- (void).cxx_destruct;	// IMP=0x00000000000a31e9
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a2a88
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000000a29e6
