...
- (void).cxx_destruct;	// IMP=0x000000000003093d
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000307bc
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 duration:(double)arg2 repeats:(_Bool)arg3 backgroundTimer:(_Bool)arg4;	// IMP=0x0000000000030625
- (id)initWithType:(unsigned long long)arg1 duration:(double)arg2 repeats:(_Bool)arg3;	// IMP=0x0000000000030610
