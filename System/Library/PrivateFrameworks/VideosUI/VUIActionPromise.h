...
- (void).cxx_destruct;	// IMP=0x000000000005c8b0
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000005c75c
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x000000000005c6a7
