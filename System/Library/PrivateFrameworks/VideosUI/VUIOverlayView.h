...
+ (id)overlayViewFromMediaItem:(id)arg1 overlayType:(long long)arg2 existingView:(id)arg3;	// IMP=0x0060000000032a76
- (void).cxx_destruct;	// IMP=0x00000000000343b3
...
- (struct UIEdgeInsets)_overlayPadding;	// IMP=0x00000000000342c4
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000033547
