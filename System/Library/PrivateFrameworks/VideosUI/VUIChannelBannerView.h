...
- (void).cxx_destruct;	// IMP=0x000000000017ee7b
...
- (void)_bgImageLoaded;	// IMP=0x000000000017ec74
- (void)_setBackdropViewsWithBgImageViewFrame:(struct CGRect)arg1;	// IMP=0x000000000017e6cf
- (void)_layoutLabels:(id)arg1 withOrigin:(struct CGPoint)arg2 maxWidth:(double)arg3;	// IMP=0x000000000017e32d
- (double)_subscribeButtonHeight;	// IMP=0x000000000017e1ba
- (_Bool)_isSubscribed;	// IMP=0x000000000017e159
- (struct CGSize)_layoutSubviewsWithSize:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000017c036
- (id)preferredFocusEnvironments;	// IMP=0x000000000017bf70
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000017bed0
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000017be3f
@property(readonly, nonatomic) UIImage *backdropImage;
- (void)setVuiBackgroundColor:(id)arg1;	// IMP=0x000000000017b619
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000017b505
