...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x00000000001b48eb
...
- (id)_sortKeys:(id)arg1;	// IMP=0x00000000001b4638
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x00000000001b39b4
