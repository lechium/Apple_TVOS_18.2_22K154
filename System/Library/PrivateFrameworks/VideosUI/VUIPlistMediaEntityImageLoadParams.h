...
- (void).cxx_destruct;	// IMP=0x00000000001de7b8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001de321
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x00000000001de14c
- (id)initWithImageURL:(id)arg1 baseImageIdentifier:(id)arg2 imageType:(unsigned long long)arg3;	// IMP=0x00000000001de024
