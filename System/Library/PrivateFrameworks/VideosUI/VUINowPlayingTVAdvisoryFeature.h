...
- (void).cxx_destruct;	// IMP=0x00000000000305fd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003046d
@property(readonly) unsigned long long hash;
@property(nonatomic, getter=isSkippable) _Bool skippable;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x00000000000303ea
