...
- (void).cxx_destruct;	// IMP=0x000000000004f494
...
- (_Bool)shouldPauseAutoFetchingArtworkInfoDictionaries;	// IMP=0x000000000004f3a2
- (id)_getPurchaseHistoryIdsFromMediaEntities:(id)arg1 inRange:(struct _NSRange)arg2;	// IMP=0x000000000004f270
- (void)_loadImageUrlsByPurchaseHistoryIds:(id)arg1;	// IMP=0x000000000004edaf
- (void)_fetchArtworkInfoIfNecessary;	// IMP=0x000000000004ecc2
- (void)controller:(id)arg1 fetchRequests:(id)arg2 didFailWithError:(id)arg3;	// IMP=0x000000000004eaf8
- (void)_notifyDelegateFetchDidComplete;	// IMP=0x000000000004e9b5
- (void)controller:(id)arg1 fetchRequests:(id)arg2 didCompleteWithResult:(id)arg3;	// IMP=0x000000000004e60c
- (void)dealloc;	// IMP=0x000000000004e4e7
- (void)setShouldPauseAutoFetchingArtworkInfoDictionaries:(_Bool)arg1;	// IMP=0x000000000004e4b1
- (void)startFetch;	// IMP=0x000000000004e2fd
- (id)initWithMediaLibrary:(id)arg1 fetchRequest:(id)arg2;	// IMP=0x000000000004e25e
