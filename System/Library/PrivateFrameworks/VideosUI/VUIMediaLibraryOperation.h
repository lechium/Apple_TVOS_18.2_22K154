...
- (void).cxx_destruct;	// IMP=0x00000000000d5606
...
- (void)cancel;	// IMP=0x00000000000d551c
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000d547b
- (id)init;	// IMP=0x00000000000d540c
