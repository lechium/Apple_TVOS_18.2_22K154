...
- (void).cxx_destruct;	// IMP=0x00000000001e2a9f
...
- (void)_updateForStyleChange;	// IMP=0x00000000001e2812
- (id)_maskImageForProgressBar;	// IMP=0x00000000001e2642
- (void)_layoutMaterialView;	// IMP=0x00000000001e2531
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001e2094
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001e1d48
- (void)layoutSubviews;	// IMP=0x00000000001e1a15
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001e1740
