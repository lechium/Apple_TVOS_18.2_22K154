...
- (void).cxx_destruct;	// IMP=0x000000000002fc3e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002fb67
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x000000000002fa04
- (id)init;	// IMP=0x000000000002f9eb
