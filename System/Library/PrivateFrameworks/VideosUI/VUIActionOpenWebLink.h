...
- (void).cxx_destruct;	// IMP=0x0000000000018a5a
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000018949
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x00000000000187af
