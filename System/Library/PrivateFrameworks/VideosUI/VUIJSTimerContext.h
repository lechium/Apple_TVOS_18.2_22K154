...
- (void).cxx_destruct;	// IMP=0x00000000000b324c
...
- (void)dealloc;	// IMP=0x00000000000b31db
- (void)removeManagedReferences;	// IMP=0x00000000000b30a5
- (id)description;	// IMP=0x00000000000b3023
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x00000000000b2e7a
