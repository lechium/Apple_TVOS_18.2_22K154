...
- (void).cxx_destruct;	// IMP=0x000000000002e62b
...
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x000000000002e4eb
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x000000000002e473
- (void)_defaultsSwitchPressed:(id)arg1;	// IMP=0x000000000002e456
- (void)layoutSubviews;	// IMP=0x000000000002de8e
- (void)configureCellWithDefaults:(id)arg1;	// IMP=0x000000000002dbe1
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000002d881
