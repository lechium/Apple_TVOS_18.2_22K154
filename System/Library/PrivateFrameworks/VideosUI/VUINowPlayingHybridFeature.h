...
- (void).cxx_destruct;	// IMP=0x00000000000303da
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000030224
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x0000000000030053
- (id)init;	// IMP=0x000000000003002f
