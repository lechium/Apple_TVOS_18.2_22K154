...
- (void)multiPlayerViewController:(id <VUIMultiPlayerViewController>)arg1 playerViewController:(AVPlayerViewController *)arg2 didResizeToFrame:(struct CGRect)arg3;
