...
+ (id)_pieImageAtFraction:(double)arg1;	// IMP=0x006000000005dda0
+ (id)_pieImagesMemoryPool;	// IMP=0x006000000005dcf2
...
- (id)_maskImage;	// IMP=0x000000000005e61c
- (void)_drawPauseUIWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000005e492
- (void)_drawIncomingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000005e3bc
- (void)_drawOutgoingCircleWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000005e217
- (void)_drawPieWithCenter:(struct CGPoint)arg1;	// IMP=0x000000000005e131
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000005db3b
- (void)_clearDisplayLink;	// IMP=0x000000000005db03
- (void)_ensureDisplayLink;	// IMP=0x000000000005da50
- (void)_onDisplayLink:(id)arg1;	// IMP=0x000000000005d948
- (void)_clearTransitionIfComplete:(id *)arg1;	// IMP=0x000000000005d911
- (void)_updateFractionTransitionAnimated:(_Bool)arg1;	// IMP=0x000000000005d828
- (void)_updateStateTransitionAnimated:(_Bool)arg1;	// IMP=0x000000000005d721
- (void)_updatePausedTransitionAnimated:(_Bool)arg1;	// IMP=0x000000000005d6b5
- (void)_updateTransitionsAnimated:(_Bool)arg1;	// IMP=0x000000000005d509
- (_Bool)_hasActiveTransitions;	// IMP=0x000000000005d4d6
- (void)setState:(long long)arg1 paused:(_Bool)arg2 fractionLoaded:(double)arg3 animated:(_Bool)arg4;	// IMP=0x000000000005d3de
- (void)dealloc;	// IMP=0x000000000005d33d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000005d2b9
