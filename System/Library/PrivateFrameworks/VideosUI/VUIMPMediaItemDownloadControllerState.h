...
- (void).cxx_destruct;	// IMP=0x00000000001e1391
...
- (id)description;	// IMP=0x00000000001e0ee5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e0d0b
- (unsigned long long)hash;	// IMP=0x00000000001e0c20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e0bc8
- (id)init;	// IMP=0x00000000001e0b64
