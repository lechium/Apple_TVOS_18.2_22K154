...
- (void).cxx_destruct;	// IMP=0x00000000000d2c31
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d28d2
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x00000000000d2714
- (id)initWithMediaItem:(id)arg1 andImageType:(unsigned long long)arg2;	// IMP=0x00000000000d266a
