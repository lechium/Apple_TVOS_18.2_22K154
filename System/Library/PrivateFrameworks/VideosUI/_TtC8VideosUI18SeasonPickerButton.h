...
- (void).cxx_destruct;	// IMP=0x000000000058520e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005851d8
...
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000585082
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000584946
- (id)init;	// IMP=0x0000000000584870
