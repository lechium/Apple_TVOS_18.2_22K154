...
+ (id)zero;	// IMP=0x004000000062c664
+ (id)add:(id)arg1 to:(id)arg2;	// IMP=0x004000000062c57e
- (void).cxx_destruct;	// IMP=0x000000000062cc96
- (id)init;	// IMP=0x000000000062cc63
@property(nonatomic, readonly) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000062c484
- (id)initWithNatural:(unsigned long long)arg1 leftToRight:(unsigned long long)arg2 rightToLeft:(unsigned long long)arg3;	// IMP=0x000000000062c1d2
