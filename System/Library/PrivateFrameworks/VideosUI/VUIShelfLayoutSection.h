...
- (struct CGRect)lastItemFrame;	// IMP=0x000000000006c64d
- (struct CGRect)firstItemFrame;	// IMP=0x000000000006c622
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x000000000006c603
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x000000000006c5e2
- (void)dealloc;	// IMP=0x000000000006c558
