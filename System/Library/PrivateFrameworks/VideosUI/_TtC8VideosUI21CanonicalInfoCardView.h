...
- (void).cxx_destruct;	// IMP=0x000000000052bebe
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000052be6e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000052bdad
...
- (void)vui_prepareForReuse;	// IMP=0x000000000052bb46
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000052b9fb
