...
+ (id)_changeSetFromMediaItemEntityTypes:(id)arg1 toMediaItemEntityTypes:(id)arg2;	// IMP=0x00600000000f2506
- (void).cxx_destruct;	// IMP=0x00000000000f261e
...
- (void)executionDidBegin;	// IMP=0x00000000000f211b
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2;	// IMP=0x00000000000f20d7
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000f2068
