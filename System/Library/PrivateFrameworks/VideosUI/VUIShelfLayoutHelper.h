...
- (void).cxx_destruct;	// IMP=0x00000000000703b8
...
- (void)_freeBuffers;	// IMP=0x0000000000070304
- (void)_compute;	// IMP=0x000000000006f73a
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x000000000006f69e
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x000000000006f663
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x000000000006f628
- (void)dealloc;	// IMP=0x000000000006f5ea
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x000000000006f576
