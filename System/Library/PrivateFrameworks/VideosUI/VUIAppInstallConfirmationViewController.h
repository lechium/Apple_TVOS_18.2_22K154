...
- (id)_namedRatingWithRatings:(id)arg1;	// IMP=0x0000000000085ec5
- (id)_fileSizeWithDeviceSizes:(id)arg1;	// IMP=0x0000000000085d87
- (void)_fetchStoreInfoForAdamID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000085ab8
- (void)_fetchAppInfo;	// IMP=0x0000000000085076
- (void)_handleSecondaryLink;	// IMP=0x000000000008505c
- (void)_handleAppStore;	// IMP=0x0000000000084f48
- (void)_handleCancel;	// IMP=0x0000000000084e2a
- (void)_handleAction;	// IMP=0x0000000000084d24
- (void)loadView;	// IMP=0x0000000000084a44
- (void)setInstallingState;	// IMP=0x0000000000084800
- (void)setPreInstallState;	// IMP=0x0000000000084628
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000008450b
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000008434a
@property(readonly, nonatomic) UIButton *actionButton;
@property(readonly, nonatomic) VUIAppInstallLockup *lockup;
- (void)setSecondaryLinkTitle:(id)arg1;	// IMP=0x000000000008429d
- (void)setUpdateTitle:(id)arg1;	// IMP=0x0000000000084289
- (void)setUpdateMessage:(id)arg1;	// IMP=0x0000000000084275
- (void)setMessage:(id)arg1;	// IMP=0x0000000000084258
- (void)setTitle:(id)arg1;	// IMP=0x00000000000841a6
- (id)initWithInstallable:(id)arg1;	// IMP=0x000000000008409e
- (id)init;	// IMP=0x000000000008405f
