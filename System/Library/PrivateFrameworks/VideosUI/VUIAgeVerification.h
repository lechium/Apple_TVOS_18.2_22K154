...
+ (id)sharedInstance;	// IMP=0x00600000000aea0c
- (void).cxx_destruct;	// IMP=0x00000000000af97d
...
- (void)performAgeGateVerificationWithRatingValue:(id)arg1 ratingDomain:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000aebf9
- (void)configureAgeVerification:(id)arg1;	// IMP=0x00000000000aea61
