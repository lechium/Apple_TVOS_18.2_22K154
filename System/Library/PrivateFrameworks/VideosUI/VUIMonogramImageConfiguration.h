...
- (void).cxx_destruct;	// IMP=0x00000000001256cc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000125543
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000000012544d
