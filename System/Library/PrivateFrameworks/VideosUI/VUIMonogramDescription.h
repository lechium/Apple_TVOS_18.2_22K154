...
- (void).cxx_destruct;	// IMP=0x000000000007edea
...
- (unsigned long long)preferedMonogramType;	// IMP=0x000000000007ea71
- (unsigned long long)hash;	// IMP=0x000000000007e972
- (struct CGPoint)specialOffsetForString:(id)arg1;	// IMP=0x000000000007e86e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000007dde9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007da9c
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x000000000007da17
- (id)init;	// IMP=0x000000000007d9fe
- (id)initWithText:(id)arg1 imageURL:(id)arg2 font:(id)arg3;	// IMP=0x000000000007d8d0
