...
+ (id)_actionForKey:(id)arg1 eventDict:(id)arg2 appContext:(id)arg3;	// IMP=0x006000000026b52d
+ (id)_documentDataSourceWithDict:(id)arg1;	// IMP=0x006000000026b514
+ (id)attachPrefetchedDict:(id)arg1 eventDict:(id)arg2;	// IMP=0x006000000026b41b
+ (id)eventDataSourceWithEventDict:(id)arg1 appContext:(id)arg2;	// IMP=0x006000000026b16f
+ (id)selectEventDataSourceWithLibraryMediaEntity:(id)arg1;	// IMP=0x006000000026b741
- (void).cxx_destruct;	// IMP=0x000000000026b677
...
- (id)_initWithLibraryMediaEntity:(id)arg1;	// IMP=0x000000000026b6d6
