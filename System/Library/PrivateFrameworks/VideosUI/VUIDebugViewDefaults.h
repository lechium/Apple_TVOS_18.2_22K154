...
- (void).cxx_destruct;	// IMP=0x00000000000bcf6f
...
- (void)toggleDefaultBoolValue;	// IMP=0x00000000000bce90
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 domain:(id)arg3 defaultName:(id)arg4 boolType:(_Bool)arg5;	// IMP=0x00000000000bcd7b
