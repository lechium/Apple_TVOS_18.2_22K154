...
- (void).cxx_destruct;	// IMP=0x0000000000013209
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012c23
- (_Bool)isAccountRequired;	// IMP=0x0000000000012c1b
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000012a1d
