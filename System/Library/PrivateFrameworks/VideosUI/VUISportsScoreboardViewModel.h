...
- (void).cxx_destruct;	// IMP=0x00000000001e4d52
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e4c92
- (void)removeUnicodeFromScoreValuesIfNeeded;	// IMP=0x00000000001e4a3a
- (id)dictionaryRepresentation;	// IMP=0x00000000001e4a1c
- (id)jsContextDictionary;	// IMP=0x00000000001e4974
@property(readonly, nonatomic) _Bool showScoreboard;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001e46b8
