...
@optional
- (_Bool)nowPlayingViewControllerShouldIgnorePlaybackStop:(VUINowPlayingViewController *)arg1;
...
- (void)nowPlayingControllerDidSelectAddToUpNext:(VUINowPlayingViewController *)arg1;
