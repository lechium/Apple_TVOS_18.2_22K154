...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x001000000019dcc6
- (void).cxx_destruct;	// IMP=0x000000000019dec8
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x000000000019dd88
- (id)description;	// IMP=0x000000000019d70e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019d61f
- (id)init;	// IMP=0x000000000019d2dc
