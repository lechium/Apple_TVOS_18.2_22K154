...
- (void).cxx_destruct;	// IMP=0x0000000000060f48
...
- (void)vui_prepareForReuse;	// IMP=0x0000000000060dd5
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000005fa59
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000005f9fa
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000005f9b1
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000005f92b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000005f5a4
