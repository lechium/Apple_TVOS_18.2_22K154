...
- (void).cxx_destruct;	// IMP=0x000000000006ae3b
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x000000000006a637
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000069e3e
- (void)_calculateColumnSpacing;	// IMP=0x0000000000069b92
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000069b53
- (void)invalidateData;	// IMP=0x0000000000069aeb
