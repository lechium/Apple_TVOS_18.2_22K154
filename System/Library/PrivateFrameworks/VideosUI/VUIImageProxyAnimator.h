...
- (void).cxx_destruct;	// IMP=0x000000000007d804
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x000000000007d64b
- (void)_fetchNext;	// IMP=0x000000000007d292
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x000000000007cd8d
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000007cb47
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000007c98f
- (void)stopAnimation;	// IMP=0x000000000007c926
- (void)startAnimation;	// IMP=0x000000000007c865
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x000000000007c781
- (id)init;	// IMP=0x000000000007c73f
