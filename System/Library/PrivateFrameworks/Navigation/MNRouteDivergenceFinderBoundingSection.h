...
- (id).cxx_construct;	// IMP=0x00000000000b8468
- (void).cxx_destruct;	// IMP=0x00000000000b8440
...
- (void)_appendDescription:(id)arg1 indent:(unsigned long long)arg2;	// IMP=0x00000000000b82cb
- (id)description;	// IMP=0x00000000000b8177
- (id)boundsDescription;	// IMP=0x00000000000b8076
- (id)treeDescription;	// IMP=0x00000000000b800e
- (_Bool)containsCoordinate:(CDStruct_071ac149)arg1;	// IMP=0x00000000000b7fd6
- (void)traverseWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b7f53
- (id)leafSectionsIntersectingSection:(id)arg1 paddingMapPoints:(double)arg2;	// IMP=0x00000000000b7c7c
