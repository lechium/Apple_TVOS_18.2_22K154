...
- (void).cxx_destruct;	// IMP=0x00000000000254ee
...
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000025112
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000024f60
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000024b56
