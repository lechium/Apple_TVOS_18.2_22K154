...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005eeba
- (void).cxx_destruct;	// IMP=0x000000000005f162
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005f03a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005eec2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005ee09
