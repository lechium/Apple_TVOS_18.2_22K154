...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000fb7db
- (void).cxx_destruct;	// IMP=0x00000000000fb96e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000fb8c2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000fb7e3
- (id)initWithAction:(unsigned long long)arg1 withTitle:(id)arg2 buttonDisplay:(int)arg3;	// IMP=0x00000000000fb6dc
