...
- (void).cxx_destruct;	// IMP=0x00000000000a4fb3
...
- (_Bool)_shouldEnableIdleTimerForArrivalState:(long long)arg1;	// IMP=0x00000000000a4f75
- (void)_updateForLocation:(id)arg1;	// IMP=0x00000000000a4c8c
- (void)_updateShouldEnableIdleTimer:(_Bool)arg1;	// IMP=0x00000000000a4b86
- (void)updateForStartNavigation;	// IMP=0x00000000000a4af6
- (void)dealloc;	// IMP=0x00000000000a48a4
