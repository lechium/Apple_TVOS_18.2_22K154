...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000e35f8
- (void).cxx_destruct;	// IMP=0x00000000000e93e3
...
- (id)description;	// IMP=0x00000000000e8d4a
@property(readonly, nonatomic) NSMapTable *routeIDLookup;
- (void)_updateRouteIDLookup;	// IMP=0x00000000000e8a07
- (id)removeTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000e8813
- (id)updateWithTrafficIncidentAlert:(id)arg1;	// IMP=0x00000000000e8659
- (void)markAnnouncementSpoken:(id)arg1;	// IMP=0x00000000000e85de
- (_Bool)isFollowingOriginalRoute;	// IMP=0x00000000000e8528
- (id)routeLookupIDs;	// IMP=0x00000000000e83e2
- (id)routeInfoForRoute:(id)arg1;	// IMP=0x00000000000e837f
- (id)routeInfoForID:(id)arg1;	// IMP=0x00000000000e81f9
- (void)updateETATrafficForRoute:(id)arg1;	// IMP=0x00000000000e7f9d
- (void)setAlternateRoutes:(id)arg1;	// IMP=0x00000000000e6d63
- (void)setCurrentRoute:(id)arg1 withAlternateRoutes:(id)arg2;	// IMP=0x00000000000e5dba
- (void)setPreviewRoutes:(id)arg1 withSelectedRouteIndex:(unsigned long long)arg2;	// IMP=0x00000000000e56cf
...
- (void)updateWithNavigationServiceCallbackParameters:(id)arg1;	// IMP=0x00000000000e487a
- (void)copySerializableValuesFrom:(id)arg1;	// IMP=0x00000000000e4432
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e3e28
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e3600
- (id)initForServer:(_Bool)arg1;	// IMP=0x00000000000e3500
