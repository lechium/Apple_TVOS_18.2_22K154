...
- (void).cxx_destruct;	// IMP=0x0000000000035322
...
- (id)description;	// IMP=0x0000000000034f04
- (id)initWithEvent:(id)arg1 distance:(double)arg2 speed:(double)arg3 durations:(id)arg4;	// IMP=0x0000000000034d0a
