...
- (void).cxx_destruct;	// IMP=0x00000000000ae777
...
- (void)_handleWalkingRouteResponse:(id)arg1;	// IMP=0x00000000000ae688
- (void)_updateForLocation:(id)arg1;	// IMP=0x00000000000ae1df
- (void)_updateWalkingRoute;	// IMP=0x00000000000addc5
- (id)_requestWalkingRouteWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ad6b9
- (unsigned long long)_requestTypeForArrivalState:(long long)arg1;	// IMP=0x00000000000ad6a6
- (void)stop;	// IMP=0x00000000000ad599
- (void)start;	// IMP=0x00000000000ad494
- (void)dealloc;	// IMP=0x00000000000ad321
