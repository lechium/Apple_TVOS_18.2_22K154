...
- (void).cxx_destruct;	// IMP=0x00000000001031d8
@property(readonly, nonatomic) GEOComposedRouteLeg *arrivalLeg; // @synthesize arrivalLeg=_arrivalLeg;
@property(readonly, nonatomic) GEOComposedRoute *route; // @synthesize route=_route;
- (id)_descriptionForSubScores;	// IMP=0x000000000010302f
- (id)_arrivalRegionsDepartureConditions;	// IMP=0x0000000000102e4c
- (id)_defaultDepartureConditions;	// IMP=0x0000000000102aa0
- (void)_initConditions;	// IMP=0x0000000000102868
- (_Bool)allowDepartureForLocation:(id)arg1;	// IMP=0x0000000000102200
@property(readonly, nonatomic) unsigned long long arrivalWaypointLegIndex;
- (id)initWithRoute:(id)arg1 arrivalLegIndex:(unsigned long long)arg2;	// IMP=0x00000000001020ea
