...
- (void).cxx_destruct;	// IMP=0x0000000000101336
@property(readonly, nonatomic) NSString *name;
- (double)scoreForLocation:(id)arg1;	// IMP=0x0000000000100f7a
- (id)initWithUpdater:(id)arg1 distanceThreshold:(double)arg2;	// IMP=0x0000000000100ee1
