...
- (void).cxx_destruct;	// IMP=0x000000000001844f
...
- (id)description;	// IMP=0x0000000000018257
- (_Bool)isEqualToEvent:(id)arg1;	// IMP=0x0000000000018102
@property(readonly, nonatomic) _Bool hasSoundEffect;
- (id)initWithUtterance:(id)arg1 andShortPrompt:(unsigned long long)arg2 andVoiceGuidanceLevel:(unsigned long long)arg3 andCompletion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000017fd7
