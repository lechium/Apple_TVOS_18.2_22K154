...
- (void).cxx_destruct;	// IMP=0x00000000001020b9
@property(readonly, nonatomic) NSString *name;
- (double)scoreForLocation:(id)arg1;	// IMP=0x0000000000101b49
- (id)initWithUpdater:(id)arg1 arrivalRegions:(id)arg2;	// IMP=0x0000000000101a64
