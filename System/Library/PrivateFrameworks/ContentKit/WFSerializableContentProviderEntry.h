...
- (void).cxx_destruct;	// IMP=0x000000000003c787
...
- (id)initWithSerializedRepresentationBlock:(CDUnknownBlockType)arg1 deserializationBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003c6ab
