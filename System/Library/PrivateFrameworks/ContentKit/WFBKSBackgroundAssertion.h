...
+ (id)backgroundAssertionWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x00600000000849ae
- (void).cxx_destruct;	// IMP=0x000000000008454b
...
- (void)end;	// IMP=0x00000000000843a8
- (id)initWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000084023
