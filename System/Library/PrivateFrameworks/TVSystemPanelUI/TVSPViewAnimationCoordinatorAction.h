...
+ (id)actionWithOptions:(unsigned long long)arg1 view:(id)arg2 identifier:(id)arg3 frame:(struct CGRect)arg4 isSetup:(_Bool)arg5 diagnosticDescription:(id)arg6 animationProvider:(CDUnknownBlockType)arg7;	// IMP=0x0060000000072140
- (void).cxx_destruct;	// IMP=0x0000000000072990
...
- (id)description;	// IMP=0x0000000000072670
- (void)perform;	// IMP=0x00000000000724a0
- (id)initWithOptions:(unsigned long long)arg1 view:(id)arg2 identifier:(id)arg3 frame:(struct CGRect)arg4 isSetup:(_Bool)arg5 diagnosticDescription:(id)arg6 animationProvider:(CDUnknownBlockType)arg7;	// IMP=0x00000000000722b0
