...
- (void).cxx_destruct;	// IMP=0x000000000002cdda
...
- (id)summary;	// IMP=0x000000000002cd02
- (_Bool)isCurrentlyValid;	// IMP=0x000000000002cb0a
- (id)initWithPathAndSetStatus:(id)arg1 setStatus:(id)arg2;	// IMP=0x000000000002ca47
