...
- (void).cxx_destruct;	// IMP=0x000000000000bfb8
...
- (id)initWithIncomingMessageOptions:(id)arg1;	// IMP=0x000000000000bd79
- (id)initWithRPCompanionLinkDevice:(id)arg1;	// IMP=0x000000000000bc32
