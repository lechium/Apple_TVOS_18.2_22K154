...
+ (_Bool)shouldSkipDefaultSchemaCheck;	// IMP=0x00600000001ed569
- (id)initWithDomain:(id)arg1 verb:(id)arg2 parametersByName:(id)arg3;	// IMP=0x00000000001fe205
- (id)initWithIdentifier:(id)arg1 backingStore:(id)arg2;	// IMP=0x00000000001fe01c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001fdf18
- (id)init;	// IMP=0x00000000001fde84
