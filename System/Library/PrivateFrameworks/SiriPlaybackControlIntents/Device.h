...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000002079ee
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000207c96
- (id)initWithIdentifier:(id)arg1 displayString:(id)arg2 pronunciationHint:(id)arg3;	// IMP=0x0000000000207b9a
