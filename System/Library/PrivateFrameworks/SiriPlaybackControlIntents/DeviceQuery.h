...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000020a219
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000020a4c1
- (id)initWithIdentifier:(id)arg1 displayString:(id)arg2 pronunciationHint:(id)arg3;	// IMP=0x000000000020a3c5
