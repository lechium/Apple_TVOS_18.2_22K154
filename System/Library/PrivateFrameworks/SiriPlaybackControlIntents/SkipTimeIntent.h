...
+ (_Bool)shouldSkipDefaultSchemaCheck;	// IMP=0x00600000001ed4f9
- (id)initWithDomain:(id)arg1 verb:(id)arg2 parametersByName:(id)arg3;	// IMP=0x00000000001f75d0
- (id)initWithIdentifier:(id)arg1 backingStore:(id)arg2;	// IMP=0x00000000001f73e7
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001f72e3
- (id)init;	// IMP=0x00000000001f724f
