...
+ (_Bool)shouldSkipDefaultSchemaCheck;	// IMP=0x00600000001ed509
- (id)initWithDomain:(id)arg1 verb:(id)arg2 parametersByName:(id)arg3;	// IMP=0x00000000001f845b
- (id)initWithIdentifier:(id)arg1 backingStore:(id)arg2;	// IMP=0x00000000001f8272
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001f816e
- (id)init;	// IMP=0x00000000001f80da
