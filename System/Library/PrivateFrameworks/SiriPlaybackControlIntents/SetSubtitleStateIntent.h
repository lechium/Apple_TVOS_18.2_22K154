...
+ (_Bool)shouldSkipDefaultSchemaCheck;	// IMP=0x00600000001ed519
- (id)initWithDomain:(id)arg1 verb:(id)arg2 parametersByName:(id)arg3;	// IMP=0x00000000001f9387
- (id)initWithIdentifier:(id)arg1 backingStore:(id)arg2;	// IMP=0x00000000001f919e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001f909a
- (id)init;	// IMP=0x00000000001f9006
