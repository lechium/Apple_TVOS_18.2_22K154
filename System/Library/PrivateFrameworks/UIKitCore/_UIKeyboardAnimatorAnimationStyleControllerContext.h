...
- (void).cxx_destruct;	// IMP=0x0000000000e367d9
...
- (void)complete;	// IMP=0x0000000000e3677e
@property(readonly, retain, nonatomic) UIView *animatingView;
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3;	// IMP=0x0000000000e36598
