...
@interface UIEventFetcher : NSObject
{
    ...
    id <UIEventFetcherSink> _eventFetcherSink;	// 232 = 0xe8
}

- (void).cxx_destruct;	// IMP=0x000000000115b77d
- (void)_receiveHIDEvent:(struct __IOHIDEvent *)arg1;	// IMP=0x0000000001159c31
- (void)threadMain;	// IMP=0x0000000001159a9f
- (void)displayLinkDidFire:(id)arg1;	// IMP=0x000000000115951c
- (void)resendDragMoveEventsOnTimer:(struct __CFRunLoopTimer *)arg1 withInterval:(double)arg2;	// IMP=0x00000000011593e6
- (id)init;	// IMP=0x0000000001158e4f
