...
+ (id)stateForKeyboardState:(id)arg1;	// IMP=0x0010000000c3ef80
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000c3ef78
- (void).cxx_destruct;	// IMP=0x0000000000c3f941
...
- (id)description;	// IMP=0x0000000000c3f732
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c3f4f2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c3f42c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c3f2d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c3f22b
- (void)createDocumentStateIfNecessary;	// IMP=0x0000000000c3f160
