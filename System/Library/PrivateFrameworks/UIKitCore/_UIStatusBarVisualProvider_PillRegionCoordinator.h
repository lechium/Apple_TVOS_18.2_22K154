...
- (void).cxx_destruct;	// IMP=0x00000000012e15ac
...
- (_Bool)handledUpdateOfActionable:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3;	// IMP=0x00000000012e147c
- (void)updateRegion:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3 cornerRadius:(double)arg4;	// IMP=0x00000000012e128f
- (id)animationForBackgroundActivityPillWithDuration:(double)arg1 scale:(double)arg2;	// IMP=0x00000000012e105b
- (id)animationForBackgroundActivityPill;	// IMP=0x00000000012e103e
- (id)animationForBackgroundActivityIcon;	// IMP=0x00000000012e0ebb
- (void)_hideActivityDetailAndUpdate:(_Bool)arg1;	// IMP=0x00000000012e0de5
- (void)updatePill;	// IMP=0x00000000012e0dc9
- (void)_updateBackgroundActivityWithEntry:(id)arg1 timeEntry:(id)arg2 needsUpdate:(_Bool)arg3;	// IMP=0x00000000012e09c3
- (void)updateDataForBackgroundActivity:(id)arg1;	// IMP=0x00000000012e0628
