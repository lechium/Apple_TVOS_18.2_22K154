...
+ (id)sliceSetWithDictionaryRepresenation:(id)arg1;	// IMP=0x0060000000f239d8
- (void).cxx_destruct;	// IMP=0x0000000000f240ea
...
- (id)description;	// IMP=0x0000000000f23e1a
- (void)addSlice:(id)arg1;	// IMP=0x0000000000f23e04
- (id)initWithSliceID:(id)arg1;	// IMP=0x0000000000f23831
