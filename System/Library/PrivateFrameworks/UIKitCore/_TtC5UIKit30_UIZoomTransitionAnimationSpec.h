...
+ (id)settingsControllerModule;	// IMP=0x0060000000138a00
- (void).cxx_destruct;	// IMP=0x0000000000138ba0
- (id)initWithDefaultValues;	// IMP=0x0000000000138b30
- (void)setDefaultValues;	// IMP=0x00000000001389d0
