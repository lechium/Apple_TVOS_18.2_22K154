...
- (void).cxx_destruct;	// IMP=0x0000000000f811ee
...
- (void)layoutSubviews;	// IMP=0x0000000000f80fea
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000f80e45
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000f7f993
