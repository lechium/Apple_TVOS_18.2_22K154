...
- (void).cxx_destruct;	// IMP=0x00000000006d61f3
...
- (id)interactionControllerForDismissal:(id)arg1;	// IMP=0x00000000006d61ab
- (id)animationControllerForDismissedController:(id)arg1;	// IMP=0x00000000006d6199
