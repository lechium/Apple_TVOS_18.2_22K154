...
- (void).cxx_destruct;	// IMP=0x00000000004d30f6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004d3040
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004d2ecc
- (id)init;	// IMP=0x00000000004d28e8
