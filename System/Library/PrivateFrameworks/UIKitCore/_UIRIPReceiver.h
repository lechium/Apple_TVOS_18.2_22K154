...
- (void).cxx_destruct;	// IMP=0x0000000000a35a8a
...
- (id)description;	// IMP=0x0000000000a359c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a3594f
- (unsigned long long)hash;	// IMP=0x0000000000a35939
- (id)initWithResponder:(id)arg1 class:(Class)arg2 press:(id)arg3 inPhase:(long long)arg4 withEvent:(id)arg5;	// IMP=0x0000000000a3585f
