...
- (void).cxx_destruct;	// IMP=0x0000000000419775
...
- (id)description;	// IMP=0x00000000004193d5
- (void)applyLayout;	// IMP=0x0000000000419323
- (void)updateLayout;	// IMP=0x0000000000418f8d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000418ea4
- (double)scopeControlHeight;	// IMP=0x0000000000418e3f
