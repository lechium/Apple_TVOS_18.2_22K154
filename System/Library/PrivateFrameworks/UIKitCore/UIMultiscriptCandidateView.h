...
- (void).cxx_destruct;	// IMP=0x0000000000a1e6e6
...
- (_Bool)requiresAlternativeCandidatesButton;	// IMP=0x0000000000a1e598
- (void)reloadArrangedSubviews:(id)arg1;	// IMP=0x0000000000a1dc41
- (id)init;	// IMP=0x0000000000a1dbd9
