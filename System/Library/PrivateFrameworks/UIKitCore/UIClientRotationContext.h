...
- (void)finishFullRotateUsingOnePartAnimation:(_Bool)arg1;	// IMP=0x00000000006cb328
- (void)finishFirstHalfRotation;	// IMP=0x00000000006cae96
- (void)rotateSnapshots;	// IMP=0x00000000006ca843
- (void)setupRotationOrderingKeyboardInAfterRotation:(_Bool)arg1;	// IMP=0x00000000006c9bfe
- (_Bool)_isFooterTranslucent;	// IMP=0x00000000006c9bb9
- (_Bool)_isHeaderTranslucent;	// IMP=0x00000000006c9b3c
- (void)_positionHeaderView:(id)arg1 andFooterView:(id)arg2 outsideContentViewForInterfaceOrientation:(long long)arg3;	// IMP=0x00000000006c98a0
- (void)slideHeaderViewAndFooterViewOffScreen:(_Bool)arg1 forInterfaceOrientation:(long long)arg2;	// IMP=0x00000000006c9880
- (void)_slideHeaderView:(id)arg1 andFooterView:(id)arg2 offScreen:(_Bool)arg3 forInterfaceOrientation:(long long)arg4;	// IMP=0x00000000006c9596
- (void)dealloc;	// IMP=0x00000000006c952d
- (id)initWithClient:(id)arg1 toOrientation:(long long)arg2 duration:(double)arg3 andWindow:(id)arg4;	// IMP=0x00000000006c92e0
