...
+ (double)_interspaceForIconSize:(long long)arg1;	// IMP=0x00100000011e80e1
- (void).cxx_destruct;	// IMP=0x00000000011e8c79
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000011e87a2
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x00000000011e8660
- (id)viewForLastBaselineLayout;	// IMP=0x00000000011e8635
- (void)_iconSizeDidChange;	// IMP=0x00000000011e84e9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000011e84a2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000011e844a
- (void)_commonInit;	// IMP=0x00000000011e8101
