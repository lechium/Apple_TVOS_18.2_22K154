...
- (void).cxx_destruct;	// IMP=0x0000000000ef9438
...
- (id)description;	// IMP=0x0000000000ef934a
- (id)splitAtIndex:(long long)arg1 withImage:(id)arg2 active:(_Bool)arg3;	// IMP=0x0000000000ef9140
- (_Bool)validPageWithinBound:(long long)arg1;	// IMP=0x0000000000ef9129
- (void)invalidateLayoutInfo;	// IMP=0x0000000000ef90e5
- (void)_copyImagesFromObject:(id)arg1;	// IMP=0x0000000000ef9021
@property(readonly, nonatomic) _Bool hasImage;
@property(readonly, nonatomic) struct CGSize resolvedSize;
- (id)initWithStartIndex:(long long)arg1 endIndex:(long long)arg2;	// IMP=0x0000000000ef8f37
