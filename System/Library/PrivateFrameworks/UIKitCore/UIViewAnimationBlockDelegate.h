...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000016d1287
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00600000016d11a7
- (void).cxx_destruct;	// IMP=0x00000000016d17fd
...
- (_Bool)_allowsHitTesting;	// IMP=0x00000000016d17b2
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x00000000016d17a9
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x00000000016d1734
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x00000000016d13d7
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x00000000016d13af
