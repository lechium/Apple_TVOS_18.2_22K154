...
- (void).cxx_destruct;	// IMP=0x0000000000a7fe5d
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x0000000000a7fbbf
- (id)initWithSettings:(id)arg1 touchedEdgesProvider:(id)arg2;	// IMP=0x0000000000a7fb29
