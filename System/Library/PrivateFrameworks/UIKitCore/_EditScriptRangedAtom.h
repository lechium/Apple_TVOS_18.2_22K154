...
+ (id)atomWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0060000000dae00a
- (void).cxx_destruct;	// IMP=0x0000000000dae0a2
...
- (id)description;	// IMP=0x0000000000dadf54
- (id)initWithEditRange:(struct _NSRange)arg1 replacementText:(id)arg2;	// IMP=0x0000000000dadec3
