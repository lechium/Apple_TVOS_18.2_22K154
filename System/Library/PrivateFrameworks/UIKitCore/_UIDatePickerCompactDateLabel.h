...
@class NSArray, NSDictionary, UIButton, _UIDatePickerLinkedLabel, _UIDatePickerOverlayPresentation, _UIDatePickerStyle;
...
- (void).cxx_destruct;	// IMP=0x00000000006850fa
...
- (void)activateLabel;	// IMP=0x0000000000684755
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000683a71
