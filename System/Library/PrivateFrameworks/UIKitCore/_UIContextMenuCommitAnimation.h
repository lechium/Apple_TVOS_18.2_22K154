...
- (void).cxx_destruct;	// IMP=0x00000000005b5bd0
...
- (void)_prepareAnimationViews;	// IMP=0x00000000005b51f0
- (void)_prepareSnapshots;	// IMP=0x00000000005b4e94
- (void)animateWithAlongsideActions:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000005b4271
- (id)initWithSource:(id)arg1 container:(id)arg2;	// IMP=0x00000000005b415e
