...
- (UITextRange *)viewportRangeForTextContainer:(NSTextContainer *)arg1;
...
- (UITextRange *)_writingToolsMinimumContextualRangeForRange:(UITextRange *)arg1;
- (void)resetTextViewportLayoutControllerLayoutForPosition:(UITextPosition *)arg1;
