...
- (void).cxx_destruct;	// IMP=0x00000000004cec6f
...
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 dataSourceSnapshot:(id)arg3 sectionIndex:(long long)arg4 wantsCollapsedTopSpacing:(_Bool)arg5;	// IMP=0x00000000004ceb6e
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 dataSourceSnapshot:(id)arg3;	// IMP=0x00000000004ceb42
