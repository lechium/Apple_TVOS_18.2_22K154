...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000c3fca6
- (void).cxx_destruct;	// IMP=0x0000000000c41065
...
- (id)description;	// IMP=0x0000000000c40b80
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c40696
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c40435
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c4016d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c40066
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x0000000000c40043
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x0000000000c3ff45
- (void)deleteBackward;	// IMP=0x0000000000c3fe8a
- (void)insertText:(id)arg1;	// IMP=0x0000000000c3fe21
- (id)_currentKeyboardOutput;	// IMP=0x0000000000c3fd78
- (void)_pushNewKeyboardOutput;	// IMP=0x0000000000c3fcae
