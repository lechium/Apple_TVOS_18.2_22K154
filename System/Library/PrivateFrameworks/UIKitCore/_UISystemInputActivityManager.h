...
- (void).cxx_destruct;	// IMP=0x0000000001389e33
...
- (void)_updateClientSettingsSystemInputActive:(_Bool)arg1;	// IMP=0x0000000001389cee
- (id)windowHostingScene;	// IMP=0x0000000001389cd8
- (id)beginTrackingSystemInputActivity;	// IMP=0x0000000001389b68
- (id)initWithScene:(id)arg1;	// IMP=0x0000000001389b04
