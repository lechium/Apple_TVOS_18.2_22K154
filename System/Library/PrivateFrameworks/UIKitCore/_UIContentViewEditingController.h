...
- (void).cxx_destruct;	// IMP=0x0000000000b910c1
...
- (_Bool)passthroughScrollInteractionDidRecognize:(id)arg1;	// IMP=0x0000000000b9105c
- (_Bool)passthroughScrollInteraction:(id)arg1 shouldInteractAtLocation:(struct CGPoint)arg2 withEvent:(id)arg3;	// IMP=0x0000000000b91040
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0000000000b90eca
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x0000000000b90d80
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000b90d68
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x0000000000b90c8e
- (_Bool)textFieldShouldBeginEditing:(id)arg1;	// IMP=0x0000000000b90c47
- (_Bool)textField:(id)arg1 shouldChangeCharactersInRange:(struct _NSRange)arg2 replacementString:(id)arg3;	// IMP=0x0000000000b90aa6
@property(readonly, nonatomic, getter=isDisplayingEditedText) _Bool displayingEditedText;
- (_Bool)makeTextInputFirstResponderWithInitialLayoutBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b90953
- (void)longPressRecognizerChanged:(id)arg1;	// IMP=0x0000000000b908a2
- (void)dealloc;	// IMP=0x0000000000b9086c
- (void)updateLabelConfiguration:(id)arg1 editingConfiguration:(id)arg2;	// IMP=0x0000000000b9031a
@property(readonly, copy) NSString *description;
- (id)initWithContentView:(id)arg1 editableLabel:(id)arg2;	// IMP=0x0000000000b9010b
