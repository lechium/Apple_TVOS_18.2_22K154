...
- (void).cxx_destruct;	// IMP=0x0000000000fce60b
...
- (_Bool)_isPlatterInYLockedPosition;	// IMP=0x0000000000fce1f6
- (void)_updateSwipeEdgeMultipliersIfNeededForTouchPosition:(struct CGPoint)arg1;	// IMP=0x0000000000fcdf9c
- (void)_positionSwipeActionViewsForCurrentPlatterViewPosition;	// IMP=0x0000000000fcdcfd
- (_Bool)isDefaultAnimatorBehavior:(id)arg1;	// IMP=0x0000000000fcdb3b
- (void)addBehaviorIfNotPresent:(id)arg1;	// IMP=0x0000000000fcda68
- (void)resetAnimatorToDefaultBehaviors;	// IMP=0x0000000000fcd87b
- (struct CGPoint)menuCenter;	// IMP=0x0000000000fcd77d
- (struct CGPoint)platterCenter;	// IMP=0x0000000000fcd67f
- (struct CGPoint)centerForCurrentPlatterPosition;	// IMP=0x0000000000fcd57f
- (struct CGPoint)centerForMenuPresentedRelativeToCurrentPlatter;	// IMP=0x0000000000fcd397
- (struct CGVector)modifiedOffsetForPosition:(struct CGPoint)arg1 offset:(struct CGVector)arg2 touchPosition:(struct CGPoint)arg3 axisLock:(unsigned long long)arg4;	// IMP=0x0000000000fcd0a3
- (void)beginTransitionWithAnimatorUsingBehaviors:(id)arg1 observedItems:(id)arg2 stateIfCompleted:(long long)arg3;	// IMP=0x0000000000fccd08
- (void)performActionsAndEnterState:(long long)arg1 velocity:(struct CGVector)arg2 underDirectManipulation:(_Bool)arg3;	// IMP=0x0000000000fcbe3b
- (void)performActionsAndEnterState:(long long)arg1;	// IMP=0x0000000000fcbe1e
- (long long)_stateForPosition:(struct CGPoint)arg1 offset:(struct CGVector)arg2 velocity:(struct CGVector)arg3;	// IMP=0x0000000000fcbc0f
- (void)stopObservingBehavior;	// IMP=0x0000000000fcbbb5
- (void)_configureAnimator;	// IMP=0x0000000000fcb189
- (void)panningTransformer:(id)arg1 didEnterTransitionNotchForTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000fcb183
- (void)panningTransformer:(id)arg1 didEndPanToTransformedPosition:(struct CGPoint)arg2 offsetFromPrevious:(struct CGVector)arg3 velocity:(struct CGVector)arg4;	// IMP=0x0000000000fcb039
- (void)panningTransformer:(id)arg1 didPanToTransformedPosition:(struct CGPoint)arg2 offsetFromPrevious:(struct CGVector)arg3 touchPosition:(struct CGPoint)arg4 velocity:(struct CGVector)arg5 didChangeAxis:(_Bool)arg6 axisLock:(unsigned long long)arg7;	// IMP=0x0000000000fcac55
- (void)panningTransformer:(id)arg1 didBeginPanToTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000fcab44
- (_Bool)hasBeenPresented;	// IMP=0x0000000000fcab2b
- (void)_animateToPlatterDismissedWithDuration:(double)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000fca8d1
- (void)_animateToPlatterPresentedWithVelocity:(struct CGVector)arg1;	// IMP=0x0000000000fca85b
- (void)_beginInYLockedStatePresented;	// IMP=0x0000000000fca809
- (void)lockIntoYAxis;	// IMP=0x0000000000fca7cc
- (_Bool)platterPanned;	// IMP=0x0000000000fca6f2
- (_Bool)isSelectingSwipeAction;	// IMP=0x0000000000fca5f2
- (_Bool)isMenuPresenting;	// IMP=0x0000000000fca5d8
- (_Bool)isMenuPresented;	// IMP=0x0000000000fca5be
- (void)resetAnimator;	// IMP=0x0000000000fca581
- (void)dealloc;	// IMP=0x0000000000fca516
- (void)toggleAnimatorDebugState;	// IMP=0x0000000000fca48a
- (void)didEndPanningWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000fca3e4
- (void)didPanWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000fca34d
- (void)didBeginPanningWithPoint:(struct CGPoint)arg1;	// IMP=0x0000000000fca280
...
- (id)initWithContainerView:(id)arg1 platterView:(id)arg2 menuView:(id)arg3 delegate:(id)arg4;	// IMP=0x0000000000fca0df
