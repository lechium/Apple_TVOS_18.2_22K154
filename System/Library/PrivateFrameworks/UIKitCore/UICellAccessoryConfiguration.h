...
- (void).cxx_destruct;	// IMP=0x00000000012ebd7f
...
- (_Bool)alwaysNeedsLayout;	// IMP=0x00000000012ebd56
- (id)description;	// IMP=0x00000000012eba3d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000012eb846
- (id)init;	// IMP=0x00000000012eb7e3
