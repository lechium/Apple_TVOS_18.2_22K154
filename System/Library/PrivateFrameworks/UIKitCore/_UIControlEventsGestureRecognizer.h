...
- (void).cxx_destruct;	// IMP=0x000000000090eb30
...
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000090eaaf
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000090e8c9
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000090e716
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000090e65e
- (void)reset;	// IMP=0x000000000090e5d0
- (void)gestureRecognizerFailed;	// IMP=0x000000000090e584
- (void)sendControlEvent:(unsigned long long)arg1 withEvent:(id)arg2;	// IMP=0x000000000090e524
