...
+ (id)_observationKeys;	// IMP=0x0010000001541903
- (void).cxx_destruct;	// IMP=0x0000000001543408
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000015431d4
- (void)_updateOutputs;	// IMP=0x00000000015423a9
- (struct CGRect)_effectiveViewSourceRect;	// IMP=0x0000000001542340
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x00000000015421a6
- (id)candidates;	// IMP=0x0000000001542195
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x000000000154212d
- (id)description;	// IMP=0x0000000001541e4c
- (void)dealloc;	// IMP=0x0000000001541ce9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001541b31
- (id)init;	// IMP=0x0000000001541988
