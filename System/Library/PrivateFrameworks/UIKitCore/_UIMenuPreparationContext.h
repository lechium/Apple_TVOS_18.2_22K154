...
+ (id)contextWithPreparer:(id)arg1 firstResponderTarget:(id)arg2;	// IMP=0x00100000017aa88e
- (void).cxx_destruct;	// IMP=0x00000000017aac7c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000017aa9b5
- (_Bool)shouldTrackSelectionForVisibleIndex:(unsigned long long)arg1 elementSize:(long long)arg2;	// IMP=0x00000000017aa98d
