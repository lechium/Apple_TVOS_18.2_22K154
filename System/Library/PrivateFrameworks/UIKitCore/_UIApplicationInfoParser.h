...
@interface _UIApplicationInfoParser : NSObject
{
    ...
    _Bool _observationTrackingEnabled;	// 25 = 0x19
    _Bool _supportsPrintCommand;	// 26 = 0x1a
    ...
    NSArray *_viewerRoleDocumentUTTypes;	// 160 = 0xa0
    NSArray *_editorRoleDocumentUTTypes;	// 168 = 0xa8
}

+ (id)mainBundleInfoParser;	// IMP=0x00600000009fcc95
- (void).cxx_destruct;	// IMP=0x00000000009fe46a
...
@property(readonly, nonatomic) _Bool observationTrackingEnabled; // @synthesize observationTrackingEnabled=_observationTrackingEnabled;
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x00000000009fe2f9
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x00000000009fe22e
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x00000000009fdf56
- (_Bool)_shouldUseHiResForClassic;	// IMP=0x00000000009fdf4e
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x00000000009fd024
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x00000000009fcd90
- (id)_initWithBundle:(id)arg1;	// IMP=0x00000000009fcd3a
