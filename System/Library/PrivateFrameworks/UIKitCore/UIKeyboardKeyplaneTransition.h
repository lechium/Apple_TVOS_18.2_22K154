...
- (void).cxx_destruct;	// IMP=0x0000000000f22709
...
- (_Bool)canDisplayTransitionFromKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000f2265d
- (void)finishWithProgress:(double)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000f224f2
- (void)transitionToFinalState:(id)arg1;	// IMP=0x0000000000f22460
- (void)finalizeTransition;	// IMP=0x0000000000f22375
- (void)removeAllAnimations;	// IMP=0x0000000000f2210e
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000f21dc4
- (void)cancelNonInteractiveAnimation;	// IMP=0x0000000000f21d6e
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f21d5c
@property(readonly, nonatomic) double nonInteractiveDuration;
- (void)commitTransitionRebuild;	// IMP=0x0000000000f21d4d
- (void)addTransitionView:(id)arg1 startFrame:(struct CGRect)arg2 endFrame:(struct CGRect)arg3;	// IMP=0x0000000000f219f9
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000f218f4
@property(readonly, nonatomic) double endHeight;
@property(readonly, nonatomic) double startHeight;
- (void)dealloc;	// IMP=0x0000000000f2181d
