...
@class NSArray, NSCoder, NSString, UIBarButtonItem, UIBlurEffect, UIDimmingView, UIFocusUpdateContext, UIPopoverController, UIPresentationController, UIResponder, UISplitViewController, UISplitViewControllerDisplayModeBarButtonItem, UITraitCollection, UIView, UIViewController;
...
+ (void)_setModernTVSidebarEnabled:(_Bool)arg1;
+ (_Bool)_modernTVSidebarEnabled;
