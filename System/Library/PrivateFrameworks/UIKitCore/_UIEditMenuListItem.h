...
+ (id)itemWithTitle:(id)arg1;	// IMP=0x0060000000fc182f
+ (id)itemWithMenuElement:(id)arg1 preferredDisplayMode:(unsigned long long)arg2;	// IMP=0x0060000000fc1320
- (void).cxx_destruct;	// IMP=0x0000000000fc1dfc
...
- (id)description;	// IMP=0x0000000000fc196f
- (_Bool)hidesImageForTraitCollection:(id)arg1;	// IMP=0x0000000000fc18ed
- (_Bool)hidesTitleForTraitCollection:(id)arg1;	// IMP=0x0000000000fc1873
