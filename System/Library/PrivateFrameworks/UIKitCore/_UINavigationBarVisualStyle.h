...
+ (id)visualStyleForIdiom:(long long)arg1;	// IMP=0x00600000003b1ccb
...
- (id)_legacyButtonFontForStyle:(long long)arg1;	// IMP=0x00000000003b234a
...
- (id)defaultTitleColorForUserInterfaceStyle:(long long)arg1 barStyle:(long long)arg2;	// IMP=0x00000000003b22e7
- (double)imageButtonMarginInNavigationBar:(id)arg1;	// IMP=0x00000000003b22d2
- (double)textButtonMarginInNavigationBar:(id)arg1;	// IMP=0x00000000003b22bd
- (long long)navigationBar:(id)arg1 metricsForOrientation:(long long)arg2 hasPrompt:(_Bool)arg3;	// IMP=0x00000000003b2293
- (double)leftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x00000000003b21cd
- (_Bool)shouldForceLegacyLeftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x00000000003b21c1
- (id)buttonFontForStyle:(long long)arg1;	// IMP=0x00000000003b2163
...
- (double)barHeightForMetrics:(long long)arg1;	// IMP=0x00000000003b1f46
...
- (double)backButtonAnimationClippingPadding;	// IMP=0x00000000003b1f13
...
- (id)timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2 isInteractive:(_Bool)arg3;	// IMP=0x00000000003b1d98
- (id)initWithIdiom:(long long)arg1;	// IMP=0x00000000003b1d5b
