...
- (void).cxx_destruct;	// IMP=0x00000000009ee2d2
...
- (id)initWithViewController:(id)arg1 containerView:(id)arg2 snapshot:(id)arg3 frame:(struct CGRect)arg4 targetFrame:(struct CGRect)arg5 dimmingAmount:(double)arg6 targetDimmingAmount:(double)arg7;	// IMP=0x00000000009ee151
