...
+ (id)rangeForTextReplacement:(id)arg1 textInput:(id)arg2;	// IMP=0x0060000001436e9e
+ (id)generatorForTextInput:(id)arg1 range:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00600000014368d5
- (void).cxx_destruct;	// IMP=0x000000000143892d
...
- (id)replacements;	// IMP=0x0000000001437f2c
- (void)addSpellingGuessesForString:(id)arg1 ToReplacements:(id)arg2;	// IMP=0x0000000001437927
- (void)addAutocorrectionGuessesToReplacements:(id)arg1;	// IMP=0x000000000143756e
- (void)addPreviouslySuggestedAutocorrectionToReplacements:(id)arg1;	// IMP=0x000000000143738f
- (id)addReplacementRevertingAutocorrectionToReplacements:(id)arg1;	// IMP=0x00000000014371a1
- (_Bool)isStringToReplaceMisspelled;	// IMP=0x0000000001437150
- (_Bool)isStringMisspelled:(id)arg1;	// IMP=0x0000000001437043
- (id)init;	// IMP=0x000000000143688c
