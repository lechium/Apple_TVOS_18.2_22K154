...
- (void).cxx_destruct;	// IMP=0x0000000000bec7e0
...
- (void)dealloc;	// IMP=0x0000000000bec6bd
@property(readonly, copy) NSString *description;
- (void)_invalidate;	// IMP=0x0000000000bec594
- (id)_initWithType:(unsigned long long)arg1 initialState:(_Bool)arg2 reason:(id)arg3 requiresExplicitInvalidation:(_Bool)arg4;	// IMP=0x0000000000bec4fb
