...
+ (id)settingsControllerModule;	// IMP=0x00600000000d42b0
- (void).cxx_destruct;	// IMP=0x00000000000d4470
- (id)initWithDefaultValues;	// IMP=0x00000000000d4400
- (void)setDefaultValues;	// IMP=0x00000000000d4280
