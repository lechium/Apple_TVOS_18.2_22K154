...
- (void).cxx_destruct;	// IMP=0x000000000028bcfc
...
- (void)interactionProgress:(id)arg1 didEnd:(_Bool)arg2;	// IMP=0x000000000028bc90
- (void)interactionProgressDidUpdate:(id)arg1;	// IMP=0x000000000028bc47
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x000000000028baae
