...
- (void).cxx_destruct;	// IMP=0x00000000003547d0
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000035468c
- (void)_setPackage:(id)arg1;	// IMP=0x0000000000353e5f
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000353d4d
