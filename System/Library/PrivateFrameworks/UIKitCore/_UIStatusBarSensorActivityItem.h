...
- (void).cxx_destruct;	// IMP=0x000000000130586d
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000001305630
- (id)viewForIdentifier:(id)arg1;	// IMP=0x000000000130561e
- (void)_create_sensorActivityIndicator;	// IMP=0x00000000013055c4
- (id)dependentEntryKeys;	// IMP=0x000000000130556a
