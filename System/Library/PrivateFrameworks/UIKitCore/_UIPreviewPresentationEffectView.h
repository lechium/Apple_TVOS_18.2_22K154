...
- (void).cxx_destruct;	// IMP=0x0000000000fe561b
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x0000000000fe4f9f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000fe4d77
