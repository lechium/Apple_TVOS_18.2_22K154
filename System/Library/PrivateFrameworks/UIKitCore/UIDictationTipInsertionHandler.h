...
- (void).cxx_destruct;	// IMP=0x00000000016e7b6e
...
- (void)startRecodingText:(id)arg1;	// IMP=0x00000000016e7a80
- (void)resetHandler;	// IMP=0x00000000016e7a3e
- (void)recordDictationTipText:(id)arg1;	// IMP=0x00000000016e7997
- (void)finalizeRecordedText;	// IMP=0x00000000016e7807
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000016e774e
