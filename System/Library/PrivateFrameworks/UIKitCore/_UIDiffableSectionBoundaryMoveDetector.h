...
- (void).cxx_destruct;	// IMP=0x0000000000bbaadc
...
- (id)_computeMovePairsFoundation;	// IMP=0x0000000000bba1b1
- (id)initWithItemDiffer:(id)arg1 beforeDataSourceState:(id)arg2 afterDataSourceState:(id)arg3;	// IMP=0x0000000000bba09a
