...
+ (id)tupleWithRequiredContainerFromEnvironment:(id)arg1;	// IMP=0x0060000000936057
+ (id)tupleWithOwningEnvironment:(id)arg1 itemContainer:(id)arg2;	// IMP=0x0060000000935fe9
- (void).cxx_destruct;	// IMP=0x00000000009365ef
...
- (id)description;	// IMP=0x0000000000936555
- (unsigned long long)hash;	// IMP=0x00000000009364c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000936461
- (_Bool)isEqualToEnvironmentContainerTuple:(id)arg1;	// IMP=0x00000000009360d4
- (id)initWithOwningEnvironment:(id)arg1 itemContainer:(id)arg2;	// IMP=0x0000000000935db5
