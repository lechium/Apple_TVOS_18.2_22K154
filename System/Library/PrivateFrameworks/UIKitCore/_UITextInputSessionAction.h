...
- (void).cxx_destruct;	// IMP=0x00000000013f42ae
...
- (_Bool)isMergeableWith:(id)arg1;	// IMP=0x00000000013f3f8e
- (id)inputModeUniqueString;	// IMP=0x00000000013f3f08
@property(readonly, nonatomic) long long netCharacterCount;
- (void)setRemovedTextLengthWithoutTracking:(unsigned long long)arg1;	// IMP=0x00000000013f3acd
- (void)setInsertedTextLengthWithoutTracking:(unsigned long long)arg1;	// IMP=0x00000000013f3a01
@property(readonly, nonatomic) long long inputActionCount;
- (id)description;	// IMP=0x00000000013f2f11
@property(readonly, nonatomic) _Bool isCapableOfTextInsertion;
@property(readonly, nonatomic) _Bool changedContent;
- (long long)mergeActionIfPossible:(id)arg1;	// IMP=0x00000000013f2ef9
