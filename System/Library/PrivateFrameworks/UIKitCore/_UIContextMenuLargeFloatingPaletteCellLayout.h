...
@class NSArray, NSString, UIColor, UIShape, _UIContextMenuCellContentView, _UIFloatingContentView;
...
- (void).cxx_destruct;	// IMP=0x0000000000ea670c
...
- (void)_configureSharedFloatingContentViewStyleForImageStyle:(_Bool)arg1;	// IMP=0x0000000000ea61e3
- (void)setControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000ea60f1
- (void)removeConstraints;	// IMP=0x0000000000ea6056
- (void)updateConstraints;	// IMP=0x0000000000ea6050
- (void)installConstraints;	// IMP=0x0000000000ea475b
...
- (id)preferredIconFontUsingBoldFont:(_Bool)arg1;	// IMP=0x0000000000ea452f
- (_Bool)allowsHighlightingOnHover;	// IMP=0x0000000000ea4527
...
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000ea43fc
