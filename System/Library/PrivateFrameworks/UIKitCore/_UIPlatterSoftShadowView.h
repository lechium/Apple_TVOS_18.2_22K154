...
- (void).cxx_destruct;	// IMP=0x000000000023150a
...
- (void)_updateForShadowPath;	// IMP=0x0000000000231299
- (id)initWithFrame:(struct CGRect)arg1 shadowPath:(id)arg2;	// IMP=0x0000000000231128
