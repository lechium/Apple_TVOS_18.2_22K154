...
- (void).cxx_destruct;	// IMP=0x00000000015f1762
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000015f14a5
- (void)animationDidStart:(id)arg1;	// IMP=0x00000000015f117c
- (id)initWithLabel:(id)arg1;	// IMP=0x00000000015f1118
