...
- (void).cxx_destruct;	// IMP=0x0000000000fa8779
...
- (void)performReset;	// IMP=0x0000000000fa846a
- (_Bool)isViewAnimating;	// IMP=0x0000000000fa83d1
- (void)reset;	// IMP=0x0000000000fa839a
- (void)animateAutocorrectionAccepted;	// IMP=0x0000000000fa8077
- (void)dismissAutocorrectBubble;	// IMP=0x0000000000fa8018
- (void)didTapAutocorrectionBubble;	// IMP=0x0000000000fa8006
- (id)createTypedTextViewWithTypedText:(id)arg1;	// IMP=0x0000000000fa7c1c
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000fa75ec
- (void)updateBubbleWithAutocorrectionText:(id)arg1 referenceRect:(struct CGRect)arg2;	// IMP=0x0000000000fa7203
- (void)updateFakeTextSelectionHighlightForRect:(struct CGRect)arg1;	// IMP=0x0000000000fa6c42
- (void)updateWithAutocorrectionText:(id)arg1 typedText:(id)arg2 referenceTextView:(id)arg3 referenceRect:(struct CGRect)arg4;	// IMP=0x0000000000fa6b82
- (id)init;	// IMP=0x0000000000fa6b08
