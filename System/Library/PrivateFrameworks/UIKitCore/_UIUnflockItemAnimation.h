...
+ (id)animationWithPlatterView:(id)arg1 destination:(id)arg2 positionReferenceView:(id)arg3 type:(long long)arg4;	// IMP=0x00600000013dbc47
- (void).cxx_destruct;	// IMP=0x00000000013dcfe9
...
- (void)complete;	// IMP=0x00000000013dceb2
- (void)play;	// IMP=0x00000000013dbded
