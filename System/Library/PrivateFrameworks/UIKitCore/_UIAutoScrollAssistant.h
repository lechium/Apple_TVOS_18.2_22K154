...
- (void).cxx_destruct;	// IMP=0x000000000166fcb6
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x000000000166fb8b
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x000000000166fafe
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x000000000166fa88
- (void)displayLinkFired:(id)arg1;	// IMP=0x000000000166f898
- (_Bool)_scrollContinuous;	// IMP=0x000000000166f82a
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x000000000166f781
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x000000000166f505
- (id)initWithScrollView:(id)arg1;	// IMP=0x000000000166f3bd
