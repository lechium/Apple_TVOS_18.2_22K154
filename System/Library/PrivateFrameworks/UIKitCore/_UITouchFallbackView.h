...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000028c406
- (int)textEffectsVisibilityLevel;	// IMP=0x000000000028c3fb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000028c35a
