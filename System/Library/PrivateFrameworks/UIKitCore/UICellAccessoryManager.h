...
- (void).cxx_destruct;	// IMP=0x00000000012eda3f
...
- (id)description;	// IMP=0x00000000012ed8c1
- (void)performWithEnforcedContainerSize:(struct CGSize)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000000012ed88e
- (struct CGRect)containerBounds;	// IMP=0x00000000012ed858
@property(readonly, nonatomic) struct CGSize containerSize;
@property(readonly, nonatomic) struct CGRect contentFrame;
- (void)layoutIfNeeded;	// IMP=0x00000000012ed676
- (void)setNeedsLayout;	// IMP=0x00000000012ed641
- (struct CGRect)_updateAccessories:(id)arg1 previousAccessories:(id)arg2 withLayout:(id)arg3 edge:(unsigned long long)arg4;	// IMP=0x00000000012ec3c5
- (void)_updateFromPreviousConfiguration:(id)arg1;	// IMP=0x00000000012ec008
@property(readonly, nonatomic) UICellAccessoryConfiguration *currentConfiguration;
- (id)_configurationWithIdentifier:(id)arg1;	// IMP=0x00000000012ebfb9
- (void)updateContainerView:(id)arg1;	// IMP=0x00000000012ebe35
- (id)initWithContainerView:(id)arg1;	// IMP=0x00000000012ebda7
