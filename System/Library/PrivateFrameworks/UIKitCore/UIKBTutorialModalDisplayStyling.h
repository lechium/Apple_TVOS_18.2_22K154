...
- (void).cxx_destruct;	// IMP=0x0000000000a5cd05
...
- (id)backgroundBlurEffects:(long long)arg1;	// IMP=0x0000000000a5cc04
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000a5cb0a
