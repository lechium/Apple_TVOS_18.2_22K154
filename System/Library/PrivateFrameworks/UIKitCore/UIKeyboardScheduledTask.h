...
- (void).cxx_destruct;	// IMP=0x0000000000e825f5
...
- (void)resetTimer;	// IMP=0x0000000000e82340
- (void)invalidate;	// IMP=0x0000000000e82280
- (_Bool)isValid;	// IMP=0x0000000000e821cb
- (void)handleDeferredTimerFiredEvent;	// IMP=0x0000000000e81f27
- (void)timerFired:(id)arg1;	// IMP=0x0000000000e81e57
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4 breadcrumb:(CDUnknownBlockType)arg5;	// IMP=0x0000000000e81cc2
- (void)dealloc;	// IMP=0x0000000000e81c67
