...
- (void).cxx_destruct;	// IMP=0x00000000006442cb
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000064422d
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000006441d5
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000643157
- (void)start;	// IMP=0x0000000000643143
...
- (id)description;	// IMP=0x000000000064305f
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x0000000000642dd9
