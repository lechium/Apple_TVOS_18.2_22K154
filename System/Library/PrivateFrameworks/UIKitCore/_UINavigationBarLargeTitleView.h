...
- (void).cxx_destruct;	// IMP=0x00000000003cfc24
...
- (void)adoptNewLayout;	// IMP=0x00000000003cfad8
- (void)adoptLayout:(id)arg1;	// IMP=0x00000000003cf9dc
- (void)clearTransitionContext;	// IMP=0x00000000003cf973
- (void)finalizeStateFromTransition:(id)arg1;	// IMP=0x00000000003cf96d
- (void)ensureBackButtonTruncationOccursWithContext:(id)arg1;	// IMP=0x00000000003cf967
- (void)recordToStateForTransition:(id)arg1;	// IMP=0x00000000003cf8cc
- (void)prepareToRecordToState:(id)arg1;	// IMP=0x00000000003cf84a
- (void)recordFromStateForTransition:(id)arg1;	// IMP=0x00000000003cf7a9
- (void)_clearAssistants;	// IMP=0x00000000003cf7a3
- (void)_setAssistants;	// IMP=0x00000000003cf79d
- (void)_contentSizeCategoryDidChange;	// IMP=0x00000000003cf760
- (void)updateContent;	// IMP=0x00000000003cf749
- (void)_updateContentAndInvalidate:(_Bool)arg1;	// IMP=0x00000000003cf44a
- (void)safeAreaInsetsDidChange;	// IMP=0x00000000003cf31b
- (id)_effectiveTitle;	// IMP=0x00000000003cf2ad
- (id)_titleForCurrentWidth;	// IMP=0x00000000003cec51
- (void)layoutSubviews;	// IMP=0x00000000003ceb61
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003ceb44
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 titleType:(long long)arg2;	// IMP=0x00000000003ceacc
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000003cea7b
@property(readonly, nonatomic) double restingHeightOfTitleView;
- (id)_layoutForMeasurement;	// IMP=0x00000000003ce9ab
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003ce4f3
- (id)_newLayout;	// IMP=0x00000000003ce4c5
