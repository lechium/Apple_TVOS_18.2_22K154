...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4 isDictationCommandReplacement:(_Bool)arg5;	// IMP=0x00600000014360f7
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x00600000014360d5
- (void).cxx_destruct;	// IMP=0x0000000001436456
...
- (_Bool)_isNoReplacementsFoundItem;	// IMP=0x00000000014363ae
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x00000000014361cb
