...
@class NSArray, NSHashTable, NSMutableArray, NSString, UIFocusSystem, _UIFocusMapRect, _UIFocusMapSnapshotDebugInfo, _UIFocusMovementInfo, _UIFocusRegion, _UIFocusSearchInfo;
...
@interface _UIFocusMapSnapshot : NSObject
{
    ...
    NSHashTable *_visitedRegionContainers;	// 96 = 0x60
    struct {
...
- (void).cxx_destruct;	// IMP=0x000000000097c1a9
...
- (void)addRegionsInContainers:(id)arg1;	// IMP=0x000000000097bf34
- (void)addRegionsInContainer:(id)arg1;	// IMP=0x000000000097a825
- (void)addRegions:(id)arg1;	// IMP=0x000000000097a65e
- (void)addRegion:(id)arg1;	// IMP=0x000000000097a19a
- (id)searchArea;	// IMP=0x000000000097a188
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
- (void)_capture;	// IMP=0x0000000000979eee
@property(readonly, nonatomic) _Bool hasOnlyStaticContent;
- (void)markContainerAsProvidingDynamicContent;	// IMP=0x0000000000979d75
- (struct CGRect)snapshotFrameForRegion:(id)arg1;	// IMP=0x0000000000979c38
- (id)_cachedNextFocusedItemForRegion:(id)arg1 withFocusMovementRequest:(id)arg2 inMap:(id)arg3;	// IMP=0x0000000000979a28
- (void)consumeRegionInformationForRegions:(id)arg1 fromSnapshot:(id)arg2;	// IMP=0x0000000000979819
- (id)occludingRegionsForRegion:(id)arg1;	// IMP=0x0000000000979702
- (void)_trackOccludingRegion:(id)arg1 forRegion:(id)arg2;	// IMP=0x000000000097963e
- (id)originalRegionForRegion:(id)arg1;	// IMP=0x0000000000979516
- (void)_trackSubregion:(id)arg1 forRegion:(id)arg2;	// IMP=0x000000000097935c
- (id)regionsForOriginalRegion:(id)arg1;	// IMP=0x00000000009790de
@property(readonly, copy, nonatomic) NSArray *originalRegions;
@property(readonly, copy, nonatomic) NSArray *regions;
- (void)dealloc;	// IMP=0x0000000000978b41
- (id)_initWithSnapshotter:(id)arg1 mapArea:(id)arg2 searchArea:(id)arg3;	// IMP=0x00000000009786e0
- (id)init;	// IMP=0x0000000000978659
- (id)_debugInfoWithFocusMapSearchInfo:(id)arg1;	// IMP=0x0000000000947172
@property(readonly, nonatomic, getter=_debugInfo) _UIFocusMapSnapshotDebugInfo *debugInfo;
- (id)debugQuickLookObject;	// IMP=0x00000000009470ad
