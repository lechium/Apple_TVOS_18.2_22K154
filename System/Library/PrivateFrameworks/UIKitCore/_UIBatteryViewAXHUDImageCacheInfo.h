...
- (void).cxx_destruct;	// IMP=0x00000000007b9487
...
- (_Bool)cacheMatchesCapacity:(double)arg1 fillColor:(id)arg2 tintColor:(id)arg3 showingBolt:(_Bool)arg4 reverseLayout:(_Bool)arg5 scale:(double)arg6 showsPercentage:(_Bool)arg7 contentSizeCategory:(id)arg8;	// IMP=0x00000000007b91e7
