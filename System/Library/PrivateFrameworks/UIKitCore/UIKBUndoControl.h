...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x0060000000f7b040
- (void).cxx_destruct;	// IMP=0x0000000000f7be2a
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000f7bc9e
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000f7bc89
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f7bc16
- (unsigned int)_secureName;	// IMP=0x0000000000f7bbfc
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000f7b13c
- (id)controlImageByType:(long long)arg1;	// IMP=0x0000000000f7afcc
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000f7af46
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000f7abc5
- (void)updateUndoControlStyle;	// IMP=0x0000000000f7a81d
- (void)layoutSubviews;	// IMP=0x0000000000f7a719
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000f7a37b
