...
- (void).cxx_destruct;	// IMP=0x000000000086948c
...
- (void)presentedItemDidMoveToURL:(id)arg1;	// IMP=0x00000000008693da
- (void)presentedItemDidChange;	// IMP=0x00000000008693a0
- (void)stopObserving;	// IMP=0x00000000008692e4
- (void)startObservingWithChangeHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000869198
@property(readonly, nonatomic, getter=isObserving) _Bool observing;
- (id)initWithFileURL:(id)arg1;	// IMP=0x0000000000869055
