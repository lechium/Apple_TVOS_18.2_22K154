...
- (void).cxx_destruct;	// IMP=0x0000000000823023
...
- (id)initWithClippingView:(id)arg1 visibleBounds:(struct CGRect)arg2 ignoresResult:(_Bool)arg3 edgesClipped:(unsigned long long)arg4;	// IMP=0x0000000000822efb
