...
+ (id)textDisplayIdentifier;	// IMP=0x00100000011a4eab
- (void).cxx_destruct;	// IMP=0x00000000011a632f
...
- (id)viewForIdentifier:(id)arg1;	// IMP=0x00000000011a61b8
- (void)_create_stringView;	// IMP=0x00000000011a6140
- (void)_create_lockView;	// IMP=0x00000000011a60af
- (id)removalAnimationForDisplayItemWithIdentifier:(id)arg1;	// IMP=0x00000000011a5f7f
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x00000000011a5e94
- (id)additionAnimationForDisplayItemWithIdentifier:(id)arg1;	// IMP=0x00000000011a5712
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x00000000011a4f8e
- (_Bool)canEnableDisplayItem:(id)arg1 fromData:(id)arg2;	// IMP=0x00000000011a4ee7
- (id)dependentEntryKeys;	// IMP=0x00000000011a4ec4
