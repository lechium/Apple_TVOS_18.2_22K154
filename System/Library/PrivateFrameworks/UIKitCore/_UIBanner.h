...
- (void).cxx_destruct;	// IMP=0x0000000001168046
...
- (void)addTapHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000001167ed1
- (void)addDismissalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000001167e54
- (void)addDismissalAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000001167dd7
- (void)dismiss;	// IMP=0x0000000001167be8
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x0000000001167964
- (void)present;	// IMP=0x00000000011677c9
