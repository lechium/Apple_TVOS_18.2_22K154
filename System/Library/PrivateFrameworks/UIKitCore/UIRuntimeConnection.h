...
- (void).cxx_destruct;	// IMP=0x0000000000ba2b66
...
- (void)connectForSimulator;	// IMP=0x0000000000ba2b11
- (void)connect;	// IMP=0x0000000000ba2b0b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000ba2a88
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000ba29ba
