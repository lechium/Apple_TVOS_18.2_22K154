...
- (void).cxx_destruct;	// IMP=0x0000000000395abf
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x000000000039596c
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000003958be
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x00000000003957fc
