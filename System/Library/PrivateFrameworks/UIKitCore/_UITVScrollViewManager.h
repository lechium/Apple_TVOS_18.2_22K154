...
- (void).cxx_destruct;	// IMP=0x0000000000af3bce
...
- (void)_observeScrollViewDidScroll:(id)arg1;	// IMP=0x0000000000af391e
- (id)_customScrollingMaskForScrollView:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000000af379e
- (void)_removeScreenshotViewIfNeeded;	// IMP=0x0000000000af3750
- (void)_scroll:(id)arg1 toContentOffset:(struct CGPoint)arg2;	// IMP=0x0000000000af3377
- (void)_scrollAnimationDidEnd:(id)arg1;	// IMP=0x0000000000af3286
- (void)_tearDown:(id)arg1;	// IMP=0x0000000000af3205
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000af2e9a
- (void)dealloc;	// IMP=0x0000000000af2d30
- (id)initWithScrollView:(id)arg1 scrollStyle:(long long)arg2;	// IMP=0x0000000000af2bb7
