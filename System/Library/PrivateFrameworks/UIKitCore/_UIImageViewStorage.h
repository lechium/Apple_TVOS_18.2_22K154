...
+ (id)storageForImageView:(id)arg1;	// IMP=0x0010000000fdab46
- (void).cxx_destruct;	// IMP=0x0000000000fdbc20
...
- (id)extendedStorage;	// IMP=0x0000000000fdabe5
- (id)simpleStorage;	// IMP=0x0000000000fdab88
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000fdbc46
