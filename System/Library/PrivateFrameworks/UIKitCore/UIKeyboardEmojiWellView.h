...
- (void).cxx_destruct;	// IMP=0x0000000000dec98d
...
- (void)dragWillBegin:(id)arg1;	// IMP=0x0000000000dec841
- (void)layoutSubviews;	// IMP=0x0000000000dec39d
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x0000000000deb804
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x0000000000deb6b3
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000deb1bd
