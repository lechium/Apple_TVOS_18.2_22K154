...
- (void).cxx_destruct;	// IMP=0x0000000000938b32
...
- (void)_reportInferredPreferredFocusEnvironment:(id)arg1;	// IMP=0x0000000000938959
- (void)_stopLogging;	// IMP=0x000000000093893f
- (id)_startLogging;	// IMP=0x000000000093864d
- (void)popEnvironment;	// IMP=0x0000000000938532
- (void)pushEnvironment:(id)arg1;	// IMP=0x00000000009382e5
- (_Bool)_isAllowedToPreferEnvironment:(id)arg1;	// IMP=0x000000000093808f
- (id)_inferPreferencesForEnvironment:(id)arg1;	// IMP=0x0000000000937ee0
- (void)_resolvePreferredFocusEnvironments;	// IMP=0x0000000000937a94
- (void)_invalidatePreferredEnvironments;	// IMP=0x0000000000937a6a
...
- (id)initWithFocusEnvironment:(id)arg1 enumerationMode:(long long)arg2;	// IMP=0x00000000009373f3
- (id)init;	// IMP=0x000000000093736c
