...
- (void).cxx_destruct;	// IMP=0x0000000001167754
...
- (void)setHighlighted:(_Bool)arg1 initialPress:(_Bool)arg2;	// IMP=0x0000000001167545
- (void)layoutSubviews;	// IMP=0x0000000001167276
- (void)updateConstraints;	// IMP=0x0000000001166ca4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000011667b4
