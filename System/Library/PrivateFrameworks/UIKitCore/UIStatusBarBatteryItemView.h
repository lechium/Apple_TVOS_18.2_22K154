...
- (void).cxx_destruct;	// IMP=0x000000000116d724
...
- (id)accessibilityHUDRepresentation;	// IMP=0x000000000116d386
- (double)legibilityStrength;	// IMP=0x000000000116d378
- (void)_updateAccessoryImage;	// IMP=0x000000000116cf79
- (double)extraRightPadding;	// IMP=0x000000000116cefc
- (id)contentsImage;	// IMP=0x000000000116ce84
- (id)_contentsImage;	// IMP=0x000000000116c986
- (id)_accessoryImage;	// IMP=0x000000000116c92f
- (_Bool)_needsAccessoryImage;	// IMP=0x000000000116c91b
- (struct CGSize)_batteryOffsetWithBackground:(id)arg1;	// IMP=0x000000000116c830
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x000000000116c793
