...
+ (id)stateWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x006000000097c325
- (void).cxx_destruct;	// IMP=0x000000000097c3d8
...
- (id)initWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x000000000097c277
