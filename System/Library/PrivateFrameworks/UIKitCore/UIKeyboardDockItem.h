...
+ (id)_darkStyleGlyphColor;	// IMP=0x0060000000e394d0
+ (id)_standardGlyphColor;	// IMP=0x0060000000e39497
- (void).cxx_destruct;	// IMP=0x0000000000e39d65
...
- (void)setTitle:(id)arg1 image:(id)arg2;	// IMP=0x0000000000e39b16
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e395a1
- (id)initWithTitle:(id)arg1 image:(id)arg2 identifier:(id)arg3;	// IMP=0x0000000000e394e9
