...
+ (id)defaultConfiguration;	// IMP=0x0060000000bed488
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bed731
- (id)description;	// IMP=0x0000000000bed640
- (unsigned long long)hash;	// IMP=0x0000000000bed508
