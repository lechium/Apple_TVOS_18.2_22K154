...
- (void).cxx_destruct;	// IMP=0x0000000000ace1cc
...
- (unsigned long long)_targetEdges;	// IMP=0x0000000000ace053
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x0000000000acdf0a
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x0000000000acde10
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000acd095
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000acc8ac
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000acc81c
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x0000000000acc78c
- (long long)_type;	// IMP=0x0000000000acc77f
- (void)_setState:(long long)arg1;	// IMP=0x0000000000acc58b
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x0000000000acc4f6
- (void)dealloc;	// IMP=0x0000000000acc4ba
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000acc45b
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x0000000000acc27a
