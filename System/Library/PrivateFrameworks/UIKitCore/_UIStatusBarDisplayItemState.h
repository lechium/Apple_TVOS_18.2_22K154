...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x001000000124e1b7
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x001000000124d9fb
- (void).cxx_destruct;	// IMP=0x00000000012518d2
...
- (id)description;	// IMP=0x000000000125143e
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x00000000012510a4
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000001250b61
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x00000000012508ea
- (void)_cancelObsoleteAnimations;	// IMP=0x00000000012506f3
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x00000000012501d2
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x000000000124ffb2
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x000000000124fcf4
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x000000000124f5c8
- (_Bool)updatePlacement;	// IMP=0x000000000124f4eb
- (void)resetToPreferredPlacement;	// IMP=0x000000000124f4d5
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000124f34a
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000124f0a8
- (void)_updateStatuses;	// IMP=0x000000000124efc6
- (void)prepareForDataUpdate;	// IMP=0x000000000124efaf
- (void)prepareForOverflowDataUpdate;	// IMP=0x000000000124ef99
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x000000000124dff2
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x000000000124de0e
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x000000000124dd81
- (void)updateToNextEnabledPlacement;	// IMP=0x000000000124dd4a
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x000000000124dcc6
