...
+ (id)_proxyWithResponder:(id)arg1;	// IMP=0x00600000013e860d
- (void).cxx_destruct;	// IMP=0x00000000013e872f
...
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x00000000013e866e
- (id)nextResponder;	// IMP=0x00000000013e8655
