...
- (void).cxx_destruct;	// IMP=0x0000000000a9c831
- (void)removeGestureRecognizer:(id)arg1;	// IMP=0x0000000000a98ef2
- (void)addGestureRecognizer:(id)arg1;	// IMP=0x0000000000a98c0d
- (void)dealloc;	// IMP=0x0000000000a98128
- (id)init;	// IMP=0x0000000000a97a0a
