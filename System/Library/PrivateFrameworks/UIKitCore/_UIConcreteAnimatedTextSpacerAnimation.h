...
- (void).cxx_destruct;	// IMP=0x0000000000b6c83f
...
- (void)finalize;	// IMP=0x0000000000b6c7d3
- (id)initWithAnimationInfo:(id)arg1 updateBlock:(CDUnknownBlockType)arg2 finalizeBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000b6c681
