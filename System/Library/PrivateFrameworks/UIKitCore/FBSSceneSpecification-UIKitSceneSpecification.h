...
- (id)disconnectionHandlers;	// IMP=0x0030000000a314c2
- (id)connectionHandlers;	// IMP=0x0030000000a314b5
...
- (id)coreSceneComponentClassDictionary;	// IMP=0x0030000000a31487
- (id)_transitionContextHandlers;	// IMP=0x0030000000a3147a
