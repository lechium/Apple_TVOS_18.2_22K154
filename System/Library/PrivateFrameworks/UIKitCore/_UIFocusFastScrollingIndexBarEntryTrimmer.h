...
- (void).cxx_destruct;	// IMP=0x000000000099e28d
...
- (id)_trimEntries:(id)arg1 toFitCount:(long long)arg2;	// IMP=0x000000000099dec5
- (id)entriesTrimmedToFitCount:(unsigned long long)arg1;	// IMP=0x000000000099da9d
