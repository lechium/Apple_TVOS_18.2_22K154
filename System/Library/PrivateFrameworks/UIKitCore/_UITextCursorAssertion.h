...
- (void).cxx_destruct;	// IMP=0x00000000012fda9e
...
- (void)invalidate;	// IMP=0x00000000012fd97a
- (void)dealloc;	// IMP=0x00000000012fd93c
- (id)_initWithReason:(id)arg1 options:(unsigned long long)arg2 controller:(id)arg3 userInfo:(id)arg4;	// IMP=0x00000000012fd870
