...
+ (id)touchStateTaskForTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x0010000000e6dbf9
- (void).cxx_destruct;	// IMP=0x0000000000e6de9f
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000e6dd63
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e6dd16
- (id)initWithTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x0000000000e6dc6b
