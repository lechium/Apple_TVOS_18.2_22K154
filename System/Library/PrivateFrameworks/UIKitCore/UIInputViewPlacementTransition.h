...
+ (id)transitionForExistingPlacement:(id)arg1 animationStyle:(id)arg2;	// IMP=0x0060000000def2fe
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x0060000000def24a
- (void).cxx_destruct;	// IMP=0x0000000000def5af
...
- (void)dealloc;	// IMP=0x0000000000def488
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x0000000000def39e
