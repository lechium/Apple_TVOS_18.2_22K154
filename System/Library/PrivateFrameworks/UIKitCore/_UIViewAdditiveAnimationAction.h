...
- (void).cxx_destruct;	// IMP=0x0000000001698e61
...
- (void)runActionForKey:(id)arg1 object:(id)arg2 arguments:(id)arg3;	// IMP=0x00000000016978c6
- (id)initWithPendingAnimation:(id)arg1 withAnimationObject:(id)arg2 forView:(id)arg3;	// IMP=0x00000000016977fd
