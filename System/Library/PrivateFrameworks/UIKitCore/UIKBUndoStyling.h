...
- (void).cxx_destruct;	// IMP=0x0000000000f7a306
...
- (void)createDynamicColors;	// IMP=0x0000000000f79e1f
- (id)vibrancyEffectForBlur:(id)arg1;	// IMP=0x0000000000f79e06
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000f79d32
