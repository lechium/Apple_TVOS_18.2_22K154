...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x0000000000eead55
- (void)reset;	// IMP=0x0000000000eead0f
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x0000000000eeaccd
