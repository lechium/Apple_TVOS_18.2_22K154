...
- (void).cxx_destruct;	// IMP=0x0000000000ba6e39
...
- (void)_configureSharedFloatingContentViewStyle;	// IMP=0x0000000000ba68fd
- (void)setControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000ba6882
- (void)removeConstraints;	// IMP=0x0000000000ba67e7
- (void)updateConstraints;	// IMP=0x0000000000ba67e1
- (void)installConstraints;	// IMP=0x0000000000ba5be2
...
- (id)preferredIconFontUsingBoldFont:(_Bool)arg1;	// IMP=0x0000000000ba5a4d
- (_Bool)allowsHighlightingOnHover;	// IMP=0x0000000000ba5a45
...
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000ba597e
