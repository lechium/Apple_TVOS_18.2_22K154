...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0060000000e84320
- (void).cxx_destruct;	// IMP=0x0000000000e844c4
...
- (void)dealloc;	// IMP=0x0000000000e843bd
