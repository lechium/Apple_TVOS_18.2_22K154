...
+ (_Bool)_isSubstringArray:(id)arg1 equalToSubstringArray:(id)arg2;	// IMP=0x0060000000da0c51
+ (id)_prepareAllWordsWithString:(id)arg1 reverse:(_Bool)arg2;	// IMP=0x0060000000da0a3b
- (void).cxx_destruct;	// IMP=0x0000000000da1532
...
- (struct _NSRange)rangeOfSubstring:(id)arg1 fullString:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x0000000000da13ae
- (struct _NSRange)_search;	// IMP=0x0000000000da1058
- (_Bool)validateWordBoundariesInRange:(struct _NSRange)arg1;	// IMP=0x0000000000da0ddc
- (id)initWithString:(id)arg1 substring:(id)arg2 reverse:(_Bool)arg3;	// IMP=0x0000000000da08f2
