...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0010000000965f00
- (void).cxx_destruct;	// IMP=0x0000000000966d28
...
- (id)takeSnapshot;	// IMP=0x0000000000966170
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000096604d
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0000000000965f6e
