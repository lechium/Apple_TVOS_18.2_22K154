...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x0010000000450a0f
- (void).cxx_destruct;	// IMP=0x0000000000450afb
...
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x0000000000450a5c
