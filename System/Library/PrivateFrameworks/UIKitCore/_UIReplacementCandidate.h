...
+ (id)candidateForDocumentText:(id)arg1 revertText:(id)arg2 candidateChoices:(id)arg3 range:(id)arg4 underlineStyle:(long long)arg5 promptStyle:(long long)arg6 promptButton:(long long)arg7;	// IMP=0x00600000009c4fd6
+ (id)candidateForDocumentText:(id)arg1 revertText:(id)arg2 textChoices:(id)arg3 range:(id)arg4 underlineStyle:(long long)arg5 promptStyle:(long long)arg6 promptButton:(long long)arg7 voiceCommandDisambiguationSelectedIndex:(id)arg8 voiceCommandDisambiguationTargetCount:(id)arg9;	// IMP=0x00600000009c4c09
+ (id)candidateForDocumentText:(id)arg1 revertText:(id)arg2 textChoices:(id)arg3 range:(id)arg4 underlineStyle:(long long)arg5 promptStyle:(long long)arg6 promptButton:(long long)arg7;	// IMP=0x00600000009c4bd5
+ (id)candidateForAutocorrection:(id)arg1 range:(id)arg2 underlineStyle:(long long)arg3 promptStyle:(long long)arg4 promptButton:(long long)arg5;	// IMP=0x00600000009c4aaf
+ (id)candidateForAutocorrectionCandidate:(id)arg1 range:(id)arg2;	// IMP=0x00600000009c499f
- (void).cxx_destruct;	// IMP=0x00000000009c552d
...
- (id)initWithText:(id)arg1;	// IMP=0x00000000009c4934
