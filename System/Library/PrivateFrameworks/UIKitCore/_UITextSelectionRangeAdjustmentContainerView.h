...
- (void).cxx_destruct;	// IMP=0x0000000000b9f0d9
...
- (void)layoutSubviews;	// IMP=0x0000000000b9eaba
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000b9eab2
- (void)_getBounds:(out struct CGRect *)arg1 position:(out struct CGPoint *)arg2 fromPreferredFrame:(struct CGRect)arg3;	// IMP=0x0000000000b9ea28
- (void)_setPortalsLollipopDotsToContainerWindow:(_Bool)arg1;	// IMP=0x0000000000b9e8db
- (void)setHidden:(_Bool)arg1;	// IMP=0x0000000000b9e88c
- (id)textInputView;	// IMP=0x0000000000b9e83c
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000b9e28f
