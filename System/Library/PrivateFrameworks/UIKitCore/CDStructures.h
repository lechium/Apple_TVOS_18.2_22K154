...
@class CADisplay, CADynamicFrameRateSource, NSMutableDictionary, NSMutableSet, NSString, UIImage, _UICommandIdentifierDictionary;
...
struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>*[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>*>>> {
    struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>**, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>*>>> {
        void **__value_;
        struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>*>> {
            struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>*>> {
                unsigned long long __value_;
            } __data_;
        } __value_;
    } __ptr_;
...
struct unordered_map<void (*)(), _UITrackedTraitUsageRecord, std::hash<void (*)()>, std::equal_to<void (*)()>, std::allocator<std::pair<void (*const)(), _UITrackedTraitUsageRecord>>> {
    struct __hash_table<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, std::__unordered_map_hasher<void (*)(), std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, std::hash<void (*)()>, std::equal_to<void (*)()>>, std::__unordered_map_equal<void (*)(), std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, std::equal_to<void (*)()>, std::hash<void (*)()>>, std::allocator<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>>> {
        ...
        struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*>, std::allocator<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>>> {
            struct __hash_node_base<std::__hash_node<std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, void *>*> {
                void *__next_;
            } __value_;
        } __p1_;
        struct __compressed_pair<unsigned long, std::__unordered_map_hasher<void (*)(), std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, std::hash<void (*)()>, std::equal_to<void (*)()>>> {
            unsigned long long __value_;
        } __p2_;
        struct __compressed_pair<float, std::__unordered_map_equal<void (*)(), std::__hash_value_type<void (*)(), _UITrackedTraitUsageRecord>, std::equal_to<void (*)()>, std::hash<void (*)()>>> {
            float __value_;
        } __p3_;
    } __table_;
};
