...
- (void).cxx_destruct;	// IMP=0x00000000015aab50
...
- (double)customSpacingAfterItem:(id)arg1;	// IMP=0x00000000015aa9d3
- (void)setCustomSpacing:(double)arg1 afterItem:(id)arg2;	// IMP=0x00000000015aa90c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000015aa7d6
