...
+ (double)lockSlideAnimationDuration;	// IMP=0x0010000001183d49
- (void).cxx_destruct;	// IMP=0x0000000001186c54
...
- (id)accessibilityHUDRepresentation;	// IMP=0x0000000001186a0e
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000011869fc
- (void)jiggleCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000118681c
- (void)animateUnlockForegroundView:(id)arg1 timeItemSnapshot:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000001184557
- (void)setVisible:(_Bool)arg1 frame:(struct CGRect)arg2 duration:(double)arg3;	// IMP=0x0000000001184116
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000001184097
- (double)updateContentsAndWidth;	// IMP=0x0000000001183ed1
- (_Bool)_isAnimating;	// IMP=0x0000000001183ebd
- (void)_endAnimation;	// IMP=0x0000000001183d79
- (void)_beginAnimation;	// IMP=0x0000000001183d69
- (_Bool)isExclusive;	// IMP=0x0000000001183d57
