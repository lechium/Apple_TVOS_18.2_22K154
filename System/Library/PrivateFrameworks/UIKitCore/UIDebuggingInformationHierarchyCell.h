...
- (void).cxx_destruct;	// IMP=0x0000000001512993
...
- (void)prepareForReuse;	// IMP=0x00000000015128c2
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000001512836
@property(readonly, nonatomic) NSIndexPath *indexPath;
@property(readonly, nonatomic) UIButton *infoButton;
- (void)displayDetailsForCell;	// IMP=0x000000000151276c
- (void)deliverToggle;	// IMP=0x00000000015126f5
- (void)layoutSubviews;	// IMP=0x000000000151197e
