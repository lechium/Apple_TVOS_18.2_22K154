...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000015a0f25
+ (id)descriptionForTransitionCoordinatorContext:(id)arg1;	// IMP=0x00100000015a0dac
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000015a1105
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000015a0f2d
