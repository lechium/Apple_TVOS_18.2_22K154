...
- (void).cxx_destruct;	// IMP=0x0000000000811d1e
...
- (_Bool)_hasTitle;	// IMP=0x0000000000811bbc
- (void)setControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000811bb6
- (void)removeConstraints;	// IMP=0x0000000000811b4f
- (void)updateConstraints;	// IMP=0x0000000000811869
- (void)installConstraints;	// IMP=0x0000000000810db2
...
- (id)preferredIconFontUsingBoldFont:(_Bool)arg1;	// IMP=0x0000000000810c7e
...
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000810bb4
