...
+ (id)contextWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x0010000000824cc2
- (void).cxx_destruct;	// IMP=0x0000000000824dc8
...
- (void)dealloc;	// IMP=0x0000000000824bc7
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x0000000000824005
