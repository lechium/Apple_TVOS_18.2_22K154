...
- (id)voiceCommandButtonTapDuration;	// IMP=0x0000000000d6ab2c
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000d6aaa1
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000d6aa16
- (void)reset;	// IMP=0x0000000000d6a9cd
