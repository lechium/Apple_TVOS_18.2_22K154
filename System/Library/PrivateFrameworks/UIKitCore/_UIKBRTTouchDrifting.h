...
+ (_Bool)isEnabled;	// IMP=0x0060000000ee5406
- (void).cxx_destruct;	// IMP=0x0000000000eea8b6
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x0000000000eea1b6
- (void)_updateDriftView;	// IMP=0x0000000000ee8954
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x0000000000ee8871
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x0000000000ee8863
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x0000000000ee8855
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x0000000000ee7deb
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x0000000000ee73f3
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x0000000000ee6fb6
- (void)_updateHistory;	// IMP=0x0000000000ee6f6d
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x0000000000ee6bc6
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x0000000000ee68db
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x0000000000ee64e3
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x0000000000ee623b
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x0000000000ee5fd8
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x0000000000ee5cb9
- (void)reset;	// IMP=0x0000000000ee5a66
- (void)_resetFeedback;	// IMP=0x0000000000ee599d
- (void)dealloc;	// IMP=0x0000000000ee595f
- (id)initWithParentView:(id)arg1;	// IMP=0x0000000000ee590e
- (id)init;	// IMP=0x0000000000ee5432
