...
- (id)description;	// IMP=0x0000000000418a24
- (void)invalidateLayout;	// IMP=0x0000000000418a1a
@property(readonly, nonatomic, getter=isLayoutValid) _Bool layoutValid;
- (void)updateLayoutIfNeeded;	// IMP=0x00000000004189e7
- (void)updateLayout;	// IMP=0x00000000004189e1
- (void)applyLayout;	// IMP=0x00000000004189db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004188a8
