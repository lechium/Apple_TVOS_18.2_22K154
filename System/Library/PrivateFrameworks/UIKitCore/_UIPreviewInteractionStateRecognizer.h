...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000fe85e0
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000fe85b3
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000fe8582
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000fe8519
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000fe8507
- (void)reset;	// IMP=0x0000000000fe830c
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000fe7f49
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000fe7e1a
- (id)description;	// IMP=0x0000000000fe7d47
- (void)dealloc;	// IMP=0x0000000000fe7cc5
- (id)init;	// IMP=0x0000000000fe7bb3
