...
- (void).cxx_destruct;	// IMP=0x0000000000da08e2
@property(nonatomic) struct _NSRange enclosingRange; // @synthesize enclosingRange=_enclosingRange;
@property(nonatomic) struct _NSRange range; // @synthesize range=_range;
@property(retain, nonatomic) NSString *string; // @synthesize string=_string;
- (id)initWithString:(id)arg1 range:(struct _NSRange)arg2 enclosingRange:(struct _NSRange)arg3;	// IMP=0x0000000000da0802
