...
+ (id)settingsControllerModule;	// IMP=0x0060000000acb358
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x0060000000acb338
...
- (void)setDefaultValues;	// IMP=0x0000000000acb183
