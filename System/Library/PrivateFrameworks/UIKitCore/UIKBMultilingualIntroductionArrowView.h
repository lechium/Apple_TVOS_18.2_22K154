...
- (void).cxx_destruct;	// IMP=0x000000000105f11e
...
- (void)_updatePath;	// IMP=0x000000000105ee83
- (void)setStartPoint:(struct CGPoint)arg1 endPoint:(struct CGPoint)arg2;	// IMP=0x000000000105ee4d
- (id)init;	// IMP=0x000000000105ebfd
