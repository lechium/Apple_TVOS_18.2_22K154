...
@interface UIKeyboardCandidateViewStyle : NSObject
{
    ...
    _Bool _showCellBorderForSpaceConfirmationCandidate;	// 25 = 0x19
    _Bool _performScalingAnimationOnCellHighlight;	// 26 = 0x1a
    _Bool _arrowButtonHighlightBackgroundHidden;	// 27 = 0x1b
    _Bool _hideLinesOnDisambiguationGridEdges;	// 28 = 0x1c
    _Bool _maximizeSortControlWidthWithPadding;	// 29 = 0x1d
    _Bool _applyCornerRadiusToAllCandidates;	// 30 = 0x1e
    _Bool _shouldUpdateCollectionViewWidthForArrowButtonVisibility;	// 31 = 0x1f
    _Bool _hideSlottedCellSeparators;	// 32 = 0x20
    _Bool _shouldScrollIfShowingLastVisibleRow;	// 33 = 0x21
    UIFont *_candidateFont;	// 40 = 0x28
    UIFont *_supplementalLexiconCandidateFont;	// 48 = 0x30
    UIFont *_annotationTextFont;	// 56 = 0x38
    UIFont *_alternativeTextFont;	// 64 = 0x40
    UIFont *_candidateNumberFont;	// 72 = 0x48
    UIFont *_sortControlFont;	// 80 = 0x50
    UIColor *_textColor;	// 88 = 0x58
    UIColor *_highlightedTextColor;	// 96 = 0x60
    UIColor *_alternativeTextColor;	// 104 = 0x68
    UIColor *_highlightedAlternativeTextColor;	// 112 = 0x70
    UIColor *_candidateNumberColor;	// 120 = 0x78
    UIColor *_highlightedCandidateNumberColor;	// 128 = 0x80
    UIColor *_backgroundColor;	// 136 = 0x88
    UIColor *_cellBackgroundColor;	// 144 = 0x90
    UIColor *_arrowButtonBackgroundColor;	// 152 = 0x98
    UIColor *_arrowButtonColor;	// 160 = 0xa0
    UIColor *_gridBackgroundColor;	// 168 = 0xa8
    UIColor *_highlightedBackgroundColor;	// 176 = 0xb0
    UIColor *_highlightedRowBackgroundColor;	// 184 = 0xb8
    UIColor *_groupHeaderBackgroundColor;	// 192 = 0xc0
    UIColor *_transliterationCandidateBackgroundColor;	// 200 = 0xc8
    UIColor *_lineColor;	// 208 = 0xd0
    UIColor *_sortControlColor;	// 216 = 0xd8
    UIColor *_sortControlBackgroundColor;	// 224 = 0xe0
    NSString *_arrowButtonImageName;	// 232 = 0xe8
    UIImage *_cellSeparatorImage;	// 240 = 0xf0
    UIImage *_slottedCellSeparatorImage;	// 248 = 0xf8
    UIImage *_leftEdgeSeparatorImage;	// 256 = 0x100
    UIImage *_rightEdgeSeparatorImage;	// 264 = 0x108
    UIImage *_arrowButtonSeparatorImage;	// 272 = 0x110
    UIImage *_leftEdgeMaskImage;	// 280 = 0x118
    UIImage *_rightEdgeMaskImage;	// 288 = 0x120
    UIImage *_cellBackgroundImage;	// 296 = 0x128
    UIImage *_highlightedCellBackgroundImage;	// 304 = 0x130
    UIImage *_transliterationCandidateBackgroundImage;	// 312 = 0x138
    double _rowHeight;	// 320 = 0x140
    double _arrowButtonHeight;	// 328 = 0x148
    double _cornerRadius;	// 336 = 0x150
    double _cellCornerRadius;	// 344 = 0x158
    unsigned long long _maskedCorners;	// 352 = 0x160
    unsigned long long _gridMaskedCorners;	// 360 = 0x168
    double _foregroundOpacity;	// 368 = 0x170
    double _backgroundOpacity;	// 376 = 0x178
    long long _layoutOrientation;	// 384 = 0x180
    unsigned long long _columnsCount;	// 392 = 0x188
    unsigned long long _maxNumberOfProactiveCells;	// 400 = 0x190
    double _minimumCellPadding;	// 408 = 0x198
    double _minimumCellWidth;	// 416 = 0x1a0
    double _minimumInterItemSpacing;	// 424 = 0x1a8
    double _maximumIconWidth;	// 432 = 0x1b0
    double _singleSlottedCellMargin;	// 440 = 0x1b8
    long long _cellTextAlignment;	// 448 = 0x1c0
    long long _alternativeTextAlignment;	// 456 = 0x1c8
    long long _lineBreakMode;	// 464 = 0x1d0
    long long _minimumNumberOfCandidates;	// 472 = 0x1d8
    double _widthOfGridGradient;	// 480 = 0x1e0
    UIButtonConfiguration *_arrowButtonConfig;	// 488 = 0x1e8
    UIColor *_spaceConfirmationCandidateCellBackgroundColor;	// 496 = 0x1f0
    double _alternativeTextLeftSpacing;	// 504 = 0x1f8
    double _interRowSpacing;	// 512 = 0x200
    UIImage *_autofillExtraCandidateImage;	// 520 = 0x208
    double _slottedCandidatesIterItemSpacing;	// 528 = 0x210
    NSDictionary *_suggestionCandidateHeaderFontAttributes;	// 536 = 0x218
    NSDictionary *_suggestionCandidateBodyFontAttributes;	// 544 = 0x220
    NSString *_proactiveCandidateContentsGravity;	// 552 = 0x228
    struct CGPoint _gridLineOffset;	// 560 = 0x230
    struct UIEdgeInsets _extraCellPadding;	// 576 = 0x240
    struct UIEdgeInsets _arrowButtonPadding;	// 608 = 0x260
    struct UIEdgeInsets _gridPadding;	// 640 = 0x280
    struct UIEdgeInsets _gridLinePadding;	// 672 = 0x2a0
    struct UIEdgeInsets _sortControlPadding;	// 704 = 0x2c0
    struct UIEdgeInsets _groupHeaderPadding;	// 736 = 0x2e0
}

+ (id)tvGridStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000bd7fa2
+ (id)tvLinearStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000bd7bb9
+ (id)disambiguationStyleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000bd7b87
+ (id)styleForDarkKeyboard:(_Bool)arg1;	// IMP=0x0010000000bd7b55
+ (id)darkKeyboardStyleForDisambiguation;	// IMP=0x0010000000bd78b8
+ (id)lightKeyboardStyleForDisambiguation;	// IMP=0x0010000000bd7669
+ (id)visionInlineStyle;	// IMP=0x0010000000bd71ce
+ (id)darkKeyboardStyle;	// IMP=0x0010000000bd6d66
+ (id)lightKeyboardStyle;	// IMP=0x0010000000bd68fe
- (void).cxx_destruct;	// IMP=0x0000000000bd8e8e
@property(nonatomic) _Bool shouldScrollIfShowingLastVisibleRow; // @synthesize shouldScrollIfShowingLastVisibleRow=_shouldScrollIfShowingLastVisibleRow;
@property(copy, nonatomic) NSString *proactiveCandidateContentsGravity; // @synthesize proactiveCandidateContentsGravity=_proactiveCandidateContentsGravity;
@property(nonatomic) _Bool hideSlottedCellSeparators; // @synthesize hideSlottedCellSeparators=_hideSlottedCellSeparators;
@property(nonatomic) _Bool shouldUpdateCollectionViewWidthForArrowButtonVisibility; // @synthesize shouldUpdateCollectionViewWidthForArrowButtonVisibility=_shouldUpdateCollectionViewWidthForArrowButtonVisibility;
@property(retain, nonatomic) NSDictionary *suggestionCandidateBodyFontAttributes; // @synthesize suggestionCandidateBodyFontAttributes=_suggestionCandidateBodyFontAttributes;
@property(retain, nonatomic) NSDictionary *suggestionCandidateHeaderFontAttributes; // @synthesize suggestionCandidateHeaderFontAttributes=_suggestionCandidateHeaderFontAttributes;
...
@property(retain, nonatomic) UIImage *autofillExtraCandidateImage; // @synthesize autofillExtraCandidateImage=_autofillExtraCandidateImage;
@property(nonatomic) _Bool applyCornerRadiusToAllCandidates; // @synthesize applyCornerRadiusToAllCandidates=_applyCornerRadiusToAllCandidates;
@property(nonatomic) double interRowSpacing; // @synthesize interRowSpacing=_interRowSpacing;
@property(nonatomic) struct UIEdgeInsets groupHeaderPadding; // @synthesize groupHeaderPadding=_groupHeaderPadding;
@property(nonatomic) double alternativeTextLeftSpacing; // @synthesize alternativeTextLeftSpacing=_alternativeTextLeftSpacing;
@property(nonatomic) _Bool maximizeSortControlWidthWithPadding; // @synthesize maximizeSortControlWidthWithPadding=_maximizeSortControlWidthWithPadding;
@property(nonatomic) _Bool hideLinesOnDisambiguationGridEdges; // @synthesize hideLinesOnDisambiguationGridEdges=_hideLinesOnDisambiguationGridEdges;
@property(retain, nonatomic) UIColor *spaceConfirmationCandidateCellBackgroundColor; // @synthesize spaceConfirmationCandidateCellBackgroundColor=_spaceConfirmationCandidateCellBackgroundColor;
@property(retain, nonatomic) UIButtonConfiguration *arrowButtonConfig; // @synthesize arrowButtonConfig=_arrowButtonConfig;
@property(nonatomic) _Bool arrowButtonHighlightBackgroundHidden; // @synthesize arrowButtonHighlightBackgroundHidden=_arrowButtonHighlightBackgroundHidden;
@property(nonatomic) _Bool performScalingAnimationOnCellHighlight; // @synthesize performScalingAnimationOnCellHighlight=_performScalingAnimationOnCellHighlight;
@property(nonatomic) _Bool showCellBorderForSpaceConfirmationCandidate; // @synthesize showCellBorderForSpaceConfirmationCandidate=_showCellBorderForSpaceConfirmationCandidate;
@property(nonatomic) double widthOfGridGradient; // @synthesize widthOfGridGradient=_widthOfGridGradient;
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bd5e20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bd58dc
