...
+ (id)createTouchInfoForTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0060000000eeec72
+ (id)touchInfoForTouch:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0060000000eeebc6
+ (void)setTouchInfo:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0060000000eeeb22
+ (id)touchDict;	// IMP=0x0060000000eeeab0
- (void).cxx_destruct;	// IMP=0x0000000000eefa2f
...
- (_Bool)willChangeTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000eef80e
- (id)setOfTouchesToIgnoreWhenSettingTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000eef2e7
- (void)cleanup;	// IMP=0x0000000000eef277
- (void)invalidateTimer;	// IMP=0x0000000000eef1e5
- (void)fireTimerNow;	// IMP=0x0000000000eef13f
- (void)setTimerWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3;	// IMP=0x0000000000eeeffe
- (void)updateTouch:(id)arg1;	// IMP=0x0000000000eeef10
@property(readonly, nonatomic) _UIKBRTTouchInfo *nextTouch;
@property(readonly, nonatomic) _UIKBRTTouchInfo *previousTouch;
- (void)dealloc;	// IMP=0x0000000000eeeeae
- (id)initWithTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000eeed0b
