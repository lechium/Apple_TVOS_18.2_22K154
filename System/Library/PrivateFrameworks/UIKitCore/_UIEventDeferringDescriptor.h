...
- (void).cxx_destruct;	// IMP=0x0000000000239ee8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000239edd
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000239bb5
- (id)debugDescriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000239b65
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000239b15
- (id)succinctDescriptionBuilder;	// IMP=0x0000000000239a51
- (id)succinctDescription;	// IMP=0x0000000000239a01
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002395eb
- (id)init;	// IMP=0x000000000023949c
