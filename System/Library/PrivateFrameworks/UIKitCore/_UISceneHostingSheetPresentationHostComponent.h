...
- (void).cxx_destruct;	// IMP=0x00000000012088bf
...
- (void)scene:(id)arg1 didUpdateClientSettingsWithDiff:(id)arg2 oldClientSettings:(id)arg3 transitionContext:(id)arg4;	// IMP=0x00000000012082e9
- (id)scene:(id)arg1 handleActions:(id)arg2;	// IMP=0x0000000001208085
- (id)currentPresentationController;	// IMP=0x0000000001207fdc
