...
- (void).cxx_destruct;	// IMP=0x0000000000d6b702
...
- (void)dismiss;	// IMP=0x0000000000d6b5fc
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000d6b33b
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000000d6b333
