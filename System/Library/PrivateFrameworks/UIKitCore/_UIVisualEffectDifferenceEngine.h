...
- (void).cxx_destruct;	// IMP=0x000000000032048b
...
- (id)description;	// IMP=0x0000000000320292
- (id)describeMergeTable;	// IMP=0x0000000000320183
- (id)mergeSource:(id)arg1 andDestination:(id)arg2;	// IMP=0x00000000003200cc
@property(readonly, copy, nonatomic) NSArray *merged;
- (void)_calculate;	// IMP=0x000000000031ff45
- (void)_calculateMerge;	// IMP=0x000000000031f734
- (void)_calculateLCSSTable;	// IMP=0x000000000031f519
- (void)_calculatePrefixAndSuffix;	// IMP=0x000000000031f355
- (void)_reset;	// IMP=0x000000000031f328
- (void)dealloc;	// IMP=0x000000000031f2ee
