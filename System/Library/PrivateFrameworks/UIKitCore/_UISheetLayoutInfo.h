...
@interface _UISheetLayoutInfo : NSObject
{
    struct {
        ...
        unsigned int modelDimmingEnabled:1;
    ...
    _Bool __hasActiveFullDetent;	// 39 = 0x27
    _Bool __expanded;	// 40 = 0x28
    _Bool __anyDescendantDragging;	// 41 = 0x29
    _Bool __anyDescendantWantsFullScreen;	// 42 = 0x2a
    _Bool __interactionEnabled;	// 43 = 0x2b
    _Bool __scrollInteractionEnabled;	// 44 = 0x2c
    _Bool __shouldPresentedViewControllerControlStatusBarAppearance;	// 45 = 0x2d
    _Bool __shouldDimmingIgnoreTouches;	// 46 = 0x2e
    _Bool __modelDimmingEnabled;	// 47 = 0x2f
    _Bool __dimmingEnabled;	// 48 = 0x30
    _Bool __tucksIntoUnsafeAreaInCompactHeight;	// 49 = 0x31
    _Bool __allowsAsymmetricVerticalMargins;	// 50 = 0x32
    _Bool __containsFirstResponder;	// 51 = 0x33
    _Bool __firstResponderRequiresKeyboard;	// 52 = 0x34
    _Bool __remoteContainsFirstResponder;	// 53 = 0x35
    _Bool __remoteFirstResponderRequiresKeyboard;	// 54 = 0x36
    _Bool __shouldAdjustDetentsToAvoidKeyboard;	// 55 = 0x37
    _Bool __wantsFullScreen;	// 56 = 0x38
    _Bool __wantsEdgeAttached;	// 57 = 0x39
    _Bool __wantsEdgeAttachedInCompactHeight;	// 58 = 0x3a
    _Bool __wantsFloatingInRegularWidthCompactHeight;	// 59 = 0x3b
    _Bool __wantsInvertedWhenFloating;	// 60 = 0x3c
    _Bool __widthFollowsPreferredContentSizeWhenEdgeAttached;	// 61 = 0x3d
    _Bool __presented;	// 62 = 0x3e
    _Bool __transitioning;	// 63 = 0x3f
    _Bool __hidden;	// 64 = 0x40
    _Bool __presentsWithGesture;	// 65 = 0x41
    _Bool __shouldScaleDownBehindDescendants;	// 66 = 0x42
    _Bool __reduceMotionEnabled;	// 67 = 0x43
    _Bool __peeksWhenFloating;	// 68 = 0x44
    _Bool __hosting;	// 69 = 0x45
    _Bool __dismissible;	// 70 = 0x46
    _Bool __shouldDismissWhenTappedOutside;	// 71 = 0x47
    _Bool __allowsInteractiveDismissWhenFullScreen;	// 72 = 0x48
    _Bool __prefersScrollingResizesWhenDetentDirectionIsDown;	// 73 = 0x49
    _Bool __prefersScrollingExpandsToLargerDetentWhenScrolledToEdge;	// 74 = 0x4a
    _Bool __dragging;	// 75 = 0x4b
    _Bool __wantsGrabber;	// 76 = 0x4c
    _Bool __insetsContentViewForGrabber;	// 77 = 0x4d
    _Bool __grabberBlurEnabled;	// 78 = 0x4e
    _Bool __alwaysAllowsEdgeAttached;	// 79 = 0x4f
    ...
    double __preferredShadowOpacity;	// 496 = 0x1f0
    double __shadowRadius;	// 504 = 0x1f8
    double __remoteProposedDepthLevel;	// 512 = 0x200
    double __hostParentDepthLevel;	// 520 = 0x208
    CDUnknownBlockType __currentOffsetGetter;	// 528 = 0x210
    _UISheetLayoutInfo *__parentLayoutInfo;	// 536 = 0x218
    _UISheetLayoutInfo *__childLayoutInfo;	// 544 = 0x220
    CDUnknownBlockType __indexOfCurrentActiveOrDismissDetentWasInvalidated;	// 552 = 0x228
    CDUnknownBlockType __rubberBandExtentBeyondMinimumOffsetWasInvalidated;	// 560 = 0x230
    CDUnknownBlockType __rubberBandExtentBeyondMaximumOffsetWasInvalidated;	// 568 = 0x238
    double __confinedPercentLightened;	// 576 = 0x240
    id <_UISheetLayoutInfoDelegate> __delegate;	// 584 = 0x248
    NSMutableArray *__mutableDetentValues;	// 592 = 0x250
    NSMutableArray *__mutableActiveDetents;	// 600 = 0x258
    struct CGSize __preferredSize;	// 608 = 0x260
    struct CGPoint __rawCurrentOffset;	// 624 = 0x270
    struct CGPoint __currentOffset;	// 640 = 0x280
    struct CGSize __screenSize;	// 656 = 0x290
    struct UIEdgeInsets __unsafeInsets;	// 672 = 0x2a0
    struct UIEdgeInsets __marginsWhenFloating;	// 704 = 0x2c0
    struct UIEdgeInsets __margins;	// 736 = 0x2e0
    struct CGRect __effectiveKeyboardFrame;	// 768 = 0x300
    struct CGRect __stackAlignmentFrame;	// 800 = 0x320
    struct CGRect __fullHeightUntransformedFrame;	// 832 = 0x340
    struct CGRect __fullHeightUntransformedFrameForDepthLevel;	// 864 = 0x360
    struct CGRect __untransformedFrame;	// 896 = 0x380
    struct CGRect __hostedUntransformedFrame;	// 928 = 0x3a0
    struct CGRect __frameOfPresentedViewInContainerView;	// 960 = 0x3c0
    struct UIEdgeInsets __touchInsets;	// 992 = 0x3e0
    struct UIRectCornerRadii __cornerRadii;	// 1024 = 0x400
    struct UIRectCornerRadii __hostedCornerRadii;	// 1056 = 0x420
    struct CGRect __containerBounds;	// 1088 = 0x440
    struct UIEdgeInsets __containerSafeAreaInsets;	// 1120 = 0x460
    struct CGRect __sourceFrame;	// 1152 = 0x480
    struct CGRect __keyboardFrame;	// 1184 = 0x4a0
    struct CGRect __remoteKeyboardFrame;	// 1216 = 0x4c0
    struct CGRect __dismissSourceFrame;	// 1248 = 0x4e0
    struct CGRect __hostParentStackAlignmentFrame;	// 1280 = 0x500
    struct CGRect __hostParentFullHeightUntransformedFrameForDepthLevel;	// 1312 = 0x520
    struct CGAffineTransform __transform;	// 1344 = 0x540
}

- (void).cxx_destruct;	// IMP=0x00000000006af5db
...
@property(nonatomic, setter=_setAlwaysAllowsEdgeAttached:) _Bool _alwaysAllowsEdgeAttached; // @synthesize _alwaysAllowsEdgeAttached=__alwaysAllowsEdgeAttached;
...
@property(nonatomic, setter=_setPresentsWithGesture:) _Bool _presentsWithGesture; // @synthesize _presentsWithGesture=__presentsWithGesture;
...
@property(readonly, nonatomic) _Bool _hasActiveFullDetent; // @synthesize _hasActiveFullDetent=__hasActiveFullDetent;
- (double)_maximumDepthLevelInChain;	// IMP=0x00000000006af074
...
- (id)_descendantDescription;	// IMP=0x00000000006aed9a
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x00000000006ad67d
@property(readonly, nonatomic, getter=_isDimmingEnabled) _Bool _dimmingEnabled; // @synthesize _dimmingEnabled=__dimmingEnabled;
@property(readonly, nonatomic, getter=_isModelDimmingEnabled) _Bool _modelDimmingEnabled; // @synthesize _modelDimmingEnabled=__modelDimmingEnabled;
...
@property(readonly, nonatomic, getter=_isExpanded) _Bool _expanded; // @synthesize _expanded=__expanded;
...
- (_Bool)_supportsAttachedEdge;	// IMP=0x00000000006a7bb4
...
- (void)_invalidateCurrentOffset;	// IMP=0x00000000006a6569
- (void)_invalidateDetents;	// IMP=0x00000000006a5ab0
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x00000000006a50b3
- (void)_invalidatePreferredSize;	// IMP=0x00000000006a5060
- (id)initWithMetrics:(id)arg1;	// IMP=0x00000000006a4d19
