...
- (struct CGPoint)convertPointToRenderSpace:(struct CGPoint)arg1 textRange:(UITextRange *)arg2;
...
- (id <_UIInvalidatable>)obtainSelectionGrabberSuppressionAssertion;
