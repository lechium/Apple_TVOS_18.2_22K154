...
- (void).cxx_destruct;	// IMP=0x0000000000810b4a
...
- (void)animationEnded:(_Bool)arg1;	// IMP=0x0000000000810a94
- (void)animateTransition:(id)arg1;	// IMP=0x000000000081078f
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000810784
- (void)finishInteractiveAnimation;	// IMP=0x00000000008106ee
- (void)cancelInteractiveAnimation;	// IMP=0x0000000000810658
- (void)updateInteractiveProgress:(double)arg1;	// IMP=0x0000000000810581
- (void)animateInteractively;	// IMP=0x000000000081048e
- (void)animate;	// IMP=0x00000000008103fc
- (void)_updateTransitionContext;	// IMP=0x00000000008102d0
@property(readonly, retain, nonatomic) NSMutableDictionary *stash;
- (void)dealloc;	// IMP=0x0000000000810001
