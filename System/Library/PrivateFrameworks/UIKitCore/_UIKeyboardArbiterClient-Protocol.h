...
- (id <_UIAssertion>)vendEmojiKeyboardPrewarmingAssertionForReason:(NSString *)arg1;
...
- (_Bool)hasActiveKeyboardSuppressionAssertionsForReason:(NSString *)arg1;
...
- (void)setDisableBecomeFirstResponder:(_Bool)arg1 forSuppressionAssertion:(_Bool)arg2 updatePlacement:(_Bool)arg3 wantsAssistant:(_Bool)arg4;
