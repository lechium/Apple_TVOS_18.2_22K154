...
+ (id)combinedVisualRepresentationForSnapshots:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x001000000096bac3
- (void).cxx_destruct;	// IMP=0x000000000096c9a2
...
- (id)debugQuickLookObject;	// IMP=0x000000000096c7bc
- (id)visualRepresentationWithMinimumArea:(struct CGRect)arg1;	// IMP=0x000000000096a7fe
...
- (void)_didChooseFocusCandidateRegion:(id)arg1;	// IMP=0x0000000000969f70
- (id)_snapshotByFulfillingPromiseFocusRegionEntry:(id)arg1;	// IMP=0x0000000000969352
- (id)focusableRegionMapEntriesLimitedByFocusContainerGuide:(id)arg1;	// IMP=0x0000000000968fe6
@property(readonly, copy, nonatomic) NSArray *allFocusableRegionMapEntries;
- (void)_commit;	// IMP=0x0000000000968f94
- (void)_updateSortedFocusContainerGuideMapEntries;	// IMP=0x0000000000968f23
- (void)_updateFinalFocusableRegionMapEntries;	// IMP=0x0000000000968e87
- (id)_sortedEligibleFocusContainerGuidesInArray:(id)arg1;	// IMP=0x0000000000968518
- (id)_finalFocusableRegionMapEntriesFromViewMapEntries:(id)arg1 guideMapEntries:(id)arg2;	// IMP=0x0000000000968229
- (id)_finalFocusableRegionMapEntriesFromMapEntries:(id)arg1;	// IMP=0x0000000000967c06
- (void)_punchHoleInMap:(id)arg1 atFrame:(struct CGRect)arg2;	// IMP=0x0000000000967976
- (void)_occludeFocusInFrame:(struct CGRect)arg1;	// IMP=0x000000000096788f
- (void)_addFocusContainerGuide:(id)arg1 withFrame:(struct CGRect)arg2;	// IMP=0x0000000000967733
- (void)_addFocusableRegion:(id)arg1 isFocusGuide:(_Bool)arg2 withFrame:(struct CGRect)arg3;	// IMP=0x000000000096748e
- (struct CGRect)_clippedRegionFrame:(struct CGRect)arg1 isFocusGuide:(_Bool)arg2;	// IMP=0x0000000000967274
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000096703f
- (id)_initWithRequest:(id)arg1;	// IMP=0x0000000000966d57
