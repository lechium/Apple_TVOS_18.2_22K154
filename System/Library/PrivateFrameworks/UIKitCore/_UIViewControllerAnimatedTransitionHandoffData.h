...
- (void).cxx_destruct;	// IMP=0x00000000009ee11e
...
- (id)handoffDataForViewController:(id)arg1;	// IMP=0x00000000009ee056
- (id)initWithFromViewControllerHandoffData:(id)arg1 toViewControllerHandoffData:(id)arg2 progressValue:(id)arg3 isPush:(_Bool)arg4;	// IMP=0x00000000009edf91
