...
- (void).cxx_destruct;	// IMP=0x0000000001624c3b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000001624c1e
- (void)update;	// IMP=0x0000000001624c01
...
- (id)initWithContents:(id)arg1 delegatingToView:(id)arg2;	// IMP=0x0000000001624a56
