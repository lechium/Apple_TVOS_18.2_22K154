...
- (void).cxx_destruct;	// IMP=0x000000000073b112
...
- (id)description;	// IMP=0x000000000073b027
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x000000000073af16
