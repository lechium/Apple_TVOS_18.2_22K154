...
- (void).cxx_destruct;	// IMP=0x00000000004a75c5
@property(retain, nonatomic) _UIVisualEffectViewBackdropCaptureGroup *captureGroup; // @synthesize captureGroup=_captureGroup;
- (id)description;	// IMP=0x00000000004a7521
- (_Bool)canTransitionToEffect:(id)arg1;	// IMP=0x00000000004a7519
- (void)removeEffectFromView:(id)arg1;	// IMP=0x00000000004a74cd
- (void)addEffectToView:(id)arg1;	// IMP=0x00000000004a7432
