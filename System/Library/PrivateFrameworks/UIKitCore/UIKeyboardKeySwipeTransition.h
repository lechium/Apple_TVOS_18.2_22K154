...
- (void).cxx_destruct;	// IMP=0x0000000000f217b9
...
- (id)meshTransformForKeyplane:(id)arg1 forward:(_Bool)arg2 initial:(_Bool)arg3;	// IMP=0x0000000000f1e8cc
- (struct CGRect)keyRectForFrame:(struct CGRect)arg1 normalizedSubRect:(struct CGRect)arg2;	// IMP=0x0000000000f1e8a2
- (void)gatherTransitionKeys;	// IMP=0x0000000000f1e335
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000f1e2ba
- (void)removeAllAnimations;	// IMP=0x0000000000f1e14e
- (void)_runOpacityAnimation;	// IMP=0x0000000000f1e01c
- (void)_runTransformAnimation;	// IMP=0x0000000000f1ddbf
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000f1dd84
- (double)nonInteractiveDuration;	// IMP=0x0000000000f1dd76
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000f1dca5
- (void)commitTransitionRebuild;	// IMP=0x0000000000f1dc4d
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000f1d844
