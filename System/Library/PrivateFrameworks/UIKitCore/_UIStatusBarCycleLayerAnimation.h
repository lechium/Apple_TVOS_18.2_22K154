...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x00600000012401bc
- (void).cxx_destruct;	// IMP=0x00000000012404d8
...
- (id)description;	// IMP=0x000000000124037c
