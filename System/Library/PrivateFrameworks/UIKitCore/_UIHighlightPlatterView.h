...
- (void).cxx_destruct;	// IMP=0x00000000011931b0
...
- (_Bool)_isEligibleForFocusOcclusion;	// IMP=0x00000000011930f0
- (id)initWithTargetedPreview:(id)arg1;	// IMP=0x0000000001192531
