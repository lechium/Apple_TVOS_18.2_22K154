...
- (void).cxx_destruct;	// IMP=0x00000000004e9bd8
...
- (double)_dimensionForRootGroupAlongAxis:(unsigned long long)arg1;	// IMP=0x00000000004e99ad
- (double)auxillaryHostPaddingBeforeBoundarySupplementaries;	// IMP=0x00000000004e9895
- (id)auxillaryHostTraitCollection;	// IMP=0x00000000004e9883
- (id)auxillaryHostPreferredSizes;	// IMP=0x00000000004e987b
- (id)auxillaryHostSupplementaryEnroller;	// IMP=0x00000000004e9861
- (long long)auxillaryHostAuxillaryKind;	// IMP=0x00000000004e9856
- (unsigned long long)auxillaryHostLayoutAxis;	// IMP=0x00000000004e9844
- (_Bool)auxillaryHostShouldLayoutRTL;	// IMP=0x00000000004e9832
- (id)auxillaryHostAuxillaryItems;	// IMP=0x00000000004e97e2
- (id)auxillaryHostContainer;	// IMP=0x00000000004e9653
- (_Bool)auxillaryHostWantsOverlapAdjustmentForMatchingAlignmentsOnly;	// IMP=0x00000000004e9627
- (struct CGRect)auxillaryHostPinningRect;	// IMP=0x00000000004e9583
- (struct CGSize)auxillaryHostContentSize;	// IMP=0x00000000004e9474
- (struct _NSRange)preferredSizeGroupingRangeForItemAtIndex:(long long)arg1;	// IMP=0x00000000004e90e3
@property(readonly, nonatomic) unsigned long long containerSizeDependentAxes;
- (id)sectionSupplementaryFrameWithKind:(id)arg1 index:(long long)arg2;	// IMP=0x00000000004e8efd
- (long long)sectionSupplementaryKindIndexForEnrollmentIdentifier:(id)arg1;	// IMP=0x00000000004e8e4e
- (id)unpinnedSectionSupplementaryFrameWithKind:(id)arg1 forIndex:(long long)arg2;	// IMP=0x00000000004e8d0e
- (id)unpinnedSectionSupplementaryFrameForIndex:(long long)arg1;	// IMP=0x00000000004e8b18
- (id)sectionSupplementaryFrameForIndex:(long long)arg1;	// IMP=0x00000000004e893e
- (id)supplementaryFrameWithKind:(id)arg1 index:(long long)arg2;	// IMP=0x00000000004e8652
- (id)frameForIndex:(long long)arg1;	// IMP=0x00000000004e856b
...
- (id)visualDescription;	// IMP=0x00000000004e8149
- (id)queryFramesIntersectingRect:(struct CGRect)arg1 frameOffset:(struct CGPoint)arg2;	// IMP=0x00000000004e813f
- (id)queryFramesIntersectingRect:(struct CGRect)arg1;	// IMP=0x00000000004e7b45
- (void)updatePinnedSupplementaryItemsWithVisibleBounds:(struct CGRect)arg1 overrideContentRectForPinning:(struct CGRect)arg2;	// IMP=0x00000000004e7ae2
- (void)updatePinnedSupplementaryItemsWithVisibleBounds:(struct CGRect)arg1;	// IMP=0x00000000004e7a51
- (id)resolveWithParameters:(id)arg1 preferredSizes:(id)arg2;	// IMP=0x00000000004e79c3
- (void)solveForContainer:(id)arg1 supplementaryContainer:(id)arg2 traitCollection:(id)arg3 layoutAxis:(unsigned long long)arg4 frameCount:(long long)arg5 preferredSizes:(id)arg6 layoutRTL:(_Bool)arg7;	// IMP=0x00000000004e7260
- (void)solveForContainer:(id)arg1 traitCollection:(id)arg2 layoutAxis:(unsigned long long)arg3 frameCount:(long long)arg4 preferredSizes:(id)arg5;	// IMP=0x00000000004e7234
- (void)solveForContainer:(id)arg1 traitCollection:(id)arg2 layoutAxis:(unsigned long long)arg3 frameCount:(long long)arg4;	// IMP=0x00000000004e7209
