...
- (void).cxx_destruct;	// IMP=0x000000000161807a
...
- (void)_enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001617c3f
- (void)enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000016178e0
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x00000000016176a8
- (_Bool)shouldRender;	// IMP=0x0000000001617684
- (id)font;	// IMP=0x0000000001617676
- (id)string;	// IMP=0x000000000161756d
- (struct _NSRange)stringRange;	// IMP=0x000000000161754c
- (long long)glyphCount;	// IMP=0x0000000001617542
- (void)dealloc;	// IMP=0x0000000001617503
- (id)initWithCTRun:(struct __CTRun *)arg1 lineIndex:(unsigned long long)arg2 layoutInfo:(id)arg3;	// IMP=0x0000000001617473
