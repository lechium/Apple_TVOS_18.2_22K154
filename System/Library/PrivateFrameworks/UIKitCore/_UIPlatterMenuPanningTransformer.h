...
+ (id)transformerWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0060000000fceb84
- (void).cxx_destruct;	// IMP=0x0000000000fcfacb
...
- (void)didEndPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000fcf7ba
- (void)didPanWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000fcefbb
- (void)didBeginPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000fcedfa
@property(readonly, nonatomic) struct CGVector velocity;
@property(readonly, nonatomic) struct CGVector offset;
- (void)_enterYLockedState;	// IMP=0x0000000000fcec9e
- (void)lockIntoYAxis;	// IMP=0x0000000000fcec87
- (double)timeIntervalSinceLastDirectionChange;	// IMP=0x0000000000fcebd6
- (id)initWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0000000000fcea8b
