...
- (void).cxx_destruct;	// IMP=0x0000000000b491dd
...
- (id)imageWithConfiguration:(id)arg1;	// IMP=0x0000000000b48fd7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b48e5a
- (id)initWithContentsOfFile:(id)arg1;	// IMP=0x0000000000b48d39
