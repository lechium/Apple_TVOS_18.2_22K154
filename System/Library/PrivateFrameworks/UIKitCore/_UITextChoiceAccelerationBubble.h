...
- (void).cxx_destruct;	// IMP=0x00000000009cd732
...
- (int)textEffectsVisibilityLevel;	// IMP=0x00000000009cd20f
- (int)textEffectsVisibilityLevelInKeyboardWindow;	// IMP=0x00000000009cd204
- (void)dismissWithText:(id)arg1;	// IMP=0x00000000009cd166
- (void)dismissWithCandidate:(id)arg1;	// IMP=0x00000000009cd0b4
- (void)dismissWithRevert:(id)arg1;	// IMP=0x00000000009cd05d
- (void)dismissWithCancel;	// IMP=0x00000000009ccfdd
- (void)removeAnimated:(_Bool)arg1;	// IMP=0x00000000009ccec1
- (void)reset;	// IMP=0x00000000009cccc3
- (void)removeFromSuperview;	// IMP=0x00000000009ccb0b
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cc4a9
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cc0a0
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cbeaf
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cbcd5
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cbc36
- (id)dictationHighlightViewForPoint:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cbb41
- (id)optionForPoint:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000009cbac5
- (_Bool)showingAutocorrectHighlight;	// IMP=0x00000000009cb996
- (void)showTextHighlightView:(_Bool)arg1;	// IMP=0x00000000009cb382
- (id)bubblePathInRect:(struct CGRect)arg1;	// IMP=0x00000000009cb361
- (id)squaredOffBubblePathInRect:(struct CGRect)arg1;	// IMP=0x00000000009cad5f
- (id)backgroundImageView;	// IMP=0x00000000009cab80
- (id)textOptionWithText:(id)arg1 type:(long long)arg2;	// IMP=0x00000000009cab24
- (_Bool)usingRTLInputMode;	// IMP=0x00000000009caaaf
- (void)inputModeDidChange:(id)arg1;	// IMP=0x00000000009caa98
- (void)layoutSubviews;	// IMP=0x00000000009ca7ac
- (void)updateButtonForType:(long long)arg1;	// IMP=0x00000000009ca77c
- (void)updateButtonName:(id)arg1 placement:(long long)arg2 originalText:(id)arg3;	// IMP=0x00000000009c91d5
- (void)updateViewForOptions:(id)arg1;	// IMP=0x00000000009c8717
- (void)updateWithChoices:(id)arg1 fromParentView:(id)arg2 referenceTextView:(id)arg3 presentedFromRect:(id)arg4 textHighlightColor:(id)arg5;	// IMP=0x00000000009c8323
- (void)hideForNow;	// IMP=0x00000000009c82a6
- (void)updateTextHighlightViewWithColor:(id)arg1 convertedRect:(struct CGRect)arg2;	// IMP=0x00000000009c81f0
- (void)updateTextBoxHighlightForRect:(id)arg1 inTextView:(id)arg2 parentView:(id)arg3 highlightColor:(id)arg4;	// IMP=0x00000000009c80b8
- (void)updateForSingleWord:(id)arg1 textAnchorRect:(id)arg2 inTextView:(id)arg3 parentView:(id)arg4 highlightColor:(id)arg5;	// IMP=0x00000000009c7d46
- (void)showChoices:(_Bool)arg1;	// IMP=0x00000000009c7af6
- (_Bool)promptWillCollideWithKeyboard:(struct CGRect)arg1;	// IMP=0x00000000009c77c4
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x00000000009c6e9f
- (void)anchorToTextIfNeeded;	// IMP=0x00000000009c5f66
- (void)updateTextAnchorForParentView:(id)arg1;	// IMP=0x00000000009c570b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009c55d4
- (id)init;	// IMP=0x00000000009c55a2
