...
- (void).cxx_destruct;	// IMP=0x0000000000a8e334
...
- (void)_pickerDidSelectColor:(id)arg1 colorSpace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x0000000000a8e204
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x0000000000a8e13a
- (void)_displayLinkFired;	// IMP=0x0000000000a8e0ea
- (id)init;	// IMP=0x0000000000a8dfa7
