...
+ (id)generateAccumulatorEntryFromAction:(id)arg1;	// IMP=0x00600000014f20ea
...
- (_Bool)isAllZeroes;	// IMP=0x00000000014f245d
- (void)increaseWithEntry:(id)arg1;	// IMP=0x00000000014f23cf
