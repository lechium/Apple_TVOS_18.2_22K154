...
- (void).cxx_destruct;	// IMP=0x0000000000f8a821
...
- (double)_trackLength;	// IMP=0x0000000000f8a6ee
- (void)_issueUpdateWithValue:(double)arg1 isActive:(_Bool)arg2;	// IMP=0x0000000000f8a656
- (void)_handleGesture:(id)arg1;	// IMP=0x0000000000f8a47e
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000f8a3e7
- (void)cancel;	// IMP=0x0000000000f8a31e
- (void)stop;	// IMP=0x0000000000f8a318
@property(readonly, nonatomic) NSString *name;
- (id)init;	// IMP=0x0000000000f8a0d9
