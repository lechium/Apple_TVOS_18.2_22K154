...
- (void).cxx_destruct;	// IMP=0x00000000006c8eca
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000006c8135
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000006c80d4
- (void)finishTransition;	// IMP=0x00000000006c7e28
- (void)interruptTabBarControllerTransition;	// IMP=0x00000000006c7e16
- (id)init;	// IMP=0x00000000006c7dda
