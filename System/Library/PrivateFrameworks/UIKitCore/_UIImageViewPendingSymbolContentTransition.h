...
+ (id)transitionWithTransition:(id)arg1 sourceSymbolImage:(id)arg2 targetSymbolImage:(id)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00600000012ad265
- (void).cxx_destruct;	// IMP=0x00000000012ad3fc
...
- (id)init;	// IMP=0x00000000012ad21b
