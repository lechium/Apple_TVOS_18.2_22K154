...
- (void).cxx_destruct;	// IMP=0x000000000033e954
...
- (void)_invoke:(id)arg1 forEvent:(id)arg2;	// IMP=0x000000000033e72e
@property(readonly, nonatomic) SEL proxyAction;
- (id)initWithBarButtonItem:(id)arg1;	// IMP=0x000000000033e6b6
- (id)init;	// IMP=0x000000000033e609
