...
- (void).cxx_destruct;	// IMP=0x00000000009a84df
...
- (void)_setupAlternateTitlesFromBarButtonItem:(id)arg1;	// IMP=0x00000000009a7cd4
- (id)_titleAlternativeForTitle:(id)arg1;	// IMP=0x00000000009a7bab
- (_Bool)supportsBackButtons;	// IMP=0x00000000009a7ba3
- (void)updateButton:(id)arg1 forHighlightedState:(_Bool)arg2;	// IMP=0x00000000009a7b78
- (void)updateButton:(id)arg1 forFocusedState:(_Bool)arg2;	// IMP=0x00000000009a78eb
- (void)buttonLayoutSubviews:(id)arg1 baseImplementation:(CDUnknownBlockType)arg2;	// IMP=0x00000000009a75cd
- (void)configureButton:(id)arg1 fromBarButtonItem:(id)arg2;	// IMP=0x00000000009a5e76
- (void)configureButton:(id)arg1 withAppearanceDelegate:(id)arg2 fromBarItem:(id)arg3;	// IMP=0x00000000009a5ddf
- (id)contentView;	// IMP=0x00000000009a5d4b
- (id)backIndicatorView;	// IMP=0x00000000009a5d39
