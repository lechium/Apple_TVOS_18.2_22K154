...
- (void).cxx_destruct;	// IMP=0x000000000024f353
...
- (id)motionEffectsOnAxis:(long long)arg1;	// IMP=0x000000000024ef57
- (id)_newMotionEffectsGroupForHighlightedAction;	// IMP=0x000000000024eee5
- (void)_removeMotionEffects;	// IMP=0x000000000024edf0
- (void)_insertMotionEffects;	// IMP=0x000000000024eceb
- (struct CATransform3D)_enlargedTransformForSize:(struct CGSize)arg1 pressed:(_Bool)arg2;	// IMP=0x000000000024ebab
- (void)_applyHighlightTransform;	// IMP=0x000000000024e772
- (id)initWithHighlightTransformTargetView:(id)arg1;	// IMP=0x000000000024e6c0
