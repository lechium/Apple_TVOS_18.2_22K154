...
- (void).cxx_destruct;	// IMP=0x00000000008b7518
...
- (_Bool)_shouldAnimatePropertyWithKey:(id)arg1;	// IMP=0x00000000008b6e54
- (id)initWithShadowPath:(id)arg1;	// IMP=0x00000000008b6d15
