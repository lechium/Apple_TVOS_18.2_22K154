...
- (void).cxx_destruct;	// IMP=0x00000000011f5a82
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000011f59c1
- (void)jiggleWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011f54f4
- (void)animateUnlockWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011f519d
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000000011f5187
- (void)resetLock;	// IMP=0x00000000011f50cd
@property(readonly, nonatomic) _Bool prefersBaselineAlignment;
// Preceding property had unknown attributes: ?
// Original attribute string: TB,?,R,N

- (void)applyStyleAttributes:(id)arg1;	// IMP=0x00000000011f4ecc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000011f4dbd
