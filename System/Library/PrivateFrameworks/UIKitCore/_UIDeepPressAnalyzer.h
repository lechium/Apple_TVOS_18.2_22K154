...
- (void).cxx_destruct;	// IMP=0x0000000000fe6a5c
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000fe6855
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000fe66cf
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000fe664b
- (id)init;	// IMP=0x0000000000fe6599
