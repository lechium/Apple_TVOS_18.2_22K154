...
- (void).cxx_destruct;	// IMP=0x00000000011fa652
@property(retain, nonatomic) UIStackView *stackView; // @synthesize stackView=_stackView;
@property(nonatomic) long long numberOfLines; // @synthesize numberOfLines=_numberOfLines;
- (id)viewForLastBaselineLayout;	// IMP=0x00000000011fa5cc
- (id)viewForFirstBaselineLayout;	// IMP=0x00000000011fa57c
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x00000000011fa421
@property(readonly, nonatomic) NSArray *stringViews;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000011f9ecf
