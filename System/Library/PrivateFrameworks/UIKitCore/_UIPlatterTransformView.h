...
- (void).cxx_destruct;	// IMP=0x00000000010581ca
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000001057e34
- (void)_updateMinificationFilter;	// IMP=0x0000000001057cb3
- (void)didMoveToWindow;	// IMP=0x0000000001057a8a
- (void)layoutSubviews;	// IMP=0x00000000010576ca
- (void)didTearOffForDrag;	// IMP=0x0000000001057620
@property(readonly, nonatomic) UIView *sourceView;
- (void)dealloc;	// IMP=0x0000000001056dac
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000001056d08
