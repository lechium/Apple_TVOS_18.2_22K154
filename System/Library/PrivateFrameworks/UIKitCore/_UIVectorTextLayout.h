...
- (void).cxx_destruct;	// IMP=0x0000000001617015
...
- (void)_layoutIfNeeded;	// IMP=0x000000000161621b
- (id)layoutDescription;	// IMP=0x00000000016157f4
- (id)description;	// IMP=0x00000000016156e0
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001615623
...
- (void)resetLayout;	// IMP=0x00000000016154bd
- (_Bool)hasLayout;	// IMP=0x00000000016154af
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x00000000016153dd
