...
+ (id)effectWithPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x001000000130217d
- (void).cxx_destruct;	// IMP=0x000000000130326c
...
- (void)_completeHighlightEffect;	// IMP=0x000000000130317c
- (void)_createHighlightPlatter;	// IMP=0x0000000001302f28
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x00000000013026b5
@property(readonly, nonatomic) UITargetedPreview *targetedPreviewForEffectContinuation;
- (id)initWithTargetedPreview:(id)arg1 continuingFromPreview:(id)arg2;	// IMP=0x00000000013021ef
