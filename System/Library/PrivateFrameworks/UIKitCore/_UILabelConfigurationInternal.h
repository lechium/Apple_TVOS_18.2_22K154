...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000038a474
- (void).cxx_destruct;	// IMP=0x000000000038accc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000038a974
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000038a5a8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000038a47c
- (unsigned long long)hash;	// IMP=0x000000000038a405
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000389f26
- (id)init;	// IMP=0x0000000000389ec8
