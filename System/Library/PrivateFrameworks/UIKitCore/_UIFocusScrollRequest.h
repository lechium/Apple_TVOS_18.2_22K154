...
- (void).cxx_destruct;	// IMP=0x00000000002a2773
...
- (id)description;	// IMP=0x00000000002a22c6
- (void)reloadFocusItemInfo;	// IMP=0x00000000002a2211
@property(readonly, nonatomic) struct CGRect focusItemFrame; // @synthesize focusItemFrame=_focusItemFrame;
- (struct CGPoint)resolveTargetContentOffsetUsingScrollOffsetResolverClamped:(_Bool)arg1;	// IMP=0x00000000002a1f2a
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemFrame:(struct CGRect)arg2 targetContentOffsetValue:(id)arg3;	// IMP=0x00000000002a1f10
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemInfo:(id)arg2 targetContentOffsetValue:(id)arg3;	// IMP=0x00000000002a1ed8
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemInfo:(id)arg2 focusUpdateContext:(id)arg3;	// IMP=0x00000000002a1e28
- (id)initWithBaseRequest:(id)arg1 environmentScrollableContainer:(id)arg2;	// IMP=0x00000000002a1c07
- (id)initWithEnvironmentScrollableContainer:(id)arg1 focusItemInfo:(id)arg2 focusMovement:(id)arg3 focusItemFrame:(struct CGRect)arg4 targetContentOffsetValue:(id)arg5;	// IMP=0x00000000002a156f
