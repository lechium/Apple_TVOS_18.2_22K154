...
#import <UIKitCore/_UITextSelectionDirectionNavigation_Internal-Protocol.h>

@class NSArray, NSAttributedString, NSString, UIColor, UIFont, UIResponder, UITextPosition, UITextRange, UIView;
...
- (NSArray *)_underlineRectsByDocumentLineForSelectionRange:(UITextRange *)arg1;
