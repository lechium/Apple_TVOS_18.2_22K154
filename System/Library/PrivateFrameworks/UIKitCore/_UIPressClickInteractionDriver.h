...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x00100000008ad6f6
+ (_Bool)requiresForceCapability;	// IMP=0x00100000008ad6ee
- (void).cxx_destruct;	// IMP=0x00000000008adf9a
...
- (void)_gestureRecognizerFailed:(id)arg1;	// IMP=0x00000000008ade72
- (void)_handlePressGesture:(id)arg1;	// IMP=0x00000000008adc24
- (void)_removeFromView;	// IMP=0x00000000008adb8f
- (void)_addToView:(id)arg1;	// IMP=0x00000000008ad9f1
@property(nonatomic) unsigned long long driverStyle;
// Preceding property had unknown attributes: ?
// Original attribute string: TQ,?,N

- (void)cancelInteraction;	// IMP=0x00000000008ad8d3
- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x00000000008ad752
...
- (id)init;	// IMP=0x00000000008ad462
