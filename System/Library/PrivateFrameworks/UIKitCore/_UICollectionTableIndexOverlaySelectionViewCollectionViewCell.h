...
- (void).cxx_destruct;	// IMP=0x00000000013113f6
@property(readonly) UIButton *button; // @synthesize button=_button;
@property(readonly) UILabel *label;
@property(nonatomic) double rightMargin;
@property(nonatomic) long long textAlignment;
@property(copy, nonatomic) NSString *text;
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000001311212
- (void)layoutSubviews;	// IMP=0x000000000131109d
- (void)tintColorDidChange;	// IMP=0x0000000001310f89
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000001310e02
