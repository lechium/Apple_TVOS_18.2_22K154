...
+ (id)_summaryImageForDebugInfoArray:(id)arg1 forFocusMovementWithInfo:(id)arg2 scaleFactor:(double)arg3;	// IMP=0x006000000094631a
- (void).cxx_destruct;	// IMP=0x000000000094707c
...
- (id)_drawImage;	// IMP=0x0000000000945795
- (struct CGRect)_rectContainingAllFocusRegions;	// IMP=0x000000000094559d
@property(readonly, nonatomic) struct CGPoint imageAnchorPoint; // @synthesize imageAnchorPoint=_imageAnchorPoint;
@property(readonly, nonatomic) UIImage *image; // @synthesize image=_image;
- (id)initWithSnapshot:(id)arg1 focusMapSearchInfo:(id)arg2;	// IMP=0x0000000000945418
