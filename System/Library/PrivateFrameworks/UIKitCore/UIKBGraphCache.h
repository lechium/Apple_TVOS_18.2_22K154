...
+ (id)graphCacheForScreen:(id)arg1;	// IMP=0x0010000000d1aed4
- (void).cxx_destruct;	// IMP=0x0000000000d1af4f
@property(readonly, nonatomic) NSMutableDictionary *graphCache; // @synthesize graphCache=_graphCache;
@property(readonly) NSDictionary *_options;
- (_Bool)_matchingOptions:(id)arg1;	// IMP=0x0000000000d1aec4
@property(readonly) UIScreen *_intendedScreen;
- (id)_initWithScreen:(id)arg1 options:(id)arg2;	// IMP=0x0000000000d1ae1c
