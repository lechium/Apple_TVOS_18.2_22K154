...
+ (id)contentForAction:(id)arg1 group:(id)arg2;	// IMP=0x0060000001079330
+ (id)contentForTab:(id)arg1;	// IMP=0x00600000010792f4
- (void).cxx_destruct;	// IMP=0x00000000010793cc
