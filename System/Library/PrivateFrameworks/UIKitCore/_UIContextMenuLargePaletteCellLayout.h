...
- (void).cxx_destruct;	// IMP=0x0000000000ba1e87
...
- (void)setControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000ba1e3f
- (void)removeConstraints;	// IMP=0x0000000000ba1dd8
- (void)updateConstraints;	// IMP=0x0000000000ba1dd2
- (void)installConstraints;	// IMP=0x0000000000ba16e7
...
- (id)preferredIconFontUsingBoldFont:(_Bool)arg1;	// IMP=0x0000000000ba1560
...
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000000ba1496
