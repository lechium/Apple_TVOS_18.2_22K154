...
+ (id)settingsControllerModule;	// IMP=0x0060000000acbfb7
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x0060000000acbf97
...
- (void)setDefaultValues;	// IMP=0x0000000000acbef4
