...
- (void).cxx_destruct;	// IMP=0x000000000088551c
- (void)refreshControl:(id)arg1 didChangeToState:(long long)arg2 fromState:(long long)arg3;	// IMP=0x000000000088541c
- (void)incrementInsetHeight:(double)arg1;	// IMP=0x00000000008853e1
- (void)decrementInsetHeight:(double)arg1;	// IMP=0x00000000008853a6
...
- (id)initWithScrollView:(id)arg1;	// IMP=0x0000000000885324
