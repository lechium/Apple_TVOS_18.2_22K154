...
+ (id)settingsControllerModule;	// IMP=0x0060000000138390
- (void).cxx_destruct;	// IMP=0x00000000001385a0
- (id)initWithDefaultValues;	// IMP=0x0000000000138560
- (void)setDefaultValues;	// IMP=0x0000000000138360
...
- (struct CATransform3D)recededContentTransformFor:(struct CGRect)arg1;	// IMP=0x0000000000137880
- (struct CGSize)platterShadowOffset;	// IMP=0x0000000000137860
