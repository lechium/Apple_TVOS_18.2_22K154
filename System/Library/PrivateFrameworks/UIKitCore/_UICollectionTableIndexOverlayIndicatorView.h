...
- (void).cxx_destruct;	// IMP=0x000000000130e400
@property(copy, nonatomic) NSString *currentText;
- (void)layoutSubviews;	// IMP=0x000000000130e36f
- (void)_willChangeToIdiom:(long long)arg1 onScreen:(id)arg2;	// IMP=0x000000000130e267
- (void)_tapGestureChanged:(id)arg1;	// IMP=0x000000000130e210
- (id)initWithHost:(id)arg1;	// IMP=0x000000000130e116
