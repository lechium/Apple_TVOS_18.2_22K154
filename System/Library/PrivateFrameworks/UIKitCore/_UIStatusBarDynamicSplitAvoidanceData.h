...
- (void).cxx_destruct;	// IMP=0x0000000001072772
...
- (id)initWithLeadingDelta:(double)arg1 trailingDelta:(double)arg2;	// IMP=0x00000000010726ca
- (id)init;	// IMP=0x000000000107264a
