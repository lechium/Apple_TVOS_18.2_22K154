...
- (void).cxx_destruct;	// IMP=0x0000000000a6f857
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x0000000000a6f643
- (id)debugDictionary;	// IMP=0x0000000000a6f594
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000a6f4fe
