...
- (void)cancel;	// IMP=0x00000000017701f6
- (void)main;	// IMP=0x00000000017700c8
- (void)_search;	// IMP=0x000000000176f9bb
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x000000000176f68f
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x000000000176f38d
- (void)_notifyDelegateOfStatus;	// IMP=0x000000000176f216
- (_Bool)_hitSearchLimit;	// IMP=0x000000000176f1eb
- (void)dealloc;	// IMP=0x000000000176f183
- (id)init;	// IMP=0x000000000176f0fe
