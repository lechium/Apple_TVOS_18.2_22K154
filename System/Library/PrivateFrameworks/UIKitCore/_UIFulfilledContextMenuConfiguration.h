...
- (void).cxx_destruct;	// IMP=0x0000000001595813
...
- (void)setPrimaryInternalIdentifier:(id)arg1 secondaryIdentifiers:(id)arg2;	// IMP=0x00000000015955f4
- (_Bool)isPresentable;	// IMP=0x0000000001595570
