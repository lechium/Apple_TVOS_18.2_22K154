...
- (void).cxx_destruct;	// IMP=0x0000000000c2b244
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000c2a4b7
- (void)layoutSubviews;	// IMP=0x0000000000c2a32a
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x0000000000c2a231
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000c29f63
