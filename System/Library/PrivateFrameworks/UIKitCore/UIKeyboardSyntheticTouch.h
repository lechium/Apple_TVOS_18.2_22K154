...
+ (id)syntheticTouchWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0060000000d1b180
- (void).cxx_destruct;	// IMP=0x0000000000d1b47b
...
- (void)_setLocationInWindow:(struct CGPoint)arg1 resetPrevious:(_Bool)arg2;	// IMP=0x0000000000d1b3d6
- (struct CGPoint)getLocationInWindow;	// IMP=0x0000000000d1b3b6
- (struct CGPoint)previousLocationInView:(id)arg1;	// IMP=0x0000000000d1b32a
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x0000000000d1b29e
- (id)initWithPoint:(struct CGPoint)arg1 timestamp:(double)arg2 window:(id)arg3;	// IMP=0x0000000000d1b1f3
