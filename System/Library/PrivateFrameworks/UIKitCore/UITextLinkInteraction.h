...
+ (id)interactionWithShouldProxyContextMenuDelegate:(_Bool)arg1;	// IMP=0x00600000013e6256
- (void).cxx_destruct;	// IMP=0x00000000013e62b1
...
- (void)dismissEditMenuOnSelectionChangeIfNecessary;	// IMP=0x00000000013e629a
