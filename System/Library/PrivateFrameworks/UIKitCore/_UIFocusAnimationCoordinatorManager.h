...
+ (id)animationCoordinatorForContext:(id)arg1;	// IMP=0x00600000009155a4
+ (id)activeCoordinatorMap;	// IMP=0x006000000091553f
- (void).cxx_destruct;	// IMP=0x0000000000916000
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x0000000000915f13
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x0000000000915e4f
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x0000000000915821
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x0000000000915645
- (id)init;	// IMP=0x00000000009154b5
