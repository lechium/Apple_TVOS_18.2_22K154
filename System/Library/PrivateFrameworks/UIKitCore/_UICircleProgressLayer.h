...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000081af4b
- (void).cxx_destruct;	// IMP=0x000000000081b2b6
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000081afc0
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000081ad7b
- (id)init;	// IMP=0x000000000081ac41
