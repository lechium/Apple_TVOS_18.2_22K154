...
- (void).cxx_destruct;	// IMP=0x0000000000f1d7d5
...
- (void)_displayLinkFired:(id)arg1;	// IMP=0x0000000000f1d0ab
- (void)_setSoundReactiveCursorEnabled:(_Bool)arg1;	// IMP=0x0000000000f1ce31
- (void)_setCursorGlowEffectEnabled:(_Bool)arg1;	// IMP=0x0000000000f1cbba
- (void)cursorShapeDidChange;	// IMP=0x0000000000f1c57b
- (void)setNeedsInitialDictationAnimation;	// IMP=0x0000000000f1c571
- (id)initWithCursorShapeView:(id)arg1;	// IMP=0x0000000000f1c31c
