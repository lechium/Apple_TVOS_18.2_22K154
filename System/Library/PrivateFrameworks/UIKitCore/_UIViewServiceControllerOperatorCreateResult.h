...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000157f850
- (void).cxx_destruct;	// IMP=0x000000000157f8cd
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000157f5e7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000157f43b
