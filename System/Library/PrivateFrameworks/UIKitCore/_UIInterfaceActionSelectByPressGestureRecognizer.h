...
- (void).cxx_destruct;	// IMP=0x0000000000267fc6
...
- (void)_gestureChanged:(id)arg1;	// IMP=0x0000000000267e79
- (void)reset;	// IMP=0x0000000000267e36
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000267d38
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000267ca3
- (id)initWithFocusedInterfaceActionPressDelegate:(id)arg1;	// IMP=0x0000000000267bff
