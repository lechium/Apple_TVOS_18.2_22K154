...
- (void).cxx_destruct;	// IMP=0x0000000000670bfd
...
- (double)_resizeAnimationDuration;	// IMP=0x0000000000670a3b
- (struct CGSize)_minimumSizeForDismissButton;	// IMP=0x00000000006709ab
- (_Bool)_shouldDisableAvoidsKeyboard;	// IMP=0x00000000006708b0
- (CDStruct_758ece87)_currentLayoutGeometry;	// IMP=0x00000000006706dc
- (void)_handleDismiss:(id)arg1;	// IMP=0x00000000006705c1
- (void)_dismiss;	// IMP=0x00000000006704da
@property(nonatomic) _Bool dismissActionUsesShorterHeightWhenCompactVertically;
- (void)endPseudoAlertPresentationMode;	// IMP=0x0000000000670344
- (void)beginPseudoAlertPresentationMode;	// IMP=0x0000000000670223
@property(copy, nonatomic) NSString *dismissActionTitle;
- (void)_updateForKeyboardStartFrame:(struct CGRect)arg1 endFrame:(struct CGRect)arg2 duration:(double)arg3 curve:(long long)arg4;	// IMP=0x000000000066ff07
- (void)_keyboardChanged:(id)arg1;	// IMP=0x000000000066fcfc
- (void)_unsubscribeFromKeyboardNotifications;	// IMP=0x000000000066fc30
- (void)_subscribeToKeyboardNotifications;	// IMP=0x000000000066fb5d
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x000000000066f708
- (void)dismissalTransitionWillBegin;	// IMP=0x000000000066f615
- (void)_willRunTransitionForCurrentStateDeferred:(_Bool)arg1;	// IMP=0x000000000066f5c0
- (void)presentationTransitionWillBegin;	// IMP=0x000000000066f2b1
- (struct CGSize)preferredContentSize;	// IMP=0x000000000066f278
- (void)_applyVisualAffordancesToViews;	// IMP=0x000000000066f1c8
- (void)_layoutViews;	// IMP=0x000000000066efbc
- (struct CGRect)_frameOfPresentedViewControllerViewInSuperview;	// IMP=0x000000000066ef9d
- (struct CGRect)frameOfPresentedViewInContainerView;	// IMP=0x000000000066ee1b
- (void)_transitionToPresentationController:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000066edd7
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000066ecb9
- (struct UIEdgeInsets)_baseContentInsetsWithLeftMargin:(double *)arg1 rightMargin:(double *)arg2;	// IMP=0x000000000066ead8
- (_Bool)_shouldOccludeDuringPresentation;	// IMP=0x000000000066ead0
- (_Bool)_shouldPresentedViewControllerControlStatusBarAppearance;	// IMP=0x000000000066eac8
- (_Bool)shouldPresentInFullscreen;	// IMP=0x000000000066ea74
- (void)dealloc;	// IMP=0x000000000066e9f2
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2 visualStyle:(id)arg3;	// IMP=0x000000000066e768
