...
- (void).cxx_destruct;	// IMP=0x0000000001273748
...
- (void)stopTransitionsImmediately;	// IMP=0x000000000127360a
- (void)_startCustomTransition:(id)arg1;	// IMP=0x0000000001272dbe
- (void)_startTransition:(int)arg1 fromViewController:(id)arg2 toViewController:(id)arg3;	// IMP=0x000000000127274a
- (void)_finishAnimationTracking;	// IMP=0x00000000012726f6
- (void)_beginAnimationTrackingInteractive:(_Bool)arg1;	// IMP=0x0000000001272662
- (void)startDeferredTransitionIfNeeded;	// IMP=0x0000000001271ee9
- (void)setNeedsDeferredTransition;	// IMP=0x0000000001271edf
- (id)interruptibleNavigationTransitionAnimator;	// IMP=0x0000000001271e65
- (_Bool)hasInterruptibleNavigationTransition;	// IMP=0x0000000001271db3
- (_Bool)willPerformCustomTransition;	// IMP=0x0000000001271da5
...
- (_Bool)shouldAnimateBottomBarVisibility;	// IMP=0x0000000001271cfc
- (_Bool)shouldCrossFadeBottomBars;	// IMP=0x0000000001271cc3
- (double)navigationBarHidingDurationWithDefaultDuration:(double)arg1;	// IMP=0x0000000001271c46
- (_Bool)shouldCrossFadeNavigationBarVisibility;	// IMP=0x0000000001271c0d
- (_Bool)shouldCrossFadeNavigationBar;	// IMP=0x0000000001271bd4
- (id)navigationToolbarTransitionController;	// IMP=0x0000000001271b53
- (id)navigationBarTransitionOverlay;	// IMP=0x0000000001271b0d
- (long long)navigationBarTransitionVariant;	// IMP=0x0000000001271ac3
- (id)initWithDelegate:(id)arg1 transitionManager:(id)arg2;	// IMP=0x0000000001271a30
