...
- (void).cxx_destruct;	// IMP=0x0000000000e393f6
@property(nonatomic) struct CGRect sectionFrame; // @synthesize sectionFrame=_sectionFrame;
@property(nonatomic) long long section; // @synthesize section=_section;
@property(nonatomic) __weak UICollectionView *collectionView; // @synthesize collectionView=_collectionView;
- (id)_fallbackFocusItemForMovementRequest:(id)arg1 inFocusMap:(id)arg2 withSnapshot:(id)arg3;	// IMP=0x0000000000e38a9a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e3890c
- (id)_focusRegionWithAdjustedFrame:(struct CGRect)arg1 coordinateSpace:(id)arg2;	// IMP=0x0000000000e38822
