...
- (void).cxx_destruct;	// IMP=0x0000000000a89d39
...
- (id)description;	// IMP=0x0000000000a89bfb
- (void)describeInto:(id)arg1;	// IMP=0x0000000000a89b25
...
- (_Bool)bg2HasHeight;	// IMP=0x0000000000a89abc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a899a8
- (id)initWithLayout:(id)arg1;	// IMP=0x0000000000a898e4
- (id)init;	// IMP=0x0000000000a898d0
