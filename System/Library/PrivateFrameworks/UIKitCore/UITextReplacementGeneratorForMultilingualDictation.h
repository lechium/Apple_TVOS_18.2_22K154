...
- (void).cxx_destruct;	// IMP=0x00000000014391ff
...
- (id)replacements;	// IMP=0x0000000001438f16
- (id)initWithMultilingualAlternatives:(id)arg1 stringToReplace:(id)arg2 replacementRange:(id)arg3;	// IMP=0x0000000001438e53
