...
- (void).cxx_destruct;	// IMP=0x000000000096ebd7
...
- (id)description;	// IMP=0x000000000096ea0b
- (void)drawVisualRepresentationInContext:(struct CGContext *)arg1 imageFrame:(struct CGRect)arg2;	// IMP=0x000000000096e82c
- (id)visualRepresentationColor;	// IMP=0x000000000096e5f9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000096e55f
