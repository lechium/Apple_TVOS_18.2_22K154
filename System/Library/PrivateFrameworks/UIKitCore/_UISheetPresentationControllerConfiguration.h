...
+ (_Bool)supportsBSXPCSecureCoding;	// IMP=0x00100000013c6fd4
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000013c6fcc
+ (id)_fullScreenConfiguration;	// IMP=0x00100000013c52c1
- (void).cxx_destruct;	// IMP=0x00000000013c724f
...
- (void)encodeWithBSXPCCoder:(id)arg1;	// IMP=0x00000000013c6b90
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000013c674f
- (id)initWithBSXPCCoder:(id)arg1;	// IMP=0x00000000013c6385
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000013c5f95
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000013c5a39
- (_Bool)_shouldFenceChangeToConfiguration:(id)arg1;	// IMP=0x00000000013c5a1f
- (_Bool)_isEqual:(id)arg1 onlyCheckPropertiesRequiringFencing:(_Bool)arg2;	// IMP=0x00000000013c52f9
- (id)init;	// IMP=0x00000000013c50fe
