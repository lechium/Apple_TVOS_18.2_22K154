...
- (void).cxx_destruct;	// IMP=0x00000000002d0c13
...
- (_Bool)_animateForInterval:(double)arg1;	// IMP=0x00000000002d0905
- (void)runWithValueApplier:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000002d0895
- (id)initWithValue:(double)arg1 targetValue:(double)arg2 convergenceRate:(double)arg3 minimumDifference:(double)arg4;	// IMP=0x00000000002d0809
