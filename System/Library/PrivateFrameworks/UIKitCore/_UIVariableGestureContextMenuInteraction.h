...
- (_Bool)_clickPresentationInteractionShouldPlayFeedback:(id)arg1;	// IMP=0x0000000000b930ad
- (void)_willBeginWithConfiguration:(id)arg1;	// IMP=0x0000000000b9300b
@property(nonatomic, setter=_setPresentOnTouchDown:) _Bool _presentOnTouchDown;
- (long long)menuAppearance;	// IMP=0x0000000000b92f27
- (id)_interactionDrivers;	// IMP=0x0000000000b92db6
- (void)didMoveToView:(id)arg1;	// IMP=0x0000000000b92d25
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000b92cd4
