...
+ (_Bool)prefersCancelsTouchesInView;	// IMP=0x001000000110fae4
+ (_Bool)requiresForceCapability;	// IMP=0x001000000110fadc
- (void).cxx_destruct;	// IMP=0x00000000011100cf
...
- (void)_handleGestureRecognizer:(id)arg1;	// IMP=0x000000000110fded
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x000000000110fdc9
- (_Bool)gestureRecognizer:(id)arg1 shouldBeRequiredToFailByGestureRecognizer:(id)arg2;	// IMP=0x000000000110fce9
- (_Bool)_gestureRecognizer:(id)arg1 canCancelGestureRecognizer:(id)arg2;	// IMP=0x000000000110fce1
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x000000000110fcd9
@property(readonly, nonatomic) _Bool allowsFeedback;
// Preceding property had unknown attributes: ?
// Original attribute string: TB,?,R,N

- (struct CGPoint)locationInCoordinateSpace:(id)arg1;	// IMP=0x000000000110fc1f
- (void)cancelInteraction;	// IMP=0x000000000110fbdd
...
- (id)init;	// IMP=0x000000000110fa53
