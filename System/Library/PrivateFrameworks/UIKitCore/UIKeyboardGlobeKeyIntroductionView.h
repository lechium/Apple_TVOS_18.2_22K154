...
- (void).cxx_destruct;	// IMP=0x000000000040a9e2
...
- (void)continueButtonTapped;	// IMP=0x000000000040a80e
- (long long)backdropStyleForRenderConfig:(id)arg1;	// IMP=0x000000000040a7f9
- (void)layoutSubviews;	// IMP=0x000000000040992e
- (id)initWithFrame:(struct CGRect)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000040930b
