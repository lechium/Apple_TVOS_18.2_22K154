...
+ (id)inlineTextCompletion:(id)arg1 source:(id)arg2;	// IMP=0x006000000150a7ff
- (void).cxx_destruct;	// IMP=0x000000000150a9e2
...
- (id)initWithCompletion:(id)arg1 source:(id)arg2;	// IMP=0x000000000150a875
