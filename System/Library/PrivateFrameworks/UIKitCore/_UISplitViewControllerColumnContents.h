...
- (void).cxx_destruct;	// IMP=0x000000000078dfe5
...
- (id)description;	// IMP=0x000000000078dee5
@property(readonly, nonatomic) UIViewController *viewController; // @synthesize viewController=_viewController;
- (id)initWithViewController:(id)arg1 navigationController:(id)arg2 navigationControllerWrapper:(id)arg3;	// IMP=0x000000000078dd56
