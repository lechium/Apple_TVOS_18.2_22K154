...
+ (id)settingsControllerModule;	// IMP=0x006000000117e7d1
- (void).cxx_destruct;	// IMP=0x000000000117eb36
...
- (id)springAnimationBehavior;	// IMP=0x000000000117ea96
- (void)setDefaultValues;	// IMP=0x000000000117e76b
