...
- (void).cxx_destruct;	// IMP=0x0000000000c34c5f
...
- (void)endMultiselectInteraction;	// IMP=0x0000000000c34b43
- (void)beginMultiselectInteraction;	// IMP=0x0000000000c34b39
@property(readonly, nonatomic, getter=isInMultiselectInteraction) _Bool inMultiselectInteraction;
- (id)pathsToDeselectForInterpolatedIndexPaths:(id)arg1 currentlySelectedIndexPaths:(id)arg2;	// IMP=0x0000000000c34a47
- (id)pathsToSelectForInterpolatedIndexPaths:(id)arg1;	// IMP=0x0000000000c34989
- (void)beginSelectingWithStartingIndexPath:(id)arg1 otherSelectedIndexPaths:(id)arg2 keepCurrentSelection:(_Bool)arg3;	// IMP=0x0000000000c348c5
- (void)updateStateWithStartingIndexPath:(id)arg1 otherSelectedIndexPaths:(id)arg2;	// IMP=0x0000000000c34784
- (void)updateStateWithDifferenceFromCurrentSelection:(id)arg1;	// IMP=0x0000000000c343ce
- (_Bool)stillValidForSelectedIndexPaths:(id)arg1;	// IMP=0x0000000000c34360
@property(readonly, nonatomic) _Bool ignoringSelectionChangedNotifications;
- (void)ignoreSelectionChangedNotificationsWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000c34334
- (id)initWithCurrentSelection:(id)arg1;	// IMP=0x0000000000c3424e
