...
- (void).cxx_destruct;	// IMP=0x00000000015947a3
...
- (_Bool)_canDisplayTabInBar:(id)arg1;	// IMP=0x0000000001594716
- (id)_listItemsFromFavoriteOrder;	// IMP=0x0000000001594448
- (id)_listItemsFromOverrideFavoriteOrder;	// IMP=0x000000000159406a
- (id)_listItemsForTabs:(id)arg1 customizableOnly:(_Bool)arg2;	// IMP=0x0000000001593b42
- (void)_insertIdentifiersFromItems:(id)arg1 intoSet:(id)arg2;	// IMP=0x0000000001593780
- (void)_parseTabs:(id)arg1 fixedTabs:(id)arg2 sourceTabs:(id)arg3 pinnedTabs:(id)arg4 sourceIdentifiers:(id)arg5;	// IMP=0x000000000159347a
