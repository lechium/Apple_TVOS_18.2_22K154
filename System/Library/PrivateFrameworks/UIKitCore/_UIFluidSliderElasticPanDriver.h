...
- (void).cxx_destruct;	// IMP=0x00000000000d6d80
- (void)handleGesture:(id)arg1;	// IMP=0x00000000000d6960
@property(nonatomic) _Bool enabled; // @synthesize enabled;
@property(nonatomic) __weak UIView *view; // @synthesize view;
- (void)cancel;	// IMP=0x00000000000d5a60
- (void)stop;	// IMP=0x00000000000d59d0
- (id)init;	// IMP=0x00000000000d59b0
...
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000d6eb0
