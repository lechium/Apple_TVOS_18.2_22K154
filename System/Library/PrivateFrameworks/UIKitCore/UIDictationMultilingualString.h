...
- (void).cxx_destruct;	// IMP=0x0000000000d9cea1
...
- (id)dictionaryValue;	// IMP=0x0000000000d9cd3d
- (id)description;	// IMP=0x0000000000d9cced
- (unsigned long long)hash;	// IMP=0x0000000000d9cc61
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d9cb64
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d9cab1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000d9ca3a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000d9c943
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000d9c876
- (id)initWithText:(id)arg1 forLanguage:(id)arg2;	// IMP=0x0000000000d9c7bd
