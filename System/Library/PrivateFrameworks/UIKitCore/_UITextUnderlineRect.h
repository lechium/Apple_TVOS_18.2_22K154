...
+ (id)underlineRectWithRect:(struct CGRect)arg1 offset:(double)arg2 transform:(struct CGAffineTransform)arg3;	// IMP=0x0060000000f63dd1
- (void).cxx_destruct;	// IMP=0x0000000000f6409f
...
- (id)description;	// IMP=0x0000000000f63eeb
@property(readonly, nonatomic) struct CGRect fullRect;
- (id)init;	// IMP=0x0000000000f63e70
