...
- (id)_symbolConfigurationForSource:(id)arg1;	// IMP=0x0000000000be08c3
- (long long)_effectiveRenderingModeForSource:(id)arg1 symbolConfiguration:(id)arg2;	// IMP=0x0000000000be08ab
- (id)_renditionForSource:(id)arg1 size:(struct CGSize)arg2 symbolConfiguration:(id)arg3 withRenditionResult:(id)arg4;	// IMP=0x0000000000be06d6
- (id)_effectForRenderingSource:(id)arg1;	// IMP=0x0000000000be06cd
- (struct UIEdgeInsets)_additionalAlignmentRectInsetsForRenderingSource:(id)arg1;	// IMP=0x0000000000be06ba
