...
- (void).cxx_destruct;	// IMP=0x000000000097d4f9
...
- (id)captureSnapshot;	// IMP=0x000000000097d2f3
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x000000000097ca1d
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x000000000097c745
- (id)init;	// IMP=0x000000000097c6be
