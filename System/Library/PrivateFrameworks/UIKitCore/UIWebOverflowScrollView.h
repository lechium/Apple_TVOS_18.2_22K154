...
- (void)setContentOffset:(struct CGPoint)arg1;	// IMP=0x00000000017970a6
- (_Bool)fixUpViewAfterInsertion;	// IMP=0x000000000179703a
- (id)superview;	// IMP=0x0000000001796f6e
- (void)willBeRemoved;	// IMP=0x0000000001796f5a
- (void)replaceLayer:(id)arg1;	// IMP=0x0000000001796f1d
- (void)dealloc;	// IMP=0x0000000001796ea9
- (id)initWithLayer:(id)arg1 node:(id)arg2 webBrowserView:(id)arg3;	// IMP=0x0000000001796d8e
