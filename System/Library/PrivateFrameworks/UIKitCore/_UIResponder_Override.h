...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x00600000010ee8e2
- (void).cxx_destruct;	// IMP=0x00000000010eed37
...
- (id)description;	// IMP=0x00000000010eeb1e
- (void)dealloc;	// IMP=0x00000000010eea79
