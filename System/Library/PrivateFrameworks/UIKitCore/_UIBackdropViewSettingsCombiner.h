...
- (void).cxx_destruct;	// IMP=0x00000000002f915e
...
- (void)computeOutputSettingsUsingModel:(id)arg1;	// IMP=0x00000000002f8aa0
- (_Bool)isBackdropVisible;	// IMP=0x00000000002f8a98
- (_Bool)requiresBackdropLayer;	// IMP=0x00000000002f8a90
- (void)setRequiresColorStatistics:(_Bool)arg1;	// IMP=0x00000000002f8a5f
- (void)copyAdditionalSettingsFromSettings:(id)arg1;	// IMP=0x00000000002f88bd
- (void)setDefaultValues;	// IMP=0x00000000002f8888
