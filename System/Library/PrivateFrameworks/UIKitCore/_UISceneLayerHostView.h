...
- (void).cxx_destruct;	// IMP=0x0000000000a09d20
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000a09be8
- (id)initWithSceneLayer:(id)arg1;	// IMP=0x0000000000a09a99
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000a09a12
