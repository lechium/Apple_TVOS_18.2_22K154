...
- (id)ui_allSupplementalCandidates;	// IMP=0x0030000000336abd
...
- (long long)sourceForAutocorrection;	// IMP=0x0030000000bd9b3e
- (void)updateLabelsWithSmartPunctuation:(id)arg1;	// IMP=0x0030000000bd9875
@end
