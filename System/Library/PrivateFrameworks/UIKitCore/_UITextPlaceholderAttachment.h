...
- (void).cxx_destruct;	// IMP=0x0000000001498815
...
- (id)imageForBounds:(struct CGRect)arg1 textContainer:(id)arg2 characterIndex:(unsigned long long)arg3;	// IMP=0x00000000014987bf
