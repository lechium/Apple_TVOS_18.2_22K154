...
+ (id)info;	// IMP=0x0060000000dece3c
- (void).cxx_destruct;	// IMP=0x0000000000dedd28
...
- (id)description;	// IMP=0x0000000000ded9fa
- (void)addKeyboardNotificationDebuggingInfo:(id)arg1;	// IMP=0x0000000000ded8ed
- (void)populateEndInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000ded83a
- (void)populateStartInfoWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000ded7ba
- (void)populateWithAnimationStyle:(id)arg1;	// IMP=0x0000000000ded742
- (_Bool)containsChange;	// IMP=0x0000000000ded6c1
- (void)logGeometry;	// IMP=0x0000000000ded6bb
@property(readonly, nonatomic) NSDictionary *privateUserInfo;
- (id)rotationUserInfo;	// IMP=0x0000000000ded369
@property(readonly, nonatomic) NSDictionary *userInfo;
- (id)inverseInfo;	// IMP=0x0000000000decf67
- (id)init;	// IMP=0x0000000000dece55
