...
- (void).cxx_destruct;	// IMP=0x0000000000edbf5a
...
- (id)init;	// IMP=0x0000000000edbe61
- (void)reset;	// IMP=0x0000000000edbddf
- (void)addTypingTouchTime:(double)arg1;	// IMP=0x0000000000edbd98
- (void)logUserTyping:(id)arg1;	// IMP=0x0000000000edbd1e
- (void)typingCadence:(double)arg1;	// IMP=0x0000000000edba25
- (void)updateConfidenceWithGap:(double)arg1;	// IMP=0x0000000000edb97f
- (id)recognizer:(id)arg1 confidenceWhenSettingTouchInfo:(id)arg2;	// IMP=0x0000000000edb977
- (id)recognizer:(id)arg1 confidenceWhenPendingTouchInfo:(id)arg2;	// IMP=0x0000000000edb8f2
