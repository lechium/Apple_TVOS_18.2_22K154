...
- (void).cxx_destruct;	// IMP=0x0000000000dce545
...
- (long long)updateToCategoryWithOffsetPercentage:(double)arg1;	// IMP=0x0000000000dce510
- (void)updateToCategory:(long long)arg1;	// IMP=0x0000000000dce50a
