...
+ (id)settingsControllerModule;	// IMP=0x0010000001493e56
...
- (void)setDefaultValues;	// IMP=0x0000000001493dc9
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x0000000001493b3e
- (id)initWithDefaultValues;	// IMP=0x0000000001493aef
