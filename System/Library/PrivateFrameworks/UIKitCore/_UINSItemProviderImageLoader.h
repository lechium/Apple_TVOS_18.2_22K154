...
- (void).cxx_destruct;	// IMP=0x00000000008c6b70
@property(retain, setter=_setProgress:) NSProgress *_progress; // @synthesize _progress=__progress;
- (_Bool)_really_cancel;	// IMP=0x00000000008c6b09
- (void)_really_loadImage:(CDUnknownBlockType)arg1;	// IMP=0x00000000008c6985
- (id)initWithItemProvider:(id)arg1 typeIdentifier:(id)arg2;	// IMP=0x00000000008c68a1
