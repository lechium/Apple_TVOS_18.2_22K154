...
- (void).cxx_destruct;	// IMP=0x0000000000fedd18
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000fedb67
- (void)stopAnimation;	// IMP=0x0000000000fedafe
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000fed985
- (id)init;	// IMP=0x0000000000fed977
