...
- (void).cxx_destruct;	// IMP=0x0000000000458c77
...
- (void)enumerateBadgeTextAttributesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000458b3b
- (id)badgeTextAttributesForState:(unsigned long long)arg1;	// IMP=0x0000000000458ab4
- (void)setBadgeTextAttributes:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x000000000045893a
