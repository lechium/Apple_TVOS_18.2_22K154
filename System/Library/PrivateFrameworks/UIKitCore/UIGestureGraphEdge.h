...
- (void).cxx_destruct;	// IMP=0x0000000000a8c20b
...
- (id)description;	// IMP=0x0000000000a8c0bc
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x0000000000a8bf25
- (id)oppositeNode:(id)arg1;	// IMP=0x0000000000a8bee8
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x0000000000a8bd68
