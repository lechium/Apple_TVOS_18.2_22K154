...
- (void).cxx_destruct;	// IMP=0x0000000000642dc9
...
- (double)speed;	// IMP=0x0000000000642c8b
- (void)addValue:(double)arg1;	// IMP=0x0000000000642bc6
- (id)init;	// IMP=0x0000000000642a64
