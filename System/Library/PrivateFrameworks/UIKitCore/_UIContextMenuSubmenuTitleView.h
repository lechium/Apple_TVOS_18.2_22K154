...
- (void).cxx_destruct;	// IMP=0x0000000000bbd7c7
...
- (_Bool)_wantsKeyCommandsWhenDeferred;	// IMP=0x0000000000bbd6ea
- (long long)focusItemDeferralMode;	// IMP=0x0000000000bbd6d1
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000bbd62e
- (_Bool)canBecomeFocused;	// IMP=0x0000000000bbd61c
- (void)setDirectionalLayoutMargins:(struct NSDirectionalEdgeInsets)arg1;	// IMP=0x0000000000bbd57d
- (void)addObscuringMaterialViewWithGroupName:(id)arg1;	// IMP=0x0000000000bbd3ad
- (void)setBackgroundMaterialGroupName:(id)arg1;	// IMP=0x0000000000bbcfe4
- (void)didMoveToWindow;	// IMP=0x0000000000bbceee
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000bbcafc
