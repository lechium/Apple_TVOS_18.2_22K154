...
+ (id)accessoryWithIdentifier:(id)arg1;	// IMP=0x00600000012eb115
- (void).cxx_destruct;	// IMP=0x00000000012eb353
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000012eb2fb
- (id)description;	// IMP=0x00000000012eb230
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000012eb15e
- (id)init;	// IMP=0x00000000012eb0d9
