...
- (void).cxx_destruct;	// IMP=0x00000000001a4260
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a41a0
- (void)updateConfiguration;	// IMP=0x00000000001a39c0
- (void)layoutSubviews;	// IMP=0x00000000001a3990
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x00000000001a37b0
@property(nonatomic, readonly) _Bool _allowsSymbolAnimations;
@property(nonatomic, readonly) unsigned long long behavioralStyle;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001a3760
