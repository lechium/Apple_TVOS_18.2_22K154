...
+ (id)leftShadowImage;	// IMP=0x0060000000bbc441
+ (double)widthWithShadow:(_Bool)arg1;	// IMP=0x0060000000bbc425
...
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000bbca41
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000bbc540
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000bbc4b8
