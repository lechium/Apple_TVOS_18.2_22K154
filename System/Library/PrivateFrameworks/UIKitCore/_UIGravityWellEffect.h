...
+ (id)effectWithDescriptor:(id)arg1 continuationPreview:(id)arg2;	// IMP=0x001000000066b030
- (void).cxx_destruct;	// IMP=0x000000000066e322
...
- (id)_criticallyDampedEffectSpringBehavior;	// IMP=0x000000000066e20c
- (id)_effectSpringBehavior;	// IMP=0x000000000066e1af
- (void)_performAllCompletions;	// IMP=0x000000000066e092
- (void)_tearDownEffectViews;	// IMP=0x000000000066deef
- (void)_updateToProgress:(double)arg1 state:(long long)arg2;	// IMP=0x000000000066d491
- (void)_installEffectViews;	// IMP=0x000000000066c31a
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000066c28d
- (id)previewForContinuingToEffectWithPreview:(id)arg1;	// IMP=0x000000000066bbf0
- (void)setDescriptor:(id)arg1 andKey:(id)arg2;	// IMP=0x000000000066bbdf
- (void)endForHandOff;	// IMP=0x000000000066bb3a
- (void)end;	// IMP=0x000000000066bab9
- (void)updateWithProgress:(double)arg1;	// IMP=0x000000000066ba76
- (void)begin;	// IMP=0x000000000066b9b5
