...
- (void).cxx_destruct;	// IMP=0x0000000000c83e71
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000c83d7c
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000c83cea
- (void)configurePortalViewIfNeededForTargetScreen:(id)arg1;	// IMP=0x0000000000c83bd7
- (void)layoutSubviews;	// IMP=0x0000000000c83a65
- (void)configureSensorViewWithoutPortalIfNeededForTargetScreen:(id)arg1;	// IMP=0x0000000000c83796
