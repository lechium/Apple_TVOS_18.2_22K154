...
- (void).cxx_destruct;	// IMP=0x0000000000670fc2
...
- (_Bool)currentSateCanTransitionWithEvents:(id)arg1;	// IMP=0x0000000000670e84
@property(readonly, nonatomic) unsigned long long *currentStateRef;
- (void)_updateFromState:(unsigned long long)arg1;	// IMP=0x0000000000670e54
- (id)initWithUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000670d64
