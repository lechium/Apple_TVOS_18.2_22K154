...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b4f7fe
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x0000000000b4f784
- (void)dealloc;	// IMP=0x0000000000b4f72b
