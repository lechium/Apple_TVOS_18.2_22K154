...
- (void).cxx_destruct;	// IMP=0x000000000093949a
...
- (_Bool)_shouldInferDefaultPreferenceForEnvironmentInContext:(id)arg1;	// IMP=0x00000000009393b5
- (void)enumeratePreferencesForEnvironment:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000938c10
- (id)initWithEnumerationMode:(long long)arg1;	// IMP=0x0000000000938bcf
- (id)init;	// IMP=0x0000000000938bbb
