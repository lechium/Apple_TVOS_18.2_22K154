...
- (void).cxx_destruct;	// IMP=0x0000000000f7f8ba
...
- (void)updateControlWithDirection:(long long)arg1 travelProgress:(double)arg2 isRTL:(_Bool)arg3;	// IMP=0x0000000000f7f5ea
- (void)controlActionUpOutside:(id)arg1;	// IMP=0x0000000000f7f587
- (void)controlActionUpInside:(id)arg1 forEvent:(id)arg2;	// IMP=0x0000000000f7f37e
- (void)controlActionDown:(id)arg1;	// IMP=0x0000000000f7f2e0
- (void)performDelegateRedoAndUpdateHUDIfNeeded;	// IMP=0x0000000000f7f262
- (void)performDelegateUndoAndUpdateHUDIfNeeded;	// IMP=0x0000000000f7f1e4
- (void)updateHUDControlState;	// IMP=0x0000000000f7eeda
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000f7ee66
- (_Bool)availableOfControl:(id)arg1;	// IMP=0x0000000000f7ed68
- (id)controlForType:(long long)arg1;	// IMP=0x0000000000f7ebe6
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000f7eb73
- (void)layoutSubviews;	// IMP=0x0000000000f7ea6f
- (id)createSeparatorView;	// IMP=0x0000000000f7e934
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2 mode:(long long)arg3 sceneBounds:(struct CGRect)arg4;	// IMP=0x0000000000f7bf43
