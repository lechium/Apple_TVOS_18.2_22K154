...
@class FMDFMIPAccountInfo, FMDLostModeInfo, FMDRepairDeviceContext, NSData, NSDictionary, NSString;

@protocol FMDFMIPProtocol <NSObject>
- (oneway void)enableRepairWithContext:(FMDRepairDeviceContext *)arg1 completion:(void (^)(FMDRepairDeviceResult *, NSError *))arg2;
- (oneway void)deviceEligibleForRepairWithContext:(FMDRepairDeviceContext *)arg1 completion:(void (^)(FMDRepairDeviceResult *, NSError *))arg2;
