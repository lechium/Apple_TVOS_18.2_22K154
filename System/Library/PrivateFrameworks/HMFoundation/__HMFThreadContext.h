...
+ (id)currentContext;	// IMP=0x0040000000042139
- (void).cxx_destruct;	// IMP=0x000000000004236b
...
- (id)description;	// IMP=0x00000000000422b3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000042221
- (unsigned long long)hash;	// IMP=0x0000000000042204
- (id)__init;	// IMP=0x00000000000421d5
- (id)init;	// IMP=0x0000000000042091
