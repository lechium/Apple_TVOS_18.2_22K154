...
- (void).cxx_destruct;	// IMP=0x0000000000051e40
...
- (_Bool)shouldFetchProtectedKey:(id)arg1;	// IMP=0x0000000000051c1c
- (_Bool)shouldFetchUserAssignedDeviceName;	// IMP=0x0000000000051b74
- (void)dealloc;	// IMP=0x0000000000051b2d
- (id)init;	// IMP=0x000000000005104a
