...
+ (id)shortDescription;	// IMP=0x001000000006c364
+ (id)timeIntervalDescription:(double)arg1;	// IMP=0x001000000006c5ef
- (id)hmf_dateComponentsUsingTimeZone:(id)arg1;	// IMP=0x001000000006c550
