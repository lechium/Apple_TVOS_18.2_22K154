...
+ (id)logCategory;	// IMP=0x001000000003ea62
- (void).cxx_destruct;	// IMP=0x000000000003eb79
...
- (id)logIdentifier;	// IMP=0x000000000003eac9
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (void)invalidate;	// IMP=0x000000000003ea03
- (void)setWatchdogTimeout:(double)arg1;	// IMP=0x000000000003e9a8
- (double)watchdogTimeout;	// IMP=0x000000000003e8e7
@property double connectionIdleTimeout;
- (void)dealloc;	// IMP=0x000000000003e63f
- (id)initWithPort:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x000000000003d6ce
- (id)init;	// IMP=0x000000000003d626
