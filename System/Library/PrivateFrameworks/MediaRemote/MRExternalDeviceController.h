...
+ (Class)externalDeviceClass;	// IMP=0x001000000017d807
- (void).cxx_destruct;	// IMP=0x000000000017e7f3
...
- (_Bool)_isManagedConfigIDAllowed:(id)arg1;	// IMP=0x000000000017e499
- (void)netService:(id)arg1 didUpdateTXTRecordData:(id)arg2;	// IMP=0x000000000017e3ef
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x000000000017e0e5
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x000000000017dd7a
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x000000000017dc68
- (void)endDiscovery;	// IMP=0x000000000017dbb6
- (void)beginDiscovery;	// IMP=0x000000000017daf5
- (void)dealloc;	// IMP=0x000000000017da9f
- (id)initWithBonjourServiceType:(id)arg1;	// IMP=0x000000000017d818
