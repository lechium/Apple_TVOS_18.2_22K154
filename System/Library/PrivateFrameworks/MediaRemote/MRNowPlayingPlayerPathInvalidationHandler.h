...
- (void).cxx_destruct;	// IMP=0x00000000001f9ffb
...
- (id)description;	// IMP=0x00000000001f9fbe
- (id)initWithPlayerPath:(id)arg1 invalidateImmediatlyIfInvalid:(_Bool)arg2 queue:(id)arg3 invalidationCallback:(CDUnknownBlockType)arg4;	// IMP=0x00000000001f9eaf
