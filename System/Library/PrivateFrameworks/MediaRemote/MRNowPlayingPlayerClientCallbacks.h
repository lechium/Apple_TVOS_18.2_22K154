...
- (_Bool)removePlaybackQueueDataSourceCallback:(id)arg1;	// IMP=0x00000000001f149f
- (void)registerNowPlayingInfoArtworkAssetCallback:(id)arg1;	// IMP=0x00000000001f10ad
- (void)registerNowPlayingInfoAssetCallbacks:(id)arg1;	// IMP=0x00000000001f0d04
- (void)registerNowPlayingInfoCallbacks:(id)arg1;	// IMP=0x00000000001f0865
- (void)registerNowPlayingInfoBackedPlaybackQueueDataSourceCallbacks;	// IMP=0x00000000001f07fd
@property(readonly, copy, nonatomic) NSArray *commandHandlerBlocks;
- (void)removeCommandHandlerBlockForKey:(id)arg1;	// IMP=0x00000000001f0604
- (void)addCommandHandlerBlock:(CDUnknownBlockType)arg1 forKey:(id)arg2;	// IMP=0x00000000001f04f6
- (unsigned long long)_onQueue_capabilities;	// IMP=0x00000000001f0439
...
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001eef70
