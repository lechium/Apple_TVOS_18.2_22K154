...
- (void).cxx_destruct;	// IMP=0x0000000000027861
...
- (void)_mirrorStateChanged:(_Bool)arg1 screenType:(unsigned int)arg2;	// IMP=0x0000000000027685
- (void)dealloc;	// IMP=0x00000000000275d4
- (id)init;	// IMP=0x000000000002735f
