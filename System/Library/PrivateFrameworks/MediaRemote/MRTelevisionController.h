...
+ (Class)externalDeviceClass;	// IMP=0x00100000001894d6
- (void).cxx_destruct;	// IMP=0x000000000018986d
...
- (void)externalDeviceController:(id)arg1 didRemoveDevice:(id)arg2;	// IMP=0x0000000000189685
- (void)externalDeviceController:(id)arg1 didDiscoverDevice:(id)arg2;	// IMP=0x00000000001894e7
- (id)init;	// IMP=0x000000000018947d
