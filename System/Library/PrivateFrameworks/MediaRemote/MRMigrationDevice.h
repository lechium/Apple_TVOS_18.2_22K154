...
+ (id)proactiveDevice;	// IMP=0x00100000000ed366
- (void).cxx_destruct;	// IMP=0x00000000000ee3f4
...
- (void)_notifyDelegateOfPlayerStateChange;	// IMP=0x00000000000ee249
- (void)_notifyDelegateOfStateChange;	// IMP=0x00000000000ee134
- (void)controllerWillReloadForInvalidation:(id)arg1;	// IMP=0x00000000000ee0a0
- (void)controller:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000edfb3
- (void)controller:(id)arg1 didUpdateResponse:(id)arg2;	// IMP=0x00000000000edfa1
- (void)controller:(id)arg1 didLoadResponse:(id)arg2;	// IMP=0x00000000000eded7
- (void)_checkIfAirPlayPossible;	// IMP=0x00000000000edc94
- (void)prepare;	// IMP=0x00000000000edaf6
...
- (void)dealloc;	// IMP=0x00000000000ed6ea
- (id)dictionaryRepresentation;	// IMP=0x00000000000ed4ca
- (id)initWithUID:(id)arg1;	// IMP=0x00000000000ed396
