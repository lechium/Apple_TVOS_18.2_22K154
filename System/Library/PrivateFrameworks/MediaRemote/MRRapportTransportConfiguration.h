...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000017457
...
- (id)description;	// IMP=0x00000000000175e8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000174cc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001745f
