...
- (void).cxx_destruct;	// IMP=0x00000000001a1258
@property(readonly, nonatomic) MRMediaRemoteService *mediaRemoteService; // @synthesize mediaRemoteService=_mediaRemoteService;
- (void)_pickableRoutesDidChangeNotification:(id)arg1;	// IMP=0x00000000001a110f
- (void)fetchPickableRoutesForCategory:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001a0ac1
- (void)dealloc;	// IMP=0x00000000001a0a4c
- (id)initWithMediaRemoteService:(id)arg1;	// IMP=0x00000000001a085f
- (id)init;	// IMP=0x00000000001a084b
