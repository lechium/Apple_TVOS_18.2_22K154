...
@class AFMultiUserSpeechPackage, AFSpeechInfoPackage, AFSpeechPackage, AFVoiceIdScoreCard, LBLocalSpeechRecognizerClient, NSArray, NSDictionary, NSError, NSString, SMTContinuityEnd, SMTMultiUserTRPCandidate, SMTTRPCandidate, SMTTRPDetected;
...
- (void)localSpeechRecognizerClient:(LBLocalSpeechRecognizerClient *)arg1 receivedMultiUserTRPCandidatePackage:(SMTMultiUserTRPCandidate *)arg2;
- (void)localSpeechRecognizerClient:(LBLocalSpeechRecognizerClient *)arg1 receivedFinalEndpointDetectedAtTime:(double)arg2;
