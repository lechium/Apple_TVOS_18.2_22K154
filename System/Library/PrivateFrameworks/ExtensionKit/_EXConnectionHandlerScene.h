...
- (void).cxx_destruct;	// IMP=0x000000000000bc72
@property(retain) UIViewController *viewController; // @synthesize viewController=_viewController;
- (void)connectToSession:(id)arg1;	// IMP=0x000000000000baa0
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x000000000000b982
