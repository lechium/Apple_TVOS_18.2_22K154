...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x003000000005cc0f
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x00300000000a3b3e
@end
