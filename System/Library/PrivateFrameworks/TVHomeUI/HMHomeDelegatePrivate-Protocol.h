...
@class CLLocation, HMAccessory, HMAccessoryNetworkProtectionGroup, HMActionSet, HMHome, HMHomePersonManagerSettings, HMMediaSystem, HMResidentDevice, HMRoom, HMServiceGroup, HMUser, NSArray, NSError, NSString, NSTimeZone;

@protocol HMHomeDelegatePrivate <HMHomeDelegate>

@optional
- (void)homeDidUpdateAutoSelectedPreferredResident:(HMHome *)arg1;
- (void)homeDidUpdateUserSelectedPreferredResident:(HMHome *)arg1;
- (void)homeDidUpdateSupportsResidentSelection:(HMHome *)arg1;
- (void)home:(HMHome *)arg1 didUpdateTimeZone:(NSTimeZone *)arg2;
...
- (void)home:(HMHome *)arg1 didUpdateSupportsResidentActionSetStateEvaluation:(_Bool)arg2;
...
- (void)home:(HMHome *)arg1 didUpdateDismissedWalletKeyUWBUnlockOnboarding:(_Bool)arg2;
