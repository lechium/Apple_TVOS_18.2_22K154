...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006f6be
- (unsigned long long)hash;	// IMP=0x000000000006f67f
- (id)description;	// IMP=0x000000000006f631
- (void)dealloc;	// IMP=0x000000000006f5e7
