...
@interface SNWiFiRecordInternal : NSObject
{
    ...
    MISSING_TYPE *timestamp;	// 733040 = 0xb2f70
}

- (void).cxx_destruct;	// IMP=0x000000000006c95a
- (id)init;	// IMP=0x000000000006c336
- (id)initWithRssi:(long long)arg1 snr:(long long)arg2 cca:(long long)arg3 channelInfo:(id)arg4 phyMode:(id)arg5 isCaptive:(_Bool)arg6 timestamp:(id)arg7;	// IMP=0x000000000006c24e
