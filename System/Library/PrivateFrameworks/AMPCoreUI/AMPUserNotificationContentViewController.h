...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000004797
- (void)mediaPause;	// IMP=0x000000000000460c
- (void)imageViewTapped:(id)arg1;	// IMP=0x00000000000045cf
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000003e38
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000003d48
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000003a26
- (void)loadView;	// IMP=0x0000000000003643
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000000027e6
