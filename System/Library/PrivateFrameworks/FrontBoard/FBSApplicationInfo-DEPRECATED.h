...
- (long long)_mapSignatureStateFromTrustState:(unsigned long long)arg1;	// IMP=0x0030000000055bd0
- (void)acceptApplicationSignatureIdentity;	// IMP=0x0030000000055ac4
- (id)_signatureValidationService;	// IMP=0x00300000000559aa
...
- (id)_initForProfileManagerTesting;	// IMP=0x00300000000558af
@end
