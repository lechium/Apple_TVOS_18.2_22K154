...
- (void)_addToEngine:(id)arg1;	// IMP=0x000000000001a73c
- (id)secondItem;	// IMP=0x000000000001a734
- (id)firstItem;	// IMP=0x000000000001a72c
- (id)description;	// IMP=0x000000000001a6c7
- (int)nsis_orientationHintForVariable:(id)arg1;	// IMP=0x000000000001a6b5
- (_Bool)nsis_valueOfVariableIsUserObservable:(id)arg1;	// IMP=0x000000000001a6a3
- (id)nsis_descriptionOfVariable:(id)arg1;	// IMP=0x000000000001a691
- (void)nsis_valueOfVariable:(id)arg1 didChangeInEngine:(id)arg2;	// IMP=0x000000000001a68b
- (void)dealloc;	// IMP=0x000000000001a63a
