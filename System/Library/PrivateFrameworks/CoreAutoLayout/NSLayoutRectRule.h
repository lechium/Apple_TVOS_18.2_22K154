...
- (id)makeChildRules;	// IMP=0x0000000000003df1
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003d61
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003d10
- (void)dealloc;	// IMP=0x0000000000003cc6
