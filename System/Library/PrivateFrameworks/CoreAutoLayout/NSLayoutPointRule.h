...
- (id)makeChildRules;	// IMP=0x0000000000003a41
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000039b9
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003968
- (void)dealloc;	// IMP=0x000000000000391e
