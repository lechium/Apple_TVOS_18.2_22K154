...
- (void)updateWithMeasurement:(id)arg1;	// IMP=0x0000000000003aa3
- (void)dealloc;	// IMP=0x0000000000003a40
- (id)initWithContainer:(id)arg1 metric:(id)arg2 unitString:(id)arg3;	// IMP=0x00000000000038dd
