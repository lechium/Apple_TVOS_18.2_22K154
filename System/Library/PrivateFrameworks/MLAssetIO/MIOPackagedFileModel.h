...
- (void).cxx_destruct;	// IMP=0x000000000002980e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000029652
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000029480
@property(readonly, nonatomic) void *irProgram;
- (id)storagePrecisionForFunctionNamed:(id)arg1;	// IMP=0x0000000000029390
- (id)computePrecisionForFunctionNamed:(id)arg1;	// IMP=0x00000000000292f8
- (id)programOperationHistogramForFunctionNamed:(id)arg1;	// IMP=0x0000000000029260
- (id)neuralNetworkLayerHistogramForFunctionNamed:(id)arg1;	// IMP=0x00000000000291c8
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002749a
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002741b
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002625e
