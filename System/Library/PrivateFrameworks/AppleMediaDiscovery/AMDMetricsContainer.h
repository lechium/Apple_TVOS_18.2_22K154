...
- (void).cxx_destruct;	// IMP=0x00000000000b8460
...
- (id)initWithLevel:(BOOL)arg1 andAction:(id)arg2 andVersion:(id)arg3 andBuild:(id)arg4 andStorefrontId:(id)arg5 withLoggingProbability:(id)arg6;	// IMP=0x00000000000b7ba0
