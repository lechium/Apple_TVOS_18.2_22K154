...
- (void).cxx_destruct;	// IMP=0x00000000000872e0
...
- (id)initWithName:(id)arg1 withDefaultValue:(id)arg2 withHelpText:(id)arg3 withShortName:(id)arg4 andIsBoolFlag:(_Bool)arg5;	// IMP=0x0000000000086fc0
