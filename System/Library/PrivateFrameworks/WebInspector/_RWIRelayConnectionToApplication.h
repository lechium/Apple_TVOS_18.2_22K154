...
- (void).cxx_destruct;	// IMP=0x00000000000038f8
...
- (void)sendMessage:(id)arg1 userInfo:(id)arg2;	// IMP=0x0000000000003780
- (void)_handleEvent:(id)arg1;	// IMP=0x00000000000034bc
- (id)_deserializeMessage:(id)arg1;	// IMP=0x0000000000003384
- (void)dealloc;	// IMP=0x0000000000003346
- (void)close;	// IMP=0x0000000000003310
- (id)initWithConnection:(id)arg1;	// IMP=0x00000000000031dc
