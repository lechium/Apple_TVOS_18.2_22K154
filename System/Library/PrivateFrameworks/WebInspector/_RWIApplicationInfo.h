...
+ (id)identifierForPID:(int)arg1;	// IMP=0x00600000000017a4
...
- (_Bool)updateFromListing:(id)arg1;	// IMP=0x0000000000001bb6
- (id)dictionaryRepresentation;	// IMP=0x00000000000018ff
@property(readonly, nonatomic) NSString *identifier; // @dynamic identifier;
- (id)initWithPID:(int)arg1 bundleId:(id)arg2 name:(id)arg3 isProxy:(_Bool)arg4 connection:(id)arg5 debuggerAvailability:(unsigned long long)arg6;	// IMP=0x00000000000017c9
