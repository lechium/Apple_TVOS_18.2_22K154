...
- (void).cxx_destruct;	// IMP=0x000000000001ca07
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001c854
- (unsigned long long)hash;	// IMP=0x000000000001c6b9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001c561
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001c442
- (void)copyTo:(id)arg1;	// IMP=0x000000000001c372
- (void)writeTo:(id)arg1;	// IMP=0x000000000001c291
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001c284
- (id)dictionaryRepresentation;	// IMP=0x000000000001bddf
- (id)description;	// IMP=0x000000000001bd30
