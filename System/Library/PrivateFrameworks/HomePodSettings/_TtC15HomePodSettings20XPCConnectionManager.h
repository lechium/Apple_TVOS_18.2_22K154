...
- (void)removeProfileWithIdentifier:(NSString *)arg1 completionHandler:(void (^)(NSError *))arg2;	// IMP=0x000000000005388c
- (void)installedProfilesWithCompletionHandler:(void (^)(NSDictionary *, NSError *))arg1;	// IMP=0x00000000000536bb
- (void)installProfileWithData:(NSData *)arg1 completionHandler:(void (^)(NSString *, NSError *))arg2;	// IMP=0x00000000000533fa
