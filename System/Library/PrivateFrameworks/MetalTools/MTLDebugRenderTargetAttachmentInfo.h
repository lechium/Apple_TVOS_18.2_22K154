...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b56cb
- (unsigned long long)hash;	// IMP=0x00000000000b56bd
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x00000000000b553b
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x00000000000b53b4
