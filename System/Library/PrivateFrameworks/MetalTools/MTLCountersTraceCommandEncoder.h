...
- (void)endEncoding;	// IMP=0x000000000004f5ee
- (void)setLabel:(id)arg1;	// IMP=0x000000000004f5c8
- (void)popDebugGroup;	// IMP=0x000000000004f559
- (void)pushDebugGroup:(id)arg1;	// IMP=0x000000000004f533
- (void)insertDebugSignpost:(id)arg1;	// IMP=0x000000000004f338
- (id)init:(struct BinaryBuffer *)arg1 flags:(unsigned long long)arg2;	// IMP=0x000000000004f2da
