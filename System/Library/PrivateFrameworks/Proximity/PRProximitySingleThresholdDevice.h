...
- (id).cxx_construct;	// IMP=0x000000000002316d
- (void).cxx_destruct;	// IMP=0x0000000000023117
@property(readonly) NSUUID *peer; // @synthesize peer=_peer;
- (long long)deviceProximity;	// IMP=0x00000000000230f9
- (_Bool)proxReady;	// IMP=0x0000000000023086
- (void)addSample:(struct BtProxData)arg1;	// IMP=0x0000000000023001
- (id)initWithPeer:(id)arg1 andPeerModel:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000000022c82
- (id)init;	// IMP=0x0000000000022c44
