...
- (id).cxx_construct;	// IMP=0x0000000000026f2e
...
- (void)updateScoresWithNewMeasurement:(const void *)arg1;	// IMP=0x0000000000026d41
- (void)updateScoresForTime:(double)arg1;	// IMP=0x00000000000269cc
- (void)reportScoresToClientAlways:(_Bool)arg1 useUpdatedScoreList:(_Bool)arg2 currentMachContTime:(double)arg3;	// IMP=0x0000000000025c06
- (void)heartbeatTimeout:(double)arg1 currentMachContTime:(double)arg2 useUpdatedScores:(_Bool)arg3;	// IMP=0x0000000000025b40
- (void)addBluetoothProximityEstimate:(struct NeighborMeasurements)arg1 currentMachContTime:(double)arg2;	// IMP=0x0000000000025a84
- (void)addRoseSolutions:(id)arg1 currentMachContTime:(double)arg2;	// IMP=0x0000000000024dcf
- (void)createEstimators;	// IMP=0x0000000000024d3a
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000024c2a
- (id)init;	// IMP=0x0000000000024bec
