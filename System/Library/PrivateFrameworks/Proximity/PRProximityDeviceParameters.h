...
- (void).cxx_destruct;	// IMP=0x00000000000120ab
...
- (id)initWithFilter:(void *)arg1 sampleSize:(unsigned long long)arg2 rssiImmediate:(id)arg3 rssiNear:(id)arg4;	// IMP=0x0000000000011fa2
- (id)init;	// IMP=0x0000000000011f64
