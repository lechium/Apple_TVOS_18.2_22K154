...
- (void).cxx_destruct;	// IMP=0x000000000003c7f6
...
- (void)updateWithTuples:(id)arg1 valueColumnIsTrailing:(_Bool)arg2 truncateKey:(_Bool)arg3;	// IMP=0x000000000003c05f
- (id)init;	// IMP=0x000000000003bf8c
