...
- (void).cxx_destruct;	// IMP=0x0000000000043d54
...
- (id)attributedString;	// IMP=0x0000000000043afc
- (struct CGRect)containerView:(id)arg1 layoutFrameForArrangedSubview:(id)arg2 withProposedFrame:(struct CGRect)arg3;	// IMP=0x0000000000043933
- (void)updateRoundedCornerLabels:(id)arg1;	// IMP=0x0000000000043698
- (void)updateIcons:(id)arg1;	// IMP=0x00000000000433dd
- (void)updateStarRating:(id)arg1;	// IMP=0x0000000000043161
@property(nonatomic) unsigned long long prominence;
- (void)updateIconSizing;	// IMP=0x0000000000042dad
@property(retain, nonatomic) UIFont *font;
- (void)updateWithRichText:(id)arg1;	// IMP=0x0000000000042a83
- (void)propertiesDidChange;	// IMP=0x0000000000042a37
- (id)init;	// IMP=0x0000000000042512
