...
+ (id)detailsLabel;	// IMP=0x006000000002aed8
- (void).cxx_destruct;	// IMP=0x000000000002b420
...
- (void)updateWithTitle:(id)arg1 contents:(id)arg2;	// IMP=0x000000000002af4e
- (id)init;	// IMP=0x000000000002adc4
