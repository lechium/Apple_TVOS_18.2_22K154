...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000001ef3b
- (void).cxx_destruct;	// IMP=0x000000000001f145
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001f04c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001ef43
...
- (id)initWithSceneIdentifier:(id)arg1 requestedTypeIdentifier:(id)arg2 requestedItemProviderIndex:(long long)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000001ee80
