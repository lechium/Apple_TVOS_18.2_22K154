...
+ (void)openMessagesForMessageGUID:(id)arg1;	// IMP=0x0010000000030711
- (void).cxx_destruct;	// IMP=0x00000000000321bb
...
- (void)_hideMenuItemSelected;	// IMP=0x0000000000031c5e
- (void)_replyMenuItemSelected;	// IMP=0x0000000000031bca
- (void)excludeContextMenuItemsWithIdentifiers:(id)arg1;	// IMP=0x0000000000031b3e
- (void)refreshContextMenuItems;	// IMP=0x0000000000031ac4
- (_Bool)shouldShowReplyContextMenu;	// IMP=0x000000000003196c
- (_Bool)shouldShowContextMenu;	// IMP=0x00000000000318ac
- (id)makePlaceholderSlotContentForStyle:(id)arg1;	// IMP=0x0000000000031821
- (_Bool)shouldInvalidatePreviousPlaceHolderSlotContent:(id)arg1 forStyle:(id)arg2;	// IMP=0x00000000000316e2
- (void)renderRemoteContentForLayerContextID:(unsigned long long)arg1 style:(id)arg2 yield:(CDUnknownBlockType)arg3;	// IMP=0x000000000003103b
- (void)remoteContentIsLoadedValueChanged;	// IMP=0x0000000000030edd
- (id)_attributionIdentifiers;	// IMP=0x0000000000030bb8
- (void)_pillTapped:(id)arg1 forEvent:(id)arg2;	// IMP=0x00000000000307cd
- (void)_configureChevronForSlotStyle:(id)arg1;	// IMP=0x000000000002ffa7
- (double)expectedHeightForMaxWidth:(double)arg1;	// IMP=0x000000000002fbab
- (void)layoutSubviews;	// IMP=0x000000000002f8e5
- (void)_setupDebugPillLabel;	// IMP=0x000000000002f8df
- (void)_setupBlurView;	// IMP=0x000000000002f5dc
- (_Bool)_shouldDisplayDebugPillLabel;	// IMP=0x000000000002f5d4
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000002f4e6
- (id)initWithHighlight:(id)arg1 maxWidth:(double)arg2 variant:(unsigned long long)arg3 shouldDrawBlur:(_Bool)arg4;	// IMP=0x000000000002f373
