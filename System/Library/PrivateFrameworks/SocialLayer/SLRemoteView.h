...
- (void).cxx_destruct;	// IMP=0x000000000001e7fc
...
- (void)serviceProxyDidDisconnect:(id)arg1;	// IMP=0x000000000001e71b
- (void)serviceProxyDidConnect:(id)arg1;	// IMP=0x000000000001e68f
- (void)remoteContentIsLoadedValueChanged;	// IMP=0x000000000001e689
- (void)_provideContentForLayerContextID:(unsigned long long)arg1 style:(id)arg2 yield:(CDUnknownBlockType)arg3;	// IMP=0x000000000001e2bd
- (CDUnknownBlockType)_contentProviderForCurrentConfiguration;	// IMP=0x000000000001e1b9
- (id)_finalSlotStyleForStyle:(id)arg1;	// IMP=0x000000000001e1a3
- (void)renderRemoteContentForLayerContextID:(unsigned long long)arg1 style:(id)arg2 yield:(CDUnknownBlockType)arg3;	// IMP=0x000000000001e19d
- (id)makePlaceholderSlotContentForStyle:(id)arg1;	// IMP=0x000000000001e195
- (_Bool)shouldInvalidatePreviousPlaceHolderSlotContent:(id)arg1 forStyle:(id)arg2;	// IMP=0x000000000001e18d
- (id)initWithServiceProxyClass:(Class)arg1 maxWidth:(double)arg2;	// IMP=0x000000000001d9b8
