...
- (id)_accessibilityAXAttributedName;	// IMP=0x003000000000be7b
- (_Bool)_accessibilityMatchesCustomActionIdentifier:(id)arg1;	// IMP=0x003000000000be0d
- (id)_accessibilityCustomActionIdentifier;	// IMP=0x003000000000bcfb
