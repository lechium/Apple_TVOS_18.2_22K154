...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x001000000001ac6b
+ (void)registerFeature;	// IMP=0x001000000001ac39
- (void).cxx_destruct;	// IMP=0x000000000001b068
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x000000000001ad02
