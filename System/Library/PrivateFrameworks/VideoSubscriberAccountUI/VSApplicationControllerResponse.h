...
@interface VSApplicationControllerResponse : NSObject
{
    ...
    NSArray *_applicationUserAccounts;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x00000000000603cf
@property(copy, nonatomic) NSArray *applicationUserAccounts; // @synthesize applicationUserAccounts=_applicationUserAccounts;
...
- (id)description;	// IMP=0x000000000005fe3a
