...
- (void).cxx_destruct;	// IMP=0x000000000001f82e
...
- (id)formattedWebsiteURL;	// IMP=0x000000000001f288
- (id)websiteURLWithQueryParameters;	// IMP=0x000000000001ed70
- (void)generateQRCode;	// IMP=0x000000000001ebaa
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000001eb46
