...
- (void).cxx_destruct;	// IMP=0x000000000005dae1
...
- (void)buttonLockupPressed;	// IMP=0x000000000005d8e5
- (void)setupLocalizedStrings;	// IMP=0x000000000005d6a1
- (void)setupLayout;	// IMP=0x000000000005ba59
- (void)setupDetailsView;	// IMP=0x000000000005b6cd
- (void)setupInfoView;	// IMP=0x000000000005b5de
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000005b4a0
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000005b417
