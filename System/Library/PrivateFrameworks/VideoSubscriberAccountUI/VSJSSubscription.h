...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x0010000000051df5
- (void).cxx_destruct;	// IMP=0x000000000005214f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000051fc0
- (id)toVSSubscription;	// IMP=0x0000000000051c8c
