...
- (void).cxx_destruct;	// IMP=0x0000000000047ebe
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x0000000000047da4
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000047bd9
- (id)init;	// IMP=0x000000000004785e
