...
- (void)clearFieldsAfterUsername;	// IMP=0x000000000005770d
- (void)pickerDidSelectRow:(unsigned long long)arg1;	// IMP=0x00000000000576bc
- (void)buttonTappedAtIndex:(unsigned long long)arg1;	// IMP=0x000000000005766b
- (void)validateCredentialEntryFields;	// IMP=0x0000000000057479
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000056fab
- (void)_bindField:(id)arg1;	// IMP=0x0000000000056daa
- (void)_unbindField:(id)arg1;	// IMP=0x0000000000056d53
