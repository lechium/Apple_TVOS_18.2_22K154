...
- (void)cancel;	// IMP=0x0000000000026240
- (void)executionDidBegin;	// IMP=0x000000000002622e
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x0000000000025eba
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x00000000000258df
- (void)_checkSupportedProviders;	// IMP=0x000000000002520b
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x0000000000024986
- (void)_checkAvailability;	// IMP=0x0000000000024803
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x0000000000024662
- (void)_checkPrivacy;	// IMP=0x0000000000023e7f
- (void)_checkEntitlement;	// IMP=0x0000000000023d35
- (void)_finishWithError:(id)arg1;	// IMP=0x0000000000023c1c
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000023ba2
- (void)dealloc;	// IMP=0x0000000000023b59
- (id)init;	// IMP=0x0000000000023906
