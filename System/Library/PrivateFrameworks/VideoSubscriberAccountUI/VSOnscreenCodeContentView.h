...
- (void).cxx_destruct;	// IMP=0x000000000001eaf5
...
- (void)setupLayout;	// IMP=0x000000000001e1f7
- (void)setupSeparatorContainer;	// IMP=0x000000000001e192
- (void)setupWebsiteContainer;	// IMP=0x000000000001e0fd
- (void)setupQRCodeContainer;	// IMP=0x000000000001e098
- (void)buttonLockupPressed;	// IMP=0x000000000001e05b
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000001dfbb
- (void)setupViews;	// IMP=0x000000000001df80
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000001df11
