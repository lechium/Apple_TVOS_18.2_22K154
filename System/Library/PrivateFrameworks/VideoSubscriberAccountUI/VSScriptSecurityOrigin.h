...
- (void).cxx_destruct;	// IMP=0x000000000005e825
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005e5d1
- (unsigned long long)hash;	// IMP=0x000000000005e539
- (id)description;	// IMP=0x000000000005e426
