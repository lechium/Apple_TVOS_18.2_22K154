...
- (void).cxx_destruct;	// IMP=0x00000000000529e4
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000052774
- (void)didSelectManualSignInButton;	// IMP=0x0000000000052728
- (id)init;	// IMP=0x0000000000052664
