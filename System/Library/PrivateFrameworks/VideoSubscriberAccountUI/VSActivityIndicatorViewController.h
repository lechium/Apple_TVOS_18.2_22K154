...
- (void).cxx_destruct;	// IMP=0x00000000000755b5
...
- (id)_textColor;	// IMP=0x0000000000075522
- (void)viewDidLayoutSubviews;	// IMP=0x000000000007502a
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000074daa
- (void)dealloc;	// IMP=0x0000000000074d49
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000074b6c
