...
- (void)start;	// IMP=0x0000000000005e01
- (void)finishExecuting;	// IMP=0x0000000000005cfe
- (void)cancel;	// IMP=0x0000000000005c3d
- (id)initWithRemoteOverlay:(id)arg1;	// IMP=0x0000000000005bcf
