...
- (void).cxx_destruct;	// IMP=0x000000000001572d
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x00000000000155f1
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000015422
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000015300
...
- (int)_linkQualityOnIvarQueue;	// IMP=0x0000000000014ef8
@property(readonly, nonatomic) long long interfaceIdentifier;
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x0000000000014e71
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x0000000000014df8
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000014d44
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x0000000000014cf6
- (void)_addMonitor;	// IMP=0x0000000000014c36
- (void)dealloc;	// IMP=0x0000000000014bf2
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000014a6e
