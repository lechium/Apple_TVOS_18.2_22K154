...
+ (id)sharedConnectionState;	// IMP=0x0060000000001bfe
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000002313
- (_Bool)sendMessage:(id)arg1;	// IMP=0x0000000000002132
- (id)init;	// IMP=0x0000000000001ccb
- (void)cleanupState;	// IMP=0x0000000000001c53
