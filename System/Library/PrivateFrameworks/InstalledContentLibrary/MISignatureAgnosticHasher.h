...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x0060000000006ed5
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x0060000000006eb3
- (void).cxx_destruct;	// IMP=0x0000000000006f4e
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x00000000000064dc
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x0000000000005170
- (void)dealloc;	// IMP=0x0000000000005114
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x0000000000005073
