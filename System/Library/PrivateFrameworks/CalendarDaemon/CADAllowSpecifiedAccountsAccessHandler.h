...
- (void).cxx_destruct;	// IMP=0x0000000000006459
@property(readonly, nonatomic) NSSet *allowedSourceIdentifiers; // @synthesize allowedSourceIdentifiers=_allowedSourceIdentifiers;
- (_Bool)isActionAllowed:(unsigned long long)arg1 forStore:(void *)arg2 inDatabase:(struct CalDatabase *)arg3;	// IMP=0x000000000000639e
- (id)initWithAllowedSourceIdentifiers:(id)arg1 databaseDataProvider:(id)arg2;	// IMP=0x000000000000630b
