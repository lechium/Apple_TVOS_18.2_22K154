...
- (void).cxx_destruct;	// IMP=0x000000000003bd56
...
- (void)purgeConnectionsLastUsedPriorTo:(unsigned long long)arg1 stats:(CDStruct_70551160 *)arg2;	// IMP=0x000000000003bb2c
- (void)_returnConnectionToPool:(id)arg1;	// IMP=0x000000000003bad3
- (id)initWithConfig:(id)arg1 databaseID:(int)arg2;	// IMP=0x000000000003b9a1
