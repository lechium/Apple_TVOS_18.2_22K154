...
- (void)CADCatchUpIntegrationSyncingIfBehind:(void (^)(int))arg1;
- (void)CADPersonaIdentifierForDatabaseID:(int)arg1 reply:(void (^)(int, NSString *))arg2;
...
- (void)CADDatabaseSetShowsCompletedReminders:(_Bool)arg1 reply:(void (^)(int))arg2;
- (void)CADDatabaseShowsDeclinedEventsWithReply:(void (^)(int, _Bool))arg1;
