...
- (void).cxx_destruct;	// IMP=0x000000000000725e
...
- (void)paradeContentViewController:(id)arg1 didSelectAction:(id)arg2 forItem:(id)arg3;	// IMP=0x00000000000070f0
- (void)paradeBackgroundViewControllerDidFinish:(id)arg1;	// IMP=0x0000000000007096
- (void)paradeBackgroundViewControllerDidStartPlaying:(id)arg1;	// IMP=0x000000000000700c
- (void)paradeBackgroundViewControllerContentStateDidChange:(id)arg1;	// IMP=0x0000000000006f01
- (void)_updateBottomGradientViewAlpha;	// IMP=0x0000000000006ec5
- (void)_configureBottomGradientView;	// IMP=0x0000000000006cda
- (void)_configureContentGradientViewWithImage:(id)arg1;	// IMP=0x0000000000006b84
- (void)_updateStandardTitleView;	// IMP=0x000000000000648e
- (_Bool)_promotionVideoIsPlaying;	// IMP=0x0000000000006470
- (void)_updateActionsDetailsViewAlpha;	// IMP=0x00000000000063eb
- (void)_updateStandardAndPromotionTitleViewAlpha;	// IMP=0x00000000000062dd
- (id)initWithContentOptions:(unsigned long long)arg1;	// IMP=0x0000000000005421
