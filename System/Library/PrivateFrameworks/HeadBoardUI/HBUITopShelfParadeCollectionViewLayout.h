...
+ (Class)layoutAttributesClass;	// IMP=0x006000000000d19a
...
- (void)_invalidateItemsInSection:(long long)arg1;	// IMP=0x000000000000d493
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000000d369
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000000d1ab
- (id)debugDescription;	// IMP=0x000000000000d0de
- (id)init;	// IMP=0x000000000000d03d
