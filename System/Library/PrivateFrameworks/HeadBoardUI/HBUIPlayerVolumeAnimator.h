...
- (void)_handleDisplayLink:(id)arg1;	// IMP=0x000000000000b1ae
- (void)invalidate;	// IMP=0x000000000000b158
- (void)setVolume:(float)arg1;	// IMP=0x000000000000b144
- (void)setVolume:(float)arg1 animated:(_Bool)arg2;	// IMP=0x000000000000af70
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000000ae84
