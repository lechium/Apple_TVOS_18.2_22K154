...
- (void).cxx_destruct;	// IMP=0x000000000000f6e6
...
- (_Bool)canBecomeFocused;	// IMP=0x000000000000f4eb
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000f419
- (id)preferredFocusEnvironments;	// IMP=0x000000000000f3ae
- (void)updateContentRating:(id)arg1;	// IMP=0x000000000000f254
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000d5c8
