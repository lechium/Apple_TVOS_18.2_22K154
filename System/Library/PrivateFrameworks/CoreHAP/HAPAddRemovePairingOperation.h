...
- (void).cxx_destruct;	// IMP=0x000000000019cbaf
...
- (id)initWith:(long long)arg1 identifier:(id)arg2 publicKey:(id)arg3 admin:(_Bool)arg4 queue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x000000000019c9b8
