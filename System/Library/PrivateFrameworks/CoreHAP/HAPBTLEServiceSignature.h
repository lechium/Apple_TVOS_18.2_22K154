...
- (void).cxx_destruct;	// IMP=0x00000000000ae31b
...
- (id)description;	// IMP=0x00000000000ae1ee
- (id)initWithServiceType:(id)arg1 serviceInstanceID:(id)arg2 serviceProperties:(unsigned long long)arg3 linkedServices:(id)arg4 authenticated:(_Bool)arg5;	// IMP=0x00000000000adeef
