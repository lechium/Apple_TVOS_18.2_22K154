...
- (void).cxx_destruct;	// IMP=0x00000000000aea26
...
- (void)reset;	// IMP=0x00000000000ae5da
- (id)initWithDiscoveryType:(long long)arg1;	// IMP=0x00000000000ae405
- (id)init;	// IMP=0x00000000000ae35d
