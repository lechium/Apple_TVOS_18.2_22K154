...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006892c
- (void).cxx_destruct;	// IMP=0x0000000000065b43
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006550f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000065407
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000064d7a
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000647e3
- (id)initWithInstanceID:(id)arg1 serviceType:(id)arg2 properties:(id)arg3 linkedServices:(id)arg4 characteristicList:(id)arg5;	// IMP=0x00000000000646dc
- (id)init;	// IMP=0x00000000000646ad
