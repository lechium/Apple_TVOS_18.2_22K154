...
- (void).cxx_destruct;	// IMP=0x00000000001cd5e1
...
- (id)initWithIdentifier:(id)arg1 currentStateNumber:(id)arg2 currentConfigNumber:(id)arg3 modelName:(id)arg4 protocolVersion:(id)arg5 authMethods:(unsigned char)arg6 statusFlags:(unsigned char)arg7 categoryIdentifier:(unsigned short)arg8 setupHash:(id)arg9;	// IMP=0x00000000001cd3ce
