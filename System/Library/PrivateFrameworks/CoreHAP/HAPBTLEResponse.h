...
- (void).cxx_destruct;	// IMP=0x0000000000044184
...
- (unsigned long long)_deserializeHeaderBodyLengthWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000043efd
- (unsigned long long)_deserializeHeaderWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000043dd3
- (unsigned long long)appendData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000043934
- (unsigned long long)_remainingBodyLength;	// IMP=0x00000000000438a7
...
- (id)description;	// IMP=0x00000000000436eb
- (id)debugDescription;	// IMP=0x00000000000436d4
- (id)descriptionWithPointer:(_Bool)arg1;	// IMP=0x0000000000043557
- (id)shortDescription;	// IMP=0x0000000000043545
- (id)initWithRequest:(id)arg1;	// IMP=0x00000000000434d7
- (id)init;	// IMP=0x000000000004342f
