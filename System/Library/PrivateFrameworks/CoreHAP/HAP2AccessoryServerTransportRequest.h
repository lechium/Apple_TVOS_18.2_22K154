...
+ (id)new;	// IMP=0x006000000005e72a
- (void).cxx_destruct;	// IMP=0x000000000005e5d4
...
- (id)debugDescription;	// IMP=0x000000000005e4fb
- (id)description;	// IMP=0x000000000005e478
@property(readonly, nonatomic, getter=isForWriting) _Bool forWriting;
- (id)initForWritingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x000000000005e44a
- (id)initForReadingWithEndpoint:(id)arg1 data:(id)arg2 encrypted:(_Bool)arg3 mimeType:(id)arg4;	// IMP=0x000000000005e42e
- (id)init;	// IMP=0x000000000005e386
