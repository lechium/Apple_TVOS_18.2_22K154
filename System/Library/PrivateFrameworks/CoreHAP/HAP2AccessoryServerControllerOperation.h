...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000045f93
- (void)_cleanUp;	// IMP=0x0000000000045f8d
- (void)_parseResponseData:(id)arg1;	// IMP=0x0000000000045e66
- (void)_sendRequest;	// IMP=0x0000000000045b37
- (void)_openTransport:(_Bool)arg1;	// IMP=0x0000000000045848
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000000457e4
- (void)cancel;	// IMP=0x00000000000457a6
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000456a4
- (void)finish;	// IMP=0x00000000000455ce
- (void)main;	// IMP=0x000000000004551e
- (id)initWithName:(id)arg1 controller:(id)arg2 encoding:(id)arg3 transport:(id)arg4 request:(id)arg5 endpoint:(id)arg6 mimeType:(id)arg7 timeout:(double)arg8 options:(unsigned long long)arg9;	// IMP=0x00000000000453ae
