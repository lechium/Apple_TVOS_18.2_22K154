...
- (void).cxx_destruct;	// IMP=0x0000000000187807
...
- (_Bool)reapSession:(id)arg1;	// IMP=0x000000000018774f
- (id)initWithSession:(struct coap_session_t *)arg1 startTime:(id)arg2;	// IMP=0x00000000001876d8
