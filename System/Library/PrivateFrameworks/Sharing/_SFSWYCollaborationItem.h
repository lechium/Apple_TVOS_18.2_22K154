...
- (void).cxx_destruct;	// IMP=0x0000000000058d30
...
- (void)_loadOptionsIfNeeded;	// IMP=0x0000000000058ca3
- (id)initWithItemProvider:(id)arg1 activityItem:(id)arg2 isURLProviderSupported:(_Bool)arg3;	// IMP=0x0000000000058a4b
