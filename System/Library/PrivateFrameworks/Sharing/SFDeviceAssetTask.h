...
- (void).cxx_destruct;	// IMP=0x000000000007233e
...
- (id)bundleAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000071e16
- (id)bundleURLFromAssetURL:(id)arg1;	// IMP=0x0000000000071b4a
- (void)completeWithBundle:(id)arg1 isFallback:(_Bool)arg2 isCached:(_Bool)arg3;	// IMP=0x0000000000071347
- (_Bool)completeIfPossible;	// IMP=0x0000000000070dc0
- (void)cancelTimeout;	// IMP=0x0000000000070d76
- (_Bool)updateTaskWithBundle:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x0000000000070b72
- (_Bool)updateTaskWithAssetBundleURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x0000000000070abc
- (_Bool)updateTaskWithAssetURL:(id)arg1 error:(id)arg2 isFallback:(_Bool)arg3 isImperfectMatch:(_Bool)arg4 isCached:(_Bool)arg5;	// IMP=0x0000000000070a2b
- (void)createQueryParameters;	// IMP=0x0000000000070702
- (id)initWithDeviceQuery:(id)arg1 requestConfiguration:(id)arg2 dispatchQueue:(id)arg3 useProcessLocalCache:(_Bool)arg4;	// IMP=0x000000000007039e
