...
- (void).cxx_destruct;	// IMP=0x0000000000058a09
...
- (void)loadCopyRepresentationURLWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000058901
- (id)_defaultLoadingOptionsSummary;	// IMP=0x00000000000588a5
@property(readonly, nonatomic) _Bool hasSeparateSendCopyRepresentation;
@property(readonly, nonatomic) _Bool isCollaborativeURL;
- (void)_loadSendCopyRepresentationIfNeeded;	// IMP=0x0000000000058828
- (void)_loadMetadataIfNeeded;	// IMP=0x00000000000585ce
@property(readonly, copy, nonatomic) NSString *additionalContentIdentifier;
- (id)initWithFileURL:(id)arg1 itemProvider:(id)arg2 activityItem:(id)arg3 defaultCollaboration:(_Bool)arg4 managedFileURL:(id)arg5;	// IMP=0x00000000000585ac
