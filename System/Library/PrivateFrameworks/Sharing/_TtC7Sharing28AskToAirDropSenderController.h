...
- (void).cxx_destruct;	// IMP=0x0000000000225e20
- (void)fetchSharingNameWithCompletionHandler:(void (^)(NSString *, NSError *))arg1;	// IMP=0x0000000000225b20
- (void)fetchPrivacyPromptInformationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002258d0
- (void)stop;	// IMP=0x0000000000224d00
- (void)start;	// IMP=0x0000000000224710
- (void)startAs:(id)arg1;	// IMP=0x0000000000224550
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000002239e0
- (id)init;	// IMP=0x00000000002237c0
