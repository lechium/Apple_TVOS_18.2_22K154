...
+ (id)fetchMergableDeltasRequestFromPeerToPeerMessage:(id)arg1 set:(id)arg2 stateVector:(id)arg3 atomBatchVersion:(unsigned long long)arg4;	// IMP=0x0060000000019e56
- (void).cxx_destruct;	// IMP=0x000000000001a5b1
...
- (id)dictionaryRepresentation;	// IMP=0x000000000001a220
- (id)initFromDictionary:(id)arg1;	// IMP=0x0000000000019f8e
