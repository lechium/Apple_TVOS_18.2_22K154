...
- (id)updaterForSet:(id)arg1 withRequest:(id)arg2;	// IMP=0x00000000000171ce
- (id)initWithWriteAccess:(id)arg1 changeNotifier:(id)arg2 timeout:(double)arg3;	// IMP=0x0000000000017107
