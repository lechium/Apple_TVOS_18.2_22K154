...
- (void).cxx_destruct;	// IMP=0x00000000000188fb
...
- (id)_connectionTypeString;	// IMP=0x000000000001885c
- (unsigned long long)hash;	// IMP=0x0000000000018732
- (_Bool)isEqualToDonateRequest:(id)arg1;	// IMP=0x00000000000183ad
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018345
- (void)terminateWithType:(long long)arg1;	// IMP=0x00000000000181f9
- (void)timeout;	// IMP=0x0000000000018192
- (void)handle;	// IMP=0x0000000000017efb
- (id)description;	// IMP=0x0000000000017e46
- (id)initWithConnection:(id)arg1 manager:(id)arg2 itemType:(unsigned short)arg3 encodedDescriptors:(id)arg4 personaIdentifier:(id)arg5 version:(unsigned long long)arg6 validity:(id)arg7 remoteDevice:(id)arg8 accessAssertion:(id)arg9;	// IMP=0x0000000000017c47
