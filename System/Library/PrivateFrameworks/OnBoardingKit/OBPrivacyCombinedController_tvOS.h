...
- (void).cxx_destruct;	// IMP=0x00000000000307e3
...
- (void)_showPrivacyFlow:(id)arg1;	// IMP=0x00000000000306bb
- (void)viewDidLoad;	// IMP=0x000000000002fbb8
- (void)loadView;	// IMP=0x000000000002fb62
- (id)initWithBundles:(id)arg1;	// IMP=0x000000000002fab9
