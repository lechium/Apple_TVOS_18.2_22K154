...
- (void).cxx_destruct;	// IMP=0x000000000002ce43
...
- (void)overrideSpansAllLines:(unsigned long long)arg1;	// IMP=0x000000000002ccc0
- (void)updateAttributedTextWithString:(id)arg1;	// IMP=0x000000000002c9b7
- (void)setText:(id)arg1;	// IMP=0x000000000002c949
- (void)setDetailedTextHeader:(id)arg1 detailedTextBody:(id)arg2;	// IMP=0x000000000002c81e
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000002c7ad
