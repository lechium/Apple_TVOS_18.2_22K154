...
- (void).cxx_destruct;	// IMP=0x000000000030dd80
...
- (int)analyzeFrame:(struct __CVBuffer *)arg1 withFaceRect:(struct CGRect)arg2 withRotation:(int)arg3 withTimestamp:(CDStruct_1b6d18a9)arg4;	// IMP=0x000000000030dd1c
- (_Bool)isTracked;	// IMP=0x000000000030dd14
- (_Bool)updateFocalLengthInPixels:(float)arg1;	// IMP=0x000000000030dd0c
- (id)initWithFocalLengthInPixels:(float)arg1 offline:(_Bool)arg2 isFastMode:(_Bool)arg3;	// IMP=0x000000000030dcfe
