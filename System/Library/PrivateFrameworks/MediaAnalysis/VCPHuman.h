...
+ (unsigned long long)flagsFromKeypoints:(id)arg1 withMinConfidence:(float)arg2;	// IMP=0x0060000000172bc4
- (void).cxx_destruct;	// IMP=0x0000000000172ecf
...
- (id)init;	// IMP=0x0000000000172b3c
