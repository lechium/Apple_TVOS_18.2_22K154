...
+ (Class)faceResultsType;	// IMP=0x001000000002cb8d
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x0010000000026ee1
- (void).cxx_destruct;	// IMP=0x000000000002ede1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002ea16
- (unsigned long long)hash;	// IMP=0x000000000002e065
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002de78
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002dbcc
- (void)copyTo:(id)arg1;	// IMP=0x000000000002da2d
- (void)writeTo:(id)arg1;	// IMP=0x000000000002d7b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002d7a8
- (id)dictionaryRepresentation;	// IMP=0x000000000002ccdf
- (id)description;	// IMP=0x000000000002cc30
@property(nonatomic) _Bool hasContentScore;
@property(nonatomic) _Bool hasGlobalQualityScore;
- (id)faceResultsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002cb70
- (unsigned long long)faceResultsCount;	// IMP=0x000000000002cb53
- (void)addFaceResults:(id)arg1;	// IMP=0x000000000002cae9
- (void)clearFaceResults;	// IMP=0x000000000002cacc
- (id)exportToLegacyDictionary;	// IMP=0x0000000000027614
