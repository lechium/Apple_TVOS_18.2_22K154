...
+ (_Bool)_isColocatingAnimalObservation:(id)arg1 withFaceObservations:(id)arg2 orTorsoObservations:(id)arg3;	// IMP=0x001000000007ebd7
+ (double)_calculateIoUBetweenObservation:(id)arg1 andObservation:(id)arg2;	// IMP=0x001000000007ea7e
+ (double)_calculateOverlappingBetweenFaceObservation:(id)arg1 andBodyObservation:(id)arg2;	// IMP=0x001000000007e970
+ (id)facesFromPHFetchResult:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000007def4
+ (id)faceFromPHFace:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000007d25f
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalHeadObservations:(id)arg3 animalBodyObservations:(id)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 blurScorePerFace:(id)arg8 exposureScorePerFace:(id)arg9 tooSmallFaceObservations:(id)arg10 processingVersion:(int)arg11 animalResults:(id *)arg12;	// IMP=0x001000000007c7e1
+ (id)_animalHeadsOnlyFromAnimalHeadObservations:(id)arg1 matchedHead:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000007c287
+ (id)_animalBodiesOnlyFromAnimalBodyObservations:(id)arg1 matchedBody:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x001000000007be67
+ (id)_animalHeadsBodiesFromAnimalHeadObservations:(id)arg1 animalBodyObservations:(id)arg2 matchedHead:(void *)arg3 matchedBody:(void *)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 processingVersion:(int)arg8;	// IMP=0x001000000007b534
+ (id)faceFromAnimalHeadObservation:(id)arg1 animalBodyObservation:(id)arg2 animalLabel:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 processingVersion:(int)arg7;	// IMP=0x001000000007b017
+ (id)_animalImageprintWrapperFromObservation:(id)arg1 visionRequests:(id)arg2 processingVersion:(int)arg3;	// IMP=0x001000000007a73b
+ (id)_filterAnimalObservations:(id)arg1 colocatingWithFaceObservations:(id)arg2 orHumanObservations:(id)arg3;	// IMP=0x001000000007a534
+ (id)_peopleTorsosOnlyFromHumanObservations:(id)arg1 matchedTorso:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6;	// IMP=0x0010000000079935
+ (id)_peopleFacesOnlyFromFaceObservations:(id)arg1 matchedFace:(set_a5418947)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 blurScorePerFace:(id)arg6 exposureScorePerFace:(id)arg7 tooSmallFaceObservations:(id)arg8 processingVersion:(int)arg9;	// IMP=0x0010000000079170
+ (id)_peopleFacesTorsosFromFaceObservations:(id)arg1 humanObservations:(id)arg2 matchedFace:(void *)arg3 matchedTorso:(void *)arg4 sourceWidth:(unsigned long long)arg5 sourceHeight:(unsigned long long)arg6 visionRequests:(id)arg7 blurScorePerFace:(id)arg8 exposureScorePerFace:(id)arg9 tooSmallFaceObservations:(id)arg10 processingVersion:(int)arg11;	// IMP=0x001000000007862e
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalObservations:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 blurScorePerFace:(id)arg7 exposureScorePerFace:(id)arg8 tooSmallFaceObservations:(id)arg9 processingVersion:(int)arg10;	// IMP=0x0010000000074a85
+ (id)faceFromFaceObservation:(id)arg1 humanObservation:(id)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6 force:(_Bool)arg7 andError:(id *)arg8;	// IMP=0x0010000000071f0e
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x0010000000071ea9
- (void).cxx_destruct;	// IMP=0x000000000007f88f
...
- (double)photosFaceRepresentationBodyHeight;	// IMP=0x000000000007f3b3
- (double)photosFaceRepresentationBodyWidth;	// IMP=0x000000000007f3a1
- (double)photosFaceRepresentationBodyCenterY;	// IMP=0x000000000007f38f
- (double)photosFaceRepresentationBodyCenterX;	// IMP=0x000000000007f37d
- (double)photosFaceRepresentationQuality;	// IMP=0x000000000007f36b
- (double)photosFaceRepresentationRoll;	// IMP=0x000000000007f359
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x000000000007f347
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x000000000007f335
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x000000000007f323
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x000000000007f311
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x000000000007f2ff
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x000000000007f2ed
- (double)photosFaceRepresentationBlurScore;	// IMP=0x000000000007f2db
- (double)photosFaceRepresentationSize;	// IMP=0x000000000007f2c9
- (double)photosFaceRepresentationCenterY;	// IMP=0x000000000007f2b7
- (double)photosFaceRepresentationCenterX;	// IMP=0x000000000007f2a5
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x000000000007f293
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x000000000007f281
- (long long)qualityMeasureWithCountOfFacesOnAsset:(unsigned long long)arg1;	// IMP=0x000000000007f125
- (id)gist;	// IMP=0x000000000007e6fe
- (struct CGRect)normalizedBodyRect;	// IMP=0x000000000007e65c
- (struct CGRect)normalizedFaceRect;	// IMP=0x000000000007e5df
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x000000000007e540
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x000000000007e122
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x0000000000071d50
