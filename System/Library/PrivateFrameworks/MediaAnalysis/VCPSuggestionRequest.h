...
+ (id)requestWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x00600000000333ea
- (void).cxx_destruct;	// IMP=0x000000000003352b
...
- (id)initWithFaceClusterIds:(id)arg1 clusterFlags:(id)arg2 updateHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000330b0
