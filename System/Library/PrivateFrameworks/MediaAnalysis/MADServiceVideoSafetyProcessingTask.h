...
- (void).cxx_destruct;	// IMP=0x000000000008bc51
@property(nonatomic) _Bool enablePowerLog; // @synthesize enablePowerLog=_enablePowerLog;
- (_Bool)run:(id *)arg1;	// IMP=0x00000000000899a7
- (id)finalizeSafetyResultsWithError:(id *)arg1;	// IMP=0x000000000008962e
- (_Bool)configureVideoProcessorWithError:(id *)arg1;	// IMP=0x00000000000889bc
- (void)_processFrameBuffer:(struct opaqueCMSampleBuffer *)arg1 stop:(_Bool *)arg2;	// IMP=0x0000000000088637
- (id)initWithRequest:(id)arg1 forAsset:(id)arg2 cancelBlock:(CDUnknownBlockType)arg3 progressHandler:(CDUnknownBlockType)arg4 andCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000088432
