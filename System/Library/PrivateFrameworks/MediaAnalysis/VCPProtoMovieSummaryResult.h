...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x001000000010d1c5
- (void).cxx_destruct;	// IMP=0x00000000003410e3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000340f4b
- (unsigned long long)hash;	// IMP=0x0000000000340deb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000340cd5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000340bef
- (void)copyTo:(id)arg1;	// IMP=0x0000000000340b51
- (void)writeTo:(id)arg1;	// IMP=0x0000000000340aa9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000340a9c
- (id)dictionaryRepresentation;	// IMP=0x00000000003405c5
- (id)description;	// IMP=0x0000000000340516
@property(readonly, nonatomic) _Bool hasPlaybackCrop;
@property(readonly, nonatomic) _Bool hasKeyFrame;
- (id)exportToLegacyDictionary;	// IMP=0x000000000010d626
