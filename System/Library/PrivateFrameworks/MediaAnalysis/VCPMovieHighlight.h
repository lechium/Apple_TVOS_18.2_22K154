...
- (void).cxx_destruct;	// IMP=0x00000000000f752f
...
- (void)checkAutoPlayable;	// IMP=0x00000000000f724d
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000f70e6
- (_Bool)isShort;	// IMP=0x00000000000f709b
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000f6ba6
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000f6b1e
