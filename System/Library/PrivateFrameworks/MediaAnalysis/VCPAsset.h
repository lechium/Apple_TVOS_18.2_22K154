...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x008000000036ec6e
- (id)typeDescription;	// IMP=0x000000000036edf1
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1 orientation:(unsigned int *)arg2;	// IMP=0x000000000036efd5
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x000000000036efb1
...
- (struct CGSize)originalMovieSize;	// IMP=0x000000000036f22f
- (id)originalMovie;	// IMP=0x000000000036f20b
- (id)streamedMovie:(_Bool)arg1;	// IMP=0x000000000036f203
- (_Bool)isMovieResourceLocalAvailable;	// IMP=0x000000000036f1df
- (id)movie;	// IMP=0x000000000036f1bb
