...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x0010000000315569
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000381327
- (unsigned long long)hash;	// IMP=0x0000000000380a5b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003808a5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000380770
- (void)copyTo:(id)arg1;	// IMP=0x000000000038059b
- (void)writeTo:(id)arg1;	// IMP=0x000000000038039d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000380390
- (id)dictionaryRepresentation;	// IMP=0x000000000037f8c8
- (id)description;	// IMP=0x000000000037f819
- (void)setHomographyParams:(float *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000037f802
- (float)homographyParamsAtIndex:(unsigned long long)arg1;	// IMP=0x000000000037f730
- (void)addHomographyParams:(float)arg1;	// IMP=0x000000000037f71f
- (void)clearHomographyParams;	// IMP=0x000000000037f70e
@property(readonly, nonatomic) float *homographyParams;
@property(readonly, nonatomic) unsigned long long homographyParamsCount;
- (void)setTimeValues:(long long *)arg1 count:(unsigned long long)arg2;	// IMP=0x000000000037f6d4
- (long long)timeValueAtIndex:(unsigned long long)arg1;	// IMP=0x000000000037f603
- (void)addTimeValue:(long long)arg1;	// IMP=0x000000000037f5ef
- (void)clearTimeValues;	// IMP=0x000000000037f5de
@property(readonly, nonatomic) long long *timeValues;
@property(readonly, nonatomic) unsigned long long timeValuesCount;
- (void)dealloc;	// IMP=0x000000000037f56c
- (id)exportToLegacyDictionary;	// IMP=0x0000000000315f14
