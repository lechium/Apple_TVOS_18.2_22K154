...
- (void).cxx_destruct;	// IMP=0x00000000001f6c80
...
- (int)trackObjectInFrame:(struct __CVBuffer *)arg1;	// IMP=0x00000000001f6859
- (id)initWithObjectBounds:(struct CGRect)arg1 inFrame:(struct __CVBuffer *)arg2 timestamp:(CDStruct_1b6d18a9)arg3;	// IMP=0x00000000001f656e
