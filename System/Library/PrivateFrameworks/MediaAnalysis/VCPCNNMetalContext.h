...
+ (_Bool)supportVectorForward;	// IMP=0x0060000000344510
+ (_Bool)supportGPU;	// IMP=0x0060000000344508
- (void).cxx_destruct;	// IMP=0x000000000034459a
...
- (int)execute;	// IMP=0x0000000000344526
- (id)initNewContext:(_Bool)arg1;	// IMP=0x0000000000344518
