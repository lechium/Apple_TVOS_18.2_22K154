...
+ (id)protoFromPhotosFace:(id)arg1;	// IMP=0x00100000000a7fbc
- (void).cxx_destruct;	// IMP=0x0000000000360357
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000035f978
- (unsigned long long)hash;	// IMP=0x000000000035e472
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000035da3c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000035d36f
- (void)copyTo:(id)arg1;	// IMP=0x000000000035cd25
- (void)writeTo:(id)arg1;	// IMP=0x000000000035c6a9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000035c69c
- (id)dictionaryRepresentation;	// IMP=0x0000000000359ea3
- (id)description;	// IMP=0x0000000000359df4
...
- (id)vcpPhotosFace;	// IMP=0x00000000000a85c8
