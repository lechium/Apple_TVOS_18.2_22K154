...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000d317b
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000d3076
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000d2ff6
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000d2f8c
- (id)init;	// IMP=0x00000000000d2f18
