...
- (void).cxx_destruct;	// IMP=0x0000000000250631
@property(copy, nonatomic) CDUnknownBlockType progressHandler; // @synthesize progressHandler=_progressHandler;
@property(retain, nonatomic) NSDictionary *decoderSettings; // @synthesize decoderSettings=_decoderSettings;
- (void)cancel;	// IMP=0x00000000002505f2
- (_Bool)analyzeWithError:(id *)arg1;	// IMP=0x00000000002504bd
- (_Bool)addFrameProcessingRequest:(CDUnknownBlockType)arg1 withConfiguration:(id)arg2 error:(id *)arg3;	// IMP=0x000000000025041e
- (_Bool)processConfiguration:(id)arg1 withError:(id *)arg2;	// IMP=0x00000000002501bd
- (id)initWithURL:(id)arg1;	// IMP=0x00000000002500fa
