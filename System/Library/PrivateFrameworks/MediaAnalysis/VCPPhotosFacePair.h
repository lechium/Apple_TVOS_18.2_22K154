...
+ (id)pairWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x00600000003254aa
- (void).cxx_destruct;	// IMP=0x0000000000325551
...
- (id)initWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x0000000000325401
