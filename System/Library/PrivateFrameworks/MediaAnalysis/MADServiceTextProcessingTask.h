...
- (void).cxx_destruct;	// IMP=0x000000000020af3d
@property(retain, nonatomic) NSString *signpostPayload; // @synthesize signpostPayload=_signpostPayload;
- (void)cancel;	// IMP=0x000000000020ad7e
- (_Bool)run:(id *)arg1;	// IMP=0x000000000020a0f8
- (_Bool)interruptBackgroundTasks;	// IMP=0x000000000020a0f0
- (_Bool)cachesResources;	// IMP=0x000000000020a0e8
- (id)initWithRequests:(id)arg1 asset:(id)arg2 cancelBlock:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000209eea
