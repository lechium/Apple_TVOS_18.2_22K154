...
- (void).cxx_destruct;	// IMP=0x0000000000083265
...
- (id)initWithSceneId:(id)arg1 withDuration:(float)arg2 withConfidence:(float)arg3 withAdjustConfidence:(float)arg4;	// IMP=0x0000000000083105
