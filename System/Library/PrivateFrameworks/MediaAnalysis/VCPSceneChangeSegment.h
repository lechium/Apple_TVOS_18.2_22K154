...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000035622e
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000356129
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000003560a9
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000035603f
- (id)init;	// IMP=0x0000000000355fcb
