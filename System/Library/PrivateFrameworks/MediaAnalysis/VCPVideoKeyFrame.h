...
+ (_Bool)isLivePhotoKeyFrameEnabled;	// IMP=0x0000000000103274
- (void).cxx_destruct;	// IMP=0x0000000000105616
...
- (void)printStats;	// IMP=0x0000000000105283
- (_Bool)hasGoodSubjectAction;	// IMP=0x0000000000105257
- (float)computeScoreFromExposure;	// IMP=0x0000000000105224
- (float)computeScoreFromColorfulness;	// IMP=0x00000000001051fa
- (float)computeExpressionScore;	// IMP=0x0000000000104efc
- (float)computeScoreFromAction;	// IMP=0x0000000000104eb5
- (void)computeCurationScore;	// IMP=0x0000000000104e24
- (void)computeCurationScoreComponents;	// IMP=0x0000000000104d9a
- (void)storeFrameResults;	// IMP=0x00000000001043e9
- (float)computePenaltyScore;	// IMP=0x0000000000104055
- (float)computeContentScore;	// IMP=0x0000000000103fed
- (float)computeVisualPleasingScore;	// IMP=0x0000000000103f83
- (float)computeGlobalQuality;	// IMP=0x0000000000103f0c
- (void)computeGlobalQualityForLivePhoto;	// IMP=0x0000000000103ebe
- (void)setMotionStatsFlag:(_Bool)arg1 cameraMotion:(float)arg2 subjectAction:(float)arg3 interestingness:(float)arg4 obstruction:(float)arg5 colorfulness:(float)arg6 exposureScore:(float)arg7 humanActionStatsFlag:(_Bool)arg8 humanPoseScore:(float)arg9 humanActionScore:(float)arg10 subMb:(_Bool)arg11;	// IMP=0x0000000000103e5c
- (void)setFaceStatsFlag:(_Bool)arg1 detectedFaces:(id)arg2;	// IMP=0x0000000000103cb7
- (void)resetStatsFlag;	// IMP=0x0000000000103ca9
- (int)loadKeyFrameResult:(id)arg1 timestamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000103470
- (void)copyFrom:(id)arg1;	// IMP=0x000000000010327c
- (id)initWithLivePhoto:(_Bool)arg1;	// IMP=0x000000000010310a
