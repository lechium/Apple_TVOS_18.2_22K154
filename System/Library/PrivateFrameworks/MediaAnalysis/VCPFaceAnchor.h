...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000028bf58
- (void).cxx_destruct;	// IMP=0x000000000028c2ab
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000028c033
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000028bf60
- (id)initWithTransform:(CDStruct_14d5dc5e)arg1 blendShapes:(id)arg2 geometry:(id)arg3;	// IMP=0x000000000028be45
