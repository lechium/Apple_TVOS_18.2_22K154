...
+ (id)sharedModel:(id)arg1 properties:(id)arg2;	// IMP=0x0060000000065117
- (void).cxx_destruct;	// IMP=0x0000000000065447
...
- (int)inference:(float *)arg1;	// IMP=0x0000000000065317
- (id)initWithModelPath:(id)arg1;	// IMP=0x000000000006484a
