...
+ (id)sharedModel:(id)arg1 outputNames:(id)arg2 properties:(id)arg3;	// IMP=0x006000000016a806
- (void).cxx_destruct;	// IMP=0x000000000016af8b
...
- (int)inference:(float *)arg1 settling:(_Bool)arg2;	// IMP=0x000000000016acea
- (id)initWithConfig:(id)arg1;	// IMP=0x000000000016a9cc
