...
+ (void)_reportDownload:(unsigned long long)arg1;	// IMP=0x00600000002d9314
+ (unsigned long long)maxSizeBytes;	// IMP=0x00600000002d9309
+ (id)sharedManager;	// IMP=0x00600000002d92b4
- (void).cxx_destruct;	// IMP=0x00000000002da885
@property(copy, nonatomic) CDUnknownBlockType cancel; // @synthesize cancel=_cancel;
- (void)flush;	// IMP=0x00000000002da811
- (id)requestDownloadOfResource:(id)arg1;	// IMP=0x00000000002d95a9
- (id)init;	// IMP=0x00000000002d9246
