...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x0010000000268b12
- (void).cxx_destruct;	// IMP=0x00000000000149e0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000014892
- (unsigned long long)hash;	// IMP=0x00000000000144c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001439e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000142b0
- (void)copyTo:(id)arg1;	// IMP=0x00000000000141fc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000014131
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000014124
- (id)dictionaryRepresentation;	// IMP=0x0000000000013c0a
- (id)description;	// IMP=0x0000000000013b5b
...
- (id)exportToLegacyDictionary;	// IMP=0x0000000000268de6
