...
+ (id)mergeCandidatePairWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x006000000017ba70
- (void).cxx_destruct;	// IMP=0x000000000017bf8e
...
- (id)description;	// IMP=0x000000000017be97
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017bc4c
- (unsigned long long)hash;	// IMP=0x000000000017bc42
- (id)initWithPerson:(id)arg1 andPerson:(id)arg2 reason:(id)arg3;	// IMP=0x000000000017bb21
