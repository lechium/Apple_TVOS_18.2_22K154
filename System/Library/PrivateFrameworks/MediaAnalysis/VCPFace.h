...
- (void).cxx_destruct;	// IMP=0x000000000011566f
...
- (struct CGRect)faceBoundsWithTransform:(unsigned long long)arg1 height:(unsigned long long)arg2 transform:(struct CGAffineTransform)arg3;	// IMP=0x00000000001154ca
- (struct CGRect)faceBounds:(unsigned long long)arg1 height:(unsigned long long)arg2;	// IMP=0x000000000011546b
- (unsigned long long)flagsForOrientation:(_Bool)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3;	// IMP=0x0000000000115401
- (id)init;	// IMP=0x000000000011539e
