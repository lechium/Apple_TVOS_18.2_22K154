...
- (void).cxx_destruct;	// IMP=0x0000000000374290
- (id)init;	// IMP=0x0000000000374230
- (id)init:(id)arg1 nonAppInitiated:(_Bool)arg2;	// IMP=0x0000000000374170
- (id)initWithUrl:(id)arg1 nonAppInitiated:(_Bool)arg2;	// IMP=0x0000000000374000
