...
- (void).cxx_destruct;	// IMP=0x000000000004614b
...
- (id)headerString;	// IMP=0x0000000000046090
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x000000000004600f
- (void)dealloc;	// IMP=0x0000000000045fd5
- (id)init;	// IMP=0x0000000000045faa
