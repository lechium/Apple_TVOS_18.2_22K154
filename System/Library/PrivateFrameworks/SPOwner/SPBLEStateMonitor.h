...
- (void).cxx_destruct;	// IMP=0x0000000000050b50
...
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x00000000000509eb
- (void)notifyDelegate:(unsigned long long)arg1;	// IMP=0x0000000000050970
- (void)startMonitoring;	// IMP=0x000000000005088f
- (id)init;	// IMP=0x0000000000050853
