...
+ (id)predicateForStableGroupID:(id)arg1;	// IMP=0x0060000000007261
+ (id)predicateForGroupIDs:(id)arg1;	// IMP=0x00600000000071dc
+ (id)predicateForGroupID:(id)arg1;	// IMP=0x0060000000007157
+ (id)groupFromGroup:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x0060000000006fcb
+ (id)insertIntoManagedObjectContext:(id)arg1;	// IMP=0x0060000000006efb
+ (id)fetchRequest;	// IMP=0x0060000000006e7e
