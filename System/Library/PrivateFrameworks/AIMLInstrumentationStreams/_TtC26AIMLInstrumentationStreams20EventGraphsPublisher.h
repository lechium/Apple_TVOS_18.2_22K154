...
+ (id)publisherWithPublisher:(id)arg1 upstreams:(id)arg2 bookmarkState:(id)arg3;	// IMP=0x006000000004a250
- (void).cxx_destruct;	// IMP=0x000000000004bca0
- (id)init;	// IMP=0x000000000004bc20
@property(nonatomic, readonly) NSArray *bookmarkableUpstreams;
- (void)subscribe:(id)arg1;	// IMP=0x000000000004a0d0
