...
+ (id)dmc_createManagementAccountWithStore:(id)arg1;	// IMP=0x0020000000001688
- (_Bool)dmc_isAccountSchemeSharediPad;	// IMP=0x00100000000024a9
- (id)dmc_accountQuotaString;	// IMP=0x0010000000001f32
- (_Bool)dmc_isPrimaryAccount;	// IMP=0x0010000000001ee7
- (_Bool)dmc_isVisibleRemoteManagementAccount;	// IMP=0x0010000000001e5b
