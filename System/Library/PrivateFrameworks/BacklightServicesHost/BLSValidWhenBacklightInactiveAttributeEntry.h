...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x00100000000771c9
- (void).cxx_destruct;	// IMP=0x0000000000077386
...
- (void)invalidate;	// IMP=0x000000000007733e
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000077336
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x0000000000077280
