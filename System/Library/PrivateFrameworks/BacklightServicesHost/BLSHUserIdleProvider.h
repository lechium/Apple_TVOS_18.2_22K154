...
- (void).cxx_destruct;	// IMP=0x00000000000770ea
...
- (void)_invalidate;	// IMP=0x0000000000076f92
- (void)_reset;	// IMP=0x0000000000076f02
- (void)_resume;	// IMP=0x0000000000076e7e
- (void)_pause;	// IMP=0x0000000000076dfa
- (void)_setShouldNotifyOfUnidle:(_Bool)arg1;	// IMP=0x0000000000076d49
- (void)_setIdleTimeout:(double)arg1 shouldReset:(_Bool)arg2;	// IMP=0x00000000000769ca
- (void)invalidate;	// IMP=0x000000000007696d
- (void)reset;	// IMP=0x0000000000076910
- (void)pause;	// IMP=0x00000000000768b3
- (void)resume;	// IMP=0x0000000000076856
- (void)setIdleTimeout:(double)arg1 shouldReset:(_Bool)arg2;	// IMP=0x000000000007677e
- (id)init;	// IMP=0x00000000000763d1
