...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000003d077
- (void).cxx_destruct;	// IMP=0x000000000003d525
...
- (void)invalidate;	// IMP=0x000000000003d2fc
- (_Bool)reactivateIfPossible;	// IMP=0x000000000003d2cb
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x000000000003d1f7
