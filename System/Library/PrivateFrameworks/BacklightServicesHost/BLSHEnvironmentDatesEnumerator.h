...
+ (id)createWithInitialSpecifier:(id)arg1 enumerator:(id)arg2 dateInterval:(id)arg3 environment:(id)arg4 sourceModel:(id)arg5;	// IMP=0x00600000000279c9
- (void).cxx_destruct;	// IMP=0x0000000000027d55
...
- (id)description;	// IMP=0x0000000000027c3e
