...
- (void).cxx_destruct;	// IMP=0x000000000007170f
...
- (id)toURL;	// IMP=0x00000000000711f0
- (id)initWithDesignation:(unsigned long long)arg1 radarTitle:(id)arg2 radarDescription:(id)arg3;	// IMP=0x0000000000071059
