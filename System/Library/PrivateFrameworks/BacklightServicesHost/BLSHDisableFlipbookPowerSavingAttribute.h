...
+ (id)disablePowerSavingForReason:(unsigned long long)arg1;	// IMP=0x006000000000e247
@property(readonly, nonatomic) unsigned long long reason; // @synthesize reason=_reason;
- (_Bool)checkEntitlementSourceForRequiredEntitlements:(id)arg1 error:(out id *)arg2;	// IMP=0x000000000000e29d
