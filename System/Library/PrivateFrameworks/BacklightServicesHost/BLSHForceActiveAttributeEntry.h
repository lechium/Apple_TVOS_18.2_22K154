...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x001000000005a0cf
- (void).cxx_destruct;	// IMP=0x000000000005a3a3
...
- (void)invalidate;	// IMP=0x000000000005a35b
- (_Bool)reactivateIfPossible;	// IMP=0x000000000005a353
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000005a29d
