...
- (void).cxx_destruct;	// IMP=0x000000000004553f
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000454d0
- (double)timeIntervalFromLastEntryToDate:(id)arg1;	// IMP=0x00000000000454b4
- (_Bool)countSpecifier:(id)arg1 hasSecondsBudget:(_Bool)arg2 isCoalesceAllowed:(_Bool)arg3;	// IMP=0x00000000000452de
- (id)description;	// IMP=0x00000000000451a2
- (id)init;	// IMP=0x0000000000045126
