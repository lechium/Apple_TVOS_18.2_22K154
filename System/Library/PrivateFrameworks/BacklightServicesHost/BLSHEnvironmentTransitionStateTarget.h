...
- (void).cxx_destruct;	// IMP=0x00000000000118dc
...
- (_Bool)isEqualToVisualState:(id)arg1 presentationDate:(id)arg2;	// IMP=0x0000000000011817
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000115ff
- (unsigned long long)hash;	// IMP=0x000000000001155f
- (id)debugDescription;	// IMP=0x00000000000113cc
- (id)description;	// IMP=0x0000000000011187
- (id)initWithSequenceID:(unsigned long long)arg1 backlightState:(long long)arg2 visualState:(id)arg3 presentationDate:(id)arg4 triggerEvent:(id)arg5 pendingBacklightRamp:(id)arg6;	// IMP=0x0000000000011090
- (id)initWithTarget:(id)arg1 visualState:(id)arg2 presentationDate:(id)arg3;	// IMP=0x0000000000010f94
- (id)initWithSequenceID:(unsigned long long)arg1 backlightState:(long long)arg2 triggerEvent:(id)arg3 backlightRampBlock:(CDUnknownBlockType)arg4 forIdentifier:(id)arg5 previousTarget:(id)arg6;	// IMP=0x0000000000010c4b
