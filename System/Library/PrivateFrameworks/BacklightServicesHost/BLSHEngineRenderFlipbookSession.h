...
- (id)telemetryDataWithEndTime:(double)arg1 reasonEnded:(id)arg2 preventedSleepDuration:(double)arg3;	// IMP=0x0000000000020613
- (void)prepareAndRenderFrameSpecifier:(id)arg1;	// IMP=0x000000000001fbdf
- (void)invalidate;	// IMP=0x000000000001f9d4
...
- (void)dealloc;	// IMP=0x000000000001f428
- (id)initWithDelegate:(id)arg1 flipbook:(id)arg2 presentation:(id)arg3 osInterfaceProvider:(id)arg4;	// IMP=0x000000000001f063
