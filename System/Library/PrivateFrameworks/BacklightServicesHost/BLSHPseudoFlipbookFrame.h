...
- (void).cxx_destruct;	// IMP=0x0000000000002de0
...
- (id)bls_shortLoggingString;	// IMP=0x0000000000002c66
- (id)bls_loggingString;	// IMP=0x0000000000002b4e
...
- (id)initWithPresentationTime:(unsigned long long)arg1 frameId:(unsigned long long)arg2 specifier:(id)arg3 memoryUsage:(unsigned long long)arg4;	// IMP=0x0000000000002a6c
