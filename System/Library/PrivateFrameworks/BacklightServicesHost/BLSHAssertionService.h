...
+ (id)serviceWithOSInterfaceProvider:(id)arg1 localOnly:(_Bool)arg2;	// IMP=0x0060000000088438
- (void).cxx_destruct;	// IMP=0x0000000000088c1c
...
- (id)initWithOSInterfaceProvider:(id)arg1 localOnly:(_Bool)arg2;	// IMP=0x000000000008848e
