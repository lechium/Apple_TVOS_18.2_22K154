...
- (id)_homePodsSupportingAnnounceIncludingCurrentAccessory:(_Bool)arg1;	// IMP=0x00300000000380e3
- (id)_homePodsWithAnnounceEnabledIncludingCurrentAccessory:(_Bool)arg1;	// IMP=0x0030000000037ee6
- (id)_usersWithAnnounceEnabledIncludingCurrentUser:(_Bool)arg1;	// IMP=0x0030000000037d3c
- (_Bool)an_announceNotificationsEnabledForCurrentUserWithOverrideHomeLocationStatus:(long long)arg1;	// IMP=0x0030000000037a5b
...
- (_Bool)announceAccessAllowedForUser:(id)arg1;	// IMP=0x00300000000374f8
