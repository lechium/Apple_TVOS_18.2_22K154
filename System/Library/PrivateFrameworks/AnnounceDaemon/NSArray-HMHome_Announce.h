...
- (id)personalDevicesForUser:(id)arg1;	// IMP=0x003000000005bd31
- (id)devicesByRemovingNonAccessoryDevicesNotBelongingToUsers:(id)arg1;	// IMP=0x003000000005b9d4
- (id)devicesInHome:(id)arg1;	// IMP=0x003000000005b6c2
