...
- (void).cxx_destruct;	// IMP=0x0000000000011671
- (_Bool)generationsRemove:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000113f7
- (id)initWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000011160
