...
+ (id)feedbackType;	// IMP=0x006000000007a9f7
- (void).cxx_destruct;	// IMP=0x000000000007a9b5
@property(readonly, nonatomic) NSString *uuid; // @synthesize uuid=_uuid;
@property(readonly, nonatomic) NSString *reason; // @synthesize reason=_reason;
@property(readonly, nonatomic) NSString *resetType; // @synthesize resetType=_resetType;
- (id)serverMessage;	// IMP=0x000000000007a815
- (id)initWithResetType:(id)arg1 reason:(id)arg2 uuid:(id)arg3 libraryIdentifier:(id)arg4;	// IMP=0x000000000007a71d
