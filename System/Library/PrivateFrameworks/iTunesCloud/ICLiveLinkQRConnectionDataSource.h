...
+ (id)dataSourceForExistingSharedListeningSession:(id)arg1 identity:(id)arg2;	// IMP=0x00100000001a206e
+ (id)dataSourceForNewSharedListeningSessionWithIdentity:(id)arg1;	// IMP=0x00100000001a201f
- (void).cxx_destruct;	// IMP=0x000000000019f71c
...
- (id)sessionURLForBag:(id)arg1 error:(id *)arg2;	// IMP=0x000000000019eeeb
- (void)_joinSharedListeningSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019eb59
- (void)_revokeUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019ea0e
- (void)_renewUserPseudonym;	// IMP=0x000000000019e85b
- (void)_beginPseudonymAutoRenewal;	// IMP=0x000000000019e6c7
- (void)_provisionUserPseudonymWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019deb6
- (void)populateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000019ddfe
- (void)dealloc;	// IMP=0x000000000019dd4c
- (id)initWithSharedListeningSessionIdentifier:(id)arg1 identity:(id)arg2;	// IMP=0x000000000019dc54
