...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000cd78d
- (void).cxx_destruct;	// IMP=0x00000000000cd74f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000cd612
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000cd463
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cd3f9
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000cd3a8
- (id)_initCommon;	// IMP=0x00000000000cd36d
