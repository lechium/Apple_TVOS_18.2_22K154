...
- (void).cxx_destruct;	// IMP=0x000000000003e09e
- (unsigned long long)hash;	// IMP=0x000000000003de76
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003daf2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003d7d2
- (void)writeTo:(id)arg1;	// IMP=0x000000000003d5ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003d5a0
- (id)dictionaryRepresentation;	// IMP=0x000000000003d004
- (id)description;	// IMP=0x000000000003cf55
