...
- (void).cxx_destruct;	// IMP=0x00000000001eb999
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x00000000001eb746
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (void)reportAppIconBadgeActionMetrics;	// IMP=0x00000000001eb5da
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x00000000001eb55a
