...
- (void).cxx_destruct;	// IMP=0x00000000001662fb
...
- (id)_analyticSignature;	// IMP=0x00000000001660a4
- (id)description;	// IMP=0x0000000000165fba
- (void)_populateItemIdentifiers:(id)arg1;	// IMP=0x0000000000165e02
- (id)_actionType;	// IMP=0x0000000000165dcc
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000165cfc
