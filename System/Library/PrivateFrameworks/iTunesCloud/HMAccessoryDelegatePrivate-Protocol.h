...
#import <iTunesCloud/HMAccessoryDelegate-Protocol.h>
...
@optional
- (void)accessoryDidUpdateSupportsMediaContentProfile:(HMAccessory *)arg1;
...
- (void)accessory:(HMAccessory *)arg1 didUpdateSupportsUWBUnlock:(_Bool)arg2;
...
- (void)accessoryDidUpdateSupportsCompanionInitiatedObliterate:(HMAccessory *)arg1;
