...
- (void).cxx_destruct;	// IMP=0x000000000013e3fc
...
- (void)_sendData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000013e273
- (void)_receivedData:(id)arg1;	// IMP=0x000000000013dffb
- (_Bool)_deriveEncryptionKeysReturningError:(id *)arg1;	// IMP=0x000000000013dabe
- (void)_handlePairingSessionCompletionWithError:(id)arg1;	// IMP=0x000000000013d876
- (id)_encryptedDataForData:(id)arg1;	// IMP=0x000000000013d706
- (void)getEncryptedDataForData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000013d64f
- (void)getDecryptedDataForEncryptedData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000013d598
- (void)receievedData:(id)arg1;	// IMP=0x000000000013d50b
- (void)prepareEncryptedSessionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000013d47e
- (void)dealloc;	// IMP=0x000000000013d43f
- (id)initWithRole:(long long)arg1 securitySettings:(id)arg2;	// IMP=0x000000000013d387
