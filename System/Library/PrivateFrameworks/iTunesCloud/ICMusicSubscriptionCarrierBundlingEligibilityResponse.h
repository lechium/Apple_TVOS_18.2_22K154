...
- (void).cxx_destruct;	// IMP=0x000000000001e5a7
...
- (id)initWithEligibilityDictionary:(id)arg1 cellularProviderName:(id)arg2 phoneNumber:(id)arg3;	// IMP=0x000000000001dd5a
