...
- (void).cxx_destruct;	// IMP=0x000000000008e680
- (unsigned long long)hash;	// IMP=0x000000000008e510
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008e29a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008e061
- (void)writeTo:(id)arg1;	// IMP=0x000000000008deff
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000008def2
- (id)dictionaryRepresentation;	// IMP=0x000000000008db15
- (id)description;	// IMP=0x000000000008da66
