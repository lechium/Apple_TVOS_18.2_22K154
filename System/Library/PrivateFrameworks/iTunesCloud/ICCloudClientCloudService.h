...
- (void).cxx_destruct;	// IMP=0x00000000000190ef
...
- (id)_xpcConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000018e1d
@property(readonly, nonatomic) NSXPCConnection *xpcConnection; // @synthesize xpcConnection=_xpcConnection;
- (void)dealloc;	// IMP=0x0000000000018cdb
- (id)initWithListenerEndpointProvider:(id)arg1;	// IMP=0x0000000000018c5b
