...
- (void).cxx_destruct;	// IMP=0x00000000000b4771
- (unsigned long long)hash;	// IMP=0x00000000000b4663
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b44b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b436e
- (void)writeTo:(id)arg1;	// IMP=0x00000000000b4269
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000b425c
- (id)dictionaryRepresentation;	// IMP=0x00000000000b4029
- (id)description;	// IMP=0x00000000000b3f7a
