...
- (void)_finishWithResult:(_Bool)arg1 tokens:(id)arg2 error:(id)arg3;	// IMP=0x00000000001805d4
- (void)finishWithError:(id)arg1;	// IMP=0x000000000018058a
- (void)execute;	// IMP=0x00000000001804e8
- (void)finishWithResponse:(id)arg1 requestDate:(id)arg2 error:(id)arg3;	// IMP=0x000000000017ffe8
