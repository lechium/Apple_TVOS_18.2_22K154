...
- (void).cxx_destruct;	// IMP=0x00000000001e8eb9
...
- (id)description;	// IMP=0x00000000001e8d49
- (id)initWithCredentialRequests:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001e8b2e
