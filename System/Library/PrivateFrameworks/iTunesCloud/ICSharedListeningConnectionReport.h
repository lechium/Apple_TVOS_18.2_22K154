...
- (void).cxx_destruct;	// IMP=0x00000000001c8288
...
- (void)_addEvents:(id)arg1 toReportString:(id)arg2 eventLevel:(long long)arg3;	// IMP=0x00000000001c7e7a
@property(readonly, nonatomic) NSString *formattedReport;
- (void)endEvent:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001c7a1e
- (void)endEvent:(id)arg1;	// IMP=0x00000000001c7a0a
- (void)startEvent:(id)arg1 withParentEvent:(id)arg2;	// IMP=0x00000000001c78ae
- (void)startEvent:(id)arg1;	// IMP=0x00000000001c789a
- (id)init;	// IMP=0x00000000001c7815
