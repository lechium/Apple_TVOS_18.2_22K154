...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001335fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000133530
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x0000000000133423
