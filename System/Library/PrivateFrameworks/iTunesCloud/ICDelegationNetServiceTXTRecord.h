...
- (void).cxx_destruct;	// IMP=0x00000000001950bb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000194c09
- (id)description;	// IMP=0x0000000000194a53
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019498b
- (unsigned long long)hash;	// IMP=0x0000000000194941
- (id)initWithTXTRecordData:(id)arg1;	// IMP=0x00000000001945a5
