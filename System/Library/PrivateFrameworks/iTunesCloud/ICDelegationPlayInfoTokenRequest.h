...
- (void).cxx_destruct;	// IMP=0x0000000000163268
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016316b
@property(readonly, copy, nonatomic) NSMutableDictionary *propertyListRepresentation;
- (id)initWithDSID:(id)arg1 SICData:(id)arg2;	// IMP=0x000000000016301d
