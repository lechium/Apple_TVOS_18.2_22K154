...
- (void).cxx_destruct;	// IMP=0x000000000019bb02
...
- (void)_stop;	// IMP=0x000000000019b92d
- (void)_handleTimeout;	// IMP=0x000000000019b83d
- (void)stop;	// IMP=0x000000000019b76f
- (void)start;	// IMP=0x000000000019b6a1
- (_Bool)delegationServiceConnection:(id)arg1 didReceiveRequest:(id)arg2;	// IMP=0x000000000019b30c
- (void)delegationServiceConnection:(id)arg1 didEncouterError:(id)arg2;	// IMP=0x000000000019b27f
- (void)delegationServiceConnectionDidClose:(id)arg1;	// IMP=0x000000000019b1f2
- (void)delegationConsumerNetService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000019b128
- (void)dealloc;	// IMP=0x000000000019b0ea
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000019af7e
