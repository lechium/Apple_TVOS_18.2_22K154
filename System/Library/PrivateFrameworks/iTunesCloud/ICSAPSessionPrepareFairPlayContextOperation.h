...
- (void).cxx_destruct;	// IMP=0x000000000016060e
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(retain, nonatomic) ICSAPSession *sapSession; // @synthesize sapSession=_sapSession;
- (void)_exchangeDataWithSAPContext:(id)arg1 requestContext:(id)arg2 setupURL:(id)arg3 responseData:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000160551
- (void)execute;	// IMP=0x00000000001604df
