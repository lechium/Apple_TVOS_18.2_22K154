...
- (void).cxx_destruct;	// IMP=0x00000000001c3787
...
- (void)_decorateHeaderPropertiesForURLRequest:(id)arg1 withBuilderProperties:(id)arg2;	// IMP=0x00000000001c347e
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001c3274
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2;	// IMP=0x00000000001c3231
