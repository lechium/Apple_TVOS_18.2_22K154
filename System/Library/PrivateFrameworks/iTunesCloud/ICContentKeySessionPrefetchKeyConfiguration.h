...
- (void).cxx_destruct;	// IMP=0x0000000000183dad
- (void)_fetchWithRequestContext:(id)arg1;	// IMP=0x0000000000183d09
...
- (id)initWithRequestContext:(id)arg1;	// IMP=0x00000000001838bf
