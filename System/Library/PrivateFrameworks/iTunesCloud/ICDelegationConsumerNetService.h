...
- (void).cxx_destruct;	// IMP=0x0000000000040965
...
- (void)_updateNetServiceStatus;	// IMP=0x0000000000040458
- (void)stop;	// IMP=0x000000000004040d
- (void)publish;	// IMP=0x00000000000403c2
@property(readonly, nonatomic) ICDelegationServiceSecuritySettings *securitySettings;
- (void)netService:(id)arg1 didNotPublish:(id)arg2;	// IMP=0x0000000000040097
- (void)netServiceDidPublish:(id)arg1;	// IMP=0x000000000003ffde
- (void)netService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000003fe52
- (void)dealloc;	// IMP=0x000000000003fd91
- (id)initWithUserIdentityDelegationAccountUUIDs:(id)arg1;	// IMP=0x000000000003fcc6
