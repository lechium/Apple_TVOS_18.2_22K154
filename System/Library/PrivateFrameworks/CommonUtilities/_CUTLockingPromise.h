...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000775c
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x000000000000753d
- (id)init;	// IMP=0x00000000000074af
