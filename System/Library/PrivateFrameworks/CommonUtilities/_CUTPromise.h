...
- (void).cxx_destruct;	// IMP=0x0000000000007361
...
- (void)registerResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000071bd
- (void)_fulfillWithResult:(id)arg1;	// IMP=0x0000000000007092
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000006ff5
