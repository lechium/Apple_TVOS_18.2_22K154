...
- (void).cxx_destruct;	// IMP=0x00000000000ad6a6
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000acb7b
- (id)description;	// IMP=0x00000000000ac9e9
