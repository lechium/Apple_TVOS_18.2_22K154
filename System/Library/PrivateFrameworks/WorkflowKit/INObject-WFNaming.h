...
- (id)wf_initWithIdentifier:(id)arg1 displayString:(id)arg2;	// IMP=0x00200000003b7101
- (void)wf_transformUsingCodableAttribute:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0020000000505d01
