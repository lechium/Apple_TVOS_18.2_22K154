...
- (void).cxx_destruct;	// IMP=0x0000000000091162
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000090f6f
- (unsigned long long)hash;	// IMP=0x0000000000090e6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000090ccb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000090b77
- (void)copyTo:(id)arg1;	// IMP=0x0000000000090a75
- (void)writeTo:(id)arg1;	// IMP=0x0000000000090971
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000090964
- (id)dictionaryRepresentation;	// IMP=0x0000000000090365
- (id)description;	// IMP=0x00000000000902b6
...
- (id)tuAssociationForHandle:(id)arg1;	// IMP=0x0000000000029749
