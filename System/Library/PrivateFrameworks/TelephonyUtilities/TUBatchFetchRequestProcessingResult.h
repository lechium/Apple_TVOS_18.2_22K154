...
- (void).cxx_destruct;	// IMP=0x00000000000608fd
...
- (id)initWithHandleToFetchRequest:(id)arg1 handlesToBatchFetch:(id)arg2 allHandlesFromFetchRequests:(id)arg3 fetchRequestResults:(id)arg4;	// IMP=0x00000000000607ed
