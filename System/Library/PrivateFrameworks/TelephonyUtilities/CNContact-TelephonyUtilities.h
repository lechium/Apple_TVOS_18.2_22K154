...
+ (id)keysToFetchForFaceTime;	// IMP=0x001000000002b5f0
+ (id)tu_contactHandlesForHandle:(id)arg1;	// IMP=0x001000000010749f
- (id)allTUHandles;	// IMP=0x001000000000ec88
- (id)tuHandlesForEmailAddresses;	// IMP=0x001000000000ea54
- (id)tuHandlesForPhoneNumbers;	// IMP=0x001000000000e7aa
- (id)tu_localizedDisplayStringForHandle:(id)arg1;	// IMP=0x001000000000e399
- (id)tu_labeledValueForSocialProfileWithUsername:(id)arg1;	// IMP=0x001000000000e144
- (id)tu_labeledValueForPhoneNumber:(id)arg1;	// IMP=0x001000000000df0e
- (id)tu_labeledValueForHandle:(id)arg1;	// IMP=0x001000000000dd2c
- (id)tu_labeledValueForEmailAddress:(id)arg1;	// IMP=0x001000000000daf6
