...
+ (id)voucherWithTUVoucher:(id)arg1;	// IMP=0x00100000000746d6
- (void).cxx_destruct;	// IMP=0x000000000005fc06
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000005fab9
- (unsigned long long)hash;	// IMP=0x000000000005fa35
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005f929
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005f83f
- (void)copyTo:(id)arg1;	// IMP=0x000000000005f79c
- (void)writeTo:(id)arg1;	// IMP=0x000000000005f705
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000005f6f8
- (id)dictionaryRepresentation;	// IMP=0x000000000005f3e3
- (id)description;	// IMP=0x000000000005f334
