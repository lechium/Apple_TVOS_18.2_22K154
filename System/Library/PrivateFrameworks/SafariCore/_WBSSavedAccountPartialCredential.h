...
- (void).cxx_destruct;	// IMP=0x000000000007e9a9
...
- (id)initWithProtectionSpace:(id)arg1 modificationDate:(id)arg2 creationDate:(id)arg3 persistentIdentifier:(id)arg4 isDefaultCredentialForProtectionSpace:(_Bool)arg5;	// IMP=0x000000000007e875
