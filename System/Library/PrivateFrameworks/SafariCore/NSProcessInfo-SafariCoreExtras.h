...
@property(readonly, nonatomic) _Bool safari_isPasswordManagerTestMode;
...
- (id)_safari_operatingSystemVersionStringFromOperatingSystemVersion:(CDStruct_2ec95fd7)arg1;	// IMP=0x003000000003f320
