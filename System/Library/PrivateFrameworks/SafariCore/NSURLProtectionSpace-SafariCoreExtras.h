...
+ (id)safari_passkeySidecarProtectionSpaceForRelyingPartyIdentifier:(id)arg1;	// IMP=0x002000000004ae7a
+ (id)safari_HTMLFormProtectionSpaceForURL:(id)arg1;	// IMP=0x002000000004ad46
...
- (_Bool)isEqualToProtectionSpaceForPasswordManager:(id)arg1;	// IMP=0x001000000004b8e5
- (id)safari_creationDateOfCredentialWithUser:(id)arg1;	// IMP=0x001000000004b712
...
- (long long)safari_compareToHighLevelDomainFromProtectionSpace:(id)arg1;	// IMP=0x001000000004b321
- (long long)safari_compareToHighLevelDomainFromProtectionSpaceOrderingDecimalCharactersLast:(id)arg1;	// IMP=0x001000000004b165
