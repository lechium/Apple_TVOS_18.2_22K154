...
- (void).cxx_destruct;	// IMP=0x000000000005e4fc
...
- (id)initWithPatternMatch:(id)arg1 guessesRequiredWithoutPatternCountPenalty:(double)arg2 withPatternCountPenalty:(double)arg3;	// IMP=0x000000000005e43e
