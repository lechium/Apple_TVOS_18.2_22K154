...
- (void).cxx_destruct;	// IMP=0x00000000000011dc
...
- (_Bool)createDirectoryAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000010de
- (_Bool)writeData:(id)arg1 toFile:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000104f
- (id)init;	// IMP=0x0000000000001020
