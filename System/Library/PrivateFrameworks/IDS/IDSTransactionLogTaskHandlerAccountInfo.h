...
- (void).cxx_destruct;	// IMP=0x000000000014c1ef
...
- (id)accountForAlias:(id)arg1;	// IMP=0x000000000014c14e
- (id)initWithAccountIdentity:(id)arg1 aliasToAccountsMap:(id)arg2 serviceName:(id)arg3;	// IMP=0x000000000014c096
