...
- (void).cxx_destruct;	// IMP=0x000000000013b141
...
- (id)dictionaryRepresentation;	// IMP=0x000000000013ab3d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000013a0ca
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000139b88
