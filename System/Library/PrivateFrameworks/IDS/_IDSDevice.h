...
- (void).cxx_destruct;	// IMP=0x00000000001070d4
@property(readonly, nonatomic) IDSEndpointCapabilities *capabilities; // @synthesize capabilities=_capabilities;
- (void)_setService:(id)arg1;	// IMP=0x0000000000106fe8
- (void)_setAccount:(id)arg1;	// IMP=0x0000000000106f06
- (void)_stateChanged;	// IMP=0x0000000000106d94
- (void)_cloudConnectedStateChanged;	// IMP=0x0000000000106c55
- (void)_connectedStateChanged;	// IMP=0x0000000000106b16
- (void)_nearbyStateChanged;	// IMP=0x00000000001069d7
- (_Bool)isTinker;	// IMP=0x00000000001069bf
- (void)_addIdentity:(id)arg1;	// IMP=0x0000000000106672
...
- (id)compactDescription;	// IMP=0x0000000000104979
@property(readonly, copy) NSString *description;
- (id)fullDescription;	// IMP=0x0000000000104040
...
- (void)stateDidChange:(unsigned long long)arg1;	// IMP=0x0000000000103738
- (void)dealloc;	// IMP=0x00000000001036fa
- (void)cancel;	// IMP=0x00000000001036b9
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001032f4
