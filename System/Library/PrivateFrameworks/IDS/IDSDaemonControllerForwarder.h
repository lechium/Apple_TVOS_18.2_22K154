...
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000000a85e
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x000000000000a841
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000000a750
- (id)initWithProtocol:(id)arg1 ivarQueue:(id)arg2 remoteMessageQueue:(id)arg3;	// IMP=0x000000000000a73b
