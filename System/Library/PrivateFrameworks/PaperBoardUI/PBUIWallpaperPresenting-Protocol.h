...
@class BSAnimationSettings, BSUIAnimationFactory, NSArray, NSSet, NSString, NSUUID, PBUIHomeVariantStyleState, PRSPosterConfiguration, UIGestureRecognizer, UIView;
...
- (_Bool)updateCurrentPosterWithUpdates:(NSArray *)arg1 error:(out id *)arg2;
- (void)noteHomeVariantStyleStateMayHaveUpdated;
- (id <BSInvalidatable>)acquireDuckHomeScreenWallpaperDimAssertionWithReason:(NSString *)arg1;
- (void)fetchWallpaperProminentColor:(void (^)(UIColor *))arg1;
