...
- (void)readStoreBagValues;	// IMP=0x00000000002c13b7
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x00000000002c11a2
- (void)readHardwareValues;	// IMP=0x00000000002c1178
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x00000000002c1100
- (void)dealloc;	// IMP=0x00000000002c10a2
- (id)init;	// IMP=0x00000000002c101e
