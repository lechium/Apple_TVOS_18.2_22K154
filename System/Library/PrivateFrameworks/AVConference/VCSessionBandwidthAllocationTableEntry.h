...
@interface VCSessionBandwidthAllocationTableEntry : NSObject
{
    ...
    unsigned int _v2StreamID;	// 48 = 0x30
    unsigned int _actualNetworkBitrate;	// 52 = 0x34
    _Bool _hasRepairStreamID;	// 56 = 0x38
    unsigned int _repairStreamID;	// 60 = 0x3c
    unsigned int _repairMaxNetworkBitrate;	// 64 = 0x40
    _Bool _onDemand;	// 68 = 0x44
    unsigned int _streamGroupID;	// 72 = 0x48
    unsigned int _encoderGroupID;	// 76 = 0x4c
...
+ (long long)compareAudioEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ec76a
+ (long long)compareVideoEntry:(id)arg1 videoEntry:(id)arg2;	// IMP=0x00600000001ec2de
+ (long long)compareAudioEntry:(id)arg1 audioEntry:(id)arg2;	// IMP=0x00600000001ec0af
+ (unsigned char)entryTypeForMediaType:(unsigned int)arg1;	// IMP=0x00600000001ebe68
...
- (long long)compare:(id)arg1;	// IMP=0x00000000001ebef4
- (id)description;	// IMP=0x00000000001ebd63
- (void)dealloc;	// IMP=0x00000000001ebd05
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 streamID:(unsigned int)arg4 streamGroupID:(unsigned int)arg5;	// IMP=0x00000000001ebc54
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 minNetworkBitrate:(unsigned int)arg4 maxNetworkBitrate:(unsigned int)arg5 mediaBitrate:(unsigned int)arg6 qualityIndex:(unsigned int)arg7 streamID:(unsigned int)arg8 hasRepairStreamID:(_Bool)arg9 repairStreamID:(unsigned int)arg10 repairMaxNetworkBitrate:(unsigned int)arg11 subscribedTo:(_Bool)arg12 startOnDemand:(_Bool)arg13 streamGroupID:(unsigned int)arg14 encoderGroupID:(unsigned int)arg15 v2StreamID:(unsigned int)arg16;	// IMP=0x00000000001ebb5b
- (id)initWithClient:(id)arg1 type:(unsigned char)arg2 streamToken:(long long)arg3 networkBitrate:(unsigned int)arg4 mediaBitrate:(unsigned int)arg5 qualityIndex:(unsigned int)arg6 streamID:(unsigned int)arg7 streamGroupID:(unsigned int)arg8 v2StreamID:(unsigned int)arg9;	// IMP=0x00000000001ebb0e
