...
+ (id)screenVirtualDisplayLabelName;	// IMP=0x00600000004c4097
+ (_Bool)forceEnableScreenVirtualDisplayLabel;	// IMP=0x00600000004c4077
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000004c21ba
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00600000004c215a
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000004c213f
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x00600000004c1ff5
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000004c1fda
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x00600000004c1e89
+ (id)sharedInstance;	// IMP=0x00600000004c1daa
...
- (_Bool)startAirPlayAudioHALPluginNullDevice;	// IMP=0x00000000004c4057
- (_Bool)startAudioHALPluginNullDevice;	// IMP=0x00000000004c4037
- (_Bool)forceEnableAudioHALPluginMockInput;	// IMP=0x00000000004c4017
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x00000000004c3ff5
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x00000000004c3c05
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x00000000004c3900
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x00000000004c38de
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x00000000004c370c
- (_Bool)forceWifiAssist;	// IMP=0x00000000004c36ec
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x00000000004c278a
...
- (void)seperateString:(id)arg1;	// IMP=0x00000000004c2483
...
- (id)autorelease;	// IMP=0x00000000004c227c
- (oneway void)release;	// IMP=0x00000000004c2276
- (unsigned long long)retainCount;	// IMP=0x00000000004c2269
- (id)retain;	// IMP=0x00000000004c2260
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c2257
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c224a
- (id)init;	// IMP=0x00000000004c21f8
