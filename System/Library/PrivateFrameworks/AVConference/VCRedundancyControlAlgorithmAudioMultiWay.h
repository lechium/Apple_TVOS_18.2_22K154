...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x00000000002de7d0
- (void)computeRedundancyInfo;	// IMP=0x00000000002de74e
- (void)reset;	// IMP=0x00000000002de748
- (void)processRCNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002de554
- (void)processNWConnectionStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002de4ba
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x00000000002de48d
- (id)init;	// IMP=0x00000000002de41d
