...
- (unsigned long long)feedbackSize;	// IMP=0x000000000016b8ff
- (int)addMediaControlInfoOption:(unsigned int)arg1;	// IMP=0x000000000016b8f4
- (int)deregisterCallbacksWithContext:(void *)arg1;	// IMP=0x000000000016b4d4
- (int)registerFillBlobCallback:(CDUnknownFunctionPointerType)arg1 processBlobCallback:(CDUnknownFunctionPointerType)arg2 context:(void *)arg3;	// IMP=0x000000000016b470
- (void)dealloc;	// IMP=0x000000000016b3f7
- (id)initWithType:(unsigned int)arg1 version:(unsigned char)arg2;	// IMP=0x000000000016b310
