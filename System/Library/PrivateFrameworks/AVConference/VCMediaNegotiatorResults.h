...
- (unsigned int)maxBandwidthWithArbiterMode:(unsigned char)arg1 connectionType:(int)arg2;	// IMP=0x0000000000373829
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x00000000003737f4
- (void)dealloc;	// IMP=0x0000000000373780
- (id)init;	// IMP=0x0000000000373700
