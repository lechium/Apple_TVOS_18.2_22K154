...
- (unsigned long long)hash;	// IMP=0x00000000002cca85
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002cc9ed
- (id)description;	// IMP=0x00000000002cc998
- (void)dealloc;	// IMP=0x00000000002cc934
- (id)initWithStreamConfig:(const struct tagVCAudioCaptionsStreamConfig *)arg1 bufferLength:(double)arg2;	// IMP=0x00000000002cc5b1
