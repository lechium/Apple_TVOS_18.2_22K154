...
- (id)entryForQualityIndex:(unsigned int)arg1;	// IMP=0x00000000004b1061
- (_Bool)addTableEntry:(id)arg1;	// IMP=0x00000000004b0f1a
- (void)dealloc;	// IMP=0x00000000004b0ead
- (id)init;	// IMP=0x00000000004b0e2e
