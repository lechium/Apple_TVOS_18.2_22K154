...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x00100000003fc9b8
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x00100000003fc998
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x00100000003fc808
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x00100000003fc6ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000b4e9
- (unsigned long long)hash;	// IMP=0x000000000000b39b
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b1f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b0b8
- (void)copyTo:(id)arg1;	// IMP=0x000000000000afbe
- (void)writeTo:(id)arg1;	// IMP=0x000000000000ae2d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000ae20
- (id)dictionaryRepresentation;	// IMP=0x000000000000a370
- (id)description;	// IMP=0x000000000000a2d6
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003fc446
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x00000000003fc1ca
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003fbfc8
