...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003022d
- (id)initWithArbiterMode:(unsigned char)arg1 connectionType:(int)arg2 maxBandwidth:(unsigned int)arg3;	// IMP=0x00000000000301b8
- (id)initWithConnectionType:(int)arg1 maxBandwidth:(unsigned int)arg2;	// IMP=0x0000000000030147
