...
- (void)process:(id)arg1;	// IMP=0x000000000014b7c0
- (double)computeNetworkDelay;	// IMP=0x000000000014b6df
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x000000000014b478
- (id)init;	// IMP=0x000000000014b41a
