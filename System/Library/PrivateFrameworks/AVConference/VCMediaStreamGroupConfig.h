...
- (void)setupStreams;	// IMP=0x000000000019b493
...
- (_Bool)addMediaStreamInfo:(id)arg1;	// IMP=0x000000000019b23f
- (void)unlock;	// IMP=0x000000000019b1f0
- (void)lock;	// IMP=0x000000000019b1df
- (void)dealloc;	// IMP=0x000000000019b106
- (id)init;	// IMP=0x000000000019b076
