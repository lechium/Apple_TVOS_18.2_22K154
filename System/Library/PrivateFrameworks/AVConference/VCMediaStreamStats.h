...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x00000000001b6db0
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x00000000001b6d3b
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x00000000001b6cd8
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x00000000001b6c21
- (void)dealloc;	// IMP=0x00000000001b6bba
- (id)init;	// IMP=0x00000000001b6ae3
