...
- (void)applyDefaultsConfigurationOverrides;	// IMP=0x00000000000556f4
- (void)cleanupNwActivity;	// IMP=0x00000000000556df
- (_Bool)applyConfigurationUsingClientDict:(id)arg1;	// IMP=0x0000000000055480
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x00000000000552e4
@property(nonatomic) long long sessionMode; // @synthesize sessionMode=_sessionMode;
- (void)dealloc;	// IMP=0x0000000000055137
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x00000000000550f8
- (id)init;	// IMP=0x0000000000055081
