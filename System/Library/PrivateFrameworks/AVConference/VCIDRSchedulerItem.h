...
- (id)description;	// IMP=0x000000000007b022
- (long long)compareBudget:(id)arg1;	// IMP=0x000000000007afc9
- (void)addStream:(id)arg1;	// IMP=0x000000000007af64
- (void)dealloc;	// IMP=0x000000000007af06
- (id)init;	// IMP=0x000000000007ae90
