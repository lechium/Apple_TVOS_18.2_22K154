...
@interface VCMediaStreamConfig : NSObject
{
    ...
    _Bool _isEnhancedJBAdaptationsEnabled;	// 298 = 0x12a
    unsigned char _dscpTag;	// 299 = 0x12b
    _Bool _isExtraDelayForPacketRetransmissionsEnabled;	// 300 = 0x12c
    _Bool _isRedundancyControlEnabled;	// 301 = 0x12d
    unsigned char _redundancyControllerFECVersion;	// 302 = 0x12e
...
- (int)jitterBufferModeFromAVCJitterBufferMode:(unsigned int)arg1;	// IMP=0x0000000000443e20
- (void)applyMediaStreamClientDictionary:(id)arg1;	// IMP=0x00000000004438f6
- (void)setupMediaStreamConfig;	// IMP=0x000000000044386d
@property(readonly, nonatomic) long long primaryTxCodecType;
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x00000000004436af
- (void)addTxPayloadType:(int)arg1;	// IMP=0x0000000000443698
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000044362f
- (void)addRxPayloadType:(int)arg1;	// IMP=0x0000000000443618
- (id)description;	// IMP=0x00000000004435d7
- (void)dealloc;	// IMP=0x00000000004434f9
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x0000000000443430
- (id)init;	// IMP=0x00000000004433c1
