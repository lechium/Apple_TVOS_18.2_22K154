...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000047abb
- (unsigned long long)hash;	// IMP=0x00000000000478cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004776c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000047660
- (void)copyTo:(id)arg1;	// IMP=0x0000000000047592
- (void)writeTo:(id)arg1;	// IMP=0x000000000004745d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000047450
- (id)dictionaryRepresentation;	// IMP=0x0000000000046c56
- (id)description;	// IMP=0x0000000000046bbc
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x00000000003fbdc7
- (id)newMultiwayAudioStream;	// IMP=0x00000000003fbc22
- (void)setPayloadFlagsWithPayloads:(id)arg1;	// IMP=0x00000000003fbaad
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003fb902
