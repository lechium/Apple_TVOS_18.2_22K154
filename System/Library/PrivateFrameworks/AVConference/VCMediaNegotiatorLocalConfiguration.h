...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000147053
- (_Bool)isEqualFaceTimeSettings:(id)arg1;	// IMP=0x0000000000146f71
- (_Bool)isEqualMediaRecorderVideoCodecs:(id)arg1;	// IMP=0x0000000000146de5
- (_Bool)isEqualMediaRecorderImageTypes:(id)arg1;	// IMP=0x0000000000146c59
- (_Bool)isEqualStreamGroupConfigs:(id)arg1;	// IMP=0x0000000000146a1c
- (_Bool)isEqualMultiwayVideoStreamSet:(id)arg1;	// IMP=0x00000000001467e5
- (_Bool)isEqualMultiwayAudioStreamSet:(id)arg1;	// IMP=0x00000000001465ae
- (_Bool)isEqualBandwidthConfigurations:(id)arg1;	// IMP=0x00000000001463a9
- (void)resetStreamGroups;	// IMP=0x0000000000146390
- (void)addStreamGroupConfig:(id)arg1;	// IMP=0x0000000000146377
- (void)addMultiwayVideoStream:(id)arg1;	// IMP=0x0000000000146361
- (void)addMultiwayAudioStream:(id)arg1;	// IMP=0x000000000014634b
- (void)addBandwidthConfiguration:(id)arg1;	// IMP=0x0000000000146335
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000145fc9
- (_Bool)setupBandwidthExtensionConfiguration:(id)arg1;	// IMP=0x00000000001459f0
- (_Bool)setupBandwidthConfigurationsWithArbiter:(id)arg1;	// IMP=0x00000000001454e9
- (id)mediaConfigurationForMediaType:(unsigned char)arg1;	// IMP=0x00000000001454a1
- (void)setMediaConfiguration:(id)arg1 forMediaType:(unsigned char)arg2;	// IMP=0x0000000000145457
- (void)dealloc;	// IMP=0x000000000014539b
- (id)initWithBitrateArbiter:(id)arg1;	// IMP=0x0000000000145352
- (id)init;	// IMP=0x0000000000144f40
