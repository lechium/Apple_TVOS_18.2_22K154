...
+ (id)profileLevelStringForId:(unsigned int)arg1;	// IMP=0x0060000000363f0f
+ (unsigned int)profileLevelIdForString:(id)arg1;	// IMP=0x0060000000363e8d
+ (_Bool)validateClientDictionary:(id)arg1;	// IMP=0x0060000000363b63
...
- (void)initializeParameterSets;	// IMP=0x0000000000364844
- (void)addTxBitrateTier:(id)arg1;	// IMP=0x000000000036479e
- (void)addTxCodecFeatureListString:(id)arg1 codecType:(long long)arg2;	// IMP=0x000000000036474c
- (void)addRxCodecFeatureListString:(id)arg1 codecType:(long long)arg2;	// IMP=0x00000000003646fa
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x00000000003646e8
- (_Bool)applyVideoStreamClientDictionary:(id)arg1;	// IMP=0x0000000000363f95
- (void)dealloc;	// IMP=0x0000000000363abe
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x00000000003637bc
- (id)init;	// IMP=0x00000000003637a8
