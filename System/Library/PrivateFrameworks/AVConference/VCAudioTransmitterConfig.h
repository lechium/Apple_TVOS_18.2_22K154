...
@interface VCAudioTransmitterConfig : NSObject
{
    ...
    _Bool _isHigherAudioREDCutoverU1Enabled;	// 293 = 0x125
    _Bool _targetBitrateIsAudioOnly;	// 294 = 0x126
}
...
- (id)description;	// IMP=0x0000000000467f96
- (void)dealloc;	// IMP=0x0000000000467eec
