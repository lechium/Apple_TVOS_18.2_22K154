...
- (id)streamIds;	// IMP=0x00000000003634f9
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x00000000003634dc
- (void)addPayload:(int)arg1;	// IMP=0x000000000036349c
- (void)dealloc;	// IMP=0x0000000000363421
- (id)init;	// IMP=0x0000000000363394
