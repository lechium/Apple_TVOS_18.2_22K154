...
- (void)getFrameRate:(double *)arg1 frameCount:(int *)arg2;	// IMP=0x00000000003d2e99
- (struct __CVBuffer *)createPixelBufferForFrameIndex:(int)arg1;	// IMP=0x00000000003d290a
- (void)attachMetadataToPixelBuffer:(struct __CVBuffer *)arg1;	// IMP=0x00000000003d2904
- (int)setWidth:(int)arg1 height:(int)arg2;	// IMP=0x00000000003d26ac
- (int)initialize;	// IMP=0x00000000003d23d9
- (int)initializeAssetReader;	// IMP=0x00000000003d2108
- (int)loadCannedMediaAssets;	// IMP=0x00000000003d1e61
- (int)finalizeVideoCapture;	// IMP=0x00000000003d1ce6
- (int)loadMetadataTrackFromList:(id)arg1 error:(id)arg2;	// IMP=0x00000000003d1ba0
- (int)loadVideoTrackFromList:(id)arg1 error:(id)arg2;	// IMP=0x00000000003d1a3c
- (void)dealloc;	// IMP=0x00000000003d1952
- (id)initWithPath:(id)arg1;	// IMP=0x00000000003d183c
