...
@interface VCAudioPayloadConfig : NSObject
{
    ...
    int _evsCMRMode;	// 84 = 0x54
    NSString *_description;	// 88 = 0x58
}
...
- (id)description;	// IMP=0x00000000004ab603
- (id)className;	// IMP=0x00000000004ab5f1
- (void)updateDescription;	// IMP=0x00000000004ab52c
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x00000000004ab436
- (void)dealloc;	// IMP=0x00000000004ab3c2
- (id)initWithConfigDict:(id)arg1;	// IMP=0x00000000004ab328
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x00000000004aaf13
- (void)createSupportedBitratesForEVS;	// IMP=0x00000000004aaef2
- (void)createSupportedBitratesForAMR16k;	// IMP=0x00000000004aaed1
- (void)createSupportedBitratesForAMR8k;	// IMP=0x00000000004aaeb0
- (void)createSupportedBitratesForOpus;	// IMP=0x00000000004aae8f
- (void)createSupportedBitratesForAACELD48;	// IMP=0x00000000004aae6e
- (void)createSupportedBitratesForAACELD;	// IMP=0x00000000004aae4d
- (void)createSupportedBitrates;	// IMP=0x00000000004aadce
- (unsigned int)aacBitrate;	// IMP=0x00000000004aaca1
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x00000000004aac26
- (_Bool)configure:(id)arg1;	// IMP=0x00000000004aa518
