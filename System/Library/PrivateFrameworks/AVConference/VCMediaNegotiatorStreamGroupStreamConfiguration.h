...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010d528
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010cf6d
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x000000000010ce2c
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x000000000010cbdb
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x000000000010cb7e
- (void)resetCodecs;	// IMP=0x000000000010cb68
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x000000000010cb2f
- (void)addCodec:(unsigned int)arg1;	// IMP=0x000000000010caf6
- (void)resetPayloads;	// IMP=0x000000000010cae0
- (void)addPayload:(int)arg1;	// IMP=0x000000000010caa7
- (void)dealloc;	// IMP=0x000000000010ca3a
- (id)init;	// IMP=0x000000000010c9b4
