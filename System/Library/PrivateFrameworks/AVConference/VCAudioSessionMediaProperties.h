...
@interface VCAudioSessionMediaProperties : NSObject
{
    ...
    _Bool _audioClockDeviceEnabled;	// 117 = 0x75
    _Bool _networkUplinkClockUsesBaseband;	// 118 = 0x76
}
...
- (id)description;	// IMP=0x00000000004fd170
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004fc0ef
