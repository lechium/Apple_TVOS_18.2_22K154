...
@interface AVCStatisticsCollector : NSObject
{
    ...
    struct _VCSingleLinkedList _statisticsChangeHandlers[15];	// 360 = 0x168
    struct _opaque_pthread_rwlock_t _statisticsChangeHandlersLock;	// 840 = 0x348
    struct __CFAllocator *_changeHandlerRequestAllocator;	// 1040 = 0x410
    struct tagAVCStatisticsCollectorChangedHandlerRequest _changeHandlerRequests;	// 1048 = 0x418
    struct os_unfair_lock_s _changeHandlerRequestsLock;	// 1080 = 0x438
    struct _opaque_pthread_mutex_t _startMutex;	// 1088 = 0x440
}
...
- (struct tagVCStatisticsMessage)getVCStatisticsWithType:(int)arg1 time:(double)arg2;	// IMP=0x00000000000436b5
- (_Bool)shouldProcessAtTime:(double)arg1;	// IMP=0x0000000000043676
- (void)unregisterAllStatisticsChangeHandlers;	// IMP=0x00000000000433f1
- (_Bool)unregisterStatisticsChangeHandlerWithType:(int)arg1 handlerIndex:(int)arg2;	// IMP=0x000000000004336e
- (int)registerStatisticsChangeHandlerWithType:(int)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000042fb4
- (void)setMaxBitrate:(unsigned int)arg1;	// IMP=0x0000000000042f1c
- (id)getStatistics:(id)arg1;	// IMP=0x0000000000042d3a
- (void)setStatistics:(id)arg1;	// IMP=0x0000000000042b5a
- (void)stop;	// IMP=0x0000000000042852
- (void)start;	// IMP=0x0000000000041c2b
- (void)dealloc;	// IMP=0x0000000000041991
- (id)initForSimulation:(_Bool)arg1 useExternalThread:(_Bool)arg2;	// IMP=0x00000000000415de
- (id)init;	// IMP=0x00000000000415c8
