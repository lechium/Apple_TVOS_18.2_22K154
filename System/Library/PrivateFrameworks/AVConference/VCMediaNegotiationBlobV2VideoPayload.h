...
@interface VCMediaNegotiationBlobV2VideoPayload : PBCodable
{
    ...
    unsigned int _preferredDecodeFormat;	// 32 = 0x20
    unsigned int _videoPayload;	// 36 = 0x24
    struct {
...
+ (int)rtpPayloadWithPayload:(int)arg1;	// IMP=0x001000000026903c
+ (int)payloadWithRTPPayload:(int)arg1;	// IMP=0x0010000000268f3c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003a13f
- (unsigned long long)hash;	// IMP=0x000000000003a058
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000039f21
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000039e19
- (void)copyTo:(id)arg1;	// IMP=0x0000000000039d51
- (void)writeTo:(id)arg1;	// IMP=0x0000000000039c69
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000039c5c
- (id)dictionaryRepresentation;	// IMP=0x0000000000039677
- (id)description;	// IMP=0x00000000000395dd
...
- (void)dealloc;	// IMP=0x00000000000393d4
- (void)setupVideoParameterSupport:(unsigned int)arg1;	// IMP=0x000000000026a15f
- (_Bool)setupEncode:(_Bool)arg1 videoRules:(id)arg2;	// IMP=0x0000000000269132
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2;	// IMP=0x000000000026883e
@property(readonly, nonatomic) unsigned int videoParameterSupport;
- (id)videoRulesWithBitmap:(unsigned int)arg1 preferredBitmap:(unsigned int)arg2;	// IMP=0x0000000000266e5d
...
- (id)initWithPayload:(int)arg1 encodeVideoRules:(id)arg2 decodeVideoRules:(id)arg3 videoParameterSupport:(unsigned int)arg4 featureListStrings:(id)arg5;	// IMP=0x0000000000266bb8
