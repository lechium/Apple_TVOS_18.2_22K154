...
- (id)className;	// IMP=0x000000000037bd3f
- (void)releaseLogDumpFile;	// IMP=0x000000000037bc76
- (void)createLogDumpFile:(unsigned int)arg1;	// IMP=0x000000000037bbce
- (void)updateAverageTargetBitrate:(unsigned int)arg1 interval:(double)arg2;	// IMP=0x000000000037bb2a
- (void)setOperatingTierIndexWithBitrate:(unsigned int)arg1;	// IMP=0x000000000037b920
- (unsigned short)maxTierIndex:(unsigned int)arg1;	// IMP=0x000000000037b89e
- (unsigned short)minTierIndex:(unsigned int)arg1;	// IMP=0x000000000037b812
...
- (void)updateVideoStall:(_Bool)arg1 withStallDuration:(unsigned int)arg2;	// IMP=0x000000000037b717
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000037b630
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingBitrate:(unsigned int)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x000000000037b393
- (void)setRateControlInterval:(double)arg1;	// IMP=0x000000000037b301
- (void)setMaxTargetBitrate:(unsigned int)arg1 minTargetBitrate:(unsigned int)arg2;	// IMP=0x000000000037b206
- (void)dealloc;	// IMP=0x000000000037b192
- (id)initWithDumpID:(unsigned int)arg1;	// IMP=0x000000000037aff1
