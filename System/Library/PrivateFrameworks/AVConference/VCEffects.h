...
- (_Bool)releaseFrameWithTime:(long long)arg1;	// IMP=0x00000000003693a9
- (_Bool)addFrame:(struct __CVBuffer *)arg1 time:(long long)arg2;	// IMP=0x0000000000369393
- (void)dealloc;	// IMP=0x0000000000369335
- (id)init;	// IMP=0x00000000003692ab
