...
@class AVCRateController, AVCStatisticsCollector, NSArray, NSMutableDictionary, NSObject, NSString, VCAudioCaptionsCoordinator, VCAudioHALPluginRemoteDeviceInfo, VCAudioStream, VCCannedAudioInjector, VCMediaRecorder, VCRateControlMediaController, VCRedundancyControllerAudio, VCRedundancyControllerVideo, VCSwitchManager;
...
struct tagVCAudioIODelegateContext {
    ...
    VCAudioCaptionsCoordinator *captionsCoordinator;
    _Bool captionsUseSecondaryThread;
};
