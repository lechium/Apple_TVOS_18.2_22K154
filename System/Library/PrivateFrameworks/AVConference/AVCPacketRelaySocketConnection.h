...
- (void)dealloc;	// IMP=0x00000000003ce9eb
- (id)description;	// IMP=0x00000000003ce91f
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x00000000003ce601
- (void)receiveDataOnSocket:(unsigned short)arg1;	// IMP=0x00000000003ce298
- (void)readyToRead;	// IMP=0x00000000003ce282
- (int)stop;	// IMP=0x00000000003ce186
- (int)start;	// IMP=0x00000000003ce031
- (id)initWithSocket:(unsigned short)arg1 remoteAddress:(id)arg2 packetFilter:(id)arg3;	// IMP=0x00000000003cdc30
