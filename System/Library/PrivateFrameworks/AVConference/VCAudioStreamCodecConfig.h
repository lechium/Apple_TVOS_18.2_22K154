...
- (void)setupEVSModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x00000000000560ba
- (void)setupAMRWBModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000055ea8
- (void)setupAMRModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000055ccc
- (void)setPreferredModeWithClientMode:(int)arg1;	// IMP=0x0000000000055cc3
- (void)setupCodecBandwidthsWithClientBandwidthMask:(unsigned int)arg1;	// IMP=0x0000000000055b5c
- (void)setupModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000055b0d
@property(readonly, nonatomic) _Bool isComfortNoise;
- (void)dealloc;	// IMP=0x0000000000055a66
- (id)initWithCodecType:(long long)arg1;	// IMP=0x00000000000559cd
