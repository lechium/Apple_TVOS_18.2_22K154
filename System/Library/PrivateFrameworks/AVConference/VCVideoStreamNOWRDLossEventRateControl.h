...
- (id)className;	// IMP=0x0000000000060ea8
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x0000000000060a8e
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000060583
- (void)resetLossEventBuffer;	// IMP=0x0000000000060572
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x000000000006054a
- (int)lossEventCount;	// IMP=0x0000000000060530
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x00000000000604e0
- (_Bool)shouldRampUp;	// IMP=0x000000000006041a
- (_Bool)shouldRampDown;	// IMP=0x0000000000060366
- (unsigned short)rampDownTier;	// IMP=0x000000000006033c
- (unsigned short)rampUpTier;	// IMP=0x000000000006031d
- (void)stateEnter;	// IMP=0x00000000000602fe
- (void)stateExit;	// IMP=0x00000000000602f8
- (void)stateChange:(int)arg1;	// IMP=0x000000000006019f
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x000000000006007a
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000060068
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x000000000005fe6b
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x000000000005fdb5
- (id)init;	// IMP=0x000000000005fba5
