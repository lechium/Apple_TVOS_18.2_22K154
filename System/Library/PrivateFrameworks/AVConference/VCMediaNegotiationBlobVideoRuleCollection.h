...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000040427a
- (unsigned long long)hash;	// IMP=0x00000000004041de
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000404100
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000404043
- (void)copyTo:(id)arg1;	// IMP=0x0000000000403fc4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000403ef1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000403ee4
- (id)dictionaryRepresentation;	// IMP=0x00000000004038b3
- (id)description;	// IMP=0x0000000000403819
...
- (int)StringAsOperation:(id)arg1;	// IMP=0x00000000004036f4
- (id)operationAsString:(int)arg1;	// IMP=0x00000000004036b4
- (int)StringAsTransport:(id)arg1;	// IMP=0x0000000000403668
- (id)transportAsString:(int)arg1;	// IMP=0x0000000000403628
