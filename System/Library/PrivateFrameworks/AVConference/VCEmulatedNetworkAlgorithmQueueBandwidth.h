...
- (int)getRemainingAQMBudgetWithPacket:(id)arg1;	// IMP=0x0000000000072ae0
- (void)addPacketToBudgetBuffer:(id)arg1;	// IMP=0x0000000000072a3e
- (_Bool)shouldDropPacketWithCurrentAQMBudget:(id)arg1;	// IMP=0x00000000000729cb
- (void)process:(id)arg1;	// IMP=0x00000000000725eb
- (double)computeNetworkServiceRate;	// IMP=0x000000000007251a
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x00000000000721ff
- (id)init;	// IMP=0x00000000000721a1
