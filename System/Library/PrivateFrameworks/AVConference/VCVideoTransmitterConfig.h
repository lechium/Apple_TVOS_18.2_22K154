...
@interface VCVideoTransmitterConfig : NSObject
{
    ...
    _Bool _foveationEnabled;	// 252 = 0xfc
    unsigned int _qualityIndex;	// 256 = 0x100
    unsigned int _maxSupportedTemporalLayers;	// 260 = 0x104
    int _reportingClientType;	// 264 = 0x108
    int _ltrAckFeedbackType;	// 268 = 0x10c
    int _accessNetworkType;	// 272 = 0x110
    unsigned long long _remoteIDSParticipantID;	// 280 = 0x118
    unsigned long long _maxEncoderPixels;	// 288 = 0x120
    double _minKeyFrameGenerationIntervalInSeconds;	// 296 = 0x128
}
...
- (void)addCustomFeatureListString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002f3245
- (void)dealloc;	// IMP=0x00000000002f319e
- (id)description;	// IMP=0x00000000002f3061
- (id)init;	// IMP=0x00000000002f2f88
