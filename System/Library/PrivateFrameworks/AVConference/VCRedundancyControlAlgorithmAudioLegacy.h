...
- (void)computeRedundancyInfo;	// IMP=0x00000000004551e8
- (void)reset;	// IMP=0x00000000004551e2
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000455164
