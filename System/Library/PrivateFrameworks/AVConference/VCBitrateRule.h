...
- (void)dealloc;	// IMP=0x0000000000481442
- (id)description;	// IMP=0x000000000048140e
- (long long)compare:(id)arg1;	// IMP=0x00000000004813c7
- (id)initWithBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x000000000048133e
