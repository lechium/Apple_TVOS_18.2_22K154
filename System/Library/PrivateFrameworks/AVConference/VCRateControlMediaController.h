...
@interface VCRateControlMediaController : NSObject
{
    ...
    _Bool _disableBasebandFlush;	// 225 = 0xe1
    double _lastForceBBFlushTime;	// 232 = 0xe8
    unsigned int _basebandAverageBitrate;	// 240 = 0xf0
    unsigned int _basebandAverageBitrateShort;	// 244 = 0xf4
    unsigned int _basebandTotalQueueDepth;	// 248 = 0xf8
    unsigned int _basebandFlushableQueueDepth;	// 252 = 0xfc
    double _basebandExpectedQueuingDelay;	// 256 = 0x100
    double _basebandNBDCD;	// 264 = 0x108
    double _lastBasebandHighNBDCDTime;	// 272 = 0x110
    _Bool _isBasebandQueuingDelayHigh;	// 280 = 0x118
    void *_logBasebandDump;	// 288 = 0x120
    void *_logBWEDump;	// 296 = 0x128
    unsigned int _afrcRemoteEstimatedBandwidth;	// 304 = 0x130
    _Bool _fromSmartBrake;	// 308 = 0x134
}
...
- (void)updateLargeFrameSizeWithBandwidth:(unsigned int)arg1;	// IMP=0x000000000014b1d9
- (void)updateProbingLargeFrameSizeCap;	// IMP=0x000000000014b11e
- (_Bool)isProbingLargeFrameRequiredAtTime:(double)arg1;	// IMP=0x000000000014ad29
- (void)printLargeFrameStatsAtTime:(double)arg1 timestamp:(unsigned int)arg2 timeSinceLastProbingSequence:(double)arg3 frameSize:(unsigned int)arg4 wastedBytes:(unsigned int)arg5 fecRatio:(double)arg6 isFrameRequested:(_Bool)arg7;	// IMP=0x000000000014ab6a
- (void)scheduleProbingSequenceAtTime:(double)arg1;	// IMP=0x000000000014aa70
- (_Bool)increaseFlushCountForVideoRefresh:(int)arg1 transactionID:(unsigned short)arg2;	// IMP=0x000000000014a9ff
- (void)recordVideoRefreshFrameWithTimestamp:(unsigned int)arg1 payloadType:(unsigned char)arg2 packetCount:(unsigned int)arg3 isKeyFrame:(_Bool)arg4;	// IMP=0x000000000014a96a
- (void)scheduleProbingSequenceWithFrameSize:(unsigned int)arg1 paddingBytes:(unsigned int)arg2 timestamp:(unsigned int)arg3 fecRatio:(double)arg4 isProbingSequenceScheduled:(_Bool *)arg5;	// IMP=0x000000000014a7b4
...
- (_Bool)rampUpAudioFraction;	// IMP=0x000000000014a50f
- (void)setTargetBitrate:(unsigned int)arg1;	// IMP=0x000000000014a049
- (_Bool)didMediaGetFlushedWithPayloadType:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x0000000000149f56
- (void)decreaseFlushCount:(int)arg1;	// IMP=0x0000000000149e24
- (void)pauseVideoByUser:(_Bool)arg1;	// IMP=0x0000000000149650
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x0000000000147a8a
- (void)dealloc;	// IMP=0x0000000000147a08
- (id)initWithMediaQueue:(struct tagHANDLE *)arg1 delegate:(id)arg2;	// IMP=0x00000000001478ca
