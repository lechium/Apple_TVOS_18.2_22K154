...
@interface VCMediaNegotiatorMultiwayMediaStream : NSObject
{
    ...
    unsigned short _v2StreamID;	// 40 = 0x28
    _Bool _hasV2StreamID;	// 42 = 0x2a
}
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005f8ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005f793
