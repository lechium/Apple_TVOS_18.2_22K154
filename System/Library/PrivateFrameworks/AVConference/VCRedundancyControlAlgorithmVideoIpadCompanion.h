...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x0000000000069b6e
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x0000000000069b44
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x0000000000069af8
- (void)reset;	// IMP=0x0000000000069af2
- (void)updateRedundancyStrategyWithNetworkStatistics:(struct tagVCStatisticsMessage)arg1;	// IMP=0x0000000000069a44
