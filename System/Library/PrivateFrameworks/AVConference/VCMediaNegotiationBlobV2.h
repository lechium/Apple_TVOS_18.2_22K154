...
+ (Class)streamGroupsType;	// IMP=0x00100000000d421b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d51dc
- (unsigned long long)hash;	// IMP=0x00000000000d5105
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d4fab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d4d2c
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d4bd9
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d4a31
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d4a24
- (id)dictionaryRepresentation;	// IMP=0x00000000000d42c6
- (id)description;	// IMP=0x00000000000d422c
- (id)streamGroupsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000d41fe
- (unsigned long long)streamGroupsCount;	// IMP=0x00000000000d41e1
- (void)addStreamGroups:(id)arg1;	// IMP=0x00000000000d4194
- (void)clearStreamGroups;	// IMP=0x00000000000d4177
...
- (void)printWithTitle:(id)arg1 logFile:(void *)arg2;	// IMP=0x0000000000162af9
