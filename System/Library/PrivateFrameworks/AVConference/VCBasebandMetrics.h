...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001ea20a
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x00000000001ea0fd
- (void)resetBBNoteHistoryList;	// IMP=0x00000000001ea0e2
- (void)resetBDCDList;	// IMP=0x00000000001ea0c7
- (void)normalizeBDCD:(double)arg1;	// IMP=0x00000000001e9e8b
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001e9e1c
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x00000000001e9b73
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001e9ab0
- (struct tagVCStatisticsMessage)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x00000000001e9833
- (void)dealloc;	// IMP=0x00000000001e97d5
- (id)init;	// IMP=0x00000000001e972e
