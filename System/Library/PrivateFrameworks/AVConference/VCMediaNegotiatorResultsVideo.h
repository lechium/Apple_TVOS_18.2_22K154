...
@interface VCMediaNegotiatorResultsVideo : NSObject
{
    ...
    _Bool _blackFrameOnClearScreenEnabled;	// 83 = 0x53
    long long _cipherSuite;	// 88 = 0x58
    _Bool _foveationIsSupported;	// 96 = 0x60
}
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000037797b
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x0000000000377965
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x000000000037794f
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x0000000000377905
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000003778bb
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x00000000003778a5
- (void)dealloc;	// IMP=0x0000000000377823
- (id)init;	// IMP=0x000000000037776c
