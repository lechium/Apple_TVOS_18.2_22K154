...
+ (unsigned long long)hdrModeWithNegotiatorInitOptions:(id)arg1;	// IMP=0x00600000002f0f44
+ (id)negotiatorSettingsForMode:(long long)arg1 deviceRole:(unsigned char)arg2 options:(id)arg3 errorString:(id *)arg4;	// IMP=0x00600000002f0eb3
...
- (void)dealloc;	// IMP=0x00000000002f0cf4
- (id)init;	// IMP=0x00000000002f0c85
- (id)initWithOptions:(id)arg1 deviceRole:(unsigned char)arg2 error:(id *)arg3;	// IMP=0x00000000002f0c73
