...
@interface VCAudioIOControllerClient : NSObject
{
    ...
    _Bool _networkUplinkClockUsesBaseband;	// 416 = 0x1a0
    _Bool _spatialAudioDisabled;	// 417 = 0x1a1
    _Bool _optOutOfSmartRouting;	// 418 = 0x1a2
...
- (void)setClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x00000000002dab2d
- (void)setRemoteCodecType:(unsigned int)arg1 sampleRate:(double)arg2;	// IMP=0x00000000002dab15
- (void)setFarEndVersionInfo:(struct VoiceIOFarEndVersionInfo)arg1;	// IMP=0x00000000002daae9
