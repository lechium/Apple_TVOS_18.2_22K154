...
+ (unsigned int)encoderUsageTypeWithHardwareSettingsMode:(unsigned char)arg1;	// IMP=0x00600000004e17e4
...
- (void)initFeatureListString;	// IMP=0x00000000004e1a2a
- (unsigned int)numTilesPerVideoFrameForHDRMode:(unsigned long long)arg1;	// IMP=0x00000000004e192b
- (void)dealloc;	// IMP=0x00000000004e18b0
- (id)initWithHardwareSettingsMode:(unsigned char)arg1;	// IMP=0x00000000004e1801
