...
+ (id)streamGroupConfigWithGroupID:(unsigned int)arg1 mediaType:(unsigned int)arg2 subtype:(unsigned int)arg3 syncGroupID:(unsigned int)arg4 cipherSuite:(unsigned int)arg5;	// IMP=0x0010000000130d13
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013131d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000131095
- (void)removeStreamConfigs:(struct _NSRange)arg1;	// IMP=0x000000000013107f
- (unsigned long long)indexOfCodecConfig:(id)arg1;	// IMP=0x0000000000130fea
- (void)addCodecConfig:(id)arg1;	// IMP=0x0000000000130e96
- (void)addStreamConfig:(id)arg1;	// IMP=0x0000000000130e52
- (id)description;	// IMP=0x0000000000130de7
- (void)dealloc;	// IMP=0x0000000000130d73
- (id)initWithGroupID:(unsigned int)arg1 mediaType:(unsigned int)arg2 subtype:(unsigned int)arg3 syncGroupID:(unsigned int)arg4 cipherSuite:(unsigned int)arg5;	// IMP=0x0000000000130cf5
- (id)initWithGroupID:(unsigned int)arg1 mediaType:(unsigned int)arg2 subtype:(unsigned int)arg3 syncGroupID:(unsigned int)arg4;	// IMP=0x0000000000130cb4
- (id)init;	// IMP=0x0000000000130c35
