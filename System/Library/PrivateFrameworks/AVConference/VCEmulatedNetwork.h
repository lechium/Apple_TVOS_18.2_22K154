...
- (void)runUntilTime:(double)arg1;	// IMP=0x00000000000925ff
- (id)copyPacketFromPop;	// IMP=0x00000000000925b0
- (void)push:(id)arg1;	// IMP=0x0000000000092577
- (void)dealloc;	// IMP=0x00000000000924f3
- (id)initWithPolicies:(id)arg1;	// IMP=0x0000000000092404
