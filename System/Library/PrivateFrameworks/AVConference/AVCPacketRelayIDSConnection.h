...
- (void)dealloc;	// IMP=0x00000000003cfc45
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x00000000003cf887
- (void)readyToRead;	// IMP=0x00000000003cf84f
- (int)stop;	// IMP=0x00000000003cf730
- (int)start;	// IMP=0x00000000003cef76
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x00000000003ced6d
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x00000000003ceb63
