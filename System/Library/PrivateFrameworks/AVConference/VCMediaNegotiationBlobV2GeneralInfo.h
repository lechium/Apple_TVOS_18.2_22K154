...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001b9ac3
- (unsigned long long)hash;	// IMP=0x00000000001b9a31
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001b994b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b9878
- (void)copyTo:(id)arg1;	// IMP=0x00000000001b97e5
- (void)writeTo:(id)arg1;	// IMP=0x00000000001b973d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001b9730
- (id)dictionaryRepresentation;	// IMP=0x00000000001b92e7
- (id)description;	// IMP=0x00000000001b924d
...
- (void)dealloc;	// IMP=0x00000000001b90dc
- (void)printWithLogFile:(void *)arg1 prefix:(id)arg2;	// IMP=0x00000000003b5392
@property(readonly, nonatomic) struct CGSize screenResolution;
@property(readonly, nonatomic) union tagNTP creationTime;
- (id)initWithCreationTime:(union tagNTP)arg1 screenResolution:(struct CGSize)arg2 abSwitches:(unsigned int)arg3;	// IMP=0x00000000003b51a0
