...
- (id)initWithPacketID:(unsigned int)arg1 datagram:(char *)arg2 datagramSize:(unsigned int)arg3;	// IMP=0x0000000000111857
- (id)initWithPacketID:(unsigned int)arg1;	// IMP=0x00000000001117f9
