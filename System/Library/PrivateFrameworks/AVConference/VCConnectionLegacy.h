...
- (int)cellularMTU;	// IMP=0x0000000000126f56
...
- (unsigned short)updateMaxConnectionMTU:(unsigned short)arg1;	// IMP=0x0000000000126e92
@property(readonly, copy) NSString *description;
@property(readonly) _Bool isWifiToWifi;
- (_Bool)isOnSameIPPortWithConnection:(id)arg1;	// IMP=0x0000000000126669
- (_Bool)isLocalIPPort:(struct tagIPPORT *)arg1;	// IMP=0x00000000001260e4
- (void)dealloc;	// IMP=0x000000000012607b
- (id)copy;	// IMP=0x0000000000125feb
- (id)initWithCandidatePair:(struct tagCANDIDATEPAIR *)arg1;	// IMP=0x0000000000125ec9
- (id)initWithConnectionResult:(struct tagCONNRESULT *)arg1 type:(unsigned int)arg2;	// IMP=0x0000000000125d28
- (void)setUpVTable;	// IMP=0x0000000000124f23
