...
- (void)unlock;	// IMP=0x000000000039018b
- (void)lock;	// IMP=0x000000000039017d
- (void)initLock;	// IMP=0x0000000000390108
- (void)resetBuffer;	// IMP=0x000000000038fbc9
- (_Bool)bundleAudioLegacy:(void *)arg1 numInputBytes:(unsigned int)arg2 payloadType:(int)arg3 timestamp:(unsigned int)arg4;	// IMP=0x000000000038f816
- (_Bool)_copyInputBytes:(void *)arg1 numInputBytes:(unsigned int)arg2 payloadType:(int)arg3 timestamp:(unsigned int)arg4;	// IMP=0x000000000038f6bb
- (_Bool)bundleAudioRFC3640:(void *)arg1 numInputBytes:(unsigned int)arg2 payloadType:(int)arg3 timestamp:(unsigned int)arg4;	// IMP=0x000000000038edce
- (char *)accessUnitDataSectionHead;	// IMP=0x000000000038edab
- (unsigned int)accessUnitHeaderSectionSizeMaximum;	// IMP=0x000000000038ed9b
- (unsigned int)accessUnitHeaderSectionSize;	// IMP=0x000000000038ed88
- (unsigned int)encodedBufferSizeForRFC3640;	// IMP=0x000000000038ed68
- (char *)encodedBufferForRFC3640;	// IMP=0x000000000038ecdf
...
- (_Bool)setPacketsPerBundle:(unsigned int)arg1;	// IMP=0x000000000038ec64
@property(nonatomic) unsigned int maxPacketSize;
- (_Bool)reallocateBufferWithMaxPacketSize:(unsigned int)arg1 maxPacketCount:(unsigned int)arg2;	// IMP=0x000000000038ebaa
- (_Bool)allocateBundleBuffer:(unsigned int)arg1;	// IMP=0x000000000038eb8c
- (unsigned int)bundleBufferSizeWidthMaxPacketSize:(unsigned int)arg1 maxPacketCount:(unsigned int)arg2;	// IMP=0x000000000038eb7d
- (void)dealloc;	// IMP=0x000000000038ea5b
- (id)initWithOperatingMode:(int)arg1 bundlingScheme:(int)arg2;	// IMP=0x000000000038e82b
