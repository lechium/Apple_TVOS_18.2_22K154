...
- (void).cxx_destruct;	// IMP=0x000000000002bbc7
...
- (void)executeCallbackwithResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000002b984
- (id)initWithAQIScaleRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002b904
- (id)initWithForecastRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002b88c
