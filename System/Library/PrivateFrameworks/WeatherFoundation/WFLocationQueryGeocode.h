...
+ (id)queryWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000bae5
+ (void)invalidateCaches;	// IMP=0x001000000000b9e3
+ (id)queryWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b96d
+ (id)queryWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b8e1
+ (id)queryWithDictionaryRepresentation:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b58d
- (void).cxx_destruct;	// IMP=0x000000000000d2fe
...
- (void)_handleErrorResponse:(id)arg1;	// IMP=0x000000000000cfe9
- (void)handleSearchResponseWithLocation:(id)arg1;	// IMP=0x000000000000ce3d
- (id)_reverseGeocoderLocation;	// IMP=0x000000000000cdbb
- (id)_mkLocalSearchRequest;	// IMP=0x000000000000ccc1
- (_Bool)isLocationValid:(id)arg1;	// IMP=0x000000000000cb1d
- (void)_startCLGeocoderReverseGeo;	// IMP=0x000000000000c45f
- (void)_startMKLocalSearch;	// IMP=0x000000000000beec
- (void)cancel;	// IMP=0x000000000000be73
- (void)start;	// IMP=0x000000000000bda9
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bc97
- (id)initWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bb5b
- (id)initWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000b9e9
