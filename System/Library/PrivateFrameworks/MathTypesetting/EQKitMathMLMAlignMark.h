...
- (struct Schemata)layoutSchemata;	// IMP=0x000000000004e3aa
- (const void *)mathMLAttributes;	// IMP=0x000000000004e339
- (void)dealloc;	// IMP=0x000000000004e2f7
- (id)initFromXMLNode:(struct _xmlNode *)arg1 parser:(id)arg2;	// IMP=0x000000000004e2c8
