...
- (void).cxx_destruct;	// IMP=0x000000000005d762
...
- (void)ensureEventWithSpecialization:(unsigned long long)arg1;	// IMP=0x000000000005d6a5
- (id)initWithOriginalURL:(id)arg1 postRedirectURL:(id)arg2 MIMEType:(id)arg3 webView:(id)arg4 hasLoadedResource:(_Bool)arg5 shouldFetchSubresources:(_Bool)arg6 allowedSpecializations:(unsigned long long)arg7 fetchIsNotUserInitiated:(_Bool)arg8;	// IMP=0x000000000005d4c9
