...
- (void).cxx_destruct;	// IMP=0x000000000009fe9f
...
- (void)dealloc;	// IMP=0x000000000009fd11
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009fbc9
- (id)init;	// IMP=0x000000000009fb73
