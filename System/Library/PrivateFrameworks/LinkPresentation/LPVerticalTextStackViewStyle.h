...
- (void).cxx_destruct;	// IMP=0x000000000006d31a
...
- (void)applyToLowerTextRowStyles:(CDUnknownBlockType)arg1;	// IMP=0x000000000006d239
- (void)applyToAllTextViewStyles:(CDUnknownBlockType)arg1;	// IMP=0x000000000006d1b2
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000006c5f9
