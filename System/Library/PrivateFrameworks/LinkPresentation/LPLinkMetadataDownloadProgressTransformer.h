...
- (void).cxx_destruct;	// IMP=0x00000000000aba09
...
- (id)downloadProgressForTransformer:(id)arg1;	// IMP=0x00000000000ab917
- (id)initWithBytesLoaded:(unsigned long long)arg1 downloadState:(long long)arg2 metadata:(id)arg3;	// IMP=0x00000000000ab87a
