...
- (void).cxx_destruct;	// IMP=0x00000000000891e8
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x0000000000089146
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x000000000008893a
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x000000000008854e
- (id)init;	// IMP=0x00000000000884c2
