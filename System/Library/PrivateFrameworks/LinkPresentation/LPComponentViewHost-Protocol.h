...
@class LPComponentView, LPDownloadProgress, NSArray, UITraitCollection, UIView;

@protocol LPComponentViewHost <NSObject>
- (UITraitCollection *)appearanceForComponentView:(LPComponentView *)arg1;
- (double)minimumCornerRadiusForComponentView:(LPComponentView *)arg1;
- (_Bool)usesBackgroundForSymbolImagesForComponentView:(LPComponentView *)arg1;
- (_Bool)allowsAsynchronousImageDecodingForComponentView:(LPComponentView *)arg1;
...
- (long long)themePlatformForComponentView:(LPComponentView *)arg1;
