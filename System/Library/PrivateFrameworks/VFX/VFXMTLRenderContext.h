...
+ (void)registerBindings;	// IMP=0x00100000000ea2b5
- (id).cxx_construct;	// IMP=0x00000000000ef818
- (void).cxx_destruct;	// IMP=0x00000000000ef7ca
...
- (void)_VFXWorldRendererMainPassCustomPostProcessSupportDrawSceneBackgroundUsingEncoder:(id)arg1 commandBuffer:(id)arg2 renderPassDescriptor:(id)arg3;	// IMP=0x00000000000ef3c0
- (void)_allowGPUBackgroundExecution;	// IMP=0x00000000000ef327
- (void)addDrawablePresentedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ef214
- (void)addCommandBufferCompletedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ef101
- (void)addCommandBufferScheduledHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000eefee
- (unsigned long long)cubeArrayTypeIfSupported;	// IMP=0x00000000000eefe3
- (struct __CFXMaterial *)getCurrentPassMaterial;	// IMP=0x00000000000eefd6
- (unsigned long long)getCurrentPassHash;	// IMP=0x00000000000eefc9
- (void)setCurrentPassMaterial:(struct __CFXMaterial *)arg1;	// IMP=0x00000000000eefbc
- (void)setCurrentPassHash:(unsigned long long)arg1;	// IMP=0x00000000000eefaf
- (void)writeBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x00000000000eef1f
- (MISSING_TYPE *)renderSize;	// IMP=0x00000000000eef11
- (float)renderTime;	// IMP=0x00000000000eef03
- (void)_drawFullScreenTexture:(id)arg1;	// IMP=0x00000000000eec1c
- (void)_drawShadowMaps;	// IMP=0x00000000000ee6ff
- (void)_drawPBRTextures;	// IMP=0x00000000000eddce
...
- (void)drawFullScreenQuadForPass:(struct __CFXFXPass *)arg1;	// IMP=0x00000000000edc6c
- (void)resetVolatileMeshElements;	// IMP=0x00000000000edace
- (void)unmapVolatileMeshElement:(struct __CFXMeshElement *)arg1;	// IMP=0x00000000000eda67
- (struct __CFXMeshElement *)createVolatileMeshElementOfType:(BOOL)arg1 primitiveCount:(long long)arg2 bytesPerIndex:(long long)arg3;	// IMP=0x00000000000ed8af
- (void)_recycleMTLBufferToPool:(id)arg1;	// IMP=0x00000000000ed826
- (id)_newMTLBufferFromPoolWithLength:(unsigned long long)arg1;	// IMP=0x00000000000ed75f
- (void)resetVolatileMeshes;	// IMP=0x00000000000ed641
- (void)unmapVolatileMesh:(struct __CFXMesh *)arg1 modifiedVerticesCount:(long long)arg2;	// IMP=0x00000000000ed559
- (_Bool)mapVolatileMesh:(struct __CFXMesh *)arg1 verticesCount:(long long)arg2;	// IMP=0x00000000000ed3a1
- (void)drawWireframeOverlayForElements:(CDStruct_d65e47c4 *)arg1 range:(CDStruct_912cb5d2)arg2 store:(struct __CFXRendererElementStore *)arg3 passInstance:(struct __CFXFXPassInstance *)arg4;	// IMP=0x00000000000ea004
...
- (void)drawRenderElement:(struct __CFXRendererElement *)arg1 withPass:(struct __CFXFXPass *)arg2;	// IMP=0x00000000000e9741
- (void)_executeDrawCommand:(CDStruct_8b09f293)arg1;	// IMP=0x00000000000e640f
- (void)_prepareMaterialTextures:(struct __CFXMaterial *)arg1;	// IMP=0x00000000000e6319
- (void)stopProcessingRendererElements:(_Bool)arg1;	// IMP=0x00000000000e61fa
- (void)startProcessingRendererElementsWithEngineIterationContext:(CDStruct_e0207beb *)arg1;	// IMP=0x00000000000e53c4
- (void)processRendererElements:(CDStruct_d65e47c4 *)arg1 count:(unsigned int)arg2 engineIterationContext:(CDStruct_e0207beb *)arg3;	// IMP=0x00000000000e4c67
- (void)renderMesh:(struct __CFXMesh *)arg1 meshElement:(struct __CFXMeshElement *)arg2 withProgram:(struct __CFXFXProgram *)arg3 engineContext:(struct __CFXEngineContext *)arg4 transform:(CDStruct_14d5dc5e)arg5 color:(const struct CFXColor4 *)arg6 rasterizerStates:(struct __CFXRasterizerStates *)arg7 blendState:(struct __CFXBlendStates *)arg8 texture:(struct __CFXImage *)arg9 depthBias:(_Bool)arg10;	// IMP=0x00000000000e48cf
- (void)renderVideoBackground:(struct __CFXImageProxy *)arg1 engineContext:(struct __CFXEngineContext *)arg2 materialProperty:(struct __CFXMaterialProperty *)arg3;	// IMP=0x00000000000e4169
- (void)renderBackground:(struct __CFXMaterialProperty *)arg1 engineContext:(struct __CFXEngineContext *)arg2 passInstance:(struct __CFXFXPassInstance *)arg3;	// IMP=0x00000000000e34cb
- (float)_zFarForSkyboxRenderingProjectionMatrix:(const CDStruct_14d5dc5e *)arg1 defaultZFar:(float)arg2;	// IMP=0x00000000000e34ac
- (void)_updateProjectionMatrixForOrthographicSkyboxRenderingIfNeeded:(CDStruct_14d5dc5e *)arg1;	// IMP=0x00000000000e32a0
- (void)_drawPatchForMeshElement:(id)arg1 instanceCount:(unsigned long long)arg2;	// IMP=0x00000000000e3150
- (void)_drawMeshElement:(id)arg1 instanceCount:(unsigned long long)arg2;	// IMP=0x00000000000e2eeb
- (void)_setMeshBuffers:(id)arg1;	// IMP=0x00000000000e2d95
- (void)_setWorldBufferAtVertexIndex:(long long)arg1 fragmentIndex:(long long)arg2;	// IMP=0x00000000000e2d21
- (void)popDebugGroup;	// IMP=0x00000000000e2d04
- (void)pushDebugGroup:(id)arg1;	// IMP=0x00000000000e2ce7
- (void)setRasterizerStates:(struct __CFXRasterizerStates *)arg1;	// IMP=0x00000000000e2b6e
- (void)_logLightingInformation;	// IMP=0x00000000000e2b20
- (id)radianceTextureForMaterialProperty:(struct __CFXMaterialProperty *)arg1;	// IMP=0x00000000000e2a56
- (id)irradianceTextureForMaterialProperty:(struct __CFXMaterialProperty *)arg1;	// IMP=0x00000000000e2927
- (id)textureForMaterialProperty:(struct __CFXMaterialProperty *)arg1;	// IMP=0x00000000000e2901
@property(retain, nonatomic) id <VFXTextureAttachmentProvider> attachmentProvider;
- (void)endRenderPass;	// IMP=0x00000000000e289c
- (void)setRenderPassParameters:(CDStruct_c218849e)arg1;	// IMP=0x00000000000e2886
- (void)beginRenderPass:(id)arg1 renderEncoder:(void *)arg2 parameters:(CDStruct_c218849e)arg3;	// IMP=0x00000000000e2849
- (void)beginRenderPass:(id)arg1 renderEncoder:(void *)arg2;	// IMP=0x00000000000e2735
...
- (void)_createResourceCommandBufferIfNeeded;	// IMP=0x00000000000e2321
- (void)_clearRenderCaches;	// IMP=0x00000000000e2309
- (void *)_clusterInfo;	// IMP=0x00000000000e22fc
- (void)_setReflectionProbeArrayTexture:(id)arg1;	// IMP=0x00000000000e22ef
- (id)_reflectionProbeArrayTexture;	// IMP=0x00000000000e22e2
- (id)_finalRenderTexture;	// IMP=0x00000000000e20cb
@property(readonly, nonatomic) CAMetalLayer *layerTarget;
@property(readonly, nonatomic) id <MTLTexture> textureTarget;
- (void)endFrameWaitingUntilCompleted:(_Bool)arg1 status:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000000e16fe
- (void)endFrameWorldSpecifics;	// IMP=0x00000000000e16d0
- (void)beginFrame:(id)arg1;	// IMP=0x00000000000e1140
- (void)captureNextFrame;	// IMP=0x00000000000e1133
...
- (struct __CFXEngineStats *)stats;	// IMP=0x00000000000e1105
- (void)_clearUnusedBindingPoints;	// IMP=0x00000000000e0eeb
...
- (_Bool)supportsMTLFeatureSet:(unsigned long long)arg1;	// IMP=0x00000000000e0d8d
...
- (void)dealloc;	// IMP=0x00000000000e094a
- (id)initWithDevice:(id)arg1 engineContext:(struct __CFXEngineContext *)arg2;	// IMP=0x00000000000e0394
- (void)_reduceStatsOfConstantBuffer:(id)arg1;	// IMP=0x00000000000e0360
- (_Bool)isLayeredRendering;	// IMP=0x00000000000efd9f
- (_Bool)isDrawingBlur;	// IMP=0x00000000000efd97
- (long long)renderMode;	// IMP=0x00000000000efd8b
- (_Bool)outputsNormal;	// IMP=0x00000000000efd7d
- (_Bool)renderInGBuffer;	// IMP=0x00000000000efd6d
- (_Bool)depthOnly;	// IMP=0x00000000000efd61
- (void)viewports:(const void **)arg1:(long long *)arg2;	// IMP=0x00000000000efd47
- (_Bool)constantOffsetAndSize:(int)arg1:(id)arg2:(long long *)arg3:(long long *)arg4;	// IMP=0x00000000000efb7c
- (const char *)constantData:(int)arg1;	// IMP=0x00000000000efb5f
- (id)sampler:(int)arg1:(id)arg2;	// IMP=0x00000000000efb44
- (id)buffer:(int)arg1:(id)arg2:(long long *)arg3:(long long *)arg4;	// IMP=0x00000000000ef9c6
- (id)texture:(int)arg1:(id)arg2;	// IMP=0x00000000000ef973
