...
@interface VFXSceneLoadOptions : NSObject
{
    ...
    MISSING_TYPE *metalLibraryURL;	// 15490624 = 0xec5e40
...
- (void).cxx_destruct;	// IMP=0x0000000000544a80
- (id)init;	// IMP=0x0000000000544a30
...
- (void)registerVFX2AuthoringSystems:(_Bool)arg1;	// IMP=0x000000000054a3a0
