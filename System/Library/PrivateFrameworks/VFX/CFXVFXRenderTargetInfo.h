...
- (MISSING_TYPE *)renderTargetSize;	// IMP=0x00000000000e0326
- (unsigned long long)colorPixelFormatAtIndex:(long long)arg1;	// IMP=0x00000000000e02ce
...
- (id)init;	// IMP=0x00000000000e0198
