...
+ (unsigned long long)requiredOutputs;	// IMP=0x001000000025b5db
+ (unsigned long long)supportedOutputs;	// IMP=0x001000000025b5d0
+ (unsigned long long)requiredInputs;	// IMP=0x001000000025b5c5
- (unsigned long long)updateWithComputeContext:(id)arg1 positions:(id)arg2 normals:(id)arg3 tangents:(id)arg4;	// IMP=0x000000000025ccbe
- (id)makeReadOnlyBuffersWithBaseGeometry:(struct __CFXGeometry *)arg1 baseMesh:(struct __CFXMesh *)arg2 blitEncoder:(id)arg3;	// IMP=0x000000000025ba5a
- (void)setupWithComputeContext:(id)arg1;	// IMP=0x000000000025b710
- (void)dealloc;	// IMP=0x000000000025b6a2
