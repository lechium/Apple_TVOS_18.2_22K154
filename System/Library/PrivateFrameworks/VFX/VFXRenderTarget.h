...
@interface VFXRenderTarget : NSObject
{
...
- (id)ciImage;	// IMP=0x000000000009d11e
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000009cfae
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000009cead
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x000000000009cdfa
- (void)dealloc;	// IMP=0x000000000009cda2
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000009cd48
