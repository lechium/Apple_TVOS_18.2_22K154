...
- (void).cxx_destruct;	// IMP=0x00000000000780ff
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x00000000000778c5
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000077750
- (id)init;	// IMP=0x000000000007773a
