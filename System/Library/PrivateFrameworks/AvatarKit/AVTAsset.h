...
@interface AVTAsset : NSObject
{
    ...
    NSDictionary *_wrapDeformerDriverNames;	// 128 = 0x80
    NSDictionary *_perAssetMain;	// 136 = 0x88
    CDStruct_10883d13 _uvRemappingInfo;	// 144 = 0x90
}

- (void).cxx_destruct;	// IMP=0x0000000000019130
...
- (id)assetImageForAsset:(id)arg1;	// IMP=0x000000000001903a
- (id)resourceByCachingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000018f4b
- (id)instantiateResource;	// IMP=0x0000000000018a3d
@property(readonly) _Bool is3DAsset;
@property(readonly) _Bool is2DAsset;
- (void)decrUseCount;	// IMP=0x00000000000189a8
- (void)freeCache;	// IMP=0x000000000001898e
- (void)incrUseCount;	// IMP=0x0000000000018968
- (id)description;	// IMP=0x00000000000188f3
- (void)enumerateVariantDependenciesOfKind:(unsigned long long)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000018721
- (id)initWithType:(long long)arg1 identifier:(id)arg2 path:(id)arg3;	// IMP=0x0000000000017e84
