...
- (void).cxx_destruct;	// IMP=0x000000000004d7c5
- (void)_tapAction:(id)arg1;	// IMP=0x000000000004d692
- (void)_loadSubviews;	// IMP=0x000000000004d0cf
- (id)_label;	// IMP=0x000000000004cf5b
- (void)_updateLatencyGraph:(CDStruct_53ba08a1 *)arg1;	// IMP=0x000000000004c90d
- (void)_updateLatencyBar:(CDStruct_53ba08a1 *)arg1;	// IMP=0x000000000004c5f8
- (void)layoutSubviews;	// IMP=0x000000000004c29e
- (void)updateWithData:(CDStruct_53ba08a1)arg1;	// IMP=0x000000000004bf05
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004be67
