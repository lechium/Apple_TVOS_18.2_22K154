...
- (void).cxx_destruct;	// IMP=0x00000000000353b4
...
- (id)description;	// IMP=0x0000000000035225
- (id)initWithType:(long long)arg1 assets:(id)arg2 morphVariant:(id)arg3 imageVariant:(id)arg4 materialVariant:(id)arg5 morphVariantIntensity:(float)arg6 bodyPoseVariantIntensity:(float)arg7 textureAssetPresence:(float)arg8;	// IMP=0x000000000003510f
- (id)materialAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000350b3
- (void)setMaterial:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x0000000000035054
