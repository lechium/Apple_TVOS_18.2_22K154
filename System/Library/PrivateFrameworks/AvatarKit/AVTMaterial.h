...
- (void).cxx_destruct;	// IMP=0x0000000000021487
...
- (id)description;	// IMP=0x00000000000213a3
- (void)applyToSceneKitMaterial:(id)arg1;	// IMP=0x00000000000211b5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002117a
