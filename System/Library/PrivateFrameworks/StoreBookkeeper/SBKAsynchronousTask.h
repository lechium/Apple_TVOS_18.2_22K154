...
- (void).cxx_destruct;	// IMP=0x000000000001e42b
...
- (void)invokeTaskCompletionBlocksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e1b2
- (void)addTaskCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001e0f0
- (void)invalidate;	// IMP=0x000000000001e0a2
- (void)_invalidateAssertion:(_Bool)arg1;	// IMP=0x000000000001dfcf
- (void)endTaskOperation;	// IMP=0x000000000001df9d
- (void)finishTaskOperationWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000001de9d
- (void)beginTaskOperation;	// IMP=0x000000000001dd14
...
- (void)_onQueueFireExpirationHandlerIfNecesary;	// IMP=0x000000000001d8f2
...
- (id)description;	// IMP=0x000000000001d5b7
- (void)_invalidateTimer;	// IMP=0x000000000001d56c
- (void)dealloc;	// IMP=0x000000000001d4bc
- (id)debugDescription;	// IMP=0x000000000001d4ae
- (id)initWithHandlerQueue:(id)arg1 timeout:(double)arg2 debugDescription:(id)arg3;	// IMP=0x000000000001d307
