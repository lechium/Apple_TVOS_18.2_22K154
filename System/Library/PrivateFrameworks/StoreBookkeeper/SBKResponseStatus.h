...
+ (id)responseStatusForStatusCodeNumber:(id)arg1;	// IMP=0x0060000000021bc5
- (void).cxx_destruct;	// IMP=0x0000000000021bb5
...
- (id)initWithStatus:(long long)arg1 isRecoverable:(_Bool)arg2 isError:(_Bool)arg3 consoleDescription:(id)arg4 shouldFileRadar:(_Bool)arg5;	// IMP=0x000000000002196b
