...
- (void).cxx_destruct;	// IMP=0x0000000000025fdd
...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x0000000000025c8a
- (void)StartWatchingForFrames;	// IMP=0x0000000000025bc7
- (void)FrameRequestCallback;	// IMP=0x000000000002573b
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x0000000000025666
- (_Bool)WaitForFinish;	// IMP=0x0000000000025415
- (unsigned long long)FramesInQueue;	// IMP=0x00000000000253c6
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000002533d
- (void)dealloc;	// IMP=0x000000000002530e
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x0000000000024ef5
