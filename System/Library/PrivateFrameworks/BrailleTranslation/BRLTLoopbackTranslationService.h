...
- (void).cxx_destruct;	// IMP=0x0000000000008a7f
@property(retain, nonatomic) BRLTSLoopbackTranslationService *loopbackService; // @synthesize loopbackService=_loopbackService;
- (_Bool)isLoopback;	// IMP=0x0000000000008a52
- (id)initWithServiceIdentifier:(id)arg1 connection:(id)arg2 loopbackService:(id)arg3;	// IMP=0x00000000000089d0
