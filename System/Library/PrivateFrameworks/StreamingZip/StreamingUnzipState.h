...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x006000000002519c
- (void).cxx_destruct;	// IMP=0x0000000000024bc0
...
- (_Bool)resolveOwnershipWithExtraField:(CDStruct_388cbe1a *)arg1 outUID:(unsigned int *)arg2 outGID:(unsigned int *)arg3;	// IMP=0x0000000000024723
- (id)finishStream;	// IMP=0x0000000000024619
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x0000000000024604
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x00000000000243b0
- (id)checkLastChunkPartialHash;	// IMP=0x000000000002412f
- (id)serializeState;	// IMP=0x0000000000023321
- (void)markResumptionPoint;	// IMP=0x000000000002331b
- (void)clearSavedState;	// IMP=0x0000000000023258
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x0000000000022eb2
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x0000000000022e25
- (id)init;	// IMP=0x0000000000022e02
