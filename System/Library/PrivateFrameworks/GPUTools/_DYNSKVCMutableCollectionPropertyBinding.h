...
- (id)underlyingIvarValueForObject:(id)arg1;	// IMP=0x000000000001f361
- (void)dealloc;	// IMP=0x000000000001f317
- (id)initWithKey:(id)arg1 underlyingIvarName:(id)arg2;	// IMP=0x000000000001f29d
