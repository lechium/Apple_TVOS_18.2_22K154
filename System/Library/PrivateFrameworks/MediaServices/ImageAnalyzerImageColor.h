...
+ (struct CGContext *)createContextForImage:(struct CGImage *)arg1;	// IMP=0x0040000000004106
+ (struct CGColor *)_colorFromITColor:(struct ITColor)arg1;	// IMP=0x0040000000004096
+ (id)analyzeImage:(struct CGImage *)arg1 error:(id *)arg2;	// IMP=0x0040000000003e89
+ (id)determineColors:(struct CGImage *)arg1 error:(id *)arg2;	// IMP=0x0040000000003649
+ (id)imageColorWithAnalyzedImageColors:(const struct AnalyzedImageColors *)arg1;	// IMP=0x004000000000361a
+ (id)imageColorWithImageAnalyzer:(const void *)arg1;	// IMP=0x00400000000035eb
+ (id)defaultColors;	// IMP=0x00400000000035bb
...
- (_Bool)isEqualToImageColor:(id)arg1;	// IMP=0x000000000000334c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000032da
- (id)initWithAnalyzedImageColors:(const struct AnalyzedImageColors *)arg1;	// IMP=0x0000000000002ff1
- (void)dealloc;	// IMP=0x0000000000002f3a
- (id)initWithImageAnalyzer:(const void *)arg1;	// IMP=0x0000000000002c34
- (id)colorString:(struct CGColor *)arg1;	// IMP=0x0000000000002b90
- (id)description;	// IMP=0x00000000000029a8
