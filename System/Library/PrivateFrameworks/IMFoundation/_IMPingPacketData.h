...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000455e9
- (void)_returnPacketArrived;	// IMP=0x00000000000455cb
- (void)_markPacketAsTimedOut:(double)arg1;	// IMP=0x000000000004553f
- (id)initWithSequeneceNumber:(int)arg1 timesent:(struct timeval *)arg2 error:(int)arg3;	// IMP=0x00000000000454e9
