...
- (void)restoreStateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006131
- (void)becomeActive;	// IMP=0x000000000000611b
- (void)start;	// IMP=0x0000000000006105
- (void)setStateRestorationSupported:(_Bool)arg1;	// IMP=0x00000000000060ef
- (void)setVideoSupported:(_Bool)arg1;	// IMP=0x00000000000060c3
- (void)setAudioAnalyzerEnabled:(_Bool)arg1;	// IMP=0x0000000000006097
- (void)setSystemMusicApplication:(_Bool)arg1;	// IMP=0x000000000000606b
@property(readonly, nonatomic, getter=isStarted) _Bool started;
@property(readonly, copy, nonatomic) NSString *playerID;
- (id)initWithPlayerID:(id)arg1 options:(unsigned long long)arg2 fallbackPlaybackIntent:(id)arg3;	// IMP=0x0000000000005e36
