...
- (void).cxx_destruct;	// IMP=0x0000000000005c8f
...
- (id)initWithPlaylist:(id)arg1 songIdentifiers:(id)arg2 representativeObject:(id)arg3 referralObject:(id)arg4;	// IMP=0x0000000000005810
