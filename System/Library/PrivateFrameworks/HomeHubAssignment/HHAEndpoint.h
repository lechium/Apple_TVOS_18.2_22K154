...
- (void).cxx_destruct;	// IMP=0x000000000000dd71
...
- (id)setIdleGracePeriodSeconds:(id)arg1;	// IMP=0x000000000000db4b
- (_Bool)isActiveWithHub:(id)arg1;	// IMP=0x000000000000db2a
...
- (id)quarantinedHubs;	// IMP=0x000000000000da4d
- (void)addHubsToQuarantine:(id)arg1;	// IMP=0x000000000000da37
- (float)scoreForHub:(id)arg1;	// IMP=0x000000000000d4e2
- (_Bool)updateEndpointTraits:(id)arg1;	// IMP=0x000000000000d243
@property(readonly, nonatomic) NSDictionary *descriptionDictionary;
@property(readonly, nonatomic) _Bool needsAssignment;
- (void)revokeAssignment;	// IMP=0x000000000000ced1
- (_Bool)assignToHub:(id)arg1 force:(_Bool)arg2;	// IMP=0x000000000000ccf3
- (_Bool)updateSessionStatus:(id)arg1;	// IMP=0x000000000000c840
- (_Bool)_statusRepresentsChange:(id)arg1;	// IMP=0x000000000000c78a
- (void)invalidate;	// IMP=0x000000000000c5a2
- (id)initWithId:(id)arg1 queue:(id)arg2 executor:(id)arg3 dependencyFactory:(id)arg4;	// IMP=0x000000000000c1c1
- (void)assignmentAttemptTimeout;	// IMP=0x000000000000c021
- (void)reattemptAssignment;	// IMP=0x000000000000be5f
- (void)quarantineExpired;	// IMP=0x000000000000bd00
- (void)_unlockAssignment;	// IMP=0x000000000000bb2f
- (void)_lockAssignmentForSeconds:(double)arg1;	// IMP=0x000000000000b7e9
- (void)_handleReapAssignmentTimer;	// IMP=0x000000000000b69e
- (void)_handleAssignmentLockTimerFired;	// IMP=0x000000000000b59c
@property(readonly, nonatomic) HHAEndpointAssignmentStatus *assignmentStatus;
- (id)description;	// IMP=0x000000000000b44a
