...
- (void).cxx_destruct;	// IMP=0x00000000001c3954
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001c3800
- (unsigned long long)hash;	// IMP=0x00000000001c376a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001c365c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c3578
- (void)copyTo:(id)arg1;	// IMP=0x00000000001c34d5
- (void)writeTo:(id)arg1;	// IMP=0x00000000001c3435
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001c3428
- (id)dictionaryRepresentation;	// IMP=0x00000000001c2fb7
- (id)description;	// IMP=0x00000000001c2f08
- (int)StringAsType:(id)arg1;	// IMP=0x00000000001c2af1
- (id)typeAsString:(int)arg1;	// IMP=0x00000000001c2aa6
