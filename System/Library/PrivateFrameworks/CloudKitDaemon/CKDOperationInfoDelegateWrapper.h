...
- (void).cxx_destruct;	// IMP=0x00000000002c3614
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x00000000002c34e3
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000002c3474
