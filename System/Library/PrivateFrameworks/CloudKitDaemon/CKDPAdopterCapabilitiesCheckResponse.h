...
- (void).cxx_destruct;	// IMP=0x0000000000389385
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000389221
- (unsigned long long)hash;	// IMP=0x000000000038918a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000389066
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000388f7d
- (void)copyTo:(id)arg1;	// IMP=0x0000000000388eda
- (void)writeTo:(id)arg1;	// IMP=0x0000000000388e39
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000388e2c
- (id)dictionaryRepresentation;	// IMP=0x0000000000388a27
- (id)description;	// IMP=0x0000000000388978
