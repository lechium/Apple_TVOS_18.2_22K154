...
- (void).cxx_destruct;	// IMP=0x0000000000377b7f
...
- (id)description;	// IMP=0x0000000000377b45
- (id)CKPropertiesDescription;	// IMP=0x0000000000377922
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000377917
- (unsigned long long)hash;	// IMP=0x0000000000377826
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003775fa
- (id)initWithRecordID:(id)arg1 fileSignature:(id)arg2 referenceSignature:(id)arg3 size:(id)arg4;	// IMP=0x00000000003774ec
