...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x00100000001fa92f
+ (Class)titleLocalizedArgumentsType;	// IMP=0x00100000001fa833
+ (Class)localizedArgumentsType;	// IMP=0x00100000001fa6e3
- (void).cxx_destruct;	// IMP=0x00000000001fc6e8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001fc093
- (unsigned long long)hash;	// IMP=0x00000000001fbf22
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001fbc8a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fb6a9
- (void)copyTo:(id)arg1;	// IMP=0x00000000001fb383
- (void)writeTo:(id)arg1;	// IMP=0x00000000001faf71
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001faf64
- (id)dictionaryRepresentation;	// IMP=0x00000000001fa9ef
- (id)description;	// IMP=0x00000000001fa940
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001fa912
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x00000000001fa8f5
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001fa88b
- (void)clearSubtitleLocalizedArguments;	// IMP=0x00000000001fa86e
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001fa816
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x00000000001fa7f9
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x00000000001fa78f
- (void)clearTitleLocalizedArguments;	// IMP=0x00000000001fa772
...
- (id)localizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001fa6c6
- (unsigned long long)localizedArgumentsCount;	// IMP=0x00000000001fa6a9
- (void)addLocalizedArguments:(id)arg1;	// IMP=0x00000000001fa63f
- (void)clearLocalizedArguments;	// IMP=0x00000000001fa622
