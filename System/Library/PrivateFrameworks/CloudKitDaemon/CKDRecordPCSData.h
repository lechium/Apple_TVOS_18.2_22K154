...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003a67ca
+ (id)dataWithRecord:(id)arg1;	// IMP=0x00100000003a62ed
- (void).cxx_destruct;	// IMP=0x00000000003a7541
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a6ed0
- (void)dealloc;	// IMP=0x00000000003a6e7e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a6b0a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a67d2
- (id)CKPropertiesDescription;	// IMP=0x00000000003a668a
- (void)setPcs:(struct _OpaquePCSShareProtection *)arg1;	// IMP=0x00000000003a6383
- (_Bool)shouldEncodePCSData;	// IMP=0x00000000003a6350
- (id)itemID;	// IMP=0x00000000003a633e
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000003a5fb7
- (id)initWithPCSData:(id)arg1 recordID:(id)arg2;	// IMP=0x00000000003a5f3f
