...
- (void).cxx_destruct;	// IMP=0x00000000000b695e
...
- (void)start;	// IMP=0x00000000000b59cb
- (void)createFetchOperationForItemIDs:(id)arg1 operationQueue:(id)arg2 operationConfigurationBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b5951
- (_Bool)dependentOperationListContainsOperationID:(id)arg1;	// IMP=0x00000000000b5899
- (_Bool)dependentOperationListContainsRunningFetch:(id)arg1;	// IMP=0x00000000000b5729
- (_Bool)canBeUsedForPendingFetch:(id)arg1;	// IMP=0x00000000000b565c
- (_Bool)canBeUsedForOperation:(id)arg1;	// IMP=0x00000000000b55a8
- (id)description;	// IMP=0x00000000000b5596
- (id)CKPropertiesDescription;	// IMP=0x00000000000b5464
- (void)cancelFetchOperation;	// IMP=0x00000000000b53bd
- (void)finishFetchOperationWithError:(id)arg1;	// IMP=0x00000000000b4e9b
- (void)performCallbacksForItemWithID:(id)arg1 withItem:(id)arg2 error:(id)arg3;	// IMP=0x00000000000b4aa1
- (id)allItemIDs;	// IMP=0x00000000000b49dd
- (id)callbacksForItemWithID:(id)arg1;	// IMP=0x00000000000b48ea
- (void)removeCallbacksForItemWithID:(id)arg1;	// IMP=0x00000000000b45d2
- (void)addCallbackForItemWithID:(id)arg1 operation:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b4207
- (int)numberOfCallbacks;	// IMP=0x00000000000b4014
@property(nonatomic) _Bool isCancelled; // @synthesize isCancelled=_isCancelled;
@property(nonatomic) _Bool isFinished; // @synthesize isFinished=_isFinished;
- (id)initWithOperation:(id)arg1 container:(id)arg2 operationQueue:(id)arg3;	// IMP=0x00000000000b3998
- (id)init;	// IMP=0x00000000000b3938
