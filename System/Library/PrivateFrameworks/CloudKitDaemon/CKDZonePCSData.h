...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003a7c75
+ (id)dataWithZone:(id)arg1;	// IMP=0x00100000003a77af
- (void).cxx_destruct;	// IMP=0x00000000003a8139
...
- (id)CKPropertiesDescription;	// IMP=0x00000000003a7f8a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a7df0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a7c7d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a79fe
- (id)itemID;	// IMP=0x00000000003a79ec
@property(nonatomic) struct _OpaquePCSShareProtection *zoneishPCS;
- (void)dealloc;	// IMP=0x00000000003a7800
- (id)initWithZone:(id)arg1;	// IMP=0x00000000003a762d
