...
- (void).cxx_destruct;	// IMP=0x00000000002ba243
...
- (id)description;	// IMP=0x00000000002ba213
- (id)CKPropertiesDescription;	// IMP=0x00000000002ba144
- (id)initWithRecordID:(id)arg1 record:(id)arg2 etag:(id)arg3;	// IMP=0x00000000002ba069
