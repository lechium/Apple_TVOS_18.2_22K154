...
- (void).cxx_destruct;	// IMP=0x00000000001adc76
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001adaaa
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001ad952
- (id)generateRequestOperations;	// IMP=0x00000000001ad537
- (id)requestOperationClasses;	// IMP=0x00000000001ad4cb
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000001ad3fa
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001ad312
- (id)zoneIDsToLock;	// IMP=0x00000000001ad0f8
- (id)initWithOperation:(id)arg1 shareMetadatasToDecline:(id)arg2;	// IMP=0x00000000001ad05f
