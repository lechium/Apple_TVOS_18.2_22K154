...
+ (id)options;	// IMP=0x00100000001c0350
- (void).cxx_destruct;	// IMP=0x00000000001c14c7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001c1261
- (unsigned long long)hash;	// IMP=0x00000000001c1154
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001c0f8d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c0e0b
- (void)copyTo:(id)arg1;	// IMP=0x00000000001c0ceb
- (Class)responseClass;	// IMP=0x00000000001c0cda
- (unsigned int)requestTypeCode;	// IMP=0x00000000001c0ccf
- (void)writeTo:(id)arg1;	// IMP=0x00000000001c0bad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001c0ba0
- (id)dictionaryRepresentation;	// IMP=0x00000000001c057d
- (id)description;	// IMP=0x00000000001c04ce
