...
- (void).cxx_destruct;	// IMP=0x00000000001db796
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000001db4e9
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000001dae23
- (id)generateRequestOperations;	// IMP=0x00000000001daa01
- (id)requestOperationClasses;	// IMP=0x00000000001da995
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000001da98d
- (id)zoneIDsToLock;	// IMP=0x00000000001da8d4
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000001da80d
- (id)initWithOperation:(id)arg1 subscriptionIDs:(id)arg2;	// IMP=0x00000000001da742
