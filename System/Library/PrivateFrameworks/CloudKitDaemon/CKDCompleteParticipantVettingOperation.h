...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x0060000000116b98
- (void).cxx_destruct;	// IMP=0x0000000000119087
...
- (void)main;	// IMP=0x0000000000118f2d
- (void)_verifyOONParticipant;	// IMP=0x000000000011846f
- (void)_reconstructShareURL;	// IMP=0x000000000011821e
- (void)_forceFetchShareMetadata;	// IMP=0x0000000000117aca
- (void)_performAuthKitVerification;	// IMP=0x00000000001174c2
- (void)_reconstructShortToken;	// IMP=0x0000000000116d93
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x0000000000116d7e
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x0000000000116c80
- (_Bool)makeStateTransition;	// IMP=0x0000000000116a3c
- (id)activityCreate;	// IMP=0x0000000000116a13
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001167ec
