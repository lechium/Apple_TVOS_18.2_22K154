...
+ (Class)clientConfigType;	// IMP=0x00100000003b9bd4
- (void).cxx_destruct;	// IMP=0x00000000003bbd04
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003bb7d7
- (unsigned long long)hash;	// IMP=0x00000000003bb62d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003bb386
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003bafc3
- (void)copyTo:(id)arg1;	// IMP=0x00000000003bad82
- (Class)responseClass;	// IMP=0x00000000003bad71
- (unsigned int)requestTypeCode;	// IMP=0x00000000003bad66
- (void)writeTo:(id)arg1;	// IMP=0x00000000003baadc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003ba547
- (id)dictionaryRepresentation;	// IMP=0x00000000003b9f7b
- (id)description;	// IMP=0x00000000003b9ecc
- (void)clearOneofValuesForDataProtection;	// IMP=0x00000000003b9e6c
- (int)StringAsDataProtection:(id)arg1;	// IMP=0x00000000003b9dd5
- (id)dataProtectionAsString:(int)arg1;	// IMP=0x00000000003b9d8c
...
- (id)clientConfigAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003b9bb7
- (unsigned long long)clientConfigsCount;	// IMP=0x00000000003b9b9a
- (void)addClientConfig:(id)arg1;	// IMP=0x00000000003b9b30
- (void)clearClientConfigs;	// IMP=0x00000000003b9b13
- (int)StringAsSerializationFormat:(id)arg1;	// IMP=0x00000000003b9aa8
- (id)serializationFormatAsString:(int)arg1;	// IMP=0x00000000003b9a52
