...
- (void).cxx_destruct;	// IMP=0x0000000000094165
...
- (id)CKPropertiesDescription;	// IMP=0x00000000000940bd
- (id)description;	// IMP=0x00000000000940ab
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x0000000000093f9f
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x0000000000093ea9
