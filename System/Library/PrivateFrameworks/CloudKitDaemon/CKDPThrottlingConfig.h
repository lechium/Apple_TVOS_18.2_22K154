...
- (void).cxx_destruct;	// IMP=0x000000000016e84a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016e6fc
- (unsigned long long)hash;	// IMP=0x000000000016e666
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000016e558
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000016e474
- (void)copyTo:(id)arg1;	// IMP=0x000000000016e3d1
- (void)writeTo:(id)arg1;	// IMP=0x000000000016e331
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000016e324
- (id)dictionaryRepresentation;	// IMP=0x000000000016def3
- (id)description;	// IMP=0x000000000016de44
