...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000016f01c
- (void).cxx_destruct;	// IMP=0x000000000017146d
...
- (void)cancel;	// IMP=0x0000000000171304
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000017129e
- (void)main;	// IMP=0x00000000001711fb
- (void)_fetchRecords;	// IMP=0x00000000001704ac
- (void)_fetchPCSForRecords;	// IMP=0x000000000016feda
- (void)_finishPublishAssetsForRecord:(id)arg1;	// IMP=0x000000000016fadc
- (void)_dispatchAssetURLsForRecord:(id)arg1 pcs:(struct _OpaquePCSShareProtection *)arg2;	// IMP=0x000000000016f136
- (id)_checkEntitlements;	// IMP=0x000000000016f072
- (_Bool)makeStateTransition;	// IMP=0x000000000016eed5
- (id)activityCreate;	// IMP=0x000000000016eeac
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000016ed8c
