...
- (void).cxx_destruct;	// IMP=0x00000000003dec94
...
- (unsigned long long)hash;	// IMP=0x00000000003debf4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003deab4
- (id)initWithAPSEnvironmentString:(id)arg1 apsToken:(id)arg2;	// IMP=0x00000000003de9fb
