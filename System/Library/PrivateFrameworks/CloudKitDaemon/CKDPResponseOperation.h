...
- (void).cxx_destruct;	// IMP=0x00000000001811d3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000180613
- (unsigned long long)hash;	// IMP=0x0000000000180065
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017f6ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017ee24
- (void)copyTo:(id)arg1;	// IMP=0x000000000017e761
- (void)writeTo:(id)arg1;	// IMP=0x000000000017e13d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000017e130
- (id)dictionaryRepresentation;	// IMP=0x000000000017bf12
- (id)description;	// IMP=0x000000000017be63
