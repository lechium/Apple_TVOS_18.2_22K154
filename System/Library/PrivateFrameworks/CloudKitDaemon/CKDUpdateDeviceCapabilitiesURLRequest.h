...
- (void).cxx_destruct;	// IMP=0x00000000001889c4
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000188411
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000187bc6
- (id)generateRequestOperations;	// IMP=0x0000000000186c9c
- (id)requestOperationClasses;	// IMP=0x0000000000186b59
- (id)initWithOperation:(id)arg1 supportedCapabilities:(id)arg2 zoneUsages:(id)arg3 shareUsages:(id)arg4;	// IMP=0x0000000000186a80
