...
- (void).cxx_destruct;	// IMP=0x00000000001ab33c
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001ab220
- (void)_sendRequest:(_Bool)arg1;	// IMP=0x00000000001aa70d
- (int)operationType;	// IMP=0x00000000001aa702
- (void)main;	// IMP=0x00000000001aa3a1
- (id)_addSelfIdentityToShareMetadataPublicPCS:(id)arg1 forShareWithURL:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001a98eb
- (id)_encryptedKeyDataWithShareMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001a968f
- (void)_handleVettingInitiationProgress:(id)arg1;	// IMP=0x00000000001a954e
- (id)activityCreate;	// IMP=0x00000000001a9525
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001a9438
