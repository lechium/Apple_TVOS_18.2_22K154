...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000007bfb0
- (void).cxx_destruct;	// IMP=0x000000000007e205
...
- (void)_postflightRecords;	// IMP=0x000000000007dc96
- (void)_deserialize;	// IMP=0x000000000007c726
- (void)_setupTranslator;	// IMP=0x000000000007c354
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000007c22c
- (_Bool)validateAgainstLiveContainer:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007c01a
- (void)main;	// IMP=0x000000000007c006
- (_Bool)makeStateTransition;	// IMP=0x000000000007bea4
- (id)activityCreate;	// IMP=0x000000000007be7b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000007bdec
