...
+ (id)options;	// IMP=0x00100000001fdb8c
- (void).cxx_destruct;	// IMP=0x00000000001fe8a4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001fe729
- (unsigned long long)hash;	// IMP=0x00000000001fe674
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001fe531
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fe424
- (void)copyTo:(id)arg1;	// IMP=0x00000000001fe364
- (Class)responseClass;	// IMP=0x00000000001fe353
- (unsigned int)requestTypeCode;	// IMP=0x00000000001fe348
- (void)writeTo:(id)arg1;	// IMP=0x00000000001fe27d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001fe270
- (id)dictionaryRepresentation;	// IMP=0x00000000001fdd58
- (id)description;	// IMP=0x00000000001fdca9
