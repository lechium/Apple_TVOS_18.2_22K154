...
- (void).cxx_destruct;	// IMP=0x0000000000362365
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x0000000000362006
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000361e90
- (id)init;	// IMP=0x0000000000361e14
