...
- (void).cxx_destruct;	// IMP=0x00000000000a78ac
...
- (id)relevantZoneIDs;	// IMP=0x00000000000a761c
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000a75b6
- (void)main;	// IMP=0x00000000000a6bcc
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000000a57e0
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x00000000000a4ad3
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x00000000000a48c0
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x00000000000a41f0
- (id)activityCreate;	// IMP=0x00000000000a41c7
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x00000000000a41af
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000a3e58
