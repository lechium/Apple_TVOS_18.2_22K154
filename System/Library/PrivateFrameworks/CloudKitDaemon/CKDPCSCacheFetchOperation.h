...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x0060000000306744
- (void).cxx_destruct;	// IMP=0x0000000000306d5e
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000306a6c
- (void)main;	// IMP=0x0000000000306a28
- (void)_willRetryFetch;	// IMP=0x000000000030682f
- (_Bool)_savePCSDataToCache;	// IMP=0x0000000000306827
- (_Bool)_saveUpdatedPCSToServer;	// IMP=0x000000000030681f
- (_Bool)_decryptPCS;	// IMP=0x0000000000306817
- (_Bool)_fetchDependentPCS;	// IMP=0x000000000030680f
- (_Bool)_createAdditionalPCS;	// IMP=0x0000000000306807
- (_Bool)_fetchPCSDataFromServer;	// IMP=0x00000000003067ff
- (_Bool)_fetchPCSDataFromDatabase;	// IMP=0x00000000003067f7
- (_Bool)needsAdditionalPCSCreation;	// IMP=0x00000000003067ef
@property(readonly, nonatomic) _Bool hasAllPCSData;
@property(readonly, nonatomic) NSString *itemTypeName;
- (_Bool)makeStateTransition;	// IMP=0x0000000000305c63
- (_Bool)canBeUsedForOperation:(id)arg1 withOptions:(unsigned long long)arg2;	// IMP=0x0000000000305b13
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000305a15
