...
- (void).cxx_destruct;	// IMP=0x000000000022c648
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x000000000022c59f
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x000000000022c52c
