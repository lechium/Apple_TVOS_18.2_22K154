...
+ (Class)protectionInfoKeysToRemoveType;	// IMP=0x0010000000142d62
- (void).cxx_destruct;	// IMP=0x000000000014499a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001443ef
- (unsigned long long)hash;	// IMP=0x000000000014427e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000143fe6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000143c2f
- (void)copyTo:(id)arg1;	// IMP=0x00000000001439eb
- (void)writeTo:(id)arg1;	// IMP=0x000000000014374d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000143740
- (id)dictionaryRepresentation;	// IMP=0x0000000000142eb5
- (id)description;	// IMP=0x0000000000142e06
...
- (id)protectionInfoKeysToRemoveAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000142d45
- (unsigned long long)protectionInfoKeysToRemovesCount;	// IMP=0x0000000000142d28
- (void)addProtectionInfoKeysToRemove:(id)arg1;	// IMP=0x0000000000142cbe
- (void)clearProtectionInfoKeysToRemoves;	// IMP=0x0000000000142ca1
