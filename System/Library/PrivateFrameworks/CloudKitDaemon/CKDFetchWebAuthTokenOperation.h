...
- (void).cxx_destruct;	// IMP=0x0000000000273493
...
- (void)main;	// IMP=0x0000000000272bb8
- (int)operationType;	// IMP=0x0000000000272bad
- (id)activityCreate;	// IMP=0x0000000000272b84
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000272ad3
