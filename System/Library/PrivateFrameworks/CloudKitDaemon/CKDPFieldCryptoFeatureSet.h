...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000002464f4
- (unsigned long long)hash;	// IMP=0x0000000000246470
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000024637b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002462cc
- (void)copyTo:(id)arg1;	// IMP=0x0000000000246240
- (void)writeTo:(id)arg1;	// IMP=0x000000000024618d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000246180
- (id)dictionaryRepresentation;	// IMP=0x0000000000245c69
- (id)description;	// IMP=0x0000000000245bba
