...
- (void).cxx_destruct;	// IMP=0x0000000000148530
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000014840e
- (unsigned long long)hash;	// IMP=0x0000000000148370
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000148258
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014817c
- (void)copyTo:(id)arg1;	// IMP=0x00000000001480db
- (void)writeTo:(id)arg1;	// IMP=0x000000000014802d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000148020
- (id)dictionaryRepresentation;	// IMP=0x0000000000147bac
- (id)description;	// IMP=0x0000000000147afd
