...
- (void).cxx_destruct;	// IMP=0x000000000036f341
...
- (void)dealloc;	// IMP=0x000000000036ef4c
- (id)initWithIdentitySet:(struct _PCSIdentitySetData *)arg1 withPrimaryServiceName:(id)arg2;	// IMP=0x000000000036eec8
