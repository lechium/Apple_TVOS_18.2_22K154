...
+ (Class)replacedDeltaIdentifiersType;	// IMP=0x00100000003a305e
- (void).cxx_destruct;	// IMP=0x00000000003a3ffa
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003a3cfc
- (unsigned long long)hash;	// IMP=0x00000000003a3c43
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003a3adf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a3865
- (void)copyTo:(id)arg1;	// IMP=0x00000000003a3707
- (void)writeTo:(id)arg1;	// IMP=0x00000000003a3541
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003a3534
- (id)dictionaryRepresentation;	// IMP=0x00000000003a311e
- (id)description;	// IMP=0x00000000003a306f
- (id)replacedDeltaIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003a3041
- (unsigned long long)replacedDeltaIdentifiersCount;	// IMP=0x00000000003a3024
- (void)addReplacedDeltaIdentifiers:(id)arg1;	// IMP=0x00000000003a2fba
- (void)clearReplacedDeltaIdentifiers;	// IMP=0x00000000003a2f9d
