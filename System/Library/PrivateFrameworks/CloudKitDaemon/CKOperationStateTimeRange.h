...
- (void).cxx_destruct;	// IMP=0x00000000003b03a2
...
- (id)CKPropertiesDescription;	// IMP=0x00000000003b02b6
@property(readonly) double relativeStart;
@property(readonly) double absoluteStop;
- (long long)compareStopTime:(id)arg1;	// IMP=0x00000000003b01a5
- (long long)compareStartTime:(id)arg1;	// IMP=0x00000000003b0125
@property(readonly) double executing;
@property(readonly) double queueing;
@property(readonly) double absoluteStart;
- (id)initWithOperationState:(unsigned long long)arg1 startDate:(id)arg2 duration:(double)arg3;	// IMP=0x00000000003b0023
