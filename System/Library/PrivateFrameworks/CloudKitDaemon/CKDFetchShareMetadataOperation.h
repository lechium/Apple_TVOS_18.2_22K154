...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x00600000000faf2c
- (void).cxx_destruct;	// IMP=0x0000000000101790
...
- (void)main;	// IMP=0x000000000010140e
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001013a8
- (void)_prepareShortTokens;	// IMP=0x0000000000100860
- (_Bool)_currentUserIsOONForShareMetadata:(id)arg1;	// IMP=0x00000000001006a9
- (void)_decryptRootRecordsForShareURL:(id)arg1 withMetadata:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000ff193
- (void)_continueHandlingFetchedShareMetadata:(id)arg1 shareURL:(id)arg2;	// IMP=0x00000000000fe9fa
- (void)_prepPPPCSDataForDugongShareMetadata:(id)arg1 withInvitationToken:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000fe7bd
- (void)_continueSharePCSPrepForShareMetadata:(id)arg1 shareURL:(id)arg2;	// IMP=0x00000000000fe0b3
- (void)_handleTokenResolveWithLookupInfo:(id)arg1 shareMetadata:(id)arg2 responseCode:(id)arg3 urlByShortTokenLookupInfos:(id)arg4 tokensToFetchByURL:(id)arg5;	// IMP=0x00000000000fcb48
- (void)_fetchShortTokenMetadata;	// IMP=0x00000000000fbdef
- (id)_decodeProtectedFullToken:(id)arg1 tokenMetadata:(id)arg2;	// IMP=0x00000000000fb6d1
- (void)_performCallbackForURL:(id)arg1 withMetadata:(id)arg2 error:(id)arg3;	// IMP=0x00000000000faf8e
- (_Bool)makeStateTransition;	// IMP=0x00000000000fae5b
- (int)operationType;	// IMP=0x00000000000fae50
- (id)activityCreate;	// IMP=0x00000000000fae27
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000fac45
