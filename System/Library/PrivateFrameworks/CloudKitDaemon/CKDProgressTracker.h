...
+ (unsigned long long)_sizeForItem:(id)arg1;	// IMP=0x00000000003c7a0f
- (void).cxx_destruct;	// IMP=0x00000000003c8576
...
- (double)updateProgressWithItem:(id)arg1 progress:(double)arg2;	// IMP=0x00000000003c8275
- (unsigned long long)_updateTotalCompletedBytes;	// IMP=0x00000000003c819d
- (unsigned long long)_updateTotalBytes;	// IMP=0x00000000003c80be
- (void)stopTrackingItems:(id)arg1;	// IMP=0x00000000003c7e40
- (void)startTrackingItems:(id)arg1;	// IMP=0x00000000003c7bb9
- (id)initWithTrackingID:(id)arg1;	// IMP=0x00000000003c7b5f
- (id)init;	// IMP=0x00000000003c7af9
