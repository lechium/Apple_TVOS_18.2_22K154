...
- (void).cxx_destruct;	// IMP=0x00000000003ef2d7
...
- (id)initWithCertificate:(id)arg1 applicationEnclaveQuote:(id)arg2 quotingEnclaveQuote:(id)arg3 routingToken:(id)arg4;	// IMP=0x00000000003ef183
