...
- (void).cxx_destruct;	// IMP=0x0000000000273c5c
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000273aab
- (id)generateRequestOperations;	// IMP=0x00000000002736b9
- (id)requestOperationClasses;	// IMP=0x000000000027364d
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000273565
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToRemove:(id)arg2;	// IMP=0x00000000002734cc
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002734c4
