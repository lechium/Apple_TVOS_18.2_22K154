...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000010fbb0
- (void).cxx_destruct;	// IMP=0x00000000001119f4
...
- (void)handleReplaceDeltasRequest:(id)arg1 result:(id)arg2;	// IMP=0x0000000000111634
- (void)handleDeltaUploaded:(id)arg1 result:(id)arg2;	// IMP=0x00000000001112a7
- (void)_uploadAndReplaceDeltas:(CDUnknownBlockType)arg1;	// IMP=0x000000000011020b
- (void)_uploadAndReplaceDeltas;	// IMP=0x0000000000110076
- (void)_encryptMergeableDeltas;	// IMP=0x000000000010fcbd
- (_Bool)supportsClearAssetEncryption;	// IMP=0x000000000010fcb5
- (void)main;	// IMP=0x000000000010fc12
- (_Bool)makeStateTransition;	// IMP=0x000000000010fadf
- (id)activityCreate;	// IMP=0x000000000010fab6
- (int)operationType;	// IMP=0x000000000010faab
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000010f975
