...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003a5903
- (void).cxx_destruct;	// IMP=0x00000000003a5ba5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a5a36
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a590b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a57ae
- (id)description;	// IMP=0x00000000003a579c
- (id)CKPropertiesDescription;	// IMP=0x00000000003a5655
...
- (_Bool)shouldEncodePCSData;	// IMP=0x00000000003a5551
- (void)dealloc;	// IMP=0x00000000003a550a
- (id)initWithPCSData:(id)arg1;	// IMP=0x00000000003a5497
