...
- (void).cxx_destruct;	// IMP=0x000000000032d193
...
- (id)MMCSOptions;	// IMP=0x000000000032c06b
- (_Bool)usesBackgroundSession;	// IMP=0x000000000032c01a
- (id)description;	// IMP=0x000000000032c008
- (id)CKPropertiesDescription;	// IMP=0x000000000032bb45
- (id)initWithOperation:(id)arg1;	// IMP=0x000000000032b709
