...
- (void).cxx_destruct;	// IMP=0x0000000000193da6
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000193964
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000018fb11
- (void)reportClientValidationError:(id)arg1 forZoneID:(id)arg2 capabilitySet:(id)arg3;	// IMP=0x000000000018fa53
- (id)generateRequestOperations;	// IMP=0x000000000018f0ce
- (id)requestOperationClasses;	// IMP=0x000000000018f062
- (id)initWithOperation:(id)arg1 zoneIDs:(id)arg2 desiredCapabilitySets:(id)arg3 options:(id)arg4;	// IMP=0x000000000018ef44
