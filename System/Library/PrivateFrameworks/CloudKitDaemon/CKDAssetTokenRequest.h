...
- (void).cxx_destruct;	// IMP=0x000000000008394d
...
- (id)description;	// IMP=0x00000000000838ea
- (id)CKPropertiesDescription;	// IMP=0x000000000008374a
- (_Bool)isEmpty;	// IMP=0x000000000008372d
- (id)successfulBatches;	// IMP=0x00000000000836da
- (_Bool)hasSuccessfulBatches;	// IMP=0x00000000000835e3
- (void)addFailedBatch:(id)arg1;	// IMP=0x00000000000835c4
- (void)addAssetBatch:(id)arg1;	// IMP=0x0000000000083514
- (id)init;	// IMP=0x000000000008349f
