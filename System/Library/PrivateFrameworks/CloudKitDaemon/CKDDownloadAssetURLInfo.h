...
- (void).cxx_destruct;	// IMP=0x00000000003850cf
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000384fb8
- (unsigned long long)hash;	// IMP=0x0000000000384f74
- (void)dealloc;	// IMP=0x0000000000384f2d
