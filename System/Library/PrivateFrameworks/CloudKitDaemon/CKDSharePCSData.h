...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003a893a
+ (id)dataWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x00100000003a84c5
+ (id)dataWithShare:(id)arg1 serviceType:(unsigned long long)arg2;	// IMP=0x00100000003a8226
- (void).cxx_destruct;	// IMP=0x00000000003a92c4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a8df1
- (id)itemID;	// IMP=0x00000000003a8ddf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003a8b80
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003a8942
- (id)CKPropertiesDescription;	// IMP=0x00000000003a8762
@property(nonatomic) struct _OpaquePCSShareProtection *invitedPCS;
- (void)dealloc;	// IMP=0x00000000003a853b
- (id)initWithShareID:(id)arg1 pcsData:(id)arg2;	// IMP=0x00000000003a81ae
