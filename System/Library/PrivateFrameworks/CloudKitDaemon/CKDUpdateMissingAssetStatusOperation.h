...
+ (id)nameForState:(unsigned long long)arg1;	// IMP=0x006000000024a558
- (void).cxx_destruct;	// IMP=0x000000000024ac31
...
- (void)main;	// IMP=0x000000000024aaff
- (void)_updateMissingAssetStatus;	// IMP=0x000000000024a5b3
- (int)operationType;	// IMP=0x000000000024a5a8
- (_Bool)makeStateTransition;	// IMP=0x000000000024a4b3
- (id)activityCreate;	// IMP=0x000000000024a48a
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000024a36d
