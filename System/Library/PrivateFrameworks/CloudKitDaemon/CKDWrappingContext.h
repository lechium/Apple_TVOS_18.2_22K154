...
- (void).cxx_destruct;	// IMP=0x00000000000d3f68
...
- (id)encryptedDataContextString;	// IMP=0x00000000000d3dbd
- (id)assetContextString;	// IMP=0x00000000000d39a2
- (id)initWithRecordID:(id)arg1 fieldName:(id)arg2 mergeableDeltaID:(id)arg3 fileSignature:(id)arg4 referenceSignature:(id)arg5;	// IMP=0x00000000000d3737
- (id)initWithRecordID:(id)arg1 fieldName:(id)arg2;	// IMP=0x00000000000d370e
