...
- (void).cxx_destruct;	// IMP=0x00000000002d4796
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002d3a19
- (id)generateRequestOperations;	// IMP=0x00000000002d3801
- (id)requestOperationClasses;	// IMP=0x00000000002d3795
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002d378d
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002d3773
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002d36d8
- (id)initWithOperation:(id)arg1 previousServerChangeTokenData:(id)arg2;	// IMP=0x00000000002d35ce
