...
- (void).cxx_destruct;	// IMP=0x000000000036c8bc
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000036c53c
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000036bf1b
- (id)generateRequestOperations;	// IMP=0x000000000036ba58
- (id)anonymousUserIDForHTTPHeader;	// IMP=0x000000000036b9de
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000036b9d6
- (id)requestOperationClasses;	// IMP=0x000000000036b96a
- (id)zoneIDsToLock;	// IMP=0x000000000036b8a0
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000036b886
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x000000000036b7f5
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x000000000036b70d
- (id)initWithOperation:(id)arg1 mergeableValueIDs:(id)arg2 previousContinuationTokens:(id)arg3;	// IMP=0x000000000036b615
