...
- (void).cxx_destruct;	// IMP=0x00000000002ca921
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002ca2f6
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002c9f2e
- (id)_handleRecords:(id)arg1;	// IMP=0x00000000002c9c21
- (id)generateRequestOperations;	// IMP=0x00000000002c94f4
- (id)requestOperationClasses;	// IMP=0x00000000002c9488
- (id)zoneIDsToLock;	// IMP=0x00000000002c9476
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000002c93e5
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000002c90bc
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002c8f06
