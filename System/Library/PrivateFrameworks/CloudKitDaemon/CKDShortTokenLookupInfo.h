...
- (void).cxx_destruct;	// IMP=0x000000000014c435
...
- (unsigned long long)hash;	// IMP=0x000000000014c30a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014bfd8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014beeb
