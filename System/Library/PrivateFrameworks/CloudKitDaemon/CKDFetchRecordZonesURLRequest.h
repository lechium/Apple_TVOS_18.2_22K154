...
- (void).cxx_destruct;	// IMP=0x00000000003d8033
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003d7d56
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003d6759
- (id)generateRequestOperations;	// IMP=0x00000000003d5fea
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000003d5f6c
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000003d5f64
- (id)requestOperationClasses;	// IMP=0x00000000003d5ef8
- (id)zoneIDsToLock;	// IMP=0x00000000003d5ee6
- (_Bool)isFullZoneRequest;	// IMP=0x00000000003d5ede
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000003d5ec4
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000003d5e33
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000003d5d4b
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2;	// IMP=0x00000000003d5c80
