...
- (void).cxx_destruct;	// IMP=0x0000000000158a5c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001588cd
- (unsigned long long)hash;	// IMP=0x0000000000158849
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000015873d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000158653
- (void)copyTo:(id)arg1;	// IMP=0x00000000001585b0
- (void)writeTo:(id)arg1;	// IMP=0x0000000000158519
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000015850c
- (id)dictionaryRepresentation;	// IMP=0x0000000000158113
- (id)description;	// IMP=0x0000000000158064
