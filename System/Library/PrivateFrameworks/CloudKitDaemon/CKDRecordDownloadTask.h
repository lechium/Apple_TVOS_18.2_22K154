...
- (void).cxx_destruct;	// IMP=0x00000000002f706d
...
- (void)didCompleteTaskWithError:(id)arg1;	// IMP=0x00000000002f6b10
- (void)didFillOutURLInfo:(id)arg1 error:(id)arg2;	// IMP=0x00000000002f69ec
- (void)didDownloadAsset:(id)arg1 error:(id)arg2;	// IMP=0x00000000002f6826
- (id)initWithRecord:(id)arg1 trackProgress:(_Bool)arg2 assetsToDownload:(id)arg3 assetsToDownloadInMemory:(id)arg4 assetURLInfosToFillOut:(id)arg5;	// IMP=0x00000000002f63b0
