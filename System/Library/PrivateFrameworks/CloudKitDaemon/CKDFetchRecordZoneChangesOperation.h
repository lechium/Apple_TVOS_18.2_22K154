...
- (void).cxx_destruct;	// IMP=0x00000000002f2828
...
- (id)analyticsPayload;	// IMP=0x00000000002f2527
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002f249b
- (void)_noteOperationFinishedBlockEnd;	// IMP=0x00000000002f2475
- (void)_noteOperationEnding;	// IMP=0x00000000002f244f
- (void)_noteOperationBeginning;	// IMP=0x00000000002f2429
- (id)_createAndConfigureURLRequestForZoneIDs:(id)arg1 optionsByZoneID:(id)arg2;	// IMP=0x00000000002f1c67
- (int)operationType;	// IMP=0x00000000002f1c5c
- (id)_optionsForZonesWithPendingChangesAfterRequest:(id)arg1;	// IMP=0x00000000002f18e6
- (void)_noteAttributesChangedForZone:(id)arg1;	// IMP=0x00000000002f1866
- (void)_noteDeletedRecordWithID:(id)arg1 recordType:(id)arg2;	// IMP=0x00000000002f17be
- (void)_noteChangedRecordWithID:(id)arg1 record:(id)arg2 error:(id)arg3;	// IMP=0x00000000002f1700
- (void)_noteCompletedURLRequest:(id)arg1 withSchedulerInfo:(id)arg2;	// IMP=0x00000000002f039d
- (id)activityCreate;	// IMP=0x00000000002f0374
- (id)pipeliningDescription;	// IMP=0x00000000002f0367
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002f0107
