...
- (void).cxx_destruct;	// IMP=0x000000000036b5e4
...
- (void)main;	// IMP=0x000000000036b122
- (void)setCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000036afc1
- (_Bool)shouldCheckAppVersion;	// IMP=0x000000000036afb9
- (id)activityCreate;	// IMP=0x000000000036af90
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000036af2d
