...
- (void)main;	// IMP=0x000000000012e3af
- (int)operationType;	// IMP=0x000000000012e3a4
- (id)activityCreate;	// IMP=0x000000000012e37b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000012e34c
