...
- (void).cxx_destruct;	// IMP=0x0000000000384e82
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000384c35
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003847ae
- (id)generateRequestOperations;	// IMP=0x00000000003841fd
- (id)requestOperationClasses;	// IMP=0x0000000000384191
- (id)zoneIDsToLock;	// IMP=0x0000000000383fcb
- (id)recordIDsUsedInZones:(id)arg1;	// IMP=0x0000000000383f4e
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x0000000000383ebd
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x0000000000383d8f
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 desiredKeys:(id)arg3 minimumVersionETag:(id)arg4;	// IMP=0x0000000000383c86
