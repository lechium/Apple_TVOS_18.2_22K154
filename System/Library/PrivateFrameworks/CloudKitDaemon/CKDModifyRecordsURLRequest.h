...
- (void).cxx_destruct;	// IMP=0x00000000003b8b96
...
- (void)requestDidComplete;	// IMP=0x00000000003b83df
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003b7e11
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000003b6f79
- (id)returnVerificationKeyAndSignatureForRequestOperation:(id)arg1 dataToBeSigned:(id)arg2 error:(id *)arg3;	// IMP=0x00000000003b684c
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000003b56b6
- (id)generateRequestOperations;	// IMP=0x00000000003b2a9b
- (_Bool)requiresCKAnonymousSignature;	// IMP=0x00000000003b2a89
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000003b2a81
- (int)isolationLevel;	// IMP=0x00000000003b2a64
- (id)requestOperationClasses;	// IMP=0x00000000003b294a
- (id)zoneIDsToLock;	// IMP=0x00000000003b260e
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000003b25f4
- (id)recordIDsUsedInZones:(id)arg1;	// IMP=0x00000000003b235d
- (void)fillOutRequestProperties:(id)arg1;	// IMP=0x00000000003b2257
- (void)fillOutEquivalencyPropertiesBuilder:(id)arg1;	// IMP=0x00000000003b20e8
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x00000000003b1ebb
