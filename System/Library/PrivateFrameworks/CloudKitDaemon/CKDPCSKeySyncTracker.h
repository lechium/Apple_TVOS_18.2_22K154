...
@interface CKDPCSKeySyncTracker : NSObject
{
    ...
    _Bool _racedWithGuitarfishRepairCallback;	// 10 = 0xa
...
- (void).cxx_destruct;	// IMP=0x00000000001dc227
...
- (void)waitOnSyncWithQueue:(id)arg1 waiterOperationID:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001dbe15
