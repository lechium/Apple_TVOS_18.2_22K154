...
- (void).cxx_destruct;	// IMP=0x00000000000a34e1
...
- (void)_parseServerHeaderValue:(id)arg1 serverApplicationName:(id *)arg2 serverApplicationVersion:(unsigned long long *)arg3;	// IMP=0x00000000000a3082
- (void)_handleResponse:(id)arg1;	// IMP=0x00000000000a2d15
- (id)initWithAccessMode:(unsigned long long)arg1 homeSharingGroupIdentifier:(id)arg2 requestSession:(id)arg3;	// IMP=0x00000000000a2c34
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x00000000000a2bc5
