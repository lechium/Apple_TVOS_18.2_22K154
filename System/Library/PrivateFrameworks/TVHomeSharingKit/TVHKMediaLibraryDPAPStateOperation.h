...
+ (id)new;	// IMP=0x0060000000031f8f
- (void).cxx_destruct;	// IMP=0x00000000000328d0
...
- (void)_startSubOperation:(id)arg1;	// IMP=0x000000000003274c
- (void)_startBasePlaylistOperation;	// IMP=0x000000000003246e
- (void)_startDatabasesOperation;	// IMP=0x000000000003219e
- (void)cancel;	// IMP=0x0000000000032120
- (void)executionDidBegin;	// IMP=0x000000000003210e
- (id)initWithSessionState:(id)arg1 requestSession:(id)arg2;	// IMP=0x000000000003202d
- (id)init;	// IMP=0x0000000000031fbe
