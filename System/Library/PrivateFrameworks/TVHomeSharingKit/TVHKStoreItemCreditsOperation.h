...
+ (id)_contributorsFromStoreCredits:(id)arg1;	// IMP=0x006000000005cbe3
+ (id)new;	// IMP=0x006000000005c408
- (void).cxx_destruct;	// IMP=0x000000000005d00a
...
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000005c852
- (void)cancel;	// IMP=0x000000000005c7d4
- (void)executionDidBegin;	// IMP=0x000000000005c532
- (id)initWithItemTitle:(id)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x000000000005c4a6
- (id)init;	// IMP=0x000000000005c437
