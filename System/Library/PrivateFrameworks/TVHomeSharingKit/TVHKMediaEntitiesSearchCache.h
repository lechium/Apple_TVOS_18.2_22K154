...
+ (id)_nonPersistentIDsFromMediaEntityIdentifiers:(id)arg1;	// IMP=0x001000000003736d
+ (id)_nonPersistentIDFromMediaEntityIdentifier:(id)arg1;	// IMP=0x00100000000372c4
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaItemType:(unsigned long long)arg2 mediaCategoryType:(unsigned long long)arg3;	// IMP=0x001000000003723e
+ (id)_mediaEntityTypePredicateWithMediaEntityCollectionType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0010000000037227
+ (id)_mediaEntityTypePredicateWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x001000000003720d
+ (id)_sortedMediaEntitiesWithMediaEntities:(id)arg1;	// IMP=0x0010000000037132
+ (_Bool)_updateMediaEntitiesDictionary:(id)arg1 withMediaEntityFetchResponse:(id)arg2;	// IMP=0x0010000000036a54
+ (id)new;	// IMP=0x00100000000357a2
- (void).cxx_destruct;	// IMP=0x000000000003770b
...
- (id)_albumsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000037067
- (id)_albumArtistsWithMediaCategoryType:(unsigned long long)arg1;	// IMP=0x0000000000036f9c
- (id)_mediaItemsWithMediaItemType:(unsigned long long)arg1 mediaCategoryType:(unsigned long long)arg2;	// IMP=0x0000000000036de1
- (void)_updateAlbumsWithAlbumsResponse:(id)arg1;	// IMP=0x00000000000369cb
- (void)_updateAlbumArtistsWithAlbumArtistResponse:(id)arg1;	// IMP=0x0000000000036942
- (void)_updateMediaItemsWithMediaItemsResponse:(id)arg1;	// IMP=0x00000000000368b9
- (void)_clearCachedMediaItemArrays;	// IMP=0x00000000000367f1
- (void)_clearCachedAlbumArrays;	// IMP=0x0000000000036792
- (void)_clearCachedAlbumArtistArrays;	// IMP=0x0000000000036760
- (id)description;	// IMP=0x0000000000036122
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003604f
- (void)reset;	// IMP=0x0000000000035a29
- (void)updateWithSearchFetchResponse:(id)arg1 searchText:(id)arg2;	// IMP=0x000000000003591e
- (id)initWithMediaServerIdentifier:(id)arg1;	// IMP=0x0000000000035840
- (id)init;	// IMP=0x00000000000357d1
