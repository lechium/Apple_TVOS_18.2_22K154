...
- (void).cxx_destruct;	// IMP=0x0000000000087e70
...
- (id)_episodesFetchRequest;	// IMP=0x0000000000087c6c
- (id)_mediaEntitiesWithFetchedEpisodes:(id)arg1 andMediaEntityCache:(id)arg2;	// IMP=0x0000000000087c04
- (id)_mediaEntityCacheWithFetchCache:(id)arg1;	// IMP=0x0000000000087ba1
- (void)_mediaEntitiesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000087526
- (void)cancel;	// IMP=0x00000000000874b8
- (id)initWithRequest:(id)arg1 mediaServerIdentifier:(id)arg2 sessionState:(id)arg3 requestSession:(id)arg4 fetchCache:(id)arg5;	// IMP=0x000000000008725f
- (id)_initWithRequest:(id)arg1;	// IMP=0x00000000000871f0
