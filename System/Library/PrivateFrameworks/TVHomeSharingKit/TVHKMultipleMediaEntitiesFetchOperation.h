...
+ (id)new;	// IMP=0x00600000000312de
- (void).cxx_destruct;	// IMP=0x0000000000031b6e
...
- (void)_runNextFetchOperationIfPossible;	// IMP=0x00000000000315e1
- (void)cancel;	// IMP=0x0000000000031563
- (void)executionDidBegin;	// IMP=0x0000000000031551
- (id)initWithRequests:(id)arg1 mediaServerIdentifier:(id)arg2 sessionState:(id)arg3 requestSession:(id)arg4 fetchCache:(id)arg5;	// IMP=0x000000000003137c
- (id)init;	// IMP=0x000000000003130d
