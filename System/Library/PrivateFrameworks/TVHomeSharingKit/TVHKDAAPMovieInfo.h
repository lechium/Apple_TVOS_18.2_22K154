...
- (void).cxx_destruct;	// IMP=0x000000000008ae84
...
- (id)description;	// IMP=0x000000000008ac4a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000008a7c2
- (unsigned long long)hash;	// IMP=0x000000000008a613
