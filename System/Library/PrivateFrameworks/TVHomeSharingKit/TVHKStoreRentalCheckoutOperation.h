...
+ (id)new;	// IMP=0x006000000002dfa7
- (void).cxx_destruct;	// IMP=0x000000000002e615
...
- (void)cancel;	// IMP=0x000000000002e51f
- (void)executionDidBegin;	// IMP=0x000000000002e196
- (id)initWithRentalItem:(id)arg1;	// IMP=0x000000000002e045
- (id)init;	// IMP=0x000000000002dfd6
