...
+ (id)new;	// IMP=0x001000000008fdb5
- (void).cxx_destruct;	// IMP=0x0000000000090a7c
...
- (void)netServiceDidStop:(id)arg1;	// IMP=0x00000000000908a2
- (void)netService:(id)arg1 didNotResolve:(id)arg2;	// IMP=0x00000000000906ed
- (void)netServiceDidResolveAddress:(id)arg1;	// IMP=0x00000000000902ad
- (void)cancel;	// IMP=0x0000000000090257
- (void)_finishOperationWithError:(id)arg1;	// IMP=0x00000000000901ec
- (void)executionDidBegin;	// IMP=0x000000000008ff67
- (void)_stopResolving;	// IMP=0x000000000008ff00
- (id)initWithBonjourServiceConfiguration:(id)arg1;	// IMP=0x000000000008fe53
- (id)init;	// IMP=0x000000000008fde4
