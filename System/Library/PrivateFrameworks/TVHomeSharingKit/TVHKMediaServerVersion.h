...
+ (id)new;	// IMP=0x001000000009913f
- (void).cxx_destruct;	// IMP=0x0000000000099e48
...
- (_Bool)_isITunesSharingServer;	// IMP=0x0000000000099db3
- (_Bool)_isDesktopSharingServer;	// IMP=0x0000000000099d8c
- (void)_updateClientSharingProtocolVersion;	// IMP=0x0000000000099d52
- (_Bool)_supportsHomeVideos;	// IMP=0x0000000000099d36
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000099cb0
- (id)description;	// IMP=0x0000000000099b10
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009963f
- (unsigned long long)hash;	// IMP=0x00000000000994dd
- (_Bool)supportsSharingProtocolMajorVersion:(unsigned short)arg1 minorVersion:(unsigned short)arg2;	// IMP=0x0000000000099482
- (_Bool)supportsSharingProtocolVersion:(unsigned int)arg1;	// IMP=0x000000000009946a
- (_Bool)supportsDPAPProtocolMajorVersion:(unsigned short)arg1 minorVersion:(unsigned short)arg2;	// IMP=0x000000000009940f
- (_Bool)supportsDPAPProtocolVersion:(unsigned int)arg1;	// IMP=0x00000000000993f7
- (_Bool)supportsDAAPProtocolMajorVersion:(unsigned short)arg1 minorVersion:(unsigned short)arg2;	// IMP=0x000000000009939c
- (_Bool)supportsDAAPProtocolVersion:(unsigned int)arg1;	// IMP=0x0000000000099384
- (_Bool)supportsCapability:(unsigned long long)arg1;	// IMP=0x0000000000099305
...
- (id)_init;	// IMP=0x0000000000099211
- (id)init;	// IMP=0x00000000000991a2
