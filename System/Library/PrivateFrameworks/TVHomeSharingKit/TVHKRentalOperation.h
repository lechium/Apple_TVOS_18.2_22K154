...
+ (id)new;	// IMP=0x006000000001c363
- (void).cxx_destruct;	// IMP=0x000000000001c702
...
- (id)initWithMediaItem:(id)arg1 sessionState:(id)arg2 requestSession:(id)arg3;	// IMP=0x000000000001c401
- (id)init;	// IMP=0x000000000001c392
