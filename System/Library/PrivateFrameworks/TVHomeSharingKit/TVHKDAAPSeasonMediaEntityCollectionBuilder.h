...
+ (id)new;	// IMP=0x006000000009840f
- (void).cxx_destruct;	// IMP=0x0000000000098de5
...
- (void)addEpisode:(id)arg1;	// IMP=0x0000000000098569
- (id)initWithShow:(id)arg1;	// IMP=0x00000000000984ad
- (id)init;	// IMP=0x000000000009843e
