...
+ (id)new;	// IMP=0x0060000000037ee3
- (void).cxx_destruct;	// IMP=0x00000000000384b0
...
- (void)_handleResponse:(id)arg1 responseData:(id)arg2 error:(id)arg3;	// IMP=0x00000000000383b9
- (void)cancel;	// IMP=0x000000000003833b
- (void)executionDidBegin;	// IMP=0x000000000003812f
@property(readonly, nonatomic) unsigned long long elapsedTimeInMilliseconds;
- (id)initWithRequest:(id)arg1 session:(id)arg2;	// IMP=0x0000000000037f95
- (id)initWithRequest:(id)arg1;	// IMP=0x0000000000037f81
- (id)init;	// IMP=0x0000000000037f12
