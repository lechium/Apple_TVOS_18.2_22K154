...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x0010000000085bca
- (void).cxx_destruct;	// IMP=0x0000000000085d7e
...
- (id)description;	// IMP=0x000000000008582f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000856f9
- (id)init;	// IMP=0x00000000000852dc
