...
- (void).cxx_destruct;	// IMP=0x000000000006a670
...
- (id)_decryptTokenData:(id)arg1;	// IMP=0x000000000006a56d
- (void)_handleResponse:(id)arg1;	// IMP=0x000000000006a1ae
- (id)initWithUserIdentifier:(id)arg1 sessionState:(id)arg2 useTokenEncryption:(_Bool)arg3 requestSession:(id)arg4;	// IMP=0x0000000000069fdc
- (id)initWithRequest:(id)arg1 requestSession:(id)arg2;	// IMP=0x0000000000069f6d
