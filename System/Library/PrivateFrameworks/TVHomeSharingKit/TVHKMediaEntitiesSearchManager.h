...
+ (id)new;	// IMP=0x006000000004a49d
- (void).cxx_destruct;	// IMP=0x000000000004aca5
...
- (void)sessionStateDidChange:(id)arg1;	// IMP=0x000000000004ac29
- (id)enqueueSearchRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000004a7af
- (void)warmdown;	// IMP=0x000000000004a695
- (void)warmup;	// IMP=0x000000000004a68f
- (void)dealloc;	// IMP=0x000000000004a624
- (id)initWithMediaServerIdentifier:(id)arg1 requestSession:(id)arg2;	// IMP=0x000000000004a53b
- (id)init;	// IMP=0x000000000004a4cc
