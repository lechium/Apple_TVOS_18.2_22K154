...
- (void).cxx_destruct;	// IMP=0x0000000000033a66
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000339f2
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithLeaf_leaf_predictions_probabilities:(id)arg1;	// IMP=0x0000000000033967
