...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000002447b
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImage:(struct __CVBuffer *)arg1 iouThreshold:(double)arg2 confidenceThreshold:(double)arg3;	// IMP=0x000000000002443f
