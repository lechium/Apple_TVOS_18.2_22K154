...
- (void).cxx_destruct;	// IMP=0x000000000008c1dc
@property(retain, nonatomic) NSString *label; // @synthesize label=_label;
@property(retain, nonatomic) NSDictionary *labelProbability; // @synthesize labelProbability=_labelProbability;
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000008c0f1
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithLabelProbability:(id)arg1 label:(id)arg2;	// IMP=0x000000000008c05f
