...
- (void).cxx_destruct;	// IMP=0x00000000000246f9
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000024628
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithConfidence:(id)arg1 coordinates:(id)arg2;	// IMP=0x0000000000024596
