...
+ (id)buttonWithDelegate:(id)arg1;	// IMP=0x00400000000451ae
+ (id)disabledTintColor;	// IMP=0x0040000000045195
+ (Class)layerClass;	// IMP=0x0040000000045184
- (void).cxx_destruct;	// IMP=0x00000000000465d0
...
- (void)_handleDragExit:(id)arg1;	// IMP=0x0000000000046228
- (void)_handleDragEnter:(id)arg1;	// IMP=0x0000000000046211
- (void)_handleTouchUpInside:(id)arg1;	// IMP=0x00000000000461b7
- (void)_handleTouchUpOrCancel:(id)arg1;	// IMP=0x0000000000046161
- (void)_handleTouchDown:(id)arg1;	// IMP=0x00000000000460bb
- (void)_updateForCircularAppearanceIfNeeded;	// IMP=0x0000000000046001
- (void)_updateGlyphConfigurationIfNeeded;	// IMP=0x0000000000045dad
- (void)didMoveToWindow;	// IMP=0x0000000000045d6c
@property(readonly, nonatomic) UIColor *enabledTintColor;
@property(nonatomic, getter=isEnabled) _Bool enabled;
- (void)sizeToFit;	// IMP=0x0000000000045af5
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000045a5c
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000459b7
- (_Bool)_shouldHitTest;	// IMP=0x0000000000045971
- (void)layoutSubviews;	// IMP=0x00000000000458e4
@property(copy, nonatomic) UIFont *font;
@property(copy, nonatomic) NSString *text;
- (void)setAccessibilityIdentifier:(id)arg1;	// IMP=0x00000000000454c8
- (id)accessibilityIdentifier;	// IMP=0x00000000000454ab
- (void)dealloc;	// IMP=0x0000000000045462
