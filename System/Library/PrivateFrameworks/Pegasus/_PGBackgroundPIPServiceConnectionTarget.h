...
- (void).cxx_destruct;	// IMP=0x000000000001440f
...
- (void)invalidate;	// IMP=0x00000000000142d2
- (oneway void)revokeAuthorization;	// IMP=0x00000000000142bb
- (oneway void)grantAuthorizationForActivitySessionWithIdentifier:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x0000000000014217
@property(readonly, nonatomic, getter=isConnectionActive) _Bool connectionActive;
- (void)transitionToStateIfPossible:(long long)arg1;	// IMP=0x0000000000013f51
@property(readonly, nonatomic) long long state;
@property(readonly, copy) NSString *bundleIdentifier;
@property(readonly, copy) NSString *activitySessionIdentifier;
- (id)initWithConnection:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000013e16
