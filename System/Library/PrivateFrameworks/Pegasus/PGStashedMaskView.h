...
- (void).cxx_destruct;	// IMP=0x00000000000337f6
...
- (void)layoutSubviews;	// IMP=0x00000000000332cd
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000033205
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x00000000000331e8
- (double)_continuousCornerRadius;	// IMP=0x00000000000331cb
- (struct CGRect)_mainBodyBounds;	// IMP=0x0000000000033158
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000032bc2
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000032489
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000032467
