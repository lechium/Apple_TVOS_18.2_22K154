...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0060000000002b93
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x0000000000002a66
