...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000001f4d
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000001e88
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000001e16
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000001d4f
