...
- (void).cxx_destruct;	// IMP=0x000000000036fa46
...
- (id)performDeviceIdentityRequestWithBaaOptions:(id)arg1 ttlBagKey:(id)arg2 logInformation:(id)arg3;	// IMP=0x000000000036f3ad
- (id)initWithBag:(id)arg1;	// IMP=0x000000000036ef6e
- (id)performDeviceIdentityRequestForAbsinthe;	// IMP=0x000000000036ee03
- (id)performDeviceIdentityRequestForFraudReport;	// IMP=0x000000000036ee2d
