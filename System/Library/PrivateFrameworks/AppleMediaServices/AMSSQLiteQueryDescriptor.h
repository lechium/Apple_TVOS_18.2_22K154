...
- (void).cxx_destruct;	// IMP=0x00000000004c986a
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000000004c9124
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c9032
