...
@interface AMSURLRequestProperties : NSObject
{
    ...
    _Bool _excludeIdentifierHeadersForAccount;	// 11 = 0xb
    _Bool _knownToBeTrusted;	// 12 = 0xc
    _Bool _remoteSecuritySigningEnabled;	// 13 = 0xd
    _Bool _shouldSetCookiesFromResponse;	// 14 = 0xe
    _Bool _shouldSetStorefrontFromResponse;	// 15 = 0xf
    ...
    Class _paymentSheetTaskClass;	// 136 = 0x88
}

- (void).cxx_destruct;	// IMP=0x0000000000508505
@property(retain, nonatomic) Class paymentSheetTaskClass; // @synthesize paymentSheetTaskClass=_paymentSheetTaskClass;
...
@property(nonatomic) _Bool excludeIdentifierHeadersForAccount; // @synthesize excludeIdentifierHeadersForAccount=_excludeIdentifierHeadersForAccount;
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000050812e
- (id)init;	// IMP=0x000000000050807d
