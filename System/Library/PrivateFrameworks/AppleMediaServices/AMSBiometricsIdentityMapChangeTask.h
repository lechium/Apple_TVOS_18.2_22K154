...
- (void).cxx_destruct;	// IMP=0x0000000000311eb0
...
- (id)perform;	// IMP=0x00000000003113ae
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x00000000003112e4
