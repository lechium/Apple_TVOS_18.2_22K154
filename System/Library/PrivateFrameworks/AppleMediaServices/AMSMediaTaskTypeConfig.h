...
+ (id)configForType:(long long)arg1;	// IMP=0x0060000000402c5f
- (void).cxx_destruct;	// IMP=0x0000000000403451
...
- (id)initWithType:(long long)arg1 typeString:(id)arg2 hostBagKey:(id)arg3 realm:(id)arg4 includePlatform:(_Bool)arg5;	// IMP=0x0000000000402b94
