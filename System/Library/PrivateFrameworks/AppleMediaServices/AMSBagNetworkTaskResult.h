...
- (void).cxx_destruct;	// IMP=0x000000000030163c
...
- (id)initWithData:(id)arg1 expirationDate:(id)arg2 loadedBagIdentifier:(id)arg3 loadedBagPartialIdentifier:(id)arg4 storefront:(id)arg5 accountIdentifier:(id)arg6;	// IMP=0x00000000003012a6
