...
- (void)isDeviceInBiometricLockoutWithCompletion:(void (^)(_Bool))arg1;
- (void)hasKeysForAccount:(ACAccount *)arg1 forSignaturePurpose:(unsigned long long)arg2 completion:(void (^)(_Bool, NSError *))arg3;
