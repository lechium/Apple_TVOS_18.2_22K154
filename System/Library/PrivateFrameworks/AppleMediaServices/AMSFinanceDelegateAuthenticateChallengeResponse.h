...
+ (_Bool)isDelegateAuthChallengeForTaskInfo:(id)arg1;	// IMP=0x00100000003b42e7
- (void).cxx_destruct;	// IMP=0x00000000003b4617
...
- (id)performWithTaskInfo:(id)arg1;	// IMP=0x00000000003b44bd
- (id)initWithResponseDictionary:(id)arg1 taskInfo:(id)arg2;	// IMP=0x00000000003b424e
