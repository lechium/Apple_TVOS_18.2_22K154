...
- (void).cxx_destruct;	// IMP=0x00000000002fd131
...
- (id)createFrozenDataSource;	// IMP=0x00000000002fcde9
- (id)createFrozenBag;	// IMP=0x00000000002fcc73
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x00000000002fca62
