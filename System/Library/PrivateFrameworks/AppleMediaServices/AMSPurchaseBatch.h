...
- (void).cxx_destruct;	// IMP=0x000000000048dc26
...
- (id)nextPurchase;	// IMP=0x000000000048d9db
- (_Bool)finishPurchase:(id)arg1 withResult:(id)arg2;	// IMP=0x000000000048d68e
- (_Bool)finishPurchase:(id)arg1 withError:(id)arg2;	// IMP=0x000000000048d223
- (id)purchaseForPurchaseId:(id)arg1;	// IMP=0x000000000048d16b
- (id)initWithPurchases:(id)arg1 weakPromise:(id)arg2;	// IMP=0x000000000048cebd
