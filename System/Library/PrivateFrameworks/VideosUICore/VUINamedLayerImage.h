...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x001000000000740c
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0010000000007398
...
- (id)imageObj;	// IMP=0x00000000000077e1
...
- (id)_init;	// IMP=0x000000000000735d
- (id)init;	// IMP=0x000000000000734f
