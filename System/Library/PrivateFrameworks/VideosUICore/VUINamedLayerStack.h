...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x001000000000dcc6
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x001000000000d91d
...
- (id)_init;	// IMP=0x000000000000d8ee
- (id)init;	// IMP=0x000000000000d8e0
