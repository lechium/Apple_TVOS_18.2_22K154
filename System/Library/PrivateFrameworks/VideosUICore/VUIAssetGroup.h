...
+ (id)_humanReadableStringForGroupType:(long long)arg1;	// IMP=0x00600000000286df
- (void).cxx_destruct;	// IMP=0x0000000000028823
...
- (id)_manifestFilePath;	// IMP=0x00000000000286fe
- (void)_saveManifest;	// IMP=0x0000000000028580
- (void)_updateManifestWithChange:(CDUnknownBlockType)arg1;	// IMP=0x00000000000283a1
- (id)description;	// IMP=0x00000000000282c5
- (void)updateAssetsFromFiles;	// IMP=0x000000000002782b
- (void)_removeAssetInfoForKey:(id)arg1 removeFile:(_Bool)arg2;	// IMP=0x00000000000273a6
- (void)_removeAssetInfoForKey:(id)arg1;	// IMP=0x000000000002738f
- (id)infoForAllAssetsWithTags:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000026e0e
- (id)infoForAllAssetsWithQueue:(id)arg1;	// IMP=0x0000000000026c5b
- (void)removeAllAssetsWithQueue:(id)arg1;	// IMP=0x0000000000026a71
- (void)removeAssetInfoForKey:(id)arg1 queue:(id)arg2;	// IMP=0x000000000002696f
- (id)assetInfoForKey:(id)arg1 queue:(id)arg2;	// IMP=0x000000000002642c
- (void)setAssetInfo:(id)arg1 forKey:(id)arg2 queue:(id)arg3;	// IMP=0x0000000000025a23
- (id)initWithGroupType:(long long)arg1 baseCachePath:(id)arg2 folderName:(id)arg3 maxCacheSize:(unsigned long long)arg4 purgeOnLoad:(_Bool)arg5;	// IMP=0x000000000002569a
