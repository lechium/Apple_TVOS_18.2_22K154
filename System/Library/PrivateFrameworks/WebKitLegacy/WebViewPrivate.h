...
@interface WebViewPrivate : NSObject
{
    ...
    struct HashMap<unsigned long, WTF::RetainPtr<id>, WTF::DefaultHash<unsigned long>, WTF::HashTraits<unsigned long>, WTF::HashTraits<WTF::RetainPtr<id>>, WTF::HashTableTraits> identifierMap;	// 904 = 0x388
    _Bool _keyboardUIModeAccessed;	// 912 = 0x390
    int _keyboardUIMode;	// 916 = 0x394
    _Bool shouldUpdateWhileOffscreen;	// 920 = 0x398
    _Bool needsOneShotDrawingSynchronization;	// 921 = 0x399
    _Bool postsAcceleratedCompositingNotifications;	// 922 = 0x39a
    struct unique_ptr<WebViewRenderingUpdateScheduler, std::default_delete<WebViewRenderingUpdateScheduler>> renderingUpdateScheduler;	// 928 = 0x3a0
    struct CGSize lastLayoutSize;	// 936 = 0x3a8
    struct RetainPtr<WebVideoFullscreenController> fullscreenController;	// 952 = 0x3b8
    struct Vector<WTF::RetainPtr<WebVideoFullscreenController>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> fullscreenControllersExiting;	// 960 = 0x3c0
    struct RetainPtr<WebFullScreenController> newFullscreenController;	// 976 = 0x3d0
...
+ (void)initialize;	// IMP=0x0060000000130250
- (id).cxx_construct;	// IMP=0x00000000001307f0
- (void).cxx_destruct;	// IMP=0x0000000000130360
- (void)dealloc;	// IMP=0x0000000000130330
- (id)init;	// IMP=0x0000000000130260
