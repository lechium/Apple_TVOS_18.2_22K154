...
struct unique_ptr<WTF::Detail::CallableWrapperBase<void, WebCore::PolicyAction>, std::default_delete<WTF::Detail::CallableWrapperBase<void, WebCore::PolicyAction>>> {
    struct __compressed_pair<WTF::Detail::CallableWrapperBase<void, WebCore::PolicyAction>*, std::default_delete<WTF::Detail::CallableWrapperBase<void, WebCore::PolicyAction>>> {
        void *__value_;
    } __ptr_;
};
