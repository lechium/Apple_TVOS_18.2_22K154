...
- (void).cxx_destruct;	// IMP=0x00000000000262a3
...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x0000000000025e53
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x0000000000025d98
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000025bca
- (id)init;	// IMP=0x0000000000025b6d
