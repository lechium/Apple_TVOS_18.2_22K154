...
+ (id)invalidRegularExpressionIntentResponseWithErrorDescription:(id)arg1;	// IMP=0x0060000000337ba8
@property(nonatomic) long long code; // @synthesize code=_code;
- (id)initWithCode:(long long)arg1 userActivity:(id)arg2;	// IMP=0x0000000000337b0c
