...
- (void).cxx_destruct;	// IMP=0x000000000001f894
@property(retain, nonatomic) InterceptConfig *interceptConfig; // @synthesize interceptConfig=_interceptConfig;
- (void)forwardInvocation:(id)arg1;	// IMP=0x000000000001f7e8
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001f798
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000001f763
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x000000000001f70b
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x000000000001f6d8
- (id)newCommandQueue;	// IMP=0x000000000001f6aa
@property(retain, nonatomic) FigMetalExecutionStatus *executionStatus;
- (id)initWithLevel:(int)arg1;	// IMP=0x000000000001f43c
