...
- (void).cxx_destruct;	// IMP=0x000000000001b1ac
...
- (double)pruneIntervalInSeconds;	// IMP=0x000000000001af31
- (double)cacheExpiryInSeconds;	// IMP=0x000000000001ae3d
- (id)noLocationKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ad46
- (id)gridKeyForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x000000000001ac4f
- (void)pruneCacheIfNeeded;	// IMP=0x000000000001a5e8
- (void)flushCache;	// IMP=0x000000000001a38f
- (void)saveMetaData;	// IMP=0x0000000000019d77
- (void)readMetaData;	// IMP=0x0000000000019823
- (_Bool)pendingMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000019777
- (_Bool)pendingMapImageForRequest:(id)arg1;	// IMP=0x0000000000019439
- (void)cacheMapImage:(id)arg1 forLocation:(id)arg2 altitude:(double)arg3 pitch:(double)arg4 width:(double)arg5 andHeight:(double)arg6;	// IMP=0x0000000000019378
- (void)cacheMapImage:(id)arg1 forRequest:(id)arg2;	// IMP=0x0000000000018d02
- (id)cachedMapImageForLocation:(id)arg1 altitude:(double)arg2 pitch:(double)arg3 width:(double)arg4 andHeight:(double)arg5;	// IMP=0x0000000000018c48
- (id)cachedMapImageForRequest:(id)arg1;	// IMP=0x0000000000018ad1
- (void)cacheNoLocationImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x0000000000018664
- (id)cachedNoLocationImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000018507
- (void)cacheGridImage:(id)arg1 forWidth:(double)arg2 andHeight:(double)arg3;	// IMP=0x000000000001809a
- (id)cachedGridImageForWidth:(double)arg1 andHeight:(double)arg2;	// IMP=0x0000000000017f3d
- (id)init;	// IMP=0x0000000000017a2a
