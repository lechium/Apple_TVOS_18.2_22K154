...
+ (id)sharedNotifier;	// IMP=0x00400000000014c1
- (void).cxx_destruct;	// IMP=0x0000000000001c77
...
- (id)_newRemoteConnection;	// IMP=0x000000000000165e
- (id)_remoteConnection;	// IMP=0x0000000000001516
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x0000000000001217
