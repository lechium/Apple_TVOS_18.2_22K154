...
- (void).cxx_destruct;	// IMP=0x000000000003b269
- (void)dealloc;	// IMP=0x000000000003b176
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000003b0a3
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000003b092
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x000000000003afd1
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x000000000003af71
- (id)originalObject;	// IMP=0x000000000003af63
@property(readonly) id <MTLDepthStencilState> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x000000000003ae77
