...
- (void).cxx_destruct;	// IMP=0x000000000002d503
@property(readonly, nonatomic) struct GTResourceHarvester *harvester; // @synthesize harvester=_harvester;
- (CDStruct_4bcfbbae)heapTextureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x000000000002d379
- (id)newAccelerationStructureWithBuffer:(id)arg1 offset:(unsigned long long)arg2 resourceIndex:(unsigned long long)arg3;	// IMP=0x000000000002d139
- (id)newAccelerationStructureWithBuffer:(id)arg1 offset:(unsigned long long)arg2;	// IMP=0x000000000002cf12
- (id)newHeapWithDescriptor:(id)arg1;	// IMP=0x000000000002cbd1
- (id)newSamplerStateWithDescriptor:(id)arg1;	// IMP=0x000000000002c9ef
- (id)newDepthStencilStateWithDescriptor:(id)arg1;	// IMP=0x000000000002c845
- (void)reserveResourceIndicesForResourceType:(unsigned long long)arg1 indices:(unsigned long long *)arg2 indexCount:(unsigned long long)arg3;	// IMP=0x000000000002c82f
- (id)vendorName;	// IMP=0x000000000002c819
- (_Bool)validateDynamicLibraryURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002c803
- (_Bool)validateDynamicLibraryDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002c7ed
- (_Bool)validateDynamicLibrary:(id)arg1 state:(_Bool)arg2 error:(id *)arg3;	// IMP=0x000000000002c784
- (void)unmapShaderSampleBuffer;	// IMP=0x000000000002c6ab
- (void)unloadShaderCaches;	// IMP=0x000000000002c695
- (CDStruct_14f26992)tileSizeWithSparsePageSize:(long long)arg1 textureType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 sampleCount:(unsigned long long)arg4;	// IMP=0x000000000002c551
- (_Bool)supportsVertexAmplificationCount:(unsigned long long)arg1;	// IMP=0x000000000002c53b
- (_Bool)supportsTextureWriteRoundingMode:(long long)arg1;	// IMP=0x000000000002c525
- (_Bool)supportsTextureSampleCount:(unsigned long long)arg1;	// IMP=0x000000000002c41a
- (_Bool)supportsSampleCount:(unsigned long long)arg1;	// IMP=0x000000000002c30f
- (_Bool)supportsRasterizationRateMapWithLayerCount:(unsigned long long)arg1;	// IMP=0x000000000002c204
- (_Bool)supportsFeatureSet:(unsigned long long)arg1;	// IMP=0x000000000002c1ee
- (_Bool)supportsFamily:(long long)arg1;	// IMP=0x000000000002c1d8
- (_Bool)supportsCounterSampling:(unsigned long long)arg1;	// IMP=0x000000000002c1c2
- (void)startCollectingPipelineDescriptorsUsingPrefixForNames:(id)arg1;	// IMP=0x000000000002c1ac
- (void)startCollectingPipelineDescriptors;	// IMP=0x000000000002c196
- (CDStruct_14f26992)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3 sparsePageSize:(long long)arg4;	// IMP=0x000000000002c052
- (unsigned long long)sparseTileSizeInBytesForSparsePageSize:(long long)arg1;	// IMP=0x000000000002bf54
- (void)setupMPSFunctionTable:(struct MPSFunctionTable *)arg1;	// IMP=0x000000000002bf3e
- (void)setRawBVHBuilderPtr:(id)arg1;	// IMP=0x000000000002bf28
- (void)setIndirectArgumentBufferDecodingData:(id)arg1;	// IMP=0x000000000002bf12
@property(getter=areGPUAssertionsEnabled, setter=setGPUAssertionsEnabled:) _Bool gpuAssertionsEnabled;
- (id)serializeTileRenderPipelineDescriptor:(id)arg1;	// IMP=0x000000000002beb7
- (void)sampleTimestamps:(unsigned long long *)arg1 gpuTimestamp:(unsigned long long *)arg2;	// IMP=0x000000000002bea1
- (unsigned long long)resourcePatchingTypeForResourceType:(unsigned long long)arg1;	// IMP=0x000000000002be8b
- (_Bool)reserveGPUAddressRange:(struct _NSRange)arg1;	// IMP=0x000000000002be75
- (id)productName;	// IMP=0x000000000002be5f
- (CDStruct_c0454aff)pipelineCacheStats;	// IMP=0x000000000002be49
- (id)newVisibleFunctionTableWithDescriptor:(id)arg1;	// IMP=0x000000000002bdfa
- (id)newTileRenderPipelineDescriptorWithSerializedData:(id)arg1 deserializationContext:(id)arg2;	// IMP=0x000000000002bd7c
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3 slice:(unsigned long long)arg4;	// IMP=0x000000000002bc9f
- (id)newTextureWithDescriptor:(id)arg1 iosurface:(struct __IOSurface *)arg2 plane:(unsigned long long)arg3;	// IMP=0x000000000002ba55
- (id)newTextureWithDescriptor:(id)arg1;	// IMP=0x000000000002b845
- (id)newTextureWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 descriptor:(id)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x000000000002b5ae
- (id)newTextureLayoutWithDescriptor:(id)arg1 isHeapOrBufferBacked:(_Bool)arg2;	// IMP=0x000000000002b3c5
- (id)newResidencySetWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002b1d9
- (id)newProfileWithExecutionSize:(unsigned long long)arg1;	// IMP=0x000000000002b035
- (id)newLogStateWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002af9b
- (id)newLibraryWithStitchedDescriptorSPI:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002ad69
- (id)newLibraryWithDescriptorSPI:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002ab37
- (id)newLibraryWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002a905
- (id)newLibraryWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002a6df
- (id)newLateEvalEvent;	// IMP=0x000000000002a54f
- (id)newIndirectRenderCommandEncoderWithBuffer:(id)arg1;	// IMP=0x000000000002a4f8
- (id)newIndirectComputeCommandEncoderWithBuffer:(id)arg1;	// IMP=0x000000000002a4a1
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x000000000002a291
- (id)newIndirectCommandBufferWithDescriptor:(id)arg1 maxCommandCount:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x000000000002a05c
- (id)newIndirectArgumentEncoderWithLayout:(id)arg1;	// IMP=0x000000000002a046
- (id)newIndirectArgumentEncoderWithArguments:(id)arg1;	// IMP=0x000000000002a030
- (id)newIndirectArgumentBufferLayoutWithStructType:(id)arg1;	// IMP=0x000000000002a01a
- (id)newFence;	// IMP=0x0000000000029e8a
- (id)newEvent;	// IMP=0x0000000000029cfa
- (id)newDynamicLibraryWithURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000029add
- (id)newDynamicLibraryWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000298cf
- (id)newDynamicLibraryWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000029871
- (id)newDynamicLibraryFromURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000297d8
- (id)newDynamicLibrary:(id)arg1 computeDescriptor:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000296d1
- (id)newDagStringWithGraphs:(id)arg1;	// IMP=0x00000000000296bb
- (id)newCommandQueueWithMaxCommandBufferCount:(unsigned long long)arg1;	// IMP=0x0000000000029518
- (id)newCommandQueueWithDescriptor:(id)arg1;	// IMP=0x0000000000029329
- (id)newCommandQueue;	// IMP=0x0000000000029199
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 gpuAddress:(unsigned long long)arg3;	// IMP=0x0000000000028fd0
- (id)newBufferWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000028e09
- (id)newBufferWithIOSurface:(struct __IOSurface *)arg1;	// IMP=0x0000000000028c45
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 gpuAddress:(unsigned long long)arg4 deallocator:(CDUnknownBlockType)arg5;	// IMP=0x0000000000028bd8
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 gpuAddress:(unsigned long long)arg4;	// IMP=0x00000000000289cf
- (id)newBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3;	// IMP=0x00000000000287e6
- (id)newBinaryLibraryWithOptions:(unsigned long long)arg1 url:(id)arg2 error:(id *)arg3;	// IMP=0x000000000002873e
- (id)newBinaryArchiveWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000028565
- (id)newArgumentEncoderWithLayout:(id)arg1;	// IMP=0x0000000000028507
- (id)newAccelerationStructureWithSize:(unsigned long long)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000002831e
- (id)newAccelerationStructureWithSize:(unsigned long long)arg1 resourceIndex:(unsigned long long)arg2;	// IMP=0x000000000002815c
- (id)newAccelerationStructureWithSize:(unsigned long long)arg1;	// IMP=0x0000000000027fad
- (id)newAccelerationStructureWithDescriptor:(id)arg1;	// IMP=0x0000000000027dae
- (unsigned long long)minimumTextureBufferAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000027d98
- (unsigned long long)minimumLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000027d82
- (unsigned long long)minLinearTextureAlignmentForPixelFormat:(unsigned long long)arg1;	// IMP=0x0000000000027c84
- (_Bool)mapShaderSampleBufferWithBuffer:(CDStruct_32a7f38a *)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3;	// IMP=0x0000000000027c6e
- (CDStruct_c0454aff)libraryCacheStats;	// IMP=0x0000000000027c58
- (_Bool)isVendorSliceCompatibleWithDeploymentTarget:(unsigned int)arg1 platform:(unsigned int)arg2 sdkVersion:(unsigned int)arg3 compilerPluginVersion:(unsigned int)arg4;	// IMP=0x0000000000027c42
- (_Bool)isCompatibleWithAccelerationStructure:(CDStruct_c0454aff)arg1;	// IMP=0x0000000000027c2c
- (id)indirectArgumentBufferDecodingData;	// IMP=0x0000000000027c16
- (CDStruct_4bcfbbae)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000027af9
- (CDStruct_4bcfbbae)heapAccelerationStructureSizeAndAlignWithSize:(unsigned long long)arg1;	// IMP=0x0000000000027ae3
- (CDStruct_4bcfbbae)heapAccelerationStructureSizeAndAlignWithDescriptor:(id)arg1;	// IMP=0x0000000000027a8f
- (void *)getShaderCacheKeys;	// IMP=0x0000000000027a79
- (id)getRawBVHBuilderPtr;	// IMP=0x0000000000027a63
- (void)getDefaultSamplePositions:(CDStruct_b2fbf00d *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000027a4d
- (struct os_unfair_lock_s *)getBVHBuilderLock;	// IMP=0x0000000000027a37
- (id)familyName;	// IMP=0x0000000000027a21
- (id)endCollectingPipelineDescriptors;	// IMP=0x0000000000027a0b
- (_Bool)deviceSupportsFeatureSet:(unsigned long long)arg1;	// IMP=0x00000000000279f5
- (_Bool)deviceOrFeatureProfileSupportsFeatureSet:(unsigned long long)arg1;	// IMP=0x00000000000279df
- (id)deserializePrimitiveAccelerationStructureFromBytes:(void *)arg1 withDescriptor:(id)arg2;	// IMP=0x0000000000027952
- (id)deserializeInstanceAccelerationStructureFromBytes:(void *)arg1 primitiveAccelerationStructures:(id)arg2 withDescriptor:(id)arg3;	// IMP=0x000000000002787b
- (void)deserializeCompileTimeStats:(id)arg1 addToDictionary:(id)arg2;	// IMP=0x0000000000027865
- (_Bool)copyShaderCacheToPath:(id)arg1;	// IMP=0x00000000000276d6
- (void)convertSparseTileRegions:(const CDStruct_4c83c94d *)arg1 toPixelRegions:(CDStruct_4c83c94d *)arg2 withTileSize:(CDStruct_14f26992)arg3 numRegions:(unsigned long long)arg4;	// IMP=0x00000000000276c0
- (void)convertSparsePixelRegions:(const CDStruct_4c83c94d *)arg1 toTileRegions:(CDStruct_4c83c94d *)arg2 withTileSize:(CDStruct_14f26992)arg3 alignmentMode:(unsigned long long)arg4 numRegions:(unsigned long long)arg5;	// IMP=0x00000000000276aa
- (void)compilerPropagatesThreadPriority:(_Bool)arg1;	// IMP=0x0000000000027694
- (void)compileVisibleFunction:(id)arg1 withDescriptor:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000275d0
- (CDStruct_14f26992)accelerationStructureSizesWithDescriptor:(id)arg1;	// IMP=0x000000000002756b
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000268b8
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x0000000000026858
- (id)originalObject;	// IMP=0x000000000002684a
- (id)newArgumentEncoderWithBufferBinding:(id)arg1;	// IMP=0x0000000000026693
- (id)newSharedEventWithOptions:(long long)arg1;	// IMP=0x0000000000026611
- (id)newEventWithOptions:(long long)arg1;	// IMP=0x000000000002658f
- (void)deserializeInstanceAccelerationStructure:(id)arg1 fromBytes:(const void *)arg2 primitiveAccelerationStructures:(id)arg3 withDescriptor:(id)arg4;	// IMP=0x0000000000026312
- (void)deserializePrimitiveAccelerationStructure:(id)arg1 fromBytes:(const void *)arg2 withDescriptor:(id)arg3;	// IMP=0x00000000000260e6
- (void)compileVisibleFunction:(id)arg1 withDescriptor:(id)arg2 destinationBinaryArchive:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000025e68
- (void)newLibraryWithStitchedDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000025d51
- (id)newLibraryWithStitchedDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000025afb
- (void)newLibraryWithDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000259e4
- (id)newDynamicLibrary:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000257ba
- (id)newBufferWithDescriptor:(id)arg1;	// IMP=0x0000000000025583
...
- (id)newIntersectionFunctionTableWithDescriptor:(id)arg1;	// IMP=0x00000000000254c0
- (id)loadDynamicLibrariesForFunction:(id)arg1 insertLibraries:(id)arg2 options:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x00000000000252dd
- (id)loadDynamicLibrariesForFunction:(id)arg1 insertLibraries:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000025106
- (id)loadDynamicLibrariesForComputeDescriptor:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000024f6e
- (id)loadDynamicLibrariesForComputeDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000024ddc
- (id)newLibraryWithDAG:(id)arg1 functions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000024af9
- (id)newBufferWithBytesNoCopy:(void *)arg1 length:(unsigned long long)arg2 options:(unsigned long long)arg3 deallocator:(CDUnknownBlockType)arg4;	// IMP=0x0000000000024891
@property(readonly) unsigned long long sparseTileSizeInBytes;
- (CDStruct_14f26992)sparseTileSizeWithTextureType:(unsigned long long)arg1 pixelFormat:(unsigned long long)arg2 sampleCount:(unsigned long long)arg3;	// IMP=0x0000000000024739
- (id)newRasterizationRateMapWithDescriptor:(id)arg1;	// IMP=0x000000000002456d
- (id)newFunctionWithGLIR:(void *)arg1 inputsDescription:(id)arg2 functionType:(unsigned long long)arg3;	// IMP=0x0000000000024349
- (id)newFunctionWithGLIR:(void *)arg1 functionType:(unsigned long long)arg2;	// IMP=0x000000000002419b
- (id)newFunctionWithGLESIR:(void *)arg1 inputsDescription:(id)arg2 functionType:(unsigned long long)arg3;	// IMP=0x0000000000023f77
- (id)newFunctionWithGLESIR:(void *)arg1 functionType:(unsigned long long)arg2;	// IMP=0x0000000000023dc9
- (id)newFunctionWithGLCoreIR:(void *)arg1 inputsDescription:(id)arg2 functionType:(unsigned long long)arg3;	// IMP=0x0000000000023ba5
- (id)newFunctionWithGLCoreIR:(void *)arg1 functionType:(unsigned long long)arg2;	// IMP=0x00000000000239f7
...
- (id)newPipelineLibraryWithFilePath:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000023671
- (void)_setDeviceWrapper:(id)arg1;	// IMP=0x000000000002366b
- (id)_deviceWrapper;	// IMP=0x0000000000023662
- (id)newResourceGroupFromResources:(const id *)arg1 count:(unsigned long long)arg2;	// IMP=0x0000000000023401
- (id)newCounterSampleBufferWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000023215
- (_Bool)supportsPrimitiveType:(unsigned long long)arg1;	// IMP=0x00000000000230f7
- (id)newDefaultLibraryWithBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000022e1a
- (id)newDefaultLibrary;	// IMP=0x0000000000022b70
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000022771
- (void)newRenderPipelineStateWithTileDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000022632
- (id)newRenderPipelineStateWithTileDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002237e
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000022203
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000021df2
- (void)newRenderPipelineStateWithMeshDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000021c84
- (id)newRenderPipelineStateWithMeshDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002199f
- (id)newRenderPipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000021525
- (id)newRenderPipelineStateWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000211e1
- (id)newComputePipelineStateWithFunction:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000020e05
- (id)newComputePipelineStateWithFunction:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000020b6d
- (id)newComputePipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x0000000000020749
- (id)newComputePipelineStateWithDescriptor:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002042e
- (void)newComputePipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000002028d
- (void)newComputePipelineStateWithFunction:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000002014c
- (void)newComputePipelineStateWithFunction:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000002001a
- (void)newRenderPipelineStateWithDescriptor:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001fe9f
- (void)newRenderPipelineStateWithDescriptor:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001fd31
- (id)newLibraryWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001fa9a
- (void)newLibraryWithSource:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001f937
- (id)newLibraryWithSource:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001f61c
- (id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001f332
- (id)newLibraryWithFile:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001f092
- (id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001ee27
- (id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001ebbc
- (id)newSharedEventWithMachPort:(unsigned int)arg1;	// IMP=0x000000000001e918
- (id)newSharedEventWithHandle:(id)arg1;	// IMP=0x000000000001e71a
- (id)newSharedEvent;	// IMP=0x000000000001e54a
- (id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const CDStruct_dbc1e4aa *)arg2 error:(id *)arg3;	// IMP=0x000000000001e23d
- (id)newArgumentEncoderWithArguments:(id)arg1;	// IMP=0x000000000001e088
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000001df2d
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x000000000001ddcd
- (void)dealloc;	// IMP=0x000000000001dcc2
@property(readonly, nonatomic) MTLSharedEventListener *captureEventListener;
- (_Bool)captureRaytracingEnabled;	// IMP=0x000000000001dca5
- (_Bool)bufferPinningEnabled;	// IMP=0x000000000001dc99
- (void)purgeDeallocatedObjects;	// IMP=0x000000000001dc60
- (void)deallocateResource:(id)arg1;	// IMP=0x000000000001dad3
- (void)invalidateHarvester;	// IMP=0x000000000001da71
- (_Bool)newCaptureSamplerState:(out id *)arg1 associatedWithBaseSamplerState:(id)arg2;	// IMP=0x000000000001d99a
- (_Bool)newCaptureDepthStencilState:(out id *)arg1 associatedWithBaseDepthStencilState:(id)arg2;	// IMP=0x000000000001d8c3
- (_Bool)newCaptureFunction:(out id *)arg1 associatedWithBaseFunction:(id)arg2 captureLibrary:(id)arg3;	// IMP=0x000000000001d7d2
- (id)initWithBaseObject:(id)arg1 captureContext:(struct GTTraceContext *)arg2;	// IMP=0x000000000001d3cb
...
- (id)dummyEncodeIntersectionFunctionTableIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001d122
- (id)dummyEncodeVisibleFunctionTableIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001cfa2
- (id)dummyEncodeComputePSOIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001ce0b
- (id)dummyEncodeRenderPSOIntoArgumentBufferForResourceIndex:(id)arg1 withMeshDescriptor:(id)arg2;	// IMP=0x000000000001cc8a
- (id)dummyEncodeRenderPSOIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001cb09
- (id)dummyEncodeICBIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001c991
- (id)dummyEncodeSamplerIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001c819
- (id)dummyEncodeTextureIntoArgumentBufferForResourceIndex:(id)arg1 withDescriptor:(id)arg2;	// IMP=0x000000000001c6b5
- (void)_initDummyEncoder;	// IMP=0x000000000001c21f
- (id)dummyArgumentEncoder;	// IMP=0x000000000001c1b7
- (void)_initArgumentBufferPatchingTypes;	// IMP=0x000000000001c12d
