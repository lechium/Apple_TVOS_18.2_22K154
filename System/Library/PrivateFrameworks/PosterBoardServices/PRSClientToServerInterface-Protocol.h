...
@class NSArray, NSData, NSNumber, NSString, NSURL, NSUUID, PFServerPosterPath, PRSActivePosterConfiguration, PRSDataStoreArchiveConfiguration, PRSHostConfiguration, PRSMigrationDescriptor, PRSPosterConfiguration, PRSPosterGalleryLayout, PRSPosterSnapshotCollection, PRSPosterSnapshotRequest, PRSPosterUpdateSessionInfo;
...
- (oneway void)runMigration:(NSNumber *)arg1 migrationDescriptor:(PRSMigrationDescriptor *)arg2 completion:(void (^)(NSError *))arg3;
...
- (oneway void)retrieveGallery:(void (^)(PRSPosterGalleryLayout *, NSDate *, NSError *))arg1;
- (oneway void)fetchGallery:(void (^)(PRSPosterGalleryLayout *, NSDate *, NSError *))arg1;
- (oneway void)pushPosterGalleryUpdate:(PRSPosterGalleryLayout *)arg1 completion:(void (^)(NSError *))arg2;
...
- (oneway void)fetchFocusUUIDForConfiguration:(PFServerPosterPath *)arg1 completion:(void (^)(NSUUID *, NSError *))arg2;
- (oneway void)fetchPosterConfigurationsForExtension:(NSString *)arg1 completion:(void (^)(NSArray<__PFServerPosterPath__> *, NSError *))arg2;
- (oneway void)fetchPosterConfigurationsForRole:(NSString *)arg1 completion:(void (^)(NSArray<__PFServerPosterPath__> *, NSError *))arg2;
...
- (oneway void)fetchActivePosterForRole:(NSString *)arg1 completion:(void (^)(PFServerPosterPath *, PFServerPosterPath *, NSError *))arg2;
- (oneway void)fetchSelectedPosterForRole:(NSString *)arg1 completion:(void (^)(PFServerPosterPath *, NSError *))arg2;
...
- (oneway void)notePosterConfigurationUnderlyingModelDidChange:(NSUUID *)arg1;
- (oneway void)updatePosterConfiguration:(PRSPosterConfiguration *)arg1 updates:(NSArray<__PRSPosterUpdate__> *)arg2 completion:(void (^)(PFServerPosterPath *, NSArray<__PRSPosterUpdateResult__> *, NSError *))arg3;
- (oneway void)updatePosterConfigurationMatchingUUID:(NSUUID *)arg1 updates:(NSArray<__PRSPosterUpdate__> *)arg2 completion:(void (^)(PFServerPosterPath *, NSArray<__PRSPosterUpdateResult__> *, NSError *))arg3;
- (oneway void)fetchAssociatedHomeScreenPosterConfigurationUUID:(NSUUID *)arg1 completion:(void (^)(PFServerPosterPath *, NSError *))arg2;
- (oneway void)refreshSnapshotForPosterConfigurationMatchUUID:(NSUUID *)arg1 completion:(void (^)(NSError *))arg2;
- (oneway void)importPosterConfigurationFromArchiveData:(NSData *)arg1 completion:(void (^)(PFServerPosterPath *, NSError *))arg2;
...
- (oneway void)refreshPosterConfigurationMatchingUUID:(NSUUID *)arg1 sessionInfo:(PRSPosterUpdateSessionInfo *)arg2 completion:(void (^)(PFServerPosterPath *, NSError *))arg3;
- (oneway void)createPosterConfigurationForProviderIdentifier:(NSString *)arg1 posterDescriptorIdentifier:(NSString *)arg2 role:(NSString *)arg3 completion:(void (^)(PFServerPosterPath *, NSError *))arg4;
- (oneway void)unignoreExtension:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (oneway void)ignoreExtension:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (oneway void)deletePosterDescriptorsForExtension:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (oneway void)refreshPosterDescriptorsForExtension:(NSString *)arg1 sessionInfo:(PRSPosterUpdateSessionInfo *)arg2 completion:(void (^)(NSArray<__PFServerPosterPath__> *, NSError *))arg3;
- (oneway void)fetchStaticPosterDescriptorsForExtension:(NSString *)arg1 completion:(void (^)(NSArray<__PFServerPosterPath__> *, NSError *))arg2;
- (oneway void)fetchPosterDescriptorsForExtension:(NSString *)arg1 completion:(void (^)(NSArray<__PFServerPosterPath__> *, NSError *))arg2;
...
- (oneway void)deleteHostConfigurationForRole:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (oneway void)setHostConfiguration:(PRSHostConfiguration *)arg1 forRole:(NSString *)arg2 completion:(void (^)(NSError *))arg3;
@end
