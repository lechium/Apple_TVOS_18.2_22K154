...
- (id)nextObject;	// IMP=0x0000000000005bbb
- (id)allObjects;	// IMP=0x0000000000005ac6
- (id)initWithFlatPlist:(id)arg1 offset:(unsigned long long)arg2 count:(unsigned long long)arg3;	// IMP=0x0000000000005a21
