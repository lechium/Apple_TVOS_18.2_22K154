...
- (void).cxx_destruct;	// IMP=0x000000000001de38
...
- (void)_preparePlayerItem;	// IMP=0x000000000001d223
- (void)_handleValuesDidLoad;	// IMP=0x000000000001d1be
- (void)main;	// IMP=0x000000000001d0ed
- (id)initWithAsset:(id)arg1 trimmedTimeRange:(CDStruct_e83c9415)arg2 photoTime:(CDStruct_1b6d18a9)arg3 includeAudio:(_Bool)arg4 includeVideo:(_Bool)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000001cfa4
