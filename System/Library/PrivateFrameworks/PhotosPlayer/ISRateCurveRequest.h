...
- (void).cxx_destruct;	// IMP=0x0000000000002b43
...
- (void)_stopObservingPlayer;	// IMP=0x0000000000002a8e
- (void)dealloc;	// IMP=0x0000000000002a50
- (void)cancel;	// IMP=0x0000000000002a3a
- (void)_didReachTargetTime;	// IMP=0x00000000000028a5
- (void)_stepDownRate;	// IMP=0x000000000000260a
- (void)start;	// IMP=0x0000000000002349
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000002271
