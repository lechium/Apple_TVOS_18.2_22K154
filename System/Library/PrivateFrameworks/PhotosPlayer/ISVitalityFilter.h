...
- (void)inputDidChange;	// IMP=0x00000000000259cf
- (void)_invalidateOutput;	// IMP=0x00000000000259b8
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000258e2
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x000000000002584f
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000000257e4
