...
- (void)_showVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d5dc
- (void)_transitionToVideoWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d557
- (void)_startPlaybackWithPlaybackID:(long long)arg1;	// IMP=0x000000000000d4f8
- (void)_didFinishPreparing;	// IMP=0x000000000000d4a6
- (void)_handleDidFinishPreroll;	// IMP=0x000000000000d494
- (void)_prerollWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000000d3b3
- (void)_handleDidSeekToBeginning;	// IMP=0x000000000000d30f
- (void)_prepareVideoForPlaybackIfNeeded;	// IMP=0x000000000000d0d9
- (void)startPlayback;	// IMP=0x000000000000d04e
- (void)activeDidChange;	// IMP=0x000000000000cfce
- (void)videoDidPlayToEnd;	// IMP=0x000000000000cf8a
- (void)_handleDidFinish;	// IMP=0x000000000000cf1b
- (void)videoWillPlayToEnd;	// IMP=0x000000000000cd9a
- (long long)behaviorType;	// IMP=0x000000000000cd8f
@property(nonatomic) __weak id <ISLivePhotoPlaybackBehaviorDelegate> delegate; // @dynamic delegate;
- (id)initWithInitialLayoutInfo:(id)arg1 keyTime:(CDStruct_1b6d18a9)arg2 playbackTimeRange:(CDStruct_e83c9415)arg3 photoTransitionDuration:(double)arg4 immediatelyShowsPhotoWhenPlaybackEnds:(_Bool)arg5 hasBlurryTransition:(_Bool)arg6;	// IMP=0x000000000000cc53
