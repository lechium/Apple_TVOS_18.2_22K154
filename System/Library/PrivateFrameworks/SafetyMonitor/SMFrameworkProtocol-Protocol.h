...
@class NSDate, NSError, NSUUID, SMCache, SMLocalSessionState, SMReceiverSessionStatus, SMSessionManagerState;
...
- (void)onLocalSessionStateChanged:(SMLocalSessionState *)arg1 withError:(NSError *)arg2;
