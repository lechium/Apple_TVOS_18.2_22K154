...
- (void).cxx_destruct;	// IMP=0x0000000000069a8a
...
- (void)updateWithSectionedChangeDetails:(id)arg1;	// IMP=0x000000000006926b
- (void)addSubitemEntry:(id)arg1;	// IMP=0x0000000000069211
- (id)initWithIndex:(long long)arg1 changeDetails:(id)arg2;	// IMP=0x0000000000069193
