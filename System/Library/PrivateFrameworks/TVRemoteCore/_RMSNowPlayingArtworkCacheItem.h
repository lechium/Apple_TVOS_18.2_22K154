...
- (void).cxx_destruct;	// IMP=0x000000000001a108
...
- (_Bool)isContentDiscarded;	// IMP=0x000000000001a0c4
- (void)discardContentIfPossible;	// IMP=0x000000000001a0a2
- (void)endContentAccess;	// IMP=0x000000000001a098
- (_Bool)beginContentAccess;	// IMP=0x000000000001a07f
