...
- (void).cxx_destruct;	// IMP=0x000000000000f23f
...
- (void)invalidate;	// IMP=0x000000000000f171
- (void)performObserverBlock;	// IMP=0x000000000000f118
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000eecd
