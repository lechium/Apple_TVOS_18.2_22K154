...
- (id)computeCaptionForImageWithInputs:(id)arg1 genderOption:(int)arg2;	// IMP=0x0000000000086a49
- (void)extractBeamID:(id *)arg1 tokenID:(id *)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 fromFollowup:(id)arg5;	// IMP=0x0000000000086825
- (id)packBeamID:(id)arg1 tokenID:(id)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 softmax:(CDStruct_0a65202a *)arg5;	// IMP=0x0000000000086561
- (void)dealloc;	// IMP=0x00000000000864cb
- (id)initWithOptions:(id)arg1 runTimeParams:(id)arg2;	// IMP=0x00000000000858dc
