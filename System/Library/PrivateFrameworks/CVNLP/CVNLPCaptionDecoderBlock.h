...
- (id).cxx_construct;	// IMP=0x000000000007315c
- (void).cxx_destruct;	// IMP=0x00000000000730b7
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000072663
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000724c7
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000722d7
- (void)copyOutputState:(id)arg1;	// IMP=0x0000000000071e71
- (void)copyInputState:(id)arg1;	// IMP=0x0000000000071a74
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x000000000006f08e
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x000000000006e043
- (void)dealloc;	// IMP=0x000000000006df45
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x000000000006dd2e
