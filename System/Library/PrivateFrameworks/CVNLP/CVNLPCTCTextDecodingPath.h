...
+ (id)_getQueue;	// IMP=0x006000000006b7a3
+ (void)applyWordLanguageModelProbabilityToPath:(id)arg1 stemmedFromPath:(id)arg2 isCommittingToken:(_Bool)arg3;	// IMP=0x006000000006a64e
- (id).cxx_construct;	// IMP=0x000000000006ba05
- (void).cxx_destruct;	// IMP=0x000000000006b906
...
- (float)_wordLanguageModelLogProbabilityForString:(id)arg1 originalWordRanges:(id)arg2 originalWordIDs:(vector_3b74075b)arg3 wordRanges:(id)arg4 wordIDs:(vector_3b74075b)arg5;	// IMP=0x000000000006af82
- (void)_updateLexiconLogProbabilityForString:(id)arg1 stemmingFromPath:(id)arg2;	// IMP=0x0000000000069cb8
- (void)_updateCharacterLanguageModelLogProbabilityForString:(id)arg1 stemmingFromPath:(id)arg2 normalizedCodepoint:(unsigned int)arg3;	// IMP=0x0000000000069a5d
- (id)pathByExtendingWithString:(id)arg1 extendedPathString:(id)arg2 blankLogProb:(double)arg3 nonBlankLogProb:(double)arg4 timestep:(long long)arg5 commitAction:(long long)arg6 symbolLogProb:(double)arg7;	// IMP=0x000000000006934e
- (id)childPathWithBlankLogProb:(double)arg1;	// IMP=0x0000000000068f38
- (void)updateLastTokenWithMaxActivation:(long long)arg1 totalLogProbability:(double)arg2 tokenBoundaryLogProbability:(double)arg3;	// IMP=0x0000000000068ef7
- (void)merge:(id)arg1 logProbCumulator:(CDUnknownBlockType)arg2;	// IMP=0x0000000000068c9d
- (long long)compare:(id)arg1;	// IMP=0x0000000000068c42
- (id)debugDescription;	// IMP=0x0000000000068b0f
- (id)description;	// IMP=0x00000000000689e6
- (id)tokensWithTimestep:(long long)arg1 isFinalTimestep:(_Bool)arg2;	// IMP=0x00000000000684a1
- (void)commitTokenAtTimestep:(long long)arg1 currentSymbolLogProbability:(double)arg2 commitAction:(long long)arg3 string:(id)arg4 stemmingFromPath:(id)arg5;	// IMP=0x0000000000067dc6
- (unsigned long long)_currentTokenStringLength;	// IMP=0x0000000000067d33
...
- (double)scoreForTokenIndex:(long long)arg1;	// IMP=0x0000000000067c5c
@property double lastTokenBoundaryLogProbability;
- (_Bool)hasProblematicMixedScriptWords;	// IMP=0x0000000000067be8
- (double)lexiconScore;	// IMP=0x0000000000067bca
@property(readonly) double normalizedTotalLogProbability;
- (double)modelLogProbability;	// IMP=0x0000000000067b2b
- (long long)tokenCount;	// IMP=0x0000000000067b11
- (long long)pseudoSpaceCount;	// IMP=0x0000000000067b07
- (long long)characterCount;	// IMP=0x0000000000067afd
- (void)setPseudoSpaceCount:(long long)arg1;	// IMP=0x0000000000067a9a
- (void)setCharacterCount:(long long)arg1;	// IMP=0x0000000000067a90
- (void)setWordLanguageModelLogProbability:(double)arg1;	// IMP=0x0000000000067a85
- (void)setCharacterLanguageModelLogProbability:(double)arg1;	// IMP=0x0000000000067a7a
- (void)dealloc;	// IMP=0x00000000000679f7
- (id)initWithLanguageResourceBundle:(id)arg1 scoringFunction:(CDUnknownBlockType)arg2 initialCharacterLMState:(struct CVNLPLanguageModelWithState *)arg3 characterTokenIDs:(vector_3b74075b)arg4 wordTokenIDs:(vector_3b74075b)arg5 optimizingAlignment:(_Bool)arg6 hasContext:(_Bool)arg7;	// IMP=0x0000000000067818
