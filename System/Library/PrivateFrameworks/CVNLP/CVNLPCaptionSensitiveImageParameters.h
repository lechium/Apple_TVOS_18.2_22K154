...
- (void).cxx_destruct;	// IMP=0x000000000004832d
...
- (id)initWithVisionIdentifier:(id)arg1 minConfidence:(double)arg2 commonBlockingTokens:(id)arg3 categoryBlockingTokens:(id)arg4 categoryBlockingTokensAnnex:(id)arg5;	// IMP=0x0000000000048186
