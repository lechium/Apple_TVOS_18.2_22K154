...
- (void).cxx_destruct;	// IMP=0x000000000001d711
...
- (void)_observableAtIndex:(unsigned long long)arg1 didFailWithError:(id)arg2 observer:(id)arg3;	// IMP=0x000000000001d592
- (void)_observableAtIndex:(unsigned long long)arg1 didCompleteForObserver:(id)arg2;	// IMP=0x000000000001d4c6
- (void)_observableAtIndex:(unsigned long long)arg1 receivedResult:(id)arg2 observer:(id)arg3;	// IMP=0x000000000001d3d9
- (id)subscribe:(id)arg1;	// IMP=0x000000000001cfac
- (id)initWithObservables:(id)arg1;	// IMP=0x000000000001cd79
