...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000080b3
- (void).cxx_destruct;	// IMP=0x00000000000082e1
...
- (id)description;	// IMP=0x00000000000081fd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000008166
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000080bb
