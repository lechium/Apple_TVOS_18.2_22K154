...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000d61a
- (void).cxx_destruct;	// IMP=0x000000000000d891
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000d797
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000d677
- (id)init;	// IMP=0x000000000000d622
