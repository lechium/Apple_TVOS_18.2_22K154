...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000002b7d
- (void).cxx_destruct;	// IMP=0x0000000000002df5
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002c1e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002b85
