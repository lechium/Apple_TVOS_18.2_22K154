...
- (void).cxx_destruct;	// IMP=0x0000000000026719
@property unsigned long long dispatcherId; // @synthesize dispatcherId;
- (void)dispatchMessage:(id)arg1 replyConnection:(id)arg2;	// IMP=0x0000000000026442
- (id)initWithCallback:(CDUnknownBlockType)arg1 bulkDataProxy:(id)arg2 andToken:(id)arg3;	// IMP=0x000000000002635d
