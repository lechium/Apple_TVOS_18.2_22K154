...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000342cb
...
- (id)description;	// IMP=0x000000000003440a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000034380
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000342d3
