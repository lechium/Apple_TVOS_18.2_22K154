...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000215dd
- (void).cxx_destruct;	// IMP=0x0000000000021d4f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000021c56
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000216b9
- (id)init;	// IMP=0x00000000000215e5
