...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cb19
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cc74
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cb87
- (id)init;	// IMP=0x000000000000cb21
