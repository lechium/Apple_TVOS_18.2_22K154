...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000703e
- (void).cxx_destruct;	// IMP=0x000000000000725b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000711f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007046
