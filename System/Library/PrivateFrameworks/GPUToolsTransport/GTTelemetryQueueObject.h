...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000034674
...
- (id)description;	// IMP=0x00000000000347cd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000034748
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003467c
