...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000007bb3
- (void).cxx_destruct;	// IMP=0x0000000000007dd7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000007cb6
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007bbb
