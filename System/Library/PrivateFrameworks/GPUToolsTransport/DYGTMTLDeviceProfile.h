...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002f29b
- (void).cxx_destruct;	// IMP=0x000000000002f5bf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002f486
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002f2a3
