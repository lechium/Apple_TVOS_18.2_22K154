...
- (void).cxx_destruct;	// IMP=0x000000000000d5f2
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000d500
- (id)initWithRequestID:(unsigned long long)arg1;	// IMP=0x000000000000d4c3
- (id)init;	// IMP=0x000000000000d464
