...
- (void).cxx_destruct;	// IMP=0x000000000000376b
...
- (id)description;	// IMP=0x000000000000369a
- (void)expire;	// IMP=0x0000000000003680
- (void)extendExpirationDate;	// IMP=0x0000000000003610
