...
- (void).cxx_destruct;	// IMP=0x000000000004578f
...
- (void)reachabilityRequest:(id)arg1 updatedWithResult:(id)arg2;	// IMP=0x00000000000455c1
- (void)_deferSendingCurrentResultIfNeeded;	// IMP=0x000000000004544d
- (void)_sendCurrentResult;	// IMP=0x00000000000450a6
- (id)initWithRequestID:(id)arg1 pushToken:(id)arg2 fromIdentifier:(id)arg3 toIdentifier:(id)arg4;	// IMP=0x0000000000044fbe
