...
- (void).cxx_destruct;	// IMP=0x0000000000078d6b
...
- (void)enumerateResponseHandlersWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000078aea
- (id)createIncompleteFinalResult;	// IMP=0x000000000007899d
@property(readonly, nonatomic) NSString *requestID;
- (id)initWithRequest:(id)arg1 responseHandler:(id)arg2;	// IMP=0x000000000007884b
