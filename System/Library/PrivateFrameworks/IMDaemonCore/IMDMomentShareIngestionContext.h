...
- (void).cxx_destruct;	// IMP=0x0000000000004e57
...
- (void)completeTransferForAssetUUID:(id)arg1;	// IMP=0x0000000000004dc5
- (void)clearAllTransfers;	// IMP=0x0000000000004daf
- (void)addTransfers:(id)arg1;	// IMP=0x0000000000004d99
@property(readonly, nonatomic) NSDictionary *assetUUIDsToFileTransfers;
- (id)initWithURL:(id)arg1 message:(id)arg2 inChat:(id)arg3;	// IMP=0x0000000000004cb9
