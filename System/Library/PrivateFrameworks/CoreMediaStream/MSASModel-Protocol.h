...
- (void)setMigrationMarker:(NSString *)arg1;
- (void)setClientOrgKey:(NSString *)arg1 forAlbumWithGUID:(NSString *)arg2;
...
- (void)setClientOrgKey:(NSString *)arg1 forAlbumWithGUID:(NSString *)arg2 info:(NSDictionary *)arg3;
