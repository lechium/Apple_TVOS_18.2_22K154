...
- (id)initWithEntity:(id)arg1 insertIntoManagedObjectContext:(id)arg2;	// IMP=0x0000000000616e60
...
@property(nonatomic, retain) NSSet *coachingEvents; // @dynamic coachingEvents;
