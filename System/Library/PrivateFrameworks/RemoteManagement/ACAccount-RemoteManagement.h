...
+ (id)rm_createMAIDAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 dsid:(id)arg4 altDSID:(id)arg5 personaIdentifier:(id)arg6 enrollmentURL:(id)arg7;	// IMP=0x0020000000001c4f
+ (id)rm_createBearerAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 enrollmentURL:(id)arg4 authToken:(id)arg5;	// IMP=0x0020000000001af9
+ (id)rm_createTestAccountWithStore:(id)arg1 username:(id)arg2 description:(id)arg3 enrollmentURL:(id)arg4;	// IMP=0x00200000000019d0
- (_Bool)rm_isAccountSchemeMAID;	// IMP=0x00100000000020d4
- (_Bool)rm_isAccountSchemeBearer;	// IMP=0x0010000000002089
- (_Bool)rm_isAccountSchemeTest;	// IMP=0x001000000000203e
