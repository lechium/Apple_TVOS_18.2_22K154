...
- (void).cxx_destruct;	// IMP=0x00000000000827ef
...
- (id)_topShelfCarouselItem;	// IMP=0x000000000008272a
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000825bc
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000821e5
...
- (void)removeObserver:(id)arg1;	// IMP=0x0000000000082027
- (void)addObserver:(id)arg1;	// IMP=0x0000000000081fbe
...
- (id)imageURLForTraitCollection:(id)arg1;	// IMP=0x0000000000081cc7
@property(readonly, nonatomic) NSString *photosAssetIdentifier;
- (void)_didPerformAction:(id)arg1 withSuccess:(_Bool)arg2;	// IMP=0x0000000000081bb2
- (void)_willPerformAction:(id)arg1;	// IMP=0x0000000000081aba
- (id)_assetCatalogImageNamed:(id)arg1;	// IMP=0x0000000000081916
- (void)_setPrimaryAction:(id)arg1;	// IMP=0x0000000000081571
- (void)setPlayAction:(id)arg1;	// IMP=0x00000000000814b6
- (void)setDisplayAction:(id)arg1;	// IMP=0x00000000000812fe
- (id)initWithTopShelfCarouselItem:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x0000000000081277
- (id)initWithTopShelfCarouselItem:(id)arg1 contentOptions:(unsigned long long)arg2 bundleIdentifier:(id)arg3;	// IMP=0x00000000000810c9
