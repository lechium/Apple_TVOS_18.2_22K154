...
- (void).cxx_destruct;	// IMP=0x000000000004fdac
...
- (id)description;	// IMP=0x000000000004fc92
- (id)init;	// IMP=0x000000000004fc79
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x000000000004fbb9
