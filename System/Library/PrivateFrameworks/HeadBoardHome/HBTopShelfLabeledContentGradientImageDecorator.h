...
- (void).cxx_destruct;	// IMP=0x0000000000049ddd
...
- (id)decoratorIdentifier;	// IMP=0x0000000000049d33
- (struct CGSize)expectedSize;	// IMP=0x0000000000049d21
- (id)decorate:(id)arg1 scaledWithSize:(struct CGSize)arg2 croppedToFit:(_Bool)arg3;	// IMP=0x0000000000049615
