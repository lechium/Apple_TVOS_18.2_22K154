...
- (id)_promotionImageName;	// IMP=0x000000000005ec3c
- (id)_topShelfPromotionCarouselItem;	// IMP=0x000000000005ec2a
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000000005eb5f
...
- (id)initWithTopShelfPromotionCarouselItem:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x000000000005e9e0
