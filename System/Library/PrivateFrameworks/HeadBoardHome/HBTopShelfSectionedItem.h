...
+ (id)_logStringForImageShape:(unsigned long long)arg1;	// IMP=0x0060000000025dd3
@property(readonly, nonatomic) long long placeholderAssetType; // @synthesize placeholderAssetType=_placeholderAssetType;
- (id)_topShelfSectionedItem;	// IMP=0x0000000000025dc1
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000000025c5b
...
- (id)initWithTopShelfSectionedItem:(id)arg1 applicationIdentifier:(id)arg2;	// IMP=0x0000000000025920
