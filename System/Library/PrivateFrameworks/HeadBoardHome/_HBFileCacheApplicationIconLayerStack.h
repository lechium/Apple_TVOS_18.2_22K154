...
- (void)_deflateLayerStack;	// IMP=0x000000000006199b
- (void)_inflateLayerStack;	// IMP=0x000000000006153a
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x00000000000613c8
- (id)initWithApplication:(id)arg1;	// IMP=0x0000000000060f27
