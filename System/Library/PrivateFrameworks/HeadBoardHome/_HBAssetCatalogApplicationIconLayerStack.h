...
- (void).cxx_destruct;	// IMP=0x000000000005e466
...
- (void)_deflateLayerStack;	// IMP=0x000000000005e298
- (void)_inflateLayerStack;	// IMP=0x000000000005de37
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000000005dcc5
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000005d932
