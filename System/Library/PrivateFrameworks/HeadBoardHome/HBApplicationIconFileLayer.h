...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000073d0d
- (void).cxx_destruct;	// IMP=0x0000000000073f0d
...
- (id)description;	// IMP=0x0000000000073d15
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000073b64
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000073986
- (id)_init;	// IMP=0x0000000000073957
