...
- (void).cxx_destruct;	// IMP=0x000000000006ee91
...
- (id)description;	// IMP=0x000000000006ec76
- (void)cancel;	// IMP=0x000000000006eb87
- (void)_executionDidBegin;	// IMP=0x000000000006e46e
- (id)initWithApplicationIdentifier:(id)arg1 fetchIdentifier:(id)arg2 contentExtensionController:(id)arg3;	// IMP=0x000000000006e379
