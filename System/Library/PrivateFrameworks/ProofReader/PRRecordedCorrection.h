...
- (id)correctedString;	// IMP=0x000000000002e6b1
- (id)correctionResult;	// IMP=0x000000000002e6a7
- (id)description;	// IMP=0x000000000002e640
- (void)dealloc;	// IMP=0x000000000002e5f6
- (id)initWithCorrectionResult:(id)arg1 correctedString:(id)arg2;	// IMP=0x000000000002e577
