...
+ (void)setTypologyRecordsLimit:(unsigned long long)arg1;	// IMP=0x006000000001bde1
+ (void)resetTypologyRecords;	// IMP=0x006000000001bd47
+ (void)writeTypologyRecords;	// IMP=0x006000000001bad4
+ (id)currentTypologyRecord;	// IMP=0x006000000001b3e4
+ (id)openTypologyRecordWithString:(id)arg1 range:(struct _NSRange)arg2 languageObject:(id)arg3 languages:(id)arg4 topLanguages:(id)arg5 autocorrect:(_Bool)arg6 initialCapitalize:(_Bool)arg7 autocapitalize:(_Bool)arg8 keyEventArray:(id)arg9 appIdentifier:(id)arg10 selectedRangeValue:(id)arg11;	// IMP=0x006000000001b152
- (void)closeTypologyRecordWithResults:(id)arg1;	// IMP=0x000000000001be82
- (id)dictionaryRepresentation;	// IMP=0x000000000001b58a
- (void)addCandidate:(id)arg1;	// IMP=0x000000000001b569
- (void)addCorrection:(id)arg1;	// IMP=0x000000000001b548
- (void)dealloc;	// IMP=0x000000000001b0d0
- (id)initWithString:(id)arg1 offset:(unsigned long long)arg2 range:(struct _NSRange)arg3 languageObject:(id)arg4 languages:(id)arg5 topLanguages:(id)arg6 autocorrect:(_Bool)arg7 initialCapitalize:(_Bool)arg8 autocapitalize:(_Bool)arg9 keyEventArray:(id)arg10 appIdentifier:(id)arg11 selectedRangeValue:(id)arg12;	// IMP=0x000000000001afa5
