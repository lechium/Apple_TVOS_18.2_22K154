...
- (void).cxx_destruct;	// IMP=0x00000000000d5e58
...
- (id)description;	// IMP=0x00000000000d5de2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d5dd7
- (id)initWithVersion:(id)arg1 score:(float)arg2 threshold:(float)arg3 calibrationScale:(float)arg4 calibrationOffset:(float)arg5 processed:(_Bool)arg6;	// IMP=0x00000000000d5cf2
