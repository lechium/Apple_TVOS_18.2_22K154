...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d54a6
- (id)_initWithSpeechRecognitionFeatures:(id)arg1 acousticFeatures:(id)arg2 snr:(double)arg3;	// IMP=0x00000000000d53b3
