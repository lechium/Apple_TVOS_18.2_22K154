...
- (id).cxx_construct;	// IMP=0x000000000008c2db
- (void).cxx_destruct;	// IMP=0x000000000008c2a1
- (unsigned long long)drawNoise;	// IMP=0x000000000008c1a9
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x000000000008bac9
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x000000000008b95a
- (id)init;	// IMP=0x000000000008b94c
