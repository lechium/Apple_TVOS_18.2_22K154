...
@interface _EARResultContext : NSObject
{
    ...
    basic_string_76cbfbed _prevBestRecogText;	// 72 = 0x48
...
- (id).cxx_construct;	// IMP=0x00000000000dd941
- (void).cxx_destruct;	// IMP=0x00000000000dd8b3
...
@property(nonatomic) basic_string_76cbfbed prevBestRecogText; // @synthesize prevBestRecogText=_prevBestRecogText;
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x00000000000dd453
- (id)description;	// IMP=0x00000000000dd373
- (void)resetPartialResultContext;	// IMP=0x00000000000dd30e
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x00000000000dd209
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x00000000000dd1ff
