...
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 endOfSentenceLikelihood:(float)arg3 silencePosterior:(float)arg4;	// IMP=0x00000000000c6c58
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 endOfSentenceLikelihood:(float)arg3 acousticEndpointerScore:(float)arg4 silencePosterior:(float)arg5;	// IMP=0x00000000000c6be3
