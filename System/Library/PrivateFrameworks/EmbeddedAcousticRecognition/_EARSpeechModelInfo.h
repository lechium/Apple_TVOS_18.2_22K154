...
+ (void)initialize;	// IMP=0x00600000000f3aee
- (id).cxx_construct;	// IMP=0x00000000000f4267
- (void).cxx_destruct;	// IMP=0x00000000000f4259
...
- (id)initWithConfig:(id)arg1;	// IMP=0x00000000000f3b87
- (id)_initWithSpeechModelInfo:(const void *)arg1;	// IMP=0x00000000000f3b16
