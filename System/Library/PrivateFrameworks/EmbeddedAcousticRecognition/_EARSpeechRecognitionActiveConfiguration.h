...
+ (id)activeConfigurationForNothing;	// IMP=0x00100000000f5467
+ (id)activeConfigurationForEverything;	// IMP=0x00100000000f544e
- (void).cxx_destruct;	// IMP=0x00000000000f6b88
...
- (id)description;	// IMP=0x00000000000f6918
- (struct SpeechRecognizerActiveConfiguration)speechRecognizerActiveConfiguration;	// IMP=0x00000000000f5cfe
- (id)_initWithActiveConfiguration:(const void *)arg1;	// IMP=0x00000000000f5893
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f5681
