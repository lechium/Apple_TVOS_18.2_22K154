...
+ (id)wf_valueWithCGAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x00200000000c0e22
+ (id)wf_valueWithCGRect:(struct CGRect)arg1;	// IMP=0x00200000000c0e10
+ (id)wf_valueWithCGSize:(struct CGSize)arg1;	// IMP=0x00200000000c0dfe
+ (id)wf_valueWithCGVector:(struct CGVector)arg1;	// IMP=0x00200000000c0dec
+ (id)wf_valueWithCGPoint:(struct CGPoint)arg1;	// IMP=0x00200000000c0dda
