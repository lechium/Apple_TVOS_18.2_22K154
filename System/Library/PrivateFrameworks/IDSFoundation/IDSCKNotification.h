...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00600000000ce201
+ (Class)__class;	// IMP=0x00600000000ce1b1
- (void).cxx_destruct;	// IMP=0x00000000000ce26e
