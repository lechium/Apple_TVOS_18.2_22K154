...
+ (id)createElement:(id *)arg1;	// IMP=0x006000000000b7a5
- (id)authorizationForResource:(id)arg1;	// IMP=0x000000000000c0ec
- (_Bool)isValidForRequestor:(id)arg1;	// IMP=0x000000000000bf46
- (_Bool)meetsConditions:(id *)arg1;	// IMP=0x000000000000bef5
- (_Bool)isValid:(id *)arg1;	// IMP=0x000000000000bde1
