...
- (_Bool)compressStreamWithOperation:(long long)arg1 availableIn:(unsigned long long *)arg2 nextIn:(const char **)arg3 availableOut:(unsigned long long *)arg4 nextOut:(char **)arg5;	// IMP=0x0000000000040dae
@property(readonly, nonatomic) _Bool isFinished;
- (void)dealloc;	// IMP=0x0000000000040cc6
- (id)init;	// IMP=0x0000000000040c5a
