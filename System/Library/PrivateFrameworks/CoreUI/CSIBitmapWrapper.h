...
- (id)compressedData:(_Bool)arg1 usedEncoding:(int *)arg2 andRowChunkSize:(unsigned int *)arg3;	// IMP=0x000000000001cd3e
...
- (id)pixelData;	// IMP=0x000000000001c9d7
- (void)setPixelData:(id)arg1;	// IMP=0x000000000001c9a9
- (unsigned int)sourceAlphaInfo;	// IMP=0x000000000001c9a0
- (void)setSourceAlphaInfo:(unsigned int)arg1;	// IMP=0x000000000001c997
- (struct CGContext *)bitmapContext;	// IMP=0x000000000001c63a
@property(nonatomic) unsigned long long rowbytes;
- (unsigned int)width;	// IMP=0x000000000001c61d
- (unsigned int)height;	// IMP=0x000000000001c614
- (void)dealloc;	// IMP=0x000000000001c5a9
- (id)initWithCGImage:(struct CGImage *)arg1 width:(unsigned int)arg2 height:(unsigned int)arg3 texturePixelFormat:(long long)arg4;	// IMP=0x000000000001c516
- (id)initWithPixelWidth:(unsigned int)arg1 pixelHeight:(unsigned int)arg2;	// IMP=0x000000000001c4ad
