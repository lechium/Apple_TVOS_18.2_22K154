...
- (void)dealloc;	// IMP=0x00000000000ac783
- (void)addLayerEffectComponent:(id)arg1;	// IMP=0x00000000000ac729
- (id)colorOverlay;	// IMP=0x00000000000ac70c
- (id)dropShadow;	// IMP=0x00000000000ac6ef
- (id)init;	// IMP=0x00000000000ac693
