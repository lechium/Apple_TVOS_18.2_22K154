...
- (void)dealloc;	// IMP=0x00000000000ac90a
- (unsigned int)effectType;	// IMP=0x00000000000ac8ff
- (id)init;	// IMP=0x00000000000ac8ac
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000004d401
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004d21e
