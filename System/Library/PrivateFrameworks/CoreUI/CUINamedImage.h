...
- (struct CGRect)alphaCroppedRect;	// IMP=0x000000000008e0c6
- (struct CGSize)originalUncroppedSize;	// IMP=0x000000000008e0b0
- (struct CGImage *)createImageFromPDFRenditionWithScale:(double)arg1;	// IMP=0x000000000008e037
- (id)baseKey;	// IMP=0x000000000008e007
- (id)description;	// IMP=0x000000000008dd12
...
- (long long)resizingModeWithSubtype:(long long)arg1;	// IMP=0x000000000008dbeb
...
- (double)positionOfSliceBoundary:(unsigned int)arg1;	// IMP=0x000000000008d958
@property(readonly, nonatomic) long long imageType;
@property(readonly, nonatomic) struct CGSize size;
@property(readonly, nonatomic) struct CGImage *croppedImage;
@property(readonly, nonatomic) struct CGImage *image;
- (_Bool)_cacheRenditionProperties;	// IMP=0x000000000008d585
- (id)initWithName:(id)arg1 usingRenditionKey:(id)arg2 fromTheme:(unsigned long long)arg3;	// IMP=0x000000000008d4f5
