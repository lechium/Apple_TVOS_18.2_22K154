...
- (void)dealloc;	// IMP=0x00000000000aca9d
- (unsigned int)effectType;	// IMP=0x00000000000aca92
- (id)init;	// IMP=0x00000000000aca3f
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000004d723
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004d555
