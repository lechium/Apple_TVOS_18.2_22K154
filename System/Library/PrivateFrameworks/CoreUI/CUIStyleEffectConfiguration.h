...
- (id)description;	// IMP=0x0000000000091e47
- (_Bool)shouldRespectOutputBlending;	// IMP=0x0000000000091e3f
- (_Bool)shouldIgnoreForegroundColor;	// IMP=0x0000000000091e37
- (void)dealloc;	// IMP=0x0000000000091dfc
- (id)init;	// IMP=0x0000000000091dcd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000091d25
