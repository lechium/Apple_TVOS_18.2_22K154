...
- (_Bool)isTintable;	// IMP=0x000000000006c1a6
- (void)setRepresentsOnDemandContent:(_Bool)arg1;	// IMP=0x000000000006c196
...
- (id)_renditionForSpecificKey:(id)arg1;	// IMP=0x000000000006c0e7
- (void)dealloc;	// IMP=0x000000000006c096
- (unsigned long long)hash;	// IMP=0x000000000006c06a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006c00f
@property(readonly, nonatomic) _Bool _cacheRenditionProperties;
- (void)unlock;	// IMP=0x000000000006bfa2
- (void)lock;	// IMP=0x000000000006bf94
- (id)initWithName:(id)arg1 usingRenditionKey:(id)arg2 fromTheme:(unsigned long long)arg3;	// IMP=0x000000000006bec2
