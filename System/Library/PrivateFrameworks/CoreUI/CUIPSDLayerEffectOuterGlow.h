...
- (void)dealloc;	// IMP=0x00000000000acef2
- (id)description;	// IMP=0x00000000000ace07
- (unsigned int)effectType;	// IMP=0x00000000000acdfc
- (id)init;	// IMP=0x00000000000acda9
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000004dca7
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004daf6
