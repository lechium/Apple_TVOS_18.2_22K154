...
+ (double)defaultSymbolPointSizeRatio;	// IMP=0x0010000000022c55
...
- (unsigned long long)hash;	// IMP=0x00000000000230b4
- (_Bool)_areValid;	// IMP=0x0000000000023053
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000022e0a
- (void)dealloc;	// IMP=0x0000000000022db9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000022ce9
- (id)init;	// IMP=0x0000000000022c7c
