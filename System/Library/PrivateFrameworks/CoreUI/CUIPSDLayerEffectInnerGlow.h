...
- (void)dealloc;	// IMP=0x00000000000accda
- (id)description;	// IMP=0x00000000000acc0e
- (unsigned int)effectType;	// IMP=0x00000000000acc03
- (id)init;	// IMP=0x00000000000acbb0
- (id)initWithEffectFromPreset:(id)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000004d9f7
- (_Bool)updateLayerEffectPreset:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004d856
