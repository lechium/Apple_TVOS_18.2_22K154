...
- (void).cxx_destruct;	// IMP=0x000000000001c043
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001bd16
- (void)serverInvalidated:(id)arg1 withError:(id)arg2;	// IMP=0x000000000001bab1
- (void)_setupQuery;	// IMP=0x000000000001acd9
- (void)_stopServer;	// IMP=0x000000000001ab82
- (void)_startServer;	// IMP=0x000000000001a957
- (_Bool)_shouldRunServer;	// IMP=0x000000000001a75d
- (void)_updateState;	// IMP=0x000000000001a6b3
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000001a4ca
- (id)initWithQueryRunner:(id)arg1;	// IMP=0x000000000001a30c
