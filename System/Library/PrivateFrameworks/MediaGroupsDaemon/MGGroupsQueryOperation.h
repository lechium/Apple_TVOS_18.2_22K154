...
- (void).cxx_destruct;	// IMP=0x0000000000017565
...
- (void)main;	// IMP=0x00000000000171e6
- (id)initWithAgent:(id)arg1 query:(id)arg2 groups:(id)arg3 substitutionVariables:(id)arg4;	// IMP=0x00000000000170cf
