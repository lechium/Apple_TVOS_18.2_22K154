...
+ (id)handlerWithQuery:(id)arg1 forGroupsQueryAgent:(id)arg2;	// IMP=0x0010000000000f94
- (void).cxx_destruct;	// IMP=0x0000000000001a17
...
- (id)handleCompleteResponse:(id)arg1 jsonPayload:(id)arg2;	// IMP=0x000000000000140d
- (_Bool)validateResponse:(id)arg1;	// IMP=0x0000000000001315
- (void)prepareURL:(id)arg1;	// IMP=0x00000000000011a5
@property(readonly, copy) NSString *description;
- (id)_initWithQuery:(id)arg1 groupsQueryAgent:(id)arg2;	// IMP=0x0000000000001002
