...
- (void).cxx_destruct;	// IMP=0x00000000000034e1
...
- (id)_targetForBrowseResult:(id)arg1;	// IMP=0x00000000000031e1
- (void)_applyUpdates;	// IMP=0x0000000000002d9f
- (void)_handleBrowseChangeFromTarget:(id)arg1 toTarget:(id)arg2 applyBatch:(_Bool)arg3;	// IMP=0x0000000000002b65
- (void)_prepareBrowserHandlers;	// IMP=0x0000000000002598
- (id)_prepareBrowseParameters;	// IMP=0x000000000000252f
- (id)_prepareBrowseDescriptor;	// IMP=0x00000000000024a7
- (void)_invalidated;	// IMP=0x0000000000002333
- (void)_invalidate;	// IMP=0x00000000000021aa
- (void)_startBrowsing;	// IMP=0x0000000000001f32
- (id)description;	// IMP=0x0000000000001e47
- (void)dealloc;	// IMP=0x0000000000001e09
- (id)initWithDelegate:(id)arg1 dispatchQueue:(id)arg2;	// IMP=0x0000000000001c4c
