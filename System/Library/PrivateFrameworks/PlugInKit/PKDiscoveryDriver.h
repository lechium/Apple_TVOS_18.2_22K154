...
- (void)removeWatchers;	// IMP=0x000000000000cd20
- (void)installWatchers;	// IMP=0x000000000000ca40
- (void)cancel;	// IMP=0x000000000000c7a0
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000c200
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000bab0
- (void)dealloc;	// IMP=0x000000000000b960
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000b4c0
