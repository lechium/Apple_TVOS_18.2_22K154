...
@interface SKRConversationTurnDataXPC : NSObject
{
...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002895e0
- (void).cxx_destruct;	// IMP=0x000000000028a5d0
- (id)init;	// IMP=0x000000000028a570
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000028a420
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000289e10
