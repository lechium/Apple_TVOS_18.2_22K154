...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000f226
- (void).cxx_destruct;	// IMP=0x000000000000f5b6
...
- (void)completeAnimation;	// IMP=0x000000000000f4e3
- (_Bool)isAnimating;	// IMP=0x000000000000f4cc
- (void)update:(double)arg1;	// IMP=0x000000000000f40a
- (void)dealloc;	// IMP=0x000000000000f3ac
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000f2be
