...
+ (id)animationWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x001000000001db8a
- (void).cxx_destruct;	// IMP=0x000000000001df3e
...
- (void)completeAnimation;	// IMP=0x000000000001de6f
- (_Bool)isAnimating;	// IMP=0x000000000001de5e
- (void)update:(double)arg1;	// IMP=0x000000000001dd5b
- (void)dealloc;	// IMP=0x000000000001dcfd
- (id)initWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001dc20
