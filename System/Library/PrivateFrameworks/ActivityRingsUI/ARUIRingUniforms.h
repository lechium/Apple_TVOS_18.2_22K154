...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x0000000000020150
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001fd2c
- (void *)uniformsBytes;	// IMP=0x000000000001fd1f
- (void *)vertexAttributesBytes;	// IMP=0x000000000001fd15
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001fc71
