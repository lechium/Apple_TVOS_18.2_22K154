...
+ (id)animationWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x0010000000014495
- (void).cxx_destruct;	// IMP=0x00000000000147fc
...
- (void)completeAnimation;	// IMP=0x0000000000014729
- (_Bool)isAnimating;	// IMP=0x0000000000014712
- (void)update:(double)arg1;	// IMP=0x0000000000014679
- (void)dealloc;	// IMP=0x000000000001461b
- (id)initWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001452d
