...
+ (id)enumeratorWithMusicBehavior:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x00600000001d3138
- (void).cxx_destruct;	// IMP=0x00000000001d300c
...
- (void)_buildEnumerator;	// IMP=0x00000000001d2747
- (id)_init;	// IMP=0x00000000001d2718
- (id)nextObject;	// IMP=0x00000000001d265f
