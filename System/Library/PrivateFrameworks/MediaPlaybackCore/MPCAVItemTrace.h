...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x00600000003088ff
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x006000000030881b
- (void).cxx_destruct;	// IMP=0x00000000003087f5
...
- (void)cancel;	// IMP=0x00000000003085e3
- (void)endInterval;	// IMP=0x0000000000308451
- (void)dealloc;	// IMP=0x0000000000308413
