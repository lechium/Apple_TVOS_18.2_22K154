...
- (void).cxx_destruct;	// IMP=0x00000000002bc5d0
...
- (void)invalidate;	// IMP=0x00000000002bc38e
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000002bc303
- (id)initWithEventStream:(id)arg1 type:(long long)arg2 reason:(id)arg3 timeout:(double)arg4;	// IMP=0x00000000002bc162
