...
+ (id)archivesAtURL:(id)arg1;	// IMP=0x001000000032f2fb
- (void).cxx_destruct;	// IMP=0x000000000032e4d3
...
- (id)_playbackSessionsDirectory;	// IMP=0x000000000032e39c
@property(retain, nonatomic) NSString *stateRestorationSessionIdentifier;
- (void)deleteSessionWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000032e0ae
- (void)saveSessionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000032d7c2
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x000000000032d647
