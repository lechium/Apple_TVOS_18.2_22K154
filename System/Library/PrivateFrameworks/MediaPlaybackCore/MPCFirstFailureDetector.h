...
- (void).cxx_destruct;	// IMP=0x0000000000183583
...
- (_Bool)processSample:(id)arg1;	// IMP=0x000000000018329a
- (id)initWithSamplingTime:(double)arg1 renderingLimit:(double)arg2;	// IMP=0x0000000000183240
