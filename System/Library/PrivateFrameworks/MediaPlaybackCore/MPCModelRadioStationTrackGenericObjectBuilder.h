...
- (void).cxx_destruct;	// IMP=0x00000000001b4d67
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)genericObjectForRadioStationTrack:(id)arg1 radioStationContainsVideo:(_Bool)arg2 containerUniqueID:(id)arg3 userIdentity:(id)arg4;	// IMP=0x00000000001b4797
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x00000000001b4724
