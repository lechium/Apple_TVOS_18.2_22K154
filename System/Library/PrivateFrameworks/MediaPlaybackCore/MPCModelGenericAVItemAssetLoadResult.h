...
@interface MPCModelGenericAVItemAssetLoadResult : NSObject
{
    ...
    long long _audioAssetType;	// 136 = 0x88
    long long _source;	// 144 = 0x90
}

+ (id)assetLoadResultWithStoreAssetPlaybackResponse:(id)arg1 assetLoadProperties:(id)arg2 source:(long long)arg3 error:(id *)arg4;	// IMP=0x0060000000195a79
- (void).cxx_destruct;	// IMP=0x0000000000197859
...
- (id)descriptionDictionary;	// IMP=0x0000000000196da4
- (id)description;	// IMP=0x0000000000196d1c
