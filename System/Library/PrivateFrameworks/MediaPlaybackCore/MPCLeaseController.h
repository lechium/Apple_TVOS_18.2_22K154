...
- (void).cxx_destruct;	// IMP=0x0000000000302b98
...
- (void)relinquishLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000030286e
- (void)requestLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000302551
- (id)initWithTranslator:(id)arg1 leaseManager:(id)arg2;	// IMP=0x00000000003024b8
