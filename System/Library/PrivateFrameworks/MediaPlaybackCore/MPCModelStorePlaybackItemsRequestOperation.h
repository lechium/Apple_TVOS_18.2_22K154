...
- (void).cxx_destruct;	// IMP=0x00000000002c3936
...
- (void)_handleItemMetadataBatchRequestCompletedWithAccumulator:(id)arg1 previousResponse:(id)arg2 error:(id)arg3 isFinalResponse:(_Bool)arg4;	// IMP=0x00000000002c3556
- (id)_localStoreAdamIDToEquivalencySourceStoreAdamIDMap:(id)arg1;	// IMP=0x00000000002c34b3
- (void)_runPersonalizationWithSectionCollection:(id)arg1 localEquivalencyMapping:(id)arg2 expirationDate:(id)arg3 error:(id)arg4 isFinalResponse:(_Bool)arg5 isInvalidForPersonalization:(_Bool)arg6 performanceMetrics:(id)arg7;	// IMP=0x00000000002c2c94
- (void)_runStorePlatformRequestToLoadMetadataWithAccumulator:(id)arg1 previousResponse:(id)arg2;	// IMP=0x00000000002c29a7
- (void)execute;	// IMP=0x00000000002c2722
- (void)cancel;	// IMP=0x00000000002c2698
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002c2573
