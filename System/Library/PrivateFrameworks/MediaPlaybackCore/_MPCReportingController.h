...
- (void).cxx_destruct;	// IMP=0x0000000000301de1
...
- (void)recordLyricsViewEvent:(id)arg1;	// IMP=0x0000000000301d9a
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x0000000000301d1c
