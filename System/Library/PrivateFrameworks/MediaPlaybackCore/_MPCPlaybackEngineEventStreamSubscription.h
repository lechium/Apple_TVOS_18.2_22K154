...
- (void).cxx_destruct;	// IMP=0x00000000002ba763
...
- (void)_onQueue_flush;	// IMP=0x00000000002b9f3c
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000002b9bde
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002b9bc7
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002b99d2
- (void)cancelSubscription;	// IMP=0x00000000002b9859
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x00000000002b957b
