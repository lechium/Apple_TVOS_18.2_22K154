...
+ (id)packageTypeIdentifier;	// IMP=0x00600000002f3962
- (void).cxx_destruct;	// IMP=0x00000000002f390f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002f3610
- (unsigned long long)hash;	// IMP=0x00000000002f35cc
- (_Bool)writeWithError:(id *)arg1;	// IMP=0x00000000002f1b65
- (_Bool)saveWithError:(id *)arg1;	// IMP=0x00000000002f1a1c
- (id)description;	// IMP=0x00000000002f19d4
- (id)initWithURL:(id)arg1 identifier:(id)arg2;	// IMP=0x00000000002f187a
- (id)initWithURL:(id)arg1;	// IMP=0x00000000002f17b7
