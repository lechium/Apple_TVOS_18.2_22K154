...
- (void).cxx_destruct;	// IMP=0x0000000000127637
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x0000000000126faf
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x0000000000126ab2
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_912cb5d2)arg1;	// IMP=0x0000000000126a8e
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x00000000001268e8
- (void)execute;	// IMP=0x0000000000126821
- (void)_loadPlaybackQueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000012613e
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x000000000012609c
