...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001dd145
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x00100000002ee890
- (void).cxx_destruct;	// IMP=0x00000000001dcfac
...
- (id)_copyWithClass:(Class)arg1 zone:(struct _NSZone *)arg2;	// IMP=0x00000000001dceb3
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001dce80
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001dcdb8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001dcc46
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001dcc3b
- (id)initWithStoreAccountID:(unsigned long long)arg1 deviceGUID:(id)arg2;	// IMP=0x00000000001dcbbd
- (id)mpc_jsonValue;	// IMP=0x00000000002ebc2b
