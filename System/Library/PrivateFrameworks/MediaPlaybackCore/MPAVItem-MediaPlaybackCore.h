...
- (id)observeChapters:(CDUnknownBlockType)arg1;	// IMP=0x00200000000e15fc
...
- (_Bool)_isInContiguousAlbumWith:(id)arg1;	// IMP=0x00200000002a5f65
- (id)activeFormat;	// IMP=0x00200000002a5f17
- (_Bool)shouldPerformOverlappingTransitionWith:(id)arg1;	// IMP=0x00200000002a5e48
- (_Bool)shouldPerformGaplessTransitionWith:(id)arg1;	// IMP=0x00200000002a5dfa
@property(readonly, nonatomic) id <MFGaplessParameters> gaplessParameters;
- (void)prepareForReuse;	// IMP=0x00200000002a5d6b
- (void)reset;	// IMP=0x00200000002a5d34
- (void)setCurrentItemTransition:(long long)arg1;	// IMP=0x00200000002a5d02
