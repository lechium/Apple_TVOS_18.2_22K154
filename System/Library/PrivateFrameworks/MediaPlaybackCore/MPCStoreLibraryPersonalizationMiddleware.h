...
- (void).cxx_destruct;	// IMP=0x000000000010ad37
...
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x000000000010ac41
- (id)operationsForRequest:(id)arg1;	// IMP=0x000000000010abd4
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x000000000010ad5f
