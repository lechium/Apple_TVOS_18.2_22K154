...
- (void).cxx_destruct;	// IMP=0x0000000000180781
- (unsigned long long)hash;	// IMP=0x00000000001806fd
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001805f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000180507
- (void)writeTo:(id)arg1;	// IMP=0x0000000000180470
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000180463
- (id)dictionaryRepresentation;	// IMP=0x00000000001802f6
- (id)description;	// IMP=0x0000000000180247
