...
- (void).cxx_destruct;	// IMP=0x000000000030ecb1
...
- (id)trackForItemAtIndex:(long long)arg1;	// IMP=0x000000000030ec19
- (long long)removeExplicitItems;	// IMP=0x000000000030eadd
- (void)removeAllItems;	// IMP=0x000000000030ea98
@property(readonly, nonatomic) long long numberOfItems;
- (_Bool)isExplicitItemAtIndex:(long long)arg1;	// IMP=0x000000000030e8ec
- (id)AVItemAtIndex:(long long)arg1;	// IMP=0x000000000030e611
- (void)updateWithPersonalizedResponse:(id)arg1;	// IMP=0x000000000030e211
- (id)initWithPlaybackContext:(id)arg1;	// IMP=0x000000000030e10e
