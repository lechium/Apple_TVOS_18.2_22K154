...
+ (id)identifier;	// IMP=0x001000000014fd0e
- (void).cxx_destruct;	// IMP=0x0000000000153217
...
- (id)_playbackBarWithElapsedTime:(double)arg1 duration:(double)arg2;	// IMP=0x0000000000153033
- (_Bool)_logAccountEvent:(id)arg1 subscription:(id)arg2 cursor:(id)arg3;	// IMP=0x0000000000152718
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x00000000001526df
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x000000000014fd1b
