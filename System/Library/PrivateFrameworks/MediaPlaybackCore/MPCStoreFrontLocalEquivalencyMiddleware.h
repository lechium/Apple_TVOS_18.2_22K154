...
- (void).cxx_destruct;	// IMP=0x00000000002fbef8
...
- (id)_stateDumpObject;	// IMP=0x00000000002fbd52
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x00000000002fbc92
- (id)operationsForRequest:(id)arg1;	// IMP=0x00000000002fbc25
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x00000000002fbf2b
