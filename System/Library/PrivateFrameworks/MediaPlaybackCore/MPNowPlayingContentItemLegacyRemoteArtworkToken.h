...
@interface MPNowPlayingContentItemLegacyRemoteArtworkToken : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00000000001e4113
...
- (id)stringRepresentation;	// IMP=0x00000000001e40ad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001e3ffa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001e3f3e
- (id)initWithIdentifier:(id)arg1 artworkProperties:(id)arg2 artworkIdentifier:(id)arg3;	// IMP=0x00000000001e3e52
