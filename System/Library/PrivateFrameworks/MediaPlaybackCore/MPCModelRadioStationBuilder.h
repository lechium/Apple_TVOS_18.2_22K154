...
- (void).cxx_destruct;	// IMP=0x00000000001e1dba
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)modelRadioStationForMetadata:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001e1945
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x00000000001e18d2
