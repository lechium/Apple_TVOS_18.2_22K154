...
- (void).cxx_destruct;	// IMP=0x000000000027a2dc
...
- (id)replaceWithPlaybackIntent:(id)arg1 replaceIntent:(long long)arg2;	// IMP=0x0000000000279d2c
- (id)replaceWithPlaybackIntent:(id)arg1;	// IMP=0x0000000000279d15
- (id)clearUpNextItems;	// IMP=0x0000000000279bbe
- (id)clear;	// IMP=0x00000000002799e4
