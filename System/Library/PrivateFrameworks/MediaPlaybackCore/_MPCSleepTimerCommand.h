...
- (id)reset;	// IMP=0x000000000027e281
- (id)startForChapterEnd;	// IMP=0x000000000027e102
- (id)startForItemEnd;	// IMP=0x000000000027df83
- (id)startWithTime:(double)arg1;	// IMP=0x000000000027ddd1
