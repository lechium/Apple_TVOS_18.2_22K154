...
- (void).cxx_destruct;	// IMP=0x000000000018a4c7
- (unsigned long long)hash;	// IMP=0x000000000018a3db
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018a24b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018a115
- (void)writeTo:(id)arg1;	// IMP=0x000000000018a009
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000189ffc
- (id)dictionaryRepresentation;	// IMP=0x0000000000189db4
- (id)description;	// IMP=0x0000000000189d05
