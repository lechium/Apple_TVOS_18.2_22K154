...
- (void).cxx_destruct;	// IMP=0x00000000001d3128
@property(readonly, nonatomic, getter=isRemoved) _Bool removed;
@property(readonly, nonatomic) NSString *itemIdentifier;
@property(readonly, nonatomic) NSString *sectionIdentifier;
- (id)trackingEntryResult;	// IMP=0x00000000001d30fd
- (id)itemResult;	// IMP=0x00000000001d30f4
@property(readonly, nonatomic) long long entryType;
@property(readonly, nonatomic) long long branchDepth;
- (id)initWithSectionIdentifier:(id)arg1;	// IMP=0x00000000001d306e
