...
- (void).cxx_destruct;	// IMP=0x000000000010b529
...
- (void)tearDownObservations;	// IMP=0x000000000010b3c8
- (void)setupObservations;	// IMP=0x000000000010b1af
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x000000000010b141
- (void)snapshotSessionSettings;	// IMP=0x000000000010b052
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x000000000010afc6
- (void)dealloc;	// IMP=0x000000000010af88
- (id)init;	// IMP=0x000000000010aefb
