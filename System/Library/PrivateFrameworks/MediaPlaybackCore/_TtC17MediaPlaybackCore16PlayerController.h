...
- (void)resetWithReason:(id)arg1;	// IMP=0x0000000000047e1b
- (void)setApplicationMusicPlayerTransitionType:(long long)arg1 duration:(double)arg2;	// IMP=0x00000000000480c4
@property(nonatomic) float relativeVolume;
- (void)setSpatializationFormat:(long long)arg1;	// IMP=0x0000000000047efb
