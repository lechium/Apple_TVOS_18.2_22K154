...
- (void).cxx_destruct;	// IMP=0x0000000000208da0
...
- (void)updateEvaluationWithReason:(id)arg1;	// IMP=0x0000000000208bf5
- (void)powerModeDidChange:(_Bool)arg1;	// IMP=0x0000000000208a92
- (void)processInfoPowerStateDidChange:(id)arg1;	// IMP=0x0000000000208a5d
- (id)evaluation;	// IMP=0x0000000000208965
- (void)reset;	// IMP=0x000000000020895f
@property(readonly, nonatomic) _Bool canBeReset;
- (id)initWithPowerModeMonitor:(id)arg1 calloutQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000000208812
- (id)initWithCalloutQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x000000000020877b
