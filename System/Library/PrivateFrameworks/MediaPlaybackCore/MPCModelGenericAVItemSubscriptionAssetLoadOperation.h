...
- (void).cxx_destruct;	// IMP=0x0000000000220d8a
...
- (void)setCancellationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000220c46
- (CDUnknownBlockType)cancellationHandler;	// IMP=0x0000000000220b87
- (id)_handlePlaybackResponse:(id)arg1 withPlaybackCacheRequest:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002205df
- (id)_loadResultsFromServerObjectDatabaseAssets:(id)arg1 hlsAsset:(id)arg2;	// IMP=0x000000000021ff22
- (id)_loadResultsFromServerObjectDatabaseAssetsWithMiniSinf:(id)arg1;	// IMP=0x000000000021f96a
- (_Bool)_canRetrieveLoadResultsFromServerObjectDatabaseWithAssets:(id *)arg1 hlsAsset:(id *)arg2;	// IMP=0x000000000021f381
- (_Bool)_canRetrieveLoadResultsFromMiniSinfWithAssets:(id *)arg1;	// IMP=0x000000000021efb1
- (void)execute;	// IMP=0x000000000021de3b
- (void)cancel;	// IMP=0x000000000021dddb
- (id)description;	// IMP=0x000000000021dd21
- (id)init;	// IMP=0x000000000021dcbd
