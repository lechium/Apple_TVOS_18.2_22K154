...
- (void).cxx_destruct;	// IMP=0x00000000002c5c46
...
- (void)execute;	// IMP=0x00000000002c5aaa
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002c59f4
