...
- (void).cxx_destruct;	// IMP=0x00000000002990b5
...
- (id)_seekCommandWithMediaRemoteCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000298e91
- (id)changePositionToElapsedInterval:(double)arg1 referenceInterval:(double)arg2;	// IMP=0x0000000000298d73
- (id)changePositionToElapsedInterval:(double)arg1;	// IMP=0x0000000000298ca2
- (id)jumpByInterval:(double)arg1;	// IMP=0x0000000000298b0e
- (id)endSeek;	// IMP=0x0000000000298ac9
- (id)beginSeekWithDirection:(long long)arg1;	// IMP=0x0000000000298a71
- (id)initWithResponse:(id)arg1 seekSupport:(unsigned long long)arg2;	// IMP=0x0000000000298a2d
