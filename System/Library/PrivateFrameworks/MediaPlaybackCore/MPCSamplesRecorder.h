...
- (void).cxx_destruct;	// IMP=0x0000000000183afb
...
- (id)flushSamplesToCSVDataWithHeader:(_Bool)arg1;	// IMP=0x0000000000183998
- (id)dictionaryRepresentation;	// IMP=0x0000000000183897
- (id)description;	// IMP=0x00000000001837de
@property(readonly, nonatomic) int numberOfSamples;
- (void)recordSample:(id)arg1;	// IMP=0x0000000000183748
- (id)initWithRecordID:(id)arg1 modelID:(id)arg2 firstFailureDetector:(id)arg3 shouldStoreSamples:(_Bool)arg4 delegate:(id)arg5;	// IMP=0x00000000001835ab
