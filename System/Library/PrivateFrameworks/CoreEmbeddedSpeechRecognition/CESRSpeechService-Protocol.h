...
@class AFSpeechCorrectionInfo, CESRSpeechParameters, NSArray, NSData, NSDictionary, NSNumber, NSSet, NSString, NSURL, SFEntitledAssetConfig;
...
- (oneway void)fetchModelPropertiesForAssetConfig:(SFEntitledAssetConfig *)arg1 completion:(void (^)(CESRModelProperties *, NSError *))arg2;
...
- (oneway void)preheatSpeechRecognitionWithAssetConfig:(SFEntitledAssetConfig *)arg1 preheatSource:(NSString *)arg2 modelOverrideURL:(NSURL *)arg3;
- (oneway void)preheatSpeechRecognitionWithLanguage:(NSString *)arg1 modelOverrideURL:(NSURL *)arg2;
- (oneway void)compilePrimaryAssistantAssetWithCompletion:(void (^)(NSError *))arg1;
- (oneway void)compileAllAssetsWithType:(unsigned long long)arg1 completion:(void (^)(NSError *))arg2;
