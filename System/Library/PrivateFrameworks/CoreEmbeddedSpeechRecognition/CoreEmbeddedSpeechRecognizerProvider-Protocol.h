...
@class CESRModelProperties, CESRSpeechParameters, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSSet, NSString, NSURL, SFEntitledAssetConfig;
...
+ (void)compilePrimaryAssistantAssetWithCompletion:(void (^)(_Bool, NSError *))arg1;
+ (void)compileAllAssetsWithType:(unsigned long long)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (CESRModelProperties *)modelPropertiesForAssetConfig:(SFEntitledAssetConfig *)arg1 error:(id *)arg2;
...
- (void)preheatSpeechRecognitionWithAssetConfig:(SFEntitledAssetConfig *)arg1 preheatSource:(NSString *)arg2 modelOverrideURL:(NSURL *)arg3;
- (void)preheatSpeechRecognitionWithLanguage:(NSString *)arg1 modelOverrideURL:(NSURL *)arg2;

@optional
- (void)updateVoiceCommandContextWithPrefixText:(NSString *)arg1 postfixText:(NSString *)arg2 selectedText:(NSString *)arg3 disambiguationActive:(NSNumber *)arg4 cursorInVisibleText:(NSNumber *)arg5 favorCommandSuppression:(NSNumber *)arg6 abortCommandSuppression:(NSNumber *)arg7 undoEvent:(NSNumber *)arg8;
@end
