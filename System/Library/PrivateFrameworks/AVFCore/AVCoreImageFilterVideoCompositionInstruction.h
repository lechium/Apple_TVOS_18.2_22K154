...
- (void)dealloc;	// IMP=0x0000000000162ed4
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1 sourceTrackIDs:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000162e1b
- (id)init;	// IMP=0x0000000000162db5
