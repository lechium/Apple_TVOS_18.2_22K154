...
- (void)dealloc;	// IMP=0x0000000000185dcc
- (id)initWithInitializationData:(id)arg1 contentIdentifier:(id)arg2 keyIDFromInitializationData:(id)arg3 options:(id)arg4 identifier:(id)arg5;	// IMP=0x0000000000185d1a
