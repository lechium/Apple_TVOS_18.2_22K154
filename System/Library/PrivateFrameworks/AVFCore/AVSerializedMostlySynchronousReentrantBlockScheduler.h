...
+ (void)initialize;	// IMP=0x0010000000124320
- (void)scheduleBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000012449b
- (void)dealloc;	// IMP=0x000000000012444e
- (id)init;	// IMP=0x00000000001243d2
