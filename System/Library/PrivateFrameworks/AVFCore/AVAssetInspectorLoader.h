...
+ (void)initialize;	// IMP=0x001000000011186c
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x0000000000111b68
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000111b53
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x0000000000111b4d
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x0000000000111b47
...
- (struct OpaqueFigFormatReader *)_copyFormatReader;	// IMP=0x0000000000111a3c
@property(readonly, nonatomic) NSURL *URL;
- (void)cancelLoading;	// IMP=0x0000000000111a2e
- (id)assetInspector;	// IMP=0x0000000000111a26
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001119fb
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001119cd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001119c2
- (void)dealloc;	// IMP=0x0000000000111987
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x000000000011191e
