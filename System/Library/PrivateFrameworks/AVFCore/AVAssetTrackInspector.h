...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00100000001191a9
@property(readonly, nonatomic, getter=_isDefunct) _Bool defunct;
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x000000000011a053
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x0000000000119fc3
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x0000000000119f33
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000119e22
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x0000000000119d33
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000119b12
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000119835
...
- (id)_segmentsForSegmentData:(id)arg1;	// IMP=0x0000000000119662
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000119362
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x000000000011934b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000119340
- (void)dealloc;	// IMP=0x00000000001192da
- (id)_weakReference;	// IMP=0x00000000001192c9
- (id)init;	// IMP=0x00000000001192ac
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x0000000000119295
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x000000000011927c
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000001191ff
