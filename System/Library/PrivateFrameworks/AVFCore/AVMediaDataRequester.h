...
- (void)_requestMediaDataIfReady;	// IMP=0x00000000000dcdf3
- (void)invalidate;	// IMP=0x00000000000dcd4b
- (_Bool)_isInvalidatePending;	// IMP=0x00000000000dcd23
- (void)_setInvalidatePending;	// IMP=0x00000000000dccfe
- (void)startRequestingMediaData;	// IMP=0x00000000000dcc9d
- (void)dealloc;	// IMP=0x00000000000dcc48
- (id)init;	// IMP=0x00000000000dcc2f
- (id)initWithMediaDataConsumer:(id)arg1 requestQueue:(id)arg2 requestBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000dcaa3
