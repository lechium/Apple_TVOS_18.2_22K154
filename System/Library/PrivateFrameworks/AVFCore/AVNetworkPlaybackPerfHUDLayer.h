...
- (void).cxx_destruct;	// IMP=0x000000000006281d
...
- (void)_hudUpdateTrigger;	// IMP=0x0000000000062545
- (void)copyPropertiesFromStringGenerator:(id)arg1;	// IMP=0x0000000000062472
- (id)displayStringGenerator;	// IMP=0x00000000000623bc
- (void)updateHudWithDisplayString:(id)arg1;	// IMP=0x0000000000061fa6
- (_Bool)valueLoadedForKey:(id)arg1 onObject:(id)arg2;	// IMP=0x0000000000061e6e
- (void)currentItemTracksChanged;	// IMP=0x0000000000061cf3
- (void)currentItemChanged;	// IMP=0x0000000000061c73
- (float)getScaleFactorForDisplaySize:(struct CGSize)arg1;	// IMP=0x0000000000061bd1
- (void)dealloc;	// IMP=0x0000000000061b3f
- (void)startDispatchTimer;	// IMP=0x0000000000061a2c
- (void)readHudSettingsAndCallCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000619ab
- (void)getHudSetting;	// IMP=0x0000000000061798
- (void)setColor:(int)arg1;	// IMP=0x000000000006166f
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x0000000000061578
- (id)init;	// IMP=0x0000000000061485
- (_Bool)hudEnabled;	// IMP=0x0000000000061475
