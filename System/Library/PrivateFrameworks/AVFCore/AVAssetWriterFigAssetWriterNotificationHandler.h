...
- (void)_handleFailedNotificationWithError:(id)arg1;	// IMP=0x00000000000a7d8c
- (void)_handleCompletedWritingNotification;	// IMP=0x00000000000a7d57
- (void)_teardownNotificationHandlers;	// IMP=0x00000000000a7ca6
- (void)_callDelegateIfNotCalledWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000000000a7c43
- (void)dealloc;	// IMP=0x00000000000a7bde
- (id)initWithFigAssetWriter:(struct OpaqueFigAssetWriter *)arg1;	// IMP=0x00000000000a79b9
