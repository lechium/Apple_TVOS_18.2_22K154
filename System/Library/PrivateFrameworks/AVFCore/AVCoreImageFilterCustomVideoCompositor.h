...
+ (void)initialize;	// IMP=0x0010000000162f90
...
- (void)cancelAllPendingVideoCompositionRequests;	// IMP=0x00000000001635a3
- (void)startVideoCompositionRequest:(id)arg1;	// IMP=0x0000000000163367
- (id)defaultCIContext;	// IMP=0x0000000000163232
...
- (void)renderContextChanged:(id)arg1;	// IMP=0x00000000001631b3
@property(readonly, nonatomic) NSDictionary *requiredPixelBufferAttributesForRenderContext;
@property(readonly, nonatomic) NSDictionary *sourcePixelBufferAttributes;
- (void)dealloc;	// IMP=0x0000000000163033
- (void)_willDeallocOrFinalize;	// IMP=0x0000000000163005
- (id)init;	// IMP=0x0000000000162fa1
