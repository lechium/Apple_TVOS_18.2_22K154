...
- (void)dealloc;	// IMP=0x000000000016c2fc
- (id)init;	// IMP=0x000000000016c2e3
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x000000000016c203
