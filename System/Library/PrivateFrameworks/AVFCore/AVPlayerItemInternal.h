...
@interface AVPlayerItemInternal : NSObject
{
    ...
    _Bool prefersSDRVideo;	// 744 = 0x2e8
    _Bool prefersSDRVideoWasSet;	// 745 = 0x2e9
    _Bool reversesMoreVideoFramesInMemory;	// 746 = 0x2ea
    _Bool reversesMoreVideoFramesInMemoryWasSet;	// 747 = 0x2eb
    _Bool aggressivelyCachesVideoFrames;	// 748 = 0x2ec
    _Bool aggressivelyCachesVideoFramesWasSet;	// 749 = 0x2ed
    _Bool decodesAllFramesDuringOrdinaryPlayback;	// 750 = 0x2ee
    _Bool decodesAllFramesDuringOrdinaryPlaybackWasSet;	// 751 = 0x2ef
    _Bool initialContinuesPlayingDuringPrerollForSeek;	// 752 = 0x2f0
    _Bool initialContinuesPlayingDuringPrerollForRateChange;	// 753 = 0x2f1
    _Bool usesIFrameOnlyPlaybackForHighRateScaledEditsWasSet;	// 754 = 0x2f2
    _Bool usesIFrameOnlyPlaybackForHighRateScaledEdits;	// 755 = 0x2f3
