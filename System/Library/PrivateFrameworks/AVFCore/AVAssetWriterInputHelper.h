...
- (id)associatedInputsWithTrackAssociationType:(id)arg1;	// IMP=0x00000000000c2878
- (id)availableTrackAssociationTypes;	// IMP=0x00000000000c2841
- (void)addTrackAssociationWithTrackOfInput:(id)arg1 type:(id)arg2;	// IMP=0x00000000000c27c1
- (_Bool)canAddTrackAssociationWithTrackOfInput:(id)arg1 type:(id)arg2;	// IMP=0x00000000000c27b9
...
- (void)markCurrentPassAsFinished;	// IMP=0x00000000000c269b
- (void)markAsFinished;	// IMP=0x00000000000c261b
- (_Bool)prepareToFinishWritingReturningError:(id *)arg1;	// IMP=0x00000000000c2613
- (void)prepareToEndSession;	// IMP=0x00000000000c260d
- (void)didStartInitialSession;	// IMP=0x00000000000c2607
- (_Bool)appendTaggedPixelBufferGroup:(struct OpaqueCMTaggedBufferGroup *)arg1 withPresentationTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000c2587
- (_Bool)appendPixelBuffer:(struct __CVBuffer *)arg1 withPresentationTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000c2507
- (long long)appendSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 error:(id *)arg2;	// IMP=0x00000000000c2477
- (void)stopRequestingMediaData;	// IMP=0x00000000000c23f7
- (void)requestMediaDataWhenReadyOnQueue:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c2377
...
- (_Bool)canStartRespondingToEachPassDescriptionReturningReason:(id *)arg1;	// IMP=0x00000000000c1fee
...
- (void)transitionAssetWriterAndAllInputsToFailedStatusWithError:(id)arg1;	// IMP=0x00000000000c1545
- (id)transitionToAndReturnTerminalHelperWithTerminalStatus:(long long)arg1;	// IMP=0x00000000000c14b8
@property(readonly, nonatomic) long long status;
- (id)description;	// IMP=0x00000000000c1427
- (void)dealloc;	// IMP=0x00000000000c13dd
- (id)initWithConfigurationState:(id)arg1;	// IMP=0x00000000000c130e
