...
@interface AVHUDStringGenerator : NSObject
{
    ...
    double _startupTime;	// 280 = 0x118
    _Bool _spatialDiagnostics;	// 288 = 0x120
    _Bool _captureCompleteURI;	// 289 = 0x121
    NSString *_formattedDisplayString;	// 296 = 0x128
}

+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x006000000005f6e4
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x006000000005f6b9
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x006000000005f64e
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x006000000005f354
- (void).cxx_destruct;	// IMP=0x0000000000061467
...
- (void)update;	// IMP=0x0000000000060c06
- (void)updateFromPlayerItem;	// IMP=0x000000000005ff04
- (void)updateFromPlayer;	// IMP=0x000000000005f9eb
- (void)dealloc;	// IMP=0x000000000005f220
