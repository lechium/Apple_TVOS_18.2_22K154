...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00600000001099bf
...
- (void)dealloc;	// IMP=0x0000000000109a5b
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000001099f6
