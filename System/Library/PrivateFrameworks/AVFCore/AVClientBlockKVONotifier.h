...
- (void)cancelCallbacks;	// IMP=0x00000000001734de
- (void)callbackDidFireWithChangeDictionary:(id)arg1;	// IMP=0x00000000001734cc
- (void)start;	// IMP=0x0000000000173483
@property(readonly, nonatomic) NSObject *observedObject;
- (void)dealloc;	// IMP=0x00000000001733d1
- (id)initWithCallbackContextRegistry:(id)arg1 observer:(id)arg2 object:(id)arg3 keyPath:(id)arg4 options:(unsigned long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000000173212
