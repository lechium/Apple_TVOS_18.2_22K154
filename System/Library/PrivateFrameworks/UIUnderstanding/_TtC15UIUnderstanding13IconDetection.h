...
@interface _TtC15UIUnderstanding13IconDetection : NSObject
{
    MISSING_TYPE *label;	// 8 = 0x8
    MISSING_TYPE *confidence;	// 16 = 0x10
}

- (id)init;	// IMP=0x0000000000035390
- (id)initWithLabel:(long long)arg1 confidence:(double)arg2;	// IMP=0x0000000000034ea0
