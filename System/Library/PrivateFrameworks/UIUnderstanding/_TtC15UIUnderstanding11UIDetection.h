...
- (void).cxx_destruct;	// IMP=0x000000000000f5c0
- (id)init;	// IMP=0x000000000000f560
- (id)initWithLabel:(long long)arg1 confidence:(double)arg2 text:(id)arg3;	// IMP=0x000000000000efc0
