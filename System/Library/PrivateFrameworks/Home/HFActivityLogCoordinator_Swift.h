...
- (id)init;	// IMP=0x00000000000589d0
- (void)eventsExistWithCompletionHandler:(void (^)(_Bool, NSError *))arg1;	// IMP=0x0000000000055ab0
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000053c90
