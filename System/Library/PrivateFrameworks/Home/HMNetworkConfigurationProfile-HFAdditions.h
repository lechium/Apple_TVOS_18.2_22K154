...
+ (id)_localizedStringForPurpose;	// IMP=0x00200000002aaa5b
+ (id)_validCurrentModesForTargetModes;	// IMP=0x00200000002aa97c
+ (_Bool)hf_currentProtectionMode:(long long)arg1 isValidForTargetProtectionMode:(long long)arg2;	// IMP=0x00200000002aa8a8
+ (_Bool)hf_targetProtectionModeIsValid:(long long)arg1;	// IMP=0x00200000002aa81b
+ (id)hf_localizedDescriptionForCredentialType:(long long)arg1;	// IMP=0x00200000002aa7da
+ (id)hf_localizedDescriptionForAllowedHostPurpose:(unsigned long long)arg1;	// IMP=0x00200000002aa48d
+ (id)hf_detailedLocalizedDescriptionForTargetProtectionMode:(long long)arg1;	// IMP=0x00200000002aa3a6
+ (id)hf_detailedLocalizedTitleForTargetProtectionMode:(long long)arg1;	// IMP=0x00200000002aa2bf
+ (id)hf_localizedTitleForTargetProtectionMode:(long long)arg1;	// IMP=0x00200000002aa1d8
