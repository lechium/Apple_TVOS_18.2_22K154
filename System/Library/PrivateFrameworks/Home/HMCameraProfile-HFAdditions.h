...
+ (unsigned long long)hf_cameraAccessModeSelectedOptionForCameraProfiles:(id)arg1 presenceType:(unsigned long long)arg2;	// IMP=0x00100000001ceb2e
- (id)hf_faceCropImageForSignificantEvent:(id)arg1;	// IMP=0x00100000001cf244
- (id)hf_significantEventWithIdentifier:(id)arg1;	// IMP=0x00100000001cee60
- (void)hf_updateDoorbellChime:(_Bool)arg1;	// IMP=0x00100000001ce8e1
...
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00100000002bd8cc
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x00100000002bd795
- (id)_hf_smartDetectionBulletinNotification;	// IMP=0x00100000002bd745
- (id)_hf_legacyMotionSensorBulletinNotification;	// IMP=0x00100000002bd6c1
- (id)_hf_doorbellBulletinNotification;	// IMP=0x00100000002bd63d
