...
@interface HFMatterAccessoryRepresentable : NSObject
{
    ...
    MISSING_TYPE *tilePath;	// 4816896 = 0x498000
    MISSING_TYPE *staticMatterDevice;	// 0 = 0x0
    MISSING_TYPE *_tileInfo;	// 0 = 0x0
    MISSING_TYPE *_deviceTypes;	// 0 = 0x0
}

- (void).cxx_destruct;	// IMP=0x0000000000028e10
- (id)init;	// IMP=0x0000000000028db0
- (id)initWithAccessory:(id)arg1;	// IMP=0x0000000000028250
- (id)hf_setTileSize:(id)arg1;	// IMP=0x000000000002a960
@property(nonatomic, readonly) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x000000000002a8a0
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x000000000002a750
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x000000000002a630
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x000000000002a130
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x000000000002a0a0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002ab50
