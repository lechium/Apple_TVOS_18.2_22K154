...
- (_Bool)hf_fake8021xNetworkSymptom;	// IMP=0x00200000001015d1
...
- (id)hf_roleForAccessory:(id)arg1;	// IMP=0x00200000001f0113
- (id)hf_accessoryForRole:(id)arg1;	// IMP=0x00200000001eff0c
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x0020000000248d54
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x0020000000248c8e
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x0020000000248bf8
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x0020000000248b5a
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x0020000000248abc
- (_Bool)hf_isValidObject;	// IMP=0x002000000028af9d
- (id)hf_identify;	// IMP=0x00200000002c6cde
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x00200000002c6c70
- (id)hf_preferredMediaUser;	// IMP=0x00200000002c6bdb
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x00200000002c6a23
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x00200000002c6a16
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000002c694b
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x00200000002c6811
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00200000002c65e6
...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00200000002c630e
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00200000002c619b
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x00200000002c613f
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x00200000002c6059
...
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x00200000002c5fb2
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x00200000002c5eb7
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x00200000002c5dbc
- (id)hf_siriLanguageOptionsManager;	// IMP=0x00200000002c5b3e
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x00200000002c59a2
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x00200000002c5901
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x00200000002c58f9
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x00200000002c5821
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x00200000002c5732
