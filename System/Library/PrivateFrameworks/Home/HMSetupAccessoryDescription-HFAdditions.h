...
- (void)hf_updateWithDiscoveredAccessory:(id)arg1;	// IMP=0x00300000001596d2
...
- (_Bool)hf_isLogitechCircleViewDoorbell;	// IMP=0x003000000015929f
- (id)hf_home;	// IMP=0x0030000000159145
@end
