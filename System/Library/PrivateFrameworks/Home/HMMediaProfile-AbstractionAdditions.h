...
- (id)hf_associatedAccessories;	// IMP=0x00200000000dc09b
- (id)hf_containedProfiles;	// IMP=0x00200000000dc089
- (id)hf_containedCharacteristics;	// IMP=0x00200000000dc01d
- (id)hf_containedServices;	// IMP=0x00200000000dbfba
- (Class)hf_itemClass;	// IMP=0x00200000000dbfa9
- (id)hf_accessoryLikeObject;	// IMP=0x00200000000dbe85
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000002491ff
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x002000000024918c
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000002490f6
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000002490a5
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x0020000000249054
- (id)hf_identify;	// IMP=0x00200000002c9e09
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x00200000002c9dc5
- (id)hf_preferredMediaUser;	// IMP=0x00200000002c9d51
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x00200000002c9b87
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x00200000002c9b16
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000002c9a72
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00200000002c9a5b
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x00200000002c99ff
...
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x00200000002c992c
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x00200000002c98b0
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x00200000002c980c
- (id)hf_siriLanguageOptionsManager;	// IMP=0x00200000002c95af
- (id)hf_mediaAccessoryCommonSettingsManager;	// IMP=0x00200000002c9311
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x00200000002c8a1c
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x00200000002c80b5
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x00200000002c80ad
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x00200000002c80a5
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x00200000002c809d
...
- (_Bool)hf_offersAutomation;	// IMP=0x00200000002c711b
...
- (id)hf_rootAccessoryLikeHomeKitObject;	// IMP=0x00200000003246f0
