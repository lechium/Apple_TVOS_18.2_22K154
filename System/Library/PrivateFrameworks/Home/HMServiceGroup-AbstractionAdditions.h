...
- (id)hf_setTileSize:(id)arg1;	// IMP=0x00200000000db5cf
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00200000000db59c
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x00200000000db540
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x00200000000db45a
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x00200000000db2c9
...
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x00200000000daffa
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00200000001233d6
...
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x0020000000247bde
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x0020000000247b3b
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x0020000000247aa5
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x0020000000247a07
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x0020000000247969
- (_Bool)hf_isValidObject;	// IMP=0x002000000028acaf
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x00200000002bd554
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)_hf_allBulletinBoardNotifications;	// IMP=0x00200000002bd47f
- (void)hf_updateApplicationData:(id)arg1 handleError:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000002da36c
- (void)_hf_didUpdateApplicationData:(id)arg1;	// IMP=0x00200000002da1d4
...
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x00200000003a511f
