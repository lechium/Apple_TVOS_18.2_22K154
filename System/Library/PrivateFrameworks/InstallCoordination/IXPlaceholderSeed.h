...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003562a
- (void).cxx_destruct;	// IMP=0x00000000000357d0
...
- (Class)clientPromiseClass;	// IMP=0x000000000003571d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000035632
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000354b4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000352ec
