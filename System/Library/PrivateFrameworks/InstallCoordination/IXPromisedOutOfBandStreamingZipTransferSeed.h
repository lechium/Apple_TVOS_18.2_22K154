...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004a0f5
- (void).cxx_destruct;	// IMP=0x000000000004a284
...
- (Class)clientPromiseClass;	// IMP=0x000000000004a1e8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004a0fd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000049f86
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000049e0d
