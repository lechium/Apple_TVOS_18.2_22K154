...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000062e72
- (void).cxx_destruct;	// IMP=0x000000000006354c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000633a0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000631c1
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000062e7a
