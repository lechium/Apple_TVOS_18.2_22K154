...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000036ae9
- (void).cxx_destruct;	// IMP=0x0000000000036c19
...
- (Class)clientPromiseClass;	// IMP=0x0000000000036ba2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036af1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000369ad
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003686e
