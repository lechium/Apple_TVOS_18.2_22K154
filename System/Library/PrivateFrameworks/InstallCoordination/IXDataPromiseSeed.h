...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004f701
- (void).cxx_destruct;	// IMP=0x000000000004f865
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004f709
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004f5bb
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004f458
