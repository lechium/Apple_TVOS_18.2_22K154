...
@class NSData, NSDictionary, NSString, _CPActionItemForFeedback, _CPCardForFeedback, _CPCoreSpotlightRankingSignalsForFeedback, _CPMailRankingSignalsForFeedback, _CPMailResultDetailsForFeedback, _CPPhotosAggregatedInfo, _CPPhotosAttributes, _CPPunchoutForFeedback, _CPSafariAttributes, _CPStruct;
