...
@class BMAccount, GDViewQuery, NSDictionary, NSNumber, NSString;

@protocol GDInternalXPCProtocol
- (void)featureKeysWithAccount:(BMAccount *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
- (void)viewSqlWithName:(NSString *)arg1 statement:(NSString *)arg2 account:(BMAccount *)arg3 completion:(void (^)(NSString *, NSError *))arg4;
- (void)viewInfoWithViewQuery:(GDViewQuery *)arg1 rows:(NSNumber *)arg2 account:(BMAccount *)arg3 completion:(void (^)(NSArray *, NSError *))arg4;
