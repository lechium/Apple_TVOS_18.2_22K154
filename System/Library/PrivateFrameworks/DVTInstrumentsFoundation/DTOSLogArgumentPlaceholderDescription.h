...
- (void).cxx_destruct;	// IMP=0x000000000001aa90
...
- (unsigned long long)hash;	// IMP=0x000000000001aa52
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001aa47
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x000000000001a574
