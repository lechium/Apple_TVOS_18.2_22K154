...
- (void).cxx_destruct;	// IMP=0x000000000002380f
...
- (void)prepareAgent:(id)arg1 loader:(id)arg2;	// IMP=0x0000000000023491
- (void)holdAgent:(id)arg1 loader:(id)arg2;	// IMP=0x00000000000229db
