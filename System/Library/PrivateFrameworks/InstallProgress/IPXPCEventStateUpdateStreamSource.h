...
- (void).cxx_destruct;	// IMP=0x0000000000007474
@property __weak id <IPStateUpdateStreamSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_queue_handleEvent:(id)arg1;	// IMP=0x00000000000071b9
- (void)resume;	// IMP=0x0000000000006fe4
- (id)initWithQueue:(id)arg1 streamName:(id)arg2;	// IMP=0x0000000000006f37
