...
- (void).cxx_destruct;	// IMP=0x000000000005b0db
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005af87
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2 modelClassName:(id)arg3;	// IMP=0x000000000005ac7e
