...
- (void).cxx_destruct;	// IMP=0x000000000006d62d
...
- (id)attributeDescriptions;	// IMP=0x000000000006ce8a
- (id)initWithStatement:(struct sqlite3_stmt *)arg1 returning:(unsigned long long)arg2;	// IMP=0x000000000006cc1b
- (id)initWithRecordRow:(unsigned long long)arg1 externalID:(id)arg2 externalData:(id)arg3 modelID:(id)arg4 modelEncoding:(unsigned long long)arg5 modelData:(id)arg6 modelSchema:(id)arg7 modelType:(id)arg8 pushEncoding:(unsigned long long)arg9 pushData:(id)arg10 pushBlockRow:(id)arg11;	// IMP=0x000000000006ca53
