...
+ (id)logCategory;	// IMP=0x006000000005c80b
- (void).cxx_destruct;	// IMP=0x000000000005c73d
...
- (void)main;	// IMP=0x000000000005c62b
- (void)cancelWithError:(id)arg1;	// IMP=0x000000000005c597
- (id)initWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000005c4fc
