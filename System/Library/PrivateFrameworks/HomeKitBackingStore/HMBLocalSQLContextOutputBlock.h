...
+ (id)logCategory;	// IMP=0x001000000007a8ec
- (void).cxx_destruct;	// IMP=0x000000000007a684
...
- (id)logIdentifier;	// IMP=0x000000000007a5c3
- (id)abort;	// IMP=0x000000000007a028
- (id)commit:(id)arg1;	// IMP=0x0000000000079a23
- (id)updateModelID:(id)arg1 modelEncoding:(unsigned long long)arg2 modelData:(id)arg3;	// IMP=0x0000000000079655
- (id)initWithOwner:(id)arg1 identifier:(id)arg2 zoneRow:(unsigned long long)arg3 blockRow:(unsigned long long)arg4;	// IMP=0x0000000000079390
