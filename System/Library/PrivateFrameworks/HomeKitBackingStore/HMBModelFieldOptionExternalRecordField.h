...
- (void).cxx_destruct;	// IMP=0x00000000000a7bbc
...
- (void)applyTo:(id)arg1;	// IMP=0x00000000000a7b0c
- (id)initWithExternalRecordField:(id)arg1 encrypted:(_Bool)arg2;	// IMP=0x00000000000a7a8d
