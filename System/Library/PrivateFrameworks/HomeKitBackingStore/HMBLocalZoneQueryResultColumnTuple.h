...
- (void).cxx_destruct;	// IMP=0x0000000000059f66
...
- (id)description;	// IMP=0x0000000000059e85
- (id)initWithName:(id)arg1 offset:(int)arg2 modelField:(id)arg3;	// IMP=0x0000000000059dd2
