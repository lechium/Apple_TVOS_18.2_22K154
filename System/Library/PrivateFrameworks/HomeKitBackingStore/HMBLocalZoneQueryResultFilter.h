...
- (void).cxx_destruct;	// IMP=0x000000000005bd18
...
- (id)fetchRowFromStatement:(struct sqlite3_stmt *)arg1 skip:(_Bool *)arg2 updatedSequence:(unsigned long long *)arg3 error:(id *)arg4;	// IMP=0x000000000005ba29
- (id)initWithLocalZone:(id)arg1 statement:(id)arg2 columns:(id)arg3 filter:(CDUnknownBlockType)arg4;	// IMP=0x000000000005b91b
