...
- (void).cxx_destruct;	// IMP=0x000000000005a8a3
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005a7bc
- (id)initWithLocalZone:(id)arg1 modelClassName:(id)arg2;	// IMP=0x000000000005a599
