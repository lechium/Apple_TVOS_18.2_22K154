...
- (void).cxx_destruct;	// IMP=0x000000000005ac28
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x000000000005ab41
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2;	// IMP=0x000000000005a91e
