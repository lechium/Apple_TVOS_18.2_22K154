...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000037f1d
- (unsigned long long)hash;	// IMP=0x0000000000037ea6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000037db4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000037cf6
- (void)copyTo:(id)arg1;	// IMP=0x0000000000037c73
- (void)writeTo:(id)arg1;	// IMP=0x0000000000037bef
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000037be2
- (id)dictionaryRepresentation;	// IMP=0x00000000000378f6
- (id)description;	// IMP=0x0000000000037847
