...
+ (Class)networkPathInfoType;	// IMP=0x0010000000008d7e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000e162
- (unsigned long long)hash;	// IMP=0x000000000000d9fa
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000d07e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c847
- (void)copyTo:(id)arg1;	// IMP=0x000000000000c1fe
- (void)writeTo:(id)arg1;	// IMP=0x000000000000bae9
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000badc
- (id)dictionaryRepresentation;	// IMP=0x0000000000009515
- (id)description;	// IMP=0x0000000000009466
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000008d61
- (unsigned long long)networkPathInfosCount;	// IMP=0x0000000000008d44
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x0000000000008cda
- (void)clearNetworkPathInfos;	// IMP=0x0000000000008cbd
