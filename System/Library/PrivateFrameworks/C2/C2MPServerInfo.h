...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000026cf5
- (unsigned long long)hash;	// IMP=0x0000000000026c71
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000026b65
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000026a7b
- (void)copyTo:(id)arg1;	// IMP=0x00000000000269d8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000026941
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000026934
- (id)dictionaryRepresentation;	// IMP=0x000000000002669f
