...
- (void).cxx_destruct;	// IMP=0x0000000000021798
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002165e
- (unsigned long long)hash;	// IMP=0x00000000000215c6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000214b2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000213c9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000021325
- (void)writeTo:(id)arg1;	// IMP=0x0000000000021285
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000021278
- (id)dictionaryRepresentation;	// IMP=0x0000000000020ea4
- (id)description;	// IMP=0x0000000000020df5
