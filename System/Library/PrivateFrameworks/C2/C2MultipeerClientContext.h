...
- (_Bool)hadFailedToDiscover;	// IMP=0x000000000000609c
- (void)stopTimer;	// IMP=0x0000000000006087
- (void)resetTimerForChunkData;	// IMP=0x0000000000006052
- (void)resetTimerForDiscovery;	// IMP=0x0000000000006022
- (void)startTimerOnQueue:(id)arg1;	// IMP=0x0000000000005cd7
- (id)init;	// IMP=0x0000000000005c2c
