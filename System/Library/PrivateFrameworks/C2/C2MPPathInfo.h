...
- (void).cxx_destruct;	// IMP=0x0000000000008458
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000834a
- (unsigned long long)hash;	// IMP=0x00000000000082af
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000081a6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000080c9
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008027
- (void)writeTo:(id)arg1;	// IMP=0x0000000000007f7a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000007f6d
- (id)dictionaryRepresentation;	// IMP=0x0000000000007b7e
- (id)description;	// IMP=0x0000000000007acf
