...
+ (Class)clientOperationType;	// IMP=0x00100000000172ff
+ (Class)operationGroupType;	// IMP=0x0010000000017195
- (void).cxx_destruct;	// IMP=0x0000000000019913
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000019322
- (unsigned long long)hash;	// IMP=0x000000000001911f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000018de9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000188e9
- (void)copyTo:(id)arg1;	// IMP=0x00000000000185d7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000018201
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000181f4
- (id)dictionaryRepresentation;	// IMP=0x000000000001744f
- (id)description;	// IMP=0x00000000000173a0
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000172e2
- (unsigned long long)clientOperationsCount;	// IMP=0x00000000000172c5
- (void)addClientOperation:(id)arg1;	// IMP=0x000000000001725b
- (void)clearClientOperations;	// IMP=0x000000000001723e
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000017178
- (unsigned long long)operationGroupsCount;	// IMP=0x000000000001715b
- (void)addOperationGroup:(id)arg1;	// IMP=0x00000000000170f1
- (void)clearOperationGroups;	// IMP=0x00000000000170d4
