...
- (void).cxx_destruct;	// IMP=0x00000000000079e4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000078da
- (unsigned long long)hash;	// IMP=0x000000000000783c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007726
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000764b
- (void)copyTo:(id)arg1;	// IMP=0x00000000000075ab
- (void)writeTo:(id)arg1;	// IMP=0x00000000000074fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000074f0
- (id)dictionaryRepresentation;	// IMP=0x00000000000070fe
- (id)description;	// IMP=0x000000000000704f
