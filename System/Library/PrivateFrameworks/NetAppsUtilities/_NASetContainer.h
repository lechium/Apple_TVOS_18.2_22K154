...
+ (id)containerWithObject:(id)arg1 atIndex:(unsigned long long)arg2 comparator:(CDUnknownBlockType)arg3 hashGenerator:(CDUnknownBlockType)arg4;	// IMP=0x0060000000004e39
- (void).cxx_destruct;	// IMP=0x0000000000005162
...
- (unsigned long long)hash;	// IMP=0x000000000000503a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004f02
