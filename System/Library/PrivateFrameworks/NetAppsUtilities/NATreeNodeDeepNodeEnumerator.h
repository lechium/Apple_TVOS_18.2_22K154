...
- (void).cxx_destruct;	// IMP=0x0000000000002f17
@property(readonly, copy, nonatomic) NATreeNode *node; // @synthesize node=_node;
@property(readonly, copy, nonatomic) NSArray *allObjects;
- (id)nextObject;	// IMP=0x0000000000002c68
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002bfe
- (id)initWithNode:(id)arg1;	// IMP=0x0000000000002b84
