...
- (void).cxx_destruct;	// IMP=0x00000000000183a5
...
- (void)invalidate;	// IMP=0x00000000000182d7
- (void)performObserverBlock;	// IMP=0x000000000001827e
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000018009
