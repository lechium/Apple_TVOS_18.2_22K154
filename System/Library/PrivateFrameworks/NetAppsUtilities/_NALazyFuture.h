...
- (void).cxx_destruct;	// IMP=0x0000000000004a09
...
- (void)willAddCompletionBlock;	// IMP=0x0000000000004723
- (id)initWithBlock:(CDUnknownBlockType)arg1 scheduler:(id)arg2;	// IMP=0x000000000000460e
