...
- (void).cxx_destruct;	// IMP=0x00000000000042fe
...
- (id)allObjects;	// IMP=0x0000000000004235
- (id)nextObject;	// IMP=0x0000000000004192
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x00000000000040dd
