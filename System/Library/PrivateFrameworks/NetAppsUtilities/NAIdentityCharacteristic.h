...
- (void).cxx_destruct;	// IMP=0x000000000001eec2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001eb91
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001ea4d
- (id)init;	// IMP=0x000000000001e9cc
