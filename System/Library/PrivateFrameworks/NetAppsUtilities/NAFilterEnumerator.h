...
- (void).cxx_destruct;	// IMP=0x00000000000040ac
...
- (id)allObjects;	// IMP=0x0000000000003fe3
- (id)nextObject;	// IMP=0x0000000000003f10
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003e5b
