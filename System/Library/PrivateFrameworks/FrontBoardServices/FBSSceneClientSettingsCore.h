...
+ (void)configureSetting:(id)arg1;	// IMP=0x0010000000073871
+ (id)descriptionOfValue:(id)arg1 forSetting:(id)arg2;	// IMP=0x001000000007379b
+ (id)protocol;	// IMP=0x001000000007378a
