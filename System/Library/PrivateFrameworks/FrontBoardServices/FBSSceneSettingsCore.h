...
+ (id)descriptionOfValue:(id)arg1 forSetting:(id)arg2;	// IMP=0x001000000002a8d4
+ (id)protocol;	// IMP=0x001000000002a8c3
...
- (void)frame:(struct CGRect)arg1;	// IMP=0x000000000002af23
