...
@interface CLSPersonIdentity (PGPersonResult) <PGGraphIngestPerson>
+ (unsigned long long)type;	// IMP=0x0010000000354549
@property(readonly, nonatomic) _Bool isInferredChild;
@property(readonly, nonatomic) _Bool isVerified;
- (long long)compareToPerson:(id)arg1;	// IMP=0x0010000000354431
