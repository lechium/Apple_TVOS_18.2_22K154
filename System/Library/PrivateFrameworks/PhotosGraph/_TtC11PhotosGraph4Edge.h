...
- (void).cxx_destruct;	// IMP=0x000000000018fa10
- (id)init;	// IMP=0x000000000018f9b0
- (id)copyWithZone:(void *)arg1;	// IMP=0x000000000018f9a0
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x000000000018f980
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 properties:(id)arg3 sourceNode:(id)arg4 targetNode:(id)arg5;	// IMP=0x000000000018f8a0
