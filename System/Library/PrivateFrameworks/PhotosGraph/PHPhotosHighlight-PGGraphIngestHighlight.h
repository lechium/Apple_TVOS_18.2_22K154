...
+ (id)fetchParentDayGroupHighlightsForDayHighlights:(id)arg1;	// IMP=0x0010000000501d98
- (unsigned short)visibilityStateForHighlightFilter:(unsigned short)arg1;	// IMP=0x00100000003de6dc
- (id)keyAssetForHighlightFilter:(unsigned short)arg1;	// IMP=0x00100000003de58a
@property(readonly, nonatomic) NSArray *extendedCuratedAssets;
@property(readonly, nonatomic) id modelObject;
- (unsigned long long)numberOfAssetsInExtendedForSharingFilter:(unsigned short)arg1;	// IMP=0x00100000003de45d
...
- (id)changeRequest;	// IMP=0x0010000000501aaa
- (double)nonDefaultCurationScorePercentageForPhotoLibrary:(id)arg1;	// IMP=0x001000000050194a
- (double)sceneAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x001000000050192f
- (double)faceAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x0010000000501914
