...
+ (id)contextWithMusicCache:(id)arg1 actionSource:(id)arg2 shouldForceMetadataRefetch:(_Bool)arg3;	// IMP=0x00600000001454c0
- (void).cxx_destruct;	// IMP=0x0000000000145610
- (id)init;	// IMP=0x00000000001455b0
