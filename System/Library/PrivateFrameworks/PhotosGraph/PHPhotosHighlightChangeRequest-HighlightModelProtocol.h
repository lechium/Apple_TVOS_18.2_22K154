...
- (void)enumerateMomentChangeRequestsForUUIDs:(id)arg1 inPhotoLibrary:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0020000000501b06
- (void)clearCurations;	// IMP=0x0020000000501ac6
