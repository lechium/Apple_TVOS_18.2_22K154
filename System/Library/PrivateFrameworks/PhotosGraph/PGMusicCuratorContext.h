...
+ (id)contextWithPhotoLibrary:(id)arg1 adamIDsWithNegativeUserFeedback:(id)arg2 allowExplicitMusicContent:(id)arg3 cache:(id)arg4 musicBag:(id)arg5 recentlyUsedSongs:(id)arg6 genre:(id)arg7 isMemoryCreationCuration:(id)arg8 configuration:(id)arg9 error:(id *)arg10;	// IMP=0x00600000001abaa0
- (void).cxx_destruct;	// IMP=0x00000000001abd20
- (id)init;	// IMP=0x00000000001abcc0
