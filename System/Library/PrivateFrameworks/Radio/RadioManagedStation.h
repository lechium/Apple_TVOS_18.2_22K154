...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000001b05
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x0000000000004e60
- (id)streamCertificateURL;	// IMP=0x0000000000004dc3
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x00000000000044bc
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x00000000000043cd
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x0000000000001fe4
- (id)additionalReferencedTrackDescriptors;	// IMP=0x0000000000001bf8
