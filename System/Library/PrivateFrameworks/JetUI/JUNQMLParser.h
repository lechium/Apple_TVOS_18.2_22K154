...
+ (void)initialize;	// IMP=0x00600000000024ac
...
- (void)parse;	// IMP=0x000000000000275f
- (void)reportParseError:(struct _xmlError *)arg1;	// IMP=0x0000000000002621
- (void)reportErrorWithCode:(unsigned long long)arg1 userInfo:(id)arg2;	// IMP=0x000000000000259c
- (id)init;	// IMP=0x0000000000002571
- (id)initWithString:(id)arg1 behavior:(unsigned long long)arg2;	// IMP=0x00000000000024f3
