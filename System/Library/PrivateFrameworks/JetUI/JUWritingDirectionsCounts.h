...
+ (id)zero;	// IMP=0x00400000000370d0
+ (id)add:(id)arg1 to:(id)arg2;	// IMP=0x0040000000036ff0
- (void).cxx_destruct;	// IMP=0x0000000000037780
- (id)init;	// IMP=0x0000000000037720
@property(nonatomic, readonly) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000036ee0
- (id)initWithNatural:(unsigned long long)arg1 leftToRight:(unsigned long long)arg2 rightToLeft:(unsigned long long)arg3;	// IMP=0x0000000000036c10
