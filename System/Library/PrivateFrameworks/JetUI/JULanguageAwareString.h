...
+ (id)JULanguageAwareStringEmpty;	// IMP=0x0010000000094240
+ (void)setDelegate:(id)arg1;	// IMP=0x0010000000094100
+ (id)delegate;	// IMP=0x0010000000094080
+ (void)setKeepStatisticsOnLanguageComponents:(_Bool)arg1;	// IMP=0x0010000000093fe0
+ (_Bool)keepStatisticsOnLanguageComponents;	// IMP=0x0010000000093f70
+ (void)setAlwaysGenerateAttributedString:(_Bool)arg1;	// IMP=0x0010000000093ec0
+ (_Bool)alwaysGenerateAttributedString;	// IMP=0x0010000000093e50
- (void).cxx_destruct;	// IMP=0x0000000000095bd0
- (id)init;	// IMP=0x0000000000095b70
- (id)writingDirectionsQuantities;	// IMP=0x0000000000095b00
- (long long)writingDirectionOfLine:(long long)arg1 maximumLinesShown:(long long)arg2 withWidth:(double)arg3 lineBreakMode:(long long)arg4 cacheLayoutInfo:(_Bool)arg5;	// IMP=0x0000000000095a80
@property(nonatomic) long long thresholdBaseWritingDirection;
- (long long)baseWritingDirectionForCharacterAtLocation:(long long)arg1;	// IMP=0x0000000000095380
- (id)initWithLanguageAwareString:(id)arg1 attributes:(id)arg2 keepStatisticsOnLanguageComponents:(_Bool)arg3;	// IMP=0x00000000000947c0
- (id)initWithString:(id)arg1 baseParagraphStyle:(id)arg2 generateAttributedString:(_Bool)arg3 keepStatisticsOnLanguageComponents:(_Bool)arg4;	// IMP=0x0000000000094640
- (id)initWithString:(id)arg1 attributes:(id)arg2 baseParagraphStyle:(id)arg3 keepStatisticsOnLanguageComponents:(_Bool)arg4;	// IMP=0x0000000000094410
- (id)initWithAttributedString:(id)arg1 baseParagraphStyle:(id)arg2 keepStatisticsOnLanguageComponents:(_Bool)arg3;	// IMP=0x0000000000094310
