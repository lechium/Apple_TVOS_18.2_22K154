...
- (void).cxx_destruct;	// IMP=0x0000000000022921
...
- (id)initWithInvitationIdentifier:(id)arg1 appleID:(id)arg2 assertion:(id)arg3 userInfo:(id)arg4;	// IMP=0x00000000000227f3
