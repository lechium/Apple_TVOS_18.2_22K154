...
- (void).cxx_destruct;	// IMP=0x0000000000023ae3
@property(nonatomic) __weak id <CATIDSServiceConnectionMessageProcessorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)receiveMessage:(id)arg1;	// IMP=0x0000000000023339
- (id)initWithWorkQueue:(id)arg1 connectionIdentifier:(id)arg2;	// IMP=0x00000000000232a0
