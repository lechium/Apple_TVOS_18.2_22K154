...
- (void).cxx_destruct;	// IMP=0x0000000000042f2c
...
- (id)initWithConnectionIdentifier:(id)arg1 senderAppleID:(id)arg2 senderAddress:(id)arg3 assertion:(id)arg4 messagingVersion:(unsigned long long)arg5 userInfo:(id)arg6;	// IMP=0x0000000000042db9
- (id)initWithSenderAppleID:(id)arg1 senderAddress:(id)arg2 assertion:(id)arg3 messagingVersion:(unsigned long long)arg4 userInfo:(id)arg5;	// IMP=0x0000000000042cd5
