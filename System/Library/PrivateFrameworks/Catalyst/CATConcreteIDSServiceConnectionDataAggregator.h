...
+ (id)missingContentTimerIdentifier;	// IMP=0x001000000000c5a5
- (void).cxx_destruct;	// IMP=0x000000000000c674
@property(nonatomic) __weak id <CATIDSServiceConnectionDataAggregatorDelegate> delegate; // @synthesize delegate=_delegate;
- (id)description;	// IMP=0x000000000000c5ff
- (void)dataAggregationCompleted:(id)arg1;	// IMP=0x000000000000c413
- (void)missingContentTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x000000000000c353
- (void)updateMissingContentTrackingForDataContent:(id)arg1;	// IMP=0x000000000000bfee
- (void)updateExistingDataWindowWithContent:(id)arg1;	// IMP=0x000000000000bebf
- (void)processNewDataWindowWithContent:(id)arg1;	// IMP=0x000000000000bdd0
- (void)receiveExpectedSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000000bce4
- (void)receiveDataContent:(id)arg1;	// IMP=0x000000000000bbbe
@property(readonly, nonatomic) unsigned long long receivedSequenceNumber;
- (id)missingSequenceNumbers;	// IMP=0x000000000000bb15
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 missingItemInterval:(double)arg3 supportsSequenceCorrection:(_Bool)arg4;	// IMP=0x000000000000ba32
