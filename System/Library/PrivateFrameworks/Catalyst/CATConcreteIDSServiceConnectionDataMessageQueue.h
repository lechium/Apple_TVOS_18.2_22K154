...
+ (id)flushTimerIdentifier;	// IMP=0x0010000000041e2d
- (void).cxx_destruct;	// IMP=0x00000000000421c4
@property(nonatomic) __weak id <CATIDSServiceConnectionDataMessageQueueDelegate> delegate; // @synthesize delegate=_delegate;
- (void)retransmitContent:(id)arg1;	// IMP=0x0000000000042060
- (void)flushTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x0000000000041fcf
- (void)scheduleFlushTimer;	// IMP=0x0000000000041e52
- (void)retransmitSequenceNumbers:(id)arg1;	// IMP=0x0000000000041d37
- (void)receiveRemoteSequenceNumber:(unsigned long long)arg1;	// IMP=0x0000000000041c03
- (void)receiveData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000417a4
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 dataChunker:(id)arg3 flushPromptInterval:(double)arg4 supportsRetransmit:(_Bool)arg5;	// IMP=0x00000000000416b7
