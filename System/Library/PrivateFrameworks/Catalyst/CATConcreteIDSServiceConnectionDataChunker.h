...
- (void).cxx_destruct;	// IMP=0x000000000002c2a2
- (id)chunkDataIntoMessageContent:(id)arg1;	// IMP=0x000000000002c0ae
- (id)initWithWorkQueue:(id)arg1 maxDataLength:(long long)arg2;	// IMP=0x000000000002c037
