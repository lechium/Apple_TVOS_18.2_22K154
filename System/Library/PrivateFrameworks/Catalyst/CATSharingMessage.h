...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000004acbd
- (void).cxx_destruct;	// IMP=0x000000000004ae66
...
- (id)initWithMessageType:(long long)arg1 contentDictionary:(id)arg2;	// IMP=0x000000000004ab46
- (id)initWithContentMessage:(id)arg1;	// IMP=0x000000000004aab8
