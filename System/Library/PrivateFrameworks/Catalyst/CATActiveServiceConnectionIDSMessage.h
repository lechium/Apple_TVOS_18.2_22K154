...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000e355
- (void).cxx_destruct;	// IMP=0x000000000000e5c0
...
- (id)initWithConnectionIdentifier:(id)arg1 receivedSequenceNumber:(id)arg2 content:(id)arg3;	// IMP=0x000000000000e0cb
