...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x00100000000423f3
- (void).cxx_destruct;	// IMP=0x0000000000042523
...
- (id)initWithConnectionIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x0000000000042242
