...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000042688
- (void).cxx_destruct;	// IMP=0x00000000000426fe
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x000000000004254b
