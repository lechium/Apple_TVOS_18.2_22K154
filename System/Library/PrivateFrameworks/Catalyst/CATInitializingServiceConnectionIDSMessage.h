...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000004a8bf
- (void).cxx_destruct;	// IMP=0x000000000004aa90
...
- (id)initWithInvitationIdentifier:(id)arg1 content:(id)arg2;	// IMP=0x000000000004a68c
