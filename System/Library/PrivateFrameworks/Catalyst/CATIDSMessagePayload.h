...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000000d7a7
- (void).cxx_destruct;	// IMP=0x000000000000da32
...
- (id)messageContent;	// IMP=0x000000000000d972
@property(readonly, copy, nonatomic) NSDictionary *dictionaryValue;
- (id)initWithMetadata:(id)arg1 message:(id)arg2;	// IMP=0x000000000000d60a
- (id)initWithMessage:(id)arg1;	// IMP=0x000000000000d582
