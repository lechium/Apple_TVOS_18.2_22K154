...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001c4af
- (unsigned long long)headerLength;	// IMP=0x000000000001c44d
@property(readonly, nonatomic) unsigned long long clientBytesWritten;
@property(readonly, nonatomic) _Bool hasBytesRemaining;
- (id)initWithData:(id)arg1 userInfo:(id)arg2;	// IMP=0x000000000001c248
