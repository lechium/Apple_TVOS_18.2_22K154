...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001925c1
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000192443
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000192409
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001919e2
- (id)init;	// IMP=0x0000000000191954
