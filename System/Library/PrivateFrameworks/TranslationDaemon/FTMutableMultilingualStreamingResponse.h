...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x0060000000193280
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000019314e
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000193114
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001928eb
- (id)init;	// IMP=0x000000000019285d
