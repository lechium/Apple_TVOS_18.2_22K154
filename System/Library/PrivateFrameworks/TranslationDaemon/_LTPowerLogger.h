...
+ (id)sharedInstance;	// IMP=0x0060000000060208
- (void).cxx_destruct;	// IMP=0x00000000000602a1
...
- (void)logTranslateRequestEvent:(id)arg1 requestType:(id)arg2 routeType:(long long)arg3;	// IMP=0x000000000006025d
- (id)init;	// IMP=0x0000000000060117
