...
+ (id)splitANECapabilityFromIdentifier:(id)arg1;	// IMP=0x0010000000023ce8
+ (id)modelFromAsset:(id)arg1;	// IMP=0x0010000000022bd1
- (void).cxx_destruct;	// IMP=0x0000000000024405
...
- (_Bool)_localFileExists;	// IMP=0x000000000002423e
...
- (_Bool)refreshState;	// IMP=0x00000000000241b8
...
- (id)_attributes;	// IMP=0x0000000000022c64
- (id)initWithMAAsset:(id)arg1;	// IMP=0x0000000000022a84
