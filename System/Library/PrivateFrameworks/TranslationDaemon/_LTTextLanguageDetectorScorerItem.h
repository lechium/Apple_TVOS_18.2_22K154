...
- (void).cxx_destruct;	// IMP=0x000000000006e2cb
...
- (double)score;	// IMP=0x000000000006e29b
- (id)initWithLocale:(id)arg1 confidence:(double)arg2 wordCount:(long long)arg3;	// IMP=0x000000000006e0e3
