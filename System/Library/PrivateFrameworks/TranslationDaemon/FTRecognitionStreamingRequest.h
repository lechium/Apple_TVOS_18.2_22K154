...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x00100000001793fb
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x00100000001793c1
- (void).cxx_destruct;	// IMP=0x0000000000179cd7
- (id)flatbuffData;	// IMP=0x0000000000179b5a
- (Offset_3f5da55c)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000001795fa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017891d
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017873a
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingRequest *)arg2;	// IMP=0x0000000000178725
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017870b
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000001786f4
