...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b6952
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b6878
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b683e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b6213
- (id)init;	// IMP=0x00000000000b6185
