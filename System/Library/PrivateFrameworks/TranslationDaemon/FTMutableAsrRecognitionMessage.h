...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000a819a
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000a7d5d
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000a7d23
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a620d
- (id)init;	// IMP=0x00000000000a617f
