...
- (void).cxx_destruct;	// IMP=0x00000000000c97cf
- (id)flatbuffData;	// IMP=0x00000000000c9652
- (Offset_53990046)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000c9211
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c8c50
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000c8aa5
- (id)initWithFlatbuffData:(id)arg1 root:(const struct FinalSpeechRecognitionResponse *)arg2;	// IMP=0x00000000000c8a90
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000c8a76
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000c8a5f
