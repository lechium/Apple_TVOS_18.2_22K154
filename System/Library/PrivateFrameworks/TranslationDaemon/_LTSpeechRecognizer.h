...
- (void).cxx_destruct;	// IMP=0x0000000000066e8c
...
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResults:(id)arg2;	// IMP=0x0000000000066e4f
- (void)speechRecognizer:(id)arg1 didRecognizePartialResult:(id)arg2;	// IMP=0x0000000000066a6d
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResultPackage:(id)arg2;	// IMP=0x00000000000668e0
- (void)speechRecognizer:(id)arg1 didFinishRecognitionWithError:(id)arg2;	// IMP=0x000000000006659c
- (void)_recognizedResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000000664b9
- (void)triggerServerSideEndPointer;	// IMP=0x00000000000663ff
- (void)cancelRecognition;	// IMP=0x0000000000066322
- (void)endAudio;	// IMP=0x0000000000066268
- (void)addSpeechAudioData:(id)arg1;	// IMP=0x000000000006616c
- (void)startRecognitionWithAutoStop:(_Bool)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000065fb0
- (id)initWithModelURL:(id)arg1 language:(id)arg2 modelVersion:(id)arg3;	// IMP=0x0000000000065c7f
