...
- (void)acoustic_profile_blob:(CDUnknownBlockType)arg1;	// IMP=0x00000000001475b7
@property(copy, nonatomic) NSData *acoustic_profile_blob;
@property(copy, nonatomic) NSString *acoustic_profile_version;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014740c
- (id)init;	// IMP=0x000000000014737e
