...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001940f1
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000193f73
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000193f39
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000193512
- (id)init;	// IMP=0x0000000000193484
