...
+ (_Bool)isPassthroughLocalePairIdentifier:(id)arg1;	// IMP=0x0060000000026a5f
+ (id)passthroughConfiguration;	// IMP=0x0060000000026981
- (void).cxx_destruct;	// IMP=0x0000000000027408
...
- (id)debugDescription;	// IMP=0x00000000000273b7
- (id)description;	// IMP=0x00000000000273a5
- (id)_offlinePairConfigurationWithIdentifier:(id)arg1 capability:(long long)arg2;	// IMP=0x0000000000026f19
- (id)offlinePairConfigurationWithIdentifier:(id)arg1;	// IMP=0x0000000000026ea1
@property(readonly, nonatomic) NSArray *languageIdentifiers;
@property(readonly, nonatomic) NSArray *languagePairs;
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000002664a
