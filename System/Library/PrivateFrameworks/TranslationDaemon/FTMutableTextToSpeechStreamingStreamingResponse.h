...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001982a2
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x00600000001981c8
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000019818e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000197b63
- (id)init;	// IMP=0x0000000000197ad5
