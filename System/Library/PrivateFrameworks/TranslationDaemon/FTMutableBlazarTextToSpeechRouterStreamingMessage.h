...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b28e3
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b2809
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b27cf
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b21a4
- (id)init;	// IMP=0x00000000000b2116
