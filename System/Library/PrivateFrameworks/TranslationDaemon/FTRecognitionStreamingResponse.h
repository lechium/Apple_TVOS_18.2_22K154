...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017acc7
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017ac8d
- (void).cxx_destruct;	// IMP=0x000000000017b771
- (id)flatbuffData;	// IMP=0x000000000017b5f4
- (Offset_48f69b49)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017af41
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000179f28
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000179d45
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionStreamingResponse *)arg2;	// IMP=0x0000000000179d30
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000179d16
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000179cff
