...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000aa840
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000aa7b1
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000aa771
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000aa344
- (id)init;	// IMP=0x00000000000aa2b6
