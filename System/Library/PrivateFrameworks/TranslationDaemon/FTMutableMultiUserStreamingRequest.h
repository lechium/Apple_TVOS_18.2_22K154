...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001905a5
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x00600000001903cf
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x0060000000190395
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018f770
- (id)init;	// IMP=0x000000000018f6e2
