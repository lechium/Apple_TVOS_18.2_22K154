...
- (void).cxx_destruct;	// IMP=0x000000000011b151
- (id)flatbuffData;	// IMP=0x000000000011afd4
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000011a42a
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000119ae0
- (unsigned long long)context_info_count;	// IMP=0x0000000000119a44
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000011994a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001194c0
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000119315
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x0000000000119300
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000001192e6
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000001192cf
