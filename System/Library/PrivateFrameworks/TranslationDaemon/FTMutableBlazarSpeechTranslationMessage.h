...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b06f2
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b0382
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b0348
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000aed2d
- (id)init;	// IMP=0x00000000000aec9f
