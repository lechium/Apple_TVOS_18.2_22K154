...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000008938d
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000089353
- (void).cxx_destruct;	// IMP=0x000000000008a1d9
- (id)flatbuffData;	// IMP=0x000000000008a05c
- (Offset_a55c7777)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000896fd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008806c
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarSpeechTranslationMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000087e89
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarSpeechTranslationMessage *)arg2;	// IMP=0x0000000000087e74
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000087e5a
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000087e43
