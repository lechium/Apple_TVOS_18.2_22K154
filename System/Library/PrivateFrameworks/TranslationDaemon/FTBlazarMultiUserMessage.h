...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x00100000000855cf
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000085595
- (void).cxx_destruct;	// IMP=0x0000000000086381
- (id)flatbuffData;	// IMP=0x0000000000086204
- (Offset_86cece31)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000085916
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000084399
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultiUserMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000841b6
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultiUserMessage *)arg2;	// IMP=0x00000000000841a1
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000084187
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000084170
