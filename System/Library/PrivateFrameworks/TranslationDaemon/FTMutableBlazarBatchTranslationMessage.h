...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b1869
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b170e
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b16d4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b0dac
- (id)init;	// IMP=0x00000000000b0d1e
