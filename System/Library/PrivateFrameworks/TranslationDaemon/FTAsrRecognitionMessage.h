...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x001000000007f4d7
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x001000000007f49d
- (void).cxx_destruct;	// IMP=0x0000000000080646
- (id)flatbuffData;	// IMP=0x00000000000804c9
- (Offset_b5e03a40)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000007f914
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007dd1f
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000007db3c
- (id)initWithFlatbuffData:(id)arg1 root:(const struct AsrRecognitionMessage *)arg2;	// IMP=0x000000000007db27
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000007db0d
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000007daf6
