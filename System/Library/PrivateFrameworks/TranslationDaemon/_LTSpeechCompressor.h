...
- (void).cxx_destruct;	// IMP=0x00000000000632e2
- (void)addAudioSampleData:(id)arg1;	// IMP=0x0000000000062f8b
- (void)reset;	// IMP=0x0000000000062f4c
- (void)startCompressionNarrowband:(_Bool)arg1;	// IMP=0x0000000000062e93
- (void)dealloc;	// IMP=0x0000000000062e55
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000062dda
