...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000ae83b
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000ae5c1
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000ae587
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ad566
- (id)init;	// IMP=0x00000000000ad4d8
