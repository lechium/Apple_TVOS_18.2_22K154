...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000019166d
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x00600000001914c7
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000019148d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000190967
- (id)init;	// IMP=0x00000000001908d9
