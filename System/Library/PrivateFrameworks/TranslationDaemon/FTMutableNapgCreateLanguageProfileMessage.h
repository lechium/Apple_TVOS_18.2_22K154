...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b3c93
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b3c04
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b3bc4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b3797
- (id)init;	// IMP=0x00000000000b3709
