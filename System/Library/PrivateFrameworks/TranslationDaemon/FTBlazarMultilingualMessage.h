...
+ (long long)session_message_typeForImmutableObject:(id)arg1;	// IMP=0x0010000000087371
+ (Class)session_message_immutableClassForType:(long long)arg1;	// IMP=0x0010000000087337
- (void).cxx_destruct;	// IMP=0x0000000000087e1b
- (id)flatbuffData;	// IMP=0x0000000000087c9e
- (Offset_a99fc554)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000875eb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000865d2
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000863ef
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BlazarMultilingualMessage *)arg2;	// IMP=0x00000000000863da
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000863c0
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000863a9
