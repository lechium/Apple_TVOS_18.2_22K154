...
+ (long long)container_message_typeForObject:(id)arg1;	// IMP=0x00600000000b8ad9
+ (long long)container_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b86c5
+ (Class)container_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b868b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b6b4c
- (id)init;	// IMP=0x00000000000b6abe
