...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000aa1e3
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000aa154
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000aa114
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000a9ce7
- (id)init;	// IMP=0x00000000000a9c59
