...
+ (long long)session_message_typeForObject:(id)arg1;	// IMP=0x00600000000b5314
+ (long long)session_message_typeForMutableObject:(id)arg1;	// IMP=0x00600000000b5212
+ (Class)session_message_mutableClassForType:(long long)arg1;	// IMP=0x00600000000b51d8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b4aae
- (id)init;	// IMP=0x00000000000b4a20
