...
- (void).cxx_destruct;	// IMP=0x0000000000004803
...
- (void)writeToURL:(id)arg1;	// IMP=0x00000000000045d5
- (_Bool)_populateWithOpusData:(id)arg1;	// IMP=0x0000000000004384
- (id)initWithASBD:(struct AudioStreamBasicDescription)arg1 rawData:(id)arg2 wordTimingInfo:(id)arg3;	// IMP=0x0000000000004266
