...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000018f27e
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018f004
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000018efca
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018dfa9
- (id)init;	// IMP=0x000000000018df1b
