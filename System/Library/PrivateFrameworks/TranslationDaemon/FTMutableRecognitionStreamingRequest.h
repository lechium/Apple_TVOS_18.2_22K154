...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000018db9b
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000018d99c
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000018d962
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018cc3e
- (id)init;	// IMP=0x000000000018cbb0
