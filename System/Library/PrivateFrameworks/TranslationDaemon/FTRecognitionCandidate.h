...
- (void).cxx_destruct;	// IMP=0x00000000000fcafb
- (id)flatbuffData;	// IMP=0x00000000000fc97e
- (Offset_adec5a97)addObjectToBuffer:(void *)arg1;	// IMP=0x00000000000fc460
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fbdc6
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000fbc1b
- (id)initWithFlatbuffData:(id)arg1 root:(const struct RecognitionCandidate *)arg2;	// IMP=0x00000000000fbc06
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000000fbbec
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000000fbbd5
