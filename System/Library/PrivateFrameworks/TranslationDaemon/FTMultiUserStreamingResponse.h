...
+ (long long)content_typeForImmutableObject:(id)arg1;	// IMP=0x001000000017d750
+ (Class)content_immutableClassForType:(long long)arg1;	// IMP=0x001000000017d716
- (void).cxx_destruct;	// IMP=0x000000000017def1
- (id)flatbuffData;	// IMP=0x000000000017dd74
- (Offset_3fe3bcde)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000017d8f6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017ce48
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000017cc65
- (id)initWithFlatbuffData:(id)arg1 root:(const struct MultiUserStreamingResponse *)arg2;	// IMP=0x000000000017cc50
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000017cc36
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000017cc1f
