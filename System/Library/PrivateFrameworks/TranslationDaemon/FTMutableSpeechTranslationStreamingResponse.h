...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x00600000001954a0
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x0060000000195278
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000019523e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019441b
- (id)init;	// IMP=0x000000000019438d
