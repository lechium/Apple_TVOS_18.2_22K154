...
- (void).cxx_destruct;	// IMP=0x0000000000018798
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000185ae
- (unsigned long long)hash;	// IMP=0x000000000001850f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000183d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000182bf
- (void)copyTo:(id)arg1;	// IMP=0x00000000000181fc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000018148
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000017e32
- (id)dictionaryRepresentation;	// IMP=0x0000000000017c79
- (id)description;	// IMP=0x0000000000017bca
