...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000019a0fc
- (void).cxx_destruct;	// IMP=0x000000000019a0d4
...
- (void)dealloc;	// IMP=0x0000000000199fe5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000199cfa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000199bc4
