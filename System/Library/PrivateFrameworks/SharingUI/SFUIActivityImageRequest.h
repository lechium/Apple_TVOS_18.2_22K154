...
- (void).cxx_destruct;	// IMP=0x000000000002bc10
...
- (id)initWithRequestID:(int)arg1 activity:(id)arg2 contentSizeCategory:(id)arg3 userInterfaceStyle:(long long)arg4 imageSymbolConfiguration:(id)arg5 synchronous:(_Bool)arg6 resultHandler:(CDUnknownBlockType)arg7;	// IMP=0x000000000002ba48
- (id)initWithRequestID:(int)arg1 uti:(id)arg2 activityCategory:(long long)arg3 contentSizeCategory:(id)arg4 userInterfaceStyle:(long long)arg5 iconFormat:(int)arg6 synchronous:(_Bool)arg7 resultHandler:(CDUnknownBlockType)arg8;	// IMP=0x000000000002b95c
- (id)initWithRequestID:(int)arg1 identifier:(id)arg2 activityCategory:(long long)arg3 contentSizeCategory:(id)arg4 userInterfaceStyle:(long long)arg5 iconFormat:(int)arg6 synchronous:(_Bool)arg7 resultHandler:(CDUnknownBlockType)arg8;	// IMP=0x000000000002b8a0
