...
- (void).cxx_destruct;	// IMP=0x0000000000009ece
...
- (id)initWithRequestID:(int)arg1 identifier:(id)arg2 synchronous:(_Bool)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000009dd7
