...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000ad40
- (void).cxx_destruct;	// IMP=0x000000000000b133
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000ae01
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000ab53
- (id)init;	// IMP=0x000000000000a9c5
