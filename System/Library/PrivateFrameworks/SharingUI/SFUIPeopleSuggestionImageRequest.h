...
- (void).cxx_destruct;	// IMP=0x0000000000033301
...
- (id)initWithRequestID:(int)arg1 peopleSuggestion:(id)arg2 type:(long long)arg3 resultHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000331f2
