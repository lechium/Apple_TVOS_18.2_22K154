...
- (void).cxx_destruct;	// IMP=0x00000000000210ab
...
- (void)invalidate;	// IMP=0x0000000000020ff5
- (id)initWithQuery:(id)arg1 priority:(long long)arg2 processAsync:(_Bool)arg3 withCompletionQueue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000020f0e
