...
- (void).cxx_destruct;	// IMP=0x00000000000322aa
...
- (id)_initWithSuccess:(_Bool)arg1 domainVersion:(id)arg2 peerPutItems:(id)arg3 putOKKeys:(id)arg4 rejectedKeys:(id)arg5;	// IMP=0x000000000003215a
