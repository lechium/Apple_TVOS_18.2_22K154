...
- (void).cxx_destruct;	// IMP=0x00000000000826d6
...
- (id)initWithevent:(unsigned long long)arg1 identity:(id)arg2 assertionCount:(int)arg3 pid:(int)arg4;	// IMP=0x0000000000082625
