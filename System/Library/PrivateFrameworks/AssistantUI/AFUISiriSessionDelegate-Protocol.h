...
- (void)siriSessionDidReceiveStartGenAIEnablementFlowCommand:(SAUIStartGenAIEnablementFlow *)arg1 completion:(void (^)(AceObject<SAAceCommand> *))arg2;
- (void)siriSessionDidReceiveStartImmersiveExperienceCommand:(SAUIStartImmersiveExperience *)arg1 completion:(void (^)(AceObject<SAAceCommand> *))arg2;
...
- (void)siriSessionRequestedCancelPhotoSelectionWithAnimation:(_Bool)arg1;
- (void)siriSessionRequestedPhotoSelectionWithSearchString:(NSString *)arg1 completion:(void (^)(NSArray *))arg2;
