...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x002000000000f56d
@property(readonly, nonatomic) UITraitCollection *traitCollection;
- (void)_ui_removeFromParentLayoutItem;	// IMP=0x002000000000f4d1
- (void)_ui_insertSubLayoutItem:(id)arg1 atIndex:(long long)arg2;	// IMP=0x002000000000f45a
- (void)_ui_addSubLayoutItem:(id)arg1;	// IMP=0x002000000000f3ea
- (void)_ui_addToView:(id)arg1 atIndex:(long long)arg2;	// IMP=0x002000000000f3cf
