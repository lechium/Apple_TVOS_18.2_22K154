...
- (void).cxx_destruct;	// IMP=0x0000000000003e63
...
- (id)debugDescriptionWithWhitespacePrefix:(id)arg1;	// IMP=0x0000000000003ac0
- (id)debugDescription;	// IMP=0x0000000000003aa7
- (id)initWithEntryLevel:(unsigned long long)arg1;	// IMP=0x0000000000003a46
