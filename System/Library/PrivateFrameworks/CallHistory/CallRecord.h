...
+ (id)fetchRequest;	// IMP=0x00800000000218d6
...
- (_Bool)supportsJunkConfidence;	// IMP=0x000000000000c4e8
...
- (_Bool)addEmergencyMediaItem:(id)arg1;	// IMP=0x000000000000be8d
- (id)compositeEmergencyMediaItemsForContext:(id)arg1;	// IMP=0x000000000000bc59
- (id)compositeVerificationStatusForContext:(id)arg1;	// IMP=0x000000000000bbf9
- (id)compositeServiceProviderForContext:(id)arg1;	// IMP=0x000000000000bb5b
- (id)compositeInitiatorHandleForContext:(id)arg1;	// IMP=0x000000000000ba67
- (id)compositeRemoteParticipantHandlesForContext:(id)arg1;	// IMP=0x000000000000b7df
- (id)compositeParticipantGroupUUIDForContext:(id)arg1;	// IMP=0x000000000000b79b
- (id)compositeOutgoingLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x000000000000b757
- (id)compositeLocalParticipantUUIDForContext:(id)arg1;	// IMP=0x000000000000b713
- (id)compositeCallDirectoryIdentityType:(id)arg1;	// IMP=0x000000000000b6b3
- (id)compositeJunkConfidenceForContext:(id)arg1;	// IMP=0x000000000000b653
- (id)compositeHandleTypeForContext:(id)arg1;	// IMP=0x000000000000b61e
- (id)compositeCallCategoryForContext:(id)arg1;	// IMP=0x000000000000b56a
