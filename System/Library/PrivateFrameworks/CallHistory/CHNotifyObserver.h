...
- (void).cxx_destruct;	// IMP=0x000000000003bd77
...
- (void)dealloc;	// IMP=0x000000000003bd07
- (id)initWithName:(id)arg1 queue:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x000000000003bb1b
