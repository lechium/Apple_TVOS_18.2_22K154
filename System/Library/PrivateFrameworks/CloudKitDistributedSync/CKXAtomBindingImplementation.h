...
- (void).cxx_destruct;	// IMP=0x00000000000c85d9
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (id)orcHelpers;	// IMP=0x00000000000c8527
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000c8419
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000c830b
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000c8122
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000c8118
- (id)init;	// IMP=0x00000000000c809e
