...
+ (_Bool)sqliteDatabaseExistsAtURL:(id)arg1;	// IMP=0x006000000000ae09
- (void).cxx_destruct;	// IMP=0x000000000000b5e9
...
- (_Bool)isDataLoaded;	// IMP=0x000000000000b189
- (_Bool)hasNotPassedExpiryDate:(id)arg1 isForCountryCode:(id)arg2;	// IMP=0x000000000000afd8
- (_Bool)isDataValid;	// IMP=0x000000000000af31
- (id)initWithClusterType:(long long)arg1 databaseMaxAge:(double)arg2 forStorefront:(id)arg3 databaseFilePathURL:(id)arg4;	// IMP=0x000000000000ae81
