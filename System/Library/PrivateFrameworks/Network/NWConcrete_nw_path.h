...
@interface NWConcrete_nw_path : NSObject
{
    ...
    unsigned int override_reason:1;	// 476 = 0x1dc
...
- (void).cxx_destruct;	// IMP=0x00000000009e68c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009e6800
- (id)redactedDescription;	// IMP=0x00000000009e67e0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000009e5210
- (id)init;	// IMP=0x00000000009e4f40
