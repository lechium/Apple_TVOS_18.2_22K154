...
- (void).cxx_destruct;	// IMP=0x00000000001748f0
- (void)dealloc;	// IMP=0x0000000000174870
- (id)redactedDescription;	// IMP=0x0000000000174760
- (id)description;	// IMP=0x0000000000174720
- (void)startEvaluator;	// IMP=0x0000000000174660
- (void)handleNewPath:(id)arg1;	// IMP=0x00000000001745b0
- (_Bool)isEligible;	// IMP=0x0000000000174540
- (id)initCandidate:(id)arg1 forManager:(id)arg2 evaluator:(id)arg3;	// IMP=0x0000000000174180
