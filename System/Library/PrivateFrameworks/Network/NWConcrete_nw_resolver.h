...
@interface NWConcrete_nw_resolver : NSObject
{
    ...
    unsigned int has_nat64_prefixes:1;	// 347 = 0x15b
    ...
    unsigned int has_completed_preferred_weighting:1;	// 348 = 0x15c
    unsigned int use_persistent_cache:1;	// 348 = 0x15c
}

- (id).cxx_construct;	// IMP=0x00000000001e78e0
- (void).cxx_destruct;	// IMP=0x00000000001e77e0
- (id)redactedDescription;	// IMP=0x00000000001e77c0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000001e6930
