...
- (void).cxx_destruct;	// IMP=0x0000000000164250
...
- (id)snapshot;	// IMP=0x0000000000163e80
- (void)reset;	// IMP=0x0000000000163e20
- (void)updateWithState:(id)arg1 atTime:(double)arg2;	// IMP=0x0000000000163a80
- (id)description;	// IMP=0x00000000001639e0
- (void)dealloc;	// IMP=0x0000000000163950
- (id)initWithName:(id)arg1;	// IMP=0x00000000001637d0
