...
- (id).cxx_construct;	// IMP=0x00000000008d7300
- (void).cxx_destruct;	// IMP=0x00000000008d7260
- (id)redactedDescription;	// IMP=0x00000000008d7240
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000008d70a0
