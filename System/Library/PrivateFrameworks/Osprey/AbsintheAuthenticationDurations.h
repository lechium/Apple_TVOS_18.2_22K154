...
- (void).cxx_destruct;	// IMP=0x0000000000006caf
...
- (id)calculateDuration:(id)arg1 and:(id)arg2;	// IMP=0x0000000000006b7a
- (void)setAbsintheConnectionMethodWith:(id)arg1;	// IMP=0x0000000000006b33
- (void)setAbsintheAuthenticationTimestampForKey:(id)arg1;	// IMP=0x0000000000006a24
- (void)reportAbsintheAuthenticationDurations;	// IMP=0x000000000000668e
