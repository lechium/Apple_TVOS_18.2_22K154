...
- (void).cxx_destruct;	// IMP=0x000000000030ab52
...
- (void)prepareForReuse;	// IMP=0x00000000003090c5
- (void)handleTapWithGestureRecognizer:(id)arg1;	// IMP=0x0000000000308e33
- (void)layoutSubviews;	// IMP=0x0000000000308d81
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000003084af
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000307f11
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000307d0a
