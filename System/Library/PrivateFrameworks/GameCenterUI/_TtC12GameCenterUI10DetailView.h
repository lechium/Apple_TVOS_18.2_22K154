...
- (void).cxx_destruct;	// IMP=0x00000000001e55c4
- (void)didTapWithAccessoryView:(id)arg1;	// IMP=0x00000000001e4465
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000000001e4339
- (void)layoutSubviews;	// IMP=0x00000000001e3f47
- (void)wasTapped;	// IMP=0x00000000001e3b17
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001e3269
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001e310d
