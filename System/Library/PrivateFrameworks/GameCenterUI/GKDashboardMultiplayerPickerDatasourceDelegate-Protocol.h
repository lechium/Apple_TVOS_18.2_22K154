...
@class GKDashboardMultiplayerPickerDataSource, NSArray, UICollectionView, UIView, _TtC12GameCenterUI22GKSuggestedPlayerGroup;
...
- (void)pickerDatasource:(GKDashboardMultiplayerPickerDataSource *)arg1 didChooseFriendFilter:(UIView *)arg2;
