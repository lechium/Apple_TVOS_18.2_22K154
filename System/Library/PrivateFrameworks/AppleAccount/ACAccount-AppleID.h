...
- (_Bool)canRemoveAccount;	// IMP=0x003000000005aea9
- (id)_registeredBundles;	// IMP=0x003000000005ae90
- (id)normalizedDSID;	// IMP=0x003000000005aca0
- (id)dsid;	// IMP=0x003000000005ac84
- (void)setDSID:(id)arg1;	// IMP=0x003000000005ac68
- (id)appleID;	// IMP=0x003000000005ac56
- (void)storeOriginalUsername;	// IMP=0x003000000005aef1
- (_Bool)_aa_skipATVTermsPrompt;	// IMP=0x003000000009a50c
- (void)_aa_recordATVTermsPrompt;	// IMP=0x003000000009a3a6
- (void)_aa_clearRawPassword;	// IMP=0x003000000009a358
@property(copy, nonatomic, setter=_aa_setRawPassword:) NSString *_aa_rawPassword;
- (void)_aa_setPrimaryEmail:(id)arg1;	// IMP=0x003000000009a1a1
- (void)_aa_setAltDSID:(id)arg1;	// IMP=0x003000000009a14f
- (void)_aa_setAppleID:(id)arg1;	// IMP=0x003000000009a0fd
- (_Bool)aa_isDuplicateAccount:(id)arg1;	// IMP=0x0030000000099bb6
- (_Bool)_aa_isExistingAccount:(id)arg1;	// IMP=0x0030000000099a91
- (_Bool)aa_hasDuplicateAccount;	// IMP=0x0030000000099874
- (void)_aa_setDataclassProperties:(id)arg1;	// IMP=0x0030000000099862
- (_Bool)aa_updateTokensWithProvisioningResponse:(id)arg1;	// IMP=0x0030000000098f91
- (void)aa_updateWithProvisioningResponse:(id)arg1;	// IMP=0x0030000000098180
- (void)aa_setUseCellular:(_Bool)arg1 forDataclass:(id)arg2;	// IMP=0x00300000000980b1
- (_Bool)aa_useCellularForDataclass:(id)arg1;	// IMP=0x0030000000098038
- (id)aa_hsaTokenWithError:(id *)arg1;	// IMP=0x0030000000097ff5
- (id)aa_authTokenWithError:(id *)arg1;	// IMP=0x0030000000097f55
- (void)aa_setMDMServerToken:(id)arg1;	// IMP=0x0030000000097e15
@property(readonly, nonatomic) NSString *aa_mdmServerToken;
- (void)aa_setMapsToken:(id)arg1;	// IMP=0x0030000000097c85
...
- (void)_aa_setTermsServerInfo:(id)arg1;	// IMP=0x0030000000097644
- (id)_aa_termsServerInfo;	// IMP=0x0030000000097633
...
- (_Bool)_hasMailDataclassProperties;	// IMP=0x00300000000974fb
- (_Bool)_dataclassIsDisabledForProperties:(id)arg1;	// IMP=0x00300000000974a6
- (_Bool)aa_serverDisabledDataclass:(id)arg1;	// IMP=0x00300000000973c9
...
- (_Bool)aa_updateAccountClassIfNecessary;	// IMP=0x00300000000967e3
@property(copy, nonatomic, setter=aa_setAccountClass:) NSString *aa_accountClass;
- (_Bool)aa_isAccountClass:(id)arg1;	// IMP=0x00300000000965bb
...
- (void)_aa_setAppProvidedContext:(id)arg1;	// IMP=0x003000000009ab87
- (id)_aa_appProvidedContext;	// IMP=0x003000000009ab6e
- (void)_aa_setPrimaryAccountUpdaterVersion:(id)arg1;	// IMP=0x003000000009ab55
- (id)_aa_primaryAccountUpdaterVersion;	// IMP=0x003000000009ab3c
- (void)_aa_setLastAgreedTermsInfo:(id)arg1;	// IMP=0x003000000009aaea
- (void)_aa_setPersonID:(id)arg1;	// IMP=0x003000000009aa98
