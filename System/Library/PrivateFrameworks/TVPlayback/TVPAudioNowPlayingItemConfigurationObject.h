...
- (void).cxx_destruct;	// IMP=0x0000000000097609
...
- (_Bool)_isStringEqual:(id)arg1 rhsString:(id)arg2;	// IMP=0x000000000009745e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000097042
