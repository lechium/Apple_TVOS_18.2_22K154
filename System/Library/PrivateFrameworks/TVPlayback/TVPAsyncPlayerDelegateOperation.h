...
- (void).cxx_destruct;	// IMP=0x00000000000093f6
@property(copy, nonatomic) CDUnknownBlockType block; // @synthesize block=_block;
@property(readonly, nonatomic) NSNumber *identifier; // @synthesize identifier=_identifier;
- (unsigned long long)hash;	// IMP=0x000000000000938f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000092db
- (id)init;	// IMP=0x0000000000009263
