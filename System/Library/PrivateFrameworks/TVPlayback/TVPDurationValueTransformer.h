...
+ (_Bool)allowsReverseTransformation;	// IMP=0x006000000009e331
+ (Class)transformedValueClass;	// IMP=0x006000000009e320
- (void).cxx_destruct;	// IMP=0x000000000009e48d
...
- (id)transformedValue:(id)arg1;	// IMP=0x000000000009e339
- (id)init;	// IMP=0x000000000009e241
