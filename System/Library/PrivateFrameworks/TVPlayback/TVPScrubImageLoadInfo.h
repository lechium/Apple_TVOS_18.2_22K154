...
- (void).cxx_destruct;	// IMP=0x0000000000023b70
...
- (unsigned long long)hash;	// IMP=0x0000000000023ad4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000023a4d
- (id)description;	// IMP=0x0000000000023a12
