...
- (void)setView:(id)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006f025
- (id)viewForContentType:(long long)arg1;	// IMP=0x000000000006efa5
- (void)setPreferredSize:(struct CGSize)arg1 forContentType:(long long)arg2;	// IMP=0x000000000006ec25
- (struct CGSize)preferredSizeForContentType:(long long)arg1;	// IMP=0x000000000006eb72
- (id)_keyForContentType:(long long)arg1;	// IMP=0x000000000006eb59
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000006eb15
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006e329
