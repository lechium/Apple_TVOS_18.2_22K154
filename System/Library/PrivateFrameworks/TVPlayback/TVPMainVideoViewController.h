...
- (void).cxx_destruct;	// IMP=0x000000000000b82e
...
- (void)viewDidLoad;	// IMP=0x000000000000b29f
- (void)loadView;	// IMP=0x000000000000b1c8
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000000b0a7
- (void)_addPlaybackView:(id)arg1;	// IMP=0x000000000000ae3b
- (void)_handleSelectButton:(id)arg1;	// IMP=0x000000000000ad2b
- (void)_didSelect;	// IMP=0x000000000000acce
- (void)preserveVideoViewForReuse;	// IMP=0x000000000000ab2a
- (id)initWithPlayer:(id)arg1;	// IMP=0x000000000000aab8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000aa8d
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000000aa62
