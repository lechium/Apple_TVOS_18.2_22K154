...
- (void).cxx_destruct;	// IMP=0x00000000000065d3
...
- (void)_updateMasks;	// IMP=0x00000000000061c3
- (void)layoutSubviews;	// IMP=0x0000000000006182
- (void)setMinPlayheadProgress:(double)arg1 maxPlayheadProgress:(double)arg2;	// IMP=0x0000000000005fda
- (void)setMinBufferingProgress:(double)arg1 maxBufferingProgress:(double)arg2;	// IMP=0x0000000000005e64
- (void)_commonInit;	// IMP=0x0000000000005b62
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000005b16
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000005ab9
