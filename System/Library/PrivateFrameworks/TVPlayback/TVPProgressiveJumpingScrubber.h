...
- (void).cxx_destruct;	// IMP=0x00000000000f86cc
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000f84c2
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000f83f0
- (void)cancelScrub;	// IMP=0x00000000000f83be
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000f82df
