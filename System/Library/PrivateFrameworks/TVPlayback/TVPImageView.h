...
- (void).cxx_destruct;	// IMP=0x0000000000072601
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x0000000000072485
- (void)_setImage:(id)arg1;	// IMP=0x0000000000072336
- (id)_imageView;	// IMP=0x00000000000721b9
- (void)_loadImage;	// IMP=0x0000000000071b8c
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000071a18
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000071632
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000071535
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000007147c
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00000000000713ea
- (void)setContentMode:(long long)arg1;	// IMP=0x00000000000713c2
- (void)layoutSubviews;	// IMP=0x0000000000071346
- (long long)contentMode;	// IMP=0x0000000000071329
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000007130c
- (void)dealloc;	// IMP=0x00000000000712a7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000711a0
