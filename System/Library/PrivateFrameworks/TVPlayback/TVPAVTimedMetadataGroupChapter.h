...
- (void).cxx_destruct;	// IMP=0x0000000000009232
...
- (void)_loadChapterNameFromMetadataItem:(id)arg1;	// IMP=0x0000000000008f61
- (id)imageProxy;	// IMP=0x0000000000008ebc
- (id)initWithAVTimedMetadataGroup:(id)arg1 filterByLanguages:(id)arg2;	// IMP=0x0000000000008c01
