...
+ (void)initialize;	// IMP=0x006000000001627b
- (void).cxx_destruct;	// IMP=0x000000000001658e
...
- (_Bool)isFinished;	// IMP=0x000000000001642a
- (double)currentPlaybackTime;	// IMP=0x00000000000162cb
