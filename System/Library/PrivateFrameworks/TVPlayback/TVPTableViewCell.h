...
- (double)_textLabelWidthWithXPosition:(double)arg1 currentWidth:(double)arg2;	// IMP=0x00000000000058c8
- (void)_updateImage;	// IMP=0x00000000000057b1
- (void)layoutSubviews;	// IMP=0x000000000000526a
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000004be5
- (id)labelForMarquee;	// IMP=0x0000000000004b72
- (_Bool)canBecomeFocused;	// IMP=0x0000000000004b1a
- (void)prepareForReuse;	// IMP=0x0000000000004a46
- (void)dealloc;	// IMP=0x00000000000049e1
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000004918
