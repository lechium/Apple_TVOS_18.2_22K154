...
- (void).cxx_destruct;	// IMP=0x0000000000047b40
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x0000000000047924
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x0000000000047850
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x000000000004761b
- (void)_cancelAllImageLoads;	// IMP=0x0000000000047587
- (void)_loadImagesIfNecessary;	// IMP=0x0000000000046a7a
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x0000000000046672
- (void)invalidate;	// IMP=0x000000000004665d
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x000000000004626b
