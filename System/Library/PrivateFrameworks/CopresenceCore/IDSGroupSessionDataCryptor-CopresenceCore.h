...
- (id)decryptData:(id)arg1 keyID:(id)arg2 seqNum:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x0020000000003bcd
- (id)encryptData:(id)arg1 seqNum:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0020000000003bbb
