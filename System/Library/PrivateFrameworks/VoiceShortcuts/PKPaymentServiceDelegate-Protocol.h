...
- (void)paymentPassWithUniqueIdentifier:(NSString *)arg1 didReceivePlanUpdate:(NSArray *)arg2;
...
- (void)passWithUniqueIdentifier:(NSString *)arg1 didUpdateTiles:(NSArray *)arg2 forContext:(long long)arg3;
