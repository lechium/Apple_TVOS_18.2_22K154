...
@class FPItem, FPSandboxingURLWrapper, INIntent, INShortcut, LNAction, LNActionMetadata, NSArray, NSData, NSDictionary, NSError, NSNumber, NSSet, NSString, WFDatabaseObjectDescriptor, WFDialogAttribution, WFDialogRequest, WFItemProviderRequestMetadata, WFOnScreenContentServiceOptions, WFRemoteImageDrawingContext, WFResultQuery, WFSpringBoardWebClipMetadata, WFStaccatoActionTemplate, WFStaccatoActionTemplateParameter, WFWorkflowDescriptor, WFWorkflowReference, WFWorkflowRunningContext;
...
- (void)loadFileURLWithItemProviderRequestMetadata:(WFItemProviderRequestMetadata *)arg1 type:(NSString *)arg2 openInPlace:(_Bool)arg3 completion:(void (^)(NSSecurityScopedURLWrapper *, NSError *))arg4;
...
- (void)requestSandboxExtensionForToolKitIndexingWithCompletion:(void (^)(NSSet *, NSSecurityScopedURLWrapper *, NSError *))arg1;
...
- (void)storeSerializedParameters:(NSData *)arg1 forAppEntityIdentifier:(NSString *)arg2 queryName:(NSString *)arg3 badgeType:(unsigned long long)arg4 completion:(void (^)(NSError *))arg5;
