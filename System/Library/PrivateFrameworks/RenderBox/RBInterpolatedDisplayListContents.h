...
+ (id)decodedObjectWithData:(id)arg1 delegate:(id)arg2 error:(id *)arg3;	// IMP=0x001000000003720f
- (id).cxx_construct;	// IMP=0x0000000000037307
- (void).cxx_destruct;	// IMP=0x00000000000372e6
@property(readonly, nonatomic) const void *_rb_xml_document;
@property(readonly, nonatomic) const void *_rb_contents;
- (id)encodedDataForDelegate:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000371a3
@property(readonly, copy, nonatomic) NSString *xmlDescription;
- (void)renderInContext:(struct CGContext *)arg1 options:(id)arg2;	// IMP=0x00000000000370a6
- (void)_drawInState:(struct _RBDrawingState *)arg1 alpha:(float)arg2;	// IMP=0x000000000003708d
- (void)drawInState:(struct _RBDrawingState *)arg1;	// IMP=0x000000000003706c
