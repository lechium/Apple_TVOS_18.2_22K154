...
+ (id)shared;	// IMP=0x004000000010d080
- (void).cxx_destruct;	// IMP=0x000000000010e5a0
- (void)emitWithEvent:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x000000000010d830
- (id)makeSpeechJobIdentifier;	// IMP=0x000000000010d650
- (id)init;	// IMP=0x000000000010d530
