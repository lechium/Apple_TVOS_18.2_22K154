...
- (_Bool)hasNativeFocusElements;	// IMP=0x0020000000004f06
- (_Bool)moveFocusWithHeading:(unsigned long long)arg1 withQueryString:(id)arg2;	// IMP=0x0020000000004e2a
- (_Bool)moveFocusWithHeading:(unsigned long long)arg1 byGroup:(_Bool)arg2;	// IMP=0x0020000000004d3a
- (void)didFocus;	// IMP=0x0020000000004cf8
- (void)disableFocus;	// IMP=0x0020000000004cda
- (void)enableFocus;	// IMP=0x0020000000004cbc
- (void)focusOnApplication;	// IMP=0x0020000000004c9e
- (void)focusOnRemoteSceneID;	// IMP=0x0020000000004c03
- (id)remoteSceneID;	// IMP=0x0020000000004b8a
