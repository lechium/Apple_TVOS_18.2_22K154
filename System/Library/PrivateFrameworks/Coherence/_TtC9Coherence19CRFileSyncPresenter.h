...
- (void).cxx_destruct;	// IMP=0x00000000004022b0
- (id)init;	// IMP=0x0000000000402250
- (void)presentedItemDidGainVersion:(id)arg1;	// IMP=0x0000000000402200
- (void)presentedItemDidChange;	// IMP=0x0000000000401ef0
