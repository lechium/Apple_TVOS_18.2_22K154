...
+ (id)logCategory;	// IMP=0x00100000000558d9
- (void).cxx_destruct;	// IMP=0x0000000000055998
...
- (void)URLSession:(id)arg1 didReceiveChallenge:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000055181
- (id)init;	// IMP=0x0000000000054fa4
