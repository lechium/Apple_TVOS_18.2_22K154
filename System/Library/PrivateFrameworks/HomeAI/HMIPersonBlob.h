...
- (void).cxx_destruct;	// IMP=0x0000000000031018
...
- (id)shortDescription;	// IMP=0x0000000000030d02
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000030c8c
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x000000000003048c
- (void)trackPersonBlob:(id)arg1;	// IMP=0x000000000003043d
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000030208
