...
- (void).cxx_destruct;	// IMP=0x00000000000d6bea
...
- (double)analysisFPS;	// IMP=0x00000000000d6809
- (void)setEncode:(_Bool)arg1;	// IMP=0x00000000000d67f9
- (_Bool)encode;	// IMP=0x00000000000d67e9
- (void)setMonitored:(_Bool)arg1;	// IMP=0x00000000000d67d9
- (_Bool)monitored;	// IMP=0x00000000000d67c9
- (unsigned long long)status;	// IMP=0x00000000000d6747
- (void)setAnalysisFPS:(double)arg1;	// IMP=0x00000000000d65cf
- (double)delay;	// IMP=0x00000000000d657f
@property(readonly) double timeSinceLastFragmentWasReceived;
@property(readonly) double timeSinceAnalyzerStarted;
- (id)state;	// IMP=0x00000000000d61ae
- (void)_produceResult:(SEL)arg1 withArguments:(id)arg2;	// IMP=0x00000000000d5f85
- (void)_notifyDelegateDidProduceAnalysisStateUpdate:(id)arg1;	// IMP=0x00000000000d5e91
- (void)_notifyDelegateDidFailWithError:(id)arg1;	// IMP=0x00000000000d5be9
- (void)_notifyDelegateDidCreateTimelapseFragment:(id)arg1;	// IMP=0x00000000000d5abe
- (void)_notifyDelegateDidAnalyzeFrameWithResult:(id)arg1;	// IMP=0x00000000000d59ca
- (void)_notifyDelegateDidAnalyzeFragmentWithResult:(id)arg1;	// IMP=0x00000000000d575a
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000000d5652
- (void)encoder:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000d54e4
- (void)decoder:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000d54cf
- (void)assetWriter:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000d54ba
- (void)assetWriter:(id)arg1 didOutputSeparableSegment:(id)arg2 segmentReport:(id)arg3;	// IMP=0x00000000000d4aad
- (void)assetWriter:(id)arg1 didOutputInitializationSegment:(id)arg2;	// IMP=0x00000000000d49f5
- (void)frameSampler:(id)arg1 didSampleFrame:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000d47a7
- (void)frameAnalyzer:(id)arg1 didProduceAnalysisStateUpdate:(id)arg2;	// IMP=0x00000000000d4792
- (void)frameAnalyzer:(id)arg1 didAnalyzeFrame:(id)arg2;	// IMP=0x00000000000d402c
- (id)_filterFrameResult:(id)arg1 dynamicConfiguration:(id)arg2 motionDetections:(id)arg3;	// IMP=0x00000000000d3cad
- (void)frameTracker:(id)arg1 didTrackFrame:(struct opaqueCMSampleBuffer *)arg2 background:(struct opaqueCMSampleBuffer *)arg3 motionDetections:(id)arg4 tracks:(id)arg5;	// IMP=0x00000000000d3b9c
- (void)frameSelector:(id)arg1 didSkipFrame:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000d3b50
- (void)frameSelector:(id)arg1 didSelectFrame:(struct opaqueCMSampleBuffer *)arg2 reference:(struct opaqueCMSampleBuffer *)arg3;	// IMP=0x00000000000d3a76
- (struct opaqueCMSampleBuffer *)frameSelector:(id)arg1 prepareFrame:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000d3a23
- (void)_handleDecodedSampleBuffer:(struct opaqueCMSampleBuffer *)arg1;	// IMP=0x00000000000d3828
- (void)encoder:(id)arg1 didEncodeSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000d36d7
- (void)decoder:(id)arg1 didDecodeSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000d363e
- (void)_ensureTimelapseEncoder;	// IMP=0x00000000000d358f
- (void)_ensureEncoder;	// IMP=0x00000000000d351c
- (void)_ensureDecoderForFragment:(id)arg1;	// IMP=0x00000000000d3430
- (void)bufferWillFlush:(id)arg1;	// IMP=0x00000000000d31be
- (void)buffer:(id)arg1 willHandleSampleBuffer:(struct opaqueCMSampleBuffer *)arg2;	// IMP=0x00000000000d2edc
- (void)_configureTimelapseEncoder;	// IMP=0x00000000000d29be
- (void)_configureEncoder;	// IMP=0x00000000000d271c
- (void)_configureTimelapseAssetWriter;	// IMP=0x00000000000d255f
- (void)_configureAssetWriter;	// IMP=0x00000000000d2427
- (void)dealloc;	// IMP=0x00000000000d22e9
- (void)_prepareForTimelapseOutputVideoFormat:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x00000000000d2277
- (void)_prepareForInputVideoFormat:(struct opaqueCMFormatDescription *)arg1 audioFormat:(struct opaqueCMFormatDescription *)arg2;	// IMP=0x00000000000d2017
- (void)_saveFragmentDataToDisk:(id)arg1 diskBufferSize:(unsigned long long)arg2;	// IMP=0x00000000000d101c
- (void)cancel;	// IMP=0x00000000000d100b
- (void)finishWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d0c41
- (void)flushAsync;	// IMP=0x00000000000d0c04
- (void)flush;	// IMP=0x00000000000d0bc7
- (void)handleSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000d0a40
- (void)handleAssetData:(id)arg1 withOptions:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000cfbe1
- (void)handleMessageWithOptions:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cf5be
- (id)dynamicConfigurationForTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000cf359
- (id)initWithConfiguration:(id)arg1 identifier:(id)arg2;	// IMP=0x00000000000cec7f
