...
+ (id)logCategory;	// IMP=0x0060000000010852
- (void).cxx_destruct;	// IMP=0x0000000000010888
...
- (void)main;	// IMP=0x00000000000104e1
- (id)initWithDataSource:(id)arg1 faceprint:(id)arg2;	// IMP=0x0000000000010437
