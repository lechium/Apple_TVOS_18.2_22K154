...
- (void).cxx_destruct;	// IMP=0x0000000000001e48
...
- (void)resume;	// IMP=0x0000000000001cda
- (id)initWithURL:(id)arg1 data:(struct __CFDictionary *)arg2 clientInfo:(id)arg3 proxiedClientInfo:(id)arg4 companionClientInfo:(id)arg5 appleITeamId:(id)arg6 appleIClientId:(id)arg7 additionalHeaders:(id)arg8;	// IMP=0x000000000000143b
