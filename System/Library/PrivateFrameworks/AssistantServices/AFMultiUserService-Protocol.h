...
- (oneway void)getSharedUserIdForiCloudAltDSID:(NSString *)arg1 completion:(void (^)(NSError *, NSString *))arg2;
- (oneway void)getSharedUserInfoForiCloudAltDSID:(NSString *)arg1 completion:(void (^)(AFSharedUserInfo *))arg2;
...
- (oneway void)triggerVoiceProfileUploadWithCompletion:(void (^)(NSError *))arg1;
- (oneway void)downloadVoiceProfileForiCloudAltDSID:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
