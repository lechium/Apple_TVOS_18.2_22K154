...
@class AFAudioPlaybackRequest, AFBluetoothDeviceInfo, AFCompanionDeviceInfo, AFDeleteSiriHistoryContext, AFMyriadAdvertisementContext, AFRequestInfo, AFSpeechRecognition, AFVoiceInfo, NSArray, NSData, NSDate, NSDictionary, NSNumber, NSString, NSURL, NSUUID, SAConfidenceScores, SCDAAdvertisementContext, SCDAFParticipation;
