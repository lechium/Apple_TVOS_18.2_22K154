...
- (void)audioRecorderExclaveBufferAvailable:(CSAudioRecorder *)arg1 audioStreamHandleId:(unsigned long long)arg2 hostTime:(unsigned long long)arg3 arrivalTimestampToAudioRecorder:(unsigned long long)arg4;
@end
