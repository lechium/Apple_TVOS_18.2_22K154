...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x002000000001388f
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x002000000001382b
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x00200000000137d9
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0020000000013775
+ (_Bool)supportsMultiPhraseVoiceTriggerForEngineVersion:(id)arg1 engineMinorVersion:(id)arg2 accessoryRTModelType:(id)arg3;	// IMP=0x0020000000054c35
@property(readonly, nonatomic) NSDictionary *SSVParameterDirectionary;
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000012c88
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x001000000000f846
- (id)_userSelectedPhraseTypeToRTModelPhraseType:(id)arg1;	// IMP=0x001000000005490c
- (_Bool)_allowMultiPhrase:(id)arg1 forceSkipEngineVersionCheck:(_Bool)arg2;	// IMP=0x001000000005474f
- (id)_rtModelWithRequestOptions:(id)arg1 accessoryBlobs:(id)arg2;	// IMP=0x0010000000054463
- (id)_getFilteredAccessoryRTBlobListForRequestOptions:(id)arg1 accessoryBlobs:(id)arg2 forceSkipEngineVersionCheck:(_Bool)arg3;	// IMP=0x0010000000054266
- (id)_splitBlobsByPhraseType:(id)arg1;	// IMP=0x0010000000053e67
- (id)_buildRTModelWithBlobConfig:(id)arg1 requestOptions:(id)arg2;	// IMP=0x001000000005383f
- (id)_sha256:(id)arg1;	// IMP=0x0010000000053787
- (id)_sha1:(id)arg1;	// IMP=0x001000000005369c
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000005349b
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x0010000000053467
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000005344e
- (id)jarvisRTModelLocaleMap;	// IMP=0x0010000000053435
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000005341c
- (id)hearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000005340a
- (id)rtModelWithRequestOptions:(id)arg1;	// IMP=0x0010000000053215
- (id)latestHearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x0010000000052d3e
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x0010000000052cd8
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x0010000000052c4f
...
- (long long)multiUserDeltaScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x00100000000881c3
@property(readonly, nonatomic) long long multiUserConfidentScoreThreshold;
- (long long)multiUserConfidentScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000088087
@property(readonly, nonatomic) long long multiUserHighScoreThreshold;
- (long long)multiUserHighScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087f4b
@property(readonly, nonatomic) long long multiUserLowScoreThreshold;
- (long long)multiUserLowScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087e0f
@property(readonly, nonatomic) float satScoreThreshold;
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087cd9
- (id)getPhraseConfig:(unsigned long long)arg1;	// IMP=0x0010000000087bc9
