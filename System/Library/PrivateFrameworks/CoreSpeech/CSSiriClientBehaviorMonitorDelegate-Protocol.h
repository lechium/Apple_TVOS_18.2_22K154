...
@class CSAudioRecordContext, CSAudioStartStreamOption, CSAudioStopStreamOption, CSAudioStream, CSFAudioDeviceInfo, CSSiriClientBehaviorMonitor, NSString;
...
@optional
- (void)siriClientBehaviorMonitorAudioDeviceInfoUpdated:(CSFAudioDeviceInfo *)arg1;
