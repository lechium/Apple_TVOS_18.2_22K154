...
@class CSFAudioDeviceInfo, CSSpeechController, NSArray, NSData, NSDictionary, NSError;
...
- (void)speechControllerDidStopRecording:(CSSpeechController *)arg1 audioDeviceInfo:(CSFAudioDeviceInfo *)arg2 forReason:(long long)arg3 estimatedSpeechEndHostTime:(unsigned long long)arg4;
...
- (void)speechControllerDidStartRecording:(CSSpeechController *)arg1 audioDeviceInfo:(CSFAudioDeviceInfo *)arg2 successfully:(_Bool)arg3 error:(NSError *)arg4;
...
- (void)speechControllerRecordBufferAvailable:(CSSpeechController *)arg1 buffers:(NSArray *)arg2 durationInSec:(float)arg3 recordedAt:(unsigned long long)arg4 audioDeviceInfo:(CSFAudioDeviceInfo *)arg5;
