...
- (void).cxx_destruct;	// IMP=0x0000000000068f4a
...
- (id)presentingSceneIdentifierPromise;	// IMP=0x0000000000068d52
@property(readonly, nonatomic) NSString *presentingSceneIdentifier;
- (id)presentingSceneBundleIdentifierPromise;	// IMP=0x0000000000068681
@property(readonly, nonatomic) NSString *presentingSceneBundleIdentifier;
- (id)runAction;	// IMP=0x000000000006835c
- (id)_initWithContext:(id)arg1;	// IMP=0x00000000000682f1
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000068171
- (id)initWithContext:(id)arg1;	// IMP=0x000000000006815f
