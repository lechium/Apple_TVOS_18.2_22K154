...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x00100000000b62e7
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x00100000000b618c
- (void).cxx_destruct;	// IMP=0x00000000000b645c
...
- (id)runAction;	// IMP=0x00000000000b5c8a
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000b5461
