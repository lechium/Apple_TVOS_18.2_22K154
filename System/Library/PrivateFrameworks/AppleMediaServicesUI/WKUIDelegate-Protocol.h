...
@class NSArray, NSString, UIViewController, WKFrameInfo, WKNavigationAction, WKPreviewElementInfo, WKSecurityOrigin, WKWebView, WKWebViewConfiguration, WKWindowFeatures;
