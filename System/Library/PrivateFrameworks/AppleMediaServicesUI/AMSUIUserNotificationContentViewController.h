...
- (void).cxx_destruct;	// IMP=0x00000000000664da
...
- (void)viewTapped:(id)arg1;	// IMP=0x0000000000066372
- (void)_setupAccessibility;	// IMP=0x0000000000066209
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000006618d
- (void)mediaPause;	// IMP=0x00000000000660b4
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000006555d
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000006546d
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000064b96
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000064b11
- (void)loadView;	// IMP=0x00000000000646d4
- (void)dealloc;	// IMP=0x0000000000064612
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000063756
