...
- (void)main;	// IMP=0x000000000001e544
- (_Bool)isLowLatency;	// IMP=0x000000000001e53c
- (id)initWithImageName:(id)arg1 searchBundles:(id)arg2 compatibleWithTraitCollection:(id)arg3;	// IMP=0x000000000001e455
