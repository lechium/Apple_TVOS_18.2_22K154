...
- (void).cxx_destruct;	// IMP=0x000000000004c143
...
- (void)switchToggled:(id)arg1;	// IMP=0x000000000004bfb1
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000004bd42
