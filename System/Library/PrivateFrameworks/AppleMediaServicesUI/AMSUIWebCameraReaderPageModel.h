...
@interface AMSUIWebCameraReaderPageModel : NSObject
{
    ...
    _Bool _prefersSessionTeardown;	// 11 = 0xb
...
- (id)loadPage;	// IMP=0x0000000000075eb2
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000075e41
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000075867
