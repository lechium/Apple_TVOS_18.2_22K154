...
- (id)_webPageViewController;	// IMP=0x00000000000aba30
- (id)loadPage;	// IMP=0x00000000000aba17
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000ab9fd
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000ab422
