...
+ (_Bool)validateJSObject:(id)arg1;	// IMP=0x001000000006b6b4
- (void).cxx_destruct;	// IMP=0x000000000006b75d
...
- (id)iconWithSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x000000000006b263
- (id)_makeBarButtonItemView;	// IMP=0x000000000006ad21
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006a928
