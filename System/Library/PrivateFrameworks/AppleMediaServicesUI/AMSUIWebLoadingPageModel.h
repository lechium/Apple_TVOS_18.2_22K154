...
- (void).cxx_destruct;	// IMP=0x000000000009afb9
...
- (id)loadPage;	// IMP=0x000000000009af18
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x000000000009ae85
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000009a8a1
- (id)initWithContext:(id)arg1;	// IMP=0x000000000009a836
