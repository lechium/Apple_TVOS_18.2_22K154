...
- (void).cxx_destruct;	// IMP=0x00000000000ac9bf
...
- (id)loadPage;	// IMP=0x00000000000ac876
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000ac6b8
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000abd73
