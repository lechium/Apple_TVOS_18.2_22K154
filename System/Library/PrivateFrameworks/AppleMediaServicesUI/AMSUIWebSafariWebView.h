...
+ (id)_createContentControllerWithScheme:(id)arg1 data:(id)arg2 messageHandler:(id)arg3;	// IMP=0x00100000000b2733
- (void).cxx_destruct;	// IMP=0x00000000000b2ded
...
- (void)webView:(id)arg1 stopURLSchemeTask:(id)arg2;	// IMP=0x00000000000b2575
- (void)webView:(id)arg1 startURLSchemeTask:(id)arg2;	// IMP=0x00000000000b2086
- (void)userContentController:(id)arg1 didReceiveScriptMessage:(id)arg2 replyHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b1d51
@property(nonatomic) double topInset;
- (id)initWithAppearance:(id)arg1 scheme:(id)arg2 data:(id)arg3 delegate:(id)arg4;	// IMP=0x00000000000b19ae
