...
- (void).cxx_destruct;	// IMP=0x00000000000aa7c0
@property(nonatomic) __weak id <AMSUIWebProtocolDelegate> delegate; // @synthesize delegate=_delegate;
- (void)reconfigureNewRequest:(id)arg1 originalTask:(id)arg2 redirect:(_Bool)arg3 error:(id *)arg4;	// IMP=0x00000000000aa6b2
