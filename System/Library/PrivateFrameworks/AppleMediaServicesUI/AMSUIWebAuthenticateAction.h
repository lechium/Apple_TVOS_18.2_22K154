...
- (void).cxx_destruct;	// IMP=0x000000000006ce0f
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x000000000006cc1c
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x000000000006caef
- (id)runAction;	// IMP=0x000000000006c417
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006b86f
