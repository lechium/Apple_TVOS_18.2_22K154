...
- (void).cxx_destruct;	// IMP=0x0000000000075814
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x00000000000756eb
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x0000000000075532
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x00000000000754ed
- (void)layoutSubviews;	// IMP=0x0000000000074fda
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000074e0f
