...
- (void).cxx_destruct;	// IMP=0x000000000008dd32
...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x000000000008d8b2
- (id)runAction;	// IMP=0x000000000008d487
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000008ce83
- (id)initWithContext:(id)arg1;	// IMP=0x000000000008ce40
