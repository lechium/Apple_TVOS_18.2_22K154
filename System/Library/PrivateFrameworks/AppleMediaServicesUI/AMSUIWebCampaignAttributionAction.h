...
+ (id)_campaignAttributionTaskForURL:(id)arg1;	// IMP=0x0060000000078dea
- (void).cxx_destruct;	// IMP=0x0000000000078ede
...
- (id)runAction;	// IMP=0x00000000000783e0
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000077f1f
