...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000009a54b
- (void).cxx_destruct;	// IMP=0x000000000009a80e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009a622
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009a553
- (id)initWithRequest:(id)arg1 duration:(double)arg2;	// IMP=0x000000000009a4d0
