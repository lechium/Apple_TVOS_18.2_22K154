...
- (void).cxx_destruct;	// IMP=0x00000000000556a4
...
- (void)_toggleChanged:(id)arg1;	// IMP=0x00000000000555a6
- (long long)selectionStyle;	// IMP=0x000000000005559e
- (void)_setup;	// IMP=0x0000000000055491
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000055445
