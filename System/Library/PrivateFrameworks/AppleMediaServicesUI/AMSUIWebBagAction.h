...
- (void).cxx_destruct;	// IMP=0x000000000006e6e4
...
- (void)_fetchValuesForKeys:(id)arg1 bag:(id)arg2 startingAtIndex:(long long)arg3 valuesArray:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x000000000006df2c
- (id)runAction;	// IMP=0x000000000006d890
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006d215
