...
- (void).cxx_destruct;	// IMP=0x0000000000081a80
...
- (id)loadPage;	// IMP=0x0000000000081980
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000081978
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000817a8
