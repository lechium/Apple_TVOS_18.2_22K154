...
- (void).cxx_destruct;	// IMP=0x00000000000a2174
...
- (id)_createSession;	// IMP=0x00000000000a1fa1
- (id)runAction;	// IMP=0x00000000000a0b79
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000a051f
