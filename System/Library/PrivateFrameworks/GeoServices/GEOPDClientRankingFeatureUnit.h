...
- (void).cxx_destruct;	// IMP=0x00000000005ac564
- (unsigned long long)hash;	// IMP=0x00000000005ac47d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005ac2f7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005ac098
- (void)writeTo:(id)arg1;	// IMP=0x00000000005abe70
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005abe61
- (id)jsonRepresentation;	// IMP=0x00000000005abaf4
- (id)dictionaryRepresentation;	// IMP=0x00000000005ab569
- (id)description;	// IMP=0x00000000005ab4ba
- (id)initWithData:(id)arg1;	// IMP=0x00000000005aa9bd
- (id)init;	// IMP=0x00000000005aa961
