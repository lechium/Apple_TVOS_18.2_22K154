...
- (void).cxx_destruct;	// IMP=0x00000000009f9584
- (unsigned long long)hash;	// IMP=0x00000000009f946f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009f9288
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009f9016
- (void)writeTo:(id)arg1;	// IMP=0x00000000009f8d68
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009f8d59
- (id)jsonRepresentation;	// IMP=0x00000000009f8ab9
- (id)dictionaryRepresentation;	// IMP=0x00000000009f8527
- (id)description;	// IMP=0x00000000009f8478
- (id)initWithData:(id)arg1;	// IMP=0x00000000009f7bb6
- (id)init;	// IMP=0x00000000009f7b5a
