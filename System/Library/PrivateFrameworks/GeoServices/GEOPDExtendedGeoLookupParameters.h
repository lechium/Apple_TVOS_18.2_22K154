...
- (void).cxx_destruct;	// IMP=0x000000000044808c
- (unsigned long long)hash;	// IMP=0x0000000000447f43
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000447d33
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000447a9a
- (void)writeTo:(id)arg1;	// IMP=0x000000000044775e
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000044774f
- (id)jsonRepresentation;	// IMP=0x0000000000447338
- (id)dictionaryRepresentation;	// IMP=0x0000000000446c64
- (id)description;	// IMP=0x0000000000446bb5
- (void)dealloc;	// IMP=0x0000000000445b32
- (id)initWithData:(id)arg1;	// IMP=0x0000000000445ad6
- (id)init;	// IMP=0x0000000000445a7a
