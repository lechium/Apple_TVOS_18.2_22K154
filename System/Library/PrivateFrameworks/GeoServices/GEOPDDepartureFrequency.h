...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000b70ca4
- (void).cxx_destruct;	// IMP=0x0000000000b71695
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000b7164f
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000b7155c
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b7130b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b71202
- (void)copyTo:(id)arg1;	// IMP=0x0000000000b71124
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b71015
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b71008
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000b706ff
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000b706ed
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000b7039c
- (id)jsonRepresentation;	// IMP=0x0000000000b7028c
- (id)dictionaryRepresentation;	// IMP=0x0000000000b6fec1
...
- (_Bool)isValidAtDate:(id)arg1;	// IMP=0x0000000001121843
