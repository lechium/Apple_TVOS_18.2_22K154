...
- (void).cxx_destruct;	// IMP=0x0000000000dce535
- (unsigned long long)hash;	// IMP=0x0000000000dce11d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000dcddd2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000dcd871
- (void)writeTo:(id)arg1;	// IMP=0x0000000000dcd313
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000dcd304
- (id)jsonRepresentation;	// IMP=0x0000000000dcb58e
- (id)dictionaryRepresentation;	// IMP=0x0000000000dcabf8
- (id)description;	// IMP=0x0000000000dcab49
- (id)initWithData:(id)arg1;	// IMP=0x0000000000dc91c5
- (id)init;	// IMP=0x0000000000dc9169
