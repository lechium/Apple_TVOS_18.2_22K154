...
+ (id)captionedPhotosForPlaceData:(id)arg1;	// IMP=0x001000000099c886
- (void).cxx_destruct;	// IMP=0x0000000000ae2a23
- (unsigned long long)hash;	// IMP=0x0000000000ae2165
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ae1e2d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ae1abb
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ae165f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ae1650
- (id)jsonRepresentation;	// IMP=0x0000000000ae0395
- (id)dictionaryRepresentation;	// IMP=0x0000000000adfcb0
- (id)description;	// IMP=0x0000000000adfc01
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ade517
- (id)init;	// IMP=0x0000000000ade4bb
