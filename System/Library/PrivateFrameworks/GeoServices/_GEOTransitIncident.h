...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000111e62e
- (void).cxx_destruct;	// IMP=0x000000000111f622
@property(readonly) unsigned long long hash;
@property(readonly, nonatomic) id <GEOTransitIconDataSource> artworkDataSource;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000111ea9d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000111e749
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000111e6a1
- (id)initWithIncident:(id)arg1;	// IMP=0x000000000111e636
