...
- (void).cxx_destruct;	// IMP=0x000000000056b73d
- (unsigned long long)hash;	// IMP=0x000000000056b5f2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000056b3d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056b118
- (void)writeTo:(id)arg1;	// IMP=0x000000000056ae8b
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000056ae7c
- (id)jsonRepresentation;	// IMP=0x000000000056a98a
- (id)dictionaryRepresentation;	// IMP=0x000000000056a14b
- (id)description;	// IMP=0x000000000056a09c
- (id)initWithData:(id)arg1;	// IMP=0x000000000056955c
- (id)init;	// IMP=0x0000000000569500
