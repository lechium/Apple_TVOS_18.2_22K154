...
+ (id)transitInfoForPlaceData:(id)arg1;	// IMP=0x0010000000996899
- (void).cxx_destruct;	// IMP=0x0000000000c9507d
- (unsigned long long)hash;	// IMP=0x0000000000c94f40
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c94d09
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c944d8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c93aaf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c93aa0
- (id)jsonRepresentation;	// IMP=0x0000000000c9324e
- (id)dictionaryRepresentation;	// IMP=0x0000000000c92549
- (id)description;	// IMP=0x0000000000c9249a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c90c12
- (id)init;	// IMP=0x0000000000c90bb6
