...
- (void).cxx_destruct;	// IMP=0x00000000013fce39
- (unsigned long long)hash;	// IMP=0x00000000013fcd34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000013fcb7e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000013fc6e1
- (void)writeTo:(id)arg1;	// IMP=0x00000000013fc11f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000013fc110
- (id)jsonRepresentation;	// IMP=0x00000000013facbc
- (id)dictionaryRepresentation;	// IMP=0x00000000013fa484
- (id)description;	// IMP=0x00000000013fa3d5
- (id)initWithData:(id)arg1;	// IMP=0x00000000013f9562
- (id)init;	// IMP=0x00000000013f9506
