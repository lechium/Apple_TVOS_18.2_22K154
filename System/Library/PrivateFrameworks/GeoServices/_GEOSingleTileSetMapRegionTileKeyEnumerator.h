...
- (void).cxx_destruct;	// IMP=0x00000000011d386d
@property(readonly, nonatomic) unsigned long long count;
- (_Bool)continueEnumeratingTileKeysWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000011d348e
- (id)initWithMapRegion:(id)arg1 tileSet:(id)arg2 zoomMode:(long long)arg3;	// IMP=0x00000000011d31ec
