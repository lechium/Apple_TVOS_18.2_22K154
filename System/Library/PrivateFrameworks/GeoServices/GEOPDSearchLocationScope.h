...
- (void).cxx_destruct;	// IMP=0x0000000000321e64
- (unsigned long long)hash;	// IMP=0x00000000003214c8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003210fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000320d62
- (void)writeTo:(id)arg1;	// IMP=0x00000000003209d3
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003209c6
- (id)jsonRepresentation;	// IMP=0x000000000032072d
- (id)dictionaryRepresentation;	// IMP=0x000000000031fd47
- (id)description;	// IMP=0x000000000031fc98
- (id)initWithData:(id)arg1;	// IMP=0x000000000031ee88
- (id)init;	// IMP=0x000000000031ee2c
