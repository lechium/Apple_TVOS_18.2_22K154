...
+ (_Bool)isValid:(id)arg1;	// IMP=0x001000000112b3bf
+ (Class)tokenCandidatesType;	// IMP=0x0010000001129724
+ (Class)spellSuggestionType;	// IMP=0x0010000001129185
- (void).cxx_destruct;	// IMP=0x000000000112d3e9
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000112d01f
- (unsigned long long)hash;	// IMP=0x000000000112ccc2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000112ca01
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000112c46e
- (void)copyTo:(id)arg1;	// IMP=0x000000000112c181
- (void)writeTo:(id)arg1;	// IMP=0x000000000112bc7d
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000112bc70
- (void)readAll:(_Bool)arg1;	// IMP=0x000000000112afaf
- (id)initWithJSON:(id)arg1;	// IMP=0x000000000112af9c
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000112a53e
- (id)jsonRepresentation;	// IMP=0x000000000112a52f
- (id)dictionaryRepresentation;	// IMP=0x0000000001129c73
- (id)description;	// IMP=0x0000000001129bc4
...
- (int)StringAsRankerModelType:(id)arg1;	// IMP=0x000000000112999c
- (id)rankerModelTypeAsString:(int)arg1;	// IMP=0x0000000001129953
...
- (id)tokenCandidatesAtIndex:(unsigned long long)arg1;	// IMP=0x00000000011296f3
- (unsigned long long)tokenCandidatesCount;	// IMP=0x00000000011296c7
- (void)addTokenCandidates:(id)arg1;	// IMP=0x00000000011295e1
- (void)clearTokenCandidates;	// IMP=0x0000000001129580
...
- (int)StringAsResultStatus:(id)arg1;	// IMP=0x000000000112928f
- (id)resultStatusAsString:(int)arg1;	// IMP=0x0000000001129244
@property(nonatomic) _Bool hasResultStatus;
@property(nonatomic) int resultStatus;
- (id)spellSuggestionAtIndex:(unsigned long long)arg1;	// IMP=0x0000000001129154
- (unsigned long long)spellSuggestionsCount;	// IMP=0x0000000001129128
- (void)addSpellSuggestion:(id)arg1;	// IMP=0x0000000001129042
- (void)clearSpellSuggestions;	// IMP=0x0000000001128fe1
@property(retain, nonatomic) NSMutableArray *spellSuggestions;
- (id)initWithData:(id)arg1;	// IMP=0x0000000001128369
- (id)init;	// IMP=0x000000000112830d
