...
- (void).cxx_destruct;	// IMP=0x0000000000d2971a
- (unsigned long long)hash;	// IMP=0x0000000000d2962b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d29490
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d29260
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d28f7b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d28f6e
- (id)jsonRepresentation;	// IMP=0x0000000000d28cfa
- (id)dictionaryRepresentation;	// IMP=0x0000000000d2885d
- (id)description;	// IMP=0x0000000000d287ae
- (void)dealloc;	// IMP=0x0000000000d27930
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d278d4
- (id)init;	// IMP=0x0000000000d27878
