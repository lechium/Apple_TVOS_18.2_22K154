...
- (void).cxx_destruct;	// IMP=0x0000000000be5942
- (unsigned long long)hash;	// IMP=0x0000000000be585f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000be56de
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000be5333
- (void)writeTo:(id)arg1;	// IMP=0x0000000000be4fa2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000be4f93
- (id)jsonRepresentation;	// IMP=0x0000000000be4aef
- (id)dictionaryRepresentation;	// IMP=0x0000000000be4510
- (id)description;	// IMP=0x0000000000be4461
- (id)initWithData:(id)arg1;	// IMP=0x0000000000be36d2
- (id)init;	// IMP=0x0000000000be3676
