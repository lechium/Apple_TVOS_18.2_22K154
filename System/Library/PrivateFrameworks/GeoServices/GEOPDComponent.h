...
- (void).cxx_destruct;	// IMP=0x0000000000b151ca
@property(nonatomic) _Bool hasTimestampFirstSeen;
@property(nonatomic) double timestampFirstSeen;
- (unsigned long long)hash;	// IMP=0x0000000000b0e0e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b0dddc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b0d864
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b0d3b7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b0d3a8
- (id)jsonRepresentation;	// IMP=0x0000000000aff368
- (id)dictionaryRepresentation;	// IMP=0x0000000000afe181
- (id)description;	// IMP=0x0000000000afe0d2
- (_Bool)statusCodeIsValid;	// IMP=0x00000000009a00c5
