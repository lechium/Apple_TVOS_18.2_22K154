...
{
    NSArray *_originalLatLngs;	// 344 = 0x158
    NSArray *_originalLatLngsE7;	// 352 = 0x160
    _Bool _shiftLocationsIfNeeded;	// 360 = 0x168
}

- (void).cxx_destruct;	// IMP=0x00000000006c0eb5
- (void)submitWithHandler:(CDUnknownBlockType)arg1 auditToken:(id)arg2 timeout:(long long)arg3 networkActivity:(CDUnknownBlockType)arg4;	// IMP=0x00000000006c002c
- (id)initWithLatLngs:(id)arg1 shiftLocationsIfNeeded:(_Bool)arg2 traits:(id)arg3;	// IMP=0x00000000006bfd41
