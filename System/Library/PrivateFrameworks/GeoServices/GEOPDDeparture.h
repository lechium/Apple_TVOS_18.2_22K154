...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000b6e9cf
- (void).cxx_destruct;	// IMP=0x0000000000b6fb94
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000b6faf3
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000b6f902
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b6f407
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b6f17e
- (void)copyTo:(id)arg1;	// IMP=0x0000000000b6effa
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b6ed2b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b6ed1c
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000b6e745
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000b6e733
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000b6e1e1
- (id)jsonRepresentation;	// IMP=0x0000000000b6e0d1
- (id)dictionaryRepresentation;	// IMP=0x0000000000b6dc0e
@property(readonly, copy) NSString *description;
@property(retain, nonatomic) NSString *displayNameOverride;
@property(readonly, nonatomic) _Bool hasDisplayNameOverride;
- (int)StringAsRealTimeStatusInfo:(id)arg1;	// IMP=0x0000000000b6d9a0
- (id)realTimeStatusInfoAsString:(int)arg1;	// IMP=0x0000000000b6d957
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b6cb37
- (id)init;	// IMP=0x0000000000b6cadb
- (_Bool)isPastDepartureRelativeToDate:(id)arg1 usingGracePeriod:(_Bool)arg2;	// IMP=0x00000000011214dc
