...
- (void).cxx_destruct;	// IMP=0x0000000000a62416
- (unsigned long long)hash;	// IMP=0x0000000000a62126
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a61daa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a61692
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a61004
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a60ff5
- (id)jsonRepresentation;	// IMP=0x0000000000a5fda9
- (id)dictionaryRepresentation;	// IMP=0x0000000000a5f2ba
- (id)description;	// IMP=0x0000000000a5f20b
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a5e076
- (id)init;	// IMP=0x0000000000a5e01a
