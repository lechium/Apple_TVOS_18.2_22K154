...
- (void).cxx_destruct;	// IMP=0x0000000000aa4605
...
- (id)initWithProcess:(id)arg1 reason:(id)arg2 creationTimestamp:(double)arg3;	// IMP=0x0000000000aa4476
- (id)init;	// IMP=0x0000000000aa444c
