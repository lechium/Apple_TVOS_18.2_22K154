...
- (void).cxx_destruct;	// IMP=0x0000000000d942a0
- (unsigned long long)hash;	// IMP=0x0000000000d941a3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d93feb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d93c19
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d938a8
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d93899
- (id)jsonRepresentation;	// IMP=0x0000000000d933f5
- (id)dictionaryRepresentation;	// IMP=0x0000000000d92de9
- (id)description;	// IMP=0x0000000000d92d3a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d91e3b
- (id)init;	// IMP=0x0000000000d91ddf
