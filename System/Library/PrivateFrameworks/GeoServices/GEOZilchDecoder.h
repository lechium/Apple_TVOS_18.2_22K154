...
+ (_Bool)decodingSupported;	// IMP=0x0060000000cceb40
- (id).cxx_construct;	// IMP=0x0000000000cceee0
- (void).cxx_destruct;	// IMP=0x0000000000ccee91
...
- (void)requestComplete:(id)arg1;	// IMP=0x0000000000ccedc7
- (void)trackRequest:(id)arg1;	// IMP=0x0000000000cced3b
- (id)decodeZilchMessage:(shared_ptr_27244a92)arg1 pathHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ccec20
- (void)setRequestQueue:(id)arg1;	// IMP=0x0000000000ccec0c
- (id)requestQueue;	// IMP=0x0000000000ccebf7
- (id)init;	// IMP=0x0000000000cceb59
