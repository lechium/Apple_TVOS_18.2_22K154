...
- (void).cxx_destruct;	// IMP=0x0000000000d73108
- (unsigned long long)hash;	// IMP=0x0000000000d72c97
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d72a04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d7259e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d72118
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d72109
- (id)jsonRepresentation;	// IMP=0x0000000000d71233
- (id)dictionaryRepresentation;	// IMP=0x0000000000d70996
- (id)description;	// IMP=0x0000000000d708e7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d6f2ec
- (id)init;	// IMP=0x0000000000d6f290
