...
- (void).cxx_destruct;	// IMP=0x00000000006c1d0b
- (void)_handleResponse:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000006c1ab4
- (void)_submitRequest:(id)arg1 auditToken:(id)arg2 timeout:(double)arg3 withHandler:(CDUnknownBlockType)arg4 networkActivity:(CDUnknownBlockType)arg5;	// IMP=0x00000000006c1956
- (void)_processRequest:(id)arg1 auditToken:(id)arg2 timeout:(double)arg3 withHandler:(CDUnknownBlockType)arg4 refinedHandler:(CDUnknownBlockType)arg5 networkActivity:(CDUnknownBlockType)arg6;	// IMP=0x00000000006c0f87
- (id)initWithRequest:(id)arg1 locationShifter:(CDUnknownBlockType)arg2 traits:(id)arg3;	// IMP=0x00000000006c0ee6
