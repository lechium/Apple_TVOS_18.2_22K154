...
+ (id)_etaFilterWithTransportTypes:(int *)arg1 transportTypesCount:(unsigned long long)arg2 automobileOptions:(id)arg3 transitOptions:(id)arg4 walkingOptions:(id)arg5 cyclingOptions:(id)arg6;	// IMP=0x00000000009a07cc
+ (id)etaFilterForRouteAttributes:(id)arg1;	// IMP=0x00000000009a05ab
+ (id)etaFilterForTraits:(id)arg1;	// IMP=0x00000000009a0385
- (void).cxx_destruct;	// IMP=0x0000000000b82c8c
- (unsigned long long)hash;	// IMP=0x0000000000b82b42
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b82918
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b8265e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b822a2
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b82293
- (id)jsonRepresentation;	// IMP=0x0000000000b8167c
- (id)dictionaryRepresentation;	// IMP=0x0000000000b80e50
- (id)description;	// IMP=0x0000000000b80da1
- (void)dealloc;	// IMP=0x0000000000b7fbe2
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b7fb86
- (id)init;	// IMP=0x0000000000b7fb2a
