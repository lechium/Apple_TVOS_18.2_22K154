...
+ (id)placeInfoForPlaceData:(id)arg1;	// IMP=0x00100000009979da
- (void).cxx_destruct;	// IMP=0x0000000000c29da1
- (unsigned long long)hash;	// IMP=0x0000000000c29bad
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c299aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c2970a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c2949e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c2948f
- (id)jsonRepresentation;	// IMP=0x0000000000c2889d
- (id)dictionaryRepresentation;	// IMP=0x0000000000c282e1
- (id)description;	// IMP=0x0000000000c28232
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c273b2
- (id)init;	// IMP=0x0000000000c27356
