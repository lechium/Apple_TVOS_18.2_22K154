...
- (void).cxx_destruct;	// IMP=0x0000000000418619
- (unsigned long long)hash;	// IMP=0x00000000004183a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000417fc6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004178bd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000416a95
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000416a86
- (id)jsonRepresentation;	// IMP=0x0000000000413309
- (id)dictionaryRepresentation;	// IMP=0x00000000004123d4
- (id)description;	// IMP=0x0000000000412325
- (id)initWithData:(id)arg1;	// IMP=0x0000000000410972
- (id)init;	// IMP=0x0000000000410916
