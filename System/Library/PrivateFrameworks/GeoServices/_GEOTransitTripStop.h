...
+ (id)transitTripStopsForPlaceData:(id)arg1;	// IMP=0x00100000010b1e4c
- (void).cxx_destruct;	// IMP=0x00000000010b2635
...
- (id)initWithTransitSnippet:(id)arg1 departureSequence:(id)arg2;	// IMP=0x00000000010b22eb
