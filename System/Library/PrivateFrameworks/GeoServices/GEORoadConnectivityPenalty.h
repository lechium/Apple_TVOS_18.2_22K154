...
- (void).cxx_destruct;	// IMP=0x000000000074ae38
@property(retain, nonatomic) NSMutableDictionary *roadIntersections; // @synthesize roadIntersections=_roadIntersections;
- (double)penaltyForCandidate:(id)arg1;	// IMP=0x000000000074adab
- (unsigned long long)shortestLengthToRoad:(id)arg1;	// IMP=0x000000000074ac98
@property(readonly, nonatomic) GEOMapFeatureRoad *originRoad;
- (void)_addRoadsFromOriginRoad:(id)arg1 currentDepth:(unsigned long long)arg2;	// IMP=0x000000000074a843
- (void)_initConnectivityMap;	// IMP=0x000000000074a799
- (id)initWithOriginRoad:(id)arg1;	// IMP=0x000000000074a6e4
- (id)init;	// IMP=0x000000000074a6ba
