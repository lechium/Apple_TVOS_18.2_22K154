...
- (void).cxx_destruct;	// IMP=0x00000000007b1378
...
- (id)_placecardLayoutConfiguration;	// IMP=0x00000000007b1350
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x00000000007b1348
...
- (id)_businessClaim;	// IMP=0x00000000007b12f8
- (_Bool)_hasBusinessClaim;	// IMP=0x00000000007b12f0
- (id)_mapItemByStrippingOptionalData;	// IMP=0x00000000007b12e7
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x00000000007b128f
...
- (id)_yelpID;	// IMP=0x00000000007b102e
...
- (id)_urlForWritingAReview;	// IMP=0x00000000007b1016
- (id)_urlForReview:(id)arg1;	// IMP=0x00000000007b100e
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x00000000007b1006
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000007b0f83
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x00000000007b0f7b
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x00000000007b0bde
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x00000000007b0b9c
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x00000000007b0b5a
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x00000000007b0b3d
- (int)_recommendedTransportType;	// IMP=0x00000000007b0b32
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x00000000007b0b15
...
- (id)weatherDisplayName;	// IMP=0x00000000007b0a6d
- (id)addressObject;	// IMP=0x00000000007b09ba
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x00000000007b03fd
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x00000000007b0342
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x00000000007b0160
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x00000000007b0087
