...
- (void).cxx_destruct;	// IMP=0x00000000011473db
...
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x0000000001145742
- (void)dataURLSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000011455bc
...
- (double)startTime;	// IMP=0x000000000114545b
- (double)elapsed;	// IMP=0x000000000114540b
- (void)clearAllRelatedOperations;	// IMP=0x00000000011453d9
- (void)cancel;	// IMP=0x000000000114523c
- (void)start;	// IMP=0x0000000001144c10
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000011441da
- (id)init;	// IMP=0x00000000011441cc
