...
- (void).cxx_destruct;	// IMP=0x00000000006c4833
...
- (id)initWithSection:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 mapItems:(id)arg4 collections:(id)arg5 publishers:(id)arg6;	// IMP=0x00000000006c41e0
