...
- (void).cxx_destruct;	// IMP=0x0000000000c88881
- (unsigned long long)hash;	// IMP=0x0000000000c8878c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c885cf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c880ff
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c87b11
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c87b02
- (id)jsonRepresentation;	// IMP=0x0000000000c87536
- (id)dictionaryRepresentation;	// IMP=0x0000000000c86c80
- (id)description;	// IMP=0x0000000000c86bd1
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c85c1f
- (id)init;	// IMP=0x0000000000c85bc3
