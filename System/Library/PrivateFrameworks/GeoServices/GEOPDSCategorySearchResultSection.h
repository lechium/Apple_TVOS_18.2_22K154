...
- (void).cxx_destruct;	// IMP=0x00000000005b5765
- (unsigned long long)hash;	// IMP=0x00000000005b5527
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005b53d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005b5191
- (void)writeTo:(id)arg1;	// IMP=0x00000000005b4f2f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005b4f20
- (id)jsonRepresentation;	// IMP=0x00000000005b4598
- (id)dictionaryRepresentation;	// IMP=0x00000000005b419a
- (id)description;	// IMP=0x00000000005b40eb
- (id)initWithData:(id)arg1;	// IMP=0x00000000005b34ee
- (id)init;	// IMP=0x00000000005b3492
