...
+ (id)businessHoursForPlaceData:(id)arg1;	// IMP=0x001000000099f394
- (void).cxx_destruct;	// IMP=0x0000000000ad98c5
- (unsigned long long)hash;	// IMP=0x0000000000ad95a3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ad93ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ad9012
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ad8b09
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ad8afa
- (id)jsonRepresentation;	// IMP=0x0000000000ad790a
- (id)dictionaryRepresentation;	// IMP=0x0000000000ad71c5
- (id)description;	// IMP=0x0000000000ad7116
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ad62d0
- (id)init;	// IMP=0x0000000000ad6274
