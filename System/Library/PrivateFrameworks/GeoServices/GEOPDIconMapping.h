...
- (void).cxx_destruct;	// IMP=0x00000000004658dc
- (unsigned long long)hash;	// IMP=0x0000000000465386
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000046513f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000464c15
- (void)writeTo:(id)arg1;	// IMP=0x00000000004646e3
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004646d4
- (id)jsonRepresentation;	// IMP=0x00000000004624ee
- (id)dictionaryRepresentation;	// IMP=0x00000000004619bd
- (id)description;	// IMP=0x000000000046190e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000460ad2
- (id)init;	// IMP=0x0000000000460a76
