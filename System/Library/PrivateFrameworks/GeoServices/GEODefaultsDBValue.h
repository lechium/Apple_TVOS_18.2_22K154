...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x0060000000195cb2
- (void).cxx_destruct;	// IMP=0x0000000000195da2
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x0000000000195bfc
