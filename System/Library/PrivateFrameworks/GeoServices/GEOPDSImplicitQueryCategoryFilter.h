...
- (void).cxx_destruct;	// IMP=0x00000000005b73ad
- (unsigned long long)hash;	// IMP=0x00000000005b7146
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005b7016
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005b6e06
- (void)writeTo:(id)arg1;	// IMP=0x00000000005b6ae9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005b6ada
- (id)jsonRepresentation;	// IMP=0x00000000005b6739
- (id)dictionaryRepresentation;	// IMP=0x00000000005b632f
- (id)description;	// IMP=0x00000000005b6280
- (id)initWithData:(id)arg1;	// IMP=0x00000000005b5836
- (id)init;	// IMP=0x00000000005b57da
