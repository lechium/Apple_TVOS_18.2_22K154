...
- (void).cxx_destruct;	// IMP=0x00000000012290e7
...
- (void)removeOldData:(id)arg1;	// IMP=0x000000000122886c
- (void)_completeWithError:(id)arg1;	// IMP=0x000000000122872f
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000001228729
- (void)cancel;	// IMP=0x000000000122869b
- (void)_handleResponse:(id)arg1 withData:(id)arg2 error:(id)arg3;	// IMP=0x0000000001228179
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x000000000122794b
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (void)dealloc;	// IMP=0x00000000012278e8
- (id)initWithMigrator:(id)arg1 newSearchAttributionManifestURL:(id)arg2 oldTileGroup:(id)arg3;	// IMP=0x00000000012276df
- (id)init;	// IMP=0x00000000012276b5
