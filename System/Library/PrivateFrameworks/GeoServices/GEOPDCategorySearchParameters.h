...
- (void).cxx_destruct;	// IMP=0x00000000004356c1
- (unsigned long long)hash;	// IMP=0x0000000000435069
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000434b54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004344ca
- (void)writeTo:(id)arg1;	// IMP=0x0000000000433c6a
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000433c5b
- (id)jsonRepresentation;	// IMP=0x00000000004332ee
- (id)dictionaryRepresentation;	// IMP=0x00000000004319d4
- (id)description;	// IMP=0x0000000000431925
- (void)dealloc;	// IMP=0x000000000042e9c5
- (id)initWithData:(id)arg1;	// IMP=0x000000000042e969
- (id)init;	// IMP=0x000000000042e90d
