...
- (void).cxx_destruct;	// IMP=0x0000000000d21618
- (unsigned long long)hash;	// IMP=0x0000000000d213e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d21095
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d20d43
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d20799
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d2078c
- (id)jsonRepresentation;	// IMP=0x0000000000d204dd
- (id)dictionaryRepresentation;	// IMP=0x0000000000d1fdb6
- (id)description;	// IMP=0x0000000000d1fd07
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d1eb6a
- (id)init;	// IMP=0x0000000000d1eb0e
