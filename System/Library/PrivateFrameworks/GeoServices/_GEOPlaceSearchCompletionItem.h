...
- (void).cxx_destruct;	// IMP=0x00000000006c6ab2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006c66a4
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x00000000006c668e
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x00000000006c6522
...
- (id)calloutTitle;	// IMP=0x00000000006c618b
- (id)queryLine;	// IMP=0x00000000006c606d
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x00000000006c601e
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x00000000006c496e
