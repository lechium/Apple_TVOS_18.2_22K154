...
- (void).cxx_destruct;	// IMP=0x0000000000ccd97f
@property(nonatomic) __weak id <_GEONetworkDefaultsServerProxyDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateNetworkDefaultsWithReason:(unsigned long long)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000ccd310
- (void)updateNetworkDefaults:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ccd2f6
- (void)_networkDefaultsDidChange;	// IMP=0x0000000000ccd21c
- (unsigned long long)_updateReason;	// IMP=0x0000000000ccd16b
- (void)dealloc;	// IMP=0x0000000000ccd132
- (id)init;	// IMP=0x0000000000cccff0
