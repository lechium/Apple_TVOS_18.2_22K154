...
- (void).cxx_destruct;	// IMP=0x0000000000b7771e
- (unsigned long long)hash;	// IMP=0x0000000000b772bc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b77026
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b76a51
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b76347
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b76338
- (id)jsonRepresentation;	// IMP=0x0000000000b74b2b
- (id)dictionaryRepresentation;	// IMP=0x0000000000b7404d
- (id)description;	// IMP=0x0000000000b73f9e
- (void)dealloc;	// IMP=0x0000000000b724f4
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b72498
- (id)init;	// IMP=0x0000000000b7243c
