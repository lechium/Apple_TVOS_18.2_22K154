...
- (void).cxx_destruct;	// IMP=0x0000000000bbcce0
- (unsigned long long)hash;	// IMP=0x0000000000bbcbf2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bbca4b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bbc7dc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bbc4e0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bbc4d1
- (id)jsonRepresentation;	// IMP=0x0000000000bbb790
- (id)dictionaryRepresentation;	// IMP=0x0000000000bbb2df
- (id)description;	// IMP=0x0000000000bbb230
- (void)dealloc;	// IMP=0x0000000000bba099
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bba03d
- (id)init;	// IMP=0x0000000000bb9fe1
