...
- (void).cxx_destruct;	// IMP=0x00000000009fe6a9
- (unsigned long long)hash;	// IMP=0x00000000009fe5a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009fe3f9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009fe055
- (void)writeTo:(id)arg1;	// IMP=0x00000000009fdcde
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009fdccf
- (id)jsonRepresentation;	// IMP=0x00000000009fd735
- (id)dictionaryRepresentation;	// IMP=0x00000000009fd117
- (id)description;	// IMP=0x00000000009fd068
- (void)dealloc;	// IMP=0x00000000009fc48f
- (id)initWithData:(id)arg1;	// IMP=0x00000000009fc433
- (id)init;	// IMP=0x00000000009fc3d7
