...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000e312f3
- (void).cxx_destruct;	// IMP=0x0000000000e32b68
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000e3294c
- (unsigned long long)hash;	// IMP=0x0000000000e32548
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e321ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e31e59
- (void)copyTo:(id)arg1;	// IMP=0x0000000000e31bef
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e31881
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e31874
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000e310bf
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000e310ad
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000e30939
- (id)jsonRepresentation;	// IMP=0x0000000000e3092a
- (id)dictionaryRepresentation;	// IMP=0x0000000000e3031b
- (id)description;	// IMP=0x0000000000e3026c
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e2ec94
- (id)init;	// IMP=0x0000000000e2ec38
