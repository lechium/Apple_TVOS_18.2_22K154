...
+ (id)lineSectionsForNearbyTransitGroup:(id)arg1 departureSequenceContainers:(id)arg2 departureSequences:(id)arg3;	// IMP=0x0010000001122dbc
- (void).cxx_destruct;	// IMP=0x0000000001123109
...
- (id)initWithTransitScheduleGroup:(id)arg1 departureSequenceContainers:(id)arg2 scheduledDepartureSequences:(id)arg3 incidentsMap:(id)arg4;	// IMP=0x0000000001122ba6
