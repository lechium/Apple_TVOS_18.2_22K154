...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000115416b
- (void).cxx_destruct;	// IMP=0x0000000001154d1f
...
- (void)addLogoPath:(id)arg1;	// IMP=0x0000000001154c67
- (id)snippetLogoPathForScale:(double)arg1;	// IMP=0x0000000001154991
- (id)logoPathForScale:(double)arg1;	// IMP=0x00000000011546bb
- (_Bool)hasAttributionRequirement:(int)arg1;	// IMP=0x00000000011546ac
- (id)description;	// IMP=0x00000000011545fd
- (id)dictionaryRepresentation;	// IMP=0x0000000001154441
- (_Bool)supportsActionURLs;	// IMP=0x0000000001154173
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001154068
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000001153e2c
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000001153c0c
...
- (id)initWithSource:(id)arg1 localizedAttribution:(id)arg2 logoPaths:(id)arg3 snippetLogoPaths:(id)arg4;	// IMP=0x0000000001153988
