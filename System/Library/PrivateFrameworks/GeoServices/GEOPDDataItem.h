...
- (void).cxx_destruct;	// IMP=0x0000000000b6b5b9
- (unsigned long long)hash;	// IMP=0x0000000000b6b032
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b6aeaa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b6ac48
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b6a8d7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b6a8c8
- (id)jsonRepresentation;	// IMP=0x0000000000b68d11
- (id)dictionaryRepresentation;	// IMP=0x0000000000b688a4
- (id)description;	// IMP=0x0000000000b687f5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b67a2b
- (id)init;	// IMP=0x0000000000b679cf
- (id)locationName;	// IMP=0x000000000099edfa
- (id)categoryName;	// IMP=0x000000000099ed7f
