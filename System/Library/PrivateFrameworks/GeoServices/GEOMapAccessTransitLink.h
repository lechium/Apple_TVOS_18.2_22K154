...
- (id).cxx_construct;	// IMP=0x000000000025ee17
- (void).cxx_destruct;	// IMP=0x000000000025edbd
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1 outClosestCoordinateOnLine:(CDStruct_c3b9c2ee *)arg2;	// IMP=0x000000000025eb38
...
- (id)initWithMap:(id)arg1 transitEdge:(shared_ptr_24ebf3c0)arg2;	// IMP=0x000000000025e66c
