...
- (void).cxx_destruct;	// IMP=0x0000000000bf3db0
- (unsigned long long)hash;	// IMP=0x0000000000bf3c81
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bf3a53
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bf3769
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bf3466
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bf3457
- (id)jsonRepresentation;	// IMP=0x0000000000bf0a02
- (id)dictionaryRepresentation;	// IMP=0x0000000000bf0286
- (id)description;	// IMP=0x0000000000bf01d7
- (id)initWithData:(id)arg1;	// IMP=0x0000000000beee24
- (id)init;	// IMP=0x0000000000beedc8
