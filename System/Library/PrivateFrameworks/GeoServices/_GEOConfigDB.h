...
- (void).cxx_destruct;	// IMP=0x000000000019c81f
...
- (long long)nextId;	// IMP=0x000000000019c7b2
- (id)init:(id)arg1 cache:(id)arg2 operationQueue:(id)arg3 clearFunction:(CDUnknownFunctionPointerType)arg4 setFunction:(CDUnknownFunctionPointerType)arg5 addFunction:(CDUnknownFunctionPointerType)arg6 tableName:(id)arg7;	// IMP=0x000000000019c5ab
