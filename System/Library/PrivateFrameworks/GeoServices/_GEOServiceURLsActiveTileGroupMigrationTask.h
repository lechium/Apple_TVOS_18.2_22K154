...
- (void).cxx_destruct;	// IMP=0x0000000001142105
...
- (void)removeOldData:(id)arg1;	// IMP=0x00000000011420c9
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000001142059
- (void)cancel;	// IMP=0x0000000001142053
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000001141f71
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x0000000001141df8
- (id)init;	// IMP=0x0000000001141dce
