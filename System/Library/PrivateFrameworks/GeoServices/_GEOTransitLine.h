...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000111fd20
- (void).cxx_destruct;	// IMP=0x000000000111feec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000111fe4c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000111fd28
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000111f83e
