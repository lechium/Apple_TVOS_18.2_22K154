...
- (void).cxx_destruct;	// IMP=0x000000000047b765
- (unsigned long long)hash;	// IMP=0x000000000047b11e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000047af82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000047ad29
- (void)writeTo:(id)arg1;	// IMP=0x000000000047a653
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000047a644
- (id)jsonRepresentation;	// IMP=0x0000000000479c9e
- (id)dictionaryRepresentation;	// IMP=0x00000000004796e7
- (id)description;	// IMP=0x0000000000479638
- (void)dealloc;	// IMP=0x000000000047843a
- (id)initWithData:(id)arg1;	// IMP=0x00000000004783de
- (id)init;	// IMP=0x0000000000478382
