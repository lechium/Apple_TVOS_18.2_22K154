...
- (void).cxx_destruct;	// IMP=0x000000000112324e
...
- (id)initWithTransitScheduleCategory:(id)arg1 nearbyScheduleGroups:(id)arg2 categoryArtwork:(id)arg3;	// IMP=0x000000000112313c
