...
+ (_Bool)isValid:(id)arg1;	// IMP=0x001000000112717f
- (void).cxx_destruct;	// IMP=0x0000000001128298
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000011280c7
- (unsigned long long)hash;	// IMP=0x0000000001127f5b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001127d02
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001127a3a
- (void)copyTo:(id)arg1;	// IMP=0x000000000112787b
- (_Bool)hasGreenTeaWithValue:(_Bool)arg1;	// IMP=0x0000000001127854
- (void)writeTo:(id)arg1;	// IMP=0x000000000112755d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001127550
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000001126f1c
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000001126f0a
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000001126806
- (id)jsonRepresentation;	// IMP=0x00000000011267f7
- (id)dictionaryRepresentation;	// IMP=0x00000000011262cf
- (id)description;	// IMP=0x0000000001126220
@property(retain, nonatomic) GEOPDSearchKeyValuePairList *tokenTags;
@property(readonly, nonatomic) _Bool hasTokenTags;
- (int)StringAsRequestFlags:(id)arg1;	// IMP=0x000000000112607e
- (id)requestFlagsAsString:(int)arg1;	// IMP=0x0000000001126035
...
- (int)StringAsQueryType:(id)arg1;	// IMP=0x0000000001125e4a
- (id)queryTypeAsString:(int)arg1;	// IMP=0x0000000001125e01
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000001124dc9
- (id)init;	// IMP=0x0000000001124d6d
