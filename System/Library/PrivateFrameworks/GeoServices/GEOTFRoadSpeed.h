...
- (void).cxx_destruct;	// IMP=0x000000000022f2ef
- (unsigned long long)hash;	// IMP=0x000000000022ee7d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000022ebae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022e72c
- (void)writeTo:(id)arg1;	// IMP=0x000000000022e204
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000022e1f5
- (id)jsonRepresentation;	// IMP=0x000000000022de6a
- (id)dictionaryRepresentation;	// IMP=0x000000000022d4cc
- (id)description;	// IMP=0x000000000022d41d
- (void)dealloc;	// IMP=0x000000000022c3bd
- (id)initWithData:(id)arg1;	// IMP=0x000000000022c361
- (id)init;	// IMP=0x000000000022c305
