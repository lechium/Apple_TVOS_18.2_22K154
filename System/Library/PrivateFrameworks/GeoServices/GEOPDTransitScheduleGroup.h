...
- (void).cxx_destruct;	// IMP=0x0000000000ca8181
- (unsigned long long)hash;	// IMP=0x0000000000ca802e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ca7e2b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ca7b9c
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ca78b5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ca78a6
- (id)jsonRepresentation;	// IMP=0x0000000000ca7539
- (id)dictionaryRepresentation;	// IMP=0x0000000000ca7005
- (id)description;	// IMP=0x0000000000ca6f56
- (void)dealloc;	// IMP=0x0000000000ca5a78
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ca5a1c
- (id)init;	// IMP=0x0000000000ca59c0
