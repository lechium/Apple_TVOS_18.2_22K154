...
- (void).cxx_destruct;	// IMP=0x00000000010aa677
@property(readonly, nonatomic) GEOTileLoader *tileLoader; // @synthesize tileLoader=_tileLoader;
- (void)cancel;	// IMP=0x00000000010aa43b
- (void)addTileRequest:(id)arg1;	// IMP=0x00000000010aa387
- (id)initWithTileLoader:(id)arg1;	// IMP=0x00000000010aa2d7
