...
- (void).cxx_destruct;	// IMP=0x00000000006c2327
- (void)cancel;	// IMP=0x00000000006c22a1
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000006c1fd6
- (id)initWithVendorIdentifier:(id)arg1 mapItemIdentifier:(id)arg2 range:(struct _NSRange)arg3 traits:(id)arg4;	// IMP=0x00000000006c1e8b
