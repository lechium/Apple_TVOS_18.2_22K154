...
- (void).cxx_destruct;	// IMP=0x00000000004896d3
- (unsigned long long)hash;	// IMP=0x0000000000489581
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004893d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000489168
- (void)writeTo:(id)arg1;	// IMP=0x0000000000488f05
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000488ef6
- (id)jsonRepresentation;	// IMP=0x00000000004889ca
- (id)dictionaryRepresentation;	// IMP=0x000000000048822f
- (id)description;	// IMP=0x0000000000488180
- (id)initWithData:(id)arg1;	// IMP=0x0000000000487871
- (id)init;	// IMP=0x0000000000487815
