...
- (void).cxx_destruct;	// IMP=0x0000000000bd07e1
- (unsigned long long)hash;	// IMP=0x0000000000bd070d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bd057d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bd031f
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bd00fc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bd00ed
- (id)jsonRepresentation;	// IMP=0x0000000000bcfd80
- (id)dictionaryRepresentation;	// IMP=0x0000000000bcf845
- (id)description;	// IMP=0x0000000000bcf796
- (id)initWithData:(id)arg1;	// IMP=0x0000000000bced05
- (id)init;	// IMP=0x0000000000bceca9
