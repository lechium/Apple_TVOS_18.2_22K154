...
- (void).cxx_destruct;	// IMP=0x00000000003d5d35
- (unsigned long long)hash;	// IMP=0x00000000003d5abd
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003d5994
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d5781
- (void)writeTo:(id)arg1;	// IMP=0x00000000003d5465
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003d5456
- (id)jsonRepresentation;	// IMP=0x00000000003d49d6
- (id)dictionaryRepresentation;	// IMP=0x00000000003d464b
- (id)description;	// IMP=0x00000000003d459c
- (id)initWithData:(id)arg1;	// IMP=0x00000000003d3b32
- (id)init;	// IMP=0x00000000003d3ad6
