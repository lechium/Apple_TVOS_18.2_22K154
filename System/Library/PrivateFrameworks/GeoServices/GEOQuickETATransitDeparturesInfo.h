...
- (void).cxx_destruct;	// IMP=0x000000000127057c
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x00000000012703f2
- (id)description;	// IMP=0x0000000001270338
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x0000000001270292
