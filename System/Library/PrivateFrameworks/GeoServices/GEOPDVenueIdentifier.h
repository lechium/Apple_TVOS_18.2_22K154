...
- (void).cxx_destruct;	// IMP=0x000000000115e717
- (unsigned long long)hash;	// IMP=0x000000000115e1e1
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000115df9d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000115dcf9
- (void)writeTo:(id)arg1;	// IMP=0x000000000115d993
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000115d984
- (id)jsonRepresentation;	// IMP=0x000000000115c730
- (id)dictionaryRepresentation;	// IMP=0x000000000115c148
- (id)description;	// IMP=0x000000000115c099
- (void)dealloc;	// IMP=0x000000000115add4
- (id)initWithData:(id)arg1;	// IMP=0x000000000115ad78
- (id)init;	// IMP=0x000000000115ad1c
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000099ff70
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3 componentIdentifier:(id)arg4;	// IMP=0x000000000099fb40
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3;	// IMP=0x000000000099fa3e
