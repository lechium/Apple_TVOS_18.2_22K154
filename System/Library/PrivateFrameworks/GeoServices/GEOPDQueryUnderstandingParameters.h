...
- (void).cxx_destruct;	// IMP=0x00000000005258b5
- (unsigned long long)hash;	// IMP=0x00000000005257ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000525648
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005253e9
- (void)writeTo:(id)arg1;	// IMP=0x000000000052508e
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000052507f
- (id)jsonRepresentation;	// IMP=0x0000000000524ca2
- (id)dictionaryRepresentation;	// IMP=0x00000000005246e3
- (id)description;	// IMP=0x0000000000524634
- (id)initWithData:(id)arg1;	// IMP=0x0000000000523b58
- (id)init;	// IMP=0x0000000000523afc
