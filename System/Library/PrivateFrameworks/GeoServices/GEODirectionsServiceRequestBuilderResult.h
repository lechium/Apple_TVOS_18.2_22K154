...
+ (id)resultWithError:(id)arg1;	// IMP=0x00600000010e7ebd
+ (id)resultWithWaypoints:(id)arg1 directionsRequest:(id)arg2;	// IMP=0x00600000010e7e3f
- (void).cxx_destruct;	// IMP=0x00000000010e7ef9
