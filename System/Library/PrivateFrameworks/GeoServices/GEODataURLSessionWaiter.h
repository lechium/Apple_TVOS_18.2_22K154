...
- (void).cxx_destruct;	// IMP=0x00000000013c02a5
- (void)cancel;	// IMP=0x00000000013c028f
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x00000000013c01e6
- (id)init;	// IMP=0x00000000013c01bc
