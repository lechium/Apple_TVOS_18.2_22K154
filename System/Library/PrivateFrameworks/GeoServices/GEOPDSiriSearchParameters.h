...
- (void).cxx_destruct;	// IMP=0x000000000055e3d4
- (unsigned long long)hash;	// IMP=0x000000000055e254
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000055dfcb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055da5f
- (void)writeTo:(id)arg1;	// IMP=0x000000000055d524
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000055d515
- (id)jsonRepresentation;	// IMP=0x000000000055d022
- (id)dictionaryRepresentation;	// IMP=0x000000000055c55d
- (id)description;	// IMP=0x000000000055c4ae
- (id)initWithData:(id)arg1;	// IMP=0x000000000055b2ae
- (id)init;	// IMP=0x000000000055b252
