...
- (void).cxx_destruct;	// IMP=0x00000000006d4d36
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x00000000006d4bd8
- (id)factoidAtIndex:(int)arg1;	// IMP=0x00000000006d4b31
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x00000000006d45a1
