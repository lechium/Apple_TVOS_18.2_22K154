...
- (void).cxx_destruct;	// IMP=0x0000000000618620
...
- (id)initWithCoordinate:(CDStruct_071ac149)arg1 angle:(double)arg2 road:(id)arg3 startCoordinate:(CDStruct_071ac149)arg4 endCoordinate:(CDStruct_071ac149)arg5 penalties:(id)arg6;	// IMP=0x0000000000618053
- (id)init;	// IMP=0x000000000061800f
