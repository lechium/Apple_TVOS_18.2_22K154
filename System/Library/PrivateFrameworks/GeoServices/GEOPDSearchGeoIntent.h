...
- (void).cxx_destruct;	// IMP=0x0000000000a12d01
- (unsigned long long)hash;	// IMP=0x0000000000a12b98
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a12931
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a12621
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a1231f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a12310
- (id)jsonRepresentation;	// IMP=0x0000000000a1200c
- (id)dictionaryRepresentation;	// IMP=0x0000000000a11830
- (id)description;	// IMP=0x0000000000a11781
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a10aa6
- (id)init;	// IMP=0x0000000000a10a4a
