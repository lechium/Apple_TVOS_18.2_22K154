...
- (void).cxx_destruct;	// IMP=0x0000000000a409c1
- (unsigned long long)hash;	// IMP=0x0000000000a408fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a40780
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a4013d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a3f01b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a3f00c
- (id)jsonRepresentation;	// IMP=0x0000000000a388d8
- (id)dictionaryRepresentation;	// IMP=0x0000000000a37ebd
- (id)description;	// IMP=0x0000000000a37e0e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a36f90
- (id)init;	// IMP=0x0000000000a36f34
