...
- (void).cxx_destruct;	// IMP=0x000000000064ec49
- (unsigned long long)hash;	// IMP=0x000000000064eb48
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000064e987
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000064e3df
- (void)writeTo:(id)arg1;	// IMP=0x000000000064debd
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000064deae
- (id)jsonRepresentation;	// IMP=0x000000000064d9ef
- (id)dictionaryRepresentation;	// IMP=0x000000000064d3c4
- (id)description;	// IMP=0x000000000064d315
- (void)dealloc;	// IMP=0x000000000064c48c
- (id)initWithData:(id)arg1;	// IMP=0x000000000064c430
- (id)init;	// IMP=0x000000000064c3d4
