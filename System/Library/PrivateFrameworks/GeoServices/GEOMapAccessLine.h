...
- (id).cxx_construct;	// IMP=0x000000000114257b
- (void).cxx_destruct;	// IMP=0x0000000001142543
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outSegmentCoordinate:(struct PolylineCoordinate *)arg2;	// IMP=0x0000000001142299
...
- (id)initWithMap:(id)arg1 edge:(shared_ptr_035a2da2)arg2;	// IMP=0x0000000001142178
