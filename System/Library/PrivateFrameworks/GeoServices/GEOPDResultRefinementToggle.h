...
- (void).cxx_destruct;	// IMP=0x0000000000dab919
- (unsigned long long)hash;	// IMP=0x0000000000dab7eb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000dab5fe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000dab38e
- (void)writeTo:(id)arg1;	// IMP=0x0000000000dab08b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000dab07c
- (id)jsonRepresentation;	// IMP=0x0000000000daa5d1
- (id)dictionaryRepresentation;	// IMP=0x0000000000daa0dd
- (id)description;	// IMP=0x0000000000daa02e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000da92c0
- (id)init;	// IMP=0x0000000000da9264
