...
- (void).cxx_destruct;	// IMP=0x00000000009fb2be
- (unsigned long long)hash;	// IMP=0x00000000009fb1ef
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009fb067
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009fae24
- (void)writeTo:(id)arg1;	// IMP=0x00000000009fab7f
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000009fab70
- (id)jsonRepresentation;	// IMP=0x00000000009fa360
- (id)dictionaryRepresentation;	// IMP=0x00000000009f9e33
- (id)description;	// IMP=0x00000000009f9d84
- (id)initWithData:(id)arg1;	// IMP=0x00000000009f9644
- (id)init;	// IMP=0x00000000009f95e8
