...
- (void).cxx_destruct;	// IMP=0x000000000047ec35
- (unsigned long long)hash;	// IMP=0x000000000047e9ff
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000047e84a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000047e5bd
- (void)writeTo:(id)arg1;	// IMP=0x000000000047e2f0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000047e2e1
- (id)jsonRepresentation;	// IMP=0x000000000047dd88
- (id)dictionaryRepresentation;	// IMP=0x000000000047d8c8
- (id)description;	// IMP=0x000000000047d819
- (id)initWithData:(id)arg1;	// IMP=0x000000000047c8f6
- (id)init;	// IMP=0x000000000047c89a
