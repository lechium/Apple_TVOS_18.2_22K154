...
- (void).cxx_destruct;	// IMP=0x00000000013c8579
- (unsigned long long)hash;	// IMP=0x00000000013c7e98
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000013c7c68
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000013c7879
- (void)writeTo:(id)arg1;	// IMP=0x00000000013c7293
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000013c7284
- (id)jsonRepresentation;	// IMP=0x00000000013c53d8
- (id)dictionaryRepresentation;	// IMP=0x00000000013c4ccc
- (id)description;	// IMP=0x00000000013c4c1d
- (id)initWithData:(id)arg1;	// IMP=0x00000000013c3c76
- (id)init;	// IMP=0x00000000013c3c1a
