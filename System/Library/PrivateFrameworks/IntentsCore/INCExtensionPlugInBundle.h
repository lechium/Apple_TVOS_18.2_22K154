...
- (void).cxx_destruct;	// IMP=0x0000000000002a14
...
- (id)initWithPrincipalClass:(Class)arg1 intentsSupported:(id)arg2 intentsRestrictedWhileLocked:(id)arg3;	// IMP=0x000000000000292b
