...
- (void)sendAceCommand:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005aab
- (id)initWithIntent:(id)arg1 extensionProxy:(id)arg2 queue:(id)arg3;	// IMP=0x00000000000059f8
- (id)initWithVoiceShortcutClient:(id)arg1 intent:(id)arg2;	// IMP=0x000000000000595f
