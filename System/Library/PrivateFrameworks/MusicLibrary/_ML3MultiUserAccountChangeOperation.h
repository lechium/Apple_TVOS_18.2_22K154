...
- (void).cxx_destruct;	// IMP=0x00000000000eebe4
...
- (void)execute;	// IMP=0x00000000000eea7e
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000ee9d0
