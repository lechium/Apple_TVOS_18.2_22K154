...
- (void).cxx_destruct;	// IMP=0x0000000000198f22
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000198ec7
- (unsigned long long)hash;	// IMP=0x0000000000198e65
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000198ca6
- (id)description;	// IMP=0x0000000000198bee
- (id)initWithAlbumArtistPersistentID:(long long)arg1 groupingKey:(id)arg2 feedURL:(id)arg3 seasonNumber:(long long)arg4 compilation:(_Bool)arg5;	// IMP=0x00000000001989a4
