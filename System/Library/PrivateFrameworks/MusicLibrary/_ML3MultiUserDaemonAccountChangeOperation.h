...
- (void).cxx_destruct;	// IMP=0x0000000000204d09
...
- (void)execute;	// IMP=0x00000000002048c4
- (id)initWithInitialDSID:(id)arg1 finalDSID:(id)arg2 accountChangeObserver:(id)arg3;	// IMP=0x00000000002047cf
