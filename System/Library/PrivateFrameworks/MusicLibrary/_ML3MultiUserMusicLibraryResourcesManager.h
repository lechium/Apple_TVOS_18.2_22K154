...
- (void).cxx_destruct;	// IMP=0x000000000021ee7d
...
- (void)terminateForFailureToPerformDatabasePathChange;	// IMP=0x000000000021ee2d
- (void)emergencyDisconnectWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000021ed2d
- (void)performDatabasePathChange:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000021ec36
...
- (id)musicAssetsContainerPath;	// IMP=0x000000000021e4a5
- (id)libraryContainerPath;	// IMP=0x000000000021e3aa
- (id)initWithLibraryResourcesService:(id)arg1;	// IMP=0x000000000021e2d8
