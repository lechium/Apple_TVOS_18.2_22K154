...
- (void).cxx_destruct;	// IMP=0x00000000000c2fa9
- (id)nextObject;	// IMP=0x00000000000c2da9
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000c2d07
