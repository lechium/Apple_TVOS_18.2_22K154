...
- (_Bool)computeMaskWithWidth:(int)arg1 height:(int)arg2 ucharSamplesAndMask:(MISSING_TYPE **)arg3;	// IMP=0x000000000002b418
- (id)initWithStrict:(_Bool)arg1;	// IMP=0x000000000002b3a0
