...
+ (id)serviceName;	// IMP=0x006000000003f9c5
+ (id)sharedInstance;	// IMP=0x006000000003f960
- (void).cxx_destruct;	// IMP=0x000000000004022e
...
- (void)removeObserver:(id)arg1;	// IMP=0x000000000004012b
- (void)addObserver:(id)arg1;	// IMP=0x00000000000400d7
- (id)findOrRegisterIcon:(id)arg1;	// IMP=0x000000000003fefe
- (void)dealloc;	// IMP=0x000000000003fecf
- (id)_init;	// IMP=0x000000000003fa1c
