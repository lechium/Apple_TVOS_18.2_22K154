...
+ (id)customRecipeWithInfo:(id)arg1 bundle:(id)arg2;	// IMP=0x001000000003318e
- (void).cxx_destruct;	// IMP=0x0000000000033654
...
- (id)resourceNamed:(id)arg1;	// IMP=0x00000000000334b0
- (id)initWithRecipe:(id)arg1 bitmapResources:(id)arg2 symbolResources:(id)arg3 bundle:(id)arg4;	// IMP=0x00000000000333b3
