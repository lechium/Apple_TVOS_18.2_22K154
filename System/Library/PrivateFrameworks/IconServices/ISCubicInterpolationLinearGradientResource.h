...
- (void).cxx_destruct;	// IMP=0x000000000002d96a
...
- (id)imageForSize:(struct CGSize)arg1 scale:(double)arg2;	// IMP=0x000000000002d5ef
- (id)initWithStartingColor:(id)arg1 endingColor:(id)arg2;	// IMP=0x000000000002d556
