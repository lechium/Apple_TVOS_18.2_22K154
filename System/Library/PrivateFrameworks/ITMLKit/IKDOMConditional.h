...
- (void)mutateWithDOMElement:(id)arg1;	// IMP=0x0000000000011577
- (_Bool)passesForDataItem:(id)arg1 default:(_Bool)arg2;	// IMP=0x0000000000011265
...
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000010d15
