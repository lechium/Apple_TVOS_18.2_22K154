...
- (void).cxx_destruct;	// IMP=0x00000000000e18e8
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e0fab
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e0e65
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0e4f
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0df7
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e0c18
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x000000000000236f
- (id)dsepm_viewElement;	// IMP=0x000000000000235e
