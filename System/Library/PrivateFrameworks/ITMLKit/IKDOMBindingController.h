...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x0010000000093ca6
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x00100000000937ef
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x001000000009268c
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x0010000000090e55
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x0010000000090d9a
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x0010000000090566
- (void).cxx_destruct;	// IMP=0x0000000000095cd7
...
- (void)_evaluateMutationRules;	// IMP=0x00000000000959f0
- (void)_resolveBinding;	// IMP=0x00000000000946d7
- (_Bool)_canBeReused;	// IMP=0x0000000000094455
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x0000000000092e9b
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x0000000000092a9c
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x0000000000091f77
- (void)dealloc;	// IMP=0x0000000000091ec6
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000090e6a
