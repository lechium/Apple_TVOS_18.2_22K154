...
- (void).cxx_destruct;	// IMP=0x00000000000e1fa6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1ee9
- (id)initWithItems:(id)arg1 usedPrototypesByIdentifier:(id)arg2 indexTitles:(id)arg3;	// IMP=0x00000000000e1dfd
