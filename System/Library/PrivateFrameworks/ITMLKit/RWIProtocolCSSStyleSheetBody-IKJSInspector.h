...
+ (id)ik_stylesheetBodyFromRuleList:(id)arg1 forStyleMarkup:(id)arg2 withHeader:(id)arg3;	// IMP=0x0020000000015130
+ (id)safe_initWithStyleSheetId:(id)arg1 rules:(id)arg2;	// IMP=0x00200000000cf006
