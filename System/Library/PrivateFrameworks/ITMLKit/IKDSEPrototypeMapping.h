...
+ (id)prototypeMappingFromAppPrototype:(id)arg1 dataSourceElement:(id)arg2 elementFactory:(id)arg3;	// IMP=0x0060000000002385
- (void).cxx_destruct;	// IMP=0x0000000000002749
...
- (id)initWithIdentifier:(id)arg1 viewElement:(id)arg2 usageIndexes:(id)arg3;	// IMP=0x0000000000002661
