...
+ (id)hashForObserver:(id)arg1;	// IMP=0x0060000000024b24
- (void).cxx_destruct;	// IMP=0x0000000000024dc1
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x0000000000024c53
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000024b49
