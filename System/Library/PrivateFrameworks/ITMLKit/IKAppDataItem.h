...
- (void).cxx_destruct;	// IMP=0x00000000000e1dbf
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e1cf6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1ceb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e1a69
- (unsigned long long)hash;	// IMP=0x00000000000e1a25
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e1924
