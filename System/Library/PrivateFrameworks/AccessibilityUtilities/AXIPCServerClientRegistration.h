...
- (unsigned long long)hash;	// IMP=0x0000000000026617
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002659e
- (void)dealloc;	// IMP=0x000000000002654d
- (id)initWithPort:(unsigned int)arg1 identifier:(id)arg2;	// IMP=0x000000000002630a
