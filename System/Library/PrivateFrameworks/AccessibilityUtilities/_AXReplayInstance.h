...
+ (id)replayBlock:(CDUnknownBlockType)arg1 name:(id)arg2 attempts:(long long)arg3 interval:(double)arg4 async:(_Bool)arg5 queue:(id)arg6 completion:(CDUnknownBlockType)arg7;	// IMP=0x0060000000098b0e
- (void).cxx_destruct;	// IMP=0x0000000000099383
...
- (id)_genericFailError;	// IMP=0x0000000000099204
- (void)_dispatchAsynchronously;	// IMP=0x0000000000098f46
- (void)_dispatchSynchronously;	// IMP=0x0000000000098d2c
- (void)dispatch;	// IMP=0x0000000000098c79
