...
- (void).cxx_destruct;	// IMP=0x00000000001fa460
...
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001fa280
- (id)initWithOptimizerType:(unsigned long long)arg1 learningRate:(float)arg2 momentum:(float)arg3 gradientClipMin:(id)arg4 gradientClipMax:(id)arg5;	// IMP=0x00000000001fa150
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000001f9f80
