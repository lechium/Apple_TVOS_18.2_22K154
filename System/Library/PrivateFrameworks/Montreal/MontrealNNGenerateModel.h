...
- (void).cxx_destruct;	// IMP=0x00000000001fe630
...
- (id)networkOutputs;	// IMP=0x00000000001fe310
- (id)networkInputs;	// IMP=0x00000000001fe060
- (void)removeOutput:(id)arg1;	// IMP=0x00000000001fdf00
- (void)addOutputs:(id)arg1;	// IMP=0x00000000001fdc10
- (void)removeInput:(id)arg1;	// IMP=0x00000000001fdab0
- (void)addInputs:(id)arg1;	// IMP=0x00000000001fd7c0
- (id)modelContainerPath;	// IMP=0x00000000001fd4a0
- (void *)generateModelContainer;	// IMP=0x00000000001fd2d0
- (void)merge:(id)arg1;	// IMP=0x00000000001fd080
@property struct MontrealNeuralNetwork *nnObject; // @synthesize nnObject=_nnObject;
- (void)dealloc;	// IMP=0x00000000001fcfc0
- (id)initWithWeightFormat:(unsigned long long)arg1;	// IMP=0x00000000001fced0
