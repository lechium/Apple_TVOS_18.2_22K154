...
- (void).cxx_destruct;	// IMP=0x000000000014c470
...
- (id)createDataContainer;	// IMP=0x000000000014c050
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x000000000014bee0
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000014bdc0
- (id)jsonDescription;	// IMP=0x000000000014bb70
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000014b7d0
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x000000000014b730
- (void)keepTensors:(id)arg1;	// IMP=0x000000000014b440
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x000000000014b030
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x000000000014a650
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x000000000014a480
- (id)checkForValidity;	// IMP=0x000000000014a240
