...
- (void)creditRecoveryPaymentPlanInformationForAccountIdentifier:(NSString *)arg1 allowFetchFromServer:(_Bool)arg2 completion:(void (^)(_Bool, _Bool))arg3;
- (void)creditRecoveryPaymentPlansForAccountIdentifier:(NSString *)arg1 allowFetchFromServer:(_Bool)arg2 completion:(void (^)(NSArray *))arg3;
- (void)updateCreditRecoveryPaymentPlansForAccountIdentifier:(NSString *)arg1 completion:(void (^)(NSArray *, NSError *))arg2;
...
- (void)reprocessPayLaterFinancingPlansForMerchantCleanup:(void (^)(void))arg1;
...
- (void)processPhysicalCardExpirationMessaging:(NSSet *)arg1 physicalCards:(NSSet *)arg2 account:(PKAccount *)arg3;
...
- (void)updatePhysicalCardsForAccountWithIdentifier:(NSString *)arg1 force:(_Bool)arg2 completion:(void (^)(NSSet *, NSError *))arg3;
...
- (void)updatePaymentFundingSourcesForAccountIdentifier:(NSString *)arg1 force:(_Bool)arg2 completion:(void (^)(NSArray *, NSError *))arg3;
...
- (void)deleteBeneficiaryWithIdentifier:(NSString *)arg1 accountIdentifier:(NSString *)arg2 completion:(void (^)(NSError *))arg3;
