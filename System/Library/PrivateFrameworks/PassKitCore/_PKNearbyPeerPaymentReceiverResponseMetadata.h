...
+ (void)receiverDataWithNonce:(id)arg1 nearbyMetadata:(id)arg2 appearanceData:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0060000000136580
- (void).cxx_destruct;	// IMP=0x0000000000136b00
- (id)init;	// IMP=0x0000000000136aa0
