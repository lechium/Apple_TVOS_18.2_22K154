...
+ (id)timeRef;	// IMP=0x0060000000055f5e
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000005600d
- (id)initWithUUID:(unsigned char [16])arg1 continuous:(unsigned long long)arg2;	// IMP=0x0000000000055fdd
