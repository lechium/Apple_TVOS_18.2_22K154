...
- (id)stringForIndex:(id)arg1;	// IMP=0x0000000000045959
- (id)indexForString:(id)arg1;	// IMP=0x000000000004584d
- (id)dataRepresentation;	// IMP=0x0000000000045435
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x0000000000044fab
- (id)init;	// IMP=0x0000000000044f45
