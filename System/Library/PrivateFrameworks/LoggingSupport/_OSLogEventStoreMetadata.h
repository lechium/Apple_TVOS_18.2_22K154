...
- (void).cxx_destruct;	// IMP=0x00000000000569e1
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x00000000000569ad
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x00000000000566f7
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000005617b
