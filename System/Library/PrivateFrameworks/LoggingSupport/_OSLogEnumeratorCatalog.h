...
- (void).cxx_destruct;	// IMP=0x00000000000195f3
...
- (void)enumerateSubchunksUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000019312
- (void)unionWithRange:(struct _NSRange)arg1;	// IMP=0x00000000000192ed
...
- (void)dealloc;	// IMP=0x000000000001927c
- (id)initWithStore:(id)arg1 index:(id)arg2 fileHeader:(struct tracev3_chunk_s *)arg3 range:(struct _NSRange)arg4 chunk:(struct tracev3_chunk_s *)arg5;	// IMP=0x000000000001917d
