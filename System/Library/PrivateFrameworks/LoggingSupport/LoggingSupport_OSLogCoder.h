...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002e0bb
- (void)setTruncated;	// IMP=0x000000000002e0b3
- (void)setPublic;	// IMP=0x000000000002e092
- (void)_initBlob;	// IMP=0x000000000002dfe4
