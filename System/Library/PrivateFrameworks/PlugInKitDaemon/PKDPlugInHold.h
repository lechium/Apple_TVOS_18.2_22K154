...
- (id)description;	// IMP=0x000000000000c5c0
- (unsigned long long)hash;	// IMP=0x000000000000c570
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c4a0
- (id)initWithPlugIns:(id)arg1 extensionPointName:(id)arg2 forClient:(id)arg3;	// IMP=0x000000000000c320
