...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x00100000000156e5
+ (void)notifyExtensionMainCalled;	// IMP=0x00100000000156b4
- (void).cxx_destruct;	// IMP=0x00000000000159f0
...
- (id)initForCurrentProcess;	// IMP=0x0000000000015760
