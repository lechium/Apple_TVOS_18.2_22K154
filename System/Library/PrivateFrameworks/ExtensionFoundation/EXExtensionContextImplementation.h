...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x00100000000108ee
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000108e6
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x0010000000010868
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x0010000000010718
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x001000000001066f
+ (id)_extensionContextHostProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x0010000000010359
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x0010000000010302
- (void).cxx_destruct;	// IMP=0x000000000001386a
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000013446
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x000000000001343b
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000001320d
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012f91
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012dbc
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000129ff
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012794
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x00000000000124c6
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011b17
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x0000000000011b0c
- (_Bool)_isHost;	// IMP=0x0000000000011ad9
- (void)dealloc;	// IMP=0x0000000000011a84
- (void)invalidate;	// IMP=0x0000000000011970
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x000000000001145b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000113e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000113d7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000011283
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x0000000000010bb1
