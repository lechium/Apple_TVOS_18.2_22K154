...
- (void)_assetDidChange:(id)arg1;	// IMP=0x000000000002f4f4
- (void)_filesystemDidChange:(id)arg1;	// IMP=0x000000000002f23d
- (id)fetchBundles;	// IMP=0x000000000002ecf5
- (void)dealloc;	// IMP=0x000000000002ec3a
- (id)init;	// IMP=0x000000000002ec0f
- (id)initWithConfigurationType:(id)arg1 provider:(id)arg2;	// IMP=0x000000000002df47
