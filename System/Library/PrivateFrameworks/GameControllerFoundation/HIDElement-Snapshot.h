...
- (id)gc_snapshot;	// IMP=0x002000000001ff3e
- (id)debugDescription;	// IMP=0x002000000002fa28
- (id)valueForKey:(id)arg1;	// IMP=0x002000000002f905
- (id)valueForElementKey:(id)arg1;	// IMP=0x002000000002f7db
