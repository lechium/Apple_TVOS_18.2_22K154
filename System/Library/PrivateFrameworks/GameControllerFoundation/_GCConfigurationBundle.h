...
- (void).cxx_destruct;	// IMP=0x000000000001b95f
...
- (id)debugDescription;	// IMP=0x000000000001b851
- (id)redactedDescription;	// IMP=0x000000000001b7be
- (id)description;	// IMP=0x000000000001b72b
@property(readonly) NSString *identifier;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001b70e
- (id)init;	// IMP=0x000000000001b6e3
- (id)initWithPath:(id)arg1;	// IMP=0x000000000001b6cf
- (id)initWithPath:(id)arg1 error:(id *)arg2;	// IMP=0x000000000001a803
