...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002d1f8
- (void).cxx_destruct;	// IMP=0x000000000002d6c4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002d52e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002d3da
- (id)init;	// IMP=0x000000000002d3af
- (id)initWithAsset:(id)arg1;	// IMP=0x000000000002d200
