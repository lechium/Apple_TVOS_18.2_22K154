...
- (void).cxx_destruct;	// IMP=0x0000000000084dc3
...
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000084af4
- (id)initWithConcreteContainer:(id)arg1 context:(id)arg2;	// IMP=0x0000000000084a59
