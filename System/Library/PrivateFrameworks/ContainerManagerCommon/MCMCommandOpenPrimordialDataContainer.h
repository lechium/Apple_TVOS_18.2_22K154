...
+ (Class)incomingMessageClass;	// IMP=0x006000000007cb40
+ (unsigned long long)command;	// IMP=0x006000000007cb14
- (void).cxx_destruct;	// IMP=0x000000000007cac0
...
- (void)execute;	// IMP=0x000000000007c13e
- (_Bool)preflightClientAllowed;	// IMP=0x000000000007c115
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000007bab7
