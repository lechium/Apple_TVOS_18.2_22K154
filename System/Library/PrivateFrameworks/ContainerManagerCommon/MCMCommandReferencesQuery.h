...
+ (Class)incomingMessageClass;	// IMP=0x0010000000070384
+ (unsigned long long)command;	// IMP=0x0010000000070358
- (void).cxx_destruct;	// IMP=0x0000000000070130
...
- (void)execute;	// IMP=0x000000000006fbe5
- (_Bool)preflightClientAllowed;	// IMP=0x000000000006fb51
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000006fa32
