...
+ (Class)incomingMessageClass;	// IMP=0x001000000003ba45
+ (unsigned long long)command;	// IMP=0x001000000003ba19
- (void).cxx_destruct;	// IMP=0x000000000003b97a
...
- (void)execute;	// IMP=0x000000000003ae4b
- (_Bool)preflightClientAllowed;	// IMP=0x000000000003adb7
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000003ac80
