...
- (void).cxx_destruct;	// IMP=0x000000000003dccf
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x000000000003d62c
- (void)_addPaths:(id)arg1;	// IMP=0x000000000003d5d3
- (id)managedPathForURL:(id)arg1;	// IMP=0x000000000003d3fd
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x000000000003d063
- (id)initWithDaemonUser:(id)arg1 privileged:(_Bool)arg2;	// IMP=0x000000000003cf02
