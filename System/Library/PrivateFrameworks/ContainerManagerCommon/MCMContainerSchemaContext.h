...
+ (id)contextWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 finalContainerPath:(id)arg3 POSIXMode:(unsigned short)arg4 POSIXOwner:(id)arg5 containerClass:(unsigned long long)arg6 dataProtectionClass:(int)arg7 libraryRepair:(id)arg8 identifier:(id)arg9;	// IMP=0x0060000000075f3c
- (void).cxx_destruct;	// IMP=0x0000000000075ec5
...
- (id)initWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 finalContainerPath:(id)arg3 POSIXMode:(unsigned short)arg4 POSIXOwner:(id)arg5 containerClass:(unsigned long long)arg6 dataProtectionClass:(int)arg7 libraryRepair:(id)arg8 identifier:(id)arg9;	// IMP=0x0000000000075b86
