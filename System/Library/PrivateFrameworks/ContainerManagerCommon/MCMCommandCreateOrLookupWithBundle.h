...
+ (Class)incomingMessageClass;	// IMP=0x00100000000a62c6
+ (unsigned long long)command;	// IMP=0x00100000000a629a
- (void).cxx_destruct;	// IMP=0x00000000000a6202
...
- (void)execute;	// IMP=0x00000000000a5a90
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000a5990
- (void)dealloc;	// IMP=0x00000000000a590c
- (void)_commonInit:(id)arg1;	// IMP=0x00000000000a53c4
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x00000000000a5221
