...
- (void).cxx_destruct;	// IMP=0x0000000000085d53
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000859e5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000085955
- (_Bool)isEqualToManagedPath:(id)arg1;	// IMP=0x000000000008591a
@property(readonly) unsigned long long hash;
- (id)managedPathByAppendingPathComponent:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6;	// IMP=0x00000000000857c1
- (id)initWithURL:(id)arg1 flags:(unsigned long long)arg2 ACLConfig:(unsigned long long)arg3 mode:(unsigned short)arg4 dpClass:(int)arg5 owner:(id)arg6 parent:(id)arg7;	// IMP=0x000000000008569f
