...
- (void).cxx_destruct;	// IMP=0x000000000007cef7
...
- (void)dealloc;	// IMP=0x000000000007cdbf
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000007cc6f
- (id)initWithSandboxToken:(const char *)arg1 personaUniqueString:(id)arg2 url:(id)arg3;	// IMP=0x000000000007cb72
