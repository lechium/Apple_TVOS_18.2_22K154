...
@interface MCMResultWithContainerBase
{
    ...
    NSString *_creator;	// 96 = 0x60
}

- (void).cxx_destruct;	// IMP=0x00000000000a5156
...
- (void)dealloc;	// IMP=0x00000000000a4dc8
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4 includeUserManagedAssetsRelPath:(_Bool)arg5 includeCreator:(_Bool)arg6;	// IMP=0x00000000000a4a5a
- (id)initWithContainerPath:(id)arg1 containerIdentity:(id)arg2 uuid:(id)arg3 sandboxToken:(const char *)arg4 includePath:(_Bool)arg5;	// IMP=0x00000000000a482e
- (id)initWithUUID:(id)arg1 containerPathIdentifier:(id)arg2 identifier:(id)arg3 containerClass:(unsigned long long)arg4 POSIXUser:(id)arg5 personaUniqueString:(id)arg6 sandboxToken:(const char *)arg7 existed:(_Bool)arg8 url:(id)arg9 info:(id)arg10 transient:(_Bool)arg11 userManagedAssetsRelPath:(id)arg12 creator:(id)arg13;	// IMP=0x00000000000a45e0
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000a4183
