...
- (void).cxx_destruct;	// IMP=0x000000000009e6e0
...
- (unsigned int)disposition;	// IMP=0x000000000009e0ef
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000009d6ce

// Remaining properties
@property(readonly, nonatomic) id <MCMContainerConfiguration> containerConfig; // @dynamic containerConfig;
