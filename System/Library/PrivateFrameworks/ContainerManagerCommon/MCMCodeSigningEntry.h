...
- (void).cxx_destruct;	// IMP=0x00000000000d7982
...
- (id)description;	// IMP=0x00000000000d75f4
- (unsigned long long)hash;	// IMP=0x00000000000d749f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d716b
- (id)serialize;	// IMP=0x00000000000d6ea9
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x00000000000d6c7d
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x00000000000d6c48
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x00000000000d6b90
