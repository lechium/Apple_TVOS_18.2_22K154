...
- (void).cxx_destruct;	// IMP=0x00000000000a7131
...
- (void)_encodeContainerIdentitiesAndPathsOnXPCContainers:(id)arg1;	// IMP=0x00000000000a6bbc
- (void)_encodeContainersOnXPCContainers:(id)arg1;	// IMP=0x00000000000a6809
- (id)initWithContainers:(id)arg1 includePath:(_Bool)arg2 includeInfo:(_Bool)arg3 includeUserManagedAssetsRelPath:(_Bool)arg4 includeCreator:(_Bool)arg5 clientIdentity:(id)arg6 skipSandboxExtensions:(_Bool)arg7;	// IMP=0x00000000000a66c2
- (id)initWithContainerPaths:(id)arg1 containerIdentities:(id)arg2 includePath:(_Bool)arg3 clientIdentity:(id)arg4 skipSandboxExtensions:(_Bool)arg5;	// IMP=0x00000000000a6578
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000a647b
