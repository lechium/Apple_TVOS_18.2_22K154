...
- (void).cxx_destruct;	// IMP=0x0000000000072c2c
...
- (unsigned int)disposition;	// IMP=0x0000000000072b16
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x00000000000726dc
