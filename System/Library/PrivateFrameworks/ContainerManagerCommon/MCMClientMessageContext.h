...
- (void).cxx_destruct;	// IMP=0x000000000009efe5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009ee1e
- (id)initForCurrentThreadContextWithXPCMessage:(id)arg1 userIdentityCache:(id)arg2;	// IMP=0x000000000009ed30
