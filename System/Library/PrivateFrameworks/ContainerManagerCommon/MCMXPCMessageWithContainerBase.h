...
- (void).cxx_destruct;	// IMP=0x000000000009ecfc
...
- (id)containerIdentityFromXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000009e91c
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000009e829
