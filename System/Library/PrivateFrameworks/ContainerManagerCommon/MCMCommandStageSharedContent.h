...
+ (Class)incomingMessageClass;	// IMP=0x0010000000052e01
+ (unsigned long long)command;	// IMP=0x0010000000052dd5
- (void).cxx_destruct;	// IMP=0x0000000000052d70
...
- (void)execute;	// IMP=0x0000000000051a12
- (_Bool)preflightClientAllowed;	// IMP=0x000000000005197e
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000051868
