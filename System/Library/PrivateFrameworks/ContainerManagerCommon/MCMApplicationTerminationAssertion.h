...
- (void).cxx_destruct;	// IMP=0x00000000000b486a
@property(retain, nonatomic) RBSTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x00000000000b4776
- (void)invalidate;	// IMP=0x00000000000b46ad
- (id)initWithBundleIdentifier:(id)arg1 reason:(id)arg2;	// IMP=0x00000000000b40eb
