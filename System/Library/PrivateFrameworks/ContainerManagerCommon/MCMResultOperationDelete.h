...
- (void).cxx_destruct;	// IMP=0x00000000000a3cda
@property(retain, nonatomic) NSObject<OS_xpc_object> *xpcToMerge; // @synthesize xpcToMerge=_xpcToMerge;
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000a3ab4
- (void)mergeWithXPCResult:(id)arg1;	// IMP=0x00000000000a3a81
