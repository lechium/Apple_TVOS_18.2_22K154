...
- (void).cxx_destruct;	// IMP=0x0000000000057dc4
...
- (unsigned int)disposition;	// IMP=0x0000000000057cc3
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000057bc1
