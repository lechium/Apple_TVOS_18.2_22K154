...
- (id).cxx_construct;	// IMP=0x00000000000264df
- (void).cxx_destruct;	// IMP=0x0000000000026473
- (_Bool)finishProfile:(id *)arg1;	// IMP=0x00000000000262c2
- (_Bool)finishDataset:(id *)arg1;	// IMP=0x0000000000025fdb
- (_Bool)addItem:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000025d50
- (_Bool)startDataset:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000025d3c
- (_Bool)startProfile:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000025d28
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0000000000025ca9
