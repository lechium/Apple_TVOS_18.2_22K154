...
- (void).cxx_destruct;	// IMP=0x000000000009895b
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000987b3
- (void)start;	// IMP=0x0000000000098681
- (id)initWithConnectionInterface:(id)arg1 typeIdentifier:(long long)arg2 entityIdentifiers:(id)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000000983bd
