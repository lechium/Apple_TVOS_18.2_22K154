...
- (void).cxx_destruct;	// IMP=0x00000000000cc887
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000cc6c0
- (void)start;	// IMP=0x00000000000cc5fa
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000cc334
