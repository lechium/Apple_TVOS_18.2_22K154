...
- (void).cxx_destruct;	// IMP=0x00000000000b5fc5
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000b5df8
- (void)start;	// IMP=0x00000000000b5c41
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 suggestionContext:(id)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000000b59f6
