...
- (void).cxx_destruct;	// IMP=0x00000000000a0bea
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000a0a56
- (void)start;	// IMP=0x00000000000a0842
- (id)initWithConnectionInterface:(id)arg1 action:(id)arg2 actionMetadata:(id)arg3 parameterIdentifier:(id)arg4 queue:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x00000000000a04cd
