...
- (void).cxx_destruct;	// IMP=0x00000000000cc1b0
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000cbf4f
- (void)start;	// IMP=0x00000000000cbc5e
- (id)initWithConnectionInterface:(id)arg1 action:(id)arg2 actionMetadata:(id)arg3 parameterMetadata:(id)arg4 optionsProviderReference:(id)arg5 searchTerm:(id)arg6 localeIdentifier:(id)arg7 queue:(id)arg8 completionHandler:(CDUnknownBlockType)arg9;	// IMP=0x00000000000cb7d3
