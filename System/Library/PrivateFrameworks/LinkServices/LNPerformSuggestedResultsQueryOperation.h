...
- (void).cxx_destruct;	// IMP=0x00000000000c569e
...
- (void)finishWithError:(id)arg1;	// IMP=0x00000000000c54d7
- (void)start;	// IMP=0x00000000000c5393
- (id)initWithConnectionInterface:(id)arg1 entityType:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000c50cb
- (id)initWithConnectionInterface:(id)arg1 entityMangledTypeName:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000000c4e05
