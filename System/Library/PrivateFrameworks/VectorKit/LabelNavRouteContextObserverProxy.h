...
- (id).cxx_construct;	// IMP=0x0000000000690550
- (void).cxx_destruct;	// IMP=0x00000000006904d0
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x0000000000690480
- (void)stopObserving:(id)arg1;	// IMP=0x0000000000690360
- (void)startObserving:(id)arg1;	// IMP=0x00000000006900b0
- (void)dealloc;	// IMP=0x000000000068ffe0
- (id)initWithRouteContextChangeObserver:(struct RouteContextChangeObserver *)arg1;	// IMP=0x000000000068ffa0
