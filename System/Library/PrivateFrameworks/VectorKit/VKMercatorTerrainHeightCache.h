...
- (id).cxx_construct;	// IMP=0x0000000000c4a9a0
- (void).cxx_destruct;	// IMP=0x0000000000c4a970
@property(nonatomic) __weak id <VKMercatorTerrainHeightProvider> heightProvider; // @synthesize heightProvider=_heightProvider;
- (void)invalidateRect:(const void *)arg1;	// IMP=0x0000000000c4a7d0
- (void)removeCachedValueForAnchor:(void *)arg1;	// IMP=0x0000000000c4a730
- (double)heightForAnchor:(void *)arg1;	// IMP=0x0000000000c4a5b0
