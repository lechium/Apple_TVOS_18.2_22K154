...
- (id).cxx_construct;	// IMP=0x0000000000e216c0
- (void).cxx_destruct;	// IMP=0x0000000000e21630
...
- (void)experimentConfigurationDidChange:(id)arg1;	// IMP=0x0000000000e21400
- (void)resourceManifestManager:(id)arg1 didChangeActiveTileGroup:(id)arg2 fromOldTileGroup:(id)arg3;	// IMP=0x0000000000e21230
- (void)resourceManifestManagerWillChangeActiveTileGroup:(id)arg1;	// IMP=0x0000000000e210f0
- (void)dealloc;	// IMP=0x0000000000e20fa0
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000e20e80
