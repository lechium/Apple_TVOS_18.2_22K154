...
- (id).cxx_construct;	// IMP=0x000000000098d580
- (void).cxx_destruct;	// IMP=0x000000000098d4e0
...
- (void)didReceiveMemoryWarning:(_Bool)arg1;	// IMP=0x000000000098d470
- (void)renderSceneWithEngine:(void *)arg1 completion:(function_2e574590)arg2;	// IMP=0x000000000098d2f0
- (void)cancelLoad;	// IMP=0x000000000098d2c0
- (void)loadScene;	// IMP=0x000000000098d290
@property(readonly, nonatomic) VKCamera *vkCamera;
@property(readonly, nonatomic) double pitch;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) GEOMapRegion *mapRegion;
- (void)setCenterCoordinate:(CDStruct_2c43369c)arg1 altitude:(double)arg2 yaw:(double)arg3 pitch:(double)arg4;	// IMP=0x000000000098d130
- (void)setMapRegion:(id)arg1 pitch:(double)arg2 yaw:(double)arg3;	// IMP=0x000000000098d070
- (void)cancelTileRequests;	// IMP=0x000000000098d060
- (void)clearScene;	// IMP=0x000000000098d050
- (void)didLayout;	// IMP=0x000000000098d040
- (void)updateWithTimestamp:(double)arg1 withContext:(void *)arg2;	// IMP=0x000000000098d020
@property(readonly, nonatomic) shared_ptr_e963992e taskContext;
- (id)initWithMapEngine:(void *)arg1;	// IMP=0x000000000098cd30
