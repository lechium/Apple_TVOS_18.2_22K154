...
- (id).cxx_construct;	// IMP=0x0000000000c3de40
- (void).cxx_destruct;	// IMP=0x0000000000c3de10
...
- (id)detailedDescription;	// IMP=0x0000000000c3dbc0
...
- (void)projectFromLocation:(id)arg1 routeMatch:(id)arg2 speedMultiplier:(double)arg3 routeLine:(id)arg4;	// IMP=0x0000000000c3d3c0
- (void)_updateCourseAndPositionFromRouteMatch:(id)arg1;	// IMP=0x0000000000c3d110
- (void)reset;	// IMP=0x0000000000c3d0b0
- (void)dealloc;	// IMP=0x0000000000c3d030
- (id)init;	// IMP=0x0000000000c3cfb0
