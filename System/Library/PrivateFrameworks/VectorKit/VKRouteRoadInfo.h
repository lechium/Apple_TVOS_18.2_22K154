...
- (id).cxx_construct;	// IMP=0x0000000000af0800
- (void).cxx_destruct;	// IMP=0x0000000000af07d0
...
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x0000000000af06d0
