...
- (void).cxx_destruct;	// IMP=0x0000000000e19680
@property(nonatomic) CDStruct_2c43369c coordinate; // @synthesize coordinate=_coordinate;
- (id)feature;	// IMP=0x0000000000e19650
- (id)initWithClusterNode:(void *)arg1 clusterTree:(const void *)arg2 baseStyle:(const void *)arg3 imageText:(id)arg4 annotationText:(id)arg5 annotationLocale:(id)arg6;	// IMP=0x0000000000e17d60
