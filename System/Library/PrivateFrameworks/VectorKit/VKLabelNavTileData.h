...
- (id).cxx_construct;	// IMP=0x0000000000cb8630
- (void).cxx_destruct;	// IMP=0x0000000000cb85a0
...
- (void)findOppositeCarriagewayJunctionsWithRouteFeatures:(void *)arg1 distanceThreshold:(double)arg2;	// IMP=0x0000000000cb79a0
- (void)appendNavJunctionsInWorldRect:(const void *)arg1 junctions:(id)arg2;	// IMP=0x0000000000cb7810
- (void)initializeJunctionInfos;	// IMP=0x0000000000cb74a0
- (id)findTileEdgeJunctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000cb72e0
- (void)_findTileEdgeJunctions;	// IMP=0x0000000000cb71a0
- (void)addJunction:(id)arg1;	// IMP=0x0000000000cb7100
- (id)junctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000cb6f50
- (id)junctionForGeoJunction:(struct GeoCodecsConnectivityJunction *)arg1;	// IMP=0x0000000000cb6f30
- (id)initWithTile:(const void *)arg1;	// IMP=0x0000000000cb6e10
