...
- (id).cxx_construct;	// IMP=0x0000000000c48c80
- (void).cxx_destruct;	// IMP=0x0000000000c488b0
...
- (struct __IOSurface *)flipImage;	// IMP=0x0000000000c48850
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x0000000000c48760
- (struct CGPoint)convertPoint:(struct CGPoint)arg1 toLayer:(id)arg2;	// IMP=0x0000000000c486a0
@property(readonly, nonatomic) float averageFPS;
// Preceding property had unknown attributes: ?
// Original attribute string: Tf,?,R,N

- (void)prepareRenderTask:(const void *)arg1;	// IMP=0x0000000000c48670
- (_Bool)hasRenderTarget;	// IMP=0x0000000000c48630
- (void)destroyRenderTarget;	// IMP=0x0000000000c484e0
- (void)createRenderTarget;	// IMP=0x0000000000c47b70
- (_Bool)insertDisplayLayer:(id)arg1;	// IMP=0x0000000000c47a10
...
- (void)didEnterBackground;	// IMP=0x0000000000c47700
- (void)didReceiveMemoryWarning;	// IMP=0x0000000000c476f0
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x0000000000c47670
- (void)_didReadPixels:(void *)arg1;	// IMP=0x0000000000c47550
- (void)drawInContext:(struct CGContext *)arg1 registry:(void *)arg2;	// IMP=0x0000000000c46f00
- (void)setBackgroundColor:(struct CGColor *)arg1;	// IMP=0x0000000000c46ea0
- (void)setContentsGravity:(id)arg1;	// IMP=0x0000000000c46e10
- (void)setOpaque:(_Bool)arg1;	// IMP=0x0000000000c46db0
- (void)setNeedsDisplayOnBoundsChange:(_Bool)arg1;	// IMP=0x0000000000c46d50
- (void)expandedPerformanceHUD:(id)arg1;	// IMP=0x0000000000c46730
- (void)disablePerformanceHUD:(id)arg1;	// IMP=0x0000000000c46710
- (void)enablePerformanceHUD:(id)arg1;	// IMP=0x0000000000c466f0
- (void)willPresent;	// IMP=0x0000000000c46620
- (void)didUpdateFrameTexture;	// IMP=0x0000000000c46570
- (void)willUpdateFrameTexture;	// IMP=0x0000000000c464c0
- (_Bool)isDelayedRenderQueueConsumptionSupported;	// IMP=0x0000000000c46470
- (void)prepareTargetsForPlatormsWithoutFramebufferFetch:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x0000000000c45660
- (void)prepareTargetsForPlatormsWithFramebufferFetch:(const void *)arg1;	// IMP=0x0000000000c45110
- (void)_prepareTexture:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x0000000000c45030
- (void)prepareTexture:(const void *)arg1;	// IMP=0x0000000000c45010
@property(readonly, nonatomic) CALayer *layer;
- (void)dealloc;	// IMP=0x0000000000c44d90
...
- (void)removeSizeObserver:(id)arg1;	// IMP=0x0000000000c44d30
- (void)addSizeObserver:(id)arg1;	// IMP=0x0000000000c44d10
- (void)_notifyObserversSizeChanged:(struct CGSize)arg1;	// IMP=0x0000000000c44b90
- (id)initWithContentScale:(double)arg1 useMultisampling:(_Bool)arg2 extraColorFormats:(const void *)arg3 shouldRasterize:(_Bool)arg4 allowBlitToDrawable:(_Bool)arg5 taskContext:(const void *)arg6 device:(void *)arg7 sharedResources:(id)arg8 services:(void *)arg9 signpostId:(unsigned long long)arg10;	// IMP=0x0000000000c43d90
