...
- (id).cxx_construct;	// IMP=0x00000000000bbd70
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x00000000000bbbb0
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x00000000000bbac0
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x00000000000bba20
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x00000000000bb910
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x00000000000bb6a0
- (void)computeFromCamera:(id)arg1;	// IMP=0x00000000000bb190
