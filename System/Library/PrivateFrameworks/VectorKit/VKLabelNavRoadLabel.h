...
- (id).cxx_construct;	// IMP=0x0000000000cadc80
- (void).cxx_destruct;	// IMP=0x0000000000cadc20
...
- (id)description;	// IMP=0x0000000000cada90
- (id)displayGroup;	// IMP=0x0000000000cad8d0
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000cad8b0
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x0000000000cad820
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x0000000000cad670
