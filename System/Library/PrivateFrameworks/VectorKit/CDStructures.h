...
struct FeatureStyleAttributesSet {
    struct set<std::shared_ptr<const FeatureStyleAttributes>, FeatureStyleAttributesSet::FeatureStyleAttributesCompare, std::allocator<std::shared_ptr<const FeatureStyleAttributes>>> _set;
    struct vector<std::shared_ptr<const FeatureStyleAttributes>, geo::StdAllocator<std::shared_ptr<const FeatureStyleAttributes>, geo::codec::Allocator>> _array;
};
...
struct GeoCodecsRoadEdge {
    struct GeoCodecsRoadFeature *_field1;
...
struct Monitorable<md::ConfigValue<GEOConfigKeyBOOL, bool>> {
    ...
    _Bool _value;
    id _listener;
    struct shared_ptr<std::atomic<bool>> _valid;
...
struct StdAllocator<std::shared_ptr<const FeatureStyleAttributes>, geo::codec::Allocator> {
    struct Allocator *_allocator;
};
...
struct function<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double>&, geo::Unit<geo::MeterUnitDescription, double>&)> {
    struct __value_func<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double>&, geo::Unit<geo::MeterUnitDescription, double>&)> {
        struct type _field1;
        void *_field2;
    } _field1;
};
...
struct optional<std::pair<const unsigned int, const unsigned int>> {
    union {
        char _field1;
        struct pair<const unsigned int, const unsigned int> _field2;
    } _field1;
    _Bool _field2;
};
...
struct pair<const unsigned int, const unsigned int> {
    unsigned int _field1;
    unsigned int _field2;
};
...
struct set<std::shared_ptr<const FeatureStyleAttributes>, FeatureStyleAttributesSet::FeatureStyleAttributesCompare, std::allocator<std::shared_ptr<const FeatureStyleAttributes>>> {
    struct __tree<std::shared_ptr<const FeatureStyleAttributes>, FeatureStyleAttributesSet::FeatureStyleAttributesCompare, std::allocator<std::shared_ptr<const FeatureStyleAttributes>>> {
        void *__begin_node_;
        struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *>*>, std::allocator<std::__tree_node<std::shared_ptr<const FeatureStyleAttributes>, void *>>> {
            struct __tree_end_node<std::__tree_node_base<void *>*> __value_;
        } __pair1_;
...
struct shared_ptr<std::atomic<bool>> {
    void *__ptr_;
    struct __shared_weak_count *__cntrl_;
};
...
struct unique_ptr<md::GeoidModel, std::default_delete<md::GeoidModel>> {
    struct __compressed_pair<md::GeoidModel *, std::default_delete<md::GeoidModel>> {
        struct GeoidModel *__value_;
    } __ptr_;
};
...
struct vector<Arrow, std::allocator<Arrow>> {
    struct Arrow *__begin_;
    struct Arrow *__end_;
    struct __compressed_pair<Arrow *, std::allocator<Arrow>> {
        struct Arrow *__value_;
    } __end_cap_;
};
...
struct vector<std::shared_ptr<const FeatureStyleAttributes>, geo::StdAllocator<std::shared_ptr<const FeatureStyleAttributes>, geo::codec::Allocator>> {
    void *__begin_;
    void *__end_;
    struct __compressed_pair<std::shared_ptr<const FeatureStyleAttributes>*, geo::StdAllocator<std::shared_ptr<const FeatureStyleAttributes>, geo::codec::Allocator>> {
        void *__value_;
        struct StdAllocator<std::shared_ptr<const FeatureStyleAttributes>, geo::codec::Allocator> __value_;
    } __end_cap_;
};
...
typedef struct {
    ...
    struct PolylineCoordinate coordinate;
    double distance;
...
typedef struct function<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double>&, geo::Unit<geo::MeterUnitDescription, double>&)> {
    struct __value_func<bool (std::shared_ptr<gdc::Camera>, geo::Unit<geo::MeterUnitDescription, double>&, geo::Unit<geo::MeterUnitDescription, double>&)> {
        struct type _field1;
        void *_field2;
    } _field1;
...
typedef struct optional<std::pair<const unsigned int, const unsigned int>> {
    union {
        char _field1;
        struct pair<const unsigned int, const unsigned int> _field2;
    } _field1;
...
typedef struct weak_ptr<mre::GraphicsResourceStore> {
    struct GraphicsResourceStore *__ptr_;
    struct __shared_weak_count *__cntrl_;
} weak_ptr_34f35905;
