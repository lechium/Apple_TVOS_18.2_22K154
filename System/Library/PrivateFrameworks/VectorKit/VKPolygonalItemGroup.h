...
- (id).cxx_construct;	// IMP=0x00000000007721c0
- (void).cxx_destruct;	// IMP=0x0000000000771c60
...
- (void)clearRouteAttributes;	// IMP=0x0000000000771c10
- (void)setRouteAttributes:(const struct PolygonRouteAttributes *)arg1;	// IMP=0x0000000000771be0
- (void)updateCachedStyles;	// IMP=0x00000000007710c0
@property(readonly, nonatomic) const void *featureIds;
- (_Bool)hasFeatureId:(unsigned long long)arg1;	// IMP=0x0000000000770f50
- (_Bool)canAcceptPolygon:(void *)arg1;	// IMP=0x0000000000770ea0
- (void)didFinishAddingData;	// IMP=0x0000000000770c10
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;	// IMP=0x0000000000770be0
- (unsigned char)indexForGeoFeatureAttributes:(const void *)arg1;	// IMP=0x00000000007707c0
- (const void *)commitRangesToVerticalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x0000000000770610
- (const void *)commitRangesToHorizontalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x0000000000770460
- (const void *)commitRangesToVenueWallEndCapRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000007702b0
- (const void *)commitRangesToVenueWallRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x0000000000770100
- (const void *)commitRangesToStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x000000000076ff20
- (const void *)commitRangesToFillRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x000000000076fd40
@property(readonly, nonatomic) void *fillMeshes;
@property(readonly, nonatomic) float tileZoom;
- (void *)styleQueries:(const struct StyleQueryOverride *)arg1;	// IMP=0x000000000076fd00
...
- (const void *)attributeSets;	// IMP=0x000000000076fc90
- (unsigned char)maxAttributeSetsPerGroup;	// IMP=0x000000000076fc80
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4 storage:(shared_ptr_fb8448a7)arg5;	// IMP=0x000000000076f980
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4;	// IMP=0x000000000076f8f0
