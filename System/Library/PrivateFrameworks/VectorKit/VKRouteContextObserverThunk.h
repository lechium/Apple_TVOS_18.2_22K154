...
- (id).cxx_construct;	// IMP=0x00000000008bc410
- (void).cxx_destruct;	// IMP=0x00000000008bc3f0
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x00000000008bc330
- (void)dealloc;	// IMP=0x00000000008bc2b0
- (id)initWithRouteContext:(id)arg1 transitSupport:(void *)arg2;	// IMP=0x00000000008bc1e0
