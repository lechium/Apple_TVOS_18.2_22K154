...
- (id).cxx_construct;	// IMP=0x0000000000601710
- (void).cxx_destruct;	// IMP=0x00000000006016b0
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000601340
- (void)resumeAnimation;	// IMP=0x0000000000601240
- (void)pauseAnimation;	// IMP=0x00000000006011d0
- (_Bool)isAnimating;	// IMP=0x0000000000601160
@property(readonly, nonatomic) _Bool shouldForceZoomToFit;
- (void)setGesturing:(_Bool)arg1;	// IMP=0x00000000006010c0
- (void)stopTrackingAnnotation;	// IMP=0x0000000000600f50
- (void)startTrackingAnnotation:(id)arg1 trackHeading:(_Bool)arg2 animated:(_Bool)arg3 duration:(double)arg4 timingFunction:(CDUnknownBlockType)arg5;	// IMP=0x0000000000600ba0
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x0000000000600b90
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x0000000000600b80
- (void)updateFramerate;	// IMP=0x0000000000600a80
@property(readonly, nonatomic, getter=isTrackingHeading) _Bool trackingHeading;
- (void)dealloc;	// IMP=0x0000000000600920
- (id)initWithMapDataAccess:(struct MapDataAccess *)arg1 animationRunner:(struct AnimationRunner *)arg2 runLoopController:(struct RunLoopController *)arg3 cameraDelegate:(id)arg4;	// IMP=0x00000000006008c0
