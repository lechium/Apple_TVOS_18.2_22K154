...
- (id).cxx_construct;	// IMP=0x0000000000aeda20
- (void).cxx_destruct;	// IMP=0x0000000000aed6b0
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x0000000000aed550
- (_Bool)_updateActiveRouteRange;	// IMP=0x0000000000aecef0
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x0000000000aec970
- (void)_updateCurrentRoadInfo;	// IMP=0x0000000000aec620
- (void)_initalizeCurrentRoadInfo;	// IMP=0x0000000000aec600
- (void)_dedupOffRouteRoads;	// IMP=0x0000000000aeb730
- (void)_updatePreferredLabelPlacements;	// IMP=0x0000000000aeb3f0
- (void)_updateRoadsInGuidance;	// IMP=0x0000000000aeae70
- (void)_updateRoadStarts;	// IMP=0x0000000000aea9b0
- (void)_updateUniqueOffRouteRoads;	// IMP=0x0000000000aea3d0
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x0000000000ae93a0
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x0000000000ae80c0
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x0000000000ae7690
- (void)_addVisibleSigns;	// IMP=0x0000000000ae75c0
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x0000000000ae4440
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x0000000000ae42a0
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x0000000000ae3fe0
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x0000000000ae3f40
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x0000000000ae3100
- (void)styleManagerDidFinishAnimating;	// IMP=0x0000000000ae30f0
- (void)styleManagerDidStartAnimating;	// IMP=0x0000000000ae30e0
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x0000000000ae30c0
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x0000000000ae2860
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000ae1460
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x0000000000ae0920
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x0000000000ae07a0
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x0000000000ae0620
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x0000000000ae0020
- (void)_refreshGuidanceRoadNames;	// IMP=0x0000000000adfd70
- (void)_reloadRouteJunctions;	// IMP=0x0000000000adf9d0
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x0000000000adf680
- (_Bool)isNavMode;	// IMP=0x0000000000adf660
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x0000000000adf4c0
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x0000000000adf2c0
- (id)init;	// IMP=0x0000000000adec60
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000008d6520
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000008d4c30
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000008d4ac0
- (_Bool)needsDebugDraw;	// IMP=0x00000000008d49b0
