...
- (void).cxx_destruct;	// IMP=0x00000000000ac80a
...
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000000ac6cb
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithBoundingBoxes:(id)arg1 classLogits:(id)arg2 anchors:(id)arg3;	// IMP=0x00000000000ac55a
