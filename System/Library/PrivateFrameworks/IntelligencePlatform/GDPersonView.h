...
- (void).cxx_destruct;	// IMP=0x00000000003740b6
- (void)enumeratePeopleWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000374045
- (id)initWithAccessAssertion:(id)arg1 database:(id)arg2;	// IMP=0x0000000000373ec3
