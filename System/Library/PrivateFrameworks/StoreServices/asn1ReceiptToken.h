...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x006000000016f464
...
- (id)description;	// IMP=0x000000000016f638
- (void)dealloc;	// IMP=0x000000000016f429
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x000000000016f3c0
