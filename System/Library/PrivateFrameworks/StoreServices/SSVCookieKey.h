...
+ (id)keyWithIdentifier:(id)arg1 scope:(long long)arg2;	// IMP=0x00100000000d5e14
- (void).cxx_destruct;	// IMP=0x00000000000d5f80
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d5e89
