...
+ (void)setSupportsSecureCoding:(_Bool)arg1;	// IMP=0x001000000000e529
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000e4ec
- (void).cxx_destruct;	// IMP=0x000000000001016c
- (id)init;	// IMP=0x000000000000fd4d
@property(nonatomic, readonly) long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000fc60
@property(nonatomic, readonly) NSString *description;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000f796
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000f1d7
- (id)initWithIdentifier:(id)arg1 assistantId:(id)arg2 builder:(CDUnknownBlockType)arg3;	// IMP=0x000000000000e99c
