...
- (void).cxx_destruct;	// IMP=0x0000000000024295
- (void)homeManagerDidUpdateDataSyncInProgress:(id)arg1;	// IMP=0x0000000000024221
- (void)homeManagerDidUpdateHomes:(id)arg1;	// IMP=0x000000000002408a
- (id)init;	// IMP=0x0000000000018165
