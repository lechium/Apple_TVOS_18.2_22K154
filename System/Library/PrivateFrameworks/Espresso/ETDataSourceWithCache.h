...
- (id).cxx_construct;	// IMP=0x000000000077b612
- (void).cxx_destruct;	// IMP=0x000000000077b5dd
- (int)numberOfDataPoints;	// IMP=0x000000000077b5c7
- (id)dataPointAtIndex:(int)arg1;	// IMP=0x000000000077b40f
- (id)initWithDataSource:(id)arg1 dumpPath:(id)arg2;	// IMP=0x000000000077b338
- (id)initWithDataSource:(id)arg1;	// IMP=0x000000000077b25c
