...
- (void).cxx_destruct;	// IMP=0x0000000000927e3c
...
- (struct _mxnetTools_imageID_t_)imageID;	// IMP=0x0000000000927ceb
- (id)labels;	// IMP=0x0000000000927bf0
- (id)imageData;	// IMP=0x0000000000927a85
- (_Bool)nextRecordAndError:(id *)arg1;	// IMP=0x0000000000927572
- (_Bool)seekRecordWithID:(struct _mxnetTools_imageID_t_ *)arg1 error:(id *)arg2;	// IMP=0x0000000000927475
- (id)initWithRecFile:(id)arg1 error:(id *)arg2;	// IMP=0x00000000009271a7
