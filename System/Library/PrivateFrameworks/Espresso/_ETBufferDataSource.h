...
- (id).cxx_construct;	// IMP=0x000000000099d6fc
- (void).cxx_destruct;	// IMP=0x000000000099d6ca
...
- (float *)dataAtIndex:(unsigned long long)arg1 key:(const void *)arg2;	// IMP=0x000000000099d4f6
- (id)initWithBlobShapes:(const void *)arg1 numberOfDataPoints:(unsigned long long)arg2 batchSize:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x000000000099d2da
- (id)dataPointAtIndex:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x000000000099cacd
- (unsigned long long)numberOfDataPoints;	// IMP=0x000000000099cac3
