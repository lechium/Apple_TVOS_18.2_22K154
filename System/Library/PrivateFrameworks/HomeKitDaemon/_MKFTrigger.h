...
+ (id)backingModelProtocol;	// IMP=0x0010000000bd6b47
+ (id)homeRelation;	// IMP=0x0010000000bd6b17
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000bd6a63
+ (Class)cd_modelClass;	// IMP=0x00100000004158da
+ (id)fetchRequest;	// IMP=0x0010000000ef8899
- (void)removeActionSetsObject:(id)arg1;	// IMP=0x0000000000bd6cca
- (void)addActionSetsObject:(id)arg1;	// IMP=0x0000000000bd6cae
@property(retain, nonatomic) NSArray *actionSets;
- (id)castIfTrigger;	// IMP=0x0000000000bd6bcc
