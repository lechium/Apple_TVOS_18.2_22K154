...
- (void).cxx_destruct;	// IMP=0x0000000000bc7ea1
...
- (void)handleUpdatedDestination:(id)arg1;	// IMP=0x0000000000bc7db0
- (void)handleMediaDestinationUpdatedNotification:(id)arg1;	// IMP=0x0000000000bc7935
- (id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 notificationCenter:(id)arg3 dataSource:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000bc77c1
