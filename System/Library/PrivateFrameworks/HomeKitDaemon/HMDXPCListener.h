...
- (void).cxx_destruct;	// IMP=0x0000000000c352c7
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000c351e7
- (void)stop;	// IMP=0x0000000000c351aa
- (void)start;	// IMP=0x0000000000c35126
@property(retain) NSObject<OS_dispatch_queue> *queue;
- (id)initWithXPCListener:(id)arg1;	// IMP=0x0000000000c34fee
