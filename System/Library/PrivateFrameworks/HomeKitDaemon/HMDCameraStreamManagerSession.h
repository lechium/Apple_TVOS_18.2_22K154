...
+ (id)logCategory;	// IMP=0x00100000001a948e
- (void).cxx_destruct;	// IMP=0x00000000001a9419
...
- (id)logIdentifier;	// IMP=0x00000000001a9323
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x00000000001a9144
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x00000000001a8fc1
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x00000000001a8e8e
