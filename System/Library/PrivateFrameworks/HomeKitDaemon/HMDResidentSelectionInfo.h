...
- (void).cxx_destruct;	// IMP=0x0000000000cb4623
...
- (id)description;	// IMP=0x0000000000cb4510
- (id)initWithPreferredResidentIDSIdentifier:(id)arg1 currentResidentSelectionModeType:(unsigned long long)arg2 selectionTimestamp:(id)arg3;	// IMP=0x0000000000cb4478
- (id)initWithPreferredResidentIDSIdentifier:(id)arg1 selectionTimestamp:(id)arg2;	// IMP=0x0000000000cb4459
