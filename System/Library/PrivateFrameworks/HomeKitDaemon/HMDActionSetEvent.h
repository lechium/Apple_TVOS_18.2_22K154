...
- (void).cxx_destruct;	// IMP=0x00000000007f6f86
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x00000000007f69f5
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000146ad2
