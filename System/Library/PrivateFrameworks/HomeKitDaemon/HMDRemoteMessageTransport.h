...
+ (id)logCategory;	// IMP=0x0010000000eab03e
+ (id)remoteMessageFromMessage:(id)arg1 secure:(_Bool)arg2 accountRegistry:(id)arg3;	// IMP=0x0010000000eaa81a
+ (unsigned long long)restriction;	// IMP=0x0010000000eaa80d
+ (id)remoteMessageTransportsForProductInfo:(id)arg1;	// IMP=0x0010000000cd2e13
- (void).cxx_destruct;	// IMP=0x0000000000eaa438
...
- (id)dumpState;	// IMP=0x0000000000eaa321
- (void)configureWithHomeMembershipVerifier:(id)arg1;	// IMP=0x0000000000eaa30d
- (long long)compareCapability:(id)arg1 key:(id)arg2 withCapability:(id)arg3;	// IMP=0x0000000000eaa191
- (_Bool)doesResponse:(id)arg1 matchAllCapabilities:(id)arg2;	// IMP=0x0000000000ea9f80
- (id)matchResponse:(id)arg1 requestedCapabilities:(id)arg2;	// IMP=0x0000000000ea95ae
- (id)remoteMessageFromMessage:(id)arg1;	// IMP=0x0000000000ea9527
- (void)postDidReceiveRemoteMessageWithNoListenerFromDevice:(id)arg1;	// IMP=0x0000000000ea9476
- (_Bool)isValidMessage:(id)arg1;	// IMP=0x0000000000ea946e
- (id)start;	// IMP=0x0000000000ea9414
@property(readonly, nonatomic, getter=isSecure) _Bool secure;
- (id)initWithAccountRegistry:(id)arg1;	// IMP=0x0000000000ea9338
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x0000000000ea9284
- (id)init;	// IMP=0x0000000000ea91dc
