...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006d082f
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x0010000000644ef5
+ (id)ruleForHAP;	// IMP=0x0010000000644d3a
- (void).cxx_destruct;	// IMP=0x00000000006cffc2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006cf833
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006cf701
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006cf0ac
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006ceab5
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 advertisementProtocol:(id)arg4 flags:(id)arg5 serviceType:(id)arg6;	// IMP=0x00000000006ce98e
- (id)init;	// IMP=0x00000000006ce95f
- (void)addTo:(id)arg1;	// IMP=0x00000000006428eb
