...
+ (id)logCategory;	// IMP=0x001000000082793f
- (void).cxx_destruct;	// IMP=0x00000000008278f0
...
- (id)callerVersionForMessage:(id)arg1;	// IMP=0x00000000008276c5
- (unsigned long long)dataSourceCallerPrivilegeWithMessage:(id)arg1 error:(id *)arg2;	// IMP=0x00000000008274c0
- (void)handleAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x0000000000826d94
- (id)siriAvailableLanguagesSetting;	// IMP=0x0000000000826d07
- (void)handleAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x00000000008264c9
- (id)initWithHomeUUID:(id)arg1 languageValuesDataProvider:(id)arg2;	// IMP=0x0000000000826427
