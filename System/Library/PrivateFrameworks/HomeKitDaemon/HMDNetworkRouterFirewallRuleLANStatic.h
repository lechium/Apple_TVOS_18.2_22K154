...
+ (id)createWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3 purpose:(unsigned long long)arg4 allowInterAccessoryConnections:(_Bool)arg5 direction:(unsigned char)arg6 requiredForHAPFunctionality:(_Bool)arg7 ruleDictionary:(id)arg8 error:(id *)arg9;	// IMP=0x0060000000ee2cd2
- (void).cxx_destruct;	// IMP=0x0000000000ee2c8c
...
- (id)prettyJSONDictionary;	// IMP=0x0000000000ee2964
- (id)attributeDescriptions;	// IMP=0x0000000000ee26fe
- (unsigned long long)hash;	// IMP=0x0000000000ee264b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ee2456
- (id)initWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3 purpose:(unsigned long long)arg4 allowInterAccessoryConnections:(_Bool)arg5 direction:(unsigned char)arg6 requiredForHAPFunctionality:(_Bool)arg7 transportProtocol:(unsigned char)arg8 ipAddress:(id)arg9 portStart:(unsigned short)arg10 portEnd:(unsigned short)arg11 icmpTypes:(id)arg12;	// IMP=0x0000000000ee2332
