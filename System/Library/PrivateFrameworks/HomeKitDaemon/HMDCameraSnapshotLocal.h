...
+ (id)logCategory;	// IMP=0x00100000003a1b83
- (void).cxx_destruct;	// IMP=0x00000000003a19f8
...
- (void)_handleSnapshotFile:(id)arg1 error:(id)arg2;	// IMP=0x00000000003a16e8
- (void)_getSnapshot:(unsigned long long)arg1;	// IMP=0x00000000003a15c6
- (void)getSnapshot:(unsigned long long)arg1;	// IMP=0x00000000003a154a
- (id)logIdentifier;	// IMP=0x00000000003a14fa
- (void)dealloc;	// IMP=0x00000000003a13fb
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 snapshotRequestHandler:(id)arg6;	// IMP=0x00000000003a12c5
