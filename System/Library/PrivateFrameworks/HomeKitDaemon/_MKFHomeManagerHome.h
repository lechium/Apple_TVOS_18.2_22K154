...
+ (id)backingModelProtocol;	// IMP=0x00100000002fe9ff
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000002fe94b
+ (id)fetchRequest;	// IMP=0x001000000042082d
+ (Class)cd_modelClass;	// IMP=0x001000000045df22
- (id)castIfHomeManagerHome;	// IMP=0x00000000002fea46
@property(readonly, copy, nonatomic) MKFHomeManagerHomeDatabaseID *databaseID;
- (id)hmd_modelsWithChangeType:(unsigned long long)arg1 detached:(_Bool)arg2 error:(id *)arg3;	// IMP=0x000000000045de32
