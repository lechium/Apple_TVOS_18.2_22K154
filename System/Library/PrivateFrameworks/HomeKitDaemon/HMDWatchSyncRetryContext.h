...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x0010000000370ef3
- (void).cxx_destruct;	// IMP=0x0000000000370ec2
...
- (id)attributeDescriptions;	// IMP=0x0000000000370ccf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000370cc4
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x0000000000370b86
