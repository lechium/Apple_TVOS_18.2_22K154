...
- (void).cxx_destruct;	// IMP=0x0000000000b7e5fc
...
- (id)description;	// IMP=0x0000000000b7e4d9
- (id)initWithUUID:(id)arg1 accessoryName:(id)arg2 manufacturerName:(id)arg3 category:(id)arg4 certificationStatus:(unsigned long long)arg5 productData:(id)arg6;	// IMP=0x0000000000b7e3ab
