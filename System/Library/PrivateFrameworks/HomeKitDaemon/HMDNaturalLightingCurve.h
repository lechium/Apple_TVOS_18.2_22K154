...
+ (id)logCategory;	// IMP=0x00100000006f4dda
+ (long long)colorTemperatureMiredsFromKelvins:(long long)arg1;	// IMP=0x00100000006f4db7
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000006f4daf
- (void).cxx_destruct;	// IMP=0x00000000006f4c6d
...
- (id)transitionPointsWithmillisecondsElapsedSinceStartOfDay:(unsigned long long)arg1;	// IMP=0x00000000006f405f
- (id)colorTemperatureForBrightness:(long long)arg1 millisecondsElapsedSinceStartOfDay:(unsigned long long)arg2;	// IMP=0x00000000006f3e85
@property(readonly) unsigned long long checksum;
- (id)attributeDescriptions;	// IMP=0x00000000006f35b8
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006f3489
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006f347e
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006f313b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000006f2cf5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000006f21cf
- (id)initWithCurve:(id)arg1 minimumColorTemperature:(long long)arg2 maximumColorTemperature:(long long)arg3;	// IMP=0x00000000006f1c5e
- (id)initWithVersion:(unsigned long long)arg1 transitionPoints:(id)arg2 minimumBrightness:(long long)arg3 maximumBrightness:(long long)arg4 minimumColorTemperature:(long long)arg5 maximumColorTemperature:(long long)arg6;	// IMP=0x00000000006f1b90
