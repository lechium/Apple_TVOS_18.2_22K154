...
+ (id)backingModelProtocol;	// IMP=0x0010000000e6e1d4
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000e6e120
+ (id)fetchRequest;	// IMP=0x0010000000814052
@property(readonly) id <MKFHome> home;
- (id)castIfNotificationRegistrationActionSet;	// IMP=0x0000000000e6e0c7
@property(readonly, copy, nonatomic) MKFNotificationRegistrationActionSetDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x0000000000e6dff5
