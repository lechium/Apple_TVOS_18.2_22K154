...
- (void).cxx_destruct;	// IMP=0x000000000037d81e
...
- (id)mainReturningError;	// IMP=0x000000000037d1d5
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x000000000037d0fa
