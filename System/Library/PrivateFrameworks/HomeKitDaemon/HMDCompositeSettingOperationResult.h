...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x0060000000453dc1
- (void).cxx_destruct;	// IMP=0x0000000000453d6e
...
- (id)attributeDescriptions;	// IMP=0x0000000000453b44
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x0000000000453a56
