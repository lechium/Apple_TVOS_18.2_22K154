...
+ (id)logCategory;	// IMP=0x00600000007cca30
- (void).cxx_destruct;	// IMP=0x00000000007cbb3d
...
- (void)_notifyDelegateWifiInfoUpdated:(id)arg1;	// IMP=0x00000000007cb880
- (void)_postUpdateSoftwareVersionIfDifferent:(id)arg1;	// IMP=0x00000000007cb6f9
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x00000000007cb53a
- (id)currentWifiNetworkInfo;	// IMP=0x00000000007cb369
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x00000000007cb0fe
- (void)configure;	// IMP=0x00000000007caf76
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 delegate:(id)arg3 notificationCenter:(id)arg4 wifiManager:(id)arg5;	// IMP=0x00000000007cae73
