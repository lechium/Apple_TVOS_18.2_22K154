...
+ (id)properties;	// IMP=0x0010000000764ab4
+ (id)schemaHashRoot;	// IMP=0x0010000000764a93
+ (Class)cd_entityClass;	// IMP=0x001000000042081c
+ (id)cd_parentReferenceName;	// IMP=0x001000000042080f
