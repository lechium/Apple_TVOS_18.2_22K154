...
+ (id)backingModelProtocol;	// IMP=0x0010000000ee7d64
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000ee7cb0
+ (id)fetchRequest;	// IMP=0x0010000000774d66
@property(readonly) id <MKFHome> home;
- (id)castIfNotificationRegistrationCharacteristic;	// IMP=0x0000000000ee7dab
