...
+ (id)logCategory;	// IMP=0x0010000000ccae5a
- (void).cxx_destruct;	// IMP=0x0000000000ccadc1
...
- (id)logIdentifier;	// IMP=0x0000000000ccacfc
@property(readonly, copy) NSString *stateDescription;
- (_Bool)containsState:(long long)arg1;	// IMP=0x0000000000ccabf6
- (void)updateState:(long long)arg1;	// IMP=0x0000000000ccaa8f
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 remoteCapabilities:(id)arg4 localNetworkConfig:(id)arg5 streamPreference:(id)arg6;	// IMP=0x0000000000cca92b
