...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x0060000000ab99a2
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x0060000000ab9790
- (void).cxx_destruct;	// IMP=0x0000000000ab9768
...
- (id)description;	// IMP=0x0000000000ab95f2
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (unsigned long long)hash;	// IMP=0x0000000000ab9408
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ab929e
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x0000000000ab91fb
