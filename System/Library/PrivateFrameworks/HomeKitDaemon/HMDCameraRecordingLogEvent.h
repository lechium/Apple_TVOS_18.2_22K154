...
- (void).cxx_destruct;	// IMP=0x0000000000758dda
...
- (id)attributeDescriptions;	// IMP=0x0000000000758bf6
@property(readonly, copy) NSUUID *ephemeralCameraID;
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x0000000000758ad9
