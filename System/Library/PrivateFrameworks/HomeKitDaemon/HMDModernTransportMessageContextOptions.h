...
@interface HMDModernTransportMessageContextOptions : NSObject
{
    ...
    _Bool _expectRapportSuccess;	// 10 = 0xa
...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0060000000dbc6ce
- (void).cxx_destruct;	// IMP=0x0000000000dbc69b
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000dbc500
