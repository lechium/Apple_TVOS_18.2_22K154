...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000019df30
- (void).cxx_destruct;	// IMP=0x000000000019deaa
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019dc5a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019d7c5
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000019d583
- (_Bool)_parseFromTLVData;	// IMP=0x000000000019d205
@property(readonly, copy) NSData *tlvData;
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 comfortNoisePayloadType:(id)arg5;	// IMP=0x000000000019cecd
