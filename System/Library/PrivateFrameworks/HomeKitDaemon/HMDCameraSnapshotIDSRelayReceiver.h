...
+ (id)logCategory;	// IMP=0x0010000000dcd160
- (void).cxx_destruct;	// IMP=0x0000000000dcce2c
...
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000dccb98
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000dcca0d
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withContext:(id)arg5;	// IMP=0x0000000000dcbfc5
- (void)_didReceiveData:(id)arg1 error:(id)arg2;	// IMP=0x0000000000dcbe7c
- (void)dealloc;	// IMP=0x0000000000dcbcfd
- (void)_handleDataFromSocket:(id)arg1;	// IMP=0x0000000000dcb53c
- (void)_startDataReceive;	// IMP=0x0000000000dcb39d
- (id)logIdentifier;	// IMP=0x0000000000dcb34d
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 machOUUID:(id)arg3 workQueue:(id)arg4 sessionInviterDeviceVerifier:(id)arg5 delegate:(id)arg6;	// IMP=0x0000000000dcb13f
