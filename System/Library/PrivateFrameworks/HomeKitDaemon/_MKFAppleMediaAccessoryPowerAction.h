...
+ (id)backingModelProtocol;	// IMP=0x0010000000541eb8
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000541e04
+ (Class)cd_modelClass;	// IMP=0x0010000000bdce0d
+ (id)fetchRequest;	// IMP=0x0010000000c12c68
@property(readonly) id <MKFHome> home;
- (id)castIfAppleMediaAccessoryPowerAction;	// IMP=0x0000000000541eff
