...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001daae4
- (void).cxx_destruct;	// IMP=0x00000000001da73a
...
- (id)describeWithFormat;	// IMP=0x00000000001da43f
- (void)_resolve:(_Bool)arg1;	// IMP=0x00000000001da228
- (void)_clearTimer;	// IMP=0x00000000001da172
- (void)_configureTimer;	// IMP=0x00000000001da026
- (void)expire;	// IMP=0x00000000001d9e20
- (void)decline;	// IMP=0x00000000001d9e0c
- (void)accept;	// IMP=0x00000000001d9df5
- (void)updateTimer:(unsigned long long)arg1 clientQueue:(id)arg2;	// IMP=0x00000000001d9cd0
- (void)updateInvitationState:(long long)arg1;	// IMP=0x00000000001d9c84
- (void)notifyStateChangedForMessage:(id)arg1;	// IMP=0x00000000001d9c7e
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000001d9a21
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d9911
- (id)initWithCoder:(id)arg1 invitationData:(id)arg2;	// IMP=0x00000000001d9805
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d97f1
- (_Bool)refreshDisplayName;	// IMP=0x00000000001d97e9
- (id)initWithInvitationData:(id)arg1 forHome:(id)arg2;	// IMP=0x00000000001d9737
