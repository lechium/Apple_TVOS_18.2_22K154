...
+ (id)logCategory;	// IMP=0x001000000092b697
- (void).cxx_destruct;	// IMP=0x000000000092b478
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000092b166
- (id)logIdentifier;	// IMP=0x000000000092b0c5
- (void)_transmitStatus:(_Bool)arg1;	// IMP=0x000000000092a7ab
- (id)_buildPayload;	// IMP=0x000000000092a532
- (void)_transmitAfter:(double)arg1;	// IMP=0x000000000092a093
- (_Bool)_residentDidChange;	// IMP=0x000000000092a01b
- (id)initWithResidentDevice:(id)arg1 owner:(id)arg2;	// IMP=0x0000000000929ed2
