...
+ (id)logCategory;	// IMP=0x00100000006011d0
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x0010000000600f35
- (void).cxx_destruct;	// IMP=0x00000000005feec6
...
- (id)logIdentifier;	// IMP=0x00000000005fed5f
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000005fe668
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000000005fe43b
- (void)_commitConfigurationUpdate;	// IMP=0x00000000005fe302
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000005fe14c
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x00000000005fe0db
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00000000005fdf6f
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000005fde31
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x00000000005fdccc
