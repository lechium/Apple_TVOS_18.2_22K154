...
+ (id)logCategory;	// IMP=0x0010000000613b1b
- (void).cxx_destruct;	// IMP=0x00000000006136e2
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000613055
- (void)didReceiveCachedEvent:(id)arg1 topic:(id)arg2 source:(id)arg3;	// IMP=0x0000000000613043
- (void)subscribeToWiFiInfoUpdate;	// IMP=0x0000000000612e33
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000612d99
