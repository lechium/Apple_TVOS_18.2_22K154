...
+ (id)backingModelProtocol;	// IMP=0x0010000000595f5a
+ (id)homeRelation;	// IMP=0x0010000000595f2a
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000595f11
+ (id)fetchRequest;	// IMP=0x001000000031d440
+ (Class)cd_modelClass;	// IMP=0x0010000000960d4a
@property(readonly, retain, nonatomic) NSArray *zones;
- (id)materializeOrCreateApplicationDataRelation:(_Bool *)arg1;	// IMP=0x000000000059603f
@property(readonly, retain, nonatomic) NSArray *accessories;
- (id)castIfRoom;	// IMP=0x0000000000595fdf
@property(readonly, copy, nonatomic) MKFRoomDatabaseID *databaseID;
- (_Bool)shouldIncludeForRestrictedGuestWithContext:(id)arg1;	// IMP=0x0000000000990308
