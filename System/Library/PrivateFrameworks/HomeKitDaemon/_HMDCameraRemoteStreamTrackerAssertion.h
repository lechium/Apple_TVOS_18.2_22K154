...
- (void).cxx_destruct;	// IMP=0x00000000008f0236
...
- (void)dealloc;	// IMP=0x00000000008f0188
- (id)initWithStreamTracker:(id)arg1 streamIdentifier:(id)arg2;	// IMP=0x00000000008f00ed
