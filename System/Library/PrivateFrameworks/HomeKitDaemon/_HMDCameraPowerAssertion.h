...
- (void).cxx_destruct;	// IMP=0x0000000000a3c7f6
...
- (void)dealloc;	// IMP=0x0000000000a3c738
- (id)initWithPowerAssertionHandler:(id)arg1 remoteRequestHandlerSessionID:(id)arg2;	// IMP=0x0000000000a3c69d
