...
- (void).cxx_destruct;	// IMP=0x00000000008f6f9a
...
- (id)attributeDescriptions;	// IMP=0x00000000008f6c3e
@property(readonly, getter=isExpired) _Bool expired;
@property(readonly, copy) NSUUID *deviceUUID;
- (id)initWithCameraUUID:(id)arg1 numberOfAvailableDevices:(long long)arg2 totalNumberOfJobSlots:(long long)arg3 remainingNumberOfJobSlots:(long long)arg4 analysisNode:(id)arg5 decisionDate:(id)arg6;	// IMP=0x00000000008f6a1d
