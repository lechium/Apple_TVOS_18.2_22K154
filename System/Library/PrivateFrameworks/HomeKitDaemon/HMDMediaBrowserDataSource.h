...
+ (id)shortDescription;	// IMP=0x0010000000dfccb5
- (void).cxx_destruct;	// IMP=0x0000000000dfcca2
...
- (id)performOperation:(id)arg1;	// IMP=0x0000000000dfcc0e
...
- (id)init;	// IMP=0x0000000000dfca18
