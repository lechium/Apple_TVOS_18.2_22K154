...
- (void).cxx_destruct;	// IMP=0x0000000000937b24
...
- (id)initWithExistingDestinationType:(id)arg1 destinationType:(id)arg2 isTriggeredOnControllerDevice:(id)arg3 userPrivilege:(id)arg4;	// IMP=0x00000000009379c7
