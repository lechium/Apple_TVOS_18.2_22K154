...
+ (id)logCategory;	// IMP=0x0060000000808dbc
- (void).cxx_destruct;	// IMP=0x0000000000808d69
...
- (id)logIdentifier;	// IMP=0x0000000000808c7a
- (_Bool)acceptMessage:(id)arg1 target:(id)arg2 errorReason:(id *)arg3;	// IMP=0x00000000008080b7
- (id)initWithTarget:(id)arg1 allowedMessages:(id)arg2 appleAccountManager:(id)arg3 systemKeychainStore:(id)arg4;	// IMP=0x0000000000807f7c
- (id)initWithTarget:(id)arg1 allowedMessages:(id)arg2;	// IMP=0x0000000000807ebc
- (id)initWithTarget:(id)arg1;	// IMP=0x0000000000807ea8
- (id)initWithName:(id)arg1;	// IMP=0x0000000000807df4
