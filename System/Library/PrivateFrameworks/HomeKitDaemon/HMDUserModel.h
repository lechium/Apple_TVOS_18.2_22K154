...
@class CKRecordID, HMDAccountHandle, HMDAccountIdentifier, NSArray, NSData, NSDictionary, NSNumber, NSString;
...
+ (id)properties;	// IMP=0x0010000000ca82a4
+ (id)shareTokenFromKeyedArchiveData:(id)arg1;	// IMP=0x0010000000961ef4
+ (id)keyedArchiveToken:(id)arg1;	// IMP=0x0010000000961ecb
+ (id)cd_getHMDUserFromMKFUser:(id)arg1;	// IMP=0x0010000000961c86
+ (id)cd_getMKFUserFromUUID:(id)arg1;	// IMP=0x0010000000961ada
+ (Class)cd_entityClass;	// IMP=0x0010000000961ac9
+ (id)cd_parentReferenceName;	// IMP=0x0010000000961abc
@property(retain, nonatomic) NSNumber *audioAnalysisUserDropInAccessLevel;
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000961388
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x000000000096111b
- (id)cd_fetchManagedObjectInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000960d79
