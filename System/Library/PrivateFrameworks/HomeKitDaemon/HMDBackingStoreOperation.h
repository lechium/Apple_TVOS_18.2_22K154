...
+ (id)logCategory;	// IMP=0x0010000000aba5ed
- (void).cxx_destruct;	// IMP=0x0000000000aba594
...
- (id)logIdentifier;	// IMP=0x0000000000aba4c5
@property(readonly, copy) NSString *description;
- (void)main;	// IMP=0x0000000000aba37b
- (id)mainReturningError;	// IMP=0x0000000000aba373
- (id)init;	// IMP=0x0000000000aba35f
- (id)initWithResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000aba28b
