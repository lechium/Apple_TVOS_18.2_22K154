...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000008362ba
- (void).cxx_destruct;	// IMP=0x0000000000836161
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000836034
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000835e69
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000835cf4
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000008359b5
- (id)initWithPrebufferLength:(id)arg1 eventTriggerOptions:(unsigned long long)arg2 mediaContainerConfigurations:(id)arg3;	// IMP=0x0000000000835900
