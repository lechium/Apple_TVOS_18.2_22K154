...
- (void).cxx_destruct;	// IMP=0x0000000000e3c0fc
...
- (id)initWithApplicationID:(id)arg1 preferencesKey:(id)arg2 preferencesSize:(unsigned long long)arg3 eventTrigger:(unsigned long long)arg4;	// IMP=0x0000000000e3be65
