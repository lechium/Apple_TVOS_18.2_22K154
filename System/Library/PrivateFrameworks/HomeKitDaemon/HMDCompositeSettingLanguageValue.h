...
- (void).cxx_destruct;	// IMP=0x000000000045339d
...
- (id)attributeDescriptions;	// IMP=0x0000000000453173
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x0000000000453076
