...
- (void).cxx_destruct;	// IMP=0x0000000000acd9f0
...
- (id)initWithActivity:(id)arg1 options:(id)arg2 promise:(id)arg3 database:(id)arg4 useAnonymousRequests:(_Bool)arg5 zoneID:(id)arg6 recordID:(id)arg7 desiredKeys:(id)arg8;	// IMP=0x0000000000acd828
