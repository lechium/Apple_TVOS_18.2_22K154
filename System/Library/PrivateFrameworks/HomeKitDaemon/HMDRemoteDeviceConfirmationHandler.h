...
- (void).cxx_destruct;	// IMP=0x0000000000c6f2bc
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c6f1f3
- (id)initWithTimeoutTimer:(id)arg1 workQueue:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000c6f0d7
