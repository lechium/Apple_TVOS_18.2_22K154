...
- (void).cxx_destruct;	// IMP=0x0000000000988185
...
- (id)attributeDescriptions;	// IMP=0x0000000000987f82
- (id)initWithEnable:(_Bool)arg1 user:(id)arg2 deviceIdsDestination:(id)arg3 mediaProfileUUID:(id)arg4;	// IMP=0x0000000000987e4f
