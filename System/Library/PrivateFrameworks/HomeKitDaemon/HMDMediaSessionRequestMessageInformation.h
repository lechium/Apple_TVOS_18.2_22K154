...
+ (id)logCategory;	// IMP=0x0010000000895b05
- (void).cxx_destruct;	// IMP=0x0000000000895af2
@property(readonly) HMFMessage *message; // @synthesize message=_message;
- (id)attributeDescriptions;	// IMP=0x00000000008959be
@property(readonly) HMDDevice *remoteSourceDevice;
@property(readonly, copy) NSUUID *messageIdentifier;
- (id)initWithMessage:(id)arg1;	// IMP=0x00000000008957fc
