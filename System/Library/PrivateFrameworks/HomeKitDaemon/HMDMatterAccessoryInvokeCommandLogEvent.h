...
- (void).cxx_destruct;	// IMP=0x0000000000046af0
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000046a60
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000046960
...
- (id)initWithHome:(id)arg1 nodeId:(unsigned long long)arg2 endpointId:(id)arg3 clusterId:(id)arg4 commandId:(id)arg5 fields:(id)arg6 source:(unsigned long long)arg7;	// IMP=0x0000000000046580
...
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000045530
