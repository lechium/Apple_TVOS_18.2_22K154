...
- (void).cxx_destruct;	// IMP=0x0000000000c40adb
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000c409d2
- (id)coreAnalyticsEventName;	// IMP=0x0000000000c409c5
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x0000000000c4093b
