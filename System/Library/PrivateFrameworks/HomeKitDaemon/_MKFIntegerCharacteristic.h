...
+ (id)backingModelProtocol;	// IMP=0x00100000004f4b3f
+ (id)fetchRequest;	// IMP=0x0010000000541de4
@property(readonly) id <MKFHome> home;
- (id)castIfIntegerCharacteristic;	// IMP=0x00000000004f4ae6
@property(readonly, copy, nonatomic) MKFIntegerCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x00000000004f498e
