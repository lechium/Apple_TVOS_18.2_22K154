...
+ (id)logCategory;	// IMP=0x00100000002ef5c9
- (void).cxx_destruct;	// IMP=0x00000000002ee63c
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000002ee237
- (void)downlinkQualityChanged:(id)arg1;	// IMP=0x00000000002ee0b8
- (void)updateReconfigurationMode:(_Bool)arg1;	// IMP=0x00000000002ede68
- (id)logIdentifier;	// IMP=0x00000000002ede42
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000002edd45
