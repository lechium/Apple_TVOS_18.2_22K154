...
+ (id)updateWithRegion:(long long)arg1 nearbyHome:(long long)arg2 accessoryReachable:(_Bool)arg3;	// IMP=0x001000000079569c
+ (id)updateWithFirstAccessory:(long long)arg1 nearbyHome:(long long)arg2;	// IMP=0x00100000007955d7
...
- (id)initWithReason:(unsigned long long)arg1 firstAccessoryReachable:(_Bool)arg2 regionStateAtHome:(long long)arg3 regionStateNearByHome:(long long)arg4 isStateCorrect:(_Bool)arg5;	// IMP=0x0000000000795153
