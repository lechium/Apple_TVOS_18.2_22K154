...
+ (id)backingModelProtocol;	// IMP=0x001000000084bffa
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000084bf46
+ (id)fetchRequest;	// IMP=0x001000000093d8e0
@property(readonly) id <MKFHome> home;
- (id)castIfCameraReachabilityBulletinRegistration;	// IMP=0x000000000084beed
@property(readonly, copy, nonatomic) MKFCameraReachabilityBulletinRegistrationDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x000000000084be1b
