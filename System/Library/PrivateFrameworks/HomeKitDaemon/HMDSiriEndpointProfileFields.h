...
- (void).cxx_destruct;	// IMP=0x0000000000985197
...
- (id)attributeDescriptions;	// IMP=0x0000000000984dfe
- (id)serializeFields;	// IMP=0x0000000000984c05
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x00000000009849f2
