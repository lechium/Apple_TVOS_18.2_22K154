...
+ (id)responsesWithRequests:(id)arg1 characteristicUpdateDictionary:(id)arg2;	// IMP=0x0060000000ecbf43
+ (id)responseWithRequest:(id)arg1 characteristicUpdateDictionary:(id)arg2;	// IMP=0x0060000000ecbdbd
+ (id)responsesWithRequests:(id)arg1 error:(id)arg2;	// IMP=0x0060000000ecbbc0
+ (id)responseWithRequest:(id)arg1 error:(id)arg2;	// IMP=0x0060000000ecbb52
- (void).cxx_destruct;	// IMP=0x0000000000ecbadd
...
- (id)attributeDescriptions;	// IMP=0x0000000000ecb4b2
@property(nonatomic, getter=isRemote) _Bool remote; // @synthesize remote=_remote;
- (id)characteristicUpdateDictionary;	// IMP=0x0000000000ecaf1e
- (void)setValue:(id)arg1 updatedTime:(id)arg2 stateNumber:(id)arg3 notificationContext:(id)arg4;	// IMP=0x0000000000ecadbe
- (id)initWithRequest:(id)arg1 error:(id)arg2;	// IMP=0x0000000000ecacc9
