...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001de413
- (void).cxx_destruct;	// IMP=0x00000000001de3c0
...
- (id)describeWithFormat;	// IMP=0x00000000001de0af
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001dde2a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ddb27
- (_Bool)refreshDisplayName;	// IMP=0x00000000001dda0f
...
- (id)initWithInviterAccount:(id)arg1 invitationIdentifier:(id)arg2 invitationState:(long long)arg3 homeName:(id)arg4 homeUUID:(id)arg5 inviterIdentity:(id)arg6 inviterMergeID:(id)arg7 expiryDate:(id)arg8;	// IMP=0x00000000001dd6e3
- (id)initWithInviterAccount:(id)arg1 invitationIdentifier:(id)arg2 invitationState:(long long)arg3 homeName:(id)arg4 homeUUID:(id)arg5 inviterIdentity:(id)arg6 expiryDate:(id)arg7;	// IMP=0x00000000001dd6ae
