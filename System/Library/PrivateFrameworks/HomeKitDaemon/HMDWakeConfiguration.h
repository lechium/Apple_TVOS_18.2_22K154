...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000e81f26
- (void).cxx_destruct;	// IMP=0x0000000000e80e46
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e80a66
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e809ae
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000e80502
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000e80120
- (id)initWithReserved:(id)arg1 custom1:(id)arg2 custom2:(id)arg3;	// IMP=0x0000000000e80068
- (id)init;	// IMP=0x0000000000e80039
