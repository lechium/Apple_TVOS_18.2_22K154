...
+ (id)backingModelProtocol;	// IMP=0x0010000000797f15
+ (id)fetchWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000797cbc
+ (id)defaultModelID;	// IMP=0x0010000000797c8c
+ (id)fetchRequest;	// IMP=0x0010000000b766c7
+ (Class)cd_modelClass;	// IMP=0x0010000000e3362f
- (id)materializeOrCreateMetadataRelation:(_Bool *)arg1;	// IMP=0x0000000000797c66
- (id)findIncomingInvitationsRelationWithModelID:(id)arg1;	// IMP=0x0000000000797c43
- (id)materializeOrCreateIncomingInvitationsRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x0000000000797c1d
@property(readonly, retain, nonatomic) NSArray *incomingInvitations;
- (id)findHomesRelationWithModelID:(id)arg1;	// IMP=0x0000000000797ba3
- (id)materializeOrCreateHomesRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x0000000000797b7d
@property(readonly, retain, nonatomic) NSArray *homes;
- (id)findAccountsRelationWithModelID:(id)arg1;	// IMP=0x0000000000797b03
- (id)materializeOrCreateAccountsRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x0000000000797add
@property(readonly, retain, nonatomic) NSArray *accounts;
- (id)castIfHomeManager;	// IMP=0x0000000000797a7d
@property(readonly, copy, nonatomic) MKFHomeManagerDatabaseID *databaseID;
- (_Bool)validateModelID:(id *)arg1 error:(id *)arg2;	// IMP=0x0000000000797f9f
- (void)awakeFromInsert;	// IMP=0x0000000000797f26
- (id)hmd_modelsWithChangeType:(unsigned long long)arg1 detached:(_Bool)arg2 error:(id *)arg3;	// IMP=0x0000000000e32ff2
