...
+ (id)logCategory;	// IMP=0x001000000051e634
- (void).cxx_destruct;	// IMP=0x000000000051e5ca
...
- (id)logIdentifier;	// IMP=0x000000000051e52b
- (id)dataSourceAccessoryWithUUID:(id)arg1;	// IMP=0x000000000051e3ca
- (void)handleSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x000000000051dd23
- (id)initWithIdentifier:(id)arg1 assistantSettingsConnection:(id)arg2;	// IMP=0x000000000051dc68
