...
+ (id)logCategory;	// IMP=0x0010000000dd2405
- (void).cxx_destruct;	// IMP=0x0000000000dd23a1
...
- (id)logIdentifier;	// IMP=0x0000000000dd22c0
- (id)negotiatedParameters;	// IMP=0x0000000000dd216b
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000dd1d3d
