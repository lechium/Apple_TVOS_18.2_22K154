...
+ (id)backingModelProtocol;	// IMP=0x00100000007b664a
+ (id)homeRelation;	// IMP=0x00100000007b661a
+ (id)fetchRequest;	// IMP=0x0010000000d3ff0c
...
- (id)castIfCharacteristic;	// IMP=0x00000000007b6c5e
@property(readonly, copy, nonatomic) MKFCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x00000000007b6b5a
- (void)pr_updateWithDictionary:(id)arg1;	// IMP=0x00000000007b693d
