...
- (void).cxx_destruct;	// IMP=0x00000000008cf944
...
- (_Bool)accessorySupportsCoordinationFreeDoorbellChime:(id)arg1;	// IMP=0x00000000008cf8cc
@property(readonly, copy) NSUUID *currentAccessoryUUID;
- (id)fetchDoorbellEnabledForAnySidekickAccessories:(id)arg1 home:(id)arg2;	// IMP=0x00000000008cf5d4
- (id)fetchDoorbellDelay;	// IMP=0x00000000008cf39e
...
- (id)initWithWorkQueue:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000008cf0a2
