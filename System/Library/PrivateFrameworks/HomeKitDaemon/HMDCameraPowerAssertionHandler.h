...
+ (id)logCategory;	// IMP=0x0010000000a3d2d8
+ (id)sharedHandler;	// IMP=0x0010000000a3d2a8
- (void).cxx_destruct;	// IMP=0x0000000000a3caf3
...
- (void)deregisterRemoteRequestHandler:(id)arg1;	// IMP=0x0000000000a3c9f9
- (void)registerRemoteRequestHandler:(id)arg1 forSessionID:(id)arg2;	// IMP=0x0000000000a3c91b
- (id)init;	// IMP=0x0000000000a3c825
