...
- (void).cxx_destruct;	// IMP=0x0000000000841d85
@property(readonly) HMUserCloudShareRepairInfo *repairInfo; // @synthesize repairInfo=_repairInfo;
- (id)description;	// IMP=0x0000000000841cb2
- (id)initWithStartDate:(id)arg1 containerID:(id)arg2 home:(id)arg3 repairInfo:(id)arg4;	// IMP=0x0000000000841c28
