...
+ (id)logCategory;	// IMP=0x0010000000d20f56
- (void).cxx_destruct;	// IMP=0x0000000000d20df4
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x0000000000d20af9
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x0000000000d20a41
- (void)handleAccessoryConfigured:(id)arg1;	// IMP=0x0000000000d209d0
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x0000000000d1fd84
- (void)start;	// IMP=0x0000000000d1fc33
- (void)dealloc;	// IMP=0x0000000000d1faa7
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x0000000000d1f88a
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000d1f6a6
