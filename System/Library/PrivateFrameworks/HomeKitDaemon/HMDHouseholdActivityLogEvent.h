...
+ (id)logCategory;	// IMP=0x00100000003212dc
+ (id)coalescedEventFromHouseholdActivityLogEvents:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x0010000000320ced
...
- (id)serializedMetric;	// IMP=0x000000000032065b
- (id)initWithDictionary:(id)arg1 contributors:(id)arg2;	// IMP=0x000000000032034e
- (id)initPopulatedFromDate:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x000000000032018a
- (id)initWithHomeUUID:(id)arg1 contributors:(id)arg2;	// IMP=0x0000000000320106
