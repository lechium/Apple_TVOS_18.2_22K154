...
- (void).cxx_destruct;	// IMP=0x0000000000841ffc
...
- (id)description;	// IMP=0x0000000000841ecb
- (id)initWithHome:(id)arg1 fromUser:(id)arg2 toUser:(id)arg3 encodedShareURL:(id)arg4 shareToken:(id)arg5 containerID:(id)arg6 currentDate:(id)arg7 completion:(CDUnknownBlockType)arg8;	// IMP=0x0000000000841d98
