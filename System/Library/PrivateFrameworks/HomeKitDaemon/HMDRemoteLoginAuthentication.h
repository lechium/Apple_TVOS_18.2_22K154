...
+ (id)logCategory;	// IMP=0x00100000007ccce5
- (void).cxx_destruct;	// IMP=0x00000000007ccc92
...
- (void)authenticate;	// IMP=0x00000000007ccba6
- (id)logIdentifier;	// IMP=0x00000000007ccb94
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x00000000007cca97
