...
+ (id)logCategory;	// IMP=0x0010000000415007
+ (_Bool)isRoleSupported:(long long)arg1;	// IMP=0x0010000000414fd3
- (void).cxx_destruct;	// IMP=0x00000000004141d9
...
- (id)setupTrackingInfo;	// IMP=0x0000000000413e2b
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x0000000000413db7
- (void)_sendRequestData:(id)arg1;	// IMP=0x0000000000413b90
- (void)_handleReceiveData:(id)arg1;	// IMP=0x0000000000413af3
- (void)close:(id)arg1;	// IMP=0x0000000000413980
- (void)_handleClose:(id)arg1;	// IMP=0x00000000004137b7
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000413112
- (void)updateAccessoryUUIDAndNotifyDelegate:(id)arg1 accessoryIDSIdentifier:(id)arg2 accessoryCategory:(id)arg3;	// IMP=0x0000000000412f57
- (void)open;	// IMP=0x0000000000412e86
- (void)__registerForMessages;	// IMP=0x0000000000412d37
- (id)messageDispatcher;	// IMP=0x0000000000412ce7
- (id)messageDestination;	// IMP=0x0000000000412c7e
@property(readonly) long long role;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000412b57
@property(readonly) unsigned long long hash;
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3 upSecondsFactory:(CDUnknownBlockType)arg4 userDefaults:(id)arg5;	// IMP=0x00000000004126ab
- (id)initWithIdentifier:(id)arg1 role:(long long)arg2 homeManager:(id)arg3;	// IMP=0x0000000000412605
- (id)init;	// IMP=0x000000000041255d
