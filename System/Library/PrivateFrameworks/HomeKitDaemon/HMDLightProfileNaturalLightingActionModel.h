...
+ (id)properties;	// IMP=0x001000000073efc1
+ (Class)cd_entityClass;	// IMP=0x0010000000987675
- (id)dependentUUIDs;	// IMP=0x000000000073f338
@property(getter=isNaturalLightingEnabled) _Bool naturalLightingEnabled;
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000987521
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000009873ee
