...
- (void).cxx_destruct;	// IMP=0x0000000000b29c00
...
- (id)initWithTrustActivityType:(long long)arg1 privilege:(unsigned long long)arg2 isPrimaryResident:(_Bool)arg3;	// IMP=0x0000000000b299ac
