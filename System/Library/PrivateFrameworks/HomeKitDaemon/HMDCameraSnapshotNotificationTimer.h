...
- (void).cxx_destruct;	// IMP=0x0000000000d1f664
...
- (id)initWithCameraSessionID:(id)arg1 changedCharacteristics:(id)arg2 timeInterval:(double)arg3;	// IMP=0x0000000000d1f56f
