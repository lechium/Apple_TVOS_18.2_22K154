...
+ (id)logCategory;	// IMP=0x0010000000e03a54
- (void).cxx_destruct;	// IMP=0x0000000000e037a3
...
- (void)handleClientConnectionDidDeactivate:(id)arg1;	// IMP=0x0000000000e035d5
- (void)handleClientConnectionDidActivate:(id)arg1;	// IMP=0x0000000000e03476
- (void)removeClientConnection:(id)arg1;	// IMP=0x0000000000e032a1
- (void)addClientConnection:(id)arg1;	// IMP=0x0000000000e030b8
- (void)configure;	// IMP=0x0000000000e03004
@property(readonly, copy) NSSet *clientConnections;
- (id)initWithLogIdentifier:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000e02e2f
