...
+ (id)name;	// IMP=0x0040000000ead676
- (void).cxx_destruct;	// IMP=0x0000000000ead647
@property(readonly) NSNotificationCenter *notificationCenter; // @synthesize notificationCenter=_notificationCenter;
@property(readonly) __weak HMDBackgroundOperationManager *owner; // @synthesize owner=_owner;
- (void)notifyDataSourceChanged;	// IMP=0x0000000000ead5cc
@property(readonly, copy) NSDictionary *values;
- (id)initWithOperationManager:(id)arg1 notificationCenter:(id)arg2;	// IMP=0x0000000000ead489
- (id)initWithOperationManager:(id)arg1;	// IMP=0x0000000000ead408
