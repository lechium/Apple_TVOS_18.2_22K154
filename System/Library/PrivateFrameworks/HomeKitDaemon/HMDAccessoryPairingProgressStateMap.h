...
- (void).cxx_destruct;	// IMP=0x0000000000e3fc74
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x0000000000e3fb51
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x0000000000e3f4c5
- (id)initWithDate:(id)arg1;	// IMP=0x0000000000e3f440
