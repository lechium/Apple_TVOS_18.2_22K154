...
- (void).cxx_destruct;	// IMP=0x0000000000b3172a
...
- (id)initWithRequestType:(id)arg1 systemUUID:(id)arg2 deviceRole:(id)arg3 totalDurationMS:(unsigned long long)arg4 setupSessionIdentifier:(id)arg5 totalDurationSinceAccessorySetupStartMS:(unsigned long long)arg6 errorStage:(id)arg7;	// IMP=0x0000000000b31321
