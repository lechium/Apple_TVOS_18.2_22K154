...
+ (void)__unregisterActivity:(id)arg1;	// IMP=0x00100000009b5937
+ (id)logCategory;	// IMP=0x00100000009b5907
- (void).cxx_destruct;	// IMP=0x00000000009b531b
...
- (void)stop;	// IMP=0x00000000009b51a2
- (void)start;	// IMP=0x00000000009b50f4
- (void)__transitionActivity:(id)arg1 state:(long long)arg2;	// IMP=0x00000000009b4f2b
- (void)__unregisterActivity;	// IMP=0x00000000009b4de7
- (void)__runActivity:(id)arg1;	// IMP=0x00000000009b49f9
- (void)__checkInActivity:(id)arg1;	// IMP=0x00000000009b458e
- (void)__registerActivity;	// IMP=0x00000000009b43b0
- (id)__initialCriteria;	// IMP=0x00000000009b42a6
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000009b405c
- (id)initWithIdentifier:(id)arg1 interval:(double)arg2 retryInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x00000000009b3f71
