...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000ae6d22
- (void).cxx_destruct;	// IMP=0x0000000000ae6cad
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000ae6b1b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000ae6951
...
- (id)initWithCloudZoneID:(id)arg1 accessory:(id)arg2;	// IMP=0x0000000000ae65ab
