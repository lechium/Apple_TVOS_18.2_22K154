...
+ (id)logCategory;	// IMP=0x0010000000937496
- (void).cxx_destruct;	// IMP=0x0000000000936d1e
...
- (void)setTrafficClass:(unsigned long long)arg1;	// IMP=0x0000000000936b43
- (void)sendRawFrame:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000936a14
- (void)close;	// IMP=0x0000000000936a00
- (void)_closeWithError:(id)arg1;	// IMP=0x00000000009367c6
- (void)_doReceive;	// IMP=0x000000000093656f
- (void)_consumeReceivedData:(id)arg1;	// IMP=0x00000000009363de
- (void)_stopWithError:(id)arg1;	// IMP=0x00000000009363c8
- (void)_start;	// IMP=0x0000000000936350
- (void)_registerForConnectionEvents;	// IMP=0x0000000000936252
- (void)_handleReadClose;	// IMP=0x0000000000936171
- (void)connect;	// IMP=0x0000000000935ced
- (id)_createTcpConnection;	// IMP=0x0000000000935a3f
- (void)dealloc;	// IMP=0x00000000009359f7
- (id)initWithAddress:(id)arg1 port:(long long)arg2 targetQueue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x00000000009358f4
- (id)initWithAddress:(id)arg1 port:(long long)arg2 workQueue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x00000000009357f9
