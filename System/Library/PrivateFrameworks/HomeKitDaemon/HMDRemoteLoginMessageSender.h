...
+ (id)logCategory;	// IMP=0x00100000008ee9dc
- (void).cxx_destruct;	// IMP=0x00000000008ee84b
...
- (void)sendRemoteMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000008ee3e5
- (id)logIdentifier;	// IMP=0x00000000008ee395
- (id)initWithTarget:(id)arg1 accessory:(id)arg2 device:(id)arg3 workQueue:(id)arg4 messageDispatcher:(id)arg5;	// IMP=0x00000000008ee275
