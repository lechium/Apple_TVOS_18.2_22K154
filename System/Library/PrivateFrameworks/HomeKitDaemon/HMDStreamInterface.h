...
+ (id)extractNetworkConfig:(int)arg1 peerNameExtractor:(CDUnknownFunctionPointerType)arg2;	// IMP=0x001000000064c624
+ (int)openSocketWithNetworkConfig:(id)arg1;	// IMP=0x001000000064c0e8
+ (id)logCategory;	// IMP=0x001000000064c0b8
- (void).cxx_destruct;	// IMP=0x000000000064c059
...
- (_Bool)loadMiscFields:(id)arg1;	// IMP=0x000000000064bbc1
- (void)setStreamInterfaceState:(unsigned long long)arg1;	// IMP=0x000000000064bb80
- (void)dealloc;	// IMP=0x000000000064baf9
- (id)logIdentifier;	// IMP=0x000000000064baa9
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 sessionHandler:(id)arg3 localRTPSocket:(int)arg4;	// IMP=0x000000000064b996
