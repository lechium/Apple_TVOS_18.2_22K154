...
+ (id)sharedState;	// IMP=0x0060000000a68856
- (void).cxx_destruct;	// IMP=0x0000000000a68843
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x0000000000a687d6
- (void)registerDelegate:(id)arg1;	// IMP=0x0000000000a68760
...
- (id)init;	// IMP=0x0000000000a682c7
