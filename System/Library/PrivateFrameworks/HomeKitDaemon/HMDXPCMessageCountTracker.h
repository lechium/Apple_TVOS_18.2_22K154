...
+ (id)logCategory;	// IMP=0x0010000000714562
+ (id)sharedTracker;	// IMP=0x0010000000714532
- (void).cxx_destruct;	// IMP=0x000000000071446a
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000714372
@property(readonly, copy) NSDictionary *stateDump;
- (void)submitCounters;	// IMP=0x0000000000713bb3
- (id)sampleCountersAndReset:(_Bool)arg1;	// IMP=0x00000000007139f6
- (void)incrementCounterOfType:(long long)arg1 clientIdentifier:(id)arg2 messageName:(id)arg3;	// IMP=0x000000000071387d
- (id)countersOfType:(long long)arg1;	// IMP=0x00000000007137f8
- (id)mutableCountersOfType:(long long)arg1;	// IMP=0x00000000007137a0
- (void)_resetCounters;	// IMP=0x00000000007136ba
- (void)configure;	// IMP=0x0000000000713636
- (id)initWithLogEventSubmitter:(id)arg1 submissionTimer:(id)arg2;	// IMP=0x0000000000713506
- (id)init;	// IMP=0x00000000007133f7
