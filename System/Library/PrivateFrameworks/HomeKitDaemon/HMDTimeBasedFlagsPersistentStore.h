...
- (void).cxx_destruct;	// IMP=0x00000000001e3c07
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchiveLegacyEventFlags;	// IMP=0x00000000001e3ab3
- (id)unarchive;	// IMP=0x00000000001e37f1
- (void)archiveDictionary:(id)arg1;	// IMP=0x00000000001e36fe
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x00000000001e369a
