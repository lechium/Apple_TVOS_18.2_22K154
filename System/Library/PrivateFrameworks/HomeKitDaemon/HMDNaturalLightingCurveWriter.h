...
+ (id)logCategory;	// IMP=0x0010000000ebc339
- (void).cxx_destruct;	// IMP=0x0000000000ebbd55
...
- (_Bool)supportsDeviceWithCapabilities:(id)arg1;	// IMP=0x0000000000ebbc22
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ebb8c8
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)writeForNaturalLightingEnabledWithReason:(id)arg1;	// IMP=0x0000000000ebb7c3
- (void)synchronizeCurveWithActiveTransitionContext:(id)arg1;	// IMP=0x0000000000ebb328
- (void)writeWithNaturalLightingEnabled:(_Bool)arg1 reason:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ebb109
- (void)handleCurrentDevicePrimaryResidentChangedWithReason:(id)arg1;	// IMP=0x0000000000ebaf22
- (void)handlePrimaryResidentUpdateNotification:(id)arg1;	// IMP=0x0000000000ebae6a
- (void)handleActiveTransitionContextUpdated:(id)arg1;	// IMP=0x0000000000eba5dd
- (void)configureWithLightProfile:(id)arg1;	// IMP=0x0000000000eba304
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3 dataSource:(id)arg4 notificationCenter:(id)arg5 timerFactory:(CDUnknownBlockType)arg6;	// IMP=0x0000000000eba1b9
- (id)initWithUUID:(id)arg1 workQueue:(id)arg2 logIdentifier:(id)arg3;	// IMP=0x0000000000eba0d7
