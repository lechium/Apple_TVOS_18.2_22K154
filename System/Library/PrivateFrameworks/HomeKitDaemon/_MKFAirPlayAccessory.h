...
+ (id)backingModelProtocol;	// IMP=0x001000000056536a
+ (id)homeRelation;	// IMP=0x001000000056533a
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000565286
+ (Class)cd_modelClass;	// IMP=0x00100000007f7150
+ (id)fetchRequest;	// IMP=0x0010000000c3644f
- (void)removePairedUsersObject:(id)arg1;	// IMP=0x000000000056546b
- (void)addPairedUsersObject:(id)arg1;	// IMP=0x000000000056544f
@property(readonly, retain, nonatomic) NSArray *pairedUsers;
- (id)castIfAirPlayAccessory;	// IMP=0x00000000005653ef
