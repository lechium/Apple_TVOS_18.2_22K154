...
+ (id)tupleWithAccessoryUUID:(id)arg1 reachable:(_Bool)arg2;	// IMP=0x00600000001eecd7
- (void).cxx_destruct;	// IMP=0x00000000001eecc4
...
- (id)description;	// IMP=0x00000000001eeac4
- (unsigned long long)hash;	// IMP=0x00000000001eea80
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001ee9ef
