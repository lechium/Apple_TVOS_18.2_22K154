...
- (void).cxx_destruct;	// IMP=0x000000000069a81e
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000069a70b
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x000000000069a4c8
- (void)submitSuccess;	// IMP=0x000000000069a44c
- (_Bool)incrementCompleted;	// IMP=0x000000000069a3d8
- (id)initWithAccessoryUUID:(id)arg1 withKeyType:(unsigned long long)arg2 expectedCount:(long long)arg3 queue:(id)arg4;	// IMP=0x000000000069a2a7
