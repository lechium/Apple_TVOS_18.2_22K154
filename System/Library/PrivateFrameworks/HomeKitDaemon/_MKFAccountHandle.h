...
+ (id)backingModelProtocol;	// IMP=0x0010000000a3c39c
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000a3c2e8
+ (Class)cd_modelClass;	// IMP=0x00100000004207fe
+ (id)fetchRequest;	// IMP=0x00100000008d4e79
- (id)castIfAccountHandle;	// IMP=0x0000000000a3c3e3
