...
+ (long long)internalDeviceDaysSinceSoftwareUpdate;	// IMP=0x00100000004cbe05
+ (long long)_daysSinceSoftwareUpdateFrom:(id)arg1 dateProvider:(id)arg2;	// IMP=0x00100000004cbd46
+ (id)lastUpdateForSoftwareVersion:(id)arg1 dateProvider:(id)arg2 userDefaults:(id)arg3 updateDefaultsIfNeeded:(_Bool)arg4;	// IMP=0x00100000004cbbfb
- (void).cxx_destruct;	// IMP=0x00000000004cbbaa
...
- (void)runDailyTask;	// IMP=0x00000000004cba17
- (void)handleHomeDataLoaded;	// IMP=0x00000000004cb926
@property(readonly) long long deviceDaysSinceSoftwareUpdate;
- (unsigned long long)bitMaskForKeyType:(unsigned long long)arg1;	// IMP=0x00000000004cb81f
- (unsigned long long)duplicateKeysBitMapFromKeyCounts:(id)arg1;	// IMP=0x00000000004cb625
- (unsigned long long)missingKeysBitMapFromKeyCounts:(id)arg1;	// IMP=0x00000000004cb42c
- (void)updateCachedPairingKeyStates;	// IMP=0x00000000004cb23a
- (void)updateWithHomeManagerStatus:(unsigned long long)arg1;	// IMP=0x00000000004cb1f3
- (void)updateHH2SentinelZoneExists:(_Bool)arg1;	// IMP=0x00000000004cb1b3
- (void)updateWithDataSyncState:(unsigned long long)arg1;	// IMP=0x00000000004cb0f7
- (void)registerForNotifications;	// IMP=0x00000000004cafcc
- (id)initWithCurrentSoftwareVersion:(id)arg1 logEventSubmitter:(id)arg2 dailyScheduler:(id)arg3 dateProvider:(id)arg4 keyCountProvider:(id)arg5 userDefaults:(id)arg6;	// IMP=0x00000000004cae58
- (id)initWithLogEventSubmitter:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3;	// IMP=0x00000000004cacff
