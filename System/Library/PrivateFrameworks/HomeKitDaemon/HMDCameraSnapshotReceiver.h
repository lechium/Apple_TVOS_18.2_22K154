...
+ (id)logCategory;	// IMP=0x0010000000a1b184
- (void).cxx_destruct;	// IMP=0x0000000000a1b0de
...
- (id)logIdentifier;	// IMP=0x0000000000a1afc5
- (void)_sendMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a1ae72
- (void)_sendConfirmationToResident:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a1ac90
- (void)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a1a91d
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegateQueue:(id)arg4 uniqueIdentifier:(id)arg5 snapshotRequestHandler:(id)arg6 residentMessageHandler:(id)arg7 remoteDevice:(id)arg8;	// IMP=0x0000000000a1a6cc
