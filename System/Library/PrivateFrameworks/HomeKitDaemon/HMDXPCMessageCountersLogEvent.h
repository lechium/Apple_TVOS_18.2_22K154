...
+ (id)XPCMessageCountersLogEventWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00600000004c5296
- (void).cxx_destruct;	// IMP=0x00000000004c5243
...
- (id)__initWithType:(id)arg1 peerInformation:(id)arg2 messageName:(id)arg3 count:(id)arg4;	// IMP=0x00000000004c50cf
