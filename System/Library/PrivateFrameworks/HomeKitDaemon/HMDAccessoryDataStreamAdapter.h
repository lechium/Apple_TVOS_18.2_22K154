...
+ (id)logCategory;	// IMP=0x001000000045ba43
- (void).cxx_destruct;	// IMP=0x000000000045af16
...
- (id)logIdentifier;	// IMP=0x000000000045ad74
- (void)accessory:(id)arg1 didCloseDataStreamWithError:(id)arg2;	// IMP=0x000000000045acbc
- (void)accessoryDidStartListening:(id)arg1;	// IMP=0x000000000045ac04
- (void)accessory:(id)arg1 didReceiveBulkSessionCandidate:(id)arg2;	// IMP=0x000000000045abea
- (void)_bulkSendDidComplete;	// IMP=0x000000000045ab4f
- (void)_bulkSendDidFail;	// IMP=0x000000000045aab4
- (_Bool)_handleFrame:(id)arg1;	// IMP=0x000000000045aa16
@property(readonly, getter=isSessionOpenInProgress) _Bool sessionOpenInProgress;
- (void)_handleAccessoryDidClose;	// IMP=0x000000000045a863
- (void)_callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000045a637
- (void)callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000045a559
- (void)_openSession;	// IMP=0x000000000045a3c0
- (void)_setUpTransport;	// IMP=0x000000000045a25c
- (void)readData;	// IMP=0x000000000045a086
- (void)setUpWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000459edd
@property(readonly, getter=isBulkSendActive) _Bool bulkSendActive;
- (void)dealloc;	// IMP=0x0000000000459d44
- (void)shutDown;	// IMP=0x0000000000459b9c
- (id)attributeDescriptions;	// IMP=0x00000000004599b1
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 fileType:(id)arg3 metadata:(id)arg4 reason:(id)arg5;	// IMP=0x000000000045989b
