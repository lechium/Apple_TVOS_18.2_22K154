...
+ (id)parsedLanguageListSetting:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000d02c5a
+ (id)parsedLanguageSetting:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000d02937
+ (id)parsedIntegerSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000d02667
+ (id)parsedBoolSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000d022fa
+ (id)logCategory;	// IMP=0x0010000000d022ca
- (void).cxx_destruct;	// IMP=0x0000000000d018e1
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000d0140d
- (id)_transformLegacyLanguageSettingValueToImmutableSetting:(id)arg1;	// IMP=0x0000000000d011c9
- (id)_settingValueForKeyPath:(id)arg1 value:(id)arg2;	// IMP=0x0000000000d009a3
- (id)languageValueList;	// IMP=0x0000000000d00996
- (void)updateSettingWithKeyPath:(id)arg1 settingValue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000d0061d
- (void)startup;	// IMP=0x0000000000d0026a
- (id)initWithQueue:(id)arg1 homeUUID:(id)arg2 accessoryUUID:(id)arg3 settingsController:(id)arg4 subscriptionProvider:(id)arg5;	// IMP=0x0000000000d00168
