...
- (void).cxx_destruct;	// IMP=0x000000000050852f
...
- (id)initWithLinkType:(id)arg1 hasAdvertisement:(_Bool)arg2 protocol:(id)arg3 protocolVersion:(id)arg4 reachable:(_Bool)arg5 reachableLastChangedTime:(id)arg6 reason:(id)arg7;	// IMP=0x0000000000508369
