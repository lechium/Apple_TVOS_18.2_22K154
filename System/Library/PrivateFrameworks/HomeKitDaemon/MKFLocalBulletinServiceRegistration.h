...
+ (id)fetchServiceRegistrationForAccessoryUUID:(id)arg1 serviceInstanceID:(id)arg2 managedObjectContext:(id)arg3;	// IMP=0x0080000000b5dcd5
+ (id)fetchRequest;	// IMP=0x0080000000efd104
