...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000c3fc61
+ (id)logCategory;	// IMP=0x0010000000c3fc31
+ (void)setBulletinBoard:(id)arg1;	// IMP=0x0010000000c3fc1d
+ (id)bulletinBoard;	// IMP=0x0010000000c3fbda
- (void).cxx_destruct;	// IMP=0x0000000000c3efe5
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c3ec33
- (void)networkMonitorIsUnreachable:(id)arg1;	// IMP=0x0000000000c3eb7b
- (void)networkMonitorIsReachable:(id)arg1;	// IMP=0x0000000000c3eac3
- (void)notificationManager:(id)arg1 didReceiveNotificationForCameraSignificantEventIdentifier:(id)arg2 notificationReasons:(unsigned long long)arg3;	// IMP=0x0000000000c3ea0b
- (void)clipManagerDidEncounterDisabledCloudStorage:(id)arg1;	// IMP=0x0000000000c3e997
- (void)clipManagerDidDisableCloudStorage:(id)arg1;	// IMP=0x0000000000c3e923
- (void)clipManagerDidStop:(id)arg1;	// IMP=0x0000000000c3e818
- (void)clipManagerDidStartUpCloudZone:(id)arg1;	// IMP=0x0000000000c3e780
- (void)clipManagerDidStart:(id)arg1;	// IMP=0x0000000000c3e5e2
- (void)clipManager:(id)arg1 didDeleteClipWithUUID:(id)arg2;	// IMP=0x0000000000c3e54a
- (void)clipManager:(id)arg1 didUpdateSignificantEvent:(id)arg2;	// IMP=0x0000000000c3e471
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c3e354
- (void)handleResidentsChangedNotification:(id)arg1;	// IMP=0x0000000000c3e2e3
- (void)handleCameraProfileSettingsDidChangeNotification:(id)arg1;	// IMP=0x0000000000c3e1f5
@property(readonly) _HMCameraUserSettings *currentSettings;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c3dfb7
- (void)cameraSettingProactiveReaderDidCompleteRead:(id)arg1;	// IMP=0x0000000000c3df1f
- (void)_handleStreamControlRequest:(id)arg1;	// IMP=0x0000000000c3d758
- (void)_handleNegotiateStreamRequest:(id)arg1;	// IMP=0x0000000000c3cd5d
- (void)_postLocalNotificationForUpdatedSignificantEvent:(id)arg1;	// IMP=0x0000000000c3cc82
- (void)_postNotificationForUpdatedSignificantEvent:(id)arg1;	// IMP=0x0000000000c3cb1c
- (_Bool)_shouldNotifyForSignificantEvent:(id)arg1;	// IMP=0x0000000000c3c6f6
- (_Bool)_areFaceClassificationsSuppressedForSignificantEvent:(id)arg1;	// IMP=0x0000000000c3c495
- (void)registerForMessages;	// IMP=0x0000000000c3b9f6
- (void)_setControlSupport;	// IMP=0x0000000000c3b7bd
- (id)dumpState;	// IMP=0x0000000000c3b6b9
- (void)dealloc;	// IMP=0x0000000000c3b64b
- (void)unconfigure;	// IMP=0x0000000000c3b599
- (void)removeCloudData;	// IMP=0x0000000000c3b507
@property(readonly, copy) NSString *description;
- (void)_setUpBulletinNotificationManagerObserver;	// IMP=0x0000000000c3b364
- (void)_createCameraRecordingManager;	// IMP=0x0000000000c3af19
- (void)tearDownWithReplacementCameraProfile:(id)arg1;	// IMP=0x0000000000c3ad50
- (void)setUp;	// IMP=0x0000000000c3a8f4
@property(readonly, nonatomic, getter=isCameraRecordingFeatureSupported) _Bool supportsCameraRecordingFeature;
- (id)initWithAccessory:(id)arg1 services:(id)arg2 recordingManagementService:(id)arg3 msgDispatcher:(id)arg4 workQueue:(id)arg5 home:(id)arg6 settingsManager:(id)arg7 uniqueIdentifier:(id)arg8 clipManager:(id)arg9 clipUserNotificationCenter:(id)arg10 reachabilityEventManager:(id)arg11 networkMonitor:(id)arg12 streamSnapshotHandler:(id)arg13 snapshotManager:(id)arg14 cameraStreamManagers:(id)arg15 significantEventNotificationFilter:(id)arg16 notificationCenter:(id)arg17;	// IMP=0x0000000000c3a3ff
- (id)initWithAccessory:(id)arg1 services:(id)arg2 msgDispatcher:(id)arg3 workQueue:(id)arg4 home:(id)arg5 settingsManager:(id)arg6;	// IMP=0x0000000000c39790
