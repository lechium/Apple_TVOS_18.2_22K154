...
- (void).cxx_destruct;	// IMP=0x0000000000e7cff0
...
- (id)initWithName:(id)arg1 qualityOfService:(long long)arg2 timeoutDate:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000e7ce43
