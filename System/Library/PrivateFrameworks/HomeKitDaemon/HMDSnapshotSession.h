...
+ (id)logCategory;	// IMP=0x00100000009c89c1
- (void).cxx_destruct;	// IMP=0x00000000009c895d
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x00000000009c8473
- (void)dealloc;	// IMP=0x00000000009c83f7
- (id)logIdentifier;	// IMP=0x00000000009c83a7
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x00000000009c81d0
