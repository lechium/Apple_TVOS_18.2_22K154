...
+ (id)logCategory;	// IMP=0x001000000091bd47
- (void).cxx_destruct;	// IMP=0x000000000091bcf4
...
- (id)logIdentifier;	// IMP=0x000000000091bc4c
- (void)startKeepAlive;	// IMP=0x000000000091bc46
- (void)dealloc;	// IMP=0x000000000091bb13
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000091b9cd
