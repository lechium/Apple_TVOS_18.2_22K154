...
+ (id)logCategory;	// IMP=0x00100000008299d9
+ (id)_streamingStatusForResponse:(id)arg1;	// IMP=0x0010000000829648
- (void).cxx_destruct;	// IMP=0x0000000000829123
...
- (void)_callDidCompleteReadDelegateCallback;	// IMP=0x0000000000828faa
- (id)_inUseStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x0000000000828dda
- (id)_availableStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x0000000000828c0a
- (void)_handleStreamStatusMultireadResponse:(id)arg1;	// IMP=0x0000000000828638
- (void)readSetting;	// IMP=0x000000000082811f
- (void)handleMessage:(id)arg1;	// IMP=0x0000000000827caf
- (_Bool)hasPendingNegotiateMessageForSessionWithIdentifier:(id)arg1;	// IMP=0x0000000000827bd9
- (id)initWithWorkQueue:(id)arg1 sessionID:(id)arg2 accessory:(id)arg3 message:(id)arg4 streamControlMessageHandlers:(id)arg5 streamPreferences:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x00000000008279a6
