...
- (void).cxx_destruct;	// IMP=0x0000000000162bef
...
- (id)attributeDescriptions;	// IMP=0x000000000016258e
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001623de
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001623d3
- (unsigned long long)hash;	// IMP=0x000000000016238f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000162008
- (id)initWithUUID:(id)arg1;	// IMP=0x0000000000161ee2
