...
- (void).cxx_destruct;	// IMP=0x00000000009e2c66
...
- (void)main;	// IMP=0x00000000009e2610
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000009e2543
