...
+ (id)logCategory;	// IMP=0x0010000000e6444c
- (void).cxx_destruct;	// IMP=0x0000000000e60465
...
- (id)logIdentifier;	// IMP=0x0000000000e60353
- (void)__handleDeviceRemovedFromAccount:(id)arg1;	// IMP=0x0000000000e602bf
- (void)__handleAccountRemovedFromRegistry:(id)arg1;	// IMP=0x0000000000e6022b
- (void)__handleRemovedIdentity:(id)arg1;	// IMP=0x0000000000e60197
- (void)handleSecureMessage:(id)arg1 fromDevice:(id)arg2 fromTransport:(id)arg3;	// IMP=0x0000000000e600a4
- (void)handleCompletedMessage:(id)arg1 options:(id)arg2 responsePayload:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000e5ff5b
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000e5fe91
- (void)stop;	// IMP=0x0000000000e5fe3f
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000e5fd68
- (void)closedWithError:(id)arg1;	// IMP=0x0000000000e5fcd4
- (void)_configureWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000e5f56e
- (void)startAndInvokeOnQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000e5f4b0
@property(readonly, copy) NSDate *lastActivity; // @synthesize lastActivity=_lastActivity;
- (void)setIdle:(_Bool)arg1;	// IMP=0x0000000000e5f347
@property(readonly, getter=isIdle) _Bool idle; // @synthesize idle=_idle;
- (void)setAuthenticated:(_Bool)arg1;	// IMP=0x0000000000e5f2d0
@property(readonly, getter=isAuthenticated) _Bool authenticated; // @synthesize authenticated=_authenticated;
- (void)setOpen:(_Bool)arg1;	// IMP=0x0000000000e5f259
@property(readonly, getter=isOpen) _Bool open; // @synthesize open=_open;
- (void)setMaximumRemoteStreams:(id)arg1;	// IMP=0x0000000000e5f1ce
...
- (void)dealloc;	// IMP=0x0000000000e5ecfe
- (id)initWithCurrentDevice:(id)arg1 peerDevice:(id)arg2 clientMode:(_Bool)arg3 sessionID:(id)arg4 accountRegistry:(id)arg5;	// IMP=0x0000000000e5ea78
