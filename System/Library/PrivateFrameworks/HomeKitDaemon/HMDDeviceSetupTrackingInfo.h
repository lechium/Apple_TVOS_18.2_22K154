...
- (void).cxx_destruct;	// IMP=0x0000000000161c70
...
- (id)initWithIdentifier:(id)arg1 startTime:(unsigned long long)arg2 endTime:(unsigned long long)arg3 role:(long long)arg4 accessoryUUID:(id)arg5 accessoryCategory:(id)arg6 accessoryIDSIdentifier:(id)arg7 setupClientBundleID:(id)arg8;	// IMP=0x0000000000161a24
