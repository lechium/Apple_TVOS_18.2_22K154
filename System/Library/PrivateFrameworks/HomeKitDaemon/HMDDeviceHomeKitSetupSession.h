...
- (void).cxx_destruct;	// IMP=0x0000000000ade2b7
...
- (void)markHasFailedRelayAttempt;	// IMP=0x0000000000ade243
@property(readonly) _Bool shouldRelayRequest;
- (id)initWithFirstResidentForHome:(_Bool)arg1 clientConnection:(id)arg2;	// IMP=0x0000000000ade193
