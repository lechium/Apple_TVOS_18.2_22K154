...
- (void).cxx_destruct;	// IMP=0x000000000038cb4c
...
- (id)description;	// IMP=0x000000000038c952
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x000000000038c7b4
- (id)init;	// IMP=0x000000000038c70c
