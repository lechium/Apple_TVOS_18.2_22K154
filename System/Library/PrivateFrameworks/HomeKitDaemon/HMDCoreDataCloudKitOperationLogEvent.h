...
- (id)initWithOperationType:(unsigned long long)arg1 interval:(double)arg2;	// IMP=0x0000000000d03c7b
- (id)initWithOperationType:(unsigned long long)arg1;	// IMP=0x0000000000d03c37
