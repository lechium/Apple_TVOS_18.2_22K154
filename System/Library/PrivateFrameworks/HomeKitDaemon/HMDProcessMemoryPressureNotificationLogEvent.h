...
+ (id)createEventWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x0010000000802244
- (void).cxx_destruct;	// IMP=0x0000000000802213
...
- (id)initWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x0000000000801ff4
