...
+ (id)logCategory;	// IMP=0x001000000049162c
- (void).cxx_destruct;	// IMP=0x0000000000491307
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000004911c7
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)stateManager:(id)arg1 didReceiveLocalUpdate:(id)arg2;	// IMP=0x0000000000490fd2
- (void)_handleRemoteAnalysisStateUpdate:(id)arg1;	// IMP=0x0000000000490d13
- (void)_publishAnalysisStateUpdate;	// IMP=0x00000000004909ab
- (void)_processStateUpdate:(id)arg1;	// IMP=0x0000000000490845
- (void)configureWithHome:(id)arg1;	// IMP=0x000000000049061e
- (id)initWithHomeMessagingContext:(id)arg1 analysisStateManager:(id)arg2 workQueue:(id)arg3 cameraAnalysisStatePublisherDebounceTimer:(id)arg4;	// IMP=0x0000000000490534
- (id)initWithHome:(id)arg1;	// IMP=0x000000000049043e
