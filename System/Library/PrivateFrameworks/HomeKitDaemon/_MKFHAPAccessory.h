...
+ (id)backingModelProtocol;	// IMP=0x001000000099a9c7
+ (id)homeRelation;	// IMP=0x001000000099a997
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000099a8e3
+ (id)fetchRequest;	// IMP=0x00100000007cdef6
+ (Class)cd_modelClass;	// IMP=0x0010000000a65617
- (void)removeMatterPathsObject:(id)arg1;	// IMP=0x000000000099bbe2
- (void)addMatterPathsObject:(id)arg1;	// IMP=0x000000000099bbc6
- (id)findMatterPathsRelationWithModelID:(id)arg1;	// IMP=0x000000000099bba3
- (id)materializeOrCreateMatterPathsRelationWithModelID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x000000000099bb7d
@property(readonly, retain, nonatomic) NSArray *matterPaths;
- (void)synchronizeServicesRelationWith:(id)arg1;	// IMP=0x000000000099bb04
- (id)findServicesRelationWithInstanceID:(id)arg1;	// IMP=0x000000000099bae1
- (id)materializeOrCreateServicesRelationWithInstanceID:(id)arg1 createdNew:(_Bool *)arg2;	// IMP=0x000000000099babb
@property(readonly, retain, nonatomic) NSArray *services;
- (void)removePairedUsersObject:(id)arg1;	// IMP=0x000000000099ba48
- (void)addPairedUsersObject:(id)arg1;	// IMP=0x000000000099ba2c
@property(readonly, retain, nonatomic) NSArray *pairedUsers;
- (id)materializeOrCreateNaturalLightingActionsRelation:(_Bool *)arg1;	// IMP=0x000000000099b9af
...
- (id)castIfHAPAccessory;	// IMP=0x000000000099b8f8
@property(readonly, copy, nonatomic) MKFHAPAccessoryDatabaseID *databaseID;
- (id)yearDayScheduleCapacity;	// IMP=0x000000000099b80b
- (id)weekDayScheduleCapacity;	// IMP=0x000000000099b754
- (void)maybeFixUpCharacteristicWriteActionsInContext:(id)arg1;	// IMP=0x000000000099b491
- (id)predicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg1 user:(id)arg2;	// IMP=0x000000000099b440
- (id)cameraSignificantEventBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 user:(id)arg2 context:(id)arg3;	// IMP=0x000000000099b33f
- (id)cameraAccessModeBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 user:(id)arg2 context:(id)arg3;	// IMP=0x000000000099b23e
- (id)cameraReachabilityBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 user:(id)arg2 context:(id)arg3;	// IMP=0x000000000099b13d
- (id)bulletinRegistrationFromFetchRequest:(id)arg1 context:(id)arg2;	// IMP=0x000000000099af97
- (id)characteristicFromInstanceID:(id)arg1 context:(id)arg2;	// IMP=0x000000000099ad21
- (id)serviceWithID:(id)arg1 context:(id)arg2;	// IMP=0x000000000099aaee
- (_Bool)hasRGCapableService;	// IMP=0x000000000099aa16
