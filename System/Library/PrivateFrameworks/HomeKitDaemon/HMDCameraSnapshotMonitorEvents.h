...
+ (id)logCategory;	// IMP=0x00100000008f66ee
- (void).cxx_destruct;	// IMP=0x00000000008f1f60
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000008f1a8f
- (void)handleCameraSettingsDidUpdateNotification:(id)arg1;	// IMP=0x00000000008f19d8
- (void)handleCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000008f1921
- (void)handleBulletinBoardNotificationDidUpdateNotification:(id)arg1;	// IMP=0x00000000008f186a
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000008f1705
- (void)dealloc;	// IMP=0x00000000008f1525
- (void)registerForMessages;	// IMP=0x00000000008f131d
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4 bulletinBoard:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x00000000008f0d93
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000008f0c8d
