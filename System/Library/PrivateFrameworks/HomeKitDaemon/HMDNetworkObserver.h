...
+ (id)supportedEventClasses;	// IMP=0x00100000005fb16c
- (void).cxx_destruct;	// IMP=0x00000000005fad7e
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000005fabab
- (void)checkNetworkChange;	// IMP=0x00000000005fa6c6
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x00000000005fa60b
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x00000000005fa550
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x00000000005fa004
- (void)runDailyTask;	// IMP=0x00000000005f9af4
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000005f9a2b
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x00000000005f982c
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x00000000005f95b0
- (void)_clearNonPersistentCounters;	// IMP=0x00000000005f94ed
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x00000000005f93b7
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x00000000005f92d7
- (void)_handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x00000000005f9122
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x00000000005f903b
- (void)stop;	// IMP=0x00000000005f8ea9
- (void)start;	// IMP=0x00000000005f8c6b
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 wifiManager:(id)arg6 notificationCenter:(id)arg7 changeDebounceTimer:(id)arg8 tickBlock:(CDUnknownBlockType)arg9;	// IMP=0x00000000005f8a73
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x00000000005f890b
