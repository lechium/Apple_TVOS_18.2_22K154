...
+ (id)logCategory;	// IMP=0x0010000000618b1c
- (void).cxx_destruct;	// IMP=0x000000000061817f
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000617f3f
- (void)monitorDidObserveExportComplete:(id)arg1;	// IMP=0x0000000000617e9b
- (id)_retrieveExpectedObjectIDsTokenMap;	// IMP=0x0000000000617760
- (void)_stopWithError:(id)arg1;	// IMP=0x00000000006176bb
- (void)startWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000006175f7
- (void)configure;	// IMP=0x0000000000617384
- (id)initWithCurrentAccessoryUUID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000006172c1
