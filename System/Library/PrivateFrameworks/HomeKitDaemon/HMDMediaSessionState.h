...
- (void).cxx_destruct;	// IMP=0x00000000008d873e
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x00000000008d8594
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008d81e2
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x00000000008d7c43
