...
+ (id)logCategory;	// IMP=0x0010000000c15deb
- (void).cxx_destruct;	// IMP=0x0000000000c156e7
...
- (id)logIdentifier;	// IMP=0x0000000000c153f5
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000c153ef
- (void)updateReachableState:(_Bool)arg1;	// IMP=0x0000000000c15375
- (void)_resetSessionMetric;	// IMP=0x0000000000c150c7
- (void)resetSessionMetric;	// IMP=0x0000000000c15056
- (void)_submitMetric;	// IMP=0x0000000000c14b1e
- (void)submitMetric;	// IMP=0x0000000000c14aad
- (void)_updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 bookkeeping:(id)arg4 withError:(id)arg5;	// IMP=0x0000000000c14185
- (void)updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 bookkeeping:(id)arg4 withError:(id)arg5;	// IMP=0x0000000000c14061
...
- (_Bool)isCurrentPrimaryResident;	// IMP=0x0000000000c13dcf
@property(readonly, nonatomic) double sessionCheckIntervalSec;
- (id)attributeDescriptions;	// IMP=0x0000000000c13539
@property(readonly, copy, nonatomic) NSDictionary *state;
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 hapSessionTTRTimer:(id)arg3 hapSessionTTRAllowList:(id)arg4 radarInitiator:(id)arg5;	// IMP=0x0000000000c12d5b
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000c12c88
