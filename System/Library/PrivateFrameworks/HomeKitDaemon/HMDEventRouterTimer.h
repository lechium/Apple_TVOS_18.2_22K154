...
- (void).cxx_destruct;	// IMP=0x0000000000ebc5b6
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ebc50b
- (void)suspend;	// IMP=0x0000000000ebc4ce
- (void)resume;	// IMP=0x0000000000ebc491
- (id)initWithQueue:(id)arg1 interval:(double)arg2 timerFireHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ebc3a0
