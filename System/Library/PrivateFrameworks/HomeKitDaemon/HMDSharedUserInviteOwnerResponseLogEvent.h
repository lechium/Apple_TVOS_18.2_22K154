...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x0000000000573489
- (id)coreAnalyticsEventDictionary;	// IMP=0x00000000005732bc
- (id)coreAnalyticsEventName;	// IMP=0x00000000005732af
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000573280
