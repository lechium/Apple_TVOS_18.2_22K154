...
- (void).cxx_destruct;	// IMP=0x00000000003fc6b2
...
- (_Bool)isSubmitted;	// IMP=0x00000000003fc364
...
- (id)initWithHomeConfigurations:(id)arg1 widgetDataSource:(id)arg2 isFMFDevice:(_Bool)arg3;	// IMP=0x00000000003fb752
- (id)initWithHomeManager:(id)arg1 widgetDataSource:(id)arg2 metadataVersion:(unsigned int)arg3;	// IMP=0x00000000003fb46e
