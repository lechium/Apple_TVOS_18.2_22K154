...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001976e9
- (void).cxx_destruct;	// IMP=0x00000000001975fc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001974a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000197198
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000196fb9
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000196b4d
- (id)initWithChannelCount:(id)arg1 bitRateSetting:(id)arg2 audioSampleRate:(id)arg3 rtpPtime:(id)arg4;	// IMP=0x0000000000196a50
