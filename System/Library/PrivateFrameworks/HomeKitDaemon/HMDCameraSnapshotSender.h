...
+ (id)logCategory;	// IMP=0x0010000000645d4f
- (void).cxx_destruct;	// IMP=0x0000000000645bd0
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x0000000000645762
- (id)logIdentifier;	// IMP=0x0000000000645712
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x0000000000645589
