...
- (void).cxx_destruct;	// IMP=0x0000000000a7a2ef
...
- (id)description;	// IMP=0x0000000000a7a183
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x0000000000a7a0d5
