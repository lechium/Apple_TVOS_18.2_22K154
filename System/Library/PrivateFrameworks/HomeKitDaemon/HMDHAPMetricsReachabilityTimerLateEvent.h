...
- (void).cxx_destruct;	// IMP=0x00000000007cf60e
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x00000000007cf493
- (id)coreAnalyticsEventName;	// IMP=0x00000000007cf486
- (id)initWithAccessory:(id)arg1 actualDuration:(id)arg2 expectedDuration:(id)arg3;	// IMP=0x00000000007cf3de
