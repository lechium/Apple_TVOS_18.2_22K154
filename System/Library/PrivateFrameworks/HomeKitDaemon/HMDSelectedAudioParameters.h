...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000019f7e6
- (void).cxx_destruct;	// IMP=0x000000000019f793
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019f637
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019f355
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000019f13d
- (_Bool)_parseFromTLVData;	// IMP=0x000000000019ee7f
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodecGroup:(id)arg1 codecParameter:(id)arg2 rtpParameter:(id)arg3 comfortNoiseEnabled:(id)arg4;	// IMP=0x000000000019ebc1
