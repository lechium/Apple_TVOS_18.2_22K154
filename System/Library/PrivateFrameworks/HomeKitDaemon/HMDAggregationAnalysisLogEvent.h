...
@interface HMDAggregationAnalysisLogEvent : HMMLogEvent
{
    ...
    long long _processAbnormalExitCount;	// 32 = 0x20
    unsigned long long _processJetsamCount;	// 40 = 0x28
    unsigned long long _processCrashCount;	// 48 = 0x30
    unsigned long long _jetsamReasonHighwaterCount;	// 56 = 0x38
    unsigned long long _jetsamReasonProcessLimitCount;	// 64 = 0x40
    unsigned long long _jetsamReasonOtherCount;	// 72 = 0x48
    unsigned long long _processMemoryPressureStateWarningCount;	// 80 = 0x50
    unsigned long long _processMemoryPressureStateCriticalCount;	// 88 = 0x58
    unsigned long long _sampledAverageProcessMemoryUsageMB;	// 96 = 0x60
    unsigned long long _sampledPeakProcessMemoryUsageMB;	// 104 = 0x68
    unsigned long long _remoteMessagesSentCount;	// 112 = 0x70
    unsigned long long _remoteMessagesReceivedCount;	// 120 = 0x78
    unsigned long long _txIDSMessagesCount;	// 128 = 0x80
    unsigned long long _rxIDSMessagesCount;	// 136 = 0x88
    unsigned long long _txIDSProxyMessagesCount;	// 144 = 0x90
    unsigned long long _rxIDSProxyMessagesCount;	// 152 = 0x98
    unsigned long long _txLoxyMessagesCount;	// 160 = 0xa0
    unsigned long long _rxLoxyMessagesCount;	// 168 = 0xa8
    unsigned long long _txRapportMessagesCount;	// 176 = 0xb0
    unsigned long long _rxRapportMessagesCount;	// 184 = 0xb8
    unsigned long long _txSecureMessagesCount;	// 192 = 0xc0
    unsigned long long _rxSecureMessagesCount;	// 200 = 0xc8
    unsigned long long _cloudSyncPushCount;	// 208 = 0xd0
    unsigned long long _legacyCloudSyncPushCount;	// 216 = 0xd8
    unsigned long long _cloudSyncFetchCount;	// 224 = 0xe0
    unsigned long long _cloudSyncUploadCount;	// 232 = 0xe8
    unsigned long long _cloudSyncUploadErrorCount;	// 240 = 0xf0
    unsigned long long _homeDataBytesFetched;	// 248 = 0xf8
    unsigned long long _homeDataBytesPushed;	// 256 = 0x100
    unsigned long long _legacyHomeDataBytesFetched;	// 264 = 0x108
    unsigned long long _legacyHomeDataBytesPushed;	// 272 = 0x110
    unsigned long long _cloudSyncDecryptionFailedCount;	// 280 = 0x118
    unsigned long long _cloudStoreCoreDataTransactionCount;	// 288 = 0x120
    unsigned long long _workingStoreCoreDataTransactionCount;	// 296 = 0x128
    unsigned long long _coreDataCloudKitImportCount;	// 304 = 0x130
    unsigned long long _coreDataCloudKitExportCount;	// 312 = 0x138
    unsigned long long _residentSyncFetchHomeDataRequestCount;	// 320 = 0x140
    unsigned long long _residentSyncHomeDataChangedNotificationCount;	// 328 = 0x148
    unsigned long long _generationCounterIncrementCount;	// 336 = 0x150
    unsigned long long _notifyXPCClientsHomeDataChangedCount;	// 344 = 0x158
    unsigned long long _numReadSiri;	// 352 = 0x160
    unsigned long long _numWriteSiri;	// 360 = 0x168
    unsigned long long _numReadFirstPartyApp;	// 368 = 0x170
    unsigned long long _numWriteFirstPartyApp;	// 376 = 0x178
    unsigned long long _numReadThirdPartyApp;	// 384 = 0x180
    unsigned long long _numWriteThirdPartyApp;	// 392 = 0x188
    unsigned long long _numReadInternalRequested;	// 400 = 0x190
    unsigned long long _numWriteInternalRequested;	// 408 = 0x198
    unsigned long long _numReadUnknownSource;	// 416 = 0x1a0
    unsigned long long _numWriteUnknownSource;	// 424 = 0x1a8
    unsigned long long _numReadWriteSuccessIP;	// 432 = 0x1b0
    unsigned long long _numReadWriteFailureIP;	// 440 = 0x1b8
    unsigned long long _numReadWriteSuccessBT;	// 448 = 0x1c0
    unsigned long long _numReadWriteFailureBT;	// 456 = 0x1c8
    unsigned long long _numReadWriteSuccessIDS;	// 464 = 0x1d0
    unsigned long long _numReadWriteFailureIDS;	// 472 = 0x1d8
    unsigned long long _averageLatencyIP;	// 480 = 0x1e0
    unsigned long long _averageLatencyBT;	// 488 = 0x1e8
    unsigned long long _averageLatencyIDS;	// 496 = 0x1f0
    unsigned long long _numAccessoriesAdded;	// 504 = 0x1f8
    unsigned long long _numScenesAdded;	// 512 = 0x200
    unsigned long long _numTriggersAdded;	// 520 = 0x208
    unsigned long long _numShortcutsAdded;	// 528 = 0x210
    unsigned long long _numScenesUserRun;	// 536 = 0x218
    unsigned long long _numShortcutsRun;	// 544 = 0x220
    unsigned long long _numTriggersFired;	// 552 = 0x228
    unsigned long long _hapIPInvalidationCount;	// 560 = 0x230
    unsigned long long _hapIPSentHTTPRequestsCount;	// 568 = 0x238
    unsigned long long _hapIPReceivedHTTPResponsesCount;	// 576 = 0x240
    unsigned long long _hapIPReceivedHTTPEventCount;	// 584 = 0x248
    unsigned long long _hapBTLEConnectionsCount;	// 592 = 0x250
    unsigned long long _hapBTLEConnectionPerReasonsCount;	// 600 = 0x258
    unsigned long long _hapBTLEDiscoveriesCount;	// 608 = 0x260
    unsigned long long _cameraStreamStartSuccessCount;	// 616 = 0x268
    unsigned long long _cameraStreamStartFailureCount;	// 624 = 0x270
    unsigned long long _fetchCameraClipVideoSegmentAssetCount;	// 632 = 0x278
    unsigned long long _acceptedXPCRequestsCount;	// 640 = 0x280
    unsigned long long _erroredXPCRequestsCount;	// 648 = 0x288
    unsigned long long _sentXPCNotificationsCount;	// 656 = 0x290
    unsigned long long _filteredXPCNotificationsCount;	// 664 = 0x298
    unsigned long long _cameraRecordingReachabilityChangedCount;	// 672 = 0x2a0
    unsigned long long _cameraRecordingReachabilityOfflineDuration;	// 680 = 0x2a8
    unsigned long long _homeHubReachabilityChangedCount;	// 688 = 0x2b0
    unsigned long long _ipAccessoryReachabilityChangedCount;	// 696 = 0x2b8
    unsigned long long _currentDeviceStartedLegacyElectionCount;	// 704 = 0x2c0
    unsigned long long _v2ElectionCoordinationMeshUpdateCount;	// 712 = 0x2c8
    unsigned long long _v2ElectionCoordinationMeshLeaderElectedCount;	// 720 = 0x2d0
    unsigned long long _v2ElectionCoordinationMeshLeaderChangedCount;	// 728 = 0x2d8
    unsigned long long _v2ElectionPrimaryResidentElectionRunCount;	// 736 = 0x2e0
    unsigned long long _v2ElectionPrimaryResidentChangedCount;	// 744 = 0x2e8
    unsigned long long _residentSelectionPrimaryResidentChangedCount;	// 752 = 0x2f0
    unsigned long long _v2ElectionCoordinationCurrentDeviceFlapCount;	// 760 = 0x2f8
    long long _v2ElectionPercentageDurationCurrentDeviceIsInPrimaryMesh;	// 768 = 0x300
    long long _primaryResidentDurationMinutes;	// 776 = 0x308
    unsigned long long _bulletinNotificationsPostedCount;	// 784 = 0x310
    unsigned long long _activeDaysPerMonthCount;	// 792 = 0x318
    long long _countOfDaysSinceLastActive;	// 800 = 0x320
    unsigned long long _widgetMaxRefreshCountForKind;	// 808 = 0x328
    HMDEventCountersManager *_eventCountersManager;	// 816 = 0x330
}

- (void).cxx_destruct;	// IMP=0x00000000001d7a43
