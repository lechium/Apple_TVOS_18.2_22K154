...
+ (id)sharedManager;	// IMP=0x0060000000c40675
- (void).cxx_destruct;	// IMP=0x0000000000c40231
...
- (void)dealloc;	// IMP=0x0000000000c3ffff
- (id)initWithNotificationCenter:(id)arg1 followUpManager:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x0000000000c3fcd5
