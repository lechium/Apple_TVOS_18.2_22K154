...
- (void).cxx_destruct;	// IMP=0x0000000000349a0b
...
- (id)initWithReachability:(_Bool)arg1 didCreateEventModel:(_Bool)arg2 reachabilityChangeDebounceCount:(unsigned long long)arg3 offlineDuration:(double)arg4 hapAccessory:(id)arg5;	// IMP=0x00000000003496e1
