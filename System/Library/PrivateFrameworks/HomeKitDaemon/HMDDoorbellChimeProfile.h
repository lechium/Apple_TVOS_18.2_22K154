...
- (void).cxx_destruct;	// IMP=0x000000000046be1e
...
- (id)doorbellMessagePayloadWithChimeMode:(long long)arg1 chimeDate:(id)arg2 personIdentificationText:(id)arg3 accessoryUUID:(id)arg4;	// IMP=0x000000000046bc3b
- (void)handleDoorbellChimeMessage:(id)arg1;	// IMP=0x000000000046b769
- (void)sendDoorbellChimeMessageWithChimeMode:(long long)arg1 chimeDate:(id)arg2 personIdentificationText:(id)arg3 accessoryUUID:(id)arg4;	// IMP=0x000000000046b0a4
- (void)registerForMessages;	// IMP=0x000000000046ae39
- (id)initWithAppleMediaAccessory:(id)arg1;	// IMP=0x000000000046acf6
