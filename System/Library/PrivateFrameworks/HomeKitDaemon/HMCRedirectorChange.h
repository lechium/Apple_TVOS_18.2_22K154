...
- (void).cxx_destruct;	// IMP=0x0000000000e343df
...
- (void)dumpForLoggingWithPrefix:(id)arg1 logType:(unsigned char)arg2;	// IMP=0x0000000000e3417c
- (id)descriptionLines;	// IMP=0x0000000000e33eaf
- (id)description;	// IMP=0x0000000000e33db2
