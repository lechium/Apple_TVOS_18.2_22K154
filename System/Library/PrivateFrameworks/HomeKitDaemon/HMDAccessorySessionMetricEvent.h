...
@interface HMDAccessorySessionMetricEvent
{
    ...
    _Bool _bonjourUpdateForced;	// 14 = 0xe
...
- (void).cxx_destruct;	// IMP=0x0000000000b1b149
...
- (id)initWithAccessory:(id)arg1 expectedTransport:(id)arg2 homeUUID:(id)arg3 topErrorDomain:(id)arg4 topErrorCode:(long long)arg5 sessionFailureCount:(unsigned long long)arg6;	// IMP=0x0000000000b1a581
- (id)initWithAccessory:(id)arg1 sessionMetric:(id)arg2;	// IMP=0x0000000000b1a07d
