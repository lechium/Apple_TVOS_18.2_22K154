...
+ (id)logCategory;	// IMP=0x001000000081273f
- (void).cxx_destruct;	// IMP=0x00000000008126c8
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000008124a6
- (void)clientConnectionsManager:(id)arg1 didHandleDeactivationForClientConnection:(id)arg2;	// IMP=0x0000000000812453
- (void)clientConnectionsManager:(id)arg1 didHandleActivationForClientConnection:(id)arg2;	// IMP=0x0000000000812400
- (void)_updateTimer;	// IMP=0x00000000008121bb
- (void)_configure;	// IMP=0x0000000000812036
- (void)removeClientConnection:(id)arg1;	// IMP=0x0000000000811f9e
- (void)addClientConnection:(id)arg1;	// IMP=0x0000000000811ef9
@property(readonly, copy) NSSet *clientConnections;
- (id)initWithTimer:(id)arg1 clientConnectionsManager:(id)arg2 logIdentifier:(id)arg3 workQueue:(id)arg4;	// IMP=0x0000000000811d08
- (id)initWithTimeInterval:(double)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000811c2d
