...
- (void).cxx_destruct;	// IMP=0x00000000006157f0
...
- (void)_ensureNetworkInterfaceMonitorStopped;	// IMP=0x0000000000615738
- (int)_ensureNetworkInterfaceMonitorStarted;	// IMP=0x00000000006154b9
- (void)_update;	// IMP=0x0000000000615314
- (void)stop;	// IMP=0x00000000006152c2
- (void)start;	// IMP=0x0000000000615270
- (void)dealloc;	// IMP=0x00000000006151ec
- (id)init;	// IMP=0x0000000000615163
