...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000069a196
- (void).cxx_destruct;	// IMP=0x000000000069a110
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000699ef5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000699d97
