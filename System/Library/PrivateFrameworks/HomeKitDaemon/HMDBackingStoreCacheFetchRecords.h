...
- (void).cxx_destruct;	// IMP=0x000000000037b539
...
- (id)mainReturningError;	// IMP=0x000000000037aebb
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000037addb
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000037acfb
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000037ac1b
