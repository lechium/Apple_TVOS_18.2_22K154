...
- (void).cxx_destruct;	// IMP=0x000000000070d4eb
...
- (id)description;	// IMP=0x000000000070d387
@property(readonly, nonatomic) NSDictionary *channelRecordPayload;
- (id)initWithVersion:(id)arg1 generationID:(id)arg2 preferredResidentsList:(id)arg3 selectionInfo:(id)arg4 connectionType:(unsigned long long)arg5 locationRawValue:(id)arg6;	// IMP=0x000000000070cd43
