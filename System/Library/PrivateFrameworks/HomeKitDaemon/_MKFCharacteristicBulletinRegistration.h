...
+ (id)backingModelProtocol;	// IMP=0x0010000000cbed3b
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000cbec87
+ (id)fetchRequest;	// IMP=0x0010000000a1b1eb
@property(readonly) id <MKFHome> home;
- (id)castIfCharacteristicBulletinRegistration;	// IMP=0x0000000000cbed82
