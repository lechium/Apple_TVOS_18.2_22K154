...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006d316d
- (void).cxx_destruct;	// IMP=0x00000000006cae82
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006ca95c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006ca87d
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006c9fb8
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006c9a00
- (id)initWithMulticastBridgingRules:(id)arg1 staticPortRules:(id)arg2 dynamicPortRules:(id)arg3 staticICMPRules:(id)arg4;	// IMP=0x00000000006c9918
- (id)init;	// IMP=0x00000000006c98e9
