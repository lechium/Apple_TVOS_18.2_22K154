...
+ (id)logCategory;	// IMP=0x0010000000b01ba8
+ (void)saveSetupLogEventIntoUserDefaults:(id)arg1 setupLogEvent:(id)arg2;	// IMP=0x0010000000b012ac
+ (id)readSetupLogEventFromUserDefaults:(id)arg1;	// IMP=0x0010000000b01156
+ (id)homepodSetupLogEventFromProtoSetupInfo:(id)arg1;	// IMP=0x0010000000b00b67
+ (void)removeLastAccessorySetupInfoFromUserDefaults:(id)arg1;	// IMP=0x0010000000b00a58
+ (id)readLastAccessorySetupInfo:(id)arg1;	// IMP=0x0010000000b009ee
- (void).cxx_destruct;	// IMP=0x0000000000aff6bd
...
- (void)setControllerSetupSessionIdentifier:(id)arg1;	// IMP=0x0000000000aff2e3
@property(readonly, copy) NSString *setupSessionIdentifier;
- (void)markFirstCoreDataContainerSetupDuration:(double)arg1 error:(id)arg2;	// IMP=0x0000000000aff090
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000afde03
- (void)markPrimaryResidentElectionJoinMesh;	// IMP=0x0000000000afdd50
- (void)markPrimaryResidentSelectionConnectedToStatusKitFutureResolved;	// IMP=0x0000000000afdc60
- (void)markPrimaryResidentElectionModernTransportStartedFutureResolved;	// IMP=0x0000000000afdb70
- (void)markPrimaryResidentElectionFirstCloudKitImportFutureResolved;	// IMP=0x0000000000afda80
- (void)markPrimaryResidentElectionPeerDeviceFutureResolved;	// IMP=0x0000000000afd990
- (id)_underlyingErrorByIgnoringCommunicationFailureErrors:(id)arg1;	// IMP=0x0000000000afd92d
- (void)startFinalSubmissionTimer;	// IMP=0x0000000000afd858
- (void)markControllerHH2Mode:(_Bool)arg1 controllerHH2SentinelExists:(_Bool)arg2;	// IMP=0x0000000000afd7d4
- (void)markCurrentDeviceConfirmedPrimaryResidentStatusDidChange:(_Bool)arg1;	// IMP=0x0000000000afd633
- (void)markEventRouterPrimaryClientConnectMessageFailedWithError:(id)arg1;	// IMP=0x0000000000afd287
- (void)markEventRouterPrimaryClientConnectStatusChanged:(_Bool)arg1;	// IMP=0x0000000000afcfc4
- (void)markSetupEndStage:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0000000000afb864
- (void)markSetupBeginStage:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0000000000afa8c9
- (id)initWithDataSource:(id)arg1 setupLogEvent:(id)arg2 logEventSubmitter:(id)arg3;	// IMP=0x0000000000afa807
- (id)initWithDataSource:(id)arg1 setupLogEvent:(id)arg2 logEventSubmitter:(id)arg3 currentUpTicksFactory:(CDUnknownBlockType)arg4 submissionTimerFactory:(CDUnknownBlockType)arg5 userDefaults:(id)arg6;	// IMP=0x0000000000afa634
