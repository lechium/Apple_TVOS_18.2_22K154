...
+ (id)logCategory;	// IMP=0x0010000000534969
- (void).cxx_destruct;	// IMP=0x00000000005333ca
...
- (id)logIdentifier;	// IMP=0x00000000005332ab
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x00000000005331f7
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x0000000000533143
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000532e32
- (void)startKeepAlive;	// IMP=0x0000000000532dc9
- (void)_createStreamSocketWithDevice:(id)arg1;	// IMP=0x0000000000531719
- (void)dealloc;	// IMP=0x0000000000531672
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 idsProxyStreamService:(id)arg3;	// IMP=0x0000000000531452
