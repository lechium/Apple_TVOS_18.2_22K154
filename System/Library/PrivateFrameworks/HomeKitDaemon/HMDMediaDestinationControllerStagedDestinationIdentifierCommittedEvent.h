...
- (void).cxx_destruct;	// IMP=0x00000000009383f1
...
- (id)initWithStagedDestinationIdentifier:(id)arg1 isTriggeredOnControllerDevice:(id)arg2 userPrivilege:(id)arg3;	// IMP=0x00000000009381c7
