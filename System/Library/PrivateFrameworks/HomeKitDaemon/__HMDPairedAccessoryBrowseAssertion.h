...
- (void).cxx_destruct;	// IMP=0x0000000000baeec8
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x0000000000baee34
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x0000000000baed01
- (id)initWithName:(id)arg1;	// IMP=0x0000000000baec4d
