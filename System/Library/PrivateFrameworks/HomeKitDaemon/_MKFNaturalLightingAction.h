...
+ (id)backingModelProtocol;	// IMP=0x0010000000c35429
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000c35375
+ (id)fetchRequest;	// IMP=0x00100000007e3dbc
+ (Class)cd_modelClass;	// IMP=0x0010000000987664
@property(readonly) id <MKFHome> home;
- (id)castIfNaturalLightingAction;	// IMP=0x0000000000c35470
