...
+ (id)sentinelParentUUID;	// IMP=0x004000000090d44a
+ (id)hmbProperties;	// IMP=0x004000000090d41a
- (id)createPerson;	// IMP=0x000000000090daec
- (id)initWithPerson:(id)arg1;	// IMP=0x000000000090d9d7
