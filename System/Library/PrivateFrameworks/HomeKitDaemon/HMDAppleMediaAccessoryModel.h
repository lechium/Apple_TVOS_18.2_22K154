...
+ (id)properties;	// IMP=0x00100000008719c5
+ (Class)cd_entityClass;	// IMP=0x00100000005790df
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000578d6e
