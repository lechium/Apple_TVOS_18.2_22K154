...
+ (id)properties;	// IMP=0x00100000007552a8
+ (id)cd_createMKFCharacteristicFromDictionary:(id)arg1 context:(id)arg2;	// IMP=0x0010000000db867d
+ (id)cd_modelTypeForCharacteristicFormat:(id)arg1;	// IMP=0x0010000000db8621
+ (Class)cd_entityClass;	// IMP=0x0010000000db8610
+ (id)cd_parentReferenceName;	// IMP=0x0010000000db8603
- (void).cxx_destruct;	// IMP=0x0000000000755277
...
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000db7ea0
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000db7b6d
- (_Bool)cd_updateManagedObjectInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000db7a9a
