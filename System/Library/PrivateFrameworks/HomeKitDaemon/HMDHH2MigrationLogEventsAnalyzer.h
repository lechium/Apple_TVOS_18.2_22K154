...
- (void).cxx_destruct;	// IMP=0x0000000000ae2a4d
...
- (void)runDailyTask;	// IMP=0x0000000000ae29a4
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000ae2910
- (id)initWithDataSource:(id)arg1;	// IMP=0x0000000000ae279b
