...
+ (id)backingModelProtocol;	// IMP=0x001000000070c744
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000070c72b
+ (Class)cd_modelClass;	// IMP=0x00100000005790ce
+ (id)fetchRequest;	// IMP=0x00100000009b5fb4
@property(readonly, retain, nonatomic) NSArray *actionsAppleMediaAccessoryPower;
- (id)castIfAppleMediaAccessory;	// IMP=0x000000000070c6cb
@property(readonly, copy, nonatomic) MKFAppleMediaAccessoryDatabaseID *databaseID;
- (id)_analysisPredicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg1 user:(id)arg2;	// IMP=0x000000000070c644
- (id)analysisBulletinRegistrationWithDeviceIdsIdentifier:(id)arg1 user:(id)arg2 context:(id)arg3;	// IMP=0x000000000070c543
- (id)bulletinRegistrationFromFetchRequest:(id)arg1 context:(id)arg2;	// IMP=0x000000000070c39d
- (void)willSave;	// IMP=0x000000000070ba75
