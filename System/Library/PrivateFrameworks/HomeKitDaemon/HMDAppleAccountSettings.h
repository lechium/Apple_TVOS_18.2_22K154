...
+ (_Bool)supportsCloudSettings;	// IMP=0x001000000093d9c5
+ (id)sharedSettings;	// IMP=0x001000000093d995
+ (id)logCategory;	// IMP=0x0010000000300d2b
- (void)updateHomeEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000093d926
- (void)synchronize;	// IMP=0x000000000093d920
...
- (id)attributeDescriptions;	// IMP=0x0000000000300b35
