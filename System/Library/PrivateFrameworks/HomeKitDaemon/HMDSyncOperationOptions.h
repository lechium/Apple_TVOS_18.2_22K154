...
- (void).cxx_destruct;	// IMP=0x00000000008bc834
...
- (id)description;	// IMP=0x00000000008bc62a
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x00000000008bc612
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x00000000008bc55d
