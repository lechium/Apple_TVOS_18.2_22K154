...
+ (id)logCategory;	// IMP=0x0010000000ef377d
- (void).cxx_destruct;	// IMP=0x0000000000ef350d
...
- (void)handleServicesUpdated:(id)arg1;	// IMP=0x0000000000ef33d7
- (void)handleCharacteristicsUpdated:(id)arg1;	// IMP=0x0000000000ef3366
- (void)_notifyDelegate;	// IMP=0x0000000000ef3178
- (id)_accessoryCharacteristicsToObserve;	// IMP=0x0000000000ef2db3
- (void)_registerForNotifications;	// IMP=0x0000000000ef2ccb
- (void)start;	// IMP=0x0000000000ef2c6b
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 interestedCharacteristicTypesByServiceType:(id)arg3;	// IMP=0x0000000000ef2a89
