...
+ (id)logCategory;	// IMP=0x0010000000a87fb4
+ (id)sharedHandler;	// IMP=0x0010000000a87f51
- (void).cxx_destruct;	// IMP=0x0000000000a87974
...
- (void)_setJetsamPriorityElevated:(_Bool)arg1;	// IMP=0x0000000000a876ff
- (void)_updateOrRemoveRelaunchPlist;	// IMP=0x0000000000a8717c
- (void)deregisterRelaunchClientWithUUID:(id)arg1;	// IMP=0x0000000000a870c4
- (void)registerRelaunchClientWithUUID:(id)arg1;	// IMP=0x0000000000a8700b
- (void)removePersistentRelaunchRegistrationsIfNecessary;	// IMP=0x0000000000a86f9a
- (id)initWithRelaunchPlistFileURL:(id)arg1 fileManager:(id)arg2 jetsamPriorityHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a86e43
- (id)init;	// IMP=0x0000000000a86da2
