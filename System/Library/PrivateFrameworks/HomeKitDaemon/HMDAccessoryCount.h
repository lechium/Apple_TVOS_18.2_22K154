...
- (void).cxx_destruct;	// IMP=0x000000000069f136
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x000000000069ef7d
...
- (id)initWithHome:(id)arg1;	// IMP=0x000000000069eb71
