...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bbafa3
- (unsigned long long)hash;	// IMP=0x0000000000bbad3c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bbac0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bbab38
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bbaa87
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bba9b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bba60d
- (id)dictionaryRepresentation;	// IMP=0x0000000000bba3f3
- (id)description;	// IMP=0x0000000000bba344
- (int)StringAsType:(id)arg1;	// IMP=0x0000000000bba2ad
- (id)typeAsString:(int)arg1;	// IMP=0x0000000000bba265
