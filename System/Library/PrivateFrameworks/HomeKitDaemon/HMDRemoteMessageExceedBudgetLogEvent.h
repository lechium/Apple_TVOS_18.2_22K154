...
+ (id)eventWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x001000000056524d
@property(readonly, nonatomic) struct _HMFRate budgetRate; // @synthesize budgetRate=_budgetRate;
- (id)initWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x00000000005651e2
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000ecf8f3
