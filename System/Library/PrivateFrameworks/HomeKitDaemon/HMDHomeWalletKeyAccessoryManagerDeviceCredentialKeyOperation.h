...
- (void).cxx_destruct;	// IMP=0x0000000000c41ae9
...
- (id)attributeDescriptions;	// IMP=0x0000000000c41906
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c418fb
- (id)operationByMergingWithOperation:(id)arg1;	// IMP=0x0000000000c417c4
- (id)initWithDeviceCredentialKey:(id)arg1 accessories:(id)arg2 user:(id)arg3;	// IMP=0x0000000000c41599
- (id)initWithDeviceCredentialKey:(id)arg1 accessoriesUUIDs:(id)arg2 user:(id)arg3;	// IMP=0x0000000000c414af
