...
+ (id)logCategory;	// IMP=0x0010000000774cff
- (void).cxx_destruct;	// IMP=0x0000000000774c8a
...
- (void)runHomeutilTask;	// IMP=0x0000000000774b87
- (void)runDailyTask;	// IMP=0x0000000000774abd
- (void)handleRequest:(id)arg1;	// IMP=0x0000000000774a54
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 dailyScheduler:(id)arg3 logEventSubmitter:(id)arg4 dateProvider:(id)arg5 requestCountProvider:(id)arg6 logEventFactories:(id)arg7;	// IMP=0x0000000000774794
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 accessoryDetailsManager:(id)arg3 metricsHomeDataChangedManager:(id)arg4 dailyScheduler:(id)arg5 logEventSubmitter:(id)arg6 dateProvider:(id)arg7 activityContributors:(id)arg8;	// IMP=0x000000000077431a
