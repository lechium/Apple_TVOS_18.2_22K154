...
- (void).cxx_destruct;	// IMP=0x0000000000ef194b
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000ef0806
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000ef070e
