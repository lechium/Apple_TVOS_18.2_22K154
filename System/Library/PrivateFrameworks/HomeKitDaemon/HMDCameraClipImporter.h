...
+ (id)logCategory;	// IMP=0x0010000000c12be1
- (void).cxx_destruct;	// IMP=0x0000000000c10fd7
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x0000000000c100cd
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000c0ff54
