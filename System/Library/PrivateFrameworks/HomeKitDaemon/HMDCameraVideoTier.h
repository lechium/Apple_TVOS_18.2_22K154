...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000c41421
- (void).cxx_destruct;	// IMP=0x0000000000c413bd
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000c41208
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000c41071
- (unsigned long long)hash;	// IMP=0x0000000000c4102d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c40f51
@property(readonly, nonatomic) long long quality;
- (id)description;	// IMP=0x0000000000c40dcc
- (id)initWithVideoResolution:(id)arg1 framerate:(id)arg2 minBitRate:(id)arg3 maxBitRate:(id)arg4 rtcpInterval:(id)arg5;	// IMP=0x0000000000c40caf
