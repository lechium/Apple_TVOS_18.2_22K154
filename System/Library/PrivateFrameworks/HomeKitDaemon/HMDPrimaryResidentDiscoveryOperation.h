...
+ (id)logCategory;	// IMP=0x00100000005fdc65
- (void).cxx_destruct;	// IMP=0x00000000005fd173
...
- (void)channel:(id)arg1 didObservePrimaryResidentChange:(id)arg2;	// IMP=0x00000000005fcf44
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000005fca37
- (void)residentStatusChannelCleanup;	// IMP=0x00000000005fc8df
- (void)cancelWithError:(id)arg1;	// IMP=0x00000000005fc82e
- (void)finish;	// IMP=0x00000000005fc78a
- (void)sendIDSAccountMessage;	// IMP=0x00000000005fc2d4
- (void)checkResidentStatusChannelForPrimary;	// IMP=0x00000000005fbdf7
- (void)main;	// IMP=0x00000000005fb7ab
- (void)cancel;	// IMP=0x00000000005fb77c
- (void)run;	// IMP=0x00000000005fb721
- (id)initWithHome:(id)arg1 messageDispatcher:(id)arg2 featuresDataSource:(id)arg3 context:(id)arg4;	// IMP=0x00000000005fb22a
