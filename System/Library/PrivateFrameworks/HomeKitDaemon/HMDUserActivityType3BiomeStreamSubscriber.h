...
- (void).cxx_destruct;	// IMP=0x00000000007d027e
...
- (void)unconfigure;	// IMP=0x00000000007d0134
- (_Bool)isEvent:(id)arg1 within24HoursInThePastOfDate:(id)arg2;	// IMP=0x00000000007cfffe
- (id)_fetchMostRecentEventFromDate:(id)arg1;	// IMP=0x00000000007cfca2
- (void)fetchMostRecentEventWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000007cfbb6
- (id)mostRecentEvent;	// IMP=0x00000000007cfb09
- (void)registerForBiomeStreamWithIdentifier:(id)arg1;	// IMP=0x00000000007cf84d
- (void)configureWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000007cf7bb
- (id)initWithIdentifier:(id)arg1 stream:(id)arg2 filterEventBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000007cf63f
