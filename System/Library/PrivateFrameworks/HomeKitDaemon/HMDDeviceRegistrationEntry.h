...
- (void).cxx_destruct;	// IMP=0x00000000001eeef1
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001eedf7
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000001eed55
