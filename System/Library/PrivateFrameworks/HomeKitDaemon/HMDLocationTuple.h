...
- (void).cxx_destruct;	// IMP=0x00000000004b5ce7
...
- (id)attributeDescriptions;	// IMP=0x00000000004b5a65
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x00000000004b59af
