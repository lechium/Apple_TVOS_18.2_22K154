...
+ (id)tupleWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x0060000000137bef
- (void).cxx_destruct;	// IMP=0x0000000000137b8b
...
- (void)updatePostingTime;	// IMP=0x0000000000137abf
- (id)initWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x000000000013797c
