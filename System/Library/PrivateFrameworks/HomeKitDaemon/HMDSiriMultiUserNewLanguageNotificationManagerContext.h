...
+ (id)logCategory;	// IMP=0x00100000002f0cc7
+ (id)userReadableLanguageFromCode:(id)arg1;	// IMP=0x00100000002f085c
- (void).cxx_destruct;	// IMP=0x00000000002f06ae
...
- (void)submitLogEventForShownNotificationWithLanguage:(id)arg1;	// IMP=0x00000000002f05a1
- (void)showNotificationForNewlySupportedLanguage:(id)arg1;	// IMP=0x00000000002f033d
- (id)siriLanguageForMediaAccessory:(id)arg1;	// IMP=0x00000000002f02ea
- (id)siriLanguagesRequiringNotificationForVersion:(id)arg1;	// IMP=0x00000000002efff4
...
- (void)setCurrentUserHasSeenNotification;	// IMP=0x00000000002efce3
@property(readonly) _Bool hasCurrentUserSeenNotification;
@property(readonly) NSArray *mediaAccessories;
- (void)handleMediaAccessorySoftwareVersionUpdated:(id)arg1;	// IMP=0x00000000002ef719
- (void)configure;	// IMP=0x00000000002ef6b5
- (id)initWithUser:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000002ef630
