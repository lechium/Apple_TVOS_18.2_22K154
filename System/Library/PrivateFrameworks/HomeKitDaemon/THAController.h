...
+ (id)selectButtonConfiguration:(id)arg1 supportsSiri:(_Bool)arg2;	// IMP=0x00600000009b5dbf
- (void).cxx_destruct;	// IMP=0x00000000009b5d97
...
- (_Bool)dispatchButtonEvent:(id)arg1;	// IMP=0x00000000009b5cd3
- (void)updateSelectedButtons:(id)arg1;	// IMP=0x00000000009b5cc1
- (id)initWithName:(id)arg1 identifier:(unsigned int)arg2 ticksPerSecond:(unsigned long long)arg3 supportedButtons:(id)arg4 supportsSiri:(_Bool)arg5;	// IMP=0x00000000009b5bd6
