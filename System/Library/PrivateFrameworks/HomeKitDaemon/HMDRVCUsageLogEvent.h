...
+ (id)eventWithSource:(unsigned long long)arg1 wholeHouse:(_Bool)arg2 roomCount:(id)arg3 roomsInHome:(id)arg4 cleanModes:(id)arg5;	// IMP=0x0010000000bb257a
- (void).cxx_destruct;	// IMP=0x0000000000bb2538
