...
- (void).cxx_destruct;	// IMP=0x0000000000452887
...
- (id)attributeDescriptions;	// IMP=0x00000000004525fa
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000045253f
- (_Bool)isEqualValue:(id)arg1;	// IMP=0x000000000045227a
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4 readVersion:(id)arg5 writeVersion:(id)arg6;	// IMP=0x000000000045217a
