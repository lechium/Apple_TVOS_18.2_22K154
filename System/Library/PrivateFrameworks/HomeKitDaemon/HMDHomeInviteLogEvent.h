...
+ (id)updateWithInvitationState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00100000007fa5f4
+ (id)updateWithState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00100000007fa5bb
...
- (id)initWithHomeInviteLogEventState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00000000007f9dfb
