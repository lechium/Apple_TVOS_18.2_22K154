...
- (void).cxx_destruct;	// IMP=0x0000000000870e96
...
- (void)configure;	// IMP=0x0000000000870c0d
- (void)dealloc;	// IMP=0x0000000000870bb5
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x0000000000870add
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x0000000000870a57
