...
- (void).cxx_destruct;	// IMP=0x0000000000a297fb
...
- (id)initWithSessionStartCallback:(CDUnknownBlockType)arg1 handleOpenRequestResponseTimer:(id)arg2 sendCloseEventTimer:(id)arg3;	// IMP=0x0000000000a2967c
