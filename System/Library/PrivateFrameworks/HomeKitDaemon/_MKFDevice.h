...
+ (id)backingModelProtocol;	// IMP=0x0010000000541130
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000054107c
+ (id)fetchRequest;	// IMP=0x0010000000b31301
+ (Class)cd_modelClass;	// IMP=0x0010000000be2ec1
- (id)castIfDevice;	// IMP=0x0000000000541177
