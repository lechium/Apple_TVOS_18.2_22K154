...
+ (id)broadcastEventFromAccessory:(id)arg1 withExpectedGSN:(_Bool)arg2;	// IMP=0x0060000000789bb6
- (void).cxx_destruct;	// IMP=0x0000000000789ba3
...
- (id)initBroadcastEventFromAccessory:(id)arg1 withExpectedGSN:(_Bool)arg2;	// IMP=0x0000000000789b03
