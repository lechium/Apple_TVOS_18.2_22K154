...
- (void).cxx_destruct;	// IMP=0x0000000000903d49
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x0000000000903c2b
- (_Bool)isComplete;	// IMP=0x0000000000903bca
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000903b1e
