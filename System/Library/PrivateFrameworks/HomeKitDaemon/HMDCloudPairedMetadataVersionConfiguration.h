...
+ (id)logCategory;	// IMP=0x0010000000afa5cd
- (void).cxx_destruct;	// IMP=0x0000000000afa59c
...
- (id)attributeDescriptions;	// IMP=0x0000000000afa395
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000af9ed2
- (id)initWithAccessoryIdentifier:(id)arg1 diagnostics:(id)arg2;	// IMP=0x0000000000af9e21
