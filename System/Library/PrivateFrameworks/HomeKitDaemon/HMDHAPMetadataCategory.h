...
- (void).cxx_destruct;	// IMP=0x000000000038c6b9
...
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x000000000038c3f1
- (id)init;	// IMP=0x000000000038c349
