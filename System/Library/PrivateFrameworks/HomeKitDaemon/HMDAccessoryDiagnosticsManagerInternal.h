...
+ (id)logCategory;	// IMP=0x0010000000b7cc70
- (void).cxx_destruct;	// IMP=0x0000000000b7ca51
...
- (id)logIdentifier;	// IMP=0x0000000000b7c97f
- (id)attributeDescriptions;	// IMP=0x0000000000b7c891
- (void)handleDiagnosticsTransferWithOptions:(id)arg1 message:(id)arg2;	// IMP=0x0000000000b7c7cd
- (void)shutDown;	// IMP=0x0000000000b7c725
- (void)start;	// IMP=0x0000000000b7c67d
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)notifyClientsOfDiagnosticsTransferSupport:(_Bool)arg1 supportDiagnosticsTransfer:(id)arg2;	// IMP=0x0000000000b7c564
- (void)_handleDiagnosticsTransferRequest:(id)arg1;	// IMP=0x0000000000b7c1a1
- (void)_registerForMessages;	// IMP=0x0000000000b7c010
- (id)initWithAccessory:(id)arg1;	// IMP=0x0000000000b7be9b
