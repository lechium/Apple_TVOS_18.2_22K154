...
+ (id)backingModelProtocol;	// IMP=0x00100000008e8a51
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000008e8a38
+ (Class)cd_modelClass;	// IMP=0x0010000000978745
+ (id)fetchRequest;	// IMP=0x0010000000bca221
- (id)castIfMediaAccessory;	// IMP=0x00000000008e8a98
