...
+ (id)logCategory;	// IMP=0x0010000000d3b8aa
- (void).cxx_destruct;	// IMP=0x0000000000d3b373
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x0000000000d3b188
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000d3afc6
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000d3ae2a
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x0000000000d3ac98
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x0000000000d3ab06
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x0000000000d3a9bb
- (void)dealloc;	// IMP=0x0000000000d3a83c
- (void)_startDataTransfer;	// IMP=0x0000000000d3a54f
- (void)sendIDSInvitation;	// IMP=0x0000000000d3a05e
- (void)_sendData;	// IMP=0x0000000000d39fc5
- (void)sendData:(id)arg1;	// IMP=0x0000000000d39dbb
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000d39c21
