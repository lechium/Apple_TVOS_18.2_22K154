...
+ (id)shortDescription;	// IMP=0x0010000000c6b348
- (void).cxx_destruct;	// IMP=0x0000000000c6b335
...
- (id)initWithDate:(id)arg1 reason:(unsigned long long)arg2 state:(unsigned long long)arg3;	// IMP=0x0000000000c6b145
