...
- (void).cxx_destruct;	// IMP=0x000000000070e631
...
- (id)description;	// IMP=0x000000000070e424
@property(readonly, nonatomic) _Bool isPrimary;
- (_Bool)hasChangedFrom:(id)arg1;	// IMP=0x000000000070e0e6
- (unsigned long long)hash;	// IMP=0x000000000070e0a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000070df57
- (id)matchingDeviceFromResidentDevices:(id)arg1;	// IMP=0x000000000070de3b
- (id)initWithChannelRecord:(id)arg1;	// IMP=0x000000000070d6cf
- (id)initWithIDSIdentifier:(id)arg1 idsDestination:(id)arg2 version:(id)arg3 generationID:(id)arg4 assertionTime:(id)arg5 preferredResidentsList:(id)arg6 selectionInfo:(id)arg7 connectionType:(unsigned long long)arg8 locationRawValue:(id)arg9;	// IMP=0x000000000070d549
