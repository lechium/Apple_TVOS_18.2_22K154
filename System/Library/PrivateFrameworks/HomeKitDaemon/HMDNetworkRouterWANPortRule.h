...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006d726e
- (void).cxx_destruct;	// IMP=0x00000000006d721a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006d6a8b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006d6959
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006d6304
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006d5d0b
- (id)initWithProtocol:(id)arg1 hostDNSName:(id)arg2 hostIPStart:(id)arg3 hostIPEnd:(id)arg4 hostPortStart:(id)arg5 hostPortEnd:(id)arg6;	// IMP=0x00000000006d5be4
- (id)init;	// IMP=0x00000000006d5bb5
- (void)addTo:(id)arg1;	// IMP=0x00000000006422f7
