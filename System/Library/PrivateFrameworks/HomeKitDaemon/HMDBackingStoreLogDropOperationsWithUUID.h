...
- (void).cxx_destruct;	// IMP=0x0000000000abc9d2
...
- (id)mainReturningError;	// IMP=0x0000000000abc3ac
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000abc304
