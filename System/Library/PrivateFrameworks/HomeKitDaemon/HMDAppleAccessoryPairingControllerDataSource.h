...
- (id)deviceForIdentifier:(id)arg1;	// IMP=0x0000000000ae3467
@property(readonly, nonatomic) HMDBulletinBoard *bulletinBoard;
- (void)deletePairingAccessoryState:(id)arg1;	// IMP=0x0000000000ae33be
- (void)updatePairingAccessoryState:(id)arg1;	// IMP=0x0000000000ae332e
- (id)timerWithInterval:(double)arg1 options:(unsigned long long)arg2;	// IMP=0x0000000000ae32ee
...
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000ae306c
