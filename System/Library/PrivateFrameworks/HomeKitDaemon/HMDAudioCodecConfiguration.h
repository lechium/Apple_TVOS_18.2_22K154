...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001984d1
- (void).cxx_destruct;	// IMP=0x00000000001984a0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001983d0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000198210
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001980a6
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000197d9a
- (id)initWithAudioCodecGroup:(id)arg1 codecParameter:(id)arg2;	// IMP=0x0000000000197cf8
