...
+ (id)backingModelProtocol;	// IMP=0x0010000000cc3995
+ (id)fetchRequest;	// IMP=0x0010000000cb464b
@property(readonly) id <MKFHome> home;
- (id)castIfFloatCharacteristic;	// IMP=0x0000000000cc393c
@property(readonly, copy, nonatomic) MKFFloatCharacteristicDatabaseID *databaseID;
- (void)pr_updateWithHAPMetadata:(id)arg1;	// IMP=0x0000000000cc3812
