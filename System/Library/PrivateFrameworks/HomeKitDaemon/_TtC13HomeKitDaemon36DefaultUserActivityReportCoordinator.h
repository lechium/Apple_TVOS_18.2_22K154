...
- (id)init;	// IMP=0x00000000001003b0
- (void)sendCoordinatedReportsForReason:(unsigned long long)arg1;	// IMP=0x00000000000fdfb0
- (void)configureWithDetectors:(id)arg1;	// IMP=0x00000000000fdc90
- (void)handleBackgroundTaskManagerTimerFiredWithNotification:(id)arg1;	// IMP=0x0000000000103340
- (void)handleStateChangeForDetectorOfType:(unsigned long long)arg1 withReason:(unsigned long long)arg2;	// IMP=0x0000000000105350
