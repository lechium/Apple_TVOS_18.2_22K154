...
- (void).cxx_destruct;	// IMP=0x000000000037cf0a
...
- (id)mainReturningError;	// IMP=0x000000000037cc3d
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000037cb81
