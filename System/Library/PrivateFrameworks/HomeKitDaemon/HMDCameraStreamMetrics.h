...
- (void).cxx_destruct;	// IMP=0x00000000003c45a9
...
- (void)dealloc;	// IMP=0x00000000003c447c
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3;	// IMP=0x00000000003c43c3
