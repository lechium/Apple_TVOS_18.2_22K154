...
- (void).cxx_destruct;	// IMP=0x0000000000e3bdf0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000e3bc05
- (unsigned long long)hash;	// IMP=0x0000000000e3bb1b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e3b981
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e3b828
- (void)copyTo:(id)arg1;	// IMP=0x0000000000e3b725
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e3b654
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e3b20c
- (id)dictionaryRepresentation;	// IMP=0x0000000000e3afb5
- (id)description;	// IMP=0x0000000000e3af06
- (void)clearOneofValuesForRequest;	// IMP=0x0000000000e3ae70
- (int)StringAsRequest:(id)arg1;	// IMP=0x0000000000e3ad7e
- (id)requestAsString:(int)arg1;	// IMP=0x0000000000e3ad36
