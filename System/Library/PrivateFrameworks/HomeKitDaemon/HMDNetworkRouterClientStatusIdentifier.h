...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006deb66
- (void).cxx_destruct;	// IMP=0x00000000006deb33
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006de753
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006de69b
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006de2df
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006ddf06
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddress:(id)arg3;	// IMP=0x00000000006dde4e
- (id)init;	// IMP=0x00000000006dde1f
