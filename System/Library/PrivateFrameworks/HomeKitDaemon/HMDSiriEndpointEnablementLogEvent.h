...
+ (id)logCategory;	// IMP=0x0010000000ef99d5
...
- (id)serializedMetric;	// IMP=0x0000000000ef9743
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000ef9544
- (id)initWithHomeUUID:(id)arg1 numCapableSiriEndpoints:(unsigned long long)arg2 numEnabledSiriEndpoints:(unsigned long long)arg3;	// IMP=0x0000000000ef94ee
- (id)initWithConfigurationDataSource:(id)arg1;	// IMP=0x0000000000ef919c
