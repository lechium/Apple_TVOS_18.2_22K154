...
+ (id)logCategory;	// IMP=0x001000000091fd68
- (void).cxx_destruct;	// IMP=0x000000000091fba3
@property(readonly) AFSettingsConnection *settingsConnection; // @synthesize settingsConnection=_settingsConnection;
- (void)main;	// IMP=0x000000000091fa49
- (id)initWithSettingsConnection:(id)arg1;	// IMP=0x000000000091f9d3
