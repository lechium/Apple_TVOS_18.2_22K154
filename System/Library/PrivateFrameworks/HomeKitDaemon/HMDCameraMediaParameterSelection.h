...
- (void).cxx_destruct;	// IMP=0x0000000000c382ea
...
- (void)setReselectedConfigParameters:(id)arg1 videoTier:(id)arg2;	// IMP=0x0000000000c3811f
- (void)setSelectedConfigParameters:(id)arg1;	// IMP=0x0000000000c37f77
- (void)setSelectedEndPointSetupParameters:(id)arg1 videoNetworkConfig:(id)arg2 audioNetworkConfig:(id)arg3;	// IMP=0x0000000000c37b93
- (_Bool)findBestMatchWithProtocolParameters:(id)arg1 streamingCapabilities:(id)arg2 videoTierParameters:(id)arg3;	// IMP=0x0000000000c377df
