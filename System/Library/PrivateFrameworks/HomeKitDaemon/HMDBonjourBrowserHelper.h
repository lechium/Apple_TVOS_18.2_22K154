...
- (void).cxx_destruct;	// IMP=0x0000000000a0fca1
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x0000000000a0f97d
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x0000000000a0f77b
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x0000000000a0f579
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000a0f4aa
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x0000000000a0f347
- (void)_removeBrowser:(id)arg1;	// IMP=0x0000000000a0f2d1
- (void)_addBrowser:(id)arg1;	// IMP=0x0000000000a0f25b
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x0000000000a0f0a6
- (void)_stopBrowsers;	// IMP=0x0000000000a0ebfe
- (void)stop;	// IMP=0x0000000000a0eb8d
- (_Bool)_startBrowsers;	// IMP=0x0000000000a0e7f8
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000a0e740
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x0000000000a0e4b9
