...
+ (id)backingModelProtocol;	// IMP=0x0010000000ab30d1
+ (id)homeRelation;	// IMP=0x0010000000ab30a1
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000ab2fed
+ (id)fetchRequest;	// IMP=0x001000000060dbb6
@property(readonly) id <MKFHome> home;
- (id)castIfNotificationRegistration;	// IMP=0x0000000000ab3156
