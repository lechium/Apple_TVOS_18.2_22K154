...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x00400000006e0404
- (void).cxx_destruct;	// IMP=0x00000000006e0282
...
- (id)attributeDescriptions;	// IMP=0x00000000006dffec
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x00000000006dfea6
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000006df710
