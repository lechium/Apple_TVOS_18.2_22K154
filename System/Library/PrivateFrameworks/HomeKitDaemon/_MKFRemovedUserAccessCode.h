...
+ (id)backingModelProtocol;	// IMP=0x0010000000ddc584
+ (id)homeRelation;	// IMP=0x0010000000ddc554
+ (Class)cd_modelClass;	// IMP=0x0010000000547cb6
+ (id)fetchRequest;	// IMP=0x001000000057351c
- (id)castIfRemovedUserAccessCode;	// IMP=0x0000000000ddc609
