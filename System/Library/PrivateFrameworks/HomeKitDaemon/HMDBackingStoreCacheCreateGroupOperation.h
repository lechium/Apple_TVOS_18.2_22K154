...
- (void).cxx_destruct;	// IMP=0x0000000000378f0b
...
- (id)mainReturningError;	// IMP=0x0000000000378bda
- (id)initWithZone:(id)arg1 owner:(id)arg2 rootRecord:(id)arg3 subscriptionName:(id)arg4 subscription:(id)arg5 creationBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000000378a98
