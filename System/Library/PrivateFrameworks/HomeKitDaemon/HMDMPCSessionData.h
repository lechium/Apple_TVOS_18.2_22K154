...
- (void).cxx_destruct;	// IMP=0x0000000000a86b98
...
- (id)dictionaryRepresentation:(_Bool)arg1;	// IMP=0x0000000000a862ff
- (id)initWithMediaAction:(id)arg1 source:(id)arg2 clientName:(id)arg3;	// IMP=0x0000000000a8619f
- (id)initWithDictionaryRepresentation:(id)arg1 profileSource:(id)arg2;	// IMP=0x0000000000a856e7
- (id)initWithMediaProfiles:(id)arg1 playbackState:(id)arg2 playbackVolume:(id)arg3 playbackArchive:(id)arg4 source:(id)arg5 clientName:(id)arg6;	// IMP=0x0000000000a852d2
