...
- (void).cxx_destruct;	// IMP=0x000000000091f991
...
- (void)dealloc;	// IMP=0x000000000091f905
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x000000000091f821
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x000000000091f757
