...
+ (id)logCategory;	// IMP=0x0010000000ee7753
- (void).cxx_destruct;	// IMP=0x0000000000ee72bd
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000ee6d45
- (void)done;	// IMP=0x0000000000ee68de
- (void)startTransportFallbackTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ee6757
- (void)startResponseTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000ee65d0
- (double)timeoutRemaining;	// IMP=0x0000000000ee64ec
- (id)preparedMessageWithTimeout:(double)arg1;	// IMP=0x0000000000ee6130
- (void)receivedResponseOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000ee6073
- (void)completeSendingOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x0000000000ee59a9
- (void)startSendingOverTransport:(id)arg1;	// IMP=0x0000000000ee5527
@property(readonly, copy, nonatomic) NSSet *inProgressTransports;
@property(readonly, nonatomic) _Bool expectsResponse;
@property(readonly, nonatomic) double timeout;
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5;	// IMP=0x0000000000ee5264
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5 activityFactory:(id)arg6 logEventSubmitter:(id)arg7;	// IMP=0x0000000000ee4dbe
