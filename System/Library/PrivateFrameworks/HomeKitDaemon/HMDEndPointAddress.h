...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000019a6d9
- (void).cxx_destruct;	// IMP=0x000000000019a697
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019a54c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019a2bc
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000019a129
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000199eec
@property(readonly, copy) NSData *tlvData;
- (_Bool)isCompatibleWithRemoteEndPointAddress:(id)arg1;	// IMP=0x0000000000199cc1
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x0000000000199be8
