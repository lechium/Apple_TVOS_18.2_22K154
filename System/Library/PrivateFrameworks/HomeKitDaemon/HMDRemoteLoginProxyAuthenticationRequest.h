...
+ (id)messageName;	// IMP=0x0010000000528ecb
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000528ec3
+ (id)objWithMessage:(id)arg1;	// IMP=0x0010000000528d02
+ (id)objWithDict:(id)arg1;	// IMP=0x0010000000528b5b
- (void).cxx_destruct;	// IMP=0x0000000000528b08
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000528913
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005287d8
