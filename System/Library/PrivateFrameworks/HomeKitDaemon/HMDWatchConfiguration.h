...
- (void).cxx_destruct;	// IMP=0x0000000000d428ee
...
- (void)setConfigVersion:(id)arg1 forHome:(id)arg2;	// IMP=0x0000000000d42792
- (void)setHomeConfiguration:(id)arg1;	// IMP=0x0000000000d42503
- (id)description;	// IMP=0x0000000000d42443
- (id)initWithUniqueID:(id)arg1;	// IMP=0x0000000000d4238e
