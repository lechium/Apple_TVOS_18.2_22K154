...
- (void).cxx_destruct;	// IMP=0x0000000000ce0783
...
- (id)attributeDescriptions;	// IMP=0x0000000000ce0462
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ce0457
- (unsigned long long)hash;	// IMP=0x0000000000ce03a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ce006a
- (id)initWithMediaProfileUniqueIdentifier:(id)arg1 mediaProperty:(id)arg2 deviceIdsDestination:(id)arg3 userUUID:(id)arg4 lastModified:(id)arg5 enabled:(_Bool)arg6;	// IMP=0x0000000000cdff3d
