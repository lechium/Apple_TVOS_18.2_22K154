...
+ (id)logCategory;	// IMP=0x0060000000a121dc
- (void).cxx_destruct;	// IMP=0x0000000000a1219a
...
- (id)attributeDescriptions;	// IMP=0x0000000000a11d90
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x0000000000a11c97
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000a11853
