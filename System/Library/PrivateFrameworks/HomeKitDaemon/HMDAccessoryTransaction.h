...
+ (id)properties;	// IMP=0x0010000000ec9068
+ (id)cd_getMKFRoom:(id)arg1;	// IMP=0x00100000009e9b32
+ (id)cd_getMKFAccessoryFromAccessory:(id)arg1;	// IMP=0x00100000009e9986
+ (id)cd_getMKFAccessoryFromAccessoryUUID:(id)arg1;	// IMP=0x00100000009e98f4
+ (Class)cd_entityClass;	// IMP=0x00100000009e98e3
+ (id)cd_parentReferenceName;	// IMP=0x00100000009e98d6
- (void).cxx_destruct;	// IMP=0x0000000000ec9d84
...
- (id)dependentUUIDs;	// IMP=0x0000000000ec9b80
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000009e91fd
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000009e9018
