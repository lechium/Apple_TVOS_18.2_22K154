...
+ (id)logCategory;	// IMP=0x001000000072b518
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x001000000072b43e
+ (id)pairingAccessory:(id)arg1 home:(id)arg2 appIdentifier:(id)arg3 retry:(_Bool)arg4;	// IMP=0x001000000072b368
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x001000000072b2f6
- (void).cxx_destruct;	// IMP=0x000000000072b0d7
...
- (id)residentConfirmationToString:(long long)arg1;	// IMP=0x000000000072a925
- (void)updateResidentConfirmationDurationWithConfirmation:(long long)arg1;	// IMP=0x000000000072a89b
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)prepareForObservation;	// IMP=0x0000000000728853
@property(readonly) NSDate *endDate; // @synthesize endDate=_endDate;
- (void)markEndTime;	// IMP=0x000000000072876d
- (_Bool)_isMatterAccessory;	// IMP=0x0000000000728758
@property(readonly, nonatomic, getter=isMatterAccessory) _Bool matterAccessory;
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x0000000000728698
- (void)updateEventPropertiesWithHAPAccessory:(id)arg1;	// IMP=0x0000000000728248
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x00000000007280b4
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x0000000000727e41
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x0000000000727e2f
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x0000000000727e1d
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x000000000072747a
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 appIdentifier:(id)arg4 retry:(_Bool)arg5 home:(id)arg6 isAddOperation:(_Bool)arg7 logEventStateManager:(id)arg8;	// IMP=0x000000000072644e
