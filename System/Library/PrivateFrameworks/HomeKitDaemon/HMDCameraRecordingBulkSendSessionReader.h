...
+ (id)logCategory;	// IMP=0x00100000009e8fb1
- (void).cxx_destruct;	// IMP=0x00000000009e8416
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000009e8262
- (void)stopWithReason:(unsigned short)arg1;	// IMP=0x00000000009e8220
- (void)start;	// IMP=0x00000000009e8070
- (id)initWithWorkQueue:(id)arg1 session:(id)arg2 readCallbackTimer:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x00000000009e7f5f
- (id)initWithWorkQueue:(id)arg1 session:(id)arg2 readTimeout:(double)arg3 logIdentifier:(id)arg4;	// IMP=0x00000000009e7e9a
