...
- (void).cxx_destruct;	// IMP=0x000000000056d775
@property(readonly, nonatomic) __weak HMDHomeManager *homeManager; // @synthesize homeManager=_homeManager;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000056d751
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000056d6ea
- (id)init;	// IMP=0x000000000056d642
