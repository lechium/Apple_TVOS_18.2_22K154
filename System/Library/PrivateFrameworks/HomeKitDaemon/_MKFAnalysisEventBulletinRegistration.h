...
+ (id)backingModelProtocol;	// IMP=0x0010000000ab9f3a
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000ab9e86
+ (id)fetchRequest;	// IMP=0x0010000000ad4332
@property(readonly) id <MKFHome> home;
- (id)castIfAnalysisEventBulletinRegistration;	// IMP=0x0000000000ab9f81
