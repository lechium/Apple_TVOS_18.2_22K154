...
+ (id)localizedMessageForCameraAccessModeChange:(unsigned long long)arg1 changeReason:(long long)arg2 camera:(id)arg3;	// IMP=0x0060000000e7fa67
- (void).cxx_destruct;	// IMP=0x0000000000e7fa03
...
- (id)attributeDescriptions;	// IMP=0x0000000000e7f6e2
- (id)initWithAccessMode:(unsigned long long)arg1 camera:(id)arg2 home:(id)arg3 changeReason:(long long)arg4 changeDate:(id)arg5;	// IMP=0x0000000000e7f34e
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x0000000000e7f1a9
