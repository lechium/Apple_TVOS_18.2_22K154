...
- (void).cxx_destruct;	// IMP=0x00000000007597c0
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000007596e0
- (void)stop;	// IMP=0x0000000000759686
- (void)start;	// IMP=0x0000000000759642
...
- (void)dealloc;	// IMP=0x0000000000759187
