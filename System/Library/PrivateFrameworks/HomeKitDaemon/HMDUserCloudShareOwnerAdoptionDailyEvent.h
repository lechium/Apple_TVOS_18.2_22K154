...
- (void).cxx_destruct;	// IMP=0x0000000000b2a509
...
- (id)initWithConfigureState:(long long)arg1 isPrimaryResident:(_Bool)arg2 trustStatusCounts:(struct CloudShareTrustManagerTrustStatusCounts)arg3;	// IMP=0x0000000000b29f55
