...
- (void).cxx_destruct;	// IMP=0x000000000037938b
...
- (id)mainReturningError;	// IMP=0x0000000000378ff2
- (id)initWithGroup:(id)arg1 serverChangeToken:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000378f3c
