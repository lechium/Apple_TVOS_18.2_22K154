...
- (void).cxx_destruct;	// IMP=0x0000000000acc1bf
...
- (void)forceRefresh;	// IMP=0x0000000000acc0fb
- (void)markDeleted;	// IMP=0x0000000000acc0ea
- (void)markChanged;	// IMP=0x0000000000acc0d9
- (id)initWithZoneID:(id)arg1;	// IMP=0x0000000000acc022
