...
+ (id)logCategory;	// IMP=0x000000000082160c
- (void).cxx_destruct;	// IMP=0x00000000008215b9
...
- (id)logIdentifier;	// IMP=0x0000000000821511
- (void)dealloc;	// IMP=0x00000000008213dd
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 proxyService:(id)arg3;	// IMP=0x0000000000821211
