...
- (void).cxx_destruct;	// IMP=0x0000000000e88555
...
- (id)attributeDescriptions;	// IMP=0x0000000000e883eb
@property(readonly) BGRepeatingSystemTaskRequest *taskRequest;
- (id)initWithTaskRequest:(id)arg1;	// IMP=0x0000000000e88214
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000e881a6
