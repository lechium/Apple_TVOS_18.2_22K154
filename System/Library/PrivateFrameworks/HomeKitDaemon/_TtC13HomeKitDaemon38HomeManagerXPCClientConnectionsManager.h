...
@interface _TtC13HomeKitDaemon38HomeManagerXPCClientConnectionsManager : NSObject
{
    ...
    MISSING_TYPE *messageTargetUUID;	// 16632592 = 0xfdcb10
    MISSING_TYPE *lockedState;	// 0 = 0x0
}

- (void).cxx_destruct;	// IMP=0x00000000000dda40
- (id)init;	// IMP=0x00000000000dd9e0
- (void)handleProcessInfoStateChangedNotification:(id)arg1;	// IMP=0x00000000000dd8f0
- (void)handleXPCConnectionDidInvalidateNotification:(id)arg1;	// IMP=0x00000000000dd370
- (void)handleXPCConnectionDidStartNotification:(id)arg1;	// IMP=0x00000000000dcc00
- (void)handleActiveAssertionUpdateStateMessage:(id)arg1;	// IMP=0x00000000000dc530
@property(nonatomic, readonly) _Bool hasActiveConnections;
- (void)configure;	// IMP=0x00000000000da2d0
