...
- (void).cxx_destruct;	// IMP=0x0000000000bdb40c
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000bdafc0
- (void)stop;	// IMP=0x0000000000bdaf16
- (void)start;	// IMP=0x0000000000bdad9d
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000bdaccf
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000bdabae
