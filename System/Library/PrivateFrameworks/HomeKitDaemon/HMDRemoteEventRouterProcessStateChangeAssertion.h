...
+ (id)logCategory;	// IMP=0x0010000000b29925
- (void).cxx_destruct;	// IMP=0x0000000000b292af
...
- (void)_backgroundTimerDidExpire:(id)arg1;	// IMP=0x0000000000b28d44
- (void)_removeBackgroundTimer:(id)arg1;	// IMP=0x0000000000b28bfd
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)arg1;	// IMP=0x0000000000b28978
- (void)handleProcessWithBundleIdentifier:(id)arg1 updatedIsActive:(_Bool)arg2;	// IMP=0x0000000000b28789
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 applicationsAndIntervals:(id)arg3 dataSource:(id)arg4;	// IMP=0x0000000000b28618
