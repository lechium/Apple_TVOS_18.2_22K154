...
+ (id)updateMultipleCharacteristicReadWriteResponsePayload:(id)arg1 withUnhandledRequests:(id)arg2;	// IMP=0x0060000000e3e932
+ (id)notificationUpdateMessagePayloadForHome:(id)arg1 notificationEnabled:(_Bool)arg2 characteristics:(id)arg3 characteristicsErrorsMap:(id)arg4;	// IMP=0x0060000000e3e12b
+ (id)responsePayloadForHome:(id)arg1 changedAccessories:(id)arg2 moreMessagesInMultipart:(id)arg3;	// IMP=0x0060000000e3dfdd
- (void).cxx_destruct;	// IMP=0x0000000000e3df79
...
- (id)attributeDescriptions;	// IMP=0x0000000000e3dcc1
- (id)notificationWithHome:(id)arg1;	// IMP=0x0000000000e3db51
- (id)initWithRequestIdentifier:(id)arg1 responses:(id)arg2 pendingMultiPartResponses:(_Bool)arg3;	// IMP=0x0000000000e3cae6
