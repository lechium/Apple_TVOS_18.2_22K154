...
+ (id)backingModelProtocol;	// IMP=0x0010000000b01dee
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000b01d3a
+ (id)fetchRequest;	// IMP=0x0010000000460b98
@property(readonly) id <MKFHome> home;
- (id)castIfNotificationRegistrationMediaProperty;	// IMP=0x0000000000b01ce1
@property(readonly, copy, nonatomic) MKFNotificationRegistrationMediaPropertyDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x0000000000b01c0f
