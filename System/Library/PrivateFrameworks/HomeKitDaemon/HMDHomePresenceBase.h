...
+ (id)logCategory;	// IMP=0x00100000008eee63
+ (id)messageTargetUUIDFromHomeUUID:(id)arg1;	// IMP=0x00100000008eed99
- (void).cxx_destruct;	// IMP=0x00000000008ef280
...
- (id)logIdentifier;	// IMP=0x00000000008ef178
- (void)residentChanged;	// IMP=0x00000000008ef172
- (void)handleHomeDataLoadedNotification:(id)arg1;	// IMP=0x00000000008ef16c
- (void)_registerForMessages;	// IMP=0x00000000008ef11e
- (void)configure:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x00000000008ef0ae
- (void)_initialize:(id)arg1;	// IMP=0x00000000008eeeca
