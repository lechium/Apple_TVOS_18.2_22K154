...
+ (id)logCategory;	// IMP=0x0010000000cb8872
+ (id)shortDescription;	// IMP=0x0010000000cb8865
- (void).cxx_destruct;	// IMP=0x0000000000cb7f25
...
- (long long)errorCodeForCurrentOperation;	// IMP=0x0000000000cb7b63
...
- (void)main;	// IMP=0x0000000000cb72ff
- (id)initWithPlaybackArchive:(id)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x0000000000cb71f1
- (id)initWithPlaybackArchive:(id)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x0000000000cb7152
- (id)initWithCommand:(unsigned int)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x0000000000cb7030
- (id)initWithCommand:(unsigned int)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x0000000000cb6fa4
