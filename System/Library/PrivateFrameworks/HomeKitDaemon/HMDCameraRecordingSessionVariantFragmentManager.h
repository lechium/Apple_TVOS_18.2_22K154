...
+ (id)logCategory;	// IMP=0x001000000099668f
- (void).cxx_destruct;	// IMP=0x00000000009960b7
...
- (void)_drainVariantFragmentQueue;	// IMP=0x0000000000995af9
- (void)handleVariantFragment:(id)arg1;	// IMP=0x000000000099579a
- (void)handleFullFragment:(id)arg1;	// IMP=0x00000000009956a6
@property(readonly) _Bool expectsVariantFragment;
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x0000000000995585
