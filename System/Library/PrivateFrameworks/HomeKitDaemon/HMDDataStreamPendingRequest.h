...
- (void).cxx_destruct;	// IMP=0x00000000004cc5e5
...
- (unsigned long long)hash;	// IMP=0x00000000004cc56f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004cc49a
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x00000000004cc395
