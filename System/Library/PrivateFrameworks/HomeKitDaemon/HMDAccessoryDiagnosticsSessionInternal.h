...
+ (id)logCategory;	// IMP=0x0010000000b7d0eb
- (void).cxx_destruct;	// IMP=0x0000000000b7d0ab
...
- (id)logIdentifier;	// IMP=0x0000000000b7cfc1
- (void)setUpWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b7cefd
- (void)shutDown;	// IMP=0x0000000000b7ce55
- (id)attributeDescriptions;	// IMP=0x0000000000b7cd89
- (id)initWithAccessory:(id)arg1;	// IMP=0x0000000000b7ccd7
