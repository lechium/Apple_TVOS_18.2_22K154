...
- (void).cxx_destruct;	// IMP=0x000000000098ff90
...
- (_Bool)_shouldExcludeForRestrictedGuestObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000098fd37
- (_Bool)shouldExcludeObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000098fd25
- (id)initWithTargetUser:(id)arg1 targetIsResident:(_Bool)arg2 targetDeviceAddress:(id)arg3;	// IMP=0x000000000098fc5b
