...
+ (id)localizedBodyForEcosystemName:(id)arg1 accessoryName:(id)arg2;	// IMP=0x0060000000c635bd
+ (id)localizedBodyForAppleEcosystemWithAccessoryName:(id)arg1;	// IMP=0x0060000000c63405
+ (id)localizedBodyForAccessoryName:(id)arg1;	// IMP=0x0060000000c6324d
+ (id)localizedTitle;	// IMP=0x0060000000c6323c
- (void).cxx_destruct;	// IMP=0x0000000000c631d8
...
- (id)attributeDescriptions;	// IMP=0x0000000000c62eb7
- (id)initWithAddedPairing:(id)arg1 accessory:(id)arg2;	// IMP=0x0000000000c6281c
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x0000000000c6262a
