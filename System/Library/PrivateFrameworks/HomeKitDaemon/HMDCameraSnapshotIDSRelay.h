...
+ (id)logCategory;	// IMP=0x001000000098fbf4
- (void).cxx_destruct;	// IMP=0x000000000098fb90
...
- (void)dealloc;	// IMP=0x000000000098f9ee
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x000000000098f85d
