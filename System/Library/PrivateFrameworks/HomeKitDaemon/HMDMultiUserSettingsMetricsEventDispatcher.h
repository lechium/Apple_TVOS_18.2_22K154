...
+ (id)logCategory;	// IMP=0x00100000003fa63d
- (void).cxx_destruct;	// IMP=0x00000000003fa5ec
...
- (id)logIdentifier;	// IMP=0x00000000003fa52d
- (void)runDailyTask;	// IMP=0x00000000003fa51b
- (void)submitMultiUserSettingsDailyEvent;	// IMP=0x00000000003fa19f
- (void)registerForDailyMultiUserSettingsEvents;	// IMP=0x00000000003fa153
- (id)initWithIdentifier:(id)arg1 logEventSubmitter:(id)arg2 dailyScheduler:(id)arg3;	// IMP=0x00000000003fa089
