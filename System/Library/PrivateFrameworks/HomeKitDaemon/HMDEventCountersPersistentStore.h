...
- (void).cxx_destruct;	// IMP=0x0000000000cfdcb7
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchive;	// IMP=0x0000000000cfd89b
- (void)archiveDictionary:(id)arg1;	// IMP=0x0000000000cfd76b
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x0000000000cfd707
