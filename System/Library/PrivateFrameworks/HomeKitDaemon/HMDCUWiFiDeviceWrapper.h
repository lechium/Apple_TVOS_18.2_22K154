...
+ (id)logCategory;	// IMP=0x001000000085cb8e
- (void).cxx_destruct;	// IMP=0x000000000085c42f
@property(readonly, nonatomic) NSString *deviceID; // @synthesize deviceID;
- (id)logIdentifier;	// IMP=0x000000000085c413
@property(readonly, copy) NSString *description;
- (void)cancelConfigurationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000085c220
- (void)startConfigurationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000085bf73
...
- (id)initWithCUWiFiDevice:(id)arg1 dispatchQueue:(id)arg2;	// IMP=0x000000000085bd45
