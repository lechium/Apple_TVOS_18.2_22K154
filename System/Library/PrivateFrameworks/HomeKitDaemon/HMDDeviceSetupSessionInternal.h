...
+ (id)allowedClasses;	// IMP=0x00600000004120b3
+ (_Bool)isSupported;	// IMP=0x006000000041200b
+ (long long)role;	// IMP=0x0060000000411f63
- (void).cxx_destruct;	// IMP=0x0000000000412372
...
- (_Bool)processSessionData:(id)arg1 outAccessoryUUID:(id *)arg2 outAccessoryCategory:(id *)arg3 outAccessoryIDSIdentifier:(id *)arg4 error:(id *)arg5;	// IMP=0x0000000000412228
- (id)initWithHomeManager:(id)arg1 userDefaults:(id)arg2;	// IMP=0x000000000041217e
