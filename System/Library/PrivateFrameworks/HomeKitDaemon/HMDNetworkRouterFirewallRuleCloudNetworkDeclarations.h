...
+ (id)__decodeRuleConfigurationWithVersionString:(id)arg1 ruleConfigurationValue:(id)arg2 baseAccessoryIdentifier:(id)arg3;	// IMP=0x0010000000cc062a
+ (id)__decodeRuleConfigurationsFromJSONDictionary:(id)arg1 baseAccessoryIdentifier:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x0010000000cbff4c
+ (id)logCategory;	// IMP=0x0010000000cbff1c
- (void).cxx_destruct;	// IMP=0x0000000000cbfeb8
...
- (id)attributeDescriptions;	// IMP=0x0000000000cbf92f
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000cbf5e2
@property(readonly, nonatomic) NSArray *ruleConfigurations; // @synthesize ruleConfigurations=_ruleConfigurations;
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2 allowUnzippedData:(_Bool)arg3;	// IMP=0x0000000000cbf1bf
- (id)initWithBaseAccessoryIdentifier:(id)arg1 data:(id)arg2;	// IMP=0x0000000000cbf1aa
- (id)initWithBaseAccessoryIdentifier:(id)arg1 name:(id)arg2 lastModifiedTime:(id)arg3 ruleConfigurationsByVersionString:(id)arg4;	// IMP=0x0000000000cbf08c
