...
+ (id)logCategory;	// IMP=0x0010000000de5a36
- (void).cxx_destruct;	// IMP=0x0000000000de59e1
...
- (_Bool)conditionPasses:(id)arg1 registrationUser:(id)arg2;	// IMP=0x0000000000de52aa
- (_Bool)canHandleCondition:(id)arg1;	// IMP=0x0000000000de5263
- (id)initWithHome:(id)arg1 presenceProvider:(id)arg2 featuresDataSource:(id)arg3;	// IMP=0x0000000000de5187
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000de50f5
