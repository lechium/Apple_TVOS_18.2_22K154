...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x00100000006a003d
- (void).cxx_destruct;	// IMP=0x000000000069ff1e
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x000000000069fa80
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000069fa2c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000069fa21
