...
- (void).cxx_destruct;	// IMP=0x000000000037ab22
...
- (id)mainReturningError;	// IMP=0x000000000037a8c4
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000037a808
