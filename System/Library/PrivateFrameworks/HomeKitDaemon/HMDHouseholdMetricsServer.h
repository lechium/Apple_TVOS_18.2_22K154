...
+ (id)logCategory;	// IMP=0x00600000001e6d79
- (void).cxx_destruct;	// IMP=0x00000000001e6101
...
- (void)runHouseholdMetricsDataCollectionAssociatedToDate:(id)arg1 forceSubmit:(_Bool)arg2;	// IMP=0x00000000001e5975
- (void)sendHouseholdMetricsCollectionRequestToDevices:(id)arg1 forHomeWithUUID:(id)arg2 associatedToDate:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000001e5328
- (_Bool)evaluateMetricResponsesForSubmission:(id)arg1;	// IMP=0x00000000001e50f8
- (_Bool)evaluateHouseholdActivityLogEventForSubmission:(id)arg1;	// IMP=0x00000000001e50db
- (id)initWithDataSource:(id)arg1 logEventSubmitter:(id)arg2 householdMetricsProvider:(id)arg3 remoteMessageDispatcher:(id)arg4 logEventFactories:(id)arg5 workQueue:(id)arg6;	// IMP=0x00000000001e4fc7
