...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006d5b08
- (void).cxx_destruct;	// IMP=0x00000000006d5aca
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006d55a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006d54c5
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006d5038
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006d4ba2
- (id)initWithHostDNSName:(id)arg1 hostIPStart:(id)arg2 hostIPEnd:(id)arg3 icmpTypes:(id)arg4;	// IMP=0x00000000006d4aba
- (id)init;	// IMP=0x00000000006d4a8b
- (void)addTo:(id)arg1;	// IMP=0x00000000006423a2
