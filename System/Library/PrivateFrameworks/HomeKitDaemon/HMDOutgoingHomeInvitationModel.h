...
+ (id)properties;	// IMP=0x00100000001dd1a9
+ (Class)cd_entityClass;	// IMP=0x00100000006be465
+ (id)cd_parentReferenceName;	// IMP=0x00100000006be458
- (id)dependentUUIDs;	// IMP=0x00000000001dcbfd
- (id)rgSettingsFromOutgoingInvitation:(id)arg1;	// IMP=0x00000000006be2f4
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x00000000006bda65
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x00000000006bd5fe
