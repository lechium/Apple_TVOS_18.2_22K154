...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009b0fb6
- (void).cxx_destruct;	// IMP=0x00000000009b0f85
...
- (id)attributeDescriptions;	// IMP=0x00000000009b0e3b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009b0bbe
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009b0b10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009b0b05
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009b09ba
- (id)initWithCameraCameraSignificantEventBulletinNotificationRegistration:(id)arg1 source:(id)arg2;	// IMP=0x00000000009b08f6
