...
+ (id)backingModelProtocol;	// IMP=0x00100000006512b3
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x001000000065129a
+ (Class)cd_modelClass;	// IMP=0x00100000009631e1
+ (id)fetchRequest;	// IMP=0x0010000000dcd742
- (id)castIfHomeNetworkRouterSetting;	// IMP=0x00000000006512fa
