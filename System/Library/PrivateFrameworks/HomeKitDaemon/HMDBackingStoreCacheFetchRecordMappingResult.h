...
- (void).cxx_destruct;	// IMP=0x000000000037cb1d
...
- (id)initWithGroup:(id)arg1 recordName:(id)arg2 uuid:(id)arg3 parentUuid:(id)arg4 type:(id)arg5;	// IMP=0x000000000037c7c9
