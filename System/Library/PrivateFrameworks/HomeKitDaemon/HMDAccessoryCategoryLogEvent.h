...
+ (id)denominatorSpecifyingEvent;	// IMP=0x00100000005160ec
- (void).cxx_destruct;	// IMP=0x00000000005160d9
...
- (id)initWithAccessoryDetailsType:(unsigned long long)arg1 accessoryCategoryIdentifier:(id)arg2 homeUUID:(id)arg3;	// IMP=0x0000000000515de6
