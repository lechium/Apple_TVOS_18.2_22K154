...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000131ced
- (void).cxx_destruct;	// IMP=0x0000000000131ca4
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000131b8c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001319bf
@property(readonly, copy) NSString *name;
@property(readonly, copy) id value;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 type:(id)arg3 numberValue:(id)arg4 dataValue:(id)arg5;	// IMP=0x00000000001316eb
