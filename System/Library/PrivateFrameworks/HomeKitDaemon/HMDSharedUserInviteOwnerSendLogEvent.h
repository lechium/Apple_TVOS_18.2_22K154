...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x0000000000dbad2b
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000dbaa7e
- (id)coreAnalyticsEventName;	// IMP=0x0000000000dbaa71
- (id)initWithHome:(id)arg1;	// IMP=0x0000000000dbaa0f
