...
+ (id)logCategory;	// IMP=0x0010000000b5dc4e
- (void).cxx_destruct;	// IMP=0x0000000000b5dbc2
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b5d941
- (void)trackCameraSignificantEvent:(id)arg1 shouldNotify:(_Bool *)arg2;	// IMP=0x0000000000b5d1a6
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x0000000000b5d00b
