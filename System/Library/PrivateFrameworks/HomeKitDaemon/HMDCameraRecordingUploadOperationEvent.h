...
- (void).cxx_destruct;	// IMP=0x0000000000c2f284
...
- (id)attributeDescriptions;	// IMP=0x0000000000c2ee4d
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x0000000000c2ed9a
