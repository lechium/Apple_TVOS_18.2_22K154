...
+ (id)logCategory;	// IMP=0x0010000000e8805d
- (void).cxx_destruct;	// IMP=0x0000000000e86211
...
- (id)logIdentifier;	// IMP=0x0000000000e85fda
- (_Bool)hasHome:(id)arg1;	// IMP=0x0000000000e85f87
- (void)addHome:(id)arg1;	// IMP=0x0000000000e85c49
@property(readonly) _Bool submitted;
- (void)markLanguageSettingObserved;	// IMP=0x0000000000e85a46
- (void)markFirstSettingObserved;	// IMP=0x0000000000e857bc
- (void)markAccessoryRemoved;	// IMP=0x0000000000e855e9
- (void)markAccessoryAddCompleted;	// IMP=0x0000000000e8544e
- (void)markLocalAccessoryAddStarted;	// IMP=0x0000000000e852e2
- (void)markRemoteAccessoryAddEndedWithError:(id)arg1;	// IMP=0x0000000000e85126
- (void)markRemoteAccessoryAddStarted;	// IMP=0x0000000000e84fba
- (void)markRemoteAccessoryAddWillStart:(id)arg1;	// IMP=0x0000000000e849d1
- (void)markRepairSessionComplete;	// IMP=0x0000000000e8499c
- (void)markEventRouterPrimaryClientConnectMessageFailedWithError:(id)arg1;	// IMP=0x0000000000e8483f
- (void)markEventRouterPrimaryClientConnectStatusChanged:(_Bool)arg1;	// IMP=0x0000000000e8467e
- (void)markPrimaryResidentChanged;	// IMP=0x0000000000e8452e
- (void)submit;	// IMP=0x0000000000e84522
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000e8424e
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000e83dd5
- (void)didReceiveCachedEvent:(id)arg1 topic:(id)arg2 source:(id)arg3;	// IMP=0x0000000000e83dc3
@property(readonly) id <HMDDeviceSetupTrackingInfo> trackingInfo;
- (void)updateTrackingInfo:(id)arg1;	// IMP=0x0000000000e83d1c
- (void)addRemoteEventRouterAssertion:(id)arg1;	// IMP=0x0000000000e83bff
- (id)initWithQueue:(id)arg1 trackingInfo:(id)arg2 setupSessionIdentifier:(id)arg3 homeManager:(id)arg4;	// IMP=0x0000000000e83a43
- (id)initWithQueue:(id)arg1 discoveryController:(id)arg2 networkInfoController:(id)arg3 trackingInfo:(id)arg4 setupSessionIdentifier:(id)arg5 homeManager:(id)arg6 logEventSubmitter:(id)arg7 radarInitiator:(id)arg8 timerFactory:(CDUnknownBlockType)arg9;	// IMP=0x0000000000e837df
- (void)releaseDiscoveryAssertionWithAssertionHandle:(id)arg1;	// IMP=0x00000000000312d0
- (id)obtainDiscoveryAssertion;	// IMP=0x00000000000312a0
- (id)networkMetricWithDiscoveryController:(id)arg1 networkInfoController:(id)arg2 sessionID:(id)arg3 idsIdentifierString:(id)arg4 currentWiFiInfo:(id)arg5 currentWiFiNetworkRSSI:(int)arg6 numResidents:(long long)arg7 numAppleMediaAccessories:(long long)arg8 accessoryDiagnosticInfo:(id)arg9 primaryResidentIdsIdentifierString:(id)arg10 primaryResidentDiagnosticInfo:(id)arg11 homeUUID:(id)arg12 primaryResidentDiagnosticInfoFetched:(_Bool)arg13;	// IMP=0x0000000000031070
