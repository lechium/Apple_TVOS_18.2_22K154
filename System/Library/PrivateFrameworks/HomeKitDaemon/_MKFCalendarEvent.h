...
+ (id)backingModelProtocol;	// IMP=0x00100000004a71a8
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x00100000004a70f4
+ (Class)cd_modelClass;	// IMP=0x0010000000c0ff32
+ (id)fetchRequest;	// IMP=0x0010000000cd1eeb
@property(readonly) id <MKFHome> home;
- (id)castIfCalendarEvent;	// IMP=0x00000000004a71ef
