...
- (void).cxx_destruct;	// IMP=0x0000000000ce1106
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ce0fc2
- (id)initWithRequest:(id)arg1 characteristicThresholds:(id)arg2;	// IMP=0x0000000000ce0f20
