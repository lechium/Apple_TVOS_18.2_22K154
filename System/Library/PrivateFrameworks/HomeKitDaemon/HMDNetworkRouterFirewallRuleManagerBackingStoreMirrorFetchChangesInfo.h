...
- (void).cxx_destruct;	// IMP=0x0000000000acd4ef
...
- (void)__cleanupMirroredZones:(id)arg1 cloudZones:(id)arg2 result:(id)arg3 error:(id)arg4;	// IMP=0x0000000000accd08
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000acc8f6
- (void)markZonesDeleted;	// IMP=0x0000000000acc8e5
- (void)markZonesChanged;	// IMP=0x0000000000acc8d4
- (id)initWithActivity:(id)arg1 options:(id)arg2 databaseChangeToken:(id)arg3 promise:(id)arg4 xpcActivity:(id)arg5 database:(id)arg6 useAnonymousRequests:(_Bool)arg7 recordIDs:(id)arg8 lastSynchronizedRecordIDs:(id)arg9;	// IMP=0x0000000000acc212
