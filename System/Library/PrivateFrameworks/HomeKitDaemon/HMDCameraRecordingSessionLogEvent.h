...
+ (_Bool)isRecordingSessionAlreadyInProgressError:(id)arg1;	// IMP=0x0010000000ead34d
- (void).cxx_destruct;	// IMP=0x0000000000ead33a
...
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x0000000000ead026
