...
- (void).cxx_destruct;	// IMP=0x0000000000c7a921
...
- (id)description;	// IMP=0x0000000000c7a839
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x0000000000c7a76f
