...
- (id)initWithReason:(long long)arg1 currentMemoryUsage:(unsigned long long)arg2 intervalMaxMemoryUsage:(unsigned long long)arg3;	// IMP=0x0000000000d3d38b
- (id)init;	// IMP=0x0000000000d3d2e3
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000ecf8f9
