...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006c5bd3
- (void).cxx_destruct;	// IMP=0x00000000006c5ba0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006c57c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006c5708
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006c534c
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006c4f73
- (id)initWithClientIdentifier:(id)arg1 lastViolationTimestamp:(id)arg2 lastResetTimestamp:(id)arg3;	// IMP=0x00000000006c4ebb
- (id)init;	// IMP=0x00000000006c4e8c
