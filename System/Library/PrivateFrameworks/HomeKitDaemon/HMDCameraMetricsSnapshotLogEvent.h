...
- (void).cxx_destruct;	// IMP=0x00000000009974f5
...
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3 snapshotForNotification:(_Bool)arg4;	// IMP=0x000000000099747d
