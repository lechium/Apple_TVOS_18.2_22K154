...
- (void).cxx_destruct;	// IMP=0x00000000003784ca
...
- (id)mainReturningError;	// IMP=0x00000000003779b2
- (id)initWithZone:(id)arg1 resultBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000377927
