...
- (id)initWithIsPrimary:(_Bool)arg1 didChangePrimary:(_Bool)arg2 electionTriggerReason:(unsigned long long)arg3 confirmationCriteria:(unsigned long long)arg4 meshAndPrimaryCandidateCountEqual:(_Bool)arg5 previousPrimaryInMesh:(_Bool)arg6;	// IMP=0x000000000012b56d
