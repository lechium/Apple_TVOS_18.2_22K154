...
- (void).cxx_destruct;	// IMP=0x0000000000c6b713
...
- (void)markEndTime;	// IMP=0x0000000000c6b3ee
- (id)initWithReason:(unsigned long long)arg1 state:(unsigned long long)arg2 notificationSentDate:(id)arg3;	// IMP=0x0000000000c6b35a
