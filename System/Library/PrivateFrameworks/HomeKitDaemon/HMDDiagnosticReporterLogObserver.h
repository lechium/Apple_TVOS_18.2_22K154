...
+ (id)logCategory;	// IMP=0x0010000000ecf7de
+ (_Bool)isSupportedEvent:(id)arg1;	// IMP=0x0010000000ecf75c
+ (id)supportedEventClasses;	// IMP=0x0010000000ecf72c
- (void).cxx_destruct;	// IMP=0x0000000000ecf6e0
...
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000ecf5d3
- (void)stop;	// IMP=0x0000000000ecf4bd
- (void)start;	// IMP=0x0000000000ecf37a
- (id)initWithLogEventDispatcher:(id)arg1;	// IMP=0x0000000000ecf1fe
- (_Bool)shouldSubmitEvent:(id)arg1;	// IMP=0x0000000000ecf1b0
