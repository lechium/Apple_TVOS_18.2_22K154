...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a1b53
- (void).cxx_destruct;	// IMP=0x00000000001a1b22
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a1a52
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a1892
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000001a176d
- (_Bool)_parseFromTLVData;	// IMP=0x00000000001a1563
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionControl:(id)arg1;	// IMP=0x00000000001a13d4
- (id)initWithSessionControl:(id)arg1 videoParameters:(id)arg2;	// IMP=0x00000000001a1332
