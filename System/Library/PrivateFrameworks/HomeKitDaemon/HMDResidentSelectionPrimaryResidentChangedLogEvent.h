...
+ (id)denominatorEvent:(id)arg1 residentSelectionMode:(unsigned long long)arg2;	// IMP=0x00100000004166e3
- (void).cxx_destruct;	// IMP=0x0000000000416690
...
- (id)initDenominatorEvent:(id)arg1 residentSelectionMode:(unsigned long long)arg2;	// IMP=0x0000000000415aa5
