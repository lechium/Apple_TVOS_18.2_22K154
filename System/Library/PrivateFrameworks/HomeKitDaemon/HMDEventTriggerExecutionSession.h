...
+ (id)logCategory;	// IMP=0x0010000000e1bd82
- (void).cxx_destruct;	// IMP=0x0000000000e1a30e
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000e1a0ba
- (id)didOccurEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000e1a000
- (void)_callExecutionCompleteIfNoMoreOutstandingRequests;	// IMP=0x0000000000e19d62
- (void)handleSessionPlaybackStateUpdatedNotification:(id)arg1;	// IMP=0x0000000000e19c62
- (void)_handleMonitoringEvent:(id)arg1;	// IMP=0x0000000000e198d1
- (void)_restoreState;	// IMP=0x0000000000e19222
- (void)_removeUserDialog;	// IMP=0x0000000000e1917f
- (void)_callExecutionComplete:(id)arg1;	// IMP=0x0000000000e19168
- (void)_submitAnalyticsData:(id)arg1;	// IMP=0x0000000000e18bac
- (void)_callExecutionComplete:(id)arg1 callDelegate:(_Bool)arg2;	// IMP=0x0000000000e18529
- (id)valueInActionSetWriteResponse:(id)arg1 actionSetUUID:(id)arg2 accUUID:(id)arg3 serviceID:(id)arg4 characteristicID:(id)arg5;	// IMP=0x0000000000e18406
- (id)_monitoringEventsFromActionSetResponse:(id)arg1;	// IMP=0x0000000000e1726f
- (void)_activateEvents:(id)arg1;	// IMP=0x0000000000e16fd6
- (void)_activateMonitoringEvents;	// IMP=0x0000000000e16f8a
- (void)_activateDurationEvents;	// IMP=0x0000000000e16f3e
- (void)_handleActionSetExecutionResponse:(id)arg1 actionSetError:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000e16778
- (void)_directlyExecuteActionSetsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000e16611
- (void)_addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000e1615a
- (void)addEvent:(id)arg1 causingDevice:(id)arg2;	// IMP=0x0000000000e1607c
- (void)_userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000e159c5
- (void)userResponse:(unsigned long long)arg1 device:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000e158db
- (id)durationEndEvents;	// IMP=0x0000000000e156f0
- (void)postponeRestoreIfWaitingForEndEvent;	// IMP=0x0000000000e1567f
- (void)cancelSessionIfWaitingForUserResponse;	// IMP=0x0000000000e1560e
- (_Bool)containsSecureActionSet;	// IMP=0x0000000000e154d0
- (void)_executeTriggerAfterEvaluatingCondition:(id)arg1;	// IMP=0x0000000000e14d3a
- (void)_evaluateFiringTrigger;	// IMP=0x0000000000e140af
- (void)evaluateFiringTrigger;	// IMP=0x0000000000e1403e
- (id)dumpState;	// IMP=0x0000000000e13c5c
- (_Bool)needsUserConfirmationForDevice:(id)arg1;	// IMP=0x0000000000e13a13
- (id)logIdentifier;	// IMP=0x0000000000e13a01
@property(readonly, copy) NSString *description;
- (id)initWithEventTrigger:(id)arg1 predicateUtilities:(id)arg2 triggerEvent:(id)arg3 causingDevice:(id)arg4 workQueue:(id)arg5 actionSets:(id)arg6 evaluationCondition:(id)arg7 recurrences:(id)arg8 endEvents:(id)arg9 msgDispatcher:(id)arg10;	// IMP=0x0000000000e13559
