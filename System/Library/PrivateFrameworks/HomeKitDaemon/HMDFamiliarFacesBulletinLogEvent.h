...
- (void).cxx_destruct;	// IMP=0x00000000001a27cc
...
- (id)initWithContainsFaceClassification:(_Bool)arg1 numberOfKnownPersons:(long long)arg2 numberOfUnknownPersons:(long long)arg3 bulletinReason:(id)arg4 doorbellPressed:(_Bool)arg5 secondsFromDoorbellToFaceClassification:(double)arg6;	// IMP=0x00000000001a237c
