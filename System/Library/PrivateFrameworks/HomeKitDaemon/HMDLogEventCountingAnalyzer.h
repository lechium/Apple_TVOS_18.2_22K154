...
- (void).cxx_destruct;	// IMP=0x0000000000b18afc
...
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000b1897e
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000b188c3
- (void)runDailyTask;	// IMP=0x0000000000b18852
- (void)incrementDailyCountersForEventName:(id)arg1;	// IMP=0x0000000000b18706
- (void)incrementPeriodicCountersForEventName:(id)arg1;	// IMP=0x0000000000b185b9
- (id)periodicSnapshotAtCurrentTickSeconds:(unsigned long long)arg1;	// IMP=0x0000000000b1850b
- (void)didReceiveEventFromDispatcher:(id)arg1 withCurrentTickSeconds:(unsigned long long)arg2;	// IMP=0x0000000000b183dd
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000b18349
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5 loggingPeriodicitySeconds:(unsigned long long)arg6 tickSecondsProviderBlock:(CDUnknownBlockType)arg7 periodicCountersLoggingBlock:(CDUnknownBlockType)arg8;	// IMP=0x0000000000b18132
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5;	// IMP=0x0000000000b1808b
