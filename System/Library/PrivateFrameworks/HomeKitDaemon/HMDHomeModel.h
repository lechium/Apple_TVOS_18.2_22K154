...
+ (id)properties;	// IMP=0x00100000007bd479
+ (id)cd_getHomeFromUUID:(id)arg1;	// IMP=0x0010000000c8abf5
+ (Class)cd_entityClass;	// IMP=0x0010000000c8abe4
+ (id)cd_parentReferenceName;	// IMP=0x0010000000c8abdc
...
- (id)audioAnalysisClassifierOptions;	// IMP=0x00000000007be3b4
- (void)setAudioAnalysisClassifierOptions:(id)arg1;	// IMP=0x00000000007be3a2
- (id)cd_generateValueForProperty:(id)arg1 managedObjectField:(id)arg2 context:(id)arg3;	// IMP=0x0000000000c89fca
- (id)cd_generateValueForModelObjectFromManagedObject:(id)arg1 modelObjectField:(id)arg2 modelFieldInfo:(id)arg3;	// IMP=0x0000000000c89579
