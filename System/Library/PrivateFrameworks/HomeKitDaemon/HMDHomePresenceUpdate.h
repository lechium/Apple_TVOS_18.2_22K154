...
{
    _Bool _update;	// 8 = 0x8
    id <HMDHomePresence> _homePresence;	// 16 = 0x10
    id <HMDUserPresence> _userPresence;	// 24 = 0x18
    HMDDevice *_causingDevice;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x000000000051dc26
...
- (id)description;	// IMP=0x000000000051daf3
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x000000000051da18
