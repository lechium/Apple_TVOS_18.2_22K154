...
- (id)attributeDescriptions;	// IMP=0x0000000000759088
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3 recordingEventTriggers:(unsigned long long)arg4;	// IMP=0x0000000000759044
