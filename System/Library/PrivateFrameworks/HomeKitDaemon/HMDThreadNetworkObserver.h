...
+ (id)supportedEventClasses;	// IMP=0x0010000000b7bddd
- (void).cxx_destruct;	// IMP=0x0000000000b7ba34
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x0000000000b7b67d
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x0000000000b7b677
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x0000000000b7b671
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000b7b5b6
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000b7b4fb
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000b7b3c5
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000b7b2e5
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000b7aa90
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x0000000000b7a2cf
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x0000000000b7a0d7
- (void)runDailyTask;	// IMP=0x0000000000b7a053
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000b79f8a
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000b79e04
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000b79c61
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000b79b7a
- (void)stop;	// IMP=0x0000000000b79a87
- (void)start;	// IMP=0x0000000000b79906
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x0000000000b798df
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x0000000000b7973a
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000b79644
