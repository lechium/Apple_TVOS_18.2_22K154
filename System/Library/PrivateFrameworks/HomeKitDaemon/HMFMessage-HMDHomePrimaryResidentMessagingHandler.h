...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000004c444a
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000004c43d3
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000004c42a8
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000795104
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000007950b5
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000795066
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000a0d96a
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000a0d900
- (_Bool)isRequestType;	// IMP=0x001000000017a93b
- (unsigned long long)homeManagerOptions;	// IMP=0x00100000004c4257
...
- (_Bool)shouldWeProcessRemoteMessageDespiteNoRemoteAccessAllowedForUser:(id)arg1;	// IMP=0x0010000000cb403f
- (id)userForHome:(id)arg1;	// IMP=0x0010000000cb3fa8
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x0010000000cb3bf5
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000ea2550
