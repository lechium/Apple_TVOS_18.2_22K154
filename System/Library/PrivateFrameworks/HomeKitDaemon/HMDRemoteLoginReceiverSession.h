...
- (void).cxx_destruct;	// IMP=0x00000000003c4abd
...
- (id)description;	// IMP=0x00000000003c4a1e
- (void)dealloc;	// IMP=0x00000000003c4914
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000003c4840
