...
+ (id)fetchRequest;	// IMP=0x0080000000efd204
- (_Bool)exportFromLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x0000000000a10b62
- (_Bool)importIntoLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x0000000000a1014a
- (_Bool)isReadyToImportIntoLocalModelWithContext:(id)arg1;	// IMP=0x0000000000a10002
