...
- (void).cxx_destruct;	// IMP=0x0000000000e25009
...
- (id)attributeDescriptions;	// IMP=0x0000000000e24e11
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e24e06
- (id)initWithNaturalLightingEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 retryCount:(unsigned long long)arg3;	// IMP=0x0000000000e24d70
