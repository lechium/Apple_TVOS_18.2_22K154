...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000195644
- (void).cxx_destruct;	// IMP=0x00000000001954d2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001953bc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000195158
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000194f8c
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x0000000000194ba3
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 attributes:(id)arg3;	// IMP=0x0000000000194ad9
