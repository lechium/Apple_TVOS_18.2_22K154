...
- (void).cxx_destruct;	// IMP=0x0000000000cb9995
...
- (id)mainReturningError;	// IMP=0x0000000000cb97e0
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x0000000000cb971c
