...
- (void).cxx_destruct;	// IMP=0x0000000000987a0c
...
- (id)attributeDescriptions;	// IMP=0x0000000000987747
- (id)initWithEnable:(_Bool)arg1 user:(id)arg2 deviceIdsDestination:(id)arg3;	// IMP=0x0000000000987686
