...
- (void).cxx_destruct;	// IMP=0x0000000000377914
@property(copy, nonatomic) CDUnknownBlockType fetchResult; // @synthesize fetchResult=_fetchResult;
- (id)mainReturningError;	// IMP=0x0000000000377816
- (id)initWithFetchResult:(CDUnknownBlockType)arg1;	// IMP=0x000000000037778d
