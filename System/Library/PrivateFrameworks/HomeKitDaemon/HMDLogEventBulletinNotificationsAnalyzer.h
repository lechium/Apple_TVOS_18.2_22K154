...
+ (id)managedEventCounterRequestGroups;	// IMP=0x00100000004b49c3
- (void).cxx_destruct;	// IMP=0x00000000004b460f
...
- (void)runDailyTask;	// IMP=0x00000000004b452b
- (void)resetAggregationAnalysisContext;	// IMP=0x00000000004b44ee
- (void)populateAggregationAnalysisLogEvent:(id)arg1 forDate:(id)arg2;	// IMP=0x00000000004b4449
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000004b4348
- (long long)cameraReachabilityThresholdFromConfiguration:(id)arg1;	// IMP=0x00000000004b430e
- (void)configurationChanged:(id)arg1;	// IMP=0x00000000004b42b2
- (id)initWithDataSource:(id)arg1 notificationSettingsProvider:(id)arg2;	// IMP=0x00000000004b4086
