...
+ (id)logCategory;	// IMP=0x0010000000e652e9
- (void).cxx_destruct;	// IMP=0x0000000000e64fea
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000e64db6
- (void)_closeSession;	// IMP=0x0000000000e64cdc
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000e64c24
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000e64b6d
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000e64a2d
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000e6499c
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000e64856
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000e64717
