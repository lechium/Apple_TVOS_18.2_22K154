...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006dca11
- (void).cxx_destruct;	// IMP=0x00000000006dc01a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006db88b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006db759
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006db104
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006dab06
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddressList:(id)arg3 lanIdentifier:(id)arg4 name:(id)arg5 rssi:(id)arg6;	// IMP=0x00000000006da9df
- (id)init;	// IMP=0x00000000006da9b0
