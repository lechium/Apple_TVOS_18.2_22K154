...
- (void).cxx_destruct;	// IMP=0x0000000000d04743
...
- (void)setErrorForPhase:(id)arg1 error:(id)arg2;	// IMP=0x0000000000d03f70
- (void)setDurationForPhase:(id)arg1 duration:(double)arg2;	// IMP=0x0000000000d03e0d
- (id)initWithActivityIdentifier:(id)arg1 setupSessionIdentifier:(id)arg2;	// IMP=0x0000000000d03cf8
