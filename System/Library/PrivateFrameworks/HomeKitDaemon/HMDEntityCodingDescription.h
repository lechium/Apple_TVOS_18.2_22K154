...
- (void).cxx_destruct;	// IMP=0x0000000000524ca2
@property(readonly) NSArray *parentRelationships; // @synthesize parentRelationships=_parentRelationships;
- (id)descriptionForRelationship:(id)arg1;	// IMP=0x0000000000524b15
- (id)descriptionForAttribute:(id)arg1;	// IMP=0x000000000052499c
