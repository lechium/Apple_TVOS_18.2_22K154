...
+ (id)fetchWithLocalModel:(id)arg1 context:(id)arg2;	// IMP=0x008000000093fb36
+ (id)fetchRequest;	// IMP=0x0080000000efd2a4
- (_Bool)exportFromLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x000000000094034e
- (_Bool)importIntoLocalModel:(id)arg1 updatedProperties:(id)arg2 context:(id)arg3;	// IMP=0x000000000093fbb2
- (id)fetchLocalModelWithContext:(id)arg1;	// IMP=0x000000000093fb74
