...
- (void).cxx_destruct;	// IMP=0x0000000000379ecc
...
- (id)mainReturningError;	// IMP=0x0000000000379b91
- (id)initWithGroup:(id)arg1 name:(id)arg2 model:(id)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000379b65
- (id)initWithGroup:(id)arg1 record:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000003799bf
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 resultBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000379993
- (id)initWithGroup:(id)arg1 name:(id)arg2 record:(id)arg3 data:(id)arg4 encoding:(unsigned long long)arg5 model:(id)arg6 resultBlock:(CDUnknownBlockType)arg7;	// IMP=0x000000000037983c
