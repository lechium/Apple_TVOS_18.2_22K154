...
+ (id)backingModelProtocol;	// IMP=0x0010000000e82854
+ (id)modelIDForParentRelationshipTo:(id)arg1;	// IMP=0x0010000000e827a0
+ (id)fetchRequest;	// IMP=0x0010000000576d7a
+ (Class)cd_modelClass;	// IMP=0x0010000000cc8950
@property(readonly) id <MKFHome> home;
- (id)castIfCharacteristicRangeEvent;	// IMP=0x0000000000e82747
@property(readonly, copy, nonatomic) MKFCharacteristicRangeEventDatabaseID *databaseID;
- (_Bool)validateForInsertOrUpdate:(id *)arg1;	// IMP=0x0000000000e82647
- (_Bool)validateMax:(id *)arg1 error:(id *)arg2;	// IMP=0x0000000000e82628
- (_Bool)validateMin:(id *)arg1 error:(id *)arg2;	// IMP=0x0000000000e82609
