...
- (void).cxx_destruct;	// IMP=0x00000000007e357e
...
- (id)description;	// IMP=0x00000000007e3479
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007e3362
- (unsigned long long)hash;	// IMP=0x00000000007e3345
- (void)dealloc;	// IMP=0x00000000007e32ff
...
- (id)initWithOutputDevice:(void *)arg1;	// IMP=0x00000000007e307b
