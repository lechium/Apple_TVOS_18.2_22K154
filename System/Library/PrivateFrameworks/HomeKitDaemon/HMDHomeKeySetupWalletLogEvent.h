...
- (void).cxx_destruct;	// IMP=0x0000000000650c8f
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000650be7
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)timeout;	// IMP=0x0000000000650a44
- (void)submitSuccess;	// IMP=0x00000000006509c8
- (id)initWithQueue:(id)arg1;	// IMP=0x0000000000650907
