...
+ (id)logCategory;	// IMP=0x0010000000ac7856
- (void).cxx_destruct;	// IMP=0x0000000000ac72cf
...
- (void)getSyncEntityObjectsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ac71a0
@property(readonly, nonatomic) NSArray *homeKitObjects;
- (void)gatherHomeKitObjectsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000ac70a0
- (void)_gatherHomeKitObjects;	// IMP=0x0000000000ac509c
...
- (id)_getCurrentHome;	// IMP=0x0000000000ac4cc0
- (id)_getPrimaryHome;	// IMP=0x0000000000ac4a9b
- (id)initWithHomeManager:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000ac4a00
