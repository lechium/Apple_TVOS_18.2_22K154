...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0060000000c8b27b
- (void).cxx_destruct;	// IMP=0x0000000000c8b228
...
- (void)close;	// IMP=0x0000000000c8b1a7
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000c8afd5
