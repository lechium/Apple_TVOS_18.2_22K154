...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x0010000000136823
+ (unsigned long long)maxRetryCount;	// IMP=0x0010000000136805
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x0010000000136721
+ (id)logCategory;	// IMP=0x00100000001366f1
- (void).cxx_destruct;	// IMP=0x000000000013668d
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x0000000000136269
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000136252
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000013623e
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x0000000000135d3f
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x0000000000135b58
