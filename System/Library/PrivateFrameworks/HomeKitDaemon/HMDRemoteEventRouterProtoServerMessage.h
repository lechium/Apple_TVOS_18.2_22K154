...
- (void).cxx_destruct;	// IMP=0x0000000000bbd94a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bbd7a6
- (unsigned long long)hash;	// IMP=0x0000000000bbd6d9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bbd56b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bbd437
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bbd354
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bbd2a0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bbceca
- (id)dictionaryRepresentation;	// IMP=0x0000000000bbccbf
- (id)description;	// IMP=0x0000000000bbcc10
- (void)clearOneofValuesForMessage;	// IMP=0x0000000000bbcb8c
- (int)StringAsMessage:(id)arg1;	// IMP=0x0000000000bbcaba
- (id)messageAsString:(int)arg1;	// IMP=0x0000000000bbca72
