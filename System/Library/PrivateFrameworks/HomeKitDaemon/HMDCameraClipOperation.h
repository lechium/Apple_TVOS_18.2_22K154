...
+ (id)logCategory;	// IMP=0x0010000000499bd8
+ (id)shortDescription;	// IMP=0x0010000000499bc6
+ (unsigned long long)cameraClipOperationType;	// IMP=0x0010000000499b1e
- (void).cxx_destruct;	// IMP=0x0000000000499a87
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x0000000000499548
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x00000000004991db
- (id)fetchClipModel;	// IMP=0x0000000000498f72
- (void)cancelWithError:(id)arg1;	// IMP=0x0000000000498e2c
- (void)finish;	// IMP=0x0000000000498d00
- (void)main;	// IMP=0x0000000000498c7c
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x00000000004988f9
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x0000000000498873
