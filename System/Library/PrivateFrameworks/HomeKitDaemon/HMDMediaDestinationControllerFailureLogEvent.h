...
- (void).cxx_destruct;	// IMP=0x0000000000938185
...
- (id)initWithDestinationControllerErrorCode:(id)arg1 errorCode:(id)arg2 errorDomain:(id)arg3 isTriggeredOnControllerDevice:(id)arg4 userPrivilege:(id)arg5;	// IMP=0x0000000000937e6d
