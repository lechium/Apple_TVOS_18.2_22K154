...
+ (id)logCategory;	// IMP=0x00100000006e1c32
- (void).cxx_destruct;	// IMP=0x00000000006e165b
...
- (id)logIdentifier;	// IMP=0x00000000006e14eb
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006e0e5a
- (void)submitMetricAndStop;	// IMP=0x00000000006e0de1
- (void)_initDiagnosticCounters;	// IMP=0x00000000006e0b9b
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000006e0889
