...
- (void).cxx_destruct;	// IMP=0x00000000006162f2
...
- (void)main;	// IMP=0x00000000006160e3
- (id)initWithItemToPost:(id)arg1 followUpController:(id)arg2;	// IMP=0x0000000000616018
