...
+ (id)logCategory;	// IMP=0x00600000008e4425
- (void).cxx_destruct;	// IMP=0x00000000008e42e4
...
- (void)_generateAllCombinations;	// IMP=0x00000000008e2671
- (id)createReselectedVideoParameters:(id)arg1;	// IMP=0x00000000008e2506
- (id)createSelectedVideoParameters;	// IMP=0x00000000008e211c
- (id)createSRTPParamters;	// IMP=0x00000000008e2091
- (_Bool)_selectParametersFromCodec:(id)arg1 profiles:(id)arg2 levels:(id)arg3 packetizationModes:(id)arg4 videoAttributes:(id)arg5;	// IMP=0x00000000008e1771
- (_Bool)selectVideoParameters;	// IMP=0x00000000008e0802
- (id)logIdentifier;	// IMP=0x00000000008e07b2
- (void)_setVideoResolutionPreference;	// IMP=0x00000000008e03ce
- (id)initWithSessionID:(id)arg1 videoTierParameters:(id)arg2 supportedVideoConfiguration:(id)arg3 supportedRTPConfiguration:(id)arg4 streamingCapabilities:(id)arg5;	// IMP=0x00000000008e01e0
