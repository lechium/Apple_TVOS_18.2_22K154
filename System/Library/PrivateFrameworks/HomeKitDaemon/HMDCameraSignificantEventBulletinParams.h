...
- (void).cxx_destruct;	// IMP=0x0000000000652736
...
- (id)initWithSignificantEvent:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x00000000006525b7
- (id)initWithUUID:(id)arg1 reason:(unsigned long long)arg2 dateOfOccurrence:(id)arg3 confidenceLevel:(unsigned long long)arg4 faceClassifications:(id)arg5 cameraProfileUUID:(id)arg6;	// IMP=0x000000000065249d
- (id)init;	// IMP=0x00000000006523f5
