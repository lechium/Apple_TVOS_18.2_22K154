...
+ (id)logCategory;	// IMP=0x006000000038b8d2
- (void).cxx_destruct;	// IMP=0x0000000000388c31
...
- (void)_finishStreamTransport;	// IMP=0x0000000000388928
- (id)_createTCPTransport;	// IMP=0x00000000003886bf
- (void)_generateStreamKeys;	// IMP=0x0000000000388490
- (void)processTransportSetupResponse:(id)arg1;	// IMP=0x0000000000388041
- (void)startSetup;	// IMP=0x0000000000387a96
- (id)_fullKeySalt;	// IMP=0x00000000003879f2
- (_Bool)_isComplete;	// IMP=0x0000000000387978
- (id)initWithAccessory:(id)arg1 queue:(id)arg2 logIdentifier:(id)arg3 transferManagementService:(id)arg4;	// IMP=0x0000000000387915
