...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000006d9f60
- (void).cxx_destruct;	// IMP=0x00000000006d9f38
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006d9c46
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006d9bb8
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000006d98ef
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000006d95bd
- (id)initWithStatus:(id)arg1 configuration:(id)arg2;	// IMP=0x00000000006d9524
- (id)init;	// IMP=0x00000000006d94f5
