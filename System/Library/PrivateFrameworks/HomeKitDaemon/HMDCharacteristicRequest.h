...
+ (id)logCategory;	// IMP=0x0010000000eca555
+ (id)requestWithCharacteristic:(id)arg1;	// IMP=0x0010000000eca50c
- (void).cxx_destruct;	// IMP=0x0000000000eca4db
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000eca386
@property(readonly, nonatomic) HMDHAPAccessory *accessory;
@property(readonly, nonatomic) HMDService *service;
- (id)attributeDescriptions;	// IMP=0x0000000000ec9e50
- (id)initWithCharacteristic:(id)arg1;	// IMP=0x0000000000ec9db5
