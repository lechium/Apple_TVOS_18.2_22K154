...
- (void).cxx_destruct;	// IMP=0x0000000000b7e28e
...
- (_Bool)matchesAccessoryServer:(id)arg1;	// IMP=0x0000000000b7def7
- (_Bool)matchesUnpairedAccessory:(id)arg1;	// IMP=0x0000000000b7de24
- (id)description;	// IMP=0x0000000000b7dc43
- (id)initWithAccessoryDescription:(id)arg1 linkType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3 progressHandler:(CDUnknownBlockType)arg4 pairingRequest:(id)arg5;	// IMP=0x0000000000b7d9bb
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 linkType:(long long)arg3 setupCode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 setupCodeProvider:(CDUnknownBlockType)arg6 pairingRequest:(id)arg7;	// IMP=0x0000000000b7d821
