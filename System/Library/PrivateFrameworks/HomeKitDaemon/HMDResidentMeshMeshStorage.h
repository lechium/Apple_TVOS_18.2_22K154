...
- (void).cxx_destruct;	// IMP=0x0000000000929a7a
...
- (void)_requestStatus;	// IMP=0x000000000092958f
- (id)initWithResidentDevice:(id)arg1 owner:(id)arg2;	// IMP=0x00000000009294a1
