...
+ (id)logCategory;	// IMP=0x00600000001d96d0
- (void).cxx_destruct;	// IMP=0x00000000001d95d3
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x00000000001d8f0a
- (id)createSelectedAudioParameters;	// IMP=0x00000000001d8b28
- (id)createSRTPParamters;	// IMP=0x00000000001d8a9d
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x00000000001d84b8
- (_Bool)selectAudioParameters;	// IMP=0x00000000001d7c51
- (id)logIdentifier;	// IMP=0x00000000001d7c01
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x00000000001d7a74
