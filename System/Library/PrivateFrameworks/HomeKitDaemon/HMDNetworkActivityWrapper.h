...
- (void).cxx_destruct;	// IMP=0x0000000000a45be5
...
- (id)childActivityWithLabel:(unsigned long long)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x0000000000a459e5
- (void)submitMetrics:(id)arg1 withName:(id)arg2;	// IMP=0x0000000000a457fc
- (void)completeWithSuccess:(_Bool)arg1;	// IMP=0x0000000000a457b1
- (void)setParent:(id)arg1;	// IMP=0x0000000000a456e6
- (void)activate;	// IMP=0x0000000000a456b1
...
- (id)initWithLabel:(unsigned long long)arg1;	// IMP=0x0000000000a45576
