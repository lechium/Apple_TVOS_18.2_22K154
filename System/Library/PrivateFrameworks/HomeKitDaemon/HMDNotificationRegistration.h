...
+ (id)logCategory;	// IMP=0x0010000000dd2fad
- (void).cxx_destruct;	// IMP=0x0000000000dd2f7e
...
- (void)addObserver:(SEL)arg1 name:(id)arg2 object:(id)arg3;	// IMP=0x0000000000dd2ca9
- (id)logIdentifier;	// IMP=0x0000000000dd2bd4
- (id)initWithRegisterer:(id)arg1;	// IMP=0x0000000000dd2b3c
