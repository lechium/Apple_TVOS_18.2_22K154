...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001942b9
+ (_Bool)translateImageResolution:(id)arg1 imageWidth:(id *)arg2 imageHeight:(id *)arg3;	// IMP=0x0010000000194268
- (void).cxx_destruct;	// IMP=0x0000000000194215
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001940ee
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000193e3f
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000193c83
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000019397c
- (id)translateImageWidth:(id)arg1 imageHeight:(id)arg2;	// IMP=0x00000000001932b8
- (id)initWithResolution:(id)arg1 framerate:(id)arg2;	// IMP=0x000000000019314b
