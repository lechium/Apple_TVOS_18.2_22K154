...
+ (id)infoWithTargetableAccessory:(id)arg1;	// IMP=0x0060000000304572
- (void).cxx_destruct;	// IMP=0x0000000000304564
...
- (_Bool)isActiveAndSupportsDragonSiri;	// IMP=0x00000000003044db
