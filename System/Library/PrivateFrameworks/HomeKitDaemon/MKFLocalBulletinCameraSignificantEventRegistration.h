...
+ (id)fetchCameraSignificantEventRegistrationForAccessoryUUID:(id)arg1 managedObjectContext:(id)arg2;	// IMP=0x00800000003ed7fc
+ (id)fetchRequest;	// IMP=0x0080000000efcfe4
