...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x00000000007cdd31
- (id)coreAnalyticsEventDictionary;	// IMP=0x00000000007cd997
- (id)coreAnalyticsEventName;	// IMP=0x00000000007cd98a
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x00000000007cd95b
