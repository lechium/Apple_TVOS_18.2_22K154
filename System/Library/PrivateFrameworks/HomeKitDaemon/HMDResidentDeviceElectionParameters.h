...
- (void).cxx_destruct;	// IMP=0x0000000000db6d89
...
- (id)attributeDescriptions;	// IMP=0x0000000000db6a86
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000db6a01
- (unsigned long long)hash;	// IMP=0x0000000000db69bd
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000db6350
- (long long)compare:(id)arg1;	// IMP=0x0000000000db633c
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000db5e96
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000db5ca0
