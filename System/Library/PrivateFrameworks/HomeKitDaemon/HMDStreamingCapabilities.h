...
+ (unsigned long long)aspectRatioOfResolution:(id)arg1;	// IMP=0x00100000006c067c
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000006c0674
+ (void)translateCapabilities:(id)arg1;	// IMP=0x00100000006bff5a
- (void).cxx_destruct;	// IMP=0x00000000006bfcce
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000006bfad9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000006bf7cf
- (void)updateWithRemoteSettings:(id)arg1;	// IMP=0x00000000006bf4bb
- (void)_updateWithStreamPreference:(id)arg1;	// IMP=0x00000000006bed3d
- (id)_supportedResolutionsWithOverrides;	// IMP=0x00000000006be870
- (id)initWithStreamPreference:(id)arg1;	// IMP=0x00000000006be5a4
- (id)description;	// IMP=0x00000000006be476
