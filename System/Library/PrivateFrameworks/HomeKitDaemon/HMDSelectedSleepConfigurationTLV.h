...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000009b6ec1
- (void).cxx_destruct;	// IMP=0x00000000009b6e8e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000009b6aae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009b69f6
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000009b663a
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000009b62ef
- (id)initWithOperationType:(id)arg1 operationStatus:(id)arg2 backoffTime:(id)arg3;	// IMP=0x00000000009b6237
- (id)init;	// IMP=0x00000000009b6208
