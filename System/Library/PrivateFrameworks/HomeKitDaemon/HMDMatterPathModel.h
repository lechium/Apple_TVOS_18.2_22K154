...
+ (id)properties;	// IMP=0x00100000009352e0
+ (Class)cd_entityClass;	// IMP=0x0010000000d40124
+ (id)cd_parentReferenceName;	// IMP=0x0010000000d40117
- (void)cd_populateParentRelationshipInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000d3ffaf
