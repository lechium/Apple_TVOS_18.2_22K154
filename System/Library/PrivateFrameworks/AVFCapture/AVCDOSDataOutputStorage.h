...
- (_Bool)hasAllExpectedSynchronizedDataForLeaderTimestamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000a73c9
@property(readonly, nonatomic, getter=isLive) _Bool live;
- (void)updateDelegateOverrideCallbackQueueQOSClass:(unsigned int)arg1;	// IMP=0x00000000000a72d5
- (void)dealloc;	// IMP=0x00000000000a727d
- (id)initWithDataOutput:(id)arg1;	// IMP=0x00000000000a71a1
