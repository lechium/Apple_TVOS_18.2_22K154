...
@interface AVCaptureMetadataOutputInternal : NSObject
{
    ...
    _Bool headObjectTypesAvailable;	// 97 = 0x61
    _Bool humanHandObjectTypeAvailable;	// 98 = 0x62
    _Bool emitsEmptyObjectDetectionMetadata;	// 99 = 0x63
    _Bool offlineVideoStabilizationMotionMetadataObjectTypesAvailable;	// 100 = 0x64
    NSMutableDictionary *previousTwoCMTimesByDetectorType;	// 104 = 0x68
}

- (void)dealloc;	// IMP=0x00000000000b863b
- (id)init;	// IMP=0x00000000000b85a8
