...
@interface AVCaptureFileOutputDelegateWrapper : NSObject
{
    ...
    _Bool _paused;	// 9 = 0x9
    _Bool _trueVideoCaptureEnabled;	// 10 = 0xa
    ...
    struct OpaqueFigCaptureSession *_pendingDidStopRecordingUnregistrationCaptureSession;	// 64 = 0x40
}

+ (id)wrapperWithURL:(id)arg1 delegate:(id)arg2 settingsID:(long long)arg3 connections:(id)arg4;	// IMP=0x0060000000004df3
...
- (void)dealloc;	// IMP=0x0000000000004eef
- (id)initWithURL:(id)arg1 delegate:(id)arg2 settingsID:(long long)arg3 connections:(id)arg4;	// IMP=0x0000000000004e43
