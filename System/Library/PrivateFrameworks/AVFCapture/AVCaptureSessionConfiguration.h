...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x00000000000b0053
- (id)uniqueConnections:(id)arg1;	// IMP=0x00000000000affdb
- (id)uniqueOutputs:(id)arg1;	// IMP=0x00000000000aff63
- (id)uniqueInputs:(id)arg1;	// IMP=0x00000000000afeeb
- (void)dealloc;	// IMP=0x00000000000afe93
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x00000000000afdf3
