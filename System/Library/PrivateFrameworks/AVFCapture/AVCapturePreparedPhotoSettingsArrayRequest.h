...
+ (id)preparedPhotoSettingsArrayRequestWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x006000000003ac41
...
- (void)_setRequestID:(unsigned long long)arg1;	// IMP=0x000000000003ad71
@property(readonly) unsigned long long requestID;
- (void)dealloc;	// IMP=0x000000000003ad1d
- (id)_initWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ac7d
