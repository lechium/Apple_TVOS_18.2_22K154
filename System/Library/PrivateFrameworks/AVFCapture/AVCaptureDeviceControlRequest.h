...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00600000000b181e
...
- (void)dealloc;	// IMP=0x00000000000b18be
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000b1855
