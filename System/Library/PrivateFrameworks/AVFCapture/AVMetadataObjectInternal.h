...
@interface AVMetadataObjectInternal : NSObject
{
    ...
    long long _objectID;	// 120 = 0x78
    unsigned long long _syntheticFocusMode;	// 128 = 0x80
    long long _detectionSource;	// 136 = 0x88
}
...
- (void)dealloc;	// IMP=0x00000000000d5abf
- (id)init;	// IMP=0x00000000000d5a40
