...
- (void)dealloc;	// IMP=0x000000000000e51d
- (id)initWithFigLevel:(int)arg1 factors:(unsigned long long)arg2 recommendedFrameRateRangeForPortrait:(id)arg3;	// IMP=0x000000000000e4b4
