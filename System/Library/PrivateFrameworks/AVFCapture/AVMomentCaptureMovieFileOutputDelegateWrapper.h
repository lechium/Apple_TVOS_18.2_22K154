...
+ (id)wrapperWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0060000000005019
...
- (void)dealloc;	// IMP=0x00000000000051c0
- (id)initWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0000000000005064
