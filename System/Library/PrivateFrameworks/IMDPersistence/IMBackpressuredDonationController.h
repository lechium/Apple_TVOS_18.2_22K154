...
- (void)donateItems:(id)arg1;	// IMP=0x00000000000359f4
- (void)_donateItems:(id)arg1;	// IMP=0x0000000000035407
- (void)_deferItems:(id)arg1;	// IMP=0x00000000000352be
- (void)_finishedDonatingItems:(id)arg1;	// IMP=0x0000000000035059
- (id)_popDonationsUpToCount:(long long)arg1;	// IMP=0x0000000000034f45
- (void)_beganDonatingItems;	// IMP=0x0000000000034f2e
- (id)initWithDonationCount:(long long)arg1 maxBackpressureSize:(long long)arg2 donationBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000034e56
