...
+ (id)messageId;	// IMP=0x0010000000008536
- (void).cxx_destruct;	// IMP=0x000000000000861c
...
- (id)initWithEncodedDictionary:(id)arg1;	// IMP=0x000000000000805b
- (id)dictionaryEncoding;	// IMP=0x0000000000008053
