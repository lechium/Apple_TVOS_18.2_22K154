...
- (id)init;	// IMP=0x0000000000028858
- (unsigned char)toBitmap;	// IMP=0x0000000000028819
- (id)initWithBitmap:(unsigned char)arg1;	// IMP=0x00000000000287d1
- (id)initWithFineRangingSupport:(_Bool)arg1 coarseRangingSupport:(_Bool)arg2 aoaSupport:(_Bool)arg3 extendedDistanceMeasurementSupport:(_Bool)arg4 syntheticApertureSupport:(_Bool)arg5;	// IMP=0x000000000002876e
- (id)initWithFineRangingSupport:(_Bool)arg1 aoaSupport:(_Bool)arg2 extendedDistanceMeasurementSupport:(_Bool)arg3 syntheticApertureSupport:(_Bool)arg4;	// IMP=0x0000000000028744
