...
- (void)storeDidSave:(id)arg1;	// IMP=0x0000000000036f65
- (void)storeMergedChanges:(id)arg1;	// IMP=0x00000000000366e9
- (void)didResetSync:(id)arg1;	// IMP=0x0000000000030840
- (void)willResetSync:(id)arg1;	// IMP=0x000000000002fd76
