...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000449b
- (void).cxx_destruct;	// IMP=0x0000000000005428
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004cd8
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000049b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000049ab
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000047d3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000044a3
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 appVersionId:(id)arg7 distributorId:(id)arg8;	// IMP=0x000000000000430e
