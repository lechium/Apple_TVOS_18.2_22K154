...
- (void).cxx_destruct;	// IMP=0x000000000004bdf5
...
- (void)finishAllWithError:(id)arg1;	// IMP=0x000000000004bcb0
- (void)cancelAll;	// IMP=0x000000000004bc66
- (void)enumerateBinaryPromises:(CDUnknownBlockType)arg1 andPromises:(CDUnknownBlockType)arg2;	// IMP=0x000000000004b941
- (void)addPromise:(id)arg1;	// IMP=0x000000000004b664
- (_Bool)containsPromise:(id)arg1;	// IMP=0x000000000004b4d9
@property(readonly, nonatomic) _Bool hasPromises;
- (void)addBinaryPromise:(id)arg1;	// IMP=0x000000000004af99
- (_Bool)containsBinaryPromise:(id)arg1;	// IMP=0x000000000004ad97
@property(readonly, nonatomic) NSMutableArray *promises;
@property(readonly, nonatomic) NSMutableArray *binaryPromises;
- (void)withLock:(CDUnknownBlockType)arg1;	// IMP=0x000000000004abda
- (id)init;	// IMP=0x000000000004ab84
