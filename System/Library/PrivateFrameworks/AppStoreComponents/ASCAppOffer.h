...
@interface ASCAppOffer : NSObject
{
    ...
    NSArray *_capabilities;	// 112 = 0x70
}

+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000a6fc
- (void).cxx_destruct;	// IMP=0x000000000000c226
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000b536
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000b01b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b010
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000ad00
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000a704
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13 capabilities:(id)arg14;	// IMP=0x000000000000a47d
