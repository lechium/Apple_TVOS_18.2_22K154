...
+ (id)sharedContext;	// IMP=0x004000000004be28
- (void).cxx_destruct;	// IMP=0x000000000004c41c
...
- (id)description;	// IMP=0x000000000004c2ed
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004c0b7
- (unsigned long long)hash;	// IMP=0x000000000004bfd7
- (id)initWithArtworkFetcher:(id)arg1 lockupFetcher:(id)arg2 appOfferStateCenter:(id)arg3;	// IMP=0x000000000004bf1f
