...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001f95f
- (void).cxx_destruct;	// IMP=0x0000000000020022
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001fca5
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001fbad
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001faba
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001f967
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4;	// IMP=0x000000000001f88f
