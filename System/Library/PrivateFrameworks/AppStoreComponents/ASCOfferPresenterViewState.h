...
- (id)description;	// IMP=0x0000000000048594
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000483f1
- (unsigned long long)hash;	// IMP=0x000000000004833f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048334
- (id)initWithMetadata:(id)arg1 theme:(id)arg2;	// IMP=0x000000000004827b
