...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000258c9
+ (id)lockupBatchRequestsFromRequests:(id)arg1;	// IMP=0x0010000000024e3d
...
- (id)lockupBatchRequestWithIDs:(id)arg1;	// IMP=0x00000000000269e5
@property(readonly, copy, nonatomic) NSArray *requests;
- (id)description;	// IMP=0x000000000002639b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000025f18
- (unsigned long long)hash;	// IMP=0x0000000000025d8e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000025d83
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000025bdf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000258d1
- (id)_initWithIDs:(id)arg1 kind:(id)arg2 context:(id)arg3 clientID:(id)arg4 enableAppDistribution:(_Bool)arg5 mediaQueryParams:(id)arg6 platformOverride:(id)arg7;	// IMP=0x00000000000257fc
- (id)initWithIDs:(id)arg1 kind:(id)arg2 context:(id)arg3;	// IMP=0x0000000000025710
