...
- (void).cxx_destruct;	// IMP=0x00000000000105e4
...
- (void)invalidateTemporaryStateForcingUpdate:(_Bool)arg1;	// IMP=0x000000000001042b
- (void)installTemporaryWaitingState;	// IMP=0x00000000000101a5
- (void)viewAppForAppDistributionOffer:(id)arg1;	// IMP=0x000000000001013c
- (id)performActionWithActivity:(id)arg1 inContext:(id)arg2;	// IMP=0x0000000000010080
- (void)offerStatusTextDidChange:(id)arg1;	// IMP=0x000000000000ffae
- (void)offerStateDidChange:(id)arg1 withMetadata:(id)arg2 flags:(long long)arg3;	// IMP=0x000000000000fbf8
- (void)enumerateDelegatesUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000fa44
- (void)removeDelegate:(id)arg1;	// IMP=0x000000000000f937
- (void)addDelegate:(id)arg1;	// IMP=0x000000000000f6c9
- (void)dealloc;	// IMP=0x000000000000f4d6
- (id)initWithOffer:(id)arg1 stateCenter:(id)arg2;	// IMP=0x000000000000f415
