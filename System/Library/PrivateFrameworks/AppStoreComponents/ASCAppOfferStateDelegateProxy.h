...
- (void)offer:(id)arg1 didChangeStatusText:(id)arg2;	// IMP=0x000000000000f1a9
- (void)offer:(id)arg1 didChangeState:(id)arg2 withMetadata:(id)arg3 flags:(long long)arg4;	// IMP=0x000000000000f058
- (id)initWithTarget:(id)arg1;	// IMP=0x000000000000eff4
