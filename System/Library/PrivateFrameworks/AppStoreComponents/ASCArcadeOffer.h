...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000107ce
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000010fe7
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000010cc5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010cba
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010ae2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000107d6
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0000000000010636
