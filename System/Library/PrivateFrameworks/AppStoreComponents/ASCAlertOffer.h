...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000003016
- (void).cxx_destruct;	// IMP=0x0000000000004299
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000003943
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000358e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000003583
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000003343
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000301e
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x0000000000002e2e
