...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000508f9
- (void).cxx_destruct;	// IMP=0x0000000000051a23
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000051195
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000050e1b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000050e10
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000050c04
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000050901
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000000050747
