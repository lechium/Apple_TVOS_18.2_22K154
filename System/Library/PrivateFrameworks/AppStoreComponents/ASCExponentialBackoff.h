...
- (void).cxx_destruct;	// IMP=0x000000000001b6a7
...
- (void)reset;	// IMP=0x000000000001b5e3
- (double)nextSleepTimeInterval;	// IMP=0x000000000001b501
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x000000000001b485
