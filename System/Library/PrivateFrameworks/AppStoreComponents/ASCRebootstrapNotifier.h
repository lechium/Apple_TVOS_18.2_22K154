...
+ (id)sharedNotifier;	// IMP=0x004000000004c44f
...
- (void)postLocalNotification;	// IMP=0x000000000004c852
- (void)postLocalNotificationIfNeeded;	// IMP=0x000000000004c7c2
- (void)dealloc;	// IMP=0x000000000004c766
- (id)_initSingleton;	// IMP=0x000000000004c4b4
