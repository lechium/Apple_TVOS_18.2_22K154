...
- (void).cxx_destruct;	// IMP=0x000000000003cec0
...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x000000000003cdc3
- (void)invalidate;	// IMP=0x000000000003cb22
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003c638
- (void)dealloc;	// IMP=0x000000000003c5fa
- (id)initWithView:(id)arg1;	// IMP=0x000000000003c57c
