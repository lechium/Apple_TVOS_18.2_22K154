...
+ (id)createTexture;	// IMP=0x0010000000004744
+ (void)_reuseTexture:(id)arg1;	// IMP=0x00100000000046c9
+ (id)_dequeueTexture;	// IMP=0x0010000000004653
+ (id)_reusableTextures;	// IMP=0x0010000000004623
- (void).cxx_destruct;	// IMP=0x00000000000045e1
...
- (MISSING_TYPE *)orientationTransform;	// IMP=0x0000000000004571
- (struct __CVBuffer *)sourceCVPixelBuffer;	// IMP=0x000000000000452d
- (struct CGImage *)sourceCGImage;	// IMP=0x00000000000044e9
...
- (void)cleanupAfterRender:(long long)arg1;	// IMP=0x0000000000004119
- (void)prepareForRender:(long long)arg1;	// IMP=0x00000000000040ca
@property(readonly, nonatomic) PXGColorProgram *colorProgram;
- (void)getTextureInfos:(CDStruct_37a3040a *)arg1 forSpriteIndexes:(const unsigned int *)arg2 geometries:(const CDStruct_4f725fed *)arg3 spriteStyles:(const CDStruct_a79e78a9 *)arg4 spriteInfos:(const CDStruct_12471299 *)arg5 screenScale:(double)arg6 count:(unsigned int)arg7;	// IMP=0x0000000000003fb6
@property(readonly, nonatomic) id <MTLTexture> texture;
@property(readonly, nonatomic) id <MTLTexture> chromaTexture;
- (id)init;	// IMP=0x0000000000003e36
