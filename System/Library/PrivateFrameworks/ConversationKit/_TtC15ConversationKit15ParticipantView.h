...
@interface _TtC15ConversationKit15ParticipantView : UIView
{
    ...
    MISSING_TYPE *participantIdentifier;	// 779318371 = 0x2e737463
    MISSING_TYPE *delegate;	// 1919907685 = 0x726f7765
    MISSING_TYPE *isInRoster;	// 1127183211 = 0x432f736b
    MISSING_TYPE *shouldOverrideShadowHidden;	// 12 = 0xc
    MISSING_TYPE *customCornerRadius;	// 1667331182 = 0x6361746e
    MISSING_TYPE *isExpanded;	// 24 = 0x18
}

- (void).cxx_destruct;	// IMP=0x000000000043860d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000439ad0
- (void)didTapKickMember;	// IMP=0x0000000000439a17
- (void)layoutSubviews;	// IMP=0x0000000000438cbb
- (void)dealloc;	// IMP=0x00000000004385f0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000043856c
