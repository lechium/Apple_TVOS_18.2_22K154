...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001caa91
- (void)configureWith:(id)arg1 isFullScreenMode:(_Bool)arg2;	// IMP=0x00000000001ca9a4
- (void)layoutSubviews;	// IMP=0x00000000001ca6f3
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ca6db
- (id)init;	// IMP=0x00000000001ca549
