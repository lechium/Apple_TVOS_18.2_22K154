...
- (void).cxx_destruct;	// IMP=0x000000000020d859
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000020d808
- (void)handleContentSizeCategoryDidChange:(id)arg1;	// IMP=0x000000000020c738
- (void)blockStatusDidUpdate;	// IMP=0x000000000020c69e
- (void)viewDidLayoutSubviews;	// IMP=0x000000000020c37a
- (_Bool)_canShowWhileLocked;	// IMP=0x000000000020c279
- (void)viewDidLoad;	// IMP=0x000000000020c24c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000020a0fb
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000000210bc0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000020f8f4
- (_Bool)collectionView:(id)arg1 canFocusItemAtIndexPath:(id)arg2;	// IMP=0x000000000020f0e5
