...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000e32ae0
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000e32a70
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x0000000000e32a10
- (void)layoutSublayers;	// IMP=0x0000000000e329d0
- (void)setNeedsDisplayInRect:(struct CGRect)arg1;	// IMP=0x0000000000e32980
