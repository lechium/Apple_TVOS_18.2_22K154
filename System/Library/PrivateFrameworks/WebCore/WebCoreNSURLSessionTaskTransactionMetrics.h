...
- (id).cxx_construct;	// IMP=0x0000000002af8930
- (void).cxx_destruct;	// IMP=0x0000000002af88c0
- (_Bool)multipath;	// IMP=0x0000000002af88b0
- (_Bool)constrained;	// IMP=0x0000000002af88a0
- (_Bool)expensive;	// IMP=0x0000000002af8890
- (_Bool)cellular;	// IMP=0x0000000002af8880
...
- (void)dealloc;	// IMP=0x0000000002af8320
- (id)_initWithMetrics:(void *)arg1 onTarget:(struct RefCountedSerialFunctionDispatcher *)arg2;	// IMP=0x0000000002af8210
