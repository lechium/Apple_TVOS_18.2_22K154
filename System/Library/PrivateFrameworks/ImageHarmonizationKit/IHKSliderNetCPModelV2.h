...
- (id).cxx_construct;	// IMP=0x000000000000c960
- (void).cxx_destruct;	// IMP=0x000000000000c800
...
- (id)applyAdjustments:(id)arg1 toCIImage:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000c450
- (id)predictSlidersForStyleVector:(id)arg1 contentVector:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000b430
- (id)predictContentVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000add0
- (id)predictStyleVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000a290
- (id)initWithModel:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000009540
- (id)initWithModel:(id)arg1;	// IMP=0x0000000000009520
- (unsigned long long)styleFVecSize;	// IMP=0x00000000000094b0
- (unsigned long long)contentFVecSize;	// IMP=0x0000000000009440
