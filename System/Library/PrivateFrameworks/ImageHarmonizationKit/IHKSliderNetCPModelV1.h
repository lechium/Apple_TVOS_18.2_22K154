...
- (id).cxx_construct;	// IMP=0x0000000000019fb0
- (void).cxx_destruct;	// IMP=0x0000000000019e60
...
- (id)applyAdjustments:(id)arg1 toCIImage:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000019af0
- (id)getValueForAdjustment:(id)arg1 adjustments:(id)arg2;	// IMP=0x00000000000199d0
- (id)predictSlidersForStyleVector:(id)arg1 contentVector:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000018140
- (struct EspressoTensor)newTensorWithCorrectShape:(struct EspressoTensor)arg1 shape:(id)arg2;	// IMP=0x0000000000017d70
- (id)predictContentVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000176e0
- (id)predictStyleVectorForPixelBuffer:(struct __CVBuffer *)arg1 scenePrint:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000017080
- (id)initWithModel:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000015790
- (id)initWithModel:(id)arg1;	// IMP=0x0000000000015770
- (unsigned long long)styleFVecSize;	// IMP=0x0000000000015700
- (unsigned long long)contentFVecSize;	// IMP=0x0000000000015690
