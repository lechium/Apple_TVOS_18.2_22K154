...
- (void).cxx_destruct;	// IMP=0x0000000000066e80
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000066c82
- (unsigned long long)hash;	// IMP=0x0000000000066b84
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000669e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006688b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000066783
- (void)writeTo:(id)arg1;	// IMP=0x0000000000066681
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000066674
- (id)dictionaryRepresentation;	// IMP=0x00000000000660c6
- (id)description;	// IMP=0x0000000000066017
...
- (int)StringAsRequestFlag:(id)arg1;	// IMP=0x0000000000065efb
- (id)requestFlagAsString:(int)arg1;	// IMP=0x0000000000065eb2
