...
- (void).cxx_destruct;	// IMP=0x00000000000627fa
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000062731
- (unsigned long long)hash;	// IMP=0x00000000000626ca
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000625ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000062539
- (void)copyTo:(id)arg1;	// IMP=0x00000000000624b7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000062427
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000006241a
- (id)dictionaryRepresentation;	// IMP=0x0000000000062089
- (id)description;	// IMP=0x0000000000061fda
