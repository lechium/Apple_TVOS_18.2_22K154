...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000571aa
- (unsigned long long)hash;	// IMP=0x0000000000057074
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000056e79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000056cee
- (void)copyTo:(id)arg1;	// IMP=0x0000000000056bb8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000056a6d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000056a60
- (id)dictionaryRepresentation;	// IMP=0x00000000000561e9
- (id)description;	// IMP=0x000000000005613a
...
- (int)StringAsPushPriority:(id)arg1;	// IMP=0x0000000000055fad
- (id)pushPriorityAsString:(int)arg1;	// IMP=0x0000000000055f64
