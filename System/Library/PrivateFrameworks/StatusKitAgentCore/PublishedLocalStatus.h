...
+ (id)identifierKeyPath;	// IMP=0x00400000000105ff
+ (id)predicateForPublishedLocalStatusIdentifiers:(id)arg1;	// IMP=0x004000000001060c
+ (id)fetchRequest;	// IMP=0x004000000008a256
