...
- (void).cxx_destruct;	// IMP=0x000000000004ce3a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000004cd3a
- (unsigned long long)hash;	// IMP=0x000000000004cca9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004cb97
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004cac4
- (void)copyTo:(id)arg1;	// IMP=0x000000000004ca20
- (void)writeTo:(id)arg1;	// IMP=0x000000000004c971
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000004c964
- (id)dictionaryRepresentation;	// IMP=0x000000000004c44c
- (id)description;	// IMP=0x000000000004c39d
...
- (int)StringAsStatus:(id)arg1;	// IMP=0x000000000004c1a3
- (id)statusAsString:(int)arg1;	// IMP=0x000000000004c15a
