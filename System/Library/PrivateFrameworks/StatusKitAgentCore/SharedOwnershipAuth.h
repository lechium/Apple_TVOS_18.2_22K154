...
- (void).cxx_destruct;	// IMP=0x0000000000086457
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000862db
- (unsigned long long)hash;	// IMP=0x000000000008623c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000086104
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000085fec
- (void)copyTo:(id)arg1;	// IMP=0x0000000000085f29
- (void)writeTo:(id)arg1;	// IMP=0x0000000000085e75
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000085e68
- (id)dictionaryRepresentation;	// IMP=0x0000000000085b90
- (id)description;	// IMP=0x0000000000085ae1
