...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000234d
- (void).cxx_destruct;	// IMP=0x0000000000003267
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002c23
- (void)setState:(long long)arg1;	// IMP=0x0000000000002a1b
- (void)setError:(id)arg1;	// IMP=0x0000000000002402
- (id)initWithRole:(long long)arg1;	// IMP=0x0000000000002355
