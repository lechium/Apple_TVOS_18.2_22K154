...
- (void).cxx_destruct;	// IMP=0x000000000005bbcb
...
- (void)systemInfoResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000005ba0d
- (void)pairVerify;	// IMP=0x000000000005b772
- (void)invalidate;	// IMP=0x000000000005b728
