...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000005e6d9
- (void).cxx_destruct;	// IMP=0x000000000005eff1
...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000000005ed52
- (id)description;	// IMP=0x000000000005ed3b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000005eb4c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000005e6e1
- (id)initWithIdentifier:(id)arg1 applicationLabel:(id)arg2 pkData:(id)arg3 bonjourListenerUUID:(id)arg4 isSameAccount:(_Bool)arg5 contactID:(id)arg6 accountID:(id)arg7 forceSingleBandAWDLMode:(_Bool)arg8 knownIdentity:(_Bool)arg9 isUnsupportedApplicationLabel:(_Bool)arg10 flags:(unsigned int)arg11;	// IMP=0x000000000005e542
