...
+ (id)startMessageMetrics:(int)arg1 withParent:(id)arg2;	// IMP=0x0060000000060d11
- (void).cxx_destruct;	// IMP=0x000000000006162d
- (id)_metricsDictionary;	// IMP=0x0000000000061443
@property(readonly, nonatomic) NSString *peerOSVersion; // @synthesize peerOSVersion=_peerOSVersion;
- (void)setPeerOSVersion:(CDStruct_2ec95fd7)arg1;	// IMP=0x00000000000612b2
