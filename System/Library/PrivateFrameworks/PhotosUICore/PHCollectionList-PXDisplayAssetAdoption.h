...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x0010000000c40b77
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x0010000000c3f9ab
+ (id)_isValidGazeRectPredicate;	// IMP=0x0010000000c3f8a2
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x0010000000c3f7da
+ (id)px_transientIdentifierForWellKnownFolderName:(id)arg1;	// IMP=0x0010000000c3f76e
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0010000000c3e1d8
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x0010000000c3e0af
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000000c3dce6
- (id)px_navigationWellKnownName;	// IMP=0x0010000000c3dc70
- (id)px_navigationURLHost;	// IMP=0x0010000000c3dc63
