...
+ (id)px_fetchAssetCollectionsWithAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x0010000000c41c57
+ (id)px_fetchSmartAlbumCollectionsBySubtypeForAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x0010000000c41877
+ (id)px_fetchContainingCollectionsForAsset:(id)arg1 excludedAssetCollection:(id)arg2;	// IMP=0x0010000000c4176e
+ (id)px_fetchSmartAlbumWithSubtype:(long long)arg1;	// IMP=0x0010000000c41636
+ (id)px_smartAlbumWithSubtype:(long long)arg1;	// IMP=0x0010000000c415e6
+ (id)px_regularAlbumWithTitle:(id)arg1;	// IMP=0x0010000000c414e3
+ (id)px_otherAlbumsSubtypes;	// IMP=0x0010000000c41480
+ (id)px_mediaTypeSmartAlbumSubtypes;	// IMP=0x0010000000c4141d
+ (void)px_getType:(long long *)arg1 subtype:(long long *)arg2 forBuiltInAlbumName:(id)arg3;	// IMP=0x0010000000c4106c
+ (id)px_builtInAlbumNameForSubtype:(long long)arg1;	// IMP=0x0010000000c40e85
+ (id)px_albumNameForTransientIdentifier:(id)arg1;	// IMP=0x0010000000c40e19
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x0010000000a5c507
...
- (id)px_fetchAncestorThatSupportsExplictlyRemovingAssets;	// IMP=0x0010000000c3f398
- (id)px_fetchAncestorThatSupportsCustomKeyAssets;	// IMP=0x0010000000c3f293
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0010000000c3f210
...
- (id)px_debugDictionary;	// IMP=0x0010000000c3e89f
- (id)px_navigationURLComponents;	// IMP=0x0010000000c3e772
- (id)px_navigationWellKnownName;	// IMP=0x0010000000c3e73d
- (id)px_navigationURLHost;	// IMP=0x0010000000c3e730
- (unsigned long long)px_assetsDropMode;	// IMP=0x0010000000c3e646
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000000c3e501
