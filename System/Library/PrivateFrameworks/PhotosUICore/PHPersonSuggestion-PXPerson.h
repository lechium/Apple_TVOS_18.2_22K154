...
+ (void)px_loadRepresentativeFacesForPersons:(id)arg1;	// IMP=0x001000000054da81
...
- (int)requestFaceCropImageWithTargetSize:(struct CGSize)arg1 displayScale:(double)arg2 cropFactor:(long long)arg3 style:(long long)arg4 cacheResult:(_Bool)arg5 synchronous:(_Bool)arg6 resultHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000054d47c
