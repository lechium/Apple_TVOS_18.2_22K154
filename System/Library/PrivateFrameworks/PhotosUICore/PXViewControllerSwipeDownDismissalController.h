...
- (void).cxx_destruct;	// IMP=0x0000000000203470
- (id)init;	// IMP=0x0000000000203410
- (void)updateCurrentPlacement;	// IMP=0x00000000002033e0
- (void)updateSwipeDownTracker;	// IMP=0x0000000000202860
- (void)updateInitialPlacement;	// IMP=0x00000000002014b0
- (void)setNeedsUpdate;	// IMP=0x0000000000201480
