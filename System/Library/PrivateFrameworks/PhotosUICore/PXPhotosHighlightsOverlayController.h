...
- (void).cxx_destruct;	// IMP=0x00000000004449f0
- (id)init;	// IMP=0x0000000000444990
- (_Bool)canHandleObjectReference:(id)arg1;	// IMP=0x00000000004445d0
- (void)handleTapWithHitTestResult:(id)arg1;	// IMP=0x0000000000444550
...
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0000000000442f90
