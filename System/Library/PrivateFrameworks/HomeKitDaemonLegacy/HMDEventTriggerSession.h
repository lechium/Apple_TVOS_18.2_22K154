...
+ (id)logCategory;	// IMP=0x001000000053fdb8
- (void).cxx_destruct;	// IMP=0x000000000053fd34
...
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 target:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000000053f9b9
- (_Bool)sendMessage:(id)arg1 payload:(id)arg2 device:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000053f8ed
- (_Bool)sendResidentMessage:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000053f7be
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (id)logIdentifier;	// IMP=0x000000000053f788
@property(readonly, copy) NSString *description;
- (id)dumpState;	// IMP=0x000000000053f614
- (void)_registerForMessages;	// IMP=0x000000000053f60e
- (void)dealloc;	// IMP=0x000000000053f456
- (id)initWithSessionID:(id)arg1 eventTrigger:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x000000000053f22a
