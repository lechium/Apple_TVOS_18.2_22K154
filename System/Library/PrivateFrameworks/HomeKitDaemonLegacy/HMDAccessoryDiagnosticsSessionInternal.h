...
+ (id)logCategory;	// IMP=0x00100000003a8557
- (void).cxx_destruct;	// IMP=0x00000000003a8517
...
- (id)logIdentifier;	// IMP=0x00000000003a842d
- (void)setUpWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000003a8369
- (void)shutDown;	// IMP=0x00000000003a82c1
- (id)attributeDescriptions;	// IMP=0x00000000003a81f5
- (id)initWithAccessory:(id)arg1;	// IMP=0x00000000003a8143
