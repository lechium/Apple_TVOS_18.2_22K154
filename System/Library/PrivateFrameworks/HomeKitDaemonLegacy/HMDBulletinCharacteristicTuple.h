...
+ (id)tupleWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x006000000003cd17
- (void).cxx_destruct;	// IMP=0x000000000003ccb3
...
- (void)updatePostingTime;	// IMP=0x000000000003cbe7
- (id)initWithServiceContextID:(id)arg1 currentType:(id)arg2 targetValue:(id)arg3 targetStateNumber:(id)arg4 changedByThisDevice:(_Bool)arg5;	// IMP=0x000000000003caa4
