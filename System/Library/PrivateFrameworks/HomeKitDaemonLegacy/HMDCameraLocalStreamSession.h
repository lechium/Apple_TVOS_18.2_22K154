...
+ (id)logCategory;	// IMP=0x00100000009fac24
- (void).cxx_destruct;	// IMP=0x00000000009fab8b
...
- (id)logIdentifier;	// IMP=0x00000000009faac6
@property(readonly, copy) NSString *stateDescription;
- (_Bool)containsState:(long long)arg1;	// IMP=0x00000000009fa9c0
- (void)updateState:(long long)arg1;	// IMP=0x00000000009fa859
- (id)initWithSessionID:(id)arg1 reachabilityPath:(unsigned long long)arg2 streamSender:(id)arg3 remoteCapabilities:(id)arg4 localNetworkConfig:(id)arg5 streamPreference:(id)arg6;	// IMP=0x00000000009fa6f5
