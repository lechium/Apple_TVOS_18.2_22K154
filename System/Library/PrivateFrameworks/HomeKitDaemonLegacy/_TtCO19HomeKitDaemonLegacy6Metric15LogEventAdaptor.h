...
- (void).cxx_destruct;	// IMP=0x0000000000020850
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x00000000000207c0
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000020760
