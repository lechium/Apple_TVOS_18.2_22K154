...
- (void).cxx_destruct;	// IMP=0x00000000003532c2
@property __weak id <HMDAccessorySettingsBackingStoreTransactionReceiverDelegate> delegate; // @synthesize delegate=_delegate;
- (void)transactionObjectRemoved:(id)arg1 message:(id)arg2;	// IMP=0x0000000000352f7b
- (void)transactionObjectUpdated:(id)arg1 newValues:(id)arg2 message:(id)arg3;	// IMP=0x0000000000352c61
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000352bfa
