...
+ (id)logCategory;	// IMP=0x00100000006a08fb
- (void).cxx_destruct;	// IMP=0x00000000006a08aa
...
- (void)resetConfig;	// IMP=0x00000000006a068f
- (void)beginPairingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000006a0557
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000006a03e6
