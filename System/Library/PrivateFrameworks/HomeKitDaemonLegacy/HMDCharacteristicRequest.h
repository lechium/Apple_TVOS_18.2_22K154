...
+ (id)logCategory;	// IMP=0x0010000000bb80db
+ (id)requestWithCharacteristic:(id)arg1;	// IMP=0x0010000000bb8092
- (void).cxx_destruct;	// IMP=0x0000000000bb8061
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bb7f0c
@property(readonly, nonatomic) HMDHAPAccessory *accessory;
@property(readonly, nonatomic) HMDService *service;
- (id)attributeDescriptions;	// IMP=0x0000000000bb79d6
- (id)initWithCharacteristic:(id)arg1;	// IMP=0x0000000000bb793b
