...
+ (id)logCategory;	// IMP=0x00100000009fe731
- (void).cxx_destruct;	// IMP=0x00000000009fd796
...
- (id)logIdentifier;	// IMP=0x00000000009fd5b2
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000009fd3ee
- (void)_dispatchNotificationUpdate:(id)arg1;	// IMP=0x00000000009fc73b
- (void)_dispatchNotification;	// IMP=0x00000000009fc4fd
- (void)_beginCoalesce:(_Bool)arg1;	// IMP=0x00000000009fc0a8
- (void)sendNotificationForMediaProperties:(id)arg1 withRequestIdentifier:(id)arg2 notificationUpdateIdentifier:(id)arg3;	// IMP=0x00000000009fbcf0
- (id)_notificationUpdateWithRequestID:(id)arg1 allowAdd:(_Bool)arg2;	// IMP=0x00000000009fbac8
- (void)sendCoalescedRemoteNotificationForAccessories:(id)arg1;	// IMP=0x00000000009fb823
- (void)sendNotificationForCharacteristicUpdates:(id)arg1 withRequestIdentifier:(id)arg2 notificationUpdateIdentifier:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00000000009fb031
- (id)initWithDestination:(id)arg1 watchDevice:(_Bool)arg2 withRequestIdentifier:(id)arg3 messageDispatcher:(id)arg4 home:(id)arg5 dataSource:(id)arg6;	// IMP=0x00000000009faed1
- (id)initWithDestination:(id)arg1 watchDevice:(_Bool)arg2 withRequestIdentifier:(id)arg3 messageDispatcher:(id)arg4 home:(id)arg5;	// IMP=0x00000000009fadec
