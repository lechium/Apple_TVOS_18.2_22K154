...
+ (id)logCategory;	// IMP=0x00100000006205f2
+ (id)_streamingStatusForResponse:(id)arg1;	// IMP=0x0010000000620261
- (void).cxx_destruct;	// IMP=0x000000000061fd3c
...
- (void)_callDidCompleteReadDelegateCallback;	// IMP=0x000000000061fbc3
- (id)_inUseStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x000000000061f9f3
- (id)_availableStreamControlMessageHandlersForReadResponses:(id)arg1;	// IMP=0x000000000061f823
- (void)_handleStreamStatusMultireadResponse:(id)arg1;	// IMP=0x000000000061f251
- (void)readSetting;	// IMP=0x000000000061ed38
- (void)handleMessage:(id)arg1;	// IMP=0x000000000061e8c8
- (_Bool)hasPendingNegotiateMessageForSessionWithIdentifier:(id)arg1;	// IMP=0x000000000061e7f2
- (id)initWithWorkQueue:(id)arg1 sessionID:(id)arg2 accessory:(id)arg3 message:(id)arg4 streamControlMessageHandlers:(id)arg5 streamPreferences:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x000000000061e5bf
