...
- (void).cxx_destruct;	// IMP=0x00000000004a4a78
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004a4854
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004a4849
- (unsigned long long)hash;	// IMP=0x00000000004a4726
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004a44a5
- (id)attributeDescriptions;	// IMP=0x00000000004a4183
- (id)init;	// IMP=0x00000000004a4079
