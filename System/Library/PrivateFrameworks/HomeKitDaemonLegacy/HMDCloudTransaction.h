...
+ (id)shortDescription;	// IMP=0x0060000000af10c9
- (void).cxx_destruct;	// IMP=0x0000000000af1034
...
- (id)replayTransaction:(id)arg1 stagedTransaction:(id)arg2;	// IMP=0x0000000000af0ac1
- (void)loadObjectChanges;	// IMP=0x0000000000af0a9e
- (id)changeWithRecordName:(id)arg1;	// IMP=0x0000000000af0a24
- (id)changeWithObjectID:(id)arg1;	// IMP=0x0000000000af09aa
...
- (void)updateCloudCache;	// IMP=0x0000000000af077a
- (void)setDeleteAsProcessedWithRecordID:(id)arg1;	// IMP=0x0000000000af0711
- (void)resetRecordWithRecordID:(id)arg1;	// IMP=0x0000000000af06a8
- (void)setSaveAsProcessedWithRecord:(id)arg1;	// IMP=0x0000000000af063f
- (void)fetchBatchToUpload:(CDUnknownBlockType)arg1;	// IMP=0x0000000000af05d6
- (_Bool)moreChangesToProcess;	// IMP=0x0000000000af0592
- (void)setAllChangedAsProcessed;	// IMP=0x0000000000af0555
- (void)loadCloudRecordsAndDetermineDeletesFromCache:(CDUnknownBlockType)arg1;	// IMP=0x0000000000af03b1
- (void)cachedCloudRecordWithObjectID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000af0326
- (id)cachedCloudRecordWithObjectID:(id)arg1;	// IMP=0x0000000000af02ac
@property(readonly) _Bool doRecordsExistInCache;
- (_Bool)doesRecordExistInCacheWithObjectID:(id)arg1;	// IMP=0x0000000000af01fa
- (_Bool)doesRecordExistWithObjectID:(id)arg1;	// IMP=0x0000000000af018c
@property(readonly, nonatomic) _Bool hasValidChanges;
- (void)removeChangeWithObjectID:(id)arg1;	// IMP=0x0000000000af00df
- (void)addChangeWithDeletedRecordID:(id)arg1;	// IMP=0x0000000000af0076
- (void)addChangeWithRecord:(id)arg1;	// IMP=0x0000000000af000d
- (void)addChangeWithObjectChange:(id)arg1;	// IMP=0x0000000000aeffa4
...
- (id)description;	// IMP=0x0000000000aefcc7
- (id)shortDescription;	// IMP=0x0000000000aefbd6
- (void)updateCloudZone:(id)arg1;	// IMP=0x0000000000aefb4f
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2 noLocalData:(_Bool)arg3;	// IMP=0x0000000000aefaac
- (id)initWithType:(unsigned long long)arg1 temporaryCache:(_Bool)arg2;	// IMP=0x0000000000aefa97
- (id)init;	// IMP=0x0000000000aef9ef
