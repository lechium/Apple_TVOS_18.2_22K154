...
- (void).cxx_destruct;	// IMP=0x0000000000656a74
...
- (void)configure;	// IMP=0x00000000006567eb
- (void)dealloc;	// IMP=0x0000000000656793
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x00000000006566bb
- (id)initWithWorkQueue:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x0000000000656635
