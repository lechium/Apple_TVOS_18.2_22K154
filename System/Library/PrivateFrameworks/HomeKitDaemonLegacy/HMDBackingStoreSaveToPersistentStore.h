...
- (void).cxx_destruct;	// IMP=0x00000000009e59e7
...
- (id)mainReturningError;	// IMP=0x00000000009e5832
- (id)initWithHomeManager:(id)arg1 reason:(id)arg2 incrementGeneration:(_Bool)arg3;	// IMP=0x00000000009e576e
