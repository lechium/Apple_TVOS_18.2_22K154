...
- (void).cxx_destruct;	// IMP=0x00000000002508a7
...
- (id)description;	// IMP=0x00000000002506ad
- (id)initWithName:(id)arg1 readHAPCharacteristic:(id)arg2 writeHAPCharacteristic:(id)arg3 format:(id)arg4;	// IMP=0x000000000025050f
- (id)init;	// IMP=0x0000000000250467
