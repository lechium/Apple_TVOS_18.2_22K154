...
- (void).cxx_destruct;	// IMP=0x000000000075da9b
...
- (id)initWithSessionID:(id)arg1 cameraAccessory:(id)arg2 isLocal:(_Bool)arg3 snapshotForNotification:(_Bool)arg4;	// IMP=0x000000000075da23
