...
- (void).cxx_destruct;	// IMP=0x00000000002a96c7
...
- (void)logRateTrigger:(id)arg1 triggerValue:(unsigned long long)arg2;	// IMP=0x00000000002a931a
- (void)updatedCounter:(id)arg1 fromOldValue:(long long)arg2 toNewValue:(long long)arg3;	// IMP=0x00000000002a8f7f
- (void)dealloc;	// IMP=0x00000000002a8f45
- (id)initWithThreshold:(long long)arg1 windowSize:(long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 ewsLogger:(id)arg5 timeSourceBlock:(CDUnknownBlockType)arg6;	// IMP=0x00000000002a8e2d
- (id)initWithThreshold:(long long)arg1 windowSize:(long long)arg2 counterName:(id)arg3 uploadImmediately:(_Bool)arg4 ewsLogger:(id)arg5;	// IMP=0x00000000002a8e0b
- (id)initWithThreshold:(long long)arg1 windowSize:(long long)arg2 counterName:(id)arg3 ewsLogger:(id)arg4;	// IMP=0x00000000002a8de9
