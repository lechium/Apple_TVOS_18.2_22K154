...
+ (void)__unregisterActivity:(id)arg1;	// IMP=0x001000000076cc8e
+ (id)logCategory;	// IMP=0x001000000076cc5e
- (void).cxx_destruct;	// IMP=0x000000000076c672
...
- (void)stop;	// IMP=0x000000000076c4f9
- (void)start;	// IMP=0x000000000076c44b
- (void)__transitionActivity:(id)arg1 state:(long long)arg2;	// IMP=0x000000000076c282
- (void)__unregisterActivity;	// IMP=0x000000000076c13e
- (void)__runActivity:(id)arg1;	// IMP=0x000000000076bd50
- (void)__checkInActivity:(id)arg1;	// IMP=0x000000000076b8e5
- (void)__registerActivity;	// IMP=0x000000000076b707
- (id)__initialCriteria;	// IMP=0x000000000076b5fd
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000076b3b3
- (id)initWithIdentifier:(id)arg1 interval:(double)arg2 retryInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x000000000076b2c8
