...
- (void).cxx_destruct;	// IMP=0x000000000004f811
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004f4f5
- (id)description;	// IMP=0x000000000004f3dd
- (id)initWithUser:(id)arg1 presenceAuthStatus:(id)arg2 presenceComputeStatus:(id)arg3 presenceRegion:(id)arg4 reason:(id)arg5;	// IMP=0x000000000004f2c7
