...
- (id)initWithReason:(long long)arg1 currentMemoryUsage:(unsigned long long)arg2 intervalMaxMemoryUsage:(unsigned long long)arg3;	// IMP=0x0000000000a2b5f8
- (id)init;	// IMP=0x0000000000a2b550
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000bbd274
