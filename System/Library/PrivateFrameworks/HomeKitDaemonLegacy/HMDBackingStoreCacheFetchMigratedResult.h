...
- (void).cxx_destruct;	// IMP=0x0000000000241a48
...
- (id)mainReturningError;	// IMP=0x00000000002413ff
- (id)initWithGroup:(id)arg1 update:(_Bool)arg2 migration:(_Bool)arg3 fetchResult:(CDUnknownBlockType)arg4;	// IMP=0x0000000000241324
