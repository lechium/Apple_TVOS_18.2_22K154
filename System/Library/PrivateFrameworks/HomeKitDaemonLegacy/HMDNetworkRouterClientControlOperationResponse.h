...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000514974
- (void).cxx_destruct;	// IMP=0x000000000051494c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000051465a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005145cc
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000514303
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000513fd1
- (id)initWithStatus:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000513f38
- (id)init;	// IMP=0x0000000000513f09
