...
+ (id)logCategory;	// IMP=0x001000000075cc35
- (void).cxx_destruct;	// IMP=0x000000000075c65d
...
- (void)_drainVariantFragmentQueue;	// IMP=0x000000000075c09f
- (void)handleVariantFragment:(id)arg1;	// IMP=0x000000000075bd40
- (void)handleFullFragment:(id)arg1;	// IMP=0x000000000075bc4c
@property(readonly) _Bool expectsVariantFragment;
- (id)initWithLogIdentifier:(id)arg1;	// IMP=0x000000000075bb2b
