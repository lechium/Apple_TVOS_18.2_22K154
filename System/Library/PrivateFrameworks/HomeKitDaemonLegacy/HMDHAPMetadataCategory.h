...
- (void).cxx_destruct;	// IMP=0x0000000000250414
...
- (id)initWithIdentifier:(id)arg1 uuid:(id)arg2 name:(id)arg3 description:(id)arg4;	// IMP=0x000000000025014c
- (id)init;	// IMP=0x00000000002500a4
