...
- (void).cxx_destruct;	// IMP=0x00000000006c512a
...
- (void)dealloc;	// IMP=0x00000000006c507c
- (id)initWithStreamTracker:(id)arg1 streamIdentifier:(id)arg2;	// IMP=0x00000000006c4fe1
