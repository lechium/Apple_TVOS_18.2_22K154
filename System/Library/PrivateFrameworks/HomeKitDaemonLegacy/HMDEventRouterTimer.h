...
- (void).cxx_destruct;	// IMP=0x0000000000bb56d3
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000bb5628
- (void)suspend;	// IMP=0x0000000000bb55eb
- (void)resume;	// IMP=0x0000000000bb55ae
- (id)initWithQueue:(id)arg1 interval:(double)arg2 timerFireHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000bb54bd
