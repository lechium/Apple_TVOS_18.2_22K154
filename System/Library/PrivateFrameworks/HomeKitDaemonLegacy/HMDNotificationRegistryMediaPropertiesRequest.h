...
- (void).cxx_destruct;	// IMP=0x0000000000754172
...
- (id)attributeDescriptions;	// IMP=0x0000000000753f6f
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 mediaProfileUUID:(id)arg3;	// IMP=0x0000000000753e68
