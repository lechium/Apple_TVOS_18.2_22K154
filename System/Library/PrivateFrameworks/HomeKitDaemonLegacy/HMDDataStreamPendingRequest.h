...
- (void).cxx_destruct;	// IMP=0x000000000033f25e
...
- (unsigned long long)hash;	// IMP=0x000000000033f1e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033f113
- (id)initWithIdentifier:(id)arg1 protocol:(id)arg2 topic:(id)arg3 payload:(id)arg4 callback:(CDUnknownBlockType)arg5;	// IMP=0x000000000033f00e
