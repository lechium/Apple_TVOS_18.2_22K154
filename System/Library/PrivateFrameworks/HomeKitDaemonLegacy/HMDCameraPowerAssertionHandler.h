...
+ (id)logCategory;	// IMP=0x00100000007dea3f
+ (id)sharedHandler;	// IMP=0x00100000007dea0f
- (void).cxx_destruct;	// IMP=0x00000000007de25a
...
- (void)deregisterRemoteRequestHandler:(id)arg1;	// IMP=0x00000000007de160
- (void)registerRemoteRequestHandler:(id)arg1 forSessionID:(id)arg2;	// IMP=0x00000000007de082
- (id)init;	// IMP=0x00000000007ddf8c
