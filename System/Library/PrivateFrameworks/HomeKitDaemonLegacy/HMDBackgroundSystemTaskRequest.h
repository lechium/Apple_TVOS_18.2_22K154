...
- (void).cxx_destruct;	// IMP=0x000000000031d321
...
- (id)attributeDescriptions;	// IMP=0x000000000031d1b7
@property(readonly) BGRepeatingSystemTaskRequest *taskRequest;
- (id)initWithTaskRequest:(id)arg1;	// IMP=0x000000000031cfe0
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000031cf72
