...
- (void).cxx_destruct;	// IMP=0x00000000000204b0
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000020420
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000020320
...
- (id)initWithHome:(id)arg1 nodeId:(unsigned long long)arg2 endpointId:(id)arg3 clusterId:(id)arg4 commandId:(id)arg5 fields:(id)arg6 source:(unsigned long long)arg7;	// IMP=0x000000000001ff40
...
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x000000000001e000
