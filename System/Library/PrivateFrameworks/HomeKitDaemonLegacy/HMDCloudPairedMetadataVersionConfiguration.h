...
+ (id)logCategory;	// IMP=0x0010000000869dd9
- (void).cxx_destruct;	// IMP=0x0000000000869da8
...
- (id)attributeDescriptions;	// IMP=0x0000000000869ba1
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x00000000008696de
- (id)initWithAccessoryIdentifier:(id)arg1 diagnostics:(id)arg2;	// IMP=0x000000000086962d
