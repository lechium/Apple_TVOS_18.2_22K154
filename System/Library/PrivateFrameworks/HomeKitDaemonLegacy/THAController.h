...
+ (id)selectButtonConfiguration:(id)arg1 supportsSiri:(_Bool)arg2;	// IMP=0x006000000076d116
- (void).cxx_destruct;	// IMP=0x000000000076d0ee
...
- (_Bool)dispatchButtonEvent:(id)arg1;	// IMP=0x000000000076d02a
- (void)updateSelectedButtons:(id)arg1;	// IMP=0x000000000076d018
- (id)initWithName:(id)arg1 identifier:(unsigned int)arg2 ticksPerSecond:(unsigned long long)arg3 supportedButtons:(id)arg4 supportsSiri:(_Bool)arg5;	// IMP=0x000000000076cf2d
