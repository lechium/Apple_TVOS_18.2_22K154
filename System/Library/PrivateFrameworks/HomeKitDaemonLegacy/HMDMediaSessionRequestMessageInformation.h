...
+ (id)logCategory;	// IMP=0x001000000067a0fe
- (void).cxx_destruct;	// IMP=0x000000000067a0eb
@property(readonly) HMFMessage *message; // @synthesize message=_message;
- (id)attributeDescriptions;	// IMP=0x0000000000679fb7
@property(readonly) HMDDevice *remoteSourceDevice;
@property(readonly, copy) NSUUID *messageIdentifier;
- (id)initWithMessage:(id)arg1;	// IMP=0x0000000000679df5
