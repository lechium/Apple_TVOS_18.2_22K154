...
@interface HMDHomePresenceBase : HMFObject
{
    ...
    NSUUID *_presenceMonitorMessageTargetUUID;	// 32 = 0x20
    HMFMessageDispatcher *_msgDispatcher;	// 40 = 0x28
    HMDNotificationRegistration *_notificationRegistration;	// 48 = 0x30
}

+ (id)logCategory;	// IMP=0x00100000006c3d77
+ (id)messageTargetUUIDFromHomeUUID:(id)arg1;	// IMP=0x00100000006c3cad
- (void).cxx_destruct;	// IMP=0x00000000006c4194
...
- (id)logIdentifier;	// IMP=0x00000000006c408c
- (void)residentChanged;	// IMP=0x00000000006c4086
- (void)handleHomeDataLoadedNotification:(id)arg1;	// IMP=0x00000000006c4080
- (void)_registerForMessages;	// IMP=0x00000000006c4032
- (void)configure:(id)arg1 messageDispatcher:(id)arg2;	// IMP=0x00000000006c3fc2
- (void)_initialize:(id)arg1;	// IMP=0x00000000006c3dde
