...
- (void).cxx_destruct;	// IMP=0x00000000008ddd56
...
- (_Bool)matchesAccessoryServer:(id)arg1;	// IMP=0x00000000008dd9bf
- (_Bool)matchesUnpairedAccessory:(id)arg1;	// IMP=0x00000000008dd8ec
- (id)description;	// IMP=0x00000000008dd70b
- (id)initWithAccessoryDescription:(id)arg1 linkType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3 progressHandler:(CDUnknownBlockType)arg4 pairingRequest:(id)arg5;	// IMP=0x00000000008dd483
- (id)initWithAccessoryUUID:(id)arg1 accessoryName:(id)arg2 linkType:(long long)arg3 setupCode:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 setupCodeProvider:(CDUnknownBlockType)arg6 pairingRequest:(id)arg7;	// IMP=0x00000000008dd2e9
