...
- (void).cxx_destruct;	// IMP=0x00000000007af031
...
- (id)initWithApplicationID:(id)arg1 preferencesKey:(id)arg2 preferencesSize:(unsigned long long)arg3 eventTrigger:(unsigned long long)arg4;	// IMP=0x00000000007aed9a
