...
+ (id)logCategory;	// IMP=0x001000000060e3dc
+ (id)timeToLiveHeaderKey;	// IMP=0x001000000060e3cf
+ (id)requestStartTimeHeaderKey;	// IMP=0x001000000060e3c2
- (void).cxx_destruct;	// IMP=0x0000000000608cdd
...
- (void)configureWithHomeMembershipVerifier:(id)arg1;	// IMP=0x0000000000608b4c
- (void)transport:(id)arg1 idsIdentifier:(id)arg2 didAppearReachable:(_Bool)arg3;	// IMP=0x0000000000608ad5
- (void)messageTransport:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00000000006089f7
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000608748
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x0000000000608590
- (id)start;	// IMP=0x000000000060832e
- (long long)qualityOfService;	// IMP=0x0000000000608323
- (_Bool)isSecure;	// IMP=0x000000000060831b
- (id)initWithAccountRegistry:(id)arg1 rapportTransport:(id)arg2 idsTransport:(id)arg3 contextManager:(id)arg4 systemDateProvider:(id)arg5 idsDateProvider:(id)arg6 timerProvider:(id)arg7 isWatch:(_Bool)arg8;	// IMP=0x00000000006080c8
- (id)initWithAccountRegistry:(id)arg1;	// IMP=0x0000000000607fa3
