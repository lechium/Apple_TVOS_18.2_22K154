...
- (void).cxx_destruct;	// IMP=0x000000000092095e
...
- (void)_updateSaveOptions:(_Bool)arg1 reason:(id)arg2;	// IMP=0x00000000009208b5
- (id)initWithReason:(id)arg1 information:(id)arg2 saveOptions:(unsigned long long)arg3;	// IMP=0x000000000092088d
- (id)initWithReason:(id)arg1 information:(id)arg2 postSyncNotification:(_Bool)arg3;	// IMP=0x0000000000920860
- (id)initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5;	// IMP=0x00000000009207d9
- (id)_initWithHome:(id)arg1 reason:(id)arg2 information:(id)arg3 postSyncNotification:(_Bool)arg4 objectChange:(_Bool)arg5 saveOptions:(unsigned long long)arg6;	// IMP=0x00000000009206cf
