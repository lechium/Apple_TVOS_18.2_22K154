...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000062dbbc
- (void).cxx_destruct;	// IMP=0x000000000062db7a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000062da64
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000062d93f
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000062d752
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x000000000062d39f
- (id)initWithGeneralConfiguration:(id)arg1 videoCodecConfiguration:(id)arg2 audioCodecConfiguration:(id)arg3;	// IMP=0x000000000062d2d5
