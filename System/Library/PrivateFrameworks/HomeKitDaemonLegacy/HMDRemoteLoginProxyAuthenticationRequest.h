...
+ (id)messageName;	// IMP=0x00100000003aa8fc
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003aa8f4
+ (id)objWithMessage:(id)arg1;	// IMP=0x00100000003aa733
+ (id)objWithDict:(id)arg1;	// IMP=0x00100000003aa58c
- (void).cxx_destruct;	// IMP=0x00000000003aa539
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003aa344
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003aa209
