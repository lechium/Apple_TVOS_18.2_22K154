...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000005005e9
- (void).cxx_destruct;	// IMP=0x00000000005005b6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005001d6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000050011e
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000004ffd62
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004ff989
- (id)initWithClientIdentifier:(id)arg1 lastViolationTimestamp:(id)arg2 lastResetTimestamp:(id)arg3;	// IMP=0x00000000004ff8d1
- (id)init;	// IMP=0x00000000004ff8a2
