...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000a22d8d
- (void).cxx_destruct;	// IMP=0x0000000000a22d03
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000a22bde
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000a22ae2
- (id)description;	// IMP=0x0000000000a229b7
- (id)initWithLocation:(id)arg1 locationUpdateTimestamp:(id)arg2 locationSource:(id)arg3;	// IMP=0x0000000000a228ed
