...
- (void).cxx_destruct;	// IMP=0x000000000033f3bc
...
- (id)initWithProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000033f2a7
