...
+ (_Bool)isNewBetter:(unsigned long long)arg1 present:(unsigned long long)arg2;	// IMP=0x0060000000a4290f
- (void).cxx_destruct;	// IMP=0x0000000000a428cd
...
- (id)description;	// IMP=0x0000000000a42832
- (void)dealloc;	// IMP=0x0000000000a42793
- (_Bool)removeSync;	// IMP=0x0000000000a425c2
- (void)addNewSync:(id)arg1;	// IMP=0x0000000000a41f90
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, nonatomic) HMDWatchSync *currentSync;
- (id)initWithDeviceId:(id)arg1 pairedSync:(id)arg2;	// IMP=0x0000000000a41deb
