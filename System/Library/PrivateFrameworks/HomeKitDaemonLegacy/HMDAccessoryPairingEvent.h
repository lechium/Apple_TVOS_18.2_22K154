...
+ (id)logCategory;	// IMP=0x001000000055fa03
+ (id)removingAccessory:(id)arg1 hapAccessory:(id)arg2;	// IMP=0x001000000055f929
+ (id)pairingAccessory:(id)arg1 home:(id)arg2 appIdentifier:(id)arg3 retry:(_Bool)arg4;	// IMP=0x001000000055f853
+ (id)pairingAccessoryWithDescription:(id)arg1 home:(id)arg2;	// IMP=0x001000000055f7e1
- (void).cxx_destruct;	// IMP=0x000000000055f5c2
...
- (id)residentConfirmationToString:(long long)arg1;	// IMP=0x000000000055ee10
- (void)updateResidentConfirmationDurationWithConfirmation:(long long)arg1;	// IMP=0x000000000055ed86
@property(readonly, nonatomic) unsigned long long coreAnalyticsEventOptions;
@property(readonly, copy, nonatomic) NSDictionary *coreAnalyticsEventDictionary;
@property(readonly, copy, nonatomic) NSString *coreAnalyticsEventName;
- (void)prepareForObservation;	// IMP=0x000000000055cd3e
@property(readonly) NSDate *endDate; // @synthesize endDate=_endDate;
- (void)markEndTime;	// IMP=0x000000000055cc58
- (_Bool)_isMatterAccessory;	// IMP=0x000000000055cc43
@property(readonly, nonatomic, getter=isMatterAccessory) _Bool matterAccessory;
- (void)_updateThreadPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x000000000055cb83
- (void)updateEventPropertiesWithHAPAccessory:(id)arg1;	// IMP=0x000000000055c733
- (void)updateEventPropertiesWithPairedAccessory:(id)arg1;	// IMP=0x000000000055c59f
- (void)pairedToServer:(id)arg1 certificationStatus:(long long)arg2 addedViaWAC:(_Bool)arg3 legacyWAC:(_Bool)arg4;	// IMP=0x000000000055c32c
- (void)setAuthenticationMethod:(unsigned long long)arg1;	// IMP=0x000000000055c31a
- (void)setAddedViaWAC:(_Bool)arg1;	// IMP=0x000000000055c308
- (id)initWithAccessoryDescription:(id)arg1 home:(id)arg2;	// IMP=0x000000000055b965
- (id)initWithUnpairedAccessory:(id)arg1 pairedAccessory:(id)arg2 hapAccessory:(id)arg3 appIdentifier:(id)arg4 retry:(_Bool)arg5 home:(id)arg6 isAddOperation:(_Bool)arg7 logEventStateManager:(id)arg8;	// IMP=0x000000000055a939
