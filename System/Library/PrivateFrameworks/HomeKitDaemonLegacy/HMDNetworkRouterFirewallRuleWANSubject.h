...
- (void).cxx_destruct;	// IMP=0x00000000008bb7c8
...
- (id)prettyJSONDictionary;	// IMP=0x00000000008bb59b
- (id)attributeDescriptions;	// IMP=0x00000000008bb41d
- (unsigned long long)hash;	// IMP=0x00000000008bb35c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008bb1a4
- (id)initWithHostnames:(id)arg1 addresses:(id)arg2 addressRange:(id)arg3;	// IMP=0x00000000008bb0ce
