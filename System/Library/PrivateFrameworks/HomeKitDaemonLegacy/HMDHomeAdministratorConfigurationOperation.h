...
+ (id)logCategory;	// IMP=0x001000000075f909
+ (double)timeout;	// IMP=0x001000000075f82b
- (void).cxx_destruct;	// IMP=0x000000000075f396
...
- (id)logIdentifier;	// IMP=0x000000000075f267
- (void)main;	// IMP=0x000000000075edeb
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000000075ec71
