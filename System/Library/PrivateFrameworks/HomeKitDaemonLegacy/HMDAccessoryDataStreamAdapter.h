...
+ (id)logCategory;	// IMP=0x00100000002f21d4
- (void).cxx_destruct;	// IMP=0x00000000002f16a7
...
- (id)logIdentifier;	// IMP=0x00000000002f1505
- (void)accessory:(id)arg1 didCloseDataStreamWithError:(id)arg2;	// IMP=0x00000000002f144d
- (void)accessoryDidStartListening:(id)arg1;	// IMP=0x00000000002f1395
- (void)accessory:(id)arg1 didReceiveBulkSessionCandidate:(id)arg2;	// IMP=0x00000000002f137b
- (void)_bulkSendDidComplete;	// IMP=0x00000000002f12e0
- (void)_bulkSendDidFail;	// IMP=0x00000000002f1245
- (_Bool)_handleFrame:(id)arg1;	// IMP=0x00000000002f11a7
@property(readonly, getter=isSessionOpenInProgress) _Bool sessionOpenInProgress;
- (void)_handleAccessoryDidClose;	// IMP=0x00000000002f0ff4
- (void)_callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000002f0dc8
- (void)callPendingOpenSessionCallbackWithResult:(id)arg1 error:(id)arg2;	// IMP=0x00000000002f0cea
- (void)_openSession;	// IMP=0x00000000002f0b51
- (void)_setUpTransport;	// IMP=0x00000000002f09ed
- (void)readData;	// IMP=0x00000000002f0817
- (void)setUpWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000002f066e
@property(readonly, getter=isBulkSendActive) _Bool bulkSendActive;
- (void)dealloc;	// IMP=0x00000000002f04d5
- (void)shutDown;	// IMP=0x00000000002f032d
- (id)attributeDescriptions;	// IMP=0x00000000002f0142
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 fileType:(id)arg3 metadata:(id)arg4 reason:(id)arg5;	// IMP=0x00000000002f002c
