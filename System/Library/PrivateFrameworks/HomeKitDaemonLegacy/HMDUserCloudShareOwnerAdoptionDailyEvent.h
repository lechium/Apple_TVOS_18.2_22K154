...
- (void).cxx_destruct;	// IMP=0x000000000088c01c
...
- (id)initWithConfigureState:(long long)arg1 isPrimaryResident:(_Bool)arg2 trustStatusCounts:(struct CloudShareTrustManagerTrustStatusCounts)arg3;	// IMP=0x000000000088ba68
