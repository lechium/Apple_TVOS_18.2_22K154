...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x00000000007740a8
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000773d0e
- (id)coreAnalyticsEventName;	// IMP=0x0000000000773d01
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x0000000000773cd2
