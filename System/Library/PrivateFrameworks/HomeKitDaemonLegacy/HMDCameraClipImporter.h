...
+ (id)logCategory;	// IMP=0x001000000095accd
- (void).cxx_destruct;	// IMP=0x00000000009590b5
...
- (id)importClipsWithImportData:(id)arg1;	// IMP=0x00000000009581ab
- (id)initWithLocalZone:(id)arg1 cameraProfileUUID:(id)arg2;	// IMP=0x0000000000958032
