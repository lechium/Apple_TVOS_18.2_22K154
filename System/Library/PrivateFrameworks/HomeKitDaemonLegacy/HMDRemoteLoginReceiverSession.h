...
- (void).cxx_destruct;	// IMP=0x000000000027c510
...
- (id)description;	// IMP=0x000000000027c471
- (void)dealloc;	// IMP=0x000000000027c367
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000027c293
