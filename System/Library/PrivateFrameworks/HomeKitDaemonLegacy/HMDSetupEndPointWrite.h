...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a067f
- (void).cxx_destruct;	// IMP=0x00000000000a062c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a0505
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a0277
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a008a
- (_Bool)_parseFromTLVDataOnFailure;	// IMP=0x000000000009ff97
- (_Bool)_parseFromTLVDataOnSuccess;	// IMP=0x000000000009ff85
- (_Bool)_parseFromTLVDataImpl;	// IMP=0x000000000009fcbb
- (_Bool)_parseFromTLVData;	// IMP=0x000000000009fca9
@property(readonly, copy) NSData *tlvData;
- (id)initWithSessionIdentifier:(id)arg1 address:(id)arg2 videoSrtpParameters:(id)arg3 audioSrtpParameters:(id)arg4;	// IMP=0x000000000009fa02
