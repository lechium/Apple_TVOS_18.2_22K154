...
- (void).cxx_destruct;	// IMP=0x000000000023d581
...
- (id)mainReturningError;	// IMP=0x000000000023d1e8
- (id)initWithGroup:(id)arg1 serverChangeToken:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000023d132
