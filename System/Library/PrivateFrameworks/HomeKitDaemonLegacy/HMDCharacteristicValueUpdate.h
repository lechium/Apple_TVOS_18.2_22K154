...
- (void).cxx_destruct;	// IMP=0x0000000000604d59
...
- (void)setValueUpdatedTime:(id)arg1 stateNumber:(id)arg2;	// IMP=0x0000000000604c3c
- (id)initWithError:(id)arg1;	// IMP=0x0000000000604bce
- (id)initWithValue:(id)arg1 updateIdentifier:(id)arg2 remoteDevice:(id)arg3;	// IMP=0x0000000000604b04
