...
- (void).cxx_destruct;	// IMP=0x0000000000753e37
...
- (id)attributeDescriptions;	// IMP=0x0000000000753c45
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2 accessoryUUID:(id)arg3;	// IMP=0x0000000000753b3e
