...
+ (id)aggregateRemoteCountersLogEventWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 primaryResidentDuration:(double)arg5 count:(id)arg6;	// IMP=0x0010000000585dc8
- (void).cxx_destruct;	// IMP=0x0000000000585d64
...
- (id)initWithMessageName:(id)arg1 deviceType:(id)arg2 transportType:(id)arg3 direction:(id)arg4 primaryResidentDuration:(double)arg5 count:(id)arg6;	// IMP=0x00000000005859d0
