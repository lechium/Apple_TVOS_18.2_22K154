...
- (void).cxx_destruct;	// IMP=0x000000000023da01
...
- (id)mainReturningError;	// IMP=0x000000000023d668
- (id)initWithGroup:(id)arg1 subscription:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000023d5b2
