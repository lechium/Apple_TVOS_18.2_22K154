...
+ (id)logCategory;	// IMP=0x0010000000b91341
- (void).cxx_destruct;	// IMP=0x0000000000b90f08
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000b9087b
- (void)didReceiveCachedEvent:(id)arg1 topic:(id)arg2 source:(id)arg3;	// IMP=0x0000000000b90869
- (void)subscribeToWiFiInfoUpdate;	// IMP=0x0000000000b90659
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000b905bf
