...
+ (id)logCategory;	// IMP=0x00100000004b030f
+ (id)coalescedEventFromHouseholdActivityLogEvents:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x00100000004afd20
- (void).cxx_destruct;	// IMP=0x00000000004afd0d
...
- (id)serializedMetric;	// IMP=0x00000000004af68e
- (id)initWithDictionary:(id)arg1 contributors:(id)arg2;	// IMP=0x00000000004af381
- (id)initPopulatedFromDate:(id)arg1 homeUUID:(id)arg2 contributors:(id)arg3;	// IMP=0x00000000004af1bd
- (id)initWithHomeUUID:(id)arg1 contributors:(id)arg2;	// IMP=0x00000000004af139
