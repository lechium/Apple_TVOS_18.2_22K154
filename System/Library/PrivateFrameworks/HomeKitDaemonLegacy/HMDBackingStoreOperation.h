...
+ (id)logCategory;	// IMP=0x001000000083dae4
- (void).cxx_destruct;	// IMP=0x000000000083da8b
...
- (id)logIdentifier;	// IMP=0x000000000083d9bc
@property(readonly, copy) NSString *description;
- (void)main;	// IMP=0x000000000083d872
- (id)mainReturningError;	// IMP=0x000000000083d86a
- (id)init;	// IMP=0x000000000083d856
- (id)initWithResultBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000083d782
