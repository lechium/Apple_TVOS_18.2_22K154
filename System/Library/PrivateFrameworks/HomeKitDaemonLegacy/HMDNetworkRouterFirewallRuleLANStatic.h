...
+ (id)createWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3 purpose:(unsigned long long)arg4 allowInterAccessoryConnections:(_Bool)arg5 direction:(unsigned char)arg6 requiredForHAPFunctionality:(_Bool)arg7 ruleDictionary:(id)arg8 error:(id *)arg9;	// IMP=0x0060000000bccc85
- (void).cxx_destruct;	// IMP=0x0000000000bccc3f
...
- (id)prettyJSONDictionary;	// IMP=0x0000000000bcc917
- (id)attributeDescriptions;	// IMP=0x0000000000bcc6b1
- (unsigned long long)hash;	// IMP=0x0000000000bcc5fe
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bcc409
- (id)initWithJSONDictionary:(id)arg1 name:(id)arg2 critical:(_Bool)arg3 purpose:(unsigned long long)arg4 allowInterAccessoryConnections:(_Bool)arg5 direction:(unsigned char)arg6 requiredForHAPFunctionality:(_Bool)arg7 transportProtocol:(unsigned char)arg8 ipAddress:(id)arg9 portStart:(unsigned short)arg10 portEnd:(unsigned short)arg11 icmpTypes:(id)arg12;	// IMP=0x0000000000bcc2e5
