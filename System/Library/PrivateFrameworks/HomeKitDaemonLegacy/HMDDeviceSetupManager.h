...
+ (id)sharedManager;	// IMP=0x0060000000971ef4
- (void).cxx_destruct;	// IMP=0x0000000000971ab0
...
- (void)dealloc;	// IMP=0x000000000097187e
- (id)initWithNotificationCenter:(id)arg1 followUpManager:(id)arg2 darwinNotificationProvider:(id)arg3;	// IMP=0x0000000000971554
