...
- (void).cxx_destruct;	// IMP=0x0000000000849bb0
...
- (void)forceRefresh;	// IMP=0x0000000000849aec
- (void)markDeleted;	// IMP=0x0000000000849adb
- (void)markChanged;	// IMP=0x0000000000849aca
- (id)initWithZoneID:(id)arg1;	// IMP=0x0000000000849a13
