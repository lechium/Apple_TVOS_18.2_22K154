...
+ (id)logCategory;	// IMP=0x0010000000535d70
+ (long long)colorTemperatureMiredsFromKelvins:(long long)arg1;	// IMP=0x0010000000535d4d
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000535d45
- (void).cxx_destruct;	// IMP=0x0000000000535c03
...
- (id)transitionPointsWithmillisecondsElapsedSinceStartOfDay:(unsigned long long)arg1;	// IMP=0x0000000000534ff5
- (id)colorTemperatureForBrightness:(long long)arg1 millisecondsElapsedSinceStartOfDay:(unsigned long long)arg2;	// IMP=0x0000000000534e1b
@property(readonly) unsigned long long checksum;
- (id)attributeDescriptions;	// IMP=0x000000000053454e
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000053441f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000534414
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005340d1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000533c8b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000533165
- (id)initWithCurve:(id)arg1 minimumColorTemperature:(long long)arg2 maximumColorTemperature:(long long)arg3;	// IMP=0x0000000000532bf4
- (id)initWithVersion:(unsigned long long)arg1 transitionPoints:(id)arg2 minimumBrightness:(long long)arg3 maximumBrightness:(long long)arg4 minimumColorTemperature:(long long)arg5 maximumColorTemperature:(long long)arg6;	// IMP=0x0000000000532b26
