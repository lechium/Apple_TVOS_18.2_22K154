...
+ (id)broadcastEventFromAccessory:(id)arg1 withExpectedGSN:(_Bool)arg2;	// IMP=0x00600000005a5342
- (void).cxx_destruct;	// IMP=0x00000000005a532f
...
- (id)initBroadcastEventFromAccessory:(id)arg1 withExpectedGSN:(_Bool)arg2;	// IMP=0x00000000005a528f
