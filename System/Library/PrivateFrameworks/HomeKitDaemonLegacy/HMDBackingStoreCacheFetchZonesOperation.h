...
- (void).cxx_destruct;	// IMP=0x000000000023bb0a
@property(copy, nonatomic) CDUnknownBlockType fetchResult; // @synthesize fetchResult=_fetchResult;
- (id)mainReturningError;	// IMP=0x000000000023ba0c
- (id)initWithFetchResult:(CDUnknownBlockType)arg1;	// IMP=0x000000000023b983
