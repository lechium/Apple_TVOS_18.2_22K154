...
- (void).cxx_destruct;	// IMP=0x00000000005dc3f3
...
- (id)description;	// IMP=0x00000000005dc2ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005dc1d7
- (unsigned long long)hash;	// IMP=0x00000000005dc1ba
- (void)dealloc;	// IMP=0x00000000005dc174
...
- (id)initWithOutputDevice:(void *)arg1;	// IMP=0x00000000005dbef0
