...
+ (id)logCategory;	// IMP=0x00100000002a1325
+ (void)_clearAllPendingRequests:(id)arg1 error:(id)arg2;	// IMP=0x00100000002a11f1
+ (void)_clearAllGeneratedRequests:(id)arg1 error:(id)arg2;	// IMP=0x00100000002a0f7d
+ (id)createResponseSubset:(id)arg1 overallError:(id)arg2 readRequest:(id)arg3 error:(id *)arg4;	// IMP=0x00100000002a0508
+ (void)_processResponseForMultireadRequest:(id)arg1 overallError:(id)arg2 response:(id)arg3;	// IMP=0x001000000029ff7d
- (void).cxx_destruct;	// IMP=0x000000000029f393
...
- (id)logIdentifier;	// IMP=0x000000000029f26c
- (void)_processResponse:(id)arg1 overallError:(id)arg2 messageIdentifier:(id)arg3;	// IMP=0x000000000029ed12
- (void)_sendMultipleCharacteristicRead;	// IMP=0x000000000029dd34
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000029dc7c
- (void)redispatchMessage:(id)arg1 target:(id)arg2 responseQueue:(id)arg3;	// IMP=0x000000000029db6c
- (long long)preferredDeviceType;	// IMP=0x000000000029da72
@property(readonly, nonatomic) HMDDevice *preferredDevice;
- (id)deviceForType:(long long)arg1;	// IMP=0x000000000029d9ba
- (_Bool)containsDevice:(id)arg1;	// IMP=0x000000000029d7c9
- (void)removeDeviceForType:(long long)arg1;	// IMP=0x000000000029d5ec
- (void)setDevice:(id)arg1 forType:(long long)arg2;	// IMP=0x000000000029d4f9
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000029d299
- (id)initWithHome:(id)arg1 remoteDispatcher:(id)arg2;	// IMP=0x000000000029d104
