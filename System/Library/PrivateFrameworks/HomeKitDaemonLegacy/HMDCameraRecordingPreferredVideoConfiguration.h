...
- (void).cxx_destruct;	// IMP=0x00000000008141d3
...
- (id)description;	// IMP=0x0000000000814067
- (id)initWithResolution:(long long)arg1 bitRateByFrameRate:(id)arg2 keyFrameInterval:(id)arg3 h264Level:(long long)arg4;	// IMP=0x0000000000813fb9
