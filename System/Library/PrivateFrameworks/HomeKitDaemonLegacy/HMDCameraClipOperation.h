...
+ (id)logCategory;	// IMP=0x001000000031c9fc
+ (id)shortDescription;	// IMP=0x001000000031c9ea
+ (unsigned long long)cameraClipOperationType;	// IMP=0x001000000031c942
- (void).cxx_destruct;	// IMP=0x000000000031c8ab
...
- (void)_markEndDateAndSubmitUploadOperationEvent;	// IMP=0x000000000031c36c
@property(readonly) double executionDuration;
- (id)updateClipModel:(id)arg1;	// IMP=0x000000000031bfff
- (id)fetchClipModel;	// IMP=0x000000000031bd96
- (void)cancelWithError:(id)arg1;	// IMP=0x000000000031bc50
- (void)finish;	// IMP=0x000000000031bb24
- (void)main;	// IMP=0x000000000031baa0
@property(readonly) double queuedDuration;
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2 dataSource:(id)arg3;	// IMP=0x000000000031b71d
- (id)initWithClipModelID:(id)arg1 localZone:(id)arg2;	// IMP=0x000000000031b697
