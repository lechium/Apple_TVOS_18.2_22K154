...
+ (void)configureKeyedArchiverClassMappings;	// IMP=0x00100000004e591e
- (void).cxx_destruct;	// IMP=0x00000000004e57ff
...
- (id)homeWithUUID:(id)arg1;	// IMP=0x00000000004e5361
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004e530d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004e5302
