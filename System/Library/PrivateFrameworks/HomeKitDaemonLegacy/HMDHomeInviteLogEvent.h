...
+ (id)updateWithInvitationState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00100000005e99dc
+ (id)updateWithState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00100000005e99a3
...
- (id)initWithHomeInviteLogEventState:(long long)arg1 isFMFDevice:(_Bool)arg2;	// IMP=0x00000000005e91e5
