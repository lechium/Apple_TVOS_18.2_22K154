...
- (void).cxx_destruct;	// IMP=0x000000000090d591
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x000000000090d4fd
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x000000000090d3ca
- (id)initWithName:(id)arg1;	// IMP=0x000000000090d316
