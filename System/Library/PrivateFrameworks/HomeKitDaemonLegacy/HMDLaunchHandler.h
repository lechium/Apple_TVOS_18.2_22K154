...
+ (id)logCategory;	// IMP=0x00100000008227ad
+ (id)sharedHandler;	// IMP=0x001000000082274a
- (void).cxx_destruct;	// IMP=0x000000000082216d
...
- (void)_setJetsamPriorityElevated:(_Bool)arg1;	// IMP=0x0000000000821ef8
- (void)_updateOrRemoveRelaunchPlist;	// IMP=0x0000000000821975
- (void)deregisterRelaunchClientWithUUID:(id)arg1;	// IMP=0x00000000008218bd
- (void)registerRelaunchClientWithUUID:(id)arg1;	// IMP=0x0000000000821804
- (void)removePersistentRelaunchRegistrationsIfNecessary;	// IMP=0x0000000000821793
- (id)initWithRelaunchPlistFileURL:(id)arg1 fileManager:(id)arg2 jetsamPriorityHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000082163c
- (id)init;	// IMP=0x000000000082159b
