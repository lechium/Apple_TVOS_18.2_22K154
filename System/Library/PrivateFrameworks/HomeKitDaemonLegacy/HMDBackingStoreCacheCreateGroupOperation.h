...
- (void).cxx_destruct;	// IMP=0x000000000023d101
...
- (id)mainReturningError;	// IMP=0x000000000023cdd0
- (id)initWithZone:(id)arg1 owner:(id)arg2 rootRecord:(id)arg3 subscriptionName:(id)arg4 subscription:(id)arg5 creationBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000000023cc8e
