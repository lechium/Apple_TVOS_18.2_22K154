...
- (void).cxx_destruct;	// IMP=0x00000000006c68bb
...
- (id)createSettingModelWithName:(id)arg1 parent:(id)arg2 type:(id)arg3 properties:(id)arg4;	// IMP=0x00000000006c66fe
- (id)createSettingGroupModelWithName:(id)arg1 parent:(id)arg2;	// IMP=0x00000000006c6647
- (id)createSettingRootGroupModelWithParentModelID:(id)arg1;	// IMP=0x00000000006c65c2
- (id)loadMetadata;	// IMP=0x00000000006c639c
- (id)settingValueForValue:(id)arg1 type:(id)arg2 constraintModels:(id)arg3 error:(id *)arg4;	// IMP=0x00000000006c601d
- (id)settingModelForUpdateWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 value:(id)arg3;	// IMP=0x00000000006c5e90
@property(readonly) id <HMDSettingsMessageHandlerProtocol> messageHandler;
- (void)configureWithHome:(id)arg1 messageDispatcher:(id)arg2 backingStoreController:(id)arg3;	// IMP=0x00000000006c5dab
- (id)initWithParentUUID:(id)arg1 logName:(id)arg2 queue:(id)arg3 metadataFileName:(id)arg4 codingKey:(id)arg5 messageHandler:(id)arg6 migrationProvider:(id)arg7;	// IMP=0x00000000006c5d73
- (id)initWithParentUUID:(id)arg1 logName:(id)arg2 queue:(id)arg3 metadataFileName:(id)arg4 codingKey:(id)arg5 messageHandler:(id)arg6 migrationProvider:(id)arg7 keyPathsToPrune:(id)arg8;	// IMP=0x00000000006c5b81
