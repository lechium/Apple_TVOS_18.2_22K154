...
+ (id)sharedInstance;	// IMP=0x00100000004961fd
- (void).cxx_destruct;	// IMP=0x00000000004961ea
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000004960ac
- (struct HMDWatchConnectivityLogEventManagerSnapshot)currentWatchConnectivitySnapshot;	// IMP=0x0000000000496029
- (void)completeCurrentReport;	// IMP=0x0000000000495e8d
- (void)incrementWatchRemovedNotificationCount;	// IMP=0x0000000000495e58
- (void)incrementWatchAddedNotificationCount;	// IMP=0x0000000000495e23
- (id)init;	// IMP=0x0000000000495d7e
