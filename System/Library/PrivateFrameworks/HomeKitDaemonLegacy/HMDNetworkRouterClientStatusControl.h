...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000005196d4
- (void).cxx_destruct;	// IMP=0x0000000000517f15
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000517c23
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000517b95
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000005178cc
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000051759a
- (id)initWithOperation:(id)arg1 clientStatusIdentifierList:(id)arg2;	// IMP=0x0000000000517501
- (id)init;	// IMP=0x00000000005174d2
