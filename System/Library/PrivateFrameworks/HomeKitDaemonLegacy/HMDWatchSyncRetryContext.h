...
+ (id)createWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3;	// IMP=0x001000000023ad69
- (void).cxx_destruct;	// IMP=0x000000000023ad38
...
- (id)attributeDescriptions;	// IMP=0x000000000023ab45
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023ab3a
@property(readonly) double retryInterval;
- (id)initWithWatchIdentifier:(id)arg1 watchSync:(id)arg2 retryAttempt:(long long)arg3 initialRetryInterval:(double)arg4 maximumRetryAttempts:(long long)arg5;	// IMP=0x000000000023a9fc
