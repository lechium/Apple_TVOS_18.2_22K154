...
- (void).cxx_destruct;	// IMP=0x000000000035c1ba
...
- (double)getTimeDurationForLongestProgressState;	// IMP=0x000000000035c097
- (void)updateWithProgressState:(id)arg1 date:(id)arg2;	// IMP=0x000000000035ba0b
- (id)initWithDate:(id)arg1;	// IMP=0x000000000035b986
