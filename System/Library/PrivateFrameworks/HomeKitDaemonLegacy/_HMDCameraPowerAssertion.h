...
- (void).cxx_destruct;	// IMP=0x00000000007ddf5d
...
- (void)dealloc;	// IMP=0x00000000007dde9f
- (id)initWithPowerAssertionHandler:(id)arg1 remoteRequestHandlerSessionID:(id)arg2;	// IMP=0x00000000007dde04
