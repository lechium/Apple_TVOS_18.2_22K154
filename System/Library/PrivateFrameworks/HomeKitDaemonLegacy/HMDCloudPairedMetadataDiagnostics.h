...
+ (id)logCategory;	// IMP=0x00600000007b7e05
- (void).cxx_destruct;	// IMP=0x00000000007b7dc3
...
- (id)attributeDescriptions;	// IMP=0x00000000007b79b9
- (id)initWithAccessoryIdentifier:(id)arg1 privacyPolicyURL:(id)arg2 uploadDestination:(id)arg3 consentVersion:(unsigned long long)arg4 uploadType:(unsigned long long)arg5;	// IMP=0x00000000007b78c0
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x00000000007b747c
