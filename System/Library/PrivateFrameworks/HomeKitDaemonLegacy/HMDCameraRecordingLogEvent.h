...
- (void).cxx_destruct;	// IMP=0x00000000005864ff
...
- (id)attributeDescriptions;	// IMP=0x000000000058631b
@property(readonly, copy) NSUUID *ephemeralCameraID;
- (id)initWithSessionID:(id)arg1 cameraID:(id)arg2 sequenceNumber:(unsigned long long)arg3;	// IMP=0x00000000005861fe
