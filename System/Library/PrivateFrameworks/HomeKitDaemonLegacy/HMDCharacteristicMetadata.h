...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000005329d4
+ (id)characteristicMetadataWithDictionary:(id)arg1;	// IMP=0x00100000005327cd
- (void).cxx_destruct;	// IMP=0x0000000000532736
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005324c6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005322af
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005322a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000531ff8
@property(readonly) unsigned long long hash;
- (id)dictionaryRepresentation;	// IMP=0x0000000000531cf6
- (id)_descriptionDetails;	// IMP=0x0000000000531685
- (id)dumpState;	// IMP=0x0000000000531618
@property(readonly, copy) NSString *description;
- (id)initWithMinimumValue:(id)arg1 maximumValue:(id)arg2 stepValue:(id)arg3 maxLength:(id)arg4 validValues:(id)arg5 format:(id)arg6 units:(id)arg7 manufacturerDescription:(id)arg8;	// IMP=0x000000000053138b
- (id)init;	// IMP=0x00000000005312e3
