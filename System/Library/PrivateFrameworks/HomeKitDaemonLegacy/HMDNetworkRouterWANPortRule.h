...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000511c82
- (void).cxx_destruct;	// IMP=0x0000000000511c2e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000051149f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000051136d
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000510d18
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000051071f
- (id)initWithProtocol:(id)arg1 hostDNSName:(id)arg2 hostIPStart:(id)arg3 hostIPEnd:(id)arg4 hostPortStart:(id)arg5 hostPortEnd:(id)arg6;	// IMP=0x00000000005105f8
- (id)init;	// IMP=0x00000000005105c9
- (void)addTo:(id)arg1;	// IMP=0x00000000004914a9
