...
+ (id)eventWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x00100000003d9409
@property(readonly, nonatomic) struct _HMFRate budgetRate; // @synthesize budgetRate=_budgetRate;
- (id)initWithBudgetRate:(struct _HMFRate)arg1;	// IMP=0x00000000003d939e
- (void)updateDiagnosticReportSignature:(id)arg1;	// IMP=0x0000000000bbd26e
