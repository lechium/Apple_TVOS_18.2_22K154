...
+ (id)__decodeRulesFromNetworkDeclarations:(id)arg1 key:(id)arg2 class:(Class)arg3 required:(_Bool)arg4;	// IMP=0x0010000000b523b2
+ (_Bool)__decodeFullAccessFromNetworkDeclarations:(id)arg1 key:(id)arg2 fullAccess:(_Bool *)arg3;	// IMP=0x0010000000b52207
+ (_Bool)__decodeNetworkDeclarationsFromJSONDictionary:(id)arg1 networkDeclarations:(id *)arg2;	// IMP=0x0010000000b51fb0
+ (id)logCategory;	// IMP=0x0010000000b51f80
- (void).cxx_destruct;	// IMP=0x0000000000b51f03
...
- (id)attributeDescriptions;	// IMP=0x0000000000b515c7
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b511f0
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(id)arg2;	// IMP=0x0000000000b50e9b
- (id)initWithAccessoryIdentifier:(id)arg1 lastModifiedTime:(id)arg2 fullAccessLAN:(_Bool)arg3 lanRules:(id)arg4 fullAccessWAN:(_Bool)arg5 wanRules:(id)arg6;	// IMP=0x0000000000b50d76
