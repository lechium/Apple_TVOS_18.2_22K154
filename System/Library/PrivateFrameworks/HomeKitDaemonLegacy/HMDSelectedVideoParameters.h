...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a33e2
- (void).cxx_destruct;	// IMP=0x00000000000a338f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a3233
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a2f51
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a2d2c
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000a2a41
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodec:(id)arg1 codecParameter:(id)arg2 attribute:(id)arg3 rtpParameter:(id)arg4;	// IMP=0x00000000000a2761
