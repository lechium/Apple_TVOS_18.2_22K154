...
+ (id)logCategory;	// IMP=0x00100000000dea94
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000dea8c
- (void).cxx_destruct;	// IMP=0x00000000000dea17
...
- (id)attributeDescriptions;	// IMP=0x00000000000de525
- (id)logIdentifier;	// IMP=0x00000000000de4b9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000de2ca
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000de025
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ddebf
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000ddab4
- (void)updateHomeModel:(id)arg1;	// IMP=0x00000000000dd8d5
- (_Bool)updateUsingHomeModel:(id)arg1;	// IMP=0x00000000000dcd4d
