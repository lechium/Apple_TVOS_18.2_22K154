...
+ (id)sharedState;	// IMP=0x006000000080248f
- (void).cxx_destruct;	// IMP=0x000000000080247c
- (void)_callDidUpdateReachabilityChangeForCompanion:(_Bool)arg1 forDelegate:(id)arg2;	// IMP=0x000000000080240f
- (void)registerDelegate:(id)arg1;	// IMP=0x0000000000802399
...
- (id)init;	// IMP=0x0000000000801f00
