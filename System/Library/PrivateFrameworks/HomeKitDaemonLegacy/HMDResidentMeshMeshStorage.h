...
- (void).cxx_destruct;	// IMP=0x00000000006f5756
...
- (void)_requestStatus;	// IMP=0x00000000006f5221
- (id)initWithResidentDevice:(id)arg1 owner:(id)arg2;	// IMP=0x00000000006f50de
