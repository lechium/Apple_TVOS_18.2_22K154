...
- (void).cxx_destruct;	// IMP=0x000000000070b7f3
...
- (id)initWithStagedDestinationIdentifier:(id)arg1 isTriggeredOnControllerDevice:(id)arg2 userPrivilege:(id)arg3;	// IMP=0x000000000070b5c9
