...
+ (id)logCategory;	// IMP=0x00600000000ca646
- (void).cxx_destruct;	// IMP=0x00000000000ca549
...
- (void)_generateAllCombinations:(id)arg1;	// IMP=0x00000000000c9e80
- (id)createSelectedAudioParameters;	// IMP=0x00000000000c9a9e
- (id)createSRTPParamters;	// IMP=0x00000000000c9a13
- (_Bool)_selectParametersFromCodec:(id)arg1 bitRateSettings:(id)arg2 sampleRates:(id)arg3 audioChannelCount:(id)arg4;	// IMP=0x00000000000c942e
- (_Bool)selectAudioParameters;	// IMP=0x00000000000c8bc7
- (id)logIdentifier;	// IMP=0x00000000000c8b77
- (id)initWithSessionID:(id)arg1 supportedAudioConfiguration:(id)arg2 supportedRTPConfiguration:(id)arg3 streamingCapabilities:(id)arg4;	// IMP=0x00000000000c89ea
