...
- (void).cxx_destruct;	// IMP=0x00000000004d4fb7
...
- (id)initWithAccessory:(id)arg1 expectedTransport:(id)arg2 homeUUID:(id)arg3 topErrorDomain:(id)arg4 topErrorCode:(long long)arg5 sessionFailureCount:(unsigned long long)arg6;	// IMP=0x00000000004d43ef
- (id)initWithAccessory:(id)arg1 sessionMetric:(id)arg2;	// IMP=0x00000000004d3eeb
