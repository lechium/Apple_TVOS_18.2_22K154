...
+ (id)logCategory;	// IMP=0x0060000000457457
- (void).cxx_destruct;	// IMP=0x0000000000456564
...
- (void)_notifyDelegateWifiInfoUpdated:(id)arg1;	// IMP=0x00000000004562a7
- (void)_postUpdateSoftwareVersionIfDifferent:(id)arg1;	// IMP=0x0000000000456120
- (void)_postUpdateWifiNetworkInfoIfDifferent:(id)arg1;	// IMP=0x0000000000455f61
- (id)currentWifiNetworkInfo;	// IMP=0x0000000000455d90
- (void)handleCurrentNetworkChangedNotification:(id)arg1;	// IMP=0x0000000000455b25
- (void)configure;	// IMP=0x000000000045599d
- (id)initWithQueue:(id)arg1 dataSource:(id)arg2 delegate:(id)arg3 notificationCenter:(id)arg4 wifiManager:(id)arg5;	// IMP=0x000000000045589a
