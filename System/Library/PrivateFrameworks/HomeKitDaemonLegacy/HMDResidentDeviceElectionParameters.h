...
- (void).cxx_destruct;	// IMP=0x0000000000ae365f
...
- (id)attributeDescriptions;	// IMP=0x0000000000ae335c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ae32d7
- (unsigned long long)hash;	// IMP=0x0000000000ae3293
- (long long)compare:(id)arg1 outCriteria:(unsigned long long *)arg2;	// IMP=0x0000000000ae2c26
- (long long)compare:(id)arg1;	// IMP=0x0000000000ae2c12
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithResident:(id)arg1 enabled:(id)arg2 location:(long long)arg3 accessories:(id)arg4;	// IMP=0x0000000000ae276c
- (id)initWithResident:(id)arg1 dictionaryRepresentation:(id)arg2;	// IMP=0x0000000000ae2576
