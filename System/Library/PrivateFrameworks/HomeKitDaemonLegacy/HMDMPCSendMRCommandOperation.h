...
+ (id)logCategory;	// IMP=0x00100000009e3cfe
+ (id)shortDescription;	// IMP=0x00100000009e3cf1
- (void).cxx_destruct;	// IMP=0x00000000009e33b1
...
- (long long)errorCodeForCurrentOperation;	// IMP=0x00000000009e2fef
...
- (void)main;	// IMP=0x00000000009e278b
- (id)initWithPlaybackArchive:(id)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x00000000009e267d
- (id)initWithPlaybackArchive:(id)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x00000000009e25de
- (id)initWithCommand:(unsigned int)arg1 destination:(id)arg2 options:(id)arg3 externalObjectInterface:(id)arg4;	// IMP=0x00000000009e24bc
- (id)initWithCommand:(unsigned int)arg1 options:(id)arg2 destination:(id)arg3;	// IMP=0x00000000009e2430
