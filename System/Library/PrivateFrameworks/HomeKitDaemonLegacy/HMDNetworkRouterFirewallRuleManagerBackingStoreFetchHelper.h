...
+ (unsigned long long)maxOperationDurationSeconds;	// IMP=0x001000000003b9e9
+ (unsigned long long)maxRetryCount;	// IMP=0x001000000003b9cb
+ (unsigned long long)__integerForPreferenceKey:(id)arg1 defaultValue:(unsigned long long)arg2;	// IMP=0x001000000003b8e7
+ (id)logCategory;	// IMP=0x001000000003b8b7
- (void).cxx_destruct;	// IMP=0x000000000003b853
...
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000003b42f
- (void)finishWithError:(id)arg1;	// IMP=0x000000000003b418
- (void)finishWithResult:(id)arg1;	// IMP=0x000000000003b404
@property(nonatomic) _Bool shouldRetry;
- (void)dealloc;	// IMP=0x000000000003af05
- (id)initWithActivity:(id)arg1 options:(id)arg2 container:(id)arg3 useAnonymousRequests:(_Bool)arg4 promise:(id)arg5;	// IMP=0x000000000003ad1e
