...
+ (id)logCategory;	// IMP=0x001000000006696f
- (void).cxx_destruct;	// IMP=0x00000000000665c1
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000000065e61
- (id)createClientConnectionWithRemoteObjectProxy:(id)arg1 homeManager:(id)arg2 connection:(id)arg3 backgroundModeEntitled:(_Bool)arg4;	// IMP=0x0000000000065cf8
- (void)stop;	// IMP=0x0000000000065cbb
- (void)start;	// IMP=0x0000000000065ba8
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000006592c
