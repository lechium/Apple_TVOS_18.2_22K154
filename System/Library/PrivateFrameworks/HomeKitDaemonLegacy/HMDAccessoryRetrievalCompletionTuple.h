...
- (void).cxx_destruct;	// IMP=0x0000000000b04db1
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b04965
- (void)stop;	// IMP=0x0000000000b048bb
- (void)start;	// IMP=0x0000000000b04742
- (void)addCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b04674
- (id)initWithHome:(id)arg1 accessory:(id)arg2 linkType:(long long)arg3;	// IMP=0x0000000000b04553
