...
+ (id)logCategory;	// IMP=0x0010000000758354
- (void).cxx_destruct;	// IMP=0x00000000007582f0
...
- (void)dealloc;	// IMP=0x000000000075814e
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000757fbd
