...
- (void).cxx_destruct;	// IMP=0x0000000000068b2d
...
- (id)attributeDescriptions;	// IMP=0x00000000000684cc
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006831c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000068311
- (unsigned long long)hash;	// IMP=0x00000000000682cd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000067f46
- (id)initWithUUID:(id)arg1;	// IMP=0x0000000000067e20
