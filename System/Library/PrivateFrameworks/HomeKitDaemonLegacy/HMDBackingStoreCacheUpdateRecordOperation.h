...
- (void).cxx_destruct;	// IMP=0x000000000023e0c2
...
- (id)mainReturningError;	// IMP=0x000000000023dd87
- (id)initWithGroup:(id)arg1 name:(id)arg2 model:(id)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000023dd5b
- (id)initWithGroup:(id)arg1 record:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000023dbb5
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 resultBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000023db89
- (id)initWithGroup:(id)arg1 name:(id)arg2 record:(id)arg3 data:(id)arg4 encoding:(unsigned long long)arg5 model:(id)arg6 resultBlock:(CDUnknownBlockType)arg7;	// IMP=0x000000000023da32
