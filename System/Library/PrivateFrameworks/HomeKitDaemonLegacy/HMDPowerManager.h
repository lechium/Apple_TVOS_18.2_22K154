...
- (void).cxx_destruct;	// IMP=0x0000000000470160
...
- (void)_ensureNetworkInterfaceMonitorStopped;	// IMP=0x00000000004700a8
- (int)_ensureNetworkInterfaceMonitorStarted;	// IMP=0x000000000046fe29
- (void)_update;	// IMP=0x000000000046fc84
- (void)stop;	// IMP=0x000000000046fc32
- (void)start;	// IMP=0x000000000046fbe0
- (void)dealloc;	// IMP=0x000000000046fb5c
- (id)init;	// IMP=0x000000000046fad3
