...
+ (id)logCategory;	// IMP=0x000000000095e69c
+ (id)shortDescription;	// IMP=0x000000000095e68a
- (void).cxx_destruct;	// IMP=0x000000000095e617
...
- (void)clearData;	// IMP=0x000000000095e459
...
- (_Bool)encodeObjectChange:(id)arg1;	// IMP=0x000000000095d937
- (id)extractObjectChange;	// IMP=0x000000000095cd72
- (id)description;	// IMP=0x000000000095cd06
- (id)shortDescription;	// IMP=0x000000000095cc1a
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2 cloudZone:(id)arg3;	// IMP=0x000000000095cac2
- (id)init;	// IMP=0x000000000095ca1a
