...
- (void).cxx_destruct;	// IMP=0x00000000002eaa1c
...
- (id)attributeDescriptions;	// IMP=0x00000000002ea7f2
- (id)initWithInputLanguage:(id)arg1 outputVoiceLanguageCode:(id)arg2 outputVoiceGenderCode:(id)arg3 voiceName:(id)arg4;	// IMP=0x00000000002ea6f5
