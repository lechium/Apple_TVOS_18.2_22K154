...
+ (id)managedEventCounterRequestGroups;	// IMP=0x00100000002fa407
- (void).cxx_destruct;	// IMP=0x00000000002fa053
...
- (void)runDailyTask;	// IMP=0x00000000002f9f6f
- (void)resetAggregationAnalysisContext;	// IMP=0x00000000002f9f32
- (void)populateAggregationAnalysisLogEvent:(id)arg1 forDate:(id)arg2;	// IMP=0x00000000002f9e8d
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x00000000002f9d8c
- (long long)cameraReachabilityThresholdFromConfiguration:(id)arg1;	// IMP=0x00000000002f9d52
- (void)configurationChanged:(id)arg1;	// IMP=0x00000000002f9cf6
- (id)initWithDataSource:(id)arg1 notificationSettingsProvider:(id)arg2;	// IMP=0x00000000002f9aca
