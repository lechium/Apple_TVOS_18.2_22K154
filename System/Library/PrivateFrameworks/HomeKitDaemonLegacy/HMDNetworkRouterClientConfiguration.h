...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00100000005129a1
+ (id)configurationForFirewallConfiguration:(id)arg1 hapAccessory:(_Bool)arg2 airplayAccessory:(_Bool)arg3 withClientIdentifier:(id)arg4;	// IMP=0x00100000004944a1
+ (id)configurationForOpenProtectionWithClientIdentifier:(id)arg1;	// IMP=0x00100000004943eb
+ (id)configurationWithClientIdentifier:(id)arg1 lanIdentifier:(long long)arg2;	// IMP=0x00100000004942eb
- (void).cxx_destruct;	// IMP=0x0000000000503849
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000503215
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000050310d
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000502b98
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000050262a
- (id)initWithClientIdentifier:(id)arg1 lanIdentifier:(id)arg2 credential:(id)arg3 wanFirewallConfiguration:(id)arg4 lanFirewallConfiguration:(id)arg5;	// IMP=0x0000000000502523
- (id)init;	// IMP=0x00000000005024f4
