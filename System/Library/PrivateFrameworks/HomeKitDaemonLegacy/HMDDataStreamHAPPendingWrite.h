...
- (void).cxx_destruct;	// IMP=0x00000000006cf408
...
- (id)popNextFrameUpToMaxLength:(unsigned long long)arg1;	// IMP=0x00000000006cf2ea
- (_Bool)isComplete;	// IMP=0x00000000006cf289
- (id)initWithData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000006cf1dd
