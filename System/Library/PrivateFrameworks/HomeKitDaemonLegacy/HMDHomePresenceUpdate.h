...
- (void).cxx_destruct;	// IMP=0x000000000039fc7a
...
- (id)description;	// IMP=0x000000000039fb47
- (id)initWithHomePresence:(id)arg1 userPresence:(id)arg2 update:(_Bool)arg3 causingDevice:(id)arg4;	// IMP=0x000000000039fa6c
