...
+ (id)qualityPredicate;	// IMP=0x0000000000bb5d27
+ (id)countOfClipsWithQualityBetweenDatesQuery;	// IMP=0x0000000000bb5cc4
+ (id)clipsWithQualityBetweenDatesDescendingQuery;	// IMP=0x0000000000bb5c61
+ (id)clipsWithQualityBetweenDatesAscendingQuery;	// IMP=0x0000000000bb5bfe
+ (id)clipsBeforeDateQuery;	// IMP=0x0000000000bb5bce
+ (id)clipsWithNeedsUploadFeedbackStatusQuery;	// IMP=0x0000000000bb5b9e
+ (id)incompleteClipsQuery;	// IMP=0x0000000000bb5b6e
+ (id)sentinelParentUUID;	// IMP=0x0000000000bb5b3e
+ (id)hmbQueries;	// IMP=0x0000000000bb59e7
+ (id)hmbExternalRecordType;	// IMP=0x0000000000bb59da
+ (id)hmbProperties;	// IMP=0x0000000000bb59aa
@property long long quality;
@property unsigned long long feedbackStatus;
- (id)createClipWithSignificantEvents:(id)arg1;	// IMP=0x0000000000bb6de0
