...
- (void).cxx_destruct;	// IMP=0x000000000095b481
...
- (id)attributeDescriptions;	// IMP=0x000000000095b04a
- (id)initWithClipModelID:(id)arg1 operation:(id)arg2;	// IMP=0x000000000095af97
