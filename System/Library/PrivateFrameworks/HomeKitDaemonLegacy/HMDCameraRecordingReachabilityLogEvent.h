...
- (void).cxx_destruct;	// IMP=0x000000000021040d
...
- (id)initWithReachability:(_Bool)arg1 didCreateEventModel:(_Bool)arg2 reachabilityChangeDebounceCount:(unsigned long long)arg3 offlineDuration:(double)arg4 hapAccessory:(id)arg5;	// IMP=0x00000000002100e3
