...
- (void).cxx_destruct;	// IMP=0x000000000023e9ab
...
- (id)description;	// IMP=0x000000000023e7a0
- (id)initWithGroup:(id)arg1 record:(id)arg2 data:(id)arg3 encoding:(unsigned long long)arg4 uuid:(id)arg5;	// IMP=0x000000000023e689
