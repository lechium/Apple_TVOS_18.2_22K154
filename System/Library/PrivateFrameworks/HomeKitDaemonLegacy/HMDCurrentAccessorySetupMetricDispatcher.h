...
+ (id)logCategory;	// IMP=0x00100000009a150c
+ (void)saveSetupLogEventIntoUserDefaults:(id)arg1 setupLogEvent:(id)arg2;	// IMP=0x00100000009a0c10
+ (id)readSetupLogEventFromUserDefaults:(id)arg1;	// IMP=0x00100000009a0aba
+ (id)homepodSetupLogEventFromProtoSetupInfo:(id)arg1;	// IMP=0x00100000009a04cb
+ (void)removeLastAccessorySetupInfoFromUserDefaults:(id)arg1;	// IMP=0x00100000009a03bc
+ (id)readLastAccessorySetupInfo:(id)arg1;	// IMP=0x00100000009a0352
- (void).cxx_destruct;	// IMP=0x000000000099f135
...
- (void)setControllerSetupSessionIdentifier:(id)arg1;	// IMP=0x000000000099ee5a
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000099e12c
- (id)_underlyingErrorByIgnoringCommunicationFailureErrors:(id)arg1;	// IMP=0x000000000099e0c9
- (void)startFinalSubmissionTimer;	// IMP=0x000000000099dff4
- (void)markControllerHH2Mode:(_Bool)arg1 controllerHH2SentinelExists:(_Bool)arg2;	// IMP=0x000000000099df70
- (void)markSetupEndStage:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x000000000099d1b4
- (void)markSetupBeginStage:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x000000000099c86b
- (id)initWithDataSource:(id)arg1 setupLogEvent:(id)arg2 logEventSubmitter:(id)arg3;	// IMP=0x000000000099c7a9
- (id)initWithDataSource:(id)arg1 setupLogEvent:(id)arg2 logEventSubmitter:(id)arg3 currentUpTicksFactory:(CDUnknownBlockType)arg4 submissionTimerFactory:(CDUnknownBlockType)arg5 userDefaults:(id)arg6;	// IMP=0x000000000099c5dd
