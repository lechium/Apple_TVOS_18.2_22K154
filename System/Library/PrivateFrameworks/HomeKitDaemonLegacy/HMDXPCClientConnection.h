...
+ (id)logCategory;	// IMP=0x0010000000351390
+ (unsigned long long)entitlementsForConnection:(id)arg1;	// IMP=0x0010000000350fcd
- (void).cxx_destruct;	// IMP=0x0000000000350a98
...
- (_Bool)sendMessage:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000350505
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000350460
- (void)updateUserInfo:(id)arg1;	// IMP=0x00000000003503e6
- (void)handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000350351
- (void)handleMessage:(id)arg1;	// IMP=0x00000000003502d5
- (void)_invalidate;	// IMP=0x00000000003500ec
- (void)_deactivate;	// IMP=0x000000000034feeb
- (void)_activate;	// IMP=0x000000000034fcc1
- (void)_start;	// IMP=0x000000000034faa2
- (void)invalidate;	// IMP=0x000000000034fa4f
- (void)deactivate;	// IMP=0x000000000034f9de
- (void)activate;	// IMP=0x000000000034f96d
- (void)_handleMessage:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000034ee82
- (_Bool)canSendMessage:(id)arg1;	// IMP=0x000000000034e1a3
@property(readonly, copy) NSDictionary *stateDump;
- (void)updateSendPolicyParameters:(id)arg1;	// IMP=0x000000000034de4d
- (void)initiateRefresh;	// IMP=0x000000000034dc06
...
- (void)notifyOfExternallyManagedActivation;	// IMP=0x000000000034da2c
- (void)handleProcessStateDidChange;	// IMP=0x000000000034d802
...
- (id)clientUUID;	// IMP=0x000000000034ce12
@property(readonly, copy) NSString *clientName;
@property(copy) NSDictionary *userInfo; // @synthesize userInfo=_userInfo;
@property(readonly, nonatomic, getter=isActivated) _Bool activated;
- (id)attributeDescriptions;	// IMP=0x000000000034c8e0
- (id)shortDescription;	// IMP=0x000000000034c82c
- (void)dealloc;	// IMP=0x000000000034c6c5
- (id)initWithConnection:(id)arg1 queue:(id)arg2 messageCountTracker:(id)arg3 requestTracker:(id)arg4;	// IMP=0x000000000034c3f8
- (id)initWithConnection:(id)arg1 queue:(id)arg2;	// IMP=0x000000000034c31f
