...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004e0a35
- (void).cxx_destruct;	// IMP=0x00000000004e09af
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004e0794
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004e0636
