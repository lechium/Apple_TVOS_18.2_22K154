...
- (void).cxx_destruct;	// IMP=0x0000000000b83aed
...
- (id)initWithTopic:(id)arg1 sourceDeviceType:(unsigned long long)arg2 destinationDeviceType:(unsigned long long)arg3 isCachedEvent:(_Bool)arg4 responseMessageType:(unsigned long long)arg5;	// IMP=0x0000000000b839bd
