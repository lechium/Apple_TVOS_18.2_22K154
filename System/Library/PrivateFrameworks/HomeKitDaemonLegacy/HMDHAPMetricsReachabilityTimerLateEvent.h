...
- (void).cxx_destruct;	// IMP=0x00000000005d1dff
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x00000000005d1c84
- (id)coreAnalyticsEventName;	// IMP=0x00000000005d1c77
- (id)initWithAccessory:(id)arg1 actualDuration:(id)arg2 expectedDuration:(id)arg3;	// IMP=0x00000000005d1bcf
