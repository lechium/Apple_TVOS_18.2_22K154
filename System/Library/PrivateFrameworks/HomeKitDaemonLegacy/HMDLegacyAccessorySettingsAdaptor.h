...
+ (id)parsedLanguageListSetting:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000632c1a
+ (id)parsedLanguageSetting:(id)arg1 topic:(id)arg2;	// IMP=0x00100000006328f7
+ (id)parsedIntegerSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0010000000632627
+ (id)parsedBoolSettingEvent:(id)arg1 topic:(id)arg2;	// IMP=0x00100000006322ba
+ (id)logCategory;	// IMP=0x001000000063228a
- (void).cxx_destruct;	// IMP=0x00000000006318a1
...
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x00000000006313cd
- (id)_transformLegacyLanguageSettingValueToImmutableSetting:(id)arg1;	// IMP=0x0000000000631189
- (id)_settingValueForKeyPath:(id)arg1 value:(id)arg2;	// IMP=0x0000000000630963
- (id)languageValueList;	// IMP=0x0000000000630956
- (void)updateSettingWithKeyPath:(id)arg1 settingValue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000006305dd
- (void)startup;	// IMP=0x000000000063022a
- (id)initWithQueue:(id)arg1 homeUUID:(id)arg2 accessoryUUID:(id)arg3 settingsController:(id)arg4 subscriptionProvider:(id)arg5;	// IMP=0x0000000000630128
