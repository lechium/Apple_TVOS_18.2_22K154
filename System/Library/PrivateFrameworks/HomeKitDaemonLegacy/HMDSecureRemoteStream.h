...
+ (id)logCategory;	// IMP=0x0010000000b77dab
- (void).cxx_destruct;	// IMP=0x0000000000b73d65
...
- (id)logIdentifier;	// IMP=0x0000000000b73c53
- (void)__handleDeviceRemovedFromAccount:(id)arg1;	// IMP=0x0000000000b73bbf
- (void)__handleAccountRemovedFromRegistry:(id)arg1;	// IMP=0x0000000000b73b2b
- (void)__handleRemovedIdentity:(id)arg1;	// IMP=0x0000000000b73a97
- (void)handleSecureMessage:(id)arg1 fromDevice:(id)arg2 fromTransport:(id)arg3;	// IMP=0x0000000000b739a4
- (void)handleCompletedMessage:(id)arg1 options:(id)arg2 responsePayload:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000b7385b
- (void)sendMessage:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b73791
- (void)stop;	// IMP=0x0000000000b7373f
- (void)_closeWithError:(id)arg1;	// IMP=0x0000000000b73668
- (void)closedWithError:(id)arg1;	// IMP=0x0000000000b735d4
- (void)_configureWithCompletionQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b72e6e
- (void)startAndInvokeOnQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b72db0
@property(readonly, copy) NSDate *lastActivity; // @synthesize lastActivity=_lastActivity;
- (void)setIdle:(_Bool)arg1;	// IMP=0x0000000000b72c47
@property(readonly, getter=isIdle) _Bool idle; // @synthesize idle=_idle;
- (void)setAuthenticated:(_Bool)arg1;	// IMP=0x0000000000b72bd0
@property(readonly, getter=isAuthenticated) _Bool authenticated; // @synthesize authenticated=_authenticated;
- (void)setOpen:(_Bool)arg1;	// IMP=0x0000000000b72b59
@property(readonly, getter=isOpen) _Bool open; // @synthesize open=_open;
- (void)setMaximumRemoteStreams:(id)arg1;	// IMP=0x0000000000b72ace
...
- (void)dealloc;	// IMP=0x0000000000b725fe
- (id)initWithCurrentDevice:(id)arg1 peerDevice:(id)arg2 clientMode:(_Bool)arg3 sessionID:(id)arg4 accountRegistry:(id)arg5;	// IMP=0x0000000000b72378
