...
+ (id)logCategory;	// IMP=0x00100000006b7c79
- (void).cxx_destruct;	// IMP=0x00000000006b708d
...
- (void)browser:(id)arg1 didRemoveAccessoryPairingWithNodeID:(id)arg2;	// IMP=0x00000000006b68fb
- (void)requestUserPermissionForBridgeAccessory:(id)arg1 withContext:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000006b67e0
- (void)requestUserPermissionForUnauthenticatedAccessory:(id)arg1 withContext:(id)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000006b66c5
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006b6469
- (void)forAllPairedMatterServersFetchVidPid:(CDUnknownBlockType)arg1;	// IMP=0x00000000006b6095
- (void)forAllStorageDataSourcesDo:(CDUnknownBlockType)arg1;	// IMP=0x00000000006b5d93
- (id)storageDataSourceForFabricWithID:(id)arg1;	// IMP=0x00000000006b5a1d
- (id)appleHomeTargetFabricUUIDWithID:(id)arg1;	// IMP=0x00000000006b5624
- (id)appleHomeFabricWithUUID:(id)arg1;	// IMP=0x00000000006b535d
- (id)appleHomeFabricWithID:(id)arg1;	// IMP=0x00000000006b5055
...
- (void)handleHomeRemovedNotification:(id)arg1;	// IMP=0x00000000006b44c0
- (void)handleAccessoryCHIPStorageChangedNotification:(id)arg1;	// IMP=0x00000000006b42f5
- (void)handleHomeCHIPStorageChangedNotification:(id)arg1;	// IMP=0x00000000006b412a
- (void)handlePrimaryResidentUpdatedNotification:(id)arg1;	// IMP=0x00000000006b3fd5
- (void)handleUpdatedDataWithIsLocalChange:(_Bool)arg1;	// IMP=0x00000000006b3e85
- (id)homeWithCHIPFabric:(id)arg1;	// IMP=0x00000000006b3cba
- (id)home;	// IMP=0x00000000006b3982
- (void)configureWithUIDialogPresenter:(id)arg1;	// IMP=0x00000000006b37e6
- (void)configureWithAttestationDataStore:(id)arg1;	// IMP=0x00000000006b35ef
- (void)configureWithVendorMetadataStore:(id)arg1;	// IMP=0x00000000006b33c9
- (void)configureWithStorage:(id)arg1;	// IMP=0x00000000006b314b
- (void)configureWithResidentStateManager:(id)arg1;	// IMP=0x00000000006b2f2a
- (void)configureWithAccessoryServerBrowser:(id)arg1;	// IMP=0x00000000006b2df0
- (id)initWithHomeManager:(id)arg1 notificationCenter:(id)arg2 vendorMetadataRefreshTimer:(id)arg3 attestationDataRefreshTimer:(id)arg4 dialogPresenter:(id)arg5;	// IMP=0x00000000006b2ca4
- (id)initWithHomeManager:(id)arg1;	// IMP=0x00000000006b2b80
