...
- (void).cxx_destruct;	// IMP=0x000000000056029d
...
- (void)main;	// IMP=0x000000000056008e
- (id)initWithItemToPost:(id)arg1 followUpController:(id)arg2;	// IMP=0x000000000055ffc3
