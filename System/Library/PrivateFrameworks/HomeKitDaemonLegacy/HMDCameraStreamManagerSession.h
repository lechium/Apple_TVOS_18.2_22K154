...
+ (id)logCategory;	// IMP=0x00100000000ac94a
- (void).cxx_destruct;	// IMP=0x00000000000ac8d5
...
- (id)logIdentifier;	// IMP=0x00000000000ac7df
- (_Bool)canStartWithError:(id *)arg1;	// IMP=0x00000000000ac600
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 streamSetupTimer:(id)arg5;	// IMP=0x00000000000ac47d
- (id)initWithSessionID:(id)arg1 destinationID:(id)arg2 streamClientConnection:(id)arg3 streamControlManager:(id)arg4 setupWaitPeriod:(double)arg5;	// IMP=0x00000000000ac34a
