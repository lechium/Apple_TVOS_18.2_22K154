...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000077015e
- (void).cxx_destruct;	// IMP=0x0000000000770115
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000076fae1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000076f9d9
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000076f378
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000076ee08
- (id)initWithWakePacketType:(id)arg1 wakeDestinationPort:(id)arg2 wakeDestinationAddress:(id)arg3 wakeType:(id)arg4 wakePattern:(id)arg5;	// IMP=0x000000000076ed01
- (id)init;	// IMP=0x000000000076ecd2
