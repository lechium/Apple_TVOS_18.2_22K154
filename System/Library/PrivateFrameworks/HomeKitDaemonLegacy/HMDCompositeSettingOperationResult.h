...
+ (id)frameWorkFetchResultsWithOperationResults:(id)arg1;	// IMP=0x00600000002eb440
- (void).cxx_destruct;	// IMP=0x00000000002eb3ed
...
- (id)attributeDescriptions;	// IMP=0x00000000002eb1c3
- (id)initWithKeyPath:(id)arg1 setting:(id)arg2 metadata:(id)arg3 error:(id)arg4;	// IMP=0x00000000002eb0d5
