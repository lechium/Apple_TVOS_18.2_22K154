...
+ (id)updateMultipleCharacteristicReadWriteResponsePayload:(id)arg1 withUnhandledRequests:(id)arg2;	// IMP=0x0060000000b56486
+ (id)notificationUpdateMessagePayloadForHome:(id)arg1 notificationEnabled:(_Bool)arg2 characteristics:(id)arg3 characteristicsErrorsMap:(id)arg4;	// IMP=0x0060000000b55c7f
+ (id)responsePayloadForHome:(id)arg1 changedAccessories:(id)arg2 moreMessagesInMultipart:(id)arg3;	// IMP=0x0060000000b55b31
- (void).cxx_destruct;	// IMP=0x0000000000b55acd
...
- (id)attributeDescriptions;	// IMP=0x0000000000b55815
- (id)notificationWithHome:(id)arg1;	// IMP=0x0000000000b556a5
- (id)initWithRequestIdentifier:(id)arg1 responses:(id)arg2 pendingMultiPartResponses:(_Bool)arg3;	// IMP=0x0000000000b5463a
