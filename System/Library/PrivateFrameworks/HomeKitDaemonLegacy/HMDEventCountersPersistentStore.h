...
- (void).cxx_destruct;	// IMP=0x0000000000a162e8
@property(readonly, nonatomic) __weak id <HMDPersistentStore> persistentStore; // @synthesize persistentStore=_persistentStore;
- (id)unarchive;	// IMP=0x0000000000a15ecc
- (void)archiveDictionary:(id)arg1;	// IMP=0x0000000000a15d9c
- (id)initWithPersistentStore:(id)arg1;	// IMP=0x0000000000a15d38
