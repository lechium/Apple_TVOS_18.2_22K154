...
+ (id)supportedEventClasses;	// IMP=0x0010000000b15d03
- (void).cxx_destruct;	// IMP=0x0000000000b1595a
...
- (void)_injectThreadNetworkStateForTestingWithNumAdvertisedBRs:(unsigned long long)arg1 numAppleBRs:(unsigned long long)arg2 numThirdPartyBRs:(unsigned long long)arg3 numThreadNetworks:(unsigned long long)arg4 maxSimuIPPrefixesDetected:(unsigned long long)arg5 txTotal:(unsigned long long)arg6 txSuccess:(unsigned long long)arg7 txDelayAvg:(unsigned long long)arg8 rxTotal:(unsigned long long)arg9 rxSuccess:(unsigned long long)arg10 reportDuration:(unsigned long long)arg11 reportDate:(id)arg12 reportDailySummary:(_Bool)arg13;	// IMP=0x0000000000b155a3
- (void)requestThreadNetworkStateCaptureForAccessory:(id)arg1 failingScenario:(int)arg2;	// IMP=0x0000000000b1559d
- (void)generateLogForPeriodicReport:(id)arg1;	// IMP=0x0000000000b15597
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x0000000000b154dc
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x0000000000b15421
- (id)_keyOfLargestCountInHistogram:(id)arg1;	// IMP=0x0000000000b152eb
- (void)_incrementError:(id)arg1 forHistogram:(id)arg2 byValue:(unsigned long long)arg3;	// IMP=0x0000000000b1520b
- (void)_updateDailyCountersAndResetCurrentReportStatsForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2;	// IMP=0x0000000000b149b6
- (id)logEventForHomeWithUUID:(id)arg1 associatedWithDate:(id)arg2 isDailySummary:(_Bool)arg3;	// IMP=0x0000000000b141f5
- (void)_runLoggingForDate:(id)arg1 isDailySummary:(_Bool)arg2;	// IMP=0x0000000000b13ffd
- (void)runDailyTask;	// IMP=0x0000000000b13f79
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000b13eb0
- (void)_handleAccessorySessionEvent:(id)arg1;	// IMP=0x0000000000b13d2a
- (void)_handleReadWriteLogEvent:(id)arg1;	// IMP=0x0000000000b13b87
- (id)counterGroupForName:(id)arg1 homeUUID:(id)arg2 date:(id)arg3;	// IMP=0x0000000000b13aa0
- (void)stop;	// IMP=0x0000000000b139ad
- (void)start;	// IMP=0x0000000000b1382c
- (void)_setDailyScheduler:(id)arg1;	// IMP=0x0000000000b13805
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x0000000000b13660
- (id)initWithLogEventDispatcher:(id)arg1 countersManager:(id)arg2 dailyScheduler:(id)arg3 currentHomeDataSource:(id)arg4 dateProvider:(id)arg5;	// IMP=0x0000000000b1356a
