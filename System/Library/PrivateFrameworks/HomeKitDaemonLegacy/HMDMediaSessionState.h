...
- (void).cxx_destruct;	// IMP=0x00000000006b1afd
@property(readonly, copy, nonatomic) NSString *sessionIdentifier; // @synthesize sessionIdentifier=_sessionIdentifier;
- (id)dumpState;	// IMP=0x00000000006b1953
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006b15a1
...
- (id)initWithSessionIdentifier:(id)arg1;	// IMP=0x00000000006b1092
