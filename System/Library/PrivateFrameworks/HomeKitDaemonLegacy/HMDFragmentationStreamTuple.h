...
+ (id)tupleWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x00600000009be2f9
- (void).cxx_destruct;	// IMP=0x00000000009be2a6
...
- (void)close;	// IMP=0x00000000009be225
@property(readonly, nonatomic, getter=isExpired) _Bool expired;
- (id)initWithFragmentationStreamForObject:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000009be053
