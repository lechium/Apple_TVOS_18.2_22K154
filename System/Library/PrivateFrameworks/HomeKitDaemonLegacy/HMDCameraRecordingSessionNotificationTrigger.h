...
+ (id)logCategory;	// IMP=0x0010000000a1a225
- (void).cxx_destruct;	// IMP=0x0000000000a1a0c3
...
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x0000000000a19dc8
- (void)handleCharacteristicsValueUpdated:(id)arg1;	// IMP=0x0000000000a19d10
- (void)handleAccessoryConfigured:(id)arg1;	// IMP=0x0000000000a19c9f
- (void)_handleObservedCharacteristicsValueUpdate:(id)arg1;	// IMP=0x0000000000a19053
- (void)start;	// IMP=0x0000000000a18f02
- (void)dealloc;	// IMP=0x0000000000a18d76
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2 availabilityListener:(id)arg3 notificationCenter:(id)arg4;	// IMP=0x0000000000a18b59
- (id)initWithCamera:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000a18975
