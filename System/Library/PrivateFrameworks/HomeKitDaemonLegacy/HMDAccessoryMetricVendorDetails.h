...
+ (unsigned long long)maximumDifferentiationNumber;	// IMP=0x004000000051ae18
...
- (id)attributeDescriptions;	// IMP=0x000000000051aa00
- (id)initWithProductData:(id)arg1 manufacturer:(id)arg2 model:(id)arg3 firmwareVersion:(id)arg4 category:(id)arg5 differentiationNumber:(id)arg6;	// IMP=0x000000000051a8ba
- (id)initWithAccessory:(id)arg1;	// IMP=0x000000000051a124
