...
- (void).cxx_destruct;	// IMP=0x000000000023ed18
...
- (id)mainReturningError;	// IMP=0x000000000023eaba
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x000000000023e9fe
