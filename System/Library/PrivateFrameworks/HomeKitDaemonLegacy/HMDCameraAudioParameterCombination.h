...
- (void).cxx_destruct;	// IMP=0x0000000000348c47
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000348a80
- (id)description;	// IMP=0x0000000000348921
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3 maximumBitrate:(id)arg4 minimumBitrate:(id)arg5 rtcpInterval:(id)arg6 rtpPtime:(id)arg7;	// IMP=0x000000000034882a
- (id)initWithCodecGroup:(id)arg1 bitrateSetting:(id)arg2 sampleRate:(id)arg3;	// IMP=0x0000000000348760
