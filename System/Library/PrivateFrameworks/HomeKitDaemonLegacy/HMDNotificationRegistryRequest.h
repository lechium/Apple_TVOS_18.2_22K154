...
- (void).cxx_destruct;	// IMP=0x0000000000753b2b
...
- (id)attributeDescriptions;	// IMP=0x000000000075391a
- (id)initWithEnable:(_Bool)arg1 userID:(id)arg2;	// IMP=0x000000000075388e
