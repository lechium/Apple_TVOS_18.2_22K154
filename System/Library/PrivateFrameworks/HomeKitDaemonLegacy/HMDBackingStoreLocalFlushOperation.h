...
- (void).cxx_destruct;	// IMP=0x0000000000793186
...
- (void)main;	// IMP=0x0000000000792b30
- (id)initWithStore:(id)arg1 clearCloud:(_Bool)arg2 resultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000792a63
