...
- (void).cxx_destruct;	// IMP=0x000000000023f72f
...
- (id)mainReturningError;	// IMP=0x000000000023f0b1
- (id)initWithGroup:(id)arg1 records:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000023efd1
- (id)initWithGroup:(id)arg1 parentUuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000023eef1
- (id)initWithGroup:(id)arg1 uuids:(id)arg2 fetchResult:(CDUnknownBlockType)arg3;	// IMP=0x000000000023ee11
