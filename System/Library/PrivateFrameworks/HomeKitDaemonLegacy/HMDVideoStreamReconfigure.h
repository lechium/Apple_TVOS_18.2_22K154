...
+ (id)logCategory;	// IMP=0x00100000001db474
- (void).cxx_destruct;	// IMP=0x00000000001da4e7
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000001da0e2
- (void)downlinkQualityChanged:(id)arg1;	// IMP=0x00000000001d9f63
- (void)updateReconfigurationMode:(_Bool)arg1;	// IMP=0x00000000001d9d13
- (id)logIdentifier;	// IMP=0x00000000001d9ced
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000001d9bf0
