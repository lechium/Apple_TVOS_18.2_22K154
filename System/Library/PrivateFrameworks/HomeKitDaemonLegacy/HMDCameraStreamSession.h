...
+ (id)logCategory;	// IMP=0x0010000000af9038
- (void).cxx_destruct;	// IMP=0x0000000000af8fd4
...
- (id)logIdentifier;	// IMP=0x0000000000af8ef3
- (id)negotiatedParameters;	// IMP=0x0000000000af8d9e
- (id)initWithSessionID:(id)arg1 streamingTierType:(unsigned long long)arg2 remoteCapabilities:(id)arg3 streamPreference:(id)arg4;	// IMP=0x0000000000af8970
