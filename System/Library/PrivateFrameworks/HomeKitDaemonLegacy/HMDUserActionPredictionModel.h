...
+ (_Bool)hmbExcludeFromCloudStorage;	// IMP=0x006000000038d3fb
+ (id)hmbProperties;	// IMP=0x006000000038d3cb
- (id)userActionPrediction;	// IMP=0x000000000038df95
- (id)initWithUserActionPrediction:(id)arg1;	// IMP=0x000000000038d979
