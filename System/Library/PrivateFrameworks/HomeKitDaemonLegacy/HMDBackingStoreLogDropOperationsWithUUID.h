...
- (void).cxx_destruct;	// IMP=0x000000000083fec9
...
- (id)mainReturningError;	// IMP=0x000000000083f8a3
- (id)initWithUUID:(id)arg1 pushingTo:(unsigned long long)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000083f7fb
