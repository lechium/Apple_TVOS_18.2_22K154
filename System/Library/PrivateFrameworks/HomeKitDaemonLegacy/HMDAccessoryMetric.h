...
+ (id)logCategory;	// IMP=0x001000000051c646
- (void).cxx_destruct;	// IMP=0x000000000051c06f
...
- (id)logIdentifier;	// IMP=0x000000000051beff
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000051b86e
- (void)submitMetricAndStop;	// IMP=0x000000000051b7f5
- (void)_initDiagnosticCounters;	// IMP=0x000000000051b5af
- (id)initWithAccessory:(id)arg1;	// IMP=0x000000000051b29d
