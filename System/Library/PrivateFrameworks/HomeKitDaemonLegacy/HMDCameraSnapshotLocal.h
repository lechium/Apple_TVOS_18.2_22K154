...
+ (id)logCategory;	// IMP=0x001000000025ff9e
- (void).cxx_destruct;	// IMP=0x000000000025fe13
...
- (void)_handleSnapshotFile:(id)arg1 error:(id)arg2;	// IMP=0x000000000025fb03
- (void)_getSnapshot:(unsigned long long)arg1;	// IMP=0x000000000025f9e1
- (void)getSnapshot:(unsigned long long)arg1;	// IMP=0x000000000025f965
- (id)logIdentifier;	// IMP=0x000000000025f915
- (void)dealloc;	// IMP=0x000000000025f816
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 snapshotRequestHandler:(id)arg6;	// IMP=0x000000000025f6e0
