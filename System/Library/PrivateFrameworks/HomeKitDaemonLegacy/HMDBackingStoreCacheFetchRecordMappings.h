...
- (void).cxx_destruct;	// IMP=0x00000000002410c4
...
- (id)mainReturningError;	// IMP=0x0000000000240df7
- (id)initWithGroup:(id)arg1 fetchResult:(CDUnknownBlockType)arg2;	// IMP=0x0000000000240d3b
