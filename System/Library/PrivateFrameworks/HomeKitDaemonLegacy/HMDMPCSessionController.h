...
- (void).cxx_destruct;	// IMP=0x0000000000bd669e
...
- (void)executeSessionWithSessionData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bd5559
- (id)initWithLogEventSubmitter:(id)arg1;	// IMP=0x0000000000bd5461
