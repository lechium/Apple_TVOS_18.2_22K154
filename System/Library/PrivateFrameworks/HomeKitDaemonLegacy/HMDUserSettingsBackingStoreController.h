...
+ (id)logCategory;	// IMP=0x001000000021e523
- (void).cxx_destruct;	// IMP=0x000000000021c982
...
- (id)logIdentifier;	// IMP=0x000000000021c6b4
- (void)database:(id)arg1 didRemoveZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x000000000021c585
- (void)database:(id)arg1 didCreateZoneWithName:(id)arg2 isPrivate:(_Bool)arg3;	// IMP=0x000000000021c456
- (void)runTransaction:(id)arg1 waitForCloudPush:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000021bcf2
- (id)settingTransactionWithName:(id)arg1;	// IMP=0x000000000021bca5
- (void)runSettingTransaction:(id)arg1 waitForCloudPush:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000021bc93
- (void)runSettingTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000021bc7c
- (void)registerForSettingsTransactions:(id)arg1;	// IMP=0x000000000021bb66
- (void)_localZone:(id)arg1 updatedModel:(id)arg2 previousModel:(id)arg3 options:(id)arg4 result:(id)arg5;	// IMP=0x000000000021af58
- (id)localZone:(id)arg1 didProcessModelUpdate:(id)arg2;	// IMP=0x000000000021ae34
- (id)localZone:(id)arg1 didProcessModelDeletion:(id)arg2;	// IMP=0x000000000021aca8
- (id)localZone:(id)arg1 didProcessModelCreation:(id)arg2;	// IMP=0x000000000021ab84
- (void)messengerDidReceiveShareAccessRevocation:(id)arg1;	// IMP=0x000000000021ab7e
- (void)messenger:(id)arg1 didReceiveInvitationRequestFromUser:(id)arg2 device:(id)arg3;	// IMP=0x000000000021a985
- (void)messenger:(id)arg1 didReceiveInvitationData:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000021a586
- (void)manager:(id)arg1 didRevokeShareAccessForUser:(id)arg2;	// IMP=0x000000000021a580
- (void)manager:(id)arg1 didRequestSendForInvitation:(id)arg2 toDevice:(id)arg3;	// IMP=0x000000000021a4e9
- (void)manager:(id)arg1 didRequestSendForInvitation:(id)arg2 toUser:(id)arg3;	// IMP=0x000000000021a451
- (_Bool)manager:(id)arg1 shouldShareWithUser:(id)arg2;	// IMP=0x000000000021a3e0
- (void)_sendShareInvitation:(id)arg1 toUser:(id)arg2 device:(id)arg3;	// IMP=0x0000000000219ebe
- (void)_updateLogEventRunState:(long long)arg1;	// IMP=0x0000000000219ce3
- (void)_updateRunState:(long long)arg1;	// IMP=0x0000000000219b76
- (id)loadUserSettings;	// IMP=0x00000000002198e2
- (void)_didFetchZonesWithResult:(id)arg1 isOwnedZone:(_Bool)arg2 error:(id)arg3;	// IMP=0x0000000000218c90
- (void)_startWithSharedZone;	// IMP=0x0000000000218806
- (void)_startWithOwnedZone;	// IMP=0x00000000002186dc
- (void)updateParticipants;	// IMP=0x00000000002185c9
- (void)clearParticipants;	// IMP=0x00000000002184b6
- (id)queryPushTokensForDevicesObservingSubjectDevice:(id)arg1 subActivity:(id)arg2;	// IMP=0x0000000000218228
- (void)deregisterObserverDeviceIdentifier:(id)arg1;	// IMP=0x0000000000218014
- (void)deregisterObserverDeviceIdentifier:(id)arg1 observerPushToken:(id)arg2 subActivity:(id)arg3 subjectDeviceIdentifier:(id)arg4;	// IMP=0x0000000000217922
- (void)updateObserverDeviceIdentifier:(id)arg1 observerPushToken:(id)arg2;	// IMP=0x00000000002174fc
- (void)registerObserverDeviceIdentifier:(id)arg1 observerPushToken:(id)arg2 subActivity:(id)arg3 subjectDeviceIdentifier:(id)arg4;	// IMP=0x0000000000216ce6
- (void)destroyZone;	// IMP=0x0000000000216b30
- (void)_invalidate;	// IMP=0x00000000002169e9
- (void)registerForSharedUserDataModelUpdates:(id)arg1 modelID:(id)arg2;	// IMP=0x0000000000216988
- (void)registerForUserSupportsAutomaticHH2MigrationModelUpdates:(id)arg1 modelID:(id)arg2;	// IMP=0x00000000002168e2
- (id)loadUserSupportsAutomaticHH2MigrationModelWithModelID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000216834
- (void)registerForUserListeningHistoryUpdateControlModelUpdates:(id)arg1 modelID:(id)arg2;	// IMP=0x000000000021678e
- (id)loadUserListeningHistoryUpdateControlModelWithModelID:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002166e0
- (void)registerForMediaContentAccessControlModelUpdates:(id)arg1 modelID:(id)arg2;	// IMP=0x000000000021663a
- (id)loadMediaContentAccessControlModelWithModelID:(id)arg1 error:(id *)arg2;	// IMP=0x000000000021658c
- (void)registerForAssistantAccessControlModelUpdates:(id)arg1 modelID:(id)arg2;	// IMP=0x00000000002164e6
- (id)loadAssistantAccessControlModelWithModelID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000216310
- (id)loadSharedUserDataModelWithError:(id *)arg1;	// IMP=0x0000000000216263
- (id)loadPrivateUserDataModelWithError:(id *)arg1;	// IMP=0x00000000002161b6
- (void)start;	// IMP=0x0000000000215c46
- (id)initWithDelegate:(id)arg1 queue:(id)arg2 zoneName:(id)arg3 database:(id)arg4 shareMessenger:(id)arg5;	// IMP=0x0000000000215ab6
