...
+ (id)createEventWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00100000005f1788
- (void).cxx_destruct;	// IMP=0x00000000005f1757
...
- (id)initWithProcessMemoryState:(id)arg1 dataSyncState:(id)arg2;	// IMP=0x00000000005f1538
