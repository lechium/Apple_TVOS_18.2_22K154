...
- (_Bool)isValidValue:(id)arg1 error:(id *)arg2;	// IMP=0x00000000004f6989
- (id)initWithMaxValue:(long long)arg1 minValue:(long long)arg2 stepValue:(long long)arg3;	// IMP=0x00000000004f6936
