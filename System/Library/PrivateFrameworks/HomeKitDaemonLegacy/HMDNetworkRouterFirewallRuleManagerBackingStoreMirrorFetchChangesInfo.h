...
- (void).cxx_destruct;	// IMP=0x000000000084aee0
...
- (void)__cleanupMirroredZones:(id)arg1 cloudZones:(id)arg2 result:(id)arg3 error:(id)arg4;	// IMP=0x000000000084a6f9
- (void)finishWithResult:(id)arg1 error:(id)arg2;	// IMP=0x000000000084a2e7
- (void)markZonesDeleted;	// IMP=0x000000000084a2d6
- (void)markZonesChanged;	// IMP=0x000000000084a2c5
- (id)initWithActivity:(id)arg1 options:(id)arg2 databaseChangeToken:(id)arg3 promise:(id)arg4 xpcActivity:(id)arg5 database:(id)arg6 useAnonymousRequests:(_Bool)arg7 recordIDs:(id)arg8 lastSynchronizedRecordIDs:(id)arg9;	// IMP=0x0000000000849c03
