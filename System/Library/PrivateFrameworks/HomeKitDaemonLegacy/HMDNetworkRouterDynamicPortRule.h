...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000050b243
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x00100000004940a7
+ (id)ruleForHAP;	// IMP=0x0010000000493eec
- (void).cxx_destruct;	// IMP=0x000000000050a9d6
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000050a247
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000050a115
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000509ac0
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000005094c9
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 protocol:(id)arg3 advertisementProtocol:(id)arg4 flags:(id)arg5 serviceType:(id)arg6;	// IMP=0x00000000005093a2
- (id)init;	// IMP=0x0000000000509373
- (void)addTo:(id)arg1;	// IMP=0x0000000000491a9d
