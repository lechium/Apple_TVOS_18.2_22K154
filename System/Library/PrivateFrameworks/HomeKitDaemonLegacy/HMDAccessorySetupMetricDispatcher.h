...
+ (id)logCategory;	// IMP=0x0010000000b8e45c
- (void).cxx_destruct;	// IMP=0x0000000000b8c7fe
...
- (id)logIdentifier;	// IMP=0x0000000000b8c5c7
- (_Bool)hasHome:(id)arg1;	// IMP=0x0000000000b8c56b
- (void)addHome:(id)arg1;	// IMP=0x0000000000b8c278
@property(readonly) _Bool submitted;
- (void)markLanguageSettingObserved;	// IMP=0x0000000000b8c075
- (void)markFirstSettingObserved;	// IMP=0x0000000000b8bdeb
- (void)markAccessoryRemoved;	// IMP=0x0000000000b8bc18
- (void)markAccessoryAddCompleted;	// IMP=0x0000000000b8ba7d
- (void)markRepairSessionComplete;	// IMP=0x0000000000b8ba48
- (void)submit;	// IMP=0x0000000000b8ba3c
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000b8b768
- (void)didReceiveEvent:(id)arg1 topic:(id)arg2;	// IMP=0x0000000000b8b2f1
- (void)didReceiveCachedEvent:(id)arg1 topic:(id)arg2 source:(id)arg3;	// IMP=0x0000000000b8b2df
@property(readonly) id <HMDDeviceSetupTrackingInfo> trackingInfo;
- (void)updateTrackingInfo:(id)arg1;	// IMP=0x0000000000b8b238
- (id)initWithQueue:(id)arg1 trackingInfo:(id)arg2 setupSessionIdentifier:(id)arg3 homeManager:(id)arg4;	// IMP=0x0000000000b8b07c
- (id)initWithQueue:(id)arg1 discoveryController:(id)arg2 networkInfoController:(id)arg3 trackingInfo:(id)arg4 setupSessionIdentifier:(id)arg5 homeManager:(id)arg6 logEventSubmitter:(id)arg7 radarInitiator:(id)arg8 timerFactory:(CDUnknownBlockType)arg9;	// IMP=0x0000000000b8ae18
- (void)releaseDiscoveryAssertionWithAssertionHandle:(id)arg1;	// IMP=0x000000000001c8b0
- (id)obtainDiscoveryAssertion;	// IMP=0x000000000001c880
- (id)networkMetricWithDiscoveryController:(id)arg1 networkInfoController:(id)arg2 sessionID:(id)arg3 idsIdentifierString:(id)arg4 currentWiFiInfo:(id)arg5 currentWiFiNetworkRSSI:(int)arg6 numResidents:(long long)arg7 numAppleMediaAccessories:(long long)arg8 accessoryDiagnosticInfo:(id)arg9 primaryResidentIdsIdentifierString:(id)arg10 primaryResidentDiagnosticInfo:(id)arg11 homeUUID:(id)arg12 primaryResidentDiagnosticInfoFetched:(_Bool)arg13;	// IMP=0x000000000001c660
