...
@interface HMDAggregationAnalysisLogEvent : HMMLogEvent
{
    ...
    unsigned long long _v2ElectionCoordinationCurrentDeviceFlapCount;	// 752 = 0x2f0
    long long _v2ElectionPercentageDurationCurrentDeviceIsInPrimaryMesh;	// 760 = 0x2f8
    long long _primaryResidentDurationMinutes;	// 768 = 0x300
    unsigned long long _bulletinNotificationsPostedCount;	// 776 = 0x308
    unsigned long long _activeDaysPerMonthCount;	// 784 = 0x310
    long long _countOfDaysSinceLastActive;	// 792 = 0x318
    unsigned long long _widgetMaxRefreshCountForKind;	// 800 = 0x320
    HMDEventCountersManager *_eventCountersManager;	// 808 = 0x328
}

- (void).cxx_destruct;	// IMP=0x00000000000c8644
