...
+ (id)exitLogEvent:(double)arg1 isFalse:(_Bool)arg2 isInitial:(_Bool)arg3;	// IMP=0x001000000046f32f
+ (id)entryLogEvent:(double)arg1 isFalse:(_Bool)arg2 isInitial:(_Bool)arg3;	// IMP=0x001000000046f2e1
...
- (id)initWithReason:(unsigned long long)arg1 isFalse:(_Bool)arg2 lastFired:(double)arg3 isInitial:(_Bool)arg4;	// IMP=0x000000000046edb7
