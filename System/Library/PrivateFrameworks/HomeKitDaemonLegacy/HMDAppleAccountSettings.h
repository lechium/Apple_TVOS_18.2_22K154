...
+ (_Bool)supportsCloudSettings;	// IMP=0x0010000000716d2b
+ (id)sharedSettings;	// IMP=0x0010000000716cfb
+ (id)logCategory;	// IMP=0x00100000001e62c4
- (void)updateHomeEnabled:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000716c8c
- (void)synchronize;	// IMP=0x0000000000716c86
...
- (id)attributeDescriptions;	// IMP=0x00000000001e60ce
