...
- (void).cxx_destruct;	// IMP=0x00000000000e272a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e2630
- (id)initWithDevice:(id)arg1 accessoryList:(id)arg2;	// IMP=0x00000000000e258e
