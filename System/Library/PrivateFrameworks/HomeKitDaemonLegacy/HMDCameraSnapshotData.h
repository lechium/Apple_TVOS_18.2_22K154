...
- (void).cxx_destruct;	// IMP=0x00000000006e5762
...
- (void)dealloc;	// IMP=0x00000000006e56d6
- (id)initWithSnapshotFile:(id)arg1 videoResolution:(id)arg2;	// IMP=0x00000000006e55f2
- (id)initWithSnapshotData:(id)arg1 videoResolution:(id)arg2 snapshotDataTrasaction:(id)arg3;	// IMP=0x00000000006e5528
