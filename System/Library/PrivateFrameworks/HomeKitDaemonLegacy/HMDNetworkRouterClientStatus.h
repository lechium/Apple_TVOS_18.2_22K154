...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000517425
- (void).cxx_destruct;	// IMP=0x0000000000516a2e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000051629f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000051616d
- (id)serializeWithError:(id *)arg1;	// IMP=0x0000000000515b18
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000051551a
- (id)initWithClientIdentifier:(id)arg1 macAddress:(id)arg2 ipAddressList:(id)arg3 lanIdentifier:(id)arg4 name:(id)arg5 rssi:(id)arg6;	// IMP=0x00000000005153f3
- (id)init;	// IMP=0x00000000005153c4
