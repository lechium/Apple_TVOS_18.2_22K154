...
+ (id)logCategory;	// IMP=0x001000000006eb29
- (void).cxx_destruct;	// IMP=0x000000000006e95e
...
- (id)generateAccessCodeValueFromConstraints:(id)arg1 accessoryAccessCodes:(id)arg2 homeAccessCodes:(id)arg3;	// IMP=0x000000000006e8cb
- (id)hapAccessoryWithUUID:(id)arg1;	// IMP=0x000000000006e7e0
...
- (id)userWithUUID:(id)arg1;	// IMP=0x000000000006e56f
- (id)userForMessage:(id)arg1;	// IMP=0x000000000006e4f5
- (void)redispatchToResidentMessage:(id)arg1;	// IMP=0x000000000006e441
- (id)_performMockedReadRequests:(id)arg1;	// IMP=0x000000000006e267
- (id)performReadRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000006e0bc
- (id)performWriteRequests:(id)arg1 withRetries:(long long)arg2 timeInterval:(double)arg3 loggingObject:(id)arg4;	// IMP=0x000000000006df11
- (id)_performMockedWriteRequests:(id)arg1;	// IMP=0x000000000006dd37
...
- (void)configureWithMessageDispatcher:(id)arg1;	// IMP=0x000000000006d445
- (id)initWithHome:(id)arg1 workQueue:(id)arg2 UUID:(id)arg3;	// IMP=0x000000000006d2d4
- (id)initWithHome:(id)arg1 workQueue:(id)arg2;	// IMP=0x000000000006d213
