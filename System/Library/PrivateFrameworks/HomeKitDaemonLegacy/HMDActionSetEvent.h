...
@interface HMDActionSetEvent : HMMDatedHomeLogEvent
{
    struct os_unfair_lock_s _lock;	// 8 = 0x8
    unsigned int _numAccessoriesModified;	// 12 = 0xc
    unsigned int _numAccessoriesInHome;	// 16 = 0x10
    unsigned int _numNonEmptyScenesInHome;	// 20 = 0x14
...
- (void).cxx_destruct;	// IMP=0x00000000005e74ae
...
- (id)initWithActionSet:(id)arg1 source:(unsigned long long)arg2 numAccessories:(unsigned int)arg3 bundleId:(id)arg4 transactionId:(id)arg5;	// IMP=0x00000000005e6f1d
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x000000000004beb5
