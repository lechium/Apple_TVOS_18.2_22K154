...
+ (id)logCategory;	// IMP=0x00100000007dfdd8
- (void).cxx_destruct;	// IMP=0x00000000007df762
...
- (void)_backgroundTimerDidExpire:(id)arg1;	// IMP=0x00000000007df1f7
- (void)_removeBackgroundTimer:(id)arg1;	// IMP=0x00000000007df0b0
- (id)_enableBackgroundTimerWithBundleIdentifier:(id)arg1;	// IMP=0x00000000007dee2b
- (void)handleProcessWithBundleIdentifier:(id)arg1 updatedIsActive:(_Bool)arg2;	// IMP=0x00000000007dec3c
- (id)initWithQueue:(id)arg1 timerProvider:(id)arg2 applicationsAndIntervals:(id)arg3 dataSource:(id)arg4;	// IMP=0x00000000007deacb
