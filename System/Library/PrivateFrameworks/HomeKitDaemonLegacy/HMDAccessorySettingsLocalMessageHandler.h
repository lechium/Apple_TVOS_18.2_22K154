...
+ (id)logCategory;	// IMP=0x001000000061de10
- (void).cxx_destruct;	// IMP=0x000000000061ddc1
...
- (id)callerVersionForMessage:(id)arg1;	// IMP=0x000000000061db96
- (unsigned long long)dataSourceCallerPrivilegeWithMessage:(id)arg1 error:(id *)arg2;	// IMP=0x000000000061d991
- (void)handleAccessorySettingsUpdateRequestMessage:(id)arg1;	// IMP=0x000000000061d265
- (id)siriAvailableLanguagesSetting;	// IMP=0x000000000061d1d8
- (void)handleAccessorySettingsFetchRequestMessage:(id)arg1;	// IMP=0x000000000061c99a
- (id)initWithHomeUUID:(id)arg1 languageValuesDataProvider:(id)arg2;	// IMP=0x000000000061c8f8
