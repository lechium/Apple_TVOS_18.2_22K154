...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a2759
- (void).cxx_destruct;	// IMP=0x00000000000a26d3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a2483
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a1fee
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a1dac
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000a1a2e
@property(readonly, copy) NSData *tlvData;
- (id)initWithPayloadType:(id)arg1 maximumBitrate:(id)arg2 minimumBitrate:(id)arg3 rtcpInterval:(id)arg4 comfortNoisePayloadType:(id)arg5;	// IMP=0x00000000000a16f6
