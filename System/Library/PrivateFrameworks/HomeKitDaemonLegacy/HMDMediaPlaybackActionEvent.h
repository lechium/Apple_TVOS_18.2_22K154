...
- (void).cxx_destruct;	// IMP=0x00000000006bca82
...
- (id)initWithIsPlaybackArchivePresent:(_Bool)arg1 playbackStateNumber:(id)arg2 volumeNumber:(id)arg3 sourceNumber:(id)arg4 sourceClientName:(id)arg5 accessories:(id)arg6;	// IMP=0x00000000006bc354
- (id)biomeEventsRepresentationForLogObserver:(id)arg1;	// IMP=0x0000000000048d17
