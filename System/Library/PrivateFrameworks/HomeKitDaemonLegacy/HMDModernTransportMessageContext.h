...
+ (id)logCategory;	// IMP=0x0010000000616e82
- (void).cxx_destruct;	// IMP=0x00000000006169ec
...
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000616474
- (void)done;	// IMP=0x000000000061600d
- (void)startTransportFallbackTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000615e86
- (void)startResponseTimerWithTimeInterval:(double)arg1 queue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000615cff
- (double)timeoutRemaining;	// IMP=0x0000000000615c1b
- (id)preparedMessageWithTimeout:(double)arg1;	// IMP=0x000000000061585f
- (void)receivedResponseOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x00000000006157a2
- (void)completeSendingOverTransport:(id)arg1 withError:(id)arg2;	// IMP=0x00000000006150d8
- (void)startSendingOverTransport:(id)arg1;	// IMP=0x0000000000614c56
@property(readonly, copy, nonatomic) NSSet *inProgressTransports;
@property(readonly, nonatomic) _Bool expectsResponse;
@property(readonly, nonatomic) double timeout;
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5;	// IMP=0x0000000000614993
- (id)initWithMessage:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 dateProvider:(id)arg4 timerProvider:(id)arg5 activityFactory:(id)arg6 logEventSubmitter:(id)arg7;	// IMP=0x00000000006144ed
