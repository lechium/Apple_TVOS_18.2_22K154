...
+ (id)logCategory;	// IMP=0x0010000000bdb6e3
- (void).cxx_destruct;	// IMP=0x0000000000bdafdf
...
- (id)logIdentifier;	// IMP=0x0000000000bdaced
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000bdace7
- (void)updateReachableState:(_Bool)arg1;	// IMP=0x0000000000bdac6d
- (void)_resetSessionMetric;	// IMP=0x0000000000bda9bf
- (void)resetSessionMetric;	// IMP=0x0000000000bda94e
- (void)_submitMetric;	// IMP=0x0000000000bda416
- (void)submitMetric;	// IMP=0x0000000000bda3a5
- (void)_updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 bookkeeping:(id)arg4 withError:(id)arg5;	// IMP=0x0000000000bd9a7d
- (void)updateSessionState:(_Bool)arg1 linkLayerType:(long long)arg2 sessionInfo:(id)arg3 bookkeeping:(id)arg4 withError:(id)arg5;	// IMP=0x0000000000bd9959
...
- (_Bool)isCurrentPrimaryResident;	// IMP=0x0000000000bd96c7
@property(readonly, nonatomic) double sessionCheckIntervalSec;
- (id)attributeDescriptions;	// IMP=0x0000000000bd8e31
@property(readonly, copy, nonatomic) NSDictionary *state;
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2 hapSessionTTRTimer:(id)arg3 hapSessionTTRAllowList:(id)arg4 radarInitiator:(id)arg5;	// IMP=0x0000000000bd8653
- (id)initWithAccessory:(id)arg1 workQueue:(id)arg2;	// IMP=0x0000000000bd8580
