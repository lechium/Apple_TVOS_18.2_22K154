...
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0060000000a0ac87
- (void).cxx_destruct;	// IMP=0x0000000000a0ac54
...
- (id)initWithBuilder:(id)arg1;	// IMP=0x0000000000a0aab9
