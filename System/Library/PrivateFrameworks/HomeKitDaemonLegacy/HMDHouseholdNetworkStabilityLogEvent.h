...
- (id)initWithHomeUUID:(id)arg1 numStabilityReporters:(unsigned long long)arg2 WifiAssociations:(unsigned long long)arg3 wifiDisassociations:(unsigned long long)arg4 apChanges:(unsigned long long)arg5 gatewayChanges:(unsigned long long)arg6 numReadWrites:(unsigned long long)arg7 numReadErrors:(unsigned long long)arg8 numWriteErrors:(unsigned long long)arg9 numSessionErrors:(unsigned long long)arg10 numNetworkSignatures:(unsigned long long)arg11;	// IMP=0x00000000004c9518
