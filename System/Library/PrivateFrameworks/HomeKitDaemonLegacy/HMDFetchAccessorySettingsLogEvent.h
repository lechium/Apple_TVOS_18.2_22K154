...
- (void).cxx_destruct;	// IMP=0x0000000000833676
...
- (id)initWithKeyPaths:(id)arg1 startTime:(unsigned long long)arg2 requestingClientName:(id)arg3 error:(id)arg4;	// IMP=0x0000000000833093
