...
+ (_Bool)isRecordingSessionAlreadyInProgressError:(id)arg1;	// IMP=0x0010000000092057
- (void).cxx_destruct;	// IMP=0x0000000000092044
...
- (id)initWithAccessoryIdentifier:(id)arg1;	// IMP=0x0000000000091d30
