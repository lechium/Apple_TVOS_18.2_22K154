...
+ (id)logCategory;	// IMP=0x00100000004b4f6c
- (void).cxx_destruct;	// IMP=0x00000000004b4f5e
@property(readonly) __weak id <HMDSettingsControllerDependency> dependency; // @synthesize dependency=_dependency;
- (id)logIdentifier;	// IMP=0x00000000004b4ece
- (id)modelsFromMetadata:(id)arg1;	// IMP=0x00000000004b3334
- (id)initWithDependency:(id)arg1;	// IMP=0x00000000004b32d0
