...
- (void).cxx_destruct;	// IMP=0x00000000008008d9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000800864
- (unsigned long long)hash;	// IMP=0x0000000000800751
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000008004d9
- (id)attributeDescriptions;	// IMP=0x0000000000800262
@property(readonly, copy) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00000000007ff9c8
- (id)initWithData:(id)arg1 sequenceNumber:(id)arg2 fragmentSequenceNumber:(id)arg3 type:(id)arg4 isLast:(_Bool)arg5;	// IMP=0x00000000007ff82f
