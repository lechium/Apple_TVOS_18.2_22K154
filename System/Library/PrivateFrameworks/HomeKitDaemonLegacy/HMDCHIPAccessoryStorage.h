...
+ (id)logCategory;	// IMP=0x0010000000276648
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000276640
- (void).cxx_destruct;	// IMP=0x00000000002765a9
...
- (id)logIdentifier;	// IMP=0x00000000002763e3
- (id)attributeDescriptions;	// IMP=0x0000000000275e92
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000275b14
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000275882
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002756a3
- (unsigned long long)hash;	// IMP=0x0000000000275485
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002750f2
- (void)updateAccessoryModel:(id)arg1;	// IMP=0x0000000000274e7b
- (_Bool)updateUsingAccessoryModel:(id)arg1;	// IMP=0x0000000000273b25
