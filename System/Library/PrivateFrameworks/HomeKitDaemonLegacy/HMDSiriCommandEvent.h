...
+ (id)commandEventWithDuration:(unsigned long long)arg1 actionType:(id)arg2 outcome:(id)arg3 numberOfEntities:(unsigned long long)arg4 numberOfFailures:(unsigned long long)arg5 numberOfIncompletions:(unsigned long long)arg6 serverConfigurationVersion:(unsigned long long)arg7 configurationVersion:(unsigned long long)arg8 lastSyncedConfigurationVersion:(unsigned long long)arg9;	// IMP=0x00100000006211a4
+ (unsigned long long)generateErrorCodeWithNumberOfFailures:(unsigned long long)arg1 numberOfIncompletions:(unsigned long long)arg2 commandOutcome:(id)arg3;	// IMP=0x001000000062111f
- (void).cxx_destruct;	// IMP=0x00000000006210dd
...
- (long long)durationMilliseconds;	// IMP=0x0000000000620b39
- (double)duration;	// IMP=0x0000000000620b1e
- (id)initWithDuration:(unsigned long long)arg1 actionType:(id)arg2 outcome:(id)arg3 numberOfEntities:(unsigned long long)arg4 numberOfFailures:(unsigned long long)arg5 numberOfIncompletions:(unsigned long long)arg6 serverConfigurationVersion:(unsigned long long)arg7 configurationVersion:(unsigned long long)arg8 lastSyncedConfigurationVersion:(unsigned long long)arg9;	// IMP=0x00000000006207e4
