...
+ (id)properties;	// IMP=0x00600000005c4b61
@property(copy, nonatomic) HMDNaturalLightingContext *naturalLightingContext;
- (id)audioAnalysisClassifierOptions;	// IMP=0x00000000005c5794
- (void)setAudioAnalysisClassifierOptions:(id)arg1;	// IMP=0x00000000005c5782
