...
+ (id)infoWithTargetableAccessory:(id)arg1;	// IMP=0x00600000001e63c2
- (void).cxx_destruct;	// IMP=0x00000000001e63b4
...
- (_Bool)isActiveAndSupportsDragonSiri;	// IMP=0x00000000001e632b
