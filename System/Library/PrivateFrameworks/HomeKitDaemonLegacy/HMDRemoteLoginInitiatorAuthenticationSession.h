...
- (void).cxx_destruct;	// IMP=0x000000000049ec22
...
- (id)description;	// IMP=0x000000000049eb94
- (void)dealloc;	// IMP=0x000000000049ea8a
- (id)initWithSessionID:(id)arg1 remoteAuthentication:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000049e9d9
