...
- (void).cxx_destruct;	// IMP=0x0000000000b453fd
...
- (id)attributeDescriptions;	// IMP=0x0000000000b45205
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b451fa
- (id)initWithNaturalLightingEnabled:(_Bool)arg1 completion:(CDUnknownBlockType)arg2 retryCount:(unsigned long long)arg3;	// IMP=0x0000000000b45164
