...
- (void)submitSuccess;	// IMP=0x00000000005e6d2d
- (void)submitFailureWithReason:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000000005e6c9c
- (id)init;	// IMP=0x00000000005e6c6d
