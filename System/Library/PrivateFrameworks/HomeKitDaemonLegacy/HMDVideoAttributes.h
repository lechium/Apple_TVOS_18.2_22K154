...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000098ae2
+ (_Bool)translateImageResolution:(id)arg1 imageWidth:(id *)arg2 imageHeight:(id *)arg3;	// IMP=0x0010000000098a91
- (void).cxx_destruct;	// IMP=0x0000000000098a3e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000098917
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000098668
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000984ac
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000981a5
- (id)translateImageWidth:(id)arg1 imageHeight:(id)arg2;	// IMP=0x0000000000097ae1
- (id)initWithResolution:(id)arg1 framerate:(id)arg2;	// IMP=0x0000000000097974
