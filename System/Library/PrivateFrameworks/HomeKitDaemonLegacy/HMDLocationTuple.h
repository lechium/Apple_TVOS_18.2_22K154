...
- (void).cxx_destruct;	// IMP=0x000000000032d9f6
...
- (id)attributeDescriptions;	// IMP=0x000000000032d774
- (id)initWithLocation:(id)arg1 reachableIPAccessoryCount:(unsigned long long)arg2 reachableBTLEAccessoryCount:(unsigned long long)arg3 reachableMediaAccessoryCount:(unsigned long long)arg4;	// IMP=0x000000000032d6be
