...
+ (id)logCategory;	// IMP=0x00100000005d0f3f
- (void).cxx_destruct;	// IMP=0x00000000005d0eec
...
- (void)authenticate;	// IMP=0x00000000005d0e00
- (id)logIdentifier;	// IMP=0x00000000005d0dee
- (id)initWithSessionID:(id)arg1 remoteDevice:(id)arg2 workQueue:(id)arg3 remoteMessageSender:(id)arg4;	// IMP=0x00000000005d0cf1
