...
- (void).cxx_destruct;	// IMP=0x000000000046a0c2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000469ed4
- (id)description;	// IMP=0x0000000000469e17
- (id)initWithProfile:(id)arg1 level:(id)arg2 videoTier:(id)arg3;	// IMP=0x0000000000469d4d
