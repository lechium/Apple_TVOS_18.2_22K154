...
+ (id)logCategory;	// IMP=0x0010000000a2741c
- (void).cxx_destruct;	// IMP=0x0000000000a26ee5
...
- (void)_callFileTransferFailed:(id)arg1;	// IMP=0x0000000000a26cfa
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x0000000000a26b38
- (void)sessionStarted:(id)arg1;	// IMP=0x0000000000a2699c
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x0000000000a2680a
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x0000000000a26678
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x0000000000a2652d
- (void)dealloc;	// IMP=0x0000000000a263ae
- (void)_startDataTransfer;	// IMP=0x0000000000a260c1
- (void)sendIDSInvitation;	// IMP=0x0000000000a25bd0
- (void)_sendData;	// IMP=0x0000000000a25b37
- (void)sendData:(id)arg1;	// IMP=0x0000000000a2592d
- (id)initWithSessionID:(id)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3 device:(id)arg4 delegate:(id)arg5;	// IMP=0x0000000000a25793
