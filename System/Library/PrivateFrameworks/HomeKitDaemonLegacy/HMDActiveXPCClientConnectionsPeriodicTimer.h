...
+ (id)logCategory;	// IMP=0x0010000000604859
- (void).cxx_destruct;	// IMP=0x00000000006047e2
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006045c0
- (void)clientConnectionsManager:(id)arg1 didHandleDeactivationForClientConnection:(id)arg2;	// IMP=0x000000000060456d
- (void)clientConnectionsManager:(id)arg1 didHandleActivationForClientConnection:(id)arg2;	// IMP=0x000000000060451a
- (void)_updateTimer;	// IMP=0x00000000006042d5
- (void)_configure;	// IMP=0x0000000000604150
- (void)removeClientConnection:(id)arg1;	// IMP=0x00000000006040b8
- (void)addClientConnection:(id)arg1;	// IMP=0x0000000000604013
@property(readonly, copy) NSSet *clientConnections;
- (id)initWithTimer:(id)arg1 clientConnectionsManager:(id)arg2 logIdentifier:(id)arg3 workQueue:(id)arg4;	// IMP=0x0000000000603e22
- (id)initWithTimeInterval:(double)arg1 logIdentifier:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000603d47
