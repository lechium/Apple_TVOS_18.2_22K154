...
- (void).cxx_destruct;	// IMP=0x00000000009789c9
...
- (id)attributeDescriptions;	// IMP=0x00000000009787e6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000009787db
- (id)operationByMergingWithOperation:(id)arg1;	// IMP=0x00000000009786a4
- (id)initWithDeviceCredentialKey:(id)arg1 accessories:(id)arg2 user:(id)arg3;	// IMP=0x0000000000978479
- (id)initWithDeviceCredentialKey:(id)arg1 accessoriesUUIDs:(id)arg2 user:(id)arg3;	// IMP=0x000000000097838f
