...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a5383
- (void).cxx_destruct;	// IMP=0x00000000000a5341
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a522b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a4fda
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a4e8c
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000a4cf5
@property(readonly, copy) NSData *tlvData;
- (id)initWithMaximumBitrate:(id)arg1 minimumBitrate:(id)arg2 rtcpInterval:(id)arg3;	// IMP=0x00000000000a4afb
