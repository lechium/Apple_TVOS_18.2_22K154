...
- (void).cxx_destruct;	// IMP=0x00000000001f13ec
...
- (id)initWithReadCharacteristicType:(id)arg1 writeCharacteristicType:(id)arg2 format:(id)arg3 mandatory:(_Bool)arg4;	// IMP=0x00000000001f12ce
