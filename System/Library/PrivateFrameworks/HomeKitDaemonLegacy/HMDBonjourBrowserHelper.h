...
- (void).cxx_destruct;	// IMP=0x00000000007b711b
...
- (void)netServiceBrowser:(id)arg1 didStopBrowsingWithError:(id)arg2;	// IMP=0x00000000007b6df7
- (void)netServiceBrowser:(id)arg1 didRemoveService:(id)arg2;	// IMP=0x00000000007b6bf5
- (void)netServiceBrowser:(id)arg1 didAddService:(id)arg2;	// IMP=0x00000000007b69f3
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000007b6924
- (void)_updateTimerWithTimeout:(double)arg1;	// IMP=0x00000000007b67c1
- (void)_removeBrowser:(id)arg1;	// IMP=0x00000000007b674b
- (void)_addBrowser:(id)arg1;	// IMP=0x00000000007b66d5
@property(nonatomic) unsigned long long state; // @synthesize state=_state;
@property(readonly, nonatomic, getter=isStarted) _Bool started;
- (unsigned long long)discoveredServicesCountForServiceType:(id)arg1;	// IMP=0x00000000007b6520
- (void)_stopBrowsers;	// IMP=0x00000000007b6078
- (void)stop;	// IMP=0x00000000007b6007
- (_Bool)_startBrowsers;	// IMP=0x00000000007b5c72
- (void)startWithBrowsingCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000007b5bba
- (id)initWithServicesOfTypes:(id)arg1 browsingTimeInterval:(double)arg2 browsingPeriodicity:(double)arg3 workQueue:(id)arg4;	// IMP=0x00000000007b5933
