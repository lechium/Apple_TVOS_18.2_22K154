...
+ (id)logCategory;	// IMP=0x00100000006cbcf6
- (void).cxx_destruct;	// IMP=0x00000000006c7c20
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000006c774f
- (void)handleCameraSettingsDidUpdateNotification:(id)arg1;	// IMP=0x00000000006c7698
- (void)handleCharacteristicsChangedNotification:(id)arg1;	// IMP=0x00000000006c75e1
- (void)handleBulletinBoardNotificationDidUpdateNotification:(id)arg1;	// IMP=0x00000000006c752a
- (void)listener:(id)arg1 didUpdateAvailableCharacteristics:(id)arg2;	// IMP=0x00000000006c73c5
- (void)dealloc;	// IMP=0x00000000006c71e5
- (void)registerForMessages;	// IMP=0x00000000006c6fdd
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4 bulletinBoard:(id)arg5 notificationCenter:(id)arg6;	// IMP=0x00000000006c6a53
- (id)initWithSnapshotManager:(id)arg1 accessory:(id)arg2 workQueue:(id)arg3 msgDispatcher:(id)arg4;	// IMP=0x00000000006c694d
