...
- (void).cxx_destruct;	// IMP=0x00000000009ee910
...
- (id)attributeDescriptions;	// IMP=0x00000000009ee5b4
@property(readonly, getter=isExpired) _Bool expired;
@property(readonly, copy) NSUUID *deviceUUID;
- (id)initWithCameraUUID:(id)arg1 numberOfAvailableDevices:(long long)arg2 totalNumberOfJobSlots:(long long)arg3 remainingNumberOfJobSlots:(long long)arg4 analysisNode:(id)arg5 decisionDate:(id)arg6;	// IMP=0x00000000009ee393
