...
- (void).cxx_destruct;	// IMP=0x0000000000b17abd
...
- (id)initWithAutoMigrationEligibilityResult:(id)arg1 migrationByOwnerManualEligibilityResult:(id)arg2 migrationByOwnerAutoEligibilityResult:(id)arg3 didRunMigrationTaskOnCurrentBuild:(_Bool)arg4 currentBuildStartedOnHH1:(_Bool)arg5;	// IMP=0x0000000000b17235
