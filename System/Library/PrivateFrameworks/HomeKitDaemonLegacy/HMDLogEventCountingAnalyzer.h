...
- (void).cxx_destruct;	// IMP=0x00000000003526dc
...
- (void)deleteCountersAfterDate:(id)arg1;	// IMP=0x000000000035255e
- (void)deleteCountersBeforeDate:(id)arg1;	// IMP=0x00000000003524a3
- (void)runDailyTask;	// IMP=0x0000000000352432
- (void)incrementDailyCountersForEventName:(id)arg1;	// IMP=0x00000000003522e6
- (void)incrementPeriodicCountersForEventName:(id)arg1;	// IMP=0x0000000000352199
- (id)periodicSnapshotAtCurrentTickSeconds:(unsigned long long)arg1;	// IMP=0x00000000003520eb
- (void)didReceiveEventFromDispatcher:(id)arg1 withCurrentTickSeconds:(unsigned long long)arg2;	// IMP=0x0000000000351fbd
- (void)didReceiveEventFromDispatcher:(id)arg1;	// IMP=0x0000000000351f29
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5 loggingPeriodicitySeconds:(unsigned long long)arg6 tickSecondsProviderBlock:(CDUnknownBlockType)arg7 periodicCountersLoggingBlock:(CDUnknownBlockType)arg8;	// IMP=0x0000000000351d12
- (id)initWithEventCountersManager:(id)arg1 dailyScheduler:(id)arg2 dateProvider:(id)arg3 systemInfo:(id)arg4 queue:(id)arg5;	// IMP=0x0000000000351c6b
