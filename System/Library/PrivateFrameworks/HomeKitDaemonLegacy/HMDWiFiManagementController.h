...
+ (id)logCategory;	// IMP=0x001000000045afd0
+ (id)sharedPSKForNetworkWithSSID:(id)arg1;	// IMP=0x001000000045ad35
- (void).cxx_destruct;	// IMP=0x0000000000458c62
...
- (id)logIdentifier;	// IMP=0x0000000000458afb
- (void)_performWiFiConfigurationControlRequest:(id)arg1 withDescription:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000458404
- (void)_reconfigurationCompletedWithSuccess:(_Bool)arg1 error:(id)arg2;	// IMP=0x00000000004581d7
- (void)_commitConfigurationUpdate;	// IMP=0x000000000045809e
- (void)timerDidFire:(id)arg1;	// IMP=0x0000000000457ee8
- (void)_accessoryDidBecomeReachable:(id)arg1;	// IMP=0x0000000000457e77
- (void)safelyReconfigureWithSSID:(id)arg1 PSK:(id)arg2 verificationCallback:(CDUnknownBlockType)arg3 logEvent:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000457d0b
- (void)reconfigureWithSSID:(id)arg1 PSK:(id)arg2 logEvent:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000457bcd
@property(readonly) NSNotificationCenter *notificationCenter;
@property(readonly) _Bool supportsStationConfiguration;
@property(readonly) long long capabilities;
- (id)initWithAccessory:(id)arg1 wiFiTransportService:(id)arg2 workQueue:(id)arg3;	// IMP=0x0000000000457a68
