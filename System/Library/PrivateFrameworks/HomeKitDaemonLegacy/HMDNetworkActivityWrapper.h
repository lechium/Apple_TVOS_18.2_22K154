...
- (void).cxx_destruct;	// IMP=0x0000000000b95b8f
...
- (id)childActivityWithLabel:(unsigned long long)arg1 createIfNeeded:(_Bool)arg2;	// IMP=0x0000000000b9598f
- (void)submitMetrics:(id)arg1 withName:(id)arg2;	// IMP=0x0000000000b957a6
- (void)completeWithSuccess:(_Bool)arg1;	// IMP=0x0000000000b9575b
- (void)setParent:(id)arg1;	// IMP=0x0000000000b95690
- (void)activate;	// IMP=0x0000000000b9565b
...
- (id)initWithLabel:(unsigned long long)arg1;	// IMP=0x0000000000b95520
