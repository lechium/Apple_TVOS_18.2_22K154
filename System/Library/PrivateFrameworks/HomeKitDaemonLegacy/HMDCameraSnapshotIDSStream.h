...
+ (id)logCategory;	// IMP=0x0010000000617afd
- (void).cxx_destruct;	// IMP=0x0000000000617aaa
...
- (id)logIdentifier;	// IMP=0x0000000000617a02
- (void)dealloc;	// IMP=0x00000000006178ce
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 proxyService:(id)arg3;	// IMP=0x0000000000617702
