...
- (void).cxx_destruct;	// IMP=0x00000000009b1c1b
...
- (id)description;	// IMP=0x00000000009b1b33
- (id)initWithSnapshotCharacteristicEventUUID:(id)arg1 snapshotFile:(id)arg2 timer:(id)arg3;	// IMP=0x00000000009b1a69
