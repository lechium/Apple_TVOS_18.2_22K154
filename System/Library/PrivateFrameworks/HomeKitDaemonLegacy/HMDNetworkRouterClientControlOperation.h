...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000513daf
- (void).cxx_destruct;	// IMP=0x0000000000513d87
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000513a95
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000513a07
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000051373e
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000051340c
- (id)initWithOperation:(id)arg1 configuration:(id)arg2;	// IMP=0x0000000000513373
- (id)init;	// IMP=0x0000000000513344
