...
+ (id)logCategory;	// IMP=0x00100000003a1edf
- (void).cxx_destruct;	// IMP=0x00000000003a1e75
...
- (id)logIdentifier;	// IMP=0x00000000003a1dd6
- (id)dataSourceAccessoryWithUUID:(id)arg1;	// IMP=0x00000000003a1c75
- (void)handleSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x00000000003a15ce
- (id)initWithIdentifier:(id)arg1 assistantSettingsConnection:(id)arg2;	// IMP=0x00000000003a1513
