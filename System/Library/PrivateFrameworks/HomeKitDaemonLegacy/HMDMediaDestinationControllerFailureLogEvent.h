...
- (void).cxx_destruct;	// IMP=0x000000000070b587
...
- (id)initWithDestinationControllerErrorCode:(id)arg1 errorCode:(id)arg2 errorDomain:(id)arg3 isTriggeredOnControllerDevice:(id)arg4 userPrivilege:(id)arg5;	// IMP=0x000000000070b26f
