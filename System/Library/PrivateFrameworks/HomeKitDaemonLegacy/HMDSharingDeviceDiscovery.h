...
- (void).cxx_destruct;	// IMP=0x0000000000586ee5
@property(retain, nonatomic) SFDeviceDiscovery *deviceDiscovery; // @synthesize deviceDiscovery=_deviceDiscovery;
- (void)repairDevice:(id)arg1 flags:(unsigned int)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000586e05
- (void)stop;	// IMP=0x0000000000586dab
- (void)start;	// IMP=0x0000000000586d67
...
- (void)dealloc;	// IMP=0x00000000005868ac
