...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000009ef02
- (void).cxx_destruct;	// IMP=0x000000000009eec0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009ed75
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009eae5
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x000000000009e952
- (_Bool)_parseFromTLVData;	// IMP=0x000000000009e715
@property(readonly, copy) NSData *tlvData;
- (_Bool)isCompatibleWithRemoteEndPointAddress:(id)arg1;	// IMP=0x000000000009e4ea
- (id)initWithIPAddress:(id)arg1 isIPv6Address:(_Bool)arg2 videoRTPPort:(id)arg3 audioRTPPort:(id)arg4;	// IMP=0x000000000009e411
