...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000076dfc4
- (void).cxx_destruct;	// IMP=0x000000000076df91
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000076dbb1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000076daf9
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000076d73d
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000076d3f2
- (id)initWithOperationType:(id)arg1 operationStatus:(id)arg2 backoffTime:(id)arg3;	// IMP=0x000000000076d33a
- (id)init;	// IMP=0x000000000076d30b
