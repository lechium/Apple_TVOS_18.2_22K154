...
@interface HMDHomeConfigurationLogEvent : HMMHomeLogEvent
{
    ...
    _Bool _isSmokeAlarmEnabled;	// 20 = 0x14
    _Bool _isSiriPhraseOptionsHeySiriEnabled;	// 21 = 0x15
    _Bool _isSiriPhraseOptionsJustSiriEnabled;	// 22 = 0x16
    ...
    NSString *_oldestTVOSVersionInHome;	// 872 = 0x368
    NSString *_oldestTVOSBuildInHome;	// 880 = 0x370
    NSString *_primaryResidentVersionInHome;	// 888 = 0x378
    NSString *_primaryResidentBuildInHome;	// 896 = 0x380
}

- (void).cxx_destruct;	// IMP=0x000000000052d541
...
- (void)updateConfigWithAccessory:(id)arg1 reportNetworkProtectionMetrics:(_Bool)arg2 networkProtectionEnabled:(_Bool)arg3 hapServiceTypes:(id)arg4 primaryHAPServiceTypes:(id)arg5;	// IMP=0x0000000000528f00
- (id)initWithDataSource:(id)arg1 home:(id)arg2 configuredWidgetsCount:(long long)arg3;	// IMP=0x0000000000526b60
- (id)initWithHome:(id)arg1 configuredWidgetsCount:(long long)arg2;	// IMP=0x0000000000526b48
- (long long)weeksSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000526ae2
- (long long)daysSinceDate:(id)arg1 trimAtMaximumValue:(unsigned long long)arg2;	// IMP=0x0000000000526a1b
- (void)setHomeConfigurationBitMasks;	// IMP=0x00000000005268ff
