...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000099e6d
- (void).cxx_destruct;	// IMP=0x0000000000099cfb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000099be5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000099981
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000997b5
@property(readonly, copy) NSData *tlvData;
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000993cc
- (id)initWithCodec:(id)arg1 codecParameters:(id)arg2 attributes:(id)arg3;	// IMP=0x0000000000099302
