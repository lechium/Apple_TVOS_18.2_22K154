...
+ (id)logCategory;	// IMP=0x0010000000b78c48
- (void).cxx_destruct;	// IMP=0x0000000000b78949
...
- (void)_pumpReadDataIfPossible;	// IMP=0x0000000000b78715
- (void)_closeSession;	// IMP=0x0000000000b7863b
- (void)asyncHandleRemoteCloseWithError:(id)arg1;	// IMP=0x0000000000b78583
- (void)asyncHandleIncomingPackets:(id)arg1 isEof:(_Bool)arg2;	// IMP=0x0000000000b784cc
- (void)read:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b7838c
- (void)cancelWithReason:(unsigned short)arg1;	// IMP=0x0000000000b782fb
@property(readonly, getter=isActive) _Bool active;
- (void)dealloc;	// IMP=0x0000000000b781b5
- (id)initWithProtocol:(id)arg1 sessionIdentifier:(id)arg2 queue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x0000000000b78076
