...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003848d
- (void).cxx_destruct;	// IMP=0x0000000000038444
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003832c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003815f
@property(readonly, copy) NSString *name;
@property(readonly, copy) id value;
- (id)initWithIdentifier:(id)arg1 parentIdentifier:(id)arg2 type:(id)arg3 numberValue:(id)arg4 dataValue:(id)arg5;	// IMP=0x0000000000037e8b
