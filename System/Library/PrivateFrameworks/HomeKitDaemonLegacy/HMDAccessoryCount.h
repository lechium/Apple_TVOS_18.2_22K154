...
- (void).cxx_destruct;	// IMP=0x00000000004e3e0d
@property __weak HMDHome *home; // @synthesize home=_home;
- (unsigned long long)numHAPAccessoriesWithAnyServiceWithTypes:(id)arg1;	// IMP=0x00000000004e3c54
...
- (id)initWithHome:(id)arg1;	// IMP=0x00000000004e3848
