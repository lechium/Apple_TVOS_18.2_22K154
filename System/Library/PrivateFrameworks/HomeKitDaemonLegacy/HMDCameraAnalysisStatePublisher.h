...
+ (id)logCategory;	// IMP=0x001000000031b630
...
- (void)timerDidFire:(id)arg1;	// IMP=0x000000000031b1cb
@property(readonly, nonatomic) NSObject<OS_dispatch_queue> *messageReceiveQueue;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSObject<OS_dispatch_queue>",?,R,N

@property(readonly, nonatomic) NSUUID *messageTargetUUID;
- (void)stateManager:(id)arg1 didReceiveLocalUpdate:(id)arg2;	// IMP=0x000000000031afd6
- (void)_handleRemoteAnalysisStateUpdate:(id)arg1;	// IMP=0x000000000031ad17
- (void)_publishAnalysisStateUpdate;	// IMP=0x000000000031a9af
- (void)_processStateUpdate:(id)arg1;	// IMP=0x000000000031a849
- (void)configureWithHome:(id)arg1;	// IMP=0x000000000031a622
- (id)initWithHomeMessagingContext:(id)arg1 analysisStateManager:(id)arg2 workQueue:(id)arg3 cameraAnalysisStatePublisherDebounceTimer:(id)arg4;	// IMP=0x000000000031a538
- (id)initWithHome:(id)arg1;	// IMP=0x000000000031a442
