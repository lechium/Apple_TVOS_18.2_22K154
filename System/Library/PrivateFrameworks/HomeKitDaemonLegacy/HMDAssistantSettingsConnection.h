...
+ (id)logCategory;	// IMP=0x00100000002effc5
- (void).cxx_destruct;	// IMP=0x00000000002efddc
...
- (id)deleteSiriHistoryOperationWithConnection:(id)arg1;	// IMP=0x00000000002efd4c
- (id)connectionForEndpointUUID:(id)arg1;	// IMP=0x00000000002efc52
- (void)deleteSiriHistoryWithEndpointUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000002ef7c6
- (id)initWithScheduler:(id)arg1;	// IMP=0x00000000002ef758
