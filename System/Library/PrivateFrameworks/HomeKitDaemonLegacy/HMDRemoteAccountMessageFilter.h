...
+ (id)logCategory;	// IMP=0x0060000000601687
- (void).cxx_destruct;	// IMP=0x0000000000601634
...
- (id)logIdentifier;	// IMP=0x0000000000601545
- (_Bool)acceptMessage:(id)arg1 target:(id)arg2 errorReason:(id *)arg3;	// IMP=0x000000000060093d
- (id)initWithTarget:(id)arg1 allowedMessages:(id)arg2 appleAccountManager:(id)arg3 systemKeychainStore:(id)arg4;	// IMP=0x0000000000600802
- (id)initWithTarget:(id)arg1 allowedMessages:(id)arg2;	// IMP=0x0000000000600742
- (id)initWithTarget:(id)arg1;	// IMP=0x000000000060072e
- (id)initWithName:(id)arg1;	// IMP=0x000000000060067a
