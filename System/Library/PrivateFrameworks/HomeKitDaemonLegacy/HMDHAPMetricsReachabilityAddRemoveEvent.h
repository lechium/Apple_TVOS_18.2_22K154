...
- (void).cxx_destruct;	// IMP=0x00000000009756ec
...
- (id)coreAnalyticsEventDictionary;	// IMP=0x00000000009755e3
- (id)coreAnalyticsEventName;	// IMP=0x00000000009755d6
- (id)initWithAccessory:(id)arg1 hmdAddRemoveEvent:(unsigned long long)arg2 forLinkType:(id)arg3;	// IMP=0x000000000097554c
