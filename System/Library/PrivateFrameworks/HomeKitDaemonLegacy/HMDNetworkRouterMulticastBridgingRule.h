...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000050dad4
+ (id)ruleFromFirewallRuleLAN:(id)arg1;	// IMP=0x0010000000493218
- (void).cxx_destruct;	// IMP=0x000000000050da96
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000050d570
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000050d491
- (id)serializeWithError:(id *)arg1;	// IMP=0x000000000050d004
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000050cb6e
- (id)initWithDirection:(id)arg1 lanIdentifierList:(id)arg2 destinationIPAddress:(id)arg3 destinationPort:(id)arg4;	// IMP=0x000000000050ca86
- (id)init;	// IMP=0x000000000050ca57
- (void)addTo:(id)arg1;	// IMP=0x0000000000491755
