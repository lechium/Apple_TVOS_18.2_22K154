...
+ (id)denominatorSpecifyingEvent;	// IMP=0x00100000000c897b
- (void).cxx_destruct;	// IMP=0x00000000000c8968
...
- (id)initWithAccessoryDetailsType:(unsigned long long)arg1 accessoryCategoryIdentifier:(id)arg2 homeUUID:(id)arg3;	// IMP=0x00000000000c8675
