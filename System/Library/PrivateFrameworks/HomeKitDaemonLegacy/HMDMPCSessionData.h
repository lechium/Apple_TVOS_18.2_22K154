...
- (void).cxx_destruct;	// IMP=0x00000000008214d3
...
- (id)dictionaryRepresentation:(_Bool)arg1;	// IMP=0x0000000000820c3a
- (id)initWithMediaAction:(id)arg1 source:(id)arg2 clientName:(id)arg3;	// IMP=0x0000000000820ada
- (id)initWithDictionaryRepresentation:(id)arg1 profileSource:(id)arg2;	// IMP=0x0000000000820022
- (id)initWithMediaProfiles:(id)arg1 playbackState:(id)arg2 playbackVolume:(id)arg3 playbackArchive:(id)arg4 source:(id)arg5 clientName:(id)arg6;	// IMP=0x000000000081fc0d
