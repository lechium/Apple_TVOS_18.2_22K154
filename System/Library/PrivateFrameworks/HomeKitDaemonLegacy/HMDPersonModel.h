...
+ (id)sentinelParentUUID;	// IMP=0x00400000006da741
+ (id)hmbProperties;	// IMP=0x00400000006da711
- (id)createPerson;	// IMP=0x00000000006dade3
- (id)initWithPerson:(id)arg1;	// IMP=0x00000000006dacce
