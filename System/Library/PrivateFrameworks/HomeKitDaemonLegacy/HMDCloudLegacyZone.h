...
+ (void)createLegacyZoneWithName:(id)arg1 owner:(id)arg2 cacheZone:(id)arg3 cloudCache:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0060000000347cb1
+ (id)zoneSubscriptionName:(id)arg1;	// IMP=0x0060000000347ca4
+ (id)zoneRootRecordName;	// IMP=0x0060000000347c85
- (void).cxx_destruct;	// IMP=0x0000000000347c10
- (void)setServerChangeToken:(id)arg1;	// IMP=0x0000000000347bcf
- (id)createCloudZoneChangeTemporaryCache:(_Bool)arg1;	// IMP=0x0000000000347b96
- (void)dropCachedRecords;	// IMP=0x0000000000347afe
- (id)createCloudRecordWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x0000000000347591
- (id)homeDataV3ModelWithPushDataPush:(id)arg1;	// IMP=0x0000000000347578
- (id)homeDataModelWithPushDataPush:(id)arg1;	// IMP=0x000000000034755c
- (id)metadataModelWithPushDataPush:(id)arg1;	// IMP=0x0000000000347543
...
- (_Bool)doesProcessChangeEvenIfDecryptionFails;	// IMP=0x00000000003470cd
