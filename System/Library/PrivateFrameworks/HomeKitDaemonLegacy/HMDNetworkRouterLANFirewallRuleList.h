...
+ (id)parsedFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000050db81
- (void).cxx_destruct;	// IMP=0x0000000000505896
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000505370
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000505291
- (id)serializeWithError:(id *)arg1;	// IMP=0x00000000005049cc
- (_Bool)parseFromData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000504414
- (id)initWithMulticastBridgingRules:(id)arg1 staticPortRules:(id)arg2 dynamicPortRules:(id)arg3 staticICMPRules:(id)arg4;	// IMP=0x000000000050432c
- (id)init;	// IMP=0x00000000005042fd
