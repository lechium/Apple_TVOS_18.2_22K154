...
- (void).cxx_destruct;	// IMP=0x0000000000803657
...
- (id)doorbellMessagePayloadWithChimeMode:(long long)arg1 chimeDate:(id)arg2 personIdentificationText:(id)arg3 accessoryUUID:(id)arg4;	// IMP=0x0000000000803474
- (void)handleDoorbellChimeMessage:(id)arg1;	// IMP=0x0000000000802fa2
- (void)sendDoorbellChimeMessageWithChimeMode:(long long)arg1 chimeDate:(id)arg2 personIdentificationText:(id)arg3 accessoryUUID:(id)arg4;	// IMP=0x00000000008028dd
- (void)registerForMessages;	// IMP=0x0000000000802672
- (id)initWithAppleMediaAccessory:(id)arg1;	// IMP=0x000000000080252f
