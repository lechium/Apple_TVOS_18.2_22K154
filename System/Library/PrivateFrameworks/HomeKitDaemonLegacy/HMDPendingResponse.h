...
+ (id)tupleForMessage:(id)arg1 originalRequestIdentifier:(id)arg2 requestCount:(unsigned long long)arg3 withCompletionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00600000000e20ca
- (void).cxx_destruct;	// IMP=0x00000000000e2066
...
- (id)retrieveAndClearLatestResponses;	// IMP=0x00000000000e1ebd
- (id)retrieveAndClearAllResponses;	// IMP=0x00000000000e1e07
- (void)addResponsesToPendingResponse:(id)arg1;	// IMP=0x00000000000e1d37
- (void)addToPendingResponses:(id)arg1;	// IMP=0x00000000000e1c6f
- (id)description;	// IMP=0x00000000000e1bae
