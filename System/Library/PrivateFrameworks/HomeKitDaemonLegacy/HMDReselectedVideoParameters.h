...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a5b53
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a5a52
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a5892
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a5728
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000a554e
@property(readonly, copy) NSData *tlvData;
- (id)initWithAttribute:(id)arg1 rtpParameter:(id)arg2;	// IMP=0x00000000000a538b
