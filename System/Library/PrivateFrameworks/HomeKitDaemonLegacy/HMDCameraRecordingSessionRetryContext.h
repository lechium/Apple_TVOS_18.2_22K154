...
- (void).cxx_destruct;	// IMP=0x00000000005d1817
...
- (void)computeNextRetryInterval;	// IMP=0x00000000005d170e
@property double retryInterval; // @synthesize retryInterval=_retryInterval;
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2 preferences:(id)arg3;	// IMP=0x00000000005d1423
- (id)initWithWorkQueue:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000005d138c
