...
- (void).cxx_destruct;	// IMP=0x000000000049e913
...
- (id)initWithAction:(id)arg1 characteristicWriteRequests:(id)arg2;	// IMP=0x000000000049e845
- (id)init;	// IMP=0x000000000049e79d
