...
+ (id)logCategory;	// IMP=0x006000000059cb18
- (void).cxx_destruct;	// IMP=0x000000000059bea0
...
- (void)runHouseholdMetricsDataCollectionAssociatedToDate:(id)arg1 forceSubmit:(_Bool)arg2;	// IMP=0x000000000059b714
- (void)sendHouseholdMetricsCollectionRequestToDevices:(id)arg1 forHomeWithUUID:(id)arg2 associatedToDate:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000059b0c7
- (_Bool)evaluateMetricResponsesForSubmission:(id)arg1;	// IMP=0x000000000059ae97
- (_Bool)evaluateHouseholdActivityLogEventForSubmission:(id)arg1;	// IMP=0x000000000059ae7a
- (id)initWithDataSource:(id)arg1 logEventSubmitter:(id)arg2 householdMetricsProvider:(id)arg3 remoteMessageDispatcher:(id)arg4 logEventFactories:(id)arg5 workQueue:(id)arg6;	// IMP=0x000000000059ad66
