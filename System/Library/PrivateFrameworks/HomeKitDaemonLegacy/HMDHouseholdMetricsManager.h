...
+ (id)logCategory;	// IMP=0x001000000067e4c0
- (void).cxx_destruct;	// IMP=0x000000000067e44b
...
- (void)runHomeutilTask;	// IMP=0x000000000067e348
- (void)runDailyTask;	// IMP=0x000000000067e27e
- (void)handleRequest:(id)arg1;	// IMP=0x000000000067e215
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 dailyScheduler:(id)arg3 logEventSubmitter:(id)arg4 dateProvider:(id)arg5 requestCountProvider:(id)arg6 logEventFactories:(id)arg7;	// IMP=0x000000000067df55
- (id)initWithCountersManager:(id)arg1 dataSource:(id)arg2 accessoryDetailsManager:(id)arg3 dailyScheduler:(id)arg4 logEventSubmitter:(id)arg5 dateProvider:(id)arg6 activityContributors:(id)arg7;	// IMP=0x000000000067db24
