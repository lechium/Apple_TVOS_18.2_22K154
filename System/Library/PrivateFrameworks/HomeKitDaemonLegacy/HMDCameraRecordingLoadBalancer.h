...
+ (id)logCategory;	// IMP=0x0010000000b81b1e
- (void).cxx_destruct;	// IMP=0x0000000000b80011
...
- (void)systemResourceUsageDidChangeTo:(long long)arg1;	// IMP=0x0000000000b7fcb4
- (void)handleResidentMeshInitialized:(id)arg1;	// IMP=0x0000000000b7fb4b
- (void)_updateReadyToRecordMetric;	// IMP=0x0000000000b7fa5d
- (id)_loadBalancingDescriptionFromSortedNodes:(id)arg1;	// IMP=0x0000000000b7f97f
- (unsigned long long)_jobSlotLimitForDevice:(id)arg1;	// IMP=0x0000000000b7f92a
- (_Bool)_isDeviceB620InOdeonConfiguration:(id)arg1;	// IMP=0x0000000000b7f4f4
- (id)_loadBalancingDecisionForCamera:(id)arg1 deviceFilter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b7e057
- (void)handleRecordingSessionForwardingFailureForDecision:(id)arg1;	// IMP=0x0000000000b7de6d
- (void)handleRecordingSessionForwardingSuccessForDecision:(id)arg1;	// IMP=0x0000000000b7dae5
- (id)loadBalancingDecisionForCamera:(id)arg1 deviceFilter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b7da48
- (void)removeDataForCameraWithUUID:(id)arg1;	// IMP=0x0000000000b7d891
- (void)setReadyToRecord:(_Bool)arg1 forCameraWithUUID:(id)arg2;	// IMP=0x0000000000b7d685
- (_Bool)isReadyToRecordForCameraWithUUID:(id)arg1;	// IMP=0x0000000000b7d599
- (void)recordingDidEndForCameraWithUUID:(id)arg1;	// IMP=0x0000000000b7d130
- (void)recordingDidStartForCameraWithUUID:(id)arg1;	// IMP=0x0000000000b7cf11
- (void)start;	// IMP=0x0000000000b7ce20
- (id)initWithHomeManager:(id)arg1 resourceUsageMonitor:(id)arg2;	// IMP=0x0000000000b7cc8a
