...
- (void).cxx_destruct;	// IMP=0x000000000069e4c0
...
- (id)description;	// IMP=0x000000000069e2b6
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 delayRespected:(_Bool)arg3;	// IMP=0x000000000069e29e
- (id)initWithOperationType:(unsigned long long)arg1 zoneName:(id)arg2 cloudConflict:(_Bool)arg3 delayRespected:(_Bool)arg4;	// IMP=0x000000000069e1e9
