...
+ (id)logCategory;	// IMP=0x0010000000494f01
- (void).cxx_destruct;	// IMP=0x0000000000494d82
...
- (void)_sendImageSendFailure:(id)arg1;	// IMP=0x0000000000494914
- (id)logIdentifier;	// IMP=0x00000000004948c4
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 device:(id)arg3 accessory:(id)arg4 delegateQueue:(id)arg5 uniqueIdentifier:(id)arg6;	// IMP=0x000000000049473b
