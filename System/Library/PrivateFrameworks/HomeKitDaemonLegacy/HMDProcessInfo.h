...
+ (id)logCategory;	// IMP=0x0010000000a050e5
+ (id)locationAuthorizationFromEffectiveBundleIdentifier:(id)arg1 processInfo:(id)arg2;	// IMP=0x0010000000a04ff0
+ (id)privateClientIdentifierSalt;	// IMP=0x0010000000a04fc0
- (void).cxx_destruct;	// IMP=0x0000000000a04edd
...
- (id)logIdentifier;	// IMP=0x0000000000a04dfa
- (id)clientIdentifierSalt:(id *)arg1;	// IMP=0x0000000000a04d15
...
- (void)setState:(unsigned long long)arg1;	// IMP=0x0000000000a04bf3
@property(readonly) unsigned long long state; // @synthesize state=_state;
- (void)_updateState:(unsigned long long)arg1;	// IMP=0x0000000000a04ba5
@property(readonly) _Bool shouldMonitor;
- (id)attributeDescriptions;	// IMP=0x0000000000a0496e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a04845
- (id)initWithAuditToken:(CDStruct_6ad76789)arg1;	// IMP=0x0000000000a04242
- (id)init;	// IMP=0x0000000000a0419a
