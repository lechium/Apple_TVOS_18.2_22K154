...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x0000000000945b16
- (id)coreAnalyticsEventDictionary;	// IMP=0x0000000000945869
- (id)coreAnalyticsEventName;	// IMP=0x000000000094585c
- (id)initWithHome:(id)arg1;	// IMP=0x00000000009457fa
