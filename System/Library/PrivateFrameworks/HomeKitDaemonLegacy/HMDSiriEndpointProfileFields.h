...
- (void).cxx_destruct;	// IMP=0x0000000000750f2c
...
- (id)attributeDescriptions;	// IMP=0x0000000000750b93
- (id)serializeFields;	// IMP=0x000000000075099a
- (id)initWithNeedsOnboardingField:(id)arg1 supportsOnboardingField:(id)arg2 siriEnableField:(id)arg3 siriListeningField:(id)arg4 siriTouchToUseField:(id)arg5 siriLightOnUseField:(id)arg6 siriSoundOnUseField:(id)arg7;	// IMP=0x0000000000750787
