...
- (void).cxx_destruct;	// IMP=0x000000000023cc1b
...
- (id)dumpDebug;	// IMP=0x000000000023c98a
- (id)initWithGroupID:(long long)arg1 zone:(id)arg2 rootRecord:(id)arg3 serverChangeToken:(id)arg4 subscriptionName:(id)arg5 owner:(id)arg6 subscription:(id)arg7;	// IMP=0x000000000023c828
