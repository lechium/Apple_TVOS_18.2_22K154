...
+ (id)logCategory;	// IMP=0x00100000004d7008
- (void).cxx_destruct;	// IMP=0x00000000004d6e0e
...
- (id)logIdentifier;	// IMP=0x00000000004d6d54
- (void)routeSiriEndpointDeleteSiriHistoryMessage:(id)arg1;	// IMP=0x00000000004d6beb
- (void)sendDeleteSiriHistoryRequestForAccessoryWithUUID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000004d6956
- (void)registerForMessagesWithHome:(id)arg1;	// IMP=0x00000000004d672c
- (id)initWithIdentifier:(id)arg1 messageDispatcher:(id)arg2 router:(id)arg3 localHandler:(id)arg4;	// IMP=0x00000000004d65d7
