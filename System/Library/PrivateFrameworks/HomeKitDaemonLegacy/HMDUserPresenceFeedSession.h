...
+ (id)logCategory;	// IMP=0x00100000003e508f
- (void).cxx_destruct;	// IMP=0x00000000003e4bfa
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003e4958
- (id)logIdentifier;	// IMP=0x00000000003e4946
- (void)_callDelegate;	// IMP=0x00000000003e4885
- (void)_handleStatusUpdateMessageError:(id)arg1 responseTime:(double)arg2;	// IMP=0x00000000003e476d
- (void)_send;	// IMP=0x00000000003e38d8
- (void)send;	// IMP=0x00000000003e3867
- (id)attributeDescriptions;	// IMP=0x00000000003e3637
- (void)dealloc;	// IMP=0x00000000003e34d5
- (id)initWithDelegate:(id)arg1 workQueue:(id)arg2 targetUUID:(id)arg3 messageDispatcher:(id)arg4 user:(id)arg5 presenceAuthStatus:(id)arg6 presenceComputeStatus:(id)arg7 presenceRegionStatus:(id)arg8 reason:(id)arg9;	// IMP=0x00000000003e31a7
