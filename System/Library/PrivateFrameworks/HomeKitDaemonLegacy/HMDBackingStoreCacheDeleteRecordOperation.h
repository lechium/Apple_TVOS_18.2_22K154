...
- (void).cxx_destruct;	// IMP=0x000000000023e658
...
- (id)mainReturningError;	// IMP=0x000000000023e1dc
- (id)initWithGroup:(id)arg1 recordNames:(id)arg2 resultBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000023e126
