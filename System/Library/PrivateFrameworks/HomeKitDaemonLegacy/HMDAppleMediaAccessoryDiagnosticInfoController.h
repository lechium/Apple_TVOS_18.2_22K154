...
+ (id)diagnosticInfoDescriptionWithData:(id)arg1;	// IMP=0x00600000007c1b6c
- (void).cxx_destruct;	// IMP=0x00000000007c1b5e
...
- (id)diagnosticInfoDataWithAdditionalKeys:(id)arg1;	// IMP=0x00000000007c1aed
- (id)_diagnosticInfoWithAdditionalKeys:(id)arg1;	// IMP=0x00000000007c0a91
- (id)initWithDataSource:(id)arg1 isHH2Mode:(_Bool)arg2;	// IMP=0x00000000007c0a22
