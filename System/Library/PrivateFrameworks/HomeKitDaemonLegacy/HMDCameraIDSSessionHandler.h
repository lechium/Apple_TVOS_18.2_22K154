...
+ (id)logCategory;	// IMP=0x00100000006e54c1
- (void).cxx_destruct;	// IMP=0x00000000006e546e
...
- (id)logIdentifier;	// IMP=0x00000000006e53c6
- (void)startKeepAlive;	// IMP=0x00000000006e53c0
- (void)dealloc;	// IMP=0x00000000006e528d
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2;	// IMP=0x00000000006e5147
