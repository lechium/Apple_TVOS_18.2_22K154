...
- (void).cxx_destruct;	// IMP=0x000000000024b511
...
- (_Bool)addFragmentChunk:(id)arg1 error:(id *)arg2;	// IMP=0x000000000024ae84
- (id)attributeDescriptions;	// IMP=0x000000000024ac0f
- (id)initWithSequenceNumber:(id)arg1 type:(id)arg2;	// IMP=0x000000000024a9ff
