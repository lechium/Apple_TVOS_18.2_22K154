...
- (id)initWithStartTime:(double)arg1 homeUUID:(id)arg2;	// IMP=0x000000000001da00
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x000000000001d900
...
- (id)initWithHome:(id)arg1 nodeId:(unsigned long long)arg2 endpointId:(id)arg3 clusterId:(id)arg4 attributeId:(id)arg5 value:(id)arg6 timedWriteTimeout:(id)arg7;	// IMP=0x000000000001d570
