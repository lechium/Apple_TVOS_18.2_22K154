...
+ (id)properties;	// IMP=0x00600000005c6316
+ (id)defaultModelForHomeUUID:(id)arg1;	// IMP=0x00600000005c624a
+ (id)modelIDForHomeUUID:(id)arg1;	// IMP=0x00600000005c616d
+ (id)modelNamespace;	// IMP=0x00600000005c613d
