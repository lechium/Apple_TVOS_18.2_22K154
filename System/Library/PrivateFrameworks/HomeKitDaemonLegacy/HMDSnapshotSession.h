...
+ (id)logCategory;	// IMP=0x0010000000786e46
- (void).cxx_destruct;	// IMP=0x0000000000786de2
...
- (void)respond:(id)arg1 payload:(id)arg2;	// IMP=0x00000000007868f8
- (void)dealloc;	// IMP=0x000000000078687c
- (id)logIdentifier;	// IMP=0x000000000078682c
- (id)initWithSessionID:(id)arg1 accessory:(id)arg2 snapshotGetter:(id)arg3 message:(id)arg4 waitPeriod:(double)arg5 streamingTierType:(unsigned long long)arg6 cameraLocallyReachable:(_Bool)arg7 snapshotForNotification:(_Bool)arg8;	// IMP=0x0000000000786655
