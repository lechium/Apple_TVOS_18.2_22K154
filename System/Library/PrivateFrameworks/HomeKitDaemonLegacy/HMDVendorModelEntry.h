...
- (void).cxx_destruct;	// IMP=0x0000000000b134b5
...
- (unsigned long long)hash;	// IMP=0x0000000000b131d7
- (long long)compare:(id)arg1;	// IMP=0x0000000000b130e1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b12d0c
- (id)attributeDescriptions;	// IMP=0x0000000000b12a0d
- (id)initWithManufacturer:(id)arg1 model:(id)arg2 appBundleID:(id)arg3 appStoreID:(id)arg4 firmwareVersion:(id)arg5 productData:(id)arg6 productDataAlternates:(id)arg7;	// IMP=0x0000000000b1280d
