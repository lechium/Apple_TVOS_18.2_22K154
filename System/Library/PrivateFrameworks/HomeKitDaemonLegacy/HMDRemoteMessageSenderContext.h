...
- (void).cxx_destruct;	// IMP=0x0000000000a2ba18
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a2b978
@property(readonly, copy) NSString *propertyDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

@property(readonly, copy) NSString *mergeID;
- (id)initWithDeviceHandle:(id)arg1 accountHandle:(id)arg2 accountIdentifier:(id)arg3 deviceVersion:(id)arg4 pairingIdentityIdentifier:(id)arg5;	// IMP=0x0000000000a2b693
