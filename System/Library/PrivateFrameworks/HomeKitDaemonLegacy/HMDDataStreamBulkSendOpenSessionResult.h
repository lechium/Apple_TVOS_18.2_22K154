...
- (void).cxx_destruct;	// IMP=0x0000000000bd12fc
...
- (id)attributeDescriptions;	// IMP=0x0000000000bd11ca
- (id)initWithSession:(id)arg1 payload:(id)arg2;	// IMP=0x0000000000bd1131
