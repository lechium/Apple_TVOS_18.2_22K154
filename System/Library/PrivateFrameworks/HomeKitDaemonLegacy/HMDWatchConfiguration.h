...
- (void).cxx_destruct;	// IMP=0x0000000000a41d98
...
- (void)setConfigVersion:(id)arg1 forHome:(id)arg2;	// IMP=0x0000000000a41c3c
- (void)setHomeConfiguration:(id)arg1;	// IMP=0x0000000000a419ad
- (id)description;	// IMP=0x0000000000a418ed
- (id)initWithUniqueID:(id)arg1;	// IMP=0x0000000000a41838
