...
+ (id)localizedBodyForEcosystemName:(id)arg1 accessoryName:(id)arg2;	// IMP=0x00600000006e4f84
+ (id)localizedBodyForAppleEcosystemWithAccessoryName:(id)arg1;	// IMP=0x00600000006e4dcc
+ (id)localizedBodyForAccessoryName:(id)arg1;	// IMP=0x00600000006e4c14
+ (id)localizedTitle;	// IMP=0x00600000006e4c03
- (void).cxx_destruct;	// IMP=0x00000000006e4b9f
...
- (id)attributeDescriptions;	// IMP=0x00000000006e487e
- (id)initWithAddedPairing:(id)arg1 accessory:(id)arg2;	// IMP=0x00000000006e41e3
- (id)initWithTitle:(id)arg1 body:(id)arg2 threadIdentifier:(id)arg3 dateOfOccurrence:(id)arg4 userInfo:(id)arg5 isTimeSensitive:(_Bool)arg6;	// IMP=0x00000000006e3ff1
