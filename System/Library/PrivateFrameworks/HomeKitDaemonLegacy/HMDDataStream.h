...
+ (id)logCategory;	// IMP=0x0010000000343be5
- (void).cxx_destruct;	// IMP=0x0000000000342be7
...
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003428c4
- (void)transport:(id)arg1 didReceiveRawFrame:(id)arg2;	// IMP=0x0000000000340f86
- (void)transportDidOpen:(id)arg1;	// IMP=0x0000000000340ba1
- (void)transportDidClose:(id)arg1;	// IMP=0x000000000034089d
- (void)transport:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x000000000034054a
- (void)setTrafficClass:(unsigned long long)arg1;	// IMP=0x0000000000340422
- (void)protocolDidUpdateActiveStatus:(id)arg1;	// IMP=0x0000000000340418
- (void)sendRequestForProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000340101
- (void)sendRequestForProtocol:(id)arg1 topic:(id)arg2 identifier:(unsigned long long)arg3 payload:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000000340005
- (void)sendResponseForRequestHeader:(id)arg1 payload:(id)arg2 status:(unsigned short)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000033ff6c
- (void)sendEventForProtocol:(id)arg1 topic:(id)arg2 payload:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000033fda0
- (id)protocolDelegateHandle;	// IMP=0x000000000033fd97
- (id)protocolWithName:(id)arg1;	// IMP=0x000000000033fcee
- (void)addProtocol:(id)arg1 name:(id)arg2;	// IMP=0x000000000033fc5d
- (void)close;	// IMP=0x000000000033fa2b
- (void)connect;	// IMP=0x000000000033f857
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
- (id)initWithTransport:(id)arg1 sessionEncryption:(id)arg2 workQueue:(id)arg3 logIdentifier:(id)arg4 connectionTimer:(id)arg5 helloMessageResponseTimer:(id)arg6;	// IMP=0x000000000033f51a
- (id)initWithTransport:(id)arg1 sessionEncryption:(id)arg2 workQueue:(id)arg3 logIdentifier:(id)arg4;	// IMP=0x000000000033f3fa
