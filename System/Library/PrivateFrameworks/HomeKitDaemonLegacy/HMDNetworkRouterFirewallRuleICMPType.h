...
+ (id)createListWithJSONDictionary:(id)arg1 key:(id)arg2;	// IMP=0x006000000083ba4c
+ (id)createWithJSONDictionary:(id)arg1;	// IMP=0x006000000083b83a
- (void).cxx_destruct;	// IMP=0x000000000083b812
...
- (id)description;	// IMP=0x000000000083b69c
@property(readonly, nonatomic) NSDictionary *prettyJSONDictionary;
- (unsigned long long)hash;	// IMP=0x000000000083b4b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000083b348
- (id)initWithJSONDictionary:(id)arg1 protocol:(unsigned char)arg2 typeValue:(id)arg3;	// IMP=0x000000000083b2a5
