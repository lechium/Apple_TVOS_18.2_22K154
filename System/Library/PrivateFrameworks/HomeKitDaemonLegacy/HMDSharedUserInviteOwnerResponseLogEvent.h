...
- (unsigned long long)coreAnalyticsEventOptions;	// IMP=0x000000000088fdd3
- (id)coreAnalyticsEventDictionary;	// IMP=0x000000000088fc06
- (id)coreAnalyticsEventName;	// IMP=0x000000000088fbf9
- (id)initWithHomeUUID:(id)arg1;	// IMP=0x000000000088fbca
