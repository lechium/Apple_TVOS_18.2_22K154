...
+ (id)logCategory;	// IMP=0x00100000003b2ec4
- (void).cxx_destruct;	// IMP=0x00000000003b1925
...
- (id)logIdentifier;	// IMP=0x00000000003b1806
- (void)_callSessionEndedWithError:(id)arg1;	// IMP=0x00000000003b1752
- (void)_socketOpenedWithError:(id)arg1;	// IMP=0x00000000003b169e
- (void)timerDidFire:(id)arg1;	// IMP=0x00000000003b138d
- (void)startKeepAlive;	// IMP=0x00000000003b1324
- (void)_createStreamSocketWithDevice:(id)arg1;	// IMP=0x00000000003afc74
- (void)dealloc;	// IMP=0x00000000003afbcd
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 idsProxyStreamService:(id)arg3;	// IMP=0x00000000003af9ad
