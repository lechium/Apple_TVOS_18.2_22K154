...
+ (id)logCategory;	// IMP=0x00100000007bb0c1
- (void).cxx_destruct;	// IMP=0x00000000007bb01b
...
- (id)logIdentifier;	// IMP=0x00000000007baf02
- (void)_sendMessageWithName:(id)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000007badaf
- (void)_sendConfirmationToResident:(CDUnknownBlockType)arg1;	// IMP=0x00000000007babcd
- (void)_sendRequestWithTierType:(unsigned long long)arg1 toResident:(CDUnknownBlockType)arg2;	// IMP=0x00000000007ba85a
- (id)initWithSessionID:(id)arg1 workQueue:(id)arg2 accessory:(id)arg3 delegateQueue:(id)arg4 uniqueIdentifier:(id)arg5 snapshotRequestHandler:(id)arg6 residentMessageHandler:(id)arg7 remoteDevice:(id)arg8;	// IMP=0x00000000007ba609
