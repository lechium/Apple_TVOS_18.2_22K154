...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000a400f
- (void).cxx_destruct;	// IMP=0x00000000000a3fbc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000a3e60
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000a3b7e
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x00000000000a3966
- (_Bool)_parseFromTLVData;	// IMP=0x00000000000a36a8
@property(readonly, copy) NSData *tlvData;
- (id)initWithCodecGroup:(id)arg1 codecParameter:(id)arg2 rtpParameter:(id)arg3 comfortNoiseEnabled:(id)arg4;	// IMP=0x00000000000a33ea
