...
+ (id)shortDescription;	// IMP=0x00100000007c0a10
- (void).cxx_destruct;	// IMP=0x00000000007c09bd
...
- (void)replayChange:(id)arg1 stagedChange:(id)arg2;	// IMP=0x00000000007c0156
- (void)resetRecord;	// IMP=0x00000000007c0117
- (void)updateChangeWithRecord:(id)arg1;	// IMP=0x00000000007c00ae
@property(readonly, nonatomic) CKRecordID *recordID;
@property(readonly, nonatomic) NSString *type;
@property(readonly, nonatomic) NSString *recordName;
@property(readonly, nonatomic) CKRecord *record;
- (void)updateWithObjectChange:(id)arg1;	// IMP=0x00000000007bf67f
- (void)updateDeletedCloudRecord:(id)arg1;	// IMP=0x00000000007bf566
- (void)updateCloudRecord:(id)arg1;	// IMP=0x00000000007beff7
- (void)forceChangeToInvalid;	// IMP=0x00000000007befe3
- (void)forceChangeToDelete;	// IMP=0x00000000007beef3
...
- (id)shortDescription;	// IMP=0x00000000007beaf9
- (id)initWithCloudObjectRecord:(id)arg1;	// IMP=0x00000000007beae2
- (id)initWithObjectChange:(id)arg1;	// IMP=0x00000000007beace
- (id)_initWithObjectChange:(id)arg1 cloudObjectRecord:(id)arg2;	// IMP=0x00000000007be771
- (id)init;	// IMP=0x00000000007be6c9
