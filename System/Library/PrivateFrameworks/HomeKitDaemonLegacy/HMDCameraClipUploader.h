...
+ (id)logCategory;	// IMP=0x00100000009e23b0
- (void).cxx_destruct;	// IMP=0x00000000009e1fae
...
- (id)attributeDescriptions;	// IMP=0x00000000009e1ca0
- (_Bool)_isCancelledError:(id)arg1;	// IMP=0x00000000009e1c16
- (void)_handleFatalOperationFailureDueToError:(id)arg1;	// IMP=0x00000000009e19bd
- (void)_startNextOperation;	// IMP=0x00000000009e1870
- (void)_operationCompleted:(id)arg1 finalizeOnError:(_Bool)arg2 future:(id)arg3;	// IMP=0x00000000009e15bf
- (id)_addOperation:(id)arg1 finalizeClipOnError:(_Bool)arg2;	// IMP=0x00000000009e130a
- (id)_createClipWithSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000009e113d
- (id)_createClip;	// IMP=0x00000000009e0fb6
- (_Bool)hasAddedCreateClipOperation;	// IMP=0x00000000009e0f83
- (id)finish;	// IMP=0x00000000009e0e87
- (id)addVideoSegmentData:(id)arg1 duration:(double)arg2 timeOffsetWithinClip:(double)arg3 clipFinalizedBecauseMaxDurationExceeded:(_Bool)arg4;	// IMP=0x00000000009e0b76
- (id)addVideoInitData:(id)arg1;	// IMP=0x00000000009e08c4
- (id)addNotificationForSignificantEvent:(id)arg1 homePresenceByPairingIdentity:(id)arg2;	// IMP=0x00000000009e057a
- (id)createClip;	// IMP=0x00000000009e038b
@property(readonly, copy) NSDictionary *stateDump;
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7 encryptionManager:(id)arg8 factory:(id)arg9;	// IMP=0x00000000009dff56
- (id)initWithClipUUID:(id)arg1 startDate:(id)arg2 targetFragmentDuration:(double)arg3 quality:(long long)arg4 localZone:(id)arg5 workQueue:(id)arg6 logIdentifier:(id)arg7;	// IMP=0x00000000009dfe3f
