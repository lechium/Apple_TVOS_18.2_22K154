...
+ (void)setSupportsSecureCoding:(_Bool)arg1;	// IMP=0x00100000000d55a0
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000d5563
- (void).cxx_destruct;	// IMP=0x00000000000d7fc1
@property(nonatomic, readonly) NSString *description;
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d752c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d6340
- (id)init;	// IMP=0x00000000000d5524
