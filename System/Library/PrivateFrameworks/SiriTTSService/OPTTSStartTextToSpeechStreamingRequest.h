...
- (void).cxx_destruct;	// IMP=0x0000000000119819
- (id)flatbuffData;	// IMP=0x0000000000119702
- (Offset_acd6b661)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000118b4f
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000118213
- (unsigned long long)context_info_count;	// IMP=0x0000000000118177
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000118057
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000117be6
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000117a03
- (id)initWithFlatbuffData:(id)arg1 root:(const struct StartTextToSpeechStreamingRequest *)arg2;	// IMP=0x00000000001179ee
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x00000000001179d4
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x00000000001179bd
