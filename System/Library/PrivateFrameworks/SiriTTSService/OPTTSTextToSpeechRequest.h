...
- (id)flatbuffData;	// IMP=0x00000000001167b2
- (Offset_91732649)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000115cb5
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000115379
- (unsigned long long)context_info_count;	// IMP=0x00000000001152dd
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001151bd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000114dba
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x0000000000114586
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2;	// IMP=0x0000000000114571
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x0000000000114557
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000114540
