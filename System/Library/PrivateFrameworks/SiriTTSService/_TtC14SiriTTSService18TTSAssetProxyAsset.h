...
- (void).cxx_destruct;	// IMP=0x000000000006a0c8
- (id)init;	// IMP=0x000000000006a095
@property(nonatomic, readonly) long long purgeCondition;
- (void)setPurgeCondition:(long long)arg1;	// IMP=0x00000000000699db
- (void)purgeImmediately:(_Bool)arg1;	// IMP=0x00000000000695dd
- (void)purge;	// IMP=0x0000000000069244
- (void)cancelDownloadingThen:(CDUnknownBlockType)arg1;	// IMP=0x00000000000691c8
- (void)downloadWithReservation:(id)arg1 useBattery:(_Bool)arg2 progress:(CDUnknownBlockType)arg3 then:(CDUnknownBlockType)arg4;	// IMP=0x0000000000068683
