...
- (void).cxx_destruct;	// IMP=0x0000000000830260
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000082fee0
- (void)tintColorDidChange;	// IMP=0x000000000082fce0
- (void)layoutSubviews;	// IMP=0x000000000082fcb0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000082fae0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000082fac0
- (id)viewForBaselineLayout;	// IMP=0x000000000082faa0
