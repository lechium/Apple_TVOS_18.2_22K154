...
- (void).cxx_destruct;	// IMP=0x00000000006d7ff0
- (void)dismissButtonTapped:(id)arg1;	// IMP=0x00000000006d6c60
- (void)actionItemButtonTapped:(id)arg1;	// IMP=0x00000000006d6c10
- (void)layoutSubviews;	// IMP=0x00000000006d58c0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000006d5460
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000006d5430
