...
- (void).cxx_destruct;	// IMP=0x00000000005be4c0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000005be3d0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005be3b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005be380
