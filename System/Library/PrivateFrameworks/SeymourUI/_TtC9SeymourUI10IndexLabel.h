...
- (void).cxx_destruct;	// IMP=0x0000000000315b80
- (void)textSizeUpdated:(id)arg1;	// IMP=0x00000000003157d0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000315650
- (void)layoutSubviews;	// IMP=0x0000000000315620
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000315430
