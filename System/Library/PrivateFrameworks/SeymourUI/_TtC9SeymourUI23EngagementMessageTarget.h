...
- (void).cxx_destruct;	// IMP=0x0000000000468cd0
- (id)init;	// IMP=0x0000000000468c50
@property(nonatomic, readonly) _Bool shouldBeNotifiedOfNilPriorityMessageAfterRegistration;
- (void)messageCoordinator:(id)arg1 didUpdatePriorityMessage:(id)arg2 forTarget:(id)arg3;	// IMP=0x0000000000468dc0
