...
+ (long long)activityCategory;	// IMP=0x0040000000620c30
- (void).cxx_destruct;	// IMP=0x0000000000621460
- (id)init;	// IMP=0x0000000000621400
- (void)performActivity;	// IMP=0x00000000006213d0
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x0000000000620f60
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000620e20
