...
- (void).cxx_destruct;	// IMP=0x000000000085ef70
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000000862a50
- (void)switchTappedWithCellSwitch:(id)arg1;	// IMP=0x00000000008621a0
- (void)updateSettings;	// IMP=0x0000000000861760
- (void)viewDidLoad;	// IMP=0x0000000000860320
- (void)dealloc;	// IMP=0x000000000085eed0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000085ee30
- (id)tableView:(id)arg1 titleForFooterInSection:(long long)arg2;	// IMP=0x0000000000863110
- (id)tableView:(id)arg1 titleForHeaderInSection:(long long)arg2;	// IMP=0x00000000008630e0
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000863020
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0000000000862af0
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0000000000862a90
