...
+ (long long)activityCategory;	// IMP=0x00400000000849f0
- (void).cxx_destruct;	// IMP=0x0000000000084f10
- (id)init;	// IMP=0x0000000000084eb0
- (void)performActivity;	// IMP=0x0000000000084e80
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x0000000000084cd0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000084b90
