...
- (void).cxx_destruct;	// IMP=0x00000000005cced0
- (void)doneButtonTapped;	// IMP=0x00000000005cce80
- (void)startButtonTapped;	// IMP=0x00000000005cce60
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005ccd30
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000005ccd00
