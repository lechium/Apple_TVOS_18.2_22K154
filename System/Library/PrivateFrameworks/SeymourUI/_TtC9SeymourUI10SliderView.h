...
- (void).cxx_destruct;	// IMP=0x000000000093e390
- (void)panGestureRecognized:(id)arg1;	// IMP=0x000000000093e1f0
- (void)layoutSubviews;	// IMP=0x000000000093da20
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000093d850
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000093d820
