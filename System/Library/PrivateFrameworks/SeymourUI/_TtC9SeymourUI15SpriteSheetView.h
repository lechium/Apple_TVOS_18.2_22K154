...
- (void).cxx_destruct;	// IMP=0x00000000002e7eb0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002e7de0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002e7d50
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000002e6f60
