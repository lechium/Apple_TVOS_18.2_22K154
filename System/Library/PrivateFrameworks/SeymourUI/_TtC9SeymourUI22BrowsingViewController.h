...
- (void).cxx_destruct;	// IMP=0x000000000098fee0
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x000000000098fe80
- (id)initWithRootViewController:(id)arg1;	// IMP=0x000000000098fdb0
- (id)initWithNavigationBarClass:(Class)arg1 toolbarClass:(Class)arg2;	// IMP=0x000000000098fd10
- (void)scrollToTop;	// IMP=0x000000000098fc50
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000098f150
@property(nonatomic, readonly) long long preferredStatusBarStyle;
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000000098f0a0
- (void)viewDidLoad;	// IMP=0x000000000098eca0
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000098ec80
