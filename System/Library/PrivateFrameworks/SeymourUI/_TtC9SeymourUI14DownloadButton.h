...
- (void).cxx_destruct;	// IMP=0x0000000000941580
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000940350
- (void)tintColorDidChange;	// IMP=0x000000000093ffb0
- (void)layoutSubviews;	// IMP=0x000000000093fe00
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000093fb40
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000093fb10
@property(nonatomic) _Bool highlighted;
- (_Bool)isHighlighted;	// IMP=0x000000000093f1d0
