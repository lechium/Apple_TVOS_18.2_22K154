...
- (void).cxx_destruct;	// IMP=0x00000000003407e0
- (void)doneButtonTapped;	// IMP=0x0000000000340790
- (void)startButtonTapped;	// IMP=0x0000000000340770
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000340360
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000340330
