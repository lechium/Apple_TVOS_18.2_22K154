...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001e21
...
- (id)description;	// IMP=0x0000000000001ce4
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001af4
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001a5f
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001870
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001f5f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001e29
