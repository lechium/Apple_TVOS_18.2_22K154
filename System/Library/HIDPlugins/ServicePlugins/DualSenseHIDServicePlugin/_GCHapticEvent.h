...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000002049
...
- (id)description;	// IMP=0x0000000000001f0c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001d1c
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001c87
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001a98
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002187
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002051
