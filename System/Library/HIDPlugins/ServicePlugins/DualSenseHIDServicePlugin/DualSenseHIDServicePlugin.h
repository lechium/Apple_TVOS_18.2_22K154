...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x00100000000075fd
...
- (void)requestSensorCalibrationInfo;	// IMP=0x00000000000083eb
- (void)requestFirmwareInfo;	// IMP=0x0000000000007b75
- (void)determineSupportMode;	// IMP=0x0000000000007872
- (id)initWithService:(unsigned int)arg1;	// IMP=0x00000000000076ba
