...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001d45
...
- (id)description;	// IMP=0x0000000000001c08
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001a18
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001983
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001794
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000001e83
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001d4d
