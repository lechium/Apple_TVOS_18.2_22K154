...
+ (id)classesForKey;	// IMP=0x0060000000056f1c
- (void).cxx_destruct;	// IMP=0x00000000000570f6
@property(copy, nonatomic) CalLocation *calLocation; // @synthesize calLocation=_calLocation;
- (id)createStructuredLocation;	// IMP=0x0000000000057071
- (id)initWithStructuredLocation:(id)arg1;	// IMP=0x0000000000056fdc
