...
- (void).cxx_destruct;	// IMP=0x000000000013c874
...
- (void)finishWithURL:(id)arg1 error:(id)arg2;	// IMP=0x000000000013c668
- (void)generateNewValidURLForOriginalURL:(id)arg1;	// IMP=0x000000000013c323
