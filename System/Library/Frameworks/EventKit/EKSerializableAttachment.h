...
+ (id)classesForKey;	// IMP=0x0060000000100657
- (void).cxx_destruct;	// IMP=0x000000000010070c
...
- (id)createAttachment;	// IMP=0x0000000000100693
- (id)initWithAttachment:(id)arg1;	// IMP=0x0000000000100664
