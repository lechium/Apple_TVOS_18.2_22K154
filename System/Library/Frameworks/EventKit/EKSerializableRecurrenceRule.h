...
+ (id)classesForKey;	// IMP=0x0060000000087a07
- (void).cxx_destruct;	// IMP=0x00000000000883db
...
- (id)createRecurrenceRule:(id *)arg1;	// IMP=0x000000000008815a
- (id)initWithRecurrenceRule:(id)arg1;	// IMP=0x0000000000087e3a
