...
- (void)mapViewDidChangeEdgeInsets:(MKMapView *)arg1;
...
- (void)mapViewDidScrollToRevealAnnotationCallout:(MKMapView *)arg1;
- (_Bool)mapViewShouldDelaySelectionAccessoryPresentation:(MKMapView *)arg1;
