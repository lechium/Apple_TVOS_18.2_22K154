...
@interface _TtC15_MapKit_SwiftUI17MapBridgingMarker : NSObject
{
    ...
    MISSING_TYPE *isCustomFeature;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x000000000005eaf0
- (id)init;	// IMP=0x000000000005eaa0
- (id)_representedMapItem;	// IMP=0x000000000005ea80
