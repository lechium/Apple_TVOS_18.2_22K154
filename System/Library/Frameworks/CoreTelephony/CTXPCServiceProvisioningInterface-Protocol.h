...
@class CTDedicatedBearerRequest, CTSatelliteMessagingProvisioningReceipt, CTTransportKeysReceipt, NSString;
...
- (void)reprovisionSatelliteMsg:(_Bool)arg1 completion:(void (^)(NSError *))arg2;
- (void)setSatelliteMsgCfgUpdated:(CTSatelliteMessagingProvisioningReceipt *)arg1 completion:(void (^)(NSError *))arg2;
- (void)getSatelliteMsgCfgToUpdate:(void (^)(CTSatelliteMessagingProvisioning *, NSError *))arg1;
