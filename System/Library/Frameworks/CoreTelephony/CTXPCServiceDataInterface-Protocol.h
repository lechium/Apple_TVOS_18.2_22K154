...
- (void)requestSliceDeactivation:(NSString *)arg1 completion:(void (^)(NSError *))arg2;
- (void)requestSliceByUUID:(NSString *)arg1 completion:(void (^)(CTXPCServiceSubscriptionContext *, int, NSString *, NSError *))arg2;
