...
- (void).cxx_destruct;	// IMP=0x00000000001c389b
...
- (_Bool)isExecuting;	// IMP=0x00000000001c3825
- (_Bool)isFinished;	// IMP=0x00000000001c3815
- (void)start;	// IMP=0x00000000001c3721
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001c3624
