...
+ (id)connectionWithWorkQueue:(id)arg1 connectBlock:(CDUnknownBlockType)arg2;	// IMP=0x00600000004d643b
- (void).cxx_destruct;	// IMP=0x00000000004d7756
...
- (void)callSubscriptionEstablishedHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000004d76c7
- (void)handleReportWithController:(id)arg1 nodeId:(unsigned long long)arg2 values:(id)arg3 error:(id)arg4;	// IMP=0x00000000004d73a6
- (void)deregisterReportHandlersWithController:(id)arg1 nodeID:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000004d6d98
- (void)registerReportHandlerWithController:(id)arg1 nodeID:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x00000000004d6abf
- (void)getProxyHandleWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000004d64c8
- (id)initWithWorkQueue:(id)arg1 connectBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000004d62f5
