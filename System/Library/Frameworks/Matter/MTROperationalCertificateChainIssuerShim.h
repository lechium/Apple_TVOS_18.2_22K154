...
- (void).cxx_destruct;	// IMP=0x000000000019b9a1
...
- (void)issueOperationalCertificateForRequest:(id)arg1 attestationInfo:(id)arg2 controller:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000000019b3e6
- (id)initWithIssuer:(id)arg1;	// IMP=0x000000000019b362
