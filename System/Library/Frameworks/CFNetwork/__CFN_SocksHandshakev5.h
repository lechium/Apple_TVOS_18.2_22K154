...
- (void).cxx_destruct;	// IMP=0x0000000000151c32
- (id)finish:(int)arg1;	// IMP=0x0000000000151a64
- (_Bool)parse:(const char *)arg1 len:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000015108b
