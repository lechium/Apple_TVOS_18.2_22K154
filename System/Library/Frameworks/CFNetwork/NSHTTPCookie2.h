...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007eb0e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000007eb03
- (id)description;	// IMP=0x000000000007e8f7
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x000000000007e6ba
