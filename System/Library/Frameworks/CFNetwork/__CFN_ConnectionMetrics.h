...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a00e5
- (id).cxx_construct;	// IMP=0x00000000001a00d2
- (void).cxx_destruct;	// IMP=0x00000000001a0027
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000019fc3c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000019f70c
