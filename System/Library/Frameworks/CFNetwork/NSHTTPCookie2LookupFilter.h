...
- (void).cxx_destruct;	// IMP=0x00000000001262da
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x0000000000125907
- (long long)_flags;	// IMP=0x00000000001253e0
- (id)initWithCookie:(id)arg1;	// IMP=0x000000000012524c
