...
- (id)uploadTaskWithStreamedRequest:(id)arg1;	// IMP=0x00000000001bb184
- (id)dataTaskWithRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001bb10a
- (id)dataTaskWithRequest:(id)arg1;	// IMP=0x00000000001bb0a2
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000001bb071
- (void)dealloc;	// IMP=0x00000000001bb027
