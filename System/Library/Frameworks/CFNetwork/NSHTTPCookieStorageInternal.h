...
- (void)dealloc;	// IMP=0x00000000001ed921
- (void)_syncCookies;	// IMP=0x00000000001ed8ab
- (void)registerForPostingNotificationsWithContext:(id)arg1;	// IMP=0x00000000001ed746
