...
- (void).cxx_destruct;	// IMP=0x00000000002348b0
- (id)init;	// IMP=0x0000000000234850
@property(nonatomic) long long state; // @synthesize state;
- (void)cancel;	// IMP=0x0000000000235900
...
- (void)invalidate;	// IMP=0x0000000000234ef0
- (void)resume;	// IMP=0x0000000000234e50
- (void)pause;	// IMP=0x0000000000234d70
- (void)startWithDuration:(double)arg1;	// IMP=0x0000000000234c90
- (void)start;	// IMP=0x0000000000234ae0
