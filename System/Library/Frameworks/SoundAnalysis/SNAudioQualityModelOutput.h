...
- (void).cxx_destruct;	// IMP=0x0000000000223a41
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000223912
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFinal_output:(id)arg1 classLabel:(id)arg2;	// IMP=0x0000000000223859
