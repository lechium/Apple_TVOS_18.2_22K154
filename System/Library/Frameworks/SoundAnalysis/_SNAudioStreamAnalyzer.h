...
- (void).cxx_destruct;	// IMP=0x00000000000392be
- (id)init;	// IMP=0x000000000003b8ed
@property(nonatomic, readonly) NSString *detailedDescription;
- (void)completeAnalysis;	// IMP=0x000000000003b769
- (void)analyzeAudioBuffer:(id)arg1 atAudioFramePosition:(long long)arg2;	// IMP=0x000000000003b053
- (void)removeAllRequests;	// IMP=0x000000000003af74
- (void)removeRequest:(id)arg1;	// IMP=0x000000000003a87b
- (_Bool)addRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2 resultsHandler:(CDUnknownBlockType)arg3 error:(id *)arg4;	// IMP=0x0000000000039caf
- (_Bool)addRequest:(id)arg1 withObserver:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000395e0
- (void)dealloc;	// IMP=0x00000000000392a1
- (id)initWithFormat:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000037f9c
