...
- (void).cxx_destruct;	// IMP=0x000000000021d6fa
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000021d5cb
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWith_9:(id)arg1 classLabel:(id)arg2;	// IMP=0x000000000021d512
