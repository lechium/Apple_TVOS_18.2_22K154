...
- (void).cxx_destruct;	// IMP=0x000000000028be42
...
- (void)modelWithConfiguration:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000028bc34
- (id)modelWithConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x000000000028badd
- (id)initWithResourceFactory:(id)arg1;	// IMP=0x000000000028ba32
