...
- (void).cxx_destruct;	// IMP=0x000000000015b522
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000015b321
- (_Bool)hasGPUSupport;	// IMP=0x000000000015b319
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000015b1e0
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000015b1ca
