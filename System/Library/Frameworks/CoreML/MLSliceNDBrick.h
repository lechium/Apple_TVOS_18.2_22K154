...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000020ad43
- (_Bool)hasGPUSupport;	// IMP=0x000000000020ad3b
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000020aa04
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000020a373
