...
- (void).cxx_destruct;	// IMP=0x00000000001b62d8
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000001b5888
- (_Bool)hasGPUSupport;	// IMP=0x00000000001b5880
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000001b5637
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001b5334
