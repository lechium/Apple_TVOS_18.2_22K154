...
- (void).cxx_destruct;	// IMP=0x00000000001a2823
...
- (id)unionFeatureProvider;	// IMP=0x00000000001a2502
- (id)featureValueForName:(id)arg1;	// IMP=0x00000000001a2462
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithFeaturesFrom:(id)arg1 addedToFeaturesFrom:(id)arg2;	// IMP=0x00000000001a2302
