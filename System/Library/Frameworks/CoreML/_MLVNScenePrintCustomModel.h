...
- (void).cxx_destruct;	// IMP=0x00000000001b73d1
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001b6e1d
- (id)featureValueFromScenePrint:(id)arg1 elementSize:(unsigned long long)arg2;	// IMP=0x00000000001b6a54
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001b6316
