...
- (void).cxx_destruct;	// IMP=0x00000000001db657
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001db535
- (unsigned long long)hash;	// IMP=0x00000000001db49e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001db380
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001db29c
- (void)copyTo:(id)arg1;	// IMP=0x00000000001db1f9
- (void)writeTo:(id)arg1;	// IMP=0x00000000001db158
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001daf22
- (id)dictionaryRepresentation;	// IMP=0x00000000001dae12
- (id)description;	// IMP=0x00000000001dad63
