...
+ (id)sharedHandle;	// IMP=0x006000000028962c
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002893e7
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x000000000028928e
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000289138
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000288fe2
- (void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000288f9a
- (void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000288f55
- (void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000288f10
- (void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000288ecb
- (id)init;	// IMP=0x0000000000288c21
