...
- (void).cxx_destruct;	// IMP=0x00000000001a9484
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000001a9283
- (_Bool)hasGPUSupport;	// IMP=0x00000000001a927b
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000001a9142
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001a912c
