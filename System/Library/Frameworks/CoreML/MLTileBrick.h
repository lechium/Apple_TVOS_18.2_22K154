...
- (void).cxx_destruct;	// IMP=0x0000000000101d7d
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000101a0e
- (_Bool)hasGPUSupport;	// IMP=0x0000000000101a06
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000101791
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001014f4
