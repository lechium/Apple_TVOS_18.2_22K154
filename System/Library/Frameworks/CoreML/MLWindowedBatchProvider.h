...
- (void).cxx_destruct;	// IMP=0x00000000002927bd
...
- (id)featuresAtIndex:(long long)arg1;	// IMP=0x000000000029275d
@property(readonly, nonatomic) long long count;
- (id)initWithBatch:(id)arg1 startIndex:(long long)arg2 windowLength:(long long)arg3 error:(id *)arg4;	// IMP=0x00000000002925a2
