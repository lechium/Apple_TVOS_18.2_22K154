...
- (void).cxx_destruct;	// IMP=0x0000000000292923
...
- (id)featuresAtIndex:(long long)arg1;	// IMP=0x000000000029287c
@property(readonly, nonatomic) long long count;
- (id)initWithBatch:(id)arg1 indices:(id)arg2 error:(id *)arg3;	// IMP=0x00000000002927cd
