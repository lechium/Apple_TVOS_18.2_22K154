...
- (void).cxx_destruct;	// IMP=0x00000000001b8367
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000001b79c8
- (_Bool)hasGPUSupport;	// IMP=0x00000000001b79c0
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000001b7777
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000001b7474
