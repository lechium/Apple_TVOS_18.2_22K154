...
- (void).cxx_destruct;	// IMP=0x000000000000e193
...
- (void)matcher:(id)arg1 didProduceResponse:(id)arg2;	// IMP=0x000000000000dfb6
- (void)stopRecognitionForRequestID:(id)arg1;	// IMP=0x000000000000df4d
- (void)stopRecognition;	// IMP=0x000000000000df10
- (void)startRecognitionForRequest:(id)arg1;	// IMP=0x000000000000de87
- (id)initWithCustomCatalog:(id)arg1;	// IMP=0x000000000000ddf3
