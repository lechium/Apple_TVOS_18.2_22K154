...
- (void)dealloc;	// IMP=0x000000000002b8dc
- (void)addTransition:(id)arg1;	// IMP=0x000000000002b89f
- (void)willAddLayer:(id)arg1;	// IMP=0x000000000002b899
- (void)addElement:(id)arg1;	// IMP=0x000000000002b85c
