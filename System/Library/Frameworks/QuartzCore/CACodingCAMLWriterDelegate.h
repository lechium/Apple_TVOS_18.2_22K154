...
- (_Bool)CAMLWriter:(id)arg1 shouldEncodeObject:(id)arg2;	// IMP=0x00000000000279d7
- (id)CAMLWriter:(id)arg1 URLForResource:(id)arg2;	// IMP=0x00000000000276a2
- (id)CAMLWriter:(id)arg1 typeForObject:(id)arg2;	// IMP=0x00000000000275b5
- (id)initWithResourceDir:(id)arg1;	// IMP=0x0000000000027553
- (void)dealloc;	// IMP=0x00000000000274e6
