...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002aa985
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002aa84f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002aa721
- (id)description;	// IMP=0x00000000002aa689
- (void)dealloc;	// IMP=0x00000000002aa61c
