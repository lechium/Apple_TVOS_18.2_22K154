...
- (void).cxx_destruct;	// IMP=0x00000000002fc283
...
- (void)invalidate;	// IMP=0x00000000002fbfd2
- (void)acquireWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000002fbc99
- (id)initWithHomeManager:(id)arg1 homeUUID:(id)arg2;	// IMP=0x00000000002fbbc4
