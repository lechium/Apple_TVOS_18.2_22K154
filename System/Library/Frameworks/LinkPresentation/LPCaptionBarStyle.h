...
@interface LPCaptionBarStyle : NSObject
{
    ...
    LPPointUnit *_trailingPaddingForPresenceOfLeadingIcon;	// 88 = 0x58
    LPAudioPlayButtonStyle *_playButton;	// 96 = 0x60
    LPPadding *_playButtonPadding;	// 104 = 0x68
    LPButtonStyle *_button;	// 112 = 0x70
    UIColor *_backgroundColor;	// 120 = 0x78
    LPCollaborationFooterStyle *_collaborationFooter;	// 128 = 0x80
}

- (void).cxx_destruct;	// IMP=0x0000000000071780
...
- (id)rightAccessory;	// IMP=0x00000000000715b6
- (id)leftAccessory;	// IMP=0x0000000000071572
- (id)rightIcon;	// IMP=0x000000000007152e
- (id)leftIcon;	// IMP=0x00000000000714ea
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 sizeClassParameters:(id)arg3 fontScalingFactor:(double)arg4;	// IMP=0x0000000000070785
