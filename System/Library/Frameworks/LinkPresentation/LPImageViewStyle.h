...
- (void).cxx_destruct;	// IMP=0x000000000006ef1f
...
- (id)emailCompatibleMargin;	// IMP=0x000000000006ec46
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000006ea34
- (id)init;	// IMP=0x000000000006e8dd
