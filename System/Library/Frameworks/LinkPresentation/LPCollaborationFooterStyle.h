...
@interface LPCollaborationFooterStyle : NSObject
{
    ...
    _Bool _useSafeAreaInsetWithPadding;	// 13 = 0xd
...
- (void).cxx_destruct;	// IMP=0x000000000007071b
...
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000070229
