...
+ (id)typeForOffer:(id)arg1;	// IMP=0x0060000000047d25
+ (id)previewURLForOffer:(id)arg1;	// IMP=0x0060000000047878
+ (_Bool)hasVideoForOffer:(id)arg1;	// IMP=0x0060000000047864
+ (_Bool)hasAudioForOffer:(id)arg1;	// IMP=0x00600000000475ab
- (void).cxx_destruct;	// IMP=0x0000000000047dce
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004746b
