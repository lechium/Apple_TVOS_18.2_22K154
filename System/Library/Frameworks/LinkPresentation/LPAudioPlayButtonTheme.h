...
- (void).cxx_destruct;	// IMP=0x000000000006fb91
...
- (id)initWithKeyColor:(id)arg1 secondaryColor:(id)arg2 outerBorderColor:(id)arg3 useInvertedInactiveState:(_Bool)arg4;	// IMP=0x000000000006fa73
