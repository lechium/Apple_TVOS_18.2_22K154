...
- (id).cxx_construct;	// IMP=0x000000000093c8f5
- (void).cxx_destruct;	// IMP=0x000000000093c88b
...
- (id)initWithFocusedElementInformation:(const void *)arg1 isUserInitiated:(_Bool)arg2 userObject:(id)arg3;	// IMP=0x000000000093c6d2
