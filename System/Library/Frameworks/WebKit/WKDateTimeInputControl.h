...
- (id)initWithView:(id)arg1;	// IMP=0x00000000004a2a14
- (_Bool)dismissWithAnimationForTesting;	// IMP=0x00000000004a2c66
...
- (void)setTimePickerHour:(long long)arg1 minute:(long long)arg2;	// IMP=0x00000000004a2af0
