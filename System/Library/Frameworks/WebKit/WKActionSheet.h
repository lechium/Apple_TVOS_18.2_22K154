...
- (id).cxx_construct;	// IMP=0x0000000000478bd9
- (void).cxx_destruct;	// IMP=0x0000000000478b70
...
- (void)didRotate;	// IMP=0x0000000000478b0e
- (void)_didRotateAndLayout;	// IMP=0x0000000000478abf
- (void)updateSheetPosition;	// IMP=0x00000000004788e6
- (void)willRotate;	// IMP=0x0000000000478743
- (void)doneWithSheet:(_Bool)arg1;	// IMP=0x0000000000478681
- (_Bool)presentSheetFromRect:(struct CGRect)arg1;	// IMP=0x0000000000478538
- (struct CGRect)_presentationRectForStyle:(long long)arg1;	// IMP=0x00000000004784ca
- (_Bool)presentSheet:(long long)arg1;	// IMP=0x00000000004783bd
- (void)_cleanup;	// IMP=0x0000000000478371
- (void)dealloc;	// IMP=0x0000000000478333
- (id)init;	// IMP=0x000000000047822e
