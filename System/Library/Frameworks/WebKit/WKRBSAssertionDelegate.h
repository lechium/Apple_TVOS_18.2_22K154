...
- (void)assertion:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0000000000401c32
- (void)assertionWillInvalidate:(id)arg1;	// IMP=0x0000000000401afb
- (void)dealloc;	// IMP=0x0000000000401ab1
