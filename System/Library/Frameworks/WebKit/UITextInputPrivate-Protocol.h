...
@class NSArray, NSAttributedString, NSDictionary, NSEmojiImageTextAttachment, NSString, NSTextAlternatives, RTIInputSystemSourceSession, UIColor, UIDictationSerializableResults, UIFont, UITextInputTraits, UITextInteractionAssistant, UITextPosition, UITextRange, UITextSuggestion, UIView, WebEvent, _UISupplementalItem;
...
- (void)autoFillDidInsertWithExplicitInvocationMode:(_Bool)arg1;
...
- (_Bool)canPerformDictationAction:(NSString *)arg1;
...
- (struct CGPoint)_convertPointFromRenderSpace:(struct CGPoint)arg1;
- (struct CGPoint)_convertPointToRenderSpace:(struct CGPoint)arg1 textRange:(UITextRange *)arg2;
...
- (void)insertEmojiImageTextAttachment:(NSEmojiImageTextAttachment *)arg1 replacementRange:(UITextRange *)arg2;
- (void)insertText:(NSString *)arg1 style:(long long)arg2 alternatives:(NSArray *)arg3;
- (NSAttributedString *)_attributedTextInRange:(UITextRange *)arg1;
@end
