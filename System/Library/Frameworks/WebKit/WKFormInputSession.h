...
- (id).cxx_construct;	// IMP=0x000000000093c6b6
- (void).cxx_destruct;	// IMP=0x000000000093c643
- (void)reloadFocusedElementContextView;	// IMP=0x000000000093c625
- (void)invalidate;	// IMP=0x000000000093c5ba
@property(readonly, nonatomic) _Bool requiresStrongPasswordAssistance;
@property(copy, nonatomic) NSArray *suggestions;
- (void)endEditing;	// IMP=0x000000000093c4f3
...
- (id)initWithContentView:(id)arg1 focusedElementInfo:(id)arg2 requiresStrongPasswordAssistance:(_Bool)arg3;	// IMP=0x000000000093c21a
