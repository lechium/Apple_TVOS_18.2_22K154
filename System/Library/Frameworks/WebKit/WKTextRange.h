...
+ (id)textRangeWithState:(_Bool)arg1 isRange:(_Bool)arg2 isEditable:(_Bool)arg3 startRect:(struct CGRect)arg4 endRect:(struct CGRect)arg5 selectionRects:(id)arg6 selectedTextLength:(unsigned long long)arg7;	// IMP=0x006000000095d9f3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000095dd63
- (_Bool)isEmpty;	// IMP=0x000000000095dd4e
- (id)end;	// IMP=0x000000000095dcbd
- (id)start;	// IMP=0x000000000095dc27
- (id)description;	// IMP=0x000000000095db46
- (void)dealloc;	// IMP=0x000000000095db04
- (_Bool)_isRanged;	// IMP=0x000000000095d9de
- (_Bool)_isCaret;	// IMP=0x000000000095d9cc
