...
- (void).cxx_destruct;	// IMP=0x0000000000053647
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000053468
- (oneway void)requestVoicemails:(CDUnknownBlockType)arg1;	// IMP=0x000000000005335b
- (oneway void)removeVoicemails:(id)arg1;	// IMP=0x00000000000532f2
- (oneway void)addOrUpdateVoicemails:(id)arg1;	// IMP=0x0000000000053289
...
- (void)dealloc;	// IMP=0x00000000000530d2
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x00000000000529b8
- (id)init;	// IMP=0x00000000000529aa
