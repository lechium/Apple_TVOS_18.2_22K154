...
+ (void)releaseSharedXPCClient;	// IMP=0x0010000000047efe
+ (id)sharedXPCClient;	// IMP=0x0010000000047e43
+ (id)sharedXPCClientSemaphore;	// IMP=0x0010000000047df0
...
- (oneway void)removeCall:(id)arg1;	// IMP=0x0000000000049a9a
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x00000000000499c5
- (id)_remoteObjectProxyWithErrorHandler:(CDUnknownBlockType)arg1 isSynchronous:(_Bool)arg2;	// IMP=0x000000000004991f
- (void)_invalidate;	// IMP=0x0000000000049410
- (void)_requestCalls;	// IMP=0x00000000000490af
- (void)_removeCall:(id)arg1;	// IMP=0x0000000000048df9
- (void)_addOrUpdateCall:(id)arg1;	// IMP=0x0000000000048b1f
- (void)_markAllCallsAsEnded;	// IMP=0x00000000000488d1
- (void)invalidate;	// IMP=0x0000000000048876
- (void)requestTransaction:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000048610
- (void)removeDelegate:(id)arg1;	// IMP=0x0000000000048578
- (void)addDelegate:(id)arg1;	// IMP=0x00000000000484e0
@property(readonly, copy, nonatomic) NSDictionary *callUUIDToCallMap;
- (void)dealloc;	// IMP=0x0000000000048346
- (id)_init;	// IMP=0x0000000000047fe0
- (id)init;	// IMP=0x0000000000047fa5
