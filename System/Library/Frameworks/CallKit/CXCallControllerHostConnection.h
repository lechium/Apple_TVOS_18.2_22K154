...
- (void).cxx_destruct;	// IMP=0x000000000004c864
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000004c661
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x000000000004c554
- (oneway void)removeCall:(id)arg1;	// IMP=0x000000000004c4eb
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x000000000004c482
...
- (void)dealloc;	// IMP=0x000000000004c22d
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x000000000004bbff
- (id)init;	// IMP=0x000000000004bbf1
