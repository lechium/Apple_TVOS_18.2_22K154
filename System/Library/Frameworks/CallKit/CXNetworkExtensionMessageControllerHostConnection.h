...
- (void).cxx_destruct;	// IMP=0x0000000000056d58
...
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0000000000056b0e
- (void)invalidate;	// IMP=0x0000000000056aae
...
- (void)dealloc;	// IMP=0x00000000000569cc
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000005658e
