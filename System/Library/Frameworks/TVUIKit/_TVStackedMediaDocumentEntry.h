...
+ (long long)_mediaTypeForMediaTypeString:(id)arg1;	// IMP=0x006000000001e4ef
+ (long long)_blendModeForBlendModeString:(id)arg1;	// IMP=0x006000000001e43a
- (void).cxx_destruct;	// IMP=0x000000000001f016
...
- (id)initWithDictionary:(id)arg1 documentVersion:(id)arg2 directory:(id)arg3 fileNamePrefix:(id)arg4;	// IMP=0x000000000001e5a4
