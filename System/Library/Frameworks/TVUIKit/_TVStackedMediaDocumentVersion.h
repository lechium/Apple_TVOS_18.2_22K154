...
+ (id)v1_0_1;	// IMP=0x00600000000068c2
+ (id)v1_0_0;	// IMP=0x0060000000006856
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000006b38
- (_Bool)isEqualToVersion:(id)arg1;	// IMP=0x0000000000006b1f
- (_Bool)isLessThanVersion:(id)arg1;	// IMP=0x0000000000006b05
- (_Bool)isGreaterThanVersion:(id)arg1;	// IMP=0x0000000000006aeb
- (id)initWithVersionString:(id)arg1;	// IMP=0x000000000000692e
