...
- (void).cxx_destruct;	// IMP=0x0000000000006a23
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000066c2
- (unsigned long long)hash;	// IMP=0x00000000000064a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000624e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000605b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000005eda
- (void)writeTo:(id)arg1;	// IMP=0x0000000000005d5d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000005d50
- (id)dictionaryRepresentation;	// IMP=0x0000000000005510
- (id)description;	// IMP=0x0000000000005461
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x0000000000053a0b
- (id)initWithObjectValue:(id)arg1;	// IMP=0x0000000000053992
