...
- (void).cxx_destruct;	// IMP=0x00000000000585ec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000005835b
- (unsigned long long)hash;	// IMP=0x00000000000581e7
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000057fb3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000057df8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000057ca4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000057b4d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000057b40
- (id)dictionaryRepresentation;	// IMP=0x00000000000573db
- (id)description;	// IMP=0x000000000005732c
