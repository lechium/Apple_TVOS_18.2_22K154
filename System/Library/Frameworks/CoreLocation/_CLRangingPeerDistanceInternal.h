...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ed182
- (void)dealloc;	// IMP=0x00000000000ed113
- (id)initWithPeer:(id)arg1 date:(id)arg2 distanceMeters:(id)arg3 accuracyMeters:(id)arg4 initiator:(_Bool)arg5 shouldUnlock:(_Bool)arg6;	// IMP=0x00000000000ed01b
