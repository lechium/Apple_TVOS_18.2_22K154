...
- (id)getStateSummary;	// IMP=0x0000000000090c06
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000090b87
- (_Bool)inUseLevelIsAtLeast:(int)arg1;	// IMP=0x0000000000090b7b
- (_Bool)isAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0000000000090b5c
- (_Bool)isAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x0000000000090b15
- (_Bool)isNonProvisionallyAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0000000000090af6
- (_Bool)isNonProvisionallyAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x0000000000090ad0
- (id)description;	// IMP=0x0000000000090a84
- (id)authorizationContextByANDingServiceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg1;	// IMP=0x00000000000909f4
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg4 diagnosticMask:(unsigned long long)arg5 authorizedForWidgetUpdates:(_Bool)arg6;	// IMP=0x0000000000090985
