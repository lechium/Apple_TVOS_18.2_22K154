...
+ (id)typeForValue:(id)arg1;	// IMP=0x006000000004b644
+ (id)typeForEncoding:(const char *)arg1;	// IMP=0x006000000004b0d9
- (void).cxx_destruct;	// IMP=0x000000000004b0a6
...
- (void)getBytes:(void *)arg1 forObject:(id)arg2;	// IMP=0x000000000004afe0
- (id)objectWithBytes:(const void *)arg1;	// IMP=0x000000000004adf9
...
- (id)initWithCode:(long long)arg1 encoding:(id)arg2 name:(id)arg3 className:(id)arg4 size:(unsigned long long)arg5 flags:(unsigned long long)arg6;	// IMP=0x000000000004acef
