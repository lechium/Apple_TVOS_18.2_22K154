...
@class NSArray, NSData, NSError, NSString, NSUUID, OTAccountSettings, OTControlArguments, OTCustodianRecoveryKey, OTInheritanceKey, OTJoiningConfiguration, OTOperationConfiguration, OTSecureElementPeerIdentity;

@protocol OTControlProtocol
- (void)reroll:(OTControlArguments *)arg1 reply:(void (^)(NSError *))arg2;
- (void)areRecoveryKeysDistrusted:(OTControlArguments *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
- (void)totalTrustedPeers:(OTControlArguments *)arg1 reply:(void (^)(NSNumber *, NSError *))arg2;
- (void)performCKServerUnreadableDataRemoval:(OTControlArguments *)arg1 isGuitarfish:(_Bool)arg2 altDSID:(NSString *)arg3 reply:(void (^)(NSError *))arg4;
- (void)clearCliqueFromAccount:(OTControlArguments *)arg1 resetReason:(long long)arg2 isGuitarfish:(_Bool)arg3 reply:(void (^)(NSError *))arg4;
...
- (void)simulateReceivePush:(OTControlArguments *)arg1 reply:(void (^)(NSError *))arg2;
- (void)healthCheck:(OTControlArguments *)arg1 skipRateLimitingCheck:(_Bool)arg2 repair:(_Bool)arg3 reply:(void (^)(TrustedPeersHelperHealthCheckResult *, NSError *))arg4;
- (void)createInheritanceKey:(OTControlArguments *)arg1 uuid:(NSUUID *)arg2 claimTokenData:(NSData *)arg3 wrappingKeyData:(NSData *)arg4 reply:(void (^)(OTInheritanceKey *, NSError *))arg5;
- (void)recreateInheritanceKey:(OTControlArguments *)arg1 uuid:(NSUUID *)arg2 oldIK:(OTInheritanceKey *)arg3 reply:(void (^)(OTInheritanceKey *, NSError *))arg4;
...
- (void)fetchAllViableBottles:(OTControlArguments *)arg1 source:(long long)arg2 reply:(void (^)(NSArray *, NSArray *, NSError *))arg3;
...
- (void)resetAndEstablish:(OTControlArguments *)arg1 resetReason:(long long)arg2 idmsTargetContext:(NSString *)arg3 idmsCuttlefishPassword:(NSString *)arg4 notifyIdMS:(_Bool)arg5 accountSettings:(OTAccountSettings *)arg6 isGuitarfish:(_Bool)arg7 reply:(void (^)(NSError *))arg8;
- (void)resetAndEstablish:(OTControlArguments *)arg1 resetReason:(long long)arg2 isGuitarfish:(_Bool)arg3 reply:(void (^)(NSError *))arg4;
...
- (void)rpcVoucherWithArguments:(OTControlArguments *)arg1 configuration:(OTJoiningConfiguration *)arg2 peerID:(NSString *)arg3 permanentInfo:(NSData *)arg4 permanentInfoSig:(NSData *)arg5 stableInfo:(NSData *)arg6 stableInfoSig:(NSData *)arg7 maxCapability:(NSString *)arg8 reply:(void (^)(NSData *, NSData *, NSError *))arg9;
