...
@interface AcmeCertRequest : NSObject
{
    ...
    struct __SecKey *_attestationCRKey;	// 72 = 0x48
    NSArray *_attestationCRChain;	// 80 = 0x50
    NSData *_attestation;	// 88 = 0x58
    NSData *_csr;	// 96 = 0x60
    NSString *_nonce;	// 104 = 0x68
    NSString *_location;	// 112 = 0x70
    NSString *_account;	// 120 = 0x78
    NSString *_token;	// 128 = 0x80
    NSString *_timestamp;	// 136 = 0x88
    NSArray *_authorizations;	// 144 = 0x90
    NSString *_authorizationURL;	// 152 = 0x98
    NSString *_challengeURL;	// 160 = 0xa0
    NSString *_finalizeOrderURL;	// 168 = 0xa8
    NSString *_orderURL;	// 176 = 0xb0
    NSString *_certificateURL;	// 184 = 0xb8
    NSString *_nextMessageURL;	// 192 = 0xc0
    NSString *_acmeNewAccountURL;	// 200 = 0xc8
    NSString *_acmeNewNonceURL;	// 208 = 0xd0
    NSString *_acmeNewOrderURL;	// 216 = 0xd8
    NSObject<OS_dispatch_queue> *_xpc_queue;	// 224 = 0xe0
    NSObject<OS_xpc_object> *_connection;	// 232 = 0xe8
    SecJWSEncoder *_encoder;	// 240 = 0xf0
    struct __SecKey *_publicKey;	// 248 = 0xf8
    struct __SecKey *_privateKey;	// 256 = 0x100
    struct __SecCertificate *_certificate;	// 264 = 0x108
    struct __SecIdentity *_identity;	// 272 = 0x110
}

- (void).cxx_destruct;	// IMP=0x000000000011be0c
...
- (struct __SecIdentity *)identityWithError:(id *)arg1;	// IMP=0x000000000011b69a
- (id)executeRequest;	// IMP=0x000000000011b28f
- (_Bool)valueForBooleanDefault:(id)arg1;	// IMP=0x000000000011b218
- (id)processReply:(id)arg1;	// IMP=0x000000000011a278
- (id)acmeRequest;	// IMP=0x0000000000119b83
- (id)pollForStatus:(id)arg1 until:(id)arg2;	// IMP=0x0000000000119b45
- (id)sendRequestToXPCService:(id)arg1 response:(id *)arg2;	// IMP=0x00000000001194b0
- (int)errorStatusWithHTTPErrorCode:(int)arg1;	// IMP=0x0000000000119448
- (id)attestationChainPEMRepresentation;	// IMP=0x0000000000119379
- (id)createCertificate;	// IMP=0x0000000000119253
- (id)hardwareAttestationWithError:(id *)arg1;	// IMP=0x0000000000118fd0
- (id)attestationObjectWithCertificates:(id)arg1;	// IMP=0x0000000000118c0f
- (id)requestAttestationChainWithError:(id *)arg1;	// IMP=0x0000000000118ba5
- (_Bool)deviceAttestationSupported;	// IMP=0x0000000000118b9d
- (id)createCSR;	// IMP=0x0000000000118aa2
- (id)createKeyPair;	// IMP=0x00000000001189d5
- (id)sanitizeParameters;	// IMP=0x00000000001188a4
- (id)sanitizeSubject;	// IMP=0x00000000001187a9
- (id)serialNumber;	// IMP=0x00000000001186d4
- (void)dealloc;	// IMP=0x0000000000118633
- (id)initWithSubject:(id)arg1 parameters:(id)arg2;	// IMP=0x0000000000118567
