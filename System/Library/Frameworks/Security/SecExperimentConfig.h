...
- (void).cxx_destruct;	// IMP=0x0000000000016008
...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x0000000000015e55
- (unsigned int)hostHash;	// IMP=0x0000000000015e2a
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0000000000015c82
