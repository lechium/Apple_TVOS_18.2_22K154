...
- (void).cxx_destruct;	// IMP=0x00000000000575c7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000005744b
- (unsigned long long)hash;	// IMP=0x00000000000573ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000057274
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005715c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000057099
- (void)writeTo:(id)arg1;	// IMP=0x0000000000056fe5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000056fd8
- (id)dictionaryRepresentation;	// IMP=0x0000000000056ee0
- (id)description;	// IMP=0x0000000000056e31
