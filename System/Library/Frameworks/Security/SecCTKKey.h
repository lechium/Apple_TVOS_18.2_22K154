...
+ (id)fromKeyRef:(struct __SecKey *)arg1;	// IMP=0x00100000000b4dc5
- (void).cxx_destruct;	// IMP=0x00000000000b4d92
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000b4a12
- (id)performOperation:(long long)arg1 data:(id)arg2 algorithms:(id)arg3 parameters:(id)arg4 error:(id *)arg5;	// IMP=0x00000000000b4851
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b4823
- (id)initFromKey:(id)arg1;	// IMP=0x00000000000b4758
- (id)initWithAttributes:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b3efb
