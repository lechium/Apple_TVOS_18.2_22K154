...
- (struct CGPoint)locationOfFirstTouchInView:(id)arg1;	// IMP=0x0000000000074097
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000073ee6
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000073c00
- (void)reset;	// IMP=0x0000000000073bb2
