...
- (_Bool)canBeMergedWith:(id)arg1;	// IMP=0x0000000000075600
- (double)maxY;	// IMP=0x00000000000755dc
- (double)minY;	// IMP=0x00000000000755b8
@property(readonly, nonatomic) double maxX;
@property(readonly, nonatomic) double minX;
- (id)initWithRect:(struct CGRect)arg1 andKind:(long long)arg2;	// IMP=0x0000000000075520
