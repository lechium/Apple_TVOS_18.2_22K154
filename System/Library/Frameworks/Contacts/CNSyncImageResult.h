...
- (void).cxx_destruct;	// IMP=0x0000000000135b52
...
- (id)initWithType:(unsigned long long)arg1 imageData:(id)arg2 cropRect:(struct CGRect)arg3 imageHash:(id)arg4;	// IMP=0x0000000000135a55
