...
- (void)XPCConnectionWasInterruptedForService:(NSString *)arg1;
- (void)XPCConnectionWasInvalidatedForService:(NSString *)arg1;
...
- (void)gettingBackgroundColor:(void (^)(void (^)(void)))arg1;
- (void)requestingProviderDomainCommand:(void (^)(void (^)(void)))arg1;
