...
- (void).cxx_destruct;	// IMP=0x00000000000c835f
...
- (void)interpretUnknownsAsEmailAddresses;	// IMP=0x00000000000c7fd0
- (void)interpretPhoneNumbers;	// IMP=0x00000000000c7d3b
- (void)interpretEmailAddresses;	// IMP=0x00000000000c7ba1
- (void)interpretValues;	// IMP=0x00000000000c7b54
- (id)description;	// IMP=0x00000000000c7ace
- (id)initWithHandleStringClassification:(id)arg1;	// IMP=0x00000000000c79ff
- (id)init;	// IMP=0x00000000000c79c2
