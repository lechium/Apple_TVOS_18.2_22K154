...
- (void).cxx_destruct;	// IMP=0x00000000000483dd
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x0000000000047467
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x0000000000047399
