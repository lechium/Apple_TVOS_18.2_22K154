...
- (void).cxx_destruct;	// IMP=0x00000000000ce3ff
@property(readonly, copy, nonatomic) NSString *parentGroupIdentifier; // @synthesize parentGroupIdentifier=_parentGroupIdentifier;
- (struct __CFArray *)cn_copyGroupsInAddressBook:(void *)arg1 error:(struct __CFError **)arg2;	// IMP=0x00000000000ce305
- (id)initWithParentGroupIdentifier:(id)arg1;	// IMP=0x00000000000ce250
