...
+ (id)descriptorForAllSupportedKeysWithOptions:(id)arg1;	// IMP=0x00100000000bd8e8
+ (id)adapterWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00100000000bd87a
- (void).cxx_destruct;	// IMP=0x00000000000beee8
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x00000000000bec2e
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x00000000000be8fd
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x00000000000be8e9
...
- (id)initWithContact:(id)arg1 options:(id)arg2;	// IMP=0x00000000000bdd22
