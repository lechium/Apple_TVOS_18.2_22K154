...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004e398
- (void).cxx_destruct;	// IMP=0x000000000004e680
...
- (struct __CFArray *)cn_copyGroupsInAddressBook:(void *)arg1 error:(struct __CFError **)arg2;	// IMP=0x000000000004e5cf
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004e50f
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004e3a0
- (id)initWithContact:(id)arg1 includeAllParentGroups:(_Bool)arg2;	// IMP=0x000000000004e213
- (id)initWithGroup:(id)arg1 includeAllParentGroups:(_Bool)arg2;	// IMP=0x000000000004e0d9
