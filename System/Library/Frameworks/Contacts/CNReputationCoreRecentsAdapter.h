...
- (void).cxx_destruct;	// IMP=0x00000000000f3f1d
@property(readonly, nonatomic) CRRecentContactsLibrary *library; // @synthesize library=_library;
- (id)recentContactsForHandle:(id)arg1;	// IMP=0x00000000000f39b0
- (id)initWithRecentContactsLibrary:(id)arg1;	// IMP=0x00000000000f3932
- (id)init;	// IMP=0x00000000000f383f
