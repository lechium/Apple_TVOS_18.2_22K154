...
@class CNAuthorizationContext, CNChangeHistoryClearRequest, CNChangeHistoryFetchRequest, CNChangeHistoryResult, CNContact, CNContactFetchRequest, CNContainer, CNDataMapperConfiguration, CNImageUtilsBitmapFormat, CNLimitedAccessSyncData, CNObservable, CNPolicy, CNPolicyDescription, CNResult, CNSaveRequest, NSArray, NSData, NSDictionary, NSNumber, NSPredicate, NSString;
...
- (_Bool)analyzeDatabaseWithError:(id *)arg1;
- (_Bool)shouldAnalyzeDatabaseWithError:(id *)arg1;
