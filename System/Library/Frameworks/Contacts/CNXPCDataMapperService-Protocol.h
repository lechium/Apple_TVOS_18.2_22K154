...
@class CNChangeHistoryClearRequest, CNChangeHistoryFetchRequest, CNContact, CNContactFetchRequest, CNContainer, CNImageUtilsBitmapFormat, CNSaveRequest, NSArray, NSData, NSDictionary, NSNumber, NSPredicate, NSString;
@protocol ProgressiveResultsHandlerProtocol;

@protocol CNXPCDataMapperService <NSObject>
- (void)analyzeDatabaseWithReply:(void (^)(NSNumber *, NSError *))arg1;
- (void)shouldAnalyzeDatabaseWithReply:(void (^)(NSNumber *, NSError *))arg1;
- (void)setLimitedAccessTableCurrentSequenceNumber:(NSNumber *)arg1 withReply:(void (^)(NSNumber *, NSError *))arg2;
- (void)dropAllLimitedAccessRowsAndSyncNotifyWithReply:(void (^)(NSNumber *, NSError *))arg1;
- (void)dropAllLimitedAccessRowsWithReply:(void (^)(NSNumber *, NSError *))arg1;
- (void)applyLimitedAccessSyncEvents:(NSArray *)arg1 withReply:(void (^)(NSNumber *, NSError *))arg2;
- (void)getWatchLimitedAccessSyncDataStartingAtSequenceNumber:(NSNumber *)arg1 withReply:(void (^)(CNLimitedAccessSyncData *, NSError *))arg2;
- (void)purgeLimitedAccessRecordsForBundle:(NSString *)arg1 withReply:(void (^)(NSNumber *, NSError *))arg2;
- (void)getLimitedAccessContactsCountForBundle:(NSString *)arg1 withReply:(void (^)(NSNumber *, NSError *))arg2;
- (void)getLimitedAccessLastSyncSequenceNumberWithReply:(void (^)(NSNumber *, NSError *))arg1;
- (void)updateLimitedAccessTable:(NSDictionary *)arg1 withReply:(void (^)(NSNumber *, NSError *))arg2;
- (void)populateSyncTableForLimitedAccessAboveSequenceNumber:(NSNumber *)arg1 withReply:(void (^)(NSDictionary *, NSError *))arg2;
- (void)removeLimitedAccessForBundle:(NSString *)arg1 contactIdentifiers:(NSArray *)arg2 withReply:(void (^)(NSNumber *, NSError *))arg3;
- (void)removeLimitedAccessForBundle:(NSString *)arg1 contactIdentifier:(NSString *)arg2 withReply:(void (^)(NSNumber *, NSError *))arg3;
- (void)addLimitedAccessForBundle:(NSString *)arg1 contactIdentifiers:(NSArray *)arg2 withReply:(void (^)(NSNumber *, NSError *))arg3;
- (void)addLimitedAccessForBundle:(NSString *)arg1 contactIdentifier:(NSString *)arg2 withReply:(void (^)(NSNumber *, NSError *))arg3;
- (void)fetchLimitedAccessContactIdentifiersForBundle:(NSString *)arg1 withReply:(void (^)(NSArray *, NSError *))arg2;
- (void)getBackgroundColorOnImageData:(NSData *)arg1 bitmapFormat:(CNImageUtilsBitmapFormat *)arg2 withReply:(void (^)(NSArray *, NSError *))arg3;
