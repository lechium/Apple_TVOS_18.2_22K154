...
+ (id)effectivePredicate:(id)arg1;	// IMP=0x00600000000f2282
+ (id)validatePredicate:(id)arg1 error:(id *)arg2;	// IMP=0x00600000000f21de
+ (id)fetchRequestFromCNFetchRequest:(id)arg1 managedConfiguration:(id)arg2 error:(id *)arg3;	// IMP=0x00600000000f1fc7
+ (long long)resolvedSortOrderFromContactSortOrder:(long long)arg1;	// IMP=0x00600000000f1f63
- (void).cxx_destruct;	// IMP=0x00000000000f1f30
...
- (id)initWithPredicate:(id)arg1 keysToFetch:(id)arg2 shouldSort:(_Bool)arg3 sortOrder:(unsigned int)arg4 unifiedFetch:(_Bool)arg5 batchSize:(long long)arg6 managedConfiguration:(id)arg7 options:(unsigned long long)arg8;	// IMP=0x00000000000f1d90
