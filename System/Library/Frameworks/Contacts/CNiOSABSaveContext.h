...
- (void).cxx_destruct;	// IMP=0x000000000006870f
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x0000000000068640
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x000000000006862a
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x0000000000068614
- (void)_populateSaveRequestIndexTables;	// IMP=0x00000000000681ab
- (void)dealloc;	// IMP=0x000000000006816c
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x0000000000067f83
