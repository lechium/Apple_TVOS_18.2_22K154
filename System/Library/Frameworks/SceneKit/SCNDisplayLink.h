...
- (_Bool)_isInvalidated;	// IMP=0x0000000000218b4e
- (void)setNeedsDisplay;	// IMP=0x0000000000218b3a
- (void)invalidate;	// IMP=0x0000000000218ad8
- (void)_caDisplayLinkCallback;	// IMP=0x0000000000218aa6
- (void)_callbackWithTime:(double)arg1;	// IMP=0x0000000000218908
- (int)queuedFrameCount;	// IMP=0x00000000002188ff
@property(nonatomic) float preferredFrameRate;
@property(copy, nonatomic) CDUnknownBlockType adaptativeFrameRate;
- (_Bool)setPaused:(_Bool)arg1 nextFrameTimeHint:(double)arg2 lastUpdate:(double)arg3;	// IMP=0x0000000000218746
@property(nonatomic, getter=isPaused) _Bool paused;
- (void)dealloc;	// IMP=0x00000000002185f5
- (id)initWithQueue:(id)arg1 screen:(id)arg2 policy:(unsigned long long)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x000000000021837d
- (id)init;	// IMP=0x000000000021836f
