...
+ (id)animationWithSCNAnimation:(id)arg1;	// IMP=0x00200000001d5993
@property(copy, nonatomic) NSArray *animationEvents;
- (void)setCommitsOnCompletion:(_Bool)arg1;	// IMP=0x00100000001d58ed
- (_Bool)commitsOnCompletion;	// IMP=0x00100000001d58bb
