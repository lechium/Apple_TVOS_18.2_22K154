...
@interface SCNMTLRenderContext : NSObject
{
    ...
    } _compositeRendering[2];	// 15304 = 0x3bc8
    SCNMTLRenderPipeline *_downSamplePipeline;	// 15336 = 0x3be8
    struct {
        id <MTLTexture> backgroundTexture;
        id <MTLTexture> overlayTexture;
        id <MTLTexture> stencilDepthTexture;
    } _skCompositing;	// 15344 = 0x3bf0
    struct {
    ...
    _Bool _showsAuthoringEnvironment;	// 15416 = 0x3c38
    struct {
        _Bool collectEnabled;
        NSMutableDictionary *errors;
    } _compilationIssues;	// 15424 = 0x3c40
    struct {
    ...
    } _counters;	// 15440 = 0x3c50
    struct {
        unsigned long long passHash;
        struct __C3DMaterial *material;
    } _renderGraph;	// 15456 = 0x3c60
    id <SCNMTLRenderContextResourceManagerMonitor> _resourceManagerMonitor;	// 15472 = 0x3c70
    id <SCNMTLRenderContextCommandBufferStatusMonitor> _commandBufferStatusMonitor;	// 15480 = 0x3c78
    struct os_unfair_lock_s _gpuHandlersLock;	// 15488 = 0x3c80
    id _commandBufferScheduledHandlers;	// 15496 = 0x3c88
    id _commandBufferCompletedHandlers;	// 15504 = 0x3c90
    id _drawablePresentedHandlers;	// 15512 = 0x3c98
    MTLRenderPassDescriptor *_clientRenderPassDescriptor;	// 15520 = 0x3ca0
    id <MTLRenderCommandEncoder> _clientRenderCommandEncoder;	// 15528 = 0x3ca8
    id <MTLCommandBuffer> _clientCommandBuffer;	// 15536 = 0x3cb0
    unsigned long long _debugOptions;	// 15544 = 0x3cb8
    double _contentScaleFactor;	// 15552 = 0x3cc0
    id <MTLCommandQueue> _clientCommandQueue;	// 15560 = 0x3cc8
    NSString *_generatedTexturePath;	// 15568 = 0x3cd0
}

- (id).cxx_construct;	// IMP=0x00000000000de7c6
- (void).cxx_destruct;	// IMP=0x00000000000de784
- (void)writeBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x00000000000ddf5a
- (void)_drawShadowMaps;	// IMP=0x00000000000dcf65
- (void)_drawPBRTextures;	// IMP=0x00000000000dc58f
- (void)resetVolatileMeshElements;	// IMP=0x00000000000dc268
- (void)_recycleMTLBufferToPool:(id)arg1;	// IMP=0x00000000000dbf8b
- (id)_newMTLBufferFromPoolWithLength:(unsigned long long)arg1;	// IMP=0x00000000000dbec4
- (void)resetVolatileMeshes;	// IMP=0x00000000000dbda6
- (void)_executeDrawCommand:(CDStruct_26eb7e6d)arg1;	// IMP=0x00000000000d4853
- (void)_prepareMaterialTextures:(struct __C3DMaterial *)arg1;	// IMP=0x00000000000d474d
- (float)_zFarForSkyboxRenderingProjectionMatrix:(const union C3DMatrix4x4 *)arg1 defaultZFar:(float)arg2;	// IMP=0x00000000000d145e
- (void)_updateProjectionMatrixForOrthographicSkyboxRenderingIfNeeded:(union C3DMatrix4x4 *)arg1;	// IMP=0x00000000000d119e
- (void)_logLightingInformation;	// IMP=0x00000000000d0779
- (void)_createResourceCommandBufferIfNeeded;	// IMP=0x00000000000d0084
- (void)_clearUnusedBindingPoints;	// IMP=0x00000000000cf0dd
- (void)dealloc;	// IMP=0x00000000000ce833
- (void)_reduceStatsOfConstantBuffer:(id)arg1;	// IMP=0x00000000000ce258
