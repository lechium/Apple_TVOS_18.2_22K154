...
- (id)ciImage;	// IMP=0x000000000009851c
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000009839e
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x00000000000982ab
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x00000000000981f8
- (void)dealloc;	// IMP=0x00000000000981a0
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x0000000000098146
