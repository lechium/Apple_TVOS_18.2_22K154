...
- (void)_computeUsageForArguments:(id)arg1 function:(id)arg2;	// IMP=0x000000000012778d
- (_Bool)matchesRenderPassDescriptor:(id)arg1;	// IMP=0x000000000012762a
- (id)description;	// IMP=0x0000000000126f3c
- (void)dealloc;	// IMP=0x0000000000126ea6
- (id)init;	// IMP=0x0000000000126e6c
