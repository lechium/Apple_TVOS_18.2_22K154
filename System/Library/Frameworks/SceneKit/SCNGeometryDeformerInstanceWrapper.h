...
- (id)dependency1TangentBuffer;	// IMP=0x00000000001f7132
- (id)dependency1NormalBuffer;	// IMP=0x00000000001f7125
- (id)dependency1PositionBuffer;	// IMP=0x00000000001f7118
- (id)dependency0TangentBuffer;	// IMP=0x00000000001f710b
- (id)dependency0NormalBuffer;	// IMP=0x00000000001f70fe
- (id)dependency0PositionBuffer;	// IMP=0x00000000001f70f1
...
- (void)setStageInputOutputBuffersToCurrentComputeEncoder;	// IMP=0x00000000001f6f48
- (id)_currentResourceManager;	// IMP=0x00000000001f6f3a
- (void)setStageInputOutputBuffersToComputeEncoder:(struct SCNMTLComputeCommandEncoder *)arg1;	// IMP=0x00000000001f6ded
- (id)_currentRenderContext;	// IMP=0x00000000001f6ddc
- (CDStruct_4c2781bd)_currentFrustumInfo;	// IMP=0x00000000001f6d83
- (CDStruct_c6fc9200)_currentTransforms;	// IMP=0x00000000001f6d5a
- (unsigned long long)_currentFrameHash;	// IMP=0x00000000001f6ca6
- (void)configureStageInputOutputDescriptor:(id)arg1 withDeformerFunction:(id)arg2;	// IMP=0x00000000001f690b
@property(readonly, nonatomic) id <MTLBlitCommandEncoder> currentBlitEncoder;
@property(readonly, nonatomic) id <MTLDevice> device;
- (void)dealloc;	// IMP=0x00000000001f68a8
