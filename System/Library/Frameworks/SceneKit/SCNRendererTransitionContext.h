...
- (void)dealloc;	// IMP=0x00000000001be59f
- (id)prepareRendererAtIndex:(int)arg1 withScene:(id)arg2 renderSize:(struct CGSize)arg3 pointOfView:(id)arg4 parentRenderer:(id)arg5;	// IMP=0x00000000001be424
- (struct __C3DFXPass *)transitionPass;	// IMP=0x00000000001be3d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001be32e
