...
- (void)dealloc;	// IMP=0x0000000000296cae
- (_Bool)isOpaque;	// IMP=0x0000000000296c9e
- (id)textureSource;	// IMP=0x0000000000296bc3
- (id)prepareWindowIfNeeded;	// IMP=0x0000000000296940
- (_Bool)supportsMetal;	// IMP=0x0000000000296938
- (id)init;	// IMP=0x0000000000296909
