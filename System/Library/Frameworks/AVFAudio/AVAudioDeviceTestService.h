...
- (id).cxx_construct;	// IMP=0x0000000000074ec1
- (void).cxx_destruct;	// IMP=0x0000000000074dcf
...
- (void)cancel;	// IMP=0x0000000000074ae1
- (void)cleanUp;	// IMP=0x00000000000748b6
- (void)removeSystemVolumeObserver;	// IMP=0x0000000000074743
- (void)cleanUpObservers;	// IMP=0x000000000007425f
- (id)stringForRouteChangeReason:(unsigned long long)arg1;	// IMP=0x0000000000074240
- (id)stringForInterruptionReason:(unsigned long long)arg1;	// IMP=0x0000000000074221
- (void)setupObservers:(CDUnknownBlockType)arg1;	// IMP=0x0000000000073a96
- (void)configureMultiChannelMixerForOutputChannel:(long long)arg1 totalChannels:(long long)arg2;	// IMP=0x000000000007361a
- (void)setupMultiChannelMixerForOutputChannel:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000730e8
- (void)dealloc;	// IMP=0x0000000000072e1d
- (id)convertBufferFor:(id)arg1 sourceBuffer:(id)arg2;	// IMP=0x000000000007281c
- (void)setupAudioEngineFor:(id)arg1 sourceNodeBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000007276b
- (_Bool)createAudioEngineAndPulseToneHandlerFor:(id)arg1;	// IMP=0x00000000000721c2
- (void)setupAudioSessionFor:(id)arg1 playbackOnly:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000071364
- (void)checkSequenceValidity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000070f31
- (void)resetVolume:(float)arg1;	// IMP=0x0000000000070d24
- (void)setupVolumeObserverForVolume:(float)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000070999
- (_Bool)isPlaybackForTestEnabled;	// IMP=0x0000000000070959
- (_Bool)isMixerOutputEnabled;	// IMP=0x0000000000070919
- (void)stopAudioSession:(CDUnknownBlockType)arg1;	// IMP=0x0000000000070852
- (void)setupAudioSessionForHearingTestWithStatus:(CDUnknownBlockType)arg1 success:(CDUnknownBlockType)arg2;	// IMP=0x0000000000070756
- (void)setupAudioSessionForHearingTest:(CDUnknownBlockType)arg1;	// IMP=0x000000000007068f
- (void)stopRecording:(CDUnknownBlockType)arg1;	// IMP=0x000000000006ff15
- (void)startRecording:(id)arg1 filePath:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000006f744
- (void)stopPlayback;	// IMP=0x000000000006f541
- (void)playback:(id)arg1 filePath:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000006ddf1
- (void)playbackTone:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000006dcf5
- (double)calculateCrossCorrelationPeakRelativeToSource:(id)arg1 capture:(id)arg2;	// IMP=0x000000000006d871
- (void)startWithSequence:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000069a82
- (_Bool)isOutputRouteBluetooth:(id)arg1 session:(id)arg2;	// IMP=0x0000000000069985
- (void)passExtensionToken:(id)arg1;	// IMP=0x0000000000069720
- (void)configureDataSources:(id)arg1 session:(id)arg2;	// IMP=0x0000000000068c5d
- (_Bool)setVolume:(id)arg1;	// IMP=0x0000000000068ad2
- (_Bool)setVolume:(id)arg1 session:(id)arg2;	// IMP=0x0000000000068753
- (void)createAudioEngineAndProcessingChain:(id)arg1 session:(id)arg2 sourceNodeBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000006668b
- (id)init;	// IMP=0x0000000000066551
