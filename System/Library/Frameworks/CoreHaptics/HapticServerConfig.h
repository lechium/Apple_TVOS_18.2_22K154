...
@interface HapticServerConfig : NSObject
{
    ...
    NSDictionary *_builtInAudioEventIDs;	// 40 = 0x28
    vector_2056c7c2 _hapticTransientIDs;	// 48 = 0x30
    vector_2056c7c2 _hapticContinuousSustainedIDs;	// 72 = 0x48
    vector_2056c7c2 _hapticContinuousNonsustainedIDs;	// 96 = 0x60
}

- (id).cxx_construct;	// IMP=0x0000000000007fb1
...
- (id)initWithHapticPlayer:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000005960
