...
@interface _CTSplicedFontKey : NSObject
{
    ...
    NSString *_variableSizeParameter;	// 104 = 0x68
}
...
- (id)description;	// IMP=0x0000000000093ee0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000093c43
- (unsigned long long)hash;	// IMP=0x0000000000093c39
- (void)dealloc;	// IMP=0x0000000000093be8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000093bdd
