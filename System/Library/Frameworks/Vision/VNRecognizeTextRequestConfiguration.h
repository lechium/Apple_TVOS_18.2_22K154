...
@interface VNRecognizeTextRequestConfiguration
{
    ...
    _Bool _keepResourcesLoaded;	// 10 = 0xa
...
- (void).cxx_destruct;	// IMP=0x00000000003c5ec5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003c5cdc
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000003c5bd4
