...
- (void).cxx_destruct;	// IMP=0x00000000003a796d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a77a3
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000003a76dd
