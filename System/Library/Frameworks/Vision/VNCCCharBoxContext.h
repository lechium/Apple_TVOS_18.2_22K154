...
- (void)releaseAllocations;	// IMP=0x00000000003ae9ac
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x00000000003ae8e0
- (void)dealloc;	// IMP=0x00000000003ae86d
- (void)resetBoxBounds;	// IMP=0x00000000003ae85c
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x00000000003ae82b
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000003ae816
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000003ae803
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x00000000003ae7f3
