...
- (void).cxx_destruct;	// IMP=0x00000000002b5130
...
- (id)outputImage;	// IMP=0x00000000002b4f75
- (id)initWithInputParameters:(id)arg1;	// IMP=0x00000000002b4ea3
- (id)init;	// IMP=0x00000000002b4e58
