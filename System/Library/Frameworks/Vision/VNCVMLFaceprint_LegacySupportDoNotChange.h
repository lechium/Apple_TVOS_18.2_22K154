...
@interface VNCVMLFaceprint_LegacySupportDoNotChange : NSObject
{
...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000032d555
- (void).cxx_destruct;	// IMP=0x000000000032d522
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000032d473
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000032d219
