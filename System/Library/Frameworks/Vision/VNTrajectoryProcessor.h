...
@interface VNTrajectoryProcessor : NSObject
{
    ...
    VNParabolaDetection *_parabolaDetector;	// 176 = 0xb0
    unsigned long long _currentImageWidth;	// 184 = 0xb8
    unsigned long long _currentImageHeight;	// 192 = 0xc0
}

- (void).cxx_destruct;	// IMP=0x00000000002c1362
- (id)processVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 warningRecorder:(id)arg4 requestUUID:(id)arg5 error:(id *)arg6;	// IMP=0x00000000002bf80d
- (id)_VNPointsFromCGPoints:(const void *)arg1;	// IMP=0x00000000002bf6f9
- (struct __CVBuffer *)_createCroppedAndScaledBufferFromVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 error:(id *)arg4;	// IMP=0x00000000002bf4b9
- (void)dealloc;	// IMP=0x00000000002bf447
- (id)initWithFrameAnalysisSpacing:(CDStruct_1b6d18a9)arg1 trajectoryLength:(long long)arg2;	// IMP=0x00000000002bea45
