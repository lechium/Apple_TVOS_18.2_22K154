...
- (void).cxx_destruct;	// IMP=0x000000000020a632
...
- (id)description;	// IMP=0x000000000020a068
...
- (void)setComputeDevice:(id)arg1 forComputeStage:(id)arg2;	// IMP=0x0000000000209e1a
- (id)computeDeviceForComputeStage:(id)arg1;	// IMP=0x0000000000209df4
@property(copy, nonatomic) VNProcessingDevice *processingDevice; // @synthesize processingDevice=_processingDevice;
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000209ceb
