...
- (void).cxx_destruct;	// IMP=0x000000000024c879
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024c72e
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000024c6cb
