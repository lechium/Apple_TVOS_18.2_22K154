...
- (void).cxx_destruct;	// IMP=0x0000000000278938
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002787d2
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000278740
- (void)setDefaultSymbologiesForRevision:(unsigned long long)arg1;	// IMP=0x00000000002785ce
