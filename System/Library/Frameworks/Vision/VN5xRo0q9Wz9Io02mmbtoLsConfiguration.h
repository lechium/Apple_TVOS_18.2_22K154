...
- (void).cxx_destruct;	// IMP=0x000000000019f360
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019f227
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000019f1a7
