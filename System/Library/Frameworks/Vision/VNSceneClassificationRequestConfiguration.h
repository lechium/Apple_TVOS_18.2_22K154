...
- (void).cxx_destruct;	// IMP=0x00000000001b5141
...
- (id)description;	// IMP=0x00000000001b4f33
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b4e73
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001b4e24
