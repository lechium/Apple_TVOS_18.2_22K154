...
- (void).cxx_destruct;	// IMP=0x000000000029dfdb
...
- (void)dealloc;	// IMP=0x000000000029df05
- (id)initWithCVPixelBufferImage:(struct __CVBuffer *)arg1 externalImageId:(id)arg2 andExifTimestampValue:(long long)arg3 error:(id *)arg4;	// IMP=0x000000000029de43
- (id)initWithCVPixelBufferImage:(struct __CVBuffer *)arg1 externalImageId:(id)arg2 andExifTimestampString:(id)arg3 error:(id *)arg4;	// IMP=0x000000000029ddc1
- (id)initWithVImage:(struct vImage_Buffer *)arg1 externalImageId:(id)arg2 andExifTimestampValue:(long long)arg3 error:(id *)arg4;	// IMP=0x000000000029dca9
- (id)initWithVImage:(struct vImage_Buffer *)arg1 externalImageId:(id)arg2 andExifTimestampString:(id)arg3 error:(id *)arg4;	// IMP=0x000000000029dc27
