...
{
    VNClassifyImageAestheticsRequest *_oldAestheticsRequest;	// 8 = 0x8
    VNClassifyJunkImageRequest *_junkRequest;	// 16 = 0x10
}

- (void).cxx_destruct;	// IMP=0x00000000003acb9d
...
- (id)requests;	// IMP=0x00000000003acb09
- (id)initWithRevision:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x00000000003aca14
