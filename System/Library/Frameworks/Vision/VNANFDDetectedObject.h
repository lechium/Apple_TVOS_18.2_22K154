...
- (id)description;	// IMP=0x000000000029da67
- (id)initWithObjectType:(long long)arg1 boundingBox:(struct CGRect)arg2 confidence:(float)arg3 rotationAngle:(float)arg4 yawAngle:(float)arg5 pitchAngle:(float)arg6 labelKey:(int)arg7 groupId:(int)arg8;	// IMP=0x000000000029d99f
