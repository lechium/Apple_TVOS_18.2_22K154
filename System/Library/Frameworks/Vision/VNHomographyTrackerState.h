...
- (id).cxx_construct;	// IMP=0x000000000032f159
- (void).cxx_destruct;	// IMP=0x000000000032f12a
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x000000000032ec10
- (_Bool)ICShouldBeCanceled;	// IMP=0x000000000032ec08
- (void)dealloc;	// IMP=0x000000000032eb8c
- (id)init;	// IMP=0x000000000032ea44
