...
- (void).cxx_destruct;	// IMP=0x00000000003a9ed4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003a9d98
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000003a9cab
