...
- (void).cxx_destruct;	// IMP=0x0000000000358c3c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000358b67
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000358afa
