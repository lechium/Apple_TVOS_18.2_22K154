...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x00600000002a2cd5
- (void).cxx_destruct;	// IMP=0x00000000002a2cc2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a2afd
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002a2a43
