...
- (void).cxx_destruct;	// IMP=0x000000000036a123
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000369edd
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000369e1b
