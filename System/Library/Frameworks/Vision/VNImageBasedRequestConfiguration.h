...
- (void).cxx_destruct;	// IMP=0x00000000002d5c54
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002d5b1d
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002d5acb
