...
- (void).cxx_destruct;	// IMP=0x00000000003f8117
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f8049
- (void)updateWithPropertiesOfModel:(id)arg1;	// IMP=0x00000000003f7fe6
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000003f7fa3
