...
- (void).cxx_destruct;	// IMP=0x00000000003a571f
- (id)sceneLabelOperationPointsForOriginatingRequestSpecifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000000003a559a
- (id)initWithInferenceNetworkDescriptor:(id)arg1;	// IMP=0x00000000003a54d5
