...
- (void).cxx_destruct;	// IMP=0x00000000003f0cb8
...
- (id)initWithSkeleton:(id)arg1 intrinsics:(CDStruct_8e0628e6)arg2 inputSize:(struct CGSize)arg3;	// IMP=0x00000000003f0bb8
