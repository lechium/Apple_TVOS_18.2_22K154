...
- (void).cxx_destruct;	// IMP=0x0000000000372e54
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000372d3b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000372b1e
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x0000000000372ace
