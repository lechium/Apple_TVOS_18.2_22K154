...
- (void).cxx_destruct;	// IMP=0x00000000001a096a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001a086e
- (unsigned long long)hash;	// IMP=0x00000000001a07dd
- (id)description;	// IMP=0x00000000001a074a
- (id)initWithRequest:(id)arg1 observationsCacheKey:(id)arg2;	// IMP=0x00000000001a06a1
