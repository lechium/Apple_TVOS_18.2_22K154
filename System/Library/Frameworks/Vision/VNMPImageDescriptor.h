...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000369e13
+ (unsigned long long)currentVersion;	// IMP=0x0010000000369e08
- (void).cxx_destruct;	// IMP=0x0000000000369de0
...
- (id)initWithRawColorGaborDescriptor:(id)arg1;	// IMP=0x0000000000369acc
@property(readonly) NSData *rawColorGaborDescriptor;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)arg1 andSceneClassifierDistance:(float)arg2;	// IMP=0x0000000000369a62
- (float)distanceFromDescriptor:(id)arg1;	// IMP=0x00000000003699df
- (_Bool)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000003699d7
- (_Bool)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000003696c8
- (_Bool)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000003696c0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003694f1
- (unsigned long long)hash;	// IMP=0x00000000003693d9
- (void)dealloc;	// IMP=0x0000000000369399
- (id)initWithState:(id)arg1 byteOffset:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x000000000036904e
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000368ddc
@property(readonly, nonatomic) unsigned long long serializedLength;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000368b1d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000368570
- (id)initWithImageData:(id)arg1 andCustomQualityScore:(float)arg2 context:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000368541
- (id)initWithImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000368309
