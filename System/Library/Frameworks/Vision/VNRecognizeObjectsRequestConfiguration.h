...
- (void).cxx_destruct;	// IMP=0x000000000023ec9e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000023eb07
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000023eaa8
