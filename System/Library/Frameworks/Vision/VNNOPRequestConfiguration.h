...
- (void).cxx_destruct;	// IMP=0x00000000002a169c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a159f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000002a14ac
