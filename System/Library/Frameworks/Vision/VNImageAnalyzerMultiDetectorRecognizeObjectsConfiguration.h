...
- (void).cxx_destruct;	// IMP=0x0000000000394c18
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000394b34
- (unsigned int)labelsListType;	// IMP=0x0000000000394b29
- (unsigned int)analysisTypes;	// IMP=0x0000000000394b1e
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x0000000000394ace
