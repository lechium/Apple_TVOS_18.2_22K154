...
+ (id)depthRepresentationForImageSource:(struct CGImageSource *)arg1 orientation:(unsigned int)arg2;	// IMP=0x006000000036c078
+ (id)depthRepresentationForDepthData:(id)arg1 orientation:(unsigned int)arg2;	// IMP=0x006000000036c01e
- (void).cxx_destruct;	// IMP=0x000000000036c00e
...
- (id)_initWithAVDepthData:(id)arg1 orientation:(unsigned int)arg2;	// IMP=0x000000000036be44
