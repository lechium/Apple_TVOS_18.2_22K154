...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000032ea34
- (void).cxx_destruct;	// IMP=0x000000000032ea01
...
- (void)dealloc;	// IMP=0x000000000032e8a0
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x000000000032e5bf
- (unsigned long long)serializedLength;	// IMP=0x000000000032e59f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000032e57d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000032e049
