...
- (void).cxx_destruct;	// IMP=0x000000000038c943
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000038c7fb
- (unsigned int)labelsListType;	// IMP=0x000000000038c7f0
- (unsigned int)analysisTypes;	// IMP=0x000000000038c7e5
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x000000000038c629
