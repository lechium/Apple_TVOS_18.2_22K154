...
- (void).cxx_destruct;	// IMP=0x0000000000440777
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x000000000044060b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000044052c
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000440465
