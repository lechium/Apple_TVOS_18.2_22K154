...
- (void).cxx_destruct;	// IMP=0x0000000000372902
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000037281e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000372672
- (id)initWithObservationsRecipient:(id)arg1;	// IMP=0x0000000000372629
