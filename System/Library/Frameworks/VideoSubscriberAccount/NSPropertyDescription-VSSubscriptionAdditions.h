...
- (id)vs_JSONValueTransformer;	// IMP=0x0030000000028bd7
...
- (id)vs_propertyListValueTransformer;	// IMP=0x0030000000028534
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x00300000000283c7
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x003000000002813d
@end
