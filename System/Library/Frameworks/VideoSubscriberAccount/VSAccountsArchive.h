...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000042b60
- (void).cxx_destruct;	// IMP=0x0000000000042f49
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000042e1a
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000042bb9
- (id)init;	// IMP=0x0000000000042b68
