...
- (id)_faultWhileAccessingPrimitiveValueForKey:(id)arg1;	// IMP=0x000000000002fa7e
- (void)_notifyWhileSettingPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000002f9f1
