...
- (void).cxx_destruct;	// IMP=0x00000000000244a5
...
- (void)binder:(id)arg1 didTearDownBinding:(id)arg2;	// IMP=0x000000000002430b
- (void)binder:(id)arg1 didEstablishBinding:(id)arg2;	// IMP=0x00000000000241a3
- (void)dealloc;	// IMP=0x0000000000023e9d
- (id)init;	// IMP=0x0000000000023e37
