...
- (void).cxx_destruct;	// IMP=0x0000000000062c4f
...
- (void)_notifyWithFunctionName:(id)arg1 eventName:(id)arg2 info:(id)arg3;	// IMP=0x0000000000062619
- (void)_cancelCurrentRequestAndNotify:(_Bool)arg1;	// IMP=0x0000000000062476
- (void)setRequestHeader:(id)arg1:(id)arg2;	// IMP=0x0000000000062261
- (id)getResponseHeader:(id)arg1;	// IMP=0x0000000000062179
- (id)getAllResponseHeaders;	// IMP=0x0000000000061f72
- (void)abort;	// IMP=0x0000000000061f5e
- (void)send:(id)arg1;	// IMP=0x0000000000061851
- (void)open:(id)arg1:(id)arg2:(id)arg3:(id)arg4:(id)arg5;	// IMP=0x00000000000616a3
- (id)initWithContext:(id)arg1;	// IMP=0x000000000006165f
- (id)init;	// IMP=0x000000000006158c
