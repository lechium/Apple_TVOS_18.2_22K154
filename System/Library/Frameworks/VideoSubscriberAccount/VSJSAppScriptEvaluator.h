...
- (void).cxx_destruct;	// IMP=0x0000000000071da7
...
- (void)transitionToDoneState;	// IMP=0x0000000000071c11
- (void)transitionToFetchingScriptState;	// IMP=0x0000000000071693
- (void)transitionToEnqueueingNextUrlState;	// IMP=0x0000000000071470
- (void)start;	// IMP=0x00000000000712e3
- (id)initWithApp:(id)arg1 urls:(id)arg2;	// IMP=0x00000000000710e6
