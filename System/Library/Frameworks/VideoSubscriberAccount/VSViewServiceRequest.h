...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000022e7b
- (void).cxx_destruct;	// IMP=0x00000000000233a0
...
- (id)description;	// IMP=0x0000000000022fb9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000022f61
- (unsigned long long)hash;	// IMP=0x0000000000022f28
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000022ed8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000022e83
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000022dfb
- (id)init;	// IMP=0x0000000000022d67
