...
- (void).cxx_destruct;	// IMP=0x000000000003ab09
...
- (id)description;	// IMP=0x000000000003a634
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x000000000003a55a
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x000000000003a4ce
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x000000000003a3db
- (id)changedValues;	// IMP=0x000000000003a09f
- (id)committedValueForKey:(id)arg1;	// IMP=0x000000000003a025
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x0000000000039fa7
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000039d7d
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x0000000000039c75
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x0000000000039abc
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x00000000000397a1
- (id)init;	// IMP=0x0000000000039732
