...
- (void).cxx_destruct;	// IMP=0x000000000005cda5
...
- (void)sendEvent:(id)arg1 toSubscriber:(id)arg2;	// IMP=0x000000000005ca83
- (void)sendEvent:(id)arg1;	// IMP=0x000000000005c657
- (void)handleEventWithAction:(unsigned int)arg1 token:(unsigned long long)arg2 descriptor:(id)arg3;	// IMP=0x000000000005c1ee
- (id)initWithStreamName:(id)arg1 isStatefulEventPublisher:(_Bool)arg2;	// IMP=0x000000000005beb7
- (id)initWithStreamName:(id)arg1;	// IMP=0x000000000005bea3
