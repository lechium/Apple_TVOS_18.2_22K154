...
- (void).cxx_destruct;	// IMP=0x0000000000076ddb
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000076d1b
- (void)invalidateConnection;	// IMP=0x0000000000076c68
- (void)fetchLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000076bbe
- (void)newLight:(id)arg1;	// IMP=0x0000000000076ad0
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000766c8
- (void)invalidateClient;	// IMP=0x0000000000076607
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000007654b
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x00000000000764a3
