...
- (void).cxx_destruct;	// IMP=0x00000000000f771f
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f765f
- (void)invalidateConnection;	// IMP=0x00000000000f75ac
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000f7502
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000f7454
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000f7070
- (void)invalidateClient;	// IMP=0x00000000000f6faf
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000f6f15
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000f6e95
