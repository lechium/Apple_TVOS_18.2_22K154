...
- (void).cxx_destruct;	// IMP=0x000000000000b423
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b363
- (void)invalidateConnection;	// IMP=0x000000000000b2b0
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000000b206
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000000adfe
- (void)invalidateClient;	// IMP=0x000000000000ad3d
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000000ac81
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000000abd9
