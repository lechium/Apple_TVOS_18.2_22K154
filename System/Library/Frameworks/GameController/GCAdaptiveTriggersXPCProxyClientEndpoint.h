...
- (void).cxx_destruct;	// IMP=0x00000000000ba52b
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000ba46d
- (void)invalidateConnection;	// IMP=0x00000000000ba3c9
- (void)refreshStatuses;	// IMP=0x00000000000ba29c
- (void)newStatuses:(id)arg1;	// IMP=0x00000000000ba17d
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x00000000000ba02c
- (void)setController:(id)arg1;	// IMP=0x00000000000b9f86
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x00000000000b9d58
- (id)init;	// IMP=0x00000000000b9d2d
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x00000000000b9b33
