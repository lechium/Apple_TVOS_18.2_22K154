...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bae9f
- (void)invalidateConnection;	// IMP=0x00000000000badec
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x00000000000bacee
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000bac44
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000ba82a
- (void)invalidateClient;	// IMP=0x00000000000ba769
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x00000000000ba6ad
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x00000000000ba59e
