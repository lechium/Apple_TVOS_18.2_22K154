...
- (void).cxx_destruct;	// IMP=0x000000000008de1d
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000008dd5d
- (void)invalidateConnection;	// IMP=0x000000000008dcaa
- (void)fetchProfileWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000008dc00
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000008d84a
- (void)invalidateClient;	// IMP=0x000000000008d79a
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValueForProfile:(id)arg1;	// IMP=0x000000000008d6de
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000008d636
