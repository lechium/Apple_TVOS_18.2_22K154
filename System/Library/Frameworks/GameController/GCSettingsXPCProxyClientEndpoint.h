...
- (void).cxx_destruct;	// IMP=0x000000000008d5d9
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000008d542
- (void)invalidateConnection;	// IMP=0x000000000008d49e
- (void)refreshProfile;	// IMP=0x000000000008d37f
- (void)newProfile:(id)arg1;	// IMP=0x000000000008d26b
- (void)_remoteEndpointHasSetProfile:(id)arg1;	// IMP=0x000000000008d13b
- (void)setController:(id)arg1;	// IMP=0x000000000008d12a
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000008cf15
- (id)init;	// IMP=0x000000000008ceea
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000008cdac
