...
- (void).cxx_destruct;	// IMP=0x000000000003eda5
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000003ecef
- (void)invalidateConnection;	// IMP=0x000000000003ec3c
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000003e9d1
- (void)invalidateClient;	// IMP=0x000000000003e910
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x000000000003e8bf
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)init;	// IMP=0x000000000003e82e
- (id)initWithIdentifier:(id)arg1;	// IMP=0x000000000003e7b9
