...
- (void).cxx_destruct;	// IMP=0x00000000000b9adf
- (void)stopAllHaptics;	// IMP=0x00000000000b99c4
- (_Bool)hasClients;	// IMP=0x00000000000b99a7
- (void)unregisterHapticClient:(id)arg1;	// IMP=0x00000000000b9991
- (void)registerHapticClient:(id)arg1;	// IMP=0x00000000000b997b
- (id)initWithIdentifier:(id)arg1 clientConnection:(id)arg2;	// IMP=0x00000000000b97ae
