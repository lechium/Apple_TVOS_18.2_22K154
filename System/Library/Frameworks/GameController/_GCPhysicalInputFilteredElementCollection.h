...
- (id)elementEnumerator;	// IMP=0x0000000000009c39
- (id)elementForAlias:(id)arg1;	// IMP=0x0000000000009bcf
- (id)elementAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000009ba0
- (unsigned long long)count;	// IMP=0x0000000000009b7e
