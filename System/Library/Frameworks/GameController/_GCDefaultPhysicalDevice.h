...
+ (id)identifierForService:(id)arg1;	// IMP=0x0010000000087163
- (void).cxx_destruct;	// IMP=0x00000000000877fe
...
- (void)updateGlyphFlags;	// IMP=0x00000000000872f4
- (void)eaAccessoriesDidChange;	// IMP=0x0000000000087274
- (id)propertyForKey:(id)arg1;	// IMP=0x00000000000870e4
@property(readonly) NSSet *components;
- (id)driverConnection;	// IMP=0x00000000000870ba
- (void)setDriverConnection:(id)arg1;	// IMP=0x000000000008645e
- (void)setFilterConnection:(id)arg1;	// IMP=0x00000000000860d9
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)redactedDescription;	// IMP=0x0000000000085f85
@property(readonly, copy) NSString *description;
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x0000000000085d5a
- (void)dealloc;	// IMP=0x0000000000085c98
- (id)init;	// IMP=0x0000000000085c6d
- (void)_workaround_backbone_97462229:(id)arg1;	// IMP=0x0000000000085ae6
- (id)initWithHIDDevice:(id)arg1 manager:(id)arg2;	// IMP=0x00000000000859ec
@property(readonly) id <_GCGamepadEventSourceDescription> gamepadEventSource;
- (_Bool)supportsGamepad;	// IMP=0x0000000000087903
...
- (_Bool)supportsMotion;	// IMP=0x0000000000087c11
@property long long indicatedPlayerIndex;
- (_Bool)supportsPlayerIndicator;	// IMP=0x0000000000087f86
...
- (_Bool)supportsLight;	// IMP=0x0000000000088088
...
- (void)setAdaptiveTriggersPayload:(id)arg1 forIndex:(int)arg2;	// IMP=0x000000000008853f
@property(copy, nonatomic) CDUnknownBlockType deviceAdaptiveTriggersServiceConnectedHandler;
- (_Bool)supportsAdaptiveTriggers;	// IMP=0x00000000000883f8
- (void)updateAdaptiveTriggerStatusWithLeftMode:(unsigned char)arg1 leftStatus:(unsigned char)arg2 leftArmPosition:(unsigned char)arg3 rightMode:(unsigned char)arg4 rightStatus:(unsigned char)arg5 rightArmPosition:(unsigned char)arg6;	// IMP=0x000000000008878c
- (void)createPowerSource;	// IMP=0x0000000000088d07
...
- (_Bool)supportsBattery;	// IMP=0x00000000000889ca
- (void)updateBattery:(unsigned char)arg1 isCharging:(_Bool)arg2;	// IMP=0x00000000000892e3
...
- (_Bool)supportsHapticCapabilities;	// IMP=0x0000000000089581
@property(copy, nonatomic) CDUnknownBlockType deviceGameIntentComponentGameIntentTriggeredHandler;
- (void)setEnableGlobalGameControllerFunctionality:(_Bool)arg1;	// IMP=0x00000000000896da
- (void)triggerGameIntentWithEvent:(long long)arg1;	// IMP=0x0000000000089751
- (unsigned long long)getGlyphFlags;	// IMP=0x0000000000089940
