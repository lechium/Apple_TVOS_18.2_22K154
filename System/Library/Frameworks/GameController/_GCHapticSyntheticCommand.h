...
- (void).cxx_destruct;	// IMP=0x00000000000faec4
...
- (id)description;	// IMP=0x00000000000fae51
...
- (void)cancel;	// IMP=0x00000000000fadfe
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x00000000000fad71
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x00000000000facc3
