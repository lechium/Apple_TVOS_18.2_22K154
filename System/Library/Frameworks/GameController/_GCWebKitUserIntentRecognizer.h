...
- (void).cxx_destruct;	// IMP=0x00000000000a8e13
...
- (void)processChangedElements:(id)arg1 atTimestamp:(unsigned long long)arg2;	// IMP=0x00000000000a83ee
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2 slidingWindowTotalDuration:(double)arg3 slidingWindowSegmentDuration:(double)arg4 deadzone:(double)arg5 sensitivity:(int)arg6;	// IMP=0x00000000000a8200
- (id)initWithPhysicalInputProfile:(id)arg1 thumbstickUserIntentHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a81cd
