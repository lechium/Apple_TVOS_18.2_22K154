...
- (void).cxx_destruct;	// IMP=0x0000000000067ddf
@property(readonly, nonatomic) __weak id <_GCIPCProcess> process; // @synthesize process=_process;
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000000067d9b
- (id)initWithConnection:(id)arg1 fromProcess:(id)arg2;	// IMP=0x0000000000067c31
