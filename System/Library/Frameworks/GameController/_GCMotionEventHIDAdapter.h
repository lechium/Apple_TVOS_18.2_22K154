...
- (void).cxx_destruct;	// IMP=0x00000000000ad1a6
...
- (id)observeMotionEvents:(CDUnknownBlockType)arg1;	// IMP=0x00000000000acdf7
- (void)dealloc;	// IMP=0x00000000000acd9e
- (id)init;	// IMP=0x00000000000acd73
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000ac754
