...
- (void).cxx_destruct;	// IMP=0x000000000014e96a
@property(readonly, nonatomic) UIFont *buttonFont; // @synthesize buttonFont=_buttonFont;
- (double)standardPaddingInline;	// IMP=0x000000000014e947
- (double)standardPaddingFullScreen;	// IMP=0x000000000014e935
- (struct UIEdgeInsets)embeddedInlineInsets;	// IMP=0x000000000014e915
- (struct UIEdgeInsets)portraitFullscreenInsets;	// IMP=0x000000000014e8f5
- (struct UIEdgeInsets)landscapeFullscreenInsets;	// IMP=0x000000000014e8d5
...
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x000000000014e601
