...
- (void).cxx_destruct;	// IMP=0x000000000003bfb7
...
- (id)debugDescription;	// IMP=0x000000000003bd19
- (unsigned long long)hash;	// IMP=0x000000000003bcd5
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003bbff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003b9c8
@property(readonly, nonatomic, getter=isCollapsedOrExcluded) _Bool collapsedOrExcluded;
- (id)init;	// IMP=0x000000000003b8bc
