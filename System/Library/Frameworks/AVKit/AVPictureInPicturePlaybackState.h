...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000168ab4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000168aa9
- (id)initWithElapsedTime:(double)arg1 timelineDuration:(double)arg2 timelineRate:(double)arg3 paused:(_Bool)arg4;	// IMP=0x0000000000168974
