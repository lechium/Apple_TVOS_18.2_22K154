...
- (void).cxx_destruct;	// IMP=0x0000000000171d38
...
- (double)offsetForItem:(unsigned long long)arg1;	// IMP=0x0000000000171c43
- (void)setItemWidth:(double)arg1;	// IMP=0x0000000000171ba2
- (void)addItem:(id)arg1;	// IMP=0x0000000000171b8c
@property(readonly, nonatomic) unsigned long long count;
- (id)init;	// IMP=0x0000000000171b18
