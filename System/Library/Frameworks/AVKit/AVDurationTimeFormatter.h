...
- (void).cxx_destruct;	// IMP=0x00000000000978e6
...
- (id)stringForTimeInterval:(double)arg1;	// IMP=0x000000000009771a
- (id)stringForObjectValue:(id)arg1;	// IMP=0x00000000000976a4
- (id)init;	// IMP=0x00000000000975f0
