...
- (void).cxx_destruct;	// IMP=0x0000000000175c98
...
- (struct UIEdgeInsets)playbackControlsViewLayoutMarginsForView:(id)arg1 keyboardHeight:(double)arg2 isFullScreen:(_Bool)arg3;	// IMP=0x0000000000175268
...
- (id)initWithTraitCollection:(id)arg1;	// IMP=0x000000000017516d
