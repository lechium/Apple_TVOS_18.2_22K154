...
+ (id)airMessageParser;	// IMP=0x00400000000a139e
- (void).cxx_destruct;	// IMP=0x000000000009fed4
...
- (id)partsWithData:(id)arg1;	// IMP=0x000000000009fc3e
- (id)init;	// IMP=0x000000000009fa7f
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x000000000009f99e
