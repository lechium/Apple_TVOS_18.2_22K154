...
+ (id)searchResultForMenu:(id)arg1 atIndex:(long long)arg2;	// IMP=0x006000000001556a
+ (id)searchResultForPiPMenuAtIndex:(unsigned long long)arg1;	// IMP=0x0060000000015539
- (void).cxx_destruct;	// IMP=0x0000000000015529
...
- (id)initWithMenu:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x000000000001548c
