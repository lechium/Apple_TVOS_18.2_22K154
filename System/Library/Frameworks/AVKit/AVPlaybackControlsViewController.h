...
- (void).cxx_destruct;	// IMP=0x0000000000058a3f
...
- (_Bool)forwardMethodToPlayerViewController:(SEL)arg1 sender:(id)arg2;	// IMP=0x0000000000058855
- (void)didChangePlayerController;	// IMP=0x000000000005884f
- (void)_didChangePlayerControllerFrom:(id)arg1 to:(id)arg2;	// IMP=0x000000000005883d
- (void)cancelScanning;	// IMP=0x0000000000058837
- (void)skipToPreviousFrame;	// IMP=0x0000000000058831
- (void)skipToNextFrame;	// IMP=0x000000000005882b
- (void)downToNextNavigationMode;	// IMP=0x0000000000058825
- (void)upToNextNavigationMode;	// IMP=0x000000000005881f
- (void)setControlsVisible:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000058744
@property(readonly, nonatomic, getter=areControlsVisible) _Bool controlsVisible;
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000058648
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x00000000000585b8
- (void)viewDidLoad;	// IMP=0x0000000000058577
- (void)_endObservations;	// IMP=0x0000000000058512
- (void)_beginObservations;	// IMP=0x00000000000583dd
- (void)dealloc;	// IMP=0x00000000000582d8
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000582a9
