...
- (struct NSDirectionalEdgeInsets)directionalLayoutMarginsForContextMenuHeaderWithLayout:(unsigned long long)arg1;
- (struct NSDirectionalEdgeInsets)directionalLayoutMarginsForContextMenuCellWithLayout:(unsigned long long)arg1;
@end
