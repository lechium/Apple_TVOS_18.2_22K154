...
- (void).cxx_destruct;	// IMP=0x0000000000114daf
...
- (void)rotaryGestureRecognizerFailedClassifyingMovement:(id)arg1;	// IMP=0x0000000000114be0
- (void)rotaryGestureRecognizerUpdatedClassifyingMovement:(id)arg1;	// IMP=0x0000000000114b60
- (void)rotaryGestureRecognizerBeganClassifyingMovement:(id)arg1;	// IMP=0x0000000000114ae0
- (_Bool)rotaryGestureRecognizerMustBeginFromRest:(id)arg1;	// IMP=0x0000000000114a54
- (_Bool)rotaryGestureRecognizerCanBeginFromRest:(id)arg1;	// IMP=0x00000000001149c8
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x0000000000114958
- (_Bool)gestureRecognizer:(id)arg1 shouldRequireFailureOfGestureRecognizer:(id)arg2;	// IMP=0x000000000011488b
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000001147d7
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000114623
@property(readonly, nonatomic, getter=isUserInteractionAllowed) _Bool userInteractionAllowed;
- (id)init;	// IMP=0x0000000000114514
