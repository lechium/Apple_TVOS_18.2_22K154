...
+ (id)customAttributes;	// IMP=0x0060000000218caa
...
- (id)outputImage;	// IMP=0x00000000002190f4
- (id)alphaImageForMainImage:(id)arg1 disparity:(id)arg2;	// IMP=0x0000000000218e1b
