...
+ (id)customAttributes;	// IMP=0x0060000000176d40
...
- (id)outputImage;	// IMP=0x0000000000177012
- (_Bool)_doMinimum;	// IMP=0x000000000017700a
- (_Bool)_isIdentity;	// IMP=0x0000000000176fbd
