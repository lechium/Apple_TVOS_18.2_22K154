...
- (id).cxx_construct;	// IMP=0x0000000000188f5b
- (void).cxx_destruct;	// IMP=0x0000000000188edd
...
- (void)computeTransform;	// IMP=0x0000000000187dc9
- (void)computeGuides;	// IMP=0x0000000000187340
- (void)clusterLineSegments;	// IMP=0x0000000000185713
- (void)extractLineSegments;	// IMP=0x0000000000185008
- (void)rangeLimitGradientMap;	// IMP=0x0000000000184d63
- (void)thresholdGradientMap;	// IMP=0x0000000000184b88
- (void)normalizeGradientMap;	// IMP=0x000000000018483b
- (void)createGradientMap;	// IMP=0x0000000000184507
- (void)standardizeImage;	// IMP=0x00000000001842b8
- (double)confidence;	// IMP=0x0000000000184233
- (_Bool)compute;	// IMP=0x0000000000183996
- (void)dealloc;	// IMP=0x0000000000183955
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x00000000001837a2
