...
- (id)outputImage;	// IMP=0x00000000001a711f
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x00000000001a6779
- (id)noiseColorKernel;	// IMP=0x00000000001a6759
- (id)_noiseGeneratorKernel;	// IMP=0x00000000001a672e
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x00000000001a66dd
