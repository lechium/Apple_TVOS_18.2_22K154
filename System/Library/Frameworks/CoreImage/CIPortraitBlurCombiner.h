...
- (id)outputImage;	// IMP=0x00000000001aa936
- (id)_ourBlendKernelMetal;	// IMP=0x00000000001aa8d9
- (id)nonMetalKernelYCC;	// IMP=0x00000000001aa8b9
- (id)nonMetalKernel;	// IMP=0x00000000001aa899
- (id)_blendKernel:(_Bool)arg1;	// IMP=0x00000000001aa858
