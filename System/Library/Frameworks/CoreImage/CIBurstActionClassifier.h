...
- (_Bool)isBurstAction;	// IMP=0x000000000003622b
- (float)predictResult;	// IMP=0x0000000000036157
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x00000000000360dd
- (void)scaleVector;	// IMP=0x0000000000035f9d
- (id)initWithVersion:(int)arg1;	// IMP=0x0000000000035f34
- (id)init;	// IMP=0x0000000000035ee5
