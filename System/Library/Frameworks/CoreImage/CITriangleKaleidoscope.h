...
+ (id)customAttributes;	// IMP=0x0060000000209e48
...
- (id)outputImage;	// IMP=0x000000000020a1af
- (id)_geomKernel;	// IMP=0x000000000020a18f
- (id)_colorKernel;	// IMP=0x000000000020a16f
