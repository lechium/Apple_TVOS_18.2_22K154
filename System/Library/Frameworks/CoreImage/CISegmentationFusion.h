...
+ (id)customAttributes;	// IMP=0x00600000002168ea
- (id)outputImage;	// IMP=0x0000000000216cb3
- (_Bool)_isIdentity;	// IMP=0x0000000000216c59
- (id)kernel;	// IMP=0x00000000002168ca
