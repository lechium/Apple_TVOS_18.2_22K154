...
- (id)outputImage;	// IMP=0x00000000000aff08
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x00000000000afe06
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x00000000000afc9a
