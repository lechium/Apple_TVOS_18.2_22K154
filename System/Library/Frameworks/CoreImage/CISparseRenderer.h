...
+ (id)customAttributes;	// IMP=0x00600000001a7bc8
...
- (id)outputImage;	// IMP=0x00000000001a89ff
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001a89a3
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x00000000001a8947
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x00000000001a885e
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x00000000001a8741
- (id)baseVecsLUTGenerator;	// IMP=0x00000000001a8716
- (id)stepsLUTGenerator;	// IMP=0x00000000001a86eb
- (_Bool)_useD2XRenderer;	// IMP=0x00000000001a85cd
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x00000000001a7d3b
