...
+ (id)customAttributes;	// IMP=0x0060000000052575
...
- (id)outputImage;	// IMP=0x0000000000051d42
- (id)_CICMYK_black;	// IMP=0x0000000000051d22
- (id)_CICMYK_yellow;	// IMP=0x0000000000051d02
- (id)_CICMYK_magenta;	// IMP=0x0000000000051ce2
- (id)_CICMYK_cyan;	// IMP=0x0000000000051cc2
- (id)_CICMYK_convert;	// IMP=0x0000000000051ca2
- (id)_CIWhite;	// IMP=0x0000000000051c82
