...
+ (id)customAttributes;	// IMP=0x00600000000599e6
...
- (id)outputImage;	// IMP=0x0000000000059bcc
- (id)_kernelAlphaPreserving;	// IMP=0x00000000000599c6
- (id)_kernel;	// IMP=0x00000000000599a6
