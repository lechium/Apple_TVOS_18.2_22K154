...
+ (id)customAttributes;	// IMP=0x00600000002195cf
...
- (id)outputImage;	// IMP=0x000000000021e04f
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x000000000021d244
- (id)blurMapV4:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3 hairImage:(id)arg4;	// IMP=0x000000000021bd3a
- (id)blurMapV3:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3;	// IMP=0x000000000021b9fc
- (id)refineShiftMapV3WithMainImage:(id)arg1 shiftmap:(id)arg2 lensModel:(id)arg3;	// IMP=0x000000000021b354
- (id)blurMapV2:(id)arg1;	// IMP=0x000000000021b2bd
- (id)smoothShiftMapV2:(id)arg1;	// IMP=0x000000000021b1fd
- (id)faceMaskDelta:(id)arg1 extent:(struct CGRect)arg2 parameters:(id)arg3 distanceToAdd:(float *)arg4;	// IMP=0x000000000021ae25
- (id)faceMaskApply:(id)arg1 blurMap:(id)arg2;	// IMP=0x000000000021ac5c
- (id)faceMaskParams:(id)arg1 useNormalizedCoords:(_Bool)arg2;	// IMP=0x000000000021a638
- (_Bool)needToRunFaceMask;	// IMP=0x000000000021a52b
- (id)lensModelApply:(id)arg1 shiftMap:(id)arg2;	// IMP=0x000000000021a395
- (id)lensModelParams:(id)arg1;	// IMP=0x000000000021a164
- (id)upsampledShiftMap:(id)arg1;	// IMP=0x0000000000219f28
- (float)intrinsicMatrixFocalLength;	// IMP=0x0000000000219ee9
- (struct CGSize)originalShiftMapSize;	// IMP=0x0000000000219e10
- (id)calibrationData;	// IMP=0x0000000000219dd9
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x0000000000219d79
