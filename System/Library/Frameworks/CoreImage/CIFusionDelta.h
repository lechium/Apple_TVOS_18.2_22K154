...
+ (id)customAttributes;	// IMP=0x006000000010370e
- (id)outputImage;	// IMP=0x000000000010383c
- (_Bool)_isIdentity;	// IMP=0x00000000001037e2
- (id)kernel;	// IMP=0x00000000001036ee
