...
+ (id)customAttributes;	// IMP=0x0060000000062c81
...
- (id)outputImage;	// IMP=0x0000000000063004
- (_Bool)_isIdentity;	// IMP=0x0000000000062ffc
- (id)_kernel;	// IMP=0x0000000000062c61
