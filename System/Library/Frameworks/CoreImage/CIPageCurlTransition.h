...
+ (id)customAttributes;	// IMP=0x006000000017d4ec
...
- (id)outputImage;	// IMP=0x000000000017b754
- (id)_CIPageCurlTransNoEmap;	// IMP=0x000000000017b734
- (id)_CIPageCurlTransition;	// IMP=0x000000000017b714
