...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x0000000000036547
- (long long)compareIndices:(id)arg1;	// IMP=0x00000000000364d4
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000003645b
