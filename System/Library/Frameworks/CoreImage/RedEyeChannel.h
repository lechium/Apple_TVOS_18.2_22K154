...
- (id)parameterNamesForChannel:(int)arg1;	// IMP=0x000000000024c827
- (id)filterNameForChannel:(int)arg1;	// IMP=0x000000000024c804
- (id)outputImage;	// IMP=0x000000000024c4c1
