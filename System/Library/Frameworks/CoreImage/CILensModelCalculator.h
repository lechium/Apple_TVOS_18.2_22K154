...
+ (id)customAttributes;	// IMP=0x0060000000157902
...
- (id)outputImage;	// IMP=0x0000000000157c2d
- (id)cpuParams;	// IMP=0x0000000000157a4b
- (id)kernel;	// IMP=0x0000000000157a2b
- (id)mtlKernel;	// IMP=0x0000000000157a00
