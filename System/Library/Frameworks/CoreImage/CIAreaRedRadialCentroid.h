...
+ (id)customAttributes;	// IMP=0x00600000001db968
...
- (id)outputImage;	// IMP=0x00000000001dbca8
- (id)_kernelCenter;	// IMP=0x00000000001dbc88
- (id)_kernelDisk;	// IMP=0x00000000001dbc68
- (id)_kernelGaussian;	// IMP=0x00000000001dbc48
