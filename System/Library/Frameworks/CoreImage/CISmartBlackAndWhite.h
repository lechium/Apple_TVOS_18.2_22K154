...
+ (id)customAttributes;	// IMP=0x00600000001f0edb
...
- (id)outputImage;	// IMP=0x00000000001f1457
- (id)_kernel;	// IMP=0x00000000001f1437
- (id)hueArrayImage:(float *)arg1;	// IMP=0x00000000001f0d25
- (float *)createHueArray;	// IMP=0x00000000001f0bd8
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x00000000001f08ac
