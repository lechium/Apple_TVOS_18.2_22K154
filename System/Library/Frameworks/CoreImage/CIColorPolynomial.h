...
+ (id)customAttributes;	// IMP=0x006000000006196e
...
- (id)outputImage;	// IMP=0x00000000000620dc
- (_Bool)_isIdentityAlpha;	// IMP=0x0000000000062017
- (_Bool)_isIdentity;	// IMP=0x0000000000061d2d
- (id)_kernelRGB;	// IMP=0x000000000006194e
- (id)_kernel;	// IMP=0x000000000006192e
