...
+ (id)customAttributes;	// IMP=0x006000000019423b
- (id).cxx_construct;	// IMP=0x0000000000194ad6
...
- (id)outputImage;	// IMP=0x0000000000194968
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x0000000000194635
- (void)computeCameraIntrinsics;	// IMP=0x00000000001944be
