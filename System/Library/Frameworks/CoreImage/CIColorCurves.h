...
+ (id)customAttributes;	// IMP=0x006000000005c90f
...
- (id)outputImage;	// IMP=0x000000000005ce6b
- (_Bool)_checkInputs;	// IMP=0x000000000005cd4c
- (id)curvesImage;	// IMP=0x000000000005cb29
- (void)dealloc;	// IMP=0x000000000005c870
