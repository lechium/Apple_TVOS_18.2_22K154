...
+ (id)customAttributes;	// IMP=0x00600000001a0148
...
- (id)outputImage;	// IMP=0x00000000001a0782
- (id)performPass:(id)arg1 reference:(id)arg2 values:(id)arg3 rect:(struct CGRect)arg4;	// IMP=0x00000000001a032e
- (id)_kernelV;	// IMP=0x00000000001a030e
- (id)_kernelH;	// IMP=0x00000000001a02ee
