...
- (struct CGRect)faceRect;	// IMP=0x0000000000235a58
- (id)description;	// IMP=0x0000000000235a1a
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x000000000023567f
