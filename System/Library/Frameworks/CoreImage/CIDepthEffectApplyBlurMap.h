...
+ (id)customAttributes;	// IMP=0x0060000000221505
...
- (id)outputImage;	// IMP=0x0000000000221e34
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x0000000000221afa
- (id)alterBlurmap;	// IMP=0x00000000002219d5
