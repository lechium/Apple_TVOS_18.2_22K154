...
+ (id)customAttributes;	// IMP=0x006000000013bf20
...
- (id)outputImage;	// IMP=0x000000000013b744
- (struct CGRect)_outputExtent;	// IMP=0x000000000013b05c
- (id)_kernel;	// IMP=0x000000000013b03c
