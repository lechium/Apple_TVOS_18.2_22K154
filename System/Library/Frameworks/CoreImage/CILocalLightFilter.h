...
+ (id)customAttributes;	// IMP=0x006000000015d075
- (id)outputImage;	// IMP=0x000000000015d426
- (id)_polyKernel;	// IMP=0x000000000015d406
- (id)_shadowKernel;	// IMP=0x000000000015d3e6
