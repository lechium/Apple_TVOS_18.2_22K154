...
+ (id)customAttributes;	// IMP=0x00600000000b87b8
...
- (id)outputImage;	// IMP=0x00000000000b8afa
- (id)_kernelGuideMono;	// IMP=0x00000000000b8ada
- (id)_kernelGuideCombine4;	// IMP=0x00000000000b8aba
- (id)_kernelGuideCombine;	// IMP=0x00000000000b8a9a
- (id)_kernelJointUpsampRG;	// IMP=0x00000000000b8a7a
- (id)_kernelJointUpsamp;	// IMP=0x00000000000b8a5a
