...
+ (id)customAttributes;	// IMP=0x006000000021105b
...
- (id)outputImage;	// IMP=0x0000000000211415
- (id)_negkernel;	// IMP=0x00000000002113f5
- (id)_poskernel;	// IMP=0x00000000002113d5
- (_Bool)_isIdentity;	// IMP=0x00000000002113a0
