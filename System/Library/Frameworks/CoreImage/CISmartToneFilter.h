...
+ (id)customAttributes;	// IMP=0x00600000001f4110
...
- (id)outputImage;	// IMP=0x00000000001f4bb5
- (void)setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000001f4b14
- (id)_kernelRH;	// IMP=0x00000000001f4af4
- (id)_kernelH;	// IMP=0x00000000001f4ad4
- (id)_kernelC;	// IMP=0x00000000001f4ab4
- (id)_kernelBpos;	// IMP=0x00000000001f4a94
- (id)_kernelBneg;	// IMP=0x00000000001f4a74
- (void)dealloc;	// IMP=0x00000000001f4a09
- (_Bool)_isIdentity;	// IMP=0x00000000001f48d3
