...
+ (id)defaultVersionString;	// IMP=0x0000000000041474
...
- (_Bool)isAction;	// IMP=0x000000000004c66a
- (_Bool)isPortrait;	// IMP=0x000000000004c635
- (_Bool)isFaceDetectionForced;	// IMP=0x000000000004c616
- (id)imageClusterForIdentifier:(id)arg1;	// IMP=0x000000000004c228
- (id)bestImageIdentifiers;	// IMP=0x0000000000048280
- (void)selectCoverPhotoFromMultiple:(id)arg1 burstSize:(int)arg2;	// IMP=0x0000000000047d7d
- (id)findBestImage:(id)arg1 useActionScores:(_Bool)arg2;	// IMP=0x000000000004754d
- (void)computeAllImageScores;	// IMP=0x0000000000045e57
- (float)computeBeginningVsEndAEMatrixDiffVsAverageAdjacent;	// IMP=0x0000000000045aeb
- (float)computeCameraTravelDistance;	// IMP=0x00000000000455fd
- (void)performEmotionalRejectionOnCluster:(id)arg1;	// IMP=0x0000000000044f62
- (int)computeEmotion:(id)arg1;	// IMP=0x0000000000044dff
- (void)addImageFromIOSurface:(struct __IOSurface *)arg1 properties:(id)arg2 identifier:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000044c8c
- (void)addYUVImage:(id)arg1 properties:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000044797
- (void)processClusters:(_Bool)arg1;	// IMP=0x0000000000042277
- (float)computeActionSelectionThreshold;	// IMP=0x0000000000041eb1
- (void)dealloc;	// IMP=0x0000000000041c50
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000041587
- (id)burstDocumentDirectory;	// IMP=0x00000000000414f3
