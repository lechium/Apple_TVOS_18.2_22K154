...
- (id)featuresInImage:(id)arg1;	// IMP=0x000000000002673b
- (id)featuresInImage:(id)arg1 options:(id)arg2;	// IMP=0x0000000000025b11
- (void)dealloc;	// IMP=0x0000000000025abb
- (id)initWithContext:(id)arg1 options:(id)arg2;	// IMP=0x0000000000025974
