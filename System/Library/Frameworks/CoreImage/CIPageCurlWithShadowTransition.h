...
+ (id)customAttributes;	// IMP=0x006000000017f294
...
- (id)outputImage;	// IMP=0x000000000017d7ec
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x000000000017d7cc
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x000000000017d7ac
