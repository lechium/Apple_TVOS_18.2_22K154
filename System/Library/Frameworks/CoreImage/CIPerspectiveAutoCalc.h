...
- (_Bool)compute;	// IMP=0x0000000000182afc
- (void)dealloc;	// IMP=0x0000000000182ac1
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x000000000018296f
