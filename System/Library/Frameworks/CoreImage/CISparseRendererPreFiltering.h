...
- (id)outputImage;	// IMP=0x00000000001a7a2b
- (void)dumpImage:(id)arg1 extent:(struct CGRect)arg2 prefixFilename:(id)arg3;	// IMP=0x00000000001a77d5
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2 width:(double)arg3;	// IMP=0x00000000001a7356
- (id)_kernel:(_Bool)arg1;	// IMP=0x00000000001a7315
