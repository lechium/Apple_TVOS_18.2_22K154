...
- (struct __CVBuffer *)pixelBuffer;	// IMP=0x0000000000051c1a
- (void)dealloc;	// IMP=0x0000000000051baa
- (id)initWithIOSurface:(struct __IOSurface *)arg1 maxDimension:(int)arg2;	// IMP=0x00000000000518fc
- (id)initWithCGImage:(struct CGImage *)arg1 maxDimension:(int)arg2;	// IMP=0x000000000005172f
- (void)convertRGBAToYUV420:(char *)arg1 rgbaBytesPerRow:(int)arg2;	// IMP=0x0000000000051206
