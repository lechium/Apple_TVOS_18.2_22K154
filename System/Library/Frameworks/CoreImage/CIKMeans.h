...
+ (id)customAttributes;	// IMP=0x00600000001da050
...
- (id)outputImage;	// IMP=0x00000000001da9db
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x00000000001da75e
- (id)_kernelKmeans;	// IMP=0x00000000001da73e
- (id)_combine:(id)arg1;	// IMP=0x00000000001da334
