...
+ (id)customAttributes;	// IMP=0x006000000022402f
+ (int)getDraftMode:(id)arg1;	// IMP=0x00600000002287c1
+ (struct CGImageMetadata *)augmentMetadataWithRenderingPropertiesForImage:(id)arg1;	// IMP=0x00600000002286ea
+ (struct CGImageMetadata *)metadataFromDictionary:(id)arg1 metadata:(struct CGImageMetadata *)arg2;	// IMP=0x0060000000228622
+ (id)tuningParametersFromMetadata:(struct CGImageMetadata *)arg1;	// IMP=0x0060000000228615
+ (struct CGImageMetadata *)replaceRenderingParameters:(struct CGImageMetadata *)arg1 tuningParameters:(id)arg2;	// IMP=0x006000000022860d
...
- (id)outputImage;	// IMP=0x0000000000224b63
- (id)_getFocusRect:(id)arg1 focusRect:(id)arg2;	// IMP=0x0000000000224887
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x000000000022469f
- (void)prewarm:(id)arg1;	// IMP=0x0000000000223a5a
