...
- (void).cxx_destruct;	// IMP=0x0000000000009fb9
...
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000009f84
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000009f72
- (void)dismissRemoteViewController:(id)arg1;	// IMP=0x0000000000009e7a
- (id)initWithViewController:(id)arg1;	// IMP=0x0000000000009e12
