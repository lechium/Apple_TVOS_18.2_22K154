...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0010000000005aa8
- (void).cxx_destruct;	// IMP=0x0000000000005d12
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000005b46
