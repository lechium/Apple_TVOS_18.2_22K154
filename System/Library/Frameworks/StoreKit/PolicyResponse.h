...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002cb17
- (void).cxx_destruct;	// IMP=0x000000000002cd1c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002cc02
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002cb1f
- (id)initWithTermsOfService:(id)arg1 privacyPolicyText:(id)arg2 privacyPolicyURL:(id)arg3;	// IMP=0x000000000002ca5f
