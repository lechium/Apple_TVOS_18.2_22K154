...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000035ed4
- (void).cxx_destruct;	// IMP=0x0000000000036510
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003610b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000035edc
- (id)initWithResult:(id)arg1 extensionID:(id)arg2 productURL:(id)arg3 isEntitled:(_Bool)arg4 parameters:(id)arg5 deepLinkURL:(id)arg6;	// IMP=0x0000000000035dcd
