...
- (void)saveNewTokenFamily:(NSData *)arg1 bundleID:(NSString *)arg2 reply:(void (^)(NSError *))arg3;
...
- (void)updateTransactions:(NSArray *)arg1 forClient:(NSDictionary *)arg2;
...
- (void)isEligibleForIntroductoryOfferForGroupID:(NSString *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
