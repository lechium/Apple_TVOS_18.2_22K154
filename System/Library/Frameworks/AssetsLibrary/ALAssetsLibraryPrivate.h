...
- (void)dealloc;	// IMP=0x000000000000a67d
- (void)registerAlbum:(id)arg1 assetGroupPrivate:(id)arg2;	// IMP=0x000000000000a5b5
- (void)photoLibraryDidChange:(id)arg1;	// IMP=0x0000000000009cd1
@property(readonly, retain, nonatomic) PLPhotoLibrary *photoLibrary; // @synthesize photoLibrary=_photoLibrary;
- (id)initWithAssetsLibrary:(id)arg1;	// IMP=0x0000000000009baa
