...
- (void).cxx_destruct;	// IMP=0x000000000000c4e9
...
- (void)_performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x000000000000c268
- (void)libraryDidChange;	// IMP=0x000000000000c256
@property(nonatomic) ALAssetsLibrary *library;
- (void)setValue:(id)arg1 forProperty:(id)arg2;	// IMP=0x000000000000c1dc
- (id)valueForProperty:(id)arg1;	// IMP=0x000000000000c16f
- (void)populateAssets;	// IMP=0x000000000000c151
- (void)updateAlbumFiltering;	// IMP=0x000000000000c105
- (void)resetAssets;	// IMP=0x000000000000c0bf
- (int)albumFilter;	// IMP=0x000000000000c03b
- (void)dealloc;	// IMP=0x000000000000bf87
- (id)initWithAlbum:(id)arg1 library:(id)arg2;	// IMP=0x000000000000beab
