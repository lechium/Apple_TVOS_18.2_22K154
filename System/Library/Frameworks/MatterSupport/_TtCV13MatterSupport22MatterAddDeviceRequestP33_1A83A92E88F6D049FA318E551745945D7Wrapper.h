...
- (id)init;	// IMP=0x0000000000007b00
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007a70
@property(nonatomic, readonly) long long hash;
@property(nonatomic, readonly) NSString *debugDescription;
@property(nonatomic, readonly) NSString *description;
- (_Bool)shouldShowDeviceWithUUID:(id)arg1 vendorID:(id)arg2 productID:(id)arg3 serialNumber:(id)arg4 rootPublicKey:(id)arg5 nodeID:(id)arg6;	// IMP=0x00000000000076f0
