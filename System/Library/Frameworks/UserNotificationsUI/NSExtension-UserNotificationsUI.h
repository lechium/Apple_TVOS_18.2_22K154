...
- (id)_un_contentSizeRatio;	// IMP=0x00300000000024bd
...
- (id)_un_customSectionIdentifiers;	// IMP=0x0030000000002127
- (id)_un_extensionContainerBundleIdentifier;	// IMP=0x0030000000001f64
@end
