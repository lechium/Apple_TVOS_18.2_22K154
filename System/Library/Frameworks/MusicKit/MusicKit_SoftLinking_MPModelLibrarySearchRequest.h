...
- (void).cxx_destruct;	// IMP=0x000000000000422b
...
- (void)performWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000003fd8
- (id)initWithSearchTerm:(id)arg1 scopes:(id)arg2 limit:(long long)arg3;	// IMP=0x0000000000003de7
