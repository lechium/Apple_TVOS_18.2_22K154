...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x0060000000010631
- (void).cxx_destruct;	// IMP=0x0000000000012876
...
- (id)description;	// IMP=0x0000000000012482
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x0000000000010c94
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x00000000000108b3
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x0000000000010713
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x0000000000010683
