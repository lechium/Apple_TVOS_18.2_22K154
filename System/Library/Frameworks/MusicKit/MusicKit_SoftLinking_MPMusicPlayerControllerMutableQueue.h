...
- (void)removeItemWithIdentifier:(id)arg1;	// IMP=0x000000000000333b
- (void)insertQueueDescriptor:(id)arg1 afterItemWithIdentifier:(id)arg2;	// IMP=0x00000000000032c2
@property(readonly, nonatomic) MPMusicPlayerControllerMutableQueue *_underlyingMutableQueue;
- (id)_initWithUnderlyingMutableQueue:(id)arg1;	// IMP=0x0000000000003249
