...
- (void).cxx_destruct;	// IMP=0x000000000000b0fc
...
- (void)setEndTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x000000000000b07a
- (void)setStartTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x000000000000b020
@property(readonly, nonatomic) MPMusicPlayerPlayParametersQueueDescriptor *_underlyingQueueDescriptor;
- (id)initWithPlayParametersQueue:(id)arg1;	// IMP=0x000000000000aaf8
