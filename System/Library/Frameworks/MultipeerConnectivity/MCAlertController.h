...
- (void)dealloc;	// IMP=0x0000000000030f59
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000000030ec4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000030e65
- (void)dismiss;	// IMP=0x0000000000030e27
- (void)show;	// IMP=0x0000000000030cd5
