...
+ (id)translateAppexptDictionary:(id)arg1 definitionURL:(id)arg2 isCatalyst:(_Bool)arg3;	// IMP=0x006000000002ea15
+ (void)enumerateExtensionPointsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000002d8ed
- (void).cxx_destruct;	// IMP=0x00000000000306ab
...
- (id)nextObject;	// IMP=0x000000000002f6b6
- (_Bool)validateExtensionPointIdentifier:(id)arg1 sdkDictionary:(id)arg2;	// IMP=0x000000000002f374
- (id)flattenEXExtensionPointConfigurationInDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000002f22e
- (id)synthesizeNSExtensionKeysInDictionary:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000002ef65
- (id)translateXPCCacheDictionary:(id)arg1;	// IMP=0x000000000002eb76
- (id)initWithSDKDictionary:(id)arg1 urls:(id)arg2 config:(id)arg3;	// IMP=0x000000000002ddc0
- (id)initWithSDKDictionary:(id)arg1 config:(id)arg2;	// IMP=0x000000000002dd93
- (id)initWithCacheURLs:(id)arg1 config:(id)arg2;	// IMP=0x000000000002dd74
