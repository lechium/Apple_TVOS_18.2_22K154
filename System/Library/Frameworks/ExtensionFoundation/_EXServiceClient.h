...
+ (id)sharedInstance;	// IMP=0x0040000000054b00
- (void).cxx_destruct;	// IMP=0x0000000000059c90
- (void)dealloc;	// IMP=0x0000000000059c70
- (_Bool)photoServiceAuthorizationStatusForExtensionUUID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000059b10
- (id)init;	// IMP=0x0000000000056020
