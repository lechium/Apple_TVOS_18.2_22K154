...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000e2962
- (void).cxx_destruct;	// IMP=0x00000000000e2bc5
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKQueryAnchor *anchor; // @synthesize anchor=_anchor;
@property(copy, nonatomic) NSArray *sortDescriptors; // @synthesize sortDescriptors=_sortDescriptors;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e2aa1
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e296a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e2896
