...
- (void).cxx_destruct;	// IMP=0x000000000029c80d
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)watchAppInstallationManagerDidObserveChange:(id)arg1;	// IMP=0x000000000029c5e6
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000029c57b
