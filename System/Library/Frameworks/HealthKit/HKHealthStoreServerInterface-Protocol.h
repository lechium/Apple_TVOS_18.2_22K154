...
@class HKCharacteristicType, HKObjectType, HKQuantitySample, HKQuantityType, HKQueryServerConfiguration, HKQuerySubscriptionAnchor, HKSampleType, HKTaskConfiguration, HKUnit, HKWorkout, HKWorkoutActivity, HKWorkoutConfiguration, NSArray, NSData, NSDate, NSDictionary, NSError, NSNumber, NSSet, NSString, NSURL, NSUUID, _HKFilter;
@protocol HKAssociatableObject;

@protocol HKHealthStoreServerInterface <NSObject>
- (void)remote_unrelateSamples:(NSArray *)arg1 withObject:(id <HKAssociatableObject>)arg2 subObject:(id <HKAssociatableObject>)arg3 type:(unsigned long long)arg4 completion:(void (^)(_Bool, NSError *))arg5;
- (void)remote_relateSamples:(NSArray *)arg1 withObject:(id <HKAssociatableObject>)arg2 subObject:(id <HKAssociatableObject>)arg3 type:(unsigned long long)arg4 completion:(void (^)(_Bool, NSError *))arg5;
- (void)remote_relateReplaceRatingOfExertionSample:(HKQuantitySample *)arg1 toWorkout:(HKWorkout *)arg2 workoutActivity:(HKWorkoutActivity *)arg3 samples:(NSArray *)arg4 completion:(void (^)(_Bool, NSError *))arg5;
...
- (void)remote_closeTransactionWithDataTypes:(NSSet *)arg1 anchor:(HKQuerySubscriptionAnchor *)arg2 ackTime:(NSNumber *)arg3 completion:(void (^)(_Bool, NSError *))arg4;
...
- (void)remote_isProtectedDataAvailable:(void (^)(_Bool, _Bool, NSError *))arg1;
