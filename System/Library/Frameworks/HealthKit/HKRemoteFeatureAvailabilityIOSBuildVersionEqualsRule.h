...
+ (id)ruleIdentifier;	// IMP=0x001000000024d9a0
- (void).cxx_destruct;	// IMP=0x000000000024db5f
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000024da22
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000024d9ad
