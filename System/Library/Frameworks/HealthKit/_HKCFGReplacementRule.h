...
+ (id)ruleWithLHS:(id)arg1 RHS:(id)arg2 nodeEvaluator:(CDUnknownBlockType)arg3;	// IMP=0x00600000000bb7fe
- (void).cxx_destruct;	// IMP=0x00000000000bbe4c
...
- (id)description;	// IMP=0x00000000000bbe2f
