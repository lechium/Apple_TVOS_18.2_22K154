...
+ (id)ruleIdentifier;	// IMP=0x00100000000611be
- (void).cxx_destruct;	// IMP=0x0000000000061361
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x0000000000061224
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000000611cb
