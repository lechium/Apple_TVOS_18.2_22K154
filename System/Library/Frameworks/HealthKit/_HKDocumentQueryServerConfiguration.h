...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000028744f
- (void).cxx_destruct;	// IMP=0x00000000002876ab
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000287587
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000287457
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002873c1
