...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000024f3fa
- (void).cxx_destruct;	// IMP=0x000000000024f72e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000024f58b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000024f402
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024f33c
