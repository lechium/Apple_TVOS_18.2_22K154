...
- (void).cxx_destruct;	// IMP=0x00000000000bcc10
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000bcbdf
- (id)_label;	// IMP=0x00000000000bcbd2
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x00000000000bcb66
