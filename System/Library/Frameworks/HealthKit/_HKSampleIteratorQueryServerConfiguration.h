...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000002229f2
- (void).cxx_destruct;	// IMP=0x0000000000222ba0
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKSampleIteratorQueryCursor *queryCursor; // @synthesize queryCursor=_queryCursor;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000222abc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002229fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022297c
