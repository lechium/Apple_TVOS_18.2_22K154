...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000018457
- (void).cxx_destruct;	// IMP=0x0000000000011b32
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009e18f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002c54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e0d1
