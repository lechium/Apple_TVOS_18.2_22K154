...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000d3900
- (void).cxx_destruct;	// IMP=0x00000000000d3b14
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d39f0
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d3908
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d3872
