...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000021dd64
- (void).cxx_destruct;	// IMP=0x000000000021e0ed
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000021df0b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000021dd6c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021dc8e
