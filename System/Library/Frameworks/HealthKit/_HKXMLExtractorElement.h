...
- (void).cxx_destruct;	// IMP=0x000000000022039a
...
- (_Bool)matchesElement:(id)arg1;	// IMP=0x000000000022007d
- (id)initWithElementName:(id)arg1 attributes:(id)arg2;	// IMP=0x000000000021ffc4
- (id)initWithTagSpecification:(id)arg1;	// IMP=0x000000000021fc75
