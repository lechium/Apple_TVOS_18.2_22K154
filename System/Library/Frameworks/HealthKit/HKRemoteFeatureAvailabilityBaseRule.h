...
+ (Class)ruleClassForRawValue:(id)arg1;	// IMP=0x0060000000127350
- (void).cxx_destruct;	// IMP=0x0000000000127ba2
@property(nonatomic) __weak id <HKRemoteFeatureAvailabilityDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (_Bool)evaluate;	// IMP=0x00000000002e4d19
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000002e4cf5
- (id)initWithRawValue:(id)arg1 dataSource:(id)arg2;	// IMP=0x0000000000127aa6
