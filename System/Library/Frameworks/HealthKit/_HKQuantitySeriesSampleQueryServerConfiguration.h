...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000f90df
- (void).cxx_destruct;	// IMP=0x00000000000f95af
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000f937e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000f90e7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f8f8d
