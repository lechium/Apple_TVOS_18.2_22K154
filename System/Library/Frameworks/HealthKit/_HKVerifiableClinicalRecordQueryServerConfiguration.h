...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000181db4
- (void).cxx_destruct;	// IMP=0x000000000018201a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000181f37
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000181dbc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000181d3e
