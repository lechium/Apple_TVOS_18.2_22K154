...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000000981b
- (void).cxx_destruct;	// IMP=0x000000000001835a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000104371
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000003974
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000104282
