...
+ (id)ruleIdentifier;	// IMP=0x001000000008e43f
- (void).cxx_destruct;	// IMP=0x000000000008ea31
...
- (_Bool)evaluate;	// IMP=0x000000000008e7b6
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000008e44c
