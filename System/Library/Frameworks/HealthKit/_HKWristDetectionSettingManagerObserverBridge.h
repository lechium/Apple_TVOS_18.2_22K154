...
- (void).cxx_destruct;	// IMP=0x000000000016f93a
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x000000000016f7d2
- (id)initWithHandle:(id)arg1;	// IMP=0x000000000016f767
