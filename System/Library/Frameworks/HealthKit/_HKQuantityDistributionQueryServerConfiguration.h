...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001b1c11
- (void).cxx_destruct;	// IMP=0x00000000001b2086
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001b1e2a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001b1c19
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001b1b0b
