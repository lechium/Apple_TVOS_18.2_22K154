...
+ (id)ruleIdentifier;	// IMP=0x00100000001de9cb
- (void).cxx_destruct;	// IMP=0x00000000001debd0
@property(retain, nonatomic) NSString *onboardingCountryCode; // @synthesize onboardingCountryCode=_onboardingCountryCode;
- (_Bool)evaluate;	// IMP=0x00000000001dea42
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000001de9d8
