...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000002431e5
- (void).cxx_destruct;	// IMP=0x0000000000243461
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000243341
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002431ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000243171
