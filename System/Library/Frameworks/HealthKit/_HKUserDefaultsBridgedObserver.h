...
- (void).cxx_destruct;	// IMP=0x000000000018561f
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000185510
- (id)initWithHandle:(id)arg1;	// IMP=0x00000000001854a5
