...
- (void).cxx_destruct;	// IMP=0x0000000000002358
@property(retain) UIViewController *viewController; // @synthesize viewController;
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x0000000000002278
- (void)connectToSession:(id)arg1;	// IMP=0x00000000000020dc
- (id)makePrincipalObjectForExtension:(id)arg1;	// IMP=0x0000000000001fe2
