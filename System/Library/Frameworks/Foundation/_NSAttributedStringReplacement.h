...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x00600000007d1ec7
...
- (void)dealloc;	// IMP=0x00000000007d1e69
- (id)initWithIndex:(long long)arg1 specifierRangeInFormatString:(struct _NSRange)arg2 replacementRangeInResult:(struct _NSRange)arg3 replacementKind:(long long)arg4 argument:(id)arg5;	// IMP=0x00000000007d1dbc
- (id)_initWithMetadata:(id)arg1;	// IMP=0x00000000007d1ab7
