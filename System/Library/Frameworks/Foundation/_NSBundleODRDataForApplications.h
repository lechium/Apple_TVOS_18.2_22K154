...
- (_Bool)assetPacksBecameUnavailable:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000857abe
- (_Bool)assetPacksBecameAvailable:(id)arg1 error:(id *)arg2;	// IMP=0x00000000008579b0
- (id)description;	// IMP=0x0000000000857926
- (void)dealloc;	// IMP=0x000000000085784a
- (id)initWithBundle:(id)arg1;	// IMP=0x0000000000856fc1
