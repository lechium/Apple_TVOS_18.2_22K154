...
- (_Bool)classNameAllowed:(Class)arg1;	// IMP=0x00000000007e5ce0
- (void)setAllowedClassNames:(id)arg1;	// IMP=0x00000000007e5cab
- (id)allowedClassNames;	// IMP=0x00000000007e5c94
- (void)dealloc;	// IMP=0x00000000007e5c20
- (id)init;	// IMP=0x00000000007e5bf7
