...
- (void)dealloc;	// IMP=0x000000000037ccdb
- (void)releaseOSTransaction;	// IMP=0x000000000037ccb4
- (unsigned char)acquireOSTransaction;	// IMP=0x000000000037cc76
- (id)initWithClientBundleIdentifier:(id)arg1 clientPersonaIdentifier:(id)arg2 dispatchQueue:(id)arg3;	// IMP=0x000000000037caf6
- (void)debug;	// IMP=0x000000000037ca9a
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x000000000037c984
