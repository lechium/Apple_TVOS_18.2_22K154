...
- (void).cxx_destruct;	// IMP=0x000000000018dbce
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x000000000018d99d
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x000000000018d6d7
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x000000000018d0e6
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x000000000018c989
- (void)setUnits:(id)arg1;	// IMP=0x000000000018c731
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x000000000018c626
- (void)clearCaches:(id)arg1;	// IMP=0x000000000018c609
- (id)init;	// IMP=0x000000000018c406
