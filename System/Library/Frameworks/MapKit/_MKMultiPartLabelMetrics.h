...
- (void).cxx_destruct;	// IMP=0x0000000000166fc6
...
- (void)reset;	// IMP=0x0000000000166c8d
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x0000000000166bb0
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x000000000016687b
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x0000000000166318
