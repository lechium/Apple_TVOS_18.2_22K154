...
+ (id)lastUpdateDisplayString:(id)arg1;	// IMP=0x001000000018571e
- (void).cxx_destruct;	// IMP=0x0000000000185954
@property(retain, nonatomic) NSDate *lastUpdated; // @synthesize lastUpdated=_lastUpdated;
@property(retain, nonatomic) UIImage *icon; // @synthesize icon=_icon;
@property(copy, nonatomic) NSString *title; // @synthesize title=_title;
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x00000000001858cd
- (void)_updateLastUpdatedLabel;	// IMP=0x0000000000185647
@property(copy, nonatomic) NSString *incidentDescription;
- (void)didMoveToWindow;	// IMP=0x0000000000185527
- (void)_contentSizeCategoryDidChange;	// IMP=0x0000000000185463
- (void)dealloc;	// IMP=0x00000000001853ee
- (void)_updateConstraintValues;	// IMP=0x00000000001852bf
- (void)updateConstraints;	// IMP=0x0000000000184f40
- (void)_setConstraints;	// IMP=0x0000000000184724
- (void)infoCardThemeChanged;	// IMP=0x00000000001845c3
- (id)initWithReuseIdentifier:(id)arg1;	// IMP=0x0000000000183e9c
