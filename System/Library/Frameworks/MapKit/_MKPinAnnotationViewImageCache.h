...
- (id).cxx_construct;	// IMP=0x0000000000202357
- (void).cxx_destruct;	// IMP=0x00000000002022cf
- (void)flush;	// IMP=0x00000000002021dd
- (void)setPins:(id)arg1 forMapType:(unsigned long long)arg2 pinColor:(id)arg3 traits:(id)arg4;	// IMP=0x0000000000201dad
- (id)pinsWithMapType:(unsigned long long)arg1 pinColor:(id)arg2 traits:(id)arg3;	// IMP=0x0000000000201b78
- (id)init;	// IMP=0x00000000002019c2
