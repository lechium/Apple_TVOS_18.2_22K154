...
- (void).cxx_destruct;	// IMP=0x0000000000074377
...
- (void)hoursViewDidUpdate:(id)arg1;	// IMP=0x000000000007412b
- (void)_setUpConstraints;	// IMP=0x0000000000073e33
- (void)_setUpViewsForPlaceHoursDayRow;	// IMP=0x0000000000073dc0
- (id)initWithBusinessHours:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000000073cfc
