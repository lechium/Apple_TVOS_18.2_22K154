...
- (void).cxx_destruct;	// IMP=0x00000000000aee82
...
- (void)keyUp:(id)arg1;	// IMP=0x00000000000aed84
- (void)keyDown:(id)arg1;	// IMP=0x00000000000aec85
- (void)handleArrowMask:(long long)arg1;	// IMP=0x00000000000aebc0
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000aead8
