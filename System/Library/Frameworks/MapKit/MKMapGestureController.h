...
- (void).cxx_destruct;	// IMP=0x00000000000ae623
...
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000ae378
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x00000000000ae22d
- (_Bool)tiltGestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000ae0ad
- (_Bool)gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x00000000000ae047
- (void)handleArrowZoom:(id)arg1;	// IMP=0x00000000000ad17c
- (void)handleArrowRotate:(id)arg1;	// IMP=0x00000000000ac28b
- (void)handleArrowPan:(id)arg1;	// IMP=0x00000000000ab6af
- (void)cancelZoomInOrOut;	// IMP=0x00000000000ab66e
- (void)zoomOut;	// IMP=0x00000000000ab5ad
- (void)zoomIn;	// IMP=0x00000000000ab4ec
- (void)handleZoomArrowMask:(long long)arg1 speed:(double)arg2;	// IMP=0x00000000000ab38e
- (double)variableDelayTapRecognizer:(id)arg1 shouldWaitForNextTapForDuration:(double)arg2 afterTouch:(id)arg3;	// IMP=0x00000000000ab289
- (void)gestureRecognizerTouchesCanceled:(id)arg1;	// IMP=0x00000000000ab277
- (void)gestureRecognizerTouchesEnded:(id)arg1;	// IMP=0x00000000000ab265
- (void)gestureRecognizerTouchesBegan:(id)arg1;	// IMP=0x00000000000ab253
- (void)handleTouch:(id)arg1;	// IMP=0x00000000000ab24d
- (void)handlePan:(id)arg1;	// IMP=0x00000000000aa65f
- (struct CGPoint)_snapPointToDevicePixels:(struct CGPoint)arg1;	// IMP=0x00000000000aa514
- (void)_updateZoomGestureForState:(long long)arg1 focusPoint:(struct CGPoint)arg2 scale:(double)arg3 velocity:(double)arg4 gestureType:(long long)arg5 configuration:(id)arg6;	// IMP=0x00000000000aa098
- (void)handlePanZoom:(id)arg1;	// IMP=0x00000000000a9ecc
- (void)_handleRightShoulder:(id)arg1;	// IMP=0x00000000000a97d4
- (void)_handleArrowTap:(id)arg1;	// IMP=0x00000000000a882b
- (void)handleTwoFingerLongPress:(id)arg1;	// IMP=0x00000000000a8732
- (void)handleTwoFingerTap:(id)arg1;	// IMP=0x00000000000a8499
- (void)handleDoubleTap:(id)arg1;	// IMP=0x00000000000a819a
- (void)_updateRotationGestureForState:(long long)arg1 focusPoint:(struct CGPoint)arg2 rotation:(double)arg3 velocity:(double)arg4;	// IMP=0x00000000000a79a4
- (void)handleRotation:(id)arg1;	// IMP=0x00000000000a778a
- (void)handleTilt:(id)arg1;	// IMP=0x00000000000a7778
- (void)_handleStandardTilt:(id)arg1;	// IMP=0x00000000000a6db6
- (void)_setTraitCollection:(id)arg1;	// IMP=0x00000000000a6d46
- (void)clearGestureRecognizersInFlight;	// IMP=0x00000000000a6cc1
- (void)_clearGesture:(id)arg1;	// IMP=0x00000000000a6c4c
- (void)stopUserInteractionFromExternalGesture;	// IMP=0x00000000000a6c3a
- (void)startUserInteractionFromExternalGesture;	// IMP=0x00000000000a6c28
- (void)endGesturing;	// IMP=0x00000000000a6b5c
- (void)beginGesturing;	// IMP=0x00000000000a6a4d
- (void)stopDynamicAnimations;	// IMP=0x00000000000a68d2
@property(nonatomic, getter=isScrollEnabled) _Bool scrollEnabled;
@property(nonatomic, getter=isZoomEnabled) _Bool zoomEnabled;
- (void)dealloc;	// IMP=0x00000000000a6701
...
- (void)_setOneHandedZoomGestureConfiguration:(id)arg1;	// IMP=0x00000000000a6687
...
- (id)initWithMapView:(id)arg1 gestureTargetView:(id)arg2;	// IMP=0x00000000000a6631
- (id)initWithMapView:(id)arg1 gestureTargetView:(id)arg2 doubleTapTargetView:(id)arg3;	// IMP=0x00000000000a5eec
