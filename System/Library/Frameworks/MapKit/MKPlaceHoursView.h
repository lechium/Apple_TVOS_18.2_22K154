...
- (void).cxx_destruct;	// IMP=0x00000000001f878f
...
- (_Bool)_shouldCollapseTopMessageLabel;	// IMP=0x00000000001f86a9
- (void)_collapseAllLabelsFromOptions;	// IMP=0x00000000001f84b1
- (void)_updateHoursView;	// IMP=0x00000000001f6cc5
- (void)_updateOptionsForCollapsingToSingleLineAndColor;	// IMP=0x00000000001f6c41
- (id)_standardLabel;	// IMP=0x00000000001f6b2c
- (void)infoCardThemeChanged;	// IMP=0x00000000001f6a5c
- (_Bool)wantsDefaultClipping;	// IMP=0x00000000001f6a54
- (void)applyRulesForTopAndBottomLabel;	// IMP=0x00000000001f64de
- (void)setTopLabel:(id)arg1;	// IMP=0x00000000001f6384
@property(readonly, nonatomic) _MKUILabel *topLabel;
- (void)_contentSizeDidChange;	// IMP=0x00000000001f5fe4
- (id)hoursGrayColor;	// IMP=0x00000000001f5fa6
- (void)_commonInit;	// IMP=0x00000000001f595b
- (id)initWithBusinessHours:(id)arg1;	// IMP=0x00000000001f5890
