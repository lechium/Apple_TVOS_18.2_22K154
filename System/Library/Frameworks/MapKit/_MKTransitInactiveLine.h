...
- (void).cxx_destruct;	// IMP=0x0000000000093fdb
...
- (id)initWithTransitLine:(id)arg1 blocked:(_Bool)arg2 serviceResumesDate:(id)arg3 timeZone:(id)arg4 referenceDate:(id)arg5 departuresSequence:(id)arg6;	// IMP=0x0000000000093ea1
