...
- (void).cxx_destruct;	// IMP=0x000000000022badc
...
- (_Bool)canDisplayCompleteTitleWhenExpanded;	// IMP=0x000000000022bab3
- (void)setDetailView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000022b0c5
@property(retain, nonatomic) UIView *detailView;
- (void)setRightView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000022a3b2
- (void)setLeftView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x000000000022955b
@property(retain, nonatomic) UIView *rightView;
@property(retain, nonatomic) UIView *leftView;
@property(copy, nonatomic) NSString *calloutSubtitle;
- (void)setCalloutSubtitle:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000229220
@property(copy, nonatomic) NSString *calloutTitle;
- (id)_maskedContainerView;	// IMP=0x000000000022901d
@property(readonly, nonatomic) struct CGSize preferredContentSize; // @synthesize preferredContentSize=_preferredContentSize;
- (void)_updatePreferredContentSize;	// IMP=0x0000000000228f7e
- (void)_updatePreferredContentSizeIfNeeded;	// IMP=0x0000000000228f5d
- (void)_setNeedsUpdatePreferredContentSize;	// IMP=0x0000000000228f4c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000228f1d
- (void)beginMapsTransitionMovingSideways;	// IMP=0x0000000000228e88
- (void)reset;	// IMP=0x0000000000228cfb
- (void)_updateTransformForMotionEffectDirection:(struct CGPoint)arg1 forSubview:(id)arg2;	// IMP=0x0000000000228928
- (_Bool)_applyKeyPathsAndRelativeValues:(id)arg1 forMotionEffect:(id)arg2;	// IMP=0x00000000002287c2
- (void)dealloc;	// IMP=0x000000000022842e
@property(nonatomic) double maximumWidth;
@property(nonatomic) double minimumWidth;
- (void)_contentSizeCategoryDidChange:(id)arg1;	// IMP=0x0000000000228187
- (id)initWithFrame:(struct CGRect)arg1 metrics:(CDStruct_f381021a)arg2;	// IMP=0x0000000000226e4b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000226da9
