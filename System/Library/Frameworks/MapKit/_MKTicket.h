...
- (void).cxx_destruct;	// IMP=0x00000000000c1b61
...
- (void)applyToPlaceInfo:(id)arg1;	// IMP=0x00000000000c17e7
- (void)applyToCorrectedSearch:(id)arg1;	// IMP=0x00000000000c17d1
@property(readonly, nonatomic) GEOMapServiceTraits *traits;
- (void)cancel;	// IMP=0x00000000000c17a5
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 queue:(id)arg3 networkActivity:(CDUnknownBlockType)arg4;	// IMP=0x00000000000c138c
- (void)submitWithHandler:(CDUnknownBlockType)arg1 queue:(id)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c1372
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c135b
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c133d
- (void)submitWithRefinedHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c0b4b
- (void)submitWithHandler:(CDUnknownBlockType)arg1 timeout:(long long)arg2 networkActivity:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c0b2f
@property(readonly, copy) NSString *description;
- (id)initWithTicket:(id)arg1;	// IMP=0x00000000000c0a2b
