...
- (id)description;	// IMP=0x000000000021727c
- (struct CGPoint)rightEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x0000000000217210
- (struct CGPoint)leftEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x00000000002171a4
