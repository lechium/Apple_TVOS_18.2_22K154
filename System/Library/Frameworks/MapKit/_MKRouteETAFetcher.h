...
- (void).cxx_destruct;	// IMP=0x000000000013063c
...
- (void)_didUpdateETAResult;	// IMP=0x00000000001305bd
- (void)invalidateETAForTransportType:(unsigned long long)arg1;	// IMP=0x0000000000130569
- (_Bool)isValidETA:(id)arg1;	// IMP=0x00000000001304bc
- (void)expireETAsIfNoLongerValid;	// IMP=0x0000000000130231
- (_Bool)shouldUpdateEstimatedTravelTimeForNewOrigin:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0000000000130139
...
- (_Bool)isUsingCurrentLocationForOrigin;	// IMP=0x000000000012fef3
- (void)requestNewETAForTransportType:(unsigned long long)arg1 additionalTransportTypes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000012f832
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x000000000012f7cb
- (void)_resetState;	// IMP=0x000000000012f75e
- (void)dealloc;	// IMP=0x000000000012f45b
- (id)init;	// IMP=0x000000000012f396
