...
- (_Bool)_tvs_performBlock:(CDUnknownBlockType)arg1 authenticationExpiration:(double)arg2 error:(id *)arg3;	// IMP=0x0030000000066a10
- (_Bool)tvs_setiCloudPhotoLibraryEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0030000000066879
@property(readonly, nonatomic) _Bool tvs_iCloudPhotoLibraryEnabled;
- (_Bool)tvs_setMyPhotoStreamEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x0030000000066688
...
- (_Bool)tvs_setSharedPhotoStreamEnabled:(_Bool)arg1 error:(id *)arg2;	// IMP=0x003000000006643e
