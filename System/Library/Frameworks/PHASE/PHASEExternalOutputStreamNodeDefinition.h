...
+ (id)new;	// IMP=0x0060000000192ac3
- (void).cxx_destruct;	// IMP=0x0000000000192d6b
...
- (id)initWithExternalOutputStreamUUID:(id)arg1 mixerDefinition:(id)arg2 channelLayoutTag:(unsigned int)arg3 uid:(id)arg4;	// IMP=0x0000000000192adb
- (id)init;	// IMP=0x0000000000192a85
