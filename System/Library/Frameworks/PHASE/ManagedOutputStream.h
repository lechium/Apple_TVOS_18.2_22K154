...
- (void).cxx_destruct;	// IMP=0x00000000000e4ddd
...
- (id)initWithPaused:(_Bool)arg1 attributedTo:(id)arg2 definition:(id)arg3 renderBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000000e4c78
