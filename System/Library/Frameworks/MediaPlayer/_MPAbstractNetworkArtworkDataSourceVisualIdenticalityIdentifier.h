...
- (void).cxx_destruct;	// IMP=0x000000000010b938
...
- (id)stringRepresentation;	// IMP=0x000000000010b841
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010b7ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010b6cc
