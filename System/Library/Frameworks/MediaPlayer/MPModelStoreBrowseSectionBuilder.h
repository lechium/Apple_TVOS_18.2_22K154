...
+ (id)allSupportedInternalOnlyProperties;	// IMP=0x0060000000046fc8
+ (id)allSupportedPropertiesIncludingInternalOnlyProperties:(_Bool)arg1;	// IMP=0x0060000000046ebe
- (void).cxx_destruct;	// IMP=0x0000000000046cd6
@property(readonly, nonatomic) MPPropertySet *requestedPropertySet; // @synthesize requestedPropertySet=_requestedPropertySet;
- (id)modelObjectWithTitle:(id)arg1 loadAdditionalContentURL:(id)arg2 uniformContentItemType:(long long)arg3 isMemberOfChartSet:(_Bool)arg4 isBrick:(_Bool)arg5 displaysAsGridCellInCarPlay:(_Bool)arg6 previouslyRetrievedNestedResponse:(id)arg7 onlyContainsEditorialElements:(_Bool)arg8 featuredContentKind:(long long)arg9 modelObject:(id)arg10;	// IMP=0x0000000000046856
- (id)modelObjectWithTitle:(id)arg1 loadAdditionalContentURL:(id)arg2 uniformContentItemType:(long long)arg3 isMemberOfChartSet:(_Bool)arg4 isBrick:(_Bool)arg5 displaysAsGridCellInCarPlay:(_Bool)arg6 previouslyRetrievedNestedResponse:(id)arg7 onlyContainsEditorialElements:(_Bool)arg8 featuredContentKind:(long long)arg9;	// IMP=0x0000000000046829
- (id)modelObjectWithTitle:(id)arg1 loadAdditionalContentURL:(id)arg2 uniformContentItemType:(long long)arg3 isMemberOfChartSet:(_Bool)arg4 isBrick:(_Bool)arg5 previouslyRetrievedNestedResponse:(id)arg6;	// IMP=0x00000000000467e7
@property(readonly, nonatomic) MPPropertySet *requestedPropertySetExcludingInternalOnlyProperties;
- (id)initWithRequestedPropertySet:(id)arg1;	// IMP=0x0000000000046512
