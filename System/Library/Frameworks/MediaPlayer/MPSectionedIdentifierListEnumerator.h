...
- (void).cxx_destruct;	// IMP=0x0000000000065e58
...
- (id)nextObject;	// IMP=0x0000000000065cd1
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x00000000000656dc
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000064c3a
