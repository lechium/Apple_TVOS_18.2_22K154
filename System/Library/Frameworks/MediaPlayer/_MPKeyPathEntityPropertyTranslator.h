...
+ (id)translatorForKeyPaths:(id)arg1 valueTransformFunction:(CDUnknownFunctionPointerType)arg2;	// IMP=0x0010000000190d75
+ (id)translatorForKeyPaths:(id)arg1 valueTransformBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000190ce3
- (void).cxx_destruct;	// IMP=0x0000000000190cbb
...
- (id)valueFromSource:(id)arg1 context:(id)arg2;	// IMP=0x0000000000190c69
