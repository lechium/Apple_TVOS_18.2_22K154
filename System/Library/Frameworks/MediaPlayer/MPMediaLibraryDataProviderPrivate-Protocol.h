...
@class MIPMultiverseIdentifier, MPMediaItem, MPStoreItemLibraryImport, NSArray, NSData, NSDate, NSDictionary, NSIndexSet, NSMutableDictionary, NSString;
...
- (void)removeArtworkForEntityPersistentID:(unsigned long long)arg1 entityType:(long long)arg2 artworkType:(long long)arg3 sourceType:(long long)arg4;
...
- (void)setReactionText:(NSString *)arg1 onEntryAtPosition:(unsigned long long)arg2 inPlaylistWithIdentifier:(long long)arg3 completion:(void (^)(_Bool, NSString *))arg4;
...
- (void)addItemsWithIdentifiers:(NSArray *)arg1 andEntryProperties:(NSDictionary *)arg2 toPlaylistWithIdentifier:(long long)arg3 completionBlock:(void (^)(_Bool))arg4;
...
- (void)setItemsWithIdentifiers:(NSArray *)arg1 andEntryProperties:(NSDictionary *)arg2 forPlaylistWithIdentifier:(long long)arg3 completionBlock:(void (^)(_Bool))arg4;
...
- (long long)addPlaylistWithValuesForProperties:(NSDictionary *)arg1 trackList:(NSArray *)arg2 playlistEntryProperties:(NSMutableDictionary *)arg3;
...
- (void)setValuesForProperties:(NSDictionary *)arg1 trackList:(NSArray *)arg2 andEntryProperties:(NSDictionary *)arg3 ofPlaylistWithIdentifier:(long long)arg4 completionBlock:(void (^)(_Bool, NSError *))arg5;
