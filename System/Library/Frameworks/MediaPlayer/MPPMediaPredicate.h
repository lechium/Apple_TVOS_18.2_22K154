...
- (void).cxx_destruct;	// IMP=0x000000000032d4af
...
- (unsigned long long)hash;	// IMP=0x000000000032d319
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000032d1c6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032d092
- (void)copyTo:(id)arg1;	// IMP=0x000000000032ceb4
- (void)writeTo:(id)arg1;	// IMP=0x000000000032cc09
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000032cbfc
- (id)dictionaryRepresentation;	// IMP=0x000000000032c9e7
- (id)description;	// IMP=0x000000000032c938
...
- (void)dealloc;	// IMP=0x000000000032c806
