...
- (void).cxx_destruct;	// IMP=0x00000000002be3d5
...
- (id)stringRepresentation;	// IMP=0x00000000002be327
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002be31c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002be0b2
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithArtworkType:(long long)arg1 availableArtworkToken:(id)arg2 fetchableArtworkToken:(id)arg3;	// IMP=0x00000000002bd308
- (id)init;	// IMP=0x00000000002bd2ef
