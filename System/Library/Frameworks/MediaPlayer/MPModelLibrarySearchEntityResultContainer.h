...
- (id).cxx_construct;	// IMP=0x0000000000276714
- (void).cxx_destruct;	// IMP=0x00000000002766e3
...
- (id)initWithEntityQueryResult:(shared_ptr_274c5e8b)arg1 forScope:(id)arg2 entityTranslationContext:(id)arg3;	// IMP=0x00000000002765e2
