...
+ (id)allSupportedProperties;	// IMP=0x006000000017284b
- (id)modelObjectWithStoreItemMetadata:(id)arg1 sourceModelObject:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000017291c
