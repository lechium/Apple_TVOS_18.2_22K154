...
- (unsigned long long)hash;	// IMP=0x00000000002e11be
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e1052
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e0f1a
- (void)copyTo:(id)arg1;	// IMP=0x00000000002e0d87
- (void)writeTo:(id)arg1;	// IMP=0x00000000002e0c45
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002e0c38
- (id)dictionaryRepresentation;	// IMP=0x00000000002e0a11
- (id)description;	// IMP=0x00000000002e0962
...
- (void)dealloc;	// IMP=0x00000000002e07b8
