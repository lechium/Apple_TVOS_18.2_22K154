...
+ (id)allSupportedItemProperties;	// IMP=0x00600000001eab38
+ (id)allSupportedGroupProperties;	// IMP=0x00600000001eaa3d
- (void).cxx_destruct;	// IMP=0x00000000001e9063
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001e8cba
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001e8b8d
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001e8a60
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001e877e
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001e8646
