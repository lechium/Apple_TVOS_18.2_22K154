...
- (void).cxx_destruct;	// IMP=0x000000000026cfa8
...
- (_Bool)_storeItemMetadataIsAvailableForContentIdentifier:(id)arg1;	// IMP=0x000000000026ceb8
- (id)_storeItemMetadataForContentIdentifier:(id)arg1;	// IMP=0x000000000026cdc6
- (void)_populateUnavailableContentIdentifiersFromPageDataDictionary:(id)arg1;	// IMP=0x000000000026caa6
- (void)_populateStorePlatformDataResultsFromRawResponseOutputDictionary:(id)arg1;	// IMP=0x000000000026c8b0
- (void)_parseUsingAdditionalContentIdentifiersFromPreviousParser;	// IMP=0x000000000026c59e
- (void)_parseSingleContentListFromPageDataDictionary:(id)arg1 isMemberOfChartSet:(_Bool)arg2;	// IMP=0x000000000026b96d
- (_Bool)_parseFeaturedContentChild:(id)arg1 isMemberOfChartSet:(_Bool)arg2 insertingResultsToSectionedCollection:(id)arg3 atSectionIndex:(long long)arg4 additionalContentIdentifiers:(id)arg5 allAdditionalContentIdentifiersNeedingLookup:(id)arg6;	// IMP=0x000000000026ac2e
- (void)_parseFeaturedContentStructureModelChildren:(id)arg1;	// IMP=0x000000000026a564
- (void)_parse;	// IMP=0x000000000026a368
...
- (id)initWithPreviousParser:(id)arg1 additionalStoreItemMetadataResponse:(id)arg2 options:(CDStruct_d2d88407)arg3 sectionBuilder:(id)arg4 contentItemBuilder:(id)arg5 userIdentity:(id)arg6;	// IMP=0x000000000026a125
- (id)initWithRawResponseOutput:(id)arg1 options:(CDStruct_d2d88407)arg2 sectionBuilder:(id)arg3 contentItemBuilder:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000026a041
