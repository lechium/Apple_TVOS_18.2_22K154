...
+ (id)allSupportedProperties;	// IMP=0x00600000002566a6
- (void).cxx_destruct;	// IMP=0x000000000025620e
...
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000255505
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3;	// IMP=0x0000000000255425
