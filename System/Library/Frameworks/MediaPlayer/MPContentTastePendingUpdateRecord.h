...
- (void).cxx_destruct;	// IMP=0x00000000002dc833
...
- (void)_initializeWithType:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002dc7c0
- (id)initWithStoreAdamID:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002dc75a
- (id)initWithPlaylistGlobalID:(id)arg1 tasteType:(long long)arg2;	// IMP=0x00000000002dc6c6
