...
- (void).cxx_destruct;	// IMP=0x0000000000324f22
...
- (void)downloadManager:(id)arg1 downloadPurchaseDidFinish:(id)arg2;	// IMP=0x0000000000324d84
- (void)downloadManager:(id)arg1 downloadDidFinish:(id)arg2;	// IMP=0x0000000000324c02
- (id)initWithDownload:(id)arg1;	// IMP=0x0000000000324af2
