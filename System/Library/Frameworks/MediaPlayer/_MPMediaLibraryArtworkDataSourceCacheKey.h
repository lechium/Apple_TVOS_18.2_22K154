...
- (void).cxx_destruct;	// IMP=0x00000000002bca9f
...
- (unsigned long long)hash;	// IMP=0x00000000002bc9b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002bc888
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x00000000002bc7ed
