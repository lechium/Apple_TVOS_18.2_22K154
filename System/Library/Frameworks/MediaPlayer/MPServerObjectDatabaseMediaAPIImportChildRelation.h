...
- (void).cxx_destruct;	// IMP=0x000000000008687d
...
- (id)initWithItemIdentifiers:(id)arg1 parentIdentifiers:(id)arg2 childKey:(id)arg3 relativeOrder:(long long)arg4;	// IMP=0x0000000000086743
