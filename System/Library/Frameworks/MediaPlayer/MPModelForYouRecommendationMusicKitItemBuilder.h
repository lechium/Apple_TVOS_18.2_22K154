...
+ (id)allSupportedProperties;	// IMP=0x0060000000232260
- (void).cxx_destruct;	// IMP=0x0000000000231fb0
...
- (id)convertToStoreItemMetadataDictionary:(id)arg1;	// IMP=0x0000000000231d97
- (id)storeItemMetadataWithMusicAPIMetadataDictionary:(id)arg1;	// IMP=0x0000000000231d0a
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000231189
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3 storeURLBag:(id)arg4 isListenNow:(_Bool)arg5;	// IMP=0x0000000000231084
