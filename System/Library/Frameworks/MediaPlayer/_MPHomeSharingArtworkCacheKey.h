...
- (unsigned long long)hash;	// IMP=0x000000000025bf4e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000025be62
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x000000000025be07
