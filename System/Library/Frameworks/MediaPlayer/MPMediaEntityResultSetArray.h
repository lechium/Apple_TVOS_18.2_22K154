...
- (void).cxx_destruct;	// IMP=0x000000000012a227
- (id)sectionInfo;	// IMP=0x000000000012a216
@property(readonly, nonatomic) id <MPMediaLibraryResultSet> resultSet; // @synthesize resultSet=_resultSet;
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000012a139
- (_Bool)isQueryResultSetInvalidated;	// IMP=0x000000000012a0e7
- (unsigned long long)count;	// IMP=0x000000000012a0ca
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012a0bf
- (id)initWithResultSet:(id)arg1 queryCriteria:(id)arg2 entityType:(long long)arg3 library:(id)arg4;	// IMP=0x0000000000129e62
