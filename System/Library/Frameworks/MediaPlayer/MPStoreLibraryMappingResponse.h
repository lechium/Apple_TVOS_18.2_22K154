...
- (void).cxx_destruct;	// IMP=0x0000000000160876
@property(nonatomic) long long libraryAddedStatus; // @synthesize libraryAddedStatus=_libraryAddedStatus;
- (void)setLibraryIdentifierSet:(id)arg1 forIdentifierSet:(id)arg2;	// IMP=0x00000000001607c5
- (id)libraryIdentifierSetForIdentifierSet:(id)arg1;	// IMP=0x00000000001607af
