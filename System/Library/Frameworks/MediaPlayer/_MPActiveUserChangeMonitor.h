...
- (void).cxx_destruct;	// IMP=0x000000000025f92f
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x000000000025f6e8
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000025f49f
- (void)ingestNotificationName:(id)arg1;	// IMP=0x000000000025f0c0
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000025ef60
