...
- (void).cxx_destruct;	// IMP=0x0000000000122f66
@property(readonly, nonatomic) MPArtworkCatalog *artworkCatalog;
- (struct CGRect)bounds;	// IMP=0x0000000000122e01
- (id)initWithArtworkCatalog:(id)arg1;	// IMP=0x0000000000122ded
- (id)initWithArtworkCatalog:(id)arg1 allowsNetworking:(_Bool)arg2;	// IMP=0x0000000000122d19
