...
- (void).cxx_destruct;	// IMP=0x00000000000c762e
...
- (void)rotateByAngle:(float)arg1;	// IMP=0x00000000000c7322
- (double)normalizeAngle:(double)arg1;	// IMP=0x00000000000c72c3
- (id)initWithNode:(id)arg1;	// IMP=0x00000000000c71ea
