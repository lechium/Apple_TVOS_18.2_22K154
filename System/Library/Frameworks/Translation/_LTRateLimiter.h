...
- (void)markPageLoaded;	// IMP=0x000000000001f71e
- (_Bool)allowedForRequests:(unsigned long long)arg1;	// IMP=0x000000000001f704
- (id)initWithMaximumPageLoadRequest:(unsigned long long)arg1 maximumDynamicContentRequests:(long long)arg2;	// IMP=0x000000000001f693
