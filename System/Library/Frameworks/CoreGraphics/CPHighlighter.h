...
+ (_Bool)reconstructHighlightFor:(id)arg1;	// IMP=0x006000000036b95a
...
- (void)highlight;	// IMP=0x000000000036b49d
- (id)initWithTextLine:(id)arg1 inZone:(id)arg2 ofColor:(struct CGColor *)arg3;	// IMP=0x000000000036b44a
