...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000004dc14
- (id).cxx_construct;	// IMP=0x000000000004e022
- (void).cxx_destruct;	// IMP=0x000000000004dfd9
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000004dd4c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004dc1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004db23
- (id)debugDescription;	// IMP=0x000000000004d9c2
