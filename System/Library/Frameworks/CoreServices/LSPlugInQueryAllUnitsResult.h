...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000085930
- (void).cxx_destruct;	// IMP=0x0000000000085b6f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000085ad2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000859e6
- (id)initWithPlugInUnits:(id)arg1 forDatabaseWithUUID:(id)arg2;	// IMP=0x0000000000085938
