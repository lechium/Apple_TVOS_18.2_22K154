...
- (void).cxx_destruct;	// IMP=0x000000000001b55c
- (id)nextObject;	// IMP=0x000000000001b3a3
- (id)initWithAppEnumerationOptions:(unsigned long long)arg1;	// IMP=0x000000000001b079
