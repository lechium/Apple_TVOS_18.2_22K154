...
- (void).cxx_destruct;	// IMP=0x0000000000169754
...
- (void)dispatchToObserver:(id)arg1 forInstallProgressService:(id)arg2;	// IMP=0x00000000001695ca
- (id)initWithNotification:(int)arg1 appProxies:(id)arg2 plugins:(_Bool)arg3;	// IMP=0x0000000000169541
