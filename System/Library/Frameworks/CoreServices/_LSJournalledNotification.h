...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000173edb
- (void).cxx_destruct;	// IMP=0x00000000001741ac
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000017402e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000173f8d
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x0000000000173ee3
