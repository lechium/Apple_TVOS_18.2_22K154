...
@interface LSBundleRecordBuilder
{
    ...
    NSString *_managementDeclarationIdentifier;	// 456 = 0x1c8
    NSMutableSet *_counterpartAppBundleIDs;	// 464 = 0x1d0
    NSMutableSet *_equivalentBundleIDs;	// 472 = 0x1d8
    ...
    NSDictionary *_distributorInfo;	// 536 = 0x218
    NSString *_primaryIconName;	// 544 = 0x220
    NSString *_alternatePrimaryIconName;	// 552 = 0x228
    NSDictionary *_iconsDict;	// 560 = 0x230
    NSArray *_iconFileNames;	// 568 = 0x238
    NSNumber *_purchaserDSID;	// 576 = 0x240
    NSNumber *_downloaderDSID;	// 584 = 0x248
    NSNumber *_familyID;	// 592 = 0x250
    NSNumber *_staticDiskUsage;	// 600 = 0x258
    NSString *_libraryPath;	// 608 = 0x260
    NSArray *_libraryItems;	// 616 = 0x268
    NSArray *_documentClaims;	// 624 = 0x270
    NSArray *_URLClaims;	// 632 = 0x278
    NSArray *_importedTypes;	// 640 = 0x280
    NSArray *_exportedTypes;	// 648 = 0x288
    NSArray *_queriableSchemes;	// 656 = 0x290
    NSDictionary *_pluginPlists;	// 664 = 0x298
    NSDictionary *_pluginMIDicts;	// 672 = 0x2a0
    NSArray *_driverExtensionPaths;	// 680 = 0x2a8
    NSDictionary *_groupContainers;	// 688 = 0x2b0
    NSDictionary *_entitlements;	// 696 = 0x2b8
    NSDictionary *_sandboxEnvironmentVariables;	// 704 = 0x2c0
    NSDictionary *_extensionSDK;	// 712 = 0x2c8
    NSDictionary *_intentDefinitionURLs;	// 720 = 0x2d0
    NSArray *_bgPermittedIdentifiers;	// 728 = 0x2d8
    NSDictionary *_localizedNames;	// 736 = 0x2e0
    NSDictionary *_localizedShortNames;	// 744 = 0x2e8
    NSDictionary *_localizedStrings;	// 752 = 0x2f0
    NSDictionary *_unlocalizedNamesWithContext;	// 760 = 0x2f8
...
- (void).cxx_destruct;	// IMP=0x0000000000084060
...
- (unsigned int)registerBundleRecord:(id)arg1 error:(id *)arg2;	// IMP=0x000000000008307e
- (int)activateBindings:(id)arg1 unitID:(unsigned int)arg2 bundleData:(const struct LSBundleData *)arg3;	// IMP=0x0000000000082fa5
- (struct LSBundleData)buildBundleData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000080a71
- (void)parseNSExtensionSDKDefinitionsFromDictionary:(id)arg1;	// IMP=0x0000000000080586
- (void)parseActivityTypesFromDictionary:(id)arg1;	// IMP=0x0000000000080323
- (_Bool)parseInstallationInfo:(id)arg1;	// IMP=0x000000000007f180
- (_Bool)parseInfoPlist:(id)arg1;	// IMP=0x000000000007d017
- (void)parseURLClaimsFromDict:(id)arg1;	// IMP=0x000000000007cda4
- (void)parseDocumentClaimsFromDict:(id)arg1;	// IMP=0x000000000007cab4
- (void)parseDeviceFamilyFromDict:(id)arg1;	// IMP=0x000000000007c947
- (void)parseIconFilenamesFromDict:(id)arg1 forPlatform:(unsigned int)arg2;	// IMP=0x000000000007c861
- (id)iconsDictionaryFromDict:(id)arg1;	// IMP=0x000000000007c2a4
- (void)parseArchitecturesFromDict:(id)arg1;	// IMP=0x000000000007c236
- (void)setCommonInfoPlistKeysFromDictionary:(id)arg1;	// IMP=0x000000000007c100
- (void)setRaritiesFromDictionary:(id)arg1;	// IMP=0x000000000007be74
- (void)setFlagsFromDictionary:(id)arg1;	// IMP=0x000000000007bbcf
- (id)_LSKeyTypeMap;	// IMP=0x000000000007b9be
- (id)_LSPlistRaritiesMap;	// IMP=0x000000000007b792
- (id)_LSBundleFlagMap;	// IMP=0x000000000007b284
- (id)truncate:(_Bool *)arg1 queriableSchemesIfNeeded:(id)arg2;	// IMP=0x000000000007b02f
- (int)registerQueriableSchemes:(id)arg1 bundleData:(struct LSBundleData *)arg2;	// IMP=0x000000000007ac26
- (void)addItemInfoFlag:(unsigned int)arg1;	// IMP=0x000000000007ac16
- (void)addIconFlag:(unsigned char)arg1;	// IMP=0x000000000007ac06
- (void)addPlistFlag:(unsigned int)arg1;	// IMP=0x000000000007abf6
- (void)addBundleFlag:(unsigned long long)arg1;	// IMP=0x000000000007abe5
- (void)setRegistrationInfo:(id)arg1 alias:(id)arg2;	// IMP=0x000000000007aad3
