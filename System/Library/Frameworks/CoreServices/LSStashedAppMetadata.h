...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002a584
- (void).cxx_destruct;	// IMP=0x000000000002ac68
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x000000000002a7f3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002a74d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002a58c
