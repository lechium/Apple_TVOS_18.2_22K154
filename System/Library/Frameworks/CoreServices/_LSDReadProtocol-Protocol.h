...
@class FSMimic, FSNode, NSArray, NSSet, NSString, NSUUID, _LSDiskUsage;

@protocol _LSDReadProtocol
- (void)getRedactedAppexRecordForSystemAppexWithUUID:(NSUUID *)arg1 node:(FSNode *)arg2 bundleIdentifier:(NSString *)arg3 platform:(unsigned int)arg4 completionHandler:(void (^)(LSApplicationExtensionRecord *, NSError *))arg5;
