...
- (void)performUpdateOfPersonasOfBundleIDs:(NSSet *)arg1 toPersonaUniqueStrings:(NSSet *)arg2 operationUUID:(NSUUID *)arg3 reply:(void (^)(id <_LSPendingSaveToken>, NSError *))arg4;
