...
- (void)destroyBuffer:(id)arg1;	// IMP=0x00000000000144a5
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000014144
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x0000000000014000
