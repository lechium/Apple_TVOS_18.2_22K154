...
- (void).cxx_destruct;	// IMP=0x00000000000113cb
...
- (void)addPresentedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000011387
@property(nonatomic) struct CGSize size;
@property(nonatomic) unsigned long long pixelFormat;
@property(readonly) id <MTLTexture> texture;
- (void)presentAtTime:(double)arg1;	// IMP=0x00000000000111c7
- (void)presentAfterMinimumDuration:(double)arg1;	// IMP=0x00000000000111a3
- (void)present;	// IMP=0x0000000000011181
- (id)initWithDevice:(id)arg1 pixelFormat:(unsigned long long)arg2 size:(struct CGSize)arg3 drawableID:(unsigned long long)arg4;	// IMP=0x00000000000110db
