...
- (void).cxx_destruct;	// IMP=0x000000000054aaf0
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x000000000054a1c0
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x0000000000549b10
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x0000000000549380
- (void)startWithHandler:(id)arg1;	// IMP=0x0000000000548090
- (void)dealloc;	// IMP=0x0000000000548060
- (id)init;	// IMP=0x0000000000547d90
