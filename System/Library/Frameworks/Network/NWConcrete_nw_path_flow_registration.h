...
@interface NWConcrete_nw_path_flow_registration : NSObject
{
    ...
    NWConcrete_nw_path_evaluator *override_evaluator;	// 136 = 0x88
    unsigned int override_traffic_class;	// 144 = 0x90
    unsigned int registered:1;	// 148 = 0x94
    unsigned int partial_checksum_offload:1;	// 148 = 0x94
    unsigned int uses_nexus:1;	// 148 = 0x94
    unsigned int override_is_expensive:1;	// 148 = 0x94
    unsigned int override_is_constrained:1;	// 148 = 0x94
    unsigned int override_uses_wifi:1;	// 148 = 0x94
    unsigned int override_uses_cellular:1;	// 148 = 0x94
    unsigned int override_reason:1;	// 148 = 0x94
    unsigned int specific_use_only:1;	// 149 = 0x95
}

- (void).cxx_destruct;	// IMP=0x00000000009e4350
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000009e4220
- (id)init;	// IMP=0x00000000009e3f50
