...
- (void).cxx_destruct;	// IMP=0x0000000000440660
- (unsigned long long)hash;	// IMP=0x0000000000440530
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000440310
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000440140
- (void)writeTo:(id)arg1;	// IMP=0x000000000043ffc0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000043ffb0
- (id)dictionaryRepresentation;	// IMP=0x000000000043fcb0
- (id)description;	// IMP=0x000000000043fc00
