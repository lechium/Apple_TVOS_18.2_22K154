...
- (void).cxx_destruct;	// IMP=0x0000000000ad0c40
- (_Bool)applyWithHandler:(id)arg1 toChildren:(CDUnknownBlockType)arg2;	// IMP=0x0000000000ad0310
- (void)updatePathWithHandler:(id)arg1;	// IMP=0x0000000000acfc80
- (void)cancelWithHandler:(id)arg1 forced:(_Bool)arg2;	// IMP=0x0000000000acf520
- (void)startWithHandler:(id)arg1;	// IMP=0x0000000000aceaa0
- (void)dealloc;	// IMP=0x0000000000acea70
- (id)init;	// IMP=0x0000000000ace7a0
