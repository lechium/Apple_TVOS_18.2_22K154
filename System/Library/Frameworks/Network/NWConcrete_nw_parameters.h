...
@interface NWConcrete_nw_parameters : NSObject
{
    struct {
        ...
        unsigned int allow_private_access_tokens_for_third_party:1;
        unsigned int using_ephemeral_configuration:1;
        unsigned int prevents_system_http_proxy_authentication:1;
        unsigned int inherited_from_silent_context:1;
        unsigned int tls_should_trust_invalid_certificates:1;
        unsigned int skip_probe_sampling:1;
        unsigned int __pad_bits:17;
    } value;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x00000000003c6b00
- (id)redactedDescription;	// IMP=0x00000000003c6ae0
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000003c6a30
