...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000d68d
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000d77d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000d695
- (void)dealloc;	// IMP=0x000000000000d64a
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000d5bc
