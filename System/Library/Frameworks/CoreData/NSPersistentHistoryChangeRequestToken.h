...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000dc07
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000de28
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000dc0f
- (void)dealloc;	// IMP=0x000000000000dba3
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000da76
