...
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x000000000026260c
- (_Bool)validate:(id *)arg1;	// IMP=0x0000000000260115
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000025fff5
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x000000000025ff40
