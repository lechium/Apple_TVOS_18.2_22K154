...
- (void)executeEpilogue;	// IMP=0x0000000000067566
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x0000000000067091
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x0000000000067063
- (void)executePrologue;	// IMP=0x000000000006705d
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x0000000000066ee7
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x0000000000066d79
