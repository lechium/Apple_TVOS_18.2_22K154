...
- (void).cxx_destruct;	// IMP=0x000000000029821d
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x00000000002981b8
- (void)applicationDidActivate:(id)arg1;	// IMP=0x00000000002981a7
- (void)dealloc;	// IMP=0x0000000000298126
- (id)init;	// IMP=0x0000000000297980
