...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015654b
- (void)dealloc;	// IMP=0x0000000000156501
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x0000000000156498
