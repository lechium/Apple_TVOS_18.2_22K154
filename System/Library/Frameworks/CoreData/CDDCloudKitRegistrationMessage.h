...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001ac4b9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001ac395
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001ac1dd
- (void)dealloc;	// IMP=0x00000000001ac13f
