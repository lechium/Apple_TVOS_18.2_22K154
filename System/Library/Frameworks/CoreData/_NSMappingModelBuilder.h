...
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x0060000000060ce5
+ (int)migrationDebugLevel;	// IMP=0x0060000000060ccc
- (void)dealloc;	// IMP=0x0000000000060d67
- (id)initWithSourceModel:(id)arg1 destinationModel:(id)arg2;	// IMP=0x0000000000060cfe
