...
- (id)description;	// IMP=0x0000000000144d60
- (void)updateWithChange:(id)arg1;	// IMP=0x0000000000144c8c
- (void)dealloc;	// IMP=0x0000000000144c1a
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x0000000000144b0c
