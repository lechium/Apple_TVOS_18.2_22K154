...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c0ac
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c46a
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c0b4
- (void)dealloc;	// IMP=0x000000000000c048
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000bf99
