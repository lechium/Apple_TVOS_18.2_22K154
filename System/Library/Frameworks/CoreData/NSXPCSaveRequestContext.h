...
- (id)managedObjectContext;	// IMP=0x00000000002aa950
- (void)dealloc;	// IMP=0x00000000002aa8ef
- (id)initForStore:(id)arg1 request:(id)arg2 metadata:(id)arg3 forceInsertsToUpdates:(_Bool)arg4 context:(id)arg5;	// IMP=0x00000000002aa801
