...
- (void)dealloc;	// IMP=0x0000000000252f0d
- (id)initWithRequest:(id)arg1 storeIdentifier:(id)arg2 acceptedShares:(id)arg3 acceptedShareMetadatas:(id)arg4 error:(id)arg5;	// IMP=0x0000000000252d7d
