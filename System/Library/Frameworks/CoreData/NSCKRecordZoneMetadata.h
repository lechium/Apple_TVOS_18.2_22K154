...
+ (id)entityPath;	// IMP=0x004000000016f2e5
+ (id)fetchZoneIDsAssignedToObjectsWithIDs:(id)arg1 fromStore:(id)arg2 inContext:(id)arg3 error:(id *)arg4;	// IMP=0x004000000016ecc4
