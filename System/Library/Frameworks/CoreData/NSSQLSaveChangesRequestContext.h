...
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x00000000002b6254
- (void)executeEpilogue;	// IMP=0x00000000002b5235
- (void)executePrologue;	// IMP=0x00000000002b51cd
- (_Bool)isWritingRequest;	// IMP=0x00000000002b51c5
- (id)rowCache;	// IMP=0x00000000002b51b3
- (void)dealloc;	// IMP=0x00000000002b5050
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x00000000002b4e80
