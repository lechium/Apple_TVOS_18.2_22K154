...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cb4c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cd89
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cb54
- (void)dealloc;	// IMP=0x000000000000cae8
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000c804
