...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022d497
- (id)copy;	// IMP=0x000000000022d453
- (void)dealloc;	// IMP=0x000000000022d3ea
- (id)initWithOptions:(id)arg1 monitor:(id)arg2 assetStorageURL:(id)arg3 workQueue:(id)arg4 andDatabase:(id)arg5;	// IMP=0x000000000022d346
