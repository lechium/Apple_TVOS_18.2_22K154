...
- (void)dealloc;	// IMP=0x00000000002b6636
- (id)initWithStore:(id)arg1 metadataContext:(id)arg2 databaseScope:(long long)arg3 metricsClient:(id)arg4;	// IMP=0x00000000002b6586
