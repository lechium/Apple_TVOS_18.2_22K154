...
+ (id)countMoveReceiptsInStore:(id)arg1 matchingPredicate:(id)arg2 withManagedObjectContext:(id)arg3 error:(id *)arg4;	// IMP=0x004000000014b6ba
+ (id)moveReceiptsMatchingRecordIDs:(id)arg1 inManagedObjectContext:(id)arg2 persistentStore:(id)arg3 error:(id *)arg4;	// IMP=0x004000000014af6c
+ (id)entityPath;	// IMP=0x004000000014ae5b
- (id)createRecordIDForMovedRecord;	// IMP=0x000000000014aec4
