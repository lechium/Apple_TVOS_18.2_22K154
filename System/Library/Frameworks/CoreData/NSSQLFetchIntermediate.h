...
- (id)fetchIntermediateForKeypathExpression:(id)arg1;	// IMP=0x000000000019f177
- (id)generateSQLStringInContext:(id)arg1;	// IMP=0x000000000019eb4c
- (id)selectIntermediate;	// IMP=0x000000000019e255
- (_Bool)isFunctionScoped;	// IMP=0x000000000019e1e5
- (id)fetchIntermediate;	// IMP=0x000000000019e1dc
- (void)dealloc;	// IMP=0x000000000019e117
- (id)initWithScope:(id)arg1;	// IMP=0x000000000019e0ad
