...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002662e7
- (id)copy;	// IMP=0x000000000026629e
- (void)dealloc;	// IMP=0x0000000000266245
- (id)initWithDatabase:(id)arg1 options:(id)arg2;	// IMP=0x00000000002661cc
