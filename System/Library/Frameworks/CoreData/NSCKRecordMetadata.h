...
+ (id)recordFromEncodedData:(id)arg1 error:(id *)arg2;	// IMP=0x004000000005025d
+ (id)encodeRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00400000000500cd
+ (id)insertMetadataForObject:(id)arg1 setRecordName:(_Bool)arg2 inZoneWithID:(id)arg3 recordNamePrefix:(id)arg4 error:(id *)arg5;	// IMP=0x004000000004d999
+ (id)entityPath;	// IMP=0x004000000004a3ec
- (_Bool)mergeMoveReceiptsWithData:(id)arg1 error:(id *)arg2;	// IMP=0x000000000004fa51
- (id)createEncodedMoveReceiptData:(id *)arg1;	// IMP=0x000000000004f891
- (id)createRecordFromSystemFields;	// IMP=0x000000000004a5c7
