...
+ (double)actionsLeftMargin;	// IMP=0x00600000000a443d
- (void).cxx_destruct;	// IMP=0x00000000000a5ec8
...
- (_Bool)isHighlighted;	// IMP=0x00000000000a5c24
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x00000000000a5bda
- (void)_updateActionsMask;	// IMP=0x00000000000a5b0e
- (CDUnknownBlockType)completionBlockForHidingActions;	// IMP=0x00000000000a5a33
- (CDUnknownBlockType)animationBlockForPreparingToShowActions;	// IMP=0x00000000000a5429
@property(retain, nonatomic) CNContact *contact;
- (void)updateConstraints;	// IMP=0x00000000000a4962
- (void)_createViewsIfNeeded;	// IMP=0x00000000000a4619
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00000000000a4603
