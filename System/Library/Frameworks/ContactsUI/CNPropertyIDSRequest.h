...
+ (id)sharedWorkQueue;	// IMP=0x000000000005aa39
...
- (void)_requestStatusOnMainQueue:(_Bool)arg1;	// IMP=0x000000000005b04d
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x000000000005af83
@property(readonly, nonatomic) _Bool cancelled;
- (void)cancel;	// IMP=0x000000000005ae9b
- (void)cleanupDelegate;	// IMP=0x000000000005adf7
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 postToMainQueue:(_Bool)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000005aabc
