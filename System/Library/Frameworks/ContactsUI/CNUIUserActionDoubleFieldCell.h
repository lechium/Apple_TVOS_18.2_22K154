...
+ (id)subtitleTextColor;	// IMP=0x0060000000079136
- (void).cxx_destruct;	// IMP=0x0000000000079a19
...
- (void)updateFonts;	// IMP=0x000000000007972b
- (void)viewWillMoveToSuperview:(id)arg1;	// IMP=0x00000000000796de
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000007916a
