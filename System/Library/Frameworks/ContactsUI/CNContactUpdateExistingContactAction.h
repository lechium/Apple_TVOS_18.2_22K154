...
- (void).cxx_destruct;	// IMP=0x00000000000cb120
@property(retain, nonatomic) CNContact *existingContact; // @synthesize existingContact=_existingContact;
- (void)contactViewController:(id)arg1 didCompleteWithContact:(id)arg2;	// IMP=0x00000000000cb03a
- (void)performActionWithSender:(id)arg1;	// IMP=0x00000000000cac1b
