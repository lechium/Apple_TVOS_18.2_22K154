...
- (void).cxx_destruct;	// IMP=0x000000000009f1d8
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x000000000009efd4
- (void)_updateLayoutMetrics;	// IMP=0x000000000009e616
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000009e371
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000009e052
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x000000000009e023
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009df4e
