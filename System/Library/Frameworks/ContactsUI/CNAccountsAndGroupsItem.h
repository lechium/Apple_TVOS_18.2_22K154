...
- (void).cxx_destruct;	// IMP=0x00000000000ae33b
...
- (long long)localizedCompare:(id)arg1;	// IMP=0x00000000000ae1e9
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x00000000000adeee
- (void)_setSelected:(_Bool)arg1;	// IMP=0x00000000000ada73
- (id)initWithType:(long long)arg1;	// IMP=0x00000000000ad852
