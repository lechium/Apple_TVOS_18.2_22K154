...
- (void).cxx_destruct;	// IMP=0x000000000001a9f8
@property(nonatomic) __weak UIViewController *presentingViewController; // @synthesize presentingViewController=_presentingViewController;
@property(retain, nonatomic) CNContact *createdContact; // @synthesize createdContact=_createdContact;
- (void)contactViewController:(id)arg1 didCompleteWithContact:(id)arg2;	// IMP=0x000000000001a8b2
- (void)performActionWithSender:(id)arg1;	// IMP=0x000000000001a6b8
