...
- (void).cxx_destruct;	// IMP=0x00000000000690f4
...
- (id)_itemAtIndexPath:(id)arg1;	// IMP=0x0000000000068ddc
- (unsigned long long)_indexForCustomItemAtIndexPath:(id)arg1;	// IMP=0x0000000000068d1d
- (void)tableView:(id)arg1 didEndEditingRowAtIndexPath:(id)arg2;	// IMP=0x0000000000068d0b
- (_Bool)textFieldShouldEndEditing:(id)arg1;	// IMP=0x0000000000068ca6
- (_Bool)textFieldShouldReturn:(id)arg1;	// IMP=0x0000000000068be2
- (void)textFieldDidBeginEditing:(id)arg1;	// IMP=0x0000000000068af2
- (void)tableView:(id)arg1 commitEditingStyle:(long long)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x0000000000068938
- (_Bool)tableView:(id)arg1 shouldIndentWhileEditingRowAtIndexPath:(id)arg2;	// IMP=0x0000000000068930
- (long long)tableView:(id)arg1 editingStyleForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000068905
- (void)tableView:(id)arg1 willDisplayHeaderView:(id)arg2 forSection:(long long)arg3;	// IMP=0x00000000000688f0
- (void)tableView:(id)arg1 willDisplayCell:(id)arg2 forRowAtIndexPath:(id)arg3;	// IMP=0x0000000000068826
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;	// IMP=0x00000000000685bc
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000000068397
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x00000000000682c9
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x00000000000681e0
- (_Bool)isEditing;	// IMP=0x000000000006819c
- (void)_updateRightButtonItem;	// IMP=0x0000000000068056
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000000679b9
- (void)removeCustomItem:(id)arg1;	// IMP=0x00000000000679b3
- (void)customLabelUpdated:(id)arg1;	// IMP=0x0000000000067942
- (void)donePicker:(id)arg1;	// IMP=0x00000000000678d1
- (void)cancelPicker:(id)arg1;	// IMP=0x0000000000067885
- (id)titleForAddCustomItem;	// IMP=0x0000000000067827
- (id)titleForPickerItem:(id)arg1;	// IMP=0x0000000000067787
- (id)_titleForPickerItem:(id)arg1;	// IMP=0x0000000000067781
- (void)dealloc;	// IMP=0x000000000006770c
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000000675c8
