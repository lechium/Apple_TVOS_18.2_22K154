...
- (void).cxx_destruct;	// IMP=0x00000000000168d8
...
- (_Bool)contactViewController:(id)arg1 shouldPerformDefaultActionForContact:(id)arg2 propertyKey:(id)arg3 labeledValue:(id)arg4;	// IMP=0x000000000001683c
- (void)contactPicker:(id)arg1 didSelectContact:(id)arg2;	// IMP=0x0000000000016663
- (void)contactPickerDidCancel:(id)arg1;	// IMP=0x00000000000165e6
- (void)peoplePickerLinkButtonTapped;	// IMP=0x000000000001650d
- (void)performActionWithSender:(id)arg1;	// IMP=0x000000000001613c
