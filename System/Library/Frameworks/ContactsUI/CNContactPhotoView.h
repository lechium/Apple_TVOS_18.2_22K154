...
+ (id)supportedPasteboardTypes;	// IMP=0x0010000000023a99
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x0010000000023084
- (void).cxx_destruct;	// IMP=0x0000000000026687
...
- (void)avatarView:(id)arg1 willShowActions:(id)arg2;	// IMP=0x0000000000026408
- (id)presentingViewControllerForAvatarView:(id)arg1;	// IMP=0x0000000000026363
- (void)_bounceSmallPhoto;	// IMP=0x0000000000026041
- (void)_zoomContactPhoto;	// IMP=0x0000000000025e56
- (id)previewPath;	// IMP=0x0000000000025e08
- (id)_createImagePickerForEditingImageData:(id)arg1 withCropRect:(struct CGRect)arg2;	// IMP=0x0000000000025c51
- (id)_createImagePicker;	// IMP=0x0000000000025ad0
- (void)imagePickerControllerDidCancel:(id)arg1;	// IMP=0x0000000000025a65
- (void)imagePickerController:(id)arg1 didFinishPickingMediaWithInfo:(id)arg2;	// IMP=0x0000000000025663
- (void)_presentPhotoEditingSheet;	// IMP=0x0000000000024bac
- (_Bool)_isUsingCuratedPhoto;	// IMP=0x0000000000024adc
- (id)_localizedStringForProfileAction:(id)arg1 type:(id)arg2;	// IMP=0x0000000000024ad6
- (void)updateAttributionBadge;	// IMP=0x0000000000024679
- (void)updatePhoto;	// IMP=0x0000000000024349
- (void)resetPhoto;	// IMP=0x00000000000242ec
- (void)paste:(id)arg1;	// IMP=0x0000000000023fab
- (void)copy:(id)arg1;	// IMP=0x0000000000023e7a
- (void)menuWillHide:(id)arg1;	// IMP=0x0000000000023e41
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000000023d8d
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x0000000000023ca5
- (void)longPressGesture:(id)arg1;	// IMP=0x00000000000239bb
- (void)avatarTapped:(id)arg1;	// IMP=0x0000000000023937
- (void)disablePhotoTapGesture;	// IMP=0x000000000002390a
- (void)setHighlightedFrame:(_Bool)arg1;	// IMP=0x00000000000236d7
- (void)saveEdits;	// IMP=0x00000000000233e0
- (id)currentImageDataAndCropRect:(struct CGRect *)arg1;	// IMP=0x00000000000232ec
- (id)currentImageData;	// IMP=0x00000000000232d8
- (void)updateConstraints;	// IMP=0x000000000002308c
- (void)updateFontSizes;	// IMP=0x0000000000022fd1
@property(readonly, nonatomic) CNMutableContact *mutableContact;
- (id)contact;	// IMP=0x0000000000022e37
- (_Bool)isMeContact;	// IMP=0x0000000000022e2f
- (void)dealloc;	// IMP=0x0000000000022d36
- (id)initWithFrame:(struct CGRect)arg1 monogrammerStyle:(long long)arg2;	// IMP=0x000000000002237d
