...
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x006000000004c334
- (void).cxx_destruct;	// IMP=0x000000000004d940
...
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x000000000004d730
- (void)handleTapGesture:(id)arg1;	// IMP=0x000000000004d691
- (void)updateLabelState;	// IMP=0x000000000004d34b
- (void)updateImageViewState;	// IMP=0x000000000004d23b
- (void)updatePlatterViewState;	// IMP=0x000000000004d1ed
- (void)updateConstraints;	// IMP=0x000000000004c435
- (void)didMoveToWindow;	// IMP=0x000000000004c3f4
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004c23b
