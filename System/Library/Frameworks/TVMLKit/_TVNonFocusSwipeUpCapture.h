...
- (void).cxx_destruct;	// IMP=0x00000000000b28c5
...
- (void)_onPan:(id)arg1;	// IMP=0x00000000000b2506
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000b2475
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000b23a8
