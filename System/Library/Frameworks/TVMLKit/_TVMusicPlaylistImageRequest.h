...
- (void).cxx_destruct;	// IMP=0x00000000000d8c63
...
- (void)loadImagesWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d82c0
- (id)identifier;	// IMP=0x00000000000d7d49
- (id)initWithImageProxies:(id)arg1 playlistStyle:(id)arg2;	// IMP=0x00000000000d7c90
