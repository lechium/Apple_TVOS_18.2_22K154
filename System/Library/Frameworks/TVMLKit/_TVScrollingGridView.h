...
- (void).cxx_destruct;	// IMP=0x00000000000b77a7
...
- (void)_imageWithImages:(id)arg1 cellSize:(struct CGSize)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000b6ed1
- (void)_stopAnimating;	// IMP=0x00000000000b6d46
- (void)_startAnimating;	// IMP=0x00000000000b687a
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x00000000000b6865
- (void)resume;	// IMP=0x00000000000b6853
- (void)pause;	// IMP=0x00000000000b6841
- (void)layoutSubviews;	// IMP=0x00000000000b6437
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b5c67
