...
- (void).cxx_destruct;	// IMP=0x0000000000099d2b
...
- (void)_freeBuffers;	// IMP=0x0000000000099c77
- (void)_compute;	// IMP=0x0000000000098f99
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000098efd
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000098ec2
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000098e87
- (void)dealloc;	// IMP=0x0000000000098e49
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000098dd5
