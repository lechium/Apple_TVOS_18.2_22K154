...
- (void)tv_resolveWithTextLayoutDirection:(long long)arg1 layoutObserver:(CDUnknownBlockType)arg2;	// IMP=0x003000000009e94b
- (void)tv_setImage:(id)arg1;	// IMP=0x003000000009e6b0
...
- (void)tv_setResolving:(_Bool)arg1;	// IMP=0x003000000009e541
@property(readonly, nonatomic, getter=tv_isResolving) _Bool tv_resolving;
- (void)tv_setImageProxy:(id)arg1;	// IMP=0x003000000009e495
- (id)tv_imageProxy;	// IMP=0x003000000009e484
@end
