...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014fc2f
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014f91d
- (void).cxx_destruct;	// IMP=0x0000000000150fb6
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000150596
- (_Bool)canBecomeFocused;	// IMP=0x000000000015058e
