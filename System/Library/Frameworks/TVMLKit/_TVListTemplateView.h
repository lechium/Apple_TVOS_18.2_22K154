...
- (void).cxx_destruct;	// IMP=0x00000000000b9223
...
- (void)layoutSubviews;	// IMP=0x00000000000b81d7
@property(readonly, nonatomic) long long listAlignment;
- (void)adjustScrollForListView:(id)arg1;	// IMP=0x00000000000b8057
- (id)preferredFocusEnvironments;	// IMP=0x00000000000b7fde
- (void)setOverlayBlurOffset:(double)arg1;	// IMP=0x00000000000b7e74
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x00000000000b78de
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b780b
