...
- (void).cxx_destruct;	// IMP=0x00000000000dd763
...
- (_Bool)_isSearchFieldVisible;	// IMP=0x00000000000dd67d
- (void)_transitionKeyboardOut;	// IMP=0x00000000000dd277
- (void)_transitionKeyboardInAnimated:(_Bool)arg1;	// IMP=0x00000000000dcdb2
- (void)_addKeyboard;	// IMP=0x00000000000dcc78
- (void)_pushKeyboardTowardsStableState:(unsigned long long)arg1;	// IMP=0x00000000000dca5c
...
- (void)layoutSubviews;	// IMP=0x00000000000dc228
- (void)updateConstraints;	// IMP=0x00000000000dbaa7
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000000000db86c
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x00000000000db791
- (id)preferredFocusEnvironments;	// IMP=0x00000000000db6b0
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00000000000db63b
- (void)stopEditing;	// IMP=0x00000000000db602
- (void)adjustScrollForContentOffset:(struct CGPoint)arg1;	// IMP=0x00000000000db5f0
- (id)initWithCollectionView:(id)arg1 searchBar:(id)arg2 keyboard:(id)arg3 touchEnabled:(_Bool)arg4;	// IMP=0x00000000000dacc4
