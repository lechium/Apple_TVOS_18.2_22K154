...
- (void).cxx_destruct;	// IMP=0x0000000000029298
...
- (void)reset;	// IMP=0x000000000002923c
- (void)evaluateForState:(long long)arg1;	// IMP=0x0000000000028f81
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000028e2b
- (id)init;	// IMP=0x0000000000028e1d
