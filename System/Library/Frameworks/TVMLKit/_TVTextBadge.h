...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00600000000507b3
- (void).cxx_destruct;	// IMP=0x0000000000050f0d
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000050c4b
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000050b4d
