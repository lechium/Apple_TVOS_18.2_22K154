...
- (id)tv_urlWithLayout:(id)arg1;	// IMP=0x0030000000062a36
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2;	// IMP=0x0030000000062980
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2 centerGrowth:(_Bool)arg3 cropCode:(id)arg4;	// IMP=0x003000000006274b
...
- (id)tv_imageProxyWithLayout:(id)arg1;	// IMP=0x00300000000622aa
...
- (id)tv_associatedViewElement;	// IMP=0x00300000000d2089
@end
