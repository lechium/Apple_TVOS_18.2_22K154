...
+ (id)productBannerViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x001000000009a64e
- (void).cxx_destruct;	// IMP=0x000000000009bc03
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x000000000009ba02
- (void)layoutSubviews;	// IMP=0x000000000009b112
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000009b100
- (id)preferredFocusEnvironments;	// IMP=0x000000000009ae2f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009add5
