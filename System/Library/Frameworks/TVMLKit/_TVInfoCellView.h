...
+ (id)infoCellViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x00100000000e4317
- (void).cxx_destruct;	// IMP=0x00000000000e6426
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x00000000000e6009
- (void)layoutSubviews;	// IMP=0x00000000000e5804
- (struct CGSize)sizeThatFits:(struct CGSize)arg1 withHeaderWidth:(double)arg2;	// IMP=0x00000000000e5247
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000e51fa
- (double)minimumHeaderWidth;	// IMP=0x00000000000e4eb3
