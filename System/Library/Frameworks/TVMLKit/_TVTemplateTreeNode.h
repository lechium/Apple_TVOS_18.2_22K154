...
- (void)addDerivedTemplateNode:(id)arg1;	// IMP=0x00000000000293b5
@property(readonly, copy, nonatomic) NSArray *derivedTemplateNodes;
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2 abstract:(_Bool)arg3;	// IMP=0x00000000000292d5
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2;	// IMP=0x00000000000292c0
