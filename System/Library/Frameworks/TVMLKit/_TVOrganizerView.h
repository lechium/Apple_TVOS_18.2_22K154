...
- (void).cxx_destruct;	// IMP=0x0000000000077de8
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x0000000000077a9a
- (long long)_positionFromView:(id)arg1;	// IMP=0x0000000000077a7c
- (struct CGSize)_contentSizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000077580
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000077494
- (id)preferredFocusEnvironments;	// IMP=0x0000000000077238
- (_Bool)canBecomeFocused;	// IMP=0x0000000000077230
- (void)tv_setShowcaseFactor:(double)arg1;	// IMP=0x0000000000076ff2
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000076fdd
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000076b18
- (void)layoutSubviews;	// IMP=0x0000000000075652
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000075494
- (struct UIEdgeInsets)tv_alignmentInsetsForExpectedWidth:(double)arg1;	// IMP=0x0000000000073f16
@property(nonatomic) double cornerRadius;
- (void)setComponentsNeedUpdate;	// IMP=0x0000000000072a84
@property(nonatomic) __weak UIView *preferredFocusedComponent;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000072973
