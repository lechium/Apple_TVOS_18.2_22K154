...
- (void).cxx_destruct;	// IMP=0x0000000000155a13
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000001554d5
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000155408
- (id)initWithInlineFrame:(struct CGRect)arg1 playerViewController:(id)arg2;	// IMP=0x0000000000155388
