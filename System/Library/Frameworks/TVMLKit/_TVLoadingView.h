...
- (void).cxx_destruct;	// IMP=0x00000000000f30e0
...
- (void)_showSpinner;	// IMP=0x00000000000f2e95
- (_Bool)canBecomeFocused;	// IMP=0x00000000000f2e8d
- (void)layoutSubviews;	// IMP=0x00000000000f29bd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000f274c
