...
- (void)_stopCyclingWorkoutDistanceUpdates;	// IMP=0x0000000000184e94
- (void)_startCyclingWorkoutDistanceUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001845fe
- (void)_stopOdometerUpdates;	// IMP=0x0000000000184472
- (void)_stopOdometerGpsAvailability;	// IMP=0x00000000001842fa
- (void)_startOdometerUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000183b68
- (void)_startDaemonConnection;	// IMP=0x0000000000183429
- (void)_teardown;	// IMP=0x00000000001833ce
- (void)dealloc;	// IMP=0x0000000000183384
- (id)initWithOdometer:(id)arg1;	// IMP=0x00000000001832a2
