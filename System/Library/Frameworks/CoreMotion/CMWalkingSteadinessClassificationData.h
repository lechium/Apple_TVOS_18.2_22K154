...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000167d29
...
- (id)description;	// IMP=0x0000000000167e3a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000167dce
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000167d31
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000167cd4
- (void)dealloc;	// IMP=0x0000000000167ca5
- (id)initWithLowerBound:(double)arg1 upperBound:(double)arg2 classificationType:(long long)arg3;	// IMP=0x0000000000167c4a
