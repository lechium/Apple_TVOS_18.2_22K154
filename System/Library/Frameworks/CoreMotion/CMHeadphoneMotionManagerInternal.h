...
- (void)disconnectStatus;	// IMP=0x000000000024e145
- (void)connectStatus;	// IMP=0x000000000024e0e7
- (void)disconnect;	// IMP=0x000000000024e0b3
- (void)connect;	// IMP=0x000000000024e055
- (void)dealloc;	// IMP=0x000000000024dfe6
- (id)init;	// IMP=0x000000000024df65
