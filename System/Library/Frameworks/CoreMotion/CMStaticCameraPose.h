...
- (id)description;	// IMP=0x0000000000267c41
- (id)initWithIsStatic:(_Bool)arg1 timeInStaticState:(double)arg2 timeInMovingState:(double)arg3 portraitAngle:(float)arg4 portraitUpsideDownAngle:(float)arg5 landscapeLeftAngle:(float)arg6 landscapeRightAngle:(float)arg7 faceUpAngle:(float)arg8 faceDownAngle:(float)arg9;	// IMP=0x0000000000267b8e
