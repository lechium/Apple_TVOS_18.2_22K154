...
@interface CMMotionManagerInternal : NSObject
{
    ...
    struct unique_ptr<CLDisplayGravityService, std::default_delete<CLDisplayGravityService>> fDisplayGravityService;	// 576 = 0x240
    int fPrivatePowerConservationMode;	// 584 = 0x248
    CDUnknownFunctionPointerType fPrivateNotificationCallback;	// 592 = 0x250
    void *fPrivateNotificationCallbackInfo;	// 600 = 0x258
    struct Dispatcher *fPrivateDeviceMotionSensorStatusDispatcher;	// 608 = 0x260
    CDUnknownBlockType fDeviceMotionErrorHandler;	// 616 = 0x268
    NSOperationQueue *fDeviceMotionErrorQueue;	// 624 = 0x270
    _Bool fIsApplicationActive;	// 632 = 0x278
    struct unique_ptr<CLDeviceMotionLiteService, std::default_delete<CLDeviceMotionLiteService>> fDeviceMotionLiteService;	// 640 = 0x280
    struct unique_ptr<CMMotionManagerStatsCollector, std::default_delete<CMMotionManagerStatsCollector>> fMotionManagerStatsCollector;	// 648 = 0x288
    struct Dispatcher *fFactoryGyroDispatcher;	// 656 = 0x290
    double fFactoryGyroUpdateInterval;	// 664 = 0x298
    struct Dispatcher *fFactoryGyroTemperatureDispatcher;	// 672 = 0x2a0
    double fFactoryGyroTemperatureUpdateInterval;	// 680 = 0x2a8
    CDUnknownBlockType fFactoryGyroHandler;	// 688 = 0x2b0
    NSOperationQueue *fFactoryGyroQueue;	// 696 = 0x2b8
    double fLastFactoryGyroNotificationTimestamp;	// 704 = 0x2c0
    float fLastFactoryGyroTemperature;	// 712 = 0x2c8
    _Bool fFactoryGyroFitComputed;	// 716 = 0x2cc
    struct NonlinearGyroBiasFit fFactoryGyroNonlinearGyroBiasFit;	// 717 = 0x2cd
    struct LinearFit fFactoryGyroLinearGyroBiasFit;	// 1000 = 0x3e8
    CDUnknownBlockType fKeyboardMotionHandler;	// 1024 = 0x400
    NSOperationQueue *fKeyboardMotionQueue;	// 1032 = 0x408
    struct Dispatcher *fKeyboardMotionDMDispatcher;	// 1040 = 0x410
    double fKeyboardMotionTimestampGravityHidReportPrev;	// 1048 = 0x418
    struct CMVector<float, 3UL> fKeyboardMotionGravityHIDReportPrev;	// 1056 = 0x420
    float fKeyboardMotionGravityDeltaThreshold;	// 1068 = 0x42c
    float fKeyboardMotionGravityNotificationFrequency;	// 1072 = 0x430
    struct Dispatcher *fKeyboardMotionDispatcher;	// 1080 = 0x438
    NSObject<OS_dispatch_semaphore> *fLocalTimeSyncSemaphore;	// 1088 = 0x440
    NSOperationQueue *_fDeviceMotionLiteClientQueue;	// 1096 = 0x448
    CDUnknownBlockType _fDeviceMotionLiteFusedHandler;	// 1104 = 0x450
    NSString *_fDeviceMotionLitePhysicalDeviceID;	// 1112 = 0x458
    CDUnknownBlockType _fDisplayGravityHandler;	// 1120 = 0x460
}

- (id).cxx_construct;	// IMP=0x0000000000188354
- (void).cxx_destruct;	// IMP=0x00000000001882e8
@property(copy, nonatomic) CDUnknownBlockType fDisplayGravityHandler; // @synthesize fDisplayGravityHandler=_fDisplayGravityHandler;
...
- (void)teardownPrivate;	// IMP=0x000000000018822f
- (void)dealloc;	// IMP=0x00000000001881c1
- (id)init;	// IMP=0x0000000000187e9d
