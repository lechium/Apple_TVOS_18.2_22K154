...
- (void).cxx_destruct;	// IMP=0x0000000000175798
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000175777
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x000000000017575a
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x000000000017529a
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x000000000017504c
