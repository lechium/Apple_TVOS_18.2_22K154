...
+ (_Bool)_bundleBeforeTCCCheck:(id)arg1;	// IMP=0x0060000000272a39
+ (_Bool)_bundleBeforeTCCCheck;	// IMP=0x00600000002729e1
- (id).cxx_construct;	// IMP=0x0000000000273016
- (void).cxx_destruct;	// IMP=0x0000000000273008
- (void)_stopRelativeAltitudeUpdates;	// IMP=0x0000000000272e5a
- (void)_startRelativeAltitudeUpdates;	// IMP=0x0000000000272cbe
- (void)_querySignificantElevationChangeFromDate:(id)arg1 toDate:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000272123
- (void)_stopSignificantElevationUpdates;	// IMP=0x0000000000271f7f
- (void)_startSignificantElevationUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000271da5
- (void)_stopElevationUpdates;	// IMP=0x0000000000271be1
- (void)_startElevationUpdatesWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000271a07
- (void)_teardown;	// IMP=0x0000000000271975
- (void)dealloc;	// IMP=0x00000000002718fd
- (id)init;	// IMP=0x00000000002706c0
