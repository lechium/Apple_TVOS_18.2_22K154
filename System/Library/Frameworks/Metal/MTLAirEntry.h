...
- (void)dealloc;	// IMP=0x000000000005b7c9
- (id)initWithData:(id)arg1;	// IMP=0x000000000005b76a
- (id)initWithData:(id)arg1 bitcode:(id)arg2 airScript:(id)arg3;	// IMP=0x000000000005b6e4
