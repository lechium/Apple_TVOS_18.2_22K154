...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000d5df9
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000d5d7a
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000d5cff
- (void)dealloc;	// IMP=0x00000000000d5c9e
