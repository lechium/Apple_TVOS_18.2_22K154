...
- (id)description;	// IMP=0x00000000000874bc
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x000000000008734f
- (id)describe;	// IMP=0x00000000000872c2
- (void)dealloc;	// IMP=0x000000000008727b
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x00000000000871fd
