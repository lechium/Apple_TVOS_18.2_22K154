...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000151a11
@property _Bool isUsed;
@property(readonly, getter=isUsed) _Bool used;
@property(readonly, getter=isActive) _Bool active;
@property(readonly, copy) NSString *description;
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000151950
- (id)formattedDescription:(unsigned long long)arg1 withPrintedTypes:(id)arg2;	// IMP=0x0000000000151584
- (id)dataTypeDescription;	// IMP=0x0000000000151573
...
- (void)dealloc;	// IMP=0x0000000000151240
@property(readonly) MTLStructType *structType; // @dynamic structType;
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6 typeDescription:(id)arg7;	// IMP=0x0000000000151179
- (id)initWithName:(id)arg1 type:(unsigned long long)arg2 access:(unsigned long long)arg3 index:(unsigned long long)arg4 active:(_Bool)arg5 arrayLength:(unsigned long long)arg6;	// IMP=0x00000000001510be
