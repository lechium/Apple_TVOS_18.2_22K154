...
- (id)newRenderPipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e1093
- (id)newComputePipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e1058
- (id)newRenderPipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000e0fac
- (id)newComputePipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x00000000000e0f00
...
- (void)dealloc;	// IMP=0x00000000000e0e10
- (id)initWithDevice:(id)arg1 pipelineLibraryData:(void *)arg2;	// IMP=0x00000000000e0d9b
