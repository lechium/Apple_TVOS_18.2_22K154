...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000145b7b
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x0000000000145ab8
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x0000000000145a3d
- (void)dealloc;	// IMP=0x00000000001459c0
