...
+ (id)indirectArgumentDescriptor;	// IMP=0x00600000000c66ae
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00600000000c663b
+ (id)alloc;	// IMP=0x00600000000c6631
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000c66a6
