...
- (void).cxx_destruct;	// IMP=0x00000000000dac8b
...
- (void)setupStatement:(id)arg1;	// IMP=0x00000000000daadd
- (void)orderDescendingByProperty:(id)arg1;	// IMP=0x00000000000daa63
- (void)orderAscendingByProperty:(id)arg1;	// IMP=0x00000000000da9e9
