...
- (void).cxx_destruct;	// IMP=0x000000000021d90d
...
- (id)targetDescription;	// IMP=0x000000000021d6cd
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000021d522
- (unsigned long long)hash;	// IMP=0x000000000021d492
