...
- (void).cxx_destruct;	// IMP=0x000000000024060a
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x000000000023fd7b
- (void)invalidate:(id)arg1;	// IMP=0x000000000023f9fd
