...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001d2722
- (void).cxx_destruct;	// IMP=0x00000000001d29da
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d2908
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d27ee
- (id)initWithRecordID:(id)arg1 databaseScope:(long long)arg2 fieldName:(id)arg3 signature:(id)arg4;	// IMP=0x00000000001d272a
