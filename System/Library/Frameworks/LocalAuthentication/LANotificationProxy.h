...
- (void)newValue:(id)arg1 oldValue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000019c05
- (id)initWithTarget:(id)arg1;	// IMP=0x0000000000019ba1
