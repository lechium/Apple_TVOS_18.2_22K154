...
- (void).cxx_destruct;	// IMP=0x0020000000180865
@property(readonly, nonatomic) BSSimpleAssertion *assertion; // @synthesize assertion=_assertion;
@property(readonly, copy, nonatomic) NSString *reason; // @synthesize reason=_reason;
- (void)invalidate;	// IMP=0x001000000018083a
- (void)dealloc;	// IMP=0x00100000001807f8
- (id)initWithReason:(id)arg1;	// IMP=0x0010000000180635
