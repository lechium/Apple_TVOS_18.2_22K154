...
+ (id)sharedInstance;	// IMP=0x004000000018e7de
- (void).cxx_destruct;	// IMP=0x002000000018f686
...
- (void)_callUpdateHandlerForNotificationName:(id)arg1 notification:(id)arg2;	// IMP=0x001000000018f562
- (void)_updateAirplayDisplayActiveFromNotification:(id)arg1;	// IMP=0x001000000018f2cb
- (void)_rebuildCache;	// IMP=0x001000000018f0d4
- (void)_initializeCache;	// IMP=0x001000000018edbe
- (void)_handleSystemControllerMetadataDidChangeNotification:(id)arg1;	// IMP=0x001000000018eb11
- (void)_handleSystemControllerServerConnectionDied:(id)arg1;	// IMP=0x001000000018e955
...
- (void)dealloc;	// IMP=0x001000000018e769
- (id)initWithDataProviderInitializer:(CDUnknownBlockType)arg1;	// IMP=0x001000000018e5ea
