...
- (void).cxx_destruct;	// IMP=0x002000000000f7ed
...
- (id)_createAnimationTransaction;	// IMP=0x001000000000f72e
- (void)animateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f479
- (id)initWithContainingView:(id)arg1 goingFullScreenLayout:(id)arg2 goingToPIPLayout:(id)arg3 quadrant:(long long)arg4 currentPIPInsets:(struct UIEdgeInsets)arg5;	// IMP=0x001000000000f39f
