...
- (void).cxx_destruct;	// IMP=0x00200000001b6406
...
- (void)_startFadeAnimation;	// IMP=0x00100000001b607c
- (void)_startScaleAnimation;	// IMP=0x00100000001b5cc3
- (void)_startCoordinatedAnimation;	// IMP=0x00100000001b5be9
- (void)_startReduceMotionAnimation;	// IMP=0x00100000001b5b76
- (void)_didComplete;	// IMP=0x00100000001b5a87
- (void)_willFailWithReason:(id)arg1;	// IMP=0x00100000001b597c
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x00100000001b5871
- (void);	// IMP=0x00100000001b578d
- (_Bool)_canBeInterrupted;	// IMP=0x00100000001b5785
- (id)initWithSceneLayoutViewController:(id)arg1 fromViewController:(id)arg2 toViewController:(id)arg3 isResigning:(_Bool)arg4;	// IMP=0x00100000001b56ad
