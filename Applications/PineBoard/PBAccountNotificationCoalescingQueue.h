...
- (void).cxx_destruct;	// IMP=0x002000000007e751
...
- (void)_keepNotification:(id)arg1 forAccountIdentifier:(id)arg2 removingNotification:(id)arg3;	// IMP=0x001000000007e69c
- (id)coalescedNotifications;	// IMP=0x001000000007e234
- (void)addNotification:(id)arg1;	// IMP=0x001000000007deb8
- (id)init;	// IMP=0x001000000007de2c
