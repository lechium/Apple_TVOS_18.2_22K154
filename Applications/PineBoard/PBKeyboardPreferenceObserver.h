...
- (void).cxx_destruct;	// IMP=0x0020000000140e03
...
- (void)_handleTouchPadAvailabilityUpdate;	// IMP=0x0010000000140cf1
- (void)_handlePreferredKeyboardUpdate;	// IMP=0x0010000000140b72
- (long long)_resolvedKeyboardStyle;	// IMP=0x0010000000140b65
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000140ad4
- (void)dealloc;	// IMP=0x0010000000140a74
- (id)init;	// IMP=0x0010000000140a50
- (id)initWithTouchPadAvailabilityNotificationName:(id)arg1 keyboardStyleProvider:(CDUnknownBlockType)arg2;	// IMP=0x0010000000140704
