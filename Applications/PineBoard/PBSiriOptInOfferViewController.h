...
- (void).cxx_destruct;	// IMP=0x00200000001a46ce
...
- (void)_didNotCompleteOptIn;	// IMP=0x00100000001a4642
- (void)_optOut;	// IMP=0x00100000001a45f3
- (void)_optIn;	// IMP=0x00100000001a45a1
- (void)_handleHomeButton:(id)arg1;	// IMP=0x00100000001a454e
- (void)_handleMenuButton:(id)arg1;	// IMP=0x00100000001a44fb
- (void)viewDidLoad;	// IMP=0x00100000001a3bbc
- (id)initWithOfferDictationOnly:(_Bool)arg1;	// IMP=0x00100000001a3b76
