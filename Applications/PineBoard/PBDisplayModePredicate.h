...
+ (id)predicatesWithPreferredSDRColorMapping:(long long)arg1 frameRate:(double)arg2;	// IMP=0x0040000000098f66
+ (id)predicatWithDynamicRange:(long long)arg1 frameRate:(double)arg2;	// IMP=0x0010000000098f0c
...
- (unsigned long long)hash;	// IMP=0x00100000000993b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000992bf
- (id)description;	// IMP=0x0010000000099187
@property(readonly, nonatomic) double roundedFrameRate;
- (id)initWithDynamicRange:(long long)arg1 SDRColorMapping:(long long)arg2 frameRate:(double)arg3;	// IMP=0x00100000000990de
