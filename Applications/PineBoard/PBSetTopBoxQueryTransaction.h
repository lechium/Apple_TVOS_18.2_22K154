...
- (void).cxx_destruct;	// IMP=0x002000000011b43a
...
- (void)_didComplete;	// IMP=0x001000000011b26b
- (void)_begin;	// IMP=0x001000000011ac9c
- (_Bool)_canBeInterrupted;	// IMP=0x001000000011ac94
- (double)watchdogTimeout;	// IMP=0x001000000011ac86
- (_Bool)shouldWatchdog:(id *)arg1;	// IMP=0x001000000011ac7e
@property(readonly, nonatomic, getter=isFresh) _Bool fresh;
- (id)init;	// IMP=0x001000000011abb6
- (id)initWithLog:(id)arg1 identityProviderInfoCenter:(id)arg2 currentBundleIdentifier:(id)arg3;	// IMP=0x001000000011aadc
