...
- (void).cxx_destruct;	// IMP=0x00200000001ec899
...
- (void)invalidateImage;	// IMP=0x00100000001ec811
- (id)fetchImage;	// IMP=0x00100000001ec17e
- (id)initWithSnapshotPredicate:(id)arg1 sceneID:(id)arg2 bundleIdentifier:(id)arg3 scaleFactor:(double)arg4;	// IMP=0x00100000001ec033
- (id)init;	// IMP=0x00100000001ec025
