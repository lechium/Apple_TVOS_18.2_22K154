...
- (void).cxx_destruct;	// IMP=0x00200000000df9cc
@property(readonly, copy, nonatomic) CDUnknownBlockType generationBlock; // @synthesize generationBlock=_generationBlock;
- (void)cancel;	// IMP=0x00100000000df971
- (void)main;	// IMP=0x00100000000df6de
- (id)initWithGenerationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000df658
