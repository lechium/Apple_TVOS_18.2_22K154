...
- (void).cxx_destruct;	// IMP=0x002000000023d9e1
...
- (void)_updateIconImage;	// IMP=0x001000000023d811
- (void)_updateDisplayName;	// IMP=0x001000000023d738
- (void)_updateForProgressChange;	// IMP=0x001000000023d725
- (id)description;	// IMP=0x001000000023d6eb
- (id)initWithType:(long long)arg1 bundleIdentifier:(id)arg2 appInfo:(id)arg3 dataSource:(id)arg4 live:(_Bool)arg5;	// IMP=0x001000000023d45a
