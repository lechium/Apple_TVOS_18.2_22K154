...
@class FBSSceneClientSettings, FBSSceneClientSettingsDiff, FBSSceneTransitionContext, FBSSceneUpdate, FBScene, FBSceneUpdateContext, NSError, PBSceneHandle;
...
- (void)sceneHandle:(PBSceneHandle *)arg1 didUpdateSettings:(FBSSceneUpdate *)arg2;
