...
- (void).cxx_destruct;	// IMP=0x002000000014f2b2
...
- (void)viewServiceDidTerminateWithError:(id)arg1;	// IMP=0x001000000014f1ac
- (void)viewServiceDidDismiss:(id)arg1;	// IMP=0x001000000014f0e3
- (void)viewService:(id)arg1 willDismissWithResult:(id)arg2;	// IMP=0x001000000014f077
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014ef13
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000014ee16
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (void)viewDidLoad;	// IMP=0x001000000014ecbd
- (id)initWithRemoteViewController:(id)arg1 supportsInterruption:(_Bool)arg2 allowsInteraction:(_Bool)arg3;	// IMP=0x001000000014ec03
- (id)initWithRemoteViewController:(id)arg1 supportsInterruption:(_Bool)arg2;	// IMP=0x001000000014ebea
