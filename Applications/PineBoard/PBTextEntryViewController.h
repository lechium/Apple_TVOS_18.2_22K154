...
- (void).cxx_destruct;	// IMP=0x002000000018239a
...
- (id)_messageStringAttributes;	// IMP=0x001000000018205b
- (id)_titleStringAttributes;	// IMP=0x0010000000181edf
- (void)_menuButtonPressed:(id)arg1;	// IMP=0x0010000000181e00
- (void)textEntryControllerDidFinish:(id)arg1;	// IMP=0x0010000000181d40
- (void)buttonView:(id)arg1 didSelectButton:(id)arg2 atIndex:(long long)arg3;	// IMP=0x0010000000181c5b
- (void)_synchronizeEnteredValues;	// IMP=0x0010000000181bf7
- (id)textField;	// IMP=0x0010000000181b6d
- (void)_showChildViewController:(id)arg1;	// IMP=0x00100000001819b3
- (id)_buttonsForTextField:(long long)arg1 defaultButtonIndex:(long long *)arg2;	// IMP=0x001000000018175b
- (void)_showTextEntryViewControllerForTextField:(long long)arg1;	// IMP=0x001000000018128d
- (void)_configureStateMachine;	// IMP=0x0010000000180d8d
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0010000000180d03
- (void)viewDidLoad;	// IMP=0x0010000000180cc2
- (void)loadView;	// IMP=0x0010000000180bfa
- (unsigned long long)addButtonWithTitle:(id)arg1;	// IMP=0x0010000000180b8c
- (void)setAlternateTitle:(id)arg1 message:(id)arg2 forTextFieldAtIndex:(unsigned long long)arg3;	// IMP=0x0010000000180ad0
- (unsigned long long)addTextFieldWithInitialText:(id)arg1 placeholder:(id)arg2 keyboardType:(long long)arg3;	// IMP=0x00100000001809a2
- (id)init;	// IMP=0x001000000018098b
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x001000000018088e
