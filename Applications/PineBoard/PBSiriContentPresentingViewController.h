...
- (void).cxx_destruct;	// IMP=0x002000000007d776
...
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000007d4d3
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000007d1d6
...
- (id)initWithSiriViewController:(id)arg1;	// IMP=0x001000000007d158
