...
+ (id)insertUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x004000000005ed8c
+ (id)deleteUpdateWithItem:(id)arg1 indexPath:(id)arg2;	// IMP=0x001000000005ed15
- (void).cxx_destruct;	// IMP=0x002000000005ee28
...
- (id)initWithType:(long long)arg1 item:(id)arg2 fromIndexPath:(id)arg3 toIndexPath:(id)arg4;	// IMP=0x001000000005ec2d
