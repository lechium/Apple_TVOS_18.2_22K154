...
- (void).cxx_destruct;	// IMP=0x00200000000e5204
...
- (id)_makeTransitionPayload;	// IMP=0x00100000000e4f8f
- (id)_payloadSourceApplication;	// IMP=0x00100000000e4e9c
- (_Bool)_shouldSendPayloadSourceApplication;	// IMP=0x00100000000e4dab
- (id)_makeTransitionActions;	// IMP=0x00100000000e49d5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000e4978
- (unsigned long long)hash;	// IMP=0x00100000000e48b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000e4666
- (id)debugDescription;	// IMP=0x00100000000e44a2
- (id)description;	// IMP=0x00100000000e43b5
- (id)makeSceneTransitionContext;	// IMP=0x00100000000e40fa
- (id)makeProcessExecutionContext;	// IMP=0x00100000000e3bd8
...
- (id)initWithOpenApplicationOptions:(id)arg1 trustedRequest:(_Bool)arg2 toAppInfo:(id)arg3 fromApplication:(id)arg4 sourceApplication:(id)arg5 sourceAuditToken:(id)arg6;	// IMP=0x00100000000e341c
- (id)initWithSystemServiceRequest:(id)arg1 toAppInfo:(id)arg2 fromApplication:(id)arg3 sourceApplication:(id)arg4;	// IMP=0x00100000000e32d0
