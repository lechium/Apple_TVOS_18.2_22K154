...
- (void).cxx_destruct;	// IMP=0x0020000000216a1c
...
- (void)applicationSceneView:(id)arg1 didUpdateReadiness:(_Bool)arg2;	// IMP=0x0010000000216959
- (void)applicationSceneViewDidUpdatePresentationMode:(id)arg1;	// IMP=0x0010000000216946
- (void)applicationSceneView:(id)arg1 willLoadSnapshotWithRequest:(id)arg2;	// IMP=0x0010000000216925
...
- (void)_updateDeferralTargetAssertionIfNeeded;	// IMP=0x0010000000216624
- (id)preferredFocusEnvironments;	// IMP=0x0010000000216598
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000216557
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long effectivePresentationMode;
@property(nonatomic) unsigned long long presentationMode;
- (void)setPresentationMode:(unsigned long long)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000216352
@property(readonly, nonatomic) PBApplicationSceneView *sceneView;
- (void)loadView;	// IMP=0x001000000021622f
- (void)dealloc;	// IMP=0x00100000002161e6
- (id)initWithSceneHandle:(id)arg1 layoutLevel:(long long)arg2;	// IMP=0x0010000000216135
