...
+ (id)_sharedInstance;	// IMP=0x0020000000043a9b
- (void).cxx_destruct;	// IMP=0x0020000000043c02
...
- (id)_assertionForDomain:(id)arg1;	// IMP=0x0010000000043b22
@property(readonly, copy) NSString *description;
- (id)assertionProviderForDomain:(id)arg1;	// IMP=0x00100000000439c6
- (id)init;	// IMP=0x00100000000438ed
- (id)initWithAllowedDomains:(id)arg1;	// IMP=0x001000000004371d
