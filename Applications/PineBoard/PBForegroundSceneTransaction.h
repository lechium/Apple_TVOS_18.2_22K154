...
- (void).cxx_destruct;	// IMP=0x002000000019b1de
...
- (void)_begin;	// IMP=0x001000000019ae69
- (id)initWithSceneIdentity:(id)arg1 backgroundAllOtherScenes:(_Bool)arg2;	// IMP=0x001000000019adea
