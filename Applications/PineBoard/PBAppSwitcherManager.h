...
+ (id)defaultManager;	// IMP=0x00400000000cd200
- (void).cxx_destruct;	// IMP=0x00200000000ce873
...
- (_Bool)_shouldPresentAppSwitcherForGestureActivation;	// IMP=0x00100000000ce639
- (_Bool)dismissAppSwitcherToBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000ce02c
- (void)presentAppSwitcherWithFocusedBundleIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000cd750
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (_Bool)shouldActivateForProcessWithIdentifier:(id)arg1;	// IMP=0x00100000000cd612
- (void)dealloc;	// IMP=0x00100000000cd5b7
- (id)_init;	// IMP=0x00100000000cd2a5
- (id)init;	// IMP=0x00100000000cd297
