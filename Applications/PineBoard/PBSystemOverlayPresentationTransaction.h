...
- (void).cxx_destruct;	// IMP=0x002000000015fa22
...
- (void)_begin;	// IMP=0x001000000015f6f5
- (void)interruptWithContext:(id)arg1;	// IMP=0x001000000015f6ac
- (_Bool)_canBeInterrupted;	// IMP=0x001000000015f68e
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 presentationDelegate:(id)arg4;	// IMP=0x001000000015f5b3
- (id)init;	// IMP=0x001000000015f5a5
