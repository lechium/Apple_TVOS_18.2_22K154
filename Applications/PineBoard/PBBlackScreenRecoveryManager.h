...
+ (id)sharedInstance;	// IMP=0x00200000000ac806
+ (id)dependencyDescription;	// IMP=0x00100000000ac6df
- (void).cxx_destruct;	// IMP=0x00200000000ad5cf
...
- (void)dismiss;	// IMP=0x00100000000ad503
- (void)presentForDisplayModes:(id)arg1 selectionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000aca36
...
- (id)init;	// IMP=0x00100000000ac88d
