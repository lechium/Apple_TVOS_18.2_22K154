...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x00400000000385f0
...
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000039c60
- (unsigned long long)_controlStateForCell;	// IMP=0x0010000000039b90
- (void)_addInitialConstraints;	// IMP=0x00100000000387a0
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0010000000037df0
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0010000000037cc0
- (void)setSelected:(_Bool)arg1;	// IMP=0x0010000000037ca0
- (void)updateConstraints;	// IMP=0x0010000000037260
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000037150
- (void)useFocusedAppearance;	// IMP=0x0010000000037120
- (void)layoutSubviews;	// IMP=0x0010000000036d30
- (void)prepareForReuse;	// IMP=0x0010000000036cd0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000035f20
