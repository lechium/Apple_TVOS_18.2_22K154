...
- (void).cxx_destruct;	// IMP=0x0020000000035df0
...
- (void)_updateVolume;	// IMP=0x0010000000035880
- (id)_imageForAVRoute:(id)arg1 destination:(id)arg2;	// IMP=0x0010000000035710
- (id)overrideTitle;	// IMP=0x00100000000356e0
- (void)setOverrideTitle:(id)arg1;	// IMP=0x0010000000035650
- (void)volumeController:(id)arg1 mutedStateDidChange:(_Bool)arg2;	// IMP=0x0010000000035550
- (void)volumeController:(id)arg1 volumeValueDidChange:(float)arg2;	// IMP=0x0010000000035440
- (void)volumeController:(id)arg1 volumeControlAvailableDidChange:(_Bool)arg2;	// IMP=0x0010000000035340
- (id)deviceTypeDescription;	// IMP=0x00100000000351b0
- (void)setMuted:(_Bool)arg1;	// IMP=0x0010000000035130
- (void)setVolumeLevel:(id)arg1;	// IMP=0x0010000000035060
- (id)deviceImage;	// IMP=0x0010000000034fc0
- (void)updateWithOutputDevice:(id)arg1 selectionState:(unsigned long long)arg2 destination:(id)arg3 wantsVolumeUpdates:(_Bool)arg4;	// IMP=0x00100000000345c0
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x00100000000344a0
