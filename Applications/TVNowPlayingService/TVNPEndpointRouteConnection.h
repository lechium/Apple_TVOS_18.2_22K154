...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x002000000003ee10
- (void).cxx_destruct;	// IMP=0x0020000000043d60
...
- (id)_preloadArtwork;	// IMP=0x00100000000438a0
- (id)_placeholderArtwork;	// IMP=0x00100000000437a0
- (void)_updateState;	// IMP=0x0010000000043540
- (void)_updateAutomaticResponseLoading;	// IMP=0x0010000000043450
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000042cc0
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000042b10
- (void)_updateMetadata;	// IMP=0x0010000000040130
- (void)_createRequestController;	// IMP=0x001000000003faa0
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x001000000003f7d0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x001000000003f580
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x001000000003f090
- (void)playPause;	// IMP=0x001000000003f060
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x001000000003efd0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000003eef0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x001000000003ed70
- (id)playerPath;	// IMP=0x001000000003ec80
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x001000000003ea90
- (id)description;	// IMP=0x001000000003e9a0
- (id)initWithRoute:(id)arg1;	// IMP=0x001000000003e760
