...
+ (Class)layoutAttributesClass;	// IMP=0x004000000002d410
- (void).cxx_destruct;	// IMP=0x002000000002daf0
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x001000000002d8b0
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x001000000002d5a0
- (void)prepareLayout;	// IMP=0x001000000002d440
