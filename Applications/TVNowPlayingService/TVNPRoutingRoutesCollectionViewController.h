...
- (void).cxx_destruct;	// IMP=0x0020000000034390
...
- (void)_pickRoute:(id)arg1;	// IMP=0x0010000000033c80
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0010000000033bd0
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0010000000033a60
- (void)_calculateVisibleVolumeCells;	// IMP=0x0010000000033510
- (void);	// IMP=0x00100000000333c0
- (id)_gradientMask;	// IMP=0x0010000000032d60
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0010000000032c50
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0010000000032360
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x00100000000322f0
- (void)shareAudioSelected;	// IMP=0x0010000000032250
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0010000000031f40
- (void)longPressSelect:(id)arg1;	// IMP=0x0010000000031e40
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0010000000031ce0
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000031b10
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000031940
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x00100000000318a0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0010000000031510
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x00100000000312d0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000311a0
- (void)handleVolumeDown;	// IMP=0x0010000000030b70
- (void)handleVolumeUp;	// IMP=0x00100000000304e0
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x001000000002f240
- (void)viewDidLayoutSubviews;	// IMP=0x001000000002eeb0
- (void)viewDidLoad;	// IMP=0x001000000002df80
- (void)dealloc;	// IMP=0x001000000002df30
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x001000000002dde0
