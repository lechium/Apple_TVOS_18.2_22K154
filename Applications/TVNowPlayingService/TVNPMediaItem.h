...
- (void).cxx_destruct;	// IMP=0x0020000000026740
@property(retain, nonatomic) TVNPDataImageLoader *imageLoader; // @synthesize imageLoader=_imageLoader;
- (id)mediaItemMetadataForProperty:(id)arg1;	// IMP=0x00100000000264f0
- (void)replaceMediaItemMetadata:(id)arg1 forProperty:(id)arg2;	// IMP=0x0010000000026440
