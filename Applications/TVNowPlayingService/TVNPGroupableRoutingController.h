...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000dda0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000018540
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000018060
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x0010000000016a10
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0010000000012990
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000012510
- (void)_updateAvailableRoutes;	// IMP=0x00100000000119c0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0010000000011800
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0010000000011780
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000011730
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0010000000011530
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0010000000010e80
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x00100000000109b0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000f4a0
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000f3c0
- (void);	// IMP=0x001000000000f360
- (void)dealloc;	// IMP=0x001000000000ee40
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000df50
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000deb0
- (id)init;	// IMP=0x001000000000de50
