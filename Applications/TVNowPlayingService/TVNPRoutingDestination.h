...
- (void).cxx_destruct;	// IMP=0x002000000001a2f0
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000019df0
- (void)connectAndPair;	// IMP=0x0010000000019de0
- (void)togglePlayPause;	// IMP=0x0010000000019dd0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000019d30
- (id)init;	// IMP=0x0010000000019d00
