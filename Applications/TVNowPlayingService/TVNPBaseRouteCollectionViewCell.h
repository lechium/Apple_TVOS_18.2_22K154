...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0020000000024890
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x00100000000223f0
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x001000000001db00
+ (_Bool)allowsSelection;	// IMP=0x001000000001dae0
- (void).cxx_destruct;	// IMP=0x0020000000024d70
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x0010000000024680
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000000237e0
- (unsigned long long)_controlStateForCell;	// IMP=0x0010000000023710
- (void)_addInitialConstraints;	// IMP=0x00100000000225a0
- (void)accessoryViewSelected;	// IMP=0x00100000000223e0
- (void)routeViewSelected;	// IMP=0x00100000000223d0
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x0010000000022390
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0010000000021970
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x0010000000021840
- (void)updateConstraints;	// IMP=0x001000000001fa00
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000001f8d0
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000001f8b0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000001f770
- (void)prepareForReuse;	// IMP=0x001000000001f6d0
- (id)preferredFocusEnvironments;	// IMP=0x001000000001f550
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001db20
