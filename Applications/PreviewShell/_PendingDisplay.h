...
- (void).cxx_destruct;	// IMP=0x0020000000005610
...
- (_Bool)matches:(id)arg1;	// IMP=0x001000000000553a
- (void)cancelTimeoutTimer;	// IMP=0x0010000000005508
- (void)startTimeoutTimerWithTimeout:(double)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000053d6
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000000525a
