...
- (void).cxx_destruct;	// IMP=0x0040000000010800
- (id)init;	// IMP=0x00100000000107a0
- (id)initWithName:(id)arg1 displayID:(unsigned int)arg2 displayConfiguration:(id)arg3 capabilitiesPath:(id)arg4;	// IMP=0x0010000000010710
