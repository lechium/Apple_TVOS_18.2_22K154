...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000016e14
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x0010000000016b9f
- (id)initWithDuration:(double)arg1 curve:(long long)arg2 beginningFrame:(struct CGRect)arg3 endingFrame:(struct CGRect)arg4;	// IMP=0x0010000000016b12
