...
+ (id)sharedApplication;	// IMP=0x0020000000016fe8
- (void).cxx_destruct;	// IMP=0x00200000000170c9
@property(nonatomic) __weak id <SRApplicationDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x001000000001708b
- (long long)_frontMostAppOrientation;	// IMP=0x001000000001707a
- (long long)launchOrientation;	// IMP=0x0010000000017069
