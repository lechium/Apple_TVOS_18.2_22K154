...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000009cbf
- (id)debugDescription;	// IMP=0x0010000000009815
- (MISSING_TYPE *)_debugDescriptionForProperty:integerValue: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000977c
- (id)_debugDescriptionForProperty:(id)arg1 boolValue:(_Bool)arg2;	// IMP=0x0010000000009753
- (id)_debugDescriptionForProperty:(id)arg1 formattedValue:(id)arg2;	// IMP=0x001000000000972b
- (id)initWithDeviceIsPad:(_Bool)arg1 navigationStackIsPopping:(_Bool)arg2 navigationStackSize:(long long)arg3 navigationBarHasContent:(_Bool)arg4 multiLevelViewHasContent:(_Bool)arg5 editableUtteranceViewHasContent:(_Bool)arg6 compactViewHasContent:(_Bool)arg7 siriViewControllerIsEditing:(_Bool)arg8 keyboardHasContent:(_Bool)arg9 contextMenuIsPresented:(_Bool)arg10;	// IMP=0x0010000000009687
