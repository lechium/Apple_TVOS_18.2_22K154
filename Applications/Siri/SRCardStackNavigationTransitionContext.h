...
- (void).cxx_destruct;	// IMP=0x0020000000044ff3
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x0010000000044da6
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x0010000000044d0b
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000044c98
