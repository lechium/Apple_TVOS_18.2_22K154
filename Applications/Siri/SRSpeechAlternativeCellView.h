...
- (void)updateConstraints;	// IMP=0x001000000004a544
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x001000000004a4c5
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x001000000004a476
- (struct UIEdgeInsets)edgeInsets;	// IMP=0x001000000004a40d
- (id)initWithTitle:(id)arg1;	// IMP=0x001000000004a277
