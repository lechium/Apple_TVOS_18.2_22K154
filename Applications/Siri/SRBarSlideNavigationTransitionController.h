...
- (void).cxx_destruct;	// IMP=0x0020000000005a8a
...
- (void)coordinateAdditionalTransitionsWithTransitionCoordinator:(id)arg1;	// IMP=0x0010000000005838
- (void)configureWithNavigationController:(id)arg1;	// IMP=0x001000000000577d
