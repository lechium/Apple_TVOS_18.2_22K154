...
- (void).cxx_destruct;	// IMP=0x002000000004a202
...
- (void)didFinishSynthesisRequest:(id)arg1 withInstrumentMetrics:(id)arg2 error:(id)arg3;	// IMP=0x0010000000049efd
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0010000000049313
- (id)init;	// IMP=0x00100000000488d6
