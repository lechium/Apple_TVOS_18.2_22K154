...
@class AFUserUtterance, AFUserUtteranceSelectionResults, AceObject, BKSAnimationFenceHandle, MISSING_TYPE, NSArray, NSBundle, NSDate, NSDictionary, NSIndexPath, NSLocale, NSString, NSURL, NSUUID, SASRequestOptions, SASSpeechRecognized, SAStartLocalRequest, UIViewController;
...
- (void)siriPresentationRequestsSystemUICollapse:(id <SiriUIPresentation>)arg1;
- (_Bool)siriPresentationIsPresentingSystemUI:(id <SiriUIPresentation>)arg1;
- (void)toggleSiriHomeAffordanceGestureControl:(_Bool)arg1;
- (void)toggleHomeAffordanceHidden:(_Bool)arg1;
- (MISSING_TYPE *)siriPresentation:requestsAttendingStateWithCompletion: /* Error: Ran out of types for this method. */;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 inputTypeDidChange:(long long)arg2;
...
- (void)siriResultsDidDismissInTamaleForSiriPresentation:(id <SiriUIPresentation>)arg1;
...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 startRequestForSuggestion:(NSString *)arg2 inputType:(long long)arg3;
...
@optional
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 preventOutsideTouchesFromDismissingSiri:(_Bool)arg2;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 willChangeKeyboardVisibility:(_Bool)arg2;
...
- (void)siriPresentationRequestsStartAttendingForNonSpeechRequest:(id <SiriUIPresentation>)arg1 deviceID:(NSString *)arg2;
