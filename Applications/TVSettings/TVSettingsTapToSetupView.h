...
- (void).cxx_destruct;	// IMP=0x002000000006ca22
...
- (void)_setActivityIndicatorIsInProgress:(_Bool)arg1;	// IMP=0x001000000006c897
- (void)_updateCompositingEffects;	// IMP=0x001000000006c6b6
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x001000000006c675
- (void)stopAnimatingSpinner;	// IMP=0x001000000006c661
- (void)startAnimatingSpinnerWithStatus:(id)arg1;	// IMP=0x001000000006c623
- (void)startAnimatingSpinner;	// IMP=0x001000000006c5d7
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000006a40f
