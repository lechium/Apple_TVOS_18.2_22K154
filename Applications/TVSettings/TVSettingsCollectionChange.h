...
- (void).cxx_destruct;	// IMP=0x002000000004584c
...
- (id)description;	// IMP=0x0010000000045732
- (id)init;	// IMP=0x0010000000045719
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x0010000000045659
