...
- (void).cxx_destruct;	// IMP=0x00200000000e8858
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x00100000000e86dc
- (void)_setImage:(id)arg1;	// IMP=0x00100000000e858d
@property(retain, nonatomic, setter=_setTintColor:) UIColor *_tintColor; // @synthesize _tintColor=__tintColor;
- (id)_imageView;	// IMP=0x00100000000e8410
- (void)_loadImage;	// IMP=0x00100000000e7e7e
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00100000000e7d0a
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e7924
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x00100000000e7827
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00100000000e776e
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x00100000000e76dc
- (void)setContentMode:(long long)arg1;	// IMP=0x00100000000e76b4
- (void)layoutSubviews;	// IMP=0x00100000000e7638
- (long long)contentMode;	// IMP=0x00100000000e761b
- (struct CGSize)intrinsicContentSize;	// IMP=0x00100000000e75fe
- (void)dealloc;	// IMP=0x00100000000e7599
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000e7492
