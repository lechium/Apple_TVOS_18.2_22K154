...
- (void).cxx_destruct;	// IMP=0x00200000000e582b
...
- (id)hiddenDigitImage;	// IMP=0x00100000000e53d1
- (id)arrowImage:(_Bool)arg1;	// IMP=0x00100000000e5196
- (void)downGesture:(id)arg1;	// IMP=0x00100000000e508f
- (void)upGesture:(id)arg1;	// IMP=0x00100000000e4f9a
@property(copy, nonatomic) NSString *text;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000000e4d00
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000000e4bf7
- (_Bool)canBecomeFocused;	// IMP=0x00100000000e4bef
- (void)layoutSubviews;	// IMP=0x00100000000e47fe
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000e40ee
