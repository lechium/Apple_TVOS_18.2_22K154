...
- (void).cxx_destruct;	// IMP=0x0020000000014047
...
- (void)_crossfadeToImage:(id)arg1;	// IMP=0x0010000000013d70
- (void)_loadNextImage:(id)arg1;	// IMP=0x0010000000013cd2
- (void)_startTimer;	// IMP=0x0010000000013c29
- (struct CGSize)_maximumImageSize;	// IMP=0x0010000000013bca
- (void)layoutSubviews;	// IMP=0x00100000000132b7
- (void)didMoveToSuperview;	// IMP=0x0010000000013254
- (void)dealloc;	// IMP=0x001000000001320b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000013122
