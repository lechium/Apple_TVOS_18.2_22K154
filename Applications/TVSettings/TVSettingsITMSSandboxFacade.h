...
- (void).cxx_destruct;	// IMP=0x00200000001163a2
...
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x0010000000116225
- (void)signOut;	// IMP=0x0010000000115ffa
- (void)signInSandboxAccountWithPresentingViewController:(id)arg1;	// IMP=0x0010000000115d91
- (void)updateSandboxAccountState;	// IMP=0x0010000000115ce9
- (id)_getSandboxAccount;	// IMP=0x0010000000115c88
- (void)dealloc;	// IMP=0x0010000000115c13
- (id)init;	// IMP=0x0010000000115b72
