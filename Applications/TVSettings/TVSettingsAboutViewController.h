...
- (void).cxx_destruct;	// IMP=0x0020000000059683
...
- (void)_presentSetAccessoryNameFailedViewControllerWithError:(id)arg1;	// IMP=0x0010000000059424
- (void)_setDeviceName:(id)arg1;	// IMP=0x0010000000058fea
- (id)_nameViewControllerForItem:(id)arg1;	// IMP=0x0010000000058ec0
- (void)_advanceMoreInfoItem;	// IMP=0x0010000000058d80
- (_Bool)_hasTiltID;	// IMP=0x0010000000058d16
- (_Bool)_showWiFiSettings;	// IMP=0x0010000000058cc7
- (void)_updateDiagnosticsItem:(id)arg1;	// IMP=0x0010000000058bcd
- (void)_handlePlayPauseGesture:(id)arg1;	// IMP=0x0010000000058602
- (void)_handleUpGesture:(id)arg1;	// IMP=0x00100000000585d4
- (void)_handleDownGesture:(id)arg1;	// IMP=0x0010000000058594
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000005854a
- (void)networkUpdated:(id)arg1;	// IMP=0x0010000000058538
- (void)textFieldDidEndEditing:(id)arg1;	// IMP=0x0010000000058369
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0010000000058194
- (_Bool)tableView:(id)arg1 canFocusRowAtIndexPath:(id)arg2;	// IMP=0x0010000000058144
- (id)previewForItemAtIndexPath:(id)arg1;	// IMP=0x0010000000057fd1
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x0010000000057f08
- (id)loadSettingGroups;	// IMP=0x00100000000560a5
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x001000000005603b
- (void)viewDidLoad;	// IMP=0x0010000000055dd4
- (void)dealloc;	// IMP=0x0010000000055cf4
- (id)initWithStyle:(long long)arg1;	// IMP=0x0010000000055bc1
