...
- (void).cxx_destruct;	// IMP=0x00200000000b2f2f
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00100000000b2b19
- (void)layoutSubviews;	// IMP=0x00100000000b26cc
@property(copy, nonatomic) NSString *instructionText;
@property(copy, nonatomic) NSString *titleText;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000000b2147
