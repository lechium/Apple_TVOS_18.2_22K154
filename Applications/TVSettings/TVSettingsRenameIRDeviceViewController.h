...
- (void).cxx_destruct;	// IMP=0x002000000005c068
...
- (void)editingController:(id)arg1 didCancelForSettingItem:(id)arg2;	// IMP=0x001000000005bf9f
- (void)editingController:(id)arg1 didProvideValue:(id)arg2 forSettingItem:(id)arg3;	// IMP=0x001000000005bd6c
- (void)viewDidLoad;	// IMP=0x001000000005bc70
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x001000000005bc21
