...
+ (id)sharedInstance;	// IMP=0x0040000000006298
+ (id)keyPathsForValuesAffectingLocalizedAllowAccessShortDescription;	// IMP=0x001000000000626c
+ (id)keyPathsForValuesAffectingRequireCodeEveryTime;	// IMP=0x0010000000006240
+ (id)keyPathsForValuesAffectingSecurityMode;	// IMP=0x0010000000006214
+ (id)keyPathsForValuesAffectingAccessMode;	// IMP=0x00100000000061e8
- (void).cxx_destruct;	// IMP=0x00200000000070b4
