...
+ (id)sharedInstance;	// IMP=0x0040000000110715
@property(nonatomic, getter=isEnabledOnDevice) _Bool enabledOnDevice; // @synthesize enabledOnDevice=_enabledOnDevice;
- (_Bool)setAllowAccess:(_Bool)arg1 forInfo:(id)arg2;	// IMP=0x0010000000110dec
- (id)fetchInfoMapping;	// IMP=0x00100000001108c9
