...
- (void).cxx_destruct;	// IMP=0x0020000000072147
...
- (void)_cancelIfNotConnectedYet;	// IMP=0x0010000000071f07
- (void)_cleanUp;	// IMP=0x0010000000071d77
- (void)_finishWithError:(id)arg1;	// IMP=0x00100000000716c2
- (void)_finish;	// IMP=0x0010000000070c0d
- (void)_restorePersona;	// IMP=0x0010000000070a73
- (void)_adoptPersona;	// IMP=0x00100000000706a8
- (void)_handleAuthServiceProgressEvent:(unsigned int)arg1 info:(id)arg2;	// IMP=0x001000000006f9d4
- (void)authenticateAccountsService:(id)arg1 didFinishAuthentication:(id)arg2;	// IMP=0x001000000006f8c8
- (void)authenticateAccountsService:(id)arg1 didAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x001000000006f822
- (void)authenticateAccountsService:(id)arg1 willAttemptSignInWithAccountType:(unsigned int)arg2;	// IMP=0x001000000006f77c
- (_Bool)authenticateAccountsService:(id)arg1 shouldSignInAccounts:(id)arg2;	// IMP=0x001000000006f23c
- (void)stop;	// IMP=0x001000000006f064
- (void)dealloc;	// IMP=0x001000000006f026
- (void)startWithUser:(id)arg1 needsCDPRepair:(_Bool)arg2;	// IMP=0x001000000006e569
- (id)init;	// IMP=0x001000000006e4f4
