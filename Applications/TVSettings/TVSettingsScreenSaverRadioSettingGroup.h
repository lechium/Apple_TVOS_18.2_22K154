...
- (void).cxx_destruct;	// IMP=0x00200000000176f0
- (void)setDelegate:(id)arg1;	// IMP=0x00100000000176dc
- (id)delegate;	// IMP=0x00100000000176c3
- (void)_itemSelected:(id)arg1;	// IMP=0x0010000000017621
