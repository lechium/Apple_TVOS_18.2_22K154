...
- (void).cxx_destruct;	// IMP=0x00200000000fc7fd
@property(nonatomic) __weak id <TVSettingsIPEntryViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(copy, nonatomic) NSString *prompt; // @synthesize prompt=_prompt;
- (id)_ipEntryView;	// IMP=0x00100000000fc74e
- (void)ipEntryViewDidFinishEditing:(id)arg1;	// IMP=0x00100000000fc6f1
@property(copy, nonatomic) NSString *ipAddress;
- (void)setTitle:(id)arg1;	// IMP=0x00100000000fc571
- (id)preferredFocusEnvironments;	// IMP=0x00100000000fc4cc
- (_Bool)becomeFirstResponder;	// IMP=0x00100000000fc4af
- (void)viewDidLayoutSubviews;	// IMP=0x00100000000fc1fc
- (void)loadView;	// IMP=0x00100000000fbe99
