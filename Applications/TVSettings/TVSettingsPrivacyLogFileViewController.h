...
- (void).cxx_destruct;	// IMP=0x00200000000e95f4
...
- (void)_deleteItem:(id)arg1;	// IMP=0x00100000000e9231
- (void)_airDropItem:(id)arg1;	// IMP=0x00100000000e8f5b
- (void)_viewItem:(id)arg1;	// IMP=0x00100000000e8d51
- (id)loadSettingGroups;	// IMP=0x00100000000e8900
