...
+ (id)keyPathsForValuesAffectingIsPrimaryiCloudAccount;	// IMP=0x00400000000a2f9b
+ (id)keyPathsForValuesAffectingName;	// IMP=0x00100000000a2cee
- (void).cxx_destruct;	// IMP=0x00200000000a3bfc
...
- (void)_refreshGroupRecommendationsConsent;	// IMP=0x00100000000a3a92
- (long long)_groupRecommendationsConsentFromPBSConsent:(long long)arg1;	// IMP=0x00100000000a3a7e
- (void)_updateWithUserProfile:(id)arg1 postKVONotifications:(_Bool)arg2;	// IMP=0x00100000000a319b
- (unsigned long long)hash;	// IMP=0x00100000000a3185
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000a30f4
- (id)description;	// IMP=0x00100000000a3082
@property(readonly, nonatomic) _Bool isPrimaryiCloudAccount;
- (void)setIsUpdatingGroupRecommendationsConsent:(_Bool)arg1;	// IMP=0x00100000000a2cc8
- (void)updateWithUserProfile:(id)arg1;	// IMP=0x00100000000a2af8
- (id)initWithUserProfile:(id)arg1 amsBag:(id)arg2;	// IMP=0x00100000000a29c3
