...
+ (Class)layerClass;	// IMP=0x00000000000ec2ad
- (void).cxx_destruct;	// IMP=0x00200000000ecfaa
...
- (void)_removeBoundaryTimeObservers;	// IMP=0x00100000000ecea2
- (void)_addBoundaryTimeObservers;	// IMP=0x00100000000ec743
- (void)playInLoopWithRate:(float)arg1 crossfadeDuration:(double)arg2;	// IMP=0x00100000000ec584
- (void)dealloc;	// IMP=0x00100000000ec2be
