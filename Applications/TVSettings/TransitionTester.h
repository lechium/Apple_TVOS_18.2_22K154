...
+ (id)sharedTransitionTester;	// IMP=0x0040000000061b0c
- (void).cxx_destruct;	// IMP=0x00200000000620fb
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000061da7
- (void)startPopTransition;	// IMP=0x0010000000061d39
- (void)startPushTransition;	// IMP=0x0010000000061bed
- (void)runTest;	// IMP=0x0010000000061b49
