...
- (void).cxx_destruct;	// IMP=0x002000000003136e
...
- (void)_menuPressed;	// IMP=0x00100000000312a2
- (id)_promptText;	// IMP=0x0010000000031291
- (void)ipEntryViewControllerDidFinish:(id)arg1;	// IMP=0x0010000000031212
- (void)viewDidLoad;	// IMP=0x00100000000310c6
- (id)title;	// IMP=0x00100000000310be
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000031032
