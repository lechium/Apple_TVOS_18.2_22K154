...
+ (id)sharedInstance;	// IMP=0x002000000006dd2f
- (void).cxx_destruct;	// IMP=0x000000000006e4bf
...
- (void)_clearLastKnownDeviceSyncState;	// IMP=0x001000000006e433
- (void)iCloudAccountManager:(id)arg1 didModifyActiveAccount:(id)arg2;	// IMP=0x001000000006e2f1
- (void)clearAccountPrefsForAutoAppDownloads;	// IMP=0x001000000006e2d2
- (_Bool)isAutoAppDownloadsEnabledForAccountIdentifier:(id)arg1;	// IMP=0x001000000006e1db
- (void)setAutoAppDownloadsEnabled:(_Bool)arg1 accountIdentifier:(id)arg2;	// IMP=0x001000000006e099
- (id)init;	// IMP=0x001000000006dd84
