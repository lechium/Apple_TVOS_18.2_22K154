...
- (void).cxx_destruct;	// IMP=0x002000000000cea8
...
- (void)_checkForPreloadCompletion;	// IMP=0x001000000000cd7f
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x001000000000cc92
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x001000000000cbf2
- (void)_loadPendingImages;	// IMP=0x001000000000c82a
- (id)_imageProxyToLoadNext;	// IMP=0x001000000000c77b
- (void)_fillQueue;	// IMP=0x001000000000c68f
- (unsigned long long)_currentQueueSize;	// IMP=0x001000000000c637
- (id)popNextImage;	// IMP=0x001000000000c59e
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000c54e
- (void)dealloc;	// IMP=0x001000000000c466
- (id)init;	// IMP=0x001000000000c389
