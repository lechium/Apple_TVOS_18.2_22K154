...
- (void).cxx_destruct;	// IMP=0x00200000000b6fae
@property(retain, nonatomic) TVSettingsRemotesFacade *remotesFacade; // @synthesize remotesFacade=_remotesFacade;
- (void)_editIRConfiguration:(id)arg1;	// IMP=0x00100000000b64e6
- (id)loadSettingGroups;	// IMP=0x00100000000b6328
- (id)init;	// IMP=0x00100000000b62b5
