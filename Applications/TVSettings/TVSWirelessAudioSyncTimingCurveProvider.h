...
- (void).cxx_destruct;	// IMP=0x002000000010f864
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000010f7e6
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000010f758
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000010f6c8
- (id)initWithTimingCurveProviderType:(unsigned long long)arg1;	// IMP=0x001000000010f5d1
