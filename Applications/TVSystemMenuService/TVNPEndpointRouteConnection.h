...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0020000000003910
- (void).cxx_destruct;	// IMP=0x0020000000008ad0
...
- (id)_preloadArtwork;	// IMP=0x0010000000008610
- (id)_placeholderArtwork;	// IMP=0x0010000000008510
- (void)_updateState;	// IMP=0x00100000000082b0
- (void)_updateAutomaticResponseLoading;	// IMP=0x00100000000081c0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000007940
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000007790
- (void)_updateMetadata;	// IMP=0x0010000000004d40
- (void)_createRequestController;	// IMP=0x00100000000046b0
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x00100000000043e0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00100000000040f0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0010000000003b90
- (void)playPause;	// IMP=0x0010000000003b60
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0010000000003ad0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000039f0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000003870
- (id)playerPath;	// IMP=0x0010000000003780
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0010000000003590
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000003260
