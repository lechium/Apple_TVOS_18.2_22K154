...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0010000000002c90
- (void)connectAndPair;	// IMP=0x0010000000002c80
- (void)togglePlayPause;	// IMP=0x0010000000002c70
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000002bd0
- (id)init;	// IMP=0x0010000000002ba0
