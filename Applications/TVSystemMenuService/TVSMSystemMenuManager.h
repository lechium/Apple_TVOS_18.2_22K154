...
+ (id)sharedInstance;	// IMP=0x004000000002aa00
- (void).cxx_destruct;	// IMP=0x002000000002ac30
...
- (void)dismissSystemMenuAnimated:(_Bool)arg1 result:(id)arg2;	// IMP=0x001000000002aaf0
