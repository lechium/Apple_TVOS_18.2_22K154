...
@interface TVNPGroupableRoutingController : NSObject
{
    ...
    MISSING_TYPE *_endpointIdentifiersToDestinations;	// 208 = 0xd0
...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000e0d0
- (void).cxx_destruct;	// IMP=0x0020000000018f80
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x00100000000188c0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000183e0
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x0010000000016d90
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0010000000012d10
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000012890
- (void)_updateAvailableRoutes;	// IMP=0x0010000000011d40
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0010000000011b80
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0010000000011b00
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0010000000011ab0
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x00100000000118b0
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x00100000000111a0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0010000000010cd0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000f800
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000f720
- (void)dealloc;	// IMP=0x001000000000f170
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000e280
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000e1e0
- (id)init;	// IMP=0x001000000000e180
