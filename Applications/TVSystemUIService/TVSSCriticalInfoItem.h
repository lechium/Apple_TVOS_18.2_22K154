...
- (void).cxx_destruct;	// IMP=0x00200000000ffb90
...
- (id)initWithImage:(id)arg1 title:(id)arg2 kind:(unsigned long long)arg3 usedRecently:(_Bool)arg4;	// IMP=0x00100000000ff870
