...
- (void).cxx_destruct;	// IMP=0x00200000001021b0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000101ff0
- (Class)preferredVisualizerViewClass;	// IMP=0x0010000000101fc0
- (id)initWithString:(id)arg1 font:(id)arg2 textEncapsulation:(id)arg3 userInfo:(id)arg4;	// IMP=0x0010000000101e60
- (id)initWithString:(id)arg1 font:(id)arg2 textEncapsulation:(id)arg3;	// IMP=0x0010000000101d80
