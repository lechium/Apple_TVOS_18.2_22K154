...
- (void).cxx_destruct;	// IMP=0x0020000000151ea0
@property(retain, nonatomic) UILabel *label; // @synthesize label=_label;
@property(copy, nonatomic) id <TVSSVisualContent> content; // @synthesize content=_content;
- (void)_updateContent;	// IMP=0x0010000000151cf0
- (id)_exampleContent;	// IMP=0x0010000000151cc0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00100000001517e0
