...
- (void).cxx_destruct;	// IMP=0x002000000003f920
...
- (void)_updatePlatterAnimated:(_Bool)arg1;	// IMP=0x001000000003f4a0
- (void)selectUltraWideLensButton;	// IMP=0x001000000003f160
- (void)selectWideLensButton;	// IMP=0x001000000003ee70
- (void)_updateButtonSelection;	// IMP=0x001000000003ece0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003e870
- (void)updateButtonTitleForUltraWideZoomFactor:(double)arg1;	// IMP=0x001000000003e710
- (void)updateButtonTitleForWideZoomFactor:(double)arg1;	// IMP=0x001000000003e6a0
- (void)layoutSubviews;	// IMP=0x001000000003e5c0
- (id)initWithCurrentZoomFactor:(double)arg1 supportsWideCamera:(_Bool)arg2 supportsUltraWideCamera:(_Bool)arg3 isUsingWideForFraming:(_Bool)arg4 defaultWideZoomFactor:(double)arg5 defaultUltraWideZoomFactor:(double)arg6;	// IMP=0x001000000003d0b0
