...
@optional
- (void)conversationManager:(TUConversationManager *)arg1 screenSharingRequestsChangedForConversation:(TUConversation *)arg2 fromOldConversation:(TUConversation *)arg3;
