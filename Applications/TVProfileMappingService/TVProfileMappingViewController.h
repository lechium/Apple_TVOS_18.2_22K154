...
- (void).cxx_destruct;	// IMP=0x00200000000047f0
...
- (id)preferredFocusEnvironments;	// IMP=0x0010000000004580
- (void)viewDidLoad;	// IMP=0x0010000000003340
- (id)initWithMap:(id)arg1 allProfiles:(id)arg2 allUsers:(id)arg3 appName:(id)arg4;	// IMP=0x0010000000002ee0
