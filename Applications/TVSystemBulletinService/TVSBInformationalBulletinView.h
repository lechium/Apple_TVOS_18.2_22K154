...
+ (unsigned long long)_footerLayoutForItem:(id)arg1;	// IMP=0x002000000000e580
+ (unsigned long long)_contentLayoutForItem:(id)arg1;	// IMP=0x001000000000e530
- (void).cxx_destruct;	// IMP=0x002000000000e6c0
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000000da50
