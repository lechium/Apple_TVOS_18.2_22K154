...
+ (id)infoWithSymbolName:(id)arg1 configuration:(id)arg2;	// IMP=0x0040000000019d20
+ (id)infoWithImageName:(id)arg1 configuration:(id)arg2;	// IMP=0x0010000000019c20
+ (id)infoWithImageName:(id)arg1;	// IMP=0x0010000000019b70
- (void).cxx_destruct;	// IMP=0x0020000000019e80
