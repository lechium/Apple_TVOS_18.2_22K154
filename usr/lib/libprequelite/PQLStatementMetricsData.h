...
- (id)initWithStmt:(struct sqlite3_stmt *)arg1 returnedRows:(unsigned long long)arg2 executionTime:(double)arg3 preparationTime:(double)arg4;	// IMP=0x000000000000c730
