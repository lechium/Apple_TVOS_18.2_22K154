...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001c0a6d
- (void).cxx_destruct;	// IMP=0x00000000001c10d4
...
- (id)summary;	// IMP=0x00000000001c0b8a
- (id)description;	// IMP=0x00000000001c0b78
- (id)copy;	// IMP=0x00000000001c0a75
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c092f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c07f3
- (id)initForClientAssetSetPolicy:(id)arg1 reasonDesired:(id)arg2 awaitingDownloadOfDiscovered:(_Bool)arg3 withCheckWaitTimeout:(long long)arg4 withLockWaitTimeout:(long long)arg5 desiringProgress:(_Bool)arg6;	// IMP=0x00000000001c0734
