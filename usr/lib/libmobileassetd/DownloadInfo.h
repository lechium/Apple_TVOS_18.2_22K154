...
@interface DownloadInfo : NSObject
{
    ...
    NSString *_spaceCheckedUUID;	// 208 = 0xd0
    NSMutableArray *_rateHistory;	// 216 = 0xd8
    NSString *_pallasUrl;	// 224 = 0xe0
    NSString *_assetAudience;	// 232 = 0xe8
    NSDictionary *_analyticsData;	// 240 = 0xf0
    NSDate *_downloadStartTime;	// 248 = 0xf8
    NSDate *_downloadFinishTime;	// 256 = 0x100
    NSDate *_nonDiscretionaryUpgradeTime;	// 264 = 0x108
}

- (void).cxx_destruct;	// IMP=0x00000000000c589e
...
@property(retain) NSString *spaceCheckedUUID; // @synthesize spaceCheckedUUID=_spaceCheckedUUID;
...
- (id)description;	// IMP=0x00000000000c5242
- (id)_taskState;	// IMP=0x00000000000c51b7
- (void)clearCacheServerUrl;	// IMP=0x00000000000c5197
- (void)addNewDownloadInfo:(id)arg1;	// IMP=0x00000000000c5177
- (double)currentEstimate;	// IMP=0x00000000000c4f2b
- (void)updateDownloadData:(long long)arg1;	// IMP=0x00000000000c4da4
- (_Bool)addNewRateDataPoint:(double)arg1;	// IMP=0x00000000000c4b46
- (void)determineDownloadUrl:(id)arg1 callback:(CDUnknownBlockType)arg2;	// IMP=0x00000000000c486d
- (id)initWithUrl:(id)arg1 forAssetType:(id)arg2 withPurpose:(id)arg3 clientName:(id)arg4 options:(id)arg5;	// IMP=0x00000000000c4551
- (id)initForAssetType:(id)arg1 withPurpose:(id)arg2 clientName:(id)arg3 options:(id)arg4;	// IMP=0x00000000000c4524
- (id)initWithUrl:(id)arg1 clientName:(id)arg2 options:(id)arg3;	// IMP=0x00000000000c44fd
