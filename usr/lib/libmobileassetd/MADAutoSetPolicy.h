...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000023bccc
...
- (id)summary;	// IMP=0x000000000023bfeb
- (id)description;	// IMP=0x000000000023bfd9
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000023bded
- (id)copy;	// IMP=0x000000000023bcd4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000023bb90
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000023ba81
- (id)initFromAutoAssetSetPolicy:(id)arg1;	// IMP=0x000000000023b995
- (id)init;	// IMP=0x000000000023b959
