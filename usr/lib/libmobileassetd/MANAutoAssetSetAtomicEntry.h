...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001be568
- (void).cxx_destruct;	// IMP=0x00000000001be8c3
...
- (id)summary;	// IMP=0x00000000001be66e
- (id)description;	// IMP=0x00000000001be65c
- (id)copy;	// IMP=0x00000000001be570
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001be42c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001be1d2
- (id)initWithFullAssetSelector:(id)arg1 withAssetID:(id)arg2 withLocalContentURL:(id)arg3 withAssetAttributes:(id)arg4 inhibitedFromEmergencyRemoval:(_Bool)arg5;	// IMP=0x00000000001be0e2
