...
- (void).cxx_destruct;	// IMP=0x00000000001bdb9b
@property(readonly, nonatomic) DownloadManager *downloadManager; // @synthesize downloadManager=_downloadManager;
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00000000001bd9ec
- (id)initWithDownloadManager:(id)arg1;	// IMP=0x00000000001bd981
