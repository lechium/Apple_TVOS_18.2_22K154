...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000023b73f
- (void).cxx_destruct;	// IMP=0x000000000023b926
...
- (id)summary;	// IMP=0x000000000023b828
- (id)description;	// IMP=0x000000000023b816
- (id)copy;	// IMP=0x000000000023b747
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000023b65c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000023b54c
- (id)initForClientDomainName:(id)arg1 forAssetSetIdentifier:(id)arg2 withSchedulerPolicy:(id)arg3;	// IMP=0x000000000023b494
