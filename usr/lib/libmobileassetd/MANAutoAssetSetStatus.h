...
{
    _Bool _haveReceivedLookupResponse;	// 8 = 0x8
    _Bool _vendingAtomicInstanceForConfiguredEntries;	// 9 = 0x9
...
+ (id)_shortTermLockFilenameNormalizedComponent:(id)arg1;	// IMP=0x00100000000cabb7
+ (id)shortTermLockFilename:(id)arg1 forAssetSetIdentifier:(id)arg2 forSetAtomicInstance:(id)arg3;	// IMP=0x00100000000caa49
+ (id)shortTermLockDirectory:(id)arg1 forAssetSetIdentifier:(id)arg2;	// IMP=0x00100000000ca95a
+ (id)newSelectorsForStagingSummary:(id)arg1;	// IMP=0x00100000000ca665
+ (id)newCurrentLockUsageDetailed:(id)arg1;	// IMP=0x00100000000ca58b
+ (id)newCurrentLockUsageSummary:(id)arg1;	// IMP=0x00100000000ca1a5
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c8a72
- (void).cxx_destruct;	// IMP=0x00000000000cafd4
...
- (id)summary;	// IMP=0x00000000000c9ea5
- (id)description;	// IMP=0x00000000000c9042
- (id)copy;	// IMP=0x00000000000c8a7a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c8468
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c7afe
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withCatalogCachedAssetSetID:(id)arg5 withCatalogDownloadedFromLive:(id)arg6 withCatalogLastTimeChecked:(id)arg7 withCatalogPostedDate:(id)arg8 withNewerAtomicInstanceDiscovered:(id)arg9 withNewerDiscoveredAtomicEntries:(id)arg10 withLatestDownloadedAtomicInstance:(id)arg11 withLatestDowloadedAtomicInstanceEntries:(id)arg12 withDownloadedCatalogCachedAssetSetID:(id)arg13 withDownloadedCatalogDownloadedFromLive:(id)arg14 withDownloadedCatalogLastTimeChecked:(id)arg15 withDownloadedCatalogPostedDate:(id)arg16 withCurrentNotifications:(id)arg17 withCurrentNeedPolicy:(id)arg18 withSchedulerPolicy:(id)arg19 withStagerPolicy:(id)arg20 havingReceivedLookupResponse:(_Bool)arg21 vendingAtomicInstanceForConfiguredEntries:(_Bool)arg22 withDownloadUserInitiated:(_Bool)arg23 withDownloadProgress:(id)arg24 withDownloadedNetworkBytes:(long long)arg25 withDownloadedFilesystemBytes:(long long)arg26 withCurrentLockUsage:(id)arg27 withSelectorsForStaging:(id)arg28 withAvailableForUseError:(id)arg29 withNewerVersionError:(id)arg30;	// IMP=0x00000000000c76a5
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withCatalogCachedAssetSetID:(id)arg5 withCatalogDownloadedFromLive:(id)arg6 withCatalogLastTimeChecked:(id)arg7 withCatalogPostedDate:(id)arg8 withNewerAtomicInstanceDiscovered:(id)arg9 withNewerDiscoveredAtomicEntries:(id)arg10 withLatestDownloadedAtomicInstance:(id)arg11 withLatestDowloadedAtomicInstanceEntries:(id)arg12 withDownloadedCatalogCachedAssetSetID:(id)arg13 withDownloadedCatalogDownloadedFromLive:(id)arg14 withDownloadedCatalogLastTimeChecked:(id)arg15 withDownloadedCatalogPostedDate:(id)arg16 withCurrentNotifications:(id)arg17 withCurrentNeedPolicy:(id)arg18 withSchedulerPolicy:(id)arg19 withStagerPolicy:(id)arg20 havingReceivedLookupResponse:(_Bool)arg21 withDownloadUserInitiated:(_Bool)arg22 withDownloadProgress:(id)arg23 withDownloadedNetworkBytes:(long long)arg24 withDownloadedFilesystemBytes:(long long)arg25 withCurrentLockUsage:(id)arg26 withSelectorsForStaging:(id)arg27 withAvailableForUseError:(id)arg28 withNewerVersionError:(id)arg29;	// IMP=0x00000000000c75ca
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withCatalogCachedAssetSetID:(id)arg5 withCatalogDownloadedFromLive:(id)arg6 withCatalogLastTimeChecked:(id)arg7 withCatalogPostedDate:(id)arg8 withNewerAtomicInstanceDiscovered:(id)arg9 withNewerDiscoveredAtomicEntries:(id)arg10 withLatestDownloadedAtomicInstance:(id)arg11 withLatestDowloadedAtomicInstanceEntries:(id)arg12 withDownloadedCatalogCachedAssetSetID:(id)arg13 withDownloadedCatalogDownloadedFromLive:(id)arg14 withDownloadedCatalogLastTimeChecked:(id)arg15 withDownloadedCatalogPostedDate:(id)arg16 withCurrentNotifications:(id)arg17 withCurrentNeedPolicy:(id)arg18 withSchedulerPolicy:(id)arg19 withStagerPolicy:(id)arg20 withDownloadUserInitiated:(_Bool)arg21 withDownloadProgress:(id)arg22 withDownloadedNetworkBytes:(long long)arg23 withDownloadedFilesystemBytes:(long long)arg24 withCurrentLockUsage:(id)arg25 withSelectorsForStaging:(id)arg26 withAvailableForUseError:(id)arg27 withNewerVersionError:(id)arg28;	// IMP=0x00000000000c74fd
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withCatalogCachedAssetSetID:(id)arg5 withCatalogDownloadedFromLive:(id)arg6 withCatalogLastTimeChecked:(id)arg7 withCatalogPostedDate:(id)arg8 withNewerAtomicInstanceDiscovered:(id)arg9 withNewerDiscoveredAtomicEntries:(id)arg10 withLatestDownloadedAtomicInstance:(id)arg11 withLatestDowloadedAtomicInstanceEntries:(id)arg12 withCurrentNotifications:(id)arg13 withCurrentNeedPolicy:(id)arg14 withSchedulerPolicy:(id)arg15 withStagerPolicy:(id)arg16 withDownloadUserInitiated:(_Bool)arg17 withDownloadProgress:(id)arg18 withDownloadedNetworkBytes:(long long)arg19 withDownloadedFilesystemBytes:(long long)arg20 withCurrentLockUsage:(id)arg21 withSelectorsForStaging:(id)arg22 withAvailableForUseError:(id)arg23 withNewerVersionError:(id)arg24;	// IMP=0x00000000000c714f
- (id)initStatusForClientDomain:(id)arg1 forAssetSetIdentifier:(id)arg2 withConfiguredAssetEntries:(id)arg3 withAtomicInstancesDownloaded:(id)arg4 withNewerAtomicInstanceDiscovered:(id)arg5 withNewerDiscoveredAtomicEntries:(id)arg6 withLatestDownloadedAtomicInstance:(id)arg7 withLatestDowloadedAtomicInstanceEntries:(id)arg8 withAllDownloadedAtomicInstanceEntries:(id)arg9 withCurrentNotifications:(id)arg10 withCurrentNeedPolicy:(id)arg11 withSchedulerPolicy:(id)arg12 withStagerPolicy:(id)arg13 withDownloadUserInitiated:(_Bool)arg14 withDownloadProgress:(id)arg15 withDownloadedNetworkBytes:(long long)arg16 withDownloadedFilesystemBytes:(long long)arg17 withCurrentLockUsage:(id)arg18 withSelectorsForStaging:(id)arg19 withAvailableForUseError:(id)arg20 withNewerVersionError:(id)arg21;	// IMP=0x00000000000c70a1
