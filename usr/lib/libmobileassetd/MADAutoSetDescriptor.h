...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000e888b
...
- (id)firstAssetType;	// IMP=0x00000000000eab50
- (id)newIdentityName;	// IMP=0x00000000000ea896
- (id)newSummaryWithoutEntryID;	// IMP=0x00000000000e9578
- (id)summary;	// IMP=0x00000000000e9012
- (id)description;	// IMP=0x00000000000e9000
- (id)copy;	// IMP=0x00000000000e8b89
- (id)downloadedEntryForAssetType:(id)arg1 forAssetSpecifier:(id)arg2;	// IMP=0x00000000000e8893
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000e83c9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000e7e45
- (id)initForClientDomainName:(id)arg1 forAssetSetIdentifier:(id)arg2 withDiscoveredAtomicInstance:(id)arg3 withDiscoveredAtomicEntries:(id)arg4;	// IMP=0x00000000000e7c97
