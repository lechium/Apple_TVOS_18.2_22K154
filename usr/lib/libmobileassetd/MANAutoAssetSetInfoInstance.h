...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001c8d43
- (void).cxx_destruct;	// IMP=0x00000000001c92e5
...
- (id)summary;	// IMP=0x00000000001c8fd3
- (id)description;	// IMP=0x00000000001c8d4b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c8b37
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c87bf
- (id)initUsingClientDomain:(id)arg1 forClientName:(id)arg2 withProcessName:(id)arg3 withProcessID:(long long)arg4 forAssetSetIdentifier:(id)arg5 forAtomicInstance:(id)arg6 comprisedOfEntries:(id)arg7 asEntriesWhenTargeting:(id)arg8 associatingFrameworkUUID:(id)arg9;	// IMP=0x00000000001c864e
