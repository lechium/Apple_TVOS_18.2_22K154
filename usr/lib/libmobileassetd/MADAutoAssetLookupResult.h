...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000003ceba
- (void).cxx_destruct;	// IMP=0x000000000003d12b
...
- (id)summary;	// IMP=0x000000000003ced4
- (id)description;	// IMP=0x000000000003cec2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000003cd6e
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000003caf6
- (id)initWithAssetCatalog:(id)arg1 forAssetSelector:(id)arg2 forSetConfiguration:(id)arg3 forAssetAudience:(id)arg4;	// IMP=0x000000000003ca03
- (id)initWithAssetCatalog:(id)arg1 forSetConfiguration:(id)arg2 forAssetAudience:(id)arg3;	// IMP=0x000000000003c9e9
- (id)initWithAssetCatalog:(id)arg1 forAssetSelector:(id)arg2 forAssetAudience:(id)arg3;	// IMP=0x000000000003c9d1
