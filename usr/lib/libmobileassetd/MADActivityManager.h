...
+ (_Bool)notifyStatusChange:(unsigned long long)arg1 forClient:(id)arg2 withReason:(id)arg3;	// IMP=0x00600000000968af
+ (void)noticeForActivity:(id)arg1 reason:(id)arg2;	// IMP=0x006000000009614f
+ (void)failureOfActivity:(id)arg1 withResult:(int)arg2 ofResultName:(id)arg3 forReason:(id)arg4;	// IMP=0x0060000000096054
+ (void)warningForActivity:(id)arg1 fromMethod:(id)arg2 leaderNote:(id)arg3 warning:(id)arg4;	// IMP=0x0060000000095f6b
+ (void)transferOwnership:(id)arg1 toOwner:(unsigned long long)arg2 reason:(id)arg3;	// IMP=0x0060000000095e0d
+ (void)progressForActivity:(id)arg1 calledPrimitive:(id)arg2 withErrorResult:(id)arg3;	// IMP=0x0060000000095ce6
+ (void)progressForActivity:(id)arg1 calledPrimitive:(id)arg2 withBoolResult:(_Bool)arg3;	// IMP=0x0060000000095c10
+ (void)progressForActivity:(id)arg1 calledPrimitive:(id)arg2 withSuccessResult:(_Bool)arg3;	// IMP=0x0060000000095b30
+ (void)progressForActivity:(id)arg1 callingPrimitive:(id)arg2;	// IMP=0x0060000000095a77
+ (void)sendReply:(id)arg1 withResult:(int)arg2 ofResultName:(id)arg3;	// IMP=0x00600000000958bc
+ (void)sendReply:(id)arg1 withCancelDownloadResult:(long long)arg2;	// IMP=0x0060000000095854
+ (void)sendReply:(id)arg1 withDownloadResult:(long long)arg2;	// IMP=0x00600000000957ec
+ (void)sendReply:(id)arg1 withOperationResult:(long long)arg2;	// IMP=0x0060000000095784
+ (id)newTrackingCommandForEvent:(id)arg1 forClient:(id)arg2;	// IMP=0x0060000000094aee
+ (void)unknownXPCType:(struct _xpc_type_s *)arg1 forClient:(id)arg2;	// IMP=0x00600000000949c6
+ (void)unknownXPCError:(id)arg1 forClient:(id)arg2;	// IMP=0x0060000000094883
+ (void)connectionInterruptedForClient:(id)arg1;	// IMP=0x006000000009485b
+ (void)terminationIminentForClient:(id)arg1;	// IMP=0x0060000000094833
+ (void)connectionInvalidForClient:(id)arg1;	// IMP=0x00600000000947e3
+ (id)clientForConnection:(id)arg1;	// IMP=0x00600000000944aa
+ (id)remoteProcessFullIdentifierForConnection:(id)arg1;	// IMP=0x0060000000094410
+ (id)remoteProcessIdentifierForConnection:(id)arg1;	// IMP=0x00600000000943ca
+ (id)sharedActivityManager;	// IMP=0x0060000000094150
...
- (void)_finishClientCommandActivity:(id)arg1 withResult:(int)arg2 ofResultName:(id)arg3 ableToReply:(_Bool)arg4;	// IMP=0x0000000000096580
- (void)_startClientCommandActivity:(id)arg1;	// IMP=0x00000000000964a5
- (id)_clientMADActivityTrackerForClient:(id)arg1 withProcessID:(id)arg2 withFullID:(id)arg3;	// IMP=0x0000000000096208
- (id)_clientForConnection:(id)arg1;	// IMP=0x000000000009469b
- (id)init;	// IMP=0x00000000000941a5
