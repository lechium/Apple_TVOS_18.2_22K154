...
- (void).cxx_destruct;	// IMP=0x000000000000e039
...
- (void)abandon;	// IMP=0x000000000000dfba
- (id)endAndReturnPerformanceMetrics;	// IMP=0x000000000000dfa1
- (void)begin;	// IMP=0x000000000000df9b
- (id)initWithProcessIdentifiers:(id)arg1;	// IMP=0x000000000000d974
