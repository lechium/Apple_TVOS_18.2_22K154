...
@class MTLCommandBufferDescriptor, MTLComputePassDescriptor, MTLRenderPassDescriptor, NSArray, NSDictionary, NSMutableDictionary;
@protocol MTLBuffer, MTLComputeCommandEncoder, MTLDeadlineProfile, MTLDebugCommandEncoder, MTLDrawable, MTLEvent, MTLHeap, MTLRenderCommandEncoder, MTLResource, MTLResourceGroupSPI, MTLSharedEvent;
...
- (void)setResponsibleTaskIDs:(const unsigned int *)arg1 count:(unsigned int)arg2;
...
- (void)configWithCommandBufferDescriptor:(MTLCommandBufferDescriptor *)arg1;
