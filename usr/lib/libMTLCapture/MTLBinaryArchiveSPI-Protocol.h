...
@class MTLComputePipelineDescriptor, MTLMeshRenderPipelineDescriptor, MTLRenderPipelineDescriptor, MTLTileRenderPipelineDescriptor, NSArray, NSMutableArray, NSString, NSURL;
...
- (_Bool)recompileToArchiveWithURL:(NSURL *)arg1 error:(id *)arg2;
