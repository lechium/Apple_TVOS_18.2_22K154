...
@protocol MTLAccelerationStructure, MTLBuffer, MTLIntersectionFunctionTable, MTLResidencySet, MTLResourceGroupSPI, MTLSamplerState, MTLTexture, MTLVisibleFunctionTable;
