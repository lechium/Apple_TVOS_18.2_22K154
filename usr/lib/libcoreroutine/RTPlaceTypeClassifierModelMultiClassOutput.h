...
- (void).cxx_destruct;	// IMP=0x000000000016cdf9
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000016ccd0
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithTarget:(long long)arg1 classProbability:(id)arg2;	// IMP=0x000000000016cc39
