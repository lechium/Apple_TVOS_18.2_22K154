...
- (void).cxx_destruct;	// IMP=0x00000000000869eb
...
- (id)initWithIdentifier:(id)arg1 messageType:(unsigned long long)arg2 messageSentDate:(id)arg3 pendingRetryCount:(long long)arg4 conversation:(id)arg5 callback:(id)arg6;	// IMP=0x00000000000866f5
