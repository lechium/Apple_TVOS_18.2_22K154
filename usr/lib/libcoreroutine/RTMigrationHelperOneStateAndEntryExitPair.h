...
- (void).cxx_destruct;	// IMP=0x000000000049b9d0
...
- (unsigned long long)hash;	// IMP=0x000000000049b8b8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000049b5d2
- (id)initWithOneState:(id)arg1 entryExit:(id)arg2;	// IMP=0x000000000049b539
