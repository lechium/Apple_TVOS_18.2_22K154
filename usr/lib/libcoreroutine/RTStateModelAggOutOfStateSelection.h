...
- (void).cxx_destruct;	// IMP=0x000000000045c0ba
...
- (id)initWithSelectOOStStates:(id)arg1 dailyDensityCorrection:(double)arg2 weeklyDensityCorrection:(double)arg3;	// IMP=0x000000000045bfe8
- (id)init;	// IMP=0x000000000045bf4b
