...
- (void).cxx_destruct;	// IMP=0x000000000003bbe6
...
- (id)initWithIdentifier:(id)arg1 destinations:(id)arg2 message:(id)arg3 pendingRetryCount:(long long)arg4 messageSentDate:(id)arg5 callback:(CDUnknownBlockType)arg6;	// IMP=0x000000000003b80f
