...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000007a600b
...
- (void)dealloc;	// IMP=0x00000000007a63cc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007a62cf
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007a6013
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000007a5f51
- (id)init;	// IMP=0x00000000007a5ee3
