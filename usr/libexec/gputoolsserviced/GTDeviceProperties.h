...
@interface GTDeviceProperties : NSObject
{
    ...
    MISSING_TYPE *_ProductName;	// 104 = 0x68
    NSString *_ReleaseType;	// 112 = 0x70
}

+ (id)uniqueDeviceID;	// IMP=0x0020000000017b51
+ (id)hardwareUUID;	// IMP=0x0010000000017ade
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000017ad6
- (void).cxx_destruct;	// IMP=0x0020000000018b5c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000187e0
- (id)initForEmbeddedSystem;	// IMP=0x0010000000018333
- (id)description;	// IMP=0x0010000000018306
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000017fb7
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0010000000017b97
