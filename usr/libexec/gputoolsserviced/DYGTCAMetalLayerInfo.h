...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000006105
- (void).cxx_destruct;	// IMP=0x00200000000063ce
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000006250
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000610d
