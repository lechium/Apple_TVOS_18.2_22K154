...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000003773
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000038ce
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000037e1
- (id)init;	// IMP=0x001000000000377b
