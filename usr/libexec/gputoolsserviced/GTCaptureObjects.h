...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000063de
- (void).cxx_destruct;	// IMP=0x0020000000006621
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000006528
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000063e6
