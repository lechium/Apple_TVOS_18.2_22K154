...
- (void).cxx_destruct;	// IMP=0x0020000000003f3e
@property(readonly, nonatomic) unsigned long long tokenId; // @synthesize tokenId=_tokenId;
- (void)waitUntilCompleted;	// IMP=0x0010000000003f1f
- (void)completed;	// IMP=0x0010000000003f11
- (id)description;	// IMP=0x0010000000003e93
- (id)initWithCaptureService:(id)arg1 andTokenId:(unsigned long long)arg2;	// IMP=0x0010000000003df5
