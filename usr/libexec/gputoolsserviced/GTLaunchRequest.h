...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000123d9
- (void).cxx_destruct;	// IMP=0x0020000000012b4b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000012a52
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000124b5
- (id)init;	// IMP=0x00100000000123e1
