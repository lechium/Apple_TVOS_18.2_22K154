...
- (void).cxx_destruct;	// IMP=0x0020000000005e34
...
- (void)schedule;	// IMP=0x00100000000053d0
- (void)invalidate;	// IMP=0x0010000000005357
- (void)checkIn;	// IMP=0x0010000000005153
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0010000000005099
