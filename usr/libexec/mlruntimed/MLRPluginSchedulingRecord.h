...
- (void).cxx_destruct;	// IMP=0x0020000000006c5a
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x0010000000006aed
- (id)description;	// IMP=0x0010000000006a6f
- (id)initWithPluginID:(id)arg1;	// IMP=0x0010000000006908
