...
- (void)updateWakeUpPeriodInSeconds;	// IMP=0x0010000000008ca5
- (id)fetchAllPluginIDs;	// IMP=0x0010000000008c4e
- (id)description;	// IMP=0x0010000000008bdc
- (id)init;	// IMP=0x0010000000008b24
