...
- (void)stop;	// IMP=0x0010000000001c2f
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000001af2
- (id)createTaskScheduler;	// IMP=0x0010000000001ac2
- (id)criteria;	// IMP=0x00100000000019ae
