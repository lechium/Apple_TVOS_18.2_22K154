...
- (void).cxx_destruct;	// IMP=0x0020000000008af1
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x0010000000008a7c
- (id)description;	// IMP=0x00100000000089fe
- (id)initWithTaskID:(id)arg1;	// IMP=0x00100000000088fc
