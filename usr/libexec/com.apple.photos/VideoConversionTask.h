...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x0020000000014e05
+ (_Bool)supportsDeduplication;	// IMP=0x0010000000014dfd
- (void).cxx_destruct;	// IMP=0x0020000000014d4d
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000014aa8
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000014a33
- (_Bool)isPassthroughConversion;	// IMP=0x00100000000149be
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x00100000000149b8
- (void)cancel;	// IMP=0x00100000000149b2
- (void)performConversion;	// IMP=0x0010000000014934
- (void)didEnqueue;	// IMP=0x00100000000148d2
- (_Bool)wantsResultAsData;	// IMP=0x001000000001485d
- (void)updateResultTracker;	// IMP=0x0010000000014709
- (void)callCompletionHandler;	// IMP=0x00100000000143ef
- (void)loadAsset;	// IMP=0x0010000000014262
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x0010000000013f69
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x0010000000013e19
