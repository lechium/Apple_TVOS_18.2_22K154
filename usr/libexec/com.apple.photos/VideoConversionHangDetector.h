...
- (void).cxx_destruct;	// IMP=0x0020000000013e09
@property double lastProgress; // @synthesize lastProgress=_lastProgress;
- (double);	// IMP=0x0010000000013df3
...
- (void)updateCurrentProgress:(double)arg1;	// IMP=0x0010000000013d02
- (id)initWithThresholdTimeInterval:(double)arg1;	// IMP=0x0010000000013c3b
