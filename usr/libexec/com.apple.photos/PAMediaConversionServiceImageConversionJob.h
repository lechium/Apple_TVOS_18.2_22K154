...
@interface PAMediaConversionServiceImageConversionJob : NSObject
{
    ...
    NSString *_inputFileType;	// 152 = 0x98
    NSString *_outputFileType;	// 160 = 0xa0
    PAMediaConversionServiceImageMetadataPolicy *_metadataPolicy;	// 168 = 0xa8
    NSNumber *_candidacy;	// 176 = 0xb0
    struct CGImageSource *_imageSource;	// 184 = 0xb8
    NSMutableData *_imageDestinationData;	// 192 = 0xc0
    struct CGImageDestination *_imageDestination;	// 200 = 0xc8
    unsigned long long _validationState;	// 208 = 0xd0
    struct CGSize _outputImageSize;	// 216 = 0xd8
}

- (void).cxx_destruct;	// IMP=0x002000000001025a
...
- (void)dealloc;	// IMP=0x001000000000fee8
...
@property(readonly) NSURL *adjustmentSidecarDataResourceURL;
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f2d0
- (_Bool)_validateOutputSize;	// IMP=0x001000000000f169
- (_Bool)_validateOrientation;	// IMP=0x001000000000f040
- (_Bool)_validateMetadata;	// IMP=0x001000000000eebc
- (_Bool)_validateSource;	// IMP=0x001000000000ec8d
- (void)_validate;	// IMP=0x001000000000eb25
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000eaec
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000e995
