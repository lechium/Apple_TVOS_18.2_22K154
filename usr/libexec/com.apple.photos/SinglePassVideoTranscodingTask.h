...
+ (_Bool)supportsDeduplication;	// IMP=0x0040000000019ba7
...
- (void)cancelTranscode;	// IMP=0x001000000001a51f
- (double)currentFractionCompleted;	// IMP=0x001000000001a388
- (_Bool)hasProgress;	// IMP=0x001000000001a355
- (void)performExport;	// IMP=0x0010000000019baf
