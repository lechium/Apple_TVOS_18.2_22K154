...
@interface TCCDAlert : NSObject
{
    ...
    NSDictionary *_customUserInfo;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x002000000004bc14
...
- (void)display;	// IMP=0x001000000004b807
- (_Bool)isDisplayableForCondition:(long long)arg1;	// IMP=0x001000000004b712
- (id)initWithCondition:(long long)arg1 platformName:(id)arg2 service:(id)arg3 displayPolicy:(long long)arg4 persistentStateType:(unsigned long long)arg5 displayCountlimit:(int)arg6 configuration:(id)arg7;	// IMP=0x001000000004b605
