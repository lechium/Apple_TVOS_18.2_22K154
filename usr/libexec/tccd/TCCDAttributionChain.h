...
- (void).cxx_destruct;	// IMP=0x002000000004b218
...
- (id)attributedBundleUsingOutermostBundle:(_Bool)arg1 computedStaticCodeRef:(const void **)arg2 computedNonIdentifiableBundleURL:(id *)arg3;	// IMP=0x001000000004aeb8
...
- (id)description;	// IMP=0x001000000004acbf
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2 processInfo:(id)arg3;	// IMP=0x001000000004a69e
- (id)createProcessFromAuditToken:(CDStruct_4c969caf)arg1 processInfo:(id)arg2;	// IMP=0x001000000004a65a
- (void)getAuditToken:(CDStruct_4c969caf *)arg1 fromMessage:(id)arg2;	// IMP=0x001000000004a64a
- (id)initWithMessage:(id)arg1 evaluateResponsibility:(_Bool)arg2;	// IMP=0x001000000004a635
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000004a61e
