...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x00400000000444a1
- (void).cxx_destruct;	// IMP=0x0020000000044fe2
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x0010000000044a7d
- (id)description;	// IMP=0x0010000000044a69
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x00100000000447a2
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x00100000000445e3
- (id)init;	// IMP=0x0010000000044592
