...
+ (id)identifierForInvalidCode;	// IMP=0x0040000000046562
- (void).cxx_destruct;	// IMP=0x00200000000478d2
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000047681
- (unsigned long long)hash;	// IMP=0x00100000000475bd
- (_Bool)_initializeUsingResponsibleIdentity:(id)arg1;	// IMP=0x00100000000475b5
- (_Bool)_initializeUsingTaskForAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0010000000047335
...
- (_Bool)hasEntitlement:(id)arg1 containsServiceAllOrService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00100000000471f3
- (_Bool)hasEntitlement:(id)arg1 containsService:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x0010000000046ede
- (id)description;	// IMP=0x0010000000046dbd
- (id)dictionaryValueForEntitlement:(id)arg1;	// IMP=0x0010000000046cac
- (id)arrayValueForEntitlement:(id)arg1;	// IMP=0x0010000000046b75
- (_Bool)boolValueForEntitlement:(id)arg1;	// IMP=0x0010000000046a3f
@property(readonly) NSString *responsiblePath; // @synthesize responsiblePath=_responsiblePath;
- (void)dealloc;	// IMP=0x00100000000469da
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1 responsibleIdentity:(id)arg2;	// IMP=0x0010000000046686
- (id)logHandle;	// IMP=0x0010000000046605
- (void)tccd_crash_fd_limit;	// IMP=0x001000000004656f
