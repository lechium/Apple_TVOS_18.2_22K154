...
@class MISSING_TYPE, NSDictionary, NSString, TCCDAccessIdentity, TCCDAttributionChain, TCCDServer, TCCDService;
@protocol OS_dispatch_semaphore;

@interface TCCDRequestContext : NSObject
{
    _Bool _initialPrompt;	// 8 = 0x8
    MISSING_TYPE *_reminderPrompt;	// 9 = 0x9
...
- (void).cxx_destruct;	// IMP=0x001000000004191f
...
- (id)initForSyncRequestForSubjectBundleIdentifier:(id)arg1 service:(id)arg2;	// IMP=0x00100000000412a0
- (id)init;	// IMP=0x0010000000041287
- (void)dealloc;	// IMP=0x00100000000411b8
- (id)initWithRequestMessage:(id)arg1 forServer:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000040bcc
- (void)presentAsynchronousDenialNotificationForService:(id)arg1;	// IMP=0x001000000002d580
- (void)presentAsynchronousDenialNotificationWithMessage:(id)arg1 buttonTitle:(id)arg2;	// IMP=0x001000000002ce31
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 aButtonTitle:(id)arg3 aButtonAuth:(unsigned long long)arg4 bButtonTitle:(id)arg5 bButtonAuth:(unsigned long long)arg6 currentAuth:(unsigned long long)arg7 updatingResult:(id)arg8;	// IMP=0x001000000002f0fb
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 aButtonTitle:(id)arg3 aButtonAuth:(unsigned long long)arg4 bButtonTitle:(id)arg5 bButtonAuth:(unsigned long long)arg6 cButtonTitle:(id)arg7 cButtonAuth:(unsigned long long)arg8 currentAuth:(unsigned long long)arg9 updatingResult:(id)arg10;	// IMP=0x001000000002f0b5
- (void)presentSynchronousPromptWithHeader:(id)arg1 message:(id)arg2 aButtonTitle:(id)arg3 aButtonAuth:(unsigned long long)arg4 bButtonTitle:(id)arg5 bButtonAuth:(unsigned long long)arg6 cButtonTitle:(id)arg7 cButtonAuth:(unsigned long long)arg8 currentAuth:(unsigned long long)arg9 withTimeoutInSeconds:(unsigned int)arg10 updatingResult:(id)arg11;	// IMP=0x001000000002d73f
