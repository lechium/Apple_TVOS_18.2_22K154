...
+ (void)cacheAccessIdentity:(id)arg1 forAccessorAuditToken:(CDStruct_4c969caf *)arg2 responsibleAuditToken:(CDStruct_4c969caf *)arg3 isSpecificIdentity:(_Bool)arg4;	// IMP=0x00400000000178f5
+ (id)cachedAccessIdentityForAccessorAuditToken:(CDStruct_4c969caf *)arg1 responsibleAuditToken:(CDStruct_4c969caf *)arg2 isSpecificIdentity:(_Bool)arg3;	// IMP=0x001000000001782e
+ (void)clearCache;	// IMP=0x00100000000177ad
+ (id)_createCacheKeyWithAccessorAuditToken:(CDStruct_4c969caf *)arg1 responsibleAuditToken:(CDStruct_4c969caf *)arg2 isSpecificIdentity:(_Bool)arg3;	// IMP=0x00100000000173dd
+ (void)_initIdentityCache;	// IMP=0x0010000000017338
- (void).cxx_destruct;	// IMP=0x002000000001abe1
...
- (_Bool)isPlugInWithExtensionPointIdentifier:(id)arg1;	// IMP=0x001000000001a9b8
- (_Bool)getSDKVersion:(unsigned int *)arg1 platformType:(unsigned int *)arg2;	// IMP=0x0010000000019fd8
@property(readonly) NSString *attributionPath;
- (id)displayName;	// IMP=0x0010000000019f8c
- (id)description;	// IMP=0x0010000000019f4a
- (void)_updateFromAccessIdentity:(id)arg1;	// IMP=0x0010000000019e5f
- (id)_initWithAccessIdentity:(id)arg1;	// IMP=0x0010000000019df1
- (id)initWithIdentifier:(id)arg1 type:(int)arg2 executableURL:(id)arg3 SDKVersion:(unsigned int)arg4 platformType:(unsigned int)arg5;	// IMP=0x0010000000019929
- (id)initWithBundleIdentifier:(id)arg1 isWK2Proxy:(_Bool)arg2;	// IMP=0x0010000000019776
- (id)initWithMessage:(id)arg1;	// IMP=0x0010000000019323
- (id)initWithAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x001000000001907d
- (_Bool)_deriveIdentityFromAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x0010000000017fd5
- (void)_makeDisplayNameBlockForURL:(id)arg1;	// IMP=0x0010000000017ec4
- (MISSING_TYPE *)isEqualToCachedIdentity: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000174dc
