...
+ (id)defaultLocalizedResourcesBundlePath;	// IMP=0x0040000000038de4
+ (id)requestAlternateTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000378c3
+ (id)requestAdditionalTextExtensionLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000378a7
+ (id)requestDenyNotificationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000003788b
+ (id)requestDenyNotificationTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000003786f
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000037853
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000037837
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000003781b
+ (id)reminderRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000377ff
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000377e3
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000377c7
+ (id)reminderRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000377ab
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000003778f
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000037773
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000037757
+ (id)requestAdditionalTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000003773b
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000003771f
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x0010000000037703
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000376e7
+ (id)reminderTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x00100000000376cb
+ (id)localizationKeyNameWithFeatureFlagEnabled:(id)arg1;	// IMP=0x001000000003769f
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x0010000000037677
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x00100000000375ff
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x0010000000037541
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x00100000000371f3
+ (id)serviceAll;	// IMP=0x0010000000037171
+ (id)allServices;	// IMP=0x0010000000032d07
- (void).cxx_destruct;	// IMP=0x0020000000039dec
...
// Error: Property attributes should begin with the type ('T') attribute, property name: sandboxOperationForDelegation
...
- (void)setUsesTwoStagePrompting:(_Bool)arg1;	// IMP=0x0010000000039286
- (_Bool)getUsesTwoStagePrompting;	// IMP=0x001000000003927d
- (id)populateRecordMetricWithFields:(id)arg1;	// IMP=0x0010000000039268
- (void)_makeAnalyticsPopulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039256
- (unsigned long long)translateAuth:(unsigned long long)arg1 versionUpgrade:(_Bool)arg2;	// IMP=0x001000000003923f
- (void)_makeAuthTranslationBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000003922d
- (void)_makePromptButtonLocalizationKeyBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000003921b
- (id)localizationKeyForButtonAuth:(unsigned long long)arg1 desiredAuth:(unsigned long long)arg2;	// IMP=0x0010000000039203
- (void)_makePromptAuthorizationChoiceBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000391f1
- (int)authorizationChoicesForCurrentAuth:(unsigned long long)arg1 desiredAuth:(unsigned long long)arg2 aButtonAuth:(unsigned long long *)arg3 bButtonAuth:(unsigned long long *)arg4 cButtonAuth:(unsigned long long *)arg5;	// IMP=0x00100000000391cb
- (id)usageDescriptionKeyForAuthorization:(unsigned long long)arg1;	// IMP=0x001000000003918a
- (id)buttonTitleLocalizationKeyForAuthorization:(unsigned long long)arg1 desiredAuth:(unsigned long long)arg2;	// IMP=0x0010000000039123
- (id)requestTitleTextLocalizationKeyForAuthorization:(unsigned long long)arg1;	// IMP=0x00100000000390e8
- (id)localizedTextWithKey:(id)arg1;	// IMP=0x0010000000038fb5
- (long long)developmentAuthorizationValue;	// IMP=0x0010000000038a99
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x00100000000389d0
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x0010000000038961
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x0010000000038935
- (long long)compare:(id)arg1;	// IMP=0x00100000000388a4
- (id)descriptionDictionary;	// IMP=0x0010000000037f03
- (id)description;	// IMP=0x0010000000037ef1
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x00100000000378df
