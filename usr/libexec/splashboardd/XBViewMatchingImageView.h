...
- (void).cxx_destruct;	// IMP=0x0020000000005357
...
- (void)layoutSubviews;	// IMP=0x001000000000512e
- (id)initWithMatchingView:(id)arg1 image:(id)arg2 bottom:(_Bool)arg3;	// IMP=0x0010000000004fbe
