...
+ (Class)entryClass;	// IMP=0x004000000010849a
+ (id)entityName;	// IMP=0x001000000010848d
- (id)internalRepresentation;	// IMP=0x0020000000108731
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000001084ab
