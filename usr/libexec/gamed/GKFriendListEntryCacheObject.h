...
+ (id)entityName;	// IMP=0x004000000010288b
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0020000000102898
- (id)internalRepresentation;	// IMP=0x001000000010265a
