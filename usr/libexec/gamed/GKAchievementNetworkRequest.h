...
+ (long long);	// IMP=0x00200000000d185b
+ (id)bagKey;	// IMP=0x00100000000d184e
- (void).cxx_destruct;	// IMP=0x00200000000d2981
...
- (id)requestIdentifier;	// IMP=0x00100000000d27d9
- (id)taskInfo;	// IMP=0x00100000000d265e
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000d2434
- (id)postBody;	// IMP=0x00100000000d23a6
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d2391
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x00100000000d237e
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x00100000000d1fc6
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d1cf3
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithAchievements:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000d1912
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d1866
