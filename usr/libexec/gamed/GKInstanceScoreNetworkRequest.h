...
+ (id)bagKey;	// IMP=0x00200000000d3f14
- (void).cxx_destruct;	// IMP=0x00200000000d4870
...
- (id)requestIdentifier;	// IMP=0x00100000000d46a7
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d4694
- (id)taskInfo;	// IMP=0x00100000000d44b4
- (id)postBody;	// IMP=0x00100000000d44a2
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000d4411
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00100000000d4157
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d3fcd
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d3f21
