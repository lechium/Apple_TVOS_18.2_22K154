...
+ (id)bagKey;	// IMP=0x00200000000d50c0
- (void).cxx_destruct;	// IMP=0x00200000000d5950
...
- (id)requestIdentifier;	// IMP=0x00100000000d5865
- (id)taskInfo;	// IMP=0x00100000000d570b
- (void)removeFromStore:(id)arg1;	// IMP=0x00100000000d5607
- (id)postBody;	// IMP=0x00000000000d5525
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d5479
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d539c
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d5287
- (id)initWithBundleID:(id)arg1 value:(id)arg2;	// IMP=0x00100000000d515e
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000d50cd
