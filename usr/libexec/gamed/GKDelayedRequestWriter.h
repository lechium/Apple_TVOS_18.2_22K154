...
+ (id)writerWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00200000000e2c84
- (void).cxx_destruct;	// IMP=0x00200000000e55c0
...
- (void)writeResourcesToCacheOnly:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e53ad
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e46d2
- (void)readAndSubmitDelayedRequestsOfResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e3747
- (void)deleteSubmittedRequestsWithIDs:(id)arg1 onConnection:(id)arg2;	// IMP=0x00100000000e3371
- (void)submitDelayedRequestsForPlayer:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e3247
- (void)batchAndPerformInGroup:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00100000000e2ff4
- (id)initWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00100000000e2e9d
