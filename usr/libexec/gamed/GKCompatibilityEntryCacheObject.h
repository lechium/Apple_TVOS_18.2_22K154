...
+ (id)entityName;	// IMP=0x0040000000103037
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0020000000103655
- (id)internalRepresentation;	// IMP=0x0010000000103044
