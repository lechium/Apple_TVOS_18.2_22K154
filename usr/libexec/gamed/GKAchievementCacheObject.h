...
+ (id)entityName;	// IMP=0x00400000000fce90
- (id)internalRepresentation;	// IMP=0x00200000000fce88
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00100000000fcbac
