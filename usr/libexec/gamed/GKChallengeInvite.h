...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001168d2
- (void).cxx_destruct;	// IMP=0x0020000000117e60
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x001000000011723d
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001169b9
- (id)initWithChallenge:(id)arg1;	// IMP=0x001000000011694e
- (id)challengeInternalObject;	// IMP=0x0010000000116946
- (id)description;	// IMP=0x00100000001168da
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000116801
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000116629
