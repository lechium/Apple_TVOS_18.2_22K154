...
+ (id)entityName;	// IMP=0x004000000010edf2
- (id)internalRepresentation;	// IMP=0x002000000010f152
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000010edff
