...
+ (id)entityName;	// IMP=0x0040000000112c03
- (id)internalRepresentation;	// IMP=0x0020000000112c10
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000112bfd
