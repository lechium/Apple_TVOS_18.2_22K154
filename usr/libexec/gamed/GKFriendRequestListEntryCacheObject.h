...
+ (id)entityName;	// IMP=0x004000000010621e
- (id)internalRepresentation;	// IMP=0x0020000000105f65
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000105bf6
