...
+ (id)entityName;	// IMP=0x0040000000104dec
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0020000000104df9
- (id)internalRepresentation;	// IMP=0x0010000000104adf
