...
+ (id)bagKey;	// IMP=0x00200000000d48cf
- (void).cxx_destruct;	// IMP=0x00200000000d501e
...
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x00100000000d4eac
@property(readonly, copy) NSString *description;
- (id)requestIdentifier;	// IMP=0x00100000000d4d3d
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00100000000d4d2a
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00100000000d4c49
- (id)taskInfo;	// IMP=0x00100000000d4b29
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x00100000000d4a29
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000d497d
- (id)postBody;	// IMP=0x00100000000d48dc
