...
+ (id)entityName;	// IMP=0x004000000010e00c
- (id)internalRepresentation;	// IMP=0x002000000010e437
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000010e019
