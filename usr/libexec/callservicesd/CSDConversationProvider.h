...
- (void).cxx_destruct;	// IMP=0x00200000001df652
...
- (void)isPseudonymHandleForProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001df53a
- (void)revokePseudonymHandle:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001df491
- (void)renewPseudonymHandle:(id)arg1 expirationDate:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001df37e
- (void)generatePseudonymHandleForConversationWithExpiryDuration:(double)arg1 URI:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001df0c8
- (id)callerIDAccount;	// IMP=0x00100000001df078
- (void)registerWithIDSWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001defe4
- (id)tuConversationProvider;	// IMP=0x00100000001deeb6
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000001ded56
