...
- (void).cxx_destruct;	// IMP=0x0040000000263af8
- (id)init;	// IMP=0x0010000000263ac5
- (void)registerCall:(id)arg1;	// IMP=0x0010000000263a0a
- (id)initWithDataSources:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000263818
