...
@interface CSDMessagingCall : PBCodable
{
    ...
    _Bool _protoUplinkMuted;	// 147 = 0x93
...
+ (Class)remoteParticipantHandlesType;	// IMP=0x00200000000b5245
- (void).cxx_destruct;	// IMP=0x00200000000b9801
...
// Error: Property attributes should begin with the type ('T') attribute, property name: protoShouldSuppressRingtone
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b8f5b
- (unsigned long long)hash;	// IMP=0x00100000000b8911
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b81b1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b7b5a
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b76a5
- (void);	// IMP=0x00100000000b712d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b7120
- (id)dictionaryRepresentation;	// IMP=0x00100000000b550d
- (id)description;	// IMP=0x00100000000b545e
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000b5228
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x00100000000b520b
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x00100000000b51a1
- (void)clearRemoteParticipantHandles;	// IMP=0x00100000000b5184
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x001000000014eadc
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x001000000014dbf0
- (void)updateRelayCall:(id)arg1;	// IMP=0x001000000014d6da
...
- (void)setService:(int)arg1;	// IMP=0x001000000014d136
- (int)service;	// IMP=0x001000000014d124
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x001000000014cba0
