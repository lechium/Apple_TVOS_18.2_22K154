...
@class CXCallSource, NSArray, NSDate, NSDictionary, NSError, NSString, NSURL, NSUUID, TUCallDisplayContext, TUCallProvider, TUCallScreenShareAttributes, TUHandle;
...
@interface CSDMockCall
{
    ...
    TUCallScreenShareAttributes *_mockScreenShareAttributes;	// 304 = 0x130
    ...
    CDUnknownBlockType _didPerformUplinkMuted;	// 344 = 0x158
}

+ (id)mockCallWithNotificationCenter:(id)arg1 fromBlock:(CDUnknownBlockType)arg2;	// IMP=0x00400000001c9f45
+ (id)mockCallFromBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000001c9eb8
+ (id)mockCallWithNotificationCenter:(id)arg1;	// IMP=0x00100000001c9ea4
+ (id)mockCall;	// IMP=0x00100000001c9e3c
- (void).cxx_destruct;	// IMP=0x00200000001cb4a4
...
- (void)setSharingScreen:(_Bool)arg1 attributes:(id)arg2;	// IMP=0x00100000001caa1c
- (_Bool)isUplinkMutedOnQueue;	// IMP=0x00100000001caa0a
- (void)disconnectWithReason:(int)arg1;	// IMP=0x00100000001ca9af
- (void)dialWithRequest:(id)arg1 displayContext:(id)arg2;	// IMP=0x00100000001ca831
- (void)performUplinkMuted:(_Bool)arg1;	// IMP=0x00100000001ca7ad
- (void)answerWithRequest:(id)arg1;	// IMP=0x00100000001ca6dc
- (void)unhold;	// IMP=0x00100000001ca6c5
- (void)hold;	// IMP=0x00100000001ca6ae
- (void)setScreeningAnnouncementHasFinished:(_Bool)arg1;	// IMP=0x00100000001ca69c
- (void)setScreening:(_Bool)arg1;	// IMP=0x00100000001ca68a
- (void)setEndpointOnCurrentDevice:(_Bool)arg1;	// IMP=0x00100000001ca678
- (void)updateWithCall:(id)arg1;	// IMP=0x00100000001ca0af
- (id)initWithUniqueProxyIdentifier:(id)arg1 endpointOnCurrentDevice:(_Bool)arg2 notificationCenter:(id)arg3;	// IMP=0x00100000001c9fbd
