...
- (void).cxx_destruct;	// IMP=0x0020000000144f93
...
- (_Bool)shouldKeepConduitAlive;	// IMP=0x0010000000144ef4
- (void)dealloc;	// IMP=0x0010000000144eb2
- (id)initWithConversationManager:(id)arg1 delegate:(id)arg2;	// IMP=0x0010000000144c70
