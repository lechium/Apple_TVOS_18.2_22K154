...
- (void).cxx_destruct;	// IMP=0x00200000001547b4
...
- (void)_updateSessionPreferences;	// IMP=0x001000000015401a
@property(readonly, copy, nonatomic) NSString *UUID;
@property(readonly, copy, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x0010000000153ed6
- (id)initWithSessionProvider:(id)arg1;	// IMP=0x0010000000153e41
- (id)init;	// IMP=0x0010000000153db7
