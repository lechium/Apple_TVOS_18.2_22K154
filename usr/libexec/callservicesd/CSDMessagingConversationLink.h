...
+ (Class)invitedHandlesType;	// IMP=0x0020000000006eb0
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x0010000000006901
- (void).cxx_destruct;	// IMP=0x0020000000008e20
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000089e3
- (unsigned long long)hash;	// IMP=0x001000000000869d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000008408
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000806e
- (void)copyTo:(id)arg1;	// IMP=0x0010000000007e54
- (void)writeTo:(id)arg1;	// IMP=0x0010000000007bbd
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000007bb0
- (id)dictionaryRepresentation;	// IMP=0x00100000000071c5
- (id)description;	// IMP=0x0010000000007116
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x00100000000070b1
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x001000000000705c
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000006e93
- (unsigned long long)invitedHandlesCount;	// IMP=0x0010000000006e76
- (void)addInvitedHandles:(id)arg1;	// IMP=0x0010000000006e0c
- (void)clearInvitedHandles;	// IMP=0x0010000000006def
...
- (id)description;	// IMP=0x0010000000006ce4
