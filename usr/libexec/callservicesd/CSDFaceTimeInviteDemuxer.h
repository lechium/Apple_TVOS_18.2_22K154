...
- (void).cxx_destruct;	// IMP=0x00400000002fcc44
- (_Bool)destinationIDsCanUseV2Blobs:(id)arg1;	// IMP=0x00100000002fbfbd
- (void)idsPeersForHandle:(id)arg1 video:(_Bool)arg2 fromID:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000002fbe99
- (id)init;	// IMP=0x00100000002f94c7
