...
@interface CSDMessagingCallDisplayContext : PBCodable
{
    ...
    NSString *_companyImageURL;	// 40 = 0x28
    NSString *_companyName;	// 48 = 0x30
    NSString *_contactIdentifier;	// 56 = 0x38
    NSMutableArray *_contactIdentifiers;	// 64 = 0x40
    NSString *_contactLabel;	// 72 = 0x48
    NSString *_contactName;	// 80 = 0x50
    NSString *_label;	// 88 = 0x58
    NSString *_location;	// 96 = 0x60
    NSString *_mapName;	// 104 = 0x68
    NSString *_name;	// 112 = 0x70
    CSDMessagingPersonNameComponents *_protoPersonNameComponents;	// 120 = 0x78
    NSString *_suggestedName;	// 128 = 0x80
}

+ (Class)contactIdentifiersType;	// IMP=0x00200000001549ae
- (void).cxx_destruct;	// IMP=0x002000000015658e
@property(retain, nonatomic) NSString *companyImageURL; // @synthesize companyImageURL=_companyImageURL;
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000155ff0
- (unsigned long long)hash;	// IMP=0x0010000000155e21
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000155b05
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001556c6
- (void)copyTo:(id)arg1;	// IMP=0x0010000000155422
- (void)writeTo:(id)arg1;	// IMP=0x001000000015512d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000155120
- (id)dictionaryRepresentation;	// IMP=0x0010000000154a98
- (id)description;	// IMP=0x00100000001549e9
@property(readonly, nonatomic) _Bool hasCompanyImageURL;
@property(readonly, nonatomic) _Bool hasCompanyDepartment;
- (id)contactIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000154991
- (unsigned long long)contactIdentifiersCount;	// IMP=0x0010000000154974
- (void)addContactIdentifiers:(id)arg1;	// IMP=0x001000000015490a
- (void)clearContactIdentifiers;	// IMP=0x00100000001548ed
...
- (id)initWithCallDisplayContext:(id)arg1;	// IMP=0x001000000017ba38
