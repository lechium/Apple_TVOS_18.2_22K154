...
- (void).cxx_destruct;	// IMP=0x00200000001594fc
@property(readonly, nonatomic) TUUserConfiguration *userConfiguration; // @synthesize userConfiguration=_userConfiguration;
- (void)migrateConversationLinkBaseURL;	// IMP=0x00100000001592ae
- (void)migrateAnnounceCalls;	// IMP=0x001000000015905d
- (void)perform;	// IMP=0x001000000015902f
- (id)init;	// IMP=0x0010000000158fd9
