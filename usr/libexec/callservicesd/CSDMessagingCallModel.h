...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000004fb40
- (unsigned long long)hash;	// IMP=0x001000000004fa61
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004f890
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004f788
- (void)copyTo:(id)arg1;	// IMP=0x001000000004f6a3
- (void)writeTo:(id)arg1;	// IMP=0x001000000004f589
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000004f57c
- (id)dictionaryRepresentation;	// IMP=0x001000000004edbc
- (id)description;	// IMP=0x001000000004ed0d
