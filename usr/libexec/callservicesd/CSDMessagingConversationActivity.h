...
+ (id)activityWithCSDConversationActivity:(id)arg1 handle:(id)arg2;	// IMP=0x00200000000ae8fb
+ (id)activityWithCSDConversationActivity:(id)arg1 fromConversation:(id)arg2 forStorage:(_Bool)arg3;	// IMP=0x00100000000ae1b5
- (void).cxx_destruct;	// IMP=0x002000000014b8a2
...
// Error: Property attributes should begin with the type ('T') attribute, property name: activityIdentifier
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000014b4d9
- (unsigned long long)hash;	// IMP=0x001000000014b193
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000014aedb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000014ac91
- (void)copyTo:(id)arg1;	// IMP=0x001000000014aac6
- (void)writeTo:(id)arg1;	// IMP=0x001000000014a90d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000014a900
- (id)dictionaryRepresentation;	// IMP=0x001000000014a0f6
- (id)description;	// IMP=0x001000000014a047
...
- (long long)mappedLifetimePolicy:(long long)arg1;	// IMP=0x00100000000af7af
- (id)description;	// IMP=0x00100000000af6e3
