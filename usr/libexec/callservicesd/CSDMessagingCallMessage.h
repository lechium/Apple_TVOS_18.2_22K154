...
- (void).cxx_destruct;	// IMP=0x0020000000148f28
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000148d38
- (unsigned long long)hash;	// IMP=0x0010000000148c03
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001489ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000014887b
- (void)copyTo:(id)arg1;	// IMP=0x001000000014874b
- (void)writeTo:(id)arg1;	// IMP=0x00100000001485f9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001485ec
- (id)dictionaryRepresentation;	// IMP=0x0010000000147cd5
- (id)description;	// IMP=0x0010000000147c26
...
- (int)StringAsType:(id)arg1;	// IMP=0x00100000001479a9
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000147960
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (void)addProtocolVersion;	// IMP=0x001000000001562a
...
- (void)setWantsVideo:(_Bool)arg1;	// IMP=0x00100000000154ec
- (_Bool)wantsVideo;	// IMP=0x00100000000154da
