...
+ (id)faceTimeAppUUID;	// IMP=0x002000000007c3e0
- (void).cxx_destruct;	// IMP=0x0020000000080e3b
...
- (void)conference:(id)arg1 didReceiveData:(id)arg2 forCallID:(long long)arg3;	// IMP=0x0010000000080b8c
- (void)conference:(id)arg1 changedBytesOfDataUsed:(long long)arg2;	// IMP=0x0010000000080b2a
- (void)conference:(id)arg1 outputLevelChangedTo:(float)arg2;	// IMP=0x0010000000080ac3
- (void)conference:(id)arg1 inputLevelChangedTo:(float)arg2;	// IMP=0x0010000000080a5c
- (void)conference:(id)arg1 outputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x00100000000809e2
- (void)conference:(id)arg1 inputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0010000000080968
- (void)conference:(id)arg1 remoteMediaStalled:(_Bool)arg2;	// IMP=0x0010000000080898
- (void)remoteVideoPausedForConference:(id)arg1;	// IMP=0x001000000008083c
- (void)receivedFirstRemoteFrameForConference:(id)arg1;	// IMP=0x0010000000080725
- (void)sendingAudioChangedForConference:(id)arg1;	// IMP=0x00100000000806c9
- (void)mutedChangedForConference:(id)arg1;	// IMP=0x001000000008066d
- (void)conference:(id)arg1 endedWithReason:(long long)arg2 error:(id)arg3;	// IMP=0x0010000000080551
- (void)conferenceStarted:(id)arg1;	// IMP=0x00100000000802cd
- (void)conferenceFinishedPreparing:(id)arg1;	// IMP=0x001000000007fea5
- (void)session:(id)arg1 receivedData:(id)arg2;	// IMP=0x001000000007fddd
- (void)session:(id)arg1 receivedInvitationCancelWithData:(id)arg2;	// IMP=0x001000000007fd13
- (void)session:(id)arg1 receivedInvitationDeclineWithData:(id)arg2;	// IMP=0x001000000007fc49
- (void)session:(id)arg1 receivedInvitationAcceptWithData:(id)arg2;	// IMP=0x001000000007f32b
- (void)session:(id)arg1 endedWithReason:(int)arg2;	// IMP=0x001000000007f212
- (void)session:(id)arg1 invitationSentToPushTokens:(id)arg2 shouldBreakBeforeMake:(_Bool)arg3;	// IMP=0x001000000007f0f2
- (void)sessionStarted:(id)arg1;	// IMP=0x001000000007ee97
- (void)_handlePushTokensInvited:(id)arg1 didSendInvitation:(_Bool)arg2 didCancelInvitation:(_Bool)arg3;	// IMP=0x001000000007ed6e
- (void)setRemoteVideoPresentationState:(int)arg1;	// IMP=0x001000000007ed16
- (void)setRemoteVideoPresentationSize:(struct CGSize)arg1;	// IMP=0x001000000007ecbd
- (void)prepareConference;	// IMP=0x001000000007ea24
- (void)startConnectionWithTransport:(id)arg1;	// IMP=0x001000000007e883
...
- (_Bool);	// IMP=0x001000000007e26f
- (void)sendDataUnreliably:(id)arg1;	// IMP=0x001000000007e206
- (void)cancelInvitationWithLocalHangup;	// IMP=0x001000000007e10d
- (void)cancelInvitationWithDeclinedElsewhere;	// IMP=0x001000000007e011
- (void)cancelInvitationWithAnsweredElsewhere;	// IMP=0x001000000007df15
- (void)end;	// IMP=0x001000000007dc1a
- (void)cancelOrDeclineInvitation;	// IMP=0x001000000007dae7
- (void)answerWithVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000007d9e1
- (void)startWithVideoAspectRatioDescriptor:(id)arg1 inviteCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000007d912
- (int)deviceRole;	// IMP=0x001000000007d8f9
- (id)capabilities;	// IMP=0x001000000007d6fc
- (void)_setLocalAspectRatiosForVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x001000000007d598
- (void)_setDateEndedIfNecessary;	// IMP=0x001000000007d322
...
- (id)initOutgoingWithSession:(id)arg1 UUID:(id)arg2 remoteHandle:(id)arg3 wantsVideo:(_Bool)arg4 isRelaying:(_Bool)arg5;	// IMP=0x001000000007c7ec
- (id)initIncomingWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3 remoteInviteDictionary:(id)arg4;	// IMP=0x001000000007c68d
- (id)initWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3;	// IMP=0x001000000007c4f5
