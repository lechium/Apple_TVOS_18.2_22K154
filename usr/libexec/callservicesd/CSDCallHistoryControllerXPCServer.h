...
- (void).cxx_destruct;	// IMP=0x002000000002590f
...
- (oneway void)allCallHistoryDeleted;	// IMP=0x00100000000257d0
- (oneway void)recentCallsDeleted:(id)arg1;	// IMP=0x0010000000025643
- (void)unregisterClient:(id)arg1;	// IMP=0x001000000002553a
- (void)registerClient:(id)arg1;	// IMP=0x0010000000025431
- (void)notifyClientsToConnectIfNecessary;	// IMP=0x0010000000025389
- (void)invalidate;	// IMP=0x0010000000025280
- (void)dealloc;	// IMP=0x00100000000251f4
- (id)initWithCallHistoryController:(id)arg1;	// IMP=0x0010000000024c9a
