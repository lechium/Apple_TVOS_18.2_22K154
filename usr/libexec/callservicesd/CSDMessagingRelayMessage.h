...
@interface CSDMessagingRelayMessage : PBCodable
{
    ...
    MISSING_TYPE *_protoSupportsEmergencyFallback;	// 394 = 0x18a
...
+ (Class)prominenceEntryType;	// IMP=0x0020000000085bab
+ (Class)handlesToInviteType;	// IMP=0x0010000000085ad9
+ (Class)conversationMembersType;	// IMP=0x0010000000085a07
+ (Class)conversationsType;	// IMP=0x001000000008590b
+ (Class)endpointIDSDestinationURIsType;	// IMP=0x00100000000856de
+ (Class)routesType;	// IMP=0x00100000000855f7
+ (Class)remoteParticipantHandlesType;	// IMP=0x0010000000084c30
+ (Class)providersType;	// IMP=0x00100000000849cc
+ (Class)otherUniqueProxyIdentifiersType;	// IMP=0x0010000000084881
+ (Class)protoCallType;	// IMP=0x0010000000083c21
- (void).cxx_destruct;	// IMP=0x002000000008fa9a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000008e0f2
- (unsigned long long)hash;	// IMP=0x001000000008d539
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008c7f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008b270
- (void)copyTo:(id)arg1;	// IMP=0x001000000008a5a8
- (void)writeTo:(id)arg1;	// IMP=0x00100000000895a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000089594
- (id)dictionaryRepresentation;	// IMP=0x0010000000085cf7
- (id)description;	// IMP=0x0010000000085c48
...
- (id)prominenceEntryAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000085b8e
- (unsigned long long)prominenceEntrysCount;	// IMP=0x0010000000085b71
- (void)addProminenceEntry:(id)arg1;	// IMP=0x0010000000085b07
- (void)clearProminenceEntrys;	// IMP=0x0010000000085aea
- (id)handlesToInviteAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000085abc
- (unsigned long long)handlesToInvitesCount;	// IMP=0x0010000000085a9f
- (void)addHandlesToInvite:(id)arg1;	// IMP=0x0010000000085a35
- (void)clearHandlesToInvites;	// IMP=0x0010000000085a18
- (id)conversationMembersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000859ea
- (unsigned long long)conversationMembersCount;	// IMP=0x00100000000859cd
- (void)addConversationMembers:(id)arg1;	// IMP=0x0010000000085963
- (void)clearConversationMembers;	// IMP=0x0010000000085946
...
- (id)conversationsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000858ee
- (unsigned long long)conversationsCount;	// IMP=0x00100000000858d1
- (void)addConversations:(id)arg1;	// IMP=0x0010000000085867
- (void)clearConversations;	// IMP=0x001000000008584a
...
- (id)endpointIDSDestinationURIsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000856c1
- (unsigned long long)endpointIDSDestinationURIsCount;	// IMP=0x00100000000856a4
- (void)addEndpointIDSDestinationURIs:(id)arg1;	// IMP=0x001000000008563a
- (void)clearEndpointIDSDestinationURIs;	// IMP=0x001000000008561d
@property(readonly, nonatomic) _Bool hasRoute;
- (id)routesAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000855da
- (unsigned long long)routesCount;	// IMP=0x00100000000855bd
- (void)addRoutes:(id)arg1;	// IMP=0x0010000000085553
- (void)clearRoutes;	// IMP=0x0010000000085536
- (int)StringAsRequestActionType:(id)arg1;	// IMP=0x0010000000084daa
- (id)requestActionTypeAsString:(int)arg1;	// IMP=0x0010000000084d61
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000084c13
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x0010000000084bf6
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x0010000000084b8c
- (void)clearRemoteParticipantHandles;	// IMP=0x0010000000084b6f
...
- (id)providersAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000849af
- (unsigned long long)providersCount;	// IMP=0x0010000000084992
- (void)addProviders:(id)arg1;	// IMP=0x0010000000084928
- (void)clearProviders;	// IMP=0x001000000008490b
...
- (id)otherUniqueProxyIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000084864
- (unsigned long long)otherUniqueProxyIdentifiersCount;	// IMP=0x0010000000084847
- (void)addOtherUniqueProxyIdentifiers:(id)arg1;	// IMP=0x00100000000847dd
- (void)clearOtherUniqueProxyIdentifiers;	// IMP=0x00100000000847c0
...
- (int)StringAsReceivedMessageType:(id)arg1;	// IMP=0x0010000000083d48
- (id)receivedMessageTypeAsString:(int)arg1;	// IMP=0x0010000000083cff
...
- (id)protoCallAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000083c04
- (unsigned long long)protoCallsCount;	// IMP=0x0010000000083be7
- (void)addProtoCall:(id)arg1;	// IMP=0x0010000000083b7d
- (void)clearProtoCalls;	// IMP=0x0010000000083b60
- (_Bool);	// IMP=0x0010000000083b4b
...
- (int)StringAsType:(id)arg1;	// IMP=0x00100000000831c0
- (id)typeAsString:(int)arg1;	// IMP=0x0010000000083177
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x0010000000056c53
...
- (void)addCall:(id)arg1;	// IMP=0x00100000000563f8
...
- (void)customizeForProtocolVersion:(int)arg1;	// IMP=0x001000000005543b
- (void)addProtocolVersion;	// IMP=0x0010000000055424
...
- (void)setService:(int)arg1;	// IMP=0x0010000000055147
- (int)service;	// IMP=0x0010000000055135
- (id)joinConversationRequest;	// IMP=0x001000000005508e
...
- (id)initBuzzMemberMessage:(id)arg1 conversationUUID:(id)arg2;	// IMP=0x0010000000054a7f
- (id)initAddRemoteMemberMessageWithMembers:(id)arg1 otherInvitedHandles:(id)arg2 conversationWithUUID:(id)arg3;	// IMP=0x00100000000545ff
- (id)initWithType:(int)arg1 uniqueProxyIdentifier:(id)arg2;	// IMP=0x001000000005459e
- (id)initWithType:(int)arg1;	// IMP=0x00100000000544bf
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000054222
