...
@class CSDCallProviderManager, CSDRelayCall, IDSDestination, IDSDevice, MISSING_TYPE, NSArray, NSString, TUAnswerRequest, TUCall, TUCallDTMFUpdate, TUConversation, TURoute;
...
- (MISSING_TYPE *)sendPlayDTMFToneForKeyMessageForCall:DTMFKey: /* Error: Ran out of types for this method. */;
...
- (void)sendReceivedDTMFUpdateForCall:(TUCall *)arg1 dtmfUpdate:(TUCallDTMFUpdate *)arg2;
- (void)sendUpdateSupportsDTMFUpdatesToClientForCall:(TUCall *)arg1;
