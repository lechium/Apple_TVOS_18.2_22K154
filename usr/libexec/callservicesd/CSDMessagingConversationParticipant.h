...
+ (id)participantWithTUConversationParticipant:(id)arg1;	// IMP=0x00200000001b3205
+ (id)participantWithCSDConversationParticipant:(id)arg1;	// IMP=0x00100000001b2c4e
+ (id)participantWithCSDConversationJoinContext:(id)arg1;	// IMP=0x00100000001b2946
- (void).cxx_destruct;	// IMP=0x00200000000152c7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000014d3b
- (unsigned long long)hash;	// IMP=0x001000000001496a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001433f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000013f79
- (void)copyTo:(id)arg1;	// IMP=0x0010000000013c0e
- (void)writeTo:(id)arg1;	// IMP=0x0010000000013839
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000001382c
- (id)dictionaryRepresentation;	// IMP=0x0010000000011e7d
- (id)description;	// IMP=0x0010000000011dce
- (int)StringAsPresentationMode:(id)arg1;	// IMP=0x0010000000011d37
- (id)presentationModeAsString:(int)arg1;	// IMP=0x0010000000011cee
...
- (int)StringAsAvMode:(id)arg1;	// IMP=0x00100000000118d4
- (id)avModeAsString:(int)arg1;	// IMP=0x001000000001188b
...
- (id)description;	// IMP=0x00100000001b3be4
