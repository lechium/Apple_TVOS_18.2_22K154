...
- (void)conversation:(CSDConversation *)arg1 spatialPersonaToggledByParticipant:(CSDConversationParticipant *)arg2;
- (void)conversation:(CSDConversation *)arg1 remoteMembersChanged:(NSSet *)arg2;
...
- (void)conversationDidLeave:(CSDConversation *)arg1;
