...
@interface CSDRelayConferenceConnection : NSObject
{
    ...
    _Bool _tinCan;	// 11 = 0xb
    _Bool _receivedSuccessfulDidStart;	// 12 = 0xc
    _Bool _preparedToStop;	// 13 = 0xd
...
- (void).cxx_destruct;	// IMP=0x00200000001b522e
...
@property(nonatomic, getter=isTinCan) _Bool tinCan; // @synthesize tinCan=_tinCan;
...
- (id)description;	// IMP=0x00100000001b4de9
- (void)invokeDidStopIfNecessary:(_Bool)arg1 error:(id)arg2;	// IMP=0x00100000001b4d44
- (void)invokeDidStartIfNecessary:(_Bool)arg1 error:(id)arg2;	// IMP=0x00100000001b4c8d
- (void)invokeDidPrepareIfNecessary:(id)arg1;	// IMP=0x00100000001b4bf9
- (id)init;	// IMP=0x00100000001b4b19
- (id)initWithCall:(id)arg1;	// IMP=0x00100000001b4a70
- (id)initWithIdentifier:(id)arg1;	// IMP=0x00100000001b4a05
