...
+ (id)callCapabilitiesForCallManagementStateInfo:(id)arg1;	// IMP=0x0040000000082ad5
+ (id)callCapabilitiesForCTCallCapabilities:(id)arg1;	// IMP=0x00100000000829f7
...
- (id)debugDescription;	// IMP=0x0010000000082d44
- (id)description;	// IMP=0x0010000000082d32
