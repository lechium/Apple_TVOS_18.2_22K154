...
@class CSDCallDataSource, CSDIDSTransport, CXCall, IDSDestination, IDSIDQueryController, MISSING_TYPE, NSDate, NSDictionary, NSObject, NSSet, NSString, TUDialRequest, TUDynamicCallDisplayContext;
...
@interface CSDCall : TUCall
{
    ...
    id <CSDCallDelegate> _delegate;	// 56 = 0x38
    CSDCallDataSource *_dataSource;	// 64 = 0x40
    TUDialRequest *_dialRequest;	// 72 = 0x48
    NSDate *_dateStartedOutgoing;	// 80 = 0x50
    NSString *_ringtoneSubscriptionIdentifier;	// 88 = 0x58
    NSDate *_temporaryDateStartedOutgoing;	// 96 = 0x60
    NSDictionary *_silencingUserInfo;	// 104 = 0x68
    long long _bytesOfDataUsed;	// 112 = 0x70
    unsigned long long _initialLinkType;	// 120 = 0x78
    ...
    IDSIDQueryController *_idQueryController;	// 184 = 0xb8
}

- (void).cxx_destruct;	// IMP=0x00200000000f42ad
...
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x00100000000f3d41
- (oneway void)handleAudioSessionActivationStateChangedTo:(id)arg1;	// IMP=0x00100000000f3cce
- (void)displayContextChanged:(id)arg1;	// IMP=0x00100000000f3cbc
- (void)performUplinkMuted:(_Bool)arg1;	// IMP=0x00100000000f3cb6
- (void)handleUpdatedPropertiesAfterChangesInBlock:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f307f
- (void)propertiesChanged;	// IMP=0x00100000000f3033
...
- (long long)providerEndedReason;	// IMP=0x00100000000f2e4a
- (long long)providerErrorCode;	// IMP=0x00100000000f2e42
- (id)displayContext;	// IMP=0x00100000000f2c96
- (void)_refreshFaceTimeIDSStatusIfNecessary;	// IMP=0x00100000000f2c09
- (void)_refreshFaceTimeIDSStatus;	// IMP=0x00100000000f28ea
- (int)faceTimeIDStatus;	// IMP=0x00100000000f28ac
...
- (_Bool)isSOS;	// IMP=0x00100000000f27fa
- (_Bool)isEmergency;	// IMP=0x00100000000f2753
- (_Bool)isVoicemail;	// IMP=0x00100000000f26ac
- (_Bool)isOutgoing;	// IMP=0x00100000000f2644
- (id)handle;	// IMP=0x00100000000f258e
...
- (int)callStatusFromUnderlyingSource;	// IMP=0x00100000000f24a5
- (int)callStatus;	// IMP=0x00100000000f2467
@property(readonly, nonatomic) _Bool shouldHandleMuteRequests;
@property(readonly, nonatomic) _Bool shouldOwnMuteHandler;
- (void)updateUplinkMuted:(_Bool)arg1;	// IMP=0x00100000000f2051
- (void)setUplinkMuted:(_Bool)arg1;	// IMP=0x00100000000f2034
- (void)setDateEnded:(id)arg1;	// IMP=0x00100000000f1e2e
- (void)setDateConnected:(id)arg1;	// IMP=0x00100000000f1d56
- (void)setDateStartedConnecting:(id)arg1;	// IMP=0x00100000000f1c66
- (void)setDateSentInvitation:(id)arg1;	// IMP=0x00100000000f1ac8
- (void)setScreening:(_Bool)arg1;	// IMP=0x00100000000f19ee
- (MISSING_TYPE *)setEndpointOnCurrentDevice: /* Error: Ran out of types for this method. */;	// IMP=0x00100000000f1938
- (void)setSupportsDTMFUpdates:(_Bool)arg1;	// IMP=0x00100000000f1882
- (void)setAnsweringMachineStreamToken:(long long)arg1;	// IMP=0x00100000000f17cc
- (void)setModel:(id)arg1;	// IMP=0x00100000000f16d0
- (void)setSoundRegion:(long long)arg1;	// IMP=0x00100000000f161a
- (void)setFaceTimeIDStatus:(int)arg1;	// IMP=0x00100000000f1565
- (void)setShouldSuppressRingtone:(_Bool)arg1;	// IMP=0x00100000000f14af
- (void)setDisconnectedReason:(int)arg1;	// IMP=0x00100000000f13fa
- (void)setScreeningAnnouncementHasFinished:(_Bool)arg1;	// IMP=0x00100000000f1344
- (void)setWasDialAssisted:(_Bool)arg1;	// IMP=0x00100000000f128e
- (void)setWantsHoldMusic:(_Bool)arg1;	// IMP=0x00100000000f11d8
- (void)setTransitionStatus:(int)arg1;	// IMP=0x00100000000f1123
- (void)playRemoteDTMFToneForKey:(unsigned char)arg1;	// IMP=0x00100000000f0f9c
- (void)playLocalDTMFToneForKey:(unsigned char)arg1;	// IMP=0x00100000000f0f96
- (void)updateWithProxyCall:(id)arg1;	// IMP=0x00100000000f0f05
- (void)updateForDisconnection;	// IMP=0x00100000000f0eff
- (void)unsuppressRingtoneIfNecessary;	// IMP=0x00100000000f0b18
- (void)disconnectCallWithReason:(int)arg1;	// IMP=0x00100000000f0a6f
- (void)disconnect;	// IMP=0x00100000000f0a5b
- (void)dialWithRequest:(id)arg1 displayContext:(id)arg2;	// IMP=0x00100000000f07f7
- (_Bool)needsConversationRelaySupport;	// IMP=0x00100000000f078c
- (_Bool)needsConversationOrVideoRelaySupport;	// IMP=0x00100000000f070a
- (int)callRelaySupport;	// IMP=0x00100000000f0584
- (void)unmuteAfterDisconnect;	// IMP=0x00100000000f0570
- (void)setupInputMuteHandlerWithFeatureFlags:(id)arg1 forApplication:(id)arg2;	// IMP=0x00100000000f056a
- (void)setupInputMuteHandlerWithFeatureFlags:(id)arg1;	// IMP=0x00100000000f0564
- (void)dealloc;	// IMP=0x00100000000f04ce
- (id)initWithUniqueProxyIdentifier:(id)arg1 configuration:(id)arg2;	// IMP=0x00100000000f0437
- (id)initWithUniqueProxyIdentifier:(id)arg1 configuration:(id)arg2 idQueryController:(id)arg3;	// IMP=0x00100000000f032e
