...
- (void).cxx_destruct;	// IMP=0x00400000002a313d
- (id)init;	// IMP=0x00100000002a3107
- (id)initWithStreamToken:(unsigned long long)arg1 requesterID:(id)arg2;	// IMP=0x00100000002a30c0
