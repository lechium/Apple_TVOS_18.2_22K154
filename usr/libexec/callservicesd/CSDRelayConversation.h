...
- (void).cxx_destruct;	// IMP=0x00200000001515ec
...
- (id)description;	// IMP=0x0010000000150ebe
- (void)updateWithProminenceRelayMessage:(id)arg1;	// IMP=0x0010000000150b01
- (void)updateWithRelayMessage:(id)arg1;	// IMP=0x001000000015091c
- (id)initWithRelayMessage:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000150674
