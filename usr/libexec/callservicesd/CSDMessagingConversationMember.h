...
+ (id)memberWithTUConversationMember:(id)arg1;	// IMP=0x002000000007bdc9
- (void).cxx_destruct;	// IMP=0x00200000000f83ab
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f81b0
- (unsigned long long)hash;	// IMP=0x00100000000f80b2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f7f20
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f7dcf
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f7ccb
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f7bc5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f7bb8
- (id)dictionaryRepresentation;	// IMP=0x00100000000f753c
- (id)description;	// IMP=0x00100000000f748d
@property(readonly, nonatomic) _Bool hasAssociationVoucher;
- (int)StringAsValidationSource:(id)arg1;	// IMP=0x00100000000f73e1
- (id)validationSourceAsString:(int)arg1;	// IMP=0x00100000000f7398
...
- (id)description;	// IMP=0x001000000007c314
