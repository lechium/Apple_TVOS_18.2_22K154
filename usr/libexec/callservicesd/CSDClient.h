...
- (void).cxx_destruct;	// IMP=0x0020000000180c19
...
- (id)valueForEntitlement:(id)arg1;	// IMP=0x0010000000180a3f
- (_Bool)isEntitledForCapability:(id)arg1;	// IMP=0x0010000000180a37
...
- (void)performBlockAfterCoalescing:(CDUnknownBlockType)arg1;	// IMP=0x001000000018092b
@property(readonly, nonatomic) id objectForBlock;
- (void)performBlock:(CDUnknownBlockType)arg1 coalescedByIdentifier:(id)arg2;	// IMP=0x0010000000180684
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000180621
@property(readonly, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x0010000000180487
- (id)initWithObject:(id)arg1 queue:(id)arg2;	// IMP=0x0010000000180398
