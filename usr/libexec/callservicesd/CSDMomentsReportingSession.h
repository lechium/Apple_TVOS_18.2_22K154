...
+ (unsigned long long)bucketedInteger:(unsigned long long)arg1;	// IMP=0x00400000001a898f
+ (double)meanFromDoubleNumbers:(id)arg1;	// IMP=0x00100000001a87ee
+ (id)medianFromNumbers:(id)arg1;	// IMP=0x00100000001a86ae
- (void).cxx_destruct;	// IMP=0x00200000001a8a96
...
- (double)meanRequestDuration;	// IMP=0x00100000001a864c
- (id)medianRequestDuration;	// IMP=0x00100000001a85e2
- (unsigned long long)fuzzyPhotoRequestSuccessCount;	// IMP=0x00100000001a859d
- (unsigned long long)fuzzyPhotoRequestFailureCount;	// IMP=0x00100000001a8558
- (void)reportDataCollectionCompleteIfNecessary;	// IMP=0x00100000001a8375
- (void)didCleanUp;	// IMP=0x00100000001a82cc
- (void)didReceiveResultsWithTransactionID:(id)arg1;	// IMP=0x00100000001a7f1d
- (void)didStartRequestWithTransactionID:(id)arg1;	// IMP=0x00100000001a7bb6
- (void)registeredStreamWithAvailability:(int)arg1;	// IMP=0x00100000001a7b2c
- (id)init;	// IMP=0x00100000001a7aa2
- (id)initWithStreamToken:(long long)arg1;	// IMP=0x00100000001a79b9
