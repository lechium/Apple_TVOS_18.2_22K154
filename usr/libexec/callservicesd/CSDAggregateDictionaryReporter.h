...
- (void).cxx_destruct;	// IMP=0x002000000001b9b4
@property(copy, nonatomic) CDUnknownBlockType block; // @synthesize block=_block;
- (void)reportingController:(id)arg1 relayMessageReceived:(id)arg2 fromPairedDevice:(_Bool)arg3;	// IMP=0x001000000001b7a8
- (id)init;	// IMP=0x001000000001b653
