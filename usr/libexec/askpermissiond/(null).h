...
+ (long long)lobForProductType:(id)arg1;	// IMP=0x0020000000026021
+ (long long)lobForSubscription:(id)arg1;	// IMP=0x0010000000025f23
+ (id)createUniqueIDFromRequestID:(id)arg1 andCreatedDate:(id)arg2;	// IMP=0x0010000000025af7
...
- (id)compile;	// IMP=0x001000000002618c
- (long long)lineOfBusiness;	// IMP=0x0010000000025e9e
- (id)metricsTopic;	// IMP=0x0010000000025db2
- (id)metricsApp;	// IMP=0x0010000000025cd4
- (_Bool)isSubscription;	// IMP=0x0010000000025c89
- (void)updateStatus:(long long)arg1 withApproverDSID:(id)arg2;	// IMP=0x0010000000025c74
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x00100000000238b6
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000023835
- (id)initWithRequestStorageItem:(id)arg1;	// IMP=0x00100000000234b3
- (id)initWithApproverStorageItem:(id)arg1;	// IMP=0x001000000002317d
- (id)initWithApproverDSID:(id)arg1 createdDate:(id)arg2 modifiedDate:(id)arg3 requestIdentifier:(id)arg4 uniqueIdentifier:(id)arg5 canSendViaMessages:(_Bool)arg6 itemBundleID:(id)arg7 itemDescription:(id)arg8 itemIdentifier:(id)arg9 itemTitle:(id)arg10 localizations:(id)arg11 offerName:(id)arg12 mocked:(_Bool)arg13 previewURL:(id)arg14 productType:(id)arg15 productTypeName:(id)arg16 productURL:(id)arg17 requesterName:(id)arg18 requesterDSID:(id)arg19 requestInfo:(id)arg20 requestString:(id)arg21 requestSummary:(id)arg22 priceSummary:(id)arg23 status:(long long)arg24;	// IMP=0x0010000000022dcf
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000021995
