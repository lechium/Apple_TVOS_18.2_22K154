...
- (void).cxx_destruct;	// IMP=0x0020000000012fc7
...
- (id)_requestIdentifierFromResult:(id)arg1 withError:(id *)arg2;	// IMP=0x0010000000012e29
- (id)_storeRequestWithResult:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000012c24
- (id)_serverRequestWithError:(id *)arg1;	// IMP=0x001000000001281d
- (id)perform;	// IMP=0x00100000000122bc
- (id)initWithRequestURL:(id)arg1 account:(id)arg2;	// IMP=0x00100000000121cf
