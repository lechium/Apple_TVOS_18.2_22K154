...
- (void).cxx_destruct;	// IMP=0x0020000000027cc6
...
- (id)compile;	// IMP=0x0010000000027a29
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000027617
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x00100000000274e8
