...
- (void).cxx_destruct;	// IMP=0x0020000000029f58
...
- (id)compile;	// IMP=0x0010000000029cbb
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000002988a
- (id)initWithDate:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 itemIdentifier:(id)arg4 localizations:(id)arg5 offerName:(id)arg6 status:(long long)arg7;	// IMP=0x001000000002975b
