...
@class ACAccount, AMSAuthenticateRequest, AMSDialogRequest, AMSEngagementRequest, AMSURLSession, MISSING_TYPE, NSDictionary, NSError, NSString, NSURLSessionTask;
...
- (MISSING_TYPE *)reportMetricsForContext: /* Error: Ran out of types for this method. */;
- (id)presentingWindow;
