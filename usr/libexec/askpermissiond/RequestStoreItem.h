...
@interface RequestStoreItem : NSObject
{
    ...
    NSString *_offerName;	// 96 = 0x60
    NSURL *_previewURL;	// 104 = 0x68
    NSString *_productType;	// 112 = 0x70
    NSString *_productTypeName;	// 120 = 0x78
    NSURL *_productURL;	// 128 = 0x80
...
- (void).cxx_destruct;	// IMP=0x002000000001da8d
