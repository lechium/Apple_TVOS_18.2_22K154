...
- (void).cxx_destruct;	// IMP=0x002000000000860c
...
// Error: Property attributes should begin with the type ('T') attribute, property name: itemBundleID
...
- (id)description;	// IMP=0x0010000000008355
- (id)compile;	// IMP=0x0010000000007cdd
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000006867
- (id)initWithItemIdentifier:(id)arg1 requestIdentifier:(id)arg2 uniqueIdentifier:(id)arg3 date:(id)arg4;	// IMP=0x001000000000677f
- (id)initWithRequest:(id)arg1 date:(id)arg2;	// IMP=0x00100000000063d5
