...
- (void).cxx_destruct;	// IMP=0x002000000002a4e1
...
- (id)description;	// IMP=0x001000000002a45a
- (id)compile;	// IMP=0x001000000002a312
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000002a137
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x0010000000029fac
