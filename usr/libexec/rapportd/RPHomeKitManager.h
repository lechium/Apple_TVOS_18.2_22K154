...
- (void).cxx_destruct;	// IMP=0x002000000005fb5d
...
- (void)home:(id)arg1 didUpdateRoom:(id)arg2 forAccessory:(id)arg3;	// IMP=0x001000000005f850
- (void)user:(id)arg1 didUpdateAssistantAccessControl:(id)arg2 forHome:(id)arg3;	// IMP=0x001000000005f6b9
- (void)getPairingIdentityFromHomeWithAccessory:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000005f474
- (void)_setupHome;	// IMP=0x001000000005f2a6
- (_Bool)personalRequestsStateForAccessory:(id)arg1;	// IMP=0x001000000005ee26
- (id)homeHubDeviceWithIdentifier:(id)arg1;	// IMP=0x001000000005ed9f
- (void)resetHomeKitUserIdentifiers;	// IMP=0x001000000005ed75
- (id)filterHomeKitUserIdentifiers:(id)arg1;	// IMP=0x001000000005e7c0
- (id)homeKitUserIdentifiers;	// IMP=0x001000000005e4a5
- (void)invalidate;	// IMP=0x001000000005e39c
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000005e2c8
