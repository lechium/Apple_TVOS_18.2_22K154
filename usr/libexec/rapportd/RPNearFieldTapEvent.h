...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000b6dfa
- (void).cxx_destruct;	// IMP=0x00200000000b7712
...
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x00100000000b7473
- (id)description;	// IMP=0x00100000000b745c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000b726d
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000b6e02
- (id)initWithIdentifier:(id)arg1 applicationLabel:(id)arg2 pkData:(id)arg3 bonjourListenerUUID:(id)arg4 isSameAccount:(_Bool)arg5 contactID:(id)arg6 accountID:(id)arg7 forceSingleBandAWDLMode:(_Bool)arg8 knownIdentity:(_Bool)arg9 isUnsupportedApplicationLabel:(_Bool)arg10 flags:(unsigned int)arg11;	// IMP=0x00100000000b6c63
