...
@optional
- (void)remoteDisplayUpdateDataLinkType:(NSNumber *)arg1;
...
- (void)remoteDisplayStartServerSessionID:(NSNumber *)arg1 device:(RPRemoteDisplayDevice *)arg2 linkType:(NSNumber *)arg3 completion:(void (^)(NSError *))arg4;
...
- (void)remoteDisplayDedicatedDeviceChanged:(RPRemoteDisplayDevice *)arg1;
