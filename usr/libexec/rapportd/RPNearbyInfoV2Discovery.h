...
- (void).cxx_destruct;	// IMP=0x002000000007f1f5
...
- (id)description;	// IMP=0x001000000007f08b
- (void)_deviceLost:(id)arg1;	// IMP=0x001000000007ef1d
- (void)_deviceFound:(id)arg1;	// IMP=0x001000000007ed82
- (void)invalidate;	// IMP=0x001000000007ecc4
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000007e112
- (id)init;	// IMP=0x001000000007e09c
