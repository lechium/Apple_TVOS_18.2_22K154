...
- (void).cxx_destruct;	// IMP=0x0020000000095d34
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095bae
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095a9e
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000959a1
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000095891
- (void)xpcConnectionInvalidated;	// IMP=0x001000000009570e
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x00100000000955e8
