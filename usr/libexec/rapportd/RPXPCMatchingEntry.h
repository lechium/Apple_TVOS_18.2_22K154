...
@interface RPXPCMatchingEntry : NSObject
{
    ...
    NSString *_angelJobLabel;	// 56 = 0x38
    NSString *_angelAssertionName;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x0020000000051446
@property(nonatomic) NSString *angelAssertionName; // @synthesize angelAssertionName=_angelAssertionName;
@property(nonatomic) NSString *angelJobLabel; // @synthesize angelJobLabel=_angelJobLabel;
