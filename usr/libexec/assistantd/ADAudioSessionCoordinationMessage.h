...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000037801e
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0010000000377fd1
- (void).cxx_destruct;	// IMP=0x0020000000377b6d
...
- (id)buildDictionaryRepresentation;	// IMP=0x00100000003778df
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000377427
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000003772ec
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000003770b6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000003770ab
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000376dfd
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x0010000000376c06
@property(readonly, copy) NSString *description;
- (id)initWithHostTime:(unsigned long long)arg1 type:(long long)arg2 payloadBeginAudioSessionRequest:(id)arg3 payloadBeginAudioSessionResponse:(id)arg4 payloadKeepAudioSessionAliveRequest:(id)arg5 payloadKeepAudioSessionAliveResponse:(id)arg6 payloadEndAudioSessionRequest:(id)arg7 payloadEndAudioSessionResponse:(id)arg8;	// IMP=0x0010000000376a68
- (id)init;	// IMP=0x0010000000376a54
- (id)initWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000003767e7
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x0010000000378026
