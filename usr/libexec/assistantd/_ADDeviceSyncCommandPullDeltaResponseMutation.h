...
- (void).cxx_destruct;	// IMP=0x00200000000fdc0d
- (void)setIncrementalChanges:(id)arg1;	// IMP=0x00100000000fdbed
- (id)getIncrementalChanges;	// IMP=0x00100000000fdbb5
- (_Bool)isDirty;	// IMP=0x00100000000fdbaa
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000fdb3f
