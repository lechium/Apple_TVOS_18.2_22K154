...
@class AFCommandExecutionInfo, MISSING_TYPE, NSArray, NSSet, NSString, NSUUID, SABaseCommand;
...
- (MISSING_TYPE *)openURL:reply: /* Error: Ran out of types for this method. */;
