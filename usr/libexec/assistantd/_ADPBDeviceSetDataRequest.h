...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x0020000000158b86
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000f00bd
- (void).cxx_destruct;	// IMP=0x0020000000158a23
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000158186
- (unsigned long long)hash;	// IMP=0x0010000000157dfe
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015787f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001572ad
- (void)copyTo:(id)arg1;	// IMP=0x0010000000156ebb
- (void)writeTo:(id)arg1;	// IMP=0x0010000000156a60
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000156204
- (id)dictionaryRepresentation;	// IMP=0x0010000000155bde
- (id)description;	// IMP=0x0010000000155b2f
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001559f5
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000001559d8
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x001000000015596e
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x0010000000155951
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000113404
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a7ec5
