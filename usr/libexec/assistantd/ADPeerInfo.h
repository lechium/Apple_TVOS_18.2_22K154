...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x0020000000376605
+ (id)locallyPairedPeerInfo;	// IMP=0x0010000000376515
+ (id)_queue;	// IMP=0x00100000003764e5
- (void).cxx_destruct;	// IMP=0x0020000000376283
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000375fbf
- (unsigned long long)hash;	// IMP=0x0010000000375fa9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000375f9e
- (id)afPeerInfo;	// IMP=0x0010000000375f41
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x0010000000375e2a
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x0010000000375a73
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x0010000000375a06
- (MISSING_TYPE *)initWithIDSIdentifer: /* Error: Ran out of types for this method. */;	// IMP=0x00100000003759ec
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x00100000003758d5
