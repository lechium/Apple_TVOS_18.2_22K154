...
- (void).cxx_destruct;	// IMP=0x0020000000250c2f
...
- (void)_resetTimer;	// IMP=0x0010000000250ae5
- (void)_cancelTimer;	// IMP=0x0010000000250aaf
- (void)locationPeerDidChange;	// IMP=0x0010000000250a64
- (void)locationDataWasRecievedFromPeer;	// IMP=0x0010000000250a19
- (id)init;	// IMP=0x0010000000250982
