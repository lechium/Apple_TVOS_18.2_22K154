...
- (void).cxx_destruct;	// IMP=0x002000000027fab4
- (unsigned long long)payloadSize;	// IMP=0x001000000027faaa
...
- (id)analyticsDictionary;	// IMP=0x001000000027f7cd
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x001000000027f7bf
- (void)markSucceeded;	// IMP=0x001000000027f7b5
- (void)markEndTime;	// IMP=0x001000000027f77c
- (void)markStartTime;	// IMP=0x001000000027f743
- (_Bool)hasFailureType;	// IMP=0x001000000027f735
- (void)setPayloadSize:(unsigned long long)arg1;	// IMP=0x001000000027f727
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x001000000027f6b6
