...
- (void).cxx_destruct;	// IMP=0x002000000012d60c
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x001000000012d2cb
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x001000000012cfd0
- (void)dealloc;	// IMP=0x001000000012cd02
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x001000000012cbf7
- (id)init;	// IMP=0x001000000012cbe9
