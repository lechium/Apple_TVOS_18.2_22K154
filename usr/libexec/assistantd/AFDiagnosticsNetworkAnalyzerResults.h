...
- (void).cxx_destruct;	// IMP=0x00200000002459ed
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x0010000000245ec8
- (id)metricValue;	// IMP=0x0010000000245adf
