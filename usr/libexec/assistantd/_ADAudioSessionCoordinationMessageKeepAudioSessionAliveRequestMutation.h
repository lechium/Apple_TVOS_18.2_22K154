...
- (void).cxx_destruct;	// IMP=0x002000000023de8b
- (void)setExpirationDuration:(double)arg1;	// IMP=0x001000000023de7c
- (double)getExpirationDuration;	// IMP=0x001000000023de59
- (_Bool)isDirty;	// IMP=0x001000000023de4e
- (id)initWithBase:(id)arg1;	// IMP=0x001000000023dde3
