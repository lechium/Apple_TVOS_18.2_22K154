...
- (void).cxx_destruct;	// IMP=0x002000000000d043
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000cec7
- (unsigned long long)hash;	// IMP=0x001000000000ce28
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000ccf0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000cbd8
- (void)copyTo:(id)arg1;	// IMP=0x001000000000cb15
- (void)writeTo:(id)arg1;	// IMP=0x001000000000ca61
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000ca54
- (id)dictionaryRepresentation;	// IMP=0x001000000000c77c
- (id)description;	// IMP=0x001000000000c6cd
