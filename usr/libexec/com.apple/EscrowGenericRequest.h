...
+ (_Bool)pcsNoRecord;	// IMP=0x002000000000ecc0
+ (_Bool)pcsUpdateDisabled;	// IMP=0x001000000000ec51
- (void).cxx_destruct;	// IMP=0x002000000000f5df
...
- (void)_checkFetchOperationWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000f0cd
- (void)_checkReadOperationWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000ef4e
- (void)_checkUpdateOperationWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000edcf
- (_Bool)isPcsRecord;	// IMP=0x001000000000ed2f
- (id)additionalHeaders;	// IMP=0x001000000000eae6
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x001000000000ea34
- (id)urlString;	// IMP=0x001000000000e984
- (id)urlRequest;	// IMP=0x001000000000e844
- (id)authorizationHeader;	// IMP=0x001000000000e733
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x001000000000e53b
- (id)bodyDictionary;	// IMP=0x001000000000e175
- (id)validateInput;	// IMP=0x001000000000de2b
...
- (id)currentAccount;	// IMP=0x001000000000d92a
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x001000000000d6b8
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000000d114
