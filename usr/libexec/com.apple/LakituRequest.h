...
- (void).cxx_destruct;	// IMP=0x002000000003b253
...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000003aa57
- (id)sessionConfig;	// IMP=0x001000000003a924
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000003a5c4
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x001000000003a508
- (id)credential;	// IMP=0x001000000003a500
- (id)validateInput;	// IMP=0x001000000003a3b0
- (id)additionalHeaders;	// IMP=0x001000000003a3a3
- (id)authorizationHeader;	// IMP=0x001000000003a39b
- (id)bodyDictionary;	// IMP=0x001000000003a393
