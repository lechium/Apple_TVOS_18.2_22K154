...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000004b45b
- (void).cxx_destruct;	// IMP=0x002000000004b96c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000004b848
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000004b588
- (id)initWithOperationId:(id)arg1 activityId:(id)arg2 activityLabel:(id)arg3 recordId:(id)arg4 type:(unsigned long long)arg5 context:(id)arg6;	// IMP=0x001000000004b463
