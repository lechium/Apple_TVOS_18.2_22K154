...
+ (Class)platformLibraryServicesDelegateClass;	// IMP=0x0020000000012508
- (void).cxx_destruct;	// IMP=0x0020000000013830
...
- (id)logPrefix;	// IMP=0x00100000000137a4
- (void)handleCompletedAllOperationsForLibraryState:(long long)arg1;	// IMP=0x00100000000135bb
- (void)operationCompletionActivities;	// IMP=0x0010000000013380
- (id)commonBuiltInOperations;	// IMP=0x00100000000129c5
- (id)operationForGreenTeaContactsAuthorizationCheck;	// IMP=0x001000000001294e
- (id)operationForLocaleChangeCheck;	// IMP=0x00100000000128d7
- (id)systemLibraryBuiltInOperations;	// IMP=0x0010000000012725
- (id)operationsForLibraryStateTransition:(long long)arg1;	// IMP=0x0010000000012572
@property(readonly, nonatomic) long long requiredStateForFileSystemImportOperation;
- (id)initWithLibraryServicesManager:(id)arg1;	// IMP=0x0010000000012519
