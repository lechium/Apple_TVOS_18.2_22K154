...
+ (id)sharedServer;	// IMP=0x002000000006fd5b
- (void).cxx_destruct;	// IMP=0x002000000006ffec
...
- (void)invalidate;	// IMP=0x001000000006fec3
- (void)run;	// IMP=0x001000000006fdb0
- (id)init;	// IMP=0x001000000006fa69
