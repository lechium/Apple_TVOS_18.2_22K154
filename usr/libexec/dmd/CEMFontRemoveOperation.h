...
- (void).cxx_destruct;	// IMP=0x0020000000005804
...
- (void)main;	// IMP=0x0010000000005694
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x00100000000055f2
