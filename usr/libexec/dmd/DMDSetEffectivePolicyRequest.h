...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000715cb
- (void).cxx_destruct;	// IMP=0x0020000000071b57
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000718af
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000715d3
