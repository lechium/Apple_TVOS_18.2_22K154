...
- (void).cxx_destruct;	// IMP=0x0020000000079332
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x0010000000079249
- (struct __CFUserNotification *)notificationRef;	// IMP=0x001000000007923f
- (void)dealloc;	// IMP=0x0010000000079200
- (id)init;	// IMP=0x001000000007919e
