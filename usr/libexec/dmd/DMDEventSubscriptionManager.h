...
- (void).cxx_destruct;	// IMP=0x002000000004c255
...
- (id)eventStatusesByPayloadIdentifierSinceStartDate:(id)arg1 organizationIdentifier:(id)arg2;	// IMP=0x001000000004bfe0
- (_Bool)setEventSubscriptionRegistrations:(id)arg1 error:(id *)arg2;	// IMP=0x001000000004b9b8
- (id)init;	// IMP=0x001000000004b962
