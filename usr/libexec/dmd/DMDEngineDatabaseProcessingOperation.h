...
- (void).cxx_destruct;	// IMP=0x00200000000463df
...
- (id)processDeclarationPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000042e26
- (id)processCommandPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000041732
- (_Bool)updateActiveRestrictionsInContext:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000040ea4
- (_Bool)preprocessDatabaseInContext:(id)arg1 forOrganization:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000405c2
- (void)performDatabaseModificationOperationWithManagedObjectContext:(id)arg1;	// IMP=0x001000000003fcec
