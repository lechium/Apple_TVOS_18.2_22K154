...
- (void).cxx_destruct;	// IMP=0x002000000004a61b
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000004a402
- (unsigned long long)hash;	// IMP=0x001000000004a2ce
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004a082
- (id)description;	// IMP=0x0010000000049fcf
- (void)dealloc;	// IMP=0x0010000000049f8d
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x0010000000049ccc
