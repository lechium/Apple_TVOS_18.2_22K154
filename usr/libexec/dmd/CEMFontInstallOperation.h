...
- (void).cxx_destruct;	// IMP=0x00200000000055c1
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x001000000000552d
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000005224
...
- (void)main;	// IMP=0x0010000000005063
- (_Bool)isAsynchronous;	// IMP=0x001000000000505b
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0010000000004fb9
