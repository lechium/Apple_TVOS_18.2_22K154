...
- (void).cxx_destruct;	// IMP=0x002000000000dd4d
...
- (id)calendarForIdentifier:(id)arg1;	// IMP=0x001000000000da5a
- (void)reportActivationPredicateObserverDidTrigger;	// IMP=0x001000000000d972
- (id)metadata;	// IMP=0x001000000000d85b
- (void)invalidate;	// IMP=0x001000000000d847
- (void)updateObserverRegistration;	// IMP=0x001000000000d841
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000d839
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 predicate:(id)arg3;	// IMP=0x001000000000d739
