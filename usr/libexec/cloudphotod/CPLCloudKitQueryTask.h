...
- (void).cxx_destruct;	// IMP=0x0020000000047faf
...
- (void)_runQueryWithCurrentUserID:(id)arg1 cursor:(id)arg2 additionalInfo:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000461b3
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x0010000000045ea4
- (void)runOperations;	// IMP=0x0010000000045e22
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x0010000000045db5
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 scope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000045c1a
