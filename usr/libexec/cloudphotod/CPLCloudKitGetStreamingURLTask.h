...
- (void).cxx_destruct;	// IMP=0x00200000000b64ae
...
- (void)_fetchStreamingURL;	// IMP=0x00100000000b5747
- (void)runOperations;	// IMP=0x00100000000b56b7
- (_Bool)shouldRequestEncryptedStream;	// IMP=0x00100000000b565e
- (id)_streamOperationForKey:(id)arg1 operationType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b4c22
- (id)initWithController:(id)arg1 resource:(id)arg2 hints:(id)arg3 timeRange:(CDStruct_e83c9415)arg4 target:(id)arg5 transportScopeMapping:(id)arg6 cache:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;	// IMP=0x00100000000b4a3d

// Remaining properties
@property(nonatomic) _Bool allowsFetchCache;
// Error: Property attributes should begin with the type ('T') attribute, property name: backgroundTask
