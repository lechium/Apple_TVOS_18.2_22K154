...
- (void).cxx_destruct;	// IMP=0x00200000000707af
...
- (id)finalizedDestinationCKRecordFromProposedCKRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000705e7
- (id)recordNameInDestinationCKRecordFromRecordName:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000070542
- (_Bool)shouldCopyCKRecordKeyToDestinationCKRecord:(id)arg1;	// IMP=0x001000000007048f
- (id)baseDestinationCKRecordForSourceCKRecord:(id)arg1 destinationCKRecordID:(id)arg2 error:(id *)arg3;	// IMP=0x001000000006fdf0
- (void)prepareCopyForCKRecordID:(id)arg1 fromCKRecord:(id)arg2;	// IMP=0x001000000006fbfa
- (_Bool)shouldCopyForCKRecordID:(id)arg1 fromCKRecord:(id)arg2;	// IMP=0x001000000006fbf2
- (id)rejectedScopedIdentifierForRejectedCKRecordID:(id)arg1;	// IMP=0x001000000006fafb
- (void)runOperations;	// IMP=0x001000000006f357
- (void)_deleteSourceRecordIDs:(id)arg1;	// IMP=0x001000000006edfc
- (id)initWithController:(id)arg1 records:(id)arg2 sourceScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x001000000006ecbd
