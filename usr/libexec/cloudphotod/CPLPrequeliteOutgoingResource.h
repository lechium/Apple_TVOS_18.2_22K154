...
- (void).cxx_destruct;	// IMP=0x0020000000195073
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x0010000000194ece
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x0010000000194dc3
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x0010000000194ae1
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000019498c
