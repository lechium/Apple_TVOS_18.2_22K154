...
- (void).cxx_destruct;	// IMP=0x0020000000075e26
- (void)runOperations;	// IMP=0x00100000000756cd
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x0010000000075651
- (double)timeoutIntervalForRequest;	// IMP=0x0010000000075643
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000075588
