...
- (void).cxx_destruct;	// IMP=0x00200000000d9484
- (_Bool)_checkResource:(id)arg1 record:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000d9115
- (void)runOperations;	// IMP=0x00100000000d86b1
- (id)initWithController:(id)arg1 resources:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000d8584
