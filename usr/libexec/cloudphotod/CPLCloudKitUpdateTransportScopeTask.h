...
- (void).cxx_destruct;	// IMP=0x002000000007eea2
...
- (void)runOperations;	// IMP=0x001000000007ebb8
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 scopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000007eaab
