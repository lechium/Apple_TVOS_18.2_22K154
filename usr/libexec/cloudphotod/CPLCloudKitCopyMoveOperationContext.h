...
- (void).cxx_destruct;	// IMP=0x00200000000412f1
...
- (id)extendedStatusDescriptionStrings;	// IMP=0x0010000000041026
- (id)operationDescription;	// IMP=0x0010000000040f78
- (void)addCopyMoveFromRecordID:(id)arg1 toRecordID:(id)arg2;	// IMP=0x0010000000040ea8
- (id)initFromZoneID:(id)arg1 toZoneID:(id)arg2;	// IMP=0x0010000000040e06
