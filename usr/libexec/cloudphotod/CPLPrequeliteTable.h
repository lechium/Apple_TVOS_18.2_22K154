...
+ (id)tableWithName:(id)arg1;	// IMP=0x002000000019f6c7
- (void).cxx_destruct;	// IMP=0x002000000019f8c6
@property(readonly, nonatomic) NSString *tableName; // @synthesize tableName=_tableName;
- (id)redactedDescription;	// IMP=0x001000000019f893
@property(readonly, copy) NSString *description;
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x001000000019f854
@property(readonly, nonatomic) NSString *injectedTableName;
@property(readonly, nonatomic) NSData *sql;
- (id)initWithName:(id)arg1;	// IMP=0x001000000019f710
