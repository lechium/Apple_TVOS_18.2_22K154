...
- (void).cxx_destruct;	// IMP=0x0020000000186246
...
- (void)unpublish;	// IMP=0x00100000001861ca
- (void)publish;	// IMP=0x00100000001861a3
- (void)_publishRealProgressIfNecessary;	// IMP=0x001000000018607e
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000185fed
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x0010000000185e2c
