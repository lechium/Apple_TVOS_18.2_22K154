...
@class CPLDropDerivativesRecipe, CPLRecordComputeStateValidator, CPLResource, CPLResourceTransferTaskOptions, CPLScopeChange, CPLScopedIdentifier, NSArray, NSDictionary, NSString, NSURL;

@protocol CPLLibraryManagerImplementation <CPLPlatformImplementation>
- (void)fetchComputeStatesForRecordsWithScopedIdentifiers:(NSArray *)arg1 validator:(CPLRecordComputeStateValidator *)arg2 shouldDecrypt:(_Bool)arg3 onDemand:(_Bool)arg4 completionHandler:(void (^)(NSDictionary *, NSError *))arg5;
- (void)attachComputeStates:(NSArray *)arg1 completionHandler:(void (^)(NSError *))arg2;
...
- (void)requestClientToPullAllChangesInScopeIdentifier:(NSArray *)arg1 completionHandler:(void (^)(NSError *))arg2;
...
- (void)beginInMemoryDownloadOfResource:(CPLResource *)arg1 clientBundleID:(NSString *)arg2 completionHandler:(void (^)(CPLResourceTransferTask *))arg3;
...
- (void)openWithCompletionHandler:(void (^)(NSError *, NSString *, NSString *, NSString *, NSURL *))arg1;
