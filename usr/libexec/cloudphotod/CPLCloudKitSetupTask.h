...
- (void).cxx_destruct;	// IMP=0x0020000000045ad4
...
- (void)runOperations;	// IMP=0x0010000000045ab2
- (void)fetchUserRecord;	// IMP=0x00100000000459f3
- (void)fetchDerivativesFilter;	// IMP=0x0010000000045725
- (void)fetchDisabledFeatures;	// IMP=0x00100000000452c2
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000004522d
