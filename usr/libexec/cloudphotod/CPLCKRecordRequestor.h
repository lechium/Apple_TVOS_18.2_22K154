...
- (void).cxx_destruct;	// IMP=0x00200000000b3416
...
- (_Bool)processedFetchedRequestedRecordsWithError:(id *)arg1;	// IMP=0x00100000000b2f6b
@property(readonly, nonatomic) NSArray *requestedRecordIDs;
- (void)fetchRequestedRecordsForTransportTask:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b2d98
- (void)_fetchRecordsForNextOperationTypeInEnumerator:(id)arg1 task:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b2ada
@property(readonly, nonatomic) _Bool needsRequestedRecords;
- (void)requestRecordWithRecordID:(id)arg1 operationType:(long long)arg2 forRecordWithRecordID:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000b2810
- (id)initWithFetchCache:(id)arg1 scopeProvider:(id)arg2;	// IMP=0x00100000000b275e
