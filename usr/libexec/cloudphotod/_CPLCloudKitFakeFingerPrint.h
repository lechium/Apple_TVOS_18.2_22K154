...
- (void).cxx_destruct;	// IMP=0x002000000004c97e
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x001000000004c621
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x001000000004c308
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x001000000004c2b2
