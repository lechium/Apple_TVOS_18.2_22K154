...
- (void).cxx_destruct;	// IMP=0x00200000000d43f9
...
- (void)_determineScopeTypeAndFetchLibraryInfoWithCurrentUserID:(id)arg1;	// IMP=0x00100000000d3d70
- (void)getScopeInfoWithCurrentUserID:(id)arg1;	// IMP=0x00100000000d35ad
- (void)runOperations;	// IMP=0x00100000000d3518
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000d33eb
