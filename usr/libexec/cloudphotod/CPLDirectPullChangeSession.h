...
+ (id)selfCrashResetReason;	// IMP=0x002000000016a541
- (void).cxx_destruct;	// IMP=0x002000000016a60d
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000169823
- (void)acknowledgeChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000001686ea
- (void)getChangeBatchWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001674b8
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000166c40
- (id)clientWorkDescription;	// IMP=0x0010000000166c33
