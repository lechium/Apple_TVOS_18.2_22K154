...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x001000000003f297
- (id)operationDescription;	// IMP=0x001000000003f28f
- (id)extendedStatusDescriptionStrings;	// IMP=0x001000000003f287
