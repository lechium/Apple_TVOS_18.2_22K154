...
- (void).cxx_destruct;	// IMP=0x00200000000cdc29
...
- (id)auxiliaryOperationDidFinishWithError:(id)arg1;	// IMP=0x00100000000cdaed
- (void)launchAuxiliaryOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3;	// IMP=0x00100000000cd946
- (id)operationDidFinishWithError:(id)arg1;	// IMP=0x00100000000cd8c9
- (void)updateProgress:(double)arg1;	// IMP=0x00100000000cd894
- (void)updateContextWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cd82c
- (void)updateOneBatch;	// IMP=0x00100000000cd7f7
- (id)operationDidFinish:(id)arg1 error:(id)arg2;	// IMP=0x00100000000cd770
- (void)launchOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3 sourceBundleIdentifiers:(id)arg4;	// IMP=0x00100000000cd687
- (void)dispatchAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000000cd4fc
- (void)runOperations;	// IMP=0x00100000000cd16f
- (void)runAuxiliaryOperation;	// IMP=0x00100000000cccc3
- (void)_fetchAndMoveNextBatchWithUserRecordID:(id)arg1;	// IMP=0x00100000000cc708
- (void)_moveBatchRecordWithNames:(id)arg1 userRecordID:(id)arg2 operationID:(id)arg3 moveBatchID:(id)arg4 hasMore:(_Bool)arg5;	// IMP=0x00100000000cc083
- (void)_sendExitFeedbackWithSourceRecordIDs:(id)arg1 destinationRecordIDs:(id)arg2 moveError:(id)arg3 operationID:(id)arg4 moveBatchID:(id)arg5;	// IMP=0x00100000000cbc44
- (id)initWithController:(id)arg1 stagedScope:(id)arg2 stagingScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000cba39
