...
+ (id)variableGroupWithVariablesAndGroups:(id)arg1;	// IMP=0x00400000001a04af
+ (id)variableGroupWithVariables:(id)arg1;	// IMP=0x00100000001a0466
- (void).cxx_destruct;	// IMP=0x00200000001a130a
...
- (id)injectionForUpdates:(id)arg1;	// IMP=0x00100000001a1223
- (id)valuesInSet:(id)arg1;	// IMP=0x00100000001a120f
- (id)valuesInSet:(id)arg1 startingAtIndex:(int)arg2;	// IMP=0x00100000001a1002
@property(readonly, nonatomic) id <PQLInjecting> injectionForDefaultValues;
- (id)injectionForValues:(id)arg1;	// IMP=0x00100000001a0f42
- (id)_defaultValuesObject;	// IMP=0x00100000001a0cd0
- (id)initWithVariables:(id)arg1;	// IMP=0x00100000001a06d0
