...
- (void).cxx_destruct;	// IMP=0x00200000000880ce
@property(readonly, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(readonly, nonatomic) NSArray *tasks; // @synthesize tasks=_tasks;
- (void)runOperations;	// IMP=0x0010000000087ee3
- (void)_updateSparseRecords:(id)arg1 currentUserRecordID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000086cbc
- (void)_fetchSparseRecordsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000086a5e
- (id)initWithController:(id)arg1 tasks:(id)arg2 transportScopeMapping:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000008697e
