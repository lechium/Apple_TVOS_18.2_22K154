...
- (void).cxx_destruct;	// IMP=0x00200000000d0391
- (void)runOperations;	// IMP=0x00100000000d0328
- (id)initWithController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000d02a4
