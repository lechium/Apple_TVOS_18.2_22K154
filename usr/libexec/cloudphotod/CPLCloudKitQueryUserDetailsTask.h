...
- (void).cxx_destruct;	// IMP=0x00200000000caf74
- (void)queryUserDetailsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000ca621
- (void)runOperations;	// IMP=0x00100000000ca5a0
- (id)initWithController:(id)arg1 participants:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000ca4e7
