...
- (void).cxx_destruct;	// IMP=0x00200000001aff7a
...
- (id)resource;	// IMP=0x00100000001afd6d
- (id)initWithResource:(id)arg1;	// IMP=0x00100000001afb86
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001afa08
