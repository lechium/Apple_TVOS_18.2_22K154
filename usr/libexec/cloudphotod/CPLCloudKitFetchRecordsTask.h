...
- (void).cxx_destruct;	// IMP=0x00200000000b6b0b
...
- (void)runOperations;	// IMP=0x00100000000b6a85
- (id)initWithController:(id)arg1 scopedIdentifiers:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000b697d
