...
+ (id)moveStepFaultInjectionWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x004000000003d207
...
- (id)initWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x001000000003d240
