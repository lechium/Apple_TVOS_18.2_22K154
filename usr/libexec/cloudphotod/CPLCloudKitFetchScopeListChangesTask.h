...
+ (id)descriptionForScopeListSyncAnchor:(id)arg1;	// IMP=0x00200000000d5bfa
- (void).cxx_destruct;	// IMP=0x00200000000d6ad1
- (void)_launchOperationForSharedDatabase:(_Bool)arg1;	// IMP=0x00100000000d5d5d
- (void)runOperations;	// IMP=0x00100000000d5d49
- (id)initWithController:(id)arg1 scopeListSyncAnchor:(id)arg2 progressHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d5c51
