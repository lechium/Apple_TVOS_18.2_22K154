...
+ (id)selfCrashResetReason;	// IMP=0x002000000016dad4
- (void).cxx_destruct;	// IMP=0x002000000016dba0
- (void)commitChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000016c644
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000016bd4e
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000016b5bb
- (id)clientWorkDescription;	// IMP=0x001000000016b5ae
