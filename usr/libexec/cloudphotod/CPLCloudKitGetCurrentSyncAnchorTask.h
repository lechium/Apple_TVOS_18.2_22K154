...
- (void).cxx_destruct;	// IMP=0x00200000000d4c5e
...
- (void)runOperations;	// IMP=0x00100000000d4899
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1 currentUserID:(id)arg2;	// IMP=0x00100000000d462b
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1;	// IMP=0x00100000000d4559
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000d444c
