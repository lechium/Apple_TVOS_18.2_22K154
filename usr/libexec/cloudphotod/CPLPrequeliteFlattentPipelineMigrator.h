...
- (void).cxx_destruct;	// IMP=0x00200000001b4976
@property(readonly, nonatomic) CPLPrequeliteStore *store; // @synthesize store=_store;
- (_Bool)migrate;	// IMP=0x00100000001b46ed
- (_Bool)_migratePushQueue:(id)arg1;	// IMP=0x00100000001b401f
- (_Bool)_discardResourceForUpload:(id)arg1;	// IMP=0x00100000001b3eaa
- (_Bool)_enqueueResourcesForChange:(id)arg1 inOutgoingResourcesWithUploadIdentifier:(id)arg2;	// IMP=0x00100000001b39b8
- (unsigned long long)_availabilityOfResource:(id)arg1;	// IMP=0x00100000001b3776
@property(readonly, nonatomic) NSError *lastError; // @synthesize lastError=_lastError;
- (void)_setLastError:(id)arg1;	// IMP=0x00100000001b36ca
- (id)initWithStore:(id)arg1;	// IMP=0x00100000001b3531
