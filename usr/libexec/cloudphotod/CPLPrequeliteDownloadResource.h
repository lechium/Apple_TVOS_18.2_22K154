...
- (void).cxx_destruct;	// IMP=0x00200000001a5243
...
- (id)resourceWithDownloadQueue:(id)arg1;	// IMP=0x00100000001a506f
- (id)initWithResource:(id)arg1;	// IMP=0x00100000001a4e78
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001a4cf0
