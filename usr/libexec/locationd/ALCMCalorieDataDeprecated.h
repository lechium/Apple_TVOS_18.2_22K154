...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000007fcf7a
- (unsigned long long)hash;	// IMP=0x00100000007fc97d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007fc7db
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007fc6b9
- (void)copyTo:(id)arg1;	// IMP=0x00100000007fc5d5
- (void)writeTo:(id)arg1;	// IMP=0x00100000007fc475
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000007fc468
- (id)dictionaryRepresentation;	// IMP=0x00100000007fb82b
- (id)description;	// IMP=0x00100000007fb7b4
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
@property(nonatomic) _Bool hasTimestamp;
- (int)StringAsMetSource:(id)arg1;	// IMP=0x00100000007fb64f
- (id)metSourceAsString:(int)arg1;	// IMP=0x00100000007fb616
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000007fb0e8
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000007fad1b
