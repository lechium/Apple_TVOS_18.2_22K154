...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000ba394c
- (unsigned long long)hash;	// IMP=0x0010000000ba38af
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000ba37da
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000ba36fa
- (void)copyTo:(id)arg1;	// IMP=0x0010000000ba3670
- (void)writeTo:(id)arg1;	// IMP=0x0010000000ba35bf
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000ba35b2
- (id)dictionaryRepresentation;	// IMP=0x0010000000ba3184
- (id)description;	// IMP=0x0010000000ba310d
@property(nonatomic) _Bool hasNumZaxisHarvestTraces;
@property(nonatomic) _Bool hasChannel;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0010000000ba3013
