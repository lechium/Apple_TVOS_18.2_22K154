...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000020dc97
- (unsigned long long)hash;	// IMP=0x001000000020db32
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000020da5b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000020d984
- (void)copyTo:(id)arg1;	// IMP=0x001000000020d906
- (void)writeTo:(id)arg1;	// IMP=0x001000000020d871
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000020d864
- (id)dictionaryRepresentation;	// IMP=0x001000000020d446
- (id)description;	// IMP=0x001000000020d3cf
@property(readonly, nonatomic) _Bool hasNatalieFeatures;
@property(nonatomic) _Bool hasTimestamp;
- (void)dealloc;	// IMP=0x001000000020d31c
