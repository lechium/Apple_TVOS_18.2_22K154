...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000001032ddb
- (unsigned long long)hash;	// IMP=0x0010000001032669
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000103249d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000103235e
- (void)copyTo:(id)arg1;	// IMP=0x001000000103225d
- (void)writeTo:(id)arg1;	// IMP=0x0010000001032109
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000010320fc
- (id)dictionaryRepresentation;	// IMP=0x00100000010319c1
- (id)description;	// IMP=0x001000000103194a
- (int)StringAsQuality:(id)arg1;	// IMP=0x00100000010318c4
- (id)qualityAsString:(int)arg1;	// IMP=0x001000000103188b
