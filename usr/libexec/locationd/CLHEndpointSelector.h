...
- (id)description;	// IMP=0x0010000000f56c1e
- (id)jsonObject;	// IMP=0x0010000000f56aa4
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x0010000000f56933
- (void)refresh;	// IMP=0x0010000000f56847
- (void)dealloc;	// IMP=0x0010000000f567c5
- (id)init;	// IMP=0x0010000000f56622
