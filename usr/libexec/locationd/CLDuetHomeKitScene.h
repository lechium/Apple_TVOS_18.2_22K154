...
- (void)dealloc;	// IMP=0x001000000029a67e
- (id)initWithHomeUUID:(id)arg1 actionSetUUID:(id)arg2 actionSetName:(id)arg3 actionSetType:(id)arg4 clientName:(id)arg5 source:(id)arg6 triggerLocalizationScan:(id)arg7 triggerRecordingScan:(id)arg8;	// IMP=0x001000000029a592
