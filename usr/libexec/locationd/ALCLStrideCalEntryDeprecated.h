...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002f22da
- (unsigned long long)hash;	// IMP=0x00100000002f1ecb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002f1db3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002f1cd9
- (void)copyTo:(id)arg1;	// IMP=0x00100000002f1c3d
- (void)writeTo:(id)arg1;	// IMP=0x00100000002f1b49
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002f1b3c
- (id)dictionaryRepresentation;	// IMP=0x00100000002f1562
- (id)description;	// IMP=0x00100000002f14eb
