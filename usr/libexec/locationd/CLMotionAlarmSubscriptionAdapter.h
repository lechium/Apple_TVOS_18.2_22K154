...
- (void)fireAlarm:(id)arg1 error:(int)arg2;	// IMP=0x001000000061fdb5
- (void)onNotification:(int)arg1 withData:(id)arg2;	// IMP=0x001000000061fdaf
- (id)initWithMotionAlarmSubscription:(void *)arg1;	// IMP=0x001000000061fd72
