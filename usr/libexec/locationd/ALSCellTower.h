...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000b52fb0
- (unsigned long long)hash;	// IMP=0x0010000000b52ee2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b52de9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b52cfc
- (void)copyTo:(id)arg1;	// IMP=0x0010000000b52c59
- (void)writeTo:(id)arg1;	// IMP=0x0010000000b52b71
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000b52b64
- (id)dictionaryRepresentation;	// IMP=0x0010000000b524e2
- (id)description;	// IMP=0x0010000000b5246b
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x0010000000b52388
