...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000b39d92
- (unsigned long long)hash;	// IMP=0x0010000000b39cdd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b39be8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b39ae9
- (void)copyTo:(id)arg1;	// IMP=0x0010000000b39a3b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000b39975
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000b39968
- (id)dictionaryRepresentation;	// IMP=0x0010000000b39461
- (id)description;	// IMP=0x0010000000b393ea
...
- (void)dealloc;	// IMP=0x0010000000b39290
