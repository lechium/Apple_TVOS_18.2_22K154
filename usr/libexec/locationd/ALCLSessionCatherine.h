...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000004c6518
- (unsigned long long)hash;	// IMP=0x00100000004c5808
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004c5389
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004c50c1
- (void)copyTo:(id)arg1;	// IMP=0x00100000004c4e37
- (void)writeTo:(id)arg1;	// IMP=0x00100000004c4b01
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000004c4af4
- (id)dictionaryRepresentation;	// IMP=0x00100000004c3578
- (id)description;	// IMP=0x00100000004c3501
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00100000004c3369
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00100000004c332e
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000004c2824
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000004c2458
