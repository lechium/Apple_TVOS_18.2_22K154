...
- (id)debugDescription;	// IMP=0x0010000000cebe3e
- (id)description;	// IMP=0x0010000000cebdd5
- (void)dealloc;	// IMP=0x0010000000cebd93
- (id)initWithArchive:(id)arg1 index:(unsigned int)arg2 score:(float)arg3 apHarvestCount:(unsigned int)arg4 macsNotInALSDatabase:(id)arg5;	// IMP=0x0000000000cebd07
