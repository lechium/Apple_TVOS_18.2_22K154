...
- (void)onScenarioTrigger:(id)arg1;	// IMP=0x00100000009796b0
- (void)onVisit:(id)arg1;	// IMP=0x0010000000979489
- (id)initWithFenceMonitor:(void *)arg1;	// IMP=0x001000000097943c
