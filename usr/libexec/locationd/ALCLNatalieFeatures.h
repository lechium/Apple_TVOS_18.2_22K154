...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000021a547
- (unsigned long long)hash;	// IMP=0x001000000021a0d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000021a008
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000219f55
- (void)copyTo:(id)arg1;	// IMP=0x0010000000219ee0
- (void)writeTo:(id)arg1;	// IMP=0x0010000000219e1d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000219e10
- (id)dictionaryRepresentation;	// IMP=0x00100000002198b7
- (id)description;	// IMP=0x0010000000219840
- (int)StringAsFEpochType:(id)arg1;	// IMP=0x00100000002197d9
- (id)fEpochTypeAsString:(int)arg1;	// IMP=0x00100000002197a0
