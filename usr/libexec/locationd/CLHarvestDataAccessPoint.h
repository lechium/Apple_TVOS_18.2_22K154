...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000003678de
...
- (id)description;	// IMP=0x0010000000367e1f
- (id)jsonObject;	// IMP=0x0010000000367c32
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000367b51
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000367a39
- (void)dealloc;	// IMP=0x00100000003679fe
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x00100000003678e6
