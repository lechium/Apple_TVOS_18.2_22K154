...
@class CLCircularRegion, CLLocation, CLVisit, NSArray, NSDate, NSString, NSUUID, RTPlaceInferenceOptions, RTStoredLocationEnumerationOptions, RTStoredVisitFetchOptions;
...
- (void)fetchCachedPlaceInferencesWithReply:(void (^)(NSArray *, NSError *))arg1;
...
- (void)getFamiliarityIndexForVisit:(CLVisit *)arg1 withReply:(void (^)(double, NSError *))arg2;
