...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000008f1f66
- (unsigned long long)hash;	// IMP=0x00100000008f1e19
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000008f1d5e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000008f1cb7
- (void)copyTo:(id)arg1;	// IMP=0x00100000008f1c4e
- (void)writeTo:(id)arg1;	// IMP=0x00100000008f1ba9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000008f1b9c
- (id)dictionaryRepresentation;	// IMP=0x00100000008f1724
- (id)description;	// IMP=0x00100000008f16ad
@property(nonatomic) _Bool hasVerticalSpeed;
- (int)StringAsGradeType:(id)arg1;	// IMP=0x00100000008f15da
- (id)gradeTypeAsString:(int)arg1;	// IMP=0x00100000008f15a1
