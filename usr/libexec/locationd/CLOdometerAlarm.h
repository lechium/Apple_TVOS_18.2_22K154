...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x0010000000c72a80
- (void)invalidate;	// IMP=0x0010000000c72a17
- (void)dealloc;	// IMP=0x0010000000c729c0
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000c728bd
- (id)init;	// IMP=0x0010000000c7288e
