...
- (id)description;	// IMP=0x0010000000ea931d
- (id)jsonObject;	// IMP=0x0010000000ea92b9
@property(readonly) NSURLRequest *URLRequest;
- (id)initWithPayload:(id)arg1;	// IMP=0x0010000000ea8fc3
- (id)initWithArchive:(id)arg1;	// IMP=0x0010000000ea8f73
- (id)initWithRequest:(id)arg1 endpoint:(id)arg2 headers:(id)arg3;	// IMP=0x0010000000ea8ed9
- (void)dealloc;	// IMP=0x0010000000ea8e81
- (id)initWithPayload:(id)arg1 requestTypeCode:(unsigned int)arg2 endpoint:(id)arg3 headers:(id)arg4;	// IMP=0x0010000000ea8dfe
