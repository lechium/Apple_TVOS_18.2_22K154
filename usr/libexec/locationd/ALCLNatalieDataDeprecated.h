...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000cbfb99
- (unsigned long long)hash;	// IMP=0x0010000000cbf726
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000cbf57f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000cbf456
- (void)copyTo:(id)arg1;	// IMP=0x0010000000cbf36b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000cbf221
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000cbf214
- (id)dictionaryRepresentation;	// IMP=0x0010000000cbe601
- (id)description;	// IMP=0x0010000000cbe58a
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x0010000000cbdee4
- (id)activityTypeAsString:(int)arg1;	// IMP=0x0010000000cbdb17
