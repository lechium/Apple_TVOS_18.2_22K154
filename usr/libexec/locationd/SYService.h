...
- (void)resume:(id *)arg1;	// IMP=0x001000000094042e
- (void)suspend;	// IMP=0x0010000000940417
- (void)setHasChangesAvailable;	// IMP=0x0010000000940400
- (void)setDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x00100000009403fa
- (id)initWithService:(id)arg1 priority:(long long)arg2 asMasterStore:(_Bool)arg3 options:(id)arg4;	// IMP=0x00100000009403c0
