...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000025c306
- (unsigned long long)hash;	// IMP=0x001000000025c269
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000025c174
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000025c0a8
- (void)copyTo:(id)arg1;	// IMP=0x001000000025c01a
- (void)writeTo:(id)arg1;	// IMP=0x001000000025bf4d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000025bf40
- (id)dictionaryRepresentation;	// IMP=0x001000000025b9b0
- (id)description;	// IMP=0x001000000025b939
