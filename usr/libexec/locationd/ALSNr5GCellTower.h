...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000010314bc
- (unsigned long long);	// IMP=0x00100000010313d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000103129b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000001031192
- (void)copyTo:(id)arg1;	// IMP=0x00100000010310c9
- (void)writeTo:(id)arg1;	// IMP=0x0010000001030fe1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000001030fd4
- (id)dictionaryRepresentation;	// IMP=0x00100000010309a0
- (id)description;	// IMP=0x0010000001030929
...
- (void)dealloc;	// IMP=0x0010000001030764
