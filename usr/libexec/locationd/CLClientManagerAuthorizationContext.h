...
- (id)getStateSummary;	// IMP=0x0010000000c28e71
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000c28df2
- (_Bool)inUseLevelIsAtLeast:(int)arg1;	// IMP=0x0010000000c28de6
- (_Bool)isAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0010000000c28dc7
- (_Bool)isAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x0010000000c28d80
- (_Bool)isNonProvisionallyAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0010000000c28d61
- (_Bool)isNonProvisionallyAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x0010000000c28d3b
- (id)description;	// IMP=0x0010000000c28cef
- (id)authorizationContextByANDingServiceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg1;	// IMP=0x0010000000c28c5f
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg4 diagnosticMask:(unsigned long long)arg5 authorizedForWidgetUpdates:(_Bool)arg6;	// IMP=0x0010000000c28bf0
