...
- (void)processMonitor:(id)arg1 didProvideUpdate:(id)arg2 forProcessHandle:(id)arg3;	// IMP=0x001000000108f165
- (void)dealloc;	// IMP=0x001000000108f11b
- (id)initWithQueue:(id)arg1;	// IMP=0x001000000108eee7
