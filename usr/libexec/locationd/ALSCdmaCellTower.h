...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000b2dfc9
- (unsigned long long)hash;	// IMP=0x0010000000b2de8c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000b2dce2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000b2db88
- (void)copyTo:(id)arg1;	// IMP=0x0010000000b2da6e
- (void)writeTo:(id)arg1;	// IMP=0x0010000000b2d925
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000b2d918
- (id)dictionaryRepresentation;	// IMP=0x0010000000b2d07a
- (id)description;	// IMP=0x0010000000b2d003
...
- (void)dealloc;	// IMP=0x0010000000b2cd60
