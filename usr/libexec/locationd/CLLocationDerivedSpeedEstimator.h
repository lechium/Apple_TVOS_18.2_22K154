...
+ (_Bool)isSupportedForDerivedSpeedEstimate;	// IMP=0x0020000000339846
+ (_Bool)isSupportedForAnalytics;	// IMP=0x001000000033981a
+ (_Bool)isSupported;	// IMP=0x00100000003397d1
- (id).cxx_construct;	// IMP=0x002000000033df71
- (void).cxx_destruct;	// IMP=0x001000000033df2d
...
- (void)submitLatencyMetrics;	// IMP=0x001000000033de9d
- (void)submitFalseDetectionMetricsWithType:(unsigned long long)arg1;	// IMP=0x001000000033de97
- (void)logLatencyMetricsInternal;	// IMP=0x001000000033de91
- (void)clearStatusBarColorAndText;	// IMP=0x001000000033de87
- (void)setStatusBarWithLabel:(id)arg1;	// IMP=0x001000000033de81
- (void)updateStatusBarLabel;	// IMP=0x001000000033de7b
...
- (void)onWifiServiceNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x001000000033d855
...
- (void)handleVehicularStateChanged;	// IMP=0x001000000033cb96
- (_Bool)_feedLocation:(id)arg1;	// IMP=0x001000000033ac8c
- (void)_invalidateSpeedEstimate;	// IMP=0x001000000033ac47
- (void)_onScanTimer;	// IMP=0x001000000033a746
- (_Bool)feedLocation:(const struct CLDaemonLocation *)arg1;	// IMP=0x001000000033a6b3
- (void)dealloc;	// IMP=0x001000000033a60c
- (void)invalidate;	// IMP=0x001000000033a5de
- (void)unregisterForNotifications;	// IMP=0x001000000033a562
- (void)updateWsbClient:(_Bool)arg1;	// IMP=0x001000000033a540
- (void)stopWsbClient;	// IMP=0x001000000033a385
- (void)startWsbClient;	// IMP=0x001000000033a194
- (void)registerForNotifications;	// IMP=0x0010000000339de5
- (id)initInUniverse:(id)arg1;	// IMP=0x00100000003398d5
- (id)init;	// IMP=0x001000000033986a
