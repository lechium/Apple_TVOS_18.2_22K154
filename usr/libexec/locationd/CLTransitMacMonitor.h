...
+ (_Bool)isSupported;	// IMP=0x0020000000f3399d
+ (id)getSilo;	// IMP=0x0010000000f33904
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000f338eb
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000f3388e
- (id).cxx_construct;	// IMP=0x0020000000f36592
- (void).cxx_destruct;	// IMP=0x0010000000f36540
...
- (void)onLocationNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x0010000000f3628c
- (void)onWifiServiceNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x0010000000f35593
- (void)processNewAccessPoints:(const void *)arg1 transitTileResults:(id)arg2;	// IMP=0x0010000000f3467f
- (void)stopMonitoringTransitStateForClient:(byref id)arg1;	// IMP=0x0010000000f342ac
- (void)startMonitoringTransitStateForClient:(byref id)arg1;	// IMP=0x0010000000f34177
- (void)endService;	// IMP=0x0010000000f33f36
- (void);	// IMP=0x0010000000f339a5
- (id)init;	// IMP=0x0010000000f33960
