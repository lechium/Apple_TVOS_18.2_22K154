...
// Error: Property attributes should begin with the type ('T') attribute, property name: regularEntry
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000211f3b
- (unsigned long long)hash;	// IMP=0x0010000000211791
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002115c2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000211480
- (void)copyTo:(id)arg1;	// IMP=0x001000000021137c
- (void)writeTo:(id)arg1;	// IMP=0x00100000002111e9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002111dc
- (id)dictionaryRepresentation;	// IMP=0x001000000021089d
- (id)description;	// IMP=0x0010000000210826
