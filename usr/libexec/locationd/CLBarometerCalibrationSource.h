...
- (void)disableSource;	// IMP=0x00200000003a7b71
- (void)enableSource;	// IMP=0x00100000003a7b6b
- (void)dealloc;	// IMP=0x00100000003a7b35
- (id)initWithUniverse:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000003a7a82
