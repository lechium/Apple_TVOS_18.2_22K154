...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000956d5e
- (unsigned long long)hash;	// IMP=0x00100000009564bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009561b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000955fd0
- (void)copyTo:(id)arg1;	// IMP=0x0010000000955e26
- (void)writeTo:(id)arg1;	// IMP=0x0010000000955c0d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000955c00
- (id)dictionaryRepresentation;	// IMP=0x0010000000955086
- (id)description;	// IMP=0x001000000095500f
