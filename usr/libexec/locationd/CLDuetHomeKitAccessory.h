...
- (void)dealloc;	// IMP=0x001000000029a916
- (id)initWithHomeUUID:(id)arg1 accessoryUUID:(id)arg2 accessoryName:(id)arg3 serviceName:(id)arg4 serviceType:(id)arg5 characteristicType:(id)arg6 clientName:(id)arg7 source:(id)arg8 serviceUUID:(id)arg9 triggerLocalizationScan:(id)arg10 triggerRecordingScan:(id)arg11;	// IMP=0x001000000029a7f7
