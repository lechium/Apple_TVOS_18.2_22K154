...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000296978
- (unsigned long long)hash;	// IMP=0x001000000029675c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000029669c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002965f1
- (void)copyTo:(id)arg1;	// IMP=0x0010000000296584
- (void)writeTo:(id)arg1;	// IMP=0x00100000002964dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002964d0
- (id)dictionaryRepresentation;	// IMP=0x00100000002960b0
- (id)description;	// IMP=0x0010000000296039
