...
- (void).cxx_destruct;	// IMP=0x00200000000039c0
...
- (unsigned long long)deltaDeliveryRequirements;	// IMP=0x0010000000003968
- (id)mergeableDeltasForMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002f93
- (_Bool)mergeDeltas:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002b36
- (id)stateVector;	// IMP=0x0010000000002a77
- (id)initWithStreamCRDT:(id)arg1 locationRow:(id)arg2 database:(id)arg3 queue:(id)arg4 maxDeltaSize:(long long)arg5 sessionContext:(id)arg6;	// IMP=0x001000000000296b
