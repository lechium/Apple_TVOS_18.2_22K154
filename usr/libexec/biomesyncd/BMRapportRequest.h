...
@class BMSyncSessionContext, MISSING_TYPE, NSDictionary, NSMutableDictionary, NSMutableSet, NSSet, NSUUID;
...
- (void).cxx_destruct;	// IMP=0x002000000000934a
...
- (void)requestTimeoutDidFire;	// IMP=0x0010000000009196
- (void)stopRequestTimeout;	// IMP=0x0010000000009160
- (MISSING_TYPE *)startRequestTimeout;	// IMP=0x0010000000009018
- (void)markAsDeliveredToDevice:(id)arg1 withError:(id)arg2;	// IMP=0x0010000000008f62
- (void)markAsInFlightToDevice:(id)arg1;	// IMP=0x0010000000008f4c
- (void)runRequestOnDevice:(id)arg1;	// IMP=0x0010000000008ed5
- (id)initWithUUID:(id)arg1 activity:(id)arg2 requestBlock:(CDUnknownBlockType)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000008d2f
