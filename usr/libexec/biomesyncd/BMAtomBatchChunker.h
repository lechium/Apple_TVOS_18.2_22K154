...
- (void).cxx_destruct;	// IMP=0x0020000000007127
@property(nonatomic) _Bool moreComing; // @synthesize moreComing=_moreComing;
- (void)didAddAtomWithData:(id)arg1;	// IMP=0x00100000000070ff
- (_Bool)canAddAtomWithData:(id)arg1;	// IMP=0x00100000000070e9
- (id)initWithChunkerPolicy:(id)arg1;	// IMP=0x0010000000007076
