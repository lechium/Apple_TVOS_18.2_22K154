...
- (void).cxx_destruct;	// IMP=0x002000000004dca9
...
- (id)description;	// IMP=0x001000000004dbc0
- (void)reset;	// IMP=0x001000000004db9e
- (void)close;	// IMP=0x001000000004db74
- (void)dealloc;	// IMP=0x001000000004db36
