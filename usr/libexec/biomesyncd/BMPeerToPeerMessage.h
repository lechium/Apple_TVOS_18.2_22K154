...
@interface BMPeerToPeerMessage : NSObject
{
    ...
    unsigned long long _syncReason;	// 32 = 0x20
}

- (void).cxx_destruct;	// IMP=0x00200000000203db
@property(nonatomic) unsigned long long syncReason; // @synthesize syncReason=_syncReason;
...
- (id)dictionaryRepresentation;	// IMP=0x001000000002021c
- (id)initFromDictionary:(id)arg1;	// IMP=0x00100000000200aa
