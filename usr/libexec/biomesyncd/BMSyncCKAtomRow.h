...
- (void).cxx_destruct;	// IMP=0x0020000000021b0c
...
- (id)description;	// IMP=0x0010000000021988
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002197d
- (unsigned long long)hash;	// IMP=0x001000000002193e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000218a9
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 valueVersion:(long long)arg6 valueData:(id)arg7;	// IMP=0x00100000000216a1
- (id)initWithLocation:(id)arg1 timestamp:(id)arg2 referenceLocation:(id)arg3 causalReference:(id)arg4 type:(unsigned long long)arg5 segmentName:(id)arg6 segmentOffset:(unsigned long long)arg7;	// IMP=0x0010000000021499
- (id)initWithFMResultSet:(id)arg1;	// IMP=0x0010000000021b60
