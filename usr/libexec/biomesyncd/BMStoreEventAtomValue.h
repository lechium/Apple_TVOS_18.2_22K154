...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002d3b1
- (void).cxx_destruct;	// IMP=0x002000000002d5e1
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002d490
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002d3b9
- (id)proto;	// IMP=0x001000000002d325
- (id)initWithProto:(id)arg1;	// IMP=0x001000000002d1b0
- (id)initWithEventData:(id)arg1 dataVersion:(unsigned int)arg2 dataTimestamp:(double)arg3;	// IMP=0x001000000002d129
