...
- (id)initWithStatusKeyPaths:(id)arg1 statusByKeyPath:(id)arg2 errorByKeyPath:(id)arg3;	// IMP=0x001000000007f2af
- (id)init;	// IMP=0x001000000007f24b
- (id)protocolStatusReportWithFullReport:(_Bool)arg1;	// IMP=0x0010000000080305
