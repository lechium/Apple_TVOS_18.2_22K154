...
+ (_Bool)isSignificantChange:(id)arg1;	// IMP=0x00400000000263e5
- (id)reportDetails;	// IMP=0x0020000000026462
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000026fde
- (_Bool)_updatePropertiesForConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000026c95
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000026af7
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x0010000000026927
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000026639
