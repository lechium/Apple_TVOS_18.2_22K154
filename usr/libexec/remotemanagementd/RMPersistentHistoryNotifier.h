...
+ (id)sharedQueryQueue;	// IMP=0x004000000006aeee
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006b721
- (void)_delayedQuery;	// IMP=0x001000000006b436
- (void)_scheduleQueryForTransactions;	// IMP=0x001000000006b311
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x001000000006b22d
- (void)start;	// IMP=0x001000000006af95
- (void)dealloc;	// IMP=0x001000000006ae46
- (id)initWithContext:(id)arg1;	// IMP=0x001000000006ada4
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x001000000006ad01
