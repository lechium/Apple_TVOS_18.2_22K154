...
- (id)reportDetails;	// IMP=0x002000000000c88c
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x001000000000cf9a
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000cdfc
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x001000000000cc4e
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000000c965
