...
- (void).cxx_destruct;	// IMP=0x002000000009deb1
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000009dc95
- (id)initWithPersistentContainer:(id)arg1 allowedToRun:(_Bool)arg2;	// IMP=0x001000000009dc1f
