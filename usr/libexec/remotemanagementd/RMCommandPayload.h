...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000024a8b
- (id)reportDetails;	// IMP=0x00200000000252e2
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000024d67
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000024afb
