...
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x00200000000594ae
- (_Bool)_loadAnyDeclaration:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000059310
- (_Bool)reloadReturningError:(id *)arg1;	// IMP=0x0010000000059162
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000058e79
