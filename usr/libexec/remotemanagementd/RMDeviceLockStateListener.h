...
+ (id)newListenerWithDelegate:(id)arg1;	// IMP=0x0020000000033704
- (void).cxx_destruct;	// IMP=0x0020000000033cf6
...
- (void)triggerAggregatingTimerAction;	// IMP=0x0010000000033b14
- (void)didReceiveNotificationForStream:(id)arg1 notificationName:(id)arg2;	// IMP=0x0010000000033a62
- (void)stopListening;	// IMP=0x00100000000339d6
- (void)startListening;	// IMP=0x001000000003385c
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000003374d
