...
- (void)markPending;	// IMP=0x0020000000025b2d
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x00100000000257e4
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000025476
- (void)markQueued;	// IMP=0x0010000000025413
