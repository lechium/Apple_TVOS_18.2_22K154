...
+ (id)sharedInstance;	// IMP=0x002000000000eb70
- (void).cxx_destruct;	// IMP=0x002000000000f699
...
- (void)willBecomeIdle:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000f41e
- (void)_updateAssetForAssetType:(id)arg1;	// IMP=0x001000000000f3ad
- (void)_refreshAssetCatalogForAssetType:(id)arg1 withOverrideTimeout:(id)arg2 forceCatalogRefresh:(_Bool)arg3;	// IMP=0x001000000000f310
- (id)_managedAssetForAssetType:(id)arg1;	// IMP=0x001000000000f0fc
- (void)run;	// IMP=0x001000000000ef91
- (void)registerManagedAssets:(id)arg1;	// IMP=0x001000000000ef28
- (void)registerManagedAsset:(id)arg1;	// IMP=0x001000000000eebf
- (id)_init;	// IMP=0x001000000000ebf8
