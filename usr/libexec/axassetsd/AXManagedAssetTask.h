...
+ (id)taskWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0020000000002300
- (void).cxx_destruct;	// IMP=0x0020000000002be7
...
- (_Bool)_deferIfNeeded;	// IMP=0x00100000000029b1
- (id)_restorationExitStatusForResult:(unsigned long long)arg1;	// IMP=0x0010000000002986
- (void)_completeWithResult:(unsigned long long)arg1;	// IMP=0x00100000000026ad
@property(readonly, copy) NSString *description;
- (id)initWithName:(id)arg1 policy:(id)arg2 context:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000023a5
