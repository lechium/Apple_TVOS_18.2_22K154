...
- (void).cxx_destruct;	// IMP=0x002000000000d6a6
...
- (void)userAccountRegistry:(id)arg1 didFinishUpdatingUserAccountsWithManager:(id)arg2;	// IMP=0x001000000000d5ce
- (void)userAccountRegistry:(id)arg1 willPerformMigrationIfRequiredWithBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000000d3c9
- (id)_securityTaskForCurrentConnection;	// IMP=0x001000000000d3b0
- (id)init;	// IMP=0x001000000000d1ef
