...
- (void).cxx_destruct;	// IMP=0x00200000000684ab
...
- (id)description;	// IMP=0x00100000000681ec
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x00100000000681ce
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x001000000006810c
- (id)initWithAttributes:(id)arg1;	// IMP=0x0010000000067dcf
