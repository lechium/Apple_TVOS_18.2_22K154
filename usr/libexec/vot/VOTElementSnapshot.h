...
- (void).cxx_destruct;	// IMP=0x002000000002c772
...
- (id)initWithLabel:(id)arg1 value:(id)arg2 traits:(unsigned long long)arg3 rowRange:(struct _NSRange)arg4 frame:(struct CGRect)arg5;	// IMP=0x001000000002c518
