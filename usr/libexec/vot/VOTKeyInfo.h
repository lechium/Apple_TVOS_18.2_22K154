...
- (void).cxx_destruct;	// IMP=0x0020000000115a61
...
- (id)description;	// IMP=0x00100000001157f4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011526d
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x001000000011510a
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000115a94
