...
- (void).cxx_destruct;	// IMP=0x0020000000068c6d
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x0010000000068b63
- (long long)_currentGestureRepeaterEvent;	// IMP=0x0010000000068b3e
- (double)_delayForCurrentRepeatCount;	// IMP=0x0010000000068b30
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x0010000000068a50
- (void)updateWithEvent:(id)arg1;	// IMP=0x001000000006880b
- (void)dealloc;	// IMP=0x0010000000068708
- (id)initWithThread:(id)arg1;	// IMP=0x00100000000684bb
