...
- (void).cxx_destruct;	// IMP=0x002000000013701b
...
- (void)_timerFired;	// IMP=0x0010000000136f13
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x0010000000136dba
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x0010000000136ce9
- (void)dealloc;	// IMP=0x0010000000136c7e
- (id)initWithThreadKey:(id)arg1 longPressDelay:(double)arg2 longPressHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000136b9e
