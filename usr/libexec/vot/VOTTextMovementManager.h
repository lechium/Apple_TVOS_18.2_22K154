...
- (void).cxx_destruct;	// IMP=0x00200000000e6fef
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00100000000e6f34
- (void)previousSegment;	// IMP=0x00100000000e6ea8
- (void)nextSegment;	// IMP=0x00100000000e6e35
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00100000000e6bda
