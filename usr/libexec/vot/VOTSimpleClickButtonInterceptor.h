...
- (void).cxx_destruct;	// IMP=0x00200000001379fd
...
- (void)_drainQueue:(_Bool)arg1;	// IMP=0x001000000013776d
- (_Bool)touchEventOccurred:(id)arg1 inTVDirectTouch:(_Bool)arg2;	// IMP=0x0010000000137535
- (void)_timerFired;	// IMP=0x0010000000137508
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x0010000000137349
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x00100000001371f5
- (void)dealloc;	// IMP=0x0010000000137170
- (id)initWithThreadKey:(id)arg1 simpleClickHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000013705d
