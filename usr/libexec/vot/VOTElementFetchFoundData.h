...
+ (id)fetchFoundData:(id)arg1 forceUpdate:(_Bool)arg2 direction:(long long)arg3 generation:(unsigned long long)arg4 range:(struct _NSRange)arg5 searchType:(long long)arg6;	// IMP=0x00400000001186e8
- (void).cxx_destruct;	// IMP=0x0020000000118947
...
- (id)description;	// IMP=0x00100000001187b6
