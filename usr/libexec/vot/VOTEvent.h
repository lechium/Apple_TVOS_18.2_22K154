...
+ (id)brailleEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00400000000172fc
+ (id)appleTVRemoteEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x001000000001725e
+ (id)systemServerEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00100000000171c0
+ (id)internalEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000017122
+ (id)touchEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000017084
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2;	// IMP=0x0010000000017068
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2 otherInfo:(id)arg3;	// IMP=0x0010000000016f9a
+ (id)externalDeviceEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000016efc
- (void).cxx_destruct;	// IMP=0x0020000000017707
...
- (id)description;	// IMP=0x0010000000017513
@property(nonatomic) _Bool bypassHelp; // @dynamic bypassHelp;
- (id)objectForIndex:(unsigned long long)arg1;	// IMP=0x00100000000174eb
- (void)setObject:(id)arg1 forIndex:(unsigned long long)arg2;	// IMP=0x0010000000017472
- (void)setInfo:(id)arg1;	// IMP=0x0010000000017427
@property(retain, nonatomic) VOTKeyInfo *keyInfo; // @dynamic keyInfo;
- (_Bool)isAppleTVRemoteEvent;	// IMP=0x00100000000173eb
- (_Bool)isSystemServerEvent;	// IMP=0x00100000000173dd
- (_Bool)isBrailleEvent;	// IMP=0x00100000000173cf
- (_Bool)isExternalDeviceEvent;	// IMP=0x00100000000173c1
- (_Bool)isTouchEvent;	// IMP=0x00100000000173b3
- (_Bool)isKeyEvent;	// IMP=0x00100000000173a5
- (double)time;	// IMP=0x001000000001739a
- (id)initWithType:(long long)arg1;	// IMP=0x0010000000016eaa
