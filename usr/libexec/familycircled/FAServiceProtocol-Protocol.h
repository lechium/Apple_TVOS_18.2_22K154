...
@class ACAccount, FAScreentimeSettingsObjectCache, NSData, NSDictionary, NSNumber, NSString;
...
- (void)cancelChildTransferRequest:(NSString *)arg1 replyBlock:(void (^)(NSDictionary *, NSError *))arg2;
- (void)resendChildTransferRequest:(NSString *)arg1 replyBlock:(void (^)(NSDictionary *, NSError *))arg2;
- (void)familyChecklistRankingConfigWithCachePolicy:(unsigned long long)arg1 replyBlock:(void (^)(id, NSError *))arg2;
- (void)cancelInvitationWith:(NSString *)arg1 familyID:(NSString *)arg2 options:(NSDictionary *)arg3 replyBlock:(void (^)(id, NSError *))arg4;
- (void)updateFamilyInviteStatusWith:(long long)arg1 inviteCode:(NSString *)arg2 options:(NSDictionary *)arg3 responseFormat:(long long)arg4 additionalRequestParameters:(NSDictionary *)arg5 replyBlock:(void (^)(_Bool, NSError *))arg6;
