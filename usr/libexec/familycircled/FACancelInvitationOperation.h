...
- (void).cxx_destruct;	// IMP=0x002000000001219e
...
- (id)cancelInvitation;	// IMP=0x0010000000011f4e
- (id)initWithNetworkService:(id)arg1 email:(id)arg2 familyID:(id)arg3;	// IMP=0x0010000000011ea6
