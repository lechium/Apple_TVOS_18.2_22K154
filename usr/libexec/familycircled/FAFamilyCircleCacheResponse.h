...
- (void).cxx_destruct;	// IMP=0x0020000000017ec2
...
- (_Bool)_isFamilyCircleFresh:(id)arg1;	// IMP=0x0010000000017de7
@property(readonly, nonatomic) NSDate *expiration;
- (_Bool)isFamilyCircleFresh;	// IMP=0x0010000000017d26
- (id)familyCircleValidatingAgeWithDate:(id)arg1;	// IMP=0x0010000000017ce2
- (id)familyCircleIfFresh;	// IMP=0x0010000000017c7c
- (id)initWithFamilyCircle:(id)arg1 serverTag:(id)arg2 cacheDate:(id)arg3 maxAge:(double)arg4;	// IMP=0x0010000000017bb2
