...
- (void).cxx_destruct;	// IMP=0x002000000000d2ba
...
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000000cff7
- (id)initWithMessage:(id)arg1 accountStore:(id)arg2;	// IMP=0x001000000000ce38
