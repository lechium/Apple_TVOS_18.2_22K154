...
- (void).cxx_destruct;	// IMP=0x002000000001db55
@property(copy, nonatomic) NSString *pushTopic; // @synthesize pushTopic=_pushTopic;
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001dac5
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x001000000001da53
- (id)description;	// IMP=0x001000000001d9be
@property(readonly, nonatomic) NSURL *launchURLFromServer;
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x001000000001d4b8
