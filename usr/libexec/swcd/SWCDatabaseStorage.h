...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000013281
- (void).cxx_destruct;	// IMP=0x0020000000013d95
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001332f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000013289
