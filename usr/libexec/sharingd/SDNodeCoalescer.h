...
- (void).cxx_destruct;	// IMP=0x00200000000ce404
...
- (id)mappedContactIdentifierForContactIdentifier:(id)arg1;	// IMP=0x00100000000ce381
- (id)setMappedContactIdentifier:(id)arg1 relatedContactIdentifiers:(id)arg2;	// IMP=0x00100000000ce041
- (id)coalescedNodesForNewAvailableNodes:(id)arg1;	// IMP=0x00100000000ccfe3
- (id)init;	// IMP=0x00100000000ccf6e
