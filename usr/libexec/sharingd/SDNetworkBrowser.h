...
- (void).cxx_destruct;	// IMP=0x002000000002c898
...
- (void)invalidate;	// IMP=0x001000000002c610
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x001000000002c597
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x001000000002c541
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x001000000002c4eb
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x001000000002c3be
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x001000000002c359
- (struct __SFNode *)copyRootNode;	// IMP=0x001000000002c342
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x001000000002c1db
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x001000000002c16b
- (void)dealloc;	// IMP=0x001000000002c111
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x001000000002c034
