...
@class MISSING_TYPE, NSString, NSURL, RPCompanionLinkDevice, SFBubbleEstimator, SFDevice, SFNotificationInfo, TURoute;
...
@interface SFCombinedDevice : NSObject
{
    ...
    MISSING_TYPE *_notificationBubble;	// 64 = 0x40
...
- (void).cxx_destruct;	// IMP=0x00200000000745c9
...
- (_Bool)stateIsNearby;	// IMP=0x00100000000741e3
- (_Bool)stateIsMedium;	// IMP=0x00100000000741b2
- (_Bool)stateIsClose;	// IMP=0x00100000000741a0
- (void)resetTicks;	// IMP=0x0010000000074009
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x0010000000073d20
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000073c2b
- (id)description;	// IMP=0x0010000000073910
