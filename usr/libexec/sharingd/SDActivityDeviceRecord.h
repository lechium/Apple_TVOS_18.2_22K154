...
- (void).cxx_destruct;	// IMP=0x002000000001ff91
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000001eea2
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001ee8a
- (id)description;	// IMP=0x001000000001eda5
- (id)initWithDevice:(id)arg1;	// IMP=0x001000000001ed13
