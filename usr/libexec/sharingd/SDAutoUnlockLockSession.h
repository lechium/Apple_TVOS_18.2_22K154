...
- (void).cxx_destruct;	// IMP=0x00200000001a4f34
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x00100000001a3e80
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00100000001a3e6b
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x00100000001a3dc9
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00100000001a3b1f
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00100000001a32ab
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00100000001a2e6e
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001a2add
- (void)consumeAuthTokenIfReady;	// IMP=0x00100000001a23b7
- (void)startAWDL;	// IMP=0x00100000001a199d
- (void)handleConfirmationACK;	// IMP=0x00100000001a171f
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00100000001a1249
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00100000001a08d6
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00100000001a0591
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x001000000019fe8c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x001000000019fa42
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000019f7fb
- (void)handleWiFiRequestInvalidated;	// IMP=0x001000000019f79f
- (void)handleRangingStarted;	// IMP=0x001000000019f69b
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x001000000019f5dc
- (void)handleAWDLUp;	// IMP=0x001000000019f427
- (void)handlePeerOutOfRange;	// IMP=0x001000000019f1ee
- (void)handlePeerInRange;	// IMP=0x001000000019ef06
- (_Bool)peerInRange:(id)arg1;	// IMP=0x001000000019ed75
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x001000000019e842
- (void)invalidateConfirmationTimer;	// IMP=0x001000000019e76c
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x001000000019e4e5
- (void)handleTimerFired;	// IMP=0x001000000019df71
- (void)invalidateTimerIfReady;	// IMP=0x001000000019df26
- (id)aksPeerAvailable;	// IMP=0x001000000019dd41
- (void)deviceConnected:(id)arg1;	// IMP=0x001000000019d96c
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x001000000019d696
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x001000000019d637
- (void)connectionActivated;	// IMP=0x001000000019d369
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x001000000019cc78
- (id)getAppName;	// IMP=0x001000000019cc70
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x001000000019cb3f
- (_Bool)isAcceptor;	// IMP=0x001000000019cb37
- (id)attemptResults;	// IMP=0x001000000019bee2
- (void)logResults;	// IMP=0x001000000019b080
- (void)displayConfigChanged:(id)arg1;	// IMP=0x001000000019afe4
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x001000000019af48
- (void)removeObservers;	// IMP=0x001000000019aef5
- (void)addObservers;	// IMP=0x001000000019adf7
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x001000000019aca6
- (void)_handleCanceledAfterSuccess;	// IMP=0x001000000019ab9f
- (void)handleCanceledAfterSuccess;	// IMP=0x001000000019ab18
- (void)lockKeyBagIfNeeded;	// IMP=0x001000000019aa3b
- (void)cancelWiFiRequest;	// IMP=0x001000000019a854
- (void)_cancel;	// IMP=0x001000000019a509
- (void)cancel;	// IMP=0x001000000019a482
- (void)tearDownAWDLIfNecessary;	// IMP=0x001000000019a2ae
- (void)completeAttemptIfNecessary;	// IMP=0x001000000019a0ec
- (void)invalidateNoDisconnect;	// IMP=0x001000000019a0bd
- (void)invalidate;	// IMP=0x0010000000199ea2
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000199ab8
