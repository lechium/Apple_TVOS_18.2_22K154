...
- (void).cxx_destruct;	// IMP=0x002000000009d332
...
- (void)stop;	// IMP=0x001000000009d276
- (int)start;	// IMP=0x001000000009cf53
- (void)mount;	// IMP=0x001000000009cf4d
- (void)bonjourResolverDidChange:(id)arg1;	// IMP=0x001000000009cc74
- (void)mountDiskImageAsync;	// IMP=0x001000000009cc6e
- (void)notifyClientAboutResolve:(int)arg1;	// IMP=0x001000000009cb4b
- (void)dealloc;	// IMP=0x001000000009cb11
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x001000000009ca8b
