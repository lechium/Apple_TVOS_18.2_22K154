...
- (void).cxx_destruct;	// IMP=0x0020000000135786
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000001356ad
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000013549b
- (void)disableService:(id)arg1;	// IMP=0x0010000000135411
- (void)enableService:(id)arg1;	// IMP=0x0010000000135393
- (id)streamHandlerForService:(id)arg1;	// IMP=0x0010000000135330
- (void)stop;	// IMP=0x00100000001350c2
- (void)start;	// IMP=0x001000000013506f
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000134f78
