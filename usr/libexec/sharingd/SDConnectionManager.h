...
+ (id)sharedManager;	// IMP=0x00200000000b52f0
- (void).cxx_destruct;	// IMP=0x00200000000b65a0
...
- (void)unlockSessionDidFinish:(id)arg1;	// IMP=0x00100000000b63c1
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x00100000000b63ab
- (void)appleAccountSignedOut;	// IMP=0x00100000000b6333
- (void)appleAccountSignedIn;	// IMP=0x00100000000b62bb
- (void)createUnlockManagerWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00100000000b61d9
- (void)createStreamsForMessage:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000000b5f2b
- (void)createCompanionServiceManagerWithIdentifier:(id)arg1 clientProxy:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b5be4
- (void)cleanUpConnections;	// IMP=0x00100000000b58a8
- (void)start;	// IMP=0x00100000000b5492
- (id)initWithXPCConnection:(id)arg1;	// IMP=0x00100000000b5345
