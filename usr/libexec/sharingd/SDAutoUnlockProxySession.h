...
- (void).cxx_destruct;	// IMP=0x0020000000098e5f
...
- (void)sendProxyTrigger;	// IMP=0x00100000000989ac
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00100000000988d8
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x001000000009867b
- (void)deviceConnected:(id)arg1;	// IMP=0x0010000000098508
- (id)results;	// IMP=0x00100000000983a5
- (void)removeObservers;	// IMP=0x0010000000098352
- (void)addObservers;	// IMP=0x00100000000982eb
- (void)invalidate;	// IMP=0x001000000009820f
- (void)_start;	// IMP=0x001000000009815d
- (void)start;	// IMP=0x00100000000980d6
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000098044
