...
@interface SDAutoUnlockAuthSession
{
    ...
    NSString *_navBarTitle;	// 216 = 0xd8
}

- (void).cxx_destruct;	// IMP=0x0020000000139ba0
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00100000001393bd
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000138e05
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000138ded
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x001000000013872a
- (void)sendAWDLInfo;	// IMP=0x0010000000138716
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000138679
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000138588
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000138576
- (void)_start;	// IMP=0x0010000000138564
- (void)start;	// IMP=0x00100000001384dd
- (id)getAppName;	// IMP=0x00100000001384d5
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00100000001384cf
- (void)connectionActivated;	// IMP=0x00100000001384c9
- (void)invalidate;	// IMP=0x00100000001383d0
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000138333
