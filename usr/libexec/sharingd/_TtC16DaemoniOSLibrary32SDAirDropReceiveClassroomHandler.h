...
- (void).cxx_destruct;	// IMP=0x00400000001f6cb0
- (id)init;	// IMP=0x00100000001f6c50
- (void)finishedEventForRecordID:(id)arg1 withResults:(id)arg2;	// IMP=0x00100000001f6b80
- (void)errorEventForRecordID:(id)arg1 withResults:(id)arg2;	// IMP=0x00100000001f5d40
- (void)cancelEventForRecordID:(id)arg1 withResults:(id)arg2;	// IMP=0x00100000001f59f0
- (void)progressEventForRecordID:(id)arg1 withResults:(id)arg2;	// IMP=0x00100000001f5780
- (void)askEventForRecordID:(id)arg1 withResults:(id)arg2;	// IMP=0x00100000001f5760
