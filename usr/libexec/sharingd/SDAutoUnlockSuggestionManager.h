...
- (void).cxx_destruct;	// IMP=0x0020000000158639
...
- (void)_systemHasPoweredOn;	// IMP=0x001000000015844d
- (void)_systemWillSleep;	// IMP=0x00100000001583e9
- (_Bool)alwaysShowSetupRetry;	// IMP=0x00100000001583d0
- (id)testDeviceID;	// IMP=0x00100000001583b7
- (_Bool)ignoreBackOff;	// IMP=0x001000000015839e
- (_Bool)suggestionsEnabled;	// IMP=0x0010000000158382
- (void)setRetriedSetup;	// IMP=0x0010000000158332
- (_Bool)retriedSetup;	// IMP=0x0010000000158251
- (void)loadSuggestedPeers;	// IMP=0x001000000015818a
- (void)setFeatureSuggestedForDeviceID:(id)arg1;	// IMP=0x0010000000157ff5
- (_Bool)featureSuggestedForDeviceID:(id)arg1;	// IMP=0x0010000000157f87
- (void)updateDefaultsForDeviceID:(id)arg1;	// IMP=0x0010000000157c1b
- (_Bool)canSuggestForDeviceID:(id)arg1;	// IMP=0x00100000001579bc
- (_Bool)shouldSendRequestsForDeviceID:(id)arg1;	// IMP=0x001000000015788f
- (void)watchAvailableForUnlockWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000015787f
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x001000000015751e
- (void)sendStartAdvertisingToDeviceID:(id)arg1;	// IMP=0x001000000015736e
- (void)invalidateScanTimer;	// IMP=0x0010000000157298
- (void)restartScanTimer:(unsigned long long)arg1;	// IMP=0x00100000001570aa
- (void)invalidateScanner;	// IMP=0x0010000000156f78
- (void)handleFoundPeer:(id)arg1;	// IMP=0x0010000000156b51
- (void)startScanningForIDSDeviceIDs:(id)arg1;	// IMP=0x0010000000156247
- (void)invalidateServiceTimer;	// IMP=0x0010000000156171
- (void)restartServiceTimer:(unsigned long long)arg1;	// IMP=0x0010000000155f76
- (void)invalidateSuggestionService;	// IMP=0x0010000000155f10
- (void)updateSuggestionService;	// IMP=0x0010000000155e9a
- (void)invalidateSuggestedDeviceTimer;	// IMP=0x0010000000155dc4
- (void)restartSuggestedDeviceTimer:(long long)arg1;	// IMP=0x0010000000155ba9
- (void)postSuggestionNotification;	// IMP=0x0010000000155a3d
- (void)postNotificationIfNeeded;	// IMP=0x001000000015585d
- (void)invalidateSetupRetryDeviceTimer;	// IMP=0x0010000000155787
- (void)restartSetupRetryDeviceTimer:(long long)arg1;	// IMP=0x001000000015556c
- (void)setupRetryNotificationDismissed;	// IMP=0x001000000015549a
- (void)setupRetryNotificationSetUpSelected;	// IMP=0x0010000000155494
- (void)setupRetryIfNeeded;	// IMP=0x0010000000155270
- (void)screenLockUnlocked:(id)arg1;	// IMP=0x00100000001551ae
- (void)triggerDevicesIfNeeded;	// IMP=0x00100000001551a8
- (void)handleTestSuggestion;	// IMP=0x00100000001550af
- (void)addObservers;	// IMP=0x0010000000155026
- (id)init;	// IMP=0x0010000000154f15
