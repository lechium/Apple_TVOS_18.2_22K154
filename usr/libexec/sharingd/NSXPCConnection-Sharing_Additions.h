...
- (_Bool)sd_connectionCanShareURL:(id)arg1;	// IMP=0x0010000000004638
- (_Bool)sd_connectionHasEntitlement:(id)arg1;	// IMP=0x00100000000045de
...
- (_Bool)_connectionHasEntitlement:(id)arg1;	// IMP=0x001000000008e488
@end
