...
- (void).cxx_destruct;	// IMP=0x00200000001998ce
...
- (void)cancel;	// IMP=0x0010000000199779
- (void)resolve;	// IMP=0x00100000001992ea
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x0010000000198f49
- (void)notifyClient:(int)arg1;	// IMP=0x0010000000198ef6
- (void)dealloc;	// IMP=0x0010000000198eb8
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x0010000000198d81
