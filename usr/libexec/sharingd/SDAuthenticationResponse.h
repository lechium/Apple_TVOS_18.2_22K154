...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000017b62
- (unsigned long long)hash;	// IMP=0x0010000000017aa2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000017962
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017854
- (void)copyTo:(id)arg1;	// IMP=0x001000000001778d
- (void)writeTo:(id)arg1;	// IMP=0x00100000000176c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000176b8
- (id)dictionaryRepresentation;	// IMP=0x0010000000017288
- (id)description;	// IMP=0x00100000000171d9
