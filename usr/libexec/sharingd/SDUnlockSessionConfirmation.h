...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000f2ca
- (unsigned long long)hash;	// IMP=0x001000000000f229
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000f0e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000f016
- (void)copyTo:(id)arg1;	// IMP=0x001000000000ef6b
- (void)writeTo:(id)arg1;	// IMP=0x001000000000ee95
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000ee88
- (id)dictionaryRepresentation;	// IMP=0x001000000000e882
- (id)description;	// IMP=0x001000000000e7d3
