...
- (void).cxx_destruct;	// IMP=0x0020000000110346
...
- (void)stop;	// IMP=0x00100000001102bc
- (void)start;	// IMP=0x00100000001101d5
- (void)bonjourNodesDidChange:(id)arg1;	// IMP=0x001000000011019f
@property(readonly, copy) NSArray *nodes;
- (void)dealloc;	// IMP=0x001000000011014b
- (id)initWithWorkgroup:(id)arg1;	// IMP=0x00100000001100ce
