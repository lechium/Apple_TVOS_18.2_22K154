...
- (void).cxx_destruct;	// IMP=0x00200000000b9aba
...
- (unsigned int);	// IMP=0x00100000000b9a2b
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000b9814
- (unsigned long long)hash;	// IMP=0x00100000000b9684
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b941f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b9231
- (void)copyTo:(id)arg1;	// IMP=0x00100000000b90b9
- (void)writeTo:(id)arg1;	// IMP=0x00100000000b8f39
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000b8f2c
- (id)dictionaryRepresentation;	// IMP=0x00100000000b8780
- (id)description;	// IMP=0x00100000000b86d1
