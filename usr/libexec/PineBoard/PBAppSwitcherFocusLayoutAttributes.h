...
- (id)description;	// IMP=0x0010000000120277
- (unsigned long long)hash;	// IMP=0x001000000011fef2
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011fb61
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011f96f
