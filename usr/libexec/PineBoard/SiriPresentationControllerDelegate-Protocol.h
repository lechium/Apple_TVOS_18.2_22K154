...
@optional
- (void)siriPresentation:(id <SiriPresentation>)arg1 didUpdatePresentationOptions:(SiriPresentationOptions *)arg2;
- (void)siriPresentation:(id <SiriPresentation>)arg1 didUpdateInputType:(long long)arg2;
...
- (void)siriPresentation:(id <SiriPresentation>)arg1 setSiriHomeAffordanceGestureControl:(_Bool)arg2;
