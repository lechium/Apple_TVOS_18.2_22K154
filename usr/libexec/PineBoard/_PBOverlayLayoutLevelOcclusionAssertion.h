...
- (void).cxx_destruct;	// IMP=0x00200000000d610d
...
- (id)stateDumpBuilder;	// IMP=0x00100000000d6063
@property(readonly, copy) NSString *description;
- (void)invalidateWithTransitionContext:(id)arg1;	// IMP=0x00100000000d5f20
- (void)invalidate;	// IMP=0x00100000000d5f0b
- (void)dealloc;	// IMP=0x00100000000d5e27
- (id)initWithController:(id)arg1 layoutLevel:(long long)arg2 reason:(id)arg3;	// IMP=0x00100000000d5d6c
