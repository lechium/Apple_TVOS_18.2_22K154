...
- (void).cxx_destruct;	// IMP=0x002000000002973c
...
- (id)nextObject;	// IMP=0x0010000000029677
- (id)initWithRecipeProvider:(CDUnknownBlockType)arg1 typeEnumerator:(id)arg2;	// IMP=0x00100000000295c9
