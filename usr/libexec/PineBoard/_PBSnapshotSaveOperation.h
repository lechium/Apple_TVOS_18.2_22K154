...
- (void).cxx_destruct;	// IMP=0x00200000000e0c37
...
- (void)cancel;	// IMP=0x00000000000e0b0b
- (void)main;	// IMP=0x00100000000e037c
- (id)initWithSnapshot:(id)arg1 dataProvider:(id)arg2 manifest:(id)arg3;	// IMP=0x00100000000e026c
