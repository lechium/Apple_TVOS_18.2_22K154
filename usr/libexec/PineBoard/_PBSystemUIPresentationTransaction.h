...
- (void).cxx_destruct;	// IMP=0x00200000001a4a95
...
- (_Bool)_canBeInterrupted;	// IMP=0x00100000001a4a4a
- (void)_begin;	// IMP=0x00100000001a47cf
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x00100000001a46e0
