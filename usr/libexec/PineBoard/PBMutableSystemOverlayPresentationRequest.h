...
- (void)_setInsertAtFrontOfQueue:(_Bool)arg1;	// IMP=0x002000000011b96c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011b898
- (id)init;	// IMP=0x001000000011b867
