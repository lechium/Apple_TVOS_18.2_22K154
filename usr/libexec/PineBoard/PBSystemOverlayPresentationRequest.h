...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011b78c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011b780
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000011b60e
