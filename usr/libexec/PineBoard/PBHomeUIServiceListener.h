...
- (void).cxx_destruct;	// IMP=0x0020000000078793
...
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x0010000000078326
- (void)invalidate;	// IMP=0x00100000000782a4
- (void)activate;	// IMP=0x0010000000078145
- (void)dealloc;	// IMP=0x0010000000078094
- (id)init;	// IMP=0x0010000000078027
