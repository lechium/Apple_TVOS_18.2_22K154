...
- (void).cxx_destruct;	// IMP=0x0020000000266839
...
- (void)start;	// IMP=0x0010000000266167
- (_Bool)isFinished;	// IMP=0x001000000026612b
- (_Bool)isExecuting;	// IMP=0x00100000002660ef
- (_Bool)isAsynchronous;	// IMP=0x00100000002660e7
- (id)initWithApplicationProcessIdentity:(id)arg1;	// IMP=0x0010000000266066
- (id)initWithProcessManager:(id)arg1 applicationProcessIdentity:(id)arg2;	// IMP=0x0010000000265ea0
