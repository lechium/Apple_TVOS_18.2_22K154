...
- (void).cxx_destruct;	// IMP=0x002000000012a1a6
...
- (id)_changePlaybackRateCommandInfo;	// IMP=0x001000000012a0e3
- (void)_begin;	// IMP=0x0010000000129fe4
- (id)queue;	// IMP=0x0010000000129fce
- (id)initWithParentTransaction:(id)arg1;	// IMP=0x0010000000129f44
- (id)initWithQueue:(id)arg1 supportedCommandsProvider:(id)arg2;	// IMP=0x0010000000129ea2
