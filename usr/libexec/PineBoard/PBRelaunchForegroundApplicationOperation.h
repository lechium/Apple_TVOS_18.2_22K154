...
- (void).cxx_destruct;	// IMP=0x002000000001ab81
...
- (void)start;	// IMP=0x001000000001a6c0
- (_Bool)isFinished;	// IMP=0x001000000001a684
- (_Bool)isExecuting;	// IMP=0x001000000001a648
- (_Bool)isAsynchronous;	// IMP=0x001000000001a640
- (id)initWithUpdatingApplicationIdentifiers:(id)arg1;	// IMP=0x001000000001a5c6
