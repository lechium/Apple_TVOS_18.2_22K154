...
+ (id)sharedInstance;	// IMP=0x0020000000170392
+ (id)dependencyDescription;	// IMP=0x0010000000170243
- (void).cxx_destruct;	// IMP=0x00200000001707e3
...
- (void)prepareUIForSystemOverlayPresentationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000001707ba
@property(readonly, nonatomic, getter=isPresenting) _Bool presenting;
- (void)updateWallpaperWithTransitionContext:(id)arg1;	// IMP=0x001000000017078c
- (void)dismissWallpaperAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001706bd
- (void)presentWallpaperAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000001705d9
- (id)init;	// IMP=0x00100000001703e9
