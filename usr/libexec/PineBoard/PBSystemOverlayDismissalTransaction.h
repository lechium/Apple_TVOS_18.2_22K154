...
- (void).cxx_destruct;	// IMP=0x002000000025bdd1
...
- (void)_begin;	// IMP=0x001000000025baf0
- (_Bool)_canBeInterrupted;	// IMP=0x001000000025bae8
- (id)initWithPresentationDelegate:(id)arg1 layoutLevel:(long long)arg2;	// IMP=0x001000000025ba6f
- (id)initWithRequest:(id)arg1 viewController:(id)arg2 layoutLevel:(long long)arg3 deactivationReasons:(unsigned long long)arg4 presentationDelegate:(id)arg5;	// IMP=0x001000000025b981
- (id)init;	// IMP=0x001000000025b973
