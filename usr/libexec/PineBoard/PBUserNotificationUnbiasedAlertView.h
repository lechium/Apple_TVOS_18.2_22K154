...
- (void)_didSelectButton:(id)arg1;	// IMP=0x001000000018d77c
@property(copy, nonatomic) NSString *descriptionText;
@property(copy, nonatomic) NSString *title;
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000018ce4c
- (id)preferredFocusEnvironments;	// IMP=0x001000000018ccfb
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000018bb64
