...
- (void).cxx_destruct;	// IMP=0x002000000002ae37
...
- (id)description;	// IMP=0x001000000002ace6
- (unsigned long long)hash;	// IMP=0x001000000002accf
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002abc8
- (id)initWithToken:(id)arg1 requestType:(unsigned long long)arg2;	// IMP=0x001000000002ab51
- (id)initWithToken:(id)arg1;	// IMP=0x001000000002ab3c
- (id)init;	// IMP=0x001000000002ab2e
