...
- (void).cxx_destruct;	// IMP=0x00200000000238ec
...
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 applicationInfo:(id)arg4;	// IMP=0x00100000000233af
- (id)_appInfoWithUpdatedPolicy:(_Bool)arg1 updatedState:(_Bool)arg2 sourceAppInfo:(id)arg3 placeholder:(id)arg4;	// IMP=0x001000000002319d
- (void)queue_processUpdates:(id)arg1;	// IMP=0x001000000002183d
- (void)languageDidChange;	// IMP=0x00100000000215a9
- (void)applicationIconDidChange:(id)arg1;	// IMP=0x0010000000021251
- (void)placeholderDidChangeSignificantly:(id)arg1;	// IMP=0x0010000000021148
- (void)placeholderProgressDidUpdate:(id)arg1;	// IMP=0x001000000002103f
- (void)handleDynamicStateChanged:(id)arg1;	// IMP=0x0010000000020feb
- (void)handlePolicyChanged:(id)arg1;	// IMP=0x0010000000020f97
- (id)appInfoControllerWithEnabledApps;	// IMP=0x0010000000020f24
- (id)appInfoControllerWithEnabledAndVisibleApps;	// IMP=0x0010000000020eb1
- (id)appInfoControllerWithEnabledAndVisibleAppsAndPlaceholders;	// IMP=0x0010000000020e3e
- (id)appInfoControllerWithEverything;	// IMP=0x0010000000020e02
- (void)_enqueueUpdate:(id)arg1;	// IMP=0x0010000000020ca3
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000020bf7
- (id)addObserver:(id)arg1;	// IMP=0x0010000000020aa1
- (id)configuration;	// IMP=0x00100000000209c5
- (id)appInfos;	// IMP=0x00100000000208aa
- (void)dealloc;	// IMP=0x00100000000206f4
- (id)initWithApplicationLibrary:(id)arg1 policy:(id)arg2 dynamicStateDataSource:(id)arg3;	// IMP=0x001000000001f93e
