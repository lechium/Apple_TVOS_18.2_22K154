...
@class BSAtomicSignal, MISSING_TYPE, NSArray, NSString, NSURL, PBCFUserNotificationWaitViewSpec;
...
@interface PBCFUserNotification : NSObject
{
    ...
    MISSING_TYPE *_requestFlags;	// 36 = 0x24
...
+ (id)_localizedDefaultButtonTitle;	// IMP=0x00200000001c82ae
+ (id)_defaultLocalizationBundle;	// IMP=0x00100000001c81b3
- (void).cxx_destruct;	// IMP=0x00200000001c985c
...
- (long long)_typeForCurrentTemplateKey;	// IMP=0x00100000001c95cb
- (id)description;	// IMP=0x00100000001c948e
- (void)cancel;	// IMP=0x00100000001c9474
- (void)_sendResponse:(unsigned long long)arg1 customButtonResponse:(long long)arg2;	// IMP=0x00100000001c9055
- (void)didSelectButtonAtIndex:(long long)arg1;	// IMP=0x00100000001c8e71
- (_Bool)isLastTextField:(long long)arg1;	// IMP=0x00100000001c8e1c
- (long long)keyboardTypeForTextField:(long long)arg1;	// IMP=0x00100000001c8d42
- (_Bool)isSecureTextField:(long long)arg1;	// IMP=0x00100000001c8d31
@property(readonly, nonatomic) long long notificationType;
- (void)updateWithMessage:(id)arg1 requestFlags:(int)arg2;	// IMP=0x00100000001c83a7
- (id)initWithMessage:(id)arg1 replyPort:(unsigned int)arg2 requestFlags:(int)arg3;	// IMP=0x00100000001c830b
