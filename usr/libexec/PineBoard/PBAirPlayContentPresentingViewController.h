...
+ (double)_transitionDuration;	// IMP=0x000000000002e1b6
- (void).cxx_destruct;	// IMP=0x002000000002e31f
...
- (void)_transitionWithAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000002e1d5
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000002df22
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000002dbd9
...
- (id)initWithChildViewController:(id)arg1;	// IMP=0x001000000002db57
