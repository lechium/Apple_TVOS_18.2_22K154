...
- (void).cxx_destruct;	// IMP=0x0020000000250d28
...
- (void)_didComplete;	// IMP=0x0010000000250aaa
- (void)_begin;	// IMP=0x0010000000250898
- (_Bool)_canBeInterrupted;	// IMP=0x0010000000250890
- (_Bool)_shouldFailForChildTransaction:(id)arg1;	// IMP=0x0010000000250888
- (_Bool)_animateDestinationViewInFront;	// IMP=0x00100000002507d8
- (id)initWithRequest:(id)arg1 transitionType:(long long)arg2;	// IMP=0x001000000025012d
