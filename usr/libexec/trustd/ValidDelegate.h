...
- (void).cxx_destruct;	// IMP=0x002000000002392a
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x001000000002362c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00100000000233e4
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000022e74
- (long long)versionFromTask:(id)arg1;	// IMP=0x0010000000022e18
- (void)updateDb:(long long)arg1;	// IMP=0x0010000000022ae9
- (void)reschedule;	// IMP=0x00100000000229eb
