...
- (void).cxx_destruct;	// IMP=0x002000000000ce26
...
- (void)trigger;	// IMP=0x001000000000cbd6
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x001000000000cb4d
- (void)run;	// IMP=0x001000000000cb3b
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x001000000000cb09
- (id)initWithLabel:(id)arg1 delay:(unsigned long long)arg2 operationQueue:(id)arg3;	// IMP=0x001000000000c6f9
