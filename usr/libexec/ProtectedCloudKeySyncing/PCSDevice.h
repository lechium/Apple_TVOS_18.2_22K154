...
- (void).cxx_destruct;	// IMP=0x00200000000043cf
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000004225
- (unsigned long long)hash;	// IMP=0x00100000000041e1
@property(readonly) NSString *model;
@property(readonly) _Bool isReachable;
- (_Bool)_onQueue_isReachable;	// IMP=0x0010000000004059
@property(readonly) _Bool supportsNewProtocol;
@property(readonly) _Bool supportsPCSKeySync;
@property(readonly) NSUUID *pairingID;
- (void)removeObserver:(id)arg1;	// IMP=0x0010000000003f37
- (void)addObserver:(id)arg1;	// IMP=0x0010000000003e2d
- (id)init;	// IMP=0x0010000000003da6
