...
- (void)runReplyHandlerWithMessage:(id)arg1 error:(id)arg2;	// IMP=0x00100000000020e4
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 logDescription:(id)arg3 sentID:(id)arg4 replyHandler:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x0010000000001d45
