...
- (void).cxx_destruct;	// IMP=0x0040000000018c57
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x0010000000018bf4
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x0010000000018bc9
- (id)initToMemory;	// IMP=0x0010000000018b9e
- (void)close;	// IMP=0x0010000000018b57
- (void)open;	// IMP=0x0010000000018830
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x00100000000186de
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x00100000000181ea
- (id)init;	// IMP=0x0010000000017f86
