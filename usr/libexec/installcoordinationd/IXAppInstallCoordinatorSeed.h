...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000006ceae
- (void).cxx_destruct;	// IMP=0x002000000006d588
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006d1fd
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006ceb6
