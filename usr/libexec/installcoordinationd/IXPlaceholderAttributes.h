...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000156fa
- (void).cxx_destruct;	// IMP=0x00200000000177f8
...
- (id)description;	// IMP=0x00100000000175e9
- (id)infoPlistContent;	// IMP=0x0010000000017252
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x0010000000017015
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x0010000000016527
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x001000000001648e
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000163da
- (id)_plistKeys;	// IMP=0x0010000000016312
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001605c
- (unsigned long long)hash;	// IMP=0x0010000000015d5c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000015702
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000153c0
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000014ff2
- (id)init;	// IMP=0x0010000000014fc3
