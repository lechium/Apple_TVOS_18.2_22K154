...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000047bea
- (void).cxx_destruct;	// IMP=0x0020000000047d3d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000047bf2
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000047aa4
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000047941
