...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000007a6c
- (void).cxx_destruct;	// IMP=0x0020000000008dd3
...
- (id)description;	// IMP=0x0010000000008c43
- (_Bool)setPhaseProportionsForLoadingPhase:(id)arg1 installingPhase:(id)arg2 postProcessingPhase:(id)arg3 error:(id *)arg4;	// IMP=0x001000000000885f
@property(readonly, copy, nonatomic) NSDictionary *progressProportionsDictionaryForLaunchServices;
- (unsigned long long)hash;	// IMP=0x001000000000856e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000804e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000007e95
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000007cad
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000007aa3
- (id)init;	// IMP=0x0010000000007a74
