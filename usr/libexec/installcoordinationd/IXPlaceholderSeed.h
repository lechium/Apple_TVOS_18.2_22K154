...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003eef5
- (void).cxx_destruct;	// IMP=0x002000000003f08a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003eefd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003ed7f
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003ebb7
