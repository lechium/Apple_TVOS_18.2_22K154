...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003d0ce
- (void).cxx_destruct;	// IMP=0x002000000003d1ce
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003d0d6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003cffa
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003cf0b
