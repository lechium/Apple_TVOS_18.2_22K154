...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000481fc
- (void).cxx_destruct;	// IMP=0x0020000000048532
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000004837e
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000048204
