...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x0040000000046c7c
- (void).cxx_destruct;	// IMP=0x0020000000046d25
...
- (void)dealloc;	// IMP=0x0010000000046c35
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x0010000000046ac4
- (id)localizedStringForKey:(id)arg1 withFormatHint:(id)arg2;	// IMP=0x00100000000469e0
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000469ce
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000462bd
- (void)_configureOptionalButtonForConfiguration:(id)arg1;	// IMP=0x0010000000045f82
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x0010000000045eae
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x001000000004594f
- (void)_processUserNotification:(struct __CFUserNotification *)arg1 withConfiguration:(id)arg2 response:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000004518c
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x0010000000045020
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 removability:(unsigned long long)arg3 deletionIsRestricted:(_Bool)arg4;	// IMP=0x0010000000044947
