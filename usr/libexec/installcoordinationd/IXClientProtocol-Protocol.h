...
- (oneway void)_remote_IXSPlaceholder:(NSUUID *)arg1 getIconResourcesPromiseAndInfoPlistContentPromise:(void (^)(IXDataPromiseSeed *, NSDictionary *, NSError *))arg2;
- (oneway void)_remote_IXSPlaceholder:(NSUUID *)arg1 hasIconResourcesPromise:(void (^)(_Bool, NSError *))arg2;
- (oneway void)_remote_IXSPlaceholder:(NSUUID *)arg1 setIconResourcesPromiseUUID:(NSUUID *)arg2 withInfoPlistIconContentPromiseUUID:(NSUUID *)arg3 completion:(void (^)(NSError *))arg4;
...
- (oneway void)_remote_IXSCoordinatedAppInstall:(NSUUID *)arg1 getInstallOptions:(void (^)(MIInstallOptions *, NSError *))arg2;
...
- (void)_remote_updateiTunesMetadata:(MIStoreMetadata *)arg1 forAppWithIdentity:(IXApplicationIdentity *)arg2 completion:(void (^)(NSError *))arg3;
...
- (void)_remote_removabilityDataWithCompletion:(void (^)(NSDictionary *, IXDataStoreClock *, NSError *))arg1;
...
- (void)_remote_removabilityForAppWithIdentity:(IXApplicationIdentity *)arg1 byClient:(unsigned long long)arg2 completion:(void (^)(unsigned long long, NSError *))arg3;
