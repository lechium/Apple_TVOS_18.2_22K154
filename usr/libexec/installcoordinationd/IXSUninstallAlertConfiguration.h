...
- (void).cxx_destruct;	// IMP=0x0020000000044909
...
- (CDUnknownBlockType)actionForButtonAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000044538
- (void)addButtonDefinition:(id)arg1 forAction:(CDUnknownBlockType)arg2;	// IMP=0x001000000004445d
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x0010000000044366
