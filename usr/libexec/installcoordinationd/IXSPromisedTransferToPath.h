...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x002000000003a1c0
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x001000000003a0ab
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x0010000000039f67
