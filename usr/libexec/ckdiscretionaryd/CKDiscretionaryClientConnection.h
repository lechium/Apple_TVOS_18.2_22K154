...
- (void).cxx_destruct;	// IMP=0x0020000000005e7d
...
- (void)handleCompletedTask:(id)arg1 operationID:(id)arg2;	// IMP=0x0010000000005af6
- (void)cleanup;	// IMP=0x00100000000056a1
- (void)finishOperationID:(id)arg1;	// IMP=0x0010000000005304
- (void)queueOperationID:(id)arg1 options:(id)arg2 clientOperationCallbackProxyEndpoint:(id)arg3 withBlock:(CDUnknownBlockType)arg4;	// IMP=0x00100000000045fb
- (id)initWithDaemon:(id)arg1 connection:(id)arg2;	// IMP=0x001000000000409c
- (id)initWithDaemon:(id)arg1 group:(id)arg2 bundleID:(id)arg3 isSpringBoardApp:(_Bool)arg4 requiresPastBuddy:(_Bool)arg5 scheduleSendBarrierBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000003f03
