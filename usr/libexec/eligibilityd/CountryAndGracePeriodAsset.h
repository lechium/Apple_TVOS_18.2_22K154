...
- (void).cxx_destruct;	// IMP=0x002000000000acc3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000a987
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000a863
- (id)initForMobileAssetRootKey:(id)arg1 withDictionary:(id)arg2;	// IMP=0x001000000000a834
