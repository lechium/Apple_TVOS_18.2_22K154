...
- (void)_updatePushNotificationTopicsOutListenToProduction:(_Bool *)arg1 outListenToDevelopment:(_Bool *)arg2;	// IMP=0x0010000000003223
- (void)deleteAssetCollections:(id)arg1 personID:(id)arg2;	// IMP=0x001000000000319c
- (void)dequeueAssetCollectionWithGUIDs:(id)arg1 personID:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000003047
- (void)enqueueAssetCollections:(id)arg1 personID:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002ef2
- (void)stop;	// IMP=0x0010000000002e7d
- (void)start;	// IMP=0x00100000000027a2
- (void)didUnidle;	// IMP=0x0010000000002730
- (void)didIdle;	// IMP=0x00100000000026b1
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000246f
- (void)dealloc;	// IMP=0x00100000000023fb
- (id)init;	// IMP=0x00100000000021fc
