...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000d629b
- (void).cxx_destruct;	// IMP=0x00200000000d6069
...
- (void)start;	// IMP=0x00100000000d5cc1
- (_Bool)isPersistent;	// IMP=0x00100000000d5cb9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000d5c19
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000d5b66
- (id)description;	// IMP=0x00100000000d5ac4
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 persistentID:(long long)arg3 socialProfileIDs:(id)arg4;	// IMP=0x00100000000d5a2f
