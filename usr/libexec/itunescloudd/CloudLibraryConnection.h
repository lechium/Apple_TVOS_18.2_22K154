...
- (void).cxx_destruct;	// IMP=0x00200000000fe810
...
- (void)disconnect;	// IMP=0x00100000000fe756
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000fe64d
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fd9b0
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fd8d2
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000fd7ab
