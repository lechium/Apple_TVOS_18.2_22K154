...
- (void).cxx_destruct;	// IMP=0x00200000000e22e1
...
- (id)metadataFilter;	// IMP=0x00100000000e2257
- (id)queryFilter;	// IMP=0x00100000000e21ea
- (id)_queryFilterEncodedStringForDAAPNameString:(id)arg1;	// IMP=0x00100000000e21c7
- (void)main;	// IMP=0x00100000000e1ad7
