...
- (void).cxx_destruct;	// IMP=0x00200000000a790b
...
- (void)_initializeMappings;	// IMP=0x00100000000a6628
- (id)geniusValueForML3ContainerProperty:(id)arg1 value:(id)arg2;	// IMP=0x00100000000a65a3
- (id)geniusPlaylistPropertyForML3ContainerProperty:(id)arg1;	// IMP=0x00100000000a658d
- (id)geniusValueForML3TrackProperty:(id)arg1 value:(id)arg2;	// IMP=0x00100000000a6508
- (id)geniusTrackPropertyForML3TrackProperty:(id)arg1;	// IMP=0x00100000000a64f2
- (id)init;	// IMP=0x00100000000a64a6
