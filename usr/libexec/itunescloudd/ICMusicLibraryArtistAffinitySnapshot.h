...
- (void).cxx_destruct;	// IMP=0x00200000000833fe
...
- (id)debugDescription;	// IMP=0x00100000000831b1
- (float)legacyScore;	// IMP=0x001000000008309b
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000082d9c
