...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000095fe0
- (void).cxx_destruct;	// IMP=0x0020000000095f49
...
- (id)description;	// IMP=0x0010000000095e1d
- (void);	// IMP=0x0010000000095d85
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000095ca9
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2;	// IMP=0x0010000000095b4f
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000095aed
- (id)init;	// IMP=0x0010000000095aad
