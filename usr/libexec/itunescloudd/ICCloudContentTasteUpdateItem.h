...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000b818a
- (void).cxx_destruct;	// IMP=0x00200000000b814c
...
- (unsigned long long)hash;	// IMP=0x00100000000b4c96
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b4ab1
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000b49db
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000b484f
- (id)description;	// IMP=0x00100000000b476d
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x00100000000b4624
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x00100000000b44f5
