...
+ (id)daemonDefaults;	// IMP=0x0020000000027046
- (void).cxx_destruct;	// IMP=0x002000000002701e
...
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000026f44
- (id)_init;	// IMP=0x0010000000026e54
