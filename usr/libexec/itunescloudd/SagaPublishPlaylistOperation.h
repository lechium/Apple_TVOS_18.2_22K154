...
- (void).cxx_destruct;	// IMP=0x002000000004fe86
...
- (void)main;	// IMP=0x001000000004f8a2
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 sagaID:(unsigned long long)arg3;	// IMP=0x001000000004f85e
- (id)initWithClientIdentity:(id)arg1 sagaID:(unsigned long long)arg2;	// IMP=0x001000000004f7f4
