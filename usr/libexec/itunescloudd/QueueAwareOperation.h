...
- (void).cxx_destruct;	// IMP=0x0020000000077095
...
- (id)musicLibrary;	// IMP=0x0010000000076fef
@property(readonly, nonatomic) NSObject<OS_tcc_identity> *clientIdentity; // @synthesize clientIdentity=_clientIdentity;
- (id)initWithArtworkImporter:(id)arg1 clientIdentity:(id)arg2 operationQueue:(id)arg3 artistPersistentIDsToUpdate:(id)arg4 albumArtistPersistentIDsToUpdate:(id)arg5;	// IMP=0x0010000000076e3a
