...
- (void).cxx_destruct;	// IMP=0x0020000000151c60
...
- (void)parser:(id)arg1 didEndContainerCode:(unsigned int)arg2;	// IMP=0x0010000000151b52
- (void)parser:(id)arg1 didParseDataCode:(unsigned int)arg2 bytes:(char *)arg3 contentLength:(unsigned int)arg4;	// IMP=0x0010000000151a2d
- (void)parser:(id)arg1 didStartContainerCode:(unsigned int)arg2 contentLength:(unsigned int)arg3;	// IMP=0x00100000001519fe
- (_Bool)parser:(id)arg1 shouldParseCodeAsContainer:(unsigned int)arg2;	// IMP=0x00100000001519a8
- (_Bool)parser:(id)arg1 shouldParseCode:(unsigned int)arg2;	// IMP=0x00100000001518a4
- (void)parserDidStart:(id)arg1;	// IMP=0x0010000000151886
- (id)init;	// IMP=0x0010000000151820
