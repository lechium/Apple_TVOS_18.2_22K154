...
+ (id)defaultOverrideHTTPHeaderFields;	// IMP=0x004000000007c471
- (void).cxx_destruct;	// IMP=0x002000000007e815
@property(copy, nonatomic) NSString *currentStoreFrontID; // @synthesize currentStoreFrontID=_currentStoreFrontID;
- (id)propertyListObjectWithPlayActivityEvent:(id)arg1;	// IMP=0x001000000007c4f7
