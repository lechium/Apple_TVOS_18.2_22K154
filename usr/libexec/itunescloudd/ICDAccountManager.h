...
- (void).cxx_destruct;	// IMP=0x00200000001325d9
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x00100000001324e4
- (id)_buildStateChange;	// IMP=0x00100000001322d9
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x0010000000131d03
- (void)updateState;	// IMP=0x0010000000131af7
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000001318ad
