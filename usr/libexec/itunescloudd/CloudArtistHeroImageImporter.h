...
+ (id)allArtistImagesMapCacheFilePathURL;	// IMP=0x00400000000778eb
- (void).cxx_destruct;	// IMP=0x002000000006c6dc
...
- (void)_importHeroImageForArtistType:(long long)arg1 withPersistentID:(long long)arg2 clientIdentity:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000006c4cd
- (void)_artistHeroImageUpdateFinished;	// IMP=0x001000000006c45c
- (long long)_synchronouslyLoadArtistUpdatePollingFrequencyFromBag;	// IMP=0x001000000006c136
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000006bff9
- (void)deprioritizeAlbumArtistHeroImageForPersistentID:(long long)arg1;	// IMP=0x001000000006bfa8
- (void)deprioritizeArtistHeroImageForPersistentID:(long long)arg1;	// IMP=0x001000000006bf57
- (void)importAlbumArtistHeroImageForPersistentID:(long long)arg1 clientIdentity:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000006bf37
- (void)importArtistHeroImageForPersistentID:(long long)arg1 clientIdentity:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000006bf17
- (void)cancelArtistHeroImageUpdateAndWaitForOperationToFinish:(_Bool)arg1;	// IMP=0x001000000006be35
- (void)cancelArtistHeroImageUpdate;	// IMP=0x001000000006be21
- (void)updateArtistHeroImagesForArtistsAddedSinceLastUpdateUsingClientIdentity:(id)arg1;	// IMP=0x001000000006bd69
- (void)updateArtistHeroImagesWithClientIdentity:(id)arg1;	// IMP=0x001000000006bca0
- (id)userIdentity;	// IMP=0x001000000006bc50
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000006b995
