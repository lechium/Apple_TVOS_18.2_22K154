...
- (void).cxx_destruct;	// IMP=0x00200000001173ed
...
- (id)dictionaryRepresentation;	// IMP=0x001000000011733d
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x001000000011729a
