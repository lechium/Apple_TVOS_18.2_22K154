...
- (void).cxx_destruct;	// IMP=0x0020000000055de6
...
- (void)main;	// IMP=0x0010000000055853
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x0010000000055731
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x00100000000556cd
