...
+ (id)_defaultQueryParameters;	// IMP=0x0020000000028de3
+ (id)_defaultQueryType;	// IMP=0x0010000000028dd6
+ (id)allExisitngInfos;	// IMP=0x00100000000288e3
- (void).cxx_destruct;	// IMP=0x00200000000290cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000002905f
@property(readonly) unsigned long long hash;
- (_Bool)shouldPrefetchResource:(id)arg1;	// IMP=0x0010000000028f29
...
- (id)initWithOverrides:(id)arg1;	// IMP=0x0010000000028765
