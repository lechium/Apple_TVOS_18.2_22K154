...
+ (CDStruct_026435ec)requestKind;	// IMP=0x00200000000261fd
- (void).cxx_destruct;	// IMP=0x00200000000269c0
- (void)cancel;	// IMP=0x001000000002698e
- (void)dataURLSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x001000000002670a
