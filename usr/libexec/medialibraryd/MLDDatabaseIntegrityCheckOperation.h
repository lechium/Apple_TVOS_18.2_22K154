...
- (void).cxx_destruct;	// IMP=0x0020000000014029
@property(readonly, nonatomic) NSError *error; // @synthesize error=_error;
@property(readonly, nonatomic) MLDDatabaseIntegrityCheck *check; // @synthesize check=_check;
@property(readonly, nonatomic) NSString *databasePath; // @synthesize databasePath=_databasePath;
- (id)_createSQLiteErrorWithCode:(int)arg1 description:(id)arg2;	// IMP=0x0010000000013f0f
- (void)main;	// IMP=0x00100000000136e3
- (id)initWithDatabasePath:(id)arg1 repairFaults:(_Bool)arg2;	// IMP=0x0010000000013658
