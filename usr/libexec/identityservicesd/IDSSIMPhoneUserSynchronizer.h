...
- (void).cxx_destruct;	// IMP=0x0020000000266897
...
- (void)didUpdatePairedDevice:(id)arg1;	// IMP=0x0010000000266628
- (void)_checkRegistrationStatus;	// IMP=0x0010000000265e82
- (void)_setupForCurrentSubscriptionState;	// IMP=0x0010000000265e4e
- (void)SIMInformationDidChange;	// IMP=0x0010000000265d79
- (void)userStore:(id)arg1 didUpdateUser:(id)arg2;	// IMP=0x0010000000265d73
- (void)userStore:(id)arg1 didRemoveAuthenticationCertificateForUser:(id)arg2;	// IMP=0x0010000000265d6d
- (void)userStore:(id)arg1 didAddAuthenticationCertificate:(id)arg2 forUser:(id)arg3;	// IMP=0x0010000000265d67
- (void)userStore:(id)arg1 didAddUser:(id)arg2;	// IMP=0x0010000000265d61
- (void)userStore:(id)arg1 didRemoveUser:(id)arg2 withAuthenticationCertificate:(id)arg3;	// IMP=0x0010000000265ce7
- (void)selectedSubscriptionLabelDidChange:(id)arg1;	// IMP=0x0010000000265c12
- (id)updatedUserSetForRealm:(long long)arg1 currentUsers:(id)arg2;	// IMP=0x001000000026476f
- (void)forceRemoveUser:(id)arg1 silently:(_Bool)arg2;	// IMP=0x00100000002646fe
- (_Bool)_isInDualPhoneIdentityModeForSims:(id)arg1;	// IMP=0x00100000002643d4
- (void)verifyState;	// IMP=0x001000000026434f
- (void)dealloc;	// IMP=0x001000000026430a
- (id)initWithUserStore:(id)arg1 queue:(id)arg2 lockdownManager:(id)arg3 systemMonitor:(id)arg4 CTAdapter:(id)arg5 userConfiguration:(id)arg6 registrationController:(id)arg7 pairingManager:(id)arg8;	// IMP=0x001000000026411d
