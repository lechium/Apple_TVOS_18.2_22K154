...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000012178d
- (void).cxx_destruct;	// IMP=0x0020000000121a23
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000121923
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000121795
@property(readonly, nonatomic) NSData *dataRepresentation;
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x00100000001215f5
- (id)initWithVersion:(unsigned long long)arg1 language:(id)arg2 hardwareVersion:(id)arg3 osVersion:(id)arg4 softwareVersion:(id)arg5 deviceName:(id)arg6;	// IMP=0x00100000001214ed
- (id)init;	// IMP=0x0010000000121375
