...
- (void).cxx_destruct;	// IMP=0x00200000002eee7f
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x00100000002ee9fd
- (void)_addRemotePacketOutage;	// IMP=0x00100000002ee96f
- (id)description;	// IMP=0x00100000002ee881
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00100000002ee544
