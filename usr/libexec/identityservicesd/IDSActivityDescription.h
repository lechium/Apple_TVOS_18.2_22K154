...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000005fd40
- (void).cxx_destruct;	// IMP=0x002000000005ff6e
...
- (id)description;	// IMP=0x001000000005fecf
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000005fdd7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000005fd48
