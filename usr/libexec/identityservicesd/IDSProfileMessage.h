...
- (void).cxx_destruct;	// IMP=0x00200000000f5ed6
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000000f5d95
- (id)additionalMessageHeaders;	// IMP=0x00100000000f5b83
- (id)additionalMessageHeadersForOutgoingPush;	// IMP=0x00100000000f58eb
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x00100000000f579c
- (long long)responseCommand;	// IMP=0x00100000000f5791
- (long long)command;	// IMP=0x00100000000f5786
- (_Bool)wantsBinaryPush;	// IMP=0x00100000000f577e
- (_Bool)wantsCompressedBody;	// IMP=0x00100000000f5776
- (_Bool)wantsHTTPHeaders;	// IMP=0x00100000000f576e
- (_Bool)wantsBagKey;	// IMP=0x00100000000f5766
- (void)dealloc;	// IMP=0x00100000000f5650
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f5509
- (id)init;	// IMP=0x00100000000f5428
