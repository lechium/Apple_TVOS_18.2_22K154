...
- (void).cxx_destruct;	// IMP=0x00200000003ab6b9
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x00100000003aaddb
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x00100000003aad30
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x00100000003aace2
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x00100000003aa9df
- (_Bool)supportsReinitiate;	// IMP=0x00100000003aa944
- (void)_endSessionTimedOut;	// IMP=0x00100000003aa83e
- (void)_endSessionTimerFiredOnMain;	// IMP=0x00100000003aa7bf
- (void)setEndSessionTimeoutTimer;	// IMP=0x00100000003aa5f7
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x00100000003aa498
- (void)_clearPacketLossTimer;	// IMP=0x00100000003aa39a
- (void)_connectionTimedOut;	// IMP=0x00100000003aa2a1
- (void)_connectionTimerFiredOnMain;	// IMP=0x00100000003aa222
- (void)setConnectionTimer;	// IMP=0x00100000003a9f6f
- (void)_clearConnectionTimer;	// IMP=0x00100000003a9e10
- (void)_clearInvitationTimer;	// IMP=0x00100000003a9cb1
- (void)_inviteTimedOut;	// IMP=0x00100000003a9b66
- (void)_inviteTimerFiredOnMain;	// IMP=0x00100000003a9ae7
- (void)setInvitationTimer;	// IMP=0x00100000003a9914
- (void)clearAllTimers;	// IMP=0x00100000003a98cc
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x00100000003a7fe0
