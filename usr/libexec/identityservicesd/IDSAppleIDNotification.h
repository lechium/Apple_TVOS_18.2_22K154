...
- (void).cxx_destruct;	// IMP=0x00200000001eb7c8
...
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forSession:(id)arg2;	// IMP=0x00100000001eb634
- (void)addSession:(id)arg1;	// IMP=0x00100000001eb5e8
- (void)addServiceType:(id)arg1;	// IMP=0x00100000001eb5d2
- (void)addAlias:(id)arg1;	// IMP=0x00100000001eb5b5
- (id)init;	// IMP=0x00100000001eb512
