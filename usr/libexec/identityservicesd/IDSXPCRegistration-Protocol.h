...
@class IDSPhoneSubscription, IDSURI, MISSING_TYPE, NSArray;
...
- (MISSING_TYPE *)requestUnselectedTemporaryPhoneAliasesWithCompletion: /* Error: Ran out of types for this method. */;
