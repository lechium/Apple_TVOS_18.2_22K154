...
- (void).cxx_destruct;	// IMP=0x0020000000157b20
...
- (void)performSyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000157aa7
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000157a90
- (id)initWithName:(char *)arg1 qosClass:(unsigned int)arg2 specific:(char *)arg3;	// IMP=0x00100000001579c7
