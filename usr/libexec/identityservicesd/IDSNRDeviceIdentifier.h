...
+ (id)newDeviceIdentifierWithBluetoothUUID:(id)arg1;	// IMP=0x0020000000005816
- (void).cxx_destruct;	// IMP=0x0020000000005828
@property(readonly, nonatomic) NSUUID *nrDeviceIdentifier; // @synthesize nrDeviceIdentifier=_nrDeviceIdentifier;
- (id)initWithUUID:(id)arg1;	// IMP=0x0010000000005808
