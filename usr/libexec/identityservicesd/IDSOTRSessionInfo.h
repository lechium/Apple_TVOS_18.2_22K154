...
- (void).cxx_destruct;	// IMP=0x00200000002e29da
...
- (void)_negotiationTimerFiredOnMain;	// IMP=0x00100000002e28da
- (void)setNegotiationTimer;	// IMP=0x00100000002e270e
- (void)_handleNegotiationTimeout;	// IMP=0x00100000002e2107
- (void)removeNegotiationTimer;	// IMP=0x00100000002e1fa2
- (void)dealloc;	// IMP=0x00100000002e1f49
- (id)initWithToken:(id)arg1;	// IMP=0x00100000002e1ede
