...
- (void).cxx_destruct;	// IMP=0x0020000000005b5e
...
- (id)init;	// IMP=0x0010000000005b10
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000005b02
