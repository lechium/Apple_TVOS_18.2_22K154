...
@interface IDSRegistration : NSObject
{
    ...
    _Bool _didRegisterWithKTAccountKey;	// 15 = 0xf
    _Bool _didRegisterWithDeviceSignature;	// 16 = 0x10
    ...
    MISSING_TYPE *_deviceName;	// 144 = 0x90
    ...
    unsigned long long _optedIntoKT;	// 296 = 0x128
...
- (void).cxx_destruct;	// IMP=0x0020000000470e2f
...
@property(nonatomic) _Bool didRegisterWithDeviceSignature; // @synthesize didRegisterWithDeviceSignature=_didRegisterWithDeviceSignature;
@property(nonatomic) unsigned long long optedIntoKT; // @synthesize optedIntoKT=_optedIntoKT;
...
- (id)debugDescription;	// IMP=0x001000000046e7af
- (id)description;	// IMP=0x001000000046e3f0
- (id)_userStore;	// IMP=0x001000000046e36f
- (id)_user;	// IMP=0x001000000046e30c
- (void)voidPassword;	// IMP=0x001000000046e0d2
- (void)voidAuthenticationTokenAllowingGracePeriod;	// IMP=0x001000000046df31
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000046cda6
...
- (id)_userID;	// IMP=0x001000000046bcfe
@property(readonly, nonatomic) NSArray *confirmedEmails;
- (void)removeCandidateEmail:(id)arg1;	// IMP=0x001000000046bbe0
- (void)addCandidateEmail:(id)arg1;	// IMP=0x001000000046bb02
@property(readonly, nonatomic) NSArray *candidateEmails;
- (_Bool)saveToKeychain;	// IMP=0x001000000046ba99
- (_Bool)removeFromKeychain;	// IMP=0x001000000046ba41
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000469466
- (id)init;	// IMP=0x001000000046940c
- (id)initWithPasswordManager:(id)arg1;	// IMP=0x001000000046936e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000469363
- (id)_keychain_comparisonValue;	// IMP=0x0010000000274cc2
- (_Bool)_keychain_isEqual:(id)arg1;	// IMP=0x0010000000274b1b
