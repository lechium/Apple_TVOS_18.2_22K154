...
@interface IDSSocketPairConnection : NSObject
{
    ...
    MISSING_TYPE *_fragmentationSize;	// 104 = 0x68
...
- (void).cxx_destruct;	// IMP=0x002000000005591a
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000055653
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x001000000005561f
- (void)_endSession;	// IMP=0x00100000000553e8
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x00100000000550ac
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x0010000000055098
- (void)_sendToConnectedSocket;	// IMP=0x0010000000054821
- (_Bool)_queueNextOutgoingData;	// IMP=0x0010000000053d21
- (void)_processBytesAvailable;	// IMP=0x0010000000053206
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x0010000000052928
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x00100000000526d2
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x00100000000521d1
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0010000000051f4c
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000051e5c
...
- (void)endSession;	// IMP=0x0010000000051810
- (void)dealloc;	// IMP=0x0010000000051787
- (void)start;	// IMP=0x001000000005163f
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x00100000000512e7
