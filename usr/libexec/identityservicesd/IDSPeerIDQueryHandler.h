...
+ (int)queryRetryNumberForBadSignature;	// IMP=0x00200000003ee3b9
+ (double)queryRetryIntervalForBadSignature;	// IMP=0x00100000003ee328
+ (_Bool)isQueryRetryForBadSignatureEnabled;	// IMP=0x00100000003ee2a8
+ (int)serverBackoffModeReceiverRetryInterval;	// IMP=0x00100000003ee20e
+ (int)serverBackoffModeMaxSenderRetries;	// IMP=0x00100000003ee178
+ (_Bool)isServerBackoffModeActive;	// IMP=0x00100000003ee102
+ (_Bool)shouldUseSelfTokens;	// IMP=0x00100000003ee05d
- (void).cxx_destruct;	// IMP=0x00200000003f6ab3
...
- (void)removeCompletionBlockForToken:(id)arg1;	// IMP=0x00100000003f6882
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forToken:(id)arg2;	// IMP=0x00100000003f6613
- (_Bool)startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 reason:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;	// IMP=0x00100000003f646b
- (void)_dequeuePendingQueryIfPossible;	// IMP=0x00100000003eff66
- (void)_startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 queryIdentifier:(id)arg6 reason:(id)arg7 completionBlock:(CDUnknownBlockType)arg8;	// IMP=0x00100000003ef742
- (void)_removeCompletionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x00100000003ef3c9
- (id)_completionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x00100000003ef1fc
- (_Bool)_addCompletionBlock:(CDUnknownBlockType)arg1 forURIs:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 queryIdentifier:(id)arg6;	// IMP=0x00100000003ee927
- (void)_bagLoaded:(id)arg1;	// IMP=0x00100000003ee773
- (void)dealloc;	// IMP=0x00100000003ee6eb
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2 dualMessageDelivery:(id)arg3 networkChangeNotifier:(id)arg4 pushHandler:(id)arg5;	// IMP=0x00100000003ee578
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2;	// IMP=0x00100000003ee43c
