...
- (void)vmDataResponse:(NSData *)arg1 forRequestID:(NSString *)arg2 withError:(NSError *)arg3;
...
- (void)session:(NSString *)arg1 didReceiveLeftParticipantID:(unsigned long long)arg2 withContext:(NSData *)arg3;
- (void)session:(NSString *)arg1 didReceiveJoinedParticipantID:(unsigned long long)arg2 withContext:(NSData *)arg3;
...
- (void)groupSessionDidDisconnectUnderlyingLinks:(NSString *)arg1;
- (void)groupSessionDidConnectUnderlyingLinks:(NSString *)arg1;
...
- (void)groupSessionDidInitialize:(NSString *)arg1 error:(NSError *)arg2;
...
- (void)service:(NSString *)arg1 restrictionReasonChanged:(unsigned long long)arg2;
...
- (MISSING_TYPE *)connectionComplete:withResponse: /* Error: Ran out of types for this method. */;
@end
