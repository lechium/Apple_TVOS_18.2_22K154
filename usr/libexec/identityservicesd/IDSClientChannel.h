...
- (void)osChannelInfoLog;	// IMP=0x0010000000051138
- (void)invalidate;	// IMP=0x0010000000051132
- (_Bool)writeBuffer:(char *)arg1 bufferSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4 moreComing:(_Bool)arg5;	// IMP=0x001000000005112a
- (_Bool)writePacketBuffer:(CDStruct_90727270 *)arg1 metaData:(const void *)arg2 metadataSize:(unsigned int)arg3 moreComing:(_Bool)arg4;	// IMP=0x0010000000051122
- (_Bool)writeDatagram:(const void *)arg1 datagramSize:(unsigned int)arg2 metaData:(const void *)arg3 metadataSize:(unsigned int)arg4;	// IMP=0x001000000005111a
- (void)connectWithProtocoHandler;	// IMP=0x0010000000051114
- (_Bool)connectWithTransportThread;	// IMP=0x001000000005110c
- (id)initWithDestination:(id)arg1;	// IMP=0x0010000000051099
