...
- (_Bool)link:(id)arg1 didReceivePacket:(CDStruct_90727270 *)arg2 fromDeviceUniqueID:(NSString *)arg3 cbuuid:(NSString *)arg4;
...
- (void)link:(id)arg1 didFinishConvergenceForRelaySessionID:(NSString *)arg2;
