...
- (void).cxx_destruct;	// IMP=0x0020000000211fad
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000211d56
- (_Bool)wantsHTTPGet;	// IMP=0x0010000000211d4e
- (id)additionalQueryStringParameters;	// IMP=0x0010000000211be9
- (id)additionalMessageHeaders;	// IMP=0x0010000000211a4e
- (id)bagKey;	// IMP=0x0010000000211a41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000211884
