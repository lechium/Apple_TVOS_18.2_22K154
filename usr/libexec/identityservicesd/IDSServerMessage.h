...
- (void).cxx_destruct;	// IMP=0x00200000002e9b7c
...
- (_Bool)wantsBinaryPush;	// IMP=0x00100000002e9b2d
- (id)messageBody;	// IMP=0x00100000002e9a29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002e99b3
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x00100000002e98fb
