...
- (void).cxx_destruct;	// IMP=0x0020000000030a24
...
- (id)initWithUser:(id)arg1 phoneSignature:(id)arg2 certificateSigningRequest:(id)arg3 pushToken:(id)arg4;	// IMP=0x0010000000030914
