...
- (void).cxx_destruct;	// IMP=0x0020000000123a2a
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000001237fd
- (id)bagKey;	// IMP=0x00100000001237f0
- (id)requiredKeys;	// IMP=0x00100000001237d7
- (id)messageBody;	// IMP=0x001000000012369b
- (id)additionalMessageHeaders;	// IMP=0x0010000000123593
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001233fc
