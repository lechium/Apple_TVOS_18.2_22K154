...
- (void).cxx_destruct;	// IMP=0x002000000032a3fb
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x0010000000329ec8
...
- (id)initWithServerBag:(id)arg1;	// IMP=0x0010000000329c15
- (id)init;	// IMP=0x0010000000329bb9
