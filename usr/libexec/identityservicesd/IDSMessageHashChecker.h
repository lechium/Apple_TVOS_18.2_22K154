...
- (void).cxx_destruct;	// IMP=0x0020000000158194
...
- (id)_legacyIdentity;	// IMP=0x00100000001580e6
- (_Bool)allowMessageData:(id)arg1 withDelayedCommitBlock:(CDUnknownBlockType *)arg2;	// IMP=0x0010000000157f39
- (_Bool)allowMessageData:(id)arg1;	// IMP=0x0010000000157e28
- (id)initWithRegistrationKeyManager:(id)arg1 messageHashStore:(id)arg2 usePairingKey:(_Bool)arg3;	// IMP=0x0010000000157d85
- (id)initWithRegistrationKeyManager:(id)arg1;	// IMP=0x0010000000157d01
