...
@class IDSPushHandler, IMSystemMonitor, NSSet, NSString;
...
@interface IDSActivityPushListener : NSObject
{
    ...
    _Bool _downgradeOnLock;	// 10 = 0xa
    NSSet *_topicsToListenOn;	// 16 = 0x10
    id <IDSActivityPushListenerDelegate> _delegate;	// 24 = 0x18
    IDSPushHandler *_pushHandler;	// 32 = 0x20
    IMSystemMonitor *_systemMonitor;	// 40 = 0x28
    IDSPushHandler *_persistentEnrollmentHandler;	// 48 = 0x30
    NSObject<OS_dispatch_queue> *_queue;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x002000000015be7f
@property(nonatomic) _Bool downgradeOnLock; // @synthesize downgradeOnLock=_downgradeOnLock;
...
- (void)handler:(id)arg1 didReceiveMessage:(id)arg2 forTopic:(id)arg3 fromID:(id)arg4 messageContext:(id)arg5;	// IMP=0x001000000015bac7
- (void)systemDidUnlock;	// IMP=0x001000000015bab0
- (void)systemDidLock;	// IMP=0x001000000015ba99
- (id)_nonWakingTopics;	// IMP=0x001000000015ba52
- (id)_opportunisticTopics;	// IMP=0x001000000015ba0b
- (void)_configurePushHandler:(_Bool)arg1;	// IMP=0x001000000015b867
- (id)initWithQueue:(id)arg1 shouldDowngradeOnLock:(_Bool)arg2;	// IMP=0x001000000015b6c4
