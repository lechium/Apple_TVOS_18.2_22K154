...
@class IDSCacheClearRequest, IDSKTOptInOutRequest, KTSelfVerificationHealableErrors, NSArray, NSDictionary, NSString;

@protocol IDSXPCKeyTransparency <NSObject>
- (void)getCurrentRegistrationStateWithCompletion:(void (^)(NSArray *))arg1;
- (void)cacheClearRequest:(IDSCacheClearRequest *)arg1;
