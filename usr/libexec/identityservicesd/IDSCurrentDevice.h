...
+ (id)sharedInstance;	// IMP=0x0040000000373a48
- (void).cxx_destruct;	// IMP=0x0020000000373e01
- (void)regenerateDeviceIdentifier;	// IMP=0x0010000000373ce0
@property(readonly, retain, nonatomic) NSString *deviceIdentifier;
- (id)_deviceIdentifierKeychainID;	// IMP=0x0010000000373b11
...
- (id)init;	// IMP=0x0010000000373a9d
