...
- (void).cxx_destruct;	// IMP=0x002000000049bc6c
...
- (void)_sendDataViaNWConnection:(id)arg1 isLargeTransfer:(_Bool)arg2;	// IMP=0x001000000049b904
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x001000000049b3c4
- (double)lastSocketActivityTime;	// IMP=0x001000000049b3b9
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x001000000049ad85
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x001000000049ad71
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x001000000049a694
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x001000000049a682
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x001000000049a1b5
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000049a13c
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x001000000049a0a2
- (void)endSession;	// IMP=0x0010000000499f7b
- (void)dealloc;	// IMP=0x0010000000499ef2
- (void)start;	// IMP=0x0010000000499a30
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x0010000000499860
