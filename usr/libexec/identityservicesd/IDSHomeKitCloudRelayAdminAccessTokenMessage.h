...
- (void).cxx_destruct;	// IMP=0x0020000000344d03
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000344b1f
- (id)bagKey;	// IMP=0x0010000000344b12
- (id)messageBody;	// IMP=0x0010000000344a32
- (id)additionalMessageHeaders;	// IMP=0x00100000003448fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000034475d
