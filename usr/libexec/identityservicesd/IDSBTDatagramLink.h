...
- (void).cxx_destruct;	// IMP=0x002000000000a466
...
- (id)copyLinkStatsDict;	// IMP=0x001000000000a2ad
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x001000000000a036
- (void)_processIncomingPacket;	// IMP=0x001000000000a030
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x001000000000a025
- (unsigned long long)sendPacketBuffer:(CDStruct_90727270 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x001000000000a01d
- (void)start;	// IMP=0x001000000000a017
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)invalidate;	// IMP=0x0010000000009ff7
- (void)dealloc;	// IMP=0x0010000000009fb9
- (id)initWithPipe:(id)arg1 withDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x0010000000009fb0
