...
- (void).cxx_destruct;	// IMP=0x0020000000127a48
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x0010000000126108
- (id)data;	// IMP=0x0010000000125b96
- (id)init;	// IMP=0x0010000000125b67
- (_Bool)_isTinkerFlagSet;	// IMP=0x0010000000125b41
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x0010000000125b1b
- (id)description;	// IMP=0x00100000001259c8
