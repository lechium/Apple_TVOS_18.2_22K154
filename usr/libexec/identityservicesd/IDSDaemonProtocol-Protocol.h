...
- (void)requestVMData:(NSData *)arg1 requestID:(NSString *)arg2;
...
- (void)updateParticipantInfo:(NSData *)arg1 forGroup:(NSString *)arg2 sessionID:(NSString *)arg3;
...
- (void)setQuickRelayUserTypeForSession:(NSString *)arg1 withUserType:(unsigned short)arg2;
- (void)setForceTCPFallbackOnCellUsingReinitiate:(_Bool)arg1 forSessionWithUniqueID:(NSString *)arg2;
- (void)setForceTCPFallbackOnWiFiUsingReinitiate:(_Bool)arg1 forSessionWithUniqueID:(NSString *)arg2;
...
- (void)forceDisableAccount:(NSString *)arg1;
