...
+ (long long)phaseForExpirationDate:(id)arg1;	// IMP=0x004000000010eeaf
- (void).cxx_destruct;	// IMP=0x002000000010eef0
...
- (id)initWithUser:(id)arg1 expirationPhase:(long long)arg2;	// IMP=0x001000000010ed59
- (id)initWithUser:(id)arg1;	// IMP=0x001000000010ecc8
