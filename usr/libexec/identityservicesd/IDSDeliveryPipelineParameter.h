...
- (void).cxx_destruct;	// IMP=0x00200000003b9e0a
...
- (id)description;	// IMP=0x00100000003b9a36
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x00100000003b9a1a
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00100000003b93c0
