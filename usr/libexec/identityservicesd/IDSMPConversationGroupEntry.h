...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x0040000000131c39
- (void).cxx_destruct;	// IMP=0x0020000000132258
...
- (id)description;	// IMP=0x0010000000132057
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x0010000000131e4e
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x0010000000131aa9
