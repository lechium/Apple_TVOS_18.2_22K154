...
@interface IDSBTLELink : NSObject
{
    ...
    CDStruct_90727270 *_incomingPacketBuffer;	// 48 = 0x30
...
- (void).cxx_destruct;	// IMP=0x0020000000123344
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x0010000000123009
- (void)_didReceiveData:(id)arg1;	// IMP=0x00100000001228fa
- (void)didReceiveData:(id)arg1;	// IMP=0x001000000012285b
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x001000000012260a
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00100000001225ff
- (unsigned long long)sendPacketBuffer:(CDStruct_90727270 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000001223b2
- (id)copyLinkStatsDict;	// IMP=0x0010000000122297
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x0010000000122225
- (void)triggerBTCorruptionRecovery;	// IMP=0x0010000000122213
- (void)_localDetectedCorruption;	// IMP=0x001000000012220d
- (void)dealloc;	// IMP=0x00100000001221c2
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000122080
