...
@interface OldIDSDSessionKeyValueDeliveryLocalEntry : NSObject
{
...
- (void).cxx_destruct;	// IMP=0x00200000003422d2
...
- (id)initWithData:(id)arg1 encryption:(unsigned int)arg2 capability:(id)arg3;	// IMP=0x00100000003421d7
