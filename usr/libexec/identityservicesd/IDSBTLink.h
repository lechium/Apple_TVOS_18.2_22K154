...
@interface IDSBTLink : NSObject
{
    ...
    CDStruct_90727270 *_currentIncomingPacket;	// 160 = 0xa0
    CDStruct_90727270 *_currentOutgoingPacket;	// 168 = 0xa8
...
- (void).cxx_destruct;	// IMP=0x00200000004a71d8
...
- (void)injectFakePacket:(CDStruct_90727270 *)arg1;	// IMP=0x00100000004a7019
- (void)suspendLink:(_Bool)arg1;	// IMP=0x00100000004a6df7
- (_Bool)isLinkSuspended;	// IMP=0x00100000004a6deb
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x00100000004a6b74
- (void)_processOutgoingPacket;	// IMP=0x00100000004a671a
- (void)_processIncomingPacket;	// IMP=0x00100000004a4e97
- (long long)_readFromDataChannel:(void *)arg1 size:(unsigned long long)arg2 withFlags:(int)arg3 isSynced:(_Bool *)arg4;	// IMP=0x00100000004a4e8a
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000004a4ba9
- (void)flushBuffer:(unsigned long long)arg1;	// IMP=0x00100000004a4b97
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00100000004a4b8c
- (unsigned long long)sendPacketBuffer:(CDStruct_90727270 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000004a4796
- (void)invalidate;	// IMP=0x00100000004a475d
- (void)remoteDetectedCorruption;	// IMP=0x00100000004a4620
- (void)start;	// IMP=0x00100000004a4581
- (void)triggerBTCorruptionRecovery;	// IMP=0x00100000004a456f
- (void)_submitMagnetCorruptionMetricsToAWD;	// IMP=0x00100000004a431b
- (void)_resetMagnetCorruptionMetrics;	// IMP=0x00100000004a4306
- (void)_dumpLogs:(double)arg1 isDownstream:(_Bool)arg2;	// IMP=0x00100000004a3e43
- (void)_localDetectedCorruption;	// IMP=0x00100000004a3d13
- (void);	// IMP=0x00100000004a3b15
- (id)initWithPipe:(id)arg1 useSkywalkChannel:(_Bool)arg2 withDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x00100000004a34d7
- (id)copyLinkStatsDict;	// IMP=0x00100000004a33bc
