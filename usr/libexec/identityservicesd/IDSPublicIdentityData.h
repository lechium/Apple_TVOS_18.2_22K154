...
- (void).cxx_destruct;	// IMP=0x0020000000302932
@property(readonly, nonatomic) NSNumber *NGMVersion; // @synthesize NGMVersion=_NGMVersion;
- (id)publicNGMPrekeyData;	// IMP=0x001000000030291e
...
- (id)initWithPublicLegacyIdentityData:(id)arg1 publicNGMIdentityData:(id)arg2 publicNGMPrekeyData:(id)arg3 NGMVersion:(id)arg4;	// IMP=0x0010000000302822
