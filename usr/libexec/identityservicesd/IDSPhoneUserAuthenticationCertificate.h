...
- (void).cxx_destruct;	// IMP=0x002000000048ab44
...
- (id)description;	// IMP=0x001000000048aa7a
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x001000000048a9e1
