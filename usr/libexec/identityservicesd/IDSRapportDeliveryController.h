...
+ (id)sharedInstance;	// IMP=0x0020000000123ab0
- (void).cxx_destruct;	// IMP=0x0020000000124a53
...
- (void)rapportClient:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x0010000000124835
- (unsigned int)_nextMessageID;	// IMP=0x0010000000124825
- (void)sendMessage:(id)arg1 messageID:(id)arg2 topic:(id)arg3 command:(id)arg4 destinationIDs:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x0010000000123c2b
- (void)dealloc;	// IMP=0x0010000000123be6
- (id)init;	// IMP=0x0010000000123b8c
- (id)initWithRapportClient:(id)arg1;	// IMP=0x0010000000123b05
