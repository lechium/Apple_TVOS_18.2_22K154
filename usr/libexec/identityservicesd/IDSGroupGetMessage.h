...
- (void).cxx_destruct;	// IMP=0x002000000047b39e
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000047b15c
- (id)bagKey;	// IMP=0x001000000047b14f
- (id)requiredKeys;	// IMP=0x001000000047b136
- (id)messageBody;	// IMP=0x001000000047ae99
- (id)additionalMessageHeaders;	// IMP=0x001000000047ac98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000047aaa5
