...
- (void).cxx_destruct;	// IMP=0x00200000000de516
...
- (id)initWithBroadcastBlock:(CDUnknownBlockType)arg1 needsClientAck:(_Bool)arg2 messageUUID:(id)arg3 priority:(long long)arg4 senderID:(id)arg5 sequenceNumber:(unsigned int)arg6;	// IMP=0x00100000000de337
- (id)init;	// IMP=0x00100000000de2da
