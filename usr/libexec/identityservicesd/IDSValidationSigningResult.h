...
- (void).cxx_destruct;	// IMP=0x0020000000171e41
...
- (id)initWithBaaResult:(id)arg1;	// IMP=0x0000000000171d71
- (id)initWithAbsintheResultData:(id)arg1 absintheServerKey:(id)arg2 absintheError:(id)arg3 baaResult:(id)arg4;	// IMP=0x0010000000171c89
