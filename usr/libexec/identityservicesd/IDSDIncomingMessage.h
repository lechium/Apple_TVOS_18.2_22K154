...
- (void).cxx_destruct;	// IMP=0x002000000038be15
...
- (id)initWithMessage:(id)arg1 fromID:(id)arg2 topic:(id)arg3 guid:(id)arg4 isLocal:(_Bool)arg5;	// IMP=0x001000000038bc42
