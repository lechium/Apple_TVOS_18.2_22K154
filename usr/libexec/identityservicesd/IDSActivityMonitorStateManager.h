...
+ (id)sharedInstance;	// IMP=0x00200000000290da
- (void).cxx_destruct;	// IMP=0x002000000002c100
...
- (void)pushListener:(id)arg1 receivedUpdatePush:(id)arg2;	// IMP=0x001000000002b727
- (void)_updateListener;	// IMP=0x001000000002b583
- (void)_subscribeForInfo:(id)arg1 withDescription:(id)arg2 resolvedTokens:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x001000000002add8
- (void)unsubscribeForActivity:(id)arg1 subActivity:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000002a88b
- (void);	// IMP=0x0010000000029d81
- (void)ackUpdatesForActivity:(id)arg1;	// IMP=0x0010000000029d16
- (id)currentSubscriptionsForActivity:(id)arg1;	// IMP=0x0010000000029c9c
- (void)removeSubscriptionForActivity:(id)arg1 subActivity:(id)arg2;	// IMP=0x0010000000029c11
- (void)storeSubscription:(id)arg1 forActivity:(id)arg2;	// IMP=0x0010000000029b86
- (id)storedUpdatesForActivity:(id)arg1;	// IMP=0x0010000000029af3
- (_Bool)isListeningOnActivity:(id)arg1;	// IMP=0x0010000000029add
- (_Bool)stopListeningOnActivity:(id)arg1;	// IMP=0x0010000000029985
- (_Bool)startListeningOnActivity:(id)arg1;	// IMP=0x001000000002981a
- (void)removeListener:(id)arg1 forActivity:(id)arg2;	// IMP=0x00100000000296e3
- (void)addListener:(id)arg1 forActivity:(id)arg2;	// IMP=0x00100000000295d4
- (void)setup;	// IMP=0x0010000000029554
- (id)initWithStateProvider:(id)arg1 messageDelivery:(id)arg2 peerIDManager:(id)arg3 accountController:(id)arg4 serviceController:(id)arg5 queue:(id)arg6;	// IMP=0x00100000000293c9
- (id)initWithStateProvider:(id)arg1 messageDelivery:(id)arg2 peerIDManager:(id)arg3 accountController:(id)arg4 serviceController:(id)arg5 pushListener:(id)arg6;	// IMP=0x00100000000292a3
