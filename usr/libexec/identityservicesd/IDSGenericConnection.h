...
- (void).cxx_destruct;	// IMP=0x00200000003ca48c
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00100000003c996e
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000003c952d
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00100000003c9394
- (void)invalidate;	// IMP=0x00100000003c8d59
- (void)dealloc;	// IMP=0x00100000003c8cd0
- (void)_closeSockets;	// IMP=0x00100000003c88b9
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000003c85e4
- (id)flagsString;	// IMP=0x00100000003c8534
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000003c8527
- (id)description;	// IMP=0x00100000003c8117
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00100000003c7def
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00100000003c7ad1
