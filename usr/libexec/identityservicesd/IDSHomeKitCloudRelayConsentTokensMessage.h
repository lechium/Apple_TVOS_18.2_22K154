...
- (void).cxx_destruct;	// IMP=0x0020000000389e72
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000389d5b
- (id)bagKey;	// IMP=0x0010000000389d4e
- (id)messageBody;	// IMP=0x0010000000389c2c
- (id)additionalMessageHeaders;	// IMP=0x0010000000389af4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000038998b
