...
- (void).cxx_destruct;	// IMP=0x002000000016c772
...
- (id)debugDescription;	// IMP=0x001000000016c52e
- (id)description;	// IMP=0x001000000016c3f3
- (void)updateLastRatchetedKeyMaterial:(id)arg1 forRemoteParticipant:(unsigned long long)arg2;	// IMP=0x001000000016c356
- (void)noteReceivedFirstKeyMaterial:(id)arg1 forRemoteParticipant:(unsigned long long)arg2;	// IMP=0x001000000016c143
- (void)resetClientMasterKeyIdentifierReceipts;	// IMP=0x001000000016c10a
- (_Bool)hasClientReceivedMasterKeyIdentifier:(id)arg1;	// IMP=0x001000000016c094
- (void)noteClientReceiptOfMasterKeyIdentifier:(id)arg1;	// IMP=0x001000000016bff4
- (void)_startAutomaticCacheResetTimerIfNeeded;	// IMP=0x001000000016bc23
- (_Bool)hasCachedMasterKeyIdentifier:(id)arg1;	// IMP=0x001000000016b94f
- (id)remoteMasterKeyMaterialCollectionToSend;	// IMP=0x001000000016b84e
- (id)cachedMasterKeyMaterialCollection;	// IMP=0x001000000016b6b7
- (id)_groupMasterKeyCollectionToBroadcastForDestinationURI:(id)arg1 shouldIncludePeerKeys:(_Bool)arg2;	// IMP=0x001000000016b1ea
- (id)localMasterKeyCollectionToBroadcastForDestinationURI:(id)arg1;	// IMP=0x001000000016b1d6
- (id)groupMasterKeyCollectionToBroadcastForDestinationURI:(id)arg1;	// IMP=0x001000000016b1bf
- (id)sampleMkMCollectionToBroadcast:(id)arg1;	// IMP=0x001000000016b062
- (void)noteReceivedGroupMasterKeyMaterialCollection:(id)arg1;	// IMP=0x001000000016a708
- (void)cleanUpMasterKeyMaterialUsingPredicate:(id)arg1;	// IMP=0x001000000016a672
- (void)resetRemoteMasterKeyMaterialCacheAndCancelResetInterval;	// IMP=0x001000000016a58e
- (void)resetCacheWithNewMembershipURIs:(id)arg1;	// IMP=0x001000000016a455
- (id)initWithIdentifier:(id)arg1 initialMembershipURIs:(id)arg2 automaticResetInterval:(double)arg3 automaticResetBlock:(CDUnknownBlockType)arg4 queue:(id)arg5;	// IMP=0x001000000016a059
- (id)initWithIdentifier:(id)arg1 initialMembershipURIs:(id)arg2 automaticResetBlock:(CDUnknownBlockType)arg3 queue:(id)arg4;	// IMP=0x001000000016a03c
