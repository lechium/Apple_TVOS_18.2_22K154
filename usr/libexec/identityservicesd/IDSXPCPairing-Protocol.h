...
@class IDSLocalPairingAddPairedDeviceInfo, MISSING_TYPE, NSSet, NSString, NSUUID;
...
- (MISSING_TYPE *)getPairedDevicesWithCompletion: /* Error: Ran out of types for this method. */;
