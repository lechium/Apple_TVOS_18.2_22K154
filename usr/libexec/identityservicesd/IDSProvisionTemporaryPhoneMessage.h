...
- (void).cxx_destruct;	// IMP=0x0020000000166afb
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000001666ed
- (id)additionalMessageHeaders;	// IMP=0x0010000000166562
- (id)messageBody;	// IMP=0x0010000000166363
- (id)requiredKeys;	// IMP=0x001000000016630a
- (id)bagKey;	// IMP=0x00100000001662fd
- (long long)responseCommand;	// IMP=0x00100000001662f2
- (long long)command;	// IMP=0x00100000001662e7
- (_Bool)wantsBinaryPush;	// IMP=0x00100000001662df
- (_Bool)wantsCompressedBody;	// IMP=0x00100000001662d7
- (_Bool)wantsHTTPHeaders;	// IMP=0x00100000001662cf
- (_Bool)wantsBagKey;	// IMP=0x00100000001662c7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000166130
- (void)addPhoneAuthenticationCertificate:(id)arg1 withUserID:(id)arg2;	// IMP=0x001000000016607c
- (id)init;	// IMP=0x0010000000165fb4
