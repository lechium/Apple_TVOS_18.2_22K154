...
- (void).cxx_destruct;	// IMP=0x002000000010eca0
...
- (id)description;	// IMP=0x001000000010ebec
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x001000000010eb47
