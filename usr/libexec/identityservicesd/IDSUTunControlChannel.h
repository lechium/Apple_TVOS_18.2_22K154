...
@class IDSStallDetector, IDSUTunControlChannelIdentityPair, MISSING_TYPE, NSDictionary, NSMutableArray, NSMutableData, NSString;
...
@interface IDSUTunControlChannel : NSObject
{
    ...
    MISSING_TYPE *_grappaHostSessionID;	// 88 = 0x58
...
- (void).cxx_destruct;	// IMP=0x0020000000165d55
...
- (void)resumeOTRNegotiation;	// IMP=0x0010000000165c26
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x0010000000165c20
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000165c18
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000165c12
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000165720
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x001000000016571a
- (void)_destroyFairplayDeviceSession;	// IMP=0x0010000000165714
- (void)_destroyFairplayHostSession;	// IMP=0x001000000016570e
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x0010000000165679
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x0010000000165671
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x0010000000165669
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x0010000000165661
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x0010000000165659
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x0010000000165651
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x0010000000165649
- (void)dealloc;	// IMP=0x001000000016560b
- (void)invalidate;	// IMP=0x00100000001655b6
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x0010000000165551
- (void)sendMessage:(id)arg1;	// IMP=0x00100000001654ec
- (void)_checkSendNewMessage;	// IMP=0x001000000016481f
- (void)_clearChannel;	// IMP=0x00100000001646f1
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x00100000001646c5
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x0010000000164553
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x0010000000164527
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x00100000001639dd
- (void)writeToConnection;	// IMP=0x001000000016332a
- (void)readFromConnection;	// IMP=0x001000000016213d
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x001000000016212f
- (void)simulateDecryptionFailure;	// IMP=0x001000000016209a
- (void)_cleanupConnection;	// IMP=0x0010000000162029
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000161e0b
- (id)description;	// IMP=0x0010000000161d4c
