...
- (void).cxx_destruct;	// IMP=0x0020000000070b17
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000070886
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x00100000000707ed
