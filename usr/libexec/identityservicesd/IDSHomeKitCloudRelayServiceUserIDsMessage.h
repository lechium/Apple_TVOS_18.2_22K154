...
- (void).cxx_destruct;	// IMP=0x00200000004636a7
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000463502
- (id)messageBody;	// IMP=0x0010000000463484
- (id)bagKey;	// IMP=0x0010000000463477
- (id)additionalMessageHeaders;	// IMP=0x0010000000463398
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004632b9
