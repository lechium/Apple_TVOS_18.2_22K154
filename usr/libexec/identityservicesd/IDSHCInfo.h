...
- (void *)remoteContext;	// IMP=0x001000000021401f
- (void *)localContext;	// IMP=0x0010000000214015
- (void)setRemoteContext:(void *)arg1;	// IMP=0x0010000000213ef9
- (void)setLocalContext:(void *)arg1;	// IMP=0x0010000000213ddd
- (void)invalidate;	// IMP=0x0010000000213c7e
