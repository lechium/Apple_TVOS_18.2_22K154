...
- (void).cxx_destruct;	// IMP=0x00200000003b7ee5
...
- (void)purgeData;	// IMP=0x00100000003b7d21
- (void)saveData:(id)arg1 allowBackup:(_Bool)arg2;	// IMP=0x00100000003b7c71
- (id)data;	// IMP=0x00100000003b7c20
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x00100000003b79fd
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000003b7966
