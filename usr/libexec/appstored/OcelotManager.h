...
- (void).cxx_destruct;	// IMP=0x00200000001ad66e
- (void)_handleRepairBundleIDNotification:(id)arg1;	// IMP=0x00100000001abb47
- (void)_handleNetworkStateDidChangeNotification:(id)arg1;	// IMP=0x00100000001ab292
- (void)decorateMetricsEvent:(id)arg1 context:(id)arg2;	// IMP=0x00100000001a9a34
- (id)createMetricsEventsForEventType:(unsigned char)arg1 context:(id)arg2;	// IMP=0x00100000001a96ce
- (id)init;	// IMP=0x00100000001a346a
