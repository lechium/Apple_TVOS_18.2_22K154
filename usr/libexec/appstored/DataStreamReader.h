...
- (void).cxx_destruct;	// IMP=0x00200000001af1e8
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00100000001af11f
- (void)close;	// IMP=0x00100000001af0d5
