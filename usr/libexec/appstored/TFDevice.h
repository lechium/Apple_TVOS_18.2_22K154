...
- (void).cxx_destruct;	// IMP=0x00200000001d3492
- (unsigned long long)hash;	// IMP=0x00100000001d32f3
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d3062
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d2e2b
- (void)writeTo:(id)arg1;	// IMP=0x00100000001d2ba5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001d2b98
- (id)dictionaryRepresentation;	// IMP=0x00100000001d22db
- (id)description;	// IMP=0x00100000001d222c
