...
- (void).cxx_destruct;	// IMP=0x002000000016df52
- (unsigned long long)hash;	// IMP=0x001000000016db06
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016d4c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016ce85
- (void)writeTo:(id)arg1;	// IMP=0x001000000016c99d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000016c990
- (id)dictionaryRepresentation;	// IMP=0x001000000016b7c3
- (id)description;	// IMP=0x001000000016b714
