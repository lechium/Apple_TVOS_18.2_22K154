...
- (void).cxx_destruct;	// IMP=0x0020000000148ae3
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x001000000014844f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000014835d
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x00100000001482b8
