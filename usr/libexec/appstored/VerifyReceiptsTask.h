...
@class ApplicationProxy, MISSING_TYPE, NSArray, NSDate, NSDictionary, NSMutableDictionary;
...
@interface VerifyReceiptsTask
{
    ...
    MISSING_TYPE *_logKey;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x002000000014d772
- (void)main;	// IMP=0x001000000014bb34
- (id)init;	// IMP=0x001000000014ba89
