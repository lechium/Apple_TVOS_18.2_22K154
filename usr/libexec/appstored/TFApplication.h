...
- (void).cxx_destruct;	// IMP=0x002000000023061f
- (unsigned long long)hash;	// IMP=0x00100000002304c5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002302be
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000023012e
- (void)writeTo:(id)arg1;	// IMP=0x001000000022ff91
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000022ff84
- (id)dictionaryRepresentation;	// IMP=0x001000000022f8ca
- (id)description;	// IMP=0x001000000022f81b
