...
@class ASDRepairOptions, ApplicationProxy, MISSING_TYPE, NSArray, NSString, TaskQueue, _TtC9appstored6LogKey;
...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x00200000000be77b
- (void).cxx_destruct;	// IMP=0x00200000000bee86
@property(retain, nonatomic) _TtC9appstored6LogKey *logKey; // @synthesize logKey=_logKey;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000be92b
...
- (id)init;	// IMP=0x00100000000be4f2
