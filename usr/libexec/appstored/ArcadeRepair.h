...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x00200000000a52e5
- (void).cxx_destruct;	// IMP=0x00200000000a54f3
@property(nonatomic) __weak id <ApplicationRepairDelegate> delegate; // @synthesize delegate=_delegate;
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000a52ed
