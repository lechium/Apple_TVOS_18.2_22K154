...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logKey:(id)arg3;	// IMP=0x002000000007f9f3
- (void).cxx_destruct;	// IMP=0x002000000007fb12
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x001000000007f9fb
...
- (id)init;	// IMP=0x001000000007f357
