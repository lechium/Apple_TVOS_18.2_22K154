...
- (void).cxx_destruct;	// IMP=0x00200000001a29e1
...
- (void)updateLogKey;	// IMP=0x00100000001a2819
@property(readonly, getter=isUserInitiated) _Bool userInitiated;
- (void)updateGeneratedProperties;	// IMP=0x00100000001a23f3
@property(readonly) id <RequestPresenter> requestPresenter;
- (id)init;	// IMP=0x00100000001a22b8
