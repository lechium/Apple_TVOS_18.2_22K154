...
@interface ODRApplication : NSObject
{
    ...
    MISSING_TYPE *_machineVPP;	// 73 = 0x49
...
- (void).cxx_destruct;	// IMP=0x00200000001df889
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001df140
- (unsigned long long)hash;	// IMP=0x00100000001df020
- (id)description;	// IMP=0x00100000001deeba
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001dedd8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001debc6
