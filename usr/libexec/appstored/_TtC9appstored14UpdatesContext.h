...
@class MISSING_TYPE, NSNumber, NSString, XPCRequestToken, _TtC9appstored6LogKey;
...
@interface _TtC9appstored14UpdatesContext : NSObject
{
    ...
    MISSING_TYPE *targetedItemID;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x00400000000528c0
@property(nonatomic, readonly) NSString *humanReadableReason;
@property(nonatomic, readonly) CDUnknownBlockType callbackHandler;
- (id)initWithReason:(long long)arg1 requestToken:(id)arg2 logKey:(id)arg3 callbackHandler:(CDUnknownBlockType)arg4 includeMetrics:(_Bool)arg5 isVPPLookup:(_Bool)arg6 userInitiated:(_Bool)arg7 targetedItemID:(id)arg8;	// IMP=0x00100000000524d0
- (id)initWithReason:(long long)arg1;	// IMP=0x0010000000052400
- (id)init;	// IMP=0x0010000000052390
@property(nonatomic, readonly) NSNumber *bridgedTargetedItemID;
