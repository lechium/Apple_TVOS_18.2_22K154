...
- (void)main;	// IMP=0x00100000000b92bf
- (void)completeWithError:(id)arg1;	// IMP=0x00100000000b926a
- (void)completeWithSuccess;	// IMP=0x00100000000b9125
@property(readonly, nonatomic) NSArray *jobResults;
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000b81e4
