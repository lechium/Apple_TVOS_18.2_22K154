...
- (void).cxx_destruct;	// IMP=0x00200000000fae68
- (void)repair:(id)arg1 needsToReleaseBlockingCallerWithReason:(id)arg2;	// IMP=0x00100000000fadd1
- (void)repair:(id)arg1 wantsToRelaunchApplication:(id)arg2;	// IMP=0x00100000000fabac
- (void)main;	// IMP=0x00100000000fa37a
