...
@class ACAccount, IXApplicationIdentity, LSApplicationRecord, MIStoreMetadata, NSArray, NSData, NSNumber, NSString, NSURL, Optional;
...
@interface ApplicationProxy : NSObject
{
    ...
    unsigned long long _updateAvailability;	// 248 = 0xf8
    NSString *_companionBundleID;	// 256 = 0x100
}

+ (void)enumerateApplicationsOfType:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00400000001fc856
+ (id)proxyForBundleURL:(id)arg1;	// IMP=0x00100000001fb203
+ (id)proxyForItemID:(id)arg1;	// IMP=0x00100000001faff8
+ (id)proxyForBundleID:(id)arg1;	// IMP=0x00100000001fafab
+ (id)proxyForBundle:(id)arg1;	// IMP=0x00100000001faf5e
+ (id)proxyMatchingBundleID:(id)arg1 orItemID:(id)arg2;	// IMP=0x00100000001fa666
- (void).cxx_destruct;	// IMP=0x00200000001fcecb
...
- (void)setParentApplicationBundleID:(id)arg1;	// IMP=0x00100000001fcd25
...
- (id)description;	// IMP=0x00100000001fcbb1
- (id)validLocationProxy;	// IMP=0x00100000001fcba8
...
- (id)parentApplicationBundleID;	// IMP=0x00100000001fbd4f
@property(readonly) _Bool isManagedAccount;
@property(readonly) NSString *shortDescription;
- (id)initWithBundleURL:(id)arg1;	// IMP=0x00100000001fb6c8
- (id)initWithBundlePath:(id)arg1;	// IMP=0x00100000001fb66e
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000001fb45c
- (id)initWithBundle:(id)arg1;	// IMP=0x00100000001fb406
- (id)initWithItemID:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001fade1
- (id)initWithBundleURL:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00100000001fac51
- (_Bool)validateEligibilityForUpdatesWithLogKey:(id)arg1;	// IMP=0x00100000001fa9f3
- (id)initWithBundleID:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00100000001fa801
