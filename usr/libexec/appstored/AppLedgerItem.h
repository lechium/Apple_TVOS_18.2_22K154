...
- (void).cxx_destruct;	// IMP=0x00200000001e2ea1
@property(readonly, nonatomic) NSNumber *itemID; // @synthesize itemID=_itemID;
@property(readonly, nonatomic) NSString *bundleIdentifier; // @synthesize bundleIdentifier=_bundleIdentifier;
- (id)lastUserInitiatedInstall;	// IMP=0x00100000001e2d3b
@property(readonly, nonatomic) NSArray *installs;
- (void)addInstall:(id)arg1;	// IMP=0x00100000001e2d07
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000001e2455
- (id)initWithBundleID:(id)arg1 itemID:(id)arg2;	// IMP=0x00100000001e2374
