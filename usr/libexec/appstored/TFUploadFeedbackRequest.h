...
- (void).cxx_destruct;	// IMP=0x00200000001861f9
- (unsigned long long)hash;	// IMP=0x00100000001860fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000185f69
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000185e1e
- (void)writeTo:(id)arg1;	// IMP=0x0010000000185cbc
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018587b
- (id)dictionaryRepresentation;	// IMP=0x00100000001855fd
- (id)description;	// IMP=0x001000000018554e
