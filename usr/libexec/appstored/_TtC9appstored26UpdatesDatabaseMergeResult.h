...
- (id)init;	// IMP=0x0010000000006360
- (id)initWithAvailableUpdateCount:(long long)arg1 shouldNotifyOfChanges:(_Bool)arg2 bundleIDs:(id)arg3 result:(_Bool)arg4;	// IMP=0x00100000000062e0
