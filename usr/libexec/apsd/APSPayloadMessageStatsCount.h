...
- (void).cxx_destruct;	// IMP=0x0020000000087f30
...
- (unsigned long long)sumOfBucketType:(unsigned char)arg1;	// IMP=0x0010000000087eb9
- (void)countTopic:(id)arg1 now:(double)arg2;	// IMP=0x0010000000087e53
- (void)shiftBucketsBasedOnNow:(double)arg1;	// IMP=0x0010000000087d71
- (void)dealloc;	// IMP=0x0010000000087d32
- (id)init;	// IMP=0x0010000000087ca9
