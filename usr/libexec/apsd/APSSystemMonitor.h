...
+ (id)sharedInstance;	// IMP=0x00400000000c3204
- (void).cxx_destruct;	// IMP=0x00200000000c3ad2
...
- (void)removeListener:(id)arg1;	// IMP=0x00100000000c39fa
- (void)addListener:(id)arg1;	// IMP=0x00100000000c3966
- (void)_setSystemLockState:(_Bool)arg1;	// IMP=0x00100000000c3820
- (void)_setSystemScreenState:(_Bool)arg1;	// IMP=0x00100000000c36da
- (void)_systemWillSleep;	// IMP=0x00100000000c363d
- (void)_systemDidWake;	// IMP=0x00100000000c3620
- (void)_deliverNotificationSelector:(SEL)arg1;	// IMP=0x00100000000c356f
- (void)dealloc;	// IMP=0x00100000000c32c3
- (id)init;	// IMP=0x00100000000c3259
