...
- (void).cxx_destruct;	// IMP=0x0020000000003877
...
- (id)initWithDNSTask:(id)arg1 messageId:(unsigned long long)arg2 taskId:(unsigned long long)arg3 taskStatus:(unsigned long long)arg4;	// IMP=0x001000000000376c
- (id)initWithDNSTask:(id)arg1;	// IMP=0x00100000000036f9
