...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x004000000007b3e6
+ (void)loadConfigurationForEnvironment:(id)arg1 connectionType:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000007b0ab
+ (id)configurationForEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x001000000007ae9c
+ (id)_onQueue_configurationForEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x001000000007abf2
+ (void)initialize;	// IMP=0x001000000007ab9b
- (void).cxx_destruct;	// IMP=0x002000000007cec7
...
- (void)setHasValidSignature:(_Bool)arg1;	// IMP=0x001000000007ceaa
- (_Bool)hasValidSignature;	// IMP=0x001000000007cea1
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000007cc7e
- (_Bool)_isExpired;	// IMP=0x001000000007cc20
- (_Bool)_isLoaded;	// IMP=0x001000000007cc17
...
- (id)bagExpiryInterval;	// IMP=0x001000000007caf5
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x001000000007c999
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x001000000007c208
- (void)_failWithError:(id)arg1;	// IMP=0x001000000007c0e2
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x001000000007be7c
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000007bd21
- (id)pendingCompletionBocks;	// IMP=0x001000000007bd13
- (void)dealloc;	// IMP=0x001000000007bcd4
- (id)initWithEnvironment:(id)arg1 connectionType:(long long)arg2;	// IMP=0x001000000007b6a5
