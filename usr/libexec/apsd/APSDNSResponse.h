...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000020ee1
- (void).cxx_destruct;	// IMP=0x002000000002112c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002108d
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000020ee9
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x0010000000020dce
