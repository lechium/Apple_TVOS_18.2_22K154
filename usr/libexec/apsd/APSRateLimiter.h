...
- (id)description;	// IMP=0x0010000000043503
- (_Bool)isUnset;	// IMP=0x00100000000434e6
- (void)clear;	// IMP=0x00100000000434ca
- (_Bool)isUnderLimit;	// IMP=0x00100000000434a0
- (void)note;	// IMP=0x0010000000043451
- (_Bool)_checkIsExpired;	// IMP=0x00100000000433e3
- (id)initWithLimit:(long long)arg1 timeLimit:(double)arg2;	// IMP=0x0010000000043397
