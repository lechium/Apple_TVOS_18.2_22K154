...
- (void).cxx_destruct;	// IMP=0x002000000005bc51
...
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5 hwVersion:(id)arg6 swVersion:(id)arg7 swBuild:(id)arg8;	// IMP=0x001000000005b92e
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 delayedResponseInterval:(int)arg3 usingServerStats:(_Bool)arg4 keepAliveState:(id)arg5;	// IMP=0x001000000005b8fa
- (id)initWithUsingWWAN:(_Bool)arg1 keepAliveInterval:(int)arg2 keepAliveState:(id)arg3;	// IMP=0x001000000005b8d5
