...
- (void).cxx_destruct;	// IMP=0x0020000000043c64
...
- (void)_clearState;	// IMP=0x0010000000043b1c
- (void)_fireMetricIfNeeded;	// IMP=0x00100000000439f2
- (void)_timerFired:(id)arg1;	// IMP=0x00100000000439c1
- (void)noteReceivedLiveMessage;	// IMP=0x00100000000439af
- (void)noteSystemWillSleep;	// IMP=0x001000000004399d
- (void)noteReceivedStoredMessage;	// IMP=0x001000000004394d
- (void)noteDidConnect;	// IMP=0x00100000000438dd
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x001000000004382e
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000043726
- (id)init;	// IMP=0x00100000000435e7
