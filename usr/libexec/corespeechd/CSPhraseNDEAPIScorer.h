...
- (void).cxx_destruct;	// IMP=0x0020000000100d57
...
- (id)_rtModelFromAsset:(id)arg1 requestOptions:(id)arg2 forSiriLanguage:(id)arg3 withPhraseCount:(unsigned long long)arg4;	// IMP=0x0010000000100b54
- (void)keywordAnalyzerNDEAPI:(id)arg1 hasResultAvailable:(id)arg2 forChannel:(unsigned long long)arg3;	// IMP=0x0010000000100980
- (double)currentShadowMicScore;	// IMP=0x001000000010094d
- (void)processAudioChunk:(id)arg1 activeChannel:(unsigned long long)arg2;	// IMP=0x001000000010076a
- (void)reset;	// IMP=0x0010000000100750
- (id)initWithAsset:(id)arg1 assetConfig:(id)arg2 firstPassSource:(unsigned long long)arg3 activeChannel:(unsigned long long)arg4 siriLanguage:(id)arg5 shouldEnableShadowMicScore:(_Bool)arg6 rtmodelRequestOptions:(id)arg7;	// IMP=0x00100000001004b9
