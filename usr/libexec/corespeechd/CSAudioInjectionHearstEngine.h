...
- (void).cxx_destruct;	// IMP=0x00200000000d8dee
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000d8c8a
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 isFileLoadedBuffer:(_Bool)arg6;	// IMP=0x00100000000d8bd2
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000d8bcc
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000d8bc6
- (void)stopAudioStream;	// IMP=0x00100000000d8b74
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000d8b22
- (_Bool)isRecording;	// IMP=0x00100000000d8a8d
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d8a5e
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000d8a2f
- (void)stop;	// IMP=0x00100000000d89dd
- (void)start;	// IMP=0x00100000000d898b
- (void)dealloc;	// IMP=0x00100000000d88d1
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000d87df
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000d874a
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000d86f5
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000d86ed
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000d8583
