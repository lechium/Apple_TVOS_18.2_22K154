...
- (void).cxx_destruct;	// IMP=0x00200000000b102d
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000b0fae
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000b0fa8
- (void)stop;	// IMP=0x00100000000b0fa2
- (void)pause;	// IMP=0x00100000000b0f9c
- (void)start;	// IMP=0x00100000000b0f96
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000b0f88
