...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000d68fc
+ (id)optionForJarvisAnnounceMessageWithDeviceId:(id)arg1;	// IMP=0x00100000000d68f4
+ (id)optionForFlexibleFollowupWithAudioRecordType:(long long)arg1 deviceId:(id)arg2;	// IMP=0x00100000000d684c
- (void).cxx_destruct;	// IMP=0x00200000000d683c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000d6388
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000d5eda
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d5ecf
- (id)description;	// IMP=0x00100000000d5ca5
- (id)copyWithRecordType:(long long)arg1;	// IMP=0x00100000000d5b16
...
- (id)initWithAttendingType:(long long)arg1;	// IMP=0x00100000000d5929
