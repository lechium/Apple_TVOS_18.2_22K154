...
- (void).cxx_destruct;	// IMP=0x00200000000a3ca6
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x00100000000a360b
- (void)processRCFeatures:(id)arg1;	// IMP=0x00100000000a357b
- (_Bool)_useEnhancedEndpointer;	// IMP=0x00100000000a3554
- (_Bool)_shouldProvideTwoShotFeedbackWithRecordContext;	// IMP=0x00100000000a34f3
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x00100000000a321d
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x00100000000a3217
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x00100000000a3187
@property(readonly, nonatomic) double lastStartOfVoiceActivityTime;
- (double)lastEndOfVoiceActivityTime;	// IMP=0x00100000000a3175
- (void)reset;	// IMP=0x00100000000a316f
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00100000000a30c5
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2 disableRCSelection:(_Bool)arg3;	// IMP=0x00100000000a2cac
- (void)stopEndpointer;	// IMP=0x00100000000a2c16
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00100000000a2b6e
- (void)terminateProcessing;	// IMP=0x00100000000a2aa7
- (void)preheat;	// IMP=0x00100000000a2aa1
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x00100000000a2a10
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x00100000000a2956
- (void)_generateEndpointerFeaturesWithEffectiveClientProcessedAudioMs:(double)arg1 osdFeatures:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000a1eb7
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2 withMHID:(id)arg3;	// IMP=0x00100000000a16e6
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x00100000000a1642
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3 audioDeliveryHostTimeDelta:(unsigned long long)arg4;	// IMP=0x00100000000a15e3
- (void)_shouldAcceptEagerResultForDuration:(double)arg1 asrFeatures:(id)arg2 lastReportedEndpointTimeMs:(double)arg3 osdFeatures:(id)arg4 resultsCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x00100000000a0f38
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000a0df7
- (void)shouldAcceptEagerResultForDuration:(double)arg1 withEndpointerMetrics:(id)arg2 resultsCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000a0caa
- (_Bool)shouldAcceptEagerResultForDurationSync:(double)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x00100000000a0b20
- (void)_swapEnhancedEndpointerModelForTaskString:(id)arg1;	// IMP=0x00100000000a0846
- (void)_processEnhancedEndpointerTaskString:(id)arg1;	// IMP=0x00100000000a04fb
- (void)processTaskString:(id)arg1;	// IMP=0x00100000000a046b
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x00100000000a023b
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x00100000000a01ac
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x001000000009fff3
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x001000000009fef9
- (void)updateEnhancedEndpointerDefaultThresholdPartial:(float)arg1 defaultThresholdRC:(float)arg2 relaxedThresholdPartial:(float)arg3 relaxedThresholdRC:(float)arg4;	// IMP=0x001000000009fe08
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x001000000009fdb5
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000009fdaf
- (void)_updateCurrentAsset:(id)arg1;	// IMP=0x001000000009fc93
- (id)_getSerialQueueWithName:(id)arg1 targetQueue:(id)arg2;	// IMP=0x001000000009fba3
- (id)init;	// IMP=0x001000000009f71b
