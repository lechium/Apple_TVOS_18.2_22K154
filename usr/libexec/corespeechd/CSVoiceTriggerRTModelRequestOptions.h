...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008791e
- (void).cxx_destruct;	// IMP=0x00200000000871b6
...
- (id)description;	// IMP=0x0010000000087112
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000087028
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000086d57
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000086ca1
- (id)initWithCSRTModelRequestOptions:(id)arg1 builder:(CDUnknownBlockType)arg2;	// IMP=0x0010000000086bd8
- (id)initWithMutableBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0010000000086a3c
