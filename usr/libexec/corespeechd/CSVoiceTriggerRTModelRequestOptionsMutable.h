...
- (void).cxx_destruct;	// IMP=0x00200000000878b4
...
- (void)setUserSelectedPhraseType:(id)arg1;	// IMP=0x00100000000877fd
- (void)setCSCoreSpeechServicesAccessoryInfo:(id)arg1;	// IMP=0x00100000000877d0
- (void)setSiriLocale:(id)arg1;	// IMP=0x00100000000877bf
- (void)setAccessoryModelType:(id)arg1;	// IMP=0x00100000000877ae
- (void)setEngineMinorVersion:(id)arg1;	// IMP=0x001000000008779d
- (void)setEngineMajorVersion:(id)arg1;	// IMP=0x001000000008778c
- (void)setEndpointId:(id)arg1;	// IMP=0x001000000008777b
- (void)setAllowMph:(_Bool)arg1;	// IMP=0x0010000000087772
