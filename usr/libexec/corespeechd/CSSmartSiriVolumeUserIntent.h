...
- (double)applyLowerAndUpperBoundsToVolumeOffset:(float)arg1;	// IMP=0x00100000000dac28
- (void)storeASVStateInformation;	// IMP=0x00100000000dabd5
- (float)decreaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000dabb4
- (float)increaseSiriVolumeBasedOnUserIntent;	// IMP=0x00100000000dab93
- (void)initWithStoredInformationAndAsset:(id)arg1;	// IMP=0x00100000000daa50
- (double)applyLowerAndUpperBoundsToVolume:(float)arg1;	// IMP=0x00100000000da948
