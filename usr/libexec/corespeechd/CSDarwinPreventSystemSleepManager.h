...
- (void).cxx_destruct;	// IMP=0x00200000001082ec
...
- (void)dealloc;	// IMP=0x0010000000108259
- (void)acquireAssertionForIdleUser;	// IMP=0x0010000000107f4c
- (void)acquireAssertionForActiveUser;	// IMP=0x0010000000107e71
- (void)acquireAssertion;	// IMP=0x0010000000107e19
- (void)releasePreventSystemSleepAssertion;	// IMP=0x0010000000107de7
- (void)_acquirePreventSystemSleepAssertionWithTimeout:(id)arg1;	// IMP=0x0010000000107cd0
- (id)initWithTimeout:(double)arg1;	// IMP=0x0010000000107c6c
- (id)initWithTimeout:(double)arg1 preferences:(id)arg2;	// IMP=0x0010000000107bf1
