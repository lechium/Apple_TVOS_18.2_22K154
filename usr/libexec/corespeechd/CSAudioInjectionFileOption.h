...
- (void).cxx_destruct;	// IMP=0x0020000000018d58
...
- (id)description;	// IMP=0x0010000000018cbb
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0010000000018c1a
