...
@interface CSASRFeatures : NSObject
{
    ...
    double _acousticEndpointerScore;	// 56 = 0x38
    NSString *_taskName;	// 64 = 0x40
}

+ (id)initialResultCandidateFeatures;	// IMP=0x0040000000009a2a
+ (id)initialASRFeatures;	// IMP=0x00100000000099d3
- (void).cxx_destruct;	// IMP=0x00200000000099ab
...
- (id)dictionary;	// IMP=0x00100000000096e4
- (id)description;	// IMP=0x001000000000962e
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7 acousticEndpointerScore:(double)arg8;	// IMP=0x001000000000954a
