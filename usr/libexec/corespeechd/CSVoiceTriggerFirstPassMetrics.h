...
+ (id)CSVoiceTriggerFirstPassMetricsWithFirstPassInfoGeneratedTime:(unsigned long long)arg1 firstPassInfoProcessedTime:(unsigned long long)arg2;	// IMP=0x004000000008d5b2
- (void).cxx_destruct;	// IMP=0x002000000008d58a
...
- (id)_initWithFirstPassInfoGeneratedTime:(unsigned long long)arg1 firstPassInfoProcessedTime:(unsigned long long)arg2;	// IMP=0x001000000008d4c9
