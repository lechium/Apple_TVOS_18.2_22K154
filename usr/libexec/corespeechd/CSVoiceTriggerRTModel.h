...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000004583c
- (void).cxx_destruct;	// IMP=0x00200000000457e8
...
- (id)description;	// IMP=0x0010000000045635
- (id)builtInRTModelDictionary;	// IMP=0x00100000000454fb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000045418
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000045326
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000450d0
- (id)initWithData:(id)arg1 hash:(id)arg2 locale:(id)arg3;	// IMP=0x0010000000045018
- (id)initWithHash:(id)arg1 locale:(id)arg2;	// IMP=0x0010000000044f7f
- (id)initWithData:(id)arg1 hash:(id)arg2 locale:(id)arg3 digest:(id)arg4 signature:(id)arg5 certificate:(id)arg6;	// IMP=0x0010000000044e58
