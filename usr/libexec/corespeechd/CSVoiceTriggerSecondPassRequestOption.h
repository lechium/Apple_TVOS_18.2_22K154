...
- (void).cxx_destruct;	// IMP=0x00200000000a9d41
...
- (id)initWithFirstPassSource:(unsigned long long)arg1 deviceId:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 rejectionMHUUID:(id)arg5 isSecondChanceRun:(_Bool)arg6 firstpassMetrics:(id)arg7 rtModelRequestOptions:(id)arg8;	// IMP=0x00100000000a9b9e
