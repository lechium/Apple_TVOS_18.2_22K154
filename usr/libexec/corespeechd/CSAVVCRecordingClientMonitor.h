...
+ (id)sharedInstance;	// IMP=0x00400000000d9f73
...
- (void)_stopMonitoring;	// IMP=0x00100000000d9f5c
- (void)_startMonitoringWithQueue:(id)arg1;	// IMP=0x00100000000d9f56
- (id)init;	// IMP=0x00100000000d9f1c
