...
- (void).cxx_destruct;	// IMP=0x00200000000409d6
...
- (void)_reportUserSpeakingContext;	// IMP=0x00100000000408a1
- (void)_emitEndpointDelayMessage:(double)arg1 epdModel:(double)arg2 speakingStart:(double)arg3 speakingEnd:(double)arg4 epdV2:(double)arg5;	// IMP=0x0010000000040796
- (void)instrumentEndpointSignpostsForServerEndpointWithEndTime:(double)arg1 leadingSilence:(double)arg2 trailingSilence:(double)arg3 stopRecordingMachContinuousTime:(unsigned long long)arg4 skippedSamplesTimeInSec:(double)arg5 firstAudioSampleSensorHostTime:(unsigned long long)arg6;	// IMP=0x00100000000405da
- (void)reportEndpointDelayIfNeed;	// IMP=0x00100000000405d4
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x001000000004030d
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2 withTrpId:(id)arg3;	// IMP=0x0010000000040286
- (unsigned long long)estimatedUserSpeakingEndedHostTime;	// IMP=0x0010000000040174
- (unsigned long long)estimatedUserSpeakingStartedHostTime;	// IMP=0x0010000000040068
- (void)reset;	// IMP=0x001000000003ffb7
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2 withMedocEnabled:(_Bool)arg3;	// IMP=0x001000000003fe3a
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2;	// IMP=0x001000000003fe25
