...
+ (_Bool)supportAttentionLostAndGain;	// IMP=0x00200000000ef22d
- (void).cxx_destruct;	// IMP=0x00200000000ef2bf
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000ef25b
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000ef255
- (void)stop;	// IMP=0x00100000000ef24f
- (void)pause;	// IMP=0x00100000000ef249
- (void)start;	// IMP=0x00100000000ef243
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000ef235
