...
- (void).cxx_destruct;	// IMP=0x00200000000dfc3f
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x00100000000df706
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x00100000000df626
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x00100000000df524
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000000df3b0
