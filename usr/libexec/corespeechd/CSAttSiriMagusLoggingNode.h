...
- (void).cxx_destruct;	// IMP=0x00200000000601af
...
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000060115
- (void)addReceiver:(id)arg1;	// IMP=0x001000000006010f
- (void)stop;	// IMP=0x0010000000060109
- (void)pause;	// IMP=0x0010000000060103
- (void)start;	// IMP=0x00100000000600fd
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000600ef
