...
- (void).cxx_destruct;	// IMP=0x00200000000fadfc
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000fac98
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5 isFileLoadedBuffer:(_Bool)arg6;	// IMP=0x00100000000fabe0
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000fabda
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000fabd4
- (void)stopAudioStream;	// IMP=0x00100000000fab82
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000fab30
- (_Bool)isRecording;	// IMP=0x00100000000faa9b
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000faa6c
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000faa3d
- (void)stop;	// IMP=0x00100000000fa9eb
- (void)start;	// IMP=0x00100000000fa999
- (void)dealloc;	// IMP=0x00100000000fa8df
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000fa7ed
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000fa758
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000fa703
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000fa6fb
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000fa593
