...
- (void).cxx_destruct;	// IMP=0x00200000000f3968
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x00100000000f38bf
- (void)report;	// IMP=0x00100000000f3627
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x00100000000f3379
- (id)initWithRequestMHUUID:(id)arg1;	// IMP=0x00100000000f328d
