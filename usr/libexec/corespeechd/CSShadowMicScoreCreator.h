...
- (void).cxx_destruct;	// IMP=0x00200000000d58e8
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x00100000000d55d8
- (void)_calculateSpeechVoicingLevel;	// IMP=0x00100000000d5345
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x00100000000d5300
- (void)calculateShadowMicScore;	// IMP=0x00100000000d4edd
- (void)addDataToBuffer:(id)arg1;	// IMP=0x00100000000d4ec7
- (id)init;	// IMP=0x00100000000d4e40
