...
- (void).cxx_destruct;	// IMP=0x0020000000049ffd
...
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2 disableRCSelection:(_Bool)arg3;	// IMP=0x0010000000049e76
- (void)stopEndpointer;	// IMP=0x0010000000049df7
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x0010000000049d78
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x0010000000049cf9
- (void)reset;	// IMP=0x0010000000049c7a
- (void)preheat;	// IMP=0x0010000000049bfb
- (id)init;	// IMP=0x0010000000049b44
