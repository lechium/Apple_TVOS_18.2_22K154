...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0010000000044a52
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x00100000000449ee
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x001000000004499c
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000044938
+ (_Bool)supportsMultiPhraseVoiceTriggerForEngineVersion:(id)arg1 engineMinorVersion:(id)arg2 accessoryRTModelType:(id)arg3;	// IMP=0x001000000004f174
@property(readonly, nonatomic) NSDictionary *SSVParameterDirectionary;
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x0010000000043e4b
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000040a09
- (id)_userSelectedPhraseTypeToRTModelPhraseType:(id)arg1;	// IMP=0x001000000004ee4b
- (_Bool)_allowMultiPhrase:(id)arg1 forceSkipEngineVersionCheck:(_Bool)arg2;	// IMP=0x001000000004ec8e
- (id)_rtModelWithRequestOptions:(id)arg1 accessoryBlobs:(id)arg2;	// IMP=0x001000000004e9a2
- (id)_getFilteredAccessoryRTBlobListForRequestOptions:(id)arg1 accessoryBlobs:(id)arg2 forceSkipEngineVersionCheck:(_Bool)arg3;	// IMP=0x001000000004e7a5
- (id)_splitBlobsByPhraseType:(id)arg1;	// IMP=0x001000000004e3a6
- (id)_buildRTModelWithBlobConfig:(id)arg1 requestOptions:(id)arg2;	// IMP=0x001000000004dd7e
- (id)_sha256:(id)arg1;	// IMP=0x001000000004dcc6
- (id)_sha1:(id)arg1;	// IMP=0x001000000004dbdb
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004d9da
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004d9a6
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004d98d
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004d974
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004d95b
- (id)hearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000004d949
- (id)rtModelWithRequestOptions:(id)arg1;	// IMP=0x001000000004d754
- (id)latestHearstRTModelWithRequestOptions:(id)arg1;	// IMP=0x001000000004d27d
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004d217
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004d18e
...
- (long long)multiUserDeltaScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087f39
@property(readonly, nonatomic) long long multiUserConfidentScoreThreshold;
- (long long)multiUserConfidentScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087dfd
@property(readonly, nonatomic) long long multiUserHighScoreThreshold;
- (long long)multiUserHighScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087cc1
@property(readonly, nonatomic) long long multiUserLowScoreThreshold;
- (long long)multiUserLowScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087b85
@property(readonly, nonatomic) float satScoreThreshold;
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000087a4f
- (id)getPhraseConfig:(unsigned long long)arg1;	// IMP=0x001000000008793f
