...
- (void).cxx_destruct;	// IMP=0x00200000000511fb
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x0010000000050ce2
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x0010000000050cdc
- (_Bool)_shouldReportBoron;	// IMP=0x0010000000050ca4
- (_Bool)_popRemoteVADSignal;	// IMP=0x0010000000050c25
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x0010000000050b9f
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x00100000000507ec
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectedly:(long long)arg2;	// IMP=0x001000000005073d
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000050726
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000050523
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000050091
- (void)_resetAlignBuffer;	// IMP=0x0010000000050068
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000004fb7f
- (id)init;	// IMP=0x001000000004fa5b
