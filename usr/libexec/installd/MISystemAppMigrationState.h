...
+ (id)defaultManager;	// IMP=0x00400000000501f0
- (void).cxx_destruct;	// IMP=0x00200000000507f9
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x00100000000505ac
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x00100000000500b2
