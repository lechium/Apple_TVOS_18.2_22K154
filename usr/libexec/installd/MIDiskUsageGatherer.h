...
- (void).cxx_destruct;	// IMP=0x002000000003211a
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x0010000000031e3e
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x0010000000031817
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x00100000000316d0
