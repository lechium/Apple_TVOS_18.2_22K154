...
- (void).cxx_destruct;	// IMP=0x002000000005816e
...
- (void)_onWorkerQueue_scheduleReload;	// IMP=0x001000000005805e
- (void)_onWorkerQueue_reload;	// IMP=0x0010000000057faf
- (void)service:(id)arg1 connectedDevicesChanged:(id)arg2;	// IMP=0x0010000000057f9d
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x0010000000057f8b
- (id)availableOutputDevices;	// IMP=0x0010000000057f79
- (unsigned int)discoveryMode;	// IMP=0x0010000000057f3d
- (void)setDiscoveryMode:(unsigned int)arg1;	// IMP=0x0010000000057e09
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)init;	// IMP=0x0010000000057b55
