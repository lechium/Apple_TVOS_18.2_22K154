...
+ (_Bool)isRemoteControllableApp:(id)arg1;	// IMP=0x0040000000092402
- (void).cxx_destruct;	// IMP=0x0020000000092578
...
- (void)notifyDelegate;	// IMP=0x00100000000922a3
...
- (void)_handleLayoutDidChangeNotification:(id)arg1;	// IMP=0x001000000009174d
- (id)initWithDelegate:(id)arg1;	// IMP=0x00100000000915ae
