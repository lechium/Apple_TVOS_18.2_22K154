...
- (void).cxx_destruct;	// IMP=0x002000000002a8a1
...
- (void)clearRoutedCommands;	// IMP=0x001000000002a828
- (void)addRoutedCommand:(id)arg1;	// IMP=0x001000000002a634
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x001000000002a40e
