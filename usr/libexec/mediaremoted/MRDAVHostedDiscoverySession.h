...
+ (id)calloutQueue;	// IMP=0x002000000006aeac
- (void).cxx_destruct;	// IMP=0x002000000006cdb2
...
- (void)_reevaluateEffectiveDiscoveryMode;	// IMP=0x001000000006cb3d
- (unsigned int)_calculateEffectiveDiscoveryMode;	// IMP=0x001000000006cb19
- (void)_maybeWakeClient;	// IMP=0x001000000006c9fa
- (void)_resumeConnection;	// IMP=0x001000000006c66c
- (void)_notifyAvailableEndpointsDidChange:(id)arg1;	// IMP=0x001000000006c37d
- (void)_notifyAvailableOutputDevicesDidChange:(id)arg1;	// IMP=0x001000000006c08e
- (void)_invalidate;	// IMP=0x001000000006bf8f
- (void)connectionDidResume:(id)arg1;	// IMP=0x001000000006bf7d
- (void)getAvailableOutputDevicesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006bf1a
- (void)getAvailableEndpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006beb7
- (void)setDiscoveryMode:(unsigned int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000006be24
- (void)getDiscoveryModeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006bd4b
- (void)getDevicePresenceDetectedWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006bcfe
- (void)hostedRoutingController:(id)arg1 outputDevicesDidChange:(id)arg2 forFeature:(unsigned int)arg3;	// IMP=0x001000000006bce9
- (void)hostedRoutingController:(id)arg1 endpointsDidChange:(id)arg2;	// IMP=0x001000000006bcd4
@property(copy, nonatomic) MRAVRoutingDiscoverySessionConfiguration *configuration;
- (void)configurationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006b5a4
...
- (void)dealloc;	// IMP=0x001000000006aada
- (id)initWithConnection:(id)arg1 hostedRoutingController:(id)arg2;	// IMP=0x001000000006a677
