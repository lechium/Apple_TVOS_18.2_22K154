...
- (void).cxx_destruct;	// IMP=0x0020000000165007
...
- (void)notifyDelegateOfWake;	// IMP=0x0010000000164f40
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000164ea5
- (id)init;	// IMP=0x0010000000164be0
