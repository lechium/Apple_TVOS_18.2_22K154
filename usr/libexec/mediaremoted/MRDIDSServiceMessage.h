...
- (void).cxx_destruct;	// IMP=0x0020000000047b2c
...
- (_Bool)replyWithData:(id)arg1 priority:(long long)arg2;	// IMP=0x0010000000047aa6
- (id)initWithID:(id)arg1 data:(id)arg2 device:(id)arg3 service:(id)arg4;	// IMP=0x00100000000479ab
