...
- (void).cxx_destruct;	// IMP=0x004000000020fd10
- (id)init;	// IMP=0x001000000020fce0
- (void)track;	// IMP=0x001000000020fcc0
- (void)trackWithError:(id)arg1;	// IMP=0x001000000020fca0
- (id)initWithRouteType:(unsigned char)arg1;	// IMP=0x001000000020fc80
