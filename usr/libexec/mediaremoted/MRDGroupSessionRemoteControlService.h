...
- (void).cxx_destruct;	// IMP=0x002000000008c29f
...
- (void)session:(id)arg1 didUpdateParticipants:(id)arg2;	// IMP=0x001000000008b86e
- (void)manager:(id)arg1 didEndHostedGroupSession:(id)arg2;	// IMP=0x001000000008b7ec
- (void)manager:(id)arg1 didStartHostedGroupSession:(id)arg2;	// IMP=0x001000000008b742
- (void)dealloc;	// IMP=0x001000000008b691
- (id)initWithGroupSessionManager:(id)arg1 delegate:(id)arg2;	// IMP=0x001000000008b545
