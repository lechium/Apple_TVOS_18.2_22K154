...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x004000000007a785
- (void).cxx_destruct;	// IMP=0x002000000007a94a
...
- (id)_extendedInfo;	// IMP=0x001000000007a8ff
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x001000000007a7d6
