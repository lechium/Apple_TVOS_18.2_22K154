...
- (void).cxx_destruct;	// IMP=0x002000000014d93f
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x001000000014d3e0
- (void)_checkConnectionStatus;	// IMP=0x001000000014cf01
- (_Bool)_canSendMessage;	// IMP=0x001000000014ce1b
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x001000000014cd5e
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x001000000014ca8d
- (id)description;	// IMP=0x001000000014ca02
- (id)_initWithLabel:(id)arg1;	// IMP=0x001000000014c951
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x001000000014c896
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x001000000014c7ca
