...
- (void).cxx_destruct;	// IMP=0x0020000000134e0b
...
- (void)nearbyGroupSessionDismissed:(id)arg1;	// IMP=0x0010000000134cf5
- (void)routeRecommendationDismissed;	// IMP=0x0010000000134cb8
- (id)remoteObjectProxy;	// IMP=0x0010000000134ca2
- (void)dealloc;	// IMP=0x0010000000134c31
- (id)description;	// IMP=0x0010000000134bf0
- (id)initWithConnection:(id)arg1 bundleID:(id)arg2;	// IMP=0x0010000000134b57
