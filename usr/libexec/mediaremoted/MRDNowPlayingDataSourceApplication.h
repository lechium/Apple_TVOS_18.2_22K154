...
- (void).cxx_destruct;	// IMP=0x0020000000047e1a
...
- (id)dictionaryRepresentation;	// IMP=0x0000000000047c66
- (id)description;	// IMP=0x0010000000047c16
- (id)initWithPID:(int)arg1 audioSessionID:(id)arg2 mxSessionIDs:(id)arg3 isEligible:(_Bool)arg4;	// IMP=0x0010000000047b6a
