...
- (void).cxx_destruct;	// IMP=0x00200000000262c7
...
- (void)clearNearbyDevices;	// IMP=0x001000000002617c
- (void)_configureObserver;	// IMP=0x0010000000026176
- (void)startObservationIfNeeded;	// IMP=0x0010000000026045
- (void)didSwitchRouteTo:(id)arg1;	// IMP=0x001000000002603f
@property(readonly, copy, nonatomic) NSArray *nearbyDeviceIdentifiers;
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x0010000000025f98
