...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00400000000262f8
- (void).cxx_destruct;	// IMP=0x00200000000263f2
...
- (void)setIsMuted:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00100000000263c5
- (void)adjustVolume:(long long)arg1 error:(id *)arg2;	// IMP=0x00100000000263bf
- (void)adjustVolumeWithStepAmount:(float)arg1 error:(id *)arg2;	// IMP=0x00100000000263b9
- (void)setVolume:(float)arg1 error:(id *)arg2;	// IMP=0x00100000000263b3
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x0010000000026348
