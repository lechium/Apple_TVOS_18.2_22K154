...
- (void).cxx_destruct;	// IMP=0x00200000001781e7
...
- (void)cancel;	// IMP=0x00100000001781c7
- (void)respondWithAuthorizationToken:(id)arg1;	// IMP=0x00100000001781b5
- (id)initWithRoute:(id)arg1 inputType:(long long)arg2 responseCallback:(CDUnknownBlockType)arg3 cancelCallback:(CDUnknownBlockType)arg4;	// IMP=0x00100000001780ca
