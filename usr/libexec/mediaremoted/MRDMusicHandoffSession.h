...
- (void)handleEvent:(id)arg1;	// IMP=0x0010000000048976
- (void)invalidate;	// IMP=0x0010000000048803
- (void)start;	// IMP=0x0010000000048738
- (id)description;	// IMP=0x00100000000486cc
- (id)initWithSource:(id)arg1 destination:(id)arg2;	// IMP=0x001000000004855f
