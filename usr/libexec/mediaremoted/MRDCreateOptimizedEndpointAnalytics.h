...
- (void).cxx_destruct;	// IMP=0x004000000022fbe0
- (id)init;	// IMP=0x001000000022fbb0
- (void)track;	// IMP=0x001000000022fb90
- (void)trackWithError:(id)arg1;	// IMP=0x001000000022fb70
- (id)initWithRequestID:(id)arg1;	// IMP=0x001000000022fb40
