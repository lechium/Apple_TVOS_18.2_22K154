...
- (void).cxx_destruct;	// IMP=0x004000000020f680
- (id)init;	// IMP=0x001000000020f640
- (void)track;	// IMP=0x001000000020f620
- (void)trackWithError:(id)arg1;	// IMP=0x001000000020f600
- (id)initWithJoinMode:(id)arg1;	// IMP=0x001000000020f5c0
