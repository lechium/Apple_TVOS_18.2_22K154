...
- (void).cxx_destruct;	// IMP=0x0020000000174df0
...
- (id)_newIOKitDeviceProperties;	// IMP=0x0010000000174c36
- (_Bool)handleTouchEvent:(struct _MRHIDTouchEvent)arg1;	// IMP=0x00100000001748b5
- (_Bool)handleHIDReport:(id)arg1;	// IMP=0x00100000001747a4
- (id)deviceProperties;	// IMP=0x0010000000174765
- (void)dealloc;	// IMP=0x0010000000174726
- (id)initWithDeviceDescriptor:(id)arg1;	// IMP=0x00100000001745df
