...
- (void).cxx_destruct;	// IMP=0x00200000001a5e89
@property(retain, nonatomic) MRExternalDeviceTransportConnectionHandle *handle; // @synthesize handle=_handle;
- (void)transport:(id)arg1 didReceiveData:(id)arg2;	// IMP=0x00100000001a5d1e
- (void)finishWithError:(id)arg1;	// IMP=0x00100000001a52ef
- (void)execute;	// IMP=0x00100000001a398b
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

- (id)initWithOutputDevice:(id)arg1;	// IMP=0x00100000001a3883
