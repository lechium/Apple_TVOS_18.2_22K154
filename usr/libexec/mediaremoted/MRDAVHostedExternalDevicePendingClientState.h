...
@class MRAVDistantEndpoint, MRDAVHostedExternalDevicePendingClientStateOutputDeviceModifications, MRDeviceInfo, MRGroupSessionToken, NSError, NSMutableDictionary, NSNumber;
...
@interface MRDAVHostedExternalDevicePendingClientState : NSObject
{
    ...
    MRGroupSessionToken *_groupSessionToken;	// 104 = 0x68
}

- (void).cxx_destruct;	// IMP=0x0020000000045ad1
- (void);	// IMP=0x0010000000045ac0
@property(retain, nonatomic) MRGroupSessionToken *groupSessionToken; // @synthesize groupSessionToken=_groupSessionToken;
...
- (id)description;	// IMP=0x0010000000045527
