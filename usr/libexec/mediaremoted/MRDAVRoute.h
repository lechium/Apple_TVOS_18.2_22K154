...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x004000000018d5b4
- (void).cxx_destruct;	// IMP=0x002000000018d776
...
- (unsigned long long)sampleRate;	// IMP=0x001000000018d704
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x001000000018d696
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000018d604
