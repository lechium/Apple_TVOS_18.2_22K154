...
+ (id)fromObject:(id)arg1;	// IMP=0x00200000002a5480
- (void).cxx_destruct;	// IMP=0x00400000002a5ab0
- (id)init;	// IMP=0x00100000002a5a60
@property(nonatomic, readonly) NSString *description;
- (id)initWithCandidateResults:(id)arg1 contextIdentifier:(id)arg2;	// IMP=0x00100000002a5520
