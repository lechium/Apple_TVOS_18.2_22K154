...
- (void).cxx_destruct;	// IMP=0x002000000018d031
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x001000000018cf29
- (MISSING_TYPE *)_optionsDictionary;	// IMP=0x001000000018ce9f
- (void)_setCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000018ce72
- (CDUnknownBlockType)_completionHandler;	// IMP=0x001000000018ce5c
@property(readonly, nonatomic) _Bool nowPlayingAppStackEligible;
- (id)optionValueForKey:(struct __CFString *)arg1;	// IMP=0x001000000018cbcb
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018c5cd
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018c5a1
- (id)debugDescription;	// IMP=0x001000000018c455
- (id)description;	// IMP=0x001000000018c342
- (id)initWithCommandType:(unsigned int)arg1 playerPath:(id)arg2 unresolvedPlayerPath:(id)arg3 senderAppDisplayID:(id)arg4 options:(id)arg5;	// IMP=0x001000000018c2ae
- (id)initWithCommandType:(unsigned int)arg1 playerPath:(id)arg2 unresolvedPlayerPath:(id)arg3 senderAppDisplayID:(id)arg4 optionsData:(id)arg5;	// IMP=0x001000000018c130
