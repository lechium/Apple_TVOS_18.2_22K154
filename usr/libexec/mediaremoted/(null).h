...
- (void).cxx_destruct;	// IMP=0x0020000000130b25
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x0010000000130187
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x0010000000130165
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x0010000000130140
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x001000000013007f
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x001000000013006a
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x0010000000130046
- (id)createDiagnosticInfo;	// IMP=0x001000000012eb9a
- (id)init;	// IMP=0x001000000012eb44
