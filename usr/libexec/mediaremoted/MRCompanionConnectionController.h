...
- (void).cxx_destruct;	// IMP=0x0020000000117a10
...
- (id)debugDescription;	// IMP=0x00100000001177ea
- (void)_maybeAttemptToDiscoverAndConnectToCompanionWithReason:(id)arg1;	// IMP=0x0010000000117114
- (_Bool)_shouldAttemptToDiscoverAndConnectToCompanion;	// IMP=0x001000000011700f
- (void)_handleExternalDeviceConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x0010000000116e11
- (void)_handleCompanionDeviceConnectedNotification:(id)arg1;	// IMP=0x0010000000116df8
- (id)init;	// IMP=0x001000000011686f
