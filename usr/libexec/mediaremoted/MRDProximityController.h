...
- (void).cxx_destruct;	// IMP=0x002000000007b184
...
- (void)_handleElectedPlayerDidChangeNotification:(id)arg1;	// IMP=0x001000000007b045
- (void)_handleLayoutDidChangeNotification:(id)arg1;	// IMP=0x001000000007ac80
- (id)_configurationForUID:(id)arg1;	// IMP=0x001000000007ab67
- (void)_onQueue_reevaluateRemoteControlState;	// IMP=0x001000000007ab61
- (void)_configureObserver;	// IMP=0x001000000007ab5b
- (void)startObservationIfNeeded;	// IMP=0x001000000007ab55
- (id)init;	// IMP=0x001000000007a95a
