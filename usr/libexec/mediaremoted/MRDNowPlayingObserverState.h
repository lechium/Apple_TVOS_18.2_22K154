...
- (void).cxx_destruct;	// IMP=0x00200000000d1364
...
- (id)_coealesceItems:(id)arg1;	// IMP=0x00100000000d0f65
@property(readonly, nonatomic) MRNowPlayingState *state;
- (id)description;	// IMP=0x00100000000cf6d8
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x00100000000cf66d
