...
- (void).cxx_destruct;	// IMP=0x00200000001a0d6c
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00100000001a0cbd
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a0c8a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001a0c5e
