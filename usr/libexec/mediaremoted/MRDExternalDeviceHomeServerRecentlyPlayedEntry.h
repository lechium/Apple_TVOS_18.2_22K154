...
- (void).cxx_destruct;	// IMP=0x0020000000080d5e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000805c1
- (id)description;	// IMP=0x00100000000804ac
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000802bf
