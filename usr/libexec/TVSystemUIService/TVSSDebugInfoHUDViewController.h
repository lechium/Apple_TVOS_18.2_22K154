...
@interface TVSSDebugInfoHUDViewController : UIViewController
{
    ...
    TVSSHUDBoxedValueVisualization *_openRequestedReasonViz;	// 80 = 0x50
    ...
    TVSSHUDBoxedValueVisualization *_dictationViz;	// 176 = 0xb0
}

- (void).cxx_destruct;	// IMP=0x0020000000148cf0
@property(retain, nonatomic) TVSSHUDBoxedValueVisualization *dictationViz; // @synthesize dictationViz=_dictationViz;
...
@property(retain, nonatomic) TVSSHUDBoxedValueVisualization *openRequestedReasonViz; // @synthesize openRequestedReasonViz=_openRequestedReasonViz;
...
- (void)_updateVisualizations;	// IMP=0x0010000000147ba0
- (void)nowPlayingState:(id)arg1 playbackStateDidChange:(long long)arg2;	// IMP=0x0010000000147b40
- (void)privacyControllerStateDidChange:(id)arg1;	// IMP=0x0010000000147af0
- (void)menuModeStateProviderDidChange:(id)arg1;	// IMP=0x0010000000147aa0
- (void)menuModeControllerModeDidChange:(id)arg1 withTransitionContext:(id)arg2;	// IMP=0x0010000000147a20
- (void)viewDidLoad;	// IMP=0x0010000000147690
- (void)dealloc;	// IMP=0x0010000000147560
- (id)initWithMenuModeController:(id)arg1 privacyController:(id)arg2;	// IMP=0x0010000000146a30
