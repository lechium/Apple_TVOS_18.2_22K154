...
- (void).cxx_destruct;	// IMP=0x00200000000300a0
...
- (void)rendererWasSelected:(id)arg1 context:(id)arg2;	// IMP=0x001000000002fb50
- (id)initWithSleepTimerController:(id)arg1;	// IMP=0x001000000002e9d0
