...
- (void).cxx_destruct;	// IMP=0x0020000000091760
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000916c0
- (id)initWithNearbyDeviceHandle:(id)arg1 conversationID:(id)arg2;	// IMP=0x0010000000091510
