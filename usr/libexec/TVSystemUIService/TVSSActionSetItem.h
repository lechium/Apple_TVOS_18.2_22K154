...
@class HFActionSetItem, NSArray, NSAttributedString, NSError, NSNumber, NSString, UIImage;
...
- (void).cxx_destruct;	// IMP=0x002000000002e990
...
- (void)updateWithHFItem:(id)arg1;	// IMP=0x001000000002e590
- (id)initWithHFItem:(id)arg1;	// IMP=0x001000000002e4d0
