...
- (id <BNBannerSourceListenerPresentable>)bannerSourceListener:(BNBannerSourceListener *)arg1 newBannerSourceListenerPresentableForBannerSpecification:(id <BNPresentableSpecifying>)arg2 serviceDomain:(NSString *)arg3 remoteProcess:(FBProcess *)arg4 readyCompletion:(void (^)(id <BNBannerSourceListenerPresentable>, NSError *))arg5;
