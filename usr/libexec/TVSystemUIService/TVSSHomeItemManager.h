...
+ (_Bool)isFilteringToFavoriteCameras;	// IMP=0x004000000003b260
- (void).cxx_destruct;	// IMP=0x002000000003c0e0
...
- (id)_buildSectionsWithDisplayedItems:(id)arg1;	// IMP=0x001000000003b730
- (id)_itemForSorting;	// IMP=0x001000000003b700
- (id)_buildItemProvidersForHome:(id)arg1;	// IMP=0x001000000003b2d0
