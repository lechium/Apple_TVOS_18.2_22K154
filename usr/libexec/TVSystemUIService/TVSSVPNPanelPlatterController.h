...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000006f920
- (void)vpnController:(id)arg1 didUpdateConfigurations:(id)arg2;	// IMP=0x001000000006efd0
- (void)rendererWasSelected:(id)arg1 context:(id)arg2;	// IMP=0x001000000006edb0
- (void)dealloc;	// IMP=0x001000000006ed00
- (id)initWithIdentifier:(id)arg1;	// IMP=0x001000000006ddd0
