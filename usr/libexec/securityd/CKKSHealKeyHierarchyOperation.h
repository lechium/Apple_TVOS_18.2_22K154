...
- (void).cxx_destruct;	// IMP=0x002000000009599b
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x001000000009536a
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x0010000000094d7a
- (void)groupStart;	// IMP=0x0010000000094888
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x001000000009476f
- (id)init;	// IMP=0x0010000000094761
