...
- (void).cxx_destruct;	// IMP=0x00200000000ba56d
...
- (_Bool)shouldHaveView:(id)arg1;	// IMP=0x00100000000ba482
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x00100000000ba38f
@property(readonly) NSString *peerID;
@property(readonly) _SFECPublicKey *publicSigningKey;
@property(readonly) _SFECPublicKey *publicEncryptionKey;
- (id)initWithSOSPeerID:(id)arg1 encryptionKey:(id)arg2 signingKey:(id)arg3 viewList:(id)arg4;	// IMP=0x00100000000ba13d
