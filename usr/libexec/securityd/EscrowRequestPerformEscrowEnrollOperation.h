...
@interface EscrowRequestPerformEscrowEnrollOperation
{
    ...
    NSString<OctagonStateString> *;	// 24 = 0x18
    unsigned long long _numberOfRecordsUploaded;	// 32 = 0x20
    CKKSLockStateTracker *_lockStateTracker;	// 40 = 0x28
}

+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00200000000c05e1
- (void).cxx_destruct;	// IMP=0x00200000000c008d
...
- (void)groupStart;	// IMP=0x00100000000bf705
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00100000000bf572
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00100000000bf497
