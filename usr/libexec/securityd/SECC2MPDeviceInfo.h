...
{
    MISSING_TYPE *_internalTestConfigs;	// 8 = 0x8
...
+ (Class)internalTestConfigType;	// IMP=0x00200000001d6c78
- (void).cxx_destruct;	// IMP=0x00200000001d6821
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001d644e
- (unsigned long long)hash;	// IMP=0x00100000001d631b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d60ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001d5dc5
- (void)copyTo:(id)arg1;	// IMP=0x00100000001d5be1
- (void)writeTo:(id)arg1;	// IMP=0x00100000001d599d
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001d5990
- (id)dictionaryRepresentation;	// IMP=0x00100000001d55d0
- (id)description;	// IMP=0x00100000001d5521
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x00100000001d5504
- (unsigned long long)internalTestConfigsCount;	// IMP=0x00100000001d54e7
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x00100000001d547d
- (void)clearInternalTestConfigs;	// IMP=0x00100000001d5460
