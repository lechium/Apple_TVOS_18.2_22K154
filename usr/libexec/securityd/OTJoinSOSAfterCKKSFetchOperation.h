...
- (void).cxx_destruct;	// IMP=0x0020000000081551
...
- (void)proceedAfterFetch;	// IMP=0x0010000000080ffb
- (void)groupStart;	// IMP=0x0010000000080d00
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000080c36
