...
- (void).cxx_destruct;	// IMP=0x00200000001646e7
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001645dd
- (unsigned long long)hash;	// IMP=0x001000000016453f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000164429
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016434e
- (void)copyTo:(id)arg1;	// IMP=0x00100000001642ae
- (void)writeTo:(id)arg1;	// IMP=0x0010000000164200
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001641f3
- (id)dictionaryRepresentation;	// IMP=0x00100000001640ab
- (id)description;	// IMP=0x0010000000163ffc
