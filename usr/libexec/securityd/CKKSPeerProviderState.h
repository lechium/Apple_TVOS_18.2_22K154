...
+ (id)createFromProvider:(id)arg1;	// IMP=0x00400000001369aa
+ (id)noPeersState:(id)arg1;	// IMP=0x0010000000136894
- (void).cxx_destruct;	// IMP=0x0020000000136840
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x001000000013585b
- (id)description;	// IMP=0x001000000013572e
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x001000000013543e
