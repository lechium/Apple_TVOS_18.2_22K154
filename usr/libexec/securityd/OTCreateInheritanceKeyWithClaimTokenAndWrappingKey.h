...
- (void).cxx_destruct;	// IMP=0x00200000000b7f07
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000b79dc
- (void)groupStart;	// IMP=0x00100000000b77e9
- (id)initWithUUID:(id)arg1 claimTokenData:(id)arg2 wrappingKeyData:(id)arg3 dependencies:(id)arg4;	// IMP=0x00100000000b76d0
