...
+ (id)trust;	// IMP=0x00400000002209b9
- (void).cxx_destruct;	// IMP=0x0020000000220986
...
- (void)dealloc;	// IMP=0x001000000022075f
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x0010000000220680
- (id)init;	// IMP=0x0010000000220595
