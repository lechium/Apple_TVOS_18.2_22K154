...
- (void).cxx_destruct;	// IMP=0x00200000000a2c1a
...
- (void)inspectErrorForRetryAfter:(id)arg1;	// IMP=0x00100000000a2809
- (id)keychainMusrForCurrentAccount;	// IMP=0x00100000000a26b6
- (id)viewNameForItem:(struct SecDbItem *)arg1;	// IMP=0x00100000000a249f
- (_Bool)intransactionCKWriteFailed:(id)arg1 attemptedRecordsChanged:(id)arg2;	// IMP=0x00100000000a1457
- (_Bool)intransactionCKRecordDeleted:(id)arg1 recordType:(id)arg2 resync:(_Bool)arg3;	// IMP=0x00100000000a0fae
- (_Bool)intransactionCKRecordChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x00100000000a05f5
- (void)provideKeySets:(id)arg1;	// IMP=0x00100000000a02d3
- (_Bool)considerSelfTrusted:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000a0002
- (id)currentTrustStates;	// IMP=0x001000000009fdc2
- (void)applyNewSyncingPolicy:(id)arg1 viewStates:(id)arg2;	// IMP=0x001000000009fb15
- (id)readyAndSyncingViews;	// IMP=0x001000000009f800
- (id)viewStateForName:(id)arg1;	// IMP=0x001000000009f5ec
- (id)viewStatesByNames:(id)arg1;	// IMP=0x001000000009f3a0
- (id)viewsInState:(id)arg1;	// IMP=0x001000000009f18f
- (void)limitOperationToPriorityViews;	// IMP=0x001000000009f0c2
- (void)operateOnAllViews;	// IMP=0x001000000009efe7
- (void)operateOnSelectViews:(id)arg1;	// IMP=0x001000000009eeff
- (void)setStateForAllViews:(id)arg1;	// IMP=0x001000000009eda4
- (void)setStateForActiveExternallyManagedViews:(id)arg1;	// IMP=0x001000000009ec1a
- (void)setStateForActiveCKKSManagedViews:(id)arg1;	// IMP=0x001000000009ea90
- (void)setStateForActiveZones:(id)arg1;	// IMP=0x001000000009e935
