...
- (void).cxx_destruct;	// IMP=0x00200000000bf345
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000bf213
- (_Bool)matchesCKRecord:(id)arg1;	// IMP=0x00100000000bf133
- (void)setFromCKRecord:(id)arg1;	// IMP=0x00100000000bf053
- (id)updateCKRecord:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000000bef66
- (id)CKRecordName;	// IMP=0x00100000000bee95
- (id)CKRecordWithZoneID:(id)arg1;	// IMP=0x00100000000bed0d
...
- (id)initWithCKRecordType:(id)arg1 encodedCKRecord:(id)arg2 contextID:(id)arg3 zoneID:(id)arg4;	// IMP=0x00100000000be70d
- (id)initWithCKRecord:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000be60c
