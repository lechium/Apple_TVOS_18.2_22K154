...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001d0187
- (void).cxx_destruct;	// IMP=0x00200000001d0149
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001cfeca
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001cfd21
- (id)description;	// IMP=0x00100000001cfba3
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6 walrus:(id)arg7 webAccess:(id)arg8;	// IMP=0x00100000001cfaa0
