...
- (void).cxx_destruct;	// IMP=0x00200000000ccd2e
...
- (void)cancel;	// IMP=0x00100000000cc9ab
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00100000000cc592
- (void)performFetch;	// IMP=0x00100000000cb54e
- (void)groupStart;	// IMP=0x00100000000cb344
- (void)queryClientsForChangeTokens;	// IMP=0x00100000000cadd0
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clientMap:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7 altDSID:(id)arg8 sendMetric:(_Bool)arg9;	// IMP=0x00100000000cab57
- (id);	// IMP=0x00100000000cab49
