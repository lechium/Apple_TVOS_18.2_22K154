...
- (void).cxx_destruct;	// IMP=0x0020000000201766
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x0010000000201573
- (void)requestSyncWith:(id)arg1;	// IMP=0x00100000002014a0
- (void)finish;	// IMP=0x00100000001ff911
- (void)restart;	// IMP=0x00100000001ff8e3
- (void)start;	// IMP=0x00100000001ff4b7
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00100000001ff42f
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00100000001ff1bd
- (unsigned long long)currentTrustBitmask;	// IMP=0x00100000001ff0ab
