...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001d24c8
- (void).cxx_destruct;	// IMP=0x00200000001d248a
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001d222b
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001d1e44
- (id)description;	// IMP=0x00100000001d1db1
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x00100000001d1b4b
