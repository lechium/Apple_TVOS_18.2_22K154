...
- (void).cxx_destruct;	// IMP=0x00200000000ac3a3
...
- (void)groupStart;	// IMP=0x00100000000ac195
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00100000000ac0cb
