...
@class CKContainer, CKKSFetchAllRecordZoneChangesOperation, CKKSNearFutureScheduler, CKKSReachabilityTracker, CKKSResultOperation, CKKSZoneChangeFetchDependencyOperation, MISSING_TYPE, NSError, NSMapTable, NSMutableSet, NSOperationQueue, NSString;
...
- (void).cxx_destruct;	// IMP=0x00200000001d9842
...
- (void)halt;	// IMP=0x00100000001d9402
- (void)cancel;	// IMP=0x00100000001d93c5
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x00100000001d93b3
- (id)createSuccessfulFetchDependency;	// IMP=0x00100000001d9348
- (void)_onqueueCreateNewFetch;	// IMP=0x00100000001d8b2d
- (void)maybeCreateNewFetch;	// IMP=0x00100000001d8abc
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00100000001d88c5
- (id)inflightFetch;	// IMP=0x00100000001d87ca
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x00100000001d868b
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x00100000001d82d7
- (void)notifyZoneChange:(id)arg1;	// IMP=0x00100000001d81fc
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x00100000001d8196
- (id)strongClientMap;	// IMP=0x00100000001d7f05
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000001d7e39
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3 altDSID:(id)arg4 sendMetric:(_Bool)arg5;	// IMP=0x00100000001d7979
