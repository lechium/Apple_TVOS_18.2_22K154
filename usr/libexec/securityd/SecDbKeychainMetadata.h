...
- (void).cxx_destruct;	// IMP=0x002000000011ab59
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000011a7aa
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x001000000011a5a7
