...
- (void).cxx_destruct;	// IMP=0x002000000003e9a4
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x001000000003e8a7
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x001000000003e643
