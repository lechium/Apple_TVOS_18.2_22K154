...
- (void).cxx_destruct;	// IMP=0x00200000000ada65
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ad7ca
- (unsigned long long)hash;	// IMP=0x00100000000ad692
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ad4a1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ad300
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ad1bf
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ad07c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000acaee
- (id)dictionaryRepresentation;	// IMP=0x00100000000ac793
- (id)description;	// IMP=0x00100000000ac6e4
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00100000000ac501
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00100000000ac495
