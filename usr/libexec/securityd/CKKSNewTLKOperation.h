...
- (void).cxx_destruct;	// IMP=0x0020000000175ee7
...
- (void)cancel;	// IMP=0x0010000000175df5
- (void)groupStart;	// IMP=0x001000000017581f
- (id)initWithDependencies:(id)arg1 rollTLKIfPresent:(_Bool)arg2 preexistingPendingKeySets:(id)arg3 intendedState:(id)arg4 errorState:(id)arg5;	// IMP=0x00100000001754ed
- (id)init;	// IMP=0x00100000001754df
