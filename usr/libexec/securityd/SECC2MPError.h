...
- (void).cxx_destruct;	// IMP=0x002000000015c4b8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000015c37e
- (unsigned long long)hash;	// IMP=0x001000000015c2e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015c1d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000015c0e9
- (void)copyTo:(id)arg1;	// IMP=0x001000000015c045
- (void)writeTo:(id)arg1;	// IMP=0x001000000015bfa5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000015bf98
- (id)dictionaryRepresentation;	// IMP=0x001000000015be65
- (id)description;	// IMP=0x001000000015bdb6
