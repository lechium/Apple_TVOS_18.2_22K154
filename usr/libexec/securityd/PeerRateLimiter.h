...
- (void).cxx_destruct;	// IMP=0x002000000023bbfc
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x001000000023ba5c
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x001000000023b95b
- (id)setUpConfigForPeer;	// IMP=0x001000000023b8e0
