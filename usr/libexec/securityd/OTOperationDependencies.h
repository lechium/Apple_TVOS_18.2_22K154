...
@class CKKSKeychainView, CKKSLockStateTracker, CKKSReachabilityTracker, CuttlefishXPCWrapper, NSString, OTCuttlefishAccountStateHolder, TPSpecificUser;
...
@interface OTOperationDependencies : NSObject
{
    ...
    id <OTAuthKitAdapter> _authKitAdapter;	// 80 = 0x50
...
- (void).cxx_destruct;	// IMP=0x00200000001e3275
