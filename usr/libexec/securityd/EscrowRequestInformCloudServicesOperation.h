...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 serializedReason:(id)arg2 error:(id *)arg3;	// IMP=0x00200000001e4cc1
- (void).cxx_destruct;	// IMP=0x00200000001e4c7f
...
- (void)main;	// IMP=0x00100000001e4341
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x00100000001e4277
