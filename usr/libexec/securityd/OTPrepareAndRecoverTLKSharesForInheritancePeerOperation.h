...
@class MISSING_TYPE, NSData, NSOperation, NSString, OTDeviceInformation, OTInheritanceKey, OTOperationDependencies, TPPolicyVersion, TrustedPeersHelperCustodianRecoveryKey;
...
- (void).cxx_destruct;	// IMP=0x00200000000fece5
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000fe8ff
- (MISSING_TYPE *)groupStart;	// IMP=0x00100000000fe0dc
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 ik:(id)arg4 deviceInfo:(id)arg5 policyOverride:(id)arg6 isInheritedAccount:(_Bool)arg7 epoch:(unsigned long long)arg8;	// IMP=0x00100000000fdf57
