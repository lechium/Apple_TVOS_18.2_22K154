...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000abb3e
- (void).cxx_destruct;	// IMP=0x00200000000ababe
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000ab722
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ab433
- (id)description;	// IMP=0x00100000000ab1aa
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000ab111
