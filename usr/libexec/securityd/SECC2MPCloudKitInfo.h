...
+ (Class)clientOperationType;	// IMP=0x00200000001705b0
+ (Class)operationGroupType;	// IMP=0x001000000017059f
- (void).cxx_destruct;	// IMP=0x002000000016ff4a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000016fab2
- (unsigned long long)hash;	// IMP=0x001000000016f945
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016f6ed
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016f2a1
- (void)copyTo:(id)arg1;	// IMP=0x001000000016f02f
- (void)writeTo:(id)arg1;	// IMP=0x001000000016ecea
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000016ecdd
- (id)dictionaryRepresentation;	// IMP=0x001000000016e67a
- (id)description;	// IMP=0x001000000016e5cb
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x001000000016e51e
- (unsigned long long)clientOperationsCount;	// IMP=0x001000000016e501
- (void)addClientOperation:(id)arg1;	// IMP=0x001000000016e497
- (void)clearClientOperations;	// IMP=0x001000000016e47a
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x001000000016e3c5
- (unsigned long long)operationGroupsCount;	// IMP=0x001000000016e3a8
- (void)addOperationGroup:(id)arg1;	// IMP=0x001000000016e33e
- (void)clearOperationGroups;	// IMP=0x001000000016e321
