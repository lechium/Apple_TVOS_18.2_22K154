...
+ (id)op:(unsigned long long)arg1 column:(unsigned long long)arg2;	// IMP=0x004000000002fbc4
...
- (id)initWithOperation:(unsigned long long)arg1 columnName:(unsigned long long)arg2;	// IMP=0x001000000002fb54
