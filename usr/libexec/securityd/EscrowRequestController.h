...
- (void).cxx_destruct;	// IMP=0x0020000000036add
...
- (void)storePrerecordsInEscrowRPC:(CDUnknownBlockType)arg1;	// IMP=0x00100000000368b5
- (void)triggerEscrowUpdateRPC:(id)arg1 options:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000035e92
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x0010000000035431
- (id)initWithLockStateTracker:(id)arg1;	// IMP=0x00100000000351ef
