...
- (void).cxx_destruct;	// IMP=0x002000000016550d
...
- (void)proceedWithKeys:(id)arg1;	// IMP=0x0010000000164f63
- (void)groupStart;	// IMP=0x0010000000164b7e
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 peerID:(id)arg5 permanentInfo:(id)arg6 permanentInfoSig:(id)arg7 stableInfo:(id)arg8 stableInfoSig:(id)arg9;	// IMP=0x00100000001649c2
