...
+ (_Bool)isFullPeer:(id)arg1;	// IMP=0x00400000001c28d8
- (void).cxx_destruct;	// IMP=0x00200000001c2879
...
- (id)initForContainerName:(id)arg1 contextID:(id)arg2 epoch:(unsigned long long)arg3 machineID:(id)arg4 modelID:(id)arg5 deviceName:(id)arg6 serialNumber:(id)arg7 osVersion:(id)arg8;	// IMP=0x00100000001c2604
