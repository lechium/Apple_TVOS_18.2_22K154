...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00400000000cf7bb
- (void).cxx_destruct;	// IMP=0x00200000000cf793
...
- (id)asPathStep;	// IMP=0x00100000000cf65a
- (id)description;	// IMP=0x00100000000cf5c7
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00100000000cf52e
