...
- (void).cxx_destruct;	// IMP=0x00200000000d5d57
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000d5a46
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000d58d9
- (void)groupStart;	// IMP=0x00100000000d54ac
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000d539c
