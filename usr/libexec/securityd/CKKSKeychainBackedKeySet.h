...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001cf82f
- (void).cxx_destruct;	// IMP=0x00200000001cf7fc
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001cf657
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001cf54f
- (id)description;	// IMP=0x00100000001cf477
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x00100000001cf3b2
