...
- (void).cxx_destruct;	// IMP=0x0020000000219f5c
...
- (id)initWithDefaults:(id)arg1 dateDescription:(id)arg2 earliest:(double)arg3 latest:(double)arg4;	// IMP=0x0010000000219e0b
- (void)schedule;	// IMP=0x0010000000219dc7
- (void)followup;	// IMP=0x0010000000219d7e
- (_Bool)checkDate;	// IMP=0x0010000000219d29
- (id)getDate;	// IMP=0x0010000000219d0c
