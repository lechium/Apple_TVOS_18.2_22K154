...
- (void).cxx_destruct;	// IMP=0x002000000007ff2d
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x001000000007fbcb
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x001000000007fa5e
- (void)groupStart;	// IMP=0x001000000007f571
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x001000000007f412
