...
- (void).cxx_destruct;	// IMP=0x002000000011a597
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000011a42d
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x001000000011a360
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x001000000011a2c5
