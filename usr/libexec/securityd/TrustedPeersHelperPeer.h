...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001d0e31
- (void).cxx_destruct;	// IMP=0x00200000001d0de8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001d0bed
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001d09e6
- (id)description;	// IMP=0x00100000001d087d
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 secureElementIdentity:(id)arg4 viewList:(id)arg5;	// IMP=0x00100000001d0776
