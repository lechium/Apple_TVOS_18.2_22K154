...
- (void).cxx_destruct;	// IMP=0x0020000000087d4e
...
- (void)afterAuthKitFetch:(id)arg1 userInitiatedRemovals:(id)arg2 evictedRemovals:(id)arg3 unknownReasonRemovals:(id)arg4 trustedDeviceHash:(id)arg5 deletedDeviceHash:(id)arg6 trustedDevicesUpdateTimestamp:(id)arg7 accountIsDemo:(_Bool)arg8 version:(id)arg9;	// IMP=0x00100000000877fe
- (void)groupStart;	// IMP=0x0010000000087081
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 listUpdatesState:(id)arg3 errorState:(id)arg4 retryFlag:(id)arg5;	// IMP=0x0010000000086f64
