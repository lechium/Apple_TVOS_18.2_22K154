...
- (void).cxx_destruct;	// IMP=0x0020000000010186
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000010094
- (unsigned long long)hash;	// IMP=0x0010000000010027
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000ff47
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000fe83
- (void)copyTo:(id)arg1;	// IMP=0x001000000000fe00
- (void)writeTo:(id)arg1;	// IMP=0x001000000000fd86
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000fbfa
- (id)dictionaryRepresentation;	// IMP=0x001000000000fb50
- (id)description;	// IMP=0x001000000000faa1
