...
+ (id)sharedInstance;	// IMP=0x002000000007168f
- (void).cxx_destruct;	// IMP=0x0020000000070cf7
- (void)orientationManager:(id)arg1 userInterfaceOrientationMayHaveChanged:(long long)arg2 isDeviceOrientationLocked:(_Bool)arg3;	// IMP=0x0010000000070c8f
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x0010000000070c74
- (void)clientDied:(id)arg1;	// IMP=0x0010000000070be4
- (void)setBacklightFeatures:(id)arg1 forPID:(int)arg2;	// IMP=0x0010000000070ab9
- (void)setBacklightLocked:(_Bool)arg1 forReason:(id)arg2;	// IMP=0x00100000000708f1
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000070879
- (id)propertyForKey:(id)arg1;	// IMP=0x0010000000070812
@property(nonatomic) int displayBrightnessCurve;
- (void)setAutoBrightnessEnabled:(_Bool)arg1;	// IMP=0x0010000000070763
...
- (void)setBrightnessLevel:(float)arg1 reason:(id)arg2 options:(unsigned long long)arg3;	// IMP=0x00100000000701de
@property(readonly, nonatomic) float brightnessLevel;
@property(readonly, nonatomic) float unentitledBrightnessLevel;
- (void)setMinimumBrightnessLevel:(float)arg1 fadeDuration:(float)arg2;	// IMP=0x001000000006ffdd
- (unsigned char)backlightArchitectureVersion;	// IMP=0x001000000006ff3b
- (id)suppressBrightnessNotificationsForReason:(id)arg1;	// IMP=0x001000000006fecc
- (void)dealloc;	// IMP=0x001000000006fe64
- (id)_initWithBrightnessSystem:(id)arg1 systemShellSentinel:(id)arg2 orientationManager:(id)arg3;	// IMP=0x001000000006fc47
