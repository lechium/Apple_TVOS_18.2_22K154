...
- (void).cxx_destruct;	// IMP=0x0020000000073cd7
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000073c7e
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0010000000073ad6
- (id)init;	// IMP=0x0010000000073a86
