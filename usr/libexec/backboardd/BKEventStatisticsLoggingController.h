...
+ (id)workQueue;	// IMP=0x0020000000055a9c
- (void).cxx_destruct;	// IMP=0x00200000000553d9
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x0010000000055375
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x00100000000552e8
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x00100000000552d2
- (void)dealloc;	// IMP=0x0010000000055149
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x0010000000054f83
