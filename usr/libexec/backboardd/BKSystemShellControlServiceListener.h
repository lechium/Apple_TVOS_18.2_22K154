...
- (void).cxx_destruct;	// IMP=0x002000000007fe0c
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x001000000007fbbb
- (void)activate;	// IMP=0x001000000007fba5
- (id)initWithSentinel:(id)arg1;	// IMP=0x001000000007fa44
