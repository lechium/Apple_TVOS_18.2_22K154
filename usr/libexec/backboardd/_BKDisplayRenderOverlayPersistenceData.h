...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002919a
+ (id)classesRequiredToDecode;	// IMP=0x0010000000029114
- (void).cxx_destruct;	// IMP=0x00200000000290ec
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000028f4a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000028de2
- (void)dealloc;	// IMP=0x0010000000028d58
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x0010000000028c65
