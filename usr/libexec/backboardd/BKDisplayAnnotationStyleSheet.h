...
- (void).cxx_destruct;	// IMP=0x002000000001d5a9
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x001000000001d3ca
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x001000000001d31a
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x001000000001d29b
