...
- (void).cxx_destruct;	// IMP=0x002000000002a79d
...
- (void)_loadAllImages;	// IMP=0x001000000002a6da
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x001000000002a42f
- (id)_idiomSuffix;	// IMP=0x001000000002a422
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x001000000002a0ee
- (id)allImages;	// IMP=0x001000000002a0bf
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x001000000002a0ad
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0010000000029f74
