...
- (void).cxx_destruct;	// IMP=0x00200000000244f9
@property(copy, nonatomic) CDUnknownBlockType displayChangedHandler; // @synthesize displayChangedHandler=_displayChangedHandler;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000243be
@property(readonly, nonatomic) BKSHIDEventDisplay *display;
- (id)init;	// IMP=0x001000000002427e
