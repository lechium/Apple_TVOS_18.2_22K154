...
- (void).cxx_destruct;	// IMP=0x002000000002409d
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0010000000023f5b
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0010000000023f0b
- (id)succinctDescriptionBuilder;	// IMP=0x0010000000023ea3
- (id)succinctDescription;	// IMP=0x0010000000023e53
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x0010000000023dd9
- (id)_persistenceData;	// IMP=0x0010000000023d63
- (void)_cleanup;	// IMP=0x0010000000023d5d
- (void)_freeze;	// IMP=0x0010000000023d57
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x0010000000023d51
- (void)_stopAnimating;	// IMP=0x0010000000023d4b
- (void)_startAnimating;	// IMP=0x0010000000023d45
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x0010000000023d3d
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x0010000000023bf7
- (void)freeze;	// IMP=0x00100000000239bd
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x00100000000237e4
...
- (void)dealloc;	// IMP=0x0010000000023586
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x00100000000234d6
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x0010000000022ff0
