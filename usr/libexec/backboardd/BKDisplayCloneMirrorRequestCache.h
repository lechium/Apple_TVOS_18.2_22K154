...
- (void).cxx_destruct;	// IMP=0x0020000000029d0f
- (void)_lock_rebuildModeCache;	// IMP=0x0010000000029a87
- (void)_lock_addDeathWatcherForPid:(int)arg1;	// IMP=0x001000000002999c
