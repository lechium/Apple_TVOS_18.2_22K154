...
+ (id)_bundleInfoOverrides;	// IMP=0x0020000000022f0d
- (void).cxx_destruct;	// IMP=0x0020000000022c9f
...
- (void)_noteExitedWithContext:(id)arg1;	// IMP=0x0010000000022af5
- (_Bool)terminate;	// IMP=0x00100000000228ca
- (_Bool)launchWithResultBlock:(CDUnknownBlockType)arg1 exitBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000021539
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x00100000000214a2
@property(readonly, copy) NSString *description;
- (id)initWithBundleId:(id)arg1 options:(id)arg2 queue:(id)arg3;	// IMP=0x00100000000213c2
