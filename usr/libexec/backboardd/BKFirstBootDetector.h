...
+ (id)sharedInstance;	// IMP=0x0020000000030a10
- (void).cxx_destruct;	// IMP=0x0020000000030900
...
- (void)_queue_finishBootingIfNecessaryAndTellObservers:(_Bool)arg1;	// IMP=0x0010000000030627
- (void)systemShellWillBootstrap;	// IMP=0x001000000003059c
- (void)systemShellDidFinishLaunching:(id)arg1;	// IMP=0x0010000000030551
- (void)removeObserver:(id)arg1;	// IMP=0x00100000000304c4
- (void)addObserver:(id)arg1;	// IMP=0x0010000000030437
@property(readonly, nonatomic, getter=isFirstBoot) _Bool firstBoot;
@property(readonly, copy) NSString *description;
- (id)initWithSystemAppSentinel:(id)arg1 firstBootToken:(id)arg2 alternateSystemAppManager:(id)arg3;	// IMP=0x00100000000301b1
