...
- (void).cxx_destruct;	// IMP=0x002000000006da11
...
- (void)removeService:(id)arg1;	// IMP=0x001000000006d99c
- (void)addService:(id)arg1;	// IMP=0x001000000006d928
- (void)_resetServiceStatus;	// IMP=0x001000000006d762
- (id)description;	// IMP=0x001000000006d674
