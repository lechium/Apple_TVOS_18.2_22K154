...
+ (id)statisticWithLabel:(id)arg1;	// IMP=0x0020000000053f02
- (void).cxx_destruct;	// IMP=0x0020000000053ea9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000053e09
- (void)reset;	// IMP=0x0010000000053cd4
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x0010000000053ba2
