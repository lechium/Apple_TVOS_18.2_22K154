...
- (void).cxx_destruct;	// IMP=0x004000000006307b
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x0010000000063018
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x0010000000062fed
- (id)initToMemory;	// IMP=0x0010000000062fc2
- (void)close;	// IMP=0x0010000000062f7b
- (void)open;	// IMP=0x0010000000062c54
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x0010000000062b02
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x001000000006260e
- (id)init;	// IMP=0x00100000000623aa
