...
- (void).cxx_destruct;	// IMP=0x0020000000002ebc
...
- (void)stopProducingData;	// IMP=0x0010000000002de6
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002d28
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000002c84
