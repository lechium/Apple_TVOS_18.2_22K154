...
- (void).cxx_destruct;	// IMP=0x0020000000006509
...
- (void)stopProducingData;	// IMP=0x0010000000006425
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000006145
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000006047
