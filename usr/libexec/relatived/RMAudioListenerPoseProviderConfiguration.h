...
- (void).cxx_destruct;	// IMP=0x0020000000002c5c
...
- (id)initWithUniqueIdentifier:(id)arg1 tempestOptions:(id)arg2 forceSessionRestart:(_Bool)arg3;	// IMP=0x0010000000002b5e
