...
+ (id)sharedManager;	// IMP=0x00200000000098d9
- (void).cxx_destruct;	// IMP=0x002000000000a5a9
...
- (void)setCursorFrameForElement:(id)arg1;	// IMP=0x001000000000a0cf
- (void)hideVisualsSynchronously;	// IMP=0x0010000000009f4e
- (void)setCursorFrame:(struct CGRect)arg1 withPath:(struct CGPath *)arg2 withContextId:(unsigned int)arg3 element:(id)arg4 forceRefresh:(_Bool)arg5;	// IMP=0x0010000000009b52
- (void)setCursorStyle:(unsigned long long)arg1;	// IMP=0x0010000000009a51
- (struct CGRect)_adjustFrameToFitScreen:(struct CGRect)arg1;	// IMP=0x0010000000009a39
- (void)dealloc;	// IMP=0x0010000000009a0a
- (id)init;	// IMP=0x001000000000995e
