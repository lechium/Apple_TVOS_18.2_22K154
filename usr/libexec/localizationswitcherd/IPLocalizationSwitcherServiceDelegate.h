...
- (void)preferredLanguageChangedForBundleID:(id)arg1;	// IMP=0x0010000000001e5e
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001de7
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000001d70
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000001c1f
- (id)init;	// IMP=0x0010000000001b98
