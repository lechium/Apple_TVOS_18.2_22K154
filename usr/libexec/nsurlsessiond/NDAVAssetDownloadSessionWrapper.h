...
- (void).cxx_destruct;	// IMP=0x0020000000012aad
...
- (void)assetDownloadSession:(id)arg1 willDownloadVariants:(id)arg2;	// IMP=0x001000000001293d
- (void)assetDownloadSession:(id)arg1 didUpdateProgressWithExpectedBytes:(unsigned long long)arg2 bytesDownloaded:(unsigned long long)arg3;	// IMP=0x00100000000128ea
- (void)assetDownloadSession:(id)arg1 didResolveMediaSelection:(id)arg2;	// IMP=0x001000000001285d
- (void)assetDownloadSession:(id)arg1 didFinishDownloadForMediaSelection:(id)arg2;	// IMP=0x001000000001278a
- (void)assetDownloadSession:(id)arg1 didLoadTimeRange:(CDStruct_3c1748cc)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(CDStruct_3c1748cc)arg4 forMediaSelection:(id)arg5;	// IMP=0x0010000000012696
- (void)assetDownloadSession:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00100000000125c3
- (void)assetDownloadSessionDidFinishDownload:(id)arg1;	// IMP=0x0010000000012535
- (void)startLoadingMetadata;	// IMP=0x00100000000124e4
- (void)cancelAndDeliverError:(id)arg1;	// IMP=0x0010000000012458
- (void)cancel;	// IMP=0x00100000000123eb
- (void)suspend;	// IMP=0x001000000001237e
- (void)resume;	// IMP=0x00100000000122d4
- (void)releasePowerAssertion;	// IMP=0x00100000000121e5
- (void)takePowerAssertion;	// IMP=0x0010000000011f41
- (void)disavowSession;	// IMP=0x0010000000011e94
- (id)initWithURLAsset:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x00100000000113be
- (id)initWithURL:(id)arg1 destinationURL:(id)arg2 options:(id)arg3 delegate:(id)arg4 queue:(id)arg5;	// IMP=0x00100000000111b6
- (_Bool)doesAVAssetDownloadSessionSupportMultipleDownloads;	// IMP=0x001000000001119b
