...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000077c5
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000085ff
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000080e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000080d9
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000007dc9
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000077cd
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13 capabilities:(id)arg14;	// IMP=0x0010000000007546
