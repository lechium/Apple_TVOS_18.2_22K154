...
+ (id)daemonDefaults;	// IMP=0x002000000000dac3
- (void).cxx_destruct;	// IMP=0x002000000000e9e0
...
- (id)description;	// IMP=0x001000000000e915
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e80a
- (unsigned long long)hash;	// IMP=0x001000000000e78f
...
- (id)objectForKey:(id)arg1;	// IMP=0x001000000000de5c
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000ddda
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000000dcb1
- (void)dealloc;	// IMP=0x001000000000dc36
- (id)initWithBundleID:(id)arg1;	// IMP=0x001000000000db2f
