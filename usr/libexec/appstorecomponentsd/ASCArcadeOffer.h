...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000009528
- (void).cxx_destruct;	// IMP=0x002000000000a491
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000009d41
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000009a1f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000009a14
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000983c
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000009530
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0010000000009390
