...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000026583
- (void).cxx_destruct;	// IMP=0x0020000000027431
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000026d4b
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000026a53
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000026a48
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000026880
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002658b
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x0010000000026415
