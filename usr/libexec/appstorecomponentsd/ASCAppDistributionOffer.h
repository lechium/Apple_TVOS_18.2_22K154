...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000047fd
- (void).cxx_destruct;	// IMP=0x002000000000578a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000503a
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000004d18
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000004d0d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000004b35
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000004805
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 appVersionId:(id)arg7 distributorId:(id)arg8;	// IMP=0x0010000000004670
