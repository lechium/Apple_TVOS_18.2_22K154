...
@class ASCAdamID, MISSING_TYPE, NSArray, NSDictionary, NSNumber, NSString;
@protocol ASCOffer;
...
@interface ASCOfferAlertOffer : NSObject
{
    ...
    MISSING_TYPE *_checkRestrictionsForContentRating;	// 88 = 0x58
    NSString *_remoteControllerRequirement;	// 96 = 0x60
    id <ASCOffer> _completionOffer;	// 104 = 0x68
}

+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001e59c
- (void).cxx_destruct;	// IMP=0x002000000001fee1
