...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000123d4
- (void).cxx_destruct;	// IMP=0x0020000000012a97
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001271a
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000012622
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001252f
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000123dc
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4;	// IMP=0x0010000000012304
