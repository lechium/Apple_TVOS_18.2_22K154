...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000024ac9
- (void).cxx_destruct;	// IMP=0x0020000000025bf3
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000025365
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0010000000024feb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000024fe0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000024dd4
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000024ad1
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0010000000024917
