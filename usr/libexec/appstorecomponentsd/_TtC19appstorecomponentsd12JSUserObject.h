...
- (void).cxx_destruct;	// IMP=0x00400000000c3710
- (id)init;	// IMP=0x00100000000c36b0
- (id)cookieForUrlWithName:(id)arg1:(id)arg2;	// IMP=0x00100000000c3630
- (id)cookiesForUrl:(id)arg1;	// IMP=0x00100000000c3370
