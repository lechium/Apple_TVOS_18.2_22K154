...
- (void).cxx_destruct;	// IMP=0x0020000000010860
@property(retain) ACAccount *activeiTunesAccount; // @synthesize activeiTunesAccount=_activeiTunesAccount;
@property(readonly, nonatomic) ACAccountStore *accountStore; // @synthesize accountStore=_accountStore;
- (_Bool)isAutomaticDownloadingEnabled;	// IMP=0x00100000000107b9
- (_Bool)deletableSystemAppCanBeInstalledOnWatchWithBundleID:(id)arg1;	// IMP=0x00100000000107b1
- (id)isPairedSystemVersionAtLeast:(id)arg1;	// IMP=0x001000000001071f
- (_Bool)isActivePairedWatchSystemVersionAtLeastMajorVersion:(id)arg1 minorVersion:(id)arg2 patchVersion:(id)arg3;	// IMP=0x0010000000010717
- (_Bool)deviceHasCapabilitiesIncludingCompatibilityCheck:(id)arg1 isVisionOSCompatibleIOSApp:(_Bool)arg2;	// IMP=0x00100000000106f2
- (_Bool)deviceHasCapabilities:(id)arg1;	// IMP=0x00100000000106de
...
- (void)accountStoreDidChange:(id)arg1;	// IMP=0x00100000000104e4
- (void)dealloc;	// IMP=0x001000000001046f
- (id)initWithAccountStore:(id)arg1;	// IMP=0x0010000000010384
