...
- (void).cxx_destruct;	// IMP=0x0020000000051324
...
- (id)_authenticateAccount:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000050bf5
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x00100000000508b3
- (void)main;	// IMP=0x001000000005038a
- (id)initWithClient:(id)arg1;	// IMP=0x00100000000502eb
