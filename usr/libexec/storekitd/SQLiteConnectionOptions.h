...
+ (id)inMemoryDatabaseSharedCacheFlag;	// IMP=0x00200000000706ce
+ (id)inMemoryDatabaseFlag;	// IMP=0x00100000000706c1
- (void).cxx_destruct;	// IMP=0x00200000000707ec
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000706db
- (_Bool)isInMemoryDatabase;	// IMP=0x0010000000070668
- (void)setCacheSizeWithNumberOfKilobytes:(long long)arg1;	// IMP=0x0010000000070653
- (void)setCacheSizeWithNumberOfDatabasePages:(long long)arg1;	// IMP=0x0010000000070641
- (id)initInMemoryDatabaseWithName:(id)arg1;	// IMP=0x0010000000070563
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x00100000000704d6
