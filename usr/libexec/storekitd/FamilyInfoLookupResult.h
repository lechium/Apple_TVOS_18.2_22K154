...
+ (id)_familyMembersFromDictionaryRepresentation:(id)arg1;	// IMP=0x004000000008d9ec
- (void).cxx_destruct;	// IMP=0x002000000008e1ad
...
- (id)description;	// IMP=0x001000000008d96a
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1 cached:(_Bool)arg2;	// IMP=0x001000000008d68e
