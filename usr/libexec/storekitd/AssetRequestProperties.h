...
@interface AssetRequestProperties : NSObject
{
    ...
    MISSING_TYPE *_externalID;	// 88 = 0x58
...
- (void).cxx_destruct;	// IMP=0x0020000000070d9e
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000708a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000070892
- (id)init;	// IMP=0x001000000007081f
