...
- (void).cxx_destruct;	// IMP=0x0020000000005933
- (MISSING_TYPE *)_updateStatisticsFromSnapshots;	// IMP=0x0010000000005739
- (void)setCurrentValue:(unsigned long long)arg1;	// IMP=0x0010000000005551
@property(readonly, nonatomic) double estimatedTimeRemaining;
- (id)initWithMaxValue:(unsigned long long)arg1;	// IMP=0x00100000000053e6
