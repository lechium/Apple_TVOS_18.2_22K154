...
- (void).cxx_destruct;	// IMP=0x002000000008caa9
...
- (id)_bomInstallFromPath:(id)arg1 withError:(id *)arg2;	// IMP=0x001000000008c364
- (void)_bomInstall;	// IMP=0x001000000008bd0f
- (void)_updateDownloadStatus:(id)arg1;	// IMP=0x001000000008bc88
- (void)_sendDownloadStatus;	// IMP=0x001000000008bbc7
- (void)_install;	// IMP=0x001000000008bbb5
- (void)_finalizeTaskWithError:(id)arg1;	// IMP=0x001000000008b7ff
- (void)_downloadedBytes:(long long)arg1 expectedBytes:(long long)arg2;	// IMP=0x001000000008b6f8
- (void)pause;	// IMP=0x001000000008b587
- (void)cancel;	// IMP=0x001000000008b394
- (void)main;	// IMP=0x001000000008a30d
- (id)initWithDownloadID:(id)arg1 info:(id)arg2 bundleID:(id)arg3 containerID:(id)arg4;	// IMP=0x001000000008a19a
