...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x0040000000065034
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x0010000000064fd0
- (void).cxx_destruct;	// IMP=0x0020000000065084
...
- (id)init;	// IMP=0x0010000000064f2e
