...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x0040000000035a1a
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x00100000000357da
- (void).cxx_destruct;	// IMP=0x0020000000035a8f
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x001000000003569e
