...
+ (void)provideCapabilitiesToBuilder:(id)arg1;	// IMP=0x002000000002a845
- (void).cxx_destruct;	// IMP=0x002000000002aad8
...
- (id)_snapshotForTargetApplicationWithError:(id *)arg1;	// IMP=0x001000000002a6fc
- (id)_snapshotForApplicationContainingElement:(id)arg1 error:(id *)arg2;	// IMP=0x001000000002a4a9
- (void)_processKeyboardEvent:(id)arg1;	// IMP=0x001000000002a3fa
- (void)_processDeviceOrientationEvent:(id)arg1;	// IMP=0x001000000002a2e2
- (void)_recognizedGestures:(id)arg1;	// IMP=0x0010000000029c55
- (void)_recognizedEventTypeName:(id)arg1 atAbsoluteTime:(double)arg2 withStartSnapshot:(id)arg3 endSnapshot:(id)arg4;	// IMP=0x0010000000029a14
- (id)_recordedEventNames:(id)arg1 timestamp:(double)arg2 duration:(double)arg3 startLocation:(id)arg4 startElementSnapshot:(id)arg5 startApplicationSnapshot:(id)arg6 endLocation:(id)arg7 endElementSnapshot:(id)arg8 endApplicationSnapshot:(id)arg9;	// IMP=0x001000000002987d
- (void)_reportDeferredActionForEventCount:(id)arg1;	// IMP=0x00100000000297bb
- (_Bool)_reportCurrentActionWaitForTimeInterval:(double *)arg1;	// IMP=0x00100000000295cb
- (void)_processHandEvent:(id)arg1;	// IMP=0x0010000000028fe4
- (void)_processButtonUpEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000028e65
- (void)_processButtonDownEventType:(unsigned int)arg1 withHIDTime:(long long)arg2;	// IMP=0x0010000000028b7e
- (void)_processButtonUpEvent:(id)arg1;	// IMP=0x0010000000028b04
- (void)_processButtonDownEvent:(id)arg1;	// IMP=0x0010000000028a8a
- (void)_releasePendingEvents:(double)arg1;	// IMP=0x0010000000028909
- (id)stringForHandEventType:(unsigned int)arg1;	// IMP=0x0010000000028720
- (id)_elementSnapshotForLocation:(struct CGPoint)arg1 rootElementSnapshot:(id *)arg2;	// IMP=0x001000000002832f
- (void)_handleHIDEventReceived:(id)arg1;	// IMP=0x0010000000027d4c
- (void)stopRecording;	// IMP=0x0010000000027968
- (void)_registerForKeyEventNotification;	// IMP=0x00100000000274da
- (id)_nativeFocusItemDidChangeAtTime:(double)arg1 parameterSnapshot:(id)arg2 applicationSnapshot:(id)arg3;	// IMP=0x0010000000027410
- (void)_registerForNativeFocusDidChangeNotification;	// IMP=0x0010000000027046
- (void)startRecordingProcessPID:(int)arg1 applicationSnapshotAttributes:(id)arg2 applicationSnapshotParameters:(id)arg3 elementSnapshotAttributes:(id)arg4 elementSnapshotParameters:(id)arg5 simpleTargetGestureNames:(id)arg6;	// IMP=0x001000000002637b
- (void)dealloc;	// IMP=0x00100000000262b3
- (id)initWithAXManager:(id)arg1;	// IMP=0x0010000000026255
- (id)initWithError:(id *)arg1;	// IMP=0x0010000000026197
