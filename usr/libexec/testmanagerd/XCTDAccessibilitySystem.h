...
+ (id)sharedSystem;	// IMP=0x002000000000b5ac
- (void).cxx_destruct;	// IMP=0x002000000000ce24
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000000cc4d
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000000ca3d
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000000c8be
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000000c635
- (void)_queue_unloadAccessibility;	// IMP=0x001000000000c40c
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000000c215
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000000be53
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000000bae3
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000000b83c
- (void)dealloc;	// IMP=0x001000000000b73b
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x001000000000b654
