...
+ (id)configurationForDisplayID:(unsigned int)arg1 error:(id *)arg2;	// IMP=0x00200000000174b2
+ (id)sharedDisplayMonitor;	// IMP=0x001000000001745d
- (void).cxx_destruct;	// IMP=0x0020000000017d32
...
- (id)initWithDisplayID:(unsigned int)arg1;	// IMP=0x00100000000174df
