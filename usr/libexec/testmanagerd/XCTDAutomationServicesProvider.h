...
- (void).cxx_destruct;	// IMP=0x0020000000017409
...
- (id)initWithAccessibilitySystem:(id)arg1 timeout:(double)arg2 error:(id *)arg3;	// IMP=0x0010000000017227
- (id)initWithApplicationLauncher:(id)arg1 siriInterface:(id)arg2 systemConfiguration:(id)arg3 axManager:(id)arg4 touchGesturePerformer:(id)arg5;	// IMP=0x00100000000170dd
- (_Bool)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x0010000000016eaf
- (void)unloadAccessibility;	// IMP=0x0010000000016d58
- (void)invalidate;	// IMP=0x0010000000016bb2
- (void)dealloc;	// IMP=0x0010000000016a86
