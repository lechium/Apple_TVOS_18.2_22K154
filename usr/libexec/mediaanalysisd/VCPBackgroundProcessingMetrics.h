...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x00400000000b9c12
- (void).cxx_destruct;	// IMP=0x00200000000bb38e
- (int)persist;	// IMP=0x00100000000bab8b
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x00100000000ba7ef
- (int)loadMetrics;	// IMP=0x00100000000b9e0d
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000b9b90
