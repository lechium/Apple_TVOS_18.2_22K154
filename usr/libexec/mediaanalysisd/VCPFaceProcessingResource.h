...
+ (id)resourceWithResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5;	// IMP=0x00400000000d83d2
- (void).cxx_destruct;	// IMP=0x00200000000d84b2
...
- (id)initWithResource:(id)arg1 resourceURL:(id)arg2 isBestResource:(_Bool)arg3 requestDownload:(_Bool)arg4 downloadStatus:(int)arg5;	// IMP=0x00100000000d82fe
