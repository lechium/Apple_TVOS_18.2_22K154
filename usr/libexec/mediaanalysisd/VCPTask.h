...
- (void).cxx_destruct;	// IMP=0x0020000000154783
...
- (void)main;	// IMP=0x00100000001546e6
- (int)mainInternal;	// IMP=0x00100000001546db
- (_Bool)isCancelled;	// IMP=0x001000000015468b
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000001545d6
- (id)init;	// IMP=0x00100000001545c8
