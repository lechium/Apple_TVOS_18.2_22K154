...
- (unsigned long long)analyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8f4
- (void)addAnalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8e6
- (unsigned long long)analyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8d8
- (void)addAnalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8ca
- (unsigned long long)unanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8bf
- (void)addUnanalyzedWithoutResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8b4
- (unsigned long long)unanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a8a9
- (void)addUnanalyzedWithResourcesCounter:(unsigned long long)arg1;	// IMP=0x001000000005a89e
- (id)init;	// IMP=0x001000000005a83d
