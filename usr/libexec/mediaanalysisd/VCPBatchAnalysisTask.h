...
+ (id)taskWithPhotoLibrary:(id)arg1;	// IMP=0x00400000000c37f2
- (void).cxx_destruct;	// IMP=0x00200000000c4a8a
...
- (int)mainInternal;	// IMP=0x00100000000c3f49
- (_Bool)containsAsset:(id)arg1;	// IMP=0x00100000000c3cd5
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3;	// IMP=0x00100000000c3c37
- (void)addAnalysis:(unsigned long long)arg1 withExistingAnalysis:(id)arg2 forAsset:(id)arg3 allowStreaming:(_Bool)arg4;	// IMP=0x00100000000c3857
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000c3722
