...
+ (id)sharedManager;	// IMP=0x0040000000100bc1
- (void).cxx_destruct;	// IMP=0x0020000000101144
...
- (CDUnknownBlockType)getJobScheduler;	// IMP=0x0010000000101048
- (void)registerQueueGroupWithName:(id)arg1 andNumberOfQueues:(unsigned long long)arg2;	// IMP=0x0010000000100c16
- (id)init;	// IMP=0x0010000000100b3e
