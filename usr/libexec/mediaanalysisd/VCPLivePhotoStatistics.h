...
- (unsigned long long)assetCountWithLivePhotoEffectsAnalyzed;	// IMP=0x001000000005a778
- (unsigned long long)firstFailedSubClassifierCounter:(unsigned long long)arg1;	// IMP=0x001000000005a76a
- (unsigned long long)stablizeResultsCounter:(unsigned long long)arg1;	// IMP=0x001000000005a75c
- (unsigned long long)activityDecisionCounter:(unsigned long long)arg1;	// IMP=0x001000000005a74e
- (unsigned long long)gatingDecisionCounter:(unsigned long long)arg1;	// IMP=0x001000000005a743
- (void)addLivePhotoEffectsAnalyzedCount:(unsigned long long)arg1;	// IMP=0x001000000005a736
- (void)addCount:(unsigned long long)arg1 toFirstFailedSubClassifierCounter:(unsigned long long)arg2;	// IMP=0x001000000005a728
- (void)addCount:(unsigned long long)arg1 toStablizeResultsCounter:(unsigned long long)arg2;	// IMP=0x001000000005a71a
- (void)addCount:(unsigned long long)arg1 toActivityDecisionCounter:(unsigned long long)arg2;	// IMP=0x001000000005a70c
- (void)addCount:(unsigned long long)arg1 toGatingDecisionCounter:(unsigned long long)arg2;	// IMP=0x001000000005a701
- (id)init;	// IMP=0x001000000005a6a0
