...
+ (id)queryWithString:(id)arg1;	// IMP=0x00400000000c71c4
- (void).cxx_destruct;	// IMP=0x00200000000c78b9
...
- (_Bool)_bindStatement:(struct sqlite3_stmt *)arg1 withParameter:(id)arg2 atPosition:(int)arg3;	// IMP=0x00100000000c767b
- (void)bindParameters:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000c7400
- (void)bindParameter:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000c7211
