...
- (void).cxx_destruct;	// IMP=0x00200000000d7500
...
- (_Bool)eligibleForContinuationKeyAuthentication;	// IMP=0x00100000000d72ff
@property(readonly, nonatomic) NSString *passwordResetToken;
- (id)continuationToken:(id *)arg1;	// IMP=0x00100000000d69ca
- (id)authKitAccount:(id *)arg1;	// IMP=0x00100000000d682f
- (void)_clearDeviceListCacheForAltDSID:(id)arg1;	// IMP=0x00100000000d65fa
- (void)clearContinuationTokenIfSupportedWithError:(id)arg1;	// IMP=0x00100000000d6336
- (void)_addExperimentalFeaturesInfoToClientProvidedData:(id)arg1;	// IMP=0x00100000000d61a6
- (id)_anisetteHeadersFromAttestationData:(id)arg1;	// IMP=0x00100000000d5f2d
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000d41ea
- (_Bool)isContextSecretValidForSRP:(id *)arg1;	// IMP=0x00100000000d405c
- (id)initWithContext:(id)arg1;	// IMP=0x00100000000d3ff1
