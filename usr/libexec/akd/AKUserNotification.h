...
@interface AKUserNotification : NSObject
{
    ...
    MISSING_TYPE *_localizedAppsNameList;	// 56 = 0x38
}

- (void).cxx_destruct;	// IMP=0x00200000000b2eaf
...
- (id)description;	// IMP=0x00100000000b2d6d
- (id)initWithPushMessage:(id)arg1;	// IMP=0x00100000000b2c3e
