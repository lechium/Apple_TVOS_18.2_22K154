...
@interface AKTrafficClearenceRequest : NSObject
{
    ...
    CDUnknownBlockType _clearanceHandler;	// 32 = 0x20
    NSString *_clientBundleID;	// 40 = 0x28
    NSDate *_requestDate;	// 48 = 0x30
}

- (void).cxx_destruct;	// IMP=0x00200000000b96f9
...
- (id)description;	// IMP=0x00100000000b9597
- (id)init;	// IMP=0x00100000000b9529
