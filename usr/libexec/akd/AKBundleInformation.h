...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000780c8
- (void).cxx_destruct;	// IMP=0x0020000000078102
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000078025
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000077e4d
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000077d76
- (id)initWithBundleIdentifier:(id)arg1 bundleName:(id)arg2 bundleDescription:(id)arg3 bundleType:(unsigned long long)arg4 otherInfo:(id)arg5;	// IMP=0x0010000000077c8d
