...
- (void).cxx_destruct;	// IMP=0x0020000000065a45
...
- (void)_handleFoundDevice:(id)arg1;	// IMP=0x001000000006589d
- (void)authorizationEndorserRapportClientDidFinish:(id)arg1;	// IMP=0x001000000006588b
- (void)deactivate;	// IMP=0x00100000000657fd
- (_Bool)activateWithError:(id *)arg1;	// IMP=0x0010000000065785
- (id)initWithClient:(id)arg1;	// IMP=0x001000000006571a
