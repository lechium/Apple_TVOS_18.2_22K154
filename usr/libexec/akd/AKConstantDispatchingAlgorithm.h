...
- (void)_decrementQueueSize;	// IMP=0x001000000002327f
- (_Bool)_incrementQueueSize;	// IMP=0x001000000002325e
@property(readonly, copy) NSString *debugDescription;
// Preceding property had unknown attributes: ?
// Original attribute string: T@"NSString",?,R,C

@property(readonly, copy) NSString *description;
- (id)nextCalculation;	// IMP=0x0010000000023063
- (id)initWithDelay:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x0010000000023017
