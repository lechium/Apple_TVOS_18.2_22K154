...
@class AKAccountRecoveryContext, AKAppleIDAuthenticationContext, AKCircleRequestContext, AKDeviceListRequestContext, AKFollowUpTearDownContext, AKPersistRecoveryKeyContext, AKUserInformation, NSArray, NSDictionary, NSHTTPURLResponse, NSNumber, NSString;
...
- (void)performRemoveEdpTokenWithAltDSID:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)performEdpCompleteKeyDropWithAltDSID:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)performEdpMigrationWithAltDSID:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)fetchBirthdayForAltDSID:(NSString *)arg1 completion:(void (^)(NSNumber *, NSNumber *, NSError *))arg2;
- (void)deleteTokensFromCacheWithAltDSID:(NSString *)arg1 tokenIdentifiers:(NSArray *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
- (void)fetchTokensWithAltDSID:(NSString *)arg1 tokenIdentifiers:(NSArray *)arg2 completion:(void (^)(NSDictionary *, NSError *))arg3;
...
- (void)persistRecoveryKeyWithContext:(AKPersistRecoveryKeyContext *)arg1 authContext:(AKAppleIDAuthenticationContext *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)performCheckInForAccountWithAltDSID:(NSString *)arg1 event:(NSString *)arg2 reason:(unsigned long long)arg3 completion:(void (^)(NSError *))arg4;
- (void)performCheckInForAccountWithAltDSID:(NSString *)arg1 event:(NSString *)arg2 completion:(void (^)(NSError *))arg3;
