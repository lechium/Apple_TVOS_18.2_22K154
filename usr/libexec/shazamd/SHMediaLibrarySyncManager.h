...
- (void)updateSnapshotWithAttribution:(id)arg1;	// IMP=0x001000000000742a
- (void)shutdownWorker;	// IMP=0x00100000000073ba
- (void)finishSyncing;	// IMP=0x00100000000072e3
- (void)_libraryDidCompleteSync:(id)arg1;	// IMP=0x0010000000007184
- (void)_library:(id)arg1 didProduceError:(id)arg2 failedItemIdentifiers:(id)arg3;	// IMP=0x0010000000007066
- (void)_library:(id)arg1 didChangeWithSnapshot:(id)arg2;	// IMP=0x0010000000006e44
- (void)_libraryWillBeginSync:(id)arg1;	// IMP=0x0010000000006df8
- (void)_synchronizeSnapshot:(id)arg1 startCondition:(id)arg2 controller:(id)arg3;	// IMP=0x0010000000006d02
- (void)_synchronizeSnapshot:(id)arg1 startCondition:(id)arg2;	// IMP=0x00100000000067ba
- (id)initWithClient:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000006716
