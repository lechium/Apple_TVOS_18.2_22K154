...
- (void).cxx_destruct;	// IMP=0x002000000001d836
@property(retain, nonatomic) NSDictionary *lyricsDictionary; // @synthesize lyricsDictionary=_lyricsDictionary;
- (id)itemForIdentifiers:(id)arg1;	// IMP=0x001000000001d5d7
- (id)initWithLyricsDictionary:(id)arg1;	// IMP=0x001000000001d56c
