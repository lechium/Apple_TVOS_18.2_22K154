...
- (void).cxx_destruct;	// IMP=0x0020000000010064
...
- (void)matcher:(id)arg1 didProduceResponse:(id)arg2;	// IMP=0x001000000000ff92
- (void)_stop;	// IMP=0x001000000000fee3
- (void)stopRecognitionForRequestID:(id)arg1;	// IMP=0x001000000000fd76
- (void)stopRecognition;	// IMP=0x001000000000fd08
- (void)startRecognitionForRequest:(id)arg1;	// IMP=0x001000000000fc56
- (id)initWithRunnerMatcher:(id)arg1;	// IMP=0x001000000000fbeb
