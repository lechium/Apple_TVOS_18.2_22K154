...
@class MISSING_TYPE, NSProgress, NSString, SHLSyncSession;
...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002b721
- (void).cxx_destruct;	// IMP=0x002000000002b7c7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002b69c
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002b5b5
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x001000000002b4d2
