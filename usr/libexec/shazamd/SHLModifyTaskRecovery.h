...
- (void).cxx_destruct;	// IMP=0x000000000003048b
...
- (id)recoverTaskFromLimitExceededError;	// IMP=0x00100000000303ad
- (id)recoverTaskFromPartialError;	// IMP=0x001000000002ffaf
@property(readonly, nonatomic) NSArray *recoverableTasks;
- (id)initWithOriginalTask:(id)arg1 savedGroups:(id)arg2 savedTracks:(id)arg3 deletedIDs:(id)arg4 error:(id)arg5;	// IMP=0x001000000002fcfb
