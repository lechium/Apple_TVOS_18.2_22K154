...
- (void).cxx_destruct;	// IMP=0x00200000000417e7
...
- (_Bool)isEntitledForSource:(long long)arg1;	// IMP=0x001000000004168b
@property(readonly, nonatomic) long long clientType;
- (id)initWithEntitlements:(id)arg1 attribution:(id)arg2;	// IMP=0x00100000000415a5
- (id)initWithConnection:(id)arg1;	// IMP=0x0010000000041501
