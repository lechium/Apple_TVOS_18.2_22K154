...
+ (void)powerlogCallingProcessBundleID:(id)arg1 startDate:(id)arg2 endDate:(id)arg3;	// IMP=0x0040000000031a8b
- (void).cxx_destruct;	// IMP=0x0020000000031ac3
...
- (void)detachedTapForClient:(long long)arg1;	// IMP=0x001000000003196e
- (void)attachedTapForClient:(long long)arg1;	// IMP=0x00100000000318e5
- (id)initWithBundleID:(id)arg1;	// IMP=0x001000000003187a
