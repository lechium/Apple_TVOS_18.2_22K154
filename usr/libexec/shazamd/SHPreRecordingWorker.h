...
- (void).cxx_destruct;	// IMP=0x0020000000010958
...
- (void)shutdownWorker;	// IMP=0x00100000000106f0
- (void)stopAfterTransferingBuffers;	// IMP=0x0010000000010620
...
- (void)startRecordingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000001026c
- (id)initWithRequestID:(id)arg1 audioTapProvider:(id)arg2;	// IMP=0x0010000000010125
