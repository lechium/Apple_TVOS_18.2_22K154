...
+ (_Bool)validateClientIdentifier:(id)arg1;	// IMP=0x0040000000017721
- (void).cxx_destruct;	// IMP=0x00200000000177ba
...
- (id)_createMatcher;	// IMP=0x00100000000176eb
- (void)loadContext:(CDUnknownBlockType)arg1;	// IMP=0x0010000000017661
- (void)loadConfiguration:(CDUnknownBlockType)arg1;	// IMP=0x001000000001759d
- (id)_initWithConfiguration:(id)arg1 installationID:(id)arg2;	// IMP=0x0010000000017540
- (id)initWithClientIdentifier:(id)arg1 clientType:(long long)arg2 installationID:(id)arg3;	// IMP=0x0010000000017378
