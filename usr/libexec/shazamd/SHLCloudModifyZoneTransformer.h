...
- (void).cxx_destruct;	// IMP=0x002000000004f532
...
- (id)recordZonesFromCloudBackedZones:(id)arg1;	// IMP=0x001000000004f323
- (id)cloudBackedOperationForZonesToSave:(id)arg1 container:(id)arg2;	// IMP=0x001000000004ed11
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000004ec8c
