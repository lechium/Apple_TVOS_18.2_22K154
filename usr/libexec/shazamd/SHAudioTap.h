...
- (void).cxx_destruct;	// IMP=0x0020000000012842
...
- (id)initWithRecordingSource:(long long)arg1 client:(long long)arg2 bundleIdentifier:(id)arg3 canEnableSpectralOutput:(_Bool)arg4;	// IMP=0x0010000000012777
- (id)initWithRecordingSource:(long long)arg1 client:(long long)arg2 bundleIdentifier:(id)arg3;	// IMP=0x0010000000012762
