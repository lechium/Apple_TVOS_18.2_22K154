...
- (void).cxx_destruct;	// IMP=0x002000000001b1bd
...
- (id)initWithType:(long long)arg1 scope:(long long)arg2 callingProcessIdentifier:(id)arg3 sessionIdentifier:(id)arg4;	// IMP=0x001000000001b0e7
