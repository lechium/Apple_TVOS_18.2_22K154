...
- (void).cxx_destruct;	// IMP=0x0020000000032eb2
...
- (_Bool)cloudBackedZones:(id)arg1 containsZone:(id)arg2;	// IMP=0x0010000000032be5
- (void)scheduleFetchTask:(id)arg1;	// IMP=0x0010000000031d64
@property(readonly, nonatomic) NSArray *preconditions;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0010000000031af6
