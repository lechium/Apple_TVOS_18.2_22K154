...
- (void).cxx_destruct;	// IMP=0x002000000004880c
...
- (id)associatedMatcherControllerForRequest:(id)arg1;	// IMP=0x001000000004870f
- (id)catalogForRequest:(id)arg1;	// IMP=0x00100000000485ef
- (id)matcherControllerForRequest:(id)arg1;	// IMP=0x0010000000047f1c
- (id)initWithAudioTapProvider:(id)arg1 attribution:(id)arg2 clientType:(long long)arg3;	// IMP=0x0010000000047e4e
