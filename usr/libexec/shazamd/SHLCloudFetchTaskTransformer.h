...
- (void).cxx_destruct;	// IMP=0x002000000004b34b
...
- (id)configurationsByRecordZoneIDUsingCache:(id)arg1;	// IMP=0x001000000004af57
- (id)recordIDsFromCloudBackedZones:(id)arg1;	// IMP=0x001000000004ad2b
- (id)cloudBackedZoneChangesOperationFromFetchTask:(id)arg1 forChangedZones:(id)arg2 container:(id)arg3;	// IMP=0x0010000000049c06
- (id)cloudBackedDatabaseChangesOperationFromFetchTask:(id)arg1 container:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000489ee
- (id)initWithConfiguration:(id)arg1;	// IMP=0x001000000004891a
