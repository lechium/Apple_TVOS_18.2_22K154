...
- (void)run;	// IMP=0x002000000010cc9c
@property(readonly) long long numberOfBytesToHash;
@property(readonly) NSArray *hashes;
@property(readonly) NSString *filePath;
- (void)dealloc;	// IMP=0x001000000010cbf7
- (id)initWithFilePath:(id)arg1 hashes:(id)arg2 bytesToHash:(long long)arg3;	// IMP=0x001000000010cb61
