...
- (void).cxx_destruct;	// IMP=0x00200000000c7b86
...
- (_Bool)_shouldSkipInitialDialog:(id)arg1;	// IMP=0x00100000000c73ac
- (_Bool)_shouldAuthenticateForButton:(id)arg1;	// IMP=0x00100000000c72ea
- (_Bool)_isLocalizationAlreadyConfiguredForAuthContext:(id)arg1;	// IMP=0x00100000000c7240
- (void)_handleSelectedButton:(id)arg1;	// IMP=0x00100000000c6f61
- (_Bool)_copySelectedButton:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000c6c3b
- (id)_copyButtonToSkipDialog:(id)arg1;	// IMP=0x00100000000c6a90
- (id)_copyAuthenticationContext;	// IMP=0x00100000000c601d
- (_Bool)_copyAccountIdentifier:(id *)arg1 returningError:(id *)arg2;	// IMP=0x00100000000c5bca
- (void)run;	// IMP=0x00100000000c5651
...
- (id)initWithDialog:(id)arg1;	// IMP=0x00100000000c530f
- (id)init;	// IMP=0x00100000000c50d7
