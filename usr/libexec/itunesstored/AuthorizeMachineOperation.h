...
- (void)_setResponse:(id)arg1;	// IMP=0x002000000008ddd0
- (_Bool)_runAuthorizationWithAuthentication:(_Bool)arg1 error:(id *)arg2;	// IMP=0x001000000008d767
- (_Bool)_runAuthentication:(id *)arg1;	// IMP=0x001000000008d549
- (void)_run;	// IMP=0x001000000008d032
- (id)_newURLOperation;	// IMP=0x001000000008cdb6
- (id)_newMachineDataOperationWithResponse:(id)arg1;	// IMP=0x001000000008cd04
- (id)_newBodyDictionary;	// IMP=0x001000000008cb89
- (id)_newAuthenticationContext;	// IMP=0x001000000008ca5e
- (_Bool)_handleResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008c7e2
- (id)_accountIdentifier;	// IMP=0x001000000008c78d
- (void)run;	// IMP=0x001000000008c753
...
- (void)dealloc;	// IMP=0x001000000008bfbe
- (id)initWithAuthorizationRequest:(id)arg1;	// IMP=0x001000000008be9a
