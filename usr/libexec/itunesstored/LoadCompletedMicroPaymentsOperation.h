...
- (void).cxx_destruct;	// IMP=0x0020000000066cdf
- (void)_runForIdentity:(id)arg1;	// IMP=0x0010000000066267
- (id)_newFetchOperationForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3;	// IMP=0x0010000000065cf5
- (id)_copyResponseForIdentity:(id)arg1 startID:(id)arg2 endID:(id)arg3 returningError:(id *)arg4;	// IMP=0x0010000000065ac8
- (void)run;	// IMP=0x00100000000656c5
