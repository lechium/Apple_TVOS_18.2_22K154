...
- (void).cxx_destruct;	// IMP=0x002000000010eebd
- (long long)_keyboardType;	// IMP=0x001000000010ee5a
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x001000000010ee45
- (void)run;	// IMP=0x001000000010eda2
@property(copy) CDUnknownBlockType tokenBlock;
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x001000000010e99e
