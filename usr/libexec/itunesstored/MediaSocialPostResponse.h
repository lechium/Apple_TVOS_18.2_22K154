...
+ (id)_unrecoverableErrors;	// IMP=0x002000000014122e
- (void).cxx_destruct;	// IMP=0x002000000014137c
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x00100000001411b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000141103
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x0010000000140ceb
