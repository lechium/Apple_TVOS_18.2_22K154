...
- (void).cxx_destruct;	// IMP=0x002000000018ff6a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018fe04
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x001000000018fb21
