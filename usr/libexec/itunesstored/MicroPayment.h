...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x004000000003f393
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x001000000003f346
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x0010000000040613
- (id)_temporaryIdentifier;	// IMP=0x00100000000405c4
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x0010000000040568
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x00100000000404e1
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x0010000000040103
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x001000000004001c
- (void)setFailedWithError:(id)arg1;	// IMP=0x001000000003ff4c
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x001000000003fb6d
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x001000000003f977
- (id)copyPaymentTransaction;	// IMP=0x001000000003f3df
- (void)dealloc;	// IMP=0x001000000003f2f8
