...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00200000000997b7
- (void)run;	// IMP=0x00100000000991f3
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x001000000009909b
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x0010000000099013
- (id)init;	// IMP=0x0010000000098ffd
