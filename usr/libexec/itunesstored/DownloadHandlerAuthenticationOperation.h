...
- (void)_setURLCredential:(id)arg1;	// IMP=0x002000000017ed0f
- (void)_setState:(long long)arg1;	// IMP=0x001000000017ecc0
- (id)_openSession;	// IMP=0x001000000017ea4c
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x001000000017e879
- (void)run;	// IMP=0x001000000017e35e
- (void)cancel;	// IMP=0x001000000017e2d6
...
- (void)dealloc;	// IMP=0x001000000017e0f5
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x001000000017e085
