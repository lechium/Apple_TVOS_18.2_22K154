...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x002000000019972c
+ (void)initialize;	// IMP=0x00100000001996fe
...
- (id)description;	// IMP=0x0010000000199ecb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000199dcb
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x0010000000199b3e
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x001000000019997e
- (void)dealloc;	// IMP=0x0010000000199911
