...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001087f0
- (_Bool)representsDownloadWithIdentifier:(long long)arg1;	// IMP=0x001000000010878f
- (void)removeDownloadIdentifier:(long long)arg1;	// IMP=0x0010000000108735
- (void)performActionForResponseFlags:(unsigned long long)arg1;	// IMP=0x001000000010872f
...
- (id)copyUserNotification;	// IMP=0x0010000000108701
- (_Bool)canCoalesceWithError:(id)arg1;	// IMP=0x00100000001086f9
- (void)addDownloadIdentifiers:(id)arg1;	// IMP=0x00100000001086bc
- (void)addDownloadIdentifier:(long long)arg1;	// IMP=0x001000000010864b
- (void)dealloc;	// IMP=0x00100000001085f3
