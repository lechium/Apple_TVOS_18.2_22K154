...
- (void).cxx_destruct;	// IMP=0x0020000000190acb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019068e
- (id)description;	// IMP=0x0010000000190640
- (id)initWithAppAdamId:(id)arg1 transactionId:(id)arg2 campaignId:(id)arg3 adNetworkId:(id)arg4 attributionSignature:(id)arg5 pingbackUrl:(id)arg6 retryCount:(long long)arg7 localTimestamp:(id)arg8;	// IMP=0x001000000019025e
