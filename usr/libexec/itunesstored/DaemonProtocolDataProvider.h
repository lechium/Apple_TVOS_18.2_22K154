...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001a2342
- (void)_presentDialog:(id)arg1;	// IMP=0x00100000001a22ae
- (void)dealloc;	// IMP=0x00100000001a226c
