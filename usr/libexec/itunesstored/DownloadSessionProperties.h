...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000266bc
- (unsigned long long)hash;	// IMP=0x00100000000266b2
- (id)description;	// IMP=0x001000000002664c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002658c
- (void)dealloc;	// IMP=0x0010000000026534
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x00100000000264d2
