...
- (id)description;	// IMP=0x0020000000025f74
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0010000000025af9
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x00100000000256ed
- (void)dealloc;	// IMP=0x0010000000025695
- (id)initWithInputConnection:(id)arg1;	// IMP=0x001000000002564b
