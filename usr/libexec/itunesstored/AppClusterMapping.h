...
- (void).cxx_destruct;	// IMP=0x00200000001ce9da
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00100000001ce8ae
- (id)description;	// IMP=0x00100000001ce796
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00100000001ce68a
