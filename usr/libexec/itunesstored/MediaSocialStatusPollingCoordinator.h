...
- (void).cxx_destruct;	// IMP=0x00200000001cb016
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00100000001ca934
- (void)_addBackgroundTaskJob;	// IMP=0x00100000001ca92e
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00100000001ca928
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00100000001ca90c
- (void)dealloc;	// IMP=0x00100000001ca8dd
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00100000001ca80e
