...
- (_Bool)_loadResponseWithAccountIdentifier:(id)arg1 URL:(id)arg2 error:(id *)arg3;	// IMP=0x0020000000080096
- (void)run;	// IMP=0x001000000007f7fe
@property(copy) NSString *userAgent;
@property(readonly) SSURLConnectionResponse *URLResponse;
- (void)dealloc;	// IMP=0x001000000007f695
- (id)initWithPushNotificationParameters:(id)arg1;	// IMP=0x001000000007f637
