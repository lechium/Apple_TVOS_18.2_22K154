...
- (void)_setInsertedItemPersistentIdentifier:(long long)arg1;	// IMP=0x002000000009e339
- (id)_libraryItem;	// IMP=0x001000000009e2e4
- (void)run;	// IMP=0x001000000009e0e6
@property(readonly) NSNumber *insertedItemPersistentIdentifier;
@property(readonly) IPodLibraryItem *IPodLibraryItem;
- (void)dealloc;	// IMP=0x001000000009dfe0
- (id)initWithIPodLibraryItem:(id)arg1;	// IMP=0x001000000009df82
