...
+ (void)initialize;	// IMP=0x00200000000b3a53
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b39b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000b388d
- (unsigned long long)hash;	// IMP=0x00100000000b3877
- (id)description;	// IMP=0x00100000000b3817
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000b3764
