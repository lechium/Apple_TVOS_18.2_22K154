...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x0040000000062616
...
- (id)copyProduct;	// IMP=0x001000000006221e
- (void)dealloc;	// IMP=0x001000000006219c
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000061ab4
