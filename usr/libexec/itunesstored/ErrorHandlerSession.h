...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001a11f6
- (unsigned long long)hash;	// IMP=0x00100000001a11ec
- (id)valueForSessionProperty:(id)arg1;	// IMP=0x00100000001a11c5
- (void)setValue:(id)arg1 forSessionProperty:(id)arg2;	// IMP=0x00100000001a115a
- (void)dealloc;	// IMP=0x00100000001a111f
- (id)init;	// IMP=0x00100000001a10c1
