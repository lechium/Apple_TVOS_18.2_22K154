...
- (void).cxx_destruct;	// IMP=0x00200000000f63c0
...
- (void)run;	// IMP=0x00100000000f631e
- (id)initWithAccountIdentifier:(id)arg1 rentalKeyIdentifier:(id)arg2;	// IMP=0x00100000000f6257
