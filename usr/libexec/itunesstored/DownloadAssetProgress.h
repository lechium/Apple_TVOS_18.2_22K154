...
- (void).cxx_destruct;	// IMP=0x00200000001d0070
...
- (id)_newProgressForMediaSelection:(id)arg1;	// IMP=0x00100000001cff06
- (void)setMediaSelectionDidComplete:(id)arg1;	// IMP=0x00100000001cfefc
- (void)setProgress:(double)arg1 forMediaSelection:(id)arg2;	// IMP=0x00100000001cfd6f
@property(readonly, nonatomic) double progress;
- (id)init;	// IMP=0x00100000001cfcf3
