...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000176f68
- (void)dealloc;	// IMP=0x0010000000176f1e
- (id)initWithPolicyIdentifiers:(id)arg1;	// IMP=0x0010000000176ec7
