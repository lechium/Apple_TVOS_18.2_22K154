...
- (void).cxx_destruct;	// IMP=0x002000000007aaca
...
- (id)initWithIdentifier:(id)arg1 keyIdentifier:(id)arg2 nonce:(id)arg3 signature:(id)arg4 timestamp:(id)arg5;	// IMP=0x001000000007a7be
