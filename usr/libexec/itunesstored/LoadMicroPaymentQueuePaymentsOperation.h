...
- (_Bool)_parsePropertyList:(id)arg1 error:(id *)arg2;	// IMP=0x001000000008479e
- (_Bool)_loadResponseReturningError:(id *)arg1;	// IMP=0x00100000000844bc
- (_Bool)_appendRangeRequestsToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000084255
- (void)run;	// IMP=0x00100000000841f3
- (void)dealloc;	// IMP=0x001000000008418d
