...
- (void)addRefreshed:(id)arg1;	// IMP=0x001000000010e8d9
- (void)addRevoked:(id)arg1;	// IMP=0x001000000010e87d
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000010e79f
- (void)dealloc;	// IMP=0x001000000010e739
