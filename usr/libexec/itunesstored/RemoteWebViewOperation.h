...
- (void).cxx_destruct;	// IMP=0x0020000000173652
- (void)setDidActivate:(_Bool)arg1;	// IMP=0x0010000000173642
- (_Bool)didActivate;	// IMP=0x0010000000173632
...
- (void)_sendActivationWithError:(id)arg1;	// IMP=0x001000000017349d
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x001000000017329c
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x00100000001730c8
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x0010000000172f04
- (void)run;	// IMP=0x0010000000172a53
- (id)initWithWebViewRequest:(id)arg1;	// IMP=0x00100000001729c2
