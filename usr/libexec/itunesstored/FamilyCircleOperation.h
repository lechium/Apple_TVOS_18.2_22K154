...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000010ab8
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x0010000000010152
- (id)_cachePath;	// IMP=0x00100000000100c6
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x001000000000fed2
- (void)run;	// IMP=0x001000000000f929
- (void)dealloc;	// IMP=0x001000000000f8c3
