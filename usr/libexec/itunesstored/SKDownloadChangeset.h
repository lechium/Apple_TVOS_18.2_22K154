...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000012c81
- (void).cxx_destruct;	// IMP=0x00200000000131b5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000012fe9
- (id)copyXPCEncoding;	// IMP=0x0010000000012f2c
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000012d1f
