...
+ (double)_randomDouble;	// IMP=0x0020000000024736
+ (void)reportAnonymousPings:(id)arg1;	// IMP=0x0010000000017b8d
- (void).cxx_destruct;	// IMP=0x002000000002532d
...
- (id)_URLBagContext;	// IMP=0x0010000000024feb
- (_Bool)_shouldUseClientAuthentication;	// IMP=0x0010000000024b09
- (_Bool)_shouldSendSBSyncData;	// IMP=0x0010000000024a53
- (_Bool)_shouldSendKeyBagSyncData;	// IMP=0x001000000002485e
- (void)_setMoveToiOS;	// IMP=0x0010000000024770
- (_Bool)_shouldDisableReversePush;	// IMP=0x001000000002436f
- (void)_setChangedBuyParameters:(id)arg1 fromDataProvider:(id)arg2;	// IMP=0x0010000000024205
- (void)_scoreDeviceRetryFailedV2Score;	// IMP=0x0010000000023d05
- (void)_scoreDevice;	// IMP=0x001000000002341d
- (void)_runPurchaseRequest;	// IMP=0x00100000000225c1
- (void)_runDialogOperationForDialog:(id)arg1;	// IMP=0x001000000002034b
- (id)_recordEngagementEventWithResult:(id)arg1 error:(id)arg2;	// IMP=0x001000000001f964
- (long long)_purchaseType;	// IMP=0x001000000001f895
- (id)_priceFromBuyParams;	// IMP=0x001000000001f78f
- (void)_performAutoEnrollmentCheck;	// IMP=0x001000000001f5e1
- (void)_performApplePayClassicCheck;	// IMP=0x001000000001f433
- (void)_performMachineDataActionForURLResponse:(id)arg1;	// IMP=0x001000000001ef86
- (void)_performDelayedGotoForOperation:(id)arg1;	// IMP=0x001000000001edfe
- (id)_newRequestParameters;	// IMP=0x001000000001e5bb
- (id)_newPurchaseRequestOperation;	// IMP=0x001000000001cb85
- (void)_handleFailureForOperation:(id)arg1;	// IMP=0x001000000001bb8d
- (id)_fairPlaySubscriptionController;	// IMP=0x001000000001bb31
- (id);	// IMP=0x001000000001ba9e
- (id)_countryCode;	// IMP=0x001000000001b697
- (void)_continueTouchIDSessionWithDialog:(id)arg1;	// IMP=0x001000000001b46c
- (_Bool)_clientIsViewService;	// IMP=0x001000000001b2f1
- (id)_buyParamProductType;	// IMP=0x001000000001b077
- (void)_addFairPlayToRequestProperties:(id)arg1 withAccountIdentifier:(unsigned long long)arg2;	// IMP=0x001000000001b071
- (id)_accountWithUniqueIdentifier:(id)arg1;	// IMP=0x001000000001af55
- (id)_account;	// IMP=0x001000000001ae1d
- (void)sender:(id)arg1 willSendChallenge:(id)arg2 andSignature:(id)arg3 andPaymentTokenData:(id)arg4 andFpanID:(id)arg5 isExtendedAction:(_Bool)arg6 isPayment:(_Bool)arg7 additionalHeaders:(id)arg8;	// IMP=0x001000000001ac00
- (void)sender:(id)arg1 shouldContinueTouchIDSession:(_Bool)arg2;	// IMP=0x001000000001abe1
- (void)sender:(id)arg1 didFallbackToPassword:(_Bool)arg2;	// IMP=0x001000000001abc2
- (void)operation:(id)arg1 willSendRequest:(id)arg2;	// IMP=0x001000000001ab04
- (void)operation:(id)arg1 shouldAuthenticateWithContext:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001aa04
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x001000000001a695
- (id)uniqueKey;	// IMP=0x001000000001a688
- (void)run;	// IMP=0x00100000000188f7
- (id)authenticatedAccountDSID;	// IMP=0x0010000000018888
...
- (id)initWithPurchase:(id)arg1;	// IMP=0x0010000000017699
- (id)init;	// IMP=0x0010000000017685
