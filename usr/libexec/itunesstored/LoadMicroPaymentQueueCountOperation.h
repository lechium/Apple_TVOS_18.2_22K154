...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000081fa8
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x0010000000081cc6
- (void)run;	// IMP=0x0010000000081a0b
- (void)dealloc;	// IMP=0x00100000000819a5
