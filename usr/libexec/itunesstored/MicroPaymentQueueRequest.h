...
- (id)_ntsQueryParameters:(id *)arg1;	// IMP=0x0020000000082be6
- (id)_copyApplicationIdentity:(id *)arg1;	// IMP=0x0010000000082973
- (id)description;	// IMP=0x00100000000828cb
...
- (id)newStoreURLOperation:(id *)arg1;	// IMP=0x0010000000082437
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000008232b
- (void)dealloc;	// IMP=0x00100000000822cc
- (id)init;	// IMP=0x0010000000082280
