...
- (void).cxx_destruct;	// IMP=0x002000000006c10c
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x001000000006ba8f
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x001000000006ac1c
- (void)run;	// IMP=0x001000000006ab7e
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x001000000006a9d7
