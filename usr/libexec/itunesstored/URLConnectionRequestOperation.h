...
- (_Bool)_shouldSendMachineDataHeadersForProperties:(id)arg1;	// IMP=0x00200000001c1a35
- (id)_newStoreURLOperationWithProperties:(id)arg1;	// IMP=0x00100000001c18d1
- (id)_metricsPageEventWithResponse:(id)arg1 performance:(id)arg2;	// IMP=0x00100000001c1759
- (void)_importKeybagFromDictionary:(id)arg1;	// IMP=0x00100000001c16f4
- (void)_addKBSyncDataToRequestProperties:(id)arg1 forAccountID:(id)arg2;	// IMP=0x00100000001c16ee
- (id)_accountIdentifier;	// IMP=0x00100000001c168d
- (void)operation:(id)arg1 didAuthenticateWithDSID:(id)arg2;	// IMP=0x00100000001c1687
- (void)run;	// IMP=0x00100000001c1047
...
- (void)dealloc;	// IMP=0x00100000001c0ce0
- (id)initWithRequestProperties:(id)arg1;	// IMP=0x00100000001c0c82
