...
- (void).cxx_destruct;	// IMP=0x00200000000d61c9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d60d5
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000d607b
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000d6021
- (id)init;	// IMP=0x00100000000d5fac
