...
+ (id)propertiesForDownloadEntities;	// IMP=0x00400000001866c9
+ (id)downloadEntityFromContext:(id)arg1;	// IMP=0x001000000018667c
- (void)awakeFromInsert;	// IMP=0x0020000000186ba8
- (void)setValuesWithAssetDictionary:(id)arg1;	// IMP=0x0010000000186883
- (id)copySKDownload;	// IMP=0x0010000000186734
