...
- (void).cxx_destruct;	// IMP=0x002000000009cbf5
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009c9fe
- (id)copyXPCEncoding;	// IMP=0x001000000009c90d
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x001000000009c731
