...
- (void).cxx_destruct;	// IMP=0x0020000000042edb
...
- (id)_fullBuyParametersWithAppProxy:(id)arg1;	// IMP=0x00100000000424da
- (id)_appProxy;	// IMP=0x001000000004209b
- (void)run;	// IMP=0x00100000000413f9
- (_Bool)purchaseOperation:(id)arg1 shouldContinueWithNewStorefront:(id)arg2;	// IMP=0x0010000000041311
...
- (void)setClientAuditTokenData:(id)arg1;	// IMP=0x0010000000040fde
...
- (id)clientAuditTokenData;	// IMP=0x0010000000040c21
