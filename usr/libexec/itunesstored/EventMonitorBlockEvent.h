...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000126a5a
- (void)performAction;	// IMP=0x0010000000126a40
- (_Bool)hasOccurred;	// IMP=0x0000000000126a24
- (void)dealloc;	// IMP=0x00100000001269cc
