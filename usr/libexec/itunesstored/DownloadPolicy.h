...
+ (id)defaultProperties;	// IMP=0x0020000000175a3d
+ (Class)databaseEntityClass;	// IMP=0x0010000000175a2c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0020000000175a64
@property(copy, nonatomic) NSData *policyData;
@property(readonly, nonatomic) SSDownloadPolicy *downloadPolicy;
- (void)dealloc;	// IMP=0x0010000000175791
