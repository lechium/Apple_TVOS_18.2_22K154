...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00100000001900ef
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00100000001900c8
- (void)dealloc;	// IMP=0x0010000000190070
