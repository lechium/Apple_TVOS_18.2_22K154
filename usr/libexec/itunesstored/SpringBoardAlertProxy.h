...
- (void).cxx_destruct;	// IMP=0x002000000004b2eb
@property(readonly) NSObject<OS_xpc_object> *XPCEndpoint; // @synthesize XPCEndpoint=_inputEndpoint;
- (void)_handleMessage:(id)arg1 connection:(id)arg2;	// IMP=0x001000000004b12f
- (void)_disconnect;	// IMP=0x001000000004b016
@property __weak id <SpringBoardAlertProxyDelegate> delegate;
- (void)sendMessage:(id)arg1;	// IMP=0x001000000004aec5
- (void)dealloc;	// IMP=0x000000000004ad59
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000004a9d9
