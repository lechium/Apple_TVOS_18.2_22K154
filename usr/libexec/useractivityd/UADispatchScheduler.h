...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x004000000002cc3a
...
- (id)nextRunTimeString;	// IMP=0x001000000002db7f
- (void)waitUntilComplete;	// IMP=0x001000000002dafb
- (void)suspend;	// IMP=0x001000000002da85
- (void)resume;	// IMP=0x001000000002da50
- (void)reset;	// IMP=0x001000000002d889
- (void)updateFrequency:(double)arg1;	// IMP=0x001000000002d69e
- (void)_doIt;	// IMP=0x001000000002d3b6
- (void)doIt;	// IMP=0x001000000002d32f
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x001000000002d2c7
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x001000000002ccf5
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x001000000002c91d
