...
- (id)debugDescription;	// IMP=0x00100000000827b5
- (id)description;	// IMP=0x00100000000826c9
- (const char *)objCType;	// IMP=0x00100000000826bc
- (void)getValue:(void *)arg1;	// IMP=0x001000000008269f
...
- (id)initWithAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0010000000082398
