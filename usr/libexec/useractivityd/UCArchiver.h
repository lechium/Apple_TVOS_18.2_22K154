...
- (void).cxx_destruct;	// IMP=0x002000000007c047
@property(retain) NSUUID *uuid; // @synthesize uuid=_uuid;
@property(retain) NSString *leaf; // @synthesize leaf=_leaf;
@property(retain) NSURL *baseURL; // @synthesize baseURL=_baseURL;
- (void)archiveURLWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000007bfce
- (id)initWithURL:(id)arg1 typeUUID:(id)arg2;	// IMP=0x001000000007beae
