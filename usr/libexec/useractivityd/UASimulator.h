...
+ (id)simulatorWithController:(id)arg1 parentSimulatorPortName:(id)arg2;	// IMP=0x0020000000092983
+ (id)simulatorWithController:(id)arg1 pairedPort:(unsigned int)arg2 childSimPid:(int)arg3 childVersion:(unsigned long long)arg4;	// IMP=0x001000000009297b
- (void).cxx_destruct;	// IMP=0x00200000000941ce
...
- (id)statusString;	// IMP=0x0010000000094028
- (_Bool)terminate;	// IMP=0x0010000000093d49
- (_Bool)suspend;	// IMP=0x0010000000093c5c
- (_Bool)resume;	// IMP=0x0010000000093b6f
- (void)setSimulatorInFront:(_Bool)arg1;	// IMP=0x00100000000939cd
- (_Bool)active;	// IMP=0x001000000009399a
@property(copy) NSSet *notifiedItems;
@property(readonly) unsigned int pairedClientPort; // @dynamic pairedClientPort;
- (_Bool)reconnectToParentSimulator;	// IMP=0x0010000000092d0d
- (void)dealloc;	// IMP=0x0010000000092c5b
- (id)initWithController:(id)arg1;	// IMP=0x0010000000092260
