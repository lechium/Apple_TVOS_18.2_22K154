...
- (void).cxx_destruct;	// IMP=0x002000000002f54a
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002f02d
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e168
- (void)dealloc;	// IMP=0x001000000002e023
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002deb2
- (id)stateAsString;	// IMP=0x001000000002de80
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002dcc6
