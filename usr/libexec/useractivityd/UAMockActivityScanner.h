...
- (void).cxx_destruct;	// IMP=0x002000000006c20d
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000006c06d
- (id)initWithController:(id)arg1;	// IMP=0x001000000006c002
