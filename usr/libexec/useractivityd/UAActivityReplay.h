...
- (void).cxx_destruct;	// IMP=0x0020000000046669
...
- (_Bool)terminate;	// IMP=0x0010000000045faf
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000045e43
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000045e3d
- (_Bool)processCommands:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000045b69
- (_Bool)sendResponse:(id)arg1;	// IMP=0x0010000000045b61
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000043531
- (id)scanMockAdvertisement:(id)arg1;	// IMP=0x0010000000042bf4
- (void)doAdvertiseAdvertisementPayload:(id)arg1 options:(id)arg2;	// IMP=0x0010000000042969
- (id)sharingAdvertiser;	// IMP=0x001000000004276d
- (id)sharingReceiver;	// IMP=0x0010000000042571
- (void)dealloc;	// IMP=0x0010000000042306
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000041d64
