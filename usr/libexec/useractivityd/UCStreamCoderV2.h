...
- (void).cxx_destruct;	// IMP=0x002000000001bab2
...
- (id)fetchDataForType:(id)arg1;	// IMP=0x001000000001b61a
- (id)unpackMessage:(id)arg1;	// IMP=0x001000000001b5aa
- (id)packMessage:(id)arg1;	// IMP=0x001000000001b593
- (void)filePackagerError:(id)arg1;	// IMP=0x001000000001b4af
- (void)packager:(id)arg1 gotData:(id)arg2 forPacket:(long long)arg3;	// IMP=0x001000000001aff4
- (void)sendCompletedWithError:(id)arg1;	// IMP=0x001000000001ad99
- (void)sendPasteboard:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000197fa
- (void)calculateTimeRemaining;	// IMP=0x00100000000195d8
- (void)processPasteboardInfo:(id)arg1;	// IMP=0x0010000000018f15
- (void)removeReceivedItems:(id)arg1;	// IMP=0x0010000000018c2a
- (void)completedReceivingPasteboardWithError:(id)arg1;	// IMP=0x001000000001897e
- (void)receivedPasteboardInfo:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000186dc
- (void)cancelReceive;	// IMP=0x0010000000018621
- (void)receivePasteboardToFile:(id)arg1 withProgress:(id)arg2 infoReceivedHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 returnInfoEarly:(_Bool)arg5;	// IMP=0x0010000000018436
- (void)sendHeartbeat;	// IMP=0x0010000000018331
- (void)sendTotalSendSize;	// IMP=0x0010000000018217
- (void)sendPasteboardDataResponse;	// IMP=0x0010000000018065
- (void)sendFileArchiveRequest;	// IMP=0x0010000000017b56
- (void)sendPasteboardDataRequest;	// IMP=0x0010000000017a6c
- (void)sendPasteboardInfoResponse;	// IMP=0x00100000000178cf
- (void)sendPasteboardInfoRequest;	// IMP=0x0010000000017841
- (void)handleHeartbeat:(id)arg1;	// IMP=0x001000000001779d
- (void)handlePasteboardAuxInfoReceived:(id)arg1;	// IMP=0x001000000001763e
- (void)handlePasteboardFileResponse:(id)arg1;	// IMP=0x0010000000016e6f
- (void)handlePasteboardDataResponse:(id)arg1;	// IMP=0x0010000000016a21
- (void)handlePasteboardInfoResponse:(id)arg1;	// IMP=0x0010000000016707
- (void)handlePasteboardFileRequest:(id)arg1;	// IMP=0x0010000000015f90
- (void)handlePasteboardDataRequest:(id)arg1;	// IMP=0x0010000000015f0c
- (void)handlePasteboardInfoRequest:(id)arg1;	// IMP=0x0010000000015e88
- (void)recvStop:(id)arg1;	// IMP=0x0010000000015cf6
- (void)sendStopWithError:(long long)arg1;	// IMP=0x0010000000015b69
- (void)streams:(id)arg1 didWriteMessageWithTag:(long long)arg2;	// IMP=0x0010000000015676
- (void)streams:(id)arg1 didReadMessage:(id)arg2 withTag:(long long)arg3;	// IMP=0x00100000000154f5
- (void)streamsDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000153e6
- (void)removeObject:(id)arg1;	// IMP=0x0010000000015334
- (void)storeObject:(id)arg1;	// IMP=0x0010000000015282
- (void)dealloc;	// IMP=0x001000000001506f
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x0010000000014c0b
