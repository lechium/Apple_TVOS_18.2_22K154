...
- (void).cxx_destruct;	// IMP=0x002000000001492e
...
- (id)statusString;	// IMP=0x00100000000147d6
- (_Bool)terminate;	// IMP=0x001000000001466c
- (_Bool)resume;	// IMP=0x0010000000014541
- (_Bool)suspend;	// IMP=0x0010000000014416
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000014187
