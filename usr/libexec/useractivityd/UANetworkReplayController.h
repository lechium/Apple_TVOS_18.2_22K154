...
+ (_Bool)createConnection:(id)arg1 host:(id)arg2 port:(long long)arg3;	// IMP=0x002000000007adf2
- (void).cxx_destruct;	// IMP=0x002000000007b031
...
- (_Bool)terminate;	// IMP=0x001000000007abf1
- (id)statusString;	// IMP=0x001000000007aa9e
- (_Bool)sendResponse:(id)arg1;	// IMP=0x001000000007a7a5
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000079b77
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000007879c
- (id)initWithManager:(id)arg1 service:(id)arg2;	// IMP=0x0010000000078515
- (id)initWithManager:(id)arg1 inputStream:(id)arg2 outputStream:(id)arg3 name:(id)arg4;	// IMP=0x00100000000782af
