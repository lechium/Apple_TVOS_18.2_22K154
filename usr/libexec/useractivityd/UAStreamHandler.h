...
- (void).cxx_destruct;	// IMP=0x002000000003e006
...
- (id)trimFirstBytes:(unsigned long long)arg1 ofData:(id)arg2;	// IMP=0x001000000003dcf8
- (long long)tryWriteMessage;	// IMP=0x001000000003d652
- (long long)tryWriteRawData;	// IMP=0x001000000003d343
- (long long)handleSpaceAvailable;	// IMP=0x001000000003d2ea
- (void)handleMessageRead;	// IMP=0x001000000003d1af
- (_Bool)dataHasMessage:(id)arg1;	// IMP=0x001000000003d13c
- (void)processHeader;	// IMP=0x001000000003d02c
- (void)handleBytesAvailable;	// IMP=0x001000000003cc39
- (void)handleOpenCompleted;	// IMP=0x001000000003cb3c
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x001000000003c8f0
- (_Bool)writeMessage:(id)arg1 tag:(long long)arg2;	// IMP=0x001000000003c5cc
- (_Bool)writeRawData:(id)arg1;	// IMP=0x001000000003c3ca
- (void)_stop;	// IMP=0x001000000003c19a
- (void)tryStop;	// IMP=0x001000000003c047
- (void)stop;	// IMP=0x001000000003bf2f
- (void)start;	// IMP=0x001000000003bb0b
- (long long)queueCount;	// IMP=0x001000000003ba89
- (id)initWithInputStream:(id)arg1 outputStream:(id)arg2 delegate:(id)arg3;	// IMP=0x001000000003b8a4
