...
- (void).cxx_destruct;	// IMP=0x0020000000014bda
...
- (id)reportedActivityType;	// IMP=0x0010000000014b2d
- (id)eventPayload;	// IMP=0x0010000000014a31
- (id)eventName;	// IMP=0x0010000000014a24
