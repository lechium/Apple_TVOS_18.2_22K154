...
- (void).cxx_destruct;	// IMP=0x002000000004b9ec
@property(readonly, retain) UAUserActivityClientProcessesController *controller; // @synthesize controller=_controller;
- (id)statusString;	// IMP=0x001000000004b8f7
- (id)receivedItems;	// IMP=0x001000000004b5fc
- (_Bool)receiving;	// IMP=0x001000000004b5b4
- (id)initWithManager:(id)arg1 controller:(id)arg2;	// IMP=0x001000000004b535
