...
- (void)shutdownStream;	// IMP=0x0010000000069b17
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x0010000000069a53
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00100000000692ae
- (id)headerForData:(id)arg1;	// IMP=0x00100000000691e6
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000068e38
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x0010000000068c9e
