...
- (void).cxx_destruct;	// IMP=0x002000000003b6ea
...
- (id)localPBStatus;	// IMP=0x001000000003ac89
- (id)statusString;	// IMP=0x001000000003ac7c
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x001000000003a7e8
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000039c2e
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000038f6f
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x0010000000038435
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000036664
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x001000000003650d
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x00100000000364fb
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000033ada
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000031922
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000031620
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x001000000003152c
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x00100000000312ba
- (void)clearLocalPasteboardInformation;	// IMP=0x00100000000311f4
- (void);	// IMP=0x0010000000030b45
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x0010000000030a73
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x0010000000030a0d
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000308f8
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000003055c
- (id)currentPasteboardActivityInfo;	// IMP=0x0010000000030246
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x0010000000030102
- (id)items;	// IMP=0x00100000000300f0
- (void)startConnection:(int)arg1;	// IMP=0x001000000003005b
...
- (id)uuid;	// IMP=0x001000000002fde2
- (void)dealloc;	// IMP=0x001000000002fd1a
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002f670
