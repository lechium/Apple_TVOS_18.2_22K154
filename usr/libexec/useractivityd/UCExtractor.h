...
- (void).cxx_destruct;	// IMP=0x0020000000040401
...
- (void)extractArchiveWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000004038d
- (id)initWithDestinationURL:(id)arg1 forArchiveUUID:(id)arg2;	// IMP=0x001000000004025c
