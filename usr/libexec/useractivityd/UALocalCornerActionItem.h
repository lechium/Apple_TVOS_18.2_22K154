...
- (void).cxx_destruct;	// IMP=0x0020000000014a13
@property __weak UAUserActivityClientProcess *originatingClient; // @synthesize originatingClient=_originatingClient;
- (id)initWithUUID:(id)arg1 type:(unsigned long long)arg2 options:(id)arg3 originatingClient:(id)arg4;	// IMP=0x0010000000014961
