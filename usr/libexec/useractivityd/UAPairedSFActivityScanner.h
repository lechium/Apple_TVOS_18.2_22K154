...
- (void).cxx_destruct;	// IMP=0x0020000000047956
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000004775b
- (void)receiveAdvertisement:(id)arg1 options:(id)arg2 fromPeer:(id)arg3;	// IMP=0x001000000004750d
- (void)scanForTypes:(unsigned long long)arg1;	// IMP=0x0010000000047507
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000047432
