...
- (void).cxx_destruct;	// IMP=0x0020000000040fe8
...
- (id)reportedActivityType;	// IMP=0x0010000000040f3b
- (void)sendEvent;	// IMP=0x0010000000040ee0
- (id)eventPayload;	// IMP=0x0010000000040de2
- (id)eventName;	// IMP=0x0010000000040dd5
- (id)initWithAnalyticsInfo:(id)arg1;	// IMP=0x0010000000040d0a
