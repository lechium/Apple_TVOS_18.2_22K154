...
- (void).cxx_destruct;	// IMP=0x0020000000057564
...
- (id)description;	// IMP=0x00100000000570ba
- (id)encodeAsData;	// IMP=0x0010000000056822
- (id)initWithData:(id)arg1;	// IMP=0x0010000000055e2c
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000055d21
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x0010000000055c9b
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0010000000055ac4
