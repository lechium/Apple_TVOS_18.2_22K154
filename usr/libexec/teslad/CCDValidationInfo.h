...
- (_Bool)validateSelfUsingValidationInfoWithDictionary:(id)arg1 resultsDictionary:(id)arg2;	// IMP=0x001000000000f16a
- (_Bool)validateSelfWithDictionary:(id)arg1 resultsDictionary:(id)arg2;	// IMP=0x001000000000f092
- (id)initWithName:(id)arg1 validationInfo:(id)arg2;	// IMP=0x001000000000efb9
