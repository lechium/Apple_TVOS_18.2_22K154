...
- (void).cxx_destruct;	// IMP=0x0020000000014578
...
- (void)dealloc;	// IMP=0x0010000000014431
- (void)releaseTokenWithTokenID:(id)arg1;	// IMP=0x00100000000142f9
- (_Bool)configureWithError:(id *)arg1;	// IMP=0x0010000000014134
- (id)acquireTokenWithSlot:(id)arg1 AID:(id)arg2 tokenID:(id *)arg3 error:(id *)arg4;	// IMP=0x0010000000013bb2
- (id)acquireTokenWithTokenID:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001368c
@property(readonly, nonatomic) TKTokenDriverHostContext *context;
- (id)contextWithError:(id *)arg1;	// IMP=0x0010000000012716
@property(readonly, nonatomic) _Bool valid;
- (void)invalidate;	// IMP=0x0010000000012649
- (void)keepAlive:(_Bool)arg1;	// IMP=0x0010000000012507
@property(readonly, nonatomic) NSString *classID;
- (id)description;	// IMP=0x00100000000122bc
- (id)initWithExtension:(id)arg1 cache:(id)arg2;	// IMP=0x0010000000012222
