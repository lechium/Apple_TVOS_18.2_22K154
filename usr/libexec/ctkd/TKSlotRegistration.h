...
+ (_Bool)handleConnection:(id)arg1 server:(id)arg2;	// IMP=0x002000000000d4a4
- (void).cxx_destruct;	// IMP=0x002000000000da72
...
- (void)addSlotWithEndpoint:(id)arg1 name:(id)arg2 type:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x001000000000d56d
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000000d411
