...
- (void)dealloc;	// IMP=0x0010000000001f24
@property(readonly, nonatomic) NSString *slotName;
@property(readonly, nonatomic) NSXPCListenerEndpoint *endpoint;
- (id)initWithDriver:(id)arg1 slot:(id)arg2 AID:(id)arg3 registry:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000001bc9
- (id)initWithToken:(id)arg1;	// IMP=0x0010000000001b39
