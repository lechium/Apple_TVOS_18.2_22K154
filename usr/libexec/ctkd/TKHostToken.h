...
+ (id)keychainItemClasses;	// IMP=0x0020000000002934
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000020b2
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000002bad
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000002a68
- (id)connectionWithError:(id *)arg1;	// IMP=0x00100000000022ab
- (id)description;	// IMP=0x00100000000021d4
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2;	// IMP=0x00100000000020ba
