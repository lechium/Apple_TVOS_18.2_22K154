...
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000014fb6
- (id)dictionaryRepresentation;	// IMP=0x0010000000014a3d
- (id)description;	// IMP=0x001000000001498e
@property(readonly, nonatomic) _Bool hasOldPeerID;
- (int)StringAsSendingMetricsPermitted:(id)arg1;	// IMP=0x00100000000148e2
- (id)sendingMetricsPermittedAsString:(int)arg1;	// IMP=0x001000000001489a
...
- (id)tlkSharesForVouchedIdentityAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000014715
- (unsigned long long)tlkSharesForVouchedIdentitysCount;	// IMP=0x00100000000146f8
- (void)addTlkSharesForVouchedIdentity:(id)arg1;	// IMP=0x001000000001468e
- (void)clearTlkSharesForVouchedIdentitys;	// IMP=0x0010000000014671
...
- (int)StringAsCdpState:(id)arg1;	// IMP=0x001000000001459b
- (id)cdpStateAsString:(int)arg1;	// IMP=0x0010000000014553
@property(nonatomic) _Bool hasCdpState;
@property(nonatomic) int cdpState; // @synthesize cdpState=_cdpState;
- (int)StringAsAttemptedJoin:(id)arg1;	// IMP=0x0010000000014453
- (id)attemptedJoinAsString:(int)arg1;	// IMP=0x001000000001440b
...
- (int)StringAsTrustState:(id)arg1;	// IMP=0x00100000000142c1
- (id)trustStateAsString:(int)arg1;	// IMP=0x0010000000014279
...
- (int)StringAsIcloudAccountState:(id)arg1;	// IMP=0x00100000000140fe
- (id)icloudAccountStateAsString:(int)arg1;	// IMP=0x00100000000140b6
