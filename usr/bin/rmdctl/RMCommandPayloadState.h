...
- (void)markPending;	// IMP=0x0020000000006752
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000006409
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x001000000000609b
- (void)markQueued;	// IMP=0x0010000000006038
