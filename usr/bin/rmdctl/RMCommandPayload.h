...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x00200000000056b0
- (id)reportDetails;	// IMP=0x0020000000005f07
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x001000000000598c
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000005720
