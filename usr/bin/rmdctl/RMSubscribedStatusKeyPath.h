...
+ (id)fetchRequestWithKeyPaths:(id)arg1;	// IMP=0x00200000000182b6
- (id)reportDetails;	// IMP=0x002000000001835d
- (void)_validateSetOncePropertiesWithErrors:(id)arg1;	// IMP=0x0010000000017f58
- (void)_validateManagementSourceWithErrors:(id)arg1;	// IMP=0x0010000000017ebb
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000017ca2
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000017a89
- (void)awakeFromInsert;	// IMP=0x0010000000017a22
