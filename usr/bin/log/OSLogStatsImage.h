...
- (void).cxx_destruct;	// IMP=0x0020000000005d29
@property(retain, nonatomic) NSMutableDictionary *offsets; // @synthesize offsets=_offsets;
- (id)statsForOffset:(unsigned long long)arg1;	// IMP=0x0010000000005c38
@property(readonly, nonatomic) const char *UUID;
- (id)initWithUUID:(const char *)arg1;	// IMP=0x0010000000005bd6
