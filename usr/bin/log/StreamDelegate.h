...
- (void)streamDidStop:(id)arg1;	// IMP=0x001000000001dcc7
- (void)streamDidFail:(id)arg1 error:(id)arg2;	// IMP=0x001000000001dc42
- (void)streamDidStart:(id)arg1;	// IMP=0x001000000001db4b
- (_Bool)activityStream:(id)arg1 results:(id)arg2;	// IMP=0x001000000001d9ae
